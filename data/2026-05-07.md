...
### [1] [Quantum Algorithms for Magic Square Diophantine Equations](https://arxiv.org/abs/2605.04106)
*Dimitrios Thanos,Marcello Bonsangue,Alfons Laarman*

Main category: quant-ph

TL;DR: This paper explores the rigid periodic structure of solutions to magic-square constraints using quantum techniques, particularly in an oracle setting to detect and reconstruct magic squares.


<details>
  <summary>Details</summary>
Motivation: To investigate the periodic nature of solutions in Diophantine systems linked to magic squares and to enhance detection methods using quantum computing.

Method: The study utilizes explicit periodic characterizations for $3 \times 3$ magic squares, applies quantum Fourier transforms for larger orders, and introduces a shifted-oracle method to reconstruct solutions.

Result: Confirmations of periodic characterizations and successful detection methods for magic squares were achieved, with finite bounds allowing exhaustive solution discovery and criteria established for non-existence in some scenarios.

Conclusion: The paper establishes a quantum framework for efficiently detecting and reconstructing certain magic-square solutions, with implications for quantum communication protocols.
...
### [2] [Emergent Quantum Dynamics as a Bayesian Inference Problem: A Critical Analysis](https://arxiv.org/abs/2605.04112)
*Thales B. S. F. Rodrigues,Lucas L. Brugger,Vinicius G. Valle,Bruno F. Rizzuti,Cristhiano Duarte*

Main category: quant-ph

TL;DR: This paper connects coarse-grained quantum dynamics with quantum conditional states, investigates emergent dynamics using Bayesian methods, and introduces a new robustness measure for noise tolerance in microscopic dynamics.


<details>
  <summary>Details</summary>
Motivation: To understand emergent quantum dynamics through effective coarse-grained descriptions, addressing limitations in state-by-state cases.

Method: Utilizes Bayesian framework and semidefinite programming to explore emergent dynamics across various scenarios and introduces a robustness measure for noise in dynamics.

Result: Demonstrates the analytic limits of the proposed dynamics and identifies scenarios where effective dynamics can exist, leading to the new robustness measure.

Conclusion: Valid emergent descriptions can be analytically established, enhancing understanding of noise resilience in quantum dynamics.
...
### [3] [Multiparameter function estimation for general Hamiltonians](https://arxiv.org/abs/2605.04136)
*Erfan Abbasgholinejad,Sean R. Muleady,Jacob Bringewatt,Lorcan O. Conlon,Alexey V. Gorshkov*

Main category: quant-ph

TL;DR: This paper derives the ultimate quantum limit for estimating functions of multiple parameters in Hamiltonians and presents an optimal estimation protocol.


<details>
  <summary>Details</summary>
Motivation: To establish ultimate bounds for estimating functions of multiple parameters encoded in Hamiltonians, which is crucial for advancements in quantum sensing and learning.

Method: The authors derive a quantum limit and present an estimation protocol that achieves this bound, showing the relationship between multiparameter estimation and single-parameter bounds.

Result: The work derives a tight bound that simplifies to an optimized quantum Cramér-Rao bound for multiple parameters coupled to distinct, non-commuting generators.

Conclusion: This framework provides a comprehensive approach to optimal function estimation in quantum systems, unifying previous studies and extending the understanding of parameter estimation.
...
### [4] [Tunneling from an oscillating initial state in quantum mechanics](https://arxiv.org/abs/2605.04139)
*Oliver Janssen,Matthew Kleban,Cameron Norton*

Main category: quant-ph

TL;DR: This paper examines quantum decay from metastable states, deriving a closed-form expression for tunneling probability and analyzing the decay rate for oscillating states against numerical results.


<details>
  <summary>Details</summary>
Motivation: Understanding decay dynamics in quantum systems, particularly tunneling through potential barriers, is crucial for various applications in quantum mechanics and related fields.

Method: The authors provide a closed-form expression for the probability current based on the resonant states of the initial quantum state, calculated analytically to a subleading order in the semiclassical limit.

Result: An approximation to the time-dependent decay rate of oscillating initial states is derived and validated against numerical solutions of the Schrödinger equation.

Conclusion: The findings improve the understanding of quantum tunneling dynamics and provide a reliable framework for studying decay processes in metastable potentials.
...
### [5] [Topological subsystem bivariate bicycle codes with four-qubit check operators](https://arxiv.org/abs/2605.04151)
*Zijian Liang,Yu-An Chen*

Main category: quant-ph

TL;DR: Subsystem bivariate bicycle (SBB) codes enable efficient syndrome extraction for high-rate BB codes through local weight-4 gauge measurements, enhancing low-overhead quantum memories.


<details>
  <summary>Details</summary>
Motivation: To improve the syndrome extraction process for high-rate bivariate bicycle codes, which typically involve complex stabilizer checks with high weight, making them less practical.

Method: Introducing SBB codes as a CSS subsystem construction that utilizes local weight-4 gauge measurements to facilitate efficient syndrome extraction. Utilization of a determinantal-ideal criterion aids in detecting nonlocal stabilizers.

Result: Demonstration that SBB codes can maintain the topological nature of BB codes while achieving lower overhead, with examples including codes that outperform subsystem surface codes in logical qubit encoding.

Conclusion: Gauge degrees of freedom effectively align high-rate BB code structures with feasible local weight-4 syndrome extraction, enhancing the practicality of these quantum memories.
...
### [6] [Quantum criticality beyond thermodynamic stability](https://arxiv.org/abs/2605.04153)
*Mariam Ughrelidze,Vincent P. Flynn,Emilio Cobanera,Lorenza Viola*

Main category: quant-ph

TL;DR: This paper explores quantum criticality in dynamically stable quadratic bosonic Hamiltonians (QBHs) that lack a ground state, establishing that criticality is meaningful even without thermodynamic stability. It introduces the concept of a quasiparticle vacuum (QPV) and identifies the Krein gap as a crucial spectral element linked to correlations and critical behavior.


<details>
  <summary>Details</summary>
Motivation: To understand quantum criticality in many-body systems, particularly for models like quadratic bosonic Hamiltonians that do not exhibit a ground state yet are dynamically stable or near instability.

Method: The paper introduces the quasiparticle vacuum (QPV) state, defines the Krein gap for QBHs, and examines correlation behaviors under varying stability conditions, particularly focusing on spectral separations and their implications.

Result: Demonstrated that the QPV is unique when the Krein gap is positive and established that correlations in dynamically stable QBHs are bounded unless the Krein gap closes, leading to potential long-range correlations.

Conclusion: The findings allow for a deeper exploration of dynamically stable QBHs, elucidating their critical behaviors and interactions, and emphasizing the Krein gap's role in understanding quantum critical phenomena beyond conventional thermodynamic limits.
...
### [7] [Nonstabilizerness Mpemba Effects](https://arxiv.org/abs/2605.04155)
*Zhenyu Xiao,Hao-Kai Zhang,Shuo Liu*

Main category: quant-ph

TL;DR: This paper explores a quantum Mpemba effect in state preparation, revealing that lower initial magic states can accelerate the generation of quantum magic faster than higher initial magic states, with dynamics influenced by initial state structure and symmetry.


<details>
  <summary>Details</summary>
Motivation: The study investigates non-intuitive quantum state preparation, specifically focusing on how initial conditions affect the efficiency of generating quantum magic.

Method: The authors analyze $	ext{U(1)}$-symmetric random circuits initialized from tilted product states, measuring magic using stabilizer Rényi entropy.

Result: They demonstrate that initial states with lower magic can generate magic more quickly than those with higher magic, and that dynamics can differ even among states with identical magic and charge distributions.

Conclusion: The findings indicate that the Mpemba effect in quantum magic generation extends beyond specific symmetries or random-circuit dynamics, highlighting a new domain for studying Mpemba phenomena in quantum mechanics.
...
### [8] [Establishing Mixed-State Phase Equivalence beyond Renormalization Fixed Points](https://arxiv.org/abs/2605.04159)
*Yuhan Liu*

Main category: quant-ph

TL;DR: This work develops a new framework to analyze mixed-state quantum phases, connecting distinct one-dimensional fixed points and establishing phase equivalence beyond traditional renormalization fixed-point approaches.


<details>
  <summary>Details</summary>
Motivation: The study addresses the complexities of mixed-state quantum phases in quantum simulation, moving beyond traditional methods centered on renormalization fixed points.

Method: The authors construct a quantum phase transition between two distinct fixed points using low-depth, quasi-local channel circuits derived from the parent Lindbladian framework to demonstrate phase equivalence.

Result: The established framework successfully connects states within each phase and generalizes to a wide range of intrinsically nontrivial mixed-state quantum phases.

Conclusion: This approach provides a rigorous methodology for analyzing phase equivalence in non-trivial mixed states, advancing understanding beyond established paradigms.
...
### [9] [Quantum state texture of dynamical criticality](https://arxiv.org/abs/2605.04161)
*Lucas C. Céleri,Krissia Zawadzki,Ivan Medina,Diogo O. Soares-Pinto*

Main category: quant-ph

TL;DR: This paper connects quantum state texture, described by rugosity, to dynamical quantum phase transitions, examining its effectiveness as an order parameter for both type-I and type-II transitions.


<details>
  <summary>Details</summary>
Motivation: To explore the relationship between quantum state texture and dynamical quantum phase transitions, with a focus on the role of rugosity.

Method: Analysis of dynamical quantum phase transitions through quench protocols, linking rugosity directly to critical phenomena and showcasing its applicability across various models.

Result: Rugosity serves as a distinguishing order parameter for type-I transitions and establishes a universal interpretation for type-II transitions through the Loschmidt rate function.

Conclusion: Rugosity offers a novel framework to understand dynamical critical phenomena, suggesting its importance alongside other metrics like complexity and entropy in analyzing nonequilibrium many-body systems.
...
### [10] [Boson Sampling with a reconfigurable 128 modes 3D integrated photonic circuit](https://arxiv.org/abs/2605.04162)
...
TL;DR: This paper presents a novel reconfigurable 3D photonic device, Qolossus 3D, facilitating complex quantum operations and randomness generation through advanced photonic architecture.


<details>
  <summary>Details</summary>
Motivation: The study addresses the need for scalable, stable hardware in quantum information processing, emphasizing integrated photonics' role in achieving quantum advantage tasks.

Method: The authors introduce a 3D photonic device with 128 modes, leveraging thermo-optic programmability for implementing complex unitary transformations and conducting Boson Sampling with single photons from a quantum dot source.

Result: Experimental realization of Boson Sampling across the integrated chip demonstrates agreement with theoretical predictions, verifying both the reconfigurable operation of the device and its utility in generating random numbers.

Conclusion: The findings affirm integrated photonics' potential for scalable quantum information processing due to its stability, precision, and capability for high-dimensional transformations.
...
### [11] [A Transferable Machine Learning Approach to Predict Optimized Orbitals for Electronic Structure Problems](https://arxiv.org/abs/2605.04174)
*Lucas van der Horst,Maniraman Periyasamy,Abhishek Y. Dubey,Davide Bincoletto,Jakob S. Kottmann,Daniel D. Scherer*

Main category: quant-ph

TL;DR: The paper presents a graph neural network to optimize orbital coefficients for variational quantum eigensolvers, reducing computational costs and enhancing scalability in quantum chemistry tasks.


<details>
  <summary>Details</summary>
Motivation: Traditional methods for optimizing orbital coefficients are computationally expensive and hinder scalability in calculating ground-state energies for varying molecular geometries.

Method: The authors developed a graph neural network that predicts optimized orbital coefficients from molecular geometry and bonding structures, trained on small hydrogenic systems, allowing transfer to larger unseen systems without retraining.

Result: The model achieved mean absolute energy errors of approximately 100 milli-Hartrees in structured configurations and 10 milli-Hartrees in random configurations, outperforming classical optimization methods.

Conclusion: Graph neural networks effectively accelerate orbital optimization in hybrid workflows, significantly alleviating the classical pre-processing burden and enhancing the feasibility of variational quantum eigensolvers on current quantum hardware.
...
TL;DR: VISTA enhances quantum metrology by utilizing a closed-loop protocol that combines passive sensing with physics-informed variational optimization, achieving near-Heisenberg scaling in noisy environments.


<details>
  <summary>Details</summary>
Motivation: To improve magnetic field sensing beyond the Standard Quantum Limit while overcoming the limitations of existing algorithms due to noise, control requirements, and interpretability issues.

Method: VISTA employs a closed-loop protocol where a probe state evolves passively and is optimized using a physics-informed twin Ansatz to avoid barren plateaus and enhance performance.

Result: VISTA achieves near-Heisenberg scaling for moderately noisy qubits, enables simultaneous extraction of coherent signals and environmental noise rates, and extends to multi-parameter vector metrology.

Conclusion: VISTA offers a practical, resource-efficient framework for enhancing quantum sensors without complex control mechanisms, making it applicable for near- to intermediate-term quantum sensing challenges.
...
TL;DR: This study explores compression methods for multipartite entanglement distribution when partitioning is uncertain, showing that joint optimization of resource states and compression enhances entanglement under budget constraints.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of distributing multipartite entanglement without prior knowledge of quantum state partitioning, aiming to maximize entanglement under fixed transmission rates.

Method: The problem is framed as a source coding issue, deriving non-asymptotic bounds for achievable entanglement and optimizing states alongside lossless compression through symmetry in weighted Dicke states.

Result: Developed practical constructions in bipartite and multipartite scenarios that approach the derived upper bounds for entanglement.

Conclusion: Jointly optimizing the quantum states and compression strategies significantly improves entanglement distribution efficiency within set transmission limits.
...
TL;DR: The paper analyzes energy requirements for encoding logical qubits in various error correction codes, finding a trade-off between precision and energy resources with exponential scaling.


<details>
  <summary>Details</summary>
Motivation: To assess the feasibility of quantum error correction for fault-tolerant quantum computing and understand its energy demands.

Method: The authors examined energy resources needed for different quantum error correction codes: repetition, perfect, and Steane codes.

Result: There exists a universal trade-off between target precision in encoding and the energy resources required, with exponential scaling of resources related to precision.

Conclusion: The physical realization of a quantum error correction code significantly influences energy requirements, highlighting challenges in achieving practical quantum advantage.
...
TL;DR: This paper presents a novel protocol for certifying quantum behavior in high-dimensional systems without pre-shared resources, demonstrating its robustness against noise.


<details>
  <summary>Details</summary>
Motivation: The need for certifying quantum behavior using accessible data for secure communication and the challenges posed by noise and higher-dimensional systems.

Method: A protocol is designed and experimentally implemented that does not require pre-shared resources or measurement incompatibility, using orbital angular momentum of single photons as a high-dimensional system.

Result: The protocol successfully certified non-classicality despite noise, demonstrating rank-stability in correlations and scalability.

Conclusion: This work offers a practical approach for validating high-dimensional quantum communication systems, enhancing possibilities for secure and efficient quantum information processing.
...
### [16] [Hidden Prime-Factor Subgroups in Molecular and Condensed-Phase Systems](https://arxiv.org/abs/2605.04343)
*Srinivasan S. Iyengar,Amr Sabry*

Main category: quant-ph

TL;DR: This paper presents a group theoretic perspective on Shor's algorithm, linking mathematical problems to physical systems like molecular orbitals and condensed matter, suggesting that these systems can encode solutions to hard mathematical problems.


<details>
  <summary>Details</summary>
Motivation: To explore the relationship between group theory, Shor's algorithm, and the symmetries in physical systems, particularly in relation to prime-factoring in encryption.

Method: The paper uses group theory to analyze Shor's algorithm and examines real molecular systems constructed from symmetry-adapted linear combinations of atomic orbitals.

Result: Molecular systems can encode information related to prime-factors of integers, suggesting that physical systems can be designed to solve mathematical problems.

Conclusion: This group theoretic approach could significantly impact encryption and cyber-security by providing alternative methods for understanding and solving problems related to prime-factoring.
...
TL;DR: SpinTune, a reinforcement learning method, optimizes dynamical decoupling sequences for quantum sensors, enhancing coherence preservation against environmental noise.


<details>
  <summary>Details</summary>
Motivation: To improve the practical utility of quantum sensors in various applications by addressing the limitations imposed by environmental decoherence.

Method: Utilizes reinforcement learning to autonomously generate adaptive, piecewise dynamical decoupling sequences for specific environments.

Result: SpinTune demonstrates significant improvements over standard dynamical decoupling techniques in maintaining coherence as evidenced by simulations with a Carbon-13 spin bath.

Conclusion: SpinTune provides an advanced solution for enhancing the reliability of quantum sensors in noisy environments.
...
TL;DR: The study derives dynamics of a four-qubit Heisenberg chain with tunable coupling, examining fidelity, coherence, and entanglement as functions of a composite phase. Key results indicate specific behavior at a coupling of -1, ensuring relevance for quantum devices and future extensions to complex systems.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics of a four-qubit isotropic Heisenberg XXX chain, particularly the effects of tunable next-nearest-neighbor coupling on quantum properties.

Method: Derivation of closed-form expressions for fidelity, coherence, and entanglement for a Bell-type initial state, focusing on the composite phase influenced by coupling strength.

Result: Fidelity and coherence show distinct behaviors with respect to the coupling parameter, including freezing at specific conditions; entanglement oscillates and also freezes at a coupling of -1.

Conclusion: The phase unifies the behavior of observed quantities, providing a framework suitable for analyzing few-qubit devices and extending the findings to scenarios involving noise, finite temperature, and larger systems.
...
TL;DR: The paper presents Triage, a dual-mode architecture for real-time classical decoding in fault-tolerant quantum computation, addressing resource allocation issues and reducing logical error rates under constraints.


<details>
  <summary>Details</summary>
Motivation: The increasing scaling of quantum systems creates decoding bottlenecks, causing latency and logical operation stalls, necessitating efficient resource allocation for real-time decoding in FTQC.

Method: The authors formulate decoding as a constrained dynamic scheduling problem and develop Triage, which combines a heuristic scheduler with an emergency mode using a spatio-temporal framework.

Result: Triage demonstrates a 52.6% reduction in logical error rates compared to standard methods while maintaining low stalls under limited classical resources.

Conclusion: The proposed architecture is effective for enhancing the performance of scalable FTQC architectures by optimizing resource allocation and minimizing operation stalls.
...
TL;DR: This paper presents a Floquet theory-based strategy for quantum multiparameter estimation in periodically driven systems, revealing enhanced precision near topological phase transitions.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the limitations of static effective Hamiltonians for quantum multiparameter estimation in time-periodically driven systems.

Method: The authors employ Floquet theory to analyze contributions from eigenmodes, quasienergies, and multi-photon processes to the quantum Fisher information matrix and measurement incompatibility.

Result: Significantly improved estimation precision near topological phase transition boundaries, achieving Heisenberg limit scaling and enhanced results. Measurement incompatibility decreases oscillatory, with stroboscopic projective measurements yielding the highest precision.

Conclusion: This research offers a comprehensive Floquet framework, advancing the understanding of critical quantum multiparameter estimation in time-dependent systems.
...
TL;DR: The paper introduces 'confidence uncertainty' and 'interval confidence uncertainty' metrics to refine the understanding of position and momentum in quantum mechanics, presenting bounds on the simultaneous localization of probabilities.


<details>
  <summary>Details</summary>
Motivation: To address limitations of existing formulations of uncertainty in quantum mechanics that do not adequately express the probability distribution contained in small regions.

Method: The authors define confidence uncertainties, prove complementary uncertainty inequalities, and use numerical evaluations to support analytical bounds, alongside comparisons to established uncertainty bounds.

Result: Two inequalities are established: (i) confidence uncertainties can be arbitrarily small for $θ_x+θ_p≤1$, allowing for joint localization, and (ii) a lower bound is derived for $θ_x+θ_p>1$ relating confidence uncertainties to the product of probabilities.

Conclusion: The findings offer a refined understanding of uncertainty principles in quantum mechanics, with implications for measurements of position and momentum.
...
TL;DR: This paper explores quantum state tomography using matrix product operators (MPOs) for efficient representation of mixed states, presenting an online Riemannian gradient descent algorithm for reconstruction.


<details>
  <summary>Details</summary>
Motivation: The study aims to enhance quantum state tomography by leveraging the properties of MPOs to efficiently represent many-body quantum states with limited entanglement.

Method: An equivalent characterization of Hermiticity in MPOs is derived, leading to the development of an online Riemannian gradient descent (oRGD) algorithm that processes measurement data sequentially for reconstructing quantum states.

Result: The proposed oRGD algorithm converges linearly to the target MPO, with measurement settings scaling quadratically with system size, and improved sample complexity bounds for low tensor-train rank completion.

Conclusion: Numerical experiments demonstrate that the method is effective and scalable, establishing guarantees for the initialization and reconstruction process.
...
TL;DR: The paper discusses hierarchical entanglement dynamics in chaotic many-body systems, revealing a transition between area and volume-law entanglement. It presents findings from quantum quenches in Gibbs states and a circuit model, demonstrating a connection between Schmidt sectors and their dimensionality.


<details>
  <summary>Details</summary>
Motivation: To understand the entanglement structure in chaotic many-body dynamics, particularly in the context of local quantum quenches.

Method: The authors analyze entanglement in locally quenched Gibbs states and a pure-state circuit model, demonstrating transitions in Renyi entropies and examining the properties of dominant Schmidt sectors.

Result: They found that at long times, Renyi entropies obey area laws for α>1 and volume laws for α≤1. The dominant Schmidt sector has a simpler, O(1)-dimensional structure with critical indices indicating a polynomial bond dimension.

Conclusion: The entanglement hierarchy remains consistent upon bipartitioning dominant Schmidt states, providing a deeper understanding of entanglement dynamics in many-body systems.
...
### [24] [Measurement-Device-Independent Entanglement Quantification in a Fully Connected Time-Bin Quantum Network](https://arxiv.org/abs/2605.04546)
*Lu Liu,Ling-Xuan Kong,Ze-Yang Lu,Xu-Jie Peng,Xiao-Xu Fang,He Lu*

Main category: quant-ph

TL;DR: This paper presents a method for reliable entanglement verification in fully connected quantum networks using measurement-device-independent techniques, demonstrating resilience to untrusted measurement conditions.


<details>
  <summary>Details</summary>
Motivation: The need for reliable entanglement characterization in secure quantum communications without relying on external measurement devices.

Method: The authors utilize a time-bin-encoded quantum network with a broadband entangled photon source and dense wavelength-division multiplexing to distribute entangled links among users, employing MDI techniques.

Result: Experimental results show the successful verification and quantification of entanglement over 20-km fiber channels without the need for active stabilization, using a single dataset for measurements.

Conclusion: The study provides a scalable solution for entanglement characterization in quantum networks, enhancing the reliability of quantum communication.
...
### [25] [Causal-Order Identification of Memoryless Sequential Quantum Processes from Restricted Projective Data](https://arxiv.org/abs/2605.04571)
*Masahito Hayashi*

Main category: quant-ph

TL;DR: This work establishes conditions for identifying causal order in memoryless sequential quantum processes from limited data, addressing the insufficiency of previous criteria and exploring the two-qubit Pauli scenario.


<details>
  <summary>Details</summary>
Motivation: Identifying causal relationships in quantum processes is challenging due to incomplete local measurements and the indistinguishability of certain causal structures.

Method: The authors derive necessary and sufficient conditions for confirming compatibility with memoryless sequential quantum processes, incorporating directional conditional independence and a positivity criterion augmented by an algebraic consistency requirement.

Result: In the two-qubit Pauli setting, the authors clarify conditions under which causal directions are statistically indistinguishable and demonstrate that positivity alone is insufficient to rule out memoryful strategies when the algebraic consistency requirement is met.

Conclusion: The study provides a comprehensive criterion for membership in the memoryless sequential class and underlines the limitations of existing methods, crucial for future quantum analysis.
...
### [26] [Fundamental Limitations of Post-Quantum Cryptographic Architectures](https://arxiv.org/abs/2605.04582)
*Jiho Jung,Donghwa Ji,Mingyu Lee,Kabgyun Jeong*

Main category: quant-ph

TL;DR: This study explores the limitations of lattice-based cryptography, focusing on the noise model's vulnerability to quantum advancements and the implications for its theoretical categorization as post-quantum.


<details>
  <summary>Details</summary>
Motivation: To evaluate the effectiveness and credibility of lattice-based cryptography in light of potential quantum advancements and to scrutinize the noise injection mechanism's limitations.

Method: A systematic examination across computational complexity, thermodynamics, quantum error correction, and quantum learning theory frameworks, analyzing how lattice-based noise models operate under these domains.

Result: Identified vulnerabilities in the theoretical assumptions and highlighted that injected noise does not permanently erase information, allowing for potential extraction of secret data.

Conclusion: While promising as a transitional solution, labeling lattice-based cryptography as unconditionally post-quantum is premature due to its reliance on evolving physical principles rather than solid theoretical foundations.
...
### [27] [Single-photon scattering by a giant molecule asymmetrically coupled to parallel waveguides](https://arxiv.org/abs/2605.04588)
*Ze-Quan Zhang,Guang-Zheng Ye,Wei-Xin Chen,Yong Li,Huaizhi Wu*

Main category: quant-ph

TL;DR: This paper explores photon scattering in a waveguide-QED setup involving coupled giant atoms, showcasing how various parameters influence photon routing and resonance behavior.


<details>
  <summary>Details</summary>
Motivation: Understanding single-photon scattering dynamics is crucial for developing efficient quantum networks and devices, particularly for controlling photon routing in waveguides.

Method: The study employs theoretical analysis of photon transmission and reflection spectra in a system with two detuned giant atoms coupled to waveguides, examining the effects of decay rates and detuning.

Result: It finds that by manipulating atomic detuning and decay asymmetry, one can achieve optimal photon transfer and deterministic routing, with spectra exhibiting both a doublet and multiple resonances depending on conditions.

Conclusion: The interplay of decay rates, atomic detuning, and non-Markovian effects allows for advanced control mechanisms in single-photon routing, significantly impacting multi-port quantum network designs.
...
### [28] [Two-site Bose-Hubbard hopping and Schrödinger cat states](https://arxiv.org/abs/2605.04598)
*Madeline Berezowski,Artur Sowa,Jonas Fransson*

Main category: quant-ph

TL;DR: The paper simplifies the Bose-Hubbard Hamiltonian to a dimer, exploring its eigenvalues and eigenvectors using bosonic commutation relations, revealing a new method for computing the $x$-axis spin projection operator and studying coherent state dynamics obtaining Schrödinger cat states.


<details>
  <summary>Details</summary>
Motivation: To explore the simplified dimer system from the Bose-Hubbard Hamiltonian and uncover its eigenproperties.

Method: An inductive argument based on bosonic canonical commutation relations is employed to derive the eigenvalues and eigenvectors in $k$-particle subspaces of the dimer hopping Hamiltonian.

Result: The study demonstrates that the dimer Hamiltonian acts as the $x$-axis spin projection operator for a system with $k$ particles, leading to a new eigenvalue computation method and identifying coherent states as Schrödinger cat states.

Conclusion: The findings provide a novel approach to studying the dynamics of two-site quantum systems, specifically through the generation of coherent Schrödinger cat states.
...
### [29] [Generative Quantum-inspired Kolmogorov-Arnold Eigensolver](https://arxiv.org/abs/2605.04604)
...
TL;DR: GQKAE is a parameter-efficient generative quantum eigensolver using hybrid Kolmogorov-Arnold network modules, achieving high chemical accuracy with significantly reduced parameters and improved performance.


<details>
  <summary>Details</summary>
Motivation: To enhance quantum chemistry workflows by integrating high-performance computing with advanced generative models, facilitating efficiency in simulations and postprocessing.

Method: GQKAE employs hybrid Kolmogorov-Arnold networks to replace parameter-heavy components in traditional generative eigensolvers, while maintaining autoregressive selections and utilizing advanced activation modules for better expressive power.

Result: GQKAE shows a 66% reduction in trainable parameters and memory usage, achieving chemical accuracy comparable to GPT-based methods, and enhances convergence for challenging molecular systems.

Conclusion: The proposed GQKAE framework demonstrates a scalable approach for HPC-quantum co-design, effectively balancing efficiency and quality in quantum calculations.
...
### [30] [Intelligent Optimal Control of Rydberg Gates with Incremental-Update Deep Reinforcement Learning](https://arxiv.org/abs/2605.04628)
*Yue Cai,Hanlin Zhang,Keye Zhang,Jing Qian*

Main category: quant-ph

TL;DR: This paper presents a deep reinforcement learning framework for optimizing Rydberg controlled-NOT gates, achieving high speed and fidelity in quantum computing.


<details>
  <summary>Details</summary>
Motivation: To enhance quantum optimal control for neutral-atom quantum computing using AI-driven techniques.

Method: Utilizes a DRL-based framework with incremental-update learning policies to achieve smooth pulse profiles and reduce computational overhead without prior heuristics.

Result: The protocol achieves a peak fidelity of 0.9991, outperforming traditional methods and exceeding the fault-tolerant threshold.

Conclusion: Establishes a generalizable approach for high-performing quantum gate design and autonomous control optimization across qubit platforms.
...
### [31] [Neural network modeling of many-body super- and sub-radiant dynamics](https://arxiv.org/abs/2605.04640)
*Gianluca Lagnese,Laurin Brunner,Lorenzo Rossi,Darrick Chang,Markus Schmitt,Zala Lenarčič*

Main category: quant-ph

TL;DR: This study introduces a novel numerical technique using neural quantum states to simulate the dissipative dynamics of light-matter-coupled systems, particularly focusing on arrays of atoms, surpassing traditional methods.


<details>
  <summary>Details</summary>
Motivation: The research aims to explore novel phenomena in quantum light-matter interfaces by developing new simulation techniques suitable for large systems without relying on semi-classical approaches.

Method: The authors apply neural quantum states to simulate the many-body emission dynamics of dense arrays of approximately 40 atoms, in one and two dimensions, capturing unique subradiant dynamics.

Result: The simulation provides insights into the dissipative dynamics of light-matter-coupled systems that were previously inaccessible through exact or tensor-network calculations.

Conclusion: This innovative approach could enhance understanding of quantum phenomena and facilitate experiments with cold atomic quantum simulators.
...
### [32] [Unconditional Authentication in Quantum Key Distribution via Hybrid Entangled Physical Unclonable Functions](https://arxiv.org/abs/2605.04650)
*Nicolas Laurent-Puig,Mina Doosti,Adriano Innocenzi,Eleni Diamanti*

Main category: quant-ph

TL;DR: This work presents a Hybrid Entangled PUF protocol for authentication in Quantum Key Distribution, removing the need for pre-shared keys while ensuring Information-Theoretically Secure key exchange.


<details>
  <summary>Details</summary>
Motivation: To overcome the requirement of a pre-shared secret key in Quantum Key Distribution, which limits practical implementations.

Method: Adoption of a Hybrid Entangled Physical Unclonable Function protocol for authentication, allowing the generation of an initial key without pre-shared secrets.

Result: Demonstrated a fully ITS-authenticated entanglement-based QKD protocol that operates using minimal hardware assumptions, eliminating the dependency on pre-shared keys.

Conclusion: This work significantly enhances the practicality of quantum networking by leveraging lightweight hardware without compromising security.
...
### [33] [Efficient Multi-Controlled Gate Implementation in Trapped-Ion Systems](https://arxiv.org/abs/2605.04654)
*Minhyeok Kang,Taejin Kim,Jungsoo Hong,Joonsuk Huh*

Main category: quant-ph

TL;DR: This paper presents efficient pulse-level implementations of multi-controlled gates in trapped-ion systems, highlighting a sign choice freedom in RSB pulses that enables reduced gate time and improved fidelity through pulse cancellation.


<details>
  <summary>Details</summary>
Motivation: Multi-controlled gates are crucial for quantum algorithms, yet their standard implementations via gate-level decompositions are resource-heavy.

Method: Utilizing the Cirac-Zoller scheme, the authors exploit the sign choice freedom in red-sideband pulses to develop equivalent realizations and employ pulse cancellation for improved efficiency in successive gate operations.

Result: Numerical simulations demonstrate that pulse cancellation decreases gate time and enhances state fidelity, leading to $O(L)$ RSB-pulse costs for select operators in LCU methods, as opposed to $O(L \log L)$.

Conclusion: The findings improve the efficiency and scalability of LCU-based quantum circuits, with potential implications for quantum algorithm performance.
...
### [34] [Distributed Quantum Error Correction with Bivariate Bicycle Codes in a Modular Architecture](https://arxiv.org/abs/2605.04663)
*Nitish Kumar Chandra,Eneet Kaur,Reza Nejabati,Kaushik P. Seshadreesan*

Main category: quant-ph

TL;DR: This paper explores the implementation challenges and solutions for bivariate bicycle (BB) codes in modular quantum computing architectures, emphasizing key design considerations and performance metrics.


<details>
  <summary>Details</summary>
Motivation: To advance quantum error correction techniques in modular quantum computing, specifically focusing on the practicality of implementing BB codes in multiprocessor environments.

Method: The study utilizes Monte Carlo simulations alongside BP+OSD decoding to analyze the performance of the [[144,12,12]] BB code across different configurations of quantum processors, assessing error rates and pseudo-threshold performance.

Result: The findings indicate that partitioning qubits across varying numbers of processors affects logical error rates and that the architecture can efficiently manage the noise from nonlocal operations, providing insight into BB code performance in distributed settings.

Conclusion: The results offer valuable architectural insights for deploying distributed BB codes in quantum computing systems, informing future designs and enhancing the feasibility of quantum error correction.
...
### [35] [Finite steps optimise dissipation in stochastically controlled quantum systems](https://arxiv.org/abs/2605.04681)
*Theodore McKeever,Harry J. D. Miller,Ahsan Nazir*

Main category: quant-ph

TL;DR: This study analyzes the thermodynamic costs of quantum control protocols impacted by classical noise, revealing effects on dissipation related to the number of steps.


<details>
  <summary>Details</summary>
Motivation: The research addresses the need for effective quantum control methods that minimize energy consumption while remaining feasible for experimental implementation.

Method: The study examines quantum step-equilibration processes influenced by stochastic control fields, contrasting deterministic protocols and identifying the effects of weak Gaussian noise.

Result: It is established that noise increases dissipative work linearly with the number of steps, leading to a derived optimal number of steps that minimizes work and variance.

Conclusion: The findings are substantiated through two practical examples involving quantum systems, highlighting the balance between control precision and energy efficiency.
...
### [36] [Neural-powered unit disk graph embedding: qubits connectivity for some QUBO problems](https://arxiv.org/abs/2605.04736)
...
TL;DR: This paper introduces a novel neural network-based approach for constrained unit disk graph embedding in quantum computing, specifically for minor graph embedding in QUBO problems, outperforming traditional Gurobi solvers.


<details>
  <summary>Details</summary>
Motivation: To efficiently map QUBO problems onto quantum hardware requirements and address the challenges of constrained unit disk graph embedding.

Method: Utilizing neural networks to convert an initial embedding configuration into a feasible unit disk arrangement that aligns with the desired QUBO matrix and quantum hardware adjacency requirements.

Result: The experimental results demonstrate a performance improvement over the Gurobi solver in solving the unit disk graph embedding problem.

Conclusion: The proposed neural network-based approach effectively aligns QUBO problems with quantum hardware constraints, enhancing the efficiency of quantum optimization tasks.
...
### [37] [Harnessing a 256-qubit Neutral Atom Simulator for Graph Classification](https://arxiv.org/abs/2605.04737)
...
TL;DR: This paper demonstrates the utility of quantum simulators for graph classification by utilizing the Quantum Evolution Kernel (QEK) on a 256-qubit platform, achieving improved performance over classical methods despite challenges with hardware limitations.


<details>
  <summary>Details</summary>
Motivation: The motivation lies in leveraging neutral atom platforms for quantum simulation to solve complex graph-based combinatorial optimization problems and enhance Quantum Machine Learning capabilities.

Method: The authors compute the Quantum Evolution Kernel (QEK) on a 256-qubit Aquila quantum simulator to extract features from graphs in the PROTEINS dataset, followed by the application of classical Machine Learning techniques for classification.

Result: The proposed approach shows slightly better performance compared to classical kernels, demonstrating its potential efficacy in noisy quantum environments.

Conclusion: The findings suggest that the combination of quantum feature extraction and classical classification can be effective, even when utilizing imperfect quantum hardware.
...
### [38] [Automated Circuit Depth Reduction of Quantum Subroutines via Compilation](https://arxiv.org/abs/2605.04748)
*Folkert de Ronde,Stephan Wong,Sebastian Feld*

Main category: quant-ph

TL;DR: This work presents a compiler-driven approach for optimizing quantum circuit depth in GHZ state creation and CNOT/CZ chain decomposition, resulting in significant depth reductions but increased gate counts.


<details>
  <summary>Details</summary>
Motivation: The optimization of quantum circuits is critical for enhancing efficiency and scalability, especially as quantum hardware evolves.

Method: A compiler automatically detects and optimizes GHZ state creation and CNOT/CZ chain decomposition to reduce circuit depth via constant and logarithmic depth techniques.

Result: Significant depth reductions are observed in benchmarked algorithms, although with increased gate counts, particularly in CNOT chains.

Conclusion: The trade-off in increased gate count is offset by improved execution time from the reduced circuit depth, making the optimization beneficial for algorithm efficiency.
...
### [39] [Quantum Magic in early FTQC: From Diagonal Clifford Hierarchy No-Go Theorems to Architecture Design Blueprints](https://arxiv.org/abs/2605.04758)
*Hsueh-Hao Lu,Yasunari Suzuki,Yasunobu Nakamura,En-Jui Kuo*

Main category: quant-ph

TL;DR: This paper explores maximizing quantum magic in early fault-tolerant quantum computing (FTQC) by proving key theorems on operational magic and gate selection, ultimately revealing the necessity for state-aware optimization.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of optimizing circuit designs for early fault-tolerant quantum computing, particularly in achieving high operational magic.

Method: The authors develop a theoretical framework that includes uniqueness theorems regarding operational magic, deriving expressions for the Pauli spectrum and introducing a state-aware, differentiable optimization approach.

Result: The research establishes two no-go theorems: hierarchy level does not universally order operational magic, and no fixed sequence can ensure monotonic magic improvement, emphasizing the need for nonlinear operations.

Conclusion: The findings suggest that traditional algebraic gate structures are inadequate for resource generation, and highlight the advantages of nonlinear diagonal phases for enhancing magic generation in early FTQC architectures.
...
### [40] [Scheduling Entanglement Flows in Multi-channel Quantum Networks](https://arxiv.org/abs/2605.04767)
*Gongyu Ni,Lester Ho*

Main category: quant-ph

TL;DR: The paper explores resource allocation strategies for entanglement distribution in multi-channel quantum networks, comparing classical methods with a new PPO-based approach.


<details>
  <summary>Details</summary>
Motivation: To optimize resource allocation in quantum networks under diverse link characteristics and entanglement request scenarios.

Method: The study implements several classical allocation techniques and introduces a Proximal Policy Optimization-based method, assessing their performance through simulations based on multiple metrics.

Result: Dynamic Efficient algorithm minimizes delay; Success Enhancement maximizes successful requests through multipath allocation; the PPO approach offers a balanced improvement in capacity utilization and request success.

Conclusion: The PPO-based method emerges as the most effective strategy overall, balancing low delay and high success rates in entanglement requests.
...
### [41] [W-state graphs: Structure and Algorithms](https://arxiv.org/abs/2605.04855)
*Rishikesh Gajjala,Saurabh Ray,Dimitrios M. Thilikos*

Main category: quant-ph

TL;DR: The paper characterizes W-state graphs related to quantum photonic experiments, establishing their structure based on 3-connected components and providing a recognition algorithm, while noting complexities in related Dicke states.


<details>
  <summary>Details</summary>
Motivation: To understand the structure of edge-coloured graphs that arise in quantum photonic experiments generating multipartite W-states, simplifying the physical aspects to focus on combinatorial properties.

Method: The paper introduces W-state graphs as matching-covered graphs with specific edge-coloring properties, and delivers a characterization based on their 3-connected components being W-cones.

Result: A graph is a W-state graph if each 3-connected component conforms to the W-cone structure, and a fast recognition algorithm is presented, while a complexity barrier is identified for Dicke states.

Conclusion: W-state graphs integrate seamlessly into classical matching theory, offering clear combinatorial structures for realizing W-states, along with recognizing computational complexities in extending the concepts to Dicke states.
...
### [42] [Quantum algorithm for solving differential equations using SLAC derivatives](https://arxiv.org/abs/2605.04861)
*Rakshit M. Gharat,Gopikrishnan Muraleedharan,Dominic W. Berry,Gavin K. Brennen*

Main category: quant-ph

TL;DR: The paper proposes efficient LCU-based block-encodings for first-order derivative and Laplacian operators, utilizing state-preparation and Shannon wavelet transforms, facilitating quantum solutions for PDEs.


<details>
  <summary>Details</summary>
Motivation: To create more efficient methods for solving partial differential equations (PDEs) using quantum computing techniques.

Method: Utilization of LCU-based block-encodings, state-preparation for LCU amplitudes, wavelet transforms for multi-scale representation, and diagonal preconditioning for matrices.

Result: Demonstrated reduction in condition number of matrices and enhanced efficiency in solving PDEs using quantum linear solving algorithm (QLSA).

Conclusion: The proposed techniques improve computational efficiency and error handling in quantum simulations of SLAC discretized operators.
...
### [43] [Catalytic advantage in asymptotic entanglement manipulation](https://arxiv.org/abs/2605.04879)
*Ray Ganardi*

Main category: quant-ph

TL;DR: This paper explores how catalysis can reduce the entanglement cost of preparing many copies of a quantum state, extending previous work from single-copy to many-copy scenarios.


<details>
  <summary>Details</summary>
Motivation: Exploring the effect of catalysis on entanglement cost in the preparation of multiple copies of quantum states, in a regime that has been less thoroughly studied.

Method: The authors develop a specific catalytic protocol that demonstrates how catalysis can lower the exact entanglement cost of preparing asymptotically many copies of a quantum state.

Result: Catalysis can significantly reduce the entanglement cost for preparing a state as copies increase, with the findings applicable to other resource theories beyond entanglement.

Conclusion: A general catalytic advantage is established in resource dilution tasks, illustrating the broader implications of catalytic processes in quantum resource theory.
...
### [44] [Real-time Surface-Code Error Correction Using an FPGA-based Neural-Network Decoder](https://arxiv.org/abs/2605.04892)
...
TL;DR: The paper presents a hardware-integrated architecture using an FPGA-based neural network for real-time quantum error correction (QEC) on a superconducting quantum processor, achieving low latency and robust performance.


<details>
  <summary>Details</summary>
Motivation: To enable fault-tolerant quantum computation, low error rates through effective quantum error correction (QEC) are essential, requiring high throughput and low latency in decoding processes.

Method: The study implements an FPGA-based neural-network decoder within a hardware control architecture for real-time surface-code QEC, demonstrating a closed-loop latency of 550 ns.

Result: The system enables real-time feedback corrections that match the performance of offline decoding while being robust against varying error conditions, including mid-circuit feedback in complex logical circuits.

Conclusion: This architecture provides a pathway for embedded QEC control, essential for scalable fault-tolerant quantum computing.
...
### [45] [Transit Noise in Spin Squeezing Experiments with Coated Rubidium Vapor Cell](https://arxiv.org/abs/2605.04914)
*Yujie Ji,Peiying Li,Yanhong Xiao,Yuzhuo Wang,Junlei Duan*

Main category: quant-ph

TL;DR: This paper investigates the impact of transit noise on spin squeezing in a rubidium vapor cell, demonstrating a correlation between probe beam size and noise levels.


<details>
  <summary>Details</summary>
Motivation: To improve measurement sensitivity beyond the standard quantum limit by addressing transit noise in optical probe interactions.

Method: The study combines theoretical analysis and experimental measurements, varying the probe beam diameter to assess its effects on transit noise and spin squeezing.

Result: A quantifiable increase in transit noise with decreasing probe beam area was found, with an experimental difference in spin squeezing performances (2.7  b0.2 dB) aligning closely with theoretical predictions (3.0  b0.3 dB).

Conclusion: Optimizing probe beam parameters is essential for minimizing transit noise and enhancing spin squeezing in experiments.
...
### [46] [Optimal Error Exponents for Composite Sequential Quantum Hypothesis Testing](https://arxiv.org/abs/2605.04915)
*Jacob Paul Simpson,Efstratios Palias,Sharu Theresa Jose*

Main category: quant-ph

TL;DR: The paper addresses composite sequential quantum hypothesis testing, proposing an adaptive mixture-sequential quantum probability ratio test that optimally distinguishes a null state from a set of alternatives while maintaining specified error rates.


<details>
  <summary>Details</summary>
Motivation: The goal is to improve the efficiency of distinguishing between a null quantum state and a set of alternative states in a quantum hypothesis testing framework.

Method: An adaptive mixture-sequential quantum probability ratio test is proposed, which chooses measurements dynamically based on current estimates of the alternatives and stops at the first significant threshold in the log-likelihood ratio.

Result: The proposed method achieves optimal Type-I and Type-II error exponents, characterized by minimal relative entropies, and establishes a converse for the error exponent region.

Conclusion: Achieving low error probabilities in composite SQHT necessitates an expected sample complexity comparable to that needed for sequential testing between two fixed quantum states.
...
### [47] [Quantum Realizability of Probabilistic Theories Stable under Teleportation](https://arxiv.org/abs/2605.04931)
*Miguel A. A. Lisboa*

Main category: quant-ph

TL;DR: This paper determines which families of general probabilistic theories (GPTs) are realizable in standard quantum mechanics, concluding that only two of seven families are realizable.


<details>
  <summary>Details</summary>
Motivation: To identify GPT families that can be implemented within standard quantum mechanics, following previous work highlighting seven theoretical families.

Method: The authors employ elementary representation theory to analyze the realization of these families within quantum mechanics.

Result: Only two families of GPTs are found to be quantum-realizable: $χ^{K_4}_{1234}$ and $χ^{D_4}_{125}$; the other five do not have quantum realizations.

Conclusion: The paper successfully resolves the open question regarding quantum realizability of the studied families in GPTs.
...
### [48] [Beyond Gates: Pulse Level Quantum Fourier Models](https://arxiv.org/abs/2605.04945)
*Melvin Strobl,Maja Franz,Lukas Scheller,Eileen Kuehn,Wolfgang Mauerer,Achim Streit*

Main category: quant-ph

TL;DR: This paper evaluates quantum Fourier models (QFMs) in the context of pulse-level quantum computing, revealing how pulse parameters impact local optimization despite having minimal effects on global expressibility.


<details>
  <summary>Details</summary>
Motivation: To explore the effect of pulse-level parameters on the performance and optimization landscape of quantum Fourier models (QFMs) in quantum machine learning (QML).

Method: The study links metrics like expressibility and Fourier coefficient correlation (FCC) to the pulse parameters, demonstrating how independent pulse scaling affects local optimization. An analytical proof supports the findings, complemented by numerical validations using a QFM with a ternary feature map.

Result: Control over pulse shapes does not alter global expressibility but significantly changes the local optimization landscape, improving training performance through independent parameter tuning.

Conclusion: The findings indicate that using pulse-level controls can enhance the efficiency of training QFMs by offering more flexible optimization pathways.
...
### [49] [Scalar and Vector Airborne Platform Calibration Using Quantum and Classical Magnetometers and Inertial Sensors](https://arxiv.org/abs/2605.04951)
*Antonia Hager,Torleiv H. Bryne,Mia Jukić*

Main category: quant-ph

TL;DR: This paper discusses the limitations of current airborne magnetometry calibration methods and introduces the advantages and challenges of using Diamond Nitrogen-Vacancy vector magnetometers compared to traditional configurations.


<details>
  <summary>Details</summary>
Motivation: To improve the accuracy of airborne magnetometry through better calibration methods that can effectively isolate geomagnetic signals from sensor errors and platform magnetic fields.

Method: The authors performed a theoretical analysis and evaluated various sensor configurations, including the integration of onboard Inertial Navigation Systems, to assess their impact on magnetic calibration accuracy.

Result: The study found that while Diamond NV vector magnetometers can enhance sensor capabilities, they cannot fully address the attitude-related challenges in airborne magnetic calibration.

Conclusion: Although NV sensors are beneficial for certain calibration aspects, they cannot independently resolve the issues caused by attitude errors, indicating a need for improved calibration strategies.
...
### [50] [Exact SU(2) Yang-Mills Waves from a Simple Ansatz](https://arxiv.org/abs/2605.04964)
*Yu-Xuan Zhang,Jing-Ling Chen*

Main category: quant-ph

TL;DR: The paper introduces an ansatz for exact wave solutions of the sourceless SU(2) Yang-Mills equations in (3+1) dimensions, yielding three families of waves with distinct characteristics.


<details>
  <summary>Details</summary>
Motivation: To explore exact wave solutions in the context of non-Abelian Yang-Mills equations and understand the implications of non-Abelian self-interactions on wave propagation.

Method: An ansatz using a $y$-dependent rotated Pauli basis and a phase dependence for gauge potentials reduces the nonlinear field equations to nine algebraic constraints.

Result: Three families of exact waves are identified: Family I (linear waves with a dispersion relation), Family II (nonlinear self-interacting waves with a constant field offset), and Family III (pure gauge solutions with vanishing field strengths).

Conclusion: The solutions shed light on the alterations in wave propagation due to non-Abelian self-interactions in gauge theories.
...
### [51] [Exact identification of unknown unitary processes](https://arxiv.org/abs/2605.04981)
*Santiago Llorens,Arnau Diebra,Michal Sedlák,Ramon Muñoz-Tapia*

Main category: quant-ph

TL;DR: This paper focuses on accurately identifying faulty hardware in quantum information processing using representation-theoretic tools and zero-error protocols.


<details>
  <summary>Details</summary>
Motivation: The motivation is to ensure reliable quantum information processing by identifying malfunctioning quantum devices.

Method: The authors model the hypothesis of faulty operations using representation theory and analyze a zero-error identification protocol, deriving optimal success probabilities in various anomaly scenarios.

Result: They show that the optimal success probability for identifying faulty devices is independent of the total number of devices and propose a protocol using ancillary systems that tests each device independently.

Conclusion: The analysis is extended to cases with arbitrary anomalies and system dimensions, with a conjecture on the protocol's global optimality in these general scenarios.
...
### [52] [Scalable Quantum Reservoir Computing over Distributed Quantum Architectures](https://arxiv.org/abs/2605.04991)
...
TL;DR: This paper presents quantum reservoir computing for time-series forecasting, demonstrating improvements in accuracy while leveraging multiple architectures and resources.


<details>
  <summary>Details</summary>
Motivation: To enhance time-series forecasting by utilizing quantum computing's rich feature representations and addressing limitations of traditional reservoir computing.

Method: The study analyzes four architectures of quantum reservoir computing, incorporating various configurations of reservoirs and readout layers, and assesses their performance through ideal and noisy simulations.

Result: Quantum-enhanced configurations show significant improvements in accuracy, achieving reductions in MAE by up to 78.8% and RMSE by 72.3%, compared to classical reservoirs.

Conclusion: Distributed quantum reservoir computing emerges as a viable, scalable method for time-series forecasting in the NISQ era.
...
### [53] [Dephasing Effects on the Dynamical Evolution of Quantum Correlations and Coherence in Neutrino Oscillations](https://arxiv.org/abs/2605.05015)
*Omar Bachain,Elhabib Jaloum,Mohamed Amazioug,Nazek Alessa,Wedad R. Alharbi,Rachid Ahl Laamara,Abdel-Haleem Abdel-Aty*

Main category: quant-ph

TL;DR: This paper examines the dynamics of quantum resources in neutrino oscillations, focusing on how environmental decoherence affects different quantum features such as steering, negativity, and coherence.


<details>
  <summary>Details</summary>
Motivation: To investigate the dynamics of quantum resources in neutrino oscillation systems and understand the effects of decoherence on these resources.

Method: The study models neutrino oscillations as an effective two-level quantum system and analyzes the influence of amplitude damping, phase flip, and phase damping channels in both Markovian and non-Markovian regimes.

Result: The analysis reveals a hierarchy in robustness, with steering being the most sensitive, logarithmic negativity intermediate, and coherence the most resilient to decoherence.

Conclusion: The findings enhance understanding of quantum resource dynamics in neutrino oscillation systems and the complexities introduced by decoherence.
...
### [54] [Polarization-Controlled Photon Mode Switching and Photon--Magnon Coupling in a Planar Cavity--Magnonic System](https://arxiv.org/abs/2605.05018)
*Abhishek Maurya,Sachin Verma,Bojong Kim,Biswanath Bhoi,Rajeev Singh,Sang-Koog Kim*

Main category: quant-ph

TL;DR: The paper discusses polarization-selective photon-magnon coupling in a cavity-magnonic setup, revealing tunable interactions through resonator orientation.


<details>
  <summary>Details</summary>
Motivation: To explore controllable interactions between photons and magnons in a planar cavity system, focusing on polarization selectivity.

Method: An electric-LC resonator is coupled to a microstrip line with a YIG thin film; the system is modeled by circuit elements and a Hamiltonian for coupled modes.

Result: Strong angular tunability of PMC is demonstrated, with specific values reported for coupling strengths across different angles, e.g., $g_{31}$ varying from $56.5$ to $98$ MHz.

Conclusion: The findings highlight the impact of resonator orientation on photon-magnon interactions, establishing a versatile mechanism for polarization selectivity in planar configurations.
...
### [55] [Network-Mediated Capacitive Coupling Drives Fast OTOC Saturation in Superconducting Circuits](https://arxiv.org/abs/2605.05035)
*Carla Caro Villanova,Alan C. Santos*

Main category: quant-ph

TL;DR: This paper explores how capacitance-mediated interactions in superconducting transmon arrays deviate from standard nearest-neighbor models, affecting dynamical behavior and spectral properties.


<details>
  <summary>Details</summary>
Motivation: To understand the effects of network-mediated couplings in superconducting transmon arrays beyond traditional models, especially in the context of information dynamics and scalability.

Method: The authors employ Out-of-Time-Ordered Correlators (OTOCs) to examine dynamical observables and spectral statistics in transmon arrays with varying degrees of capacitive connectivity.

Result: The study finds that increased capacitive connectivity enhances operator scrambling and shifts spectral statistics away from Poissonian towards level repulsion, indicating partial ergodicity.

Conclusion: The results suggest that network-mediated interactions can significantly influence information dynamics, which is crucial for the scalability of superconducting quantum architectures.
...
### [56] [Block Permutation Routing on Ramanujan Hypergraphs for Fault-Tolerant Quantum Computing](https://arxiv.org/abs/2605.05036)
*Joshua M. Courtney*

Main category: quant-ph

TL;DR: This study examines the permutation routing of rigid blocks in surface codes on a reconfigurable lattice, demonstrating that the block routing number scales as Θ(d_C log N_L) with implications for quantum fault tolerance and error correction.


<details>
  <summary>Details</summary>
Motivation: To enhance the efficiency of routing in quantum computing architectures that use surface codes, particularly in ensuring low overhead during syndrome extraction and integration with lattice surgery protocols.

Method: Analysis of permutation routing using hypergraph transformations, spectral analysis of quotient graphs, and incorporation of error models and syndrome extraction techniques, including a correlated-decoding scheme.

Result: The block routing number is established as rt_B(H, s, g) = Θ(d_C log N_L) with a lower bound rt_B = Ω(d_C log N_L). The study also presents reductions in syndrome-extraction overhead.

Conclusion: The proposed methods and analyses effectively optimize routing within quantum circuits, achieving significant improvements in depth and overhead, applicable to various trapped-ion architecture scenarios.
...
### [57] [Dimeric Perylene-Bisimide Organic Molecules: Fractional-Time Control of Quantum Resources](https://arxiv.org/abs/2605.05109)
*Abdessamie Chhieb,Chaimae Banouni,Sliha Abdessamie*

Main category: quant-ph

TL;DR: This study investigates quantum correlations like coherence, entanglement, and nonlocality in molecular systems using fractional dynamics.


<details>
  <summary>Details</summary>
Motivation: Understanding quantum correlations in molecular systems is crucial for advancements in quantum technology.

Method: The study employs the time-fractional Schrödinger equation with Caputo fractional derivatives to analyze systems with varying parameters like fractional order, transition energies, interaction strength, and purity.

Result: The analysis reveals that the fractional order influences system dynamics, including memory effects and relaxation, impacting coherence, entanglement, and nonlocality.

Conclusion: The findings integrate fractional calculus with quantum information, offering new methodologies for controlling and utilizing molecular quantum correlations.
...
### [58] [A Factor-Graph Formulation of CSS Syndrome Decoding: Joint BP and Four-State BP](https://arxiv.org/abs/2605.05132)
*Kenta Kasai*

Main category: quant-ph

TL;DR: This paper introduces a joint belief propagation method for CSS syndrome decoding, comparing it to the traditional four-state approach.


<details>
  <summary>Details</summary>
Motivation: To improve CSS syndrome decoding, leveraging the inherent correlations in Pauli error components is crucial.

Method: The study employs a binary factor graph with joint prior constraints, applying the sum-product algorithm termed joint BP, and evaluates it against the four-state Pauli-label factor graph.

Result: Both joint BP and four-state BP yield identical posterior weights, messages, and beliefs after necessary adjustments to local states and marginalization.

Conclusion: The joint belief propagation method effectively retains local channel correlations and matches the performance of the traditional four-state method.
...
### [59] [The Saturable Electronic Reluctance Switch: Switchable low-power and low-noise generation of magnetic fields using permanent magnets](https://arxiv.org/abs/2605.05158)
*P. D. Taylor-Burdett,C. A. Burhan,S. Mason,F. R. Lebrun-Gallagher,S. Weidt,W. K. Hensinger*

Main category: quant-ph

TL;DR: The paper presents the Saturable Electronic Reluctance Switch (SERS), a hybrid technique for generating ultra-stable, switchable magnetic fields with reduced power dissipation and noise.


<details>
  <summary>Details</summary>
Motivation: There is a scientific need for magnetic fields that are both ultra-stable and easily switchable, as existing methods like permanent magnets or electromagnets have significant limitations.

Method: The SERS circuit utilizes a non-linear ferromagnetic approach for bi-stable switching, activating with a threshold current that minimally affects the magnetic output.

Result: The SERS significantly reduces power dissipation by an order of magnitude compared to traditional methods and decreases current-induced magnetic noise by up to five orders of magnitude.

Conclusion: SERS shows great promise for applications such as ultra-stable magnetic field generation in quantum computing, combining efficiency and stability.
...
### [60] [Entanglement-Rank Duality in Quadratic Phase Quantum States](https://arxiv.org/abs/2605.05167)
*Zakaria Dahbi,Amelle Zair*

Main category: quant-ph

TL;DR: The paper addresses the construction of Absolutely Maximally Entangled (AME) states, establishing a link between entanglement and finite-field rank structures in quadratic-phase quantum states.


<details>
  <summary>Details</summary>
Motivation: The construction of AME states is a challenging problem in quantum information processing, and a systematic approach is needed.

Method: The authors introduce a finite-field rank structure related to multipartite entanglement and prove a Rank-Purity Duality linking the Rényi-2 purity of subsystems to the rank of a phase matrix. They also apply the Chinese Remainder Theorem to factorize entanglement structures based on local dimensions.

Result: Establishing that the existence of an AME state can be reduced to a rank condition on the phase matrix and providing a framework for the additive decomposition of Rényi-2 entropies.

Conclusion: The findings offer an algebraic characterization of entanglement, facilitating the systematic construction of highly entangled states.
...
### [61] [Plasma effects on lifetimes and screening of Rydberg excitons](https://arxiv.org/abs/2605.05171)
*AbdAlGhaffar Amer,V. Walther,Francis Robicheaux*

Main category: quant-ph

TL;DR: The study analyzes the impact of a neutral electron-hole plasma on Rydberg excitons in Cu$_2$O, challenging the assumptions of Debye screening and examining thermalization effects through simulations.


<details>
  <summary>Details</summary>
Motivation: Understanding the limitations of Debye screening in the context of Rydberg excitons is crucial for interpreting experimental results and guiding future research in Cu$_2$O.

Method: A combination of a classical orbit model and harmonic-oscillator representation via truncated Wigner approximation was used to investigate exciton lifetimes and screening effects under plasma conditions.

Result: Plasma-induced scattering leads to finite exciton lifetimes that scale with plasma density, principal quantum number $n$, and temperature, explaining deviations from expected $n^3$ behavior at high $n$.

Conclusion: Debye screening significantly overestimates the internal field screening of excitons, particularly for high angular momentum states, and exciton-exciton interactions are not screened at separations around the Debye length.
...
### [62] [Release-free electro-optomechanical crystal modulator](https://arxiv.org/abs/2605.05190)
*Paul Burger,Joey Frey,Johan Kolvik,Mads B. Kristensen,Raphaël van Laer*

Main category: quant-ph

TL;DR: This study presents a release-free electro-optomechanical transducer that combines strong optomechanical interactions with piezoelectric materials for efficient microwave-optical transduction, addressing thermal noise limitations.


<details>
  <summary>Details</summary>
Motivation: To improve the performance of electro-optic modulators in quantum technologies and optical communications by integrating release-free optomechanical crystals with superconducting qubits.

Method: The researchers employed micro-transfer printing to integrate silicon-based optomechanical interactions with lithium niobate piezoelectricity, resulting in a release-free transducer.

Result: The device demonstrated strong electro- and optomechanical coupling rates suitable for quantum-level operations when integrated with a superconducting microwave circuit.

Conclusion: The development marks a significant step toward practical microwave-optical interfaces using release-free electro-optomechanical devices.
...
### [63] [Observation of the charmless purely baryonic decay $\mathinner{\mathitΛ^0_b\!\to \mathitΛ p \overline{p}}$](https://arxiv.org/abs/2605.04348)
...
TL;DR: This paper reports the observation of the charmless baryonic decay of Λ⁰_b to Λ p p̄ with a significance of 5.1σ, providing the first measurement of its branching fraction.


<details>
  <summary>Details</summary>
Motivation: To search for and measure the branching fraction of the charmless decay Λ⁰_b to Λ p p̄, contributing to the understanding of baryonic decays in particle physics.

Method: Data was collected from proton-proton collisions at LHCb at 13 TeV, with a focus on isolating the decay from contributions of intermediate charmonium resonances by applying an invariant mass requirement on the final state particles.

Result: The absolute branching fraction of the decay Λ⁰_b to Λ p p̄ was measured relative to the similar decay Λ⁰_b to Λ K⁺ K⁻, yielding a ratio of approximately (5.1 ± 1.3 (stat) ± 0.3 (syst)) × 10⁻².

Conclusion: This research has established the first measurement of the branching fraction for the decay Λ⁰_b to Λ p p̄, offering important insights into charmless baryonic decays.
...
### [64] [Measurement of the double Dalitz decay $η\to e^+e^-e^+e^-$](https://arxiv.org/abs/2605.04898)
...
TL;DR: The paper reports the measurement of the branching fraction for the rare decay process $ηightarrow e^+e^-e^+e^-$ using data from $J/ψ$ decay events. Two channels yield significant signals, allowing for precise determination of the branching fraction.


<details>
  <summary>Details</summary>
Motivation: To investigate rare decay processes and provide constraints for physics beyond the standard model.

Method: Analyzed a data sample of approximately 10 billion $J/ψ$ events using the BESIII detector, focusing on the double Dalitz decay of $η$ via specific decay modes of $J/ψ$.

Result: Identified clear $η$ signals in the invariant mass spectrum with statistical significances of 5.9$σ$ and 7.8$σ$, leading to a combined branching fraction determination of $(2.63~	imes~10^{-5})$ with specified uncertainties.

Conclusion: The findings are consistent with previous measurements and offer additional insights into physics beyond the standard model.
...
### [65] [Geant4 Optical Simulation without C++](https://arxiv.org/abs/2605.04907)
*Ariestotle Raj Maharjan,Jianchen Li,Jing Liu*

Main category: hep-ex

TL;DR: Geant4's plain text geometry description now supports optical properties, enhancing simulation ease and efficiency.


<details>
  <summary>Details</summary>
Motivation: To simplify the optical simulation setup process and reduce reliance on C++ coding.

Method: Implemented new ':prop' and ':surf' tags for optical properties and demonstrated their application on key optical processes.

Result: Validated through examples like Cherenkov radiation, scintillation, Rayleigh scattering, and absorption, with detailed complex boundary configuration.

Conclusion: The extension facilitates rapid prototyping and enhances simulation capabilities for users.
...
### [66] [Recent Advances in Tabletop Kibble Balance -- KBmini](https://arxiv.org/abs/2605.04090)
*Nanjia Li,Weibo Liu,Kang Ma,Elsayed E. E. Qupasie,Wei Zhao,Songling Huang,Shisong Li*

Main category: physics.ins-det

TL;DR: This paper details advancements in the KBmini Kibble balance for high-accuracy mass calibration, focusing on magnet positioning and enhanced coil design for improved voltage outputs.


<details>
  <summary>Details</summary>
Motivation: To improve the precision of mass calibration systems, particularly for weights up to 1 kg.

Method: The research involves setting the magnet at various heights to identify the optimal weighing position and measuring the spring constant of the weighing cell. It employs a new coil design with more turns and utilizes a multi-harmonic excitation technique to create a consistent velocity profile.

Result: A stable velocity profile was realized over a 180 μm range, generating a flat-top induced voltage region exceeding 1 V.

Conclusion: These developments provide a strong foundation for future mass calibration experiments.
...
### [67] [Comprehensive Design Validation of serially powered CMS Phase-2 Pixel Modules](https://arxiv.org/abs/2605.04095)
*Giorgia Bonomelli*

Main category: physics.ins-det

TL;DR: The CMS Tracker detector is being upgraded for the HL-LHC with enhanced QC testing for pixel modules to ensure performance under new conditions.


<details>
  <summary>Details</summary>
Motivation: To prepare for the harsh radiation environment and increased data rate at HL-LHC, an upgrade to the CMS Tracker is necessary.

Method: Developed a QC test flow for evaluating pixel module prototypes, including thermal stress tests and design adjustments, particularly focusing on the HDI.

Result: Qualified pixel module components met upgrade specifications on power and leakage; stress tests confirmed robust module design under temperature variations.

Conclusion: The tests ensure the reliability and durability of pixel modules critical to the CMS Phase-2 detector upgrade.
...
### [68] [Stability of Charge Collection Efficiency in a Novel Graphene-Optimized Silicon Carbide Detector Under 160 keV X-Ray Irradiation](https://arxiv.org/abs/2605.04597)
*Yingjie Huang,Congcong Wang,Jingxuan He,Yi Zhan,Zhenyu Jiang,Xiyuan Zhang,Xin Shi*

Main category: physics.ins-det

TL;DR: A graphene-optimized silicon carbide PIN detector shows stable electrical properties and charge collection performance under X-ray irradiation up to 1 MGy, with minor degradation attributed to ionization effects.


<details>
  <summary>Details</summary>
Motivation: To explore the performance stability of a graphene-optimized silicon carbide PIN detector under high radiation doses, assessing its suitability for radiation-sensitive applications.

Method: Evaluated electrical properties, charge collection performance, and signal rise time of the detector under non-irradiated and X-ray irradiation conditions (160 keV, 0.1 MGy & 1 MGy).

Result: Leakage currents were stable; minor rise time increases and high charge collection efficiencies were observed, indicating robust performance under irradiation.

Conclusion: The detector demonstrates excellent charge collection efficiency and stability under extreme conditions, making it suitable for high-energy physics and radiation monitoring applications.
...
### [69] [Study of Particle Fluence Effects on Collected Charge and Depletion Voltage of the ATLAS IBL Planar Pixel Sensors](https://arxiv.org/abs/2605.05030)
*ATLAS Collaboration*

Main category: physics.ins-det

TL;DR: The ATLAS Pixel detector's planar pixel sensors at the LHC have experienced significant radiation damage over ten years, impacting their performance metrics.


<details>
  <summary>Details</summary>
Motivation: To understand the effects of radiation on the performance of ATLAS Pixel detector sensors after extensive operation at the LHC.

Method: Analysis of pixel cluster charge and bulk depletion through bias voltage scans, supplemented by TCAD modeling and Monte Carlo simulations.

Result: The study reveals increased leakage current, reduced charge collection efficiency, and elevated depletion voltage correlating with particle fluence.

Conclusion: The findings provide insights into the deterioration of sensor performance due to radiation over the operational period.
...
### [70] [First Detection of Extensive Air Showers Using a Small-Aperture Fluorescence Telescope](https://arxiv.org/abs/2605.05004)
*M. Zotov,A. Trusov,P. Klimov,K. Asatryan,A. Belov,G. Gabaryan,V. Kudryavtsev,A. Murashov*

Main category: astro-ph.IM

TL;DR: Successful detection of extensive air showers from cosmic rays using a small-aperture fluorescence telescope is reported, with event selection through conventional and deep learning methods.


<details>
  <summary>Details</summary>
Motivation: To demonstrate the potential of compact fluorescence telescopes for detecting extensive air showers generated by ultra-high-energy cosmic rays.

Method: Utilized a 25 cm diameter Fresnel lens and implemented two event selection pipelines: a cut-based analysis and a neural network approach.

Result: Identified over 15 high-confidence EAS tracks during optimal observational conditions using both algorithms.

Conclusion: The study confirms the feasibility of fluorescence detection techniques, paving the way for future applications in ground-based and space missions.
...
### [71] [CP asymmetries in charged meson decay to two pions](https://arxiv.org/abs/2605.04137)
*Yuval Grossman,Zoltan Ligeti,Yosef Nir*

Main category: hep-ph

TL;DR: The paper investigates CP asymmetries in $B^+$, $D^+$, and $K^+$ decays to $π^+π^0$, providing a unified framework and estimating asymmetry sizes in the Standard Model.


<details>
  <summary>Details</summary>
Motivation: To clarify the concept of the 'isospin limit' and analyze CP asymmetries in specific particle decays.

Method: A unified formalism is developed to analyze the CP asymmetries and to identify suppression factors affecting them.

Result: Asymmetries are estimated: $A_{CP}(B^+	o π^+π^0) 	ext{ is approximately } 3 	imes 10^{-3}$, $A_{CP}(D^+	o π^+π^0) 	ext{ is } 10^{-5}$, and $A_{CP}(K^+	o π^+π^0) 	ext{ is } 10^{-6}$.

Conclusion: The findings enhance the understanding of CP violation in these decays and highlight differences attributable to suppression factors.
...
### [72] [Composite top partners in exotic colour representations](https://arxiv.org/abs/2605.04143)
*Giacomo Cacciapaglia,Rosy Caliri,Aldo Deandrea,Benjamin Fuks,Mark Goodsell,Jan Hadlik,Manuel Kunkel,Werner Porod*

Main category: hep-ph

TL;DR: The paper investigates coloured fermionic colour sextets in composite Higgs models with partial compositeness, focusing on their decay patterns and constraints from LHC data.


<details>
  <summary>Details</summary>
Motivation: To explore the largely unexplored coloured fermionic sextets that arise in certain composite Higgs models due to strong dynamics.

Method: The authors systematically study colour sextets, derive low-energy interactions, and analyze their decay patterns with emphasis on decay via pseudo-Nambu-Goldstone bosons and reinterpret existing LHC search results.

Result: Current LHC data exclude single colour sextet masses up to 2-2.5 TeV; future HL-LHC could reach nearly 3 TeV.

Conclusion: Colour-sextet fermions are a significant yet underexplored aspect of probing composite Higgs models with partial compositeness.
...
### [73] [Proton-Proton to Antinucleon Cross Sections for Cosmic Ray Applications](https://arxiv.org/abs/2605.04150)
*Mariaelena Boglione,Mattia di Mauro,Fiorenza Donato,Emanuele R. Nocera,Jennifer Rittenhouse West,Andrea Signori*

Main category: hep-ph

TL;DR: Predictions for antiproton and antineutron production cross sections in proton-proton collisions show discrepancies with NA49 findings, suggesting a slight excess of antineutrons in cosmic ray interactions.


<details>
  <summary>Details</summary>
Motivation: To understand antiproton and antineutron production in cosmic ray collisions and assess the implications for cosmic ray physics.

Method: Utilized collinear factorisation in Quantum Chromodynamics, calculating cross sections to next-to-leading order, and compared results with data from collider experiments.

Result: Findings do not support the NA49 observation of antineutron excess and indicate a mild excess instead, with identified uncertainties in parton distribution and fragmentation functions.

Conclusion: The NA49 results may only align with this study's framework under the assumption of significant variations in production mechanisms at low transverse momenta.
...
### [74] [Pressure-Energy Equations of State of the Nucleon](https://arxiv.org/abs/2605.04163)
*Keh-Fei Liu*

Main category: hep-ph

TL;DR: The paper derives pressure-energy equations of state in nucleons from gravitational form factors, emphasizing two pressure components: static and dynamic. The study connects these concepts to QCD confinement, type-II superconductors, and cosmological models.


<details>
  <summary>Details</summary>
Motivation: To understand the pressure-energy dynamics in nucleons and their implications in QCD confinement and other physical systems.

Method: Derivation from gravitational form factors and energy-momentum tensor conservation, analyzing contributions from static and dynamic pressures.

Result: Two pressure components are identified: a static pressure linked to gluon and quark condensate depletion and a dynamic pressure from the traceless stress tensor, both balancing total pressure.

Conclusion: The pressure-energy relations derived for nucleons are analogous to those in type-II superconductors and cosmology, highlighting deeper connections across different physical systems.
...
### [75] [Long Inflation Screens Euclidean-Wormhole Initial States](https://arxiv.org/abs/2605.04166)
*Imtiaz Khan,Pirzada,G. Mustafa,Farruh Atamurotov,Chengxun Yuan*

Main category: hep-ph

TL;DR: Euclidean wormholes influence inflation in non-standard initial states, but prolonged expansion limits observable effects in the CMB. This study formulates a visibility restriction on perturbations that depends on inflation duration.


<details>
  <summary>Details</summary>
Motivation: To understand how Euclidean wormholes influence inflation in different initial conditions and its observable consequences in the cosmic microwave background (CMB).

Method: The study derives visibility bounds for Euclidean-matched Bogoliubov data, focusing on the excitation parameter and how perturbations behave under prolonged inflation.

Result: The findings indicate that only near-minimal inflation or specific comoving edges can produce detectable signatures, while longer inflation aligns with Bunch-Davies predictions, diminishing observable effects.

Conclusion: Euclidean memory serves as a quantitative limit on the duration of inflation; longer inflation reduces observable wormhole effects in CMB polarization and large-scale structures.
...
### [76] [Indications for New Higgs Bosons](https://arxiv.org/abs/2605.04233)
*Andreas Crivellin,Saiyad Ashanujjaman,Sumit Banik,Siddharth P. Maharathy,Guglielmo Coloretti*

Main category: hep-ph

TL;DR: The paper explores potential new Higgs bosons at approximately 95 GeV and 152 GeV, analyzing their characteristics and implications for theories beyond the Standard Model.


<details>
  <summary>Details</summary>
Motivation: The discovery of the Higgs particle raises questions about the existence of other particles beyond the Standard Model, especially in the scalar sector, which may help address fundamental issues and explain phenomena like Dark Matter and neutrino masses.

Method: The authors review evidence for new Higgs bosons at the electroweak scale, focusing on their production mechanisms, particularly the di-photon channel and other decay modes, as well as potential connections to top-quark distribution anomalies.

Result: Indications exist for new scalar states around 95 GeV and 152 GeV, with the latter associated with leptons and missing energy, suggesting a link to an $SU(2)_L$ triplet model that replicates certain Standard Model t	o H^  b decays.

Conclusion: The paper suggests that discrepancies between Standard Model predictions and measurements of top-quark distributions may hint at new physics involving these scalar states.
...
### [77] [Emergence of conformal properties in Finite Grand Unified Theories via reduction of couplings](https://arxiv.org/abs/2605.04378)
*Luis Enrique Reyes Rodríguez,Myriam Mondragón*

Main category: hep-ph

TL;DR: Zimmermann's RoC method addresses parameter excess in field theory, aiding in the construction of predictive, UV-divergence-free supersymmetric GUT models through scale invariance and soft-coupling relations.


<details>
  <summary>Details</summary>
Motivation: To tackle the problem of excess parameters in field theories and develop effective supersymmetric GUT models.

Method: Utilizing the Reduction of Couplings (RoC) method to derive relations among couplings within a scale-invariant framework, ensuring all-loop finiteness and anomaly mediation.

Result: Derivation of scale-invariant relations between soft couplings and dimensionless parameters, including a notable sum rule for scalar masses that avoids tachyonic spectra, resembling AMSB relations.

Conclusion: A connection is established between parameter reduction in the soft-breaking sector and anomaly-mediated patterns, highlighting the necessity of a specific Kähler potential form akin to that in no-scale supergravity.
...
### [78] [Production of $D_s\bar{D}_s$ and $D\bar{D}$ bound states in the $B$ decays within the Bethe-Salpeter framework](https://arxiv.org/abs/2605.04383)
*Zhen-Yang Wang,Jing-Juan Qi,Zhen-Hua Zhang,Xin-Heng Guo*

Main category: hep-ph

TL;DR: This study explores the production of $D_sar{D}_s$ and $Dar{D}$ bound states in $B$ decays using the Bethe--Salpeter framework, revealing varying existence and properties of bound state solutions based on coupling parameters.


<details>
  <summary>Details</summary>
Motivation: To analyze the production of heavy meson bound states in $B$ decays and their significance in particle physics using the Bethe-Salpeter framework and the one-boson-exchange model.

Method: The study employs the Bethe--Salpeter framework and one-boson-exchange model to describe the bound state properties, calculating normalized wave functions to estimate branching fractions for $B^+	o X_{sar s}K^+$ and $B^+	o X_{qar q}K^+$.

Result: Bound state solutions for the $Dar{D}$ system are found for all coupling sets, while the $D_sar{D}_s$ system allows solutions only in a limited parameter space. The branching fractions vary significantly, ranging from $1.09 	imes 10^{-5}$ to $20.06 	imes 10^{-4}$ for $D_sar{D}_s$ and $1.56 	imes 10^{-6}$ to $4.14 	imes 10^{-4}$ for $Dar{D}$.

Conclusion: The findings indicate the potential identification of $X(3915)$ as a predominantly $D_sar{D}_s$ bound state, implying important implications for heavy meson production in $B$ decays.
...
### [79] [Landscape of Spontaneous CP Violation](https://arxiv.org/abs/2605.04387)
*Yuichiro Nakai*

Main category: hep-ph

TL;DR: The paper discusses Spontaneous CP violation (SCPV) in a supersymmetric context, addressing its implications for the strong CP problem, baryon asymmetry, and light particles couplings with the Standard Model.


<details>
  <summary>Details</summary>
Motivation: The motivation lies in providing a solution to the strong CP problem through SCPV, which simultaneously explains the small QCD $θ$-angle and the CKM phase.

Method: The authors review SCPV in a supersymmetric framework, stabilizing it through supersymmetry-breaking and non-perturbative dynamics, while addressing issues like higher-dimensional operators and radiative corrections.

Result: SCPV is shown to be realizable along flat directions, predicting light SCPV sector particles coupled weakly to the Standard Model and generating baryon asymmetry through the Affleck-Dine mechanism.

Conclusion: The framework predicts a nonzero neutron electric dipole moment, which is expected to be detectable by upcoming experiments.
...
### [80] [Fundamental or Composite? The Higgs Enigma](https://arxiv.org/abs/2605.04800)
*Alon E. Faraggi*

Main category: hep-ph

TL;DR: The Higgs boson discovery marks a significant milestone in particle physics, linking to theoretical frameworks like String Phenomenology and potentially revealing whether the Higgs is fundamental or composite. Advancements in technology could enable future investigations at higher energy scales.


<details>
  <summary>Details</summary>
Motivation: To understand the fundamental nature of the Higgs boson and its implications for the Standard Model and theories of quantum gravity.

Method: Exploration of fermionic Z2xZ2 orbifolds as model frameworks to connect Standard Model parameters to quantum gravity theories.

Result: The identification of the Higgs as a composite particle could challenge existing heterotic string models and necessitate exploring alternatives in quantum gravity.

Conclusion: A future hadron collider designed for 50-60 TeV could facilitate critical investigations into the nature of the Higgs boson.
...
### [81] [On the Consistency of Covariant Light-Speed Variation in Doubly Special Relativity](https://arxiv.org/abs/2605.04422)
*Hao Li,Jie Zhu*

Main category: hep-ph

TL;DR: Doubly special relativity (DSR) proposes an observer-independent energy scale and examines energy-dependent speed of light variations, leading to tensions in particle dynamics and relativistic principles.


<details>
  <summary>Details</summary>
Motivation: To explore the implications of observer-independent light-speed variation in the context of doubly special relativity and its effects on particle dynamics and relativistic covariance.

Method: A thought experiment involving an inertial box emitting two photons was conducted, distinguishing between two classes of light-speed variation scenarios and focusing on energy-dependent speed-energy relations in the DSR1 model.

Result: In the subluminal case, a critical rapidity is identified beyond which the box overtakes one of its emitted photons, creating tension in particle counting and motion across frames, which is unresolved by relative locality.

Conclusion: The findings highlight intrinsic conflicts among observer-independent light-speed variation, traditional relativistic covariance, and established principles of particle propagation within DSR frameworks.
...
### [82] [Gravitational Waves from Higgs Preheating after Inflaton $Z_2$-Symmetry Breaking](https://arxiv.org/abs/2605.04670)
*Hua Zhou,Qing Yu,Wei Cheng,Ruo-Peng Zhang*

Main category: hep-ph

TL;DR: The study employs lattice simulations to explore Higgs preheating and gravitational wave (GW) production after the inflaton's $Z_2$ symmetry breaking during inflation, revealing conditions for efficient preheating and the characteristics of generated GW spectra.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics of Higgs preheating following the symmetry breaking of the inflaton field and its implications for gravitational wave production.

Method: Nonperturbative lattice simulations to analyze inflaton-Higgs interactions characterized by various parameters, focusing on resonance conditions and backreaction effects.

Result: Efficient preheating requires a broad resonance band and specific parameter ranges (including $10<q_{φh}<10^4$, $q_h<10^3$, and $q_ε<10^{-5}$). The GW spectrum develops a broad peak with significant amplitude that redshifts by the present day.

Conclusion: High-frequency gravitational waves from Higgs preheating may be detectable by future resonant-cavity detectors, highlighting the relevance of this phenomenon in cosmological observations.
...
### [83] [New Predictions for the Lifetimes of Doubly Heavy Baryons and the $B_c$ Meson](https://arxiv.org/abs/2605.04967)
*Lovro Dulibić,Blaženka Melić,Ivan Nišandžić*

Main category: hep-ph

TL;DR: This paper updates predictions for the lifetimes of weakly decaying doubly heavy baryons and B_c mesons, incorporating NNLO and NLO corrections and comparing results across different mass schemes.


<details>
  <summary>Details</summary>
Motivation: To improve the accuracy of lifetime predictions for doubly heavy baryons and the B_c meson using enhanced theoretical frameworks.

Method: The analysis integrates higher-order corrections, including NNLO contributions and various NLO terms, while comparing results across multiple mass schemes (e.g., $ar{m MS}$, kinetic).

Result: Predictions are provided for the lifetimes of doubly heavy baryons, showing hierarchies dependent on the baryon structure and spin assignments, with specific lifetimes defined for several baryon states.

Conclusion: The study refines lifetime predictions for baryons and revisits the B_c meson's lifetime, emphasizing the importance of newly considered factors like the Darwin term.
...
### [84] [The $T_{bc}$ tetraquarks near the $B\bar{D}$ threshold](https://arxiv.org/abs/2605.05150)
*Halil Mutuk*

Main category: hep-ph

TL;DR: The study investigates doubly heavy tetraquarks $T_{bc}^{(0)}$ and $T_{bc}^{(1)}$ using the dynamical diquark model, finding specific mass ranges, hyperfine splittings, and implications for their decay and resonance behavior related to open-flavor thresholds.


<details>
  <summary>Details</summary>
Motivation: Understanding doubly heavy tetraquarks enhances insight into heavy quark dynamics and tetraquark states in quantum chromodynamics (QCD).

Method: The authors apply a dynamical diquark model and solve the radial Schrödinger equation utilizing the lattice-QCD Born–Oppenheimer potential to calculate mass, hyperfine splittings, and other properties of tetraquarks.

Result: Masses for $T_{bc}^{(0)}$ are estimated between 7.143-7.158 GeV and for $T_{bc}^{(1)}$ between 7.217-7.222 GeV, with a hyperfine splitting of 59-79 MeV, and a compact diquark–antidiquark interpretation supported by their radius measurements.

Conclusion: The scalar tetraquark is near the $Bar D$ threshold as a weakly decaying bound state or narrow resonance, while the axial-vector state is predicted to be an $S$-wave resonance near the $B^{*}ar D$ and $Bar D^{*}$ thresholds.
...
### [85] [On the spin dependence of the emergent gravity phenomena as observed in axially symmetric black hole accretion with spatially varying adiabatic index](https://arxiv.org/abs/2605.04156)
*Kalyanbrata Pal,Souvik Ghose,Ripon Sk,Arpan Krishna Mitra,Tapas K. Das*

Main category: astro-ph.HE

TL;DR: This paper studies axisymmetric accretion onto black holes using astrophysical models, dynamical systems, and emergent gravity frameworks, leading to multi-transonic solutions that include stationary shocks and characterize their stability and acoustic horizons.


<details>
  <summary>Details</summary>
Motivation: To explore the complex dynamics and stability of black hole accretion systems utilizing multiple theoretical frameworks.

Method: The authors formulate steady-state equations for multi-species flow in low angular momentum accretion under a pseudo-Kerr potential, analyzing transonic solutions and critical points through dynamical systems and linear stability methods.

Result: Findings indicate that the system supports multi-transonic solutions potentially containing stationary shocks, with confirmed stability under perturbations and identification of acoustic black holes and a white hole structure in the acoustic geometry.

Conclusion: The study successfully delineates the acoustic horizons' properties and stability, enhancing the understanding of black hole accretion dynamics in an emergent gravity context.
...
### [86] [Sensitivity of the As-Built Askaryan Radio Array to Ultra-High Energy Neutrinos](https://arxiv.org/abs/2605.04268)
...
TL;DR: The ARA is a leading UHE neutrino observatory which demonstrates enhanced sensitivity and contributes significant findings on neutrinos above $10^{19}$ eV.


<details>
  <summary>Details</summary>
Motivation: To assess the performance and achievements of the Askaryan Radio Array in detecting UHE neutrinos, utilizing improved simulation methods.

Method: Enhanced simulation pipeline including data-driven approaches for detector simulation and secondary particle production; evaluation of trigger-level acceptance and sensitivity over ten years of exposure.

Result: ARA shows world-leading sensitivity above $10^{19}$ eV and predicts up to 13 observable neutrinos, with secondary particles contributing significantly to acceptance.

Conclusion: The findings have implications for future UHE neutrino experiments, particularly informing the design of IceCube-Gen2 Radio.
...
### [87] [Multiwavelength Characterization of a New Magnetic Cataclysmic Variable 2CXO J050740.7-091337](https://arxiv.org/abs/2605.04179)
*Ilkham Galiullin,Vladislav Dodon,Antonio C. Rodriguez,Paula Szkody,Askar Sibgatullin*

Main category: astro-ph.HE

TL;DR: Discovery of a new cataclysmic variable 2CXO J050740.7-091337, characterized by strong magnetic fields and significant X-ray and optical variability.


<details>
  <summary>Details</summary>
Motivation: To identify and characterize new cataclysmic variables using X-ray and optical data, particularly focusing on faint, magnetic CVs.

Method: Cross-matching Chandra Source Catalogue with Gaia DR3; followed by optical spectroscopy and archival data analysis from Chandra and XMM-Newton.

Result: Identification of 2CXO J0507 with a magnetic field of approximately 30 MG, X-ray luminosity of (5.18 ± 0.88)×10^{30} erg s^{-1}, and an orbital period of 2.34 hr; exhibits long-term optical variability of about 2 mag.

Conclusion: 2CXO J0507 exemplifies a faint, magnetic CV, reinforcing the expectation of discovering similar objects through upcoming surveys like the Rubin Observatory.
...
### [88] [HD3191, the high-mass X-ray binary that wasn't there](https://arxiv.org/abs/2605.04577)
*Gregor Rauw,Yaël Nazé,Piotr Antoni Kołaczek-Szymański*

Main category: astro-ph.HE

TL;DR: The B1 IV:nn star HD3191, initially considered a high-mass X-ray binary, is likely a single star exhibiting non-radial pulsations instead of orbital motion.


<details>
  <summary>Details</summary>
Motivation: To clarify the nature of the rapidly rotating star HD3191, which lies within the error box of a gamma-ray source.

Method: Spectroscopic observations and analysis of photometric variations in HD3191 to examine radial velocity changes and their implications.

Result: Findings indicate that the observed variations are due to multi-mode pulsations rather than an orbital system, suggesting HD3191 is likely a single star.

Conclusion: HD3191 is most likely a single star with intrinsic rotational features, not a binary system or affected by past mass transfer.
...
### [89] [Spectro-Polarimetric Observations of TeV Sources (SPOTS): First results](https://arxiv.org/abs/2605.04619)
*J. Barnard,B. van Soelen,I. P. van der Westhuizen,M. Böttcher,A. Martin-Carrillo,H. M. Schutte,S. van der Merwe,M. Zacharias*

Main category: astro-ph.HE

TL;DR: This study investigates the optical polarization properties of TeV-emitting blazars using 21-month observations, revealing low average polarization and varying magnetic field structures.


<details>
  <summary>Details</summary>
Motivation: Understanding the underlying magnetic field and particle acceleration mechanisms in blazar jets is essential for comprehending their non-thermal emission characteristics.

Method: The study utilized optical polarization data from a long-term monitoring campaign (SPOTS) conducted with the Southern African Large Telescope on 14 blazars over 21 months.

Result: The campaign yielded low average optical polarization ($Π<10	ext{%}$) with varying polarization angle behaviors and low magnetic field ordering, indicating complex jet dynamics.

Conclusion: The finding suggests that simple one-zone models cannot fully explain the observed phenomena, highlighting the necessity of long-term, multi-wavelength studies for better modeling and future observations.
...
### [90] [Dynamics and Radiative Signatures of Accretion Flows onto a Kerr-like Wormhole](https://arxiv.org/abs/2605.04631)
*Jing-ze Xia,Hong-xuan Jiang,Cheng Liu,Yosuke Mizuno*

Main category: astro-ph.HE

TL;DR: This study investigates Kerr-like wormholes as alternatives to black holes, using GRMHD simulations and GRRT calculations to analyze accretion flows and horizon-scale images.


<details>
  <summary>Details</summary>
Motivation: To explore wormholes as viable alternatives to black holes, potentially offering insights into strong-field gravity through observable characteristics.

Method: GRMHD simulations and GRRT calculations are performed for accretion flows onto a Kerr-like wormhole, varying the spin parameter in both two- and three-dimensional settings.

Result: The spin affects the dynamical properties across the wormhole, and ray-traced images reveal emissions near the throat dominate, showing quasi-periodic light curve modulation.

Conclusion: Findings could help confirm or rule out the existence of exotic compact objects like wormholes through observational techniques.
...
### [91] [Theoretical Constraints on Neutron Star Superfluidity from Her X-1 Precession](https://arxiv.org/abs/2605.04686)
*Anton Biryukov,Amir Levinsov,Pavel Abolmasov*

Main category: astro-ph.HE

TL;DR: Study of Her X-1 shows precession dynamics impacting neutron star behavior.


<details>
  <summary>Details</summary>
Motivation: To understand the implications of IXPE observations that correlate various parameters of Her X-1 over its 35-day cycle and the nature of neutron star precession.

Method: Analyzing IXPE observations to explore the relationship between flux, polarization degree, and angle during the superorbital cycle.

Result: Findings suggest that maintaining neutron star precession over decades challenges current models and requires weakly pinned superfluid vortices in the inner crust.

Conclusion: Weak pinning and balance of torques are crucial for long-term precession, questioning existing theories of superfluid dynamics in neutron stars.
...
### [92] [Confirmation of Binary Clustering in Gamma-Ray Bursts through an Integrated $p$-value from Multiple Nonparametric Tests of Hypotheses](https://arxiv.org/abs/2605.04739)
*Soumita Modak*

Main category: astro-ph.HE

TL;DR: The paper introduces a novel nonparametric method to identify groups in gamma-ray bursts, resolving the debate on their clustering.


<details>
  <summary>Details</summary>
Motivation: To clarify the existence of multiple clusters in gamma-ray burst populations, particularly addressing the controversy of binary classification.

Method: The study employs a new interpoint distance-based metric and utilizes clustering methods, including Gaussian-mixture models and K-means algorithms, alongside multiple nonparametric statistical tests.

Result: The analysis provides a comprehensive p-value confirming the distinct groups of short and long gamma-ray bursts, clarifying previous uncertainty about their classification.

Conclusion: The findings support the existence of two distinct clusters in gamma-ray bursts, enhancing understanding in this area of astrophysics.
...
### [93] [Exact solutions, trajectories and radiation patterns in the classical relativistic Störmer problem](https://arxiv.org/abs/2605.04790)
*Tiberiu Harko,Francisco S. N. Lobo*

Main category: astro-ph.HE

TL;DR: The paper presents a relativistic analysis of charged particle motion in a magnetic dipole field, deriving equations of motion and conservation laws, solving for trajectories, and examining radiation emitted by accelerated charges.


<details>
  <summary>Details</summary>
Motivation: To understand the effects of special relativity on the dynamics of charged particles in a magnetic dipole field, extending the classical Störmer problem.

Method: Derivation of relativistic equations of motion from the Lorentz force law, performing a detailed numerical analysis of particle dynamics, and analyzing the electromagnetic radiation emitted.

Result: Exact solutions for planar motion are obtained; numerical analysis shows the impact of relativistic effects and characterizes emitted radiation, revealing distinct peaks in the power spectral density.

Conclusion: The findings enhance the understanding of magnetic dipole radiation associated with relativistic particle motion and highlight preferred frequency bands in the emitted radiation.
...
### [94] [AGILE detection of transient γ-ray emission from the region of the supergiant fast X-ray transient source IGR J17354-3255](https://arxiv.org/abs/2605.04818)
...
TL;DR: This study investigates the γ-ray flares from the SFXT IGR J17354-3255, linking it to a transient source identified as AGL J1736-3250 based on AGILE archival data.


<details>
  <summary>Details</summary>
Motivation: To establish a definitive connection between the high-energy emissions of SFXTs and observed γ-ray flares, enhancing understanding of their behavior and origins.

Method: Analysis of archival AGILE data to identify γ-ray flares consistent with IGR J17354-3255, along with orbital phase analysis and incorporation of Swift and INTEGRAL observations.

Result: Identification of transient source AGL J1736-3250 emitting 19 γ-ray flares, with half of the activity coinciding with the apastron of the binary system.

Conclusion: The findings support a physical association between IGR J17354-3255 and AGL J1736-3250, suggesting SFXTs may represent a new class of Galactic high-energy transient sources.
...
### [95] [Bayesian parameter estimation for the Core-bounce phase of Rapidly Rotating Core-Collapse Supernovae in real interferometric data](https://arxiv.org/abs/2605.04852)
*Emmanuel Avila,Michele Zanolin,Javier M. Antelis,Claudia Moreno*

Main category: astro-ph.HE

TL;DR: A new method is introduced for estimating kinetic to gravitational potential energy ratios in supernova progenitors using gravitational-wave signals, improving model fitting and parameter recovery.


<details>
  <summary>Details</summary>
Motivation: To accurately estimate the energy ratio and assess the EOS in core-collapse supernova progenitors from gravitational-wave signals.

Method: An extended phenomenological model with an additional signal timescale parameter, evaluated via fitting factors, Bayesian model comparison, and MCMC methods against real O3aL1 noise.

Result: The median fitting factor improved from 88.88% to 90.83%, with the rotational parameter recovered with a median relative error of 11.93% for 452 simulated signals.

Conclusion: Real interferometric noise can introduce significant biases, but optimized prior choices can minimize these biases substantially.
...
### [96] [Sensitivity of the Cherenkov Telescope Array Observatory to Gamma-Ray Signals in Dwarf Irregular Galaxies](https://arxiv.org/abs/2605.04890)
*Jaume Zuriaga-Puig,Viviana Gammaldi,Miguel Á. Sánchez-Conde*

Main category: astro-ph.HE

TL;DR: This study evaluates dwarf irregular galaxies (dIrrs) as targets for WIMP dark matter indirect searches using the Cherenkov Telescope Array Observatory (CTAO). It identifies four key dIrrs, analyzes their potential gamma-ray emissions, and provides sensitivity prospects for dark matter signals, concluding that dIrrs can yield significant constraints on dark matter parameters.


<details>
  <summary>Details</summary>
Motivation: The low star formation rate and expected low gamma-ray emission from dwarf irregular galaxies make them intriguing candidates for dark matter indirect searches, especially as they have not yet been detected in gamma rays.

Method: The study identifies four dIrrs suitable for observation with the CTAO, explores their gamma-ray astrophysical emission, computes the CTAO sensitivity to dark matter signals while considering substructures, and analyzes both cuspy and cored DM density profiles.

Result: The findings suggest that the CTAO could exclude dark matter annihilation cross-section values around $2\times 10^{-24} \, \mathrm{cm^{3}}\mathrm{s^{-1}}$ for 100 GeV WIMP masses, achieving results competitive with galaxy clusters. It also projects enhanced constraints for the velocity-dependent annihilation cross-section due to subhalo contributions.

Conclusion: Dwarf irregular galaxies represent promising targets for both dark matter searches and potential astrophysical sources in gamma-ray astronomy.
...
### [97] [Parameter Estimation Horizon of Core-Collapse Supernovae with Current and Next-Generation Gravitational-Wave Detectors](https://arxiv.org/abs/2605.04896)
...
TL;DR: This study explores gravitational wave signals from core-collapse supernovae using machine learning for parameter estimation, focusing on effects like progenitor models and core rotation.


<details>
  <summary>Details</summary>
Motivation: To improve parameter estimation of gravitational wave signals from core-collapse supernovae and understand their central engine characteristics.

Method: Utilizing machine learning to analyze the bounce and early ring-down signals from rotating core-collapse supernovae, while varying progenitor models and nuclear equations of state.

Result: Identified that bounce-time uncertainty minimally affects estimation in the Fourier domain, but inclination angles significantly hinder performance; next-gen detectors may effectively constrain core rotation beyond 100 kpc for optimal orientations.

Conclusion: Future gravitational wave observatories have the potential to enhance understanding of core-collapse supernovae by accurately inferring core rotation parameters.
...
### [98] [The one and the only: the pulsar - white dwarf system in NGC 6749](https://arxiv.org/abs/2605.04988)
...
TL;DR: The study of PSR J1905+0154A, a binary millisecond pulsar in the globular cluster NGC 6749, reveals significant astrometric and spin parameters over 20 years, implying a unique interaction with its low-mass white dwarf companion and questioning its association with the cluster.


<details>
  <summary>Details</summary>
Motivation: To understand the characteristics and implications of PSR J1905+0154A within its globular cluster and its relationship with its white dwarf companion.

Method: Utilized a combination of Arecibo and FAST observational data to establish a phase-coherent timing solution for PSR J1905+0154A, analyzing spin, orbital parameters, and the characteristics of the companion star.

Result: Measured parameters indicate a high magnetic field and characteristic age typical of millisecond pulsars, while the white dwarf companion is consistent with a Helium composition and a cooling age suggesting an early spin period.

Conclusion: The peculiar velocity of the system raises doubts about its association with the globular cluster, and efforts to identify additional pulsars in the cluster were unsuccessful.
