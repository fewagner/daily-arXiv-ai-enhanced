...
### [1] [Optimized filtering for pulse-shape based pile-up rejection applied to $0νββ$ search with $^{100}$Mo](https://arxiv.org/abs/2606.17948)
...
TL;DR: This paper presents an optimized digital filter algorithm for identifying pile-up events in experimental physics, specifically in neutrinoless double beta decay searches using cryogenic Li$_{2}$$^{100}$MoO$_4$ detectors.


<details>
  <summary>Details</summary>
Motivation: To address the significant challenge of pile-up events that distort data in experimental physics, particularly in low-rate processes like neutrinoless double beta decay.

Method: An algorithm is developed for an optimized digital filter to effectively discriminate pile-up events based on known signal response and stationary noise power spectral density.

Result: The new filter reduces pile-up induced background by 31% at 90% efficiency compared to a previously referenced method.

Conclusion: While focused on cryogenic detectors, the proposed method is applicable to a variety of detector technologies and experimental scenarios.
...
### [2] [A High-Precision Frequency Locking Method Based on All-Phase FFT Demonstrated on a Crystal Oscillator with Rubidium Clock Reference](https://arxiv.org/abs/2606.17959)
*Qibin Zheng,Kang Xu,Jiacheng Yang,Liguo Zhou,Li Ding,Xianfeng Jiang,Zhaohui Bu*

Main category: physics.ins-det

TL;DR: The study presents a frequency-locking method using frequency-domain unbiased phase estimation (FDUPE) for enhanced precision. Experiments validate its effectiveness, demonstrating significant improvements in frequency stability.


<details>
  <summary>Details</summary>
Motivation: To achieve high-precision frequency control, which is critical in various applications.

Method: The proposed FDUPE method employs weighted data recombination and Fourier-transform processing, executed on an FPGA with a digital PID controller to ensure accurate frequency locking.

Result: The system showed a drastic reduction in frequency fluctuation standard deviation from (12.75~mHz) to (0.88~μHz) rms, and Allan deviation improved from (9.6 	imes 10^{-10}) to (1.45 	imes 10^{-14}), indicating a five-order-of-magnitude enhancement.

Conclusion: The developed system demonstrates exceptional locking performance, validating the FDUPE method as a robust solution for high-precision frequency control.
...
### [3] [Are neutrinos Majorana? Fixed-target and high-energy astrophysical searches decide](https://arxiv.org/abs/2606.17132)
*Gabriela Barenboim,Mauricio Bustamante,Qinrui Liu*

Main category: hep-ph

TL;DR: This study proposes a new method to determine if neutrinos are Dirac or Majorana fermions by using heavy neutral lepton (HNL) interactions and astrophysical neutrino scattering.


<details>
  <summary>Details</summary>
Motivation: Current neutrino research relies heavily on neutrinoless double beta decay, which has limitations. A new approach is needed to explore the nature of neutrinos more effectively.

Method: The paper suggests probing HNL interactions that alter active neutrino flavor mixing; for Majorana neutrinos, this would lead to measurable effects in high-energy experiments like SHiP and in neutrino telescopes observing cosmic neutrinos.

Result: The proposed method allows for identifying signatures consistent with Majorana neutrinos, especially through flavor shifts in astrophysical neutrinos, avoiding existing experimental blind spots.

Conclusion: A concurrent observation of HNL signatures at SHiP and flavor shifts at neutrino telescopes would confirm neutrinos as Majorana particles, while no such correlation would indicate they are Dirac.
...
### [4] [Short-Range Correlations Between Partons in a Proton](https://arxiv.org/abs/2606.17133)
*Jen-Chieh Peng,Krishna Rajagopal,John Terry*

Main category: hep-ph

TL;DR: This study proposes using the Electron-Ion Collider to investigate short-range correlations between quark pairs within protons, enhancing understanding of their structure and similarities to quark-gluon plasma.


<details>
  <summary>Details</summary>
Motivation: The similarities in energy density and pressure between confined quarks in protons and quark-gluon plasma (QGP) suggest a need to explore parton correlations within protons to deepen knowledge of their internal structure and the liquid-like nature of QGP.

Method: Utilizing Electron-Ion Collider measurements involving jets, pions, and scattered electrons to investigate and quantify the short-range correlations (SRCs) between quark pairs in nucleons, drawing parallels to existing SRC observations in nucleon pairs within nuclei.

Result: Proposed measurements aim to identify and quantify quark pairs' SRCs, with expectations of detecting stronger $ud$ SRCs compared to $uu$ and $dd$, supporting the liquid-like behavior of QGP and revealing new insights into proton structure.

Conclusion: Investigating SRCs within protons could lead to a deeper understanding of their internal dynamics and the underlying physics of quark-gluon plasma, enhancing existing parton distribution functions with a focus on the strong coupling phenomena.
...
### [5] [PineAPPLv1: fast and flexible theory predictions for present and future colliders](https://arxiv.org/abs/2606.17134)
*Tomáš Ježo,Emanuele R. Nocera,Tanjona R. Rabemananjara,Christopher Schwan,Tanishq Sharma,Jan Wissmann*

Main category: hep-ph

TL;DR: PineAPPLv1 is a library for efficient interpolation of partonic cross sections, supporting various convolutions and both polarised/unpolarised distributions, aiding precision physics predictions in high-energy collisions.


<details>
  <summary>Details</summary>
Motivation: The need for fast and flexible evaluation of high-energy observables using partonic cross sections that can be easily convolved with PDFs and FFs.

Method: The library supports multiple convolutions for various hadronic particle states, incorporating both polarised and unpolarised data; it allows control over scale choices in scattering processes and introduces new interpolation coefficient representations.

Result: Demonstrated capabilities include accurate predictions for pion production in both unpolarised and polarised proton collisions, assessing PDF, FF, and scale uncertainties in various scenarios.

Conclusion: PineAPPL showcases significant potential as a key tool for enhancing precision measurements in current and future collider experiments.
...
### [6] [$|V_{cb}|$ determinations from $\bar{B} \to D^{(*)} \ell \barν$ decays within the SM and beyond](https://arxiv.org/abs/2606.17138)
*Wen-Sheng Fang,Syuhei Iguro,Xin-Qiang Li,Ria Sain,Ryoutaro Watanabe,Ben-Liang Zhang*

Main category: hep-ph

TL;DR: The study analyzes determinations of the CKM matrix element $|V_{cb}|$ from $ar{B} 	o D^{(*)}	ext{lepton}ar{
u}$ decays, focusing on form-factor parameterizations and incorporating recent experimental data.


<details>
  <summary>Details</summary>
Motivation: To refine the determination of $|V_{cb}|$ and assess the influence of different form-factor parameterizations on this value, considering potential new-physics contributions.

Method: The analysis involves comprehensive fitting of transition form-factors using various parameterizations (BSZ, BGL, HQET) and comparing the outcomes with official PDG averages and other empirical data.

Result: The BGL parameterization aligns closely with the PDG average of $|V_{cb}|$, while the HQET parameterization yields a significantly smaller value. Investigations into new-physics contributions are included.

Conclusion: The findings highlight the dependence of $|V_{cb}|$ on the choice of form-factor parameterization and the viability of new-physics effects, subject to current data constraints.
...
TL;DR: This paper introduces a new terrestrial probe for detecting millicharged particles (mCPs) produced in supernovae, showing a potential to detect over 10 events per year, thus enhancing search capabilities beyond current limits.


<details>
  <summary>Details</summary>
Motivation: The need for improved detection methods for millicharged particles produced in core-collapse supernovae, which can yield distinct signals upon reaching Earth.

Method: The authors compute electron-recoil signals from mCPs at various detectors (XENONnT, JUNO, DUNE, Hyper-Kamiokande) for different supernova scenarios, focusing on mCPs with a specific charge and mass.

Result: Detection of over 10 events per year for mCPs with charge $orall 
eq 10^{-9}$ and mass in the sub-MeV to MeV range, indicating promising discovery potential.

Conclusion: The study suggests that this method can enhance existing limits on mCP charge by an order of magnitude, providing a significant improvement in probing the existence of mCPs.
...
### [8] [Freeze-in and ultra-relativistic freeze-out during general reheating scenarios](https://arxiv.org/abs/2606.17155)
*Kuldeep Deka*

Main category: hep-ph

TL;DR: This paper presents a framework for understanding dark-matter production during a non-instantaneous reheating era, integrating various freeze mechanisms while accounting for the thermal history's impact on relic abundance.


<details>
  <summary>Details</summary>
Motivation: To explore how the thermal history before radiation domination influences dark-matter relic abundance.

Method: The authors develop an analytic framework using effective parameters to describe the non-instantaneous reheating and analyze the thermal production of dark matter across different regimes.

Result: The framework yields analytic relic yields based on temperature exponents, explaining the scaling of relic-density contours and matching numerical results for various reheating scenarios.

Conclusion: The study elucidates how different reheating histories can transition between freeze-in, ultra-relativistic freeze-out, and ordinary freeze-out, impacting dark-matter production.
...
### [9] [Scaling of the Surface Free Energy as a Probe of the QCD Critical Region](https://arxiv.org/abs/2606.17204)
*Joseph I. Kapusta,Mayank Singh,Shensong Wan*

Main category: hep-ph

TL;DR: The study explores the QCD phase diagram's critical point and suggests a realistic model for heavy ion simulations that examines the influence of surface energy on critical behavior.


<details>
  <summary>Details</summary>
Motivation: To effectively isolate experimental signatures of a critical point in heavy ion collisions, a reliable model incorporating phase boundary effects is necessary.

Method: The paper presents a construction of a new equation of state, analyzing its critical behavior and the effects of surface energy on the critical region's size.

Result: It was found that to detect critical exponents, temperatures need to be extremely close to the critical value (within 1%), raising doubts about their measurability in heavy ion collisions.

Conclusion: While measuring critical exponents may be unlikely, detecting signatures of first-order phase transitions remains possible, and the proposed method can be applied to any equation of state.
...
### [10] [Quantum decoherence of hyperon spin correlations in QCD hadronization](https://arxiv.org/abs/2606.17240)
*Feng Liu,Zhoudunming Tu*

Main category: hep-ph

TL;DR: This paper proposes a quantum information-inspired model to explore hadronization, linking spin entanglement and decoherence to the QCD vacuum.


<details>
  <summary>Details</summary>
Motivation: To understand the loss of quantumness during hadronization, a process not accurately captured by perturbative QCD.

Method: The approach involves quark-antiquark pairs inheriting quantum numbers and environmental influence leading to spin state decoherence during string breaking.

Result: The framework aligns with spin-correlation data for $Λ$ hyperons from RHIC and LHC, providing insight into the relationship between the QCD vacuum and hadronization.

Conclusion: This model establishes a quantitative bridge between quantum concepts and the hadronization process.
...
TL;DR: This study computes and verifies higher-order corrections in the NRQCD framework for the color-singlet contribution to $e^+e^- 	o J/ψ + X_{{m non \,}c\bar{c}}$ at B factories, achieving high precision results that align closely with experimental measurements, though inconsistencies in angular distribution suggest further study is necessary.


<details>
  <summary>Details</summary>
Motivation: To provide a detailed analysis of the color-singlet contributions to the production of $J/ψ$ in electron-positron collisions and validate NRQCD factorization at higher orders.

Method: Calculating $	ext{O}(α_s)$, $	ext{O}(v^2)$, and $	ext{O}(α_s v^2)$ corrections to cross sections and angular distribution, obtaining short-distance coefficients as asymptotic expansions using differential equations.

Result: Achieved relative errors of $10^{-14}$ for cross-section predictions and $10^{-7}$ for angular distribution, confirming $	ext{O}(α_s)$ and $	ext{O}(v^2)$ corrections align with existing literature, while the $	ext{O}(α_s)$ correction accounts for about $50\%$ of the leading-order cross section.

Conclusion: Predicted cross section aligns with Belle's measurements, but angular distribution shows significant deviation, requiring further investigations.
...
### [12] [Fourier-Preconditioned Path Deformations for Multi-Field Vacuum Tunnelling](https://arxiv.org/abs/2606.17485)
*Suriyah R. Kannagi,Aadarsh Singh,Sudhir K Vempati*

Main category: hep-ph

TL;DR: An endpoint-safe Fourier method is proposed for optimizing multi-field vacuum tunneling paths, showing strong agreement with existing solvers in benchmark cases while improving efficiency.


<details>
  <summary>Details</summary>
Motivation: To enhance the optimization of tunneling paths in multi-field scenarios while maintaining safety at the endpoints.

Method: The method employs a straight-line interpolation between vacua with sine-mode deformations, utilizing automatic differentiation in JAX for path optimization.

Result: The Fourier method achieved sub-percent accuracy relative to existing solutions and improved efficiency in high-dimensional scenarios, particularly in CosmoTransitions and FindBounce tests.

Conclusion: Endpoint-safe Fourier paths effectively bridge analytical ansätze and numerical algorithms in multi-field vacuum tunneling, enhancing computational efficiency.
...
### [13] [Search for a Time-Dependent Z' Resonance in the Dimuon Channel](https://arxiv.org/abs/2606.17569)
...
TL;DR: This paper introduces a new strategy for detecting time-varying resonances in collider data, specifically using a 2D likelihood framework to improve sensitivity over traditional methods.


<details>
  <summary>Details</summary>
Motivation: Conventional resonance searches are ineffective for signals that change over time during data collection, necessitating a method that captures such dynamics.

Method: A two-dimensional unbinned likelihood framework in invariant mass and time is developed, enabling the detection of signals with non-stationary properties in the $(m,t)$ plane.

Result: The technique is applied to dimuon events from CMS data, deriving upper limits on the gauge coupling as a function of the $Z'$ mass and modulation amplitude, showing enhanced sensitivity compared to standard methods.

Conclusion: Incorporating temporal information significantly improves the sensitivity of resonance searches in high-energy collider experiments.
...
### [14] [Description of the process $e^+ e^- \to π^0π^0 γ$ in the extended NJL model](https://arxiv.org/abs/2606.17813)
*M. K. Volkov,A. A. Pivovarov,K. Nurlan*

Main category: hep-ph

TL;DR: The paper calculates the cross section for $e^+ e^- 	o π^0π^0 γ$ using the extended NJL quark model, highlighting the contributions from intermediate mesons, particularly the radially excited $ρ'$.


<details>
  <summary>Details</summary>
Motivation: To provide a detailed understanding of the process $e^+ e^- 	o π^0π^0 γ$ and its contributions from various intermediate mesons within the framework of the extended NJL quark model.

Method: Calculation of the cross section using the extended NJL quark model, focusing on vector and scalar meson contributions, particularly the radially excited $ρ'$ meson.

Result: The radially excited $ρ'$ meson provides the main contribution to the cross section, with additional discussion on the impact of scalar mesons.

Conclusion: The study deepens understanding of mesonic contributions in the considered process, emphasizing the significance of the radially excited $ρ'$ meson.
...
### [15] [From target to projectile: CSS evolution of quark TMD in different light-cone gauges](https://arxiv.org/abs/2606.17993)
*Tolga Altinoluk,Guillaume Beuf,Jamal Jalilian-Marian,Mirja Tevio*

Main category: hep-ph

TL;DR: This paper presents a calculation of one-loop corrections to the quark TMD using the light-cone gauge with an emphasis on rapidity divergences. It derives the CSS evolution equations and compares findings with the target light-cone gauge.


<details>
  <summary>Details</summary>
Motivation: To investigate one-loop corrections to the quark TMD and clarify the implications for TMD factorization and Color Glass Condensate frameworks.

Method: One-loop corrections are calculated in the projectile light-cone gauge via the background field formalism using the Mandelstam-Leibbrandt prescription and a pure rapidity regulator.

Result: The CSS evolution equations are derived after one-loop renormalization, and the structure of rapidity divergences and double-logarithmic contributions are compared with those from target light-cone gauge calculations.

Conclusion: The findings enhance the understanding of the relationship between TMD factorization and the Color Glass Condensate.
...
### [16] [Ultra-High-Energy Cosmic Ray Boosted Relic Neutrinos](https://arxiv.org/abs/2606.18088)
*Jiajie Zhang,Jiajun Liao*

Main category: hep-ph

TL;DR: This paper investigates the effect of ultra-high-energy cosmic rays on the cosmic neutrino background, analyzing various neutrino interactions and deriving limits on overdensity.


<details>
  <summary>Details</summary>
Motivation: To explore the indirect probe of cosmic neutrino background by analyzing interactions induced by ultra-high-energy cosmic rays.

Method: Systematic study of various scattering channels (ES, COH, INCOH, RES, DIS) and analysis of UHECR flux using mixed-composition spectra and source evolution models.

Result: A clear hierarchy of neutrino scattering channels is identified, leading to significant contributions to the CνB signal; coherent scattering dominates at low energies, while RES and DIS are relevant at higher energies.

Conclusion: Reliable predictions of UHECR-boosted CνB signals necessitate integrating scattering channels, UHECR composition, source evolution, and neutrino mass spectrum.
...
### [17] [Twist-3 contributions to $γγ\toπ^0π^0,\,K_S^0K_S^0$ in $k_T$ factorization](https://arxiv.org/abs/2606.18233)
*Jun-Kang He,Cong Wang*

Main category: hep-ph

TL;DR: The study computes cross sections for two-photon processes, showing significant twist-3 contribution that better aligns predictions with experimental data.


<details>
  <summary>Details</summary>
Motivation: To improve the theoretical predictions for cross sections of charge-suppressed neutral channels in two-photon processes and address discrepancies with experimental data.

Method: Utilized $k_T$ factorization and included chirally enhanced twist-3 light-cone distribution amplitudes in calculations of the cross sections for $γγ	oπ^0π^0$ and $γγ	o K_S^0K_S^0$.

Result: The twist-3 cross sections are found to exceed twist-2 estimates significantly, aligning predictions closer to Belle data, particularly in angular distributions and energy dependence.

Conclusion: Combining hard and soft contributions yields a better match to observed energy dependence, suggesting that both are important in the few-GeV region.
...
### [18] [Projected logical ensembles in surface codes via the random-matrix theory of quantum dots](https://arxiv.org/abs/2606.17140)
*Mircea Bejan,Jan Behrends,Max McGinley,Benjamin Béri*

Main category: quant-ph

TL;DR: This paper explores post-measurement logical states in active quantum error correction using topological codes, introducing the "projected logical ensemble" (PLE) and establishing a link to scattering matrices in mesoscopic quantum dot systems.


<details>
  <summary>Details</summary>
Motivation: To understand the statistical properties of logical states in quantum error correction and uncover novel many-body phenomena resulting from measurements.

Method: The study analyzes the PLE arising from syndrome extraction and decoding in surface codes affected by single-qubit rotations, relating it to scattering matrices of a 2D Majorana network.

Result: Identified conditions where the PLE resembles chaotic scattering matrices, aligning with random matrix theory and establishing universal ensemble characteristics.

Conclusion: The findings connect emergent concepts in mesoscopic physics, quantum many-body systems, and quantum error correction, revealing a deeper understanding of measurement-induced randomness.
...
### [19] [Fermionic Hamiltonian engineering with local control](https://arxiv.org/abs/2606.17158)
*Özgün Kum,Matthias Zipper,Ludwig Mathey,Martin Kliesch*

Main category: quant-ph

TL;DR: This paper introduces a framework for engineering fermionic Hamiltonians by interleaving free evolution with local unitaries to expand accessible target Hamiltonians while maintaining robustness to errors.


<details>
  <summary>Details</summary>
Motivation: The paper addresses limitations in experimental implementations of quantum simulators due to constraints on Hamiltonian realizations, aiming to broaden the range of Hamiltonians that can be engineered.

Method: The proposed framework conjugates free system evolution with sequences of local fermionic unitaries, obtained efficiently through linear programming, allowing for time evolution under diverse target Hamiltonians.

Result: The method can realize arbitrary complex tunneling coefficients limited only by system connectivity, demonstrated via simulations of the Harper-Hofstadter model and an interacting Fermi-Hubbard chain.

Conclusion: This approach enhances fermionic Hamiltonian engineering, avoiding issues with continuous energy absorption while enabling robust control over quantum dynamics.
...
### [20] [Tripartite entanglement of remote atomic qubits](https://arxiv.org/abs/2606.17173)
...
TL;DR: This study reports the first fully-distributed GHZ state of qubits in a three-node quantum network using single atomic memories and photonic interconnects, achieving significant fidelity and closing the detection loophole.


<details>
  <summary>Details</summary>
Motivation: The research aims to advance quantum technologies that rely on distributed entanglement, particularly for scalable quantum networks and secure communications.

Method: A three-node quantum network was established using single atomic memories and photonic interconnects to generate a fully-distributed GHZ state of qubits.

Result: The generated state exhibited a bounded fidelity of $0.841(17) 	ext{ to } 0.881(17)$ at a rate of 0.095(5)/sec, along with a verified violation of Mermin's inequality while successfully closing the detection loophole.

Conclusion: This work represents a significant step in realizing practical multi-node quantum networks, demonstrating the feasibility of maintaining high-fidelity entanglement across atomic qubits.
...
### [21] [Post-Selection Probability and Fidelity of Bidirectional Teleportation](https://arxiv.org/abs/2606.17251)
*Ning Sun,Lei Feng,Pengfei Zhang*

Main category: quant-ph

TL;DR: This paper provides a comprehensive study of a bidirectional teleportation protocol for qubits, analyzing key quantum dynamics metrics and their implications for practical implementations.


<details>
  <summary>Details</summary>
Motivation: Understanding quantum information scrambling is essential in various quantum physics fields, leading to innovations in quantum protocols and algorithms.

Method: The study focuses on the post-selection probability and fidelity of a bidirectional teleportation protocol, examining errors in time-reversed dynamics and relating them to quantum dynamic diagnostics like the Loschmidt echo.

Result: The findings indicate the initial-state dependence of fidelity and the stability of post-selection probability in integrable models, highlighting the role of standard quantum diagnostics in assessing protocol performance.

Conclusion: The results provide practical guidance for implementing the bidirectional teleportation protocol in realistic quantum devices.
...
### [22] [Breaking the bicycle frame: Coset-based quantum LDPC codes](https://arxiv.org/abs/2606.17268)
*Arda Aydin,Itzhak Tamo,Alexander Barg*

Main category: quant-ph

TL;DR: This paper introduces a family of two-block quantum LDPC codes using group actions on subgroup cosets, yielding new codes and improving performance metrics.


<details>
  <summary>Details</summary>
Motivation: The goal is to enhance the construction methods of two-block quantum LDPC codes by expanding the search space beyond traditional methods.

Method: The study employs group actions on cosets of subgroups to construct new quantum LDPC codes, complemented by a syndrome extraction schedule designed for specific stabilizer weights.

Result: New codes discovered include weight-6 codes with parameters like $[[48,8,6]]$ and weight-8 codes such as $[[84,16,8]]$, with competitive thresholds under a noise model.

Conclusion: The work concludes with a group-theoretic framework that generates graph-based covers, providing both new codes and insights into existing constructions.
...
### [23] [Induced Resource Theories and Harvesting via Quantum Probes](https://arxiv.org/abs/2606.17287)
*Ron Nyström,Simone Cepollaro,Nicola Pranzini,Stefano Cusumano,Alioscia Hamma,Esko Keski-Vakkuri*

Main category: quant-ph

TL;DR: This paper explores how a quantum probe can reveal information about an incomplete resource-theoretic environment through resource harvesting, proposing a new framework for interpretation.


<details>
  <summary>Details</summary>
Motivation: The need to understand how quantum systems interact with environments lacking clear resource-theoretic descriptions.

Method: Development of a framework establishing conditions under which resource generation in a probe indicates resource presence in the environment.

Result: A systematic approach for analyzing resource harvesting beyond traditional controlled settings, leading to a novel conception of environmental resources.

Conclusion: The findings suggest a pathway to better comprehend the interaction of diverse quantum resources.
...
### [24] [Effects of Josephson Junction Non-idealities on Adiabatic Quantum Flux Parametron Circuits](https://arxiv.org/abs/2606.17338)
*Daryoush Shiri,Likai Yang,Mohamed A. Hassan,Philip Krantz,Eric T. Holland*

Main category: quant-ph

TL;DR: This paper investigates the effects of non-sinusoidal current-phase relations in SNS and WL junctions on the performance of AQFP gates used in cryogenic microwave electronics.


<details>
  <summary>Details</summary>
Motivation: To understand how the quality of Josephson junctions impacts AQFP gate performance in superconducting qubit control.

Method: The authors used the Keysight ADS simulator with symbolically defined device (SDD) modeling to analyze different types of Josephson junctions.

Result: The performance metrics, including speed, delay, and margin of AQFP gates, are significantly influenced by the non-sinusoidal characteristics of SNS and WL junctions.

Conclusion: Improving the understanding of junction properties is crucial for optimizing AQFP gate performance in quantum computing applications.
...
### [25] [Pulse-optimised circuit elements for scalable and noise-resilient quantum chemistry](https://arxiv.org/abs/2606.17357)
...
TL;DR: This paper presents a new methodology to enhance the efficiency of variational quantum eigensolvers (VQEs) using gradient-ascent pulse engineering, significantly reducing runtime and increasing performance for quantum chemistry calculations.


<details>
  <summary>Details</summary>
Motivation: The motivation is to overcome the limitations of current algorithmic runtimes in quantum chemistry calculations on near-term quantum processors.

Method: The authors developed a gradient-ascent pulse engineering approach to implement VQE algorithms directly with hardware-tailored pulses instead of primitive gate sequences, allowing for more efficient operation of modular VQE elements.

Result: Numerical demonstrations on a silicon spin-qubit quantum processor showed that the implementation of single- and double-qubit excitations could be executed in less than 289 ns and 927 ns, respectively, with a runtime reduction of up to 15.3 times compared to traditional methods.

Conclusion: The methodology offers a scalable and noise-robust approach for quantum chemistry simulations, facilitating faster computations and making it more feasible to study complex systems.
...
### [26] [Canonical regularization of the stationary Coulomb problem and an Aufbau-like spectral ordering](https://arxiv.org/abs/2606.17359)
*Anand Aruna Kumar*

Main category: quant-ph

TL;DR: This paper analyzes the hydrogen atom's spectral ordering using a regularized de Broglie--Bohm approach, revealing orbital-dependent shifts that lift Coulomb degeneracy and align with Aufbau/Madelung principles.


<details>
  <summary>Details</summary>
Motivation: To investigate the hydrogen atom's spectral structure and degeneracy using a novel approach that incorporates canonical corrections and regularization.

Method: A regularized de Broglie--Bohm representation is employed, leading to modified boundary value problems and analytical solutions for the hydrogen-like spectrum.

Result: The approach yields a spectral ordering that removes Coulomb degeneracy and aligns with the Aufbau/Madelung sequence, retaining the standard Rydberg sequence for l=0 states.

Conclusion: This study offers an analytical perspective on spectral ordering in the one-center Coulomb problem, complementing existing many-electron atomic theory.
...
TL;DR: This study addresses the limitations of daylight entanglement-based quantum key distribution (QKD) due to background noise, presenting a framework to optimize receiver parameters for better performance in QKD.


<details>
  <summary>Details</summary>
Motivation: To improve the effectiveness of daylight quantum key distribution by minimizing the impact of accidental coincidences from background light, thus enhancing signal integrity and overall key rates.

Method: Developed and validated a receiver-level framework that connects receiver bandwidth, temporal width, and background noise density to key performance indicators such as sifted-key rate and QBER in a BBM92 QKD system; tested in various conditions including indoor and a 10 m rooftop scenario.

Result: Experimental validation showed that optimal single counts are achieved near source-matched bandwidth; increased temporal width raised QBER while leaving single counts steady, and a rooftop experiment yielded a sifted-key rate of 2,811 cps with a QBER of 4.43%.

Conclusion: The findings demonstrate that optimizing the receiver's bandwidth and temporal width can effectively mitigate background noise impacts, facilitating reliable operation of QKD in daylight conditions.
...
### [28] [Broadband High-Level Squeezed Light using Waveguide Optical Parametric Amplifiers with External Dispersion Compensation](https://arxiv.org/abs/2606.17422)
...
TL;DR: The paper presents a method to measure broadband phase-sensitive amplification of squeezed light using a waveguide optical parametric amplifier with external dispersion compensation, achieving significant squeezing across a wide frequency range.


<details>
  <summary>Details</summary>
Motivation: The research addresses the challenge of group velocity dispersion in broadband systems, which restricts the effective bandwidth for phase-sensitive amplification measurements of squeezed light.

Method: The authors implemented external dispersion compensation between two optical parametric amplifiers to mitigate the frequency-dependent rotation of the squeezing axis caused by group velocity dispersion.

Result: They achieved a maximum squeezing of 5.9 dB at the carrier frequency and over 5 dB of squeezing up to 4.5 THz offset from the carrier, with significant squeezing confirmed up to 6 THz.

Conclusion: The findings offer a practical technique for broadband squeezed light characterization, advancing the development of ultrafast continuous-variable quantum information processing.
...
### [29] [Impact of Network Constraints on Fault-Tolerant Distributed Quantum Computing](https://arxiv.org/abs/2606.17495)
*Eneet Kaur,Shahrooz Pouryousef,Nitish Kumar Chandra,Hassan Shapourian,Jiapeng Zhao,Ramana Kompella,Reza Nejabati*

Main category: quant-ph

TL;DR: This work introduces an end-to-end simulation framework for scalable quantum computing, integrating error correction, QPU connectivity, and network constraints to optimize resource allocation and performance.


<details>
  <summary>Details</summary>
Motivation: The need for effective quantum data centers as scalable quantum computing evolves, highlighting the gaps in existing analyses regarding network constraints and error correction interactions.

Method: An end-to-end simulation framework that models surface-code operations, QPU connectivity, and realistic network constraints, producing metrics such as execution latency and logical error rates.

Result: The modular framework enables the analysis of various routing heuristics and scheduling policies, revealing distinct operating regimes based on network characteristics.

Conclusion: Tradeoffs in distributed quantum computing architecture design can be better understood by jointly modeling computation and communication, leading to improved resource allocation strategies.
...
### [30] [Kinematic properties of the Pauli equation](https://arxiv.org/abs/2606.17548)
*E. E. Perepelkin,B. I. Sadovnikov,N. G. Inozemtseva,V. A. Svetovidov*

Main category: quant-ph

TL;DR: The paper uses the Wigner-Vlasov formalism to analyze the kinematics of the Pauli equation, showing that probability currents are linked to spinor components, leading to a new Hamilton-Jacobi system and motion equations influenced by spin-magnetic field interaction.


<details>
  <summary>Details</summary>
Motivation: The study aims to deepen the understanding of the kinematic properties of quantum systems described by the Pauli equation, particularly in scenarios involving magnetic fields.

Method: Utilizing the Wigner-Vlasov formalism, the paper represents the probability current of the Pauli equation as a superposition of currents linked to spinor components, and derives a new system of Hamilton-Jacobi equations and motion equations for particle dynamics in electromagnetic fields.

Result: The derived equations reveal how each spin projection leads to its own probability flux and yield an exact solution for quantum kinematics under specific conditions (uniform magnetic field and asymmetric quadratic potential).

Conclusion: The findings provide a framework for analyzing quantum systems with spin under magnetic influences, highlighting the significance of the spinor expansion in modeling probability currents.
...
### [31] [On the entanglement induced by the deformation of phase-space](https://arxiv.org/abs/2606.17587)
*Shilpa Nandi,Shatarupa Maity,Pinaki Patra*

Main category: quant-ph

TL;DR: This paper revisits how noncommutative (NC) deformations of phase space influence entanglement in bipartite Gaussian states, suggesting that such deformations often lead to entanglement, particularly illustrated through a harmonic oscillator model.


<details>
  <summary>Details</summary>
Motivation: To explore the effects of noncommutative phase space on quantum entanglement and provide experimental signatures of quantum gravity.

Method: The paper extends the positive partial transpose (PPT) criterion for separability of bipartite Gaussian states to Bopp's shift, examining position-position and momentum-momentum noncommutativity with parameters θ and η.

Result: It is found that noncommutativity parameters θ and η induce entanglement, leading to a near-universal entanglement of bipartite Gaussian states in deformed space.

Conclusion: A gedankenexperiment is proposed to test supposedly separable states, potentially revealing noncommutativity signatures as evidence for the quantum nature of gravity.
...
### [32] [Asymptotically Optimal Circuit Depth for Diagonal Unitary Synthesis and Compilation on Two-Dimensional Grids](https://arxiv.org/abs/2606.17589)
*Chengzhuo Xu,Xiao Chen,Zhihao Liu,Zhigang Li*

Main category: quant-ph

TL;DR: The paper presents the Gray-Path Framework (GPF) for synthesizing diagonal unitaries efficiently on quantum hardware, ensuring optimal routing depth and count, regardless of architecture.


<details>
  <summary>Details</summary>
Motivation: To address the inefficiency of heuristic search in compiling diagonal unitaries on nearest-neighbor quantum hardware, which leads to intractable solutions for large qubit sizes.

Method: Developed the Gray-Path Framework (GPF) for asymptotically optimal realization of n-qubit diagonal unitaries in R_z and CNOT depths of O(2^n/n). Compiled GPF onto nearest-neighbor grids, demonstrating optimality in routing.

Result: Established that routing adds predictable depth and gate count, and provided both ancilla-free and configurable layouts, showing the method is topology-independent and deterministic with closed-form bounds.

Conclusion: The proposed GPF methodology quantitatively optimizes resource estimates for synthesizing diagonal unitaries, overcoming limitations of heuristic compilers, thus making it viable for large-scale quantum operations.
...
### [33] [Helical Dirac Current with Local Coupling to a Chiral Potential](https://arxiv.org/abs/2606.17618)
*Ju Gao,Fang Shen*

Main category: quant-ph

TL;DR: The study reveals that confined Dirac eigenstates in cylindrical geometry possess a conserved helical current even with zero orbital angular momentum, leading to distinct spin-dependent properties and a geometric selection rule under a static scalar potential.


<details>
  <summary>Details</summary>
Motivation: To explore the properties of Dirac eigenstates under cylindrical confinement and their implications for spin-selective phenomena without relying on external fields.

Method: By analyzing the Dirac current in cylindrical confinement, especially in the l=0 channel, and deriving a matrix-element kernel influenced by a chiral scalar potential, we examine the resulting spin-selective couplings and spatial overlaps.

Result: Found that confined Dirac modes exhibit a nonvanishing azimuthal current component and geometric selection rules for spin-selective responses, including off-diagonal channel conversions in the presence of a static chiral potential.

Conclusion: The research establishes fundamental insights into the interplay between Dirac currents and static scalar potentials, providing a framework for understanding spin-polarization phenomena in various contexts.
...
### [34] [Photon anti-bunching in high harmonic generation](https://arxiv.org/abs/2606.17620)
*Philipp Stammer,Javier Rivera-Dean,Maciej Lewenstein*

Main category: quant-ph

TL;DR: This paper predicts photon anti-bunching in high harmonic generation (HHG), highlighting non-classical behavior in HHG photon correlations.


<details>
  <summary>Details</summary>
Motivation: To establish the presence of individual photon emissions in high harmonic generation and explore its non-classical characteristics.

Method: Utilizing the Heisenberg picture approach for quantum optical HHG to analyze the intensity correlation function.

Result: Predicted clear anti-bunching signatures in intensity correlations across the harmonic spectrum, indicating inherent non-classicality.

Conclusion: The discovery of photon anti-bunching in HHG represents a significant theoretical advancement, confirming individual photon dynamics in this process.
...
### [35] [Quantum Computing Algebra (QCA), the theory and implementation](https://arxiv.org/abs/2606.17621)
*Jaroslav Hrdina,Dietmar Hildenbrand,Oliver Rettig*

Main category: quant-ph

TL;DR: The paper introduces a real geometric algebra framework (QCA) for translating the Dirac formalism into geometric algebra, enabling efficient representation of quantum states and operations, and showcasing its application in quantum game theory.


<details>
  <summary>Details</summary>
Motivation: To create a more efficient representation of quantum states and operators by utilizing geometric algebra instead of traditional methods, providing advantages in computational modeling.

Method: QCA utilizes a split-signature construction, facilitating the direct implementation of quantum mechanics through geometric algebra principles, and is demonstrated via the GAALOP software for the representation of quantum gates and systems.

Result: QCA allows efficient computational representation of quantum gates, multi-qubit systems, and provides enhancements in modeling strategies in quantum game theory.

Conclusion: The framework connects quantum computation's abstract concepts with practical implementations in geometric algebra, demonstrating notable computational benefits.
...
### [36] [Quantum mechanics in configuration space in context](https://arxiv.org/abs/2606.17622)
*Arwa Bukhari,Margherita Moro,Max Davies,Alastair Wilson,Almut Beige*

Main category: quant-ph

TL;DR: Bukhari et al. propose a new formalism for quantum mechanics that enhances wave-particle duality by using configuration space, leading to clearer continuity between quantum and classical mechanics.


<details>
  <summary>Details</summary>
Motivation: To improve the modelling of quantum systems and address issues in the implementation of wave-particle duality.

Method: Introducing quantum mechanics in configuration space, where classical position-velocity states are treated as distinguishable quantum states on classical trajectories.

Result: The new approach increases continuity between quantum and classical mechanics and resolves a conceptual inconsistency in momentum definition during canonical quantisation.

Conclusion: Standard quantum mechanics and the new formalism represent different formulations of classical mechanics.
...
### [37] [From Period Finding to Lattice Sampling: Experimental Insights into Shor's and Regev's Factoring Algorithms](https://arxiv.org/abs/2606.17647)
*Daniela Falcó,Arturo Rodríguez,Guillermo Rivas,Ricardo S. Alonso*

Main category: quant-ph

TL;DR: This paper explores Regev's quantum factoring algorithm on real quantum hardware, comparing its performance with Shor's algorithm under similar conditions to assess their robustness against hardware limitations.


<details>
  <summary>Details</summary>
Motivation: The practical implementation of Shor's algorithm for integer factorization is hindered by the constraints of current quantum hardware, prompting the exploration of alternative algorithms.

Method: An experimental study was conducted on the QMIO quantum computer, comparing Regev's and Shor's algorithms in factoring the integer N = 15, while also contrasting with IBM's quantum computers and ideal simulations.

Result: The study highlights differences in how Shor's and Regev's algorithms encode arithmetic structure, revealing insights into their performance, robustness, and failure modes in the presence of NISQ hardware limitations.

Conclusion: While neither algorithm shows a clear advantage yet in the small N regime, the results contribute to understanding the implications of algorithm design choices in the NISQ context.
...
### [38] [Coherent Control of an Embedded Bound State Without a Spectral Gap](https://arxiv.org/abs/2606.17685)
*Yue Chang*

Main category: quant-ph

TL;DR: This paper presents a method to utilize bound states in the continuum (BICs) for long-lived quantum storage and single-photon control by overcoming limitations related to photon interaction and spectral gap protection.


<details>
  <summary>Details</summary>
Motivation: The research aims to enhance the functionality of BICs, making them viable candidates for applications in quantum storage and photonic control by addressing their inherent limitations.

Method: The authors use a giant atom coupled to a one-dimensional waveguide, implementing two control mechanisms: atomic-frequency modulation for the capture and release of single photons, and coupling modulation to maintain BIC while tuning stored states.

Result: A significant finding is that the embedded state's control can occur adiabatically without a spectral gap, exhibiting a leakage probability that depends linearly on the ramp rate.

Conclusion: The study successfully transforms a dark BIC into a useful single-photon memory, showing that fidelity is managed by intrinsic leakage, thus advancing embedded-state control in photonic systems.
...
### [39] [Optimizing bias-tailored quantum error correction beyond code-capacity noise](https://arxiv.org/abs/2606.17709)
*César Benito,I. Jesán Velázquez-Reséndiz,Alejandro Bermudez*

Main category: quant-ph

TL;DR: Bias-tailored quantum error correction (QEC) benefits diminish under realistic noise models; XZZX codes outperform rectangular surface codes.


<details>
  <summary>Details</summary>
Motivation: To assess the efficacy of bias-tailored quantum error correction under realistic noise models and circuit-level constraints.

Method: Comparative analysis between XZZX codes and rectangular surface codes with bias-dependent anisotropy under code-capacity and circuit-level noise models.

Result: XZZX codes remain advantageous even in the presence of circuit-level noise, while the predicted benefits of rectangular surface codes are negated under these conditions.

Conclusion: Introducing a bias-filtering CNOT gadget can partially recover the advantages of bias-tailored QEC, improving error threshold performance in high-bias, low-idle error scenarios.
...
### [40] [Dimension-Free Approximate Tensorization of Quantum Hypercontractivity for Qudit Depolarizing Semigroups](https://arxiv.org/abs/2606.17729)
*Yangjing Dong,Li Gao,Fengning Ou,Penghui Yao,Haigang Zhou*

Main category: quant-ph

TL;DR: The paper establishes almost tensorization for log-Sobolev constants in reversible quantum Markov semigroups with the PODS property, demonstrating significant relations and bounds between single-site and product semigroups.


<details>
  <summary>Details</summary>
Motivation: To investigate the properties of quantum Markov semigroups, focusing on their hypercontractivity and logarithmic-Sobolev constants, particularly under the positive off-diagonal scaling property.

Method: The authors prove exact tensorization of the $(q,2)$-hypercontractive inequality for integers and extend it through complex interpolation for real values, then link hypercontractivity to logarithmic-Sobolev inequalities to achieve the main results.

Result: For any reversible quantum Markov semigroup in the specified class, the log-Sobolev constant of its tensor power semigroup is bounded by 0.96 times that of the single-site semigroup, regardless of tensor power or dimension.

Conclusion: The findings enhance the understanding of hypercontractive inequalities within quantum Markov semigroups and provide sharp estimates for specific cases like qubit depolarizing channels.
...
### [41] [Cavity method for permutation models on Cayley trees](https://arxiv.org/abs/2606.17751)
*Masayuki Ohzeki*

Main category: quant-ph

TL;DR: This study examines permutation models on Cayley trees inspired by random tensor networks, focusing on class functions on the symmetric group for edge interactions, leading to character eigenvalue analysis and stability criteria.


<details>
  <summary>Details</summary>
Motivation: The research is motivated by the exploration of permutation statistical models that appear in random tensor networks, highlighting the need to understand their behavior on structured graphs like Cayley trees.

Method: The authors analyze permutation models with interactions based on cycle types of permutations, employing class functions to diagonalize edge convolution operators. They relate character eigenvalues to Schur functions for specific weight types and derive stability criteria from this analysis.

Result: The study establishes that the uniform paramagnetic cavity solution's linear stability is determined by the ratios of character eigenvalues, with specific instabilities verified through numerical methods.

Conclusion: The findings deepen the understanding of permutation models in statistical mechanics, particularly in their application to random tensor networks, providing tools for determining stability within these systems.
...
### [42] [Quantum Routers: A Switching-Fabric Framework for Quantum-Native Forwarding](https://arxiv.org/abs/2606.17773)
*Jessica Illiano,Caterina De Risi,Angela Sara Cacciapuoti,Marcello Caleffi*

Main category: quant-ph

TL;DR: The paper proposes a novel quantum router framework using multipartite entanglement to address the limitations of classical switching in quantum networks, introducing the edge-controlled design principle for efficient entanglement forwarding.


<details>
  <summary>Details</summary>
Motivation: Quantum networks face unique challenges due to the no-cloning theorem and measurement postulate, necessitating new switching fabrics distinct from classical methods.

Method: The authors define entanglement-based switching fabrics leveraging graph states and local Pauli measurements, translating classical design concepts into entanglement terms through the edge-controlled (EC) design principle.

Result: Two designs are proposed: a monolithic EC crossbar and a modular Clos-type EC fabric, with a highlighted efficiency regime for the modular approach. An analysis shows constant forwarding depth for EC fabrics versus latency scaling in traditional EPR-based methods.

Conclusion: The proposed framework offers a foundational approach for developing quantum-router switching fabrics that are hardware-agnostic and efficient in entanglement forwarding.
...
### [43] [Engineering entanglement and transport in interacting quantum walks with tailored potentials](https://arxiv.org/abs/2606.17825)
*Gaia Forghieri,Matteo G. A. Paris*

Main category: quant-ph

TL;DR: This paper investigates the dynamics of distinguishable continuous-time quantum walkers on parallel lattices with variable interactions, uncovering four distinct dynamical regimes with implications for quantum transport and information processing.


<details>
  <summary>Details</summary>
Motivation: The study addresses the challenge of controlling particle propagation and quantum correlation in quantum transport systems.

Method: The authors analyze two distinguishable quantum walkers on one-dimensional lattices, examining the effects of distance-dependent potentials on their dynamics.

Result: Four dynamical regimes are identified: high-entropy oscillatory, strongly localized bound-pair, a novel intermediate regime, and weakly interacting free-propagation, with regime (iii) optimizing both transport efficiency and entanglement.

Conclusion: The framework developed can inform the design of interaction-engineered quantum walks for applications in quantum information and simulation.
...
### [44] [Split-Head Quantum Generative Adversarial Network for Crystalline Material Discovery](https://arxiv.org/abs/2606.17852)
*Huan-Ming Chang,Jen-Yu Chang,Tsung-Wei Huang,En-Jui Kuo*

Main category: quant-ph

TL;DR: This study presents a new approach to discovering crystalline materials using a Split-Head Quantum Generative Adversarial Network (SH-QGAN) that improves spatial diversity while maintaining thermodynamic precision.


<details>
  <summary>Details</summary>
Motivation: The discovery of novel crystalline materials faces challenges due to limitations in classical generative models, especially regarding spatial representation and hardware capabilities.

Method: The paper introduces a Split-Head architecture that separates macroscopic and microscopic data representation within a Quantum GAN framework, and evaluates its performance against a classical model.

Result: The SH-QGAN demonstrates superior structural breadth and latent space exploration, significantly exceeding the geometric validity of the classical model, which shows better thermodynamic precision.

Conclusion: The study concludes that while architectural separation enhances thermodynamic accuracy, the quantum feature mapping facilitates the necessary spatial diversity for generating novel materials.
...
### [45] [Experimental Characterization and Modeling of Measurement-Induced State-Transitions in a Fluxonium Superconducting Qubit](https://arxiv.org/abs/2606.17866)
*Martijn F. S. Zwanenburg,Jinlun Hu,Eugene Y. Huang,Figen Yilmaz,Siddharth Singh,Christian Kraglund Andersen*

Main category: quant-ph

TL;DR: This study investigates measurement-induced state transitions (MIST) in superconducting fluxonium qubits during readout, detailing its dependence on external flux and highlighting theoretical and experimental correlations.


<details>
  <summary>Details</summary>
Motivation: Understanding and minimizing readout errors in superconducting qubits is crucial for improving measurement fidelity in quantum computing applications.

Method: Experimental characterization of MIST in fluxonium qubits across the external flux range, complemented by numerical calculations of MIST errors.

Result: The study confirms eleven regions of increased MIST, revealing that transitions to higher qubit levels and transmission-line-like modes significantly impact measurement accuracy.

Conclusion: The theoretical predictions align closely with experimental findings, emphasizing the importance of array modes in fluxonium qubit readout errors.
...
### [46] [Frequency upconversion of infrared signals via molecular cavity optomechanical systems with gain](https://arxiv.org/abs/2606.17877)
*Shu-Xian Quan,Fen Zou,Yong Li*

Main category: quant-ph

TL;DR: The paper presents a method to enhance infrared detection sensitivity in molecular cavity optomechanical systems by adding gain to the infrared cavity, significantly improving upconversion efficiency while controlling noise levels.


<details>
  <summary>Details</summary>
Motivation: To enhance infrared detection sensitivity by overcoming conversion efficiency constraints in molecular cavity optomechanical systems.

Method: The proposed scheme involves incorporating gain into the infrared cavity of a system with two cavities and N molecules, aiming to amplify the upconversion process via IR absorption and Raman scattering under red-detuned conditions.

Result: The method allows the upconversion efficiency of the IR signal to approach 1, while the added noise is kept close to 0.5.

Conclusion: The incorporation of gain effectively improves the efficiency of the upconversion process in infrared detection systems without significantly increasing noise.
...
### [47] [Demultiplexing Generalized Information via Quantum Transmission Lines](https://arxiv.org/abs/2606.17894)
*Soham Sau,Anna Jenčová,Tamal Guha*

Main category: quant-ph

TL;DR: This paper introduces a quantum demultiplexer (Q-DEMUX) that enables the perfect routing of classical and quantum information, addressing the transmission challenges within quantum transmission lines.


<details>
  <summary>Details</summary>
Motivation: The motivation is to explore whether classical and quantum information can be perfectly demultiplexed to designated output ports in quantum transmission systems.

Method: The paper introduces the Q-DEMUX device, characterizes its capabilities for perfect routing, and presents circuit realizations.

Result: It establishes a connection between the effectiveness of Q-DEMUX and the incompatibility of quantum instruments.

Conclusion: The findings extend the concept of Q-DEMUX, allowing for scenarios where the sender is unaware of the data's nature.
...
### [48] [Quantum Chip Paradigm Framework](https://arxiv.org/abs/2606.17899)
*Cai,Ling Qiao,Bin Yang,Fumin Luo,WeiGui Guo,GuoRong Zhang,XueFei Liu,Fan Xu,Qinglang Guo,Bin Wu*

Main category: quant-ph

TL;DR: The paper proposes a Quantum Chip Paradigm Framework to transition Q-EDA from experience-based to model-driven design, emphasizing physical structures and co-optimization techniques for scalable quantum chip development.


<details>
  <summary>Details</summary>
Motivation: As quantum chips evolve, existing design methods are inadequate to address the increasing complexity of quantum systems, necessitating a shift to model-driven engineering akin to classical EDA's development.

Method: The proposed framework integrates PCell-based modeling, SPICE-Q simulations, and Quantum PDKs, focusing on starting design with physical structures and co-optimizing various aspects of quantum chip design.

Result: A hierarchical Q-EDA system is outlined, covering everything from physical structures to quantum arithmetic, aiming to create reusable engineering objects for developing scalable quantum processors.

Conclusion: The transition to a model-driven Q-EDA approach will facilitate more robust design methodologies for fault-tolerant quantum computing, addressing the challenges of complex quantum chip environments.
...
### [49] [SPICE-Q and Large-Scale Quantum Chip Production](https://arxiv.org/abs/2606.17907)
*Cai,Ling Qiao,Bin Yang,Fumin Luo,Chang Liu,WeiGui Guo,GuoRong Zhang,XueFei Liu,Qinglang Guo,Bin Wu*

Main category: quant-ph

TL;DR: SPICE-Q is a unified design-technology co-optimization framework for superconducting quantum processors that connects existing simulation tools through a comprehensive data flow, addressing numerous factors that influence processor performance and manufacturability.


<details>
  <summary>Details</summary>
Motivation: To improve superconducting quantum processor design by creating a cohesive framework that integrates various simulation and analysis tools, enabling a comprehensive understanding of the device's performance and manufacturability.

Method: SPICE-Q integrates tools for process rules, layout, electromagnetic simulation, and noise analysis into a unified framework, utilizing standardized interfaces and a continuous data chain from device physics to manufacturing.

Result: The framework accounts for critical factors such as Josephson-junction variability, resonator constraints, and material losses, providing a systematic approach to quantum chip design and performance optimization.

Conclusion: Scalable and fault-tolerant quantum processors require an integrated engineering workflow that captures the entire design process to ensure high performance, manufacturability, and yield.
...
### [50] [Twin-beam advantage in quantum LiDAR under correlated noise](https://arxiv.org/abs/2606.17908)
*Valeria Cimini*

Main category: quant-ph

TL;DR: The study explores the effectiveness of various quantum light states in optical remote sensing under realistic noise, particularly in LiDAR systems, revealing that entangled states outperform others in certain noise conditions.


<details>
  <summary>Details</summary>
Motivation: To determine how nonclassical light resources, specifically entangled states, perform in realistic noise scenarios relevant to LiDAR systems.

Method: Joint estimation of target range and velocity using two-mode Gaussian probes, with comparison of coherent, separable squeezed, and twin-beam states via homodyne detection.

Result: Separable squeezing outperforms coherent illumination under loss and thermal noise, while twin-beam states excel under correlated interference with optimized receivers.

Conclusion: Correlated noise provides an operational advantage for entanglement, suggesting a pathway to quantum-enhanced LiDAR that is robust against realistic disturbances.
...
### [51] [Fabless Quantum Chip Design and Commercial Production](https://arxiv.org/abs/2606.17956)
*Cai,Ling Qiao,Bin Yang,Fumin Luo,WeiGui Guo,GuoRong Zhang,XueFei Liu,Qinglang Guo,Bin Wu*

Main category: quant-ph

TL;DR: This paper introduces a fabless architecture for superconducting quantum chip design using the SPICE-Q simulation framework, emphasizing standardized processes and reusable components for scalability and efficiency.


<details>
  <summary>Details</summary>
Motivation: To advance the development of superconducting quantum computing by transitioning from a vertically integrated model to a fabless-foundry ecosystem.

Method: The proposed architecture integrates quantum process design kits (PDKs), parameterized device cells, SPICE-Q simulation, and automated Q-EDA flows while ensuring standardized and verified production processes.

Result: The framework reduces the time and effort spent on device debugging and layout, offering a path to scalability in quantum hardware manufacturing, contingent on factors like PDK maturity and foundry yield.

Conclusion: A shift towards a fabless-foundry model for quantum chip design is feasible, supported by standardization and reusable components, potentially enhancing manufacturing efficiency and market viability.
...
### [52] [Manipulation of Topological Corner States via Subchiral Symmetry](https://arxiv.org/abs/2606.17975)
*Hai-Tao Ding,Tianqi Chen,Leong-Chuan Kwek,Jiangbin Gong*

Main category: quant-ph

TL;DR: The paper demonstrates a method for controlling topological corner modes using subchiral symmetry, enabling the manipulation of individual modes and their superpositions in higher-order topological phases.


<details>
  <summary>Details</summary>
Motivation: To utilize higher-order topological phases effectively, it's essential to create, isolate, and transfer corner modes efficiently.

Method: The study leverages the Benalcazar-Bernevig-Hughes model, breaking down conventional chiral symmetry into subchiral symmetries, and implements protocols for transferring corner states via controlled intercell hoppings and adiabatic processes.

Result: Numerical simulations and IBM quantum-processor implementations confirm high-fidelity execution of the proposed protocols for manipulating corner states.

Conclusion: Subchiral symmetry offers a viable framework for programmable manipulation of higher-order topological states.
...
### [53] [Emergent de Sitter Space and Non-Unitary Tensor Networks from Non-Hermitian Quantum Criticality](https://arxiv.org/abs/2606.17983)
*Kuang-Hung Chou,Po-Yao Chang*

Main category: quant-ph

TL;DR: This paper proposes a framework connecting boundary entanglement and emergent de Sitter spacetime using a novel non-unitary continuous multi-scale entanglement renormalization ansatz (cMERA). It reveals a distinct tensor-network architecture linked to geodesics that reflects the Ryu-Takayanagi surfaces, emphasizing a new approach to quantum gravity.


<details>
  <summary>Details</summary>
Motivation: The need to extend the holographic principle to de Sitter spacetimes remains a significant challenge in quantum gravity, where a clear relationship between boundary quantum information and emergent geometries is yet to be established.

Method: The authors develop a non-unitary continuous multi-scale entanglement renormalization ansatz (cMERA) applied to a non-Hermitian critical fermion chain to derive the structure of emergent de Sitter spacetime from boundary entanglement, analyzing the geodesics as extremal Ryu-Takayanagi surfaces.

Result: The analysis shows that the geodesics represent a smooth transition from timelike to null, leading to a unique tensor-network architecture with a bond-counting contribution that truncates at this transition, enabling identification of zero-cost links along the horizon.

Conclusion: The findings establish the dS/(c)MERA correspondence, linking emergent geometries and holographic entanglement at both continuum spacetime and discrete levels.
...
### [54] [Approximately Decoding the Colour Code](https://arxiv.org/abs/2606.18035)
*Mark Walters*

Main category: quant-ph

TL;DR: This paper demonstrates a polynomial-time approximation algorithm for minimum weight decoding in (6.6.6) planar color codes, proving it is feasible to find near-optimal solutions efficiently.


<details>
  <summary>Details</summary>
Motivation: The motivation stems from the NP-hardness of minimum weight decoding in color codes, raising the need to explore feasible approximation methods.

Method: The authors present a polynomial-time algorithm that approximates the weight of error sets generating a given syndrome within a factor of $1 + \varepsilon$ compared to the optimal solution.

Result: The algorithm allows for correction of errors up to almost the theoretical limit of $d/2$ in distance $d$ color codes, despite the large polynomial size.

Conclusion: While the polynomial is large and impractical, the result confirms that approximate decoding can be achieved efficiently and is not NP-hard.
...
### [55] [Full-state information-disturbance tradeoff for direction estimation with antiparallel spin-coherent pairs](https://arxiv.org/abs/2606.18040)
*Massimiliano F. Sacchi*

Main category: quant-ph

TL;DR: This paper establishes the optimal tradeoff between information gain and disturbance in estimating the direction of two antiparallel spins using a finite-dimensional Choi problem framework.


<details>
  <summary>Details</summary>
Motivation: The study aims to find an optimal approach for estimating spatial directions encoded in antiparallel spins while minimizing disturbance during measurement.

Method: The optimization is reduced to a finite-dimensional Choi problem; the optimal instrument is characterized using kernel vectors of the dual slack operator and involves a covariant filter with scalar-vector coherence.

Result: The findings indicate that the optimal operation outperforms existing methods for both maximum information and minimal disturbance, particularly focusing on antiparallel spins.

Conclusion: The results extend to antiparallel spin-coherent states of arbitrary spin, where information and disturbance are analyzed in relation to nearest-neighbor sector coherences.
...
### [56] [Quantum statistical enhancement of collective behaviour in a bosonic active Ising model](https://arxiv.org/abs/2606.18091)
*Kian L. Assent,Emil Strauch,Sabine H. L. Klapp,André Eckardt,Alexander Schnell*

Main category: quant-ph

TL;DR: This paper introduces a one-dimensional quantum variant of the active Ising model (AIM) focusing on the enhanced collective behaviors like flocking and aster formation due to bosonic statistics, contrasting it with previous studies.


<details>
  <summary>Details</summary>
Motivation: The study aims to explore the emergent phenomena of collective behavior, like flocking and aster formation, in quantum systems, extending the classical active Ising model to a quantum lattice framework.

Method: A one-dimensional quantum lattice model based on ideal bosons with a spin degree of freedom is formulated to investigate these phenomena.

Result: The investigations reveal that bosonic quantum statistics significantly enhance both flocking and aster formation compared to classical counterparts, while a recent study on hard-core bosons did not observe these effects.

Conclusion: The paper concludes that the quantum statistical stabilization of collective phases competes with suppression due to quantum fluctuations, particularly in the presence of a transverse external magnetic field.
...
### [57] [Stochastic signal sensing with finite energy and dead time at the fundamental quantum limit](https://arxiv.org/abs/2606.18133)
*James W. Gardner,Tuvia Gefen,Matteo Fadel*

Main category: quant-ph

TL;DR: This study examines the limitations of state preparation and measurement in quantum metrology, establishing that two-mode squeezed vacuum states are optimal under finite energy constraints and demonstrating the essential role of entanglement for achieving quantum limits.


<details>
  <summary>Details</summary>
Motivation: To understand the impact of finite time and energy constraints on optimal quantum metrology protocols, particularly in sensing stochastic signals related to fundamental physics.

Method: The authors analyze the use of two-mode squeezed vacuum states for incoherent sensing problems and investigate the transition between non-Gaussian and Gaussian states with respect to dead time and loss.

Result: The findings indicate that two-mode squeezed vacuum is optimal under energy constraints, and that entanglement is necessary to reach the quantum limit in gain estimation.

Conclusion: These results have implications for practical applications in quantum sensing technologies, particularly in the context of detecting ultralight dark matter and enhancing acoustic wave resonators.
...
### [58] [A polynomial-time approximation scheme for minimum-weight decoding of topological codes](https://arxiv.org/abs/2606.18145)
*Shouzhen Gu,Lily Wang,Aleksander Kubica*

Main category: quant-ph

TL;DR: This paper demonstrates that minimum-weight decoding for 2D topological translationally invariant codes can be approximated in polynomial time despite its NP-hard status.


<details>
  <summary>Details</summary>
Motivation: Understanding the decoding problem of 2D TTI stabilizer codes is crucial for fault-tolerant quantum computation, yet minimum-weight decoding is NP-hard in many instances.

Method: The authors develop a polynomial-time approximation scheme (PTAS) by leveraging techniques from Arora's PTAS for Euclidean problems, particularly applicable to decoding via point-like excitations and string-like errors.

Result: A PTAS is established for 2D TTI codes, allowing for recovery operators that are close to optimal in polynomial time, applicable to various topological codes and higher-dimensional scenarios.

Conclusion: The findings expand the feasibility of decoding strategies in quantum error correction, broadening their application in both 2D and higher-dimensional quantum systems.
...
### [59] [Closest Accessible Symmetry reduction: a tool for Hamiltonian interpolation analysis](https://arxiv.org/abs/2606.18161)
*Ana Palacios,Artur Garcia-Saez,Arnau Riera,Marta P. Estarellas*

Main category: quant-ph

TL;DR: A novel framework for analyzing Hamiltonian interpolations via accessible symmetries, enhancing insights into quantum phase transitions without excessive discretization.


<details>
  <summary>Details</summary>
Motivation: To analyze Hamiltonian interpolations effectively, reducing reliance on discretized parameters and gaining a deeper understanding of quantum phase transitions.

Method: The framework employs accessible symmetries to project interpolation Hamiltonians onto relevant sectors, yielding a hierarchy of pseudo-eigenspaces with residual couplings.

Result: The method captures qualitative characteristics of quantum phase transitions and estimates their locations while providing insights into their nature.

Conclusion: The approach, inspired by adiabatic quantum computation, has broader implications for studying Hamiltonian phase diagrams and reveals spectral reorganization in many-body quantum systems.
...
### [60] [Optimal Calibration of Quantum Network Links](https://arxiv.org/abs/2606.18167)
*Vinay Kumar,Claudio Cicconetti,Marco Conti,Andrea Passarella*

Main category: quant-ph

TL;DR: The paper develops a protocol for optimizing activation periods in quantum networks, addressing entanglement recalibration to balance link quality and availability.


<details>
  <summary>Details</summary>
Motivation: The need for reliable entanglement distribution in quantum networks, despite degradation due to environmental changes.

Method: An analytical protocol for assigning activation periods in linear quantum repeater chains is proposed, extending to general networks with multiple paths.

Result: Simulations of the heuristic approach are compared with a numerical method and theoretical limits to demonstrate effectiveness.

Conclusion: The proposed optimization protocol effectively manages the trade-off between entanglement quality and link usability in quantum networks.
...
### [61] [Optimal Probe State for Phase Estimation Under Covariant Measurement](https://arxiv.org/abs/2606.18169)
*Qipeng Qian,Christos N. Gagatsos*

Main category: quant-ph

TL;DR: This study optimizes input states for phase estimation using covariant measurements, connecting Fock coefficients to optimal states via Toeplitz matrices and demonstrating Heisenberg scaling.


<details>
  <summary>Details</summary>
Motivation: To enhance phase estimation accuracy through optimization of input states under covariant measurements.

Method: Utilizing Holevo's framework and analyzing a Toeplitz matrix defined by a 2π-periodic cost function to determine optimal Fock coefficients for phase estimation.

Result: Derivation of a necessary and sufficient condition for optimal input states, leading to an explicit lower bound for average cost that approaches zero in the infinite-energy limit; closed-form solutions for specific cost functions yield optimal states and costs.

Conclusion: The study establishes a link between input states and covariant measurements, demonstrating Heisenberg scaling and providing explicit expressions for the optimal average cost.
...
### [62] [Learning Arbitrary Lindbladians with Quantum Error Correction](https://arxiv.org/abs/2606.18188)
*Nikita Romanov,Petr Ivashkov,Weiyuan Gong,Ishaan Kannan,Andi Gu,Hong-Ye Hu,Susanne F. Yelin*

Main category: quant-ph

TL;DR: This paper presents an algorithm for reconstructing the generator of open quantum systems without prior knowledge, overcoming information-theoretic limits with a novel approach.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of learning the dynamics of open quantum systems without predefined structures of Hamiltonians or dissipators, which current methods fail to do effectively.

Method: The authors develop a standard-quantum-limited algorithm for arbitrary sparse Lindbladians, utilizing a recursive random stabilizer-code construction to manage the complexities of unknown interactions and dissipation effects.

Result: The framework achieves Heisenberg-limited learning of Hamiltonian components disjoint from the dissipator while reaching the standard quantum limit for other components, showcasing its effectiveness in ansatz-free contexts.

Conclusion: This work establishes a scalable and efficient method for characterizing unknown open quantum systems, leveraging quantum error correction as a fundamental component.
...
### [63] [Einstein-Podolsky-Rosen correlations between mechanical oscillators revealed through SU(1,1) interferometry](https://arxiv.org/abs/2606.18202)
*Max-Emanuel Kern,Stefano Marti,Raquel Garcia-Belles,Andraz Omahen,Igor Kladaric,Arianne Brooks,Yiwen Chu,Matteo Fadel*

Main category: quant-ph

TL;DR: This paper presents the experimental observation of continuous-variable Einstein-Podolsky-Rosen correlations in macroscopic mechanical oscillators, demonstrating quantum correlations stronger than entanglement.


<details>
  <summary>Details</summary>
Motivation: To investigate quantum correlations at macroscopic scales, challenging our understanding of quantum and classical boundaries.

Method: The study used two spatially-separated mechanical oscillators coupled to a superconducting qubit to engineer a two-mode squeezing interaction, employing a mechanical SU(1,1) interferometer for quantum correlation detection.

Result: Successful observation of continuous-variable EPR correlations in oscillators with effective masses of ~16 μg, realizing quantum correlations stronger than entanglement.

Conclusion: These findings enhance circuit quantum acoustodynamics capabilities and elucidate the transition between quantum and classical realms.
...
### [64] [Impulse Decoding of Quantum LDPC Codes: Equivalence of Degeneracy and Code-Shortening](https://arxiv.org/abs/2606.18240)
*Shobhit Bhatnagar,Michele Pacenti,Nithin Raveendran,David Declercq,Bane Vasić*

Main category: quant-ph

TL;DR: The paper explores quantum error correction, focusing on degeneracy in the Calderbank-Shor-Steane framework, linking it to classical code shortening, and introduces an efficient parallel decoding scheme that outperforms existing methods.


<details>
  <summary>Details</summary>
Motivation: To address the gap in understanding the classical significance of degeneracy in quantum error correction and improve decoding strategies.

Method: Introduces impulse decoding for quantum low-density parity-check codes, leveraging the concept of degeneracy related to classical code shortening, and presents an additional algorithm for residual error decoding.

Result: Impulse decoding significantly outperforms belief propagation and other techniques in terms of performance, complexity, and noise resilience.

Conclusion: The combination of impulse decoding and residual error decoding enhances performance in quantum error correction under circuit-level noise.
...
### [65] [Searching for axion dark matter conversion spectral lines in neutron star magnetospheres with FAST](https://arxiv.org/abs/2606.17067)
*Sinuo Gao,Chen Wang,Maoyuan Liu*

Main category: astro-ph.HE

TL;DR: This study uses the FAST telescope to search for axion-conversion spectral lines in isolated neutron stars, establishing new upper limits on the axion-photon coupling constant.


<details>
  <summary>Details</summary>
Motivation: To probe dark matter candidates, particularly axions, through astrophysical observations rather than laboratory experiments.

Method: Observations were conducted using FAST on two X-ray dim isolated neutron stars, focusing on axion-conversion spectral lines predicted in their magnetospheres.

Result: No significant detection was made, but new upper limits on the axion-photon coupling constant were determined as g_{a gamma gamma} < 5 x 10^{-12} GeV^{-1} for specific axion masses.

Conclusion: The study provides the tightest constraints within the examined axion mass range using the ACL-based method.
...
### [66] [What an Amortized X-ray Posterior Cannot See: Gain Shifts, Silent Miscalibration, and Where Nested Sampling Still Earns Its Cost](https://arxiv.org/abs/2606.17098)
*Karan Akbari*

Main category: astro-ph.HE

TL;DR: Neural posterior estimation (NPE) serves as a rapid alternative to nested sampling for X-ray spectral fits, but lacks certain calibration guarantees. This study benchmarks NPE against one real X-ray response using a posterior-predictive check to identify model misspecifications and evaluate calibration accuracy.


<details>
  <summary>Details</summary>
Motivation: To assess the calibration and goodness-of-fit of Neural Posterior Estimation (NPE) compared to nested sampling for analyzing X-ray spectra, particularly focusing on simulation-based inference diagnostics.

Method: The study benchmarks NPE against a real XMM-Newton EPIC-pn response across various count regimes, using nested sampling as a reference. It evaluates model performance through posterior-predictive checks and recovery metrics under different misspecifications.

Result: A posterior-predictive check identified an unmodelled 6.4 keV line (ROC AUC 0.97, significant bias on photon index for bright counts). A 3% detector gain shift remained undetected by most scores but was flagged by nested sampling.

Conclusion: While NPE improves speed, it lacks calibration certainty without evidence-based checks, highlighting the necessity of ensuring model reliability even in fast inference methods.
...
### [67] [Constraints on Late-Time Flaring from Luminous Fast Blue Optical Transients using the Transiting Exoplanet Survey Satellite and the Zwicky Transient Facility](https://arxiv.org/abs/2606.17129)
...
TL;DR: This paper examines optical flares from LFBOT AT2022tsd and similar transients, analyzing data from TESS and ZTF to conclude that observed flares likely stem from solar system objects.


<details>
  <summary>Details</summary>
Motivation: To understand the nature of optical flares associated with LFBOTs and evaluate the engine activity behind these transients.

Method: Data from TESS and ZTF was used to identify and analyze flare signals in known LFBOTs, focusing on their timing and luminosity.

Result: Seven flare-like signals were detected, attributed to solar system objects, leading to the conclusion of a decline in engine power for AT2022tsd after its initial event.

Conclusion: The study sets constraints on the flaring activity and suggests no significant late-time flaring in AT2018cow, impacting estimates of future flare detection.
...
### [68] [Optical polarization variability and its relation to gamma-ray activity in blazars](https://arxiv.org/abs/2606.17156)
*Styliana Grigoriou,Anastasia Glykopoulou,Ioannis Liodakis*

Main category: astro-ph.HE

TL;DR: This study analyzes the relationship between gamma-ray activity and optical polarization in blazars, finding no correlation and evidence for multiple emission mechanisms.


<details>
  <summary>Details</summary>
Motivation: To investigate the link between gamma-ray activity and polarization variability in blazars, large-scale observations are utilized to enhance understanding of these high-energy phenomena.

Method: The research synthesizes data from three blazar monitoring programs to create light curves for 15 blazars, examining the correlation between gamma-ray flux and polarization variance, and documenting polarization angle rotations.

Result: The analysis reveals 64 rotations in polarization angles across 12 blazars; the polarization degree does not correlate with gamma-ray flux in individual sources or subsamples, suggesting diverse emission mechanisms.

Conclusion: The findings indicate that while a trend exists for lower polarization during angle rotations, some sources show indistinguishable polarization distributions, reinforcing the hypothesis of multiple emission mechanisms.
...
### [69] [QPO-like Signatures and Hydrodynamical Variability in Accretion around a JNW-type Compact Spacetime in Freund-Nambu Scalar-Tensor Gravity](https://arxiv.org/abs/2606.17157)
*Orhan Donmez,M. Yousaf,G. Mustafa*

Main category: astro-ph.HE

TL;DR: This study presents an exact solution in scalar-tensor gravity, revealing significant changes in shock-cone behavior and oscillatory modes due to scalar deviations, particularly relevant to black-hole-candidate systems.


<details>
  <summary>Details</summary>
Motivation: To explore extensions of general relativity via scalar-tensor theories, focusing on new geometries and their astrophysical implications.

Method: Introduced a new exact solution in Freund-Nambu scalar-tensor gravity and numerically solved hydrodynamic equations for Bondi-Hoyle-Lyttleton accretion near compact spacetimes.

Result: Demonstrated that stronger scalar deviations alter shock-cone structure, increase matter accumulation, and lead to distinct oscillatory behavior, producing QPO-like frequencies in the range of stellar-mass black-hole candidates.

Conclusion: The findings indicate that variations in hydrodynamics around FNST compact spacetimes offer insights into scalar-field effects compared to traditional Schwarzschild solutions.
...
### [70] [Discovery of a Supernova Following the Einstein Probe Transient EP250302a at z = 1.131](https://arxiv.org/abs/2606.17170)
...
TL;DR: The study analyzes the FXT EP250302a, emphasizing its bright optical and X-ray emissions without corresponding gamma-ray detection, and suggests a supernova association.


<details>
  <summary>Details</summary>
Motivation: To understand the characteristics and implications of the fast X-ray transient EP250302a at redshift z=1.131, particularly its association with massive star deaths.

Method: Conducted multi-wavelength observations (X-ray and optical), analyzed chromatic flaring, and modeled jet dynamics to derive constraints on Lorentz factors while comparing late-time imaging to known supernova emissions.

Result: Identified a luminescent source with chromatic flaring, established a requirement for an ultrarelativistic jet, and observed late-time optical excess consistent with the broad-lined Ic supernova 1998bw, suggesting a significant association with massive star deaths.

Conclusion: The findings support the hypothesis that most EP FXTs are related to the deaths of massive stars, enhancing the understanding of their nature and implications.
...
### [71] [The properties of tidal disruption event infrared counterparts produced by dust rings and inference of the observing angle](https://arxiv.org/abs/2606.17230)
*Rob A. J. Eyles-Ferris*

Main category: astro-ph.HE

TL;DR: This paper presents a model for infrared counterparts of tidal disruption events (TDEs) caused by dust in a ring formation, showing how this arrangement alters observed emissions and properties compared to traditional spherical shell models.


<details>
  <summary>Details</summary>
Motivation: To reconcile observational discrepancies regarding infrared counterparts of TDEs, particularly the angular dependence of X-ray and optical emissions.

Method: Introduces a toy model where dust is arranged in a ring, analyzing how this affects IR luminosity and emission patterns based on observing angle.

Result: Demonstrates that the ring model produces brighter infrared counterparts at on-axis angles and can account for delayed emissions and double-peaked structures at off-axis angles.

Conclusion: The ring model successfully explains the properties of two observed IR counterparts, constraining their observing angles and suggesting implications for quasi-periodic eruptions.
...
### [72] [Can a Slow and Strong Phase Transition in Neutron Stars Relieve Major Compact-Star Observation Tensions?](https://arxiv.org/abs/2606.17231)
*Chen Zhang*

Main category: astro-ph.HE

TL;DR: The paper explores neutron stars with a strong hadron-quark phase transition to reconcile anomalous observations of compact stars with current mass and radius constraints.


<details>
  <summary>Details</summary>
Motivation: Recent observations of compact stars suggest the need for new models beyond the conventional neutron-star paradigm, particularly regarding mass and radius discrepancies.

Method: The authors employ a piecewise-polytropic model and speed-of-sound parametrization to analyze a broad range of equations of state (EOS) that include both hadronic and hybrid branches of neutron stars.

Result: Two viable scenarios emerged: the first scenario provides a single EOS accommodating all observed masses and radii; the second scenario divides the transition strengths across different branches, maintaining compatibility with observed data.

Conclusion: A strong hadron-quark phase transition in neutron stars may resolve existing observations and constraints, suggesting complex structures that could enhance our understanding of stellar physics.
...
### [73] [GRB 250424A: A Case Study of Energy Injection with Multiwavelength Observations](https://arxiv.org/abs/2606.17444)
...
TL;DR: A multiwavelength analysis of GRB 250424A reveals a shallow decay phase in its afterglow, linked to continuous energy injection from a relativistic shock model without a distinct supernova component.


<details>
  <summary>Details</summary>
Motivation: To analyze the long-duration gamma-ray burst GRB 250424A using a comprehensive dataset from prompt emission to optical monitoring for insights into its afterglow behavior.

Method: Utilized multiwavelength data, including spectra from the Keck 10 m telescope, to model light curves and spectral energy distributions, applying a relativistic shock model for interpretation.

Result: Observations indicate a simultaneous shallow decay phase in X-ray and optical bands, a transition to standard decay, and a successful model yielding kinetic energy of $E_{\rm K,iso} \approx 5.5 \times 10^{52}$ erg with an injection index of $q \approx 0.34$.

Conclusion: The afterglow evolution is explained within the framework of a relativistic forward shock with energy injection, and no clear supernova component was identified despite late-time observations.
...
### [74] [A Joint Optimal Search for Gravitational Waves from Resolved and Unresolved Supermassive Binary Black Holes with Pulsar Timing Arrays](https://arxiv.org/abs/2606.18241)
*Boris Goncharov,Gabriela Sato-Polito,Xiaoming Bi,Matias Zaldarriaga*

Main category: astro-ph.HE

TL;DR: This paper develops a model linking the gravitational wave background (GWB) to supermassive black hole binaries (SMBHBs), introducing a detection statistic and applying it to simulated NANOGrav data. It reveals tensions with certain SMBHB candidates and calculates probabilities for future detection.


<details>
  <summary>Details</summary>
Motivation: The study aims to enhance understanding of the gravitational wave background and its relation to supermassive black hole binaries, critical for astrophysical insights and detection methodologies.

Method: A joint model of the GWB and resolvable SMBHB sources is formulated, using simulated NANOGrav 15-year data to derive constraints on SMBHB strain amplitudes and calculate detection probabilities.

Result: The analysis reveals tensions with 21 out of 114 SMBHB candidates and estimates a 2% detection probability for isolated SMBHBs at an SNR of 5, increasing to 5% in projected future data.

Conclusion: The findings will inform SMBHB population characteristics and enhance gravitational wave detection strategies, especially as new data becomes available.
...
### [75] [Revisiting Disk Winds in Active Galactic Nuclei as an Origin of Cosmic Gamma-ray and Neutrino Backgrounds](https://arxiv.org/abs/2606.17490)
*Nobuyuki Sakai,Yoshiyuki Inoue,Ellis R. Owen*

Main category: astro-ph.HE

TL;DR: The study investigates the contributions of AGN disk winds to the cosmic neutrino and gamma-ray backgrounds, finding they play a minor role and suggesting future observational targets.


<details>
  <summary>Details</summary>
Motivation: The uncertainty in the origins of the cosmic neutrino background (CNB) and cosmic gamma-ray background (CGB) prompts a reassessment of AGN disk winds as a source.

Method: A lepto-hadronic wind model was developed and calibrated using radio and GeV gamma-ray data from Seyfert galaxies, incorporating recent constraints on wind parameters.

Result: The analysis indicates that disk winds contribute no more than 5% to the CGB above 10 GeV and 10% to the CNB around 100 TeV.

Conclusion: Disk winds are unlikely to dominate the CNB or CGB, and nearby Seyfert galaxies with ultrafast outflows should be prioritized for future high-energy observations.
...
### [76] [Effects of Rotation on the Gravitational Tug-Boat Mechanism for Neutron-Star Kicks and Implications for Spin-Kick Alignment](https://arxiv.org/abs/2606.17496)
*Yiming Lu,Eric G. Blackman*

Main category: astro-ph.HE

TL;DR: This study investigates how initial stellar rotation influences spin-kick alignment in neutron stars resulting from core-collapse supernovae, primarily through the tug-boat mechanism.


<details>
  <summary>Details</summary>
Motivation: To understand the origin of natal kicks in neutron stars, which are not well explained by current theories, particularly regarding their spin-kick alignment.

Method: The authors extend a previous model of the tug-boat mechanism by incorporating the effects of initial stellar rotation on the asymmetry of the ejecta.

Result: The analysis reveals that the spin-kick angle depends on the shock expansion time relative to the rotation period, and the direction of the mass distribution relative to the spin-axis, with strong rotation significantly affecting kick alignment under certain conditions.

Conclusion: Effective spin-kick alignment requires either significantly high rotation speeds or a naturally spin-aligned mass flux asymmetry; otherwise, the standard tug-boat mechanism may not account for observed spin-kick distributions.
...
### [77] [A MUSE View of the Optical Torus within the Supernova Remnant 1E 0102.2-7219](https://arxiv.org/abs/2606.17563)
...
TL;DR: The study uses advanced MUSE observations to analyze the optical torus around a Central Compact Object in a supernova remnant, revealing complex morphology and multiple emission phases.


<details>
  <summary>Details</summary>
Motivation: To improve spatial resolution of the optical torus surrounding a central object in the supernova remnant 1E 0102.2-7219, enhancing understanding of its structure and composition.

Method: Utilized MUSE Narrow Field Mode with Adaptive Optics observations to achieve high spatial resolution, enabling detailed analysis of the emission structure and line ratios.

Result: The observations revealed a cavity-like torus structure with continuous velocity connectivity, varying line widths, and multiple ionized species, indicating a multiphase medium.

Conclusion: Results suggest that a combination of shock interactions and other mechanisms influence the observed morphology and excitation of the emission, challenging single-component models.
...
### [78] [A catalogue of TeV pulsar environments](https://arxiv.org/abs/2606.17690)
*Tina Wach,Tim Linden,Alison M. W. Mitchell,Samuel T. Spencer*

Main category: astro-ph.HE

TL;DR: This paper presents a comprehensive catalogue of TeV gamma-ray properties of pulsar environments, drawing on data from major observatories to enhance understanding of their evolutionary characteristics and implications for particle transport models.


<details>
  <summary>Details</summary>
Motivation: To understand the diverse gamma-ray properties of pulsars and their environments and to provide a uniform dataset for future research.

Method: Data collection from H.E.S.S., MAGIC, VERITAS, HAWC, and LHAASO, cross-matched with pulsar properties from the ATNF and Fermi-LAT catalogues, resulting in a catalogue of 128 gamma-ray sources associated with 66 pulsars.

Result: The catalogue shows that TeV-detected pulsars are primarily young and energetic, with weak correlation between TeV luminosity and pulsar age, suggesting environmental effects are crucial.

Conclusion: The catalogue lays a foundation for future studies on pulsar populations and models of particle transport in their environments.
...
### [79] [Effective description of lensed gravitational waves diffracted by stellar fields](https://arxiv.org/abs/2606.17765)
*Miguel Zumalacárregui,Xikai Shan*

Main category: astro-ph.HE

TL;DR: The paper presents models for Reduced-Order Stochastic Diffraction (ROSD) to analyze gravitational wave (GW) signals affected by microlensing, using wave-optics simulations and singular value decomposition to enhance detection of distant compact binary mergers.


<details>
  <summary>Details</summary>
Motivation: To better interpret gravitational wave observations affected by microlensing from stellar fields, which distort signals and can provide insights into gravitational magnification and the presence of small-scale objects.

Method: Novel models for Reduced-Order Stochastic Diffraction (ROSD) are developed from numerical simulations, employing singular value decomposition to create an optimized basis for modeling microlensing distortions and yielding a probability density function for coefficients.

Result: The models successfully synthesize insights from simulations, allowing for characterization of microlensing effects and their impact on gravitational wave signals, thereby optimizing the analysis process.

Conclusion: ROSD models offer a new approach to investigate small-scale gravitational lensing effects, enhancing the detection of distant compact binary mergers and aiding in the study of stellar remnants and dark matter.
...
### [80] [An atypical X-ray variability component in the black hole candidate AT2019wey](https://arxiv.org/abs/2606.17976)
...
TL;DR: This study identifies and characterizes an imaginary quasi-periodic oscillation (QPO) in the black hole X-ray binary AT2019wey, adding to the understanding of timing features during state transitions in BHXBs.


<details>
  <summary>Details</summary>
Motivation: To explore the presence and characteristics of imaginary QPOs in black hole X-ray binaries (BHXBs), particularly in relation to recent observations of timing features during state transitions.

Method: Analysis of five years of NICER observations of BHXB AT2019wey during its low-hard and hard-intermediate states to identify QPOs in the cross spectrum.

Result: An imaginary QPO was found in AT2019wey with frequency and phase lag variations; these findings correlate with those in other BHXBs, establishing AT2019wey as the fifth known instance of such a QPO.

Conclusion: While a connection to type-C QPOs was suggested, the inclination dependence of phase lags in imaginary QPOs remains an unresolved question.
...
### [81] [Kes 75 with IXPE: Detection of Nebular X-ray Polarization and Change in Pulsar Lightcurve](https://arxiv.org/abs/2606.17980)
...
TL;DR: This study presents X-ray polarization measurements of the PSR/PWN complex in SNR Kes 75, revealing a significant polarization degree and suggesting a toroidal magnetic field.


<details>
  <summary>Details</summary>
Motivation: To understand the magnetic field structure and polarization characteristics in the PSR/PWN complex within SNR Kes 75.

Method: Conducted two X-ray polarization observations using IXPE, measuring polarization degree and angle across different phases.

Result: Significant phase-average polarization of 9.9% indicating a toroidal field, with an additional pulsed component detected during the first observation.

Conclusion: Further observations are recommended to clarify the nature of the anomalous pulse and establish a more comprehensive understanding of the system.
...
### [82] [Galaxy-cluster-stacked Fermi-LAT, part IV: $\sim70$ GeV WIMP annihilation lines](https://arxiv.org/abs/2606.17044)
*Uri Keshet*

Main category: astro-ph.HE

TL;DR: The study examines velocity-dependent annihilation signals from WIMP dark matter using cross-correlations in galaxy clusters, identifying emission lines in Fermi-LAT data and suggesting potential channels of WIMP interactions.


<details>
  <summary>Details</summary>
Motivation: To derive constraints on WIMP dark matter annihilation using observational data from galaxy clusters and improve signal detection methods.

Method: Cross-correlated $γ$-rays from Fermi-LAT with eROSITA maps and stacked cluster catalogs to identify emission lines.

Result: Three emission lines around 70, 40, and 13 GeV were detected, aligning with expected WIMP annihilation channels, showing notable significance from multiple analyses.

Conclusion: The findings indicate potential WIMP annihilation processes and support the presence of dark matter, with implications for the understanding of WIMP properties.
...
### [83] [MeV Gamma-Ray Lines from Radioactive Nuclei in Magnetar Giant Flares](https://arxiv.org/abs/2606.17997)
*Wu-Zimo Qiumu,Meng-Hua Chen,Qiu-Hong Chen,Fei Xie,Hou-Jun Lv,Xiang-Gao Wang,En-Wei Liang*

Main category: astro-ph.HE

TL;DR: This study explores the role of magnetar giant flares in the r-process nucleosynthesis and gamma-ray emission through nuclear reaction simulations, emphasizing their potential for gamma-ray detection.


<details>
  <summary>Details</summary>
Motivation: To identify the astrophysical sites of r-process nucleosynthesis and leverage observations of magnetar flares as a significant source of heavy elements.

Method: Nuclear reaction network simulations were executed to assess nucleosynthesis yields and characterize nuclear gamma-ray line emissions from magnetar giant flares.

Result: Nuclides synthesized are concentrated near the first and second r-process abundance peaks; gamma-ray opacity varies significantly with energy, with MeV emissions dominating early on.

Conclusion: Magnetar giant flares, being more frequent than neutron star mergers, present valuable opportunities for gamma-ray astronomy and insights into heavy element formation.
...
### [84] [Discovery of a quasi-periodic oscillation non-harmonically related to the Type-C QPO in the hard intermedidate state of MAXI J1820+070](https://arxiv.org/abs/2606.18004)
*Pei Jin,Mariano Méndez,Federico García,Diego Altamirano,Ruican Ma*

Main category: astro-ph.HE

TL;DR: This study investigates the HIMS to SIMS transition in MAXI J1820+070, highlighting new QPO behaviors, noise drops, jet activity halts, and their implications.


<details>
  <summary>Details</summary>
Motivation: To understand the timing and characteristics of QPOs and noise behavior during the state transition in MAXI J1820+070.

Method: NICER observations were utilized to analyze the broadband noise and QPO features during the HIMS to SIMS transition.

Result: Discovery of a precursor QPO before the transition, indicating potential connections with QPOs in other sources and suggesting a lack of direct link between Type-B QPOs and discrete radio ejections.

Conclusion: The results imply that certain QPOs can arise before transitions, and their characteristics may relate to underlying physical processes in outflows.
...
### [85] [A Semi-Analytical Loss Cone Theory for Tidal Disruption Event Rates Around Kerr Black Holes](https://arxiv.org/abs/2606.18050)
*Wenkang Xin*

Main category: astro-ph.HE

TL;DR: This paper develops a semi-analytical framework to analyze tidal disruption events (TDEs) involving spinning black holes, addressing how black hole spin affects tidal dynamics and disruption boundaries.


<details>
  <summary>Details</summary>
Motivation: The need for a comprehensive understanding of TDEs involving spinning black holes, which influence the survival of stars based on angular momentum thresholds and orientation.

Method: A semi-analytical framework that integrates spin-dependent loss cone boundaries and employs a tidal tensor formalism, alongside a two-dimensional Fokker-Planck equation to study angular momentum diffusion.

Result: The study quantifies inclination-dependent thresholds for tidal disruption and finds that while spin induces a bias favoring retrograde star disruption, the overall TDE rate remains largely unaffected by black hole spin.

Conclusion: This framework provides a novel approach to incorporate spin and orbital inclination into the analysis of TDEs, facilitating improved predictions in population-level studies.
...
### [86] [The Chirp-Mass Ladder: A New Rung Emerges](https://arxiv.org/abs/2606.18081)
*Vaibhav Tiwari*

Main category: astro-ph.HE

TL;DR: The study analyzes around 250 binary black hole events from gravitational waves, identifying a structured chirp-mass distribution with key peaks, suggesting a hierarchical merger scenario explains the observations.


<details>
  <summary>Details</summary>
Motivation: To understand the structured distribution of chirp masses in the binary black hole population, leveraging new data from GWTC-5.0 to identify the nature of the mergers and their implications for black hole formation.

Method: Analysis of gravitational wave data to identify peaks in the chirp-mass distribution, proposing a hierarchical merger scenario and examining intergenerational merger contributions to peak formations.

Result: The analysis reveals distinct peaks at $7.5M_{	ext{odot}}$, $14M_{	ext{odot}}$, $27M_{	ext{odot}}$, and an intermediate peak at $19M_{	ext{odot}}$, supporting the hierarchical merger hypothesis as a unifying framework.

Conclusion: The findings highlight the need for further investigation into mass and spin correlations among black holes, emphasizing the role of hierarchical mergers in shaping the observed BBH population.
...
### [87] [Polarized emission of orbiting hot-spots near Sagittarius A*: effects of electromagnetic interaction](https://arxiv.org/abs/2606.18107)
*Abylaikhan Tlemissov,Arman Tursunov,Maciek Wielgus*

Main category: astro-ph.HE

TL;DR: This study explores the impact of electromagnetic interactions on the polarimetric signatures of orbiting hot-spots around a Schwarzschild black hole, utilizing a general-relativistic model to analyze how different interaction parameters affect polarization patterns, specifically in ALMA observations of Sagittarius A*.


<details>
  <summary>Details</summary>
Motivation: Understanding polarimetric signatures around black holes can provide insights into their physical properties and the influence of magnetic fields on emission patterns.

Method: A general-relativistic model is employed, incorporating synchrotron emission and ray-tracing techniques, to simulate and analyze how various electromagnetic interaction parameters affect polarization, focusing on EVPA and $Q$-$U$ plane polarization loops.

Result: Findings demonstrate that a positive interaction parameter enhances the symmetry and time ratio of polarization loops, while a negative parameter causes significant asymmetry and does not align with observed data.

Conclusion: The study reveals that electromagnetic interactions complicate parameter estimation for orbital inclination and hot-spot velocity in black hole systems.
...
### [88] [Detailed Timing, Spectral, and Polarimetric Analysis of Magnetar 1RXS J170849.0-400910](https://arxiv.org/abs/2606.18127)
*Rachael Stewart,George Younes,Alice Harding,Hoa Dinh Thi,Matthew Baring,Zorawar Wadiasingh,Michela Negro,Alex Van Kooten*

Main category: astro-ph.HE

TL;DR: A comprehensive study using multiple X-ray observatories reveals the intricate timing, spectral, and polarimetric behavior of the magnetar 1RXS J170849.0-400910, showing significant variations in pulse morphology and polarization across energy bands.


<details>
  <summary>Details</summary>
Motivation: To understand the complex emission mechanisms and structures of the magnetar 1RXS J170849.0-400910 by examining its timing, spectral, and polarimetric properties across a wide energy range.

Method: Broadband observations were conducted using XMM-Newton, NuSTAR, and IXPE, focusing on pulse morphology and phase-resolved spectroscopy across 0.5-70 keV.

Result: Observations revealed a strong evolution in pulse morphology, distinct soft and hard components, and a significant variation in polarization with energy and phase, indicating diverse emission mechanisms.

Conclusion: The study highlights the complexity of emissions from magnetars, suggesting a superposition of emitting regions and processes, unveiled through comprehensive spectropolarimetric analysis.
...
### [89] [X-ray eclipse tomography: Resolving the extent of X-ray-emitting region(s) in the Seyfert galaxy ESO362-G18](https://arxiv.org/abs/2606.18155)
*Laura Rueda-Nieto,Beatriz Agís-González,Giovanni Miniutti*

Main category: astro-ph.HE

TL;DR: The study analyzes X-ray spectral variability in the Seyfert galaxy ESO 362-G18 through monitoring campaigns, identifying X-ray eclipses and deriving properties of the absorbing cloud and emission regions.


<details>
  <summary>Details</summary>
Motivation: To understand the nature of X-ray spectral variability in AGNs and the impact of variable absorption on observed spectral changes.

Method: The researchers conducted time-resolved spectroscopy during Swift monitoring campaigns to analyze X-ray eclipses, assess the properties of an obscuring cloud, and estimate the sizes of different X-ray-emitting regions.

Result: Two X-ray eclipses were observed, allowing the characterization of the cloud's density structure, along with a definition of the soft-excess and hot corona emission regions. The soft excess is found to be 50% more extended than the hot corona within certain radii from the AGN center.

Conclusion: X-ray eclipse tomography is a powerful tool for exploring the geometry of the accretion flow and the environment around AGNs, revealing insights into their structure and dynamics.
...
### [90] [Improved limits on a new $Z'$ in $B-L$ scenarios with the NA64 experiment at CERN](https://arxiv.org/abs/2606.17320)
...
TL;DR: This study presents new constraints on the coupling constant in a $U(1)_{B-L}$ extended Standard Model, utilizing data from the NA64 experiment from 2016 to 2022.


<details>
  <summary>Details</summary>
Motivation: To link neutrino masses and dark matter candidates through an additional $U(1)_{B-L}$ gauge symmetry.

Method: Analysis of electron-beam data from the NA64 experiment, focusing on resonant $e^{+}e^{-}$ annihilation and an enhanced mass range for the gauge boson $Z'$ using a larger dataset.

Result: New limits on the coupling constant $g_{B-L}$ surpass previous neutrino-scattering bounds, offering the most stringent laboratory constraints for new boson masses below 1 GeV.

Conclusion: The study advances understanding of $g_{B-L}$ coupling, particularly in scenarios where the $Z'$ decays invisibly to dark matter.
...
### [91] [Final Report on the Measurement of the Positive Muon Anomalous Magnetic Moment at Fermilab to 127 ppb](https://arxiv.org/abs/2606.17323)
...
TL;DR: The Muon $g-2$ experiment at FNAL reports a new measurement of the muon magnetic anomaly, yielding an experimental world average significantly refined by increased data from 2021 to 2023.


<details>
  <summary>Details</summary>
Motivation: To provide a precise measurement of the muon magnetic anomaly, enhancing our understanding of fundamental particle physics and testing theoretical predictions.

Method: Analyzing the ratio of anomalous spin precession frequency to shielded proton precession frequency in a magnetic storage ring, using an expansive dataset collected over multiple years.

Result: New measurement yields $a_μ=1165920710(162)\times 10^{-12}$ (139 ppb), with combined previous results at $a_μ=1165920705(148)\times 10^{-12}$ (127 ppb).

Conclusion: The updated world average from FNAL data is now $a_μ^{\text{Exp}}=1165920715(145)\times 10^{-12}$ (124 ppb).
...
### [92] [Better Queries, Cheaper Attention: Adapting Transformers for Efficient Sparse Reconstruction](https://arxiv.org/abs/2606.17631)
*Philippa Duckett,Samuel Van Stroud,Max Hart,Gabriel Facini,Tim Scanlon*

Main category: hep-ex

TL;DR: The paper presents a geometry-aware dynamic-query decoder to improve object reconstruction efficiency from sparse sensor measurements, particularly in high-multiplicity data scenarios.


<details>
  <summary>Details</summary>
Motivation: Current query-based transformer decoders struggle with high-multiplicity data due to fixed query sets and expensive cross-attention mechanisms.

Method: Introduction of a dynamic-query decoder that adjusts queries based on input conditions and uses Local Strided Cross-Attention for efficient, structured attention on physics-based interactions.

Result: Improved trajectory reconstruction efficiency from 94.1% to 98.1% and reduced fake rate significantly; the DQ+LSCA model further cuts inference latency by ~50% and memory usage by over 90%.

Conclusion: The proposed model significantly enhances performance and scalability for charged-particle trajectory reconstruction, particularly in complex detector environments.
...
### [93] [Observation of an Altered $a_{0}(980)$ Line shape in $D^{+} \rightarrow π^{+}ηη$](https://arxiv.org/abs/2606.17724)
...
TL;DR: First amplitude analysis of the decay $D^+\toπ^+ηη$ reveals the $D^+\to a_0(980)^+η$ as the main component, with a specific branching fraction and a distinct mass spectrum.


<details>
  <summary>Details</summary>
Motivation: To explore the decay $D^+\toπ^+ηη$ and understand the intermediate processes involved, particularly the role of the $a_0(980)$ resonance.

Method: Analysis of $20.3~{m fb}^{-1}$ of data from $e^+e^-$ collisions at $\,\sqrt{s}=3.773~{m GeV}$ using amplitude analysis techniques to identify resonant structures and branching fractions.

Result: Identified the $D^+\to a_0(980)^+η$ as the significant component, with a branching fraction of $(3.67\pm0.12_{\rm stat}\pm0.06_{\rm syst})\times10^{-3}$. The mass spectrum shows discrepancies with conventional models for the $a_0(980)$ particle.

Conclusion: Conventional amplitude models struggle to fit the observed line shape, indicating potential issues with parameterization and fit quality regarding the physical pole position of the $a_0(980)$. Allowing parameters to float results in satisfactory fits, but suggests inconsistencies concerning $K\bar K$ threshold behavior.
...
### [94] [Hidden-sectors search and probe of discrete symmetries at the REDTOP experiment](https://arxiv.org/abs/2606.12158)
*The REDTOP COllaboration*

Main category: hep-ex

TL;DR: The REDTOP facility aims to enhance the study of $η$ and $η^{	ext{
}}$ mesons, searching for new physics through increased decay samples and sensitivity to various theoretical portals, while also improving measurements relevant to muon anomalous magnetic moment.


<details>
  <summary>Details</summary>
Motivation: The uniqueness of $η$ and $η^{	ext{
}}$ mesons as nearly Goldstone bosons, combined with the limitations of previous data, motivates the need for a facility that can collect significantly larger samples to explore beyond the Standard Model.

Method: The study evaluates the sensitivity of the proposed REDTOP facility to decay processes associated with different theoretical portals connecting the Standard Model and New Physics, leveraging the potential of high-statistics samples.

Result: REDTOP will acquire samples on the order of $10^{14}$ $η$ and $10^{12}$ $η'$ mesons, allowing extensive searches for new physics and enabling precise tests of fundamental symmetries and other physical constants.

Conclusion: By providing improved statistical data on $η$ and $η^{	ext{
}}$ mesons, REDTOP will enhance our understanding of particle interactions and contribute valuable insights into the muon anomalous magnetic moment.
...
### [95] [The Lazuli Space Observatory: Opportunities for time-domain and multi-messenger astronomy](https://arxiv.org/abs/2606.17136)
...
TL;DR: The Lazuli Space Observatory aims to enhance time-domain and multi-messenger astronomy by providing rapid, sensitive follow-up observations of transient phenomena with a focus on speed and capability.


<details>
  <summary>Details</summary>
Motivation: To fill the critical gap in current observational capabilities for rapidly following up faint, fast-evolving astrophysical transients in real-time.

Method: Lazuli will employ a large collecting area, optical/NIR photometry, low-resolution integral field spectroscopy, and a rapid-response architecture targeting response times of less than 4 hours, ideally under 90 minutes.

Result: The observatory is set to enable extensive research opportunities in areas such as gravitational wave follow-up, kilonova characterization, and other high-redshift events, while also enhancing studies of Galactic time-domain science.

Conclusion: Lazuli's advanced capabilities will significantly contribute to the fields of time-domain and multi-messenger astrophysics, due to its superior sensitivity and rapid response times compared to existing observatories.
...
### [96] [OpenGadget3 GPU solver tests](https://arxiv.org/abs/2606.17145)
*A. Ragagnin,G. S. Karademir,F. Groth,K. Dolag,L. M. Böss,T. Castro,N. Hariharan,M. Aiello,L. Tornatore*

Main category: astro-ph.IM

TL;DR: This paper evaluates the scalability and accuracy of GPU porting for N-body code in hydrodynamic cosmological simulations, comparing results with traditional CPU implementations.


<details>
  <summary>Details</summary>
Motivation: To assess performance improvements and validation of a GPU-ported N-body code for cosmological simulations, building upon previous work by Ragagnin et al. (2020).

Method: Various tests were conducted with increasing complexity, including gravity-only simulations and hydrodynamics setups, on multiple supercomputers to compare the GPU implementation with CPU performance.

Result: The GPU implementation shows excellent accuracy compared to the CPU version, with speedups of approximately 3-5 for individual modules and 2-3 for complex setups.

Conclusion: Overall, the GPU-ported code maintains high accuracy and notable performance improvements across several supercomputing environments, validating its application in cosmological simulations.
...
### [97] [A fast spectral-multigrid Poisson solver in non-Cartesian geometries](https://arxiv.org/abs/2606.17636)
*Ankush Mandal,Oliver Gressel,Udo Ziegler,Andrea Mignone*

Main category: astro-ph.IM

TL;DR: A robust and scalable Poisson solver for three-dimensional non-Cartesian geometries is presented, capable of high accuracy and efficiency in astrophysical simulations.


<details>
  <summary>Details</summary>
Motivation: The solver addresses the need for accurate self-gravity computations in astrophysical fluid dynamics, especially in complex geometries with large dynamic ranges and non-axisymmetric structures.

Method: The method uses azimuthal Fourier decomposition to convert the 3D Poisson equation into independent 2D Helmholtz equations, solved with a multigrid algorithm that maintains second-order accuracy.

Result: The solver demonstrates second-order convergence and strong parallel performance, validated against analytical solutions and test problems in spherical and cylindrical geometries, showing scalability up to 4096 cores.

Conclusion: This Poisson solver is effective for large-scale astrophysical simulations, particularly in applications like star formation and accretion disks.
...
### [98] [On-sky binary source hypothesis testing beyond the diffraction limit using spatial mode demultiplexing based detection](https://arxiv.org/abs/2606.18025)
*John S. Wallis,Ayden S. McCann,Joshua J. Collier,Lilani D. Toms-Hardman,Alex M. Frost,Benjamin P. Dix-Matthews,David R. Gozzard*

Main category: astro-ph.IM

TL;DR: This paper demonstrates a novel telescope instrument employing spatial mode de-multiplexing (SPADE) for enhanced imaging beyond the diffraction limit, specifically targeting sub-diffraction binary star systems in low-light conditions.


<details>
  <summary>Details</summary>
Motivation: The motivation is to improve telescope resolution to study new physical phenomena and detect dim celestial objects that traditional imaging techniques cannot resolve.

Method: The method involves a binary-SPADE based hypothesis testing instrument utilizing mode demultiplexing with a double clad fiber coupler, facilitating on-sky detection of binary stars separated below the diffraction limit.

Result: In a proof-of-principle experiment, the instrument successfully detected a binary star system in conditions where traditional direct imaging failed, despite challenges from unbalanced loss in the fiber coupler.

Conclusion: While the type II error rate was limited by certain losses, the SPADE approach consistently outperformed traditional imaging methods, suggesting potential improvements with larger telescopes despite atmospheric turbulence concerns.
...
### [99] [Sustainability as a design parameter in the early development of the Wide-field Spectroscopic Telescope](https://arxiv.org/abs/2606.18079)
...
TL;DR: The Wide-field Spectroscopic Telescope aims to integrate sustainability into its design, focusing on life-cycle assessment and data management to minimize environmental impact.


<details>
  <summary>Details</summary>
Motivation: To create a next-generation telescope that balances scientific performance with sustainability from the early design stages.

Method: Conducting a life-cycle assessment for spectrographs and cooling systems, while evaluating data processing and storage strategies to manage carbon footprint.

Result: Identified two key areas for reducing environmental impact: construction/operation of spectrographs and data management, with quantified carbon footprint as a design parameter.

Conclusion: Integrating environmental factors into telescope design will promote responsible astronomy with reduced carbon footprints.
...
### [100] [Querying an astronomical database using large language models: the ALeRCE text-to-SQL system](https://arxiv.org/abs/2606.18108)
...
TL;DR: A new text-to-SQL system for querying astronomical databases is developed, leveraging large language models and in-context learning to effectively interpret natural language into SQL.


<details>
  <summary>Details</summary>
Motivation: To enable users to easily query the ALeRCE astronomical database using natural language, facilitating accessibility and usability in data retrieval.

Method: A step-by-step generation framework is introduced that includes schema linking, query classification, prompt decomposition, and self-correction, evaluated on a dataset of 110 NL/SQL pairs across thirteen LLMs.

Result: The proposed framework significantly surpasses a direct-inference baseline, with Claude Opus 4.6 achieving high perfect-match rates in simpler queries and consistent performance across varying complexities.

Conclusion: The performance of the step-by-step framework and self-correction module proves effective in enhancing SQL query generation, with certain LLMs showing superior capabilities in the text-to-SQL task.
...
### [101] [Resolving the smallest scales of massive star formation: A case for next-generation thermal-infrared interferometers](https://arxiv.org/abs/2606.18178)
*Emma Bordier,Evgenia Koumpia,Lucas Labadie,Joel Sanchez-Bermudez,Alvaro Sanchez-Monge,Jean-Philippe Berger*

Main category: astro-ph.IM

TL;DR: The white paper proposes next-generation thermal-infrared interferometers to study massive star formation processes, addressing current observational limitations.


<details>
  <summary>Details</summary>
Motivation: Understanding massive star assembly is a key astrophysical challenge due to inaccessibility of crucial accretion processes within 100 au.

Method: Advocates for thermal-infrared interferometers in L, M, N, and Q bands to observe warm dust, hot gas, and protostars at sub-milliarcsecond scales.

Result: The proposed interferometers will enable unprecedented access to molecular inventory and spatially resolved spectroscopy.

Conclusion: Developing heterodyne-based, long-baseline interferometry at high, dry sites is essential for revealing the complex processes of massive star formation.
