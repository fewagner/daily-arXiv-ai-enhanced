...
TL;DR: The study examines the role of muons and their reactions in binary neutron star merger simulations, showing minimal impact on remnant properties but notable reductions in ejecta masses.


<details>
  <summary>Details</summary>
Motivation: To explore the influence of muons in binary neutron star mergers on astrophysical outcomes.

Method: Binary neutron star merger simulations using a gray neutrino treatment and a two timescales approach for matter-radiation equilibration.

Result: Muons lead to less than 6% differences in remnant properties and a maximum 17% reduction in ejecta masses, suggesting less severe impacts on nucleosynthesis than previously thought.

Conclusion: Including muonic effects might not drastically alter nucleosynthetic yields and electromagnetic signatures compared to earlier studies.
...
### [2] [Localization and Confidence Region Estimation of Short GRBs with the COSI BGO Shield Using a HEALPix-Based Deep Learning Approach](https://arxiv.org/abs/2604.15119)
...
TL;DR: This paper discusses a localization method for Gamma-Ray Bursts (GRBs) using a deep learning approach integrated with the Compton Spectrometer and Imager's Anticoincidence Subsystem for improved precision and efficiency compared to classical methods.


<details>
  <summary>Details</summary>
Motivation: The motivation is to enhance the localization of GRBs using data from the Compton Spectrometer and Imager, addressing the need for accurate and rapid identification of transient astronomical events.

Method: A neural network classifier predicts the GRB location as a probability distribution on a sky map, utilizing the HEALPix framework to compute the 90% confidence region, even in cases with multiple potential locations.

Result: The deep learning method allows for estimation of GRB locations with higher accuracy and has the potential to improve the speed of GRB localization compared to traditional methods.

Conclusion: Future research will involve comparing this deep learning method with classical localization techniques, aiming to validate its effectiveness and reliability.
...
TL;DR: This paper analyzes 3D GRMHD simulations to study the azimuthal structure of accreting matter around black holes, revealing enhanced non-axisymmetry during flux eruptions.


<details>
  <summary>Details</summary>
Motivation: The study aims to provide insights into the behavior and structure of accreting matter in black holes, particularly during flux eruption events.

Method: The authors utilize standard 3D GRMHD simulations, focusing on equatorial slices to examine the azimuthal structure and evolution of the inner accretion disk.

Result: Findings indicate that the accretion disk's non-axisymmetry is dominated by low azimuthal mode numbers (m = 2 and m = 1), particularly noticeable near the black hole during flux eruptions.

Conclusion: The morphology of the equatorial accretion flow is largely influenced by the formation and movement of vertical magnetic flux bundles, which are critical during the reconnection of magnetic fields and expulsion of excess magnetic flux.
...
### [4] [Las Cumbres Observatory Gravitational-Wave Follow-up in O3 and O4: Strengths and Weaknesses of a Rapid Response Galaxy Targeted Strategy](https://arxiv.org/abs/2604.15129)
...
TL;DR: The Los Cumbres Observatory effectively responded to gravitational-wave alerts during runs O3 and O4, revealing the need for improved strategies and collaboration for efficient follow-up.


<details>
  <summary>Details</summary>
Motivation: To assess the efficacy of the galaxy-targeted strategy for gravitational-wave follow-up using Las Cumbres Observatory during O3 and O4.

Method: Analysis of response time and depth for nine specific GW alerts, testing the effectiveness of the galaxy-targeted strategy in differing localization scenarios.

Result: Las Cumbres Observatory effectively initiated observations within minutes, with sufficient depth to detect kilonovae at a median distance of 250 Mpc; however, the galaxy-targeted strategy was less efficient than expected due to larger localization areas.

Conclusion: Coordination among varied observational facilities is essential for enhancing the efficiency and comprehensiveness of gravitational-wave event follow-ups.
...
TL;DR: The discovery of EP250302a, a new type of Extragalactic Fast X-ray Transient, highlights unique X-ray and optical characteristics that suggest a late-time collision of relativistic shells, indicating possible central engine activity.


<details>
  <summary>Details</summary>
Motivation: To investigate the origins of Extragalactic Fast X-ray Transients, particularly for those whose physical basis is unclear.

Method: Analysis of multi-wavelength light curves of EP250302a, identified through the Einstein Probe, noting distinctive X-ray and optical behavior.

Result: EP250302a exhibited a needle-like X-ray flare and smooth optical rebrightening, distinguishing it from known EFXTs and suggesting a unique mechanism at play.

Conclusion: The findings propose that EP250302a exemplifies a new class of EFXTs associated with the late-time activity of central engines, valuable for understanding jet physics in such phenomena.
...
TL;DR: Multi-wavelength analysis of GRB 210704A indicates a collapsar nature and links its optical/infrared excess to fast blue optical transients.


<details>
  <summary>Details</summary>
Motivation: To analyze the properties and nature of GRB 210704A and determine its relationship with other astronomical phenomena.

Method: Utilized detailed spectral analysis, redshift determination, and follow-up observations across various wavelengths.

Result: Determined a redshift of z=2.34 and identified excess optical/infrared emission associated with GRB 210704A, indicating a possible connection to luminous fast blue optical transients.

Conclusion: The findings support a collapsar model for GRB 210704A and suggest a relationship between GRBs and LFBOTs, linked by a refreshed shock model.
...
TL;DR: This paper analyzes the motion of charged relativistic particles in an inhomogeneous magnetic field, focusing on energy loss and magnetic mirroring in neutron star magnetospheres.


<details>
  <summary>Details</summary>
Motivation: To understand particle dynamics in the complex magnetic environments of neutron stars, particularly the mechanisms of energy loss and particle confinement.

Method: The guiding center formalism is applied to derive the governing equation for the evolution of magnetic moments of charged particles in an inhomogeneous magnetic field, simulating conditions in a neutron star magnetosphere.

Result: Particles experience significant energy loss, especially near turning points, leading to rapid migration into a loss cone or temporary trapping, which creates distinct particle distributions based on initial conditions.

Conclusion: The findings suggest that certain regions in the magnetosphere are crucial for synchrotron radiation, and these processes may contribute to coherent pulsar emissions and fast radio bursts.
...
TL;DR: The JWST has identified high-redshift active galactic nuclei (AGN) potentially responsible for a notable neutrino production signal at 50 PeV, aligning with IceCube data.


<details>
  <summary>Details</summary>
Motivation: To explore the connection between ultrahigh-energy protons emitted by AGN and neutrino production in the early universe.

Method: Analysis of cosmogenic neutrino flux from high-redshift AGN based on observations from JWST.

Result: Identification of a neutrino flux bump at around 50 PeV consistent with IceCube's measurements, derived without fine-tuning parameters.

Conclusion: Future neutrino observations should validate the predicted bump and enhance our understanding of cosmic-ray emissions in the early universe.
...
TL;DR: The 2023/24 NICER campaign studied Swift J1727.8-1613 across various accretion states, revealing significant inner disk radius evolution and onset of disk truncation, especially differentiating bright and dim hard states.


<details>
  <summary>Details</summary>
Motivation: To analyze accretion flow variations across different states in the black hole X-ray binary Swift J1727.8-1613 during its monitoring campaign.

Method: Utilized disk continuum fitting techniques to evaluate the inner disk radius changes throughout the outburst, considering a temperature-dependent color-correction factor.

Result: Observed a significant evolution of the inner disk radius between hard states and the soft state, with tentative evidence of disk truncation occurring during state transitions.

Conclusion: The inner disk is more truncated during high-luminosity bright hard states compared to low-luminosity dim hard states.
...
TL;DR: This study explores the interactions between winds and viscous accretion flows around a rotating black hole, revealing significant effects on luminosity and shock properties in the disk.


<details>
  <summary>Details</summary>
Motivation: To understand the global transonic solutions of viscous, magnetized accretion flows and the impact of mass and angular momentum losses due to winds.

Method: The governing equations for accretion flows are solved considering a power-law decrease in mass accretion rate and the effects of winds, analyzing the flow structure through various parameters.

Result: Winds significantly modify the accretion flow, decreasing disk luminosity and altering shock properties, including shock radius, compression ratio, and strength.

Conclusion: The interplay between viscosity and winds is critical in determining shock formation dynamics, with critical wind parameters identified that affect the existence of steady shock solutions.
...
TL;DR: This study analyzes the unidentified gamma-ray source 4FGL J2112.5-3043 from the Fermi-LAT catalog, finding a unique spectral signature and considering both astrophysical and dark matter origins.


<details>
  <summary>Details</summary>
Motivation: Around one-third of sources in the Fermi-LAT catalog remain unidentified, highlighting the need for detailed analysis of specific candidates.

Method: Spectral and spatial analyses were conducted on 4FGL J2112.5-3043, using a subexponential cutoff power-law model and examining temporal flux and morphology.

Result: The source shows no significant flux variability and its photon spectrum favors dark matter annihilation channels over pulsar origins, offering no definitive conclusions about its nature.

Conclusion: 4FGL J2112.5-3043 presents compelling evidence for dark matter annihilation as a candidate, warranting further multiwavelength observations.
...
TL;DR: The study connects magnetic field strengths in certain neutron stars to the double-humped X-ray spectra observed in high-mass X-ray binaries (HMXBs).


<details>
  <summary>Details</summary>
Motivation: To understand the relationship between the double-humped X-ray spectra and the magnetic field strength in neutron stars, as existing models predict this dependency.

Method: Analyzed NuSTAR observations of four BeXRBs, modeling their spectra to derive a correlation between intersection energy of the two humps and magnetic field strength, and tested this with synthetic spectra from the polcap model.

Result: Found a linear correlation between magnetic field strength and intersection energy for both real and synthetic NuSTAR spectra.

Conclusion: This correlation allows for estimation of magnetic field strength and suggests further observations are needed to validate these findings in a broader context.
...
TL;DR: This study presents a framework for detecting and characterizing variations in the Faraday rotation measure (RM) of repeating fast radio bursts (FRBs), focusing on identifying rare RM flares amid complex environmental fluctuations.


<details>
  <summary>Details</summary>
Motivation: Identifying RM variations can provide insights into the magneto-ionic environments of FRBs, but the complexity and variability of RM evolution challenge the detection of transient phenomena.

Method: A generalized algorithmic framework is introduced for automated detection of RM flares, distinguishing them from background noise and environmental fluctuations.

Result: The application of this framework to 15 FRBs revealed that significant RM flares are rare, with only one source showing a statistically significant event, while others displayed intrinsic variability.

Conclusion: The research establishes a foundational tool for analyzing plasma dynamics around FRBs, aiding in the understanding of their progenitor systems.
...
TL;DR: The paper proposes a complexity measure for diagnosing quantum ergodicity by analyzing entangled states under various Hamiltonians.


<details>
  <summary>Details</summary>
Motivation: To improve the understanding of quantum chaos and its relation to ergodicity through a detailed measure of complexity.

Method: Numerical bootstrapping of Hamiltonian ensembles to examine the scrambling dynamics of maximally entangled states, using Rosenzweig-Porter ensembles for analysis across ergodic regimes.

Result: The integrated spread complexity is effective in distinguishing between different levels of ergodicity within quantum systems.

Conclusion: This method provides a reliable approach to diagnosing quantum chaos over time.
...
TL;DR: This study evaluates the impact of quantum encoding strategies in SAR ATR, finding hybrid architectures favor magnitude-only encoding, while pure quantum models benefit from phase information.


<details>
  <summary>Details</summary>
Motivation: To improve SAR ATR performance by better leveraging complex-valued data through quantum encoding methods.

Method: The paper compares five quantum encoding strategies in a unified framework using the MSTAR dataset, assessing their performance in both hybrid quantum-classical and purely quantum architectures.

Result: Magnitude-only encoding outperformed all complex strategies in hybrid models (99.57% accuracy for 3 classes), while phase information proved essential in pure quantum models, improving accuracy by up to 21.65%.

Conclusion: Encoding effectiveness relies on model architecture; hybrid models thrive on classical compensation for phase, while pure quantum models need phase for effective discrimination.
...
TL;DR: This paper explores parallels between consciousness and quantum mechanics, arguing that both challenge classical objectivist views in science.


<details>
  <summary>Details</summary>
Motivation: To investigate the relationship between consciousness and quantum mechanics, addressing claims of a minimization of mystery and exploring their challenge to classical metaphysics.

Method: The authors identify and analyze the metaphysical theses that underlie objectivism and their tensions with consciousness and quantum views, proposing three non-objectivist responses.

Result: The paper identifies 'relationalism', 'fragmentalism', and 'many-subjective-worlds' as responses to the non-objectivist interpretations of consciousness and quantum mechanics, mapping their advantages and disadvantages.

Conclusion: The discussion emphasizes the need to reconsider traditional scientific paradigms in light of the complexities of consciousness and quantum mechanics.
...
### [17] [Quantum correlation tests at cosmic distances](https://arxiv.org/abs/2604.14252)
*Thomas Durt,Jean Schneider*

Main category: quant-ph

TL;DR: This paper explores extending the measurement of entangled quantum systems to a distance of 390,000 km, with one subsystem on the Moon and the other on Earth, to test Quantum Physics and Bell inequalities further.


<details>
  <summary>Details</summary>
Motivation: To investigate the feasibility of testing the correlation of entangled particles over astronomical distances, enhancing the understanding of Quantum Physics and the validity of alternative theories.

Method: Proposing an experimental setup involving polarimeters located on the Moon and Earth, enabling the measurement of entangled subsystems separated by 390,000 km.

Result: The potential to achieve measurements over a distance 300 times greater than previously tested, confirming correlations predicted by quantum mechanics and providing stricter tests for alternative theories.

Conclusion: Conducting such experiments could strengthen the foundational aspects of Quantum Physics and explore the boundaries of existing theories and interpretations.
...
### [18] [AI-Enabled Decoding of Qubit Loss for Quantum Error-Correcting Codes](https://arxiv.org/abs/2604.14269)
*Yuqing Wang,Xiaotian Nie,Jiale Dai,Zhongyi Ni,Tao Zhang,Hui Zhai,Linghui Chen*

Main category: quant-ph

TL;DR: This paper presents a spatiotemporal Graph Neural Network decoder that effectively corrects qubit loss errors in quantum computing, improving logical accuracy and inference time compared to traditional methods.


<details>
  <summary>Details</summary>
Motivation: Qubit loss disrupts quantum error correction processes and introduces complexity in decoding, necessitating an advanced approach for accurate error correction.

Method: The authors developed a dual-head decoder using a spatiotemporal Graph Neural Network to simultaneously correct Pauli errors and identify qubit loss locations from syndrome histories.

Result: The proposed decoder outperforms traditional MWPM and delayed-erasure MWPM methods in logical accuracy and successfully identifies over 90% of qubit loss locations after ten rounds of measurements.

Conclusion: This STGNN-based framework enhances qubit loss error correction, offering a scalable solution for fault-tolerant quantum computation.
...
### [19] [Entanglement and circuit complexity in finite-depth random linear optical networks](https://arxiv.org/abs/2604.14277)
*Laura Shou,Joseph T. Iosue,Yu-Xin Wang,Victor Galitski,Alexey V. Gorshkov*

Main category: quant-ph

TL;DR: The paper investigates entanglement growth and circuit complexity in random linear optical networks, revealing that entanglement increases diffusively with circuit depth and presents bounds on average subsystem entanglement and circuit approximation complexity.


<details>
  <summary>Details</summary>
Motivation: Understanding the dynamics of entanglement and complexity in quantum circuits has implications for quantum information theory and practical quantum computing.

Method: Analyzes random passive linear optical networks by studying entanglement viaRényi-2 entropy and investigating the robust circuit complexity in terms of circuit depth and the number of modes.

Result: Demonstrates that entanglement grows at most diffusively with circuit depth, establishes bounds on average entanglement and closeness to Haar randomness, and shows that the robust circuit complexity also scales diffusively with high probability.

Conclusion: The findings suggest that both entanglement dynamics and circuit complexity exhibit diffusively scaling behavior in random circuits, highlighting key traits of quantum processing in linear optical systems.
...
### [20] [Scalable quantum error correction tailored for a heavy-hex qubit array](https://arxiv.org/abs/2604.14296)
...
TL;DR: The paper presents the dynamic compass code, a new subsystem code for quantum error correction, demonstrating improved performance through tailored decoding strategies in superconducting qubit arrays.


<details>
  <summary>Details</summary>
Motivation: The need for effective quantum error correction in the face of imperfect hardware to enable practical quantum computing.

Method: Introduces the dynamic compass code with a specialized syndrome extraction cycle for efficient qubit use on a heavy-hex lattice, along with a detailed noise characterization and augmented decoder using soft information from measurements.

Result: Achieved a 38.3% improvement in logical error rates through noise-informed decoding strategies in a distance-5 experiment.

Conclusion: The dynamic compass code significantly enhances logical qubit performance by adapting to device-specific noise, proving viable for scalable quantum computing.
...
### [21] [Precision Limits of Multiparameter Markovian-Noise Metrology](https://arxiv.org/abs/2604.14298)
*Anthony J. Brady,Yu-Xin Wang,Luis Pedro García-Pintos,Alexey V. Gorshkov*

Main category: quant-ph

TL;DR: This paper establishes precision bounds for estimating stochastic signals in quantum systems, showing enhanced scaling under specific conditions and proposing a protocol for optimal measurements.


<details>
  <summary>Details</summary>
Motivation: To advance noise metrology in quantum sensing and characterize open quantum systems effectively.

Method: The study formulates ultimate precision bounds for multiparameter estimation using Markovian Lindblad dynamics, focusing on entangled probes and high-rank correlations across dissipative channels.

Result: It discovers that for high-rank correlations, average variance scales as Ω(1/(TR²)), revealing super-Heisenberg scaling with system size in collective k-body dissipation scenarios.

Conclusion: A Rapid Prepare-and-Measure protocol allows optimal measurement strategies for quantum noise metrology in various applications.
...
### [22] [Low-valency scalable quantum error correction with a dynamic compass code](https://arxiv.org/abs/2604.14299)
...
TL;DR: The dynamic compass code is a new quantum error-correcting code designed for efficient implementation and improved error rates, evaluated through a novel measurement schedule that balances error protection in different bases while enabling fault-tolerant logic.


<details>
  <summary>Details</summary>
Motivation: There is a need for practical quantum error-correcting codes that efficiently reduce logical error rates as quantum hardware scales.

Method: The dynamic compass code is implemented using a novel measurement schedule for the syndrome extraction circuit of the heavy-hex subsystem code, evaluated numerically.

Result: The dynamic compass code offers a balance in protection against logical errors in the $X$ vs $Z$ basis and demonstrates a threshold for stability experiments.

Conclusion: This code can facilitate fault-tolerant logic through lattice surgery between code patches.
...
### [23] [Cell-Dependent Criticality for Quantum Metrology](https://arxiv.org/abs/2604.14300)
*Zhoutao Lei,Jihao Ma,Yun Chen,Tingting Wang,Jiangbin Gong*

Main category: quant-ph

TL;DR: This paper proposes using Fock-space lattices to enhance quantum metrology near phase transitions, addressing challenges like critical slowing down and parameter sensing limits.


<details>
  <summary>Details</summary>
Motivation: The motivation is to overcome limitations in critical quantum metrology caused by gap-closure effects near phase transition boundaries.

Method: The authors utilize a two-mode Jaynes-Cummings model on Fock-space lattices, focusing on cell-dependent parameters that allow for tuning within a topological phase diagram.

Result: The approach enables a continuous transition from standard to Heisenberg scaling of quantum Fisher information and broadens the sensing range while reducing gap costs.

Conclusion: Fock-space lattices are put forward as a scalable solution for effective criticality-based quantum metrology.
...
### [24] [Warring Contextualities - Provably Classical vs Provably Nonclassical](https://arxiv.org/abs/2604.14319)
*Enrico Bozzetto,Jonte R. Hance*

Main category: quant-ph

TL;DR: This paper compares two definitions of contextuality—Kochen-Specker's and Spekkens'—and proposes a hierarchy linking them to classical and nonclassical systems.


<details>
  <summary>Details</summary>
Motivation: The existing literature lacks comparative analysis of Kochen-Specker and Spekkens' definitions of contextuality, which leads to an incomplete understanding of their relationship.

Method: The authors explore the conceptual frameworks of both definitions, arguing that Kochen-Specker contextuality relates to nonclassical systems and Spekkens' noncontextuality relates to classical systems, suggesting a hierarchical structure between them.

Result: The paper proposes a reconciliation of the two notions, establishing a framework that positions them as different stages of classicality and nonclassicality.

Conclusion: The suggested hierarchy enriches the understanding of contextuality in quantum systems and provides a unified perspective on the classical versus nonclassical nature of systems.
...
### [25] [Boson sampling beyond the dilute regime: second moments and anti-concentration](https://arxiv.org/abs/2604.14323)
*Hela Mhiri,Hugo Thomas,Léo Monbroussou,Ulysse Chabaud,Zoë Holmes,Elham Kashefi*

Main category: quant-ph

TL;DR: This paper addresses the incomplete characterization of output statistics in boson sampling, especially under conditions involving significant photon interactions. It utilizes representation-theoretic methods to derive expressions for second moments of bosonic observables and establishes anti-concentration results beyond the dilute regime.


<details>
  <summary>Details</summary>
Motivation: To fill the gap in understanding the output statistics of boson sampling, particularly in the saturated regime where photon interactions are prevalent and critical for demonstrating quantum advantage.

Method: The authors leverage representation-theoretic tools to obtain closed-form expressions for second moments of bosonic observables and utilize Hilbert-Schmidt norms to analyze projection onto irreducible components in the operator space.

Result: The study establishes closed-form expressions for important statistical quantities and demonstrates anti-concentration in boson sampling beyond the dilute regime, reinforcing the complexity-theoretic results related to hardness guarantees.

Conclusion: The findings provide deeper insights into the output distributions of boson sampling, essential for its practical implementation and theoretical validation, especially in regimes of experimental interest.
...
### [26] [Learning Cut Distributions with Quantum Optimization](https://arxiv.org/abs/2604.14381)
*Bao Bach,Cameron Ibrahim,Reuben Tate,Jad Salem,Stephan Eidenbenz,Ilya Safro*

Main category: quant-ph

TL;DR: The paper introduces a quantum approach to solving maximin fairness distribution optimization problems, demonstrating its superiority over classical methods for specific cases.


<details>
  <summary>Details</summary>
Motivation: To efficiently tackle maximin fairness optimization problems where optimal distributions can be complex and expansive.

Method: A quantum circuit is constructed using a QAOA ansatz that captures distributions over bitstrings with a finite number of layers, specifically addressing the Fair Cut Cover problem.

Result: The proposed quantum algorithm shows provable superiority over classical approximations and outperforms them empirically on various graph instances.

Conclusion: The quantum approach to distribution optimization enhances efficiency and effectiveness compared to certain classical algorithms, particularly for particular graph structures.
...
### [27] [Revealing the physical structure of the general quantum master equation](https://arxiv.org/abs/2604.14382)
*Eugenia Pyurbeeva,Ronnie Kosloff*

Main category: quant-ph

TL;DR: This paper presents a novel framework for understanding the Lindblad master equation without assumptions, highlighting the importance of generalized charges and their effects on quantum dynamics.


<details>
  <summary>Details</summary>
Motivation: To explore the dynamics of open quantum systems without the typical limitations, providing a fresh perspective on the Lindblad master equation.

Method: The authors analyze the Lindblad (GKLS) master equation without prior assumptions, decomposing quantum dynamics into free evolution, exchanges of generalized charges, and pure dephasing.

Result: The approach reveals that strong coupling, particle exchange, and non-Abelian effects stem from a common physical foundation, and introduces a non-commutation term in the generalized Gibbs state that has been overlooked in previous studies.

Conclusion: This work extends the understanding of quantum dynamics in open systems by integrating physical processes and providing new insights into the role of generalized charges.
...
### [28] [Distributed Learning of Quantum State Tomography Robust to Readout Errors](https://arxiv.org/abs/2604.14428)
*Amirhossein Taherpour,Alireza Sadeghi,Georgios B. Giannakis*

Main category: quant-ph

TL;DR: This paper presents a unified framework for scalable quantum state estimation with readout errors, improving on existing methods by enforcing consistency among overlapping regions.


<details>
  <summary>Details</summary>
Motivation: The challenge of estimating quantum states accurately in large multiqubit systems, particularly considering readout errors and measurement consistency, prompts the need for improved methods.

Method: The framework partitions a multiqubit system into overlapping regions, assigning local density operators and confusion matrices, coupled through consistent reduced states. A distributed alternating method using ADMM for state updates is developed.

Result: The proposed method shows improved state recovery and approaches oracle performance in simulations, highlighting a tradeoff between estimation accuracy, communication, and computation requirements.

Conclusion: The approach enhances joint regional quantum state tomography, addressing scalability and consistency in estimating quantum states.
...
### [29] [Distributed Variational Quantum Linear Solver](https://arxiv.org/abs/2604.14435)
*Chao Lu,Pooja Rao,Muralikrishnan Gopalakrishnan Meena,Kalyana Chakaravarthi Gottiparthi*

Main category: quant-ph

TL;DR: The paper proposes a distributed framework to enhance the scalability of the Variational Quantum Linear Solver (VQLS) by reducing circuit evaluation costs and computing complexity, achieving significant performance improvements for large quantum systems.


<details>
  <summary>Details</summary>
Motivation: To overcome the scalability bottleneck in the VQLS due to the high number of required circuit evaluations in Linear Combination of Unitaries (LCU) decomposition, especially as the number of qubits increases.

Method: A distributed VQLS (D-VQLS) framework leveraging NVIDIA CUDA-Q is introduced for scalable asynchronous distribution of circuit evaluations, along with a fast Walsh--Hadamard transform-based Pauli decomposition to reduce the complexity of LCU terms.

Result: Achieved a 256x reduction in circuit evaluations per iteration for a 10-qubit system while preserving over 99.99% solution fidelity, demonstrating effective scaling on multi-GPU systems with significant speedup.

Conclusion: The D-VQLS framework substantially improves the scalability and efficiency of VQLS for large quantum systems, validated through simulations that confirm high fidelity and computational efficiency.
...
### [30] [Performance Optimization Method for Laser-Phase-Noise based Quantum Random Number Generation](https://arxiv.org/abs/2604.14511)
*Jinlu Liu,Jie Yang,Yu Gao,Guowei Zhang,Yan Pan,Heng Wang,Yuyang Ding,Yang Li,Wei Huang,Bingjie Xu,Wei Chen*

Main category: quant-ph

TL;DR: This paper presents a comprehensive model for quantum random number generation based on laser phase noise, aiming to optimize performance metrics like generation rate and entropy.


<details>
  <summary>Details</summary>
Motivation: Despite advancements in quantum random number generation, a theoretical model for optimal performance has been lacking.

Method: The paper introduces a physical model to predict the power spectrum and probability distribution of raw data, enabling calculation of entropy source bandwidth and quantum min-entropy.

Result: The model was validated through simulations and experiments, showing significant agreement in various setups.

Conclusion: The proposed model allows for the design of experimental configurations to maximize generation rates or min-entropy, optimizing system performance.
...
### [31] [Dual-mode ground-state cooling in quadratic optomechanical systems: from multistability to general dark-mode suppression](https://arxiv.org/abs/2604.14515)
*Huanhuan Wei,Yun Chen,Jing Tang,Yuangang Deng*

Main category: quant-ph

TL;DR: This study explores a quadratic optomechanical system, revealing a transition to multistability and enabling dual-mode ground-state cooling.


<details>
  <summary>Details</summary>
Motivation: To investigate the dynamics of a quadratic optomechanical system and enhance functionalities related to quantum cooling and nonlinear optical behaviors.

Method: The authors analyze a system with a single-mode optical cavity and two mechanical resonators with different coupling strengths, mapping regions of bistability and multistability through parameter tuning.

Result: They achieve multistability with up to seven steady-state solutions and demonstrate robust simultaneous ground-state cooling across a wide parameter range, although challenges arise near comparable couplings due to dark-mode effects.

Conclusion: The findings offer a framework for engineering multimode quantum states and suggest applications in sensitive sensors, quantum memories, and networks.
...
### [32] [General Static Solutions of the SU(2) Yang-Mills Equations from a Spin Vector Potential](https://arxiv.org/abs/2604.15110)
*Yu-Xuan Zhang,Jing-Ling Chen*

Main category: quant-ph

TL;DR: The paper investigates static solutions of SU(2) Yang-Mills equations with gauge potential dependence on spin operators, using a vector potential extraction method to classify various solutions.


<details>
  <summary>Details</summary>
Motivation: To explore static solutions of SU(2) Yang-Mills equations that involve spin, enhancing understanding of non-Abelian gauge fields and their configurations.

Method: Utilizing the vector potential extraction approach (VPEA) to derive a general spin vector potential ansatz, followed by substituting it into the Yang-Mills equations and applying angular momentum constraints to obtain consistency equations.

Result: A complete classification of static solutions to the Yang-Mills equations is achieved, uncovering new static configurations beyond known solutions.

Conclusion: This study provides valuable insights for non-perturbative analyses and interactions between spin and non-Abelian gauge fields.
...
### [33] [Linear Optical Schemes to Postselect High-Dimensional Dicke States](https://arxiv.org/abs/2604.14516)
*Daniel Bhatti,William J. Munro,Seungbeom Chin*

Main category: quant-ph

TL;DR: The paper presents interference schemes for postselecting symmetric qudit Dicke states in linear optical setups, improving success probability using ancillary photons.


<details>
  <summary>Details</summary>
Motivation: To efficiently create multipartite entanglement for distributed quantum applications, particularly using linear optical interference.

Method: Introduces a family of interference schemes for postselecting symmetric qudit Dicke states, both with and without ancillary photons.

Result: Demonstrates that schemes using ancillary photons can achieve higher success probabilities compared to those without, accommodating various linear optical configurations.

Conclusion: Multiple practical approaches are provided for postselecting Dicke states, enhancing resource creation for quantum communication and computing.
...
### [34] [Observation of Tunable Superradiant Frequency Combs](https://arxiv.org/abs/2604.14601)
*Tian Xie,Rikuto Fukumori,Wai-Keong Mok,Jiahui Li,Joonhee Choi,Andrei Faraon*

Main category: quant-ph

TL;DR: This paper investigates dynamical phase transitions in cavity QED and introduces a model for periodic pulsed superradiance, paving the way for applications in quantum metrology.


<details>
  <summary>Details</summary>
Motivation: To explore the engineering of time-domain superradiance for applications like pulsed sources and frequency combs, which have not been thoroughly investigated.

Method: A driven-dissipative cavity-QED model was introduced to analyze the dynamics of a spin ensemble coupled to a superconducting resonator, revealing a transition from continuous-wave to periodic pulsed superradiance.

Result: The study uncovers dynamical phases in superradiant emission and demonstrates that rare-earth ion spin systems can achieve phase-synchronized dual-rail superradiant frequency combs.

Conclusion: The findings establish a connection between periodic pulsed superradiance and new nonequilibrium phases, suggesting implications for quantum metrology and information processing.
...
### [35] [Optimal Quantum Logarithmic Trace Inequality](https://arxiv.org/abs/2604.14617)
*Gilad Gour*

Main category: quant-ph

TL;DR: The paper establishes a refined logarithmic trace inequality with a smaller constant, enhancing previous results and demonstrating its optimality for positive operators.


<details>
  <summary>Details</summary>
Motivation: To improve previous bounds on logarithmic trace inequalities in quantum information theory.

Method: Introduces an iterative integration-by-parts procedure to enhance scalar bounds at the operator level, defining a new constant G_s via the Lambert W function.

Result: The paper proves that G_s is the optimal universal constant for the logarithmic trace inequality, with specific conditions under which this optimality holds for density matrices.

Conclusion: The resulting inequalities provide significant improvements for various primitives in quantum information theory, fostering tighter resource bounds.
...
### [36] [Photonic state engineering via energy-level crossing by giant atoms in topological waveguide QED setup](https://arxiv.org/abs/2604.14660)
*Mingzhu Weng,Gang Wang,Zhihai Wang*

Main category: quant-ph

TL;DR: The paper introduces a mechanism in waveguide quantum electrodynamics that combines nonlocal giant-atom coupling with topological band structures to control photonic bound states.


<details>
  <summary>Details</summary>
Motivation: To overcome limitations in controlling the spatial structure of bound photonic states in waveguide QED, primarily tied to local light-matter interactions.

Method: The authors examine giant atoms coupled to a Su-Schrieffer-Heeger waveguide, leading to controllable energy-level crossings protected by a topological gap, facilitating the exchange of distinct photonic bound states through adiabatic detuning.

Result: The mechanism enables high-fidelity conversion of splitting states into combining states with two giant atoms and achieves robust photon transfer in a configuration with three giant atoms, utilizing sequential in-gap crossings to preserve the shape of the emitted states.

Conclusion: Combining topology with nonlocal light-matter coupling allows for programmable control of bound photonic states in waveguide QED systems.
...
### [37] [Spectroscopic measurement of the Casimir-Polder force in the intermediate regime](https://arxiv.org/abs/2604.14721)
*K. Ton,G. Kestler,D. A. Steck,J. T. Barreiro*

Main category: quant-ph

TL;DR: Direct measurement of the Casimir-Polder effect between strontium atoms and a dielectric surface using atomic energy level shifts reveals new insights into the nature of quantum forces at intermediate distances.


<details>
  <summary>Details</summary>
Motivation: Understanding the Casimir-Polder effect is key for advancements in quantum technologies and atomic physics, particularly in how neutral atoms interact with surfaces.

Method: The study used spectroscopic probing to measure the CP-induced frequency shifts in ultracold strontium atoms near a dielectric surface, specifically at a distance of 189 nm, investigating effects related to the atomic transition wavelength.

Result: The results aligned with quantum electrodynamics (QED) predictions and confirmed a discrepancy with short-range approximations, while also ruling out long-range models.

Conclusion: This research opens avenues for further exploration of the CP effect in relation to different surface characteristics and geometries, impacting future atomic quantum device development.
...
### [38] [Quantum Mpemba Effect in Non-Equilibrium Quantum Thermometry](https://arxiv.org/abs/2604.14740)
*Zi-Shen Li,Yuxiang Yang*

Main category: quant-ph

TL;DR: The quantum Mpemba effect (QMpE) reveals that certain quantum states can reach thermal equilibrium faster than those closer to equilibrium. This study links QMpE to quantum thermometry, demonstrating that optimal initial states for temperature measurement exhibit QMpE, potentially improving temperature estimation.


<details>
  <summary>Details</summary>
Motivation: To explore the largely unexplored implications of QMpE for quantum information processing and thermometry.

Method: A Markovian model was used to rigorously prove that initial states optimal for thermometry also exhibit QMpE with high probability and thermalize more rapidly.

Result: Initial states optimal for thermometry were shown to demonstrate QMpE and thermalize faster than most other states.

Conclusion: The findings establish a significant link between quantum thermodynamics and thermometry, indicating that QMpE can be utilized to enhance temperature estimation using quantum probes.
...
### [39] [Activating entanglement and EPR steering from continuous-variable resources using witness-based measures](https://arxiv.org/abs/2604.14757)
*Kaustav Chatterjee,Ulrik Lund Andersen*

Main category: quant-ph

TL;DR: The paper presents a framework for converting continuous-variable (CV) resources into discrete-variable (DV) entanglement and EPR steering, defining witness monotones for CV resource theories and establishing operational connections with experimental correlations.


<details>
  <summary>Details</summary>
Motivation: To develop a systematic approach for quantifying and activating CV resources into DV entanglement or EPR steering, enhancing operational understanding and applicability in quantum resource theories.

Method: A general witness-based framework is introduced, characterized by bounded-witness monotones under specific constraints. The authors establish properties like faithfulness, strong monotonicity, and continuity for both convex and non-convex free sets, and construct CPTP channels leading to two-qubit Werner states.

Result: The framework reveals that the optimal entanglement and EPR steering obtained from witness-dependent activations depend directly on underlying monotones, with specific examples illustrating these results.

Conclusion: The findings indicate that CV free sets can be effectively quantified and operationalized through witness-based methods, offering clear pathways for translating CV resources into experimentally relevant DV correlations.
...
### [40] [Integrable, Mixed, and Chaotic Dynamics in a Single All-to-All Ising Spin Model](https://arxiv.org/abs/2604.14798)
*David Amaro-Alcalá,Carlos Pineda*

Main category: quant-ph

TL;DR: The Ising all-to-all model displays a spectrum of dynamics, from integrable to chaotic, resilient to noise, and linked to symmetry sectors via kicked top dynamics.


<details>
  <summary>Details</summary>
Motivation: To explore the dynamics of the Ising ATA model and its resilience to noise while considering fixed parameters.

Method: Dynamics are analyzed across symmetry blocks, with each block mapped to a kicked top; the dependence of KT parameters on block dimension is examined.

Result: The study reveals varied dynamics across blocks and confirms noise resilience when the Hamiltonian norm approaches 1; the mapping to kicked tops elucidates these findings.

Conclusion: The findings create a new basis for understanding quantum chaos, analogous to classical chaos in the Bunimovich billiard, enhancing research into symmetry sector dynamics.
...
TL;DR: This study analyzes the dynamics of quantum coherence in the HHL quantum algorithm for linear equations, emphasizing how coherence depends on certain coefficients and probabilities.


<details>
  <summary>Details</summary>
Motivation: To understand the coherence dynamics inherent in the HHL quantum algorithm, which is essential for quantum computing applications in solving linear systems.

Method: Utilizing Tsallis relative α entropy and l_{1,p} norm of coherence to analyze coherence for the phase estimation and inverse phase estimation processes.

Result: The research shows that coherence is influenced by coefficients from the eigenbasis decomposition and the success probability, with specific patterns based on the value of α.

Conclusion: As success probability increases, coherence decreases, indicating a relationship between coherence depletion, eigenvalues of A, and probability measures.
...
### [42] [Time-Dependent Logarithmic Perturbation Theory for Quantum Dynamics: Formulation and Applications](https://arxiv.org/abs/2604.14812)
*Juan Carlos del Valle,Paul Bergold,Karolina Kropielnicka*

Main category: quant-ph

TL;DR: This paper extends logarithmic perturbation theory to time-dependent nonrelativistic quantum dynamics, providing a framework for calculating corrections to wave functions and energy shifts influenced by external fields, applicable to systems like the harmonic oscillator and hydrogen atom.


<details>
  <summary>Details</summary>
Motivation: To develop a method that handles time-dependent quantum systems accurately while preserving the structure of logarithmic perturbation theory.

Method: The authors expand the logarithm of the wave function in powers of a coupling constant, resulting in a hierarchy of equations governed by a gauge-rotated Hamiltonian and yielding closed-integral expressions for time-dependent corrections based on Duhamel's formula.

Result: The method successfully applies to the harmonic oscillator and hydrogen atom, recovering exact solutions and yielding accurate numerical simulations of energy shifts related to time-dependent external fields.

Conclusion: This revised approach offers an effective framework for studying time-dependent multi-photon processes in quantum systems, demonstrating high accuracy in calculating relevant physical observables.
...
### [43] [Quantum Thermometry of External Phonon Reservoirs in Driven Open Quantum Systems](https://arxiv.org/abs/2604.14855)
*Yildiz Berk Ates*

Main category: quant-ph

TL;DR: The paper studies temperature sensitivity in a two-level quantum system influenced by phonon environments, finding an optimal coupling strength that enhances thermal sensing.


<details>
  <summary>Details</summary>
Motivation: To explore how environmental interactions affect the temperature sensitivity of quantum systems, particularly in the context of enhancing thermometric precision.

Method: The study employs a unitary polaron transformation to analyze phonon-induced renormalization effects beyond weak-coupling approximations, focusing on Quantum Fisher Information (QFI).

Result: The QFI shows a peak at intermediate coupling strengths, indicating an optimal regime for thermal sensing, while thermometric precision diminishes at weak and strong coupling limits.

Conclusion: Environmental interactions can be harnessed to improve the performance of quantum thermometers, transforming potential decoherence sources into advantages for thermal sensitivity.
...
### [44] [Split-Evolution Quantum Phase Estimation for Particle-Conserving Hamiltonians](https://arxiv.org/abs/2604.14921)
*Megan Cerys Rowe,Carlo A. Gaggioli,Ludmila Szulakowska,David Muñoz Ramo,David Zsolt Manrique*

Main category: quant-ph

TL;DR: The paper showcases SE-QPE, a quantum phase estimation method that improves efficiency in quantum computing. It presents a hardware demonstration on a specific quantum computer, emphasizing reduced resource requirements in evolution processes, particularly for complex Hamiltonians.


<details>
  <summary>Details</summary>
Motivation: To enhance the efficiency of quantum phase estimation while preserving compatibility with non-exact eigenstates and reducing controlled simulation overhead.

Method: SE-QPE modifies canonical quantum phase estimation by using CSWAP-based interference instead of controlled time evolution, allowing for parallel evolution and resource reduction in Hamiltonians with shared eigenbases.

Result: SE-QPE achieves up to 33% reduction in CX count, 25% in $T$ count, and an asymptotic depth ratio of $3/N$ for CX layers, demonstrating significant resource savings over various FeMoco active spaces.

Conclusion: SE-QPE demonstrates a valuable approach for reducing resource demands in quantum phase estimation, particularly beneficial for high-phase power applications, and provides useful error detection capabilities in quantum computations.
...
### [45] [Learning to Concatenate Quantum Codes](https://arxiv.org/abs/2604.14931)
*Nico Meyer,Christopher Mutschler,Dominik Seuß,Andreas Maier,Daniel D. Scherer*

Main category: quant-ph

TL;DR: This paper introduces a hybrid, learning-based method for optimizing concatenated quantum error correction codes by adapting to noise structure, significantly reducing qubit requirements.


<details>
  <summary>Details</summary>
Motivation: To enhance error correction capability in quantum computing while managing the challenges posed by noise structure during code concatenation.

Method: The approach automates the selection of quantum error correction codes by estimating the effective noise channel at each level, incorporating learning-based techniques that adaptively tailor encoders based on noise characteristics.

Result: Simulations demonstrate that this adaptive method achieves target logical error rates with up to two orders of magnitude fewer qubits compared to traditional stabilizer code concatenation, particularly under strongly structured noise.

Conclusion: The proposed hybrid, learning-based strategy significantly improves the efficiency of quantum error correction, making it a valuable advancement for achieving fault-tolerant quantum computing.
...
### [46] [Introducing a novel $Z_{4n}$-detection scheme to enhance the performance of quantum LiDAR systems](https://arxiv.org/abs/2604.14935)
*Priyanka Sharma,Manoj K Mishra,Devendra Kumar Mishra*

Main category: quant-ph

TL;DR: The paper presents a novel $Z_{4n}$-detection scheme for quantum LiDAR systems, improving resolution and sensitivity by considering specific photon counts.


<details>
  <summary>Details</summary>
Motivation: The need for enhanced measurement capabilities in quantum LiDAR systems inspires the development of a novel detection scheme to improve resolution and sensitivity.

Method: The study proposes a $Z_{4n}$-detection scheme that considers $4n$ photons as a click, using superposition of four coherent states and vacuum in a Mach-Zehnder interferometer setup.

Result: The $Z_{4n}$-detection scheme shows significant enhancements in resolution and phase sensitivity compared to the traditional $Z$-detection scheme.

Conclusion: The proposed detection scheme offers promising advancements in quantum LiDAR technology, paving the way for more precise and sensitive measurements.
...
### [47] [Floquet dynamical quantum phase transitions in periodically flux-quenched systems](https://arxiv.org/abs/2604.14946)
*Wen-Hui Nie,Mei-Yu Zhang,Lin-Cheng Wang,Chong Li*

Main category: quant-ph

TL;DR: This paper explores Floquet dynamical quantum phase transitions (FDQPTs) in periodically driven XY spin chains, emphasizing the critical role of flux differences and introducing the concept of Floquet quench fidelity.


<details>
  <summary>Details</summary>
Motivation: To understand the mechanisms governing FDQPTs in periodically driven quantum systems, highlighting their significance in nonequilibrium critical phenomena.

Method: An extended XY spin chain under a periodic flux-quench protocol is studied, analyzing metrics like Loschmidt echo and dynamical topological order parameter to investigate FDQPTs.

Result: The emergence of FDQPTs is influenced by the flux difference in micromotion periods and the Floquet fidelity condition, unlike conventional single-quench scenarios.

Conclusion: The framework developed can be applied to various periodically driven systems, offering insight into how periodic protocols shape nonequilibrium phase transitions in quantum many-body systems.
...
### [48] [Quantum gravimetry with mechanical qubits](https://arxiv.org/abs/2604.14950)
*Xiao-Wen Huo,Jun-Hong An,Peng-Bo Li*

Main category: quant-ph

TL;DR: The paper proposes a novel quantum gravimeter using levitated particles directly as gravity sensors, achieving enhanced sensitivity without auxiliary quantum systems.


<details>
  <summary>Details</summary>
Motivation: Current quantum gravimeters underutilize the mass of levitated particles due to reliance on auxiliary quantum systems, which diminish their mass advantage.

Method: The approach utilizes the mechanical qubit formed by a levitated particle to directly read its motion in response to gravity, enhancing sensitivity based on the particle's mass and phonon number.

Result: Sensitivity scales as $m^{-1/2}$ with mass and $N^{-1/2}$ with mean phonon number, achieving a sensitivity of $0.1~ 	ext{	extmu}	ext{Gal}/	ext{Hz}^{1/2}$, outperforming traditional methods by two orders of magnitude.

Conclusion: The proposed scheme offers a practical solution for high-sensitivity quantum gravimetry, simultaneously achieving optimal scaling with mass and phonon number.
...
### [49] [Three ways to share a QPU: Scheduling strategies for hybrid Quantum-HPC applications](https://arxiv.org/abs/2604.14955)
...
TL;DR: The paper investigates scheduling strategies for integrating quantum computing with high-performance computing, highlighting methodologies that optimize resource utilization across hybrid workloads.


<details>
  <summary>Details</summary>
Motivation: The integration of quantum computing into high-performance computing systems is crucial for harnessing their potential, yet challenges remain in resource management and programming model compatibility.

Method: Three scheduling methodologies are explored: time-based multiplexing, dynamic resource management, and workflow decomposition, with experimental validation on production HPC clusters and real quantum hardware.

Result: The proposed strategies significantly optimize resource utilization, achieving reductions in consumption of up to 45.7% and 64% for specific workload scenarios, and enhancing QPU utilization for high classical-quantum workload imbalances.

Conclusion: Tailored scheduling strategies demonstrate practical viability for hybrid HPC-QC environments, emphasizing their role in developing efficient, scalable software stacks for future quantum-accelerated systems.
...
### [50] [Ultrafast all-optical quantum teleportation](https://arxiv.org/abs/2604.14959)
...
TL;DR: This paper presents a method for achieving 1-terahertz-bandwidth all-optical quantum teleportation, demonstrating genuine quantum teleportation that exceeds classical limits. This advancement bypasses electrical limitations, enabling future high-speed quantum computing.


<details>
  <summary>Details</summary>
Motivation: The need to utilize light's intrinsic frequency for faster quantum information processing, surpassing the current limitations of electrical feedforward in quantum teleportation.

Method: Optically transferring Bell measurement outcomes, achieving teleportation of vacuum states and random coherent wavepackets at terahertz speeds.

Result: Teleportation fidelities of 0.784 for vacuum states and 0.770 for coherent wavepackets, both surpassing the classical limit of 0.5.

Conclusion: Optical quantum processing speeds are now limited by the nonlinear medium's response time, facilitating the development of terahertz quantum computers and a compatible quantum internet.
...
### [51] [Unconventional Photon Blockade in a Symmetrically Driven Nonlinear Dimer](https://arxiv.org/abs/2604.14963)
*Hamid Ohadi*

Main category: quant-ph

TL;DR: The paper presents a method for achieving photon blockade in a Kerr dimer using equal-amplitude fields with a specific phase difference.


<details>
  <summary>Details</summary>
Motivation: To explore photon blockade in systems with minimal inter-cavity coupling and high stability against fabrication variances.

Method: Utilizing a symmetric Kerr dimer driven by fields at a 90-degree phase difference to achieve strong antibunching of emitted light.

Result: The scheme demonstrates antibunched light emission with an easily measurable second-order correlator, effective under both continuous-wave and pulsed excitation.

Conclusion: The ability to compensate for fabrication disorder by phase re-tuning enhances the practicality of implementing this scheme in photonic applications.
...
### [52] [Recurrence Time for Finite Quantum Systems](https://arxiv.org/abs/2604.14995)
*Chaitanya Gupta,Anthony J. Short*

Main category: quant-ph

TL;DR: This paper explores the recurrence time of finite quantum systems, defining it as the time when all states are near their initial configuration, utilizing Dirichlet's approximation theorem for bounding this time in continuous and discrete cases.


<details>
  <summary>Details</summary>
Motivation: Understanding the behavior of quantum systems over time, particularly when states revert to initial configurations, is fundamental in quantum mechanics and has implications for quantum processes.

Method: The authors apply Dirichlet's approximation theorem to derive bounds on recurrence time, relating it to approximating real number differences using rational numbers.

Result: The study provides bounds on the recurrence time for finite-dimensional quantum systems, both in continuous and discrete time, leveraging new mathematical insights on rational approximations.

Conclusion: By establishing tighter bounds for recurrence time, the findings enhance our understanding of the temporal dynamics of quantum systems.
...
### [53] [Investigating Spectral Dynamics and Spin Signatures of a Mechanically Isolated Quantum Emitter in hBN](https://arxiv.org/abs/2604.14998)
*Sajedeh Shahbazi,Alexander Pachl,Kathrin Schwer,Patrick Maier,Alexander Kubanek*

Main category: quant-ph

TL;DR: The study investigates a single quantum emitter in hexagonal boron nitride (hBN) to explore its spectral characteristics and spin-related behaviors.


<details>
  <summary>Details</summary>
Motivation: Despite their potential as quantum emitters, defects in hBN exhibit spectral instabilities and an unclear spin-related nature, necessitating further investigation.

Method: The authors employed high-resolution spectroscopy, time-resolved measurements, and various photoluminescence techniques on a single mechanically isolated emitter integrated onto a coplanar waveguide.

Result: The emitter showed bright fluorescence with count rates over 10 Mc/s, revealing two zero-phonon-line transitions with different diffusion dynamics, linked to distinct recombination pathways and affected by external illumination and magnetic fields.

Conclusion: The findings elucidate how charge fluctuations and spin-dependent dynamics influence the emitter's optical behavior, contributing to a deeper understanding of its potential as a coherent quantum emitter.
...
### [54] [Runtime-efficient zero-noise extrapolation from mixed physical and logical data](https://arxiv.org/abs/2604.15014)
*D. V. Babukhin,W. V. Pogosov*

Main category: quant-ph

TL;DR: Combining quantum error correction with error mitigation through mixed datasets significantly enhances efficiency in quantum computing, achieving lower noise and reduced runtime requirements.


<details>
  <summary>Details</summary>
Motivation: To quantify the resource advantages of combining partial quantum error correction with quantum error mitigation in pre-fault-tolerant quantum systems.

Method: The study analyzes zero-noise extrapolation using mixed datasets, counting both error-corrected and non-error-corrected data points to improve variance in estimates.

Result: The mixed-data strategy reduces variance amplification and can drastically lower the physical runtime needed to achieve target precision, especially for low effective gate error rates.

Conclusion: Hybrid error correction and mitigation strategies provide a practical approach for resource-efficient quantum computation prior to achieving full fault tolerance.
...
### [55] [Hidden Quantum Advantage near the Decoding Threshold of Decoded Quantum Interferometry](https://arxiv.org/abs/2604.15025)
*Maoxin Gao,Yan Chang*

Main category: quant-ph

TL;DR: This paper improves upon existing bounds on quantum advantage in decoded quantum interferometry (DQI) by proposing a more accurate lower bound, which reveals quantum advantage in scenarios previously deemed absent.


<details>
  <summary>Details</summary>
Motivation: To accurately determine the boundaries of quantum advantage in DQI, especially where existing methods underestimate the potential for quantum performance.

Method: The authors replace the uniform penalty used in previous analyses with a weighted average penalty based on the concentration of the Perron eigenvector, resulting in a new lower bound applicable across finite fields F_q.

Result: The new bound successfully identifies quantum advantage in 26 cases where previous analyses indicated none, with an approximation ratio reaching 0.66 instead of <0.5.

Conclusion: The proposed Master Theorem significantly enhances the understanding of quantum advantage in DQI, proving more reliable than previous methodologies.
...
### [56] [Entanglement quantification with randomized measurements is maximally difficult](https://arxiv.org/abs/2604.15029)
*Julian Eisfeld,Nikolai Wyderka*

Main category: quant-ph

TL;DR: This paper addresses the certification of quantum systems, focusing on the measurement settings needed to access two-qubit invariants and their implications for entanglement certification.


<details>
  <summary>Details</summary>
Motivation: The paper aims to tackle the challenges in maintaining a common reference frame in quantum technologies by exploring reference frame independent measurement schemes.

Method: It determines the minimal number of measurement settings required to access all two-qubit invariants and analyzes the challenges associated with entanglement certification.

Result: The study reveals a fundamental hierarchy among invariants and establishes that entanglement certification is a maximally difficult task, influencing both theoretical understanding and experimental feasibility.

Conclusion: Extending the findings to three-qubit systems, the paper improves existing measurement protocols and suggests a pathway toward exploring similar hierarchies in higher dimensional systems.
...
### [57] [A NISQ-friendly Coined Quantum Walk Algorithm for Chaos-based Cryptographic Applications](https://arxiv.org/abs/2604.15030)
*Natalie Gibson,Niklas Keckman,Andrea Marchesin,Matti Raasakka,Ilkka Tittonen*

Main category: quant-ph

TL;DR: The paper introduces a novel LAQW algorithm with reduced circuit depth, suitable for NISQ devices, and demonstrates its effectiveness in chaotic symmetric-key generation.


<details>
  <summary>Details</summary>
Motivation: To provide a quantum walk model with reduced circuit depth, improving feasibility for NISQ devices while showcasing its application in cryptographic systems.

Method: The LAQW algorithm is introduced, which achieves a circuit depth of $	ext{O}(n^2+nt)$ over $t$ time steps, and is applied to generate random bitstrings for key generation using chaos-based methods.

Result: The LAQW algorithm yields reproducible 128-bit keys under simulated noise, showing significant depth advantages over the CAQW model.

Conclusion: The LAQW model is promising for cryptographic applications, demonstrating potential in key generation and overall practicality in current quantum computing environments.
...
### [58] [SyQMA: A memory-efficient, symbolic and exact universal simulator for quantum error correction](https://arxiv.org/abs/2604.15043)
*George Umbrarescu,David Amaro*

Main category: quant-ph

TL;DR: SyQMA is a simulator designed for quantum error correction, allowing for the exact simulation of quantum circuits with incoherent Pauli noise and dynamic outcomes, utilizing compact state representation and polynomial memory.


<details>
  <summary>Details</summary>
Motivation: The need for efficient simulation of universal quantum circuits is essential for advancing quantum computation and error correction techniques.

Method: SyQMA employs an intuitive extension of stabiliser simulators to manage non-Clifford Pauli rotations and incoherent noise, leveraging auxiliary qubits and modified traces for state representation.

Result: The simulator provides exact symbolic expressions for measurement probabilities, logical error rates, and supports maximum-likelihood decoding for quantum error correction without approximations.

Conclusion: SyQMA enables detailed analysis of fault-tolerant protocols and supports advanced quantum circuit simulations, being accessible as open-source software.
...
### [59] [GAT-QNN: Genetic Algorithm-Based Training of Hybrid Quantum Neural Networks](https://arxiv.org/abs/2604.15048)
*Tasnim Ahmed,Alberto Marchisio,Muhammad Kashif,Nouhaila Innan,Muhammad Shafique*

Main category: quant-ph

TL;DR: GAT-QNN enhances Hybrid Quantum Neural Networks by integrating a genetic algorithm for efficient microCircuit selection, improving accuracy while minimizing resource usage.


<details>
  <summary>Details</summary>
Motivation: To overcome performance limitations of HQNNs due to NISQ noise and the design complexity of quantum circuits, and to facilitate more effective deployment across heterogeneous backends.

Method: GAT-QNN employs a genetic algorithm to construct a macroCircuit, sampling and training subcircuits (microCircuits), then utilizing a GA-driven inference stage to evaluate and select the best architectures without retraining.

Result: Achieved 22-23% test accuracy gains on MNIST classification for GA-driven inference across different backends.

Conclusion: The two-stage framework effectively enables backend-aware microCircuit selection and optimizes computational resources.
...
### [60] [Hardware Validation of DAGI via a Modular "Ridge" Signature and High-Order Synergistic Information](https://arxiv.org/abs/2604.15051)
*Petr Sramek*

Main category: quant-ph

TL;DR: This study validates the DAGI framework on IBM Quantum hardware, revealing significant higher-order key recovery patterns despite noise.


<details>
  <summary>Details</summary>
Motivation: The goal is to validate the DAGI framework's capability to detect high-order information in a noisy quantum environment, focusing on key recovery linked to algebraic constraints.

Method: A controlled experiment was conducted with 4-bit registers, measuring output distributions on IBM hardware through 1024 shots per key to assess ridge visibility and key recovery accuracy across different orders.

Result: The results showed persistent ridge visibility under noise, with a significant ridge contrast of 2.93x and key recovery rates exceeding chance, with targeted synergy indicating the presence of non-trivial higher-order information.

Conclusion: The findings support the premise that DAGI can effectively capture and quantify higher-order information structures in quantum outputs that are resilient to noise.
...
### [61] [Quantum instanton approach to metastable collective spins](https://arxiv.org/abs/2604.15091)
*Krzysztof Ptaszynski,Maciej Chudak,Massimiliano Esposito*

Main category: quant-ph

TL;DR: This paper introduces a real-time instanton approach for analyzing collective spin systems, highlighting its advantages over the semiclassical Wigner method in capturing non-Gaussian fluctuations and dynamics during phase transitions.


<details>
  <summary>Details</summary>
Motivation: The study investigates collective spin systems, emphasizing the significance of their nonlinearity and metastable states in atomic and solid-state physics, as well as their phase transition behavior.

Method: The authors develop a real-time instanton approach using quantum quasiprobability dynamics to examine the stationary states and relaxation rates in the large-spin limit, addressing limitations of the semiclassical Wigner method.

Result: The new approach provides a more accurate description of stationary states and the scaling of relaxation rates compared to the semiclassical method, especially in relation to non-Gaussian fluctuations.

Conclusion: By addressing the limitations of existing methods, the paper establishes a framework that better captures the dynamics of collective spin systems and their transitioning behaviors.
...
### [62] [QLLVM: A Scalable Quantum-Classical Co-Compilation Framework based on LLVM](https://arxiv.org/abs/2604.15094)
*Yu Zhu,Qiming Du,Yuqiong Jin,Woji He,Hang Lian,Xin Zhou,Jinchen Xu,Zheng Shan*

Main category: quant-ph

TL;DR: QLLVM is a novel Quantum-Classical co-compilation framework that integrates classical and quantum program compilation, enhancing efficiency in the NISQ era.


<details>
  <summary>Details</summary>
Motivation: There is a pressing need for high-performance quantum compilers that can work alongside classical computing for effective quantum software development.

Method: QLLVM employs a three-stage compilation process: high-level optimizations using the MLIR Quantum dialect, followed by lowering to QIR for low-level optimization and hardware mapping.

Result: Experimental results indicate that QLLVM reduces circuit depth and gate counts compared to leading compilers, particularly benefitting hybrid classical-quantum programs.

Conclusion: QLLVM provides a robust framework for the efficient compilation of quantum and classical programs, facilitating advancements in quantum software development.
...
### [63] [O3LS: Optimizing Lattice Surgery via Automatic Layout Searching and Loose Scheduling](https://arxiv.org/abs/2604.15099)
*Chenghong Zhu,Xian Wu,Jiahan Chen,Keming He,Junjie Wu,Xin Wang,Lingling Lao*

Main category: quant-ph

TL;DR: O3LS optimizes lattice surgery in quantum computing by balancing space and time overhead, resulting in significant reductions in resource usage and logical error rates.


<details>
  <summary>Details</summary>
Motivation: Quantum error correction is crucial for practical quantum computing, and existing methods often neglect the trade-off between movement distance and rotation bottlenecks.

Method: O3LS employs automatic layout search and loose scheduling to optimize data layouts and reduce time overhead, achieving efficient resource utilizations.

Result: O3LS reduces space overhead by 28.0% over standard layouts and 46.7% over sparse layouts, suppressing logical error rates by up to 16% without increasing time steps.

Conclusion: O3LS offers significant improvements in both space and time efficiencies, achieving logical error reductions up to an order of magnitude compared to existing compilers.
...
### [64] [Low-rank geometry of two-qubit gates](https://arxiv.org/abs/2604.15102)
*Llorenç Balada Gaggioli*

Main category: quant-ph

TL;DR: A framework for two-qubit gate synthesis using determinantal geometry is proposed, revealing nonlocal complexity and quantifying gate approximations.


<details>
  <summary>Details</summary>
Motivation: To deepen the understanding of two-qubit gate synthesis and quantify the complexity of nonlocal operations.

Method: Utilizes the Weyl chamber representation and operator Schmidt theory to interpret gate synthesis as a distance problem to determinantal varieties.

Result: Identifies the square root iSWAP gate as the closest perfect entangler and establishes a fidelity limit for approximations by local gates (79.8%).

Conclusion: Introduces a synthesis-adapted coordinate system to encode nonlocal complexity and effectively reconstructs the Weyl chamber.
...
### [65] [Constraints on phantom codes from automorphism group bounds](https://arxiv.org/abs/2604.15111)
*Arthur S. Morris,Daniel Malz*

Main category: quant-ph

TL;DR: Phantom codes can reduce circuit depth but impose strict encoding constraints.


<details>
  <summary>Details</summary>
Motivation: To explore the trade-offs between circuit depth reduction and encoding efficiency in quantum fault tolerance using phantom codes.

Method: Analysis of phantom codes' encoding rates, distance properties, and construction of specific nonstabiliser codes.

Result: Proved encoding bounds for binary phantom codes, with a specific construction for k=4 that violates these bounds.

Conclusion: The logarithmic encoding constraints are universally applicable to certain code types and relate to quantum code structure.
...
### [66] [Coherent control of optomechanical entanglement and steering via dual parametric amplification](https://arxiv.org/abs/2604.15162)
*Jinhao Jia,Yingru Li,Ran Liang,Mei Zhang*

Main category: quant-ph

TL;DR: The paper presents a method for enhancing quantum correlations in cavity optomechanical systems via coherent control and parametric amplifications.


<details>
  <summary>Details</summary>
Motivation: To protect fragile quantum resources in optomechanical systems against thermal noise by engineering quantum correlations.

Method: Utilization of a coherent feedback loop and modulated optical and mechanical parametric amplifications to adjust the cavity decay rate and quantum fluctuation distribution.

Result: Strengthened quantum correlations that are robust against thermal noise, achieved through fine control of modulation frequencies and pump amplitudes.

Conclusion: The proposed scheme offers a promising avenue for generating strong, tunable quantum correlations in cavity optomechanical systems.
...
### [67] [Quantum Metropolis-Hastings via Penalised Qubitized Walks: Spectral Filtering and Circuit Implementation](https://arxiv.org/abs/2604.15179)
*Miguel Carrasco-Arango,Rosa M. Badia,Artur Garcia-Saez*

Main category: quant-ph

TL;DR: This study presents a quantum Metropolis-Hastings algorithm with circuit-level implementation and necessary modifications for practical use.


<details>
  <summary>Details</summary>
Motivation: To explore the challenges and potential of quantum variants of the Metropolis-Hastings algorithm for enhanced mixing and applicability in quantum computing.

Method: An explicit quantum circuit implementation of the Metropolis-Hastings algorithm was constructed and simulated, including modifications for realistic quantum models.

Result: The proposed modifications were crucial for achieving the correct stationary distribution, showing both the viability and limitations of the quantum approach.

Conclusion: Quantum Metropolis-Hastings algorithms hold promise but require further development to be viable in fault-tolerant quantum computing.
...
### [68] [Variational quantum state preparation within an entangle-rotate circuit framework for quantum-enhanced metrology in noisy systems](https://arxiv.org/abs/2604.15209)
...
TL;DR: The paper explores optimizing quantum states in noisy two-level systems for precision metrology using variational quantum circuits, demonstrating improved quantum Fisher information through a specific circuit architecture despite noise.


<details>
  <summary>Details</summary>
Motivation: To enhance precision metrology in the presence of noise in two-level systems by generating optimized quantum states.

Method: Employs variational quantum circuits with a twist-and-turn architecture that includes entangling layers to optimize quantum Fisher information based on decoherence and interaction dynamics.

Result: Findings indicate that increasing circuit layer depth significantly improves quantum Fisher information, even under considerable noise, indicating potential advantages for quantum-enhanced sensing.

Conclusion: The proposed method offers a general framework for generating quantum states that can withstand realistic noise, with applicability to larger systems beyond 8 qubits.
...
### [69] [Simulation of quantum annealing on a semiconducting cQED device for Multiple Hypothesis Tracking (MHT) benchmark](https://arxiv.org/abs/2604.15213)
*Quentin Schaeverbeke,Viktor Radović,Jean-Marc Divanon,Bing Hong Teh*

Main category: quant-ph

TL;DR: The paper analyzes a semiconducting spin cQED quantum processor's performance in Multiple Hypothesis Tracking (MHT) via quantum annealing, highlighting its viability for real-time applications like radar tracking.


<details>
  <summary>Details</summary>
Motivation: To evaluate the effectiveness of semiconducting spin cQED quantum processors in executing the MHT algorithm under practical error conditions.

Method: The research employs quantum annealing procedures and benchmarking scenarios on a quantum emulator, accounting for both coherent and incoherent errors.

Result: The cQED-spin processors demonstrated a potential total run time of around 50 ms, suitable for real-time applications.

Conclusion: Given its performance and error management, this technology holds promise for real-time applications, exemplified by radar tracking.
...
### [70] [Optimal algorithmic complexity of inference in quantum kernel methods](https://arxiv.org/abs/2604.15214)
*Elies Gil-fuster,Seongwook Shin,Sofiene Jerbi,Jens Eisert,Maximilian J. Kramer*

Main category: quant-ph

TL;DR: Quantum kernel methods can be optimized for inference cost by combining quantum amplitude estimation and single-observable sum approximation, achieving a query complexity of $O(\lVertα\rVert_1/\varepsilon)$, which significantly reduces dependency on training data size compared to traditional methods.


<details>
  <summary>Details</summary>
Motivation: To overcome the high inference costs of quantum kernel methods in supervised learning by optimizing how kernel values are estimated and summed.

Method: The study systematically evaluates combinations of estimation techniques and sum approximation methods, focusing on quantum amplitude estimation and encoding sums as expectations of single observables to achieve optimal query complexity.

Result: The proposed method achieves a query complexity of $O(\lVertα\rVert_1/\varepsilon)$, eliminating the dependence on $N$ and improving efficiency by quadratic factors in $\lVertα\rVert_1$ and $\varepsilon$. A lower bound of $Ω(\lVertα\rVert_1/\varepsilon)$ confirms the optimality of this approach.

Conclusion: The results provide a query-optimal algorithm for quantum kernel methods, with practical guidance on strategy selection based on hardware capabilities, and show the importance of considering both query complexity and gate costs.
...
### [71] [Universal quantum state purification with energy-preserving operations](https://arxiv.org/abs/2604.15228)
*Xing-Chen Guo,Benchi Zhao,Xin Wang*

Main category: quant-ph

TL;DR: The paper presents a framework for quantum state purification that respects energy conservation, addressing limitations of existing protocols that ignore these constraints.


<details>
  <summary>Details</summary>
Motivation: To develop quantum state purification methods that consider the energetic limitations of real-world quantum devices, rather than assuming unconstrained operations.

Method: A general framework for universal state purification is established under energy-conservation constraints, including deriving conditions for nonexistence of universal energy-preserving purification and optimizing performance.

Result: The paper identifies the necessary and sufficient conditions for energy-constrained purification and shows how optimal protocols can be implemented, supported by numerical results confirming their effectiveness.

Conclusion: The findings provide fundamental limits on state distillation and present an energy-efficient approach to quantum error mitigation, extending the standard purification methods.
...
### [72] [IQP circuits for 2-Forrelation](https://arxiv.org/abs/2604.15248)
*Quentin Buzet,André Chailloux*

Main category: quant-ph

TL;DR: The paper explores the 2-Forrelation problem within the context of quantum query complexity, demonstrating that it can be solved with IQP circuits, thus indicating their capability for classically hard problems and offering a new perspective on quantum advantage.


<details>
  <summary>Details</summary>
Motivation: To investigate the minimal quantum resources required to solve the 2-Forrelation problem and explore the implications for quantum computation models like IQP.

Method: The authors use commutative IQP circuits with two quantum queries and classical processing for the standard 2-Forrelation; for the signed variant, a single IQP circuit and query is sufficient.

Result: Establishes that IQP can efficiently solve 2-Forrelation and shows that the class $(	ext{BPP}^	ext{IQP})^O$ does not fit within $	ext{PH}^O$, thus reinforcing the separation of complexity classes.

Conclusion: The findings extend the understanding of quantum computational advantages with IQP models, highlighting their utility in addressing classically hard problems, along with proving new growth bounds for IQP circuits.
...
### [73] [General framework for anticoncentration and linear cross-entropy benchmarking in photonic quantum advantage experiments](https://arxiv.org/abs/2604.15258)
*Zoltán Kolarovszki,Ágoston Kaposi,Zoltán Zimborás,Michał Oszmaniec*

Main category: quant-ph

TL;DR: This paper develops a theoretical framework for linear cross-entropy benchmarking (LXEB) in photonic quantum computing, focusing on its application to Boson Sampling and Gaussian Boson Sampling.


<details>
  <summary>Details</summary>
Motivation: To address the lack of systematic theoretical understanding of LXEB in photonic quantum advantage experiments.

Method: A representation-theoretic framework is introduced for calculating average LXEB scores and second moments of output probability distributions for $n$-photon states in $m$-mode Haar-random interferometers.

Result: The approach proves anticoncentration for Fock-state Boson Sampling in saturated regimes, while highlighting that second moments alone are inadequate for Gaussian Boson Sampling.

Conclusion: The decomposition of bosonic spaces into irreducible representations reveals the crucial role of particle entanglement in LXEB measurements.
...
### [74] [Computing the free energy of quantum Coulomb gases and molecules via quantum Gibbs sampling](https://arxiv.org/abs/2604.15263)
*Simon Becker,Cambyse Rouzé,Robert Salzmann*

Main category: quant-ph

TL;DR: This paper presents a quantum algorithm for estimating free energy and Gibbs states in interacting quantum Coulomb gases and molecular systems, addressing challenges posed by singular interactions and leveraging finite-rank truncation methods.


<details>
  <summary>Details</summary>
Motivation: The study addresses the difficulty of estimating free energy and Gibbs states in quantum systems with singular interactions, which existing classical methods cannot handle effectively.

Method: The authors approximate the free energy via low-energy truncation of interactions and develop a quantum Gibbs sampling scheme influenced by quantum Markov semigroups, ensuring a positive spectral gap for convergence to the Gibbs state.

Result: The main result is the establishment of a strictly positive spectral gap for the generator associated with the Gibbs sampling, guaranteeing exponential convergence and providing a rigorous mixing-time guarantee.

Conclusion: This work provides a mathematically rigorous framework for quantum algorithms in free energy estimation, allowing for calculations without classical approximations like the Born-Oppenheimer reduction.
...
### [75] [Assembling Extensive Quantum Fisher Information in Stabilizer Systems](https://arxiv.org/abs/2604.15268)
*Arnau Lira-Solanilla,Sreemayee Aditya,Xhek Turkeshi,Silvia Pappalardi*

Main category: quant-ph

TL;DR: A framework is developed for creating nonlocal observables in stabilizer codes that reveals extensive quantum Fisher information density, aiding in the understanding of QFI scaling transitions.


<details>
  <summary>Details</summary>
Motivation: To improve the accessibility of nonlocal quantum features by relating them to measurable quantities through the formalism of quantum Fisher information.

Method: The authors map stabilizer generators to dual Ising spins, allowing the calculation of correlators that correspond to string order parameters, thus revealing nonlocal order.

Result: The application to monitored cluster codes and the toric code showcases a transition in QFI scaling from extensive to intensive regimes, influenced by measurements.

Conclusion: This work bridges nonlocal order and quantum measurement, providing a method to investigate the impact of competing measurements on quantum information.
...
### [76] [Cloning is as Hard as Learning for Stabilizer States](https://arxiv.org/abs/2604.15269)
*Nikhil Bansal,Matthias C. Caro,Gaurav Mahajan*

Main category: quant-ph

TL;DR: This paper explores the relation between sample complexities in cloning and learning of $n$-qubit stabilizer states, establishing that optimal cloning complexity is $Θ(n)$, which aligns with learning complexity.


<details>
  <summary>Details</summary>
Motivation: Investigating the relationship between sample complexities for cloning and learning structured quantum states, as traditional quantum theory principles seem at odds with modern quantum learning algorithms.

Method: Utilizes representation-theoretic tools and the Abelian State Hidden Subgroup framework, alongside a new structured random purification channel to derive cloning lower bounds through sample amplification techniques.

Result: Demonstrates that for $n$-qubit stabilizer states, the optimal cloning sample complexity is $Θ(n)$, highlighting that cloning remains as complex as learning.

Conclusion: The findings contribute to a nuanced understanding of No-Cloning theorems, linking foundational quantum principles with advancements in quantum learning and cryptography.
...
### [77] [Generation of Schrödinger cat-like states via degenerate dual pump spontaneous four-wave mixing in a $χ^{(3)}$ microring resonator](https://arxiv.org/abs/2604.15275)
*Ranjit Singh,Alexander E. Teretenkov*

Main category: quant-ph

TL;DR: This paper investigates generating non-Gaussian Schrödinger cat-like states through a novel approach in a microring resonator, demonstrating robustness despite dissipation.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of degenerate dual-pump spontaneous four-wave mixing in generating non-Gaussian quantum states, specifically SCLSs, within a microring resonator framework.

Method: A unitary transformation decouples self-phase modulation and cross-phase modulation, simplifying the Hamiltonian to study dynamics via the Lindblad master equation while incorporating quantum pump depletion and cavity losses.

Result: The study reveals that the signal mode exhibits clear non-Gaussian characteristics, evident through structured Wigner functions and coherent state features, even under dissipative conditions with high fidelity retention.

Conclusion: Degenerate dual-pump spontaneous four-wave mixing in microring resonators serves as an effective method for generating and controlling non-Gaussian states, showing robustness against dissipation.
...
### [78] [Super-Constant Weight Dicke States in Constant Depth Without Fanout](https://arxiv.org/abs/2604.15298)
*Lucas Gretta,Meghal Gupta,Malvika Raj Joshi*

Main category: quant-ph

TL;DR: The paper presents a method for preparing $n$-qubit Dicke states of weight $k$ in constant depth using specific quantum gates, advancing the construction capabilities within the QAC$^0$ model.


<details>
  <summary>Details</summary>
Motivation: Dicke states serve as crucial entanglement resources for applications in quantum computing, especially relevant in the NISQ era and Decoded Quantum Interferometry (DQI).

Method: The authors propose explicit constant-depth circuits using multi-qubit Toffoli gates and single-qubit unitaries to prepare Dicke states for all $k \leq \text{polylog}(n)$, eliminating the need for the FANOUT$_n$ gate.

Result: Establishes that any weight-$k$ Dicke state requires access to FANOUT$_{\min(k,n-k)}$ and characterizes the condition under which weight-$k$ Dicke states can be prepared in QAC$^0$ based on FANOUT$_k$ capabilities.

Conclusion: Extending the methodology allows arbitrary symmetric states to be prepared in constant depth on quantum hardware that supports FANOUT$_n$, marking a significant advancement in quantum circuit construction.
...
TL;DR: The paper presents $σ$-ensembles of random quantum states, overcoming entanglement issues of Haar measure states by allowing control between volume-law and area-law behavior.


<details>
  <summary>Details</summary>
Motivation: Generating random quantum states while managing their entanglement properties is essential for practical applications in quantum physics.

Method: The authors introduce $σ$-ensembles, tuning a single parameter to create states with controlled entanglement, using a probability distribution on eigenvalues and the matrix product state formalism.

Result: The constructed states exhibit area-law entanglement, allowing for more efficient classical simulations compared to Haar-random states, and are representative of typical Hamiltonian ground states.

Conclusion: The $σ$-ensembles provide a tractable alternative to Haar measure states, addressing significant challenges in the generation and simulation of random quantum states.
...
### [80] [Heuristic Search for Minimum-Distance Upper-Bound Witnesses in Quantum APM-LDPC Codes](https://arxiv.org/abs/2604.15307)
*Kenta Kasai*

Main category: quant-ph

TL;DR: This paper presents upper bounds on the minimum distance of Calderbank-Shor-Steane quantum LDPC codes using techniques involving logical representatives and row-space relations.


<details>
  <summary>Details</summary>
Motivation: To explore upper bounds on the minimum distance of specific quantum LDPC codes by constructing non-stabilizer logical representatives.

Method: Utilizes a framework based on latent row relations and specific subspace constructions for verifying upper bounds through exclusion tests of kernel and stabilizer space.

Result: Improved bounds for APM-LDPC codes and concrete certified values were obtained across a tested parameter range.

Conclusion: The proposed methods enhance the understanding of upper bounds in quantum LDPC codes, contributing precise values to the field.
...
### [81] [Studies of the Modular COsmic Ray Detector (MCORD) using an automatic temperature control loop to maintain constant gain parameters of semiconductor SiPM photomultipliers](https://arxiv.org/abs/2604.15250)
...
TL;DR: The MCORD detector is analyzed for temperature effects on SiPM performance, employing automatic compensation loops to enhance gain stability.


<details>
  <summary>Details</summary>
Motivation: To optimize the performance of the MCORD detector under varying ambient temperatures, particularly focusing on SiPM gain stability.

Method: Automatic temperature compensation loops were implemented, and various control strategies were evaluated through controlled laboratory measurements.

Result: Effectiveness of different control strategies was assessed, highlighting optimal configurations for gain stability and response dynamics.

Conclusion: Recent modifications to the detector's electronics and software enhance its temperature control, supporting improved measurements in planned MCORD applications.
...
### [82] [NOMAI : A real-time photometric classifier for superluminous supernovae identification. A science module for the Fink broker](https://arxiv.org/abs/2604.14761)
...
TL;DR: NOMAI is a machine learning classifier for identifying superluminous supernovae (SLSNe) in real-time ZTF photometric alerts, achieving significant success in candidate identification.


<details>
  <summary>Details</summary>
Motivation: SLSNe are rare and luminous stellar explosions, necessitating efficient identification in time-domain survey streams for follow-up studies.

Method: NOMAI uses XGBoost to classify SLSN candidates based on features derived from ZTF light curves without requiring spectral redshift, utilizing a training dataset of 5280 sources including 225 classified SLSNe.

Result: The classifier achieved 66% completeness and 58% purity, successfully identifying 22 of 24 active SLSNe during a two-month evaluation period.

Conclusion: NOMAI efficiently aids in scanning alert streams for SLSN candidates and is expected to adapt for future surveys like the LSST.
...
### [83] [Sky background accounting in spectral infrared observations of extended objects at the Caucasus Mountain Observatory of the SAI MSU](https://arxiv.org/abs/2604.14863)
*A. S. Gusev,A. M. Tatarnikov,S. G. Zheltoukhov,M. S. Kirsanova*

Main category: astro-ph.IM

TL;DR: This paper presents a new technique for processing near-infrared spectral data of extended astronomical objects, addressing issues caused by variable atmospheric interference.


<details>
  <summary>Details</summary>
Motivation: To enhance spectral data accuracy for extended astronomical objects, which are impacted by atmospheric variability.

Method: A novel technique was developed that accounts for and excludes the influence of variable atmospheric hydroxyl lines in infrared spectra.

Result: The technique was successfully tested on the star-forming region NGC 7538, demonstrating its effectiveness in addressing atmospheric interference.

Conclusion: This method improves the processing of spectra for extended astronomical objects, enabling more reliable spectral analysis in variable atmospheric conditions.
...
### [84] [Continuing to Advance European High Contrast Imaging Research and Development towards HWO and LIFE](https://arxiv.org/abs/2604.15077)
...
TL;DR: The 2025 European R&D for Space-based High Contrast Imaging Workshop set strategic priorities for exoplanet imaging missions, highlighting key technical areas and collaboration needs.


<details>
  <summary>Details</summary>
Motivation: To enhance Europe's capabilities and coordination in future exoplanet imaging missions like HWO and LIFE.

Method: Defined priorities in eight technical areas and engaged in discussions regarding strengths and gaps in adaptive optics, interferometry, and detectors.

Result: Highlighted the need for a European vacuum testbed and emphasized advanced data reduction algorithms and coronagraphy as key areas for leadership.

Conclusion: Created a collaborative roadmap to enhance technological readiness and foster partnerships to maintain European leadership in space-based exoplanet exploration.
...
### [85] [Probing $τ$ lepton dipole moments at future Lepton Colliders](https://arxiv.org/abs/2604.14281)
*Dario Buttazzo,Gabriele Levati,Yang Ma,Fabio Maltoni,Paride Paradisi,ZeQiang Wang*

Main category: hep-ph

TL;DR: Future lepton colliders, particularly the Future Circular Collider and muon collider, can significantly constrain the electric and magnetic dipole moments of the τ lepton across various production channels.


<details>
  <summary>Details</summary>
Motivation: The dipole moments of the τ lepton are currently poorly constrained compared to those of the electron and muon, making them a crucial area for probing beyond the Standard Model physics.

Method: The study investigates multiple channels for τ dipole moment production at future lepton colliders, analyzing processes such as τ pair production, Higgs production, radiative Higgs decays, and vector-boson scattering.

Result: The results indicate that future lepton colliders can extend the limits on τ dipole moments by several orders of magnitude, demonstrating the complementarity of these facilities in probing new physics.

Conclusion: By exploring various production mechanisms, this research emphasizes the potential of lepton colliders to significantly advance our understanding of τ lepton dipole moments, potentially leading to new discoveries in particle physics.
...
### [86] [Probing Neutrino Compositeness with Invisible and Displaced Signals](https://arxiv.org/abs/2604.14282)
*Matteo Borrello,Marco Costa,Diego Redigolo,Michele Tammaro*

Main category: hep-ph

TL;DR: The paper investigates how neutrinos might interact with a 'sterile' sector, leading to new detection signatures, specifically dark jets, in high-energy neutrino experiments.


<details>
  <summary>Details</summary>
Motivation: To explore the potential interactions of neutrinos with a composite sterile sector and identify new experimental signals in high-energy physics.

Method: By analyzing the dynamics of neutrinos disintegrating into hidden states, or dark jets, under various confinement scales and through different particle interactions.

Result: The study identifies two main signatures: changes in the neutral-current to charged-current ratio due to long-lived dark resonances and the production of displaced vertices or emerging jets from shorter-lived dark states.

Conclusion: High-energy neutrino beams can provide significant sensitivity to neutrino compositeness, with experiments like DUNE and the Future Circular Collider being crucial for probing these new physics scenarios.
...
### [87] [A Busy Higgs Signal](https://arxiv.org/abs/2604.14284)
*Peiran Li,Zhen Liu,Lian-Tao Wang*

Main category: hep-ph

TL;DR: This paper identifies a mechanism that enhances Higgs-rich final states in searches for new resonances, challenging conventional expectations based on SU(2) symmetry.


<details>
  <summary>Details</summary>
Motivation: To explore physics beyond the Standard Model through Higgs final states, typically correlated with gauge-boson channels in resonance searches.

Method: The authors analyze higher-order Higgs couplings and their electroweak-symmetry-breaking effects using effective field theory and potential UV completions.

Result: Enhanced Higgs-rich final states could dominate discovery channels for new resonances, including di-Higgs for scalar resonances, and tri-Higgs and four-Higgs channels for higher masses.

Conclusion: The enhanced channels can serve as important targets for collider searches, expanding the range of phenomena investigated beyond traditional expectations.
...
### [88] [Cornering MeV-GeV Axions and Dark Photons with LDMX](https://arxiv.org/abs/2604.14285)
*Sarah Gaiser,Alessandro Russo,Philip Schuster*

Main category: hep-ph

TL;DR: The paper explores the sensitivity of the Light Dark Matter eXperiment (LDMX) to axion-like particles and dark photons in a previously unexplored low-mass range below 100 MeV.


<details>
  <summary>Details</summary>
Motivation: The motivation arises from the need to address dark matter models and the strong CP problem, particularly in the sub-100 MeV mass range where current searches are ineffective.

Method: The authors assess the capabilities of LDMX to detect axions and dark photons, considering its clean production environment and tracking abilities.

Result: The study finds that LDMX has the potential to significantly close the low-mass gap for axion and dark photon detection.

Conclusion: By utilizing LDMX's capabilities, experimental searches can advance our understanding of these particles in the low-mass domain.
...
### [89] [Logarithmic EW corrections at two-loop](https://arxiv.org/abs/2604.14320)
*J. M. Lindert,L. Mai*

Main category: hep-ph

TL;DR: The paper details the implementation of NNLO electroweak virtual corrections in OpenLoops, emphasizing the significance of these corrections in key LHC processes.


<details>
  <summary>Details</summary>
Motivation: To improve the accuracy of theoretical predictions for LHC processes by incorporating higher-order electroweak corrections.

Method: Implementation of NNLO electroweak virtual corrections at NLL accuracy in OpenLoops, focusing on massless fermions and transversely polarized vector bosons.

Result: Validation against literature results shows that logarithmic EW corrections significantly affect kinematic distributions, with enhancements observed at both NLO and NNLO levels.

Conclusion: The two-loop EW corrections help reduce theoretical uncertainties by addressing missing higher-order contributions, crucial for accurate LHC phenomenology.
...
### [90] [Astrophysical bounds on the high-energy evolution of neutrino mixing](https://arxiv.org/abs/2604.14409)
*Mauricio Bustamante,Qinrui Liu,Gabriela Barenboim*

Main category: hep-ph

TL;DR: This paper discusses the evolution of neutrino mixing parameters at high energies using astrophysical neutrinos, highlighting the potential of upcoming experiments.


<details>
  <summary>Details</summary>
Motivation: Conventional neutrino oscillation experiments are limited to sub-TeV scales, necessitating exploration at higher energies to understand neutrino mixing evolution.

Method: The study analyzes the flavor composition of high-energy neutrinos (ν_e, ν_μ, ν_τ) to constrain the evolution of mixing parameters, considering factors from Standard Model Effective Field Theory and astrophysical uncertainties.

Result: Current IceCube measurements are not sensitive enough to detect the running of mixing parameters, but predictions indicate that future multi-detector combinations will significantly improve the bounds on high-energy neutrino mixing.

Conclusion: The findings suggest that high-energy neutrino observations could yield crucial insights into the evolution of neutrino mixing parameters, surpassing the limitations of conventional experiments.
...
### [91] [Wave-envelope dark matter beyond the monochromatic paradigm](https://arxiv.org/abs/2604.14480)
*Yechan Kim,Hye-Sung Lee*

Main category: hep-ph

TL;DR: This paper explores how ultralight dark matter signals exhibit non-monochromatic characteristics due to field mixing, leading to a two-timescale structure with slow modulation.


<details>
  <summary>Details</summary>
Motivation: Traditional searches for ultralight dark matter often assume monochromatic signals, which may not hold true in the presence of field mixing.

Method: The authors analyze the effects of mixing between ultralight wave dark matter fields, revealing a two-timescale structure in the signals.

Result: The study shows that field mixing can give rise to slow-beating envelopes and sideband structures in frequency spectra, contrasting with the expected monochromatic signals.

Conclusion: Implications of these findings extend to neutrino observables, suggesting a need to reassess traditional dark matter signal assumptions.
...
### [92] [Search for the $Λ_cΣ_c$ and $\barΛ_cΣ_c$ dibaryon structures via the QCD sum rules](https://arxiv.org/abs/2604.14597)
*Xiu-Wu Wang,Zhi-Gang Wang,Guo-Liang Yu*

Main category: hep-ph

TL;DR: This paper investigates hexaquark states, specifically the $Λ_cΣ_c$ and $arΛ_cΣ_c$ dibaryons, using QCD sum rules, identifying several molecular and resonance states based on calculated masses and pole residues.


<details>
  <summary>Details</summary>
Motivation: To explore the possible existences of dibaryon states composed of hexaquark currents, extending the understanding of exotic hadronic matter.

Method: The authors construct eight pairs of hexaquark currents, showing their equivalence and using QCD sum rules to calculate masses and pole residues of the relevant states.

Result: The study identifies three possible molecular states: the $Λ_cΣ_c$ dibaryon with $J^P=1^+$ and $arΛ_cΣ_c$ dibaryons with $J^P=0^-$ and $1^-$. The other five states do not form bound dibaryons, categorizing them as resonances.

Conclusion: The findings suggest certain configurations of hexaquark states are viable as molecular states, while others are less likely to exist as bound states.
...
### [93] [Inflaton Regeneration via Scalar Couplings: Generic Models and the Higgs Portal](https://arxiv.org/abs/2604.14620)
*Kunio Kaneta,Tomo Takahashi,Natsumi Watanabe*

Main category: hep-ph

TL;DR: The paper challenges the assumption that the inflaton field becomes negligible post-reheating, showing that for monomial potentials (k ≥ 4), the inflaton's effective mass decreases as the Universe expands, enabling interactions with thermal plasma and potential dark matter implications.


<details>
  <summary>Details</summary>
Motivation: To explore the dynamics of the inflaton field beyond the standard assumption of its insignificance after reheating, particularly in models where the potential is a monomial of the form V(φ) ∝ φ^k.

Method: Analyzing inflationary models with potentials V(φ) ∝ φ^k (k ≥ 4) to demonstrate how the effective mass of the inflaton changes with field amplitude and cosmic expansion, facilitating interactions with thermal plasma.

Result: Identified a mechanism where vanishing effective mass allows inflaton regeneration through particle decays and scatterings, impacting dark matter generation and giving constraints via big bang nucleosynthesis and the cosmic microwave background.

Conclusion: This work presents a novel framework for understanding post-inflationary dynamics, with implications for dark matter and the nature of reheating, especially if reheating involves the Standard Model Higgs.
...
### [94] [Mechanical properties of proton in the momentum space](https://arxiv.org/abs/2604.14625)
*Navpreet Kaur,Shubham Sharma,Abi Jebarson A,Harleen Dahiya*

Main category: hep-ph

TL;DR: This study examines the energy-momentum tensor of protons using gravitational transverse momentum-dependent distributions, incorporating higher-twist effects to analyze mechanical properties like transverse pressure and shear forces for $u$ and $d$ quark flavors.


<details>
  <summary>Details</summary>
Motivation: To understand the mechanical properties of protons through a refined parametrization of the energy-momentum tensor in momentum space.

Method: Utilized the light-cone framework and the spectator diquark model to compute gravitational transverse momentum-dependent distributions for $u$ and $d$ quarks, including higher-twist contributions.

Result: Calculated individual distributions for $u$ and $d$ quarks, revealing significant binding contributions to transverse pressure in low-momentum space.

Conclusion: The study provides insights into the mechanical properties of protons, highlighting strong transverse pressure contributions from both quark flavors.
...
### [95] [Exploring non-equilibrium effects in sequential freeze-in](https://arxiv.org/abs/2604.14688)
*Shiuli Chatterjee,Andrzej Hryczuk*

Main category: hep-ph

TL;DR: This study examines the freeze-in process of multi-component dark sectors, emphasizing the significance of their internal dynamics and deviations from thermal equilibrium on dark matter abundance and distributions.


<details>
  <summary>Details</summary>
Motivation: The authors aim to understand how non-equilibrium dynamics affect dark matter properties, which is crucial for accurate predictions in dark sector models.

Method: They utilize a minimal two-scalar model to analyze the effects of non-thermal evolution on dark matter abundance, comparing a full phase-space treatment with a traditional number-density approach.

Result: The study finds deviations in dark matter abundance predictions of up to an order of magnitude, highlighting significant differences between the two analytical methods.

Conclusion: The findings underscore the necessity for phase-space level computations in freeze-in scenarios and call for advanced numerical tools to better study multi-component dark sectors.
...
### [96] [Rescattering effects in near-threshold $J/ψ$ photoproduction](https://arxiv.org/abs/2604.14814)
*S. Sakinah,Sang-Ho Kim,H. M. Choi*

Main category: hep-ph

TL;DR: The paper investigates near-threshold $J/ψ$ photoproduction, focusing on hadronic rescattering and open-charm states, showing improved data fitting through effective Lagrangian methods.


<details>
  <summary>Details</summary>
Motivation: To explore the impact of open-charm meson-baryon intermediate states on $J/ψ$ photoproduction, beyond conventional mechanisms.

Method: An effective Lagrangian framework was used to incorporate $ar D^0Λ_c^+$ and $ar D^{*0} Λ_c^+$ channels, calculating production amplitudes via tree-level diagrams in a gauge-invariant way.

Result: The inclusion of open-charm rescattering significantly enhances data fitting, especially at large momentum transfer, and reveals cusp-like features in GlueX data around thresholds.

Conclusion: Predictions for open-charm processes show cross sections around 5 nb, highlighting the relevance of intermediate states in photoproduction.
...
### [97] [Status of the hadronic light-by-light contribution to the muon $g-2$ and holographic QCD predictions](https://arxiv.org/abs/2604.14891)
*Anton Rebhan,Luigi Cappiello,Josef Leutgeb,Jonas Mager*

Main category: hep-ph

TL;DR: The paper reviews advancements in the hadronic light-by-light (HLbL) contributions to the muon anomalous magnetic moment, focusing on holographic QCD models and their predictions concerning tensor-meson contributions.


<details>
  <summary>Details</summary>
Motivation: To evaluate the HLbL contribution's role in the discrepancy between theoretical predictions and experimental data for the muon anomalous magnetic moment.

Method: The paper analyzes holographic QCD models and their tensor-meson contributions, comparing them with the 2020 White Paper's predictions and existing data.

Result: Holographic predictions show significant alignment with singly virtual data for tensor-meson transition form factors, presenting a sizable positive contribution to the HLbL estimate.

Conclusion: This contribution might resolve the existing tensions between lattice QCD calculations and empirical results regarding the HLbL effect.
...
### [98] [Glauber-Lachs formula-based analysis of three-pion Bose-Einstein correlation data at 7 TeV from the LHCb Collaboration](https://arxiv.org/abs/2604.15011)
*Takuya Mizoguchi,Seiji Matsumoto,Minoru Biyajima*

Main category: hep-ph

TL;DR: The paper analyzes two- and three-pion Bose–Einstein correlations at 7 TeV using quantum optics and a two-component model for pion production.


<details>
  <summary>Details</summary>
Motivation: To enhance understanding of pion production and correlations in high-energy collisions, particularly in the context of LHCb data.

Method: Utilization of the Glauber–Lachs formula alongside a two-component picture for pion production, employing a dipole form and an inverse one-and-a-half pole form for the pion exchange function $E_{2B}$ in a 4D Euclidean configuration space.

Result: The analysis provides insights into the correlations observed in LHCb data, refining the model of pion interactions and production mechanisms.

Conclusion: The findings contribute to a deeper comprehension of Bose–Einstein correlations in particle physics, fostering better modeling of high-energy collision events.
...
### [99] [Phenomenology of Vanishing Effective Majorana Mass with a Sterile Neutrino under Cosmological and JUNO Constraints](https://arxiv.org/abs/2604.14983)
*Rushi Chambyal,Tapender,Labh Singh,Surender Verma*

Main category: hep-ph

TL;DR: This study examines the effects of a zero effective Majorana neutrino mass in a 3+1 neutrino model with a sterile neutrino, focusing on constraints from cosmological bounds and the implications for neutrinoless double beta decay.


<details>
  <summary>Details</summary>
Motivation: To investigate the implications of a zero effective Majorana mass in the context of a 3+1 neutrino model and understand the parameter space involving sterile neutrinos.

Method: Analysis of neutrino mass parameters, interactions, and cancellations between active and sterile states, incorporating cosmological data and JUNO experimental results.

Result: Identified parameter space shows that cosmological bounds restrict the sterile mixing angle and the lightest active neutrino mass, with some cancellations arising due to CP violation affecting detection of certain parameters.

Conclusion: Sterile neutrino parameters may be less sensitive to precise measurements from the JUNO experiment, indicating complex interactions between neutrino states that challenge straightforward interpretations.
...
### [100] [Production of doubly heavy quarkonium associated with two heavy quarks via top quark decays](https://arxiv.org/abs/2604.15015)
*Juan-Juan Niu,Xu-Chang Zheng,Hong-Hao Ma*

Main category: hep-ph

TL;DR: The paper examines the $1 \rightarrow 4$ decay channel for producing $(b\bar{c})$ and $(c\bar{c})$ quarkonium from top-quark decays using NRQCD, presenting calculations for decay widths and potential experimental implications for LHC.


<details>
  <summary>Details</summary>
Motivation: To explore the production mechanisms of doubly heavy quarkonium states through top-quark decays, enhancing understanding of heavy quark interactions in high-energy physics.

Method: Utilizing nonrelativistic QCD (NRQCD) to analyze the decay channels $t \to (b\bar{c}) + c + c + \bar{s}$ and $t \to (c\bar{c}) + b + c + \bar{s}$, focusing on S-wave color-singlet states and calculating their decay widths.

Result: Decay widths calculated for $ar{B_{c}}$, $ar{B_{c}^{*}}$, $J/ψ$, and $η_{c}$ yield event predictions on the order of ${\cal O}(10^{4}\text{--}10^{6})$ for $ar{B}_c^{(*)}$ and ${\cal O}(10^{3}\text{--}10^{5})$ for charmonium production at LHC.

Conclusion: The discovered decay channels are significant for producing $J/ψ$ and $η_{c}$, offering insight into quarkonium production and validating the narrow-width approximation, with suggested theoretical and experimental follow-up.
...
### [101] [Symmetry Preserving Contact Interaction Approaches: An Overview of Meson and Diquark Form Factors](https://arxiv.org/abs/2604.15122)
*L. X. Gutiérrez-Guerrero,Roger José Hernández-Pinto*

Main category: hep-ph

TL;DR: This paper reviews the evolution and current application of the Contact Interaction model in hadronic physics, focusing on the mass spectrum and form factors of mesons and diquarks, as well as comparisons with experimental results and other theoretical frameworks.


<details>
  <summary>Details</summary>
Motivation: The motivation for this work is to provide a comprehensive overview of the Contact Interaction model, which facilitates a nonperturbative understanding of QCD and has potential applications in baryon and multiquark studies.

Method: The paper employs the Contact Interaction model to analyze the mass spectrum and elastic form factors of various mesons and their diquark partners, incorporating recent literature to update comparisons and refine prior results.

Result: The analysis reveals that the Contact Interaction model remains a viable tool for studying hadronic structure, successfully aligning many predictions with recent experimental data while identifying its strengths and limitations.

Conclusion: The authors conclude that ongoing experiments, particularly at FAIR and Jefferson Lab, will enhance our understanding of hadron structure and provide critical benchmarks for testing the Contact Interaction model.
...
### [102] [Dilaton-Flattened Axion Inflation](https://arxiv.org/abs/2604.15194)
*Pirzada,Ali Muhammad,Tianjun Li,Imtiaz Khan,Mussawir Khan*

Main category: hep-ph

TL;DR: This paper introduces a novel effective theory for axion inflation using a Lambert-$W$ potential to simplify the dynamics and satisfy observational constraints.


<details>
  <summary>Details</summary>
Motivation: To develop a solvable model for axion inflation that effectively incorporates anomalies without relying on external operators.

Method: The authors eliminate the radial field at tree-level, leading to a Lambert-$W$ potential that flattens the inflationary potential. They derive observables from a reduced one-field action, ensuring robustness against approximations.

Result: The model yields consistent predictions for tensor-to-scalar ratio $r$ and running of spectral index $α_s$, aligning with current observational constraints.

Conclusion: The Lambert-$W$ framework provides a flexible benchmark for axion inflation, offering pathways for further refinement and consistency with reheating physics.
...
### [103] [Echoes of Global Cosmic Strings](https://arxiv.org/abs/2604.15241)
*Jeff A. Dror,Antonios Kyriazis*

Main category: hep-ph

TL;DR: The study investigates the consequences of cosmic strings from phase transitions in the Universe, focusing on decay products such as gravitational waves and Nambu-Goldstone bosons, and assesses their detectability through cosmological probes.


<details>
  <summary>Details</summary>
Motivation: To understand the implications of cosmic strings formed during the Universe's phase transitions and how they might yield observable effects in the form of gravitational waves or dark matter.

Method: Semi-numerical methods are used to estimate the energy density and matter power spectrum resulting from decay events, followed by a comparison of these predictions with various cosmological observations.

Result: Derived constraints on the mass of Nambu-Goldstone bosons and the symmetry-breaking scale, informed by observations of the cosmic microwave background and other cosmic structures.

Conclusion: Projected sensitivity of future cosmic microwave background missions indicates potential for better detection and understanding of these phenomena.
...
TL;DR: The paper presents a search for heavy resonances decaying into four leptons via two intermediate bosons in proton-proton collisions at the LHC, utilizing novel techniques and setting upper limits on production cross sections.


<details>
  <summary>Details</summary>
Motivation: To explore unexplored phase spaces at the LHC for heavier resonances and investigate potential new physics through decay into four leptons.

Method: The study employs collision data at 13 TeV from the CMS experiment, with innovative techniques for detecting collimated dilepton pairs as merged objects, enhancing sensitivity.

Result: No significant excess over background predictions is found; upper limits on the production cross section for the four-lepton resonance are set, covering dilepton masses between 0.4 and 15 GeV.

Conclusion: The search extends the exploration of heavy resonance production in new mass ranges but finds no evidence of new particles, affirming the upper limits established.
...
TL;DR: LDMX is designed to detect sub-GeV dark matter through missing energy signs and to identify visibly decaying particles, like dark photons, using advanced simulations.


<details>
  <summary>Details</summary>
Motivation: To achieve sensitivity to sub-GeV dark matter particles and explore new particle signatures in the dark sector.

Method: Using detailed Geant4-toolkit simulations to assess detection efficiencies and background levels for visibly decaying particles.

Result: LDMX can achieve competitive sensitivity for detecting long-lived particles compared to current experiments.

Conclusion: This dual approach will enhance dark matter research and broaden the understanding of the sub-GeV dark sector.
...
TL;DR: BESIII reports on various decays of charmed baryons using a large dataset, highlighting rare decay observations and new measurements.


<details>
  <summary>Details</summary>
Motivation: To investigate the decays of charmed baryons and provide new insights into their properties using the largest dataset to date.

Method: Utilizing advanced techniques like Graph Neural Networks for decay analysis and measuring branching fractions and asymmetries in various decay channels.

Result: Observation of the rare semi-leptonic decay, measurement of decay asymmetries, and detailed branching fraction results for multiple decay processes.

Conclusion: These findings enhance the understanding of charmed baryon decays and contribute to the characterization of weak interactions in particle physics.
...
TL;DR: A study predicts the branching fraction and dilepton mass spectrum for the Dalitz decay $K^*(892) ightarrow K 
ewline 	ext{e}^+ 	ext{e}^-$, explores dark photon implications, and sets new standards for hadronic and dark sector research.


<details>
  <summary>Details</summary>
Motivation: To explore the rare Dalitz decay for insights into meson structure and potential new physics.

Method: Utilizes a single pole approximation for the transition form factor to calculate the branching fraction and examines the dilepton spectrum for signs of a dark photon.

Result: First predictions for the branching fraction and dilepton mass spectrum for the decay are provided, along with analysis of dark photon resonances.

Conclusion: This decay channel serves as a new platform for studying hadronic structure and probing dark matter physics.
...
TL;DR: This paper reviews recent measurements in multiboson and vector boson scattering at the LHC, highlighting results from ATLAS and CMS that test the Standard Model.


<details>
  <summary>Details</summary>
Motivation: To assess the electroweak gauge sector of the Standard Model and investigate anomalous gauge couplings through new VBS measurements.

Method: The review includes precision diboson cross-section measurements, CP-sensitive and polarization observables in Wγ production, and triboson process observations at √s = 13.6 TeV.

Result: The findings provide comprehensive insights from the latest VBS measurements, including novel observables and constraints on gauge couplings.

Conclusion: These results validate the electroweak sector of the Standard Model and enhance constraints on gauge-related anomalies within an effective field theory context.
...
TL;DR: The decay $B^0 	o Λ_c^+ arΛ_c^- K_S^0$ is investigated at LHCb, revealing a branching ratio of $0.53$ compared to $B^+ 	o Λ_c^+ arΛ_c^- K^+$ and significant evidence of two resonances in the final state.


<details>
  <summary>Details</summary>
Motivation: To explore the decay channels of $B^0$ mesons and investigate the presence of resonant states in the $Λ_c^+ K_S^0$ system, enhancing understanding of hadronic decays.

Method: The analysis utilizes LHCb data from proton-proton collisions at 13 TeV with an integrated luminosity of 5.4 fb$^{-1}$ to measure branching ratios and identify resonances.

Result: The measured branching ratio is $rac{{m B}(B^0 	o Λ_c^+ arΛ_c^- K_S^0)}{{m B}(B^+ 	o Λ_c^+ arΛ_c^- K^+)} = 0.53 	imes (statistical and systematic uncertainties)$, with a significance of $3.9σ$ for the resonances $Ξ_c(2923)^+$ and $Ξ_c(2939)^+$.

Conclusion: The findings indicate significant contributions from two resonant states, suggesting a deeper connection with isospin partners observed in similar decay channels.
