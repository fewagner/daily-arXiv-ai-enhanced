...
### [1] [Enhanced Reconstruction of Sub-GeV Neutrinos Charged Current Interactions in LArTPC](https://arxiv.org/abs/2604.20957)
*Stone Chou,Sanskar Jain,Wei Shi,Ciro Riccio*

Main category: hep-ex

TL;DR: The paper explores sub-GeV neutrino interactions in Liquid Argon Time Projection Chambers, highlighting the limitations of traditional methods and the effectiveness of using scintillation light for energy reconstruction.


<details>
  <summary>Details</summary>
Motivation: To improve the reconstruction of sub-GeV neutrino charged-current interactions in LArTPCs, addressing limitations of traditional charge-based methods.

Method: The study investigates energy reconstruction using scintillation light, alongside charge information, and implements algorithms for separation of electron neutrinos from antineutrinos and isolation of neutron-induced events.

Result: Using light-only reconstruction outperforms charge-only methods above 400 MeV, with a 70% efficiency in separating neutrino types and a 20-degree improvement in direction reconstruction for antineutrinos.

Conclusion: The findings enhance the potential for future analyses of atmospheric neutrinos using LArTPCs.
...
### [2] [Search for dark matter produced in association with a dark Higgs boson decaying into a bottom quark-antiquark pair in proton-proton collisions at $\sqrt{s}$ = 13 TeV](https://arxiv.org/abs/2604.20999)
*CMS Collaboration*

Main category: hep-ex

TL;DR: The paper presents a search for dark matter associated with a dark Higgs boson decaying into bottom quarks, using data from proton-proton collisions at 13 TeV at the CERN LHC, setting stringent limits on dark Higgs boson masses and mediator mass.


<details>
  <summary>Details</summary>
Motivation: To investigate the existence of dark matter and its potential association with a dark Higgs boson, contributing to the understanding of dark sector physics.

Method: Data from proton-proton collisions at 13 TeV collected by the CMS detector during 2016-2018 was analyzed, focusing on signatures of large missing transverse momentum and resonant structures in the invariant mass of bottom quark-antiquark pairs.

Result: Upper limits on signal strength for dark Higgs boson masses below 160 GeV were established, with exclusion of mediator masses up to 4.5 TeV and 2.5 TeV for specific dark Higgs boson masses.

Conclusion: The study provides the most stringent limits on the properties of dark Higgs bosons and associated mediators, advancing the search for dark matter.
...
### [3] [Performance of the LHCb muon detector in Run 3](https://arxiv.org/abs/2604.21075)
...
TL;DR: The LHCb has increased luminosity in Run 3, leading to enhancements in muon detection through hardware upgrades and improved algorithms, achieving high efficiency and low misidentification rates.


<details>
  <summary>Details</summary>
Motivation: To maintain the performance of muon detection under increased luminosity conditions during Run 3 of the LHC.

Method: Hardware upgrades to the muon detector and improvement of muon identification algorithms were implemented, alongside data calibration from 2024.

Result: Achieved over 90% muon identification efficiency with sub-percent misidentification probability by utilizing hit patterns in the muon detector.

Conclusion: The upgrades successfully ensured effective muon identification, facilitating reliable data collection at the higher particle rates.
...
### [4] [Observation of a new excited charm-strange meson $D_{s1}(2933)^+$ in $B^0\to D^+ D^- K^+ π^-$ decays](https://arxiv.org/abs/2604.21257)
...
TL;DR: A new charm-strange meson, $D_{s1}(2933)^+$, is observed with high statistical significance via analysis of $B^0	o D^+ D^- K^+ 	o 	ext{decays}$ in LHCb data.


<details>
  <summary>Details</summary>
Motivation: To identify and analyze possible new charmed strange mesons in particle physics.

Method: Amplitude analysis of the phase space from $B^0$ decays using data from the LHCb experiment with 5.4 fb$^{-1}$ of integrated luminosity.

Result: Discovery of a new meson with mass $m_0 = {2933}^{+6}_{-5}(	ext{stat})^{+4}_{-3}(	ext{syst}) 	ext{MeV}$ and width $Γ_0 = {72}^{+18}_{-12}(	ext{stat})^{+	ext{7}}_{-10}(	ext{syst}) 	ext{MeV}$, and identified as $J^P = 1^+$.

Conclusion: The $D_{s1}(2933)^+$ is proposed as a $D_s(2P^{(	ext{prime})}_{1})^+$ state, indicating new physics in the charm sector.
...
### [5] [Precision measurement of positron decay modes of Xe-125 in the LUX-ZEPLIN experiment](https://arxiv.org/abs/2604.21503)
...
TL;DR: The paper reports the detection of positron emission in the decay of $^{125}	ext{Xe}$, providing new insights into its branching ratios.


<details>
  <summary>Details</summary>
Motivation: To investigate the decay characteristics of the short-lived radioisotope $^{125}	ext{Xe}$, particularly the positron emission and its implications for the decay process.

Method: The study employs multiple-scatter event analysis and pre-activation data to improve background constraints, allowing for a precise measurement of positron emission.

Result: Positron emission was detected with a statistical significance of 5.5$σ$, with a branching ratio determined to be $0.29\pm0.08_{\text{stat.}}\pm0.04_{\text{sys.}}$ %, representing the first constraint on individual branching levels of $^{125}\text{I}$.

Conclusion: The findings enhance understanding of $^{125}\text{Xe}$ decay and provide important constraints for future studies on its decay products.
...
### [6] [Effective field theory interpretation of ATLAS measurements involving the Higgs boson, electroweak bosons and the top quark](https://arxiv.org/abs/2604.21670)
*ATLAS Collaboration*

Main category: hep-ex

TL;DR: The paper constrains Wilson coefficients in dimension-six effective field theory using various ATLAS measurements, finding no significant deviations from the Standard Model.


<details>
  <summary>Details</summary>
Motivation: To provide a comprehensive interpretation of experimental data involving Higgs-boson processes and other interactions in effective field theory.

Method: A combined fit to multiple ATLAS measurements across various production and decay modes, including di-Higgs signatures and electroweak observables, constraining 48 parameters.

Result: Constraints on Wilson coefficients and two-Higgs-doublet/heavy-vector-boson models were established, leading to comprehensive effective field theory interpretations.

Conclusion: The analysis observed no significant deviations from the Standard Model, marking an extensive effort in constraining parameters relevant to new physics.
...
### [7] [Gravity Echoes from Supermassive Black Hole Binaries](https://arxiv.org/abs/2604.21010)
*Qinyuan Zheng,Bence Bécsy,Chiara M. F. Mingarelli*

Main category: astro-ph.HE

TL;DR: The paper proposes that pulsar timing arrays can detect gravitational waves from supermassive black hole binaries, utilizing both Earth and pulsar terms to study binary evolution and inspire new observational techniques.


<details>
  <summary>Details</summary>
Motivation: To explore gravitational waves from supermassive black hole binaries and improve our understanding of their evolution.

Method: The paper uses pulsar timing array techniques to calculate signal-to-noise ratios and angular dependence of echo sensitivity, focusing on a nearby massive binary as a case study.

Result: A signal-to-noise ratio of 33 was identified for a fiducial binary, with multiple pulsars aiding in source localization and measuring historical binary evolution rates.

Conclusion: The study indicates that future detections could provide detailed insights into binary evolution while connecting pulsar observations coherently over vast distances.
...
### [8] [Archival Multiband Gravitational-Wave Signals from Massive Black Hole Binary Mergers](https://arxiv.org/abs/2604.21013)
*Alexander W. Criswell,Stephen R. Taylor,Kris Pardo,Alberto Sesana,David Izquierdo,Silvia Bonoli,Daniele Spinoso*

Main category: astro-ph.HE

TL;DR: This paper explores how orphaned signals from merging massive black hole binaries can be identified in pulsar timing arrays, suggesting potential multiband observations in conjunction with other detection methods.


<details>
  <summary>Details</summary>
Motivation: To investigate the implications of merging massive black holes on pulsar timing measurements, particularly how these events can influence low-frequency signals detectable by pulsar timing arrays.

Method: The paper analyzes the time-delayed nature of pulsar signals influenced by massive black hole binary mergers and proposes a method for stacking these signals across the array.

Result: It demonstrates how these orphaned pulsar signals can be detected and analyzed within a pulsar timing array framework, providing insights into the characteristics of the associated merger events.

Conclusion: The study opens avenues for multiband observational strategies that could enhance the detection and understanding of massive black hole binaries through existing and future astrophysical data.
...
TL;DR: This paper studies lepton-number emission asymmetry in core-collapse supernovae, showing that emitted lepton-number flux can become negative in certain directions, particularly in 3D simulations of CCSNe.


<details>
  <summary>Details</summary>
Motivation: To explore the asymmetry in lepton-number emission during core-collapse supernovae and its implications for emitted neutrino fluxes.

Method: The authors derived a diagnostic for lepton-number flux transitions and tested it across 33 3D CCSN simulations from various models, focusing on emission properties and their temporal aspects.

Result: Out of 23 non-black-hole-forming models tested, 22 showed significant transitions in lepton-number flux, with notable timing and behavior differences across models.

Conclusion: The study suggests that in imminent CCSNe, the anti-LESA transitions could allow $arν_e$ flux to surpass $ν_e$ in certain directions, with implications for flavor instability, requiring further investigation.
...
TL;DR: The study reveals that the radio-infrared-$γ$-ray correlation in star-forming galaxies is primarily a geometric effect, rather than a result of local cosmic-ray calorimetry.


<details>
  <summary>Details</summary>
Motivation: To investigate the nature of the radio-infrared-$γ$-ray correlation observed in star-forming galaxies and determine if it's due to geometry or local cosmic-ray processes.

Method: Utilizing the GALPROP framework to create synthetic observations from 3D Milky Way models with variations in cosmic-ray sources, gas, and magnetic fields, normalized to match local cosmic-ray data.

Result: A tight, quasi-linear correlation is naturally produced through line-of-sight integration, significantly influenced by viewing geometry and maintaining properties under moderate inclination but breaking down in edge-on perspectives.

Conclusion: The correlation is an emergent geometric property rather than a reflection of local physics, indicating that its variability is associated with galactic structure and viewing angle.
...
TL;DR: This study employs a Bayesian framework to analyze dense-matter equations of state (EOSs) related to small-radius compact-star candidates, particularly examining twin-star scenarios. It finds that PSR J0614$-$3329 indicates a softer EOS, while phase transitions in quark matter can produce distinct hybrid star characteristics.


<details>
  <summary>Details</summary>
Motivation: To explore the compatibility of recent small-radius compact stars within a twin-star scenario and characterize the dense-matter EOS using observational data.

Method: Utilized a Bayesian framework with constraints from NICER measurements and phase transition parameters from specific compact star observations, examining hadronic and hybrid star models.

Result: Identified a softer EOS for PSR J0614$-$3329, a preferred transition density of about 2.7-2.8 times nuclear saturation density, and significant changes in tidal deformability due to a first-order phase transition.

Conclusion: Small-radius compact stars can yield insights into the strength of phase transitions and dense matter's stiffness, serving as valuable observational indicators in future studies.
...
### [12] [Mitigating Systematic Errors in Parameter Estimation of Binary Black Hole Mergers in O1-O3 LIGO-Virgo Data](https://arxiv.org/abs/2604.21859)
*Sumit Kumar,Max Melching,Frank Ohme,Harsh Narola,Tom Dooney,Chris Van Den Broeck*

Main category: astro-ph.HE

TL;DR: This study addresses systematic errors in gravitational wave parameter estimation by reanalyzing selected LIGO-Virgo-KAGRA events using advanced parametric models that account for uncertainties.


<details>
  <summary>Details</summary>
Motivation: The goal is to identify and mitigate systematic errors in gravitational wave data analysis arising from various sources, enhancing the accuracy of parameter estimation.

Method: Selected gravitational wave events are reanalyzed using parametric models that incorporate uncertainties in phase and amplitude, applying broad priors to account for systematic errors.

Result: The method effectively reduces systematic errors and inconsistencies across different waveform models, yielding consistent parameter estimates for notable events like GW191109_010717 and GW200129_065458.

Conclusion: The proposed framework enhances the reliability of gravitational wave parameter estimation by ensuring consistency across raw and deglitched data, as well as various waveform models.
...
### [13] [Energy Loss of Newborn Magnetars by Schwinger Process](https://arxiv.org/abs/2604.21419)
*Chul Min Kim,Sang Pyo Kim,Remo Ruffini,Yu Wang,Shurui Zhang*

Main category: astro-ph.HE

TL;DR: This study examines electron-positron pair creation in newborn magnetars with high magnetic fields, revealing that the Schwinger process dominates charge supply and leads to rapid energy discharge.


<details>
  <summary>Details</summary>
Motivation: To understand electron-positron pair creation in newborn magnetars, especially in relation to their intense magnetic fields.

Method: Analyzed the Schwinger process in unscreened magnetic fields, deriving an analytical formula for pair creation flux and applying it to a fiducial model of a magnetar.

Result: The Schwinger channel significantly surpasses the classical particle supply by Goldreich--Julian, leading to a discharge that depletes 90% of the initial rotational energy in 30 ms.

Conclusion: The rapid energy release indicates that the observable phase of millisecond magnetars is very short, potentially influencing astrophysical transients and connecting newborn magnetars to the mature population over longer timescales.
...
### [14] [Multi-wavelength study of EP250416a / GRB 250416C: An Optically Dark Long GRB with a Late Jet Break](https://arxiv.org/abs/2604.21624)
...
TL;DR: This paper reports a comprehensive multi-wavelength study of the X-ray transient EP250416a, revealing its characteristics and implications for gamma-ray burst classification.


<details>
  <summary>Details</summary>
Motivation: To analyze the properties and origins of the γ/X-ray transient EP250416a, a significant astrophysical event detected across various wavelengths.

Method: Multi-wavelength observations were conducted on the burst, including gamma-ray, X-ray, and optical studies, with detailed spectral analysis and afterglow measurements.

Result: EP250416a is classified as an X-ray rich GRB with redshift z=0.963, isotropic energies that conform to the Amati relation, and shows distinctive decay characteristics in its X-ray afterglow.

Conclusion: The optical darkness of EP250416a is likely due to host-galaxy extinction, highlighting the need for further understanding of its environment and implications for GRB classification.
...
### [15] [Gauging the Impact of Cosmic Ray Feedback on the Stellar Initial Mass Function](https://arxiv.org/abs/2604.21754)
*Margot Fitz Axen,Stella S. R. Offner,Philip F. Hopkins,Michael Y. Grudić*

Main category: astro-ph.HE

TL;DR: Cosmic rays (CRs) significantly influence star formation in molecular clouds (MCs), enhancing star formation efficiency (SFE) and producing a top-heavy initial mass function (IMF) in simulations that account for CR transport.


<details>
  <summary>Details</summary>
Motivation: To investigate the role of cosmic rays in gas dynamics and star formation in molecular clouds, aiming to resolve issues related to the stellar initial mass function.

Method: Numerical simulations of a 20,000 M₀ molecular cloud collapse and star formation were conducted, comparing scenarios with and without cosmic ray transport (CRT) and including cases with stellar wind-accelerated cosmic rays.

Result: Simulations with CRT showed a 43% higher star formation efficiency (SFE) compared to non-CRT simulations and a top-heavy IMF with a slope 20% shallower for masses above 1 M₀. Even without wind-accelerated CRs, SFE was 16% higher and the IMF slope 10% shallower.

Conclusion: The findings suggest that cosmic rays contribute to observed top-heavy IMFs in high-cosmic-ray environments, like the galactic center, by enhancing star formation and altering the mass distribution of new stars.
...
### [16] [Magnetar Engines in Broad-lined Type Ic Supernovae and a Unified Picture for Magnetar-powered Stripped-envelope Supernovae](https://arxiv.org/abs/2604.21759)
*Jin-Ping Zhu,Bing Zhang*

Main category: astro-ph.HE

TL;DR: The study models multi-band lightcurves of SNe Ic-BL using a magnetar engine, finding consistent fits and correlations in key parameters, without major differences based on lGRB association.


<details>
  <summary>Details</summary>
Motivation: To understand the properties and behaviors of SNe Ic-BL and their relationship to lGRBs through magnetar engines and $^{56}$Ni decay.

Method: Modeling lightcurves of 80 SNe Ic-BL, including associated lGRBs, using a magnetar engine framework and analyzing key parameters with statistical correlations.

Result: Found high-quality fit consistency with magnetar models, key parameter medians, and significant correlations among ejecta mass and other factors, with no significant difference between associated and non-associated samples.

Conclusion: Proposes a unified framework for understanding magnetar-powered SNe and their progenitors, highlighting commonalities and differences among various supernova types.
...
### [17] [An RXTE Search for the Sterile Neutrino Decay in Galaxy Clusters](https://arxiv.org/abs/2604.21817)
*Mark J. Henriksen*

Main category: astro-ph.HE

TL;DR: The study investigates a potential 3.55 keV emission line from sterile neutrino decay in RXTE cluster data, finding a significant excess and correlation with cluster properties, suggesting a connection to dark matter.


<details>
  <summary>Details</summary>
Motivation: To explore the potential detection of a 3.55 keV line from sterile neutrino decay, which could provide insights into dark matter properties.

Method: Analysis of 3.1 megaseconds of RXTE data from eight clusters, identifying a 2.5σ excess in emission, modeling it with a Gaussian, and correlating with cluster temperature and mixing angles.

Result: A significant correlation (r = 0.76) for a line at 3.6 keV; mixing angles range from 0.35 to 6.2 x 10$^{-10}$; approximately half of the decay line flux is attributed to the Coma cluster, with strong correlation (r = 0.87) between decay rate and cluster temperature.

Conclusion: The excess emission may partially indicate sterile neutrino decay, as existing models of low-temperature emission do not fully account for the observed signals.
...
### [18] [Testing solitonic boson star interpretations of Sagittarius A* with near-infrared flare astrometry](https://arxiv.org/abs/2604.21883)
*Xiangyu Wang,Zhenyu Zhang,Hai-Qing Zhang,Minyong Guo,Bin Chen*

Main category: astro-ph.HE

TL;DR: This study analyzes Sagittarius A* as a potential solitonic boson star using GRAVITY flare astrometry, finding that inferred masses from various models exceed established values but some models align more closely with black hole characteristics.


<details>
  <summary>Details</summary>
Motivation: To investigate the nature of Sagittarius A* and assess whether it could be modeled as a solitonic boson star by comparing its properties to those of a Schwarzschild black hole.

Method: Five spherically symmetric solitonic boson-star models were analyzed using centroid motions and images of NIR flares. Parameter fitting was conducted through $χ^2$ analysis and Markov Chain Monte Carlo methods.

Result: The inferred masses for the boson-star models were consistently larger than the established mass of Sagittarius A*, but diffusive boson stars showed imaging traits closer to black holes, suggesting similar mass estimates.

Conclusion: While the results impose strict constraints on the solitonic boson star hypothesis for Sagittarius A*, they do not entirely exclude the possibility.
...
### [19] [Planetary Exploration 3.0: A Roadmap for Software-Defined, Radically Adaptive Space Systems](https://arxiv.org/abs/2604.20910)
...
TL;DR: Proposes a new paradigm for outer Solar System exploration, termed Planetary Exploration 3.0 (PE 3.0), utilizing adaptive space systems to conduct comprehensive missions.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of exploring unexplored worlds beyond Mars, which hold significant scientific interest, using an unfeasible incremental approach.

Method: Introduce PE 3.0, enabling exploration through a few adaptive missions utilizing software-defined space systems (SDSSs) for increased flexibility and intelligence.

Result: Insights gained regarding systems engineering, advanced technologies for SDSSs, and three innovative mission concepts for exploring Neptune/Triton, ocean worlds, and the Oort cloud.

Conclusion: PE 3.0 offers a viable framework for efficiently and effectively exploring distant celestial bodies, leveraging new adaptive technologies.
...
### [20] [Joint Estimation of Properties of the Lunar Subsurface and Galactic Foregrounds with LuSEE-Night](https://arxiv.org/abs/2604.21170)
...
TL;DR: The LuSEE-Night project aims to establish a radio telescope on the lunar far side, contending with uncertainties in lunar subsurface dielectric properties that affect instrument calibration and signal interpretation. Simulations indicate that subsurface properties notably influence beam characteristics. A Bayesian approach reveals the potential for jointly estimating subsurface and galactic parameters, despite some idealization in the models.


<details>
  <summary>Details</summary>
Motivation: To address calibration challenges faced by the LuSEE-Night radio telescope caused by unknown lunar subsurface dielectric properties, which can significantly alter signal reception.

Method: Simulations were conducted to explore far-field properties of the telescope's beam under varying subsurface dielectric profiles, alongside a Bayesian inference pipeline for joint estimation of galactic foreground and subsurface parameters.

Result: The study found that variations in subsurface dielectric properties significantly affect the telescope's beam characteristics, especially around antenna resonance, while also permitting simultaneous estimation of galaxy and subsurface parameters through Bayesian analysis.

Conclusion: Despite some idealizations in modeling, spectral differences between subsurface and galaxy signatures suggest the results are robust and highlight the importance of understanding lunar subsurface properties for the LuSEE-Night mission.
...
### [21] [Hill's level surfaces in the circular restricted three-body problem solved](https://arxiv.org/abs/2604.21426)
*Jean-Marc Huré*

Main category: astro-ph.IM

TL;DR: The paper provides a closed-form expression for Hill's surfaces in the circular restricted three-body problem, revealing various geometric patterns.


<details>
  <summary>Details</summary>
Motivation: To advance the understanding of Hill's surfaces and their configurations within the circular restricted three-body problem.

Method: Deriving a closed-form solution for the function $φ(r,θ)$ using a cubic equation, resulting in multiple roots across the separatrix.

Result: The method produces classic shapes including tadpole, horseshoe, peanut, Roche lobes, and Hill's quasi-spheres.

Conclusion: The findings offer exact representations of Hill's surfaces, enhancing the study of celestial mechanics.
...
TL;DR: This paper presents the operation and performance evaluation of a transition-edge sensor (TES) spectrometer at the SPring-8 synchrotron, demonstrating high-resolution multi-element analysis capabilities.


<details>
  <summary>Details</summary>
Motivation: To improve X-ray spectroscopy techniques for better resolution and detection of trace elements in complex samples.

Method: Utilized a 240-pixel TES system to evaluate performance at high count rates and conducted X-ray absorption near-edge structure (XANES) analysis using fluorescence mode.

Result: Achieved energy resolution of 5 eV at high count rates, enabling the resolution of weak fluorescence lines from dilute samples and clear detection of specific elements like As and Pb.

Conclusion: The study demonstrates the potential of high-resolution TES-based spectroscopy at synchrotron facilities, marking a significant advancement in the field.
...
### [23] [Diffraction in the ASPIICS coronagraph: observations and modeling](https://arxiv.org/abs/2604.21559)
...
TL;DR: The study analyzes diffractions in ASPIICS images to validate and refine a diffraction model, finding good correspondence between model predictions and actual observations.


<details>
  <summary>Details</summary>
Motivation: To address straylight issues in coronagraphs, specifically due to diffraction of solar disk light on the external occulter, affecting the image quality of ASPIICS.

Method: By comparing ASPIICS data with simulated diffraction images and fine-tuning the analytical-numerical diffraction model based on geometrical properties and radiometric signal.

Result: The analysis confirmed qualitative properties of the diffraction model and achieved a quantitative correspondence of 30%–50% after refinement, depending on configuration.

Conclusion: The analysis validates the model, justifies its assumptions, and indicates that diffracted light is significantly lower than the coronal signal in most of the field of view.
...
### [24] [HHL with a Coherent Fourier Oracle: A Proof-of-Concept Quantum Architecture for Joint Melody-Harmony Generation](https://arxiv.org/abs/2604.20882)
*Alexis Kirke*

Main category: quant-ph

TL;DR: The paper explores leveraging the HHL quantum algorithm for encoding and generating music, incorporating tonal and melodic preferences, while overcoming classical constraints through a coherent structure.


<details>
  <summary>Details</summary>
Motivation: To utilize the HHL algorithm's exponential speedup in generating musically coherent outputs by encoding cognitive frameworks of musical preference.

Method: A coherent Fourier harmonic oracle is developed to apply chord-transition weights to the HHL amplitude vector, allowing simultaneous selection of melody notes and chord progressions, with blocks chained for longer passages.

Result: 97% of the generated chord progressions are rated as strong or acceptable by rule-based harmony validation, demonstrating the effectiveness of the approach.

Conclusion: The study successfully implements a coherent HHL pipeline for music generation, illustrating the potential for quantum algorithms in creative fields.
...
### [25] [Quantum-HPC Software Stacks and the openQSE Reference Architecture: A Survey](https://arxiv.org/abs/2604.20912)
...
TL;DR: This paper analyzes existing quantum high-performance computing (QHPC) software stacks, identifies common design patterns and needs, and proposes an open quantum-HPC software ecosystem (openQSE) reference architecture for improved interoperability.


<details>
  <summary>Details</summary>
Motivation: Quantum resources are becoming integral to HPC and cloud environments, but existing QHPC software stacks are isolated with proprietary implementations, necessitating a unified approach.

Method: The authors surveyed nine production QHPC stacks to identify common design patterns and emerging requirements in deployment, interaction, support, and fault tolerance.

Result: The analysis reveals consistent needs for runtime abstraction, resource management, interconnect semantics, and observability across QHPC stacks.

Conclusion: openQSE provides a reference architecture to facilitate interoperability and support both current NISQ and future FTQC workloads, maintaining flexibility in deployment.
...
### [26] [Adiabatic Error Cancellation in Berry Phase Estimation](https://arxiv.org/abs/2604.20952)
*Chusei Kiumi*

Main category: quant-ph

TL;DR: The paper presents an adiabatic error-cancellation mechanism for Berry phase estimation, enhancing quantum computing reliability by reducing phase errors and runtime scaling.


<details>
  <summary>Details</summary>
Motivation: To improve the reliability of Berry phase estimation in quantum computing, which is crucial before achieving full fault tolerance.

Method: The authors utilize a method combining finite-runtime evolutions under $\pm H$ to cancel leading phase errors, and apply Richardson extrapolation to minimize residual errors. Runtime randomization is also introduced to further reduce remaining oscillatory contributions.

Result: The leading $O(T^{-1})$ phase error is canceled, and residual oscillatory errors are reduced to an order $O(T^{-M})$ for any fixed $M$ with randomized runtime distributions, enhancing runtime efficiency under standard sample complexity.

Conclusion: This error-cancellation approach makes Berry phase estimation a viable and efficient option for practical quantum computing applications.
...
TL;DR: This study explores thermalization in the chaotic Tavis-Cummings model, revealing regimes influencing quantum spectroscopy outputs.


<details>
  <summary>Details</summary>
Motivation: The research addresses limitations in traditional treatments of the Tavis-Cummings model, particularly regarding many-body effects in quantum systems.

Method: Using the Eigenstate Thermalization Hypothesis, the study analyzes the non-integrable excitonic Hamiltonian and identifies two dynamic regimes based on polariton splitting.

Result: It identifies distinct thermalizing and non-thermalizing dynamics, affecting output photon statistics and correlation times.

Conclusion: The findings suggest using entangled-biphoton spectroscopy to investigate these thermalization regimes and enable the characterization of exciton-coupling disorder.
...
TL;DR: This study assesses the Variational Quantum Eigensolver (VQE) for examining entanglement entropy in the Transverse Field Ising Model across various dimensions and spin configurations, comparing its results against exact methods and various ansätze for effective quantum simulations.


<details>
  <summary>Details</summary>
Motivation: To understand the ground state properties and entanglement in quantum systems using VQE, especially at larger scales.

Method: We benchmark VQE results against exact diagonalization for the TFIM across dimensions and spin systems, utilizing the EfficientSU2, HVA, and HVA with symmetry breaking ansätze.

Result: VQE effectively captures critical phenomena and demonstrates varying performance based on the chosen ansatz, as assessed through energy variance, entanglement entropy, and correlation metrics.

Conclusion: The study discusses scaling methods in VQE to tackle larger quantum systems and highlights the influence of expressivity and optimization on simulating entangled states.
...
### [29] [Light-induced Self-Organization in Cooperative Free Space Atomic Arrays](https://arxiv.org/abs/2604.21012)
*Sara Molló-Guri,Oriol Rubies-Bigorda,Raphael Holzinger,Jonah S. Peter,Susanne F. Yelin*

Main category: quant-ph

TL;DR: The paper explores self-organized configurations in atomic arrays driven by laser-induced dipole interactions, identifying various steady-state arrangements and demonstrating complex spatial dynamics in linear and ring formations.


<details>
  <summary>Details</summary>
Motivation: To understand how laser-driven interactions lead to self-organization in weakly trapped atomic ensembles.

Method: Analytical treatment of a two-emitter system, extended to larger ensembles in linear and ring geometries.

Result: Identification of topologically nontrivial dimerized configurations and self-organizing dynamics such as contraction and expansion in ring geometries.

Conclusion: Collective light-matter interactions can produce modified ordered structures, even at distances greater than the transition wavelength.
...
### [30] [A rigorous quasipolynomial-time classical algorithm for SYK thermal expectations](https://arxiv.org/abs/2604.21089)
*Alexander Zlokapa*

Main category: quant-ph

TL;DR: This paper presents a quasipolynomial-time classical algorithm for estimating local observables in the Sachdev-Ye-Kitaev (SYK) model's Gibbs states at high constant temperature, despite the challenges posed by existing analytical techniques.


<details>
  <summary>Details</summary>
Motivation: The motivation is to explore the computational complexity of estimating local observables in quantum systems, particularly in the context of the SYK model, which is believed to exhibit non-Gaussian Gibbs states.

Method: The paper introduces a new Wick-pair cluster expansion to develop a classical algorithm that operates in quasipolynomial time, allowing for the estimation of local thermal expectations in the SYK model.

Result: The proposed algorithm successfully estimates local observables in SYK states at sufficiently high constant temperatures, demonstrating effective computational feasibility.

Conclusion: This result suggests that quantum advantage may not be necessary for this problem at constant temperatures and offers a promising new approach for analyzing disordered quantum many-body systems.
...
### [31] [Qubit-efficient and gate-efficient encodings of graph partitioning problems for quantum optimization](https://arxiv.org/abs/2604.21123)
*Tristan Zaborniak,Prashanti Priya Angara,Vikram Khipple Mulligan,Hausi Müller,Ulrike Stege*

Main category: quant-ph

TL;DR: The paper presents a novel encoding for higher-order binary optimization in quantum computing, improving graph partitioning efficiency and solution quality.


<details>
  <summary>Details</summary>
Motivation: To solve graph partitioning problems like graph coloring and community detection efficiently using quantum computing.

Method: A higher-order unconstrained binary optimization encoding is developed using a lexicographic penalty system and logarithmic encoding of vertex variables, allowing optimization without dedicated indicators.

Result: The new encoding reduces gate count and improves solution quality in quantum annealing, outperforming traditional one-hot encoding, especially for larger problems.

Conclusion: This encoding method enhances efficiency in quantum graph optimization, demonstrating significant gains in performance metrics over existing techniques.
...
### [32] [Multidimensional semiclassical single- and double-quantum spectroscopy of anharmonic molecular polaritons](https://arxiv.org/abs/2604.21158)
*Michael Reitz,Harsh Bhakta,Wei Xiong,Joel Yuen-Zhou*

Main category: quant-ph

TL;DR: The paper introduces an effective method for calculating phase-resolved multidimensional spectra of anharmonic molecular polaritons, enabling clear analysis of nonlinear interactions in spectroscopy.


<details>
  <summary>Details</summary>
Motivation: To provide a straightforward computational approach to understand phase-resolved spectra of molecular polaritons and resolve existing mysteries in experimental spectroscopic data.

Method: The method involves semiclassical evolution of molecular Hamiltonians and cavity fields, expanding in amplitudes and phases to construct two-dimensional spectra through phase cycling and analysis in Liouville space.

Result: The method successfully benchmarks against experimental data, particularly clarifying the polariton bleach effect, and reveals insights on the role of anharmonicities in double-excitation phenomena.

Conclusion: The findings offer a practical framework for nonlinear spectroscopy of strongly coupled light-matter systems, facilitating the design of new cavity-enhanced molecular platforms.
...
### [33] [Monitoring photon entanglement in coupled cavities](https://arxiv.org/abs/2604.21208)
*Moises Acero,Jeremiah Harrington,Oleg L. Berman,K. Ziegler*

Main category: quant-ph

TL;DR: This paper explores the dynamics and entanglement of $N$ photons in a Fock state between two cavities connected by an optical fiber, focusing on their transition probabilities and entanglement characteristics through monitoring protocols.


<details>
  <summary>Details</summary>
Motivation: To investigate how projective measurements and monitoring protocols affect the entanglement of photons in quantum systems, particularly in the formation and control of photonic N00N states.

Method: The study uses projective measurements on $N$ photons in a Fock state across two cavities linked by optical fiber, examining transition probabilities and entanglement quantifiers like fidelity and entanglement entropy under the Jaynes-Cummings model for single cavity scenarios.

Result: The research finds that the probability of transitioning $N$ photons between cavities and the fidelity of the N00N state depend critically on the monitoring process; entanglement entropy is calculated to analyze inter-cavity entanglement.

Conclusion: Entanglement is highly sensitive to the monitoring protocol, suggesting potential control methods for photon entanglement in quantum applications.
...
TL;DR: This paper investigates the feedback protocol for quantum systems, revealing how a specific Hamiltonian can reverse measurement trajectories and connecting this phenomenon to machine learning concepts.


<details>
  <summary>Details</summary>
Motivation: Understanding the mechanisms behind time reversal in quantum systems through the feedback protocol and its relation to score-based models in machine learning.

Method: Computed the functional derivative of log path probability in density-matrix space, leveraging Girsanov's theorem, Fréchet differentiation, and Kähler geometry.

Result: Demonstrated that the feedback Hamiltonian is the score function for quantum trajectory distribution, facilitating trajectory reversal and extending to multi-qubit systems.

Conclusion: Identified a continuous family of path measures generated by feedback gain and enabled the application of machine learning score estimation methods for improving real-world experimental results.
...
### [35] [Time-optimal Qubit Reset via Environmental Spectral Structure](https://arxiv.org/abs/2604.21230)
*Hong-Bo Huang,Hui Dong*

Main category: quant-ph

TL;DR: The study presents a time-optimal reset strategy for frequency-tunable qubits, reducing reset time significantly while maintaining high precision.


<details>
  <summary>Details</summary>
Motivation: Fast qubit reset is crucial for efficient qubit reuse in quantum computing but conflicts with decoherence needs for accurate calculations.

Method: A switch--restore--switch approach optimally transitions the qubit between low and high decoherence environments, tailored to environmental constraints.

Result: Reset time is significantly reduced from over 100 ns to 20 ns with a precision of 10^-5 in various superconducting qubit scenarios.

Conclusion: Environmental spectral structure aids in achieving speedy, accurate qubit resets, serving as a key design principle for qubit-limited processors.
...
### [36] [On the importance of hyperparameters in initializing parameterized quantum circuits](https://arxiv.org/abs/2604.21266)
*Ankit Kulshrestha,Sarvagya Upadhyay*

Main category: quant-ph

TL;DR: This paper proposes an evolutionary-based algorithm for identifying optimal hyperparameters for Parameterized Quantum Circuits (PQCs), facilitating improved performance without worsening gradient variance scaling in quantum tasks.


<details>
  <summary>Details</summary>
Motivation: The need for effective initial parameters in PQCs has become critical, as conventional methods primarily focus on distribution selection rather than hyperparameter optimization.

Method: The authors introduce an evolutionary-search algorithm designed to optimize hyperparameters for PQCs tailored to specific quantum tasks.

Result: Empirical results demonstrate that the algorithm consistently selects high-performing initial parameters, enhancing convergence speed and overall performance without exacerbating the barren plateau phenomenon.

Conclusion: The proposed algorithm effectively optimizes hyperparameters for PQCs, improving task performance while maintaining favorable gradient variance properties.
...
### [37] [Structured Quantum State Reconstruction via Physically Motivated Operator Selection](https://arxiv.org/abs/2604.21272)
*Ayush Chambyal,Brijesh,Rakesh Sharma*

Main category: quant-ph

TL;DR: Structured Gibbs Quantum State Tomography (SG-QST) reduces the complexity of quantum state reconstruction by restricting the operator space to relevant observables, achieving comparable fidelity with fewer parameters.


<details>
  <summary>Details</summary>
Motivation: To address the exponential scaling of quantum state tomography, enhancing practicality for multi-qubit systems.

Method: A structured framework that progressively includes local, nearest-neighbor, and global correlations for density matrix reconstruction using a restricted set of observables.

Result: Benchmarking on GHZ states of three to five qubits shows that SG-QST achieves similar fidelity to full reconstruction but with significantly fewer parameters through operator space restriction.

Conclusion: Restricting the operator space based on physical relevance allows for efficient and interpretable quantum state reconstruction.
...
### [38] [Random Access Codes: Explicit Constructions, Optimality, and Classical-Quantum Gaps](https://arxiv.org/abs/2604.21274)
*Ruho Kondo,Yuki Sato,Hiroshi Yano,Yota Maeda,Kosuke Ito,Naoki Yamamoto*

Main category: quant-ph

TL;DR: The paper presents a constructive framework for classical random access codes (RACs) and explores their quantum version, demonstrating optimal designs and comparing performance under average and worst-case scenarios.


<details>
  <summary>Details</summary>
Motivation: To address the lack of explicit constructions for optimal RACs and QRACs, particularly in the context of decoding success probabilities.

Method: The authors develop a framework for constructing $(L,k)$-RACs by selecting points in binary and continuous spaces to minimize a distance-like objective for both average- and worst-case criteria.

Result: Optimal encoders and decoders are achieved for $(L,L-1)$-RACs, which meet proven upper bounds, and these classical codes yield QRACs that also reach a conjectured decoding success probability upper bound.

Conclusion: While numerical optimization indicates minor differences between RACs and QRACs in average cases, it reveals a significant classical-quantum gap in the worst-case scenario.
...
### [39] [StabilizerBench: A Benchmark for AI-Assisted Quantum Error Correction Circuit Synthesis](https://arxiv.org/abs/2604.21287)
*Andres Paz,Christian Tarta,Cordelia Yuqiao Li,Mayee Sun,Sarju Patel,Sylvie Lausier*

Main category: quant-ph

TL;DR: StabilizerBench is a benchmark suite designed for evaluating AI agents in generating quantum error correction circuits, consisting of 192 stabilizer codes categorized by task difficulty.


<details>
  <summary>Details</summary>
Motivation: The increasing demand for efficient quantum error correction circuit design due to scaling quantum hardware necessitates an automated approach, where AI can play a crucial role.

Method: The benchmark comprises 192 stabilizer codes organized into three progressive tasks, with a scoring system that assesses both capability and circuit quality, along with continuous metrics for fault tolerance and optimization.

Result: Evaluation of three AI models on StabilizerBench revealed varying performance levels across tasks, indicating the effectiveness of the benchmark in distinguishing AI capabilities and identifying improvement areas.

Conclusion: StabilizerBench establishes a foundation for measuring AI progress in quantum circuit design, aligning with the needs of emerging quantum technologies.
...
TL;DR: This paper explores the concept of third quantization in relation to the commutation relations of order parameters and particle-number operators, highlighting the emergence of this framework from traditional quantum mechanics and providing a novel interpretation of the BCS-BEC crossover.


<details>
  <summary>Details</summary>
Motivation: To unify the understanding of Bose-Einstein condensates (BECs) and Bardeen-Cooper-Schrieffer (BCS) states through the lens of third quantization and coherent states.

Method: The authors analyze macroscopic commutation relations and model the BCS-BEC crossover as an assembly of superconducting segments with varying coupling, leading to collective behavior and phase coherence.

Result: The research demonstrates that the BCS-BEC crossover reflects a macroscopic quantum process, with global phase coherence establishing a bulk Bose-Einstein condensate.

Conclusion: The phase diagram of the BCS-BEC crossover can be interpreted through third quantization, offering insights into the nature of BEC, BCS superconductivity, and their interrelations.
...
TL;DR: The study investigates the quantum Mpemba effect (ME) in Markovian systems, demonstrating that faster relaxation can occur even with larger overlap with the slowest decay mode, leading to multiple trajectory crossings.


<details>
  <summary>Details</summary>
Motivation: To explore how the quantum Mpemba effect challenges conventional wisdom by considering scenarios where initial states overlap more with the slowest decay mode but still relax faster than expected.

Method: The research employs experimental observations of a trapped ion's relaxation dynamics and develops a theoretical framework focusing on the relaxation speed and its relationship with decay modes.

Result: The findings reveal multiple trajectory crossings (multi-ME) and present a phase diagram showing the relationship between initial relaxation speed, slowest decay mode overlap, and types of quantum ME.

Conclusion: This comprehensive framework enhances the understanding of transient quantum relaxation and extends the analysis beyond traditional long-time limit perspectives.
...
### [42] [Sufficient support size of measurements for quantum estimation](https://arxiv.org/abs/2604.21323)
*Koichi Yamagata*

Main category: quant-ph

TL;DR: This paper simplifies the search for optimal quantum estimators by bounding the number of outcomes for POVMs and showing that rank-one measurements suffice.


<details>
  <summary>Details</summary>
Motivation: The challenge in quantum estimation is the vast space of possible POVMs, making it difficult to find optimal estimators for a family of density operators.

Method: The authors derived bounds on the number of outcomes for POVMs required for minimizing the mean squared error, proving that rank-one measurements are sufficient in both locally unbiased and Bayesian contexts.

Result: It was shown that optimal estimators can be obtained with a limited number of outcomes, specifically related to the dimension of the Hilbert space and the parameter count, and that rank-one POVMs are optimal.

Conclusion: The established bounds significantly streamline the search for optimal measurements, allowing for focused optimization on simpler, rank-one POVMs with finite outcomes.
...
### [43] [pygridsynth: A fast numerical tool for ancilla-free Clifford+T synthesis](https://arxiv.org/abs/2604.21333)
*Shuntaro Yamamoto,Nobuyuki Yoshioka*

Main category: quant-ph

TL;DR: pygridsynth is an open-source Python library for efficient approximate Clifford+$T$ synthesis, achieving high precision and scalability for multiple qubits.


<details>
  <summary>Details</summary>
Motivation: To provide an efficient tool for ancilla-free synthesis of Clifford+$T$ circuits, addressing the complexities of high-precision synthesis as qubit numbers increase.

Method: The library utilizes efficient synthesis routines for 1-2 qubits and a partial-decomposition technique for 3 or more qubits, optimizing T-count and introducing a mixed-synthesis workflow for unitary channel approximation.

Result: The library operates in $O("log(1/ε))$ for synthesis precision and reduces synthesis error from $ε$ to $ε^2/(2n)$ for mixed approaches, enhancing performance across multi-qubit instances.

Conclusion: pygridsynth serves as a robust platform for high-precision Clifford+$T$ synthesis and benchmarking strategies, facilitating improved quantum circuit design.
...
### [44] [Scalable surface ion trap design for magnetic quantum sensing and gradiometry](https://arxiv.org/abs/2604.21342)
*Qirat Iqbal,Altaf Hussain Nizamani*

Main category: quant-ph

TL;DR: This study presents an innovative design of Surface Paul Traps for trapped ion quantum sensors, enhancing their sensitivity for magnetic field detection and measurement.


<details>
  <summary>Details</summary>
Motivation: The study aims to leverage the quantum mechanical properties of trapped ions to surpass current sensor limitations and achieve higher precision in magnetic field measurements.

Method: The approach involves modeling and simulating a new design of Surface Paul Traps with multiple trapping regions for enhanced sensitivity and spatial resolution in measurements.

Result: The design enables ultra-sensitive detection of magnetic fields with sensitivities in the pT to sub pT range, facilitating high-resolution mapping of magnetic field gradients.

Conclusion: The advancements in ion manipulation and the innovative chip architecture contribute to significant improvements in the application of trapped ions as magnetic field sensors.
...
### [45] [Ghost Degrees of Freedom Without Quantum Runaway: Exact Moment Bounds from an Operator Conservation Law](https://arxiv.org/abs/2604.21348)
*Christopher Ewasiuk,Stefano Profumo*

Main category: quant-ph

TL;DR: An exact quantum conservation law for a harmonic oscillator coupled to a ghost degree of freedom is proven, establishing an upper bound on the mean squared phase-space radius regardless of quantum state, using basic quantum mechanics without requiring perturbation theory or confinement.


<details>
  <summary>Details</summary>
Motivation: The study aims to address the quantum mechanical implications of a harmonic oscillator coupled with a ghost degree of freedom, particularly focusing on conservation laws and stability.

Method: The proof leverages canonical commutation relations and the Leibniz rule, avoiding confining potentials or spectral assumptions, to derive a state-independent upper bound on phase-space characteristics.

Result: The findings are validated through three numerical frameworks, confirming the validity of the conservation law, energy spectrum, and statistical properties, with all results consistent with theoretical predictions.

Conclusion: The absence of a confining potential indicates that spectral properties remain unresolved, highlighting areas for future research, especially concerning ghost quantum instability which is not solely determined by the kinetic term.
...
### [46] [Vertical Shuttling Protocols for Trapped Ions in Multi-Rail, Multi-Zone Surface Ion Trap Architectures](https://arxiv.org/abs/2604.21350)
*Qirat Iqbal,Altaf H. Nizamani*

Main category: quant-ph

TL;DR: This study presents optimized vertical ion-shuttling protocols aimed at minimizing motional energy gain during ion transport in various trapped-ion applications.


<details>
  <summary>Details</summary>
Motivation: To improve performance and reduce energy gain during ion transport in trapped-ion systems, which is crucial for applications like quantum information processing and high-fidelity sensing.

Method: The researchers investigated different shuttling protocols to minimize motional heating during ion transport, focusing on durations and experimental heating rates.

Result: Anomalous heating limits shuttling effectiveness primarily past $500~μ	ext{m}$, but the choice of transport protocol significantly influences final motional excitation, which can be kept below eight quanta with proper displacement.

Conclusion: The findings pave the way for adiabatic shuttling within $0.5~ms$, ensuring compliance with the requirements for high-fidelity quantum sensing and control.
...
### [47] [Bayesian Phase Stabilization at the Shot-Noise Limit for Scalable Quantum Networks](https://arxiv.org/abs/2604.21388)
...
TL;DR: The paper presents a framework for high-precision optical phase stabilization in quantum networks, utilizing a Bayesian phase estimator to enhance single-photon detection, achieving shot-noise limit performance and facilitating entanglement generation over long distances.


<details>
  <summary>Details</summary>
Motivation: The need for precise phase stabilization in quantum networks while adhering to strict photon-flux and duty-cycle constraints, particularly in multi-source setups.

Method: An integrated phase-stabilization framework employing a Bayesian phase estimator to optimally analyze sparse detection events, allowing real-time phase noise correction from lasers and fibers.

Result: Achieved greater than 97% interferometric visibility over distances of 10 km and 100 km, with ion-ion entanglement parity contrast exceeding 85%, under low photon rates and duty cycles.

Conclusion: The developed system provides a robust foundation for long-distance quantum networks and is crucial for applications like quantum key distribution and quantum repeaters.
...
TL;DR: Integration of HEOM solver in qubit calibration reveals significant non-Markovian effects in bath structure, influencing measurement accuracy and protocol overhead.


<details>
  <summary>Details</summary>
Motivation: To address limitations in existing frameworks that treat bath dynamics as Markovian, hiding bath structure within fit residuals instead of analyzing it as a diagnostic tool.

Method: Utilized a QuTiP 5.x HEOM solver for a 1/f Burkard bath integrated into a multi-protocol calibration DAG, benchmarking against existing numerical methods like sesolve and mesolve.

Result: HEOM produced a measurable revival envelope in the T2* time, distinguishing it from Markovian results by a significant margin (13x separation); Rabi contrast showed a slight drop compared to mesolve, affirming the influence of non-Markovian effects.

Conclusion: Incorporating HEOM changes calibration reporting, quantifying bath structure as a measurable aspect rather than a hidden variable, improving diagnostic capabilities in superconducting-qubit calibrations.
...
TL;DR: The paper studies the dynamics of two identical superconducting qubits coupled via a finite transmission line, detailing conditions for different dynamical regimes based on qubit and mode frequencies.


<details>
  <summary>Details</summary>
Motivation: To understand how finite transmission lines affect the dynamics of superconducting qubits in quantum circuit architectures.

Method: Derived a circuit Hamiltonian separating line modes into parity sectors, analyzed dynamics using hierarchical equations of motion and identified non-Markovian behavior with the Breuer--Laine--Piilo measure.

Result: Characterized the reduced dynamics as either structured reservoir or discrete coupler depending on frequency parameters, and established conditions for multimode and single-mode dynamics in the short-line limit.

Conclusion: Provided a comprehensive framework for interpreting the dynamical regimes of superconducting qubits coupled through transmission lines, enhancing our understanding of circuit QED.
...
TL;DR: LightStim automates the construction of Detector Error Models (DEMs) in quantum error correction, facilitating rigorous circuit evaluation without manual intervention.


<details>
  <summary>Details</summary>
Motivation: The need for effective and efficient evaluation of quantum error correction protocols in fault-tolerant quantum computing, addressing the limitations of current manual DEM construction.

Method: LightStim utilizes a Pauli tableau integrated with measurement records to automate DEM construction during circuit compilation without requiring protocol-specific inputs.

Result: LightStim's benchmarking shows accurate detector and observable counts, consistent logical error rates, and it successfully accelerates protocol exploration, exemplified through a new lattice surgery design.

Conclusion: LightStim serves as a unified platform for the systematic evaluation and exploration of diverse quantum error correction protocols.
...
TL;DR: The paper presents a new measurement-based quantum computation (MBQC) compilation scheme that addresses fusion erasure errors in photonic quantum computing by using tree-encoded fusion, resulting in improved robustness and efficiency over existing methods.


<details>
  <summary>Details</summary>
Motivation: To overcome limitations in existing MBQC compilation techniques that do not account for fusion erasures, which can severely impact quantum program reliability.

Method: The authors propose a new MBQC compilation scheme that integrates tree-encoded fusion strategies, particularly designed to mitigate fusion erasure errors in the graph-state generation process, within a comprehensive compiler framework.

Result: The proposed framework outperforms the state-of-the-art OneAdapt, demonstrating exponential improvements in execution efficiency and robustness against fusion erasure errors during evaluation on a realistic PQC simulator across multiple benchmarks.

Conclusion: The introduced tree-encoded fusion and accompanying compiler framework significantly enhance the stability and performance of photonic quantum implementations, validated through both simulation and proof-of-concept experiments.
...
TL;DR: This paper introduces a new framework for analyzing catalytic thermal transformations in quantum thermodynamics using non-additive divergences, highlighting the explicit role of catalysts and the limitations of reduced-state data in characterizing thermodynamic transformations.


<details>
  <summary>Details</summary>
Motivation: To clarify the catalytic contributions in quantum thermodynamics and address the limitations of existing frameworks that do not explicitly account for catalysts in system-level inequalities.

Method: The authors develop a formulation based on non-additive divergences, producing a new family of generalized free energies that include a catalyst-dependent correction term.

Result: The new formulation leads to non-additive second-law relations that explicitly showcase catalytic contributions and highlight the constraints on admissible catalysts, particularly in uncorrelated catalytic transformations.

Conclusion: The study shows that non-additivity is informative in uncorrelated catalysis while correlated catalysis demands a detailed joint-state-sensitive approach to understand thermodynamic accessibility.
...
### [53] [Quantum jump correlations in long-range dissipative spin systems](https://arxiv.org/abs/2604.21513)
*Giulia Salatino,Anna Delmonte,Zejian Li,Rosario Fazio,Alberto Biella*

Main category: quant-ph

TL;DR: The paper investigates nonequilibrium phases in long-range dissipative spin systems using quantum jump trajectories, revealing dynamics through correlations in detection events, particularly during a phase transition.


<details>
  <summary>Details</summary>
Motivation: To explore nonequilibrium phases in dissipative spin systems and understand their dynamics through quantum jump correlations.

Method: Utilizes the tilted Lindbladian approach along with cluster mean-field and cumulant expansion techniques to analyze the full counting statistics and waiting-time distributions of quantum jumps.

Result: Identifies distinct dynamical features and clear signatures of phases in quantum jump correlations across a paramagnetic-to-ferromagnetic transition.

Conclusion: Trajectory-resolved observables can effectively probe collective behaviors in open quantum many-body systems, highlighting the impact of long-range interactions on nonequilibrium dynamics.
...
### [54] [Quantum plasmonics with N emitters: bright hybrid continuum selection](https://arxiv.org/abs/2604.21560)
*Georgii Semin,Hans-Rudolf Jauslin,Gérard Colas des Francs,Stéphane Guérin*

Main category: quant-ph

TL;DR: The paper develops effective models for quantum plasmon-polariton interactions with quantum emitters, highlighting the role of bright and dark modes, and showing equivalences in continuum spectra for the system.


<details>
  <summary>Details</summary>
Motivation: To understand and model the interactions between a quantum plasmon-polariton field and quantum emitters in a finite dielectric medium.

Method: The authors decompose the field into bright and dark modes, using Lippmann-Schwinger equations to derive continuum spectra and describe the effective interactions between the emitters and the field.

Result: The effective interaction reduces to a set of $N$ non-degenerate one-dimensional continua for $N$ emitters, and this representation aligns with the macroscopic Langevin model for bulk medium.

Conclusion: The study clarifies the complexity of the plasmon-polariton field interactions with emitters and establishes a framework that links microscopic and macroscopic descriptions of the system.
...
### [55] [Pulse Shaping for Superconducting Qubits](https://arxiv.org/abs/2604.21565)
*Animesh Patra,Ankur Raina*

Main category: quant-ph

TL;DR: This paper provides an overview of microwave pulse-shaping techniques for superconducting qubits, emphasizing both theoretical understanding and practical applications to improve qubit control.


<details>
  <summary>Details</summary>
Motivation: To equip students and early researchers with an accessible framework for designing high-fidelity control pulses for superconducting qubits while addressing multiple error channels.

Method: The article introduces simple pulse envelopes, analyzes their spectral properties, and discusses techniques like the DRAG method and single-qubit control through Magnus expansion, culminating in two-qubit operations and their implementations.

Result: The paper demonstrates how tailored microwave pulses, including the DRAG technique, can mitigate error channels and improve the fidelity of quantum gate operations in superconducting systems.

Conclusion: This guide serves as a foundational resource to enhance the understanding and practical skills necessary for effective pulse design in superconducting quantum computing.
...
### [56] [Generalized stochastic spin-wave theory for open quantum spin systems](https://arxiv.org/abs/2604.21574)
*Zejian Li,Anna Delmonte,Rosario Fazio*

Main category: quant-ph

TL;DR: The paper presents a semiclassical method for analyzing open quantum dynamics in driven-dissipative spin systems, focusing on a driven-dissipative Ising model and its phase transitions.


<details>
  <summary>Details</summary>
Motivation: To provide an efficient method for simulating open quantum dynamics in large interacting spin systems, which conventional theories struggle to address.

Method: Generalized spin-wave approximations that apply to quantum trajectories from the master equation, effective in capturing both short-range interactions and local quantum jumps.

Result: The study reveals a continuous phase transition with broken $	ext{Z}_2$ symmetry depending on interaction range, and a first-order transition under specific dissipation conditions.

Conclusion: The framework offers a robust approach for understanding non-equilibrium dynamics and many-body phases in spin systems, adaptable to various interaction scenarios.
...
TL;DR: The paper proposes composite pulse sequences for X and Hadamard gates that compensate for systematic control errors, enhancing fidelity through strategies involving derivative cancellation and direct minimization of gate infidelity.


<details>
  <summary>Details</summary>
Motivation: To address systematic control errors that hinder high-fidelity single-qubit gates in quantum computing.

Method: The authors employ two strategies: derivative-based error cancellation using Cayley-Klein parametrization, and numerical optimization to derive sequences of varying lengths for error suppression.

Result: They derive symmetric five-pulse solutions that effectively cancel first-order errors, and optimize longer sequences to improve robustness against larger error ranges, demonstrating improved fidelity in their benchmarks.

Conclusion: The findings illustrate a trade-off between sequence length and robustness, while providing significant fidelity enhancements across various error conditions.
...
TL;DR: New software for efficient quantum circuit generation shows significant performance advantages over existing tools, particularly for larger qubit systems.


<details>
  <summary>Details</summary>
Motivation: The need for quick circuit generation to retain the quantum advantage in computing tasks, especially in combinatorial optimization.

Method: The software employs a backend that utilizes benchmarking with the quantum Fourier transform (QFT) to optimize circuit generation.

Result: The software can create circuits for systems of up to 2000 qubits faster than Qiskit and Q#, showcasing notable performance gains.

Conclusion: This software represents a promising step towards more efficient quantum programming, particularly for large-scale quantum computations.
...
TL;DR: This study experimentally demonstrates the ability to control the optical spectrum of a quantum emitter using periodic pi-pulses, reducing its optical linewidth and enabling selective frequency targeting.


<details>
  <summary>Details</summary>
Motivation: To develop methods for efficiently controlling the spectral properties of single photon emitters, crucial for various quantum technologies.

Method: We applied a periodic sequence of optical pi-pulses to a solid-state two-level system during its excited state lifetime, allowing for frequency detuning of the emission spectrum.

Result: The experimental implementation resulted in a significant reduction of the optical linewidth, concentrating approximately half of the absorption at a selectable frequency.

Conclusion: This technique can enhance the performance of quantum emitters, making it broadly applicable to both individual and ensemble quantum systems.
...
### [60] [Bipartite entanglement under frequency comb pumping in parametric Josephson circuits](https://arxiv.org/abs/2604.21692)
*Mikael Vartiainen,Ilari Lilja,Ekaterina Mukhanova,Kirill Petrovnin,Gheorghe Sorin Paraoanu,Pertti Hakonen*

Main category: quant-ph

TL;DR: This paper explores the effects of multiple parametric pump tones on two-mode squeezing in superconducting circuits, particularly with Josephson parametric amplifiers, and finds that these additional pumps can reduce initial correlations while enhancing entanglement.


<details>
  <summary>Details</summary>
Motivation: To enhance the production of high-quality cluster states essential for continuous-variable quantum computing, especially in the face of challenges like dissipation in microwave circuits.

Method: The study examines both experimentally and theoretically how varying the number of parametric pump tones influences two-mode squeezing in quantum circuits, specifically analyzing the Josephson parametric amplifier (JPA).

Result: The addition of more pump tones is shown to reduce the initial two-mode correlations by redistributing them among additional modes and creating new entanglement with idler frequencies, aligning experimental data with theoretical predictions under heterodyne measurement conditions.

Conclusion: The findings indicate that while additional pump tones can complicate the correlation dynamics, they also play a crucial role in enhancing entanglement, which is vital for the development of quantum information technologies.
...
### [61] [Lagrange: Operating Italy's First Publicly-Accessible Quantum Computer for Research and Education](https://arxiv.org/abs/2604.21695)
...
TL;DR: The paper details the design and implementation of a management stack for Italy's first operational superconducting quantum computer, Lagrange, which supports collaborative use by academia and the public.


<details>
  <summary>Details</summary>
Motivation: The need for a software management stack to enable fair usage, project management, and billing for a newly delivered quantum computing system.

Method: A modular middleware layer was developed to intercept API calls, ensuring project-based budgets, authorization, and fairness policies without altering vendor software.

Result: The system managed over 240,000 quantum jobs, achieving over 98% uptime, allowing broad access to students and researchers, including unique usage in educational contexts.

Conclusion: The architecture and lessons from Lagrange's deployment can inform future quantum computing initiatives, showcasing its operational success and accessibility.
...
### [62] [Testing Spontaneous Collapse Models with Coulomb Mediated Squeezing](https://arxiv.org/abs/2604.21705)
*Suroj Dey,Peter Barker,Animesh Datta*

Main category: quant-ph

TL;DR: This study presents a method to bound the Continuous Spontaneous Localization (CSL) parameter using thermal variance reductions in nanospheres, achieving results comparable to early X-ray experiments.


<details>
  <summary>Details</summary>
Motivation: The paper aims to find new ways to constrain the CSL parameter, critical for understanding quantum mechanics and its implications on gravity and decoherence.

Method: By detecting the steady-state Coulomb-mediated reduction in the thermal variance of two charged nanospheres, the authors estimate bounds on the CSL parameter ($λ_{	ext{CSL}}$).

Result: The bounds achieved are comparable to those from X-ray experiments and exceed the limits set by bulk-heating experiments, while remaining robust against colored-noise scenarios.

Conclusion: This approach offers a viable experimental pathway to constrain CSL parameters effectively, maintaining robustness against noise influences.
...
### [63] [Near-Term Reduction in Nonlocal Gate Count from Distributed Logical Qubits](https://arxiv.org/abs/2604.21722)
*Bruno Avritzer,Nathan Sankary*

Main category: quant-ph

TL;DR: This paper addresses error correction in modular quantum computing by minimizing noisy operations, presenting techniques for qubit allocation with a focus on color codes, and achieving significant reductions in processor-nonlocal gates.


<details>
  <summary>Details</summary>
Motivation: To address the challenges posed by noisy inter-processor operations in modular quantum computing and enhance error correction schemes.

Method: Developed qubit allocation techniques using color code families, evaluated the efficiency of universal gate sets, and assessed trade-offs among various methods.

Result: Achieved a 10% reduction in processor-nonlocal gates with potential for greater efficiencies in multi-qubit scenarios.

Conclusion: Outlined an allocation algorithm that could scale effectively for distributed quantum architectures, linking to prior work on quantum circuit partitions.
...
### [64] [Entanglement of two optical emitters mediated by a terahertz channel](https://arxiv.org/abs/2604.21723)
*Yanis Le Fur,Diego Martín-Cano,Carlos Sánchez Muñoz*

Main category: quant-ph

TL;DR: The paper presents a method for generating steady-state entanglement between polar quantum emitters mediated by THz photons, leveraging strong optical driving.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the need for a coherent interface between qubits and THz quantum channels, which is underdeveloped in current technologies.

Method: The authors utilize strong visible-light driving to create Rabi-split dressed eigenstates, tuning their energy into the THz regime and inducing collective dissipative dynamics to achieve steady-state entanglement.

Result: The method achieves high concurrence values ($C>0.9$) through optical manipulation, avoiding direct THz control, and demonstrating a hybrid quantum interface.

Conclusion: This work establishes a viable pathway for integrating THz channels into quantum technologies, facilitating qubit entanglement while remaining accessible through optical means.
...
### [65] [Symplectic split-operator method for the time-dependent unitary Tavis-Cummings model](https://arxiv.org/abs/2604.21778)
*Roman Ovsiannikov,Kurt Jacobs,Andrii G. Sotnikov,Denys I. Bondar*

Main category: quant-ph

TL;DR: This paper introduces a fast, memory-efficient numerical method for the Tavis-Cummings model, allowing for dynamic spin-system interactions with a cavity mode.


<details>
  <summary>Details</summary>
Motivation: To address the limitations inherent in traditional approaches for simulating the Tavis-Cummings model, particularly regarding time-dependency and computational efficiency.

Method: The proposed method transforms the Tavis-Cummings model into tri-diagonal form using basis re-indexing, combined with Fock basis truncation, leading to linear computational complexity.

Result: The method achieves significant gains in both time and memory efficiency, making it suitable for simulating various closed quantum systems.

Conclusion: This fast and efficient method expands the computational capabilities for simulating closed quantum systems, especially with time-dependent parameters.
...
### [66] [Partial oracles quantum algorithm framework -- Part I: Analysis of in-place operations](https://arxiv.org/abs/2604.21788)
*Fintan M. Bolton*

Main category: quant-ph

TL;DR: This paper introduces a construction method for the partial oracles framework in quantum search, specifically focusing on in-place operations, and introduces a new reciprocal transform to facilitate complex operations.


<details>
  <summary>Details</summary>
Motivation: To provide an explicit construction for the search iteration operator in the partial oracles framework, which aims to surpass Grover's quadratic speedup in quantum search algorithms.

Method: The paper constructs the search iteration operator for in-place operations and defines a new reciprocal transform that simplifies complex transformations through a chain rule.

Result: The reciprocal transform was successfully applied to elementary operations from the SHA-256 hash algorithm, with practical demonstrations included.

Conclusion: While the current construction does not yet yield quantum advantage due to its limitation to classically reversible operations, extending this method to include out-of-place operations could lead to significant improvements.
...
### [67] [Rigorous Security Proofs for Practical Quantum Key Distribution](https://arxiv.org/abs/2604.21791)
*Devashish Tupkary*

Main category: quant-ph

TL;DR: This thesis rigorously analyzes Quantum Key Distribution (QKD) protocols, offering new security proofs, error bound methods, and a unified framework for understanding QKD security.


<details>
  <summary>Details</summary>
Motivation: To address flaws and improve the security analysis techniques of QKD protocols in realistic scenarios.

Method: The thesis employs modern proof techniques to establish security proofs for variable-length QKD against various attack scenarios, develop error rate bounding methods, and introduce a general security analysis framework.

Result: Identified rigorous proofs for QKD protocols, demonstrated flexibility in error bounding despite detector imperfections, and created a comprehensive framework adaptable to practical situations and side channels.

Conclusion: The work enhances the theoretical foundation of QKD security, making it more applicable to real-world conditions, while serving as a reference for future research.
...
### [68] [Variance Geometry of Exact Pauli-Detecting Codes: Continuous Landscapes Beyond Stabilizers](https://arxiv.org/abs/2604.21800)
*Arunaday Gupta,Baisong Sun,Xi He,Bei Zeng*

Main category: quant-ph

TL;DR: This paper explores the geometry and structure of exact quantum codes addressing specific Pauli errors using algebraic methods, revealing continuous families of codes characterized by the scalar $λ^*$ derived from Knill-Laflamme conditions.


<details>
  <summary>Details</summary>
Motivation: To investigate the largely uncharted structures of exact quantum codes in relation to higher-rank numerical ranges of Pauli operators and their geometric implications.

Method: The authors analyze the geometry of higher-rank operator compressions, examining small-system cases numerically and applying symmetry restrictions to define continuous families of codes based on the scalar $λ^*$.

Result: The study identifies that stabilizer codes form discrete subsets within a broader continuum of nonadditive codes, with the attainable $λ^*$-spectrum exhibiting single closed intervals in analyzed cases.

Conclusion: The findings provide a cohesive framework for different quantum code families, promoting a continuous geometric perspective on their properties and interrelations.
...
### [69] [The clock ambiguity is back with a vengeance](https://arxiv.org/abs/2604.21805)
*Ovidiu Cristinel Stoica*

Main category: quant-ph

TL;DR: This paper critiques previous claims about clock ambiguities in dynamical systems, highlighting inconsistencies in mathematical assumptions and extending the ambiguity to encompass Hamiltonians, not just histories.


<details>
  <summary>Details</summary>
Motivation: To address and clarify the ambiguity present in the role of clocks within dynamical systems and its implications for the nature of spacetime and knowledge.

Method: The author proves that the clock ambiguity applies to both histories and Hamiltonians for continuous and discrete unbounded time, and not just histories as previously claimed.

Result: The proof reveals that the ambiguity is more extensive than previously acknowledged and that assuming noninteraction leads to incorrect conclusions about the nature of correlations and knowledge.

Conclusion: The ambiguity is resolved by incorporating the physical meanings of operators, challenging purely relational approaches and emphasizing the significance of Hilbert space dimensionality.
...
TL;DR: The chiral Dicke model generalizes the Dicke model, focusing on chiral interactions between an atomic ensemble and a two-mode cavity, revealing a rich phase diagram and multiversal critical behavior.


<details>
  <summary>Details</summary>
Motivation: To explore new collective light-matter interactions through the chiral Dicke model that incorporates chiral coupling and angular momentum conservation.

Method: Analyzed the ground-state phase diagram and quantum phase transitions of the chiral Dicke model, examining tunable quantum fluctuations and the emergence of various universality classes.

Result: Identified a $U(1)$-broken superradiant phase and multiversality in phase transitions, with a notable change in the dynamical critical exponent from $zν=1$ to $zν=1/2$ along a specific parameter line.

Conclusion: The chiral Dicke model offers a novel platform for investigating new quantum phases and critical phenomena in light-matter interactions.
...
### [71] [Deterministic generation of grid states with programmable nonlinear bosonic circuits](https://arxiv.org/abs/2604.21824)
*Yanis Le Fur,Javier Lalueza-Puértolas,Carlos Sánchez Muñoz,Alberto Muñoz de las Heras,Alejandro González-Tudela*

Main category: quant-ph

TL;DR: The paper presents deterministic protocols for generating bosonic grid states using nonlinear circuits, achieving competitive performance and introducing phased-comb states as a new quantum error-correcting code.


<details>
  <summary>Details</summary>
Motivation: To develop efficient methods for generating bosonic grid states for quantum error correction without relying on auxiliary systems.

Method: Deterministic protocols using programmable nonlinear bosonic circuits with squeezing, displacement, and Kerr operations to generate bosonic grid states.

Result: Demonstrated that the output states align with GKP symmetries, yielding high-performance states, while introducing a class of phased-comb states with optimal performance under boson loss.

Conclusion: Programmable nonlinear bosonic circuits provide a promising approach for scalable bosonic quantum error correction, offering alternatives to standard GKP states.
...
### [72] [Replay-buffer engineering for noise-robust quantum circuit optimization](https://arxiv.org/abs/2604.21863)
*Akash Kundu,Sebastian Feld*

Main category: quant-ph

TL;DR: The paper presents ReaPER$+$ and OptCRLQAS, innovative approaches for enhancing sample efficiency and runtime in deep reinforcement learning for quantum circuit optimization, while addressing critical issues in replay buffers and evaluation processes.


<details>
  <summary>Details</summary>
Motivation: To overcome bottlenecks in deep reinforcement learning for quantum circuit optimization related to replay buffers, curriculum-based architectures, and noise handling.

Method: Introduces ReaPER$+$ for adaptive replay prioritization, OptCRLQAS for efficient evaluation in curriculum RL, and a lightweight transfer scheme for utilizing noiseless trajectories.

Result: Achieves significant improvements in sample efficiency (4-32×), reduces evaluation time by up to 67.5%, and decreases steps to chemical accuracy by 85-90% in practical tasks.

Conclusion: Experience storage, sampling, and transfer are crucial for improving the scalability and noise robustness of quantum circuit optimization.
...
### [73] [High-performance cellular automaton decoders for quantum repetition and toric code](https://arxiv.org/abs/2604.21866)
*Don Winter,Thiago L. M. Guedes,Markus Müller*

Main category: quant-ph

TL;DR: SCALA is a scalable local decoder for quantum error correction, offering low latency and robustness against errors.


<details>
  <summary>Details</summary>
Motivation: To achieve low logical error rates in quantum computing, effective decoding architectures are essential, and local decoders can mitigate bottlenecks of global strategies.

Method: SCALA is introduced as a non-hierarchical cellular automaton decoder for quantum repetition and toric codes, compared against a hierarchical CA decoder.

Result: SCALA reaches a code-capacity threshold of about 7.5% and shows favorable scaling of sub-threshold performance; it also maintains resource independence from system size.

Conclusion: SCALA is validated as a high-performance, scalable, and robust solution for local decoding in quantum error correction.
...
### [74] [Enhancing Coherence of Spin Centers in p-n Diodes via Optimization Algorithms](https://arxiv.org/abs/2604.21874)
*Jonatan A. Posligua,David E. Stewart,Denis R. Candido*

Main category: quant-ph

TL;DR: This work develops an optimization algorithm to improve spin center coherence in $p$-$n$ diodes by minimizing optical linewidth through control of various design parameters under realistic constraints.


<details>
  <summary>Details</summary>
Motivation: To optimize the coherence of spin centers in diodes using design parameters like doping and bias voltage, which impact their performance in quantum technologies.

Method: A scaled gradient descent optimization algorithm minimizes optical linewidth by solving the diode's Poisson equation and assessing charge noise, applied to both single- and multiple-parameter cases for divacancies in SiC $p$-$i$-$n$ diodes.

Result: The study identifies optimal configurations for key parameters such as reverse-bias voltage, doping density and profile, leading to improved coherence and narrow optical linewidths while considering physical constraints and leakage current influences.

Conclusion: The findings offer valuable insights for designing experimentally relevant diodes that can efficiently host spin centers with high coherence and minimal linewidth.
...
### [75] [Loss-biased fault-tolerant quantum error correction](https://arxiv.org/abs/2604.21876)
*Laura Pecorari,Gavin K. Brennen,Stanimir S. Kondov,Guido Pupillo*

Main category: quant-ph

TL;DR: This paper explores quantum error correction (QEC) limits in neutral-atom processors, proposing 'loss biasing' to convert errors into manageable noise and improve performance.


<details>
  <summary>Details</summary>
Motivation: To enhance quantum error correction efficiency in neutral-atom processors amid high-fidelity gates and rapid cycle times.

Method: Introducing loss biasing to convert spurious Rydberg excitations into atom loss, mitigating non-Markovian correlated errors and enabling shorter QEC cycles.

Result: Loss biasing restores optimal error scaling for Pauli errors and potential erasure scaling with reduced hardware overhead.

Conclusion: Loss biasing offers a practical strategy for improved fault tolerance in quantum computing, allowing sub-millisecond QEC cycles.
...
### [76] [A Universal Quantum Information Preserving Photonic Switch for Scalable Quantum Networks](https://arxiv.org/abs/2604.21902)
...
TL;DR: A Universal Quantum Switch enables dynamic routing of quantum information with minimal decoherence, demonstrated experimentally with a prototype that supports high-speed entanglement distribution.


<details>
  <summary>Details</summary>
Motivation: To overcome limitations in current quantum networks related to the routing of quantum information and decoherence in existing static link implementations.

Method: A prototype of the Universal Quantum Switch was developed using thin-film lithium niobate, incorporating techniques like thermo-optic modulation and electro-optic switching to demonstrate robust performance with minimal decoherence.

Result: Experimental demonstration showed $	extless 4\\%$ decoherence and reconfiguration speeds up to 1 GHz, facilitating multi-node dynamic entanglement distribution.

Conclusion: The proposed architecture is scalable, dimension-independent in terms of decoherence, and serves as a foundational component for future heterogeneous quantum networks.
...
### [77] [Efficient Classical Simulation of Heuristic Peaked Quantum Circuits](https://arxiv.org/abs/2604.21908)
*David Kremer,Nicolas Dupuis*

Main category: quant-ph

TL;DR: The paper critiques peaked quantum circuits for claimed verifiable quantum advantage by showing they can be efficiently simulated classically.


<details>
  <summary>Details</summary>
Motivation: Peaked quantum circuits promise verifiable quantum advantage, but their classical simulation remains a concern.

Method: The authors developed a method for efficient tensor network contraction to sample and extract the peaked bitstring, using matrix product operators and a technique named unswapping to simplify computations.

Result: The method allows for near-exact sampling of the output from the largest peaked circuits on classical hardware in about an hour, proving efficient against quantum simulation claims.

Conclusion: The findings challenge the notion of quantum advantage claimed in previous work, demonstrating classical efficiency in simulating peaked circuits.
...
### [78] [Dual-use quantum hardware for quantum resource generation and energy storage](https://arxiv.org/abs/2604.21913)
*Vaibhav Sharma,Yiming Wang,Shouvik Sur*

Main category: quant-ph

TL;DR: This paper discusses the synergy between quantum resource generation and quantum batteries, suggesting a framework where quantum states can be efficiently generated while simultaneously charging a quantum battery.


<details>
  <summary>Details</summary>
Motivation: To explore the intersection of quantum resource generation and quantum energy storage, highlighting their potential coexistence and advantages.

Method: The authors propose an integrated hardware protocol using superconducting circuits that allows for interchangeable operations between quantum battery charging and quantum sensing during each experimental run.

Result: The study demonstrates that resourceful quantum states and energy storage can be produced simultaneously, thereby enabling more efficient quantum architectures.

Conclusion: The findings indicate that quantum resources and energy storage are distinct yet interrelated quantities, paving the way for versatile quantum systems capable of multiple functions with minimal additional hardware.
...
### [79] [Algorithmic Locality via Provable Convergence in Quantum Tensor Networks](https://arxiv.org/abs/2604.21919)
*Siddhant Midha,Yifan F. Zhang,Daniel Malz,Dmitry A. Abanin,Sarang Gopalakrishnan*

Main category: quant-ph

TL;DR: The paper presents a comprehensive theory for tensor network belief propagation, demonstrating efficient computation under certain conditions and a novel locality phenomenon.


<details>
  <summary>Details</summary>
Motivation: To establish a robust theory for tensor network belief propagation, particularly for projected entangled pair states, addressing gaps between numerical practices and empirical guarantees.

Method: Developed an end-to-end theory for tensor network belief propagation with a focus on strong injectivity and a cluster-corrected BP algorithm to analyze physical quantities efficiently.

Result: Verified that BP fixed points can be efficiently located when the injectivity is above a certain threshold, introducing a phenomenon called algorithmic locality, where local perturbations only require local recomputation for updates.

Conclusion: The findings ensure reliability and efficiency in tensor-network belief propagation for a broad range of many-body states, reinforcing the connection between numerical methods and algorithmic theory.
...
### [80] [Subsystem-Resolved Spectral Theory for Quantum Many-Body Hamiltonians](https://arxiv.org/abs/2604.21929)
*MD Nahidul Hasan Sabit*

Main category: quant-ph

TL;DR: This study explores the spectral properties of quantum many-body Hamiltonians using a subsystem-based approach, revealing how interaction structure influences spectra.


<details>
  <summary>Details</summary>
Motivation: To understand how the geometry of interactions affects the spectral properties of quantum many-body systems.

Method: Introduce subsystem Hamiltonians for each subset of a Hilbert space, analyzing their spectra and proving stability and additivity properties under local approximations and truncations.

Result: Subsystem Hamiltonians can be approximated locally, leading to stable spectra under truncation, and demonstrating approximate additivity for disjoint subsystems.

Conclusion: The framework highlights the role of interaction geometry in shaping the spectral behavior of quantum many-body systems.
...
### [81] [Improving the robustness of the $δ_{CP}$ determination with $ν$SCOPE](https://arxiv.org/abs/2604.20956)
*João Paulo Pinheiro,Salvador Urrea*

Main category: hep-ph

TL;DR: The paper examines how uncertainties in neutrino cross-section ratios impact CP violation sensitivity in future neutrino experiments DUNE and T2HK, suggesting that external measurements from the proposed νSCOPE experiment can restore this sensitivity.


<details>
  <summary>Details</summary>
Motivation: To determine leptonic CP violation accurately, the sensitivity of future neutrino experiments relies heavily on cross-section ratios and theoretical assumptions.

Method: The authors conducted a model-agnostic, data-driven analysis to assess systematic uncertainties in ν_e and ν_e cross sections, evaluating impacts on CP violation sensitivity for DUNE and T2HK.

Result: They found that neglecting certain assumptions can significantly reduce CP-violation sensitivity by about 3σ for DUNE and 4σ for T2HK.

Conclusion: Including measurements from the proposed νSCOPE experiment can recover lost sensitivity, underscoring the need for precise cross-section data to ensure robust detection of δ_CP.
...
### [82] [Kitchen Sink Anomaly Detection](https://arxiv.org/abs/2604.20965)
...
TL;DR: This paper addresses limitations in resonant anomaly detection methods by introducing new simulated benchmarks and a versatile observable set, achieving improved signal sensitivity and reduced training costs.


<details>
  <summary>Details</summary>
Motivation: To overcome limitations in existing anomaly detection methods that focus on limited signal models and observables.

Method: Introduces new simulated signal benchmarks and evaluates a combination of observables (Energy Flow Polynomials and subjettiness variables) for anomaly detection tasks.

Result: The 'kitchen sink' observable set shows enhanced sensitivity to varied signal types, while an attribute bagging variant achieves comparable performance with lower training costs.

Conclusion: Combining diverse observables enhances anomaly detection sensitivity, and efficient training techniques can reduce costs without sacrificing performance.
...
### [83] [Impact of different neutrino decoherence formalisms at the future long-baseline Experiments](https://arxiv.org/abs/2604.20977)
*Rudra Majhi,Koushik Pal,Monojit Ghosh,Rukmani Mohanta*

Main category: hep-ph

TL;DR: The paper investigates how two quantum decoherence formalisms affect sensitivity analyses in long-baseline neutrino experiments DUNE and P2SO, revealing that differences emerge under strong decoherence or matter effects.


<details>
  <summary>Details</summary>
Motivation: To understand the role of quantum decoherence in neutrino behavior, particularly in the context of future experiments.

Method: Two formalisms are analyzed: Formalism-A uses a decoherence matrix in the matter mass eigenstate basis, while Formalism-B starts in the vacuum mass eigenstate basis and is transformed to the matter basis.

Result: The two formalisms yield similar results in vacuum for small decoherence parameter values but diverge significantly under larger decoherence or strong matter influences.

Conclusion: Quantum decoherence impacts neutrino oscillation probabilities and sensitivities differently depending on the formalism and conditions, which is crucial for designing future experimental setups.
...
### [84] [Multimessenger probes of Axions from Compact Objects](https://arxiv.org/abs/2604.21077)
*Alessandro Lella*

Main category: hep-ph

TL;DR: Astrophysics aids in the search for axions by enhancing production under extreme conditions, and multimessenger techniques improve detection of axion signatures during stellar events.


<details>
  <summary>Details</summary>
Motivation: To explore axions and axion-like particles, which are difficult to probe through conventional means.

Method: Utilizing astrophysical environments like supernovae and neutron stars to enhance axion production and employing multimessenger astrophysics for detection.

Result: Identifies that extreme stellar conditions can significantly boost axion production and that multimessenger techniques can help uncover their signatures.

Conclusion: This approach offers a promising pathway to investigate axion properties and their interactions with known particles.
...
### [85] [Jet Quenching Identification via Supervised Learning in Simulated Heavy-Ion Collisions](https://arxiv.org/abs/2604.21088)
*Leonardo Lima da Silva,Marcelo Gameiro Munhoz*

Main category: hep-ph

TL;DR: The paper explores using machine learning to improve jet modification analysis in heavy-ion collisions, showing that sequential models can capture more dynamics than traditional methods.


<details>
  <summary>Details</summary>
Motivation: Jet modification in heavy-ion collisions seeks to understand the quark-gluon plasma properties, but existing global observables provide limited insights.

Method: The study employs sequential machine learning architectures applied to the jet declustering history tree, enhancing classification compared to static models that consider single jet evolution stages.

Result: Models trained on various medium implementations show significant cross-domain performance changes, highlighting machine learning's sensitivity to specific features not captured by traditional methods.

Conclusion: Machine learning presents new avenues for analyzing jet modifications, addressing limitations in conventional studies.
...
### [86] [Neutron Portal and Dark Matter-Baryon Coincidence: from UV Completion to Phenomenology](https://arxiv.org/abs/2604.21168)
*Sudhakantha Girmohanta,Yuichiro Nakai,Yoshihiro Shigekami,Zhihao Zhang*

Main category: hep-ph

TL;DR: A solution for the dark matter-baryon coincidence problem is proposed via a neutron portal operator, linking visible and dark sector asymmetries, with implications for gravitational wave signals and mass scales.


<details>
  <summary>Details</summary>
Motivation: The framework aims to address the coincidence of dark matter and baryons by suggesting a connection through a neutron portal, considering implications for gravitational waves observed in pulsar timing arrays.

Method: The study employs a dynamical model where dark confinement transitions are linked to dark matter and baryon asymmetries. It explores both tree and loop-level ultraviolet completions, associating GeV-scale asymmetric dark matter with multi-TeV scale neutron portal cut-offs through their UV completion.

Result: The mass of asymmetric dark matter is shown to correlate with the neutron portal cut-off, verifying the model against cosmological constraints and linking the confinement scale to the neutron portal scale.

Conclusion: This approach provides insights into both the dark matter-baryon alignment and potential experimental avenues for probing the neutron portal through cosmological observations and particle physics experiments.
...
### [87] [Ultra High Energy Cosmic Rays from the Local Void](https://arxiv.org/abs/2604.21099)
*Michael J. Padgett,Thomas W. Kephart*

Main category: hep-ph

TL;DR: This paper posits that ultra high energy cosmic rays from local cosmic voids could be light magnetic monopoles, suggesting their relative fraction can be determined through comprehensive sky observations.


<details>
  <summary>Details</summary>
Motivation: To explain the origin of ultra high energy cosmic rays observed from local voids and to propose a new source: light magnetic monopoles.

Method: Analyses based on full sky observations of ultra high energy cosmic rays.

Result: Identification of a potential relative fraction of these cosmic rays that could be attributed to magnetic monopoles above 10^20 eV.

Conclusion: The study supports the hypothesis that light magnetic monopoles may contribute to ultra high energy cosmic rays detected in our universe.
...
### [88] [Comparing relativistic and non-relativistic quark pair creation models](https://arxiv.org/abs/2604.21403)
*Xiu-Li Gao,Yu-Hui Zhou,Bin Wu,Zhi-Yong Zhou*

Main category: hep-ph

TL;DR: The study compares the strong decay predictions of light unflavored and strange mesons using relativistic and non-relativistic quark-pair-creation models, finding comparable accuracy but noting enhanced decay amplitude suppression in the relativistic model.


<details>
  <summary>Details</summary>
Motivation: To better understand strong decay properties of mesons using different theoretical frameworks.

Method: Strong decay widths of light unflavored and strange mesons are analyzed within a relativistic QPC framework and compared with a conventional non-relativistic QPC model.

Result: The relativistic QPC model produces predictions for decay widths that are comparable in quality to those of the non-relativistic model, but shows stronger suppression of decay amplitudes at high energies.

Conclusion: The non-relativistic QPC model is still suitable for practical applications, though the relativistic model offers potential advantages in unquenched quark models.
...
### [89] [Solving Cosmological Puzzles using Finite Temperature $ν$SMEFT](https://arxiv.org/abs/2604.21492)
*Debajyoti Choudhury,Jaydeb Das,Tripurari Srivastava*

Main category: hep-ph

TL;DR: The paper develops a framework combining Dark Matter, electroweak phase transition, and leptogenesis through an extended Standard Model with heavy Majorana neutrinos, while ensuring consistency with experimental constraints.


<details>
  <summary>Details</summary>
Motivation: To integrate viable Dark Matter, strong first-order electroweak phase transitions, and low-scale resonant leptogenesis within a unified theoretical framework.

Method: The authors augment the Standard Model with three heavy Majorana neutrinos, employing neutrino-extended effective field theory with operators of mass-dimension up to six, and solve Boltzmann equations for baryogenesis.

Result: Demonstrated that the observed baryon asymmetry can be reproduced while remaining compliant with neutrino oscillation data and other experimental bounds, with a dark matter candidate linked to one of the heavy neutrinos.

Conclusion: The framework successfully decouples the dark matter sector from electroweak dynamics and leptogenesis, enabling a coherent model that addresses multiple phenomena in particle physics.
...
### [90] [$γZ$-exchange contribution in elastic $ep$ scattering by perturbative QCD](https://arxiv.org/abs/2604.21610)
*Qian-Qian Guo,Hui-Yun Cao,Hai-Qing Zhou*

Main category: hep-ph

TL;DR: This study analyzes the $γZ$-exchange contributions to elastic $ep$ scattering at high momentum transfer using perturbative QCD and finds that existing dispersion relations for the axial-vector amplitude need modification.


<details>
  <summary>Details</summary>
Motivation: To accurately assess contributions to elastic $ep$ scattering via $γZ$-exchange at high momentum transfer using perturbative QCD techniques.

Method: The authors compute the analytical expressions for the amplitude contributions and examine their asymptotic behaviors to establish the proper subtraction order in the dispersion relations.

Result: The study concludes that the conventional dispersion relation for the axial-vector part is invalid at high $Q^2$ and requires modification to a once-subtracted form, impacting interpretations in both high-energy physics and low-energy assumptions.

Conclusion: The modifications to the dispersion relations provide essential constraints on low-energy assumptions within the framework of high-energy scattering processes.
...
### [91] [Dilepton Production as a Probe of Pion Condensation in Hot and Dense QCD Matter](https://arxiv.org/abs/2604.21633)
*Aritra Bandyopadhyay,Chowdhury Aminul Islam,Krzysztof Redlich,Chihiro Sasaki*

Main category: hep-ph

TL;DR: The paper examines dilepton production in isospin-asymmetric media, focusing on the effects of pion condensation and isospin imbalance, using the Nambu–Jona-Lasinio model to identify key modifications in dilepton rates that could impact future experiments.


<details>
  <summary>Details</summary>
Motivation: To explore how isospin imbalance influences electromagnetic spectral properties in hot and dense media, particularly relating to pion condensation.

Method: Utilizing the Nambu–Jona-Lasinio model, the study analyzes the phase structure in the T-μ_I plane and calculates the resummed dilepton rate with an effective quark chemical potential.

Result: The interplay of isospin asymmetry, pion condensation, and vector interactions results in significant modifications of dilepton yields, characterized by enhancements at lower invariant masses and distinctive plateau structures in the dilepton spectrum.

Conclusion: Dilepton observables are sensitive to the pion-condensed phase of QCD matter, with implications for low-energy heavy-ion collision experiments and neutron star matter.
...
### [92] [Constraining dark matter self-interaction from kinetic heating in neutron stars](https://arxiv.org/abs/2604.21652)
*Sambo Sarkar*

Main category: hep-ph

TL;DR: Research explores dark matter detection via neutron stars, focusing on self-interactions affecting thermal characteristics detectable by advanced telescopes.


<details>
  <summary>Details</summary>
Motivation: To investigate how dark matter self-interactions might alter neutron star temperatures, offering potential insights into elusive dark matter properties.

Method: Analyses conducted on the impacts of dark matter capture and thermalization in neutron stars and their effects on observable temperatures and radiation.

Result: Neutron stars may reveal observable effects of dark matter self-interaction, with potential temperatures detectable by major telescopes.

Conclusion: Detecting cold neutron stars could offer new constraints on dark matter models, pushing limits on self-interaction cross-sections significantly.
...
### [93] [True Leptonium ($l^+ l^-$) Production in UPC Triphoton Interaction](https://arxiv.org/abs/2604.21838)
*Qi-Ming Feng,Qi-Wei Hu,Cong-Feng Qiao*

Main category: hep-ph

TL;DR: This paper discusses the production of ortho-leptonium states in ultraperipheral heavy-ion collisions, offering a method to identify elusive states like dimuonium and tauonium.


<details>
  <summary>Details</summary>
Motivation: The search for true leptonium states has been ongoing since their theoretical prediction, with positronium confirmed but dimuonium and tauonium remaining unobserved due to low production yields.

Method: The authors propose generating ortho-leptonium states via the triphoton interaction process in ultraperipheral heavy-ion collisions, leveraging photon emissions from two colliding heavy ions.

Result: The proposed model reproduces experimental data for $J/ψ$ and dimuon production effectively in Pb+Pb collisions at the LHC, indicating the feasibility of observing dimuonium and tauonium.

Conclusion: This novel interaction mechanism provides a promising avenue for confirming the existence of dimuonium and tauonium states in future experiments.
...
### [94] [Quark and gluon production in the presence of the time-varying chiral magnetic current](https://arxiv.org/abs/2604.21872)
*Kirill Tuchin*

Main category: hep-ph

TL;DR: The paper investigates the effect of time-varying chiral magnetic conductivity on particle spectra and energy loss in quark-gluon plasma, using ultra-relativistic approximations and models relevant to relativistic heavy-ion collisions.


<details>
  <summary>Details</summary>
Motivation: To understand how time-dependent chiral magnetic conductivity influences particle behavior in high-energy physics, particularly in quark-gluon plasma.

Method: The study employs ultra-relativistic approximations to derive particle spectra and energy loss rates in both Abelian and non-Abelian systems, focusing on chiral Cherenkov processes in a specific model for quark-gluon plasma.

Result: The analysis indicates significant polarization of jets in the quark-gluon plasma due to the chiral magnetic effect, highlighting the impact of time-variation of chiral magnetic conductivity.

Conclusion: Findings demonstrate that time-dependent chiral magnetic conductivity profoundly affects particle dynamics and energy loss in high-energy collisions, relevant for understanding quark-gluon plasma behavior.
...
### [95] [Heavy Quark Transport is Non-Gaussian Beyond Leading Log](https://arxiv.org/abs/2604.21895)
*Jean F. Du Plessis,Bruno Scheihing-Hitschfeld*

Main category: hep-ph

TL;DR: Heavy quark transport in weak coupling is found to have non-Gaussian momentum transfer distributions, important for equilibration.


<details>
  <summary>Details</summary>
Motivation: To understand the non-Gaussian characteristics of heavy quark transport and their implications in quark-gluon plasma dynamics.

Method: Computed the leading-order momentum transfer kernel for heavy quarks in weakly coupled non-Abelian plasmas, linking perturbative momentum transfer with soft physics.

Result: The momentum transfer distribution features asymmetric exponential tails, aligning with findings from strongly coupled holographic plasmas.

Conclusion: This non-Gaussian behavior is expected to be a consistent feature across different coupling regimes of quark-gluon plasma.
...
### [96] [Liquid argon purification and purity monitoring: apparatus and first results](https://arxiv.org/abs/2604.21307)
...
TL;DR: This paper presents findings from a liquid argon test stand, highlighting low impurity levels and promising electron lifetimes, aiding future detector technology development.


<details>
  <summary>Details</summary>
Motivation: The need for improved charge and light readout technologies for large-scale liquid argon time projection chambers (LArTPCs) necessitated the establishment of a test stand at Wellesley College.

Method: A 13-liter purified liquid argon test stand was set up, utilizing a purification column and purity monitor to measure O$_2$-equivalent impurities and electron lifetimes under controlled conditions.

Result: Measurements indicated an O$_2$-equivalent impurity level of 0.25 ppb, translating to an electron lifetime of 1.2 ms at a drift field of 500 V/cm, demonstrating effective purification.

Conclusion: The successful operation of the test stand advances research and development in charge and light readout technologies, contributing to the future of LArTPC applications.
...
### [97] [Performance characterisation of the Hamamatsu R760 photomultiplier tube for the PLUME detector](https://arxiv.org/abs/2604.21687)
*A. Bellavista,A. Carbone,V. Chaumat,F. Ferrari,T. Nguyen-Trung,V. Puill,L. Toscano,A. Villa*

Main category: physics.ins-det

TL;DR: This paper discusses the Probe for Luminosity Measurement detector, focusing on the characterization of photomultiplier tubes used for luminosity monitoring in the LHCb experiment.


<details>
  <summary>Details</summary>
Motivation: To ensure accurate and stable luminosity measurements at the LHCb experiment during Runs 3 and 4.

Method: Characterization of 48 Hamamatsu R760 photomultiplier tubes, analyzing their gain, transit-time drift, linearity, dark current, and aging under controlled conditions.

Result: A comprehensive assessment of photomultiplier performance is provided, leading to the establishment of optimal operating conditions for stable measurements.

Conclusion: The findings will aid in achieving reliable luminosity measurements throughout the data-taking periods.
...
### [98] [Phenomenological Detector Design and Optimization in Vertically-Integrated Differentiable Full Simulations with Agentic-AI](https://arxiv.org/abs/2604.21804)
*Wonyong Chung,Qibin Liu,Liangyu Wu,Julia Gonski*

Main category: physics.ins-det

TL;DR: The paper introduces AI agents for optimizing detector design in high-energy physics using a bilevel optimization framework, demonstrating significant efficiency and computational validation improvements.


<details>
  <summary>Details</summary>
Motivation: Incorporating AI agents aims to enhance the design and optimization processes of detectors in high-energy physics experiments, enabling better parameter identification and reduction.

Method: A bilevel optimization framework is applied to integrate detector geometry, digitization, and reconstruction algorithm parameters, utilizing differentiable full simulations. The study focuses on a dual-readout, segmented crystal EM calorimeter.

Result: The integration of AI agents, particularly LLM-based reasoning models, effectively optimizes detector parameters like crystal granularity and ADC characteristics and suggests pathways for further research without detailed context.

Conclusion: AI agents present a valuable tool for improving workflows in high-energy physics detector design, reducing labor and computational needs, though autonomous physics insight remains undeveloped.
