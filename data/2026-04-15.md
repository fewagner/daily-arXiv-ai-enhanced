...
### [1] [Frequency & Radiative Analysis of Random Yagi-UHF/VHF Phased Array](https://arxiv.org/abs/2604.11816)
*Luis M. Bres,Luis A. Hernandez,Teviet D. Creighton*

Main category: physics.ins-det

TL;DR: The paper presents a cost-effective, scalable phased array ground station designed for multi-source tracking and electronic steering, featuring a dual-polarized yagi-UHF/VHF array.


<details>
  <summary>Details</summary>
Motivation: To enhance tracking capabilities and efficiency in phased array systems for various applications while maintaining low costs and scalability.

Method: Development of a 20-pair dual-polarized yagi-UHF/VHF phased array with pseudo-random layout, analyzed through various metrics including side lobes, element scaling, and steering techniques.

Result: Comprehensive analyses reveal performance differences between random and uniform distributions, efficiency of beam steering methods, and effect of array density on system performance.

Conclusion: The findings support the feasibility of low-cost, scalable phased array ground stations with improved tracking and multi-beamforming capabilities.
...
### [2] [An AI-based Detector Simulation and Reconstruction Model for the ALEPH Experiment at LEP](https://arxiv.org/abs/2604.11834)
*Ya-Feng Lo,Dmitrii Kobylianskii,Benjamin Nachman*

Main category: physics.ins-det

TL;DR: Parnassus, a generative model, effectively simulates and reconstructs the ALEPH detector at LEP, showing compatibility with older collider data.


<details>
  <summary>Details</summary>
Motivation: To extend modern generative simulation techniques used in LHC experiments to historical colliders like ALEPH, enabling analysis of legacy data.

Method: Training Parnassus on simulated $e^+e^-$ events through the ALEPH detector, checking fidelity at event, jet, and particle levels.

Result: Parnassus accurately reproduces the ALEPH detector response, verified in a controlled $e^+e^-$ environment.

Conclusion: The successful application of Parnassus indicates its utility for analyzing historical data from experiments with distinct geometries.
...
### [3] [Projection of purification performance for the RELICS experiment](https://arxiv.org/abs/2604.12572)
...
TL;DR: The RELICS experiment uses a liquid xenon chamber to study coherent elastic neutrino-nucleus scattering, focusing on impurity management for optimal detector performance.


<details>
  <summary>Details</summary>
Motivation: The study aims to enhance detection capabilities for coherent elastic neutrino-nucleus scattering by managing impurity levels in the detector system, which are crucial for minimizing signal loss.

Method: A purity evolution model was developed, accounting for impurity migration and utilizing measured outgassing rates. The model integrates transport mechanisms like circulation, vaporization, and condensation, validated with a prototype detector's data.

Result: The model effectively describes impurity dynamics and provides projections for purification performance in the upcoming RELICS-10 and RELICS-50 detectors.

Conclusion: The comprehensive impurity management strategy is essential for optimizing the detection of sub-keV nuclear recoils in future experiments.
...
### [4] [Finite temperature effects on g-modes of inviscid neutron stars](https://arxiv.org/abs/2604.11815)
*David Morales-Zapien,Prashanth Jaikumar,Thomas Klähn*

Main category: astro-ph.HE

TL;DR: This study investigates how temperature influences $g$-modes in neutron star cores using a chiral sigma model, revealing that $g$-mode frequencies depend on the symmetry energy parameter $L.


<details>
  <summary>Details</summary>
Motivation: To understand the influence of temperature and composition on $g$-modes in neutron stars and how these factors can inform us about nuclear symmetry energy.

Method: The authors used a chiral $SU(2)_f$ sigma model to derive isentropic temperature profiles for dense matter and analyzed the frequency of $g$-modes based on the symmetry energy slope parameter $L.

Result: The study found that the frequency of the global core $g$-mode can be either increased or decreased with temperature, contingent on the value of $L$.

Conclusion: The findings suggest that observations of neutron star $g$-modes can effectively constrain models of nuclear symmetry energy, revealing complex interactions between thermal effects and compositional changes.
...
### [5] [Sensitivities of Black Hole Images from GRMHD Simulations](https://arxiv.org/abs/2604.11869)
*Pedro Naethe Motta,Mário Raia Neto,Cora Prather,Alejandro Cárdenas-Avendaño*

Main category: astro-ph.HE

TL;DR: The paper presents a method using differentiable radiative transfer code for efficient analysis of supermassive black hole images from GRMHD simulations, focusing on pixel-wise sensitivity to model parameters and gradient-based parameter fitting.


<details>
  <summary>Details</summary>
Motivation: To improve data analysis for high-fidelity imaging of supermassive black holes using advanced modeling techniques.

Method: Utilizes $	exttt{Jipole}$ to compute pixel-wise derivatives (Jacobian) of image intensity with respect to model parameters, facilitating gradient-based analysis.

Result: Identifies structured error landscapes in GRMHD images with anisotropies and local minima, making parameter fitting nontrivial yet manageable with gradient guidance.

Conclusion: The study shows that image gradients from automatic differentiation can enhance parameter exploration, even under noisy conditions, laying the groundwork for improved model--data comparisons in black hole imaging.
...
### [6] [An XMM-Newton Analysis of the Supermassive Black Hole Binary Candidate MCG+11--11--032](https://arxiv.org/abs/2604.11874)
*Yash A. Gursahani,Tingting Liu,Richard Mushotzky,Christopher S. Reynolds,Michael Koss*

Main category: astro-ph.HE

TL;DR: The study investigates a potential binary supermassive black hole system in the Seyfert 2 galaxy MCG+11--11--032, finding no evidence of double Fe K$α$ lines despite previous suggestions. The data from XMM-Newton/EPIC fits support a single AGN model.


<details>
  <summary>Details</summary>
Motivation: To explore the existence of a binary supermassive black hole system in the Seyfert 2 galaxy MCG+11--11--032 based on spectral analysis.

Method: Follow-up observations using two epochs of XMM-Newton/EPIC data analyzed for Fe K$α$ lines and compared with prior studies' models and data.

Result: No evidence for double Fe K$α$ lines was found in the XMM-Newton observations, with spectral parameters broadly consistent with previous datasets.

Conclusion: The findings support the notion of a single AGN scenario in MCG+11--11--032, aligning with other Seyfert 2 galaxies.
...
### [7] [Spectral index evolution of the limb-brightened jet in 3C 84](https://arxiv.org/abs/2604.11875)
...
TL;DR: Study of relativistic jets in active galactic nuclei, focusing on the jet of 3C 84 through VLBI observations, revealing dynamic activity and influences on high-energy emissions.


<details>
  <summary>Details</summary>
Motivation: Understanding the mechanisms driving jet launching in supermassive black holes is crucial for astrophysical research.

Method: Utilized multi-epoch, multi-frequency VLBI observations at 22 and 43 GHz to analyze the spectral index gradient and jet dynamics.

Result: Found significant changes in jet structure and dynamics across epochs, highlighting interactions with the medium and magnetic fields, alongside a correlation with a $γ$-ray flare.

Conclusion: Dynamic activities and interactions shape the jet’s innermost region, influencing its evolution and high-energy emissions.
...
### [8] [A sample of short-lived Galactic radio transients from ASKAP VAST](https://arxiv.org/abs/2604.11881)
...
TL;DR: This paper identifies new Galactic radio transients (GRTs) using the Australian SKA Pathfinder and suggests potential classifications based on their emission mechanisms.


<details>
  <summary>Details</summary>
Motivation: The nature and classification of Galactic radio transients remain poorly understood due to a limited sample size and lack of comprehensive observations.

Method: The study employed radio observations from the Australian SKA Pathfinder's survey to discover six new transients, analyzing their emissions and comparing them to existing data on white dwarf binaries.

Result: The investigation categorized the new transients into two classes—short-term pulse-like sources and long-term flaring sources—linking them to white dwarf binary systems.

Conclusion: These findings indicate that wide-field radio surveys may reveal previously undiscovered radio emissions from sub-populations of white dwarf binaries.
...
### [9] [Distinct First-to-Second Peak Yield Ratios and Timescales Reveal a Sub-dominant Prompt Channel](https://arxiv.org/abs/2604.11885)
*Yossef Zenati,Paz Beniamini,Kenta Hotokezaka*

Main category: astro-ph.HE

TL;DR: The study analyzes stellar abundances of Y and Sr relative to Eu, revealing complex nucleosynthesis involving at least three distinct neutron-capture sources and varying timescales.


<details>
  <summary>Details</summary>
Motivation: To understand the observed non-monotonic evolution of heavy element abundances, particularly [Y/Eu] and [Sr/Eu], in relation to [Eu/H] across different metallicities.

Method: A one-zone chemical-evolution model is developed to quantify delay times, rates, and yield ratios of different nucleosynthetic processes, including a dominant delayed r-process, prompt production, and delayed AGB s-process.

Result: The model successfully reproduces observed abundance sequences and variations, indicating significant contributions from binary neutron-star mergers and other nucleosynthesis channels with distinct properties.

Conclusion: The findings highlight the necessity of multiple nucleosynthetic processes with specific operational timescales to explain heavy-element abundance patterns, providing critical constraints on their yield ratios and production mechanisms.
...
### [10] [Beyond the Diffusion Coefficient: Propagators and Memory in Cosmic Ray Transport](https://arxiv.org/abs/2604.11898)
*Naixin Liang,S. Peng Oh*

Main category: astro-ph.HE

TL;DR: The paper proposes a new framework for modeling cosmic ray transport that accounts for varying diffusion processes and memory effects, improving understanding of particle distributions in complex media.


<details>
  <summary>Details</summary>
Motivation: Current models using a single diffusion coefficient fail to capture the diverse transport processes of cosmic rays in structured and time-varying environments, leading to inaccurate predictions of particle distributions.

Method: The authors develop a propagator-based framework focusing on the probability distribution of particle positions, using Fourier-Laplace transforms and the Montroll-Weiss formalism to capture memory effects and analyze transport mechanisms.

Result: The study reveals that transport in multiphase media can vary significantly, showing that slow regions can influence cosmic ray escape without dominating overall residence times. An accelerated Monte Carlo method is also introduced for better analysis of the transport process.

Conclusion: This new framework lays the groundwork for enhanced observational studies and modeling in cosmic ray transport, promising more accurate representations of particle behavior and improved applications in related astrophysical processes.
...
### [11] [Hybrid Simulations of Supersonic Shear Flows: II) Cosmic Ray Viscosity](https://arxiv.org/abs/2604.11901)
*Naixin Liang,Damiano Caprioli*

Main category: astro-ph.HE

TL;DR: This paper explores the dynamic influences of nonthermal particles in shear flows prone to the Kelvin-Helmholtz instability, using 2D hybrid simulations.


<details>
  <summary>Details</summary>
Motivation: To characterize the impact of nonthermal particles (cosmic rays) on shear layer dynamics and momentum exchange.

Method: Employs 2D hybrid simulations with Kolmogorov-type velocity shear flows, analyzing the role of cosmic rays and their gyroradii on momentum transfer and shear dissipation rates.

Result: CRs enhance momentum transfer between shear layers, even at low energy densities, contingent on their gyroradii being smaller than the shear lengthscale.

Conclusion: The presence of nonthermal particles significantly influences the energy partitioning and shear dissipation in turbulent flows.
...
### [12] [Relativistic Effects on Circumbinary Orbit Stability](https://arxiv.org/abs/2604.11982)
*Gonzalo C. de Elía,Macarena Zanardi,Rebecca G. Martin*

Main category: astro-ph.HE

TL;DR: This study uses n-body simulations and analytic methods to explore the dynamics and stability of misaligned test particles around binary systems, highlighting general relativity's role in particle instability.


<details>
  <summary>Details</summary>
Motivation: To understand the effects of general relativity on the dynamics and stability of test particles in binary systems, especially regarding their implications for circumbinary configurations.

Method: Employing n-body simulations and analytic approximations, the study examines the motion of test particles in relation to varied binary mass fractions and eccentricities.

Result: Instability of particles is observed up to a semimajor axis of about 8 times that of the binary's, with three identified instability regions influenced by general relativity in the phase plane of semimajor axis and inclination.

Conclusion: The findings hold significance for circumbinary orbits and disks, particularly in supermassive black hole binaries where GR effects are pronounced.
...
### [13] [Mapping the emission and spectral properties of the FRI radio galaxy 3C 449 with LOFAR and the VLA](https://arxiv.org/abs/2604.12043)
*Luca Ricci,Luisa Ostorero,Raffaella Morganti,Judith H. Croston,Martin J. Hardcastle,Timothy W. Shimwell*

Main category: astro-ph.HE

TL;DR: This study analyzes the spectral and dynamical evolution of the radio-emitting plasma in the nearby FRI radio galaxy 3C 449 using high-resolution radio continuum data from LOFAR and VLA.


<details>
  <summary>Details</summary>
Motivation: To investigate the spectral and dynamical properties of radio-emitting plasma in active galactic nuclei, particularly focusing on the nearby FRI radio galaxy 3C 449.

Method: Combining LOFAR radio data at 145 MHz with archival VLA data across multiple frequencies (1365-8485 MHz) to create high-resolution maps and spectral index distributions.

Result: The spectrum is a single power law for the inner ~50", steepening beyond that, indicating no significant downstream particle acceleration, with estimated spectral ages of ~150 Myr in the outer regions, suggesting supersonic expansion of the jets.

Conclusion: High Mach numbers derived from spectral ages may indicate short periods of supersonic expansion or underestimation of spectral ages due to distant particle acceleration.
...
### [14] [Disk instability model incorporating a variable inner disk radius in SS Cyg and U Gem](https://arxiv.org/abs/2604.12085)
*Mariko Kimura,Osaki Yoji*

Main category: astro-ph.HE

TL;DR: This study incorporates a disk evaporation model into existing numerical simulations to analyze dwarf novae, revealing insights into their outburst mechanisms and luminosity profiles across multiple wavelengths.


<details>
  <summary>Details</summary>
Motivation: To better understand the mechanisms behind dwarf nova outbursts and the role of disk evaporation in altering the observed luminosity and dynamics.

Method: A numerical model incorporating inner disk evaporation was applied to two dwarf novae, SS Cyg and U Gem, to simulate their accretion flows and calculate their optical, UV, and X-ray luminosities.

Result: The study found that evaporation suppresses outbursts, leading to a significant time delay in UV luminosity relative to optical brightness; discrepancies in accretion rates suggest a need for enhanced evaporation or additional mass supply in SS Cyg.

Conclusion: The findings provide a refined disk instability model for dwarf novae that aligns with observed multiwavelength light curves and highlights differences between the two studied systems.
...
### [15] [Accretion-Mode Transition: The Driver Behind Spectral Changes in Changing-Look AGNs](https://arxiv.org/abs/2604.12427)
*Pengyuan Han,Huaiyuan Lu,Bing Lyu,Jiancheng Wu,Qingwen Wu*

Main category: astro-ph.HE

TL;DR: This study investigates the physical origins of changing-look AGNs (CLAGNs) by analyzing a sample of 224 CLAGNs, focusing on the correlation between luminosities at different wavelengths and the implications of disk truncation in relation to black-hole accretion rates.


<details>
  <summary>Details</summary>
Motivation: To understand the mechanisms behind the appearance and disappearance of broad emission lines in changing-look AGNs, particularly regarding black-hole accretion rates.

Method: The research analyzes UV-to-optical continua from a sample of 224 CLAGNs, examining the luminosity correlation between $L_{3000}$ and $L_{5100}$ across different luminosity ranges.

Result: The study finds a steeper luminosity correlation at low luminosities, indicating that these AGNs are more consistent with truncated disk predictions compared to high luminous sources, which align with standard accretion disk models.

Conclusion: The observed changes in the UV-to-optical continuum and the associated weakening or disappearance of broad lines are driven by variations in the truncation radius of the accretion disk, impacting the ionization photon deficit and leading to the changing-look phenomenon.
...
### [16] [Acoustic instability at shock-wave precursors](https://arxiv.org/abs/2604.12514)
*Antonio Capanema,Pasquale Blasi,Emanuele Sobacchi*

Main category: astro-ph.HE

TL;DR: This study explores magnetic field amplification in non-relativistic shocks, crucial for particle acceleration in supernova remnants, using advanced magnetohydrodynamical simulations to investigate acoustic instability and its effects on turbulence and cosmic-ray dynamics.


<details>
  <summary>Details</summary>
Motivation: The research aims to understand how magnetic field amplification aids particle acceleration in cosmic events, particularly in supernova remnants thought to be significant sources of Galactic cosmic rays.

Method: The study employs the PLUTO code for 2D and some 3D magnetohydrodynamical simulations to analyze the behavior of small density perturbations amid a cosmic-ray pressure gradient and incorporates realistic parameters for Mach number and cosmic-ray acceleration efficiency.

Result: The findings indicate that the acoustic instability can convert small density perturbations into large nonlinear structures in the precursor region of cosmic-ray-modified shocks, and the power spectrum of turbulent magnetic fluctuations may enhance particle scattering.

Conclusion: Limitations of previous simulations are highlighted, and the research points to future investigations to further explore the critical spatial scales where turbulence transitions to a nonlinear state.
...
### [17] [POLARIS: A Sparse Radial Neutrino Telescope Design for the Pacific Ocean](https://arxiv.org/abs/2604.12521)
*Karolin Hymon,Alexander Chen,Meng-Xue,Tsai,Wan-Ting Hseu,Tzu-Hsuan,Su,Anatoli Fedynitch*

Main category: astro-ph.HE

TL;DR: POLARIS is a specialized neutrino detector optimized for horizontal muon tracks, providing cost-effective sensitivity at ultra-high energies while overcoming traditional detector limitations.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of observing high-energy neutrinos in a constrained observable sky due to Earth's opacity above ~100 TeV, which complicates general-purpose detector architectures.

Method: The POLARIS design uses a sparse planar deep-water Cherenkov array with a radial configuration to maximize sensitivity to horizontal muon tracks and suppress atmospheric background, utilizing only 1100 optical modules.

Result: POLARIS achieves competitive point source and diffuse flux sensitivities at PeV energies, providing unique coverage of muon flavor channels, complementing existing tau-optimized experiments.

Conclusion: This study highlights that specialized, targeted detector geometries like POLARIS can significantly expand the high-energy astrophysical discovery space at reduced costs compared to conventional general-purpose arrays.
...
### [18] [Gravitational Gertsenshtein-Zeldovich mechanism for the Association between GW190425 and FRB 20190425A](https://arxiv.org/abs/2604.12775)
*Shao-Qin Wu,Jing-Rui Zhang,Rong-Gen Cai,Bing Zhang,Yun-Long Zhang*

Main category: astro-ph.HE

TL;DR: This study proposes a novel mechanism connecting GW190425 and FRB 20190425A, whereby a magnetar converts gravitational waves into electromagnetic radiation, leading to fast radio bursts.


<details>
  <summary>Details</summary>
Motivation: The potential link between the gravitational wave event GW190425 and the fast radio burst FRB 20190425A prompts investigation into their physical connection, particularly due to inconsistencies in existing models.

Method: The authors propose that a magnetar, located 2.5 light hours from the neutron star merger, converts gravitational waves into electromagnetic radiation through the Gertsenshtein-Zeldovich effect, followed by inverse Compton scattering from relativistic particles to produce the FRB emission.

Result: Calculations show that with suitable parameters, the characteristics of FRB 20190425A can be accurately replicated using the proposed mechanism.

Conclusion: The study presents a feasible mechanism to explain the association between the gravitational wave event and the fast radio burst, advancing our understanding of their potential relationship.
...
### [19] [The spectrum of the persistent radio source associated with FRB 20190417A](https://arxiv.org/abs/2604.12791)
*L. Bruno,D. Pelliciari,G. Bernardi,M. Pilia,L. Beduzzi,P. Esposito*

Main category: astro-ph.HE

TL;DR: This paper investigates the spectrum of a persistent radio source (PRS) associated with FRB 20190417A, revealing insights into its properties, suggesting its link to a young magnetar.


<details>
  <summary>Details</summary>
Motivation: Understanding the nature of persistent radio sources (PRSs) associated with repeating fast radio bursts (FRBs) enhances knowledge of their environments and potential progenitors.

Method: Spectral analysis of the confirmed PRS using observations at multiple frequencies (1.26 GHz uGMRT and 6 GHz VLA) and archival data, modeling it with a broken power law.

Result: The spectrum shows a power-law behavior at gigahertz frequencies with a spectral index of 0.20 ± 0.05 and a lower limit on the turn-over frequency of > 370 MHz, indicating properties consistent with magneto-ionic nebulae from a young magnetar.

Conclusion: The findings suggest an estimated age of < 250 years and a radius of < 0.4 pc for the PRS, positioning it as somewhat older than related PRSs linked to other FRBs.
...
### [20] [The role of accretion efficiency, natal kicks, and angular momentum transport in the formation of the Gaia black holes](https://arxiv.org/abs/2604.12839)
...
TL;DR: The study explores the formation of dormant black holes with low-mass stellar companions, analyzing various parameters affecting their characteristics and comparing results with observed Gaia black holes.


<details>
  <summary>Details</summary>
Motivation: To understand the uncertain formation pathways of dormant black holes detected by Gaia, contributing to the astrophysical knowledge of black hole systems.

Method: A large parametric study using the population-synthesis code SEVN, examining factors such as accretion efficiency, mass transfer stability, and natal kicks to model the formation of Gaia BHs.

Result: Models suggest that non-conservative mass transfer and angular momentum loss enhance the formation probability of dormant systems matching observed Gaia BH properties, while low natal kicks lead to different orbital characteristics.

Conclusion: The findings advocate for models with stable, non-conservative mass transfer and larger natal kicks, while highlighting the need for testing with upcoming Gaia data releases.
...
### [21] [High-energy Processes in the Bubbles of Wolf-Rayet Stars: The case of WR 102](https://arxiv.org/abs/2604.12993)
*L. Espinosa,M. V. del Valle*

Main category: astro-ph.HE

TL;DR: This study presents a high-energy model for the bubble formed by WR 102, analyzing the emission of cosmic rays and predicting gamma-ray outputs based on relativistic particles.


<details>
  <summary>Details</summary>
Motivation: To understand the role of massive stars in cosmic ray acceleration and their interaction with the interstellar medium.

Method: A classical model for the stellar bubble was employed, using a one-zone approach to calculate radiation from relativistic particles and estimating emission from diffusing protons.

Result: Fitted observations indicate that 3% of wind kinetic energy contributes to relativistic electrons, with a magnetic field of 250 μG; however, predicted gamma-ray flux remains undetectable.

Conclusion: While protons may reach high energies in the bubble, their gamma-ray emissions are too low for detection.
...
### [22] [Cross-Domain Transfer with Particle Physics Foundation Models: From Jets to Neutrino Interactions](https://arxiv.org/abs/2604.12364)
*Gregor Krzmanc,Vinicius Mikuni,Benjamin Nachman,Callum Wilkinson*

Main category: hep-ex

TL;DR: The study explores the use of a pre-trained AI model in particle physics, demonstrating its effectiveness across varied experimental setups.


<details>
  <summary>Details</summary>
Motivation: To enhance AI applications in particle physics by utilizing a foundation model for improved training and sensitivity.

Method: Investigated the transferability of the OmniLearned model pre-trained on high-energy collisions to a low-energy fixed-target neutrino experiment, specifically MINERvA.

Result: The pre-trained models outperformed models trained from scratch, showing superior performance in energy regression and event classification tasks.

Conclusion: The findings indicate that foundation models can generalize across different energy scales and technologies, promoting detector-agnostic approaches in particle physics.
...
### [23] [Observation of the Exotic State $π_{1}(1600)$ in $ψ(2S)\rightarrowγχ_{c1},χ_{c1}\rightarrowπ^{+}π^{-}η'$](https://arxiv.org/abs/2604.12524)
...
TL;DR: A new isovector state $π_{1}(1600)$ has been discovered in charmonium decay with significant statistical evidence, revealing its mass and width. The product of branching fractions for its decay is also reported.


<details>
  <summary>Details</summary>
Motivation: To explore the decay process of $ψ(2S)$ and enhance understanding of exotic quantum states in charmonium.

Method: Partial wave analysis using over 2712 million $ψ(2S)$ events from the BESIII detector, applying a relativistic Breit-Wigner function for mass width determination.

Result: Observation of the exotic state $π_{1}(1600)$ with mass $1828 	ext{ MeV}/c^2$, width $638 	ext{ MeV}$, and a statistical significance of over $21σ$.

Conclusion: The findings provide crucial insights into exotic states in charmonium and their decay mechanisms, enriching our understanding of quantum chromodynamics.
...
### [24] [Precision measurement of the muon charge asymmetry from $W$-boson decays in $pp$ collisions at $\sqrt{s}$ = 13 TeV in the forward region](https://arxiv.org/abs/2604.12593)
...
TL;DR: This paper presents a precise measurement of muon charge asymmetry from W-boson decays in proton-proton collisions at LHCb, with results showing strong agreement with theoretical predictions.


<details>
  <summary>Details</summary>
Motivation: To improve the precision of muon charge asymmetry measurements in high-energy physics, enhancing the understanding of W-boson interactions and QCD predictions.

Method: Analysis conducted on data from LHCb detector, utilizing an integrated luminosity of 5.1 fb^-1, focusing on muons with specified transverse momentum and pseudorapidity ranges.

Result: The measurement of muon charge asymmetry in the forward region shows excellent agreement with next-to-next-to-leading-order QCD predictions.

Conclusion: This study achieves the most precise determination of the muon charge asymmetry to date, reinforcing theoretical models in particle physics.
...
### [25] [New measurement of $K^+\toπ^+ν\barν$ branching ratio at the NA62 experiment](https://arxiv.org/abs/2604.12649)
*Xiafei Chang*

Main category: hep-ex

TL;DR: The NA62 experiment measures the ultra-rare decay $K^+\to\pi^+ν\barν$, reporting a branching ratio of $(9.6^{+1.9}_{-1.8})\times10^{-11}$, which aligns with Standard Model predictions.


<details>
  <summary>Details</summary>
Motivation: To explore new physics through the measurement of the ultra-rare decay $K^+\to\pi^+ν\barν$, which is sensitive to high mass scale new physics.

Method: Utilizing data from the NA62 experiment at CERN SPS collected between 2016 and 2024, the analysis combined old and new datasets, doubling the signal and proportionately reducing the background to measure the branching ratio.

Result: The branching ratio measured is $	ext{B}(K^+\to\pi^+ν\barν) = (9.6^{+1.9}_{-1.8})\times10^{-11}$, consistent with Standard Model predictions with a precision of better than 20%.

Conclusion: The measurement supports the Standard Model and shows the experiment's capability in probing rare decays.
...
### [26] [Measurement of the $W$-boson production cross-sections in $pp$ collisions at $\sqrt{s}$ = 13 TeV in the forward region](https://arxiv.org/abs/2604.12706)
*LHCb collaboration,R. Aaij,M. Abdelfatah,A. S. W. Abdelmotteleb,C. Abellan Beteta,F. Abudinén,T. Ackernley,A. A. Adefisoye,B. Adeva,M. Adinolfi,P. Adlarson,C. Agapopoulou,C. A. Aidala,Z. Ajaltouni,S. Akar,K. Akiba,P. Albicocco,J. Albrecht,R. Aleksiejunas,F. Alessio,P. Alvarez Cartelle,R. Amalric,S. Amato,J. L. Amey,Y. Amhis,L. An,L. Anderlini,M. Andersson,P. Andreola,M. Andreotti,S. Andres Estrada,A. Anelli,D. Ao,C. Arata,F. Archilli,Z. Areg,M. Argenton,S. Arguedas Cuendis,L. Arnone,M. Artuso,E. Aslanides,R. Ataíde Da Silva,M. Atzeni,B. Audurier,J. A. Authier,D. Bacher,I. Bachiller Perea,S. Bachmann,M. Bachmayer,J. J. Back,Z. B. Bai,P. Baladron Rodriguez,V. Balagura,A. Balboni,W. Baldini,Z. Baldwin,L. Balzani,H. Bao,J. Baptista de Souza Leite,C. Barbero Pretel,M. Barbetti,I. R. Barbosa,R. J. Barlow,M. Barnyakov,S. Barsuk,W. Barter,J. Bartz,S. Bashir,B. Batsukh,P. B. Battista,A. Bavarchee,A. Bay,A. Beck,M. Becker,F. Bedeschi,I. B. Bediaga,N. A. Behling,S. Belin,A. Bellavista,I. Belov,I. Belyaev,G. Benane,G. Bencivenni,E. Ben-Haim,R. Bernet,A. Bertolin,F. Betti,J. Bex,O. Bezshyyko,S. Bhattacharya,M. S. Bieker,N. V. Biesuz,A. Biolchini,M. Birch,F. C. R. Bishop,A. Bitadze,A. Bizzeti,T. Blake,F. Blanc,J. E. Blank,S. Blusk,J. A. Boelhauve,O. Boente Garcia,T. Boettcher,A. Bohare,C. Bolognani,R. Bolzonella,R. B. Bonacci,A. Bordelius,F. Borgato,S. Borghi,M. Borsato,J. T. Borsuk,E. Bottalico,S. A. Bouchiba,M. Bovill,T. J. V. Bowcock,A. Boyer,C. Bozzi,J. D. Brandenburg,A. Brea Rodriguez,N. Breer,C. Breitfeld,J. Brodzicka,J. Brown,D. Brundu,E. Buchanan,M. Burgos Marcos,C. Burr,C. Buti,J. S. Butter,J. Buytaert,W. Byczynski,S. Cadeddu,H. Cai,Y. Cai,A. Caillet,R. Calabrese,L. Calefice,M. Calvi,M. Calvo Gomez,P. Camargo Magalhaes,J. I. Cambon Bouzas,P. Campana,A. C. Campos,A. F. Campoverde Quezada,Y. Cao,S. Capelli,M. Caporale,L. Capriotti,R. Caravaca-Mora,A. Carbone,L. Carcedo Salgado,R. Cardinale,A. Cardini,P. Carniti,L. Carus,A. Casais Vidal,R. Caspary,G. Casse,M. Cattaneo,G. Cavallero,V. Cavallini,S. Celani,I. Celestino,S. Cesare,A. J. Chadwick,I. Chahrour,M. Charles,Ph. Charpentier,E. Chatzianagnostou,R. Cheaib,M. Chefdeville,C. Chen,J. Chen,S. Chen,Z. Chen,A. Chen Hu,M. Cherif,A. Chernov,S. Chernyshenko,X. Chiotopoulos,G. Chizhik,V. Chobanova,M. Chrzaszcz,V. Chulikov,P. Ciambrone,X. Cid Vidal,G. Ciezarek,P. Cifra,P. E. L. Clarke,M. Clemencic,H. V. Cliff,J. Closier,C. Cocha Toapaxi,V. Coco,J. Cogan,E. Cogneras,L. Cojocariu,S. Collaviti,P. Collins,T. Colombo,M. Colonna,A. Comerma-Montells,L. Congedo,J. Connaughton,A. Contu,N. Cooke,G. Cordova,C. Coronel,I. Corredoira,A. Correia,G. Corti,G. C. Costantino,J. Cottee Meldrum,B. Couturier,D. C. Craik,N. Crepet,M. Cruz Torres,M. Cubero Campos,E. Curras Rivera,R. Currie,C. L. Da Silva,X. Dai,E. Dall'Occo,J. Dalseno,C. D'Ambrosio,J. Daniel,G. Darze,A. Davidson,J. E. Davies,O. De Aguiar Francisco,C. De Angelis,F. De Benedetti,J. de Boer,K. De Bruyn,S. De Capua,M. De Cian,U. De Freitas Carneiro Da Graca,E. De Lucia,J. M. De Miranda,L. De Paula,M. De Serio,P. De Simone,F. De Vellis,J. A. de Vries,F. Debernardis,D. Decamp,S. Dekkers,L. Del Buono,B. Delaney,J. Deng,V. Denysenko,O. Deschamps,F. Dettori,B. Dey,P. Di Nezza,S. Ding,Y. Ding,L. Dittmann,A. D. Docheva,A. Doheny,C. Dong,F. Dordei,A. C. dos Reis,A. D. Dowling,L. Dreyfus,W. Duan,P. Duda,L. Dufour,V. Duk,P. Durante,M. M. Duras,J. M. Durham,O. D. Durmus,A. Dziurda,S. Easo,E. Eckstein,U. Egede,S. Eisenhardt,E. Ejopu,L. Eklund,M. Elashri,D. Elizondo Blanco,J. Ellbracht,S. Ely,A. Ene,J. Eschle,T. Evans,F. Fabiano,S. Faghih,L. N. Falcao,B. Fang,R. Fantechi,L. Fantini,M. Faria,K. Farmer,F. Fassin,D. Fazzini,L. Felkowski,C. Feng,M. Feng,A. Fernandez Casani,M. Fernandez Gomez,A. D. Fernez,F. Ferrari,F. Ferreira Rodrigues,M. Ferrillo,M. Ferro-Luzzi,R. A. Fini,M. Fiorini,M. Firlej,K. L. Fischer,D. S. Fitzgerald,C. Fitzpatrick,T. Fiutowski,F. Fleuret,A. Fomin,M. Fontana,L. A. Foreman,R. Forty,D. Foulds-Holt,V. Franco Lima,M. Franco Sevilla,M. Frank,E. Franzoso,G. Frau,C. Frei,D. A. Friday,J. Fu,Q. Führing,T. Fulghesu,G. Galati,M. D. Galati,A. Gallas Torreira,D. Galli,S. Gambetta,M. Gandelman,P. Gandini,B. Ganie,H. Gao,R. Gao,T. Q. Gao,Y. Gao,Y. Gao,Y. Gao,L. M. Garcia Martin,P. Garcia Moreno,J. García Pardiñas,P. Gardner,L. Garrido,C. Gaspar,A. Gavrikov,L. L. Gerken,E. Gersabeck,M. Gersabeck,T. Gershon,S. Ghizzo,Z. Ghorbanimoghaddam,F. I. Giasemis,V. Gibson,H. K. Giemza,A. L. Gilman,M. Giovannetti,A. Gioventù,L. Girardey,M. A. Giza,F. C. Glaser,V. V. Gligorov,C. Göbel,L. Golinka-Bezshyyko,E. Golobardes,A. Golutvin,S. Gomez Fernandez,W. Gomulka,F. Goncalves Abrantes,I. Gonçales Vaz,M. Goncerz,G. Gong,J. A. Gooding,C. Gotti,E. Govorkova,J. P. Grabowski,L. A. Granado Cardoso,E. Graugés,E. Graverini,L. Grazette,G. Graziani,A. T. Grecu,N. A. Grieser,L. Grillo,C. Gu,M. Guarise,L. Guerry,A. -K. Guseinov,Y. Guz,T. Gys,K. Habermann,T. Hadavizadeh,C. Hadjivasiliou,G. Haefeli,C. Haen,S. Haken,G. Hallett,P. M. Hamilton,Q. Han,X. Han,S. Hansmann-Menzemer,N. Harnew,T. J. Harris,M. Hartmann,S. Hashmi,J. He,N. Heatley,A. Hedes,F. Hemmer,C. Henderson,R. Henderson,R. D. L. Henderson,A. M. Hennequin,K. Hennessy,J. Herd,P. Herrero Gascon,J. Heuel,A. Heyn,A. Hicheur,G. Hijano Mendizabal,J. Horswill,R. Hou,Y. Hou,D. C. Houston,N. Howarth,W. Hu,X. Hu,W. Hulsbergen,R. J. Hunter,D. Hutchcroft,M. Idzik,P. Ilten,A. Iohner,H. Jage,S. J. Jaimes Elles,S. Jakobsen,T. Jakoubek,E. Jans,A. Jawahery,C. Jayaweera,A. Jelavic,V. Jevtic,Z. Jia,E. Jiang,X. Jiang,Y. Jiang,Y. J. Jiang,E. Jimenez Moya,N. Jindal,M. John,A. John Rubesh Rajan,D. Johnson,C. R. Jones,S. Joshi,B. Jost,J. Juan Castella,N. Jurik,I. Juszczak,K. Kalecinska,D. Kaminaris,S. Kandybei,M. Kane,Y. Kang,C. Kar,M. Karacson,A. Kauniskangas,J. W. Kautz,M. K. Kazanecki,F. Keizer,M. Kenzie,T. Ketel,B. Khanji,S. Kholodenko,G. Khreich,F. Kiraz,T. Kirn,V. S. Kirsebom,S. Klaver,N. Kleijne,A. Kleimenova,D. K. Klekots,K. Klimaszewski,M. R. Kmiec,T. Knospe,R. Kolb,S. Koliiev,L. Kolk,A. Konoplyannikov,P. Kopciewicz,P. Koppenburg,A. Korchin,I. Kostiuk,O. Kot,S. Kotriakhova,E. Kowalczyk,O. Kravcov,M. Kreps,W. Krupa,W. Krzemien,O. Kshyvanskyi,S. Kubis,M. Kucharczyk,A. Kupsc,V. Kushnir,B. Kutsenko,J. Kvapil,I. Kyryllin,D. Lacarrere,P. Laguarta Gonzalez,A. Lai,A. Lampis,D. Lancierini,C. Landesa Gomez,J. J. Lane,G. Lanfranchi,C. Langenbruch,J. Langer,T. Latham,F. Lazzari,C. Lazzeroni,R. Le Gac,H. Lee,R. Lefèvre,M. Lehuraux,E. Lemos Cid,O. Leroy,T. Lesiak,E. D. Lesser,B. Leverington,A. Li,C. Li,C. Li,H. Li,J. Li,K. Li,L. Li,P. Li,P. -R. Li,Q. Li,T. Li,T. Li,Y. Li,Y. Li,Y. Li,Z. Lian,Q. Liang,X. Liang,Z. Liang,S. Libralon,A. Lightbody,C. Lin,T. Lin,R. Lindner,H. Linton,R. Litvinov,D. Liu,F. L. Liu,G. Liu,K. Liu,S. Liu,W. Liu,Y. Liu,Y. Liu,Y. L. Liu,G. Loachamin Ordonez,I. Lobo,A. Lobo Salvia,A. Loi,T. Long,F. C. L. Lopes,J. H. Lopes,A. Lopez Huertas,C. Lopez Iribarnegaray,Q. Lu,C. Lucarelli,D. Lucchesi,M. Lucio Martinez,Y. Luo,A. Lupato,M. Lupberger,E. Luppi,K. Lynch,S. Lyu,X. -R. Lyu,H. Ma,S. Maccolini,F. Machefert,F. Maciuc,B. Mack,I. Mackay,L. M. Mackey,L. R. Madhan Mohan,M. J. Madurai,D. Magdalinski,J. J. Malczewski,S. Malde,L. Malentacca,G. Manca,G. Mancinelli,C. Mancuso,R. Manera Escalero,A. Mangalasseri,F. M. Manganella,D. Manuzzi,S. Mao,D. Marangotto,J. F. Marchand,R. Marchevski,U. Marconi,E. Mariani,S. Mariani,C. Marin Benito,J. Marks,A. M. Marshall,L. Martel,G. Martelli,G. Martellotti,L. Martinazzoli,M. Martinelli,D. Martinez Gomez,D. Martinez Santos,F. Martinez Vidal,A. Martorell i Granollers,A. Massafferri,R. Matev,A. Mathad,C. Matteuzzi,K. R. Mattioli,A. Mauri,E. Maurice,J. Mauricio,P. Mayencourt,J. Mazorra de Cos,M. Mazurek,D. Mazzanti Tarancon,M. McCann,N. T. McHugh,A. McNab,R. McNulty,B. Meadows,D. Melnychuk,D. Mendoza Granada,P. Menendez Valdes Perez,F. M. Meng,M. Merk,A. Merli,L. Meyer Garcia,D. Miao,H. Miao,M. Mikhasenko,D. A. Milanes,A. Minotti,E. Minucci,B. Mitreska,D. S. Mitzel,R. Mocanu,A. Modak,L. Moeser,R. D. Moise,E. F. Molina Cardenas,T. Mombächer,M. Monk,T. Monnard,S. Monteil,A. Morcillo Gomez,G. Morello,M. J. Morello,M. P. Morgenthaler,A. Moro,J. Moron,W. Morren,A. B. Morris,A. G. Morris,R. Mountain,Z. Mu,E. Muhammad,F. Muheim,M. Mulder,K. Müller,F. Muñoz-Rojas,V. Mytrochenko,P. Naik,T. Nakada,R. Nandakumar,G. Napoletano,I. Nasteva,M. Needham,N. Neri,S. Neubert,N. Neufeld,J. Nicolini,D. Nicotra,E. M. Niel,L. Nisi,Q. Niu,B. K. Njoki,P. Nogarolli,P. Nogga,C. Normand,J. Novoa Fernandez,G. Nowak,C. Nunez,H. N. Nur,A. Oblakowska-Mucha,T. Oeser,O. Okhrimenko,R. Oldeman,F. Oliva,E. Olivart Pino,M. Olocco,R. H. O'Neil,J. S. Ordonez Soto,D. Osthues,J. M. Otalora Goicochea,P. Owen,A. Oyanguren,O. Ozcelik,F. Paciolla,A. Padee,K. O. Padeken,B. Pagare,T. Pajero,A. Palano,L. Palini,M. Palutan,C. Pan,X. Pan,S. Panebianco,S. Paniskaki,L. Paolucci,A. Papanestis,M. Pappagallo,L. L. Pappalardo,C. Pappenheimer,C. Parkes,D. Parmar,G. Passaleva,D. Passaro,A. Pastore,M. Patel,J. Patoc,C. Patrignani,A. Paul,C. J. Pawley,A. Pellegrino,J. Peng,X. Peng,M. Pepe Altarelli,S. Perazzini,H. Pereira Da Costa,M. Pereira Martinez,A. Pereiro Castro,C. Perez,P. Perret,A. Perrevoort,A. Perro,M. J. Peters,K. Petridis,A. Petrolini,S. Pezzulo,J. P. Pfaller,H. Pham,L. Pica,M. Piccini,L. Piccolo,B. Pietrzyk,R. N. Pilato,D. Pinci,F. Pisani,M. Pizzichemi,V. M. Placinta,M. Plo Casasus,T. Poeschl,F. Polci,M. Poli Lener,A. Poluektov,I. Polyakov,E. Polycarpo,S. Ponce,D. Popov,K. Popp,K. Prasanth,C. Prouve,D. Provenzano,V. Pugatch,A. Puicercus Gomez,G. Punzi,J. R. Pybus,Q. Qian,W. Qian,N. Qin,R. Quagliani,R. I. Rabadan Trejo,R. Racz,J. H. Rademacker,M. Rama,M. Ramírez García,V. Ramos De Oliveira,M. Ramos Pernas,M. S. Rangel,G. Raven,M. Rebollo De Miguel,F. Redi,J. Reich,F. Reiss,Z. Ren,P. K. Resmi,M. Ribalda Galvez,R. Ribatti,G. Ricart,D. Riccardi,S. Ricciardi,K. Richardson,M. Richardson-Slipper,F. Riehn,K. Rinnert,P. Robbe,G. Robertson,E. Rodrigues,A. Rodriguez Alvarez,E. Rodriguez Fernandez,J. A. Rodriguez Lopez,E. Rodriguez Rodriguez,J. Roensch,A. Rogovskiy,D. L. Rolf,P. Roloff,V. Romanovskiy,A. Romero Vidal,G. Romolini,F. Ronchetti,T. Rong,M. Rotondo,M. S. Rudolph,M. Ruiz Diaz,R. A. Ruiz Fernandez,J. Ruiz Vidal,J. J. Saavedra-Arias,J. J. Saborido Silva,S. E. R. Sacha Emile R.,D. Sahoo,N. Sahoo,B. Saitta,M. Salomoni,I. Sanderswood,R. Santacesaria,C. Santamarina Rios,M. Santimaria,L. Santoro,E. Santovetti,A. Saputi,A. Sarnatskiy,G. Sarpis,M. Sarpis,C. Satriano,A. Satta,M. Saur,H. Sazak,F. Sborzacchi,A. Scarabotto,S. Schael,S. Scherl,M. Schiller,H. Schindler,M. Schmelling,B. Schmidt,N. Schmidt,S. Schmitt,H. Schmitz,O. Schneider,A. Schopper,N. Schulte,M. H. Schune,G. Schwering,B. Sciascia,A. Sciuccati,G. Scriven,I. Segal,S. Sellam,T. Senger,M. Senghi Soares,A. Sergi,N. Serra,L. Sestini,B. Sevilla Sanjuan,Y. Shang,D. M. Shangase,R. S. Sharma,L. Shchutska,T. Shears,J. Shen,Z. Shen,S. Sheng,B. Shi,J. Shi,Q. Shi,W. S. Shi,E. Shmanin,R. Silva Coutinho,G. Simi,S. Simone,M. Singha,I. Siral,N. Skidmore,T. Skwarnicki,M. W. Slater,E. Smith,M. Smith,L. Soares Lavra,M. D. Sokoloff,F. J. P. Soler,A. Solomin,K. Solovieva,N. S. Sommerfeld,R. Song,Y. Song,Y. Song,Y. S. Song,F. L. Souza De Almeida,B. Souza De Paula,K. M. Sowa,E. Spadaro Norella,E. Spedicato,J. G. Speer,P. Spradlin,F. Stagni,M. Stahl,S. Stahl,S. Stanislaus,M. Stefaniak,O. Steinkamp,Y. Su,F. Suljik,J. Sun,J. Sun,L. Sun,D. Sundfeld,W. Sutcliffe,P. Svihra,V. Svintozelskyi,K. Swientek,F. Swystun,A. Szabelski,T. Szumlak,Y. Tan,Y. Tang,Y. T. Tang,M. D. Tat,J. A. Teijeiro Jimenez,F. Terzuoli,F. Teubert,E. Thomas,D. J. D. Thompson,A. R. Thomson-Strong,H. Tilquin,V. Tisserand,S. T'Jampens,M. Tobin,T. T. Todorov,L. Tomassetti,G. Tonani,X. Tong,T. Tork,L. Toscano,D. Y. Tou,C. Trippl,G. Tuci,N. Tuning,L. H. Uecker,A. Ukleja,D. J. Unverzagt,A. Upadhyay,B. Urbach,A. Usachov,U. Uwer,V. Vagnoni,A. Vaitkevicius,V. Valcarce Cadenas,G. Valenti,N. Valls Canudas,J. van Eldik,H. Van Hecke,E. van Herwijnen,C. B. Van Hulse,R. Van Laak,M. van Veghel,G. Vasquez,R. Vazquez Gomez,P. Vazquez Regueiro,C. Vázquez Sierra,S. Vecchi,J. Velilla Serna,J. J. Velthuis,M. Veltri,A. Venkateswaran,M. Verdoglia,M. Vesterinen,W. Vetens,D. Vico Benet,P. Vidrier Villalba,M. Vieites Diaz,X. Vilasis-Cardona,E. Vilella Figueras,A. Villa,P. Vincent,B. Vivacqua,F. C. Volle,D. vom Bruch,K. Vos,C. Vrahas,J. Wagner,J. Walsh,N. Walter,E. J. Walton,G. Wan,A. Wang,B. Wang,C. Wang,G. Wang,H. Wang,J. Wang,J. Wang,J. Wang,J. Wang,M. Wang,N. W. Wang,R. Wang,X. Wang,X. Wang,X. W. Wang,Y. Wang,Y. Wang,Y. H. Wang,Z. Wang,Z. Wang,J. A. Ward,M. Waterlaat,N. K. Watson,D. Websdale,Y. Wei,Z. Weida,J. Wendel,B. D. C. Westhenry,C. White,M. Whitehead,E. Whiter,A. R. Wiederhold,D. Wiedner,M. A. Wiegertjes,C. Wild,G. Wilkinson,M. K. Wilkinson,M. Williams,M. J. Williams,M. R. J. Williams,R. Williams,S. Williams,Z. Williams,F. F. Wilson,M. Winn,W. Wislicki,M. Witek,L. Witola,T. Wolf,E. Wood,G. Wormser,S. A. Wotton,H. Wu,J. Wu,X. Wu,Y. Wu,Z. Wu,K. Wyllie,S. Xian,Z. Xiang,Y. Xie,T. X. Xing,A. Xu,L. Xu,M. Xu,R. Xu,Z. Xu,Z. Xu,Z. Xu,S. Yadav,K. Yang,X. Yang,Y. Yang,Y. Yang,Z. Yang,Z. Yang,H. Yeung,H. Yin,X. Yin,C. Y. Yu,J. Yu,X. Yuan,Y Yuan,J. A. Zamora Saa,M. Zavertyaev,M. Zdybal,F. Zenesini,C. Zeng,M. Zeng,S. H Zeng,C. Zhang,D. Zhang,J. Zhang,L. Zhang,R. Zhang,S. Zhang,S. L. Zhang,Y. Zhang,Z. Zhang,Y. Zhao,A. Zhelezov,S. Z. Zheng,X. Z. Zheng,Y. Zheng,T. Zhou,X. Zhou,V. Zhovkovska,L. Z. Zhu,X. Zhu,X. Zhu,Y. Zhu,V. Zhukov,J. Zhuo,D. Zuliani,G. Zunica*

Main category: hep-ex

TL;DR: A precision measurement of the $W$-boson production cross-section in the $W 	o μν$ decay channel at LHCb with 5.1 $fb^{-1}$ of data shows improved accuracy, matching theoretical predictions.


<details>
  <summary>Details</summary>
Motivation: To enhance the precision of $W$-boson production cross-section measurements and provide comparative data with theoretical predictions.

Method: Utilized proton-proton collision data at $	ext{√s} = 13 	ext{ TeV}$ for the decay channel $W 	o μν$, focusing on muons with specified momentum and pseudorapidity ranges.

Result: Measured integrated production cross-sections are: $σ_{W^+ 	o μ^+ν} = 1754.2 \\ \, 	ext{pb}$ and $σ_{W^- 	o μ^-arν} = 1178.1 \\ \, 	ext{pb}$ with detailed uncertainty breakdowns.

Conclusion: The measurement's precision surpasses previous results and aligns well with next-to-next-to-leading order theoretical predictions in perturbative quantum chromodynamics.
...
### [27] [After 100 Years of Quantum Mechanics: Toward a Constructive Observation-Centered Perspective](https://arxiv.org/abs/2604.11814)
*Timothy Stroschein,Markus Reiher*

Main category: quant-ph

TL;DR: The paper advocates for a new mathematical program in quantum mechanics focusing on observation-centered analysis, emphasizing the need for effective descriptions of complex systems.


<details>
  <summary>Details</summary>
Motivation: Current quantum mechanics formalism does not align well with finite-dimensional computations and practical limitations, indicating a need for new methodologies.

Method: The authors propose a signal-based spectral equation that reformulates frequency analysis as an operator problem, treating signals as primary objects of analysis.

Result: They demonstrate a relationship between observation time and effective spectral density that is crucial for accurate resolution in quantum systems.

Conclusion: The framework presented incorporates approximation directly into quantum mechanics, suggesting a pathway toward better handling of complex quantum systems in fields like molecular sciences.
...
### [28] [QMC-Net: Data-Aware Quantum Representations for Remote Sensing Image Classification](https://arxiv.org/abs/2604.11817)
*Md Aminur Hossain,Ayush V. Patel,Biplab Banerjee*

Main category: quant-ph

TL;DR: The paper presents QMC-Net, a hybrid quantum-classical model tailored for multi-band remote sensing imagery that utilizes band-specific quantum circuits, achieving significant accuracy improvements over classical baselines.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of generic quantum circuits in processing multi-band remote sensing imagery, particularly the failure to account for channel-specific variability.

Method: A data-driven framework maps band-level statistics to hyperparameters of customized quantum circuits, forming QMC-Net, which processes multiple data channels adaptively.

Result: QMC-Net achieves accuracies of 93.80 % on EuroSAT and 99.34 % on SAT-6 datasets, with a residual-enhanced variant further improving these scores to 94.69 % and 99.39 %, respectively.

Conclusion: The results demonstrate that data-aware quantum circuit design significantly outperforms classical approaches and generic hybrid quantum models, operating effectively under NISQ constraints.
...
### [29] [Perspectivist Account of Truth-Theoretic Semantics in Quantum Mechanics](https://arxiv.org/abs/2604.11823)
*Vassilios Karakostas*

Main category: quant-ph

TL;DR: The paper discusses how to assign truth values in quantum mechanics, arguing for a perspectivist approach that aligns with Tarski's truth theory, addressing context-dependence in a microphysical reality.


<details>
  <summary>Details</summary>
Motivation: To resolve issues with assigning truth values to propositions in quantum systems with dimensions higher than two, as highlighted by no-go results.

Method: The Bub-Clifton uniqueness theorem is applied to restore truth-value definiteness using a sublattice of propositions related to the system's state and a specific observable.

Result: A perspectivist/contextual account of truth valuation is established that meets Tarski's adequacy criterion and reflects context-bound correspondence to objectively existing states of affairs.

Conclusion: This approach highlights the context-dependence of facts in quantum mechanics, challenging the idea of a fixed, objective standpoint in understanding nature.
...
### [30] [Quantum algorithms for Young measures: applications to nonlinear partial differential equations](https://arxiv.org/abs/2604.11825)
*Shi Jin,Nana Liu,Maria Lukacova-Medvidova,Yuhuan Yuan*

Main category: quant-ph

TL;DR: This study explores the use of quantum linear programming to solve nonlinear PDEs with singular solutions, demonstrating advantages in certain contexts.


<details>
  <summary>Details</summary>
Motivation: Nonlinear PDEs often present challenges like singularity and oscillations, necessitating effective solution concepts.

Method: The authors propose using quantum linear programming (QLP) to address optimization problems arising from measure-valued formulations of nonlinear PDEs, particularly in the context of dissipative weak solutions.

Result: QLP algorithms, particularly the quantum central path algorithm, demonstrate a polynomial advantage over classical methods for some problems, while offering no benefit for direct solutions of dissipative weak solutions.

Conclusion: QLP shows significant promise for solving random PDEs with respect to Young measures, suggesting a need for further exploration of quantum methods in this area.
...
### [31] [A skepticism on the concept of quantum state related to quantum field theory on curved spacetime](https://arxiv.org/abs/2604.11830)
*Hideyasu Yamashita*

Main category: quant-ph

TL;DR: The paper critiques the physical reality of quantum states in quantum field theory in curved spacetime, suggesting that distinguishing physical states from fictional ones is problematic due to the lack of a unique physical Hilbert space. It counters arguments for the necessity of quantum states in quantum physics, claiming they are dispensable in non-relativistic quantum mechanics and potentially in other frameworks.


<details>
  <summary>Details</summary>
Motivation: To explore the skepticism surrounding the physicality of quantum states in different quantum frameworks, particularly in quantum field theory in curved spacetime.

Method: Analyzes the role of algebraic quantum field theory in curved spacetime and compares it to non-relativistic quantum mechanics and quantum field theory in Minkowski spacetime.

Result: Demonstrates that in QFTCS, the absence of a distinguished physical Hilbert space makes it challenging to identify physically real states, contradicting the notion of pragmatic realism regarding quantum states' necessity in quantum theories.

Conclusion: Quantifying quantum states may be unnecessary, suggesting that this perspective holds across various quantum frameworks, necessitating a reevaluation of their role in quantum physics.
...
### [32] [Q-LINK: Quantum Layerwise Information Residual Network via a Messenger Qubit for Barren Plateaus Mitigation](https://arxiv.org/abs/2604.11831)
*Zhehao Yi,Rahul Bhadani*

Main category: quant-ph

TL;DR: This paper presents Q-LINK, a novel quantum circuit architecture that improves optimization in variational quantum algorithms by addressing barren plateaus, enhancing gradient variance and convergence speed without compromising expressibility.


<details>
  <summary>Details</summary>
Motivation: To enhance the performance of variational quantum algorithms in NISQ conditions, particularly against the issue of barren plateaus that hinder optimization efficacy.

Method: A residual-inspired quantum circuit architecture, Q-LINK, is introduced, incorporating a single messenger qubit. Numerical simulations on random quantum states are conducted to evaluate its impact on optimization behavior.

Result: Q-LINK increases convergence efficiency by 4-6 times and boosts gradient variance by up to two orders of magnitude compared to the traditional Vanilla model, while maintaining circuit expressibility.

Conclusion: The introduction of a single messenger qubit in the Q-LINK architecture effectively mitigates barren plateaus, facilitating better exploration of the Hilbert space in variational quantum circuits.
...
### [33] [Blind Catalytic Quantum Error Correction: Target-State Estimation and Fidelity Recovery Without \textit{A Priori} Knowledge](https://arxiv.org/abs/2604.11857)
*Hikaru Wakaura*

Main category: quant-ph

TL;DR: Blind CQEC improves quantum error correction through state estimation from noisy outputs, demonstrating high recovery fidelities and insights into noise modeling.


<details>
  <summary>Details</summary>
Motivation: To address the challenge in CQEC requiring complete knowledge of the target state by developing a strategy that estimates the target only from noisy outputs.

Method: Five estimation strategies were benchmarked against various noise models and quantum algorithms, focusing on fidelity metrics for state recovery and identifying limiting factors in estimation.

Result: Coherence maximization achieved high fidelity without noise model knowledge; channel inversion was necessary for larger dimensions; a strong correlation was found between estimation and recovery fidelities; an analytical crossover dimension was identified, and scaling relationships were derived.

Conclusion: Standard linear inversion fails in the context of CQEC, necessitating new strategies that account for decoherence, with a practical demonstration showing significant error reduction in a quantum computation task.
...
### [34] [From Symmetry and Reduction to Physically Meaningful Relational Observables in Many-Body Quantum Theory](https://arxiv.org/abs/2604.11858)
*Ville J. Härkönen*

Main category: quant-ph

TL;DR: This paper presents a unified framework for analyzing symmetries and reduction in non-relativistic many-body quantum mechanics, focusing on identifying physically meaningful observables in molecular and crystalline systems.


<details>
  <summary>Details</summary>
Motivation: To develop a framework that clarifies the observables' dependence on symmetry and relational aspects in non-relativistic quantum systems.

Method: Introduces two postulates: (1) relevant states are stationary and normalizable, and (2) observables must be invariant under a symmetry subgroup and Galilean boosts. A map from all quantum observables to invariant ones is established.

Result: The framework integrates symmetry reduction and relational theory, emphasizing that meaningful observables must depend on multiple non-invariant observables and align with existing literature on quantum descriptions of molecules.

Conclusion: The postulates enhance the understanding of physical observability in quantum mechanics, providing a relational perspective that is consistent with many-body systems' nature.
...
### [35] [Spectral-angular parametrization of open qudit dynamics](https://arxiv.org/abs/2604.11864)
*Jean-Pierre Gazeau,Kaoutar El Bachiri,Zakaria Bouameur,Yassine Hassouni*

Main category: quant-ph

TL;DR: This paper presents a novel parametrization for density matrices in finite-dimensional Hilbert spaces to analyze the dynamics of open quantum systems through GKLS equations. The approach separates spectral parameters and angular variables, allowing for distinct treatments of their time evolution.


<details>
  <summary>Details</summary>
Motivation: The aim is to provide a robust framework for describing the time evolution of mixed states in open quantum systems using a systematic approach to density matrix parametrization.

Method: The authors decompose density matrices into spectral parameters constrained by a convex polytope and angular variables associated with the flag manifold, employing a Lie-algebraic interpretation of spectral parameters as simple root coordinates.

Result: This method facilitates a partial decoupling of the dynamics, where only the dissipative component affects the evolution of spectral parameters, while angular variables respond to both Hamiltonian and dissipative influences. Low-dimensional cases are exemplified, addressing specific applications.

Conclusion: The proposed parametrization enhances understanding of quantum dynamics, suggesting an alternative purity measure based on spectral parameters.
...
### [36] [Eigenstate thermalization](https://arxiv.org/abs/2604.11872)
*Rohit Patil,Marcos Rigol*

Main category: quant-ph

TL;DR: The paper introduces eigenstate thermalization, explaining thermalization in isolated quantum systems. It uses random matrix theory for motivation and explores entropy in random states, supported by numerical results in many-body systems.


<details>
  <summary>Details</summary>
Motivation: Eigenstate thermalization is motivated by random matrix theory, showing its relevance in understanding thermalization in isolated quantum systems.

Method: The paper discusses the phenomenon of eigenstate thermalization, reviewing recent results related to entanglement entropy in Haar-random states and presenting numerical evidence.

Result: Numerical results confirm the expected behaviors of eigenstate thermalization in quantum many-body systems, supporting the theory with observational data.

Conclusion: The findings contribute to a deeper understanding of thermalization in quantum mechanics, reinforcing the significance of eigenstate thermalization and its implications for many-body physics.
...
### [37] [Quantum Mpemba effect in chaotic systems with conservation laws](https://arxiv.org/abs/2604.11876)
*Thomas Martin Müller,Silvia Pappalardi,Rosario Fazio*

Main category: quant-ph

TL;DR: Closed chaotic quantum systems can reach the same Gibbs ensemble from different initial states, leading to unequal relaxation speeds; this highlights the quantum Mpemba effect in chaotic spin chains.


<details>
  <summary>Details</summary>
Motivation: To explore how conservation laws and hydrodynamics influence relaxation speeds in chaotic quantum systems and demonstrate unusual thermalization behaviors.

Method: Analyzed two chaotic spin chains to observe the relaxation dynamics following a quench and established pairs of initial states thermalizing to the same ensemble.

Result: Identified situations where an initial state closer to equilibrium relaxes slower than one farther from it, demonstrating the quantum Mpemba effect.

Conclusion: The findings illustrate that initial conditions can significantly impact relaxation rates, providing insights into thermalization processes in quantum systems.
...
### [38] [Time-Delocalized Local Measurements in an Indefinite Causal Order](https://arxiv.org/abs/2604.11878)
*Yann Valibouse,Martí Cladera-Rosselló,Michael Antesberger,Patrick Lima,Philip Walther,Lee A. Rozema*

Main category: quant-ph

TL;DR: This paper presents a new local measurement scheme for indefinite causal order processes, specifically quantum switches, enabling measurements without destroying superposition or delaying readout.


<details>
  <summary>Details</summary>
Motivation: To enable measurements inside quantum switches that preserve superposition and allow local readout, addressing limitations of prior photonic implementations.

Method: The authors introduce a local measurement scheme coupled with a time-delocalized ancilla system, implementing it experimentally using photonic quantum switches with post-selected linear optical gates.

Result: The method demonstrated successful local measurement while maintaining the integrity of the causal order, evidenced by a negative causal witness value of approximately -0.305, indicating the certification of ICO.

Conclusion: The proposed protocol provides a new framework for local readout in quantum switches and has wider implications for preserving path coherence in various quantum applications.
...
### [39] [Observation of feedback-directed quantum dynamics in large-scale quantum processors](https://arxiv.org/abs/2604.11900)
*Ruizhe Shen,Ching Hua Lee*

Main category: quant-ph

TL;DR: This work presents feedback-directed circuit architectures for controlling non-unitary quantum dynamics via mid-circuit measurements and real-time operations on digital quantum processors, achieving scalable simulations and demonstrating robust feedback-induced asymmetry.


<details>
  <summary>Details</summary>
Motivation: To explore and control non-unitary quantum dynamics using programmable quantum hardware, enhancing measurement from passive to active control.

Method: Introduced feedback-directed architectures that leverage spatially structured mid-circuit measurements combined with real-time conditional operations, enabling large-scale simulations on up to 100 qubits.

Result: Successful implementations on IBM superconducting quantum processors showed robust signatures of feedback-induced asymmetry, distinct from known non-Hermitian effects.

Conclusion: Feedback is established as a key programmable resource for non-unitary control, paving the way for advancements in measurement-based dynamics and open-system behaviors in large-scale quantum systems.
...
### [40] [Network Nonlocality with Separable Measurements](https://arxiv.org/abs/2604.11910)
*Emanuele Polino,Davide Poderini,Giorgio Minati,Giovanni Rodari,Rafael Chaves,Fabio Sciarrino*

Main category: quant-ph

TL;DR: This paper presents a strategy for achieving full network nonlocality without relying on entangled measurements, using separable measurements and classical feedforward.


<details>
  <summary>Details</summary>
Motivation: Investigate the unexplored role of entanglement in measurements within quantum networks and how it relates to nonclassical behavior and nonlocality.

Method: The paper constructs a strategy employing separable measurements enhanced with bidirectional classical feedforward to achieve full network nonlocality.

Result: The proposed method not only achieves full network nonlocality but also demonstrates another form of network nonlocality called minimal network nonclassicality, allowing for the extraction of device-independent randomness.

Conclusion: The findings provide a practical alternative for experimental implementations of network nonlocality, thereby advancing the understanding of quantum correlations without needing entangled measurements.
...
### [41] [A Relativizing MIP for BQP](https://arxiv.org/abs/2604.11952)
*Scott Aaronson,Anand Natarajan,Avishay Tal,Agi Villanyi*

Main category: quant-ph

TL;DR: This paper demonstrates that $	ext{BQP} 	ext{ is contained in } 	ext{MIP}$ under any classical oracle, advancing the understanding of quantum and interactive proof classes.


<details>
  <summary>Details</summary>
Motivation: The relationship between quantum complexity class $	ext{BQP}$ and interactive proofs $	ext{IP}$ is unresolved; this paper aims to shed light on that connection via the containment in $	ext{MIP}$ under classical oracles.

Method: The authors develop a $	ext{PCP}$ proof system for $	ext{BQP}^{O}$, using polynomial queries to an exponentially-length proof and an oracle, inspired by the work of Grover and Rudolph.

Result: The paper establishes that $	ext{BQP} 	ext{ is indeed contained in } 	ext{MIP}$ for any classical oracle, indicating a structured relationship between these complexity classes.

Conclusion: The findings suggest that understanding this containment in the oracle world could contribute to developing an interactive protocol for proving quantum computations to classical skeptics, addressing a key challenge in quantum complexity theory.
...
### [42] [The Rotation Gap Is Not An Error: Ternary Structure in IBM Quantum Hardware](https://arxiv.org/abs/2604.11963)
*Selina Stenberg*

Main category: quant-ph

TL;DR: This study reveals that quantum error correction (QEC) mistakenly treats certain structured errors as random noise, leading to unnecessary corrections that degrade performance. A newly developed decoder improves logical error rates by 7-19% by identifying and abstaining from correcting these structured errors, demonstrating that selective correction based on observed error statistics enhances quantum information preservation.


<details>
  <summary>Details</summary>
Motivation: To challenge the assumption in quantum error correction that all syndrome activations indicate errors needing correction.

Method: Analysis of 756 QEC runs on IBM processors, introducing a regime classifier decoder to distinguish between binary errors and non-disruptive ternary transitions based on sub-Poissonian syndrome statistics.

Result: The new decoder reduces logical error rates by 7-19% at static detection depth, with statistical significance in multiple conditions, showing a marked improvement in error identification and correction practices.

Conclusion: Standard QEC can harm performance by correcting valid ternary states; targeted correction leads to better outcomes in systems where cooperative errors are present.
...
### [43] [Can present be the average of the future?](https://arxiv.org/abs/2604.11968)
*Z. Gedik*

Main category: quant-ph

TL;DR: This paper introduces a new formalism in quantum mechanics, proposing a two state vector model that extends Bell's hidden variable theory to higher dimensions. It connects forward and backward time evolution to derive probabilistic outcomes from deterministic rules, aligning with the Born rule.


<details>
  <summary>Details</summary>
Motivation: To explore a novel interpretation of quantum mechanics that reconciles determinism and probabilism through a two state vector approach.

Method: The authors generalize Bell's hidden variable model to higher dimensions and establish a deterministic measurement outcome rule that allows for time-symmetric interpretation of quantum states.

Result: The derivation of the Born rule from a deterministic framework, demonstrating that probabilistic outcomes emerge from averaging over future states evolving backward in time.

Conclusion: This formalism not only offers a new perspective on quantum measurements but also reaffirms the Pusey, Barrett, Rudolph theorem within this framework.
...
### [44] [Bell Nonlocality Test on Two-Mode Squeezed Output Generated in Double-Cavity Optomechanical](https://arxiv.org/abs/2604.12050)
*Souvik Agasti*

Main category: quant-ph

TL;DR: The paper investigates generating two-mode squeezed states in a double-cavity optomechanical system, revealing that maximal squeezing doesn't guarantee nonlocality, while lower squeezing can exhibit nonlocal correlations.


<details>
  <summary>Details</summary>
Motivation: The work aims to enhance understanding of the relationship between squeezing and nonlocality, crucial for quantum communication and metrology.

Method: Utilizing reservoir engineering in a double-cavity system and examining CHSH Bell inequality violations across varying cavity finesse values.

Result: The study finds that nonlocal correlations can exist in states with lower squeezing and that the region supporting nonlocality can expand even as squeezing diminishes.

Conclusion: Mixedness of the state significantly impacts the interplay between squeezing and nonlocality, suggesting nuanced strategies for designing quantum systems.
...
### [45] [Why does the wavefunction 'collapse' in relational approaches to quantum mechanics?](https://arxiv.org/abs/2604.12094)
*Emily Adlam*

Main category: quant-ph

TL;DR: The paper discusses wavefunction collapses in relational quantum mechanics, proposing that interactions cause discontinuities in descriptions due to the relative nature of reference systems. It suggests acceptance of quantum mechanics as incomplete to accurately describe quantum events.


<details>
  <summary>Details</summary>
Motivation: To clarify the occurrence of wavefunction collapses in relational quantum mechanics and address concerns regarding quantum events.

Method: Analyzes the interactions between systems and their references, highlighting the inherent limitations in describing a system relative to itself.

Result: The analysis reveals that discontinuities occur during interactions, which clarifies recent concerns in relational quantum mechanics.

Conclusion: Accepting the incomplete nature of quantum mechanics is essential for providing precise descriptions of quantum events.
...
### [46] [Hybrid Six-Level Rydberg Atomic Quantum Receiver for Multi-Band RF Communication](https://arxiv.org/abs/2604.12106)
*Lahiru Shyamal,Harini Hapuarachchi,Saman Atapattu,Jared H. Cole*

Main category: quant-ph

TL;DR: The paper proposes a six-level Rydberg atomic quantum receiver architecture that enhances multi-band RF reception capabilities, surpassing existing models in throughput.


<details>
  <summary>Details</summary>
Motivation: The need for advanced RF sensing systems that can operate without calibration and offer broad frequency response configurations.

Method: A hybrid architecture combining cascaded and parallel RF coupling pathways was developed, along with a consistent electromagnetic coupling model and steady-state analytical expressions.

Result: The proposed H-RAQR architecture supports four simultaneous RF channels and outperforms conventional receiver models in terms of throughput, as validated through simulations.

Conclusion: The hybrid architecture shows significant promise for scalable multi-channel RF sensing and communication applications.
...
### [47] [Dequantizing Short-Path Quantum Algorithms](https://arxiv.org/abs/2604.12131)
*François Le Gall,Suguru Tamaki*

Main category: quant-ph

TL;DR: This paper reveals classical mechanisms underlying short-path quantum algorithms, demonstrating that these do not provide a super-quadratic advantage over classical computation.


<details>
  <summary>Details</summary>
Motivation: To investigate the complexity of the short-path quantum algorithm and its advantages over classical approaches, especially regarding constraint satisfaction problems.

Method: Identifying classical mechanisms that lead to clean dequantizations, resulting in classical algorithms with improved time complexity.

Result: Classical algorithms achieved complexity of $2^{(1-c')n}$, indicating no super-quadratic advantage from quantum algorithms.

Conclusion: Despite lacking a super-quadratic advantage, the results offer a new approach to designing effective classical algorithms for constraint satisfaction problems.
...
### [48] [Quantum chaotic systems: a random-matrix approach](https://arxiv.org/abs/2604.12141)
*Mario Kieburg*

Main category: quant-ph

TL;DR: This paper reviews the application of random matrix theory in quantum physics, emphasizing spectrum preparation, symmetry classifications, and statistical techniques.


<details>
  <summary>Details</summary>
Motivation: To properly apply random matrix theory to quantum physics, ensuring accurate comparisons between random matrices and physical eigenvalue spectra.

Method: Discusses symmetry classifications, Dyson's and Altland-Zirnbauer's frameworks, joint probability density functions, unfolding procedures, and employs techniques like orthogonal polynomials and supersymmetry methods.

Result: Details on calculating joint probability density functions, local spacing distributions, and relations to effective Lagrangians, including excursions into non-Hermitian random matrix theory.

Conclusion: The paper provides insights into how random matrix theory can be effectively utilized in quantum physics, enhancing understanding of spectral statistics, particularly in open quantum systems.
...
### [49] [Fault-tolerant simulation of the electronic structure using Projector Augmented-Waves and Bloch orbitals](https://arxiv.org/abs/2604.12142)
*Rishabh Bhardwaj,Alexander Reed Muñoz,Travis E. Jones,John Golden*

Main category: quant-ph

TL;DR: The paper introduces the Bloch--UPAW framework for efficiently modeling strongly correlated materials in quantum computing, improving convergence and reducing resource requirements.


<details>
  <summary>Details</summary>
Motivation: Current tools for studying materials do not effectively handle the complexities of strongly correlated systems necessary for fault-tolerant quantum computers, particularly concerning electronic wavefunctions and finite-size errors.

Method: The Bloch--UPAW framework combines Bloch-orbital $k$-space structure with unitary projector-augmented-wave (UPAW) methods, allowing systematic control over Brillouin-zone sampling and addressing local physics at near-nuclear regions.

Result: The derived block-encoding circuit requires only one ancilla qubit and scales the Toffoli cost favorably, showing a significant resource reduction for bulk diamond compared to existing methods.

Conclusion: The newly developed framework allows for more efficient modeling of strongly correlated materials, crucial for advancing quantum computing technologies.
...
### [50] [Scalable Qumode-Qubit State Transfer and Fast-forward Quantum Fourier Transform using Oscillators](https://arxiv.org/abs/2604.12157)
*Joel Bierman,Shubdeep Mohapatra,Huiyang Zhou,Yuan Liu*

Main category: quant-ph

TL;DR: This paper improves the transfer of multi-qubit states to continuous-variable states, demonstrating enhanced performance by distributing the workload across multiple qumodes.


<details>
  <summary>Details</summary>
Motivation: The need to efficiently transfer quantum information between discrete and continuous states for better computation and communication.

Method: Transferring an n-qubit state to m qumodes, resulting in a runtime of O(2^{n/m}), and applying it to approximate the n-qubit quantum Fourier transform with a new runtime scaling.

Result: The proposed method improves runtime efficiency significantly and enables a scalable approach for quantum state conversion, enhancing quantum signal processing capabilities.

Conclusion: This work represents a significant advancement in the field of quantum information processing, integrating mixed analog-digital systems.
...
### [51] [Quantum Message Passing for Factor Graphs over Finite Abelian Groups](https://arxiv.org/abs/2604.12186)
*Avijit Mandal,Henry D. Pfister*

Main category: quant-ph

TL;DR: The paper presents a quantum message-passing framework for factor graphs over finite abelian groups, enhancing classical frameworks for quantum state discrimination and message consistency in quantum channels.


<details>
  <summary>Details</summary>
Motivation: To enhance the discrimination of quantum states and facilitate message passing in quantum information theory using the structure of finite abelian group factor graphs.

Method: Develop a quantum message-passing framework based on the diagonalization of the Gram matrix by the dual group's character basis and analyze classical-quantum channels induced by various factors, providing update rules for incoming and outgoing messages.

Result: Shows that incoming heralded mixtures of group-covariant pure-state channels yield outgoing messages that remain within the same class, applicable to efficient coding schemes.

Conclusion: The work extends prior quantum message-passing methods to a broader class of factor graphs, impacting standard coding techniques and quantum state manipulation.
...
### [52] [A Bundle Isomorphism Relating Complex Velocity to Quantum Fisher Operators](https://arxiv.org/abs/2604.12187)
*Jorge Meza-Domínguez*

Main category: quant-ph

TL;DR: The paper demonstrates that averaging over stochastic gravitational fluctuations results in a complex velocity field, which is isomorphic to the symmetric logarithmic derivative operator in a specific Hilbert space, preserving quantum geometric structures and yielding measurable topological phases in atom interferometry.


<details>
  <summary>Details</summary>
Motivation: To understand the effects of stochastic gravitational fluctuations on matter dynamics and their implications for quantum information geometry.

Method: Averaging matter dynamics leads to a complex velocity field linked with the SLD operator in a Hilbert space, and establishing an isomorphism that preserves quantum structures.

Result: The complex velocity field is isomorphic to the SLD operator, with the quantum Fisher metric expressed in terms of this field, revealing quantized holonomy.

Conclusion: The findings indicate that gravitational fluctuations can give rise to observable topological phases in atom interferometry.
...
### [53] [Current conservation and amplitude regularisation of the Landau problem: Bohm--Madelung description](https://arxiv.org/abs/2604.12224)
*Anand Aruna Kumar*

Main category: quant-ph

TL;DR: This paper explores the behavior of charged particles in a magnetic field using a quantum mechanics approach that separates amplitude and phase equations, highlighting regularisation schemes for analysis.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics of charged particles in magnetic fields through a quantum lens, particularly using the Bohm--Madelung approach.

Method: The study employs coupled amplitude and phase equations derived from the stationary Schrödinger equation, utilizing global Fisher-information-based and local canonical regularisation schemes.

Result: The radial and axial dynamics maintain global regularity, while the azimuthal sector shows complex amplitude behavior due to gauge coupling. Local regularity is found in canonical branches, leading to organised amplitude-momentum relations.

Conclusion: Regularisation facilitates structural organisation in amplitude space, allowing description of stationary Bohmian dynamics in the Landau problem while preserving key spectral characteristics.
...
### [54] [Large-Scale Quantum Circuit Simulation on HPC Cluster via Cache Blocking, Boosting, and Gate Fusion Optimization](https://arxiv.org/abs/2604.12256)
*Chuan-Chi Wang,Yan-Jie Wang,Chia-Heng Tu,Shih-Hao Hung*

Main category: quant-ph

TL;DR: This paper presents a framework to optimize quantum circuit simulation performance through data locality and computational efficiency improvements, achieving significant speedup compared to existing simulators.


<details>
  <summary>Details</summary>
Motivation: The high cost and noise limitations of physical quantum hardware necessitate efficient quantum circuit simulations, particularly for algorithm development.

Method: An extensible framework is proposed that integrates an optimizer for circuit restructuring and a simulator for execution strategy adjustments, employing new components like merge booster and diagonal detector inspired by quantum principles.

Result: Experimental results show a speedup of up to 160 times for circuit-level benchmarks and up to 34 times for diagonal-heavy gate-level benchmarks against existing simulators.

Conclusion: The proposed methodologies provide robust and faster quantum circuit simulations, which will aid in advancing novel quantum algorithms.
...
### [55] [Long-range tunable coupler for modular fluxonium quantum processors](https://arxiv.org/abs/2604.12261)
*Peng Zhao,Peng Xu,Zheng-Yuan Xue*

Main category: quant-ph

TL;DR: The paper presents a long-range coupler for integrating fluxonium qubits in modular quantum processors, enhancing scalability and performance.


<details>
  <summary>Details</summary>
Motivation: To overcome scaling limitations in superconducting quantum processors, addressing the need for long-range interconnects between physically separated qubits while maintaining high performance.

Method: The authors propose a tunable coupler designed to link fluxonium qubits separated by over one centimeter, aiming for sub-100-ns two-qubit gate operations with low error rates.

Result: The coupler potentially enables high-performance inter-module gates, achieving fidelity similar to intra-module operations, and supports low quantum crosstalk essential for scalability.

Conclusion: This development may significantly advance the realization of large-scale modular fluxonium quantum processors, enhancing connectivity and supporting complex quantum error correction.
...
### [56] [Quantum Chaos and Quantum Information: Interactions and Implications](https://arxiv.org/abs/2604.12267)
*Arul Lakshminarayan,Karol Życzkowski*

Main category: quant-ph

TL;DR: The paper explores the connection between von Neumann entropy, quantum chaotic systems, and their implications for quantum information processing.


<details>
  <summary>Details</summary>
Motivation: To investigate how entropy dynamics in quantum systems relates to quantum chaotic behavior and the effects of noise in quantum information processing.

Method: Conceptual analysis of the relationship between von Neumann entropy and quantum chaotic systems, incorporating models of noise affecting quantum states.

Result: Demonstrates a universal link between quantum chaotic dynamics and entropy production, highlighting the impact of noise on quantum information.

Conclusion: Understanding these relationships may enhance quantum information processing techniques by leveraging insights from quantum chaos.
...
### [57] [Geometric phase-assisted simple phase compensation enabling quantum key distribution using phase-shifted Bell states](https://arxiv.org/abs/2604.12272)
*Ayan Kumar Nai,G. K. Samanta*

Main category: quant-ph

TL;DR: A new phase-compensation scheme in entanglement-based quantum key distribution enhances fidelity and reduces quantum bit error rate (QBER), facilitating practical implementation in real systems.


<details>
  <summary>Details</summary>
Motivation: To address the issue of unwanted relative phases in Bell states that degrade QKD performance.

Method: A versatile phase-compensation scheme is proposed and quantitatively assessed, focusing on its application in the BBM92 protocol.

Result: A proof-of-concept experiment achieves over 95% fidelity and reduces QBER to below 11%, meeting the security threshold for QKD.

Conclusion: This method allows practical phase control in entangled-photon systems, enhancing quantum communication stability and performance.
...
### [58] [Periodic dynamics in an Ising chain with a quadratic transverse field](https://arxiv.org/abs/2604.12276)
*H. P. Zhang,Z. Song*

Main category: quant-ph

TL;DR: This paper explores many-body dynamics in a quadratic well using a localized Ising chain, revealing spatially varying quantum phases and topological properties.


<details>
  <summary>Details</summary>
Motivation: To enhance understanding of many-body dynamics in quadratic wells, which are common in modern physics.

Method: Analyzed the system using Majorana representation for exact solutions, focusing on localized modes and their spectral properties; employed numerical simulations for additional insights.

Result: Found a topologically degenerate spectrum in the thermodynamic limit, and identified periodic oscillations arising from lifted degeneracies in finite systems.

Conclusion: The results provide deeper insights into many-body dynamics and quantum phase transitions in trapping fields.
...
### [59] [Numerically optimized amplitude-robust controlled-Z gate for ultracold neutral atoms with individual addressing capability](https://arxiv.org/abs/2604.12279)
*K. V. Kozenko,V. V. Gromyko,I. I. Beterov,I. I. Ryabtsev*

Main category: quant-ph

TL;DR: The paper presents a robust symmetric controlled-Z gate scheme for neutral atoms using optimized laser pulse profiles, enhancing gate fidelity against Rabi frequency variations.


<details>
  <summary>Details</summary>
Motivation: To improve the fidelity of neutral atom Rydberg blockade CZ gates under varying Rabi frequencies, addressing the challenges posed by thermal motion and beam instability.

Method: Numerical optimization of laser pulse phase profiles, focusing on individual addressing of Rydberg atoms and accounting for asymmetrical Rabi frequencies.

Result: Achieved nearly an order of magnitude increase in robustness to Rabi frequency variations; validated performance for single-photon and two-photon excitation schemes in finite temperature scenarios.

Conclusion: The proposed gate protocol effectively reduces errors related to thermal motion and beam pointing instability, yielding higher fidelity in quantum gate operations.
...
### [60] [Dynamical signatures of conventional and asymptotic quantum many-body scars on a trapped ion simulator](https://arxiv.org/abs/2604.12296)
*Leonard Logarić,John Goold,Shane Dooley*

Main category: quant-ph

TL;DR: This paper explores the connection between gapless excitations and asymptotic quantum many-body scars (AQMBS) in qudit-based models, demonstrating their preparation in a quantum processor and slower thermalization times with increased system size.


<details>
  <summary>Details</summary>
Motivation: To investigate ergodicity violating mechanisms in quantum systems, specifically exploring the role of AQMBS in thermalization processes.

Method: The authors connect gapless excitations to AQMBS within a 2-local model, prepare these states using a quantum processor, and analyze their thermalization behavior under Floquet dynamics.

Result: Slower thermalization times are observed as the system size increases, offering experimental evidence for AQMBS.

Conclusion: The findings suggest that AQMBS may lead to significantly altered thermalization dynamics in larger quantum systems, with potential implications for understanding quantum many-body dynamics.
...
### [61] [The Quantum Kicked Rotor: A Paradigm of Quantum Chaos. Foundational aspects and new perspectives](https://arxiv.org/abs/2604.12316)
*Giuliano Benenti,Giulio Casati,Jiangbin Gong,Zhixing Zou*

Main category: quant-ph

TL;DR: The kicked rotor model illustrates key classical and quantum chaos concepts through diverse dynamics and recent developments across various physics fields.


<details>
  <summary>Details</summary>
Motivation: To explore foundational ideas of chaos using the kicked rotor as a framework, highlighting its significance in various physics applications.

Method: The chapter discusses transitions from regular to chaotic motion in classical systems, introduces quantum phenomena, and reviews experimental realizations to ground theoretical concepts.

Result: Key insights include characteristic time scales, near-resonant dynamics, topological features, and non-Hermitian physics as they relate to quantum phases derived from classical behaviors.

Conclusion: The chapter concludes by discussing open problems and future research directions, emphasizing the ongoing relevance of the kicked rotor model in understanding complex dynamical systems.
...
### [62] [Quantum-Enhanced Single-Parameter Phase Estimation with Adaptive NOON States](https://arxiv.org/abs/2604.12323)
*Simanshu Kumar,Nandan S Bisht*

Main category: quant-ph

TL;DR: The paper presents a framework for optimizing quantum metrology using NOON states, demonstrating significant improvements in phase sensitivity and measurement efficiency across varying photon numbers.


<details>
  <summary>Details</summary>
Motivation: To enhance phase sensitivity in quantum metrology beyond the shot-noise limit by utilizing entanglement and optimizing measurement circuits.

Method: An end-to-end differentiable quantum-optical framework was implemented to learn optimal circuit parameters using gradient descent, maximizing classical Fisher information across coincidence channels for $N=2,3,4,5$ photon states.

Result: Raw classical Fisher information improved by up to +1775% and useful measurement events per pulse improved by 8x to 133x across photon numbers $N=2$ to $N=5$.

Conclusion: Optimized quantum probes achieved significant fractions of the Heisenberg limit, making quantum-enhanced sensing at high photon numbers experimentally feasible.
...
### [63] [Gaussian boson sampling: Benchmarking quantum advantage](https://arxiv.org/abs/2604.12330)
*Ned Goodman,Alexander S. Dellios,Margaret D. Reid,Peter D. Drummond*

Main category: quant-ph

TL;DR: This paper presents a scalable classical algorithm that approximates Gaussian boson sampling (GBS), demonstrating improved performance against existing methods and highlighting the impact of physical error sources on quantum advantage.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of understanding errors in quantum computing, particularly in Gaussian boson sampling, and their effect on the complexity of problems.

Method: The authors introduce a classical algorithm capable of approximating GBS outputs and rigorously test its performance against previous algorithms.

Result: The proposed algorithm achieves closer numerical simulation of output data than current experiments, up to 1152 modes, outperforming previous classical approximations.

Conclusion: This advancement provides a pathway to develop more accurate algorithms in quantum computing and enhances understanding of the relationship between quantum advantage and physical error factors.
...
### [64] [Entanglement concentration of high-dimensional unknown partially entangled state](https://arxiv.org/abs/2604.12338)
*Si-Qi Du,Guo-Zhu Song,Hai-Rui Wei*

Main category: quant-ph

TL;DR: This paper presents a method for concentrating high-dimensional quantum states, particularly Bell states, through a universal scheme that improves upon previous techniques focused on qubits.


<details>
  <summary>Details</summary>
Motivation: The study aimed to address the challenges of noise affecting high-dimensional quantum states during transmission or storage in quantum communication, which can degrade entanglement.

Method: The proposed scheme involves cross-Kerr nonlinearities, X-quadrature homodyne measurements, and single-partite projection measurements at Bob's site to distill a two-qutrit maximally entangled Bell state.

Result: The method successfully concentrates nonlocal high-dimensional Bell states and generates partially entangled qubit states as a useful by-product for future quantum information processing tasks.

Conclusion: This work enhances the entanglement concentration of high-dimensional states using linear optical elements, contributing valuable techniques for quantum communication applications.
...
TL;DR: The quantum kicked top (QKT) serves as a model for studying the interplay between classical dynamics and quantum chaos, utilizing a finite-dimensional Hilbert space to analyze and understand chaotic behavior in quantum systems.


<details>
  <summary>Details</summary>
Motivation: Exploring the relationship between classical dynamics and quantum behavior through a manageable model.

Method: Deriving discrete nonlinear maps, analyzing phase space structures, and applying Floquet theory to study quantum dynamics, symmetries, and chaos signatures.

Result: Identification of quantum chaos indicators like spectral statistics and entanglement, with connections to quantum information measures as a system of interacting qubits.

Conclusion: The QKT acts as a pivotal model linking classical and quantum chaos, enriching the understanding of chaos in semiclassical contexts.
...
### [66] [Noise-Enhanced Self-Healing Dynamics in Non-Hermitian Systems](https://arxiv.org/abs/2604.12347)
*Wuping Yang,H. Huang*

Main category: quant-ph

TL;DR: The paper explores how stochastic noise can enhance self-healing in non-Hermitian systems, revealing that both weak and strong noise lead to improved recovery of wave packet profiles after scattering.


<details>
  <summary>Details</summary>
Motivation: To understand the impact of stochastic noise on edge self-healing in non-Hermitian systems, a phenomenon that has potential applications in robust dynamical systems.

Method: The authors analyze the influence of noise on self-healing using finite-time Lyapunov exponent analysis and perturbation theory, focusing on both weak and strong noise regimes.

Result: Weak noise extends the self-healing duration by aligning dynamics, while strong noise stabilizes profile recovery across the spectrum through a non-unitary drift-diffusion mechanism.

Conclusion: The findings suggest practical approaches for implementing non-Hermitian dynamics in noisy environments, highlighting noise's constructive role in dynamic recovery.
...
### [67] [Chiral state conversion near an exceptional point: speed-noise competition](https://arxiv.org/abs/2604.12354)
*Qing-Wei Wang*

Main category: quant-ph

TL;DR: The paper explores how noise and encircling speed affect chirality in non-Hermitian systems, proposing a quantitative measure and revealing limits influenced by these factors.


<details>
  <summary>Details</summary>
Motivation: To systematically examine the influence of factors like loop geometry, starting conditions, encircling speed, and noise on chiral dynamics in non-Hermitian systems.

Method: Introduces a non-chirality degree $χ_c$ to quantify chirality, employing exact solutions for dynamics without noise and numerical integration for dynamics with noise.

Result: Chirality oscillations were observed that are sensitive to noise, with a critical boundary differentiating noisy and clean limits determined by the interplay of encircling speed and noise strength.

Conclusion: The study highlights the impact of noise on non-Hermitian dynamics and provides insights for future theoretical and experimental research.
...
### [68] [Noise-Robust Ultrafast Entanglement Generation in Rydberg Atoms via Quantum Optimal Control](https://arxiv.org/abs/2604.12361)
*Tanveer Ahmad,Muhammad Muneer*

Main category: quant-ph

TL;DR: The paper analyzes ultrafast entanglement generation between Rydberg-blockaded atoms, focusing on the effects of realistic laser noise.


<details>
  <summary>Details</summary>
Motivation: To understand the impact of different types of noise on the fidelity of entanglement generation, essential for quantum processors.

Method: The study employs Monte Carlo simulations to evaluate Bell-state fidelity against various noise spectra, using Gaussian laser pulses and quantum optimal control theory.

Result: Amplitude noise tolerated up to 30% (90% fidelity) but phase noise severely limits fidelity beyond 1% noise; pink noise causes less fidelity loss than white noise.

Conclusion: Identifies a critical noise threshold for maintaining entanglement fidelity, providing benchmarks for the design of femtosecond quantum processors.
...
### [69] [A Periodic Orbit Trace Formula for Quantum Scrambling: The Role of the Normally Hyperbolic Invariant Manifold](https://arxiv.org/abs/2604.12369)
*Stephen Wiggins*

Main category: quant-ph

TL;DR: The paper develops a semiclassical framework linking out-of-time-order correlators (OTOCs) to microcanonical structures and periodic orbits, particularly in quantum systems with index-1 saddle points.


<details>
  <summary>Details</summary>
Motivation: To formally connect OTOCs with localized phase-space structures like chemical transition states, elucidating the mechanics of quantum information scrambling.

Method: The authors derive a semiclassical expansion for microcanonical OTOCs using Normal Form theory around index-1 saddle points, examining unstable periodic orbits on the Normally Hyperbolic Invariant Manifold (NHIM).

Result: The derivation leads to a local instability exponent, Λ(J), characterizing semiclassical growth, with simplified conditions when observation time aligns with orbit periods, yielding a 1.5Λ scaling due to competing dynamics.

Conclusion: Dependence of instability on transverse actions provides a theoretical basis for mode-selective scrambling control, with outlined numerical methods to validate the findings.
...
### [70] [Enhanced quantum illumination of a lossy target: A sequential interaction model](https://arxiv.org/abs/2604.12381)
*Shilpi Srivastava,Shubhrangshu Dasgupta*

Main category: quant-ph

TL;DR: The paper evaluates the effectiveness of quantum illumination in detecting a lossy target amid noise, highlighting the superior performance of Gaussian two-mode squeezed states over classical coherent states.


<details>
  <summary>Details</summary>
Motivation: Investigating quantum illumination in realistic scenarios where interactions with a noisy environment affect detection performance.

Method: Signal interactions modeled with independent beam splitters; performance measured using signal-to-noise ratio (SNR) and quantum Chernoff bound (QCB).

Result: Gaussian two-mode squeezed state (TMSS) demonstrates higher SNR than coherent states (CS) in low-reflectivity scenarios; lower QCB indicates better distinguishability.

Conclusion: Realistic modeling enhances quantum illumination for lossy target detection, with implications for quantum radar and lidar technologies.
...
### [71] [Permutationally symmetric molecular aggregates](https://arxiv.org/abs/2604.12395)
*Sricharan Raghavan-Chitra,Arghadip Koner,Joel Yuen-Zhou*

Main category: quant-ph

TL;DR: The paper explores the limitations of classical optics methods in analyzing linear optical spectra of molecular aggregates, providing a quantum mechanical approach that identifies exact conditions for traditional methods and introduces corrections for finite aggregates.


<details>
  <summary>Details</summary>
Motivation: To clarify the limitations of classical optics methods and explore how quantum features manifest in molecular aggregates.

Method: The authors use a quantum mechanical Hamiltonian, focusing on permutationally symmetric aggregates and employing a $1/N$ expansion for corrections in finite systems.

Result: Identified exact conditions for the validity of DDA, CPA, and CES, and established finite-N corrections represented by Raman-like transitions in aggregates.

Conclusion: The study shows that quantum optical features can emerge even in simple configurations of quantum emitters, contributing to understanding molecular aggregates' optical behavior.
...
### [72] [Notes on some inequalities, resulting uncertainty relations and correlations. 1. General mathematical formalism](https://arxiv.org/abs/2604.12410)
*Krzysztof Urbanowski*

Main category: quant-ph

TL;DR: This paper explores generalizations of the Schwarz and Jensen inequalities to derive uncertainty relations in quantum mechanics for non-commuting observables.


<details>
  <summary>Details</summary>
Motivation: Understanding uncertainty relations in quantum mechanics is crucial for interpreting the behavior of non-commuting observables and their correlations.

Method: The paper employs generalizations of the Schwarz and Jensen inequalities to derive various uncertainty relations for multiple non-commuting observables.

Result: New generalized uncertainty relations are derived for more than two non-commuting observables, linking these relations to correlation matrix elements.

Conclusion: The study highlights the connection between generalized uncertainty relations and observable correlations, introducing an equivalent form of the SR uncertainty relation using Pearson coefficients.
...
### [73] [Efficient classical training of model-free quantum photonic reservoir](https://arxiv.org/abs/2604.12441)
...
TL;DR: This paper presents a method for estimating quantum state properties using classical light for training, which allows for effective reconstruction of quantum states without prior models.


<details>
  <summary>Details</summary>
Motivation: The challenge in accurately estimating properties of quantum states due to experimental imperfections and model inaccuracies in quantum technologies necessitates robust solutions.

Method: The authors developed a training strategy employing photonic quantum extreme learning machines, utilizing classical light for both learning and setting optimization, while inference is based on quantum states. This approach leverages the relationship between coherent state outputs and separable input quantum state statistics to facilitate a model-free, gradient-based optimization directly on experimental data.

Result: The method effectively reconstructs single-qubit Pauli observables from unseen single-photon states and extends to estimating two-qubit entanglement witnesses across arbitrary bipartite states.

Conclusion: The research establishes a new framework for adaptive training in photonic quantum learning devices, highlighting a unique out-of-distribution generalization capability that enhances efficiency and accuracy in quantum state estimation.
...
### [74] [$\mathbb{Z}_{2}$ Skin Channels and Scale-Dependent Dynamical Quantum Phase Transitions](https://arxiv.org/abs/2604.12450)
*Yongxu Fu*

Main category: quant-ph

TL;DR: The paper analyzes $	ext{Z}_2$ skin channels in non-Hermitian systems, highlighting their unique time evolution and implications for quantum revivals and dynamical phase transitions.


<details>
  <summary>Details</summary>
Motivation: To explore the behavior of $	ext{Z}_{2}$ skin channels under periodic boundary conditions in non-Hermitian systems with anomalous time-reversal symmetry, and to deepen the understanding of skin effects in this context.

Method: The authors use a semiclassical worldline perspective to analytically describe wavepacket evolutions tied to initial states and relevant symmetries, focusing on their exponential-dominated dynamics in momentum space and circulating behavior in real space.

Result: The study shows that skin channels exhibit quantum revivals and can undergo dynamical quantum phase transitions with scale-dependent behavior, which differs from typical DQPTs, reinforcing conclusions drawn from prior research on worldlines and winding mechanisms.

Conclusion: The findings confirm that the underlying principles governing $	ext{Z}_2$ skin channels are consistent with traditional skin effects, thereby contributing to the broader understanding of non-Hermitian phenomena.
...
### [75] [Many-body localization](https://arxiv.org/abs/2604.12464)
*Jakub Zakrzewski*

Main category: quant-ph

TL;DR: This paper reviews nonergodic dynamics in many-body quantum systems, focusing on many-body localization (MBL) and its crossover from ergodic behavior.


<details>
  <summary>Details</summary>
Motivation: To explore the phenomenon of many-body localization and its implications for many-body quantum systems and quantum computing.

Method: An introductory review that highlights MBL's characteristics and summarizes evidence for its emergence in finite systems using the XXZ model and other models.

Result: Evidence for the ergodic to MBL crossover in finite systems is presented, demonstrating the generality of MBL across different quantum models.

Conclusion: The paper emphasizes the significance of understanding MBL, particularly in relation to its potential impact on quantum computing.
...
### [76] [Demonstrating Record Fidelity for the Quantum Fourier Transform](https://arxiv.org/abs/2604.12465)
...
TL;DR: Demonstrated the Parity Architecture's effectiveness on quantum hardware with QFT benchmark, achieving high fidelity and qubit count, and showing super-exponential speedup over prior methods.


<details>
  <summary>Details</summary>
Motivation: To optimize quantum processing through innovative architecture and instruction sets.

Method: Implementation of the Parity Architecture on quantum processors, benchmarking with the Quantum Fourier Transform (QFT).

Result: Achieved process fidelity of ${F 	ext{approx} 10^{-2}}$ for ${N=50}$ qubits on IBM Heron r3, with super-exponential scaling of speedup ${	ext{O}(	ext{exp}(N^2))}$ compared to previous methods.

Conclusion: Including iSWAP gates can further enhance scaling efficiency in quantum computations.
...
### [77] [Noise-enhanced quantum kernels on analog quantum computers](https://arxiv.org/abs/2604.12476)
*Hsiang-Wei Huang,Shen-Liang Yang,Chuan-Chi Huang,Yueh-Nan Chen,Hong-Bin Chen*

Main category: quant-ph

TL;DR: This paper introduces analog and hybrid quantum kernels that outperform traditional methods in benchmarking tasks, even under operational noise, which unexpectedly enhances performance.


<details>
  <summary>Details</summary>
Motivation: Exploring the quantum kernel method's potential in analog quantum computing and its advantages in machine learning tasks.

Method: The authors construct an analog quantum kernel and a hybrid quantum kernel, benchmarking them against existing methodologies and incorporating operational noise into their performance analysis.

Result: The analog and hybrid quantum kernels show competitive results in estimating non-Markovianity and outperform traditional kernel methods despite, or perhaps due to, operational noise.

Conclusion: The findings suggest that operational noise can enhance the expressivity and complexity of quantum kernels, facilitating practical implementations and reduced experimental demand.
...
### [78] [Scattering Faddeev calculations in the double continuum](https://arxiv.org/abs/2604.12516)
*Romain Guérout*

Main category: quant-ph

TL;DR: The paper utilizes the configuration-space Faddeev formalism to analyze three-particle scattering in the double continuum and develops a comprehensive matrix for various scattering processes, specifically focusing on neutron-deuteron interactions.


<details>
  <summary>Details</summary>
Motivation: The need for a unified approach to understand complex scattering processes involving three particles in both single and double continua prompted this study.

Method: The authors employ the configuration-space Faddeev formalism to systematically categorize all scattering processes in a unique matrix framework.

Result: The method is applied to neutron-deuteron scattering, providing a benchmark for the effectiveness and accuracy of the approach in describing the dynamics involved.

Conclusion: The resulting matrix represents a comprehensive tool for analyzing a variety of three-body scattering scenarios in nuclear physics.
...
### [79] [Utility of NISQ devices: optimizing experimental parameters for the fabrication of Au atomic junction using gate-based quantum computers](https://arxiv.org/abs/2604.12549)
*Takumi Kanezashi,Daisuke Tsukayama,Jun-ichi Shirakashi,Tetsuo Shibuya,Hiroshi Imai*

Main category: quant-ph

TL;DR: The study demonstrates that a noisy intermediate-scale quantum (NISQ) device can autonomously fabricate Au atomic junctions via feedback-controlled electromigration, outperforming a D-Wave quantum annealer in terms of accuracy and solution quality.


<details>
  <summary>Details</summary>
Motivation: The research addresses the challenges of manually fine-tuning parameters for feedback-controlled electromigration, seeking a more efficient alternative through quantum computing.

Method: The study utilized a noisy intermediate-scale quantum (NISQ) device for automatic fabrication of Au atomic junctions, comparing its performance with a D-Wave quantum annealer in solving combinatorial optimization problems.

Result: The NISQ device achieved lower residual energies and higher-quality solutions for large-scale problems compared to the D-Wave quantum annealer.

Conclusion: The findings suggest that NISQ devices offer a promising approach to optimize complex atomic migration processes over traditional quantum annealers.
...
### [80] [Design automation and space-time reduction for surface-code logical operations using a SAT-based EDA kernel compatible with general encodings](https://arxiv.org/abs/2604.12560)
*Wang Liao,Rei Tokami,Yasunari Suzuki*

Main category: quant-ph

TL;DR: KOVAL-Q is an EDA kernel that optimizes surface-code logical operations for fault-tolerant quantum computers by framing them as a SAT problem.


<details>
  <summary>Details</summary>
Motivation: There is a need for a framework to identify, verify, and optimize low-space-time-cost logical operations for FTQCs, akin to EDA in classical circuits.

Method: KOVAL-Q formulates surface-code logical operations as a satisfiability (SAT) problem, offering flexibility in surface-code encodings and determining minimal execution times for logical operations.

Result: KOVAL-Q reduces execution times by about 10% in simplified models for FTQC applications, demonstrating efficiency improvements over existing frameworks.

Conclusion: The framework enhances optimization and validation of FTQC subroutines and can be integrated into larger heuristic frameworks.
...
### [81] [Detecting entanglement from few partial transpose moments and their decay via weight enumerators](https://arxiv.org/abs/2604.12576)
*Daniel Miller,Jens Eisert*

Main category: quant-ph

TL;DR: The paper explores a generalized approach to the $p_3$-PPT criterion for detecting quantum entanglement through PT moments, focusing on reductions in experimental requirements and demonstrating the power of three-moment criteria.


<details>
  <summary>Details</summary>
Motivation: The need for more efficient methods in certifying quantum entanglement and reducing experimental overheads in the application of entanglement criteria.

Method: The authors prove a relationship among three PT moments, $p_k$, $p_l$, and $p_m$, that allows entanglement detection without the need for all moment orders, proposing a condition for entanglement based on these moments.

Result: Any state satisfying the condition $p_l > p_k^x p_m^{1-x}$ (with $x=(m-l)/(m-k)$) must be entangled, simplifying the entanglement certification process significantly.

Conclusion: The study enhances the understanding of higher-moment PPT relaxations, offers a pathway for practical implementation with fewer required measurements, and introduces quantum weight enumerators for exploring quantum states in various contexts.
...
### [82] [Ternary Quantum Eraser Cryptography](https://arxiv.org/abs/2604.12577)
*Ahmed Halawani,Yahya Meshalwi Khabrani,Abdulaziz Al-Mogheeth,Zheng-Hong Li,M. Al-Amri*

Main category: quant-ph

TL;DR: This paper introduces a ternary quantum key distribution protocol using the quantum eraser phenomenon, overcoming vulnerabilities in binary implementations by enhancing security through geometry and ordering of quantum states, ultimately achieving lower success probability for eavesdroppers.


<details>
  <summary>Details</summary>
Motivation: To address security vulnerabilities in binary quantum eraser protocols that allow eavesdroppers to effectively identify transmitted quantum states with high probability.

Method: The proposed ternary quantum eraser protocol uses three polarization states with $120^	extcirc$ separation and random temporal ordering in three-photon groups to enhance security.

Result: The protocol reduces the maximum success probability of eavesdroppers to 54%, significantly improving over the 85% threshold of binary systems and maintaining competitive efficiency.

Conclusion: This work demonstrates that employing a ternary approach with enhanced state distinguishability can substantially improve security in quantum key distribution while preserving operational advantages.
...
### [83] [Mutual information harvesting for circularly accelerated detectors](https://arxiv.org/abs/2604.12629)
*Mingkun Quan,Runhu Li,Zixu Zhao*

Main category: quant-ph

TL;DR: This study analyzes how mutual information between two circularly accelerated detectors interacting with massless scalar fields varies with acceleration, trajectory radius, and interdetector separation, revealing complex oscillatory behavior particularly near boundaries.


<details>
  <summary>Details</summary>
Motivation: To explore the effects of acceleration and boundary interactions on mutual information in quantum systems, particularly in the context of circularly accelerated detectors.

Method: The authors examine detectors with a shared rotational axis, analyzing how mutual information changes with different parameters such as interdetector separation, acceleration, and trajectory radius.

Result: The findings indicate that mutual information exhibits oscillatory behavior at high acceleration and small radius, with variations based on interdetector separation and the characteristics of the boundary.

Conclusion: In scenarios involving significant acceleration and small radius, mutual information shows complex behaviors due to modifications in vacuum fluctuations, especially near boundaries.
...
### [84] [The Impact of Qubit Connectivity on Quantum Advantage in Noisy IQP Circuits](https://arxiv.org/abs/2604.12635)
*Leonardo Placidi,Enrico Rinaldi,Keisuke Fujii,Chen-Yu Liu*

Main category: quant-ph

TL;DR: The paper analyzes the impact of qubit connectivity on the performance of Instantaneous Quantum Polynomial-time (IQP) circuits, highlighting how sparse architectures increase circuit depth and affect the ability to achieve quantum advantage in the presence of noise.


<details>
  <summary>Details</summary>
Motivation: To investigate how qubit connectivity influences the effectiveness of IQP circuits in relation to classical simulation boundaries, especially under noise conditions.

Method: The authors perform a connectivity-aware analysis of compiled IQP circuits, comparing different hardware connectivity graphs and using analytic depth estimates for various sparse geometries. They also conduct compilation experiments across several experimental device models to assess their performance relative to effective noise levels.

Result: Sparse architectures require lower effective noise levels than fully connected ones to maintain a quantum advantage, and the study quantifies the relationship between circuit depth, connectivity, and noise tolerance.

Conclusion: The findings provide a quantitative framework to determine when IQP circuit experiments might transition from a regime capable of quantum advantage to one that is classically simulatable, emphasizing the critical role of qubit connectivity.
...
### [85] [Interferometrically Enhanced Asymmetry in Strong-field Ionization with Bright Squeezed Vacuum](https://arxiv.org/abs/2604.12646)
*G. Singh,T. Rook,J. Rivera-Dean,C. Figueira de Morisson Faria*

Main category: quant-ph

TL;DR: Quantum light statistics enhance strong-field ionization, showing greater asymmetries in photoelectron momentum distributions than classical fields by orders of magnitude. This is linked to the nonclassical nature of squeezed vacuum fields.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of quantum light statistics in controlling strong-field ionization processes at the tunneling step.

Method: Utilized a bichromatic field of a strong coherent driver and weak bright squeezed vacuum, then conducted simulations to analyze photoelectron momentum distributions and employed semiclassical analysis via the strong-field approximation.

Result: Photoelectron momentum distributions showed asymmetries significantly larger than those from classical fields, attributed to fluctuations in the instantaneous field amplitude affecting tunneling probabilities.

Conclusion: Selective control achieved through quantum light statistics allows for reconstruction of ionization pathways, providing a method to extract sub-cycle dynamics from strong-field observables.
...
### [86] [Restoring polarization entanglement from solid-state photon sources by time-dependent photonic control](https://arxiv.org/abs/2604.12661)
*Ismail Nassar,Dan Cogan,Ido Schwartz*

Main category: quant-ph

TL;DR: A photonic-compensation protocol is proposed to counteract phase evolution in emitted photons from quantum emitters, enhancing entanglement without modifying the emitters themselves.


<details>
  <summary>Details</summary>
Motivation: Photon entanglement is essential for quantum communication, but coherent dynamics in quantum emitters can obscure this entanglement due to phase evolution.

Method: The authors apply synchronized, time-dependent coherent operations to emitted photons to reverse accumulated phase, using a semiconductor quantum dot to demonstrate dynamic phase modulation and time-resolved two-photon polarization tomography.

Result: The technique successfully restores a stationary two-photon polarization state and recovers polarization entanglement, independent of emission timing and detector resolution.

Conclusion: This robust method paves the way for efficient solid-state entangled-photon sources and offers a general strategy for managing emitter dynamics in photonic entanglement.
...
### [87] [Quasi-Orthogonal Stabilizer Design for Efficient Quantum Error Suppression](https://arxiv.org/abs/2604.12684)
*Valentine Nyirahafashimana,Sharifah Kartini Said Husain,Umair Abdul Halim,Ahmed Jellal,Nurisya Mohd Shah*

Main category: quant-ph

TL;DR: This paper presents a quasi-orthogonal geometric framework for stabilizer codes, enhancing design flexibility in quantum error correction by allowing controlled overlaps in check supports, leading to improved performance over traditional orthogonal codes.


<details>
  <summary>Details</summary>
Motivation: The need for greater flexibility and efficiency in quantum error-correcting codes beyond strict orthogonality, which limits code design.

Method: Introducing a quasi-orthogonal framework that maintains the symplectic structure while allowing overlap between X- and Z-check supports, thus forming quasi-orthogonal Pauli operators and defining a new effective distance.

Result: Quasi-orthogonal codes demonstrate better performance than traditional orthogonal codes, achieving improvements in logical error rates, fidelities, and trace distances, with finite-length constructions significantly enhancing logical rates at moderate distances.

Conclusion: The quasi-orthogonal geometric approach expands the design space for stabilizer codes, enabling better performance under depolarizing noise and showcasing the potential for efficient and flexible quantum error-correcting codes.
...
### [88] [An Introduction to Quantum Graphs and Current Applications](https://arxiv.org/abs/2604.12690)
*Gregory Berkolaiko,Sven Gnutzmann*

Main category: quant-ph

TL;DR: An introduction to quantum graphs addressing quantum chaos and spectral theory, summarizing foundational and recent results.


<details>
  <summary>Details</summary>
Motivation: To provide insights into quantum graphs, emphasizing their role in understanding quantum chaos and spectral theory.

Method: Concise didactical presentation of Schrödinger Hamiltonians on metric graphs, exploring related theories such as periodic orbit theory.

Result: Summary of key results in quantum chaos and spectral theory, alongside an overview of recent advancements in the field.

Conclusion: Establishes a foundational understanding of quantum graphs, supporting further research and learning.
...
### [89] [Quantum analogues of exponential sensitivity: from Loschmidt echo to Krylov complexity](https://arxiv.org/abs/2604.12707)
*Ignacio García-Mata,Diego A. Wisnicki*

Main category: quant-ph

TL;DR: The paper reviews quantum analogs of classical chaos, focusing on three key concepts: Loschmidt echo, out-of-time-order correlators (OTOCs), and Krylov complexity.


<details>
  <summary>Details</summary>
Motivation: To explore how quantum systems exhibit behavior similar to classical chaos despite the unitary nature of quantum mechanics, particularly through the lens of exponential sensitivity.

Method: The article provides an overview of various quantities that capture chaotic behavior in quantum systems, specifically the Loschmidt echo, OTOCs, and Krylov complexity.

Result: The review elucidates the significance and applications of the three quantities in understanding quantum chaos.

Conclusion: These quantities serve as important tools for researchers to analyze and understand chaos in quantum systems, contributing to the field's ongoing development.
...
### [90] [Ising selector machine by Kerr parametric oscillators](https://arxiv.org/abs/2604.12718)
*Jacopo Tosca,Cristiano Ciuti,Claudio Conti,Marcello Calvanese Strinati*

Main category: quant-ph

TL;DR: This paper demonstrates a mechanism using Kerr parametric oscillators to selectively access various states within the Ising model, enhancing the probability of reaching target excited states for practical applications.


<details>
  <summary>Details</summary>
Motivation: Ising machines aim to minimize energy states of Ising Hamiltonians, yet accessing specific excited states remains challenging.

Method: A network of Kerr parametric oscillators (KPOs) is employed, utilizing frequency detuning to steer the system towards different energy configurations within the Ising model.

Result: Numerical simulations show that the KPO system can target specific excited states more effectively than others, even under noise, suggesting a unique control mechanism.

Conclusion: Controlling the pump-cavity detuning allows exploration of the entire Ising energy landscape, with implications for various practical applications.
...
TL;DR: A novel method is proposed to verify the performance of a photonic 3D QRNG, ensuring it produces truly random and unpredictable sequences.


<details>
  <summary>Details</summary>
Motivation: To test the validity of 3D QRNGs in producing high-quality random digits according to theoretical principles.

Method: By undoing the unitary evolution of the 3D QRNG, the method assesses unitarity, noise levels, and errors such as photon loss or fabrication defects.

Result: The approach confirms or corrects the incomputability and unpredictability features of the 3D QRNG, ensuring it is not constrained by quantum measurement limits.

Conclusion: This method serves as an effective tool for experimental certification of QRNGs, guaranteeing adherence to theoretical standards.
...
### [92] [Decoherence Resilience of the Non-Hermitian Skin Effect](https://arxiv.org/abs/2604.12739)
*Kunkun Wang,Lei Xiao,Stefano Longhi,Peng Xue*

Main category: quant-ph

TL;DR: This paper investigates the effects of decoherence on the non-Hermitian skin effect (NHSE) in photonic quantum walks, revealing resilience and enhancement in certain conditions.


<details>
  <summary>Details</summary>
Motivation: To understand the influence of decoherence on non-Hermitian transport phenomena, particularly the NHSE, and to explore its potential applications in noisy environments.

Method: Experimental analysis of photonic quantum walks using two decoherence channels: dephasing and amplitude damping, to observe the impact on NHSE.

Result: Dephasing enhances the NHSE up to the incoherent regime whereas amplitude damping exhibits order-dependent effects, with specific configurations allowing NHSE to persist even under strong losses.

Conclusion: Decoherence can not only sustain but also enhance directional transport in non-Hermitian systems, linking quantum and classical dynamics and suggesting practical applications.
...
### [93] [Quantum Chaos in Phase Space](https://arxiv.org/abs/2604.12741)
*Martina Hentschel*

Main category: quant-ph

TL;DR: The paper discusses mesoscopic devices as models for observing quantum chaotic behavior, emphasizing the importance of semiclassical concepts and classical-quantum correspondence.


<details>
  <summary>Details</summary>
Motivation: To explore how mesoscopic devices serve as effective systems for studying quantum chaos using semiclassical theories.

Method: It extends classical ray tracing principles into phase space, integrating both spatial and momentum information.

Result: This approach enhances the understanding of the dynamics of electronic and photonic billiard cavities.

Conclusion: Applying classical-quantum correspondence in phase space provides deeper insights into the dynamical behavior of mesoscopic systems.
...
### [94] [Quantum chaos in many-body systems of indistinguishable particles](https://arxiv.org/abs/2604.12745)
*Juan-Diego Urbina,Klaus Richter*

Main category: quant-ph

TL;DR: This paper explores semiclassical methods in quantum systems, extending their application to many-body interference in quantum fields, leading to new insights in quantum chaos, spectral correlations, and correlation scrambling.


<details>
  <summary>Details</summary>
Motivation: To bridge classical and quantum descriptions in systems with indistinguishable particles and to understand many-body quantum interference.

Method: The paper reviews advanced semiclassical techniques, particularly the many-body version of the van Vleck-Gutzwiller semiclassical propagator, applied to systems of $N$ indistinguishable particles.

Result: It demonstrates a unified framework for analyzing quantum chaotic phenomena, including spectral correlations, eigenstate morphology, weak localization effects, and scrambling of correlations.

Conclusion: The findings enhance the understanding of chaos and interference in many-body quantum systems, contributing to the development of theoretical frameworks in this area.
...
### [95] [Path Integral Approach to Quantum Fisher Information](https://arxiv.org/abs/2604.12763)
*Francis J. Headley,Mahdi RouhbakhshNabati,Henry Harper-Gardner,Daniel Braun,Henning Schomerus,Emre Köse*

Main category: quant-ph

TL;DR: This paper introduces a real-time path-integral approach to the quantum Fisher information, facilitating dynamical parameter estimation without needing to reconstruct quantum states.


<details>
  <summary>Details</summary>
Motivation: The motivation is to streamline quantum parameter estimation methods by expressing the quantum Fisher information in terms of real-time correlators, making it more accessible for many-body physics frameworks.

Method: The authors reformulate the quantum Fisher information using connected symmetrized covariances of time-integrated actions and employ the Schwinger-Keldysh formalism to connect it with contour-ordered correlators.

Result: The reformulated quantum Fisher information aligns with the Keldysh component of contour-ordered correlators and retains applicability in many-body systems.

Conclusion: The paper highlights that classical trajectories play a crucial role in determining metrological sensitivity, thereby linking classical mechanics to quantum measurement results.
...
TL;DR: The paper reviews the development of fine-grained low-dimensional holographic correspondence, focusing on the role of quantum chaos in connecting boundary and bulk theories within the framework of the SYK model and two-dimensional gravity.


<details>
  <summary>Details</summary>
Motivation: To explain the progress in holographic correspondence in the context of quantum chaos and its implications for boundary and bulk theories.

Method: The article examines bridges between bulk and boundary physics, addressing chaotic dynamics at early and late time scales, and highlights the necessity of integrating string theory with semiclassical gravity.

Result: It demonstrates that an understanding of fine-grained quantum scales in this context requires extending semiclassical gravity with elements from string theory.

Conclusion: The authors suggest future research directions towards higher-dimensional extensions of chaotic holographic correspondence.
...
### [97] [Entanglement concentration via measurement:- role of imaginarity](https://arxiv.org/abs/2604.12796)
*Indranil Biswas,Subrata Bera,Ujjwal Sen,Indrani Chattopadhyay,Debasis Sarkar*

Main category: quant-ph

TL;DR: This paper explores the operational benefits of complex-valued measurements in three-qubit entanglement protocols, demonstrating significant enhancements in entanglement concentration and efficiency compared to traditional methods.


<details>
  <summary>Details</summary>
Motivation: To highlight the operational advantages of complex numbers in quantum mechanics, particularly in resource optimization for entanglement protocols.

Method: The study employs complex-valued measurement bases in three-qubit entanglement protocols and modifies an entanglement swapping protocol to analyze performance against standard measurements like the GHZ basis.

Result: Complex measurement bases showed a substantial improvement in bipartite entanglement concentration and outperformed the standard GHZ-basis in a three-qubit setup.

Conclusion: The complex measurement approach not only addresses existing theoretical questions but also demonstrates practical applications in quantum networks, reducing resource requirements significantly.
...
### [98] [Distinguishability of locally diagonal orthogonally invariant quantum states](https://arxiv.org/abs/2604.12808)
*Nathaniel Johnston,Vincent Russo*

Main category: quant-ph

TL;DR: This paper explores the distinguishability of locally diagonal orthogonally invariant quantum states using different measurement techniques, demonstrating that LDOI measurements optimize the distinguishability problem while reducing complexity.


<details>
  <summary>Details</summary>
Motivation: To understand better how local operations and classical communication affect the distinguishability of specific quantum states, particularly under various types of measurements.

Method: The study analyzes optimal PPT and separable measurements for distinguishing locally diagonal orthogonally invariant states, proving that these can always be represented as LDOI measurements, thus simplifying optimization tasks.

Result: The authors find that optimal measurements can be confined to LDOI states, allowing significant reduction in computational complexity. They establish bounds on distinguishability and assert that for many two-qubit cases, LOCC supremum aligns with PPT and separable optimum.

Conclusion: The research reveals that the gap between PPT and LOCC distinguishability is limited, providing insights and measurable frameworks for efficient characterizations of quantum state distinguishability.
...
### [99] [The use of the output states generated by the broadcasting of entanglement in quantum teleportation](https://arxiv.org/abs/2604.12823)
*Iulia Ghiu,Catalina Cirneci,George Alexandru Nemnes*

Main category: quant-ph

TL;DR: The paper establishes a link between maximal teleportation fidelity and the concurrence of $X$ states in quantum channels, demonstrating that nonlocal broadcasting of entanglement enhances both concurrence and teleportation fidelity.


<details>
  <summary>Details</summary>
Motivation: To investigate the relationship between quantum channel properties and teleportation efficiency by analyzing the role of concurrence in entangled states.

Method: The authors prove a theorem correlating the maximal fidelity of teleportation with the concurrence of nonlocal and local entangled states, and assess the effectiveness of these states as quantum channels.

Result: It is shown that output states from nonlocal asymmetric broadcasting exhibit greater concurrence, leading to higher maximal fidelity in quantum teleportation compared to local broadcasting.

Conclusion: All inseparable states produced from both local and nonlocal asymmetric broadcasting are useful for quantum teleportation, with superior outcomes when using nonlocal broadcasting.
...
### [100] [2D quantum-path interference in high-harmonic generation driven by highly-bichromatic fields](https://arxiv.org/abs/2604.12838)
...
TL;DR: The paper presents a new type of quantum-path interference observed in high-harmonic generation driven by a bichromatic field, highlighting distinct modulation patterns in odd and even harmonics.


<details>
  <summary>Details</summary>
Motivation: To explore novel interference phenomena in high-harmonic generation that enable fine control and understanding of electron dynamics on attosecond timescales.

Method: Experimental observation of 2D quantum-path interference in HHG facilitated by an orthogonally-polarized bichromatic field, along with calculations using strong-field approximation and saddle-point methods.

Result: Identification of unique harmonic intensity modulations, revealing monomodal behavior for odd harmonics and bimodal for even harmonics, reflecting the dynamic symmetry of the driving field.

Conclusion: This new form of 2D quantum-path interference enhances HHG spectroscopy, providing deeper insights into attosecond electron dynamics through increased dimensionality of quantum paths.
...
### [101] [Fast and accurate AI-based pre-decoders for surface codes](https://arxiv.org/abs/2604.12841)
*Christopher Chamberland,Jan Olle,Muyuan Li,Scott Thornton,Igor Baratta*

Main category: quant-ph

TL;DR: The paper presents a scalable AI-based pre-decoder for surface code error correction in quantum computing, achieving low decoding runtimes and improved logical error rates, especially with noise-learning architectures.


<details>
  <summary>Details</summary>
Motivation: The necessity for fast and scalable decoding architectures for real-time fault-tolerant quantum computing drives the research, addressing the challenges posed by physical errors in quantum systems.

Method: The introduced pre-decoder processes local errors in parallel and integrates with various global decoding algorithms, offering open-source implementation and optimized performance on NVIDIA GPUs.

Result: The approach achieves end-to-end decoding runtimes of $	ext{O}(1 μ	ext{s})$ per round, with significant reductions possible using multiple GPUs, alongside improved logical error rates compared to global decoding alone.

Conclusion: The results demonstrate a modular and efficient decoding framework that is adaptable to different hardware conditions and capable of enhancing surface-code implementations for practical quantum computing.
...
### [102] [Emission and Absorption of Microwave Photons in Orthogonal Temporal Modes across a 30-Meter Two-Node Network](https://arxiv.org/abs/2604.12947)
...
TL;DR: The paper explores using orthogonal temporal modes of microwave photons for quantum networking, enhancing the selection and transfer of quantum information.


<details>
  <summary>Details</summary>
Motivation: To improve quantum networking by utilizing alternative temporal modes in the encoding of quantum information, beyond traditional symmetric photon wavepackets.

Method: Superconducting quantum circuits are employed to generate individual itinerant microwave photons shaped in three orthogonal temporal modes, which are then transferred via a 30-meter cryogenic link.

Result: Demonstrated a mode-selective absorption at the receiver with a selectivity ratio of 40, allowing for the reflection of unselected modes.

Conclusion: The findings extend the capabilities of microwave-frequency quantum communication by introducing a new photonic degree of freedom through orthogonal temporal modes.
...
### [103] [Hamiltonian Chaos](https://arxiv.org/abs/2604.12976)
*Steven Tomsovic*

Main category: quant-ph

TL;DR: The paper explores the intersection of Hamiltonian chaos and quantum chaos, presenting theoretical tools and conceptual frameworks for understanding chaotic systems.


<details>
  <summary>Details</summary>
Motivation: The paper aims to bridge the gap between Hamiltonian chaos research and quantum chaos, emphasizing their interconnectedness.

Method: It introduces theoretical and computational tools such as surfaces of section, chaos paradigms, stability analysis, and symbolic dynamics, followed by discussions on the geometry of chaos and system responses to perturbations.

Result: The chapter offers intuitive explanations and illustrations of chaos concepts, referencing more rigorous mathematical treatments for further study.

Conclusion: The work underlines the significance of Hamiltonian chaos in understanding quantum chaos through various analytical and visual methods.
...
### [104] [Opportunistic QKD: Exploiting Idle Capacity of Classical WDM Systems](https://arxiv.org/abs/2604.12982)
*Sumit Chaudhary,Pere Munar Vallespir,Alonso Viladomat Jasso,Janis Nötzel*

Main category: quant-ph

TL;DR: The paper presents an opportunistic Quantum Key Distribution (QKD) framework utilizing idle spectral channels in classical fibers, addressing integration challenges with classical traffic while mitigating crosstalk, and demonstrating through simulation a significant potential for repurposing unused spectrum.


<details>
  <summary>Details</summary>
Motivation: To make Quantum Key Distribution (QKD) viable in large-scale environments alongside existing classical systems, addressing the integration and crosstalk challenges.

Method: An opportunistic QKD framework using a stochastic traffic model, Monte-Carlo simulations on an 80-channel WDM system, and modeling of key reservoir states to manage buffer parameters.

Result: Simulations show that 45-65% of unused spectrum can be repurposed for QKD, with key insights on the Reliability Horizon and the impact of buffer reset levels on service continuity.

Conclusion: The proposed framework allows network operators to optimize buffer parameters, enhancing the integration of QKD into classical infrastructures and maintaining service level agreements.
...
### [105] [Quantum-safe IPsec in the banking industry](https://arxiv.org/abs/2604.12985)
...
TL;DR: The paper presents a hybrid quantum-safe architecture using Software-Defined Networking (SDN) for secure communication, addressing the vulnerabilities of classical cryptographic systems in the face of Quantum Computers.


<details>
  <summary>Details</summary>
Motivation: The rise of Cryptographically Relevant Quantum Computers threatens existing cryptographic protocols widely used in financial systems, necessitating the development of quantum-safe communication methods.

Method: A hybrid architecture incorporating Classical Cryptography, Quantum Key Distribution, and Post-Quantum Cryptography is implemented within a Dynamic Multipoint Virtual Private Network, tested on a five-node network across multiple locations.

Result: The architecture successfully demonstrates flexible and scalable quantum-safe communication across various physical and virtual devices, achieving interoperability despite using different key-delivery interfaces.

Conclusion: The proposed framework offers a solid foundation for secure financial communications, ensuring resilience against future quantum threats.
...
### [106] [Classical and Quantum Speedups for Non-Convex Optimization via Energy Conserving Descent](https://arxiv.org/abs/2604.13022)
*Yihang Sun,Huaijin Wang,Patrick Hayden,Jose Blanchet*

Main category: quant-ph

TL;DR: The Energy Conserving Descent algorithm shows significant improvements over traditional gradient descent methods in optimizing non-convex functions, particularly by enabling faster convergence to global minima through stochastic and quantum adaptations.


<details>
  <summary>Details</summary>
Motivation: The study aims to analyze the ECD algorithm's efficiency in escaping local minima, which is crucial for successful optimization in machine learning tasks.

Method: The authors develop a stochastic variant (sECD) with energy-preserving noise and a quantum version (qECD) of the ECD Hamiltonian, investigating their performance on positive double-well objectives.

Result: Both sECD and qECD demonstrate exponential speedup in reaching the global minimum compared to stochastic gradient descent and its quantum counterpart, particularly highlighting qECD's superior performance in overcoming tall barriers.

Conclusion: The findings establish ECD, sECD, and qECD as potent alternatives to traditional optimization methods, suggesting further research into their applications in complex optimization landscapes.
...
### [107] [A complexity phase transition at the EPR Hamiltonian](https://arxiv.org/abs/2604.13026)
*Kunal Marwaha,James Sud*

Main category: quant-ph

TL;DR: The paper investigates the complexity of 2-local Hamiltonian problems with positive-weight interactions, identifying three phases: QMA-complete, StoqMA-complete, and reducible to EPR*. It conjectures that EPR* is in BPP, potentially marking the transition between easy and hard local Hamiltonians.


<details>
  <summary>Details</summary>
Motivation: The study aims to classify the computational complexity of 2-local Hamiltonian problems, which are significant in statistical mechanics and optimization, into distinct complexity phases.

Method: The authors employ perturbative gadgets and a large spin chain analysis via the Jordan-Wigner transformation to delineate the complexity classes and investigate EPR*.

Result: The paper categorizes 2-local Hamiltonian problems into three complexity phases and presents EPR* as a pivotal problem that may have an efficient algorithm, conjectured to be in BPP.

Conclusion: The findings suggest that EPR* could represent the boundary between easy and hard local Hamiltonians, with implications for the broader understanding of computational complexity in quantum systems.
...
### [108] [Floquet Many-Body Cages](https://arxiv.org/abs/2604.13027)
*Tom Ben-Ami,Roderich Moessner,Markus Heyl*

Main category: quant-ph

TL;DR: This paper explores engineering many-body cages in Floquet circuits to create novel nonequilibrium quantum states.


<details>
  <summary>Details</summary>
Motivation: To advance the understanding of nonergodic behavior in quantum matter using many-body cages.

Method: Identification of a general construction for Floquet circuits and a strategy to engineer many-body cages, exemplified through the quantum hard disk model.

Result: Demonstration of Floquet many-body cages with topological features and time crystalline order in a specific model system.

Conclusion: The findings provide a new approach to engineer nonequilibrium dynamics in quantum circuits.
...
### [109] [Zeno Blockade Enabling Photonic Quantum Optimization](https://arxiv.org/abs/2604.13032)
*Mohammad-Ali Miri,Uchenna Chukwu,Nicholas Chancellor*

Main category: quant-ph

TL;DR: The paper proposes an optical quantum optimizer leveraging non-linear optics to find a maximum independent set using Zeno effects, with emphasis on error mitigation and performance comparison.


<details>
  <summary>Details</summary>
Motivation: To explore quantum optimization techniques using optical methods and address the limitations of existing paradigms.

Method: Utilizing sum-frequency generation and two-photon absorption along with Zeno effects, the method implements a linear protocol for maximizing independent sets with weighted elements.

Result: The study shows that coherent applications of the Zeno effect outperform incoherent ones, indicating a path for building an effective optical quantum optimizer.

Conclusion: The proposed device could advance quantum optimization, with emphasis on error mitigation strategies, especially for photon loss.
...
### [110] [Partial majorization and Schur concave functions on the sets of quantum and classical states](https://arxiv.org/abs/2604.13033)
*M. E. Shirokov*

Main category: quant-ph

TL;DR: This paper establishes tight upper bounds on the differences of Schur concave functions evaluated at quantum states, focusing on partially majorized states. It introduces the concept of $\,rac{1}{2}\
orm{ρ−σ}\\_1≤ε$ and provides conditions for the bounds to vanish. The results have applications to von Neumann entropy and Gibbs states, with potential reformulations for probability distributions.


<details>
  <summary>Details</summary>
Motivation: The need for precise upper bounds of Schur concave functions across quantum states, particularly in the context of quantum information theory and partial majorization, drives this research.

Method: The paper constructs analytical upper bounds on the difference of Schur concave functions using the frameworks of quantum states, partially majorized states, and incorporates conditions related to the 1-norm distance.

Result: Tight bounds for the difference $f(ρ)-f(σ)$ under given conditions, including insights into $rac{1}{2}
orm{ρ-σ}
orm_1	o rac{1}{m}	o 0$ and ramifications for the von Neumann entropy and Gibbs states.

Conclusion: The findings enhance the understanding of majorization in quantum states and expand the applicability of Schur concave functions, with implications for statistical mechanics and quantum information.
...
### [111] [21 cm Power Spectrum Analysis of North Celestial Pole Observations with the Tianlai Dish Pathfinder Array](https://arxiv.org/abs/2604.12200)
...
TL;DR: The Tianlai Dish Pathfinder Array successfully establishes data analysis methods for 21 cm intensity mapping, focusing on large-scale cosmic structure.


<details>
  <summary>Details</summary>
Motivation: To measure large-scale cosmic structure in the post-reionization universe through 21 cm intensity mapping techniques.

Method: Data were processed using techniques including RFI flagging, calibration, imaging, and SVD-based foreground removal, leading to the computation of the spherically averaged power spectrum.

Result: A comprehensive data analysis framework was validated, with key improvements identified for future studies.

Conclusion: Enhancements in sky modeling and optimization are crucial for future 21 cm signal detection in correlation with optical galaxy surveys.
...
### [112] [In Situ Interferometric Spatial Mapping Of A Microwave Kinetic Inductance Detector Array](https://arxiv.org/abs/2604.12287)
...
TL;DR: This paper introduces a novel method for spatially mapping MKID arrays using a cryogenic interferometer, improving accuracy as pixel spacing decreases.


<details>
  <summary>Details</summary>
Motivation: To accurately map the spatial locations of MKIDs in kilopixel arrays for astronomical applications where pixel spacings are very small.

Method: A cryogenic interferometer in reflection mode is employed to map MKIDs, leveraging the phase accumulation from on-resonance signals reflecting from the MKIDs.

Result: The mapping technique successfully measures a length ordering that aligns with the nonlinear kinetic inductance properties of a 44 pixel MKID array designed for PRIMA.

Conclusion: This new method enhances the precision of MKID spatial mapping, which is crucial for the effective deployment of kilopixel arrays in telescope applications.
...
### [113] [FRTSearch: Unified Detection and Parameter Inference of Fast Radio Transients using Instance Segmentation](https://arxiv.org/abs/2604.12344)
...
TL;DR: FRTSearch is an advanced framework for detecting and characterizing Fast Radio Transients, addressing challenges of traditional methods by utilizing a new dataset and algorithms, achieving high accuracy and speed.


<details>
  <summary>Details</summary>
Motivation: The increasing volume of data from modern radio telescopes and the limitations of existing single-pulse search algorithms, particularly regarding false positives due to RFI, necessitate a more efficient detection method for Fast Radio Transients.

Method: FRTSearch uses pattern recognition based on the cold plasma dispersion relation, supported by the CRAFTS-FRT dataset for training a Mask R-CNN model. The process includes trajectory segmentation and applies the IMPIC algorithm for inferring Dispersion Measure (DM) and Time of Arrival (ToA).

Result: FRTSearch achieved a recall of 98.0%, surpassed traditional methods by reducing false positives by over 99.9%, and provided a processing speedup of up to 13.9 times compared to existing solutions.

Conclusion: By transitioning to a 'detect-and-infer' methodology, FRTSearch offers a scalable, precise approach suitable for real-time detection during the increasingly data-intensive era of radio astronomy.
...
### [114] [Spin-Momentum Decoupling in Quarkonium Hadronization: Polarization Quenching via Environment-Induced Decoherence in Jets](https://arxiv.org/abs/2604.11847)
*Yi Yang*

Main category: hep-ph

TL;DR: The paper proposes an open-quantum-system approach to explain the quarkonium polarization suppression at high transverse momentum, emphasizing the decoupling of spin states during hadronization and introducing an effective temperature influenced by parton multiplicity.


<details>
  <summary>Details</summary>
Motivation: To address the longstanding challenge of understanding the polarization suppression of heavy quarkonium in high energy collisions as predicted by Quantum Chromodynamics (QCD).

Method: An open-quantum-system framework is introduced, combining non-relativistic QCD calculations with a model of stochastic chromo-electric fields in jets. An effective temperature, derived from parton multiplicity, is incorporated into a Lindblad-type dissipation approach.

Result: The framework predicts simultaneous quenching of angular anisotropies and provides a phase-space description consistent with recent experimental observations of soft fragmentation, linking them to the suppression phenomenon.

Conclusion: A key testable result is identified: the $z$-dependent suppression of three parameters related to quarkonium polarization, offering a method to validate the proposed model against experimental data.
...
### [115] [Spin Correlation and Quantum Entanglement of Fermion Pairs in Transversely Polarized $e^-e^+$ Collisions](https://arxiv.org/abs/2604.11887)
*Yi-Jing Fang,Amit Bhoonah,Kun Cheng,Tao Han,Yandong Liu,Hao Zhang*

Main category: hep-ph

TL;DR: This study demonstrates how transversely polarized electron-positron collisions enhance spin correlations and quantum entanglement across various processes, highlighting their potential in quantum information applications at colliders.


<details>
  <summary>Details</summary>
Motivation: To explore how transverse polarization affects spin correlations and entanglement in electron-positron collisions, revealing new opportunities for quantum information.

Method: We analyze spin correlations and entanglement in $e^-e^+$ collisions, examining QED and electroweak processes, focusing on the effects of transverse polarization.

Result: The study shows maximally entangled states arise in QED processes under transverse polarization, with electroweak and Bhabha processes also benefiting, though entanglement is slightly diluted in the latter.

Conclusion: Transverse polarization significantly enhances entanglement, making it a valuable resource for quantum information in high-energy collider experiments.
...
### [116] [ALP production in Lepton Flavour Violating meson, tau and gauge boson decays](https://arxiv.org/abs/2604.11889)
*Marco Ardu,Lorenzo Calibbi,Marco Fedele,Federico Mescia*

Main category: hep-ph

TL;DR: The paper explores axion-like particles (ALPs) with lepton-flavour-violating (LFV) couplings above the muon mass threshold, highlighting new production strategies via various particle decays and assessing future experimental sensitivities.


<details>
  <summary>Details</summary>
Motivation: To investigate ALPs with LFV couplings in a mass range where traditional constraints are no longer applicable, thus enabling new search methods for their detection.

Method: The authors analyze ALPs produced in decay processes involving charged mesons, W and Z bosons, and tau decays, focusing on the decay channel a→eμ which provides distinctive LFV signatures.

Result: Identified new production modes of LFV ALPs with low backgrounds in high-energy tests, and evaluated sensitivities for next-generation colliders and fixed-target experiments.

Conclusion: LFV ALP production offers a novel approach to probing ALP interactions with charged leptons, highlighting it as a promising area for future research.
...
### [117] [Operator structure of power corrections and anomalous scaling in energy correlators](https://arxiv.org/abs/2604.11967)
*Hao Chen,Yibei Li*

Main category: hep-ph

TL;DR: This paper investigates energy correlators in quantum chromodynamics, revealing universal anomalous scaling through light-ray operators and providing a framework connecting operator theory with collider physics.


<details>
  <summary>Details</summary>
Motivation: To rigorously explore non-perturbative power corrections in quantum chromodynamics using energy correlators.

Method: The authors utilize light-ray operators and perform explicit loop calculations to derive the one-loop anomalous dimension, analyzing the necessary combination of the dijet operator with a specific triple-jet component.

Result: The study uncovers the quantum field-theoretic basis for the observed universal anomalous scaling in energy-energy correlators and establishes a first-principles framework.

Conclusion: The findings link operator theory to high-precision collider phenomenology, enhancing our understanding of non-perturbative effects in quantum chromodynamics.
...
### [118] [The 3-3-1 Model: a natural framework for sub-MeV dark matter](https://arxiv.org/abs/2604.12121)
*Vinicius Oliveira,D. Cogollo,A. Doff,C. A. de S. Pires*

Main category: hep-ph

TL;DR: This paper presents a model providing a sub-MeV dark matter candidate through gravitational effects and the freeze-in mechanism, suitable for current and future collider tests.


<details>
  <summary>Details</summary>
Motivation: To identify a viable dark matter candidate within a specific gauge symmetry framework while addressing mass generation mechanisms.

Method: The $	ext{SU}(3)_C 	imes 	ext{SU}(3)_L 	imes 	ext{U}(1)_N$ model incorporates right-handed neutrinos and investigates the pseudo-Goldstone boson as a dark matter candidate, utilizing gravitational effects for mass acquisition and the freeze-in process for relic abundance.

Result: The model successfully accommodates dark matter that is consistent with observations, generating the observed relic density without requiring very small couplings or higher reheating temperatures.

Conclusion: The proposed model is operational at the TeV scale and is amenable to verification through ongoing and upcoming collider experiments.
...
### [119] [Effect of $K^*$ meson magnetic dipole moment on the $e^+e^- \to K^+ K^-π^0 π^0 $ cross section](https://arxiv.org/abs/2604.12150)
*Luis A. Jiménez Pérez,Antonio Rojas,Genaro Toledo*

Main category: hep-ph

TL;DR: The paper investigates how the magnetic dipole moment (MDM) of the $K^*$ meson affects the cross section of the reaction $e^{+} e^{-} 	o K^+ K^- 2 π^0$, using BaBar data and a vector meson dominance model.


<details>
  <summary>Details</summary>
Motivation: Understanding the MDM of the $K^*$ meson can provide insights into the structure of this particle and help validate theoretical models.

Method: The authors utilize a vector meson dominance model to express the $γ^* 	o 2K2π$ vertex and analyze BaBar data to assess the dependence of the cross section on the $K^*$ MDM.

Result: They derive a central value for the $K^*$ MDM as $μ_{K^*} = 4.5$ and an upper limit of $arμ_{K^*} = 6.3$, measured in terms of physical constants.

Conclusion: The study highlights the necessity for more precise data to obtain a robust experimental determination of the $K^*$ MDM, which can be compared with theoretical predictions.
...
### [120] [Deciphering the nature of $P^Σ_{ψs}$ pentaquarks in the light of their electromagnetic multipole moments](https://arxiv.org/abs/2604.12533)
*Ulaş Özdem*

Main category: hep-ph

TL;DR: This study computes electromagnetic multipole moments of strange hidden-charm pentaquarks using QCD light-cone sum rules, focusing on both spin-1/2 and spin-3/2 states.


<details>
  <summary>Details</summary>
Motivation: The motivation lies in understanding the electromagnetic properties of newly explored pentaquarks, which can provide insights into their structure and interactions through the analysis of multipole moments.

Method: The authors employ QCD light-cone sum rules with diquark-diquark-antiquark interpolating currents, covering spin-1/2 and spin-3/2 configurations to calculate moments like magnetic dipole, electric quadrupole, and magnetic octupole.

Result: Findings indicate charm dominance in scalar diquark currents with certain moments being flavor-insensitive, while larger, flavor-sensitive moments arise from axial-vector currents. The study provides the first quark-flavor decomposition and insights into the deformations and correlations of the multipole moments.

Conclusion: The results offer critical benchmarks for lattice QCD comparisons and contribute to distinguishing pentaquark configurations, inviting further exploration in electromagnetic characteristics.
...
### [121] [Two component pseudo-Nambu-Goldstone-boson dark matter](https://arxiv.org/abs/2604.12435)
*Riasat Sheikh,Takashi Toma,Koji Tsumura*

Main category: hep-ph

TL;DR: The paper presents a two-component pseudo-Nambu-Goldstone-boson dark matter model with suppressed scattering and automatic stability, analyzing relic abundance and BDM dynamics.


<details>
  <summary>Details</summary>
Motivation: To develop a dark matter model that aligns with boosted dark matter while minimizing unwanted scattering and ensuring stability of multiple components.

Method: Utilizes a complex scalar field under a dark U(1)_V gauge symmetry, with a softly broken global SU(3)_g symmetry, analyzing relic abundance, freeze-out dynamics, and scattering cross sections.

Result: Identifies stable pNGB dark matter candidates with a controlled hierarchy through soft-breaking parameters, meeting requirements for boosted dark matter.

Conclusion: The model successfully provides a mechanism for dark matter hierarchy and stability without introducing arbitrary tunings, and satisfies relevant constraints.
...
### [122] [Neutrinoless double-beta decay of the $Δ^-$ resonance](https://arxiv.org/abs/2604.12535)
*Li-Ping He,Feng-Kun Guo,Ulf-G. Meißner,De-Liang Yao,Xiao-Yu Zhang,Zhen-Hua Zhang*

Main category: hep-ph

TL;DR: The study explores the neutrinoless double-beta decay through the subprocess $nn \to ppe^-e^-$ with a focus on $\Delta$ resonance, utilizing chiral effective field theory.


<details>
  <summary>Details</summary>
Motivation: Understanding the subprocess $nn \to ppe^-e^-$ is essential for interpreting neutrinoless double-beta decay, particularly the role of intermediate $\Delta$ resonances in enhancing transitions.

Method: The authors derive long-range contributions via light-Majorana-neutrino exchange loop diagrams and short-range components via renormalization counterterms in chiral effective field theory, focusing on the $\Delta^- \to p e^-e^-$ decay.

Result: The study predicts the pion-mass dependence of the decay amplitude for collinear electrons and calculates the amplitude in the limit of degenerate $\Delta$-nucleon masses, aiding in lattice-QCD matching.

Conclusion: This work lays the foundation for a comprehensive description of the neutrinoless double-beta decay process by incorporating the effects of $\Delta$ resonances.
...
### [123] [Mass creation by the strong interaction: Glueballs -- status and perspectives](https://arxiv.org/abs/2604.12895)
*Ulrich Wiedner*

Main category: hep-ph

TL;DR: Glueballs, composed of multiple gluons, are massive particles resulting from the strong interaction's color charges, offering insights into mass creation in strongly interacting systems.


<details>
  <summary>Details</summary>
Motivation: Understanding glueballs can shed light on the complexities of strong interactions and the role of color charge in mass formation.

Method: The study explores the properties and interactions of glueballs, focusing on how color charges influence their mass.

Result: Glueballs are shown to become massive due to the interactions between gluons' color charges, despite gluons being massless on their own.

Conclusion: Investigating glueballs provides valuable information on the mechanisms behind mass generation in strongly interacting particles.
...
### [124] [Next-to-next-to-next-to-leading order QCD corrections to photon-pair production](https://arxiv.org/abs/2604.12613)
*Michal Czakon,Felix Eschment,Terry Generet,Rene Poncelet*

Main category: hep-ph

TL;DR: The paper presents ${	ext{N}^3}$LO predictions for isolated photon production in high-energy hadron collisions, addressing challenges in perturbative QCD and demonstrating perturbative convergence at the LHC.


<details>
  <summary>Details</summary>
Motivation: To address the difficulties in predicting isolated photon production due to large NNLO corrections in perturbative QCD.

Method: The authors utilize ${	ext{N}^3}$LO calculations to provide improved predictions for photon production in hadron collisions.

Result: The study demonstrates perturbative convergence and provides insights into the computational challenges involved.

Conclusion: The findings enhance understanding of photon production at the LHC, confirming the viability of ${	ext{N}^3}$LO predictions in mitigating NNLO corrections.
...
### [125] [Graviton Production from Inflaton Condensate: Boltzmann vs Bogoliubov](https://arxiv.org/abs/2604.12687)
*Chenhuan Wang,Yong Xu,Wenbin Zhao*

Main category: hep-ph

TL;DR: The paper compares Boltzmann and Bogoliubov methods for analyzing graviton production during reheating from an oscillating inflaton, revealing key differences, especially for steeper inflaton potentials.


<details>
  <summary>Details</summary>
Motivation: To understand graviton production dynamics during reheating and clarify the efficacy of two analytical frameworks (Boltzmann vs. Bogoliubov) in different potential regimes.

Method: The authors systematically compare both frameworks for inflaton potentials of the form V(φ)∝φ^n, analyzing graviton spectra and deriving analytic approximations.

Result: For n=2, both approaches yield identical graviton spectra at short wavelengths. For n>2, significant non-adiabatic contributions arise, which are captured by the Bogoliubov formalism but not by Boltzmann.

Conclusion: The Bogoliubov framework is essential for accurate graviton production descriptions with steeper inflaton potentials due to its ability to incorporate non-adiabatic transitions, contrasting with the limitations of the Boltzmann approach.
...
### [126] [Hydrodynamic Initial Conditions in Small Systems from Proton Phase-Space Entropy](https://arxiv.org/abs/2604.12691)
*Gabriel Rabelo-Soares,Gojko Vujanovic,Giorgio Torrieri*

Main category: hep-ph

TL;DR: The paper addresses the challenge of linking quantum states of protons to classical hydrodynamic behavior in collisions by introducing Wehrl-like entropy as a measure for initial conditions.


<details>
  <summary>Details</summary>
Motivation: To reconcile the quantum nature of protons with the classical framework of hydrodynamics in the context of particle collisions.

Method: The authors utilize Wehrl-like entropy to quantitate the coarse-graining of the phase-space distribution of protons, allowing for a bridge between quantum states and classical entropy models.

Result: The study demonstrates that Wehrl-like entropy provides a semi-classical measure of microstate density, aiding in defining initial conditions for hydrodynamic evolution in small collision systems.

Conclusion: Wehrl-like entropy is a suitable measure for characterizing entropy deposition, enhancing the understanding of hydrodynamic behavior from quantum origins.
...
### [127] [Probing muon anomaly and lepton flavor violation with scalar leptoquarks in the 331LHN model](https://arxiv.org/abs/2604.12755)
*D. T. Binh,V. H. Binh,H. T. Hung,Duong Van Loi*

Main category: hep-ph

TL;DR: The paper explores an extension of the $SU(3)_C 	imes SU(3)_L 	imes U(1)_X$ model by introducing scalar leptoquarks, addressing the discrepancy in the muon anomalous magnetic moment and analyzing the implications for collider searches.


<details>
  <summary>Details</summary>
Motivation: To address the $4.2σ$ discrepancy in the muon anomalous magnetic moment, identified in previous findings, and explore the viability of scalar leptoquarks within an extended theoretical framework.

Method: The authors introduce scalar leptoquarks into the 331LHN model and determine their Yukawa interactions. They analyze constraints on leptoquark mass based on muon anomalous magnetic moment data and investigate collider signatures.

Result: The study finds that a singlet leptoquark can explain the muon anomaly, with mass constraints evolving from approximately 1.8 TeV to over 6 TeV based on updated data, while establishing a hierarchical pattern for Yukawa couplings.

Conclusion: Future hadron colliders could provide greater discovery potential for these leptoquarks, as current LHC searches yield suppressed signal rates due to their high masses.
...
### [128] [Operator Identification in Charged Lepton-Flavor Violation: Global EFT Analysis with RG Evolution, Polarization Observables, and Bayesian Model Discrimination at Future Colliders](https://arxiv.org/abs/2604.12844)
*Nicolás Viaux M*

Main category: hep-ph

TL;DR: This paper analyzes charged lepton-flavor violation through a global effective field theory framework across multiple collider environments, focusing on operator identification and incorporating various experimental data.


<details>
  <summary>Details</summary>
Motivation: To probe physics beyond the Standard Model via charged lepton-flavor violation, a critical area for identifying new physics.

Method: A global EFT analysis is performed using data from various colliders, incorporating low-energy constraints, differential observables, and decay channel information, along with simulations and renormalization effects.

Result: The analysis reveals significant shifts in operator correlation entries when comparing tree-level and RG-evolved coefficients, demonstrating the complexity of operator mixing at multi-TeV scales.

Conclusion: The research provides a comprehensive framework for exploring lepton-flavor violation, including a full code chain for reproducibility of event generation and analysis.
