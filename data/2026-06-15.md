...
### [1] [Fast Timing and TCT Measurement Results of CNM Double-Sided 3D Sensors](https://arxiv.org/abs/2606.13895)
...
TL;DR: The study evaluates the performance of silicon 3D sensors for high-energy physics applications, focusing on their timing resolution and radiation hardness under proton irradiation.


<details>
  <summary>Details</summary>
Motivation: To improve timing capabilities in high-energy physics tracking detectors, particularly in high multiplicity event scenarios in future colliders like the FCC-hh.

Method: Double-sided 3D sensors with hexagonal and orthogonal layouts were designed and produced, followed by IV, top-TCT, and timing measurements on both unirradiated and proton irradiated structures.

Result: Irradiated sensors showed decreased leakage current and maintained a time resolution of approximately 65 ps, with strong charge collection observed and slight degradation compared to unirradiated sensors.

Conclusion: The 3D silicon sensors demonstrate excellent performance in high radiation environments, making them viable for future hadron collider applications.
...
### [2] [Silicon Photomultipliers in the CMS Upgrade](https://arxiv.org/abs/2606.13956)
*A. Heering,A. Karneyeu,Y. Musienko,M. Wayne*

Main category: physics.ins-det

TL;DR: Silicon Photomultipliers (SiPMs) are critical for CMS detector upgrades at the LHC, particularly in Phase I and II subdetectors, facing and overcoming unique challenges.


<details>
  <summary>Details</summary>
Motivation: SiPMs provide superior performance as photodetectors for the upgraded CMS detector, crucial for precision measurements and enhanced detector capabilities.

Method: The paper discusses the implementation of SiPMs in the HCAL and the design and upgrade processes for the BTL and HGCAL subdetectors in phases I and II.

Result: It highlights the extensive utilization of SiPMs in multiple subdetectors and the technical advancements achieved from Phase I to Phase II.

Conclusion: The transition to SiPMs marks a significant improvement in the performance of the CMS detector, overcoming inherent challenges presented in the upgrade process.
...
### [3] [Seeding and Matching algorithms for the first GPU-based High Level Trigger of the LHCb experiment](https://arxiv.org/abs/2606.14480)
...
TL;DR: This paper presents a GPU implementation of Seeding and Matching algorithms for the LHCb experiment, enhancing track reconstruction efficiency at 40 MHz and improving physics reach.


<details>
  <summary>Details</summary>
Motivation: To optimize track reconstruction for long and displaced tracks during LHCb's Run 3, increasing the experiment's physics capabilities.

Method: The Seeding algorithm recognizes charged particle trajectories in the forward tracker, while the Matching algorithm integrates these trajectories with stubs from the first tracker to construct Long tracks, subsequently refining them with data from the second tracker.

Result: The implementation achieved high throughput, successfully participating in data acquisition and improving Long track efficiency, especially at low transverse momenta.

Conclusion: This backward reconstruction process complements existing methods and enhances the potential for exploring significant physics decay channels.
...
### [4] [IceCube Real-time Searches for High-energy Neutrinos Coincident with LIGO/Virgo/KAGRA Gravitational-Wave Alerts in O4a](https://arxiv.org/abs/2606.13762)
...
TL;DR: The paper analyzes gravitational-wave events for associated high-energy neutrinos using IceCube data, reporting no significant emissions but improving detection methods.


<details>
  <summary>Details</summary>
Motivation: To explore the connection between gravitational-wave events from mergers of compact objects and high-energy neutrinos, potentially deepening our understanding of astrophysical phenomena.

Method: Data from 85 significant and 945 low-significance gravitational-wave events were analyzed using two statistical methods: an unbinned maximum likelihood analysis and a Bayesian analysis, searching for neutrino emissions coincident with these events.

Result: No statistically significant neutrino emissions were detected from the gravitational-wave events, but upper limits on neutrino flux and energy were established.

Conclusion: Improvements in detection methods were confirmed, yet the study found no direct evidence for high-energy neutrino emissions associated with the analyzed gravitational-wave events.
...
### [5] [Resolving the temporal evolution of M87 jet with $\lesssim0.1$-arcsec Chandra observations](https://arxiv.org/abs/2606.13800)
*Camille Poitras,Gerrit Schellenberger,Ralph Kraft,Paul Nulsen,Marie-Lou Gendron-Marsolais,Eileen Meyer*

Main category: astro-ph.HE

TL;DR: A 13-year Chandra study of the M87 jet reveals complex structures and a significant decrease in X-ray emission, indicating synchrotron cooling and providing insights into particle acceleration processes.


<details>
  <summary>Details</summary>
Motivation: To investigate the structure and temporal evolution of the M87 jet using high-resolution X-ray imaging over an extended temporal baseline.

Method: Point-spread-function deconvolution was employed to enhance the X-ray resolution, revealing detailed structures and flux measurements.

Result: Deconvolved images showed a global decrease in X-ray emission of up to 84%, with minimum magnetic field strengths of ~324-1006 μG for HST-1. Jet features exhibited up to 4.8 c superluminal motion, highlighting biases from unresolved blending.

Conclusion: This research underscores the ability of high-resolution X-ray imaging to resolve the dynamics of relativistic jets and elucidate the processes of particle acceleration and energy dissipation.
...
### [6] [Observational Biases and Improved Modelling of Off-axis Relativistic Jets](https://arxiv.org/abs/2606.13806)
*A. J. Cooper,A. P. Scott,L. Rhodes,F. Carotenuto,A. K. Hughes,J. H. Matthews,K. Savard,F. J. Cowie,E. L. Elley,C. Lilje,R. Fender*

Main category: astro-ph.HE

TL;DR: The paper explores how relativistic Doppler boosting impacts the observation and modeling of astrophysical jets, demonstrating techniques to improve parameter estimation via non-detections and addressing observational biases through case studies of two X-ray binaries.


<details>
  <summary>Details</summary>
Motivation: To address the biases in observing relativistic jets caused by Doppler boosting, which can mislead parameter estimation and interpretation.

Method: The study analyzes two X-ray binary case studies (MAXI J1535-571 and MAXI J1820+070) to assess observational biases, employing kinematic modeling that incorporates the non-detection of receding jet components.

Result: Incorporating non-detections improves parameter estimation, reducing uncertainties by over 40% and revealing a common powerlaw evolution in jet components, while underscoring the bias against detecting high-Lorentz-factor and receding jets.

Conclusion: Observational strategies significantly influence the detection of relativistic jets; leveraging non-detections can enhance the analysis of jetted transients in future gravitational-wave and optical observations.
...
### [7] [Twisted-pair unilateral reconnection: A unifying driver for magnetically powered astrophysical bursts](https://arxiv.org/abs/2606.13953)
...
TL;DR: The first direct observation of twisted loop magnetic reconnection in a solar flare reveals extreme twists enabling efficient reconnection and an identified common mechanism for energetic cosmic events.


<details>
  <summary>Details</summary>
Motivation: To directly observe and understand the mechanism behind magnetic reconnection in twisted loops, which powers various energetic cosmic phenomena.

Method: The study involved observing a solar flare with a twisted magnetic loop and analyzing the current sheet emissions, identifying relationships between oscillation frequencies and magnetic field strengths.

Result: The researchers documented a 540-degree twist in the magnetic loop, confirmed the current sheet as a particle accelerator and established a power-law relationship across various cosmic phenomena.

Conclusion: These findings pave the way for new theories and simulations about magnetic reconnection, providing insights into the mechanisms behind magnetically powered bursts.
...
### [8] [Electron-capture Supernova Candidates from Light Curves: Implications for Their Progenitors and Explosion Properties](https://arxiv.org/abs/2606.14044)
...
TL;DR: The paper investigates electron-capture supernovae (ECSNe) candidates from Type II supernovae literature, identifying ten candidates and determining their explosion energies, suggesting a need for further spectroscopy to confirm ECSNe and refine occurrence ratios.


<details>
  <summary>Details</summary>
Motivation: To identify additional candidates for electron-capture supernovae, which have been sparsely observed, especially given the recent discovery of SN 2018zd.

Method: A color-based diagnostic was applied to Type II supernovae literature and a public sample from the Zwicky Transient Facility; candidates were classified into 'gold' and 'silver' based on spectral analysis and light curve comparisons with radiation-hydrodynamical models.

Result: The explosion energies for 'gold candidates' range from 0.4 to 1.7 x 10^50 erg, and for 'silver candidates' from 0.4 to 2.7 x 10^50 erg. The inferred occurrence ratios of ECSNe among Type II SNe are estimated as 3.0% and 15.7% for 'gold' and 'silver' candidates, respectively.

Conclusion: Spectroscopic follow-ups of ECSN candidates are crucial for confirmation and to improve the understanding of ECSN occurrence ratios.
...
### [9] [Licence to Bin: Accurate and Scalable Inference for Binary Neutron Stars in Next-Generation Gravitational-Wave Detectors](https://arxiv.org/abs/2606.14197)
*Nir Guttman,A. Makai Baker,Paul D. Lasky,Eric Thrane*

Main category: astro-ph.HE

TL;DR: Next-gen gravitational-wave observatories require innovative methods for Bayesian parameter estimation, especially for long-duration binary neutron-star signals. This paper introduces a modified reduced-order quadrature that addresses memory and accuracy challenges, enabling efficient inference for signals previously deemed intractable.


<details>
  <summary>Details</summary>
Motivation: Next-generation gravitational-wave detectors will significantly enhance the detection of binary neutron-star (BNS) mergers, posing computational challenges for parameter estimation due to longer signal durations and broader frequency ranges.

Method: The paper presents a practical reduced-order quadrature approach, combining adaptive frequency sampling, disk-backed streaming, and subbanded quadrature construction to enable accurate and efficient modeling of long BNS signals with time-dependent detector responses.

Result: Successful implementation of reduced-order Bayesian inference on a ~2-hour BNS signal with a signal-to-noise ratio of 2090, demonstrating sufficient accuracy in a practical timeframe of ~48 hours using 128 CPU cores.

Conclusion: The method enhances the feasibility of reduced-order techniques for next-gen gravitational-wave inference, ensuring accurate signal localization crucial for multimessenger astronomy.
...
### [10] [Fortifying gravitational-wave population inference with normalizing flows](https://arxiv.org/abs/2606.14229)
*Christian Adamcewicz,Hugh McDougall,Paul D. Lasky,Eric Thrane*

Main category: astro-ph.HE

TL;DR: The paper discusses limitations in the LIGO-Virgo-KAGRA gravitational-wave transient catalog, highlighting that the growing number of binary black hole merger events can lead to significant numerical errors in population inferences regarding astrophysical parameters. It proposes using nested samples for immediate improvements and advocates for the long-term use of normalizing flows for accurate posterior sample representation.


<details>
  <summary>Details</summary>
Motivation: To address the challenges in inferring population properties of binary black holes from the growing LIGO-Virgo-KAGRA catalog, specifically the numerical errors arising from posterior sample approximations when combining numerous events.

Method: The paper evaluates the use of nested samples for short-term improvements in population inferences and proposes the application of normalizing flows as a more robust long-term solution to accurately represent each event's posterior samples.

Result: Combining more than 300 binary black hole merger events leads to substantial numerical errors in population analyses, affecting the reliability of astrophysical parameter distribution measurements.

Conclusion: Nested samples can temporarily enhance accuracy, but for sustained reliability, implementing normalizing flows to generate extensive new posterior samples is recommended.
...
### [11] [Exploring the nature of Galactic unassociated sources detected by the Fermi-LAT](https://arxiv.org/abs/2606.14244)
...
TL;DR: The study analyzes unassociated gamma-ray sources near the Galactic plane, identifying unique spectral features and exploring potential origins, including diffusion emission modeling and star-forming regions.


<details>
  <summary>Details</summary>
Motivation: To better understand the characteristics and potential origins of unassociated gamma-ray sources identified in the Fermi-LAT 4FGL-DR4 catalog, which represent a significant portion of the catalog.

Method: Utilized machine learning for classification, analyzed spectral properties, and conducted simulations to explore origins—including possible connections to diffuse emission.

Result: Identified soft Galactic unassociated sources (SGUs) with unique spectral characteristics and complex Galactic distributions; found star-forming regions account for up to 10% of these sources, but the overall nature remains ambiguous.

Conclusion: While it is plausible SGUs arise from diffuse emission, the possibility of them constituting a new class of gamma-ray emitters has not been ruled out.
...
### [12] [Multiwavelength Analysis of the Einstein Probe X-ray Transient EP240305a](https://arxiv.org/abs/2606.14341)
...
TL;DR: EP240305a is an uncatalogued X-ray transient observed across multiple wavelengths, showing unique flares and spectral evolution that suggest it is a novel type of astronomical transient.


<details>
  <summary>Details</summary>
Motivation: To investigate a newly detected X-ray transient, EP240305a, and understand its behavior and classification compared to known transients.

Method: Multiwavelength observations were conducted using X-ray, optical, near-infrared, and radio bands to analyze the characteristics and evolution of EP240305a.

Result: EP240305a exhibited significant X-ray flares and spectral evolution indicative of discrete jet ejection, ruling out traditional transient classifications.

Conclusion: The findings suggest EP240305a may represent a new category of transient, highlighting the importance of sensitive surveys and rapid follow-up observations in understanding unusual astronomical events.
...
### [13] [Simulating observed point-symmetric core-collapse supernova morphologies with the jittering jets explosion mechanism](https://arxiv.org/abs/2606.14364)
*Jessica Braudo,Amir Michaelis,Muhammad Akashi,Noam Soker*

Main category: astro-ph.HE

TL;DR: This study explores the jittering-jets explosion mechanism in core-collapse supernovae through detailed hydrodynamic simulations, highlighting the formation of complex morphological features in supernova remnants that single jets or instabilities can't explain.


<details>
  <summary>Details</summary>
Motivation: To better understand the explosion mechanism of core-collapse supernovae and reproduce the diverse morphological characteristics observed in supernova remnants.

Method: Conducted two 3D hydrodynamic simulations of the jittering-jets explosion mechanism, launching three pairs of inclined jets into a stellar core and tracking their interactions over time.

Result: The simulations produced a point-symmetric morphology and various features resembling actual supernova remnants, including blowouts and complex clumping.

Conclusion: The findings support the jittering-jets mechanism as the primary driver of supernova explosions, explaining the diverse structures observed in remnants.
...
### [14] [Transitions in the Mass-ratio and Spin Properties of Binary Black Holes in GWTC-5](https://arxiv.org/abs/2606.14472)
*Elizabeth Flanagan,Fabio Antonini,Thomas Callister,Debatri Chattopadhyay,Fani Dosopoulou,Isobel Romero-Shaw*

Main category: astro-ph.HE

TL;DR: This study investigates the mass-ratio and effective-spin distributions of binary black hole mergers from GWTC-5, revealing distinct mass regions with different properties.


<details>
  <summary>Details</summary>
Motivation: Understanding the properties of binary black hole mergers can provide insights into their formation and evolutionary channels.

Method: Hierarchical Bayesian inference with flexible Gaussian-process population models was employed to analyze distributions as functions of primary mass.

Result: Four distinct mass regions were identified with varying mass-ratio and effective-spin distributions, indicating changes in formation channels across mass ranges.

Conclusion: The findings suggest a transition from isolated binary formation in lower masses to dynamical assembly in higher masses, aligned with the characteristics of black hole merger remnants.
...
### [15] [Detecting classical nova-like explosions with LISA](https://arxiv.org/abs/2606.14473)
*Ethan McKeever,Shu Yan Lau,Hang Yu,Neil J. Cornish*

Main category: astro-ph.HE

TL;DR: This study examines the impact of novae on gravitational wave observations from close binary white dwarfs detected by LISA, proposing models to predict signal detectability and associated parameter biases.


<details>
  <summary>Details</summary>
Motivation: To address the oversight in gravitational wave studies regarding the effects of novae on the observability of white dwarf binary systems during LISA's operational window.

Method: The authors model a nova burst as an abrupt mass loss from the accretor, influencing gravitational wave frequency, and calculate signal-to-noise ratios for detecting novae while examining biases from improper modeling using statistical methods for future data comparison.

Result: They predict conditions under which the signal detectability and biases occur, providing a framework for model-agnostic detection techniques.

Conclusion: The study enhances methods for identifying nova events and estimating the galactic nova rate, improving potential observations beyond traditional optical techniques.
...
### [16] [Pulse profile modelling of accreting millisecond pulsars with disc occultation and its impact on parameter inference](https://arxiv.org/abs/2606.14493)
*Ying-Han Mao,Bas Dorsman,Anna L. Watts,Tuomo Salmi,Juri Poutanen,Xiang-Dong Li*

Main category: astro-ph.HE

TL;DR: This study enhances pulse profile modelling for accreting millisecond pulsars by integrating accretion disc occultation effects, revealing its critical role in parameter inference accuracy.


<details>
  <summary>Details</summary>
Motivation: To improve the accuracy of neutron star parameter inference by considering the effects of accretion disc geometry in pulse profile modelling.

Method: Extending the X-PSI code to include disc occultation effects, quantifying its impacts on pulse profiles through simulations of various hotspot configurations.

Result: Disc occultation primarily affects profiles based on viewing inclination, with hotspots near the poles leading to significant deviations in inferred parameters compared to those closer to the equator.

Conclusion: Incorporating disc occultation is essential for accurate inference of neutron star properties in accreting millisecond pulsars, as neglecting it may lead to misleading results.
...
### [17] [Spectral Softenings, Composition Bump, and Anisotropy Transition: A Consistent Picture of Cosmic-Ray Origin Below the Knee](https://arxiv.org/abs/2606.14501)
*Xulin Dong,Yuhua Yao,Shuwang Cui,Yiqing Guo*

Main category: astro-ph.HE

TL;DR: DAMPE's measurements reveal distinct features in cosmic rays' energy spectra, indicating multiple source contributions and a transition in cosmic-ray origin.


<details>
  <summary>Details</summary>
Motivation: To understand the origin and propagation of cosmic rays through detailed analysis of individual cosmic-ray components.

Method: Analyzed individual elemental spectra from DAMPE to derive a comprehensive mass composition distribution and employed a spatially dependent propagation model incorporating nearby sources.

Result: A pronounced bump in the mass distribution indicates a transition from standard Galactic sources to nearby sources; the model effectively reproduces observed cosmic-ray characteristics.

Conclusion: The findings suggest that Galactic cosmic rays below the knee stem from diverse source populations, and future anisotropy measurements will validate this model.
...
### [18] [Linear Gravitational Wave Memory Through the Window of Core-Collapse Supernovae](https://arxiv.org/abs/2606.14670)
*Colter J. Richardson,Anthony Mezzacappa,Haakon Andresen,Michele Zanolin*

Main category: astro-ph.HE

TL;DR: The paper reviews low-frequency gravitational waves from core-collapse supernovae, focusing on their generation, detection approaches, and future detection prospects.


<details>
  <summary>Details</summary>
Motivation: Investigating low-frequency gravitational waves is essential for understanding core-collapse supernovae and improving detection methods in gravitational wave astronomy.

Method: The paper reviews theory and detection techniques, including linear gravitational wave memory from neutrino emission, and utilizes linear predictive filtering and matched templating for detection analysis.

Result: The paper presents results from an example 15 $M_{\odot}$ progenitor and evaluates detection capabilities in current and future gravitational wave detectors.

Conclusion: Future detectors like Cosmic Explorer and Einstein Telescope may enhance the detection of low-frequency gravitational waves, expanding our understanding of core-collapse supernovae.
...
### [19] [Tantalum as a base material for superconducting integrated circuits](https://arxiv.org/abs/2606.13750)
...
TL;DR: This review highlights the promising potential of tantalum for next-generation superconducting integrated circuits, discussing its unique properties and performance compared to traditional materials.


<details>
  <summary>Details</summary>
Motivation: Superconducting integrated circuits for quantum applications face limitations due to material-related losses, prompting the exploration of tantalum as a superior alternative.

Method: This review summarizes recent findings on tantalum thin films, fabrication techniques, and performance assessments, including first-principles theoretical studies.

Result: Tantalum shows remarkable promise with distinct operational features in cryogenic tests, and explores polymorphism influencing its superconducting properties.

Conclusion: The paper outlines ongoing challenges such as the impact of {eta}-phase impurities and other chemical influences on tantalum's superconducting characteristics.
...
### [20] [Computational regimes in matrix-product-state-based quantum trajectory simulations](https://arxiv.org/abs/2606.13779)
*Aaron Sander,Simon Cichy,Martin Eigel,Jens Eisert,Maximilian Fröhlich,Tom Peham,Robert Wille*

Main category: quant-ph

TL;DR: A framework for efficient simulation of open quantum systems is proposed, decomposing total simulation cost in terms of memory, runtime, and sampling effort while addressing the complexities of various stochastic unravelings.


<details>
  <summary>Details</summary>
Motivation: To improve efficiency in simulating open quantum systems, particularly in relation to the demands of noisy quantum hardware and the complexities of many-body dynamics.

Method: Develop a cost-resolved framework that decomposes total simulation costs into memory usage per trajectory, runtime per trajectory, and statistical sampling effort, using matrix product states (MPS) and investigating various stochastic unravelings of Lindblad dynamics.

Result: The study identifies that different stochastic unravelings can redistribute costs among complexity and convergence without a decrease in total cost, characterized by dimensionless inflation factors $α$ and $κ$. Benchmarks across several noise channels illustrate how cost-effective unraveling choices vary with factors like noise strength and system size.

Conclusion: Unraveling choice is a simulation design problem linked to specific hardware capabilities, necessitating a nuanced approach that goes beyond just trajectory entanglement optimization.
...
### [21] [Universal Crossovers of Stabilizer Entropy Beyond Criticality](https://arxiv.org/abs/2606.13810)
*Reyhaneh Khasseh,E. A. Ramirez Trino,M. A. Rajabpour*

Main category: quant-ph

TL;DR: This paper analyzes the scaling structure of stabilizer Rényi entropy (SRE) beyond critical points in quantum many-body systems, providing exact formulas for finite-size effects in spin chains, revealing universal behaviors and crossover phenomena from critical to noncritical regimes.


<details>
  <summary>Details</summary>
Motivation: To understand the scaling structure and behaviors of stabilizer Rényi entropy in quantum many-body systems, particularly beyond critical points where entanglement entropy has been better studied.

Method: Derived exact finite-size formulas for both periodic chains and finite intervals of infinite spin chains at Rényi index one-half, exploring how entropies transition from critical to non-critical phases.

Result: A volume law for entropy in periodic geometry away from criticality, a cusp in SRE density across the critical line, and the segregation of boundary effects in subsystem geometries, all demonstrating universal behaviors governed by correlation length.

Conclusion: The findings provide a benchmark for the QFT description of stabilizer entropy, offering insights into crossover behaviors and scaling phenomena in various spin chain configurations.
...
### [22] [Aligning Quantum Operators with Large Language Models](https://arxiv.org/abs/2606.13811)
*Rogerio Feris,Yunchao Liu,Pengyuan Li,Hang Hua,David Kremer*

Main category: quant-ph

TL;DR: This study explores whether Large Language Models (LLMs) can understand quantum operators by mapping unitary operators into their latent space, leading to effective synthesis in quantum and linguistic contexts.


<details>
  <summary>Details</summary>
Motivation: To explore the capabilities of LLMs in understanding quantum representations, which they inherently struggle with, especially unitary matrices.

Method: The authors introduce a mapping technique to integrate unitary operators into the LLM's latent space, applied specifically to Clifford+T circuit synthesis over a Pauli rotation gate set.

Result: The proposed model demonstrates competitive performance against state-of-the-art methods in quantum circuit synthesis and improves with training data without saturation, while also facilitating language-conditioned synthesis.

Conclusion: This research implies that LLMs can evolve into quantum-aware models capable of interpreting quantum operations, potentially impacting fields like quantum compilation and algorithm discovery.
...
### [23] [Calibrated Helstrom geometry on the Bloch ball via Connes spectral distance](https://arxiv.org/abs/2606.13824)
*Kaushlendra Kumar*

Main category: quant-ph

TL;DR: The paper demonstrates the connection between Helstrom trace-distance geometry of qubit states and Connes spectral distance through a specific model, revealing how scalar-sector distances influence the overall geometry.


<details>
  <summary>Details</summary>
Motivation: To explore the relationship between quantum state geometries and spectral metrics in a finite model context, enhancing understanding of distance measures in quantum information theory.

Method: A finite scalar-qubit-scalar model is utilized, where two scalar sectors interact isotropically with a qubit block via identity Dirac links, constructing a Bloch ball that incorporates mixed states geometrically.

Result: The study establishes that the Bloch ball's geometry and metric properties emerge from the finite spectral distance, with scalar-sector distances determining the geometry of the qubit states and satisfying key consistency relations.

Conclusion: The findings illustrate a significant correspondence between quantum state geometry and spectral distances, paving the way for further studies on distance measures in quantum systems.
...
### [24] [Local correlations in long-range dual-unitary kicked Hamiltonian chains](https://arxiv.org/abs/2606.13857)
*Vladimir Al. Osipov,Marc Cedric Spyra,Jana Carolina Schumann,Thomas Guhr,Boris Gutkin*

Main category: quant-ph

TL;DR: The paper introduces a family of dual-unitary kicked spin chains with long-range interactions, expanding on the concept used in the kicked Ising spin chain, and demonstrates the propagation of local correlations analytically.


<details>
  <summary>Details</summary>
Motivation: To extend dual-unitarity in many-body Floquet systems beyond the restrictive nearest-neighbor interactions by introducing long-range interactions.

Method: The authors use a construction based on Hadamard matrices to create a family of dual-unitary kicked spin chains with interactions that can extend over multiple sites.

Result: Local two-point correlations in these dual-unitary models propagate along defined light-cone edges, specifically at the boundaries determined by the interaction range, captured mathematically for local operators.

Conclusion: The study successfully demonstrates the feasibility of creating dual-unitary models with long-range interactions while preserving important dynamical features.
...
### [25] [Compact graphs and quantum automorphisms](https://arxiv.org/abs/2606.13928)
*Pedro Baptista,Gabriel Coutinho,Chris Godsil,Simon Schmidt*

Main category: quant-ph

TL;DR: This paper introduces a quantum version of compact graphs by analyzing the quantum automorphism group, demonstrating that quantum compact graphs maintain classical compactness properties.


<details>
  <summary>Details</summary>
Motivation: To explore the relationship between classical compactness in graph theory and its quantum counterparts, particularly in the context of automorphism groups.

Method: By evaluating the fundamental magic unitary of the quantum automorphism group on states, leading to a set of doubly stochastic matrices that bridge classical and fractional automorphism polytopes.

Result: The research establishes that the quantum analogue of compactness is equivalent to classical compactness, and addresses various pseudonotions of compactness in both domains.

Conclusion: The findings suggest that while quantum compactness retains classical properties, there are identified areas where quantum symmetries could enhance the understanding of compactness theory.
...
### [26] [Certification of the genuine resolution of photon number resolving detectors](https://arxiv.org/abs/2606.14365)
*Jef Pauwels,Towsif Taher,Roope Uola,Boris Korzh,Nicolas Brunner,Pavel Sekatski*

Main category: quant-ph

TL;DR: The paper presents a framework for quantifying and certifying the genuine photon-number resolution of PNR detectors, using a scalable protocol with coherent state probes and applied to a specific detector, achieving genuine four-outcome resolution.


<details>
  <summary>Details</summary>
Motivation: To address the lack of practical metrics for certifying the photon-number resolution capabilities of PNR detectors in photonic quantum technologies.

Method: An operational framework was developed to quantify the capability of PNR detectors, and a scalable protocol was created for certification, utilizing coherent state probes.

Result: The method was successfully applied to a 28-pixel PNR-SNSPD, certifying its genuine resolution for four outcomes.

Conclusion: The research provides an operational benchmark for PNR detectors and emphasizes the importance of detector efficiency in achieving high genuine resolution.
...
TL;DR: This study demonstrates a programmable quantum simulation illustrating spin-dependent electron transfer in chiral structures, revealing interference effects as a key mechanism.


<details>
  <summary>Details</summary>
Motivation: The chiral-induced spin selectivity effect in electron transfer lacks a comprehensive understanding, particularly regarding its microscopic origins and the role of path interference.

Method: A quantum simulation using a trapped ion model was implemented, encoding chiral bridge interactions in ion states with tunable coupling, facilitating investigations of spin-dependent dynamics.

Result: Evidence of spin-dependent interference was observed within the chiral bridge, influencing the dynamics of electron transfer between donor and acceptor states.

Conclusion: The findings support the hypothesis that interference between spin-dependent pathways contributes to electron transfer mechanisms, paving the way for further quantum simulations of intricate chiral systems.
...
TL;DR: Development of a UHV cluster tool for studying shallow NV centers in diamond, integrating surface analysis and measurements.


<details>
  <summary>Details</summary>
Motivation: To enable comprehensive studies of NV centers in diamond by correlating surface chemistry with NV properties.

Method: An integrated UHV cluster tool combining a surface science chamber and a cryogenic confocal microscope for real-time analysis and measurement.

Result: Facilitates systematic investigation of decoherence mechanisms and charge dynamics in shallow NV centers.

Conclusion: Establishes a pathway for reproducible surface engineering for future quantum sensing applications.
...
TL;DR: The paper presents two Rydberg excitation schemes for two-qubit operations on neutral Rb atoms, highlighting that spatial configuration impacts fidelity more than the intermediate level.


<details>
  <summary>Details</summary>
Motivation: To explore effective two-qubit operations in quantum computing using neutral atoms.

Method: Two excitation schemes using 5P$_{1/2}$ and 6P$_{3/2}$ levels for entangling neutral Rb atoms, analyzed via numerical modeling.

Result: Achieved a two-qubit operation fidelity of 94% using the 6P$_{3/2}$ scheme.

Conclusion: The spatial arrangement significantly influences quantum fidelity over the choice of intermediate level.
...
### [30] [All about quantum error correction: distillation, mitigation, self-correction and beyond](https://arxiv.org/abs/2606.14034)
*D. -S. Wang*

Main category: quant-ph

TL;DR: This work unifies various quantum error manipulation techniques under a general quantum error correction framework, leading to a proposed model for self-correcting quantum memory.


<details>
  <summary>Details</summary>
Motivation: To clarify the relationships between different quantum error manipulation techniques and enhance the design of reliable quantum information systems.

Method: Extend quantum error correction to encompass state-adaptive and channel-adaptive settings, including multi-stage coding.

Result: Establishes a unified framework for various techniques and introduces a model for self-correcting quantum memory.

Conclusion: The unified perspective aids in understanding and improving the reliability of quantum information systems.
...
### [31] [Link-Free Multi-Node Timing Synchronization for Scalable Quantum Networking](https://arxiv.org/abs/2606.14077)
*Jacob E. Humberd,Mohmad Junaid Ul Haq,Angel Fraire Estrada,Ike Deitch,Tian Li*

Main category: quant-ph

TL;DR: This study presents a novel synchronization method for quantum networking, utilizing independent rubidium atomic clocks to achieve performance comparable to traditional systems without dedicated infrastructure.


<details>
  <summary>Details</summary>
Motivation: The need for precise synchronization in quantum networks for various applications, while addressing the limitations of existing architectures like White Rabbit.

Method: The authors employed miniature rubidium atomic clocks combined with computational post-processing for link-free synchronization in a metropolitan-scale fiber network.

Result: The synchronization method demonstrated stability over 8 hours, performing similarly to White Rabbit systems, with successful Hong-Ou-Mandel interference exceeding 70% visibility.

Conclusion: This approach establishes a scalable alternative for synchronization in diverse environments, essential for the advancement of quantum networks without relying on dedicated timing-distribution infrastructure.
...
### [32] [OQMD: Single-Qubit Rotation Control Improves Low-CNOT Multiclass Quantum Classification](https://arxiv.org/abs/2606.14088)
*Michael A. Magid,Melissa Zeynep Ertem,Jun Suzuki*

Main category: quant-ph

TL;DR: OQMD refines quantum measurement decoding to reduce error and latency, demonstrating improved accuracy in variational classifiers without adding CNOT gates.


<details>
  <summary>Details</summary>
Motivation: To address the substantial error and latency associated with two-qubit gates in variational classifiers and to challenge the assumption that increased entangling depth automatically leads to higher accuracy.

Method: The study introduces Optimal Quantum Measurement Decoding (OQMD), optimizing the mapping of quantum outcomes to classical labels through a trained readout layer in conjunction with the variational circuit, avoiding additional CNOT gates.

Result: On the Iris benchmark, a 0-CNOT configuration with OQMD achieved 83.33% accuracy, compared to 56.67% for an 18-CNOT setup, highlighting the inefficiency of relying solely on CNOT count for accuracy.

Conclusion: OQMD provides statistically consistent performance improvements across different architectures, suggesting that significant enhancements can occur even with minimal circuits, although the benefits are not uniformly large across all configurations.
...
### [33] [Collision models for open quantum systems coupled to finite environments](https://arxiv.org/abs/2606.14163)
*Gyaneswar Bhoi,Anil Shaji*

Main category: quant-ph

TL;DR: This study investigates the interaction of a system qubit with an environmental qubit under various reset conditions, revealing the necessity of complete environmental resetting for suppressing correlations and identifying distinct dynamical regimes in the system's behavior.


<details>
  <summary>Details</summary>
Motivation: Understanding the dynamics of qubits interacting with environmental noise is crucial in quantum information and computing. Determining the conditions under which correlations can be suppressed aids in designing better quantum systems.

Method: The study employs mathematical modeling using a completely positive, trace-preserving map governing the environmental interactions. It derives Bloch-vector dynamics for resonant interactions and utilizes dynamical measures like the Breuer--Laine--Piilo measure to categorize different regimes.

Result: The research identifies three dynamical regimes: CP-divisible Markovian dynamics, CP-indivisible but P-divisible dynamics, and non-P-divisible non-Markovian dynamics, with clear numerical boundaries between them, impacted by the degree of environmental reset.

Conclusion: Complete suppression of system-environment correlations necessitates a full reset of the environment, while partial resets facilitate transitions between Markovian and non-Markovian dynamics, with the nature of these transitions demonstrating the importance of environmental relaxation characteristics.
...
### [34] [Dynamically frozen long-distance entanglement via non-Hermitian PT-symmetric systems](https://arxiv.org/abs/2606.14177)
*Sejal Ahuja,Keshav Das Agarwal,Aditi Sen De*

Main category: quant-ph

TL;DR: This paper explores how non-Hermitian dynamics in distributed quantum networks enhance long-distance entanglement between nodes, particularly through exceptional points in a specific spin model.


<details>
  <summary>Details</summary>
Motivation: To investigate how non-Hermitian effects influence entanglement in distributed quantum networks.

Method: The study employs analytical and numerical analyses on non-Hermitian nearest-neighbor SSH models, focusing on quantum XX bulks and imaginary staggered magnetic fields to reveal exceptional points.

Result: Non-Hermitian dynamics facilitate the transition from separable states to high entanglement at exceptional points, with time-averaged entanglement exceeding that of Hermitian systems.

Conclusion: Engineered non-Hermitian dynamics can yield robust, frozen entangled links in quantum networks, potentially improving long-range entanglement interactions.
...
### [35] [Simultaneous Estimation of Partial-Transpose Moments with Active Memory Independent of the Moment Order](https://arxiv.org/abs/2606.14204)
*Junxiang Huang,Xiaoyang Wang,Xiao Yuan,Yukun Zhang*

Main category: quant-ph

TL;DR: The paper explores efficient methods for estimating partial-transpose moments of bipartite quantum states under active memory constraints, presenting optimal copy complexity results and necessary bounds.


<details>
  <summary>Details</summary>
Motivation: Understanding the structure of bipartite quantum states through partial-transpose moments is crucial for advancements in quantum information theory and quantum state estimation.

Method: The authors introduce a sequential qubit-reuse method for estimating partial-transpose moments, using at most $2n+1$ active qubits and analyzing the total copy complexity involved in this estimation process.

Result: They establish that all moments can be estimated to a uniform additive error with $O(K\log K/ε^2)$ total copies, while proving that at least $Ω(K/ε^2)$ copies are necessary for accurate estimation in the worst case.

Conclusion: The findings characterize the copy complexity related to partial-transpose moments, extending the framework of simultaneous nonlinear-functional estimations in quantum mechanics.
...
### [36] [Fourier analysis of quantum neural network with non-linear data embedding](https://arxiv.org/abs/2606.14206)
*Haiyue Kang,Martin Sevior,Muhammad Usman*

Main category: quant-ph

TL;DR: This paper extends Fourier analysis to amplitude-encoded Variational Quantum Circuits (VQCs) in the presence of noise, revealing insights into expressivity and barren plateaus.


<details>
  <summary>Details</summary>
Motivation: To explore the expressivity of VQCs, particularly with amplitude embedding, and its implications for performance under noise conditions.

Method: The authors employ Fourier analysis combined with Weingarten calculus to examine the Fourier coefficients of amplitude-encoded VQCs, considering both noiseless and noisy environments.

Result: The study finds that the mean Fourier coefficients concentrate at zero, with variance diminishing exponentially with the frequency magnitude, further suppressed by noise through a calculable factor.

Conclusion: The research provides a rigorous analytical framework for understanding amplitude-encoded VQCs, demonstrating their expressivity and practical applicability, especially in noisy quantum settings.
...
### [37] [Efficient Simulation of Szegedy Quantum Walk Formulations and Algorithms](https://arxiv.org/abs/2606.14226)
*Sergio A. Ortega,Daniel K. Park*

Main category: quant-ph

TL;DR: The paper presents efficient classical simulation methods for Szegedy quantum walks that enhance the breadth of applicable walk formulations and achieve optimal complexity for dense and sparse graphs, implemented in a Python package.


<details>
  <summary>Details</summary>
Motivation: To develop a framework for simulating Szegedy quantum walks without explicitly constructing the full unitary evolution operator, broadening the applications of quantum walks.

Method: The proposed methods are based on fundamental update and reflection operators, allowing for efficient simulation of various Szegedy walk formulations and integration with phase-estimation algorithms.

Result: The methods achieve optimal $O(N^2)$ complexity for dense graphs, while for sparse graphs, the cost scales linearly with the number of edges, or $O(N)$ in many scenarios.

Conclusion: The implementation in SQWLib enables practical and numerical studies of Szegedy-walk-based algorithms, expanding beyond purely analytical approaches.
...
### [38] [Quantum codes and optimal pure quantum $(r,δ)$-LRCs via the MP construction](https://arxiv.org/abs/2606.14253)
*Meng Cao,Kun Zhou*

Main category: quant-ph

TL;DR: The paper presents advancements in quantum codes using $τ$-optimal defining matrices (τ-OD), establishing a unified theorem and discovering new infinite families of such matrices, leading to 222 record-breaking quantum codes and 30 optimal pure quantum $(r,δ)$-LRCs.


<details>
  <summary>Details</summary>
Motivation: To develop new quantum codes and $(r,δ)$-LRCs through the application of MP codes with $τ$-OD matrices, expanding the theoretical groundwork and practical implementations.

Method: A unified $τ$-monomial decomposition theorem for self-adjoint matrices over finite fields was established, leading to the discovery of infinite families of $τ$-OD matrices; MP codes were used to construct quantum codes and $(r,δ)$-LRCs.

Result: The paper reports 222 new quantum codes that break existing records and introduces 30 optimal pure quantum $(r,δ)$-LRCs, some of which are simultaneously record-breaking.

Conclusion: This work extends existing knowledge on quantum codes, revealing that certain codes can achieve optimality and record-breaking status together, a previously unreported phenomenon.
...
### [39] [Dose-efficient Quantum Phase Estimation in Lossy Optical Interferometry](https://arxiv.org/abs/2606.14254)
*Qilin Yu,Ben Wang,Kaimin Zheng,Minghao Mi,Hui Li,Lijian Zhang*

Main category: quant-ph

TL;DR: This study presents an experimental approach to enhance quantum phase estimation in optical interferometry under dose-limited regimes, demonstrating that sequential strategies outperform traditional methods amid photon loss.


<details>
  <summary>Details</summary>
Motivation: The need to maximize precision in optical interferometry, particularly under light intensity constraints to protect sensitive samples, motivates this research.

Method: The authors utilized sequential phase estimation strategies and evaluated their performance using quantum Fisher information (QFI) per dose, comparing results from controlled and uncontrolled scenarios.

Result: Experimental findings indicate that both sequential strategies surpass classical limits and outperform parallel strategies, with the control-enhanced sequential strategy achieving near-quantum limit performance.

Conclusion: This research underscores the potential of sequential strategies for advancing practical quantum metrology, particularly in situations characterized by resource limitations and photon loss.
...
### [40] [A new class of degenerate solutions to the massless Dirac equation and their potential applications in optical memories](https://arxiv.org/abs/2606.14256)
*Georgios N. Tsigaridas,Aristides I. Kechriniotis,Christos A. Tsonos,Konstantinos K. Delibasis*

Main category: quant-ph

TL;DR: The article introduces novel degenerate solutions to the massless Dirac equation with applications to electromagnetic fields, highlighting synchronized spin rotation with field configurations.


<details>
  <summary>Details</summary>
Motivation: To explore new solutions to the massless Dirac equation that can be applied to various electromagnetic contexts and potentially enhance optical memory technologies.

Method: By analyzing the massless Dirac equation under different electromagnetic 4-potentials, the authors derive degenerate solutions and examine their properties.

Result: The study reveals that the spin of particles aligns and rotates with the electromagnetic fields, including both static and dynamic configurations.

Conclusion: These findings have implications for developing advanced optical memories utilizing materials like graphene that support massless Dirac fermions.
...
### [41] [Quantum-Classical Hierarchical Equations of Motion](https://arxiv.org/abs/2606.14363)
*Amartya Bose*

Main category: quant-ph

TL;DR: The QC-HEOM method efficiently simulates non-Markovian open quantum systems by utilizing classical paths and a hierarchy of quantum influence functionals, reducing complexity and enhancing accuracy compared to traditional methods.


<details>
  <summary>Details</summary>
Motivation: To improve simulation methods for non-Markovian open quantum systems by addressing limitations in conventional hierarchical equations of motion.

Method: The QC-HEOM approach combines ensemble-averaged classical paths with a hierarchy of quantum influence functionals, allowing for the incorporation of thermal fluctuations and reducing dependency on complex expansions.

Result: QC-HEOM shows improved accuracy and efficiency, particularly at low temperatures, reproducing results similar to benchmark methods while requiring fewer auxiliary objects.

Conclusion: QC-HEOM is an efficient framework for modeling residual quantum memory in open-system dynamics, extending capabilities to complex anharmonic environments.
...
### [42] [Quantum sensing through bosonic-fermionic Bell-state transitions in two-photon interference](https://arxiv.org/abs/2606.14408)
*Chahat Kaushik,Vimlesh Kumar,G. K. Samanta*

Main category: quant-ph

TL;DR: The paper introduces a new quantum sensing scheme utilizing symmetry-controlled transitions between Bell states to enhance sensitivity and stability against conventional measurement issues.


<details>
  <summary>Details</summary>
Motivation: Existing HOM-based sensing faces limitations from optical loss and alignment instability, hindering robust measurements.

Method: The proposed scheme uses geometric phase imprinting on a pump beam to continuously modulate the exchange symmetry of polarization-entangled photons, allowing control over the quantum interference response without sacrificing photon indistinguishability.

Result: The HOM response exhibits a continuous shift from bunching to antibunching with a stable modulation rate of ~10 * 10^4 counts/s and a fixed phase-modulation linewidth of pi/2, regardless of bandwidth.

Conclusion: The findings demonstrate that exchange symmetry can be precisely controlled for enhanced robustness in quantum sensing applications, suggesting its potential for advancing quantum information processing.
...
### [43] [Jones-matrix analysis of phase accumulation in a linear-optical multi-pass interferometer](https://arxiv.org/abs/2606.14422)
*Byoung S. Ham*

Main category: quant-ph

TL;DR: This study reexamines a multi-pass photonic scheme for superresolution and supersensitivity in quantum measurements using a Jones-matrix formalism to demonstrate phase accumulation via polarization rotation.


<details>
  <summary>Details</summary>
Motivation: To clarify mechanisms behind superresolution and supersensitivity in quantum information science using classical and nonclassical resources.

Method: Employing a rigorous Jones-matrix approach to model the round-trip evolution of the optics unit, demonstrating phase accumulation through coherent polarization-state rotation on the Poincaré sphere, and validating with classical-wave experiments.

Result: Findings reveal a geometric interpretation of phase accumulation through polarization state realignment, and the analysis of Fisher information confirms the origin of supersensitivity.

Conclusion: The study links classical-wave implementations to quantum phenomena, comparing results with a coherence de Broglie wavelength framework that achieves similar superresolution via cascaded interactions.
...
### [44] [Spin counting via projection noise measurement of mesoscopic solid-state spin ensemble](https://arxiv.org/abs/2606.14437)
*Lorenzo Bechelli,Konstantin Herb,Laura Alicia Völker,Christian L. Degen*

Main category: quant-ph

TL;DR: The paper presents a novel method for measuring quantum projection noise in mesoscopic ensembles of nitrogen-vacancy (NV) spin defects at room temperature, enabling improved magnetometry sensitivity.


<details>
  <summary>Details</summary>
Motivation: The study addresses the challenge of measuring quantum projection noise in solid-state spin ensembles, where classical noise often dominates.

Method: The authors achieved high ODMR contrast using polarization-selective optical excitation and spin-to-charge conversion to measure projection noise and perform spin counting in NV ensembles of up to 43 spins.

Result: The method demonstrated successful measurement of quantum projection noise and significant increases in sensitivity for magnetometry applications without requiring cryogenic conditions.

Conclusion: This work enhances the feasibility of high-precision measurements in solid-state systems, leading to advancements in magnetometry.
...
### [45] [Dealing with locality in QAOA](https://arxiv.org/abs/2606.14447)
*Mithilesh Kumar,Yusuf Tahir*

Main category: quant-ph

TL;DR: This paper introduces a transport-augmented QAOA to improve performance on MaxCut problems by optimizing mixer couplings, effectively addressing locality limitations associated with circuit depth and diameter.


<details>
  <summary>Details</summary>
Motivation: The motivation stems from the locality bottleneck encountered in shallow-depth QAOA for sparse, high-diameter MaxCut instances, which affects performance due to limited interaction among observables.

Method: The method involves enhancing the mixer in the QAOA with optimized, unweighted shortcut couplings, while keeping the MaxCut cost Hamiltonian unchanged, and using finite-depth support recursions to analyze optimal coupling placements.

Result: Benchmarks indicate a significant performance improvement; for bipartite graphs, the approximation ratio increases from 0.7378 to 0.9767 at depth 1, and for random trees, it rises from 0.9226 to 0.9997 at depth 2, showing size-invariance after reducing diameter.

Conclusion: The proposed approach effectively mitigates locality issues in QAOA, demonstrating enhanced performance and promising implications for other graph-based problems.
...
### [46] [Optimal Decoding of Small Codes by Density Matrix Propagation](https://arxiv.org/abs/2606.14455)
*Anthony Benois,Pierre Cussenot,Grégoire Misguich,Nicolas Sangouard,Kiara Hansenne*

Main category: quant-ph

TL;DR: This study evaluates practical quantum decoding algorithms against a maximum likelihood benchmark, highlighting significant deviations in performance depending on code and noise model.


<details>
  <summary>Details</summary>
Motivation: To address the challenges posed by circuit-level noise in quantum computing and assess the effectiveness of practical decoding algorithms.

Method: The study uses density matrix propagation to compute optimal decoding for each syndrome history, applying pruning techniques to explore more syndrome-extraction rounds.

Result: While standard decoders perform well for repetition codes, their performance falters for cellular automaton codes, particularly under higher noise levels, with BP+OSD showing early deterioration.

Conclusion: At low physical error rates, only a small subset of syndrome histories has a considerable impact on the logical error rate.
...
### [47] [QCI Connect: A Modular Full-Stack Quantum Computing Platform](https://arxiv.org/abs/2606.14456)
...
TL;DR: QCI Connect is a hardware-agnostic, full-stack quantum computing platform designed to support domain experts through cloud access, featuring a modular architecture and open-source interfaces.


<details>
  <summary>Details</summary>
Motivation: As various quantum computing architectures emerge, a unified platform is needed to enable domain experts to access quantum computing resources effectively.

Method: QCI Connect offers a modular design and an accompanying Software Development Kit that allows for community-driven application development through open-source interface definitions.

Result: The paper details the platform's design, main features, and interfaces, providing insights aimed at users and informing future development efforts.

Conclusion: QCI Connect serves as a valuable reference for building innovative quantum computing applications while fostering a collaborative ecosystem.
...
### [48] [Sensitivity of polaron-molecule observables to MDR/GUP-like ultraviolet deformations at low energies via quantum computing](https://arxiv.org/abs/2606.14479)
*Ezequiel Valero,Hugo Catala,Victor Ilisie,Germán Rodrigo*

Main category: quant-ph

TL;DR: Impurity many-body observables are sensitive to ultraviolet deformations, affecting spectral and Ramsey measurements in a quantum computing framework, with experimental validation on a superconducting quantum processor.


<details>
  <summary>Details</summary>
Motivation: To explore the effects of ultraviolet deformations on impurity many-body observables and their implications in low-energy quantum gravity phenomenology.

Method: Utilized a deformed polaron-molecule Hamiltonian while ensuring the infrared sector's preservation to study the impacts on observables in a controlled quantum computing environment.

Result: Identified significant sensitivity of observables in regimes near the polaron-molecule crossover, leading to detectably altered quasiparticle properties and spectral responses.

Conclusion: Results provide a sensitivity-based approach to quantum gravity studies in many-body systems, supported by experimental results from the QRed superconducting quantum processor.
...
### [49] [Quantum Horizon: An evaluation of quantum computing as a threat to Bitcoin and Ethereum](https://arxiv.org/abs/2606.14484)
*Iosif M. Gershteyn,Jacob A. Alber*

Main category: quant-ph

TL;DR: Quantum computing presents a mitigable threat to Bitcoin and Ethereum, primarily affecting elliptic-curve signatures while not significantly impacting mining. A forecast indicates a notable increase in quantum computer relevance by 2050, emphasizing governance for timely migration to post-quantum signatures.


<details>
  <summary>Details</summary>
Motivation: To assess the threat of quantum computing to blockchain technologies, particularly Bitcoin and Ethereum, and to clarify confusions around quantum algorithms.

Method: A Monte-Carlo forecasting approach combines various factors, including hardware scaling, resource requirements, and expert surveys, to predict the arrival distribution of cryptographically relevant quantum computers.

Result: Forecast indicates a 1/6 chance of a relevant quantum computer by 2035, 30% by 2040, and 60% by 2050. Bitcoin has 2.3 million coins at risk, while Ethereum is at greater risk due to many coins being in vulnerable accounts.

Conclusion: Timely migration to post-quantum signatures is crucial and more influenced by governance than technology. A review shows no cryptocurrencies are fully prepared for post-quantum challenges.
...
### [50] [Physics-Informed Variational Quantum Classifier for Phase Detection in Strongly Correlated Matter](https://arxiv.org/abs/2606.14489)
*Hugo Catalá,Ezequiel Valero,Germán Rodrigo*

Main category: quant-ph

TL;DR: The paper introduces a Physics-Informed Variational Quantum Classifier (VQC) to detect topological phase transitions in strongly correlated quantum systems, showcasing its effectiveness in distinguishing BEC and BCS regimes through optimized interferometric protocols, validated on a superconducting quantum processor.


<details>
  <summary>Details</summary>
Motivation: Characterizing quantum phases in correlated systems is vital for advancing quantum sensors.

Method: A Physics-Informed Variational Quantum Classifier (VQC) uses Trotterised time-evolution of an effective Hamiltonian to learn interpretable physical parameters, optimizing interferometric protocol for phase distinction.

Result: The VQC effectively identifies the Fermi polaron and molecular bound states, distinguishes BEC and BCS regimes, and maintains phase order despite hardware noise.

Conclusion: The architecture demonstrates favorable linear complexity $	ext{O}(N)$, offering scalability for many-body regimes while overcoming limitations of classical simulations.
...
### [51] [Quantum gates with parametrically driven multi-qubit couplers](https://arxiv.org/abs/2606.14522)
*Verena Feulner,Marjan Fani,Lukas Heunisch,Stephan Tasler,Michael J. Hartmann*

Main category: quant-ph

TL;DR: This paper explores enhancing interactions and gate operations among qubits in superconducting quantum processors using four-qubit plaquettes with tunable coupling.


<details>
  <summary>Details</summary>
Motivation: To improve connectivity and precise control in superconducting quantum processors for better performance and fidelity in qubit interactions.

Method: Numerical and analytical analysis of parametrically driven processes to execute $	ext{iSWAP}$-gates and three-qubit gates in a four-qubit architecture.

Result: Achieved $	ext{iSWAP}$-gates with a gate time of 50 ns and 99.9% fidelity, slightly reduced to 99.4% for parallel operations; three-qubit gates show 95% fidelity at 200 ns.

Conclusion: Enhanced qubit connectivity enables high-fidelity gate operations, crucial for advancing superconducting quantum processors.
...
### [52] [Dissipation-induced superradiance in matter coupled to a self-interacting cavity](https://arxiv.org/abs/2606.14526)
*Sebastian Schmid,Matteo Soriente,Oded Zilberberg,Javier del Pino*

Main category: quant-ph

TL;DR: The paper explores the Dicke model of light-matter interactions, introducing self-interacting light through negative Kerr nonlinearity to achieve a low-threshold superradiant phase, stabilized by cavity dissipation.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the challenges of accessing the superradiance threshold in traditional light-matter models due to limitations imposed by experimental conditions and diamagnetic effects.

Method: The authors investigate the effects of negative Kerr nonlinearity on a two-level system coupled to a cavity, examining how this nonlinearity influences superradiant behavior when combined with cavity dissipation.

Result: The study finds that negative Kerr nonlinearity leads to a stable superradiant phase characterized by spin inversion, despite being unstable in isolated systems.

Conclusion: This work suggests that cavity dissipation can stabilize unusual quantum phases, potentially paving the way for new lasing mechanisms and engineered quantum states.
...
### [53] [Scaling native entanglement generation in layered semiconductors with quasi-phase matching](https://arxiv.org/abs/2606.14553)
...
TL;DR: This study presents a method to efficiently generate polarization-entangled photon pairs using periodically-poled transition metal dichalcogenides (PPTMDs), overcoming traditional phase-matching limitations and achieving high fidelity.


<details>
  <summary>Details</summary>
Motivation: To address the limitations in generating entangled photon states due to bulk optics and phase-matching constraints in conventional materials.

Method: The authors design periodically-poled TMDs to implement quasi-phase matching by mechanically flipping the sign of nonlinearity at specific intervals, enhancing pair-production rates while maintaining high-fidelity entanglement.

Result: The proposed method achieved polarization-entangled photon pairs with fidelities exceeding 99%, demonstrating a significant improvement in conversion efficiency.

Conclusion: This work highlights the relationship between crystal symmetry and nonlinear optical response, offering new pathways for quantum light engineering in nanoscale photonic systems.
...
### [54] [On-site interactions in quantum thermal machines: efficiency, rectification and entanglement beyond local and global master equations](https://arxiv.org/abs/2606.14593)
*Salvatore Araceli,Teddy H. M. Ong,Baptiste Debecker,Kai Müller,Oliver Lunt,Andrew J. Daley,François Damanet*

Main category: quant-ph

TL;DR: The paper explores how on-site interactions in mesoscopic quantum systems affect transport properties, particularly for a thermal machine with two coupled oscillators.


<details>
  <summary>Details</summary>
Motivation: To unify differing theoretical descriptions of quantum thermal machines in the weak coupling regime and understand the effects of on-site interactions on efficiency and entanglement.

Method: Utilizing the Redfield master equation (RME) and the Hierarchy of Pure States (HOPS) approach, the authors investigate the full parameter space and derive expressions for system-bath correlators.

Result: Interactions are shown to enhance efficiency at high temperatures, create non-reciprocal transport with asymmetric couplings, and generate steady-state entanglement, clarifying the influence of non-Markovianity in quantum transport.

Conclusion: The study demonstrates how on-site interactions increase the versatility of quantum thermodynamic junctions and contribute to a deeper understanding of quantum transport dynamics.
...
### [55] [No classical particle limit for massless quanta](https://arxiv.org/abs/2606.14632)
*Riccardo Falcone,Simon Fuchs*

Main category: quant-ph

TL;DR: The paper shows that relativistic massless classical particles cannot emerge from massless quanta under the set conditions, while allowing for the possibility of field-like limits.


<details>
  <summary>Details</summary>
Motivation: To determine if classical massless particles can arise as a classical limit of massless quanta in a general framework.

Method: An axiomatic kinematical framework for coarse-graining was developed, applying it to the Poincaré group to analyze classicality and covariance.

Result: A no-go theorem was proven, indicating that the covariance condition contradicts the operational requirements for classical massless particles.

Conclusion: While classical massless particles like photons or gravitons cannot exist under the established conditions, the emergence of field-like constructs such as electromagnetic or gravitational fields remains possible.
...
### [56] [Quasilinear Equivalence Checking for Detector Error Models](https://arxiv.org/abs/2606.14677)
*Mathys Rennela*

Main category: quant-ph

TL;DR: The paper introduces an equational theory and a rewriting system for Detector Error Models (DEMs) in quantum circuits, enabling efficient normal form computation and static decision procedures for error equivalence in quantum error correction.


<details>
  <summary>Details</summary>
Motivation: To enhance understanding and manage the error mechanisms in quantum circuits, particularly for improving fault tolerance in quantum compilation.

Method: Development of an equational theory for DEMs and a symmetric monoidal theory over the Giry monad, leading to a sound and confluent rewriting system for efficient computation of normal forms.

Result: Establishment of unique normal forms for DEM terms, scalable decision procedures for error equivalence in quantum error correction, and guarantees for both non-adaptive and partially-adaptive circuits.

Conclusion: The methodology significantly aids in verifying and optimizing quantum compilers, showcasing the practical implications of the theoretical advancements.
...
### [57] [Resolving the Edge of a Quantum Pyramid](https://arxiv.org/abs/2606.14698)
*Alvan Arulandu*

Main category: quant-ph

TL;DR: The paper resolves the quantum pyramids conjecture and confirms optimal measurements for equiangular equiprobable pure states by proving entropy inequalities for obtuse and flat pyramids.


<details>
  <summary>Details</summary>
Motivation: To address the quantum pyramids conjecture and establish the optimality of measurements conjectured by Englert and Řeháček.

Method: The authors prove remaining entropy inequalities using techniques from algebraic inequalities and symmetric inequalities, specifically focusing on local minimizers and the equal variables method.

Result: They provide a rigorous proof that local minimizers cannot have three distinct coordinate values for obtuse pyramids, and establish a tight $ p$ inequality for flat pyramids valid for all dimensions $d\geq 2$.

Conclusion: The findings confirm the conjectures related to quantum measurements and provide new insights into algebraic inequalities related to the Lambert $W$ function.
...
### [58] [Optimal binning of $D\rightarrow K_{\mathrm S}^0π^+π^-$ and $D\rightarrow K_{\mathrm S}^0K^+K^-$ phase space for experimental measurements](https://arxiv.org/abs/2606.13948)
*Marcelo Bovill,Nathan Jurik,Sneha Malde*

Main category: hep-ex

TL;DR: This paper presents new binning schemes for Dalitz plots of specific D meson decays, improving sensitivity for γ measurements and enhancing statistical sensitivity in charm mixing parameters.


<details>
  <summary>Details</summary>
Motivation: To enhance the measurement of γ in D meson decays by developing improved binning schemes that better address sensitivity and background treatment compared to existing methods.

Method: New binning schemes are optimized using a novel figure of merit, considering degeneracy with other parameters and employing a refined approach to background treatment.

Result: The new optimization estimates a 5% improvement in γ measurement precision through one decay process and a 20% gain in statistical sensitivity for charm mixing observables, while controlling bin migration bias.

Conclusion: The proposed binning schemes significantly enhance measurement precision for γ and charm mixing observables, promising improvements over current methodologies.
...
### [59] [Constraining Neutrino Interaction Uncertainties for Neutrino Oscillation Measurements at the T2K Experiment](https://arxiv.org/abs/2606.14015)
...
TL;DR: The paper discusses the role of the ND280 detector in the T2K experiment for enhancing the accuracy of neutrino oscillation measurements by constraining neutrino flux and interaction cross sections.


<details>
  <summary>Details</summary>
Motivation: To improve the precision of neutrino oscillation parameters obtained from the T2K experiment by minimizing systematic uncertainties through effective modeling of neutrino interactions.

Method: Utilizes a new neutrino cross-section model and refined flux predictions fit to data from ND280 event selections, along with extensive robustness studies and alternative interaction models for validation.

Result: Demonstrates the reliability of the methodology through extensive testing, leading to insights on how the upgraded ND280 will improve experimental sensitivity and systematic uncertainty reduction.

Conclusion: With enhancements to the ND280 detector, future neutrino oscillation measurements can achieve greater accuracy in constraining parameters, contributing significantly to the understanding of neutrino physics.
...
### [60] [Evidence of $ψ(3770) \to π^{0}J/ψ$](https://arxiv.org/abs/2606.14105)
...
TL;DR: First evidence of the hadronic transition $ψ(3770) 	o π^0 J/ψ$ is reported, with significant statistical measures and a branching fraction determined.


<details>
  <summary>Details</summary>
Motivation: To investigate the hadronic transitions and provide insights into the nature of $ψ(3770)$ decays.

Method: Data from $20.3~	ext{fb}^{-1}$ at $	ext{BESIII}$ detector was analyzed; the process $e^+ e^- 	o π^{0}J/ψ$ was observed with statistical significance calculated.

Result: The dressed cross section for the process is $(249 	imes 10^{-15})$ fb, and the branching fraction is $	ext{B}(ψ(3770) 	o π^0 J/ψ) = (2.08 	imes 10^{-5})$ with various uncertainties.

Conclusion: The result is below tetraquark model predictions but consistent with meson loop effects, enhancing understanding of isospin-violating decays from $ψ(3770)$.
...
### [61] [Determining Neutrino Mass Ordering with NOvA and Upcoming JUNO Measurements](https://arxiv.org/abs/2606.14121)
*NOvA Collaboration*

Main category: hep-ex

TL;DR: This study analyzes upcoming JUNO measurements' effects on NOvA's neutrino mass ordering determination.


<details>
  <summary>Details</summary>
Motivation: To assess how JUNO's precise reactor constraints could enhance the significance of mass ordering results from NOvA.

Method: The analysis utilizes data from NOvA alongside predictive scenarios for JUNO's measurements to evaluate their impact on mass ordering significance.

Result: The study indicates that NOvA could achieve $3σ$ evidence for normal mass ordering based on a range of future JUNO measurements over the next five years.

Conclusion: Enhanced reactor constraints from JUNO can significantly improve the confidence in determining the neutrino mass ordering via NOvA.
...
### [62] [A Novel Approach to Short Baseline Oscillation Searches Using Neutrino Tagging with nuSCOPE](https://arxiv.org/abs/2606.14263)
*Adrien Blanchet,César Jesús-Valls,Animesh Chatterjee,Stephen Dolan,Pierre Granger,Laura Munteanu*

Main category: hep-ex

TL;DR: The study introduces a novel method using tagged neutrino beams at the nuSCOPE facility to enhance sensitivity in short-baseline neutrino oscillation searches.


<details>
  <summary>Details</summary>
Motivation: To explore non-standard neutrino oscillations using a new experimental approach that offers higher precision in flavor, energy, and distance measurements.

Method: Utilizing tagged neutrino beams to study ν_μ disappearance, ν_μ→ν_e appearance, and ν_e disappearance channels, assessing sensitivity to sterile-neutrino-induced oscillations.

Result: Significantly improved sensitivity to mass-squared splittings across several orders of magnitude and reduced reliance on neutrino flux predictions compared to conventional methods.

Conclusion: The nuSCOPE facility can probe a wide range of parameter space related to existing anomalies and establish coverage in novel regions, showcasing the advantages of tagged neutrino beams for precision oscillation studies.
...
### [63] [Search for dark photons from Higgs boson decays in the gluon-gluon fusion channel in proton-proton collisions at $\sqrt{s}=13.6$ TeV with the ATLAS detector](https://arxiv.org/abs/2606.14362)
*ATLAS Collaboration*

Main category: hep-ex

TL;DR: The paper investigates semi-visible Higgs boson decays into a photon and a dark photon using data from the ATLAS experiment. It reports no significant excess beyond the Standard Model predictions and establishes upper limits on the branching ratio for such decays.


<details>
  <summary>Details</summary>
Motivation: To explore potential decays of the Higgs boson into a photon and a dark photon, providing insights into dark sector physics and extending the understanding of Higgs properties.

Method: The analysis focuses on semi-visible decays in final states with a photon and missing transverse momentum, utilizing a novel trigger with lowered thresholds, a boosted decision tree for event identification, and data-driven methods for background estimation.

Result: No significant excess is found beyond the Standard Model prediction, with upper limits on branching ratio of 1.4% observed and 1.2% expected at 95% confidence level for the decay mode $H \to γγ_d$. Combining with prior data refines these limits to 0.9% each.

Conclusion: The absence of significant signals supports the current Standard Model framework, while the results set stringent limits on Higgs boson decays to dark photons, contributing to ongoing searches for new physics.
...
### [64] [Machine-learned particle flow as a foundation model for collider physics](https://arxiv.org/abs/2606.14373)
*Farouk Mokhtar,Joosep Pata,Michael Kagan,Javier Duarte*

Main category: hep-ex

TL;DR: This study presents a method for integrating event reconstruction and physics analysis using machine learning, enhancing accuracy and efficiency in jet identification and momentum regression tasks.


<details>
  <summary>Details</summary>
Motivation: Traditional particle collision workflows are modular and disconnected, lacking a unified representation linking detector data to analysis tasks.

Method: The authors repurpose a machine learning model for particle-flow reconstruction (MLPF) to simultaneously handle jet flavor identification, energy regression, and missing momentum regression, employing per-particle latent representations as input features.

Result: The approach significantly outperforms baselines that rely solely on kinematic features, achieving competitive results with a minimal parameter footprint, particularly excelling in missing momentum regression.

Conclusion: The latent representations from reconstruction not only carry essential physics information but also make MLPF a foundational model for creating an end-to-end analysis pipeline.
...
### [65] [Measurement of the muon neutrino charged-current cross section with SND@LHC](https://arxiv.org/abs/2606.14669)
...
TL;DR: This study measures the muon neutrino charged-current interaction cross section on tungsten using SND@LHC at CERN, reporting a cross section value and providing background assessments.


<details>
  <summary>Details</summary>
Motivation: The research aims to enhance understanding of muon neutrino interactions, particularly on tungsten, in the context of high-energy proton collisions.

Method: The analysis utilizes LHC proton--proton collision data at 13.6 TeV, selecting 31 muon neutrino candidates from a background of 5.0 events, while performing calorimetric measurements for neutrino energies.

Result: The measured muon neutrino and anti-neutrino cross section on tungsten is σ(ν_μ+ arν_μ) = (37^{+24}_{-12})×10^{-35} cm^2 at a median energy of 228 GeV, with a signal strength of 1.09.

Conclusion: This study provides a significant measurement that informs the understanding of neutrino interactions, contributing valuable data for future experiments.
...
### [66] [A Scalable Fast Multipole Method Poisson Solver for the RAMSES code: I. Unigrid Algorithm](https://arxiv.org/abs/2606.13793)
*Jun-Young Lee,Romain Teyssier*

Main category: astro-ph.IM

TL;DR: A Poisson solver using FMM in RAMSES achieves $O(N)$ complexity, offering efficient computation and scalability.


<details>
  <summary>Details</summary>
Motivation: To improve computational efficiency in solving Poisson's equation for hydrodynamics and particle-mesh simulations.

Method: Utilizes a fast multipole method that constructs hierarchical grids, enabling a single upward and downward pass for multipole expansions.

Result: FMM achieves similar accuracy to multigrid methods while being better suited for isolated boundary conditions and demonstrating improved performance.

Conclusion: Despite requiring more operations, FMM's arithmetic intensity leads to comparable performance to MG with better scalability.
...
### [67] [Design and Commissioning of an Iodine Cell for the ESPRESSO Spectrograph](https://arxiv.org/abs/2606.13816)
*Gillian Nave,R. Paul Butler*

Main category: astro-ph.IM

TL;DR: The paper outlines the design and commissioning of an iodine cell for the ESO's ESPRESSO spectrograph, aiming to enhance precision in exoplanet detection through improved Doppler radial velocity measurements.


<details>
  <summary>Details</summary>
Motivation: To improve the precision of Doppler radial velocity measurements necessary for exoplanet detection, while merging techniques from both traditional unstabilized and super-stabilized spectrographs.

Method: An iodine cell was designed, built, calibrated at NIST, and commissioned for use with the ESPRESSO spectrograph. Observations were made on five stars over ten nights.

Result: The iodine cell successfully calibrated the ESPRESSO spectrograph, which has historically detected numerous exoplanets and has decreased long-term Doppler RV uncertainty towards sub 10 cm/s.

Conclusion: The successful implementation of the iodine cell demonstrates a significant step forward in enhancing precision RV measurements essential for ongoing exoplanet discovery efforts.
...
### [68] [Multi-Variable Stellar Parameter Estimation Using Residual Multitask Neural Networks](https://arxiv.org/abs/2606.13868)
*Bruno Santos Meneses Barreto,Marcio Eisencraft*

Main category: astro-ph.IM

TL;DR: An efficient neural network pipeline estimates stellar parameters from SDSS spectra with low errors and complexity.


<details>
  <summary>Details</summary>
Motivation: To provide an effective estimation of stellar parameters from large-scale spectral datasets while minimizing model complexity.

Method: Utilized a multitask neural network with residual blocks and Bayesian optimization for hyperparameter tuning, with preprocessing including standardization, normalization, and data augmentation.

Result: The model achieved MAE of 59.76 K for effective temperature, 0.103 dex for metallicity, and 0.130 dex for surface gravity, with range-normalized errors between 1% and 3%.

Conclusion: A compact residual multitask architecture is shown to be efficient for nonlinear parameter estimation, outperforming deeper network baselines in terms of complexity and performance.
...
### [69] [Autonomous AI-Cosmoindustry and the Quiet Expansion Filter: A Threshold-Based Resolution of the Fermi Paradox](https://arxiv.org/abs/2606.13914)
*Sergey Ivliev*

Main category: astro-ph.IM

TL;DR: The paper argues that the Fermi paradox is heightened by advancements in AI and robotics, suggesting that mature civilizations may expand quietly through non-biological means, leading to weak signals rather than observable galaxy-scale activities.


<details>
  <summary>Details</summary>
Motivation: To address the Fermi paradox and explore why advanced civilizations might not be detectable despite capable technologies for interstellar expansion.

Method: The paper proposes the 'quiet expansion filter' hypothesis, extending AI-filter discussions to predict low-intensity, machine-mediated expansion within nearby stellar systems.

Result: Order-of-magnitude estimates indicate that a post-threshold civilization could saturate nearby stars within ~10 million years, using modest energy for low-mass probes.

Conclusion: Success in interstellar expansion is likely to manifest through subtle artifacts and local probes rather than grand, observable galactic megastructures, indicating a need for a shift in how we search for extraterrestrial life.
...
### [70] [Classification of Astronomical Spectra Using PCA-Compressed Flux and Inverse-Variance Features](https://arxiv.org/abs/2606.13978)
*Bruno Santos Meneses Barreto,Marcio Eisencraft*

Main category: astro-ph.IM

TL;DR: The paper presents a method for classifying astronomical spectra into stars, galaxies, and quasars using signal processing and supervised learning, achieving high accuracy with LightGBM.


<details>
  <summary>Details</summary>
Motivation: The motivation is to enhance the classification of astronomical spectra from SDSS DR17 by improving the signal-processing techniques combined with machine learning.

Method: Spectra are resampled onto a logarithmic wavelength grid, standardized, and compressed via Principal Component Analysis (PCA) before training classifiers, with a focus on the LightGBM model.

Result: The LightGBM classifier achieved 94.6% accuracy and 92.1% balanced accuracy on the test set.

Conclusion: The approach successfully combines signal processing and machine learning for accurate classification of astronomical spectra.
...
### [71] [Efficient Evaluation of Gravitational Lensing Amplification Factors: A Deep Learning Framework](https://arxiv.org/abs/2606.14001)
*Fan Zhang,Qikai Zhang,Qiyuan Yang,Yong Yuan,Xilong Fan*

Main category: astro-ph.IM

TL;DR: A new framework using Sinusoidal Representation Networks (SIRENs) significantly improves the efficiency and accuracy of evaluating diffraction integrals for gravitational waves, achieving a major speedup over traditional methods.


<details>
  <summary>Details</summary>
Motivation: To analyze lensed gravitational waves effectively while overcoming the computational limitations associated with evaluating diffraction integrals.

Method: Introduced the Sinusoidal Representation Networks (SIRENs) framework that employs periodic activation functions tailored to the oscillatory nature of diffraction integrals, enhancing spectral feature resolution.

Result: Achieved relative accuracy of $	extmath{O}(10^{-3})$ and approximately 100-fold speedup over direct numerical integration, with stable inference times of $	extmath{O}(1)$ complexity.

Conclusion: The framework's dimensional formulation allows versatile applications across various astrophysical settings, ensuring efficient computations for gravitational wave analysis.
...
### [72] [Prime Focus Spectrograph on the Subaru Telescope: Overview of Science Operations](https://arxiv.org/abs/2606.14012)
...
TL;DR: This paper details the science operation framework for the Prime Focus Spectrograph (PFS) at the Subaru Telescope, focusing on its queue observing method and fiber hour system for efficient data collection.


<details>
  <summary>Details</summary>
Motivation: To provide an efficient and effective operational structure for the Prime Focus Spectrograph (PFS) to maximize observing capabilities and data collection efficiency at the Subaru Telescope.

Method: Implementation of a queue observing system with the introduction of fiber hours as a metric for observing time, enabling the execution of multiple observing programs simultaneously and the incorporation of community and observatory fillers for unassigned fibers.

Result: The establishment of a dedicated framework that allows for high observing efficiency through optimal use of resources, with data processed and delivered via the PFS Science Platform.

Conclusion: The paper outlines a structured approach to operating the PFS, making detailed observations feasible while ensuring that data is effectively managed and analyzed.
...
### [73] [Semianalytic Sensitivity Estimates for Out-of-Bank Gravitational-Wave Signals](https://arxiv.org/abs/2606.14045)
*Aditya Vijaykumar,Reed Essick*

Main category: astro-ph.IM

TL;DR: This paper develops a rapid semianalytic method to estimate the sensitivity of gravitational-wave searches, particularly concerning effects not included in standard templates.


<details>
  <summary>Details</summary>
Motivation: Accurate sensitivity estimation is crucial for various astrophysical and fundamental physics applications.

Method: The authors create a semianalytic approximation using fitting factors to assess the overlap of candidate signals with the template bank, explicitly focusing on unmodeled physical effects.

Result: The method's estimates were compared successfully with actual search performances for spinning binary neutron stars and other cases of interest.

Conclusion: This approach enables quick estimations of search sensitivity for a range of additional factors, broadening the capabilities of gravitational-wave analysis.
...
### [74] [Demonstration of a Single-chip Dual-polarization Sideband-separation SIS mixer at 2 mm Band](https://arxiv.org/abs/2606.14124)
*Wenlei Shan,Shohei Ezaki,Yoshinori Uzawa*

Main category: astro-ph.IM

TL;DR: This paper presents a novel monolithic dual-polarization SIS mixer for millimeter wavelengths, achieving significant sideband rejection and low noise, advancing integrated receiver technology for radio telescopes.


<details>
  <summary>Details</summary>
Motivation: There is a need for highly integrated receiver architectures that provide low noise and good sideband rejection in large-format heterodyne focal plane arrays, particularly for superconducting SIS mixers at millimeter wavelengths.

Method: The paper presents a monolithic dual-polarization SIS mixer operating at 2 mm wavelengths on a silicon-on-insulator substrate, demonstrating its performance in terms of sideband rejection and noise temperature.

Result: The integrated SIS mixer achieves a sideband rejection ratio exceeding 10 dB in the 4-8 GHz IF band and an SSB receiver noise temperature as low as approximately 60 K.

Conclusion: This work confirms the potential for integrating highly efficient SIS mixers in large-format heterodyne focal plane arrays, paving the way for enhanced millimeter and submillimeter-wave radio telescope capabilities.
...
### [75] [Dynamical Mass Growing of Fermion with Bare Mass in Two Dimensions](https://arxiv.org/abs/2606.13724)
*Toyoki Matsuyama*

Main category: hep-ph

TL;DR: This paper investigates the dynamical mass generation of fermions interacting with a massive vector field in two dimensions using Schwinger-Dyson equations. It reveals a coincidence in the purely dynamical masses at a specific coupling constant, suggesting duality in the bare masses.


<details>
  <summary>Details</summary>
Motivation: The motivation is to explore the mechanisms behind dynamical mass generation in fermionic systems and to understand the role of the coupling constant and bare mass.

Method: The authors employ Schwinger-Dyson equations in the lowest-ladder approximation, using both analytical and numerical methods to analyze the mass generation.

Result: They find that purely dynamical masses derived from different bare masses align at a particular coupling constant, signifying duality among bare masses.

Conclusion: The findings enhance understanding of fermionic mass generation and suggest an intriguing duality relation dependent on the coupling constant.
...
### [76] [Conformal calibration and look-elsewhere effect in anomaly detection for new-physics searches](https://arxiv.org/abs/2606.13780)
*Jack Y. Araz,Michael Spannowsky*

Main category: hep-ph

TL;DR: The paper introduces a calibration layer for machine-learned anomaly detection in physics, addressing issues with raw anomaly scores and providing a system for deriving significance with finite-sample guarantees. The method includes conformal prediction to convert scores into valid p-values, ensuring accurate significance that corrects miscalibration without retraining the detector.


<details>
  <summary>Details</summary>
Motivation: To address the inadequacies of raw anomaly detection scores in machine learning, particularly their lack of calibration and the potential for misleading significance in searches for new physics.

Method: A calibration layer using conformal prediction is proposed, transforming anomaly scores into valid local p-values and correcting exchangeability failures through weighted and Mondrian variants. A Gross-Vitells step accounts for global significance considering look-elsewhere effects.

Result: On LHC Olympics data, the standard methods failed to accurately reflect the null hypothesis, leading to fabricated high excesses, while the proposed method maintained a global false-positive rate verified through background-only experiments.

Conclusion: The conformal prediction calibration layer provides a reliable, detector-agnostic approach to derive trial-aware significance from uncalibrated anomaly scores, enhancing the integrity of anomaly searches in physics.
...
### [77] [Probing New Degrees of Freedom with the Universal Tail of Primordial Black Hole Mass Functions](https://arxiv.org/abs/2606.13788)
*Kaustubh Agashe,Jae Hyeok Chang,Steven J. Clark,Bhaskar Dutta,Yuhsin Tsai,Tao Xu*

Main category: hep-ph

TL;DR: The paper discusses how the low-mass evaporation tail of primordial black holes (PBHs) affects gamma-ray emission, revealing potential new physics through distortions in the gamma-ray spectrum.


<details>
  <summary>Details</summary>
Motivation: To explore how the mass function of primordial black holes evolves and influences photon emissions during Hawking evaporation, especially under the influence of additional particle degrees of freedom.

Method: Analysis of the universal shape of the PBH mass function and its relationships with the Hawking mass-loss rate, focusing on how distortions due to extra particles affect gamma-ray emissions.

Result: Identified characteristic features in the gamma-ray spectrum resulting from distortions in the evaporation tail caused by the participation of additional particle degrees of freedom.

Conclusion: The findings suggest that the modified gamma-ray spectrum can serve as a reliable indicator of new physics related to subdominant PBHs, making it accessible for upcoming experimental detection.
...
### [78] [Anomalies, Topology, and Hadron Structure in QCD](https://arxiv.org/abs/2606.13908)
*Ismail Zahed*

Main category: hep-ph

TL;DR: This review examines the role of quantum anomalies in Quantum Chromodynamics (QCD), focusing on their implications for hadron masses, vacuum structure, and connections to partonic observables.


<details>
  <summary>Details</summary>
Motivation: To elucidate how quantum effects, particularly anomalous symmetry breaking, influence the behavior and properties of strong-interaction physics within QCD.

Method: The review discusses theoretical foundations, covering anomalous Ward identities, gauge field topology, and implications for hadron structure, emphasizing experimental manifestations.

Result: Findings highlight the significance of gluonic dynamics and vacuum topology in explaining hadron masses and behaviors, including the $η'$ mass and its connection to the $U(1)_A$ problem.

Conclusion: The paper concludes that understanding quantum anomalies and vacuum structure is critical for bridging nonperturbative and perturbative aspects of QCD, providing insights into hadronic and partonic phenomena.
...
### [79] [Probing the $G(3900)$ State in Heavy-Ion Collisions](https://arxiv.org/abs/2606.13909)
*Luciano M. Abreu,Pedro Brandão,Rodrigo O. Magalhães,Fernando S. Navarra*

Main category: hep-ph

TL;DR: The study explores the interactions of the exotic hadron $G(3900)$ in a hadronic medium, using an effective Lagrangian approach to calculate cross sections and multiplicity in heavy-ion collisions, finding a lower yield compared to $Z_c(3900)$.


<details>
  <summary>Details</summary>
Motivation: To investigate the behavior and production mechanisms of the exotic hadron $G(3900)$ in the context of heavy-ion collisions and its interactions with light mesons.

Method: An effective Lagrangian approach is utilized to compute cross sections for $G(3900)$ interactions and employ rate equations to model its multiplicity over time, relying on initial conditions from statistical and coalescence hadronization models.

Result: The study finds that the final yield of $G(3900)$ in central Pb-Pb collisions at $
um{s_{NN}} = 5.02$ TeV is considerably smaller than that of $Z_c(3900)$.

Conclusion: The production of the exotic hadron $G(3900)$ is less significant than that of $Z_c(3900)$ in heavy-ion collision environments.
...
### [80] [A Model-Independent Approach to First-Order Phase Transitions, Gravitational Waves, and Primordial Magnetic Fields](https://arxiv.org/abs/2606.13943)
*Fayez Abu-Ajamieh,Nobuchika Okada*

Main category: hep-ph

TL;DR: This paper examines strong First-Order Phase Transitions (FOPT) in Beyond Standard Model physics using Effective Field Theory, finding that certain Higgs interactions can lead to detectable Gravitational Wave signals and address magnetic field puzzles.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of strong FOPT in BSM scenarios through the lens of Effective Field Theory, particularly focusing on the role of Higgs interactions.

Method: A model-independent Effective Field Theory approach is applied to analyze Higgs cubic and quartic interactions, while calculating Gravitational Wave power spectra and investigating the generated magnetic fields from FOPT.

Result: Large deviations in Higgs coupling can lead to strong FOPT, with significant GW signals detectable by future experiments. Notably, changes in the Higgs quartic coupling have the most substantial effect on FOPT.

Conclusion: The study indicates the viability of probing Higgs couplings through both collider experiments and Gravitational Wave observations, with potential implications for new physics at energy scales as low as 4-11 TeV.
...
### [81] [Thermal dileptons to probe the baryon-rich QCD matter in the forward region of LHC energy heavy-ion collisions](https://arxiv.org/abs/2606.14166)
*Motomi Oya,Nicholas J. Benoit,Chiho Nonaka,Azumi Sakai,Yorito Yamaguchi*

Main category: hep-ph

TL;DR: The study examines how finite baryon chemical potential affects thermal dilepton production in quark-gluon plasma during central Pb-Pb collisions at LHC energies. A suppression of dilepton production is observed due to reduced quark-antiquark abundance, indicating the potential of forward-rapidity dileptons as thermometers for baryon density.


<details>
  <summary>Details</summary>
Motivation: To investigate thermal dilepton production in quark-gluon plasma with finite baryon chemical potential in Pb-Pb collisions at LHC energies, highlighting the influence of baryon density on dilepton spectra.

Method: A (3+1)-dimensional hydrodynamic framework is used to incorporate finite baryon chemical potential and calculate thermal dilepton spectra over a wide rapidity range in the context of Pb-Pb collisions.

Result: A suppression of 3-4% in dilepton production is observed in the forward-rapidity region due to decreased quark-antiquark abundance with finite baryon density. The effective temperature from dilepton mass spectra is closely tied to hydrodynamic temperature.

Conclusion: Forward-rapidity dileptons are effective thermometers for the QGP, providing insights into finite baryon density during the thermal evolution of the medium.
...
### [82] [Connecting DUNE to UV models through an EFT pipeline](https://arxiv.org/abs/2606.13983)
*Adriano Cherchiglia*

Main category: hep-ph

TL;DR: This paper investigates the potential of future neutrino experiments, particularly DUNE, to detect new physics signals through the lens of effective field theories, specifically examining the implications of SMEFT Wilson coefficients.


<details>
  <summary>Details</summary>
Motivation: To explore how new physics could be probed by future experiments like DUNE, focusing on non-standard interactions and their manifestations in effective field theory frameworks.

Method: The authors develop a pipeline to analyze new physics signals phenomenologically linked to SMEFT Wilson coefficients, particularly regarding contributions from extra isosinglet and isodoublet fields while considering existing flavor constraints.

Result: The study shows that the relevant lepton-flavour-violating semileptonic coefficient can be significant but remains below the DUNE sensitivity benchmarks, specifically around ($10^{-2}m 	ext{TeV}^{-2}$).

Conclusion: This highlights the challenges in realizing significant signals of new physics within the current constraints, suggesting that while there is potential for discovery, the signals might be subtler than anticipated.
...
### [83] [Testing varying coupling constants through multi-Higgs production at the LHC](https://arxiv.org/abs/2606.14303)
*Ulf Danielsson,Rikard Enberg,Gunnar Ingelman,Soumyadip Kundu,Tanumoy Mandal,Subhadip Mitra*

Main category: hep-ph

TL;DR: The One Scalar Theory (1ST) proposes a single scalar field to explain Higgs self-coupling and top Yukawa coupling, offering a predictive model with experimental signals.


<details>
  <summary>Details</summary>
Motivation: To provide a simplified and predictive framework for the coupling dynamics in the electroweak sector.

Method: Introduce the One Scalar Theory (1ST) where a real singlet scalar field governs the dynamics, constraining production and decay modes to a single scale $Λ_0$.

Result: Show that collider phenomenology distinguishes di-Higgs and di-top resonance regions, establishing lower bounds on $Λ_0$ and demonstrating the capability of future High-Luminosity LHC experiments to probe up to $4$ TeV.

Conclusion: The 1ST framework is highly predictive and could definitively test the dynamics of the electroweak sector through experimental observations.
...
### [84] [Meson molecules in strong magnetic fields: non-monotonic evolution of the charged pion and kaon energies](https://arxiv.org/abs/2606.14017)
*Toru Kojo*

Main category: hep-ph

TL;DR: The paper investigates how strong magnetic fields affect hadronic dynamics, revealing distinct regimes of meson interactions through a Born-Oppenheimer analysis.


<details>
  <summary>Details</summary>
Motivation: To understand the impact of strong magnetic fields on quark dynamics and hadronic bound states.

Method: Employing a Born-Oppenheimer framework to analyze the interactions within meson-meson systems under strong magnetic fields, highlighting dimensional reduction effects.

Result: Identified three regimes of meson interactions: scattering-dominated, molecular, and compact multiquark states, particularly focusing on charged pseudoscalar mesons like $π_+$ and $K_+$.

Conclusion: Strong magnetic fields serve as a vital tool for investigating and categorizing hadronic bound states, with potential implications for understanding underlying particle interactions.
...
### [85] [Quality control for axions and ALPs](https://arxiv.org/abs/2606.14098)
*Andrew Cheek,Andrew Fowlie,Gonzalo Herrera*

Main category: hep-ph

TL;DR: The paper studies the implications of quantum gravity on axions and axion-like particles (ALPs), emphasizing the required fine-tuning for acceptable parameters, resulting in a central focus on the quality of PQ symmetries.


<details>
  <summary>Details</summary>
Motivation: To understand how quantum gravity affects axion and ALP properties, specifically the fine-tuning needed for the strong CP phase and ALP masses.

Method: The authors model quantum gravity effects through Planck-suppressed operators and analyze the fine-tuning required for a strong CP phase and ALP mass, while evaluating measurements in upcoming experiments.

Result: For the QCD axion to explain dark matter at a specific mass scale, certain PQ-breaking operators must be absent, and parts of the parameter space for ALPs are already highly fine-tuned, necessitating significant PQ protection.

Conclusion: Quality of PQ protection is deemed crucial for understanding axion naturalness beyond merely mass considerations.
...
### [86] [The unintuitive SU(3) flavor and chiral limits of hadron resonances](https://arxiv.org/abs/2606.14634)
*José Ramón Peláez,Pablo Rabán,Jacobo Ruiz de Elvira*

Main category: hep-ph

TL;DR: Hadron resonance poles may not continuously degenerate in the SU(3)$_F$ and chiral limits of QCD; shadow poles, often overlooked, may instead define these resonances.


<details>
  <summary>Details</summary>
Motivation: To investigate the behavior of hadron resonance poles in QCD, particularly in the SU(3)$_F$ and chiral limits, and challenge naive expectations regarding their degeneracy.

Method: The study employs a one-loop unitarized QCD low-energy effective theory to analyze the properties of both light-vector mesons and light-scalar mesons, focusing on shadow poles.

Result: The findings show that shadow poles, rather than the standard resonance poles, exhibit degeneracy in the SU(3)$_F$ and chiral limits, providing new insight into resonance characterization.

Conclusion: The identification of shadow poles expands our understanding of hadron resonances in QCD, suggesting that these poles play a crucial role in resonance behavior as the limits are approached.
...
### [87] [Small x dynamics of the unpolarised color dipole gluon TMD PDFs for all transverse momenta](https://arxiv.org/abs/2606.14290)
*Mariyah Siddiqah,Nahid Vasim,Mushood Nabi*

Main category: hep-ph

TL;DR: The paper presents a general solution to the BK equation that describes gluon TMD distributions in saturation and beyond, showing key properties across variable transverse momenta and exhibiting universal characteristics indicative of gluon saturation.


<details>
  <summary>Details</summary>
Motivation: To understand the partonic behavior and gluon TMD distributions in the small x regime, especially in relation to gluon saturation phenomena.

Method: The authors Fourier-Bessel transform the general S matrix of the BK equation, applying the leading logarithmic approximation to derive a closed form expression for unpolarized gluon TMD distributions.

Result: The derived gluon TMD distribution demonstrates a smooth dependence on transverse momentum and shows a distinctive x-ordering inversion at the saturation scale, validated numerically for conditions relevant to the EIC.

Conclusion: The findings align with the BGK model's predictions, providing evidence that the observed gluon saturation feature is independent of the model used.
...
### [88] [Light-front gluonic gravitational distributions and the chromoelectric EMT projection in near-threshold quarkonium scattering](https://arxiv.org/abs/2606.14304)
*Arkadiy I. Syamtomov*

Main category: hep-ph

TL;DR: The paper constructs light-front gravitational distributions using scalar and non-scalar energy-momentum tensors related to quarkonium scattering, revealing differences in transverse localization and probing chromoelectric properties.


<details>
  <summary>Details</summary>
Motivation: To deepen understanding of gravitational distributions associated with different energy-momentum tensors in quarkonium chromoelectric scattering.

Method: Construction of transverse gravitational distributions in the Drell--Yan frame, separating universal EMT form-factor shapes from normalization, and normalizing by a pre-derived threshold strength.

Result: Demonstrated that scalar and non-scalar energy-momentum tensor responses exhibit differing transverse localization; quarkonium production highlights a chromoelectric energy-momentum tensor projection instead of individual form-factor slopes.

Conclusion: The findings suggest distinct behaviors of scalar versus non-scalar distributions in the context of near-threshold quarkonium production, enhancing the understanding of chromoelectric interactions.
...
### [89] [On Compositeness of $D_{s0}^*(2317)$ and its decay to $D_sπ^0$](https://arxiv.org/abs/2606.14305)
*Yu-Hui Zhou,Xiu-Li Gao,Bin Wu,Jun-Xi Cui,Zhi-Yong Zhou*

Main category: hep-ph

TL;DR: The $D_{s0}^{*}(2317)$ is a bound state formed by the coupling of a $car{s}(1^3P_0)$ state and the $DK$ continuum, exhibiting mixed characteristics of a compact quark-state and a hadronic molecule, with a significant decay channel analyzed.


<details>
  <summary>Details</summary>
Motivation: To understand the nature and decay mechanisms of the exotic $D_{s0}^{*}(2317)$ state, particularly its composition and behavior in specific decay channels.

Method: Utilizing the Lee-Friedrichs model, the interaction between the discrete $car{s}(1^3P_0)$ state and the $DK$ continuum is analyzed, alongside a quark rearrangement framework for decay calculations.

Result: The $D_{s0}^{*}(2317)$ shows approximately equal components of quark-model state and hadronic molecule (51.1% vs. 48.9%), with the decay width calculated through a coupling model highlighting isospin violation effects.

Conclusion: This work provides deeper insight into the nature of the $D_{s0}^{*}(2317)$ and its decay properties, emphasizing the role of isospin violation in its decay routes.
...
### [90] [Unavoidable Loop-Induced Quintessence -- Higgs Mixing and Its Phenomenological Consequences](https://arxiv.org/abs/2606.14320)
*Zurab Kepuladze*

Main category: hep-ph

TL;DR: This study explores quintessence models where dark energy interacts with sterile neutrinos, impacting Higgs interactions and cosmology through radiative corrections.


<details>
  <summary>Details</summary>
Motivation: To establish a connection between dark energy dynamics, neutrino mass generation, and Higgs sector phenomenology, particularly examining how sterile neutrinos influence these interactions.

Method: The paper calculates one-loop mixing amplitudes between the quintessence scalar field and sterile neutrinos, analyzing how these interactions depend on momentum transfer and the sterile-neutrino mass.

Result: Findings indicate that mixing forms vary with momentum; at low energies, the effect is kinetic, while at high energies, it becomes mass-related. The mixing is suppressed by the neutrino mass scale, correlating neutrino properties with Higgs-quintessence interactions.

Conclusion: Though current effects are below experimental sensitivity in the minimal heavy-seesaw model, this framework provides a foundation for future explorations of lighter sterile neutrinos which may yield observable effects.
...
### [91] [High-scale Mirror Standard Model Dark Matter, Dark Phase Transitions and Gravitational Waves Implications](https://arxiv.org/abs/2606.14385)
*V. K. Oikonomou*

Main category: hep-ph

TL;DR: The paper explores a dark Standard Model sector interacting only via gravity with the ordinary Standard Model. It discusses the implications of differing scales and Yukawa couplings on the Universe's evolution, highlighting dark phase transitions and their potential effects on gravitational waves. The findings suggest that high scale mirror dark matter could form atomic structures and address inconsistencies in astrophysical observations.


<details>
  <summary>Details</summary>
Motivation: To examine the properties and implications of a gravitationally interacting dark Standard Model sector, particularly how it could resolve existing astrophysical inconsistencies.

Method: Analysis of a dark Standard Model sector with differing scales and Yukawa couplings, study of phase transitions and their effects on gravitational wave spectra, and assessment of mirror dark matter's atomic formation.

Result: Identified possible first or second order phase transitions in the dark sector, which could influence gravitational wave observations. Also demonstrated conditions under which mirror dark matter can form atomic structures.

Conclusion: High scale mirror dark matter can reconcile observed phenomena like the Bullet and Abell 520 clusters while exhibiting interesting characteristics such as potential atomic formation.
...
### [92] [Bose-enhanced Neutrino Decays in a Thermal Medium](https://arxiv.org/abs/2606.14441)
*Yuber F. Perez-Gonzalez,Manibrata Sen,Walter Tangarife*

Main category: hep-ph

TL;DR: The study calculates the thermal decay width of neutrinos in a medium, revealing that near-degenerate mass states significantly enhance decay rates due to thermal effects.


<details>
  <summary>Details</summary>
Motivation: To explore how thermal environments affect neutrino decay processes, particularly for non-standard decays into lighter neutrinos and bosons.

Method: Utilizing finite-temperature quantum field theory to derive decay rate expressions and analyzing effects of thermal occupation and kinematics.

Result: Demonstrated significant enhancement of decay widths in thermal conditions, particularly for nearly degenerate mass states, with results largely independent of interaction specifics.

Conclusion: The findings present a new understanding of neutrino decay in thermal environments, offering a framework for various fermionic decays.
...
### [93] [Light hybrid baryons in the constituent model of QCD](https://arxiv.org/abs/2606.14451)
*Joachim Viseur,Claude Semay,Cyrille Chevalier*

Main category: hep-ph

TL;DR: This study investigates the mass spectrum of light hybrid baryons using a constituent framework, demonstrating their properties and relationship with quantum chromodynamics.


<details>
  <summary>Details</summary>
Motivation: To explore the dynamics of hybrid baryons, which are crucial for understanding nonperturbative quantum chromodynamics (QCD).

Method: The mass spectrum is analyzed using a quark core-gluon approximation, reducing a four-body problem into manageable calculations involving a three-body core and a two-body treatment, utilizing semirelativistic Hamiltonians and helicity formalism.

Result: The analysis predicts that light hybrid baryons exist at energies above 3 GeV, with negative-parity states generally found to be lighter than positive-parity ones, aligning qualitatively with lattice QCD results despite some discrepancies in absolute mass values.

Conclusion: The findings provide new insights into hybrid baryon properties, emphasizing the need for future experimental validation and potential model extensions.
...
### [94] [Tripartite entanglement of oscillating and decohering neutrinos](https://arxiv.org/abs/2606.14454)
*Subhashish Banerjee,Heinrich Päs,Erika Rani*

Main category: hep-ph

TL;DR: A study establishes entanglement measures for oscillating neutrinos, identifying genuine tripartite entanglement and its persistence under decoherence, along with the impact of CP phases.


<details>
  <summary>Details</summary>
Motivation: Investigating the quantum properties of neutrinos may enhance understanding of neutrino oscillations and their application in quantum information science.

Method: Utilizing the wave-packet formalism, the study analyzes tripartite entanglement in oscillating neutrinos and evaluates the effects of decoherence and CP phases.

Result: Oscillating neutrinos exhibit genuine tripartite entanglement and align with the W class of states, maintaining these characteristics despite decoherence.

Conclusion: The research advances knowledge in quantum neutrino behavior and suggests implications for quantum information technologies, particularly with astrophysical neutrinos observed in telescopes.
...
### [95] [Cosmological signals of dark matter semi-annihilation](https://arxiv.org/abs/2606.14495)
*Boris Betancourt Kamenetskaia,Mathias Garny,Alejandro Ibarra,Alessia Musumeci,Merlin Reichard*

Main category: hep-ph

TL;DR: Research on dark matter reveals that semi-annihilation processes significantly enhance detection sensitivity, allowing exploration of lower mass ranges in future experiments.


<details>
  <summary>Details</summary>
Motivation: To understand how primordial density fluctuations impact dark matter distribution and detection methods in the early Universe.

Method: The study employs a cosmological boost factor model to compute the redshift-dependent flux of dark matter particles resulting from semi-annihilation processes.

Result: Findings indicate that the semi-annihilation processes can boost dark matter detection sensitivity by up to three orders of magnitude, enabling the probing of lower mass regimes.

Conclusion: The enhanced sensitivity may allow future experiments to detect dark matter scattering cross sections in the femtobarn range for masses from approximately 10 MeV to 1 GeV.
...
### [96] [Efficient calculation of exclusive diffractive cross sections at the EIC and LHeC with the Sartre event generator](https://arxiv.org/abs/2606.14633)
*Tobias Toll,Dipan Ghosh,Abhinav Srivastav*

Main category: hep-ph

TL;DR: This paper describes an upgraded version of the Sartre event generator for simulating exclusive diffraction processes, improving efficiency in generating lookup tables and resolving numerical issues.


<details>
  <summary>Details</summary>
Motivation: The aim is to enhance the simulation of exclusive diffraction in various scattering scenarios, addressing previous inefficiencies and numerical glitches in the process of generating lookup tables.

Method: The paper introduces a new numerical approach that significantly streamlines the production of lookup tables for interaction amplitudes in the Sartre generator, achieving a speedup of 3-4 orders of magnitude.

Result: The new method allows for efficient table production for different nuclear targets and final state outputs, completed within hours rather than years, while eliminating previous numerical glitches.

Conclusion: This advancement enables comprehensive simulations of exclusive diffraction processes at EIC and LHeC, offering new predictions and simplifying the research process.
...
### [97] [In search for signals of the $D\bar{D}$ bound state $X(3700)$ from study of the $B^+ \to D^+ D^- K^+$, $B^0 \to D^+ D^- K^0$ and $Λ_b \to D^+ D^- Λ$ reactions](https://arxiv.org/abs/2606.14644)
*Xiu-Lei Ren,Hai-Peng Li,Wei-Hong Liang,Chu-Wen Xiao,Eulogio Oset*

Main category: hep-ph

TL;DR: This study analyzes the reactions $B^+ 	o D^+ D^- K^+$, $B^0 	o D^+ D^- K^0$, and $Λ_b 	o D^+ D^- Λ$, focusing on the final state interactions of charmed mesons that generate resonances like $X_{c0}(3930)$ and a bound state $X(3700)$. The research indicates a significant difference in the final state interaction strength between the $B^+$ and $Λ_b$ reactions, highlighting the importance of upcoming measurements to validate the existence of the bound state.


<details>
  <summary>Details</summary>
Motivation: To explore the production mechanisms of specific B-meson decay reactions and understand the dynamics of charmed meson final states, particularly resonances and bound states.

Method: Theoretical analysis of B-meson decay mechanisms with emphasis on final state interactions, supported by comparisons of mass distributions from related reactions.

Result: A comparison of mass distributions reveals that the $B^+ 	o D^+ D^- K^+$ reaction has a peak approximately 13 times larger than that of the $Λ_b 	o D^+ D^- Λ$, indicating stronger final state interactions for the former.

Conclusion: The findings encourage further measurements at LHCb to provide evidence for the strongly coupled bound $D^+ D^-$ state.
...
### [98] [Leptonic flavour transfer: a new window on flavour gauge symmetries](https://arxiv.org/abs/2606.14689)
*L. Darmé,N. Fardeau,F. Mahmoudi,M. Palmiotto*

Main category: hep-ph

TL;DR: This paper explores new non-abelian gauge groups in the lepton sector and their potential implications for flavour-transfer processes, comparing these to standard interactions and assessing experimental constraints, particularly from heavy lepton lifetimes.


<details>
  <summary>Details</summary>
Motivation: To investigate new theoretical frameworks for flavour interactions and their consistency with existing experimental data, especially in the lepton sector.

Method: The paper employs a systematic study of various flavour structures and constraints from accelerator experiments, utilizing the MARTY framework for numerical predictions and darkpack for dark matter compatibility assessments.

Result: Findings reveal that heavy lepton lifetime constraints dominate most parameter space, with certain regions still viable for future searches at electron-positron colliders.

Conclusion: Extensions of these models are potentially compatible with dark matter relic density, suggesting further avenues for theoretical exploration and experimental verification.
