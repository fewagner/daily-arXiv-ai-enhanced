...
### [1] [Higher-Dimensional Information Lattice: Quantum State Characterization through Inclusion-Exclusion Local Information](https://arxiv.org/abs/2512.20793)
*Ian Matthias Flór,Claudia Artiaco,Thomas Klein Kvorning,Jens H. Bardarson*

Main category: quant-ph

TL;DR: This paper extends the concept of an information lattice from one-dimensional chains to higher-dimensional geometries, addressing challenges in assigning unique information to overlapping subsystems using an inclusion-exclusion principle.


<details>
  <summary>Details</summary>
Motivation: To better characterize quantum many-body states in higher dimensions, overcoming the limitations of traditional one-dimensional information lattices that struggle with overlapping subsystems.

Method: Introduction of a higher-dimensional information lattice where local information is defined through an inclusion-exclusion principle, implemented explicitly in two dimensions.

Result: Extraction of information-based localization lengths, direction-dependent critical exponents, edge mode information, long-range patterns due to topological order, and signatures of non-Abelian fusion channels in various many-body ground states.

Conclusion: The study establishes a comprehensive information-theoretic framework for capturing universal scale-resolved features of quantum many-body states in higher dimensions.
...
### [2] [Liouvillian Gap in Dissipative Haar-Doped Clifford Circuits](https://arxiv.org/abs/2602.03234)
*Ha Eum Kim,Andrew D. Kim,Jong Yeon Lee*

Main category: quant-ph

TL;DR: This paper explores the relationship between chaotic dynamics and minimal departures from Clifford circuits using a dissipative diagnostic, demonstrating how doping influences the Liouvillian gap in different scenarios.


<details>
  <summary>Details</summary>
Motivation: The study aims to understand the minimal changes needed in Clifford dynamics for intrinsic relaxation in chaotic systems.

Method: The authors analyze the dynamics of Floquet two-qubit Clifford circuits interleaved with random single-site gates and a depolarizing channel, examining the Liouvillian gap under varying doping densities.

Result: Two regimes for the Liouvillian gap were identified: one that scales with the system size and another that remains constant as the system approaches infinity, heavily influenced by doping density.

Conclusion: Doping alters the chaotic behavior diagnostics, showing that the spatial structure can lead to different gap scaling, with implications for understanding the effects of disorder in chaotic systems.
...
### [3] [Neural Network Discovery of Paired Wigner Crystals in Artificial Graphene](https://arxiv.org/abs/2602.16798)
*Conor Smith,Yubo Yang,Zhou-Quan Wan,Yixiao Chen,Miguel A. Morales,Shiwei Zhang*

Main category: quant-ph

TL;DR: This study discovers a novel ground state in a two-dimensional electron gas on a honeycomb moiré lattice, featuring paired electrons forming a valence bond state and a molecular Wigner crystal.


<details>
  <summary>Details</summary>
Motivation: The exploration of moiré systems as a platform for studying quantum matter and identifying exotic states.

Method: A neural-network-based quantum Monte Carlo approach is utilized to analyze the electron interactions in the moiré potential.

Result: At filling factor $ν_m =1/4$, opposite-spin electrons form a singlet-like valence bond state resulting in a molecular Wigner crystal and restoring local $C_6$ symmetry.

Conclusion: The discovery of this paired Wigner crystal highlights collective phenomena in quantum many-body systems, suggesting avenues for engineering unique properties.
...
TL;DR: The paper establishes a bound on the diamond norm of the composition of a transposition map with the difference of the identity and any quantum channel, demonstrating an explicit constant exists.


<details>
  <summary>Details</summary>
Motivation: The study aims to explore the properties of quantum channels and their behavior under specific transformations, particularly in relation to the diamond norm, which is crucial for characterizing quantum maps.

Method: The authors provide a proof that includes the establishment of an absolute constant α<1, specifically showing that α=1/√2 suffices as a bound for the discussed relationship involving quantum channels and the transposition map.

Result: It is shown that for any finite dimension d and any quantum channel T, the stated inequality involving the diamond norms holds true, thereby confirming the existence of an explicit constant.

Conclusion: The findings contribute to the understanding of quantum channel behavior, particularly emphasizing the role of the transposition map in relation to the diamond norm, with practical implications in quantum information theory.
...
TL;DR: This paper discusses quantum Zeno dynamics and presents a unified framework involving a nonadiabatic geometric connection for achieving shortcuts to adiabaticity through adaptive measurements.


<details>
  <summary>Details</summary>
Motivation: To explore the quantum Zeno effect in the context of time-dependent projectors and its implications for adiabatic processes in quantum systems.

Method: The study utilizes a stroboscopic measurement protocol to derive an effective Hamiltonian illustrating Zeno dynamics, incorporating nonadiabatic geometric connections and examining continuous quantum measurements with a complex time-dependent potential.

Result: The effective Zeno Hamiltonian resembles the Kato-Avron model for parallel transport and reveals aspects of counterdiabatic driving when projective measurements align with instantaneous energy eigenstates.

Conclusion: The findings lay the groundwork for leveraging quantum Zeno measurements to create shortcuts to adiabaticity, enhancing the efficiency of quantum state manipulations.
...
### [6] [Measuring and correcting nanosecond pulse distortions in quantum-dot spin qubits](https://arxiv.org/abs/2602.17899)
*Jiheng Duan,Fernando Torres-Leal,John M. Nichol*

Main category: quant-ph

TL;DR: The paper presents a method to measure and correct electrical pulse distortions in silicon quantum dots via detuning-axis pulsed spectroscopy, enhancing control fidelity of qubits.


<details>
  <summary>Details</summary>
Motivation: To improve the fidelity of control in gate-defined semiconductor quantum dots by addressing the challenge of electrical pulse distortions that limit performance.

Method: Utilized detuning-axis pulsed spectroscopy to characterize and extract the gate-voltage impulse response, followed by applying a digital pre-distortion filter to mitigate distortions on longer timescales.

Result: Achieved reduced frequency chirp in coherent exchange oscillations of a singlet-triplet qubit, demonstrating improved control over the qubit states.

Conclusion: Proposed an efficient method for characterizing and correcting pulse distortions, contributing to the scalability and performance enhancement of quantum-dot spin qubits.
...
### [7] [Exact quantum decision diagrams with scaling guarantees for Clifford+$T$ circuits and beyond](https://arxiv.org/abs/2602.17775)
*Arend-Jan Quist,Tim Coopmans,Alfons Laarman*

Main category: quant-ph

TL;DR: The paper introduces an algebraic method for representing complex numbers in decision diagrams for quantum circuits, ensuring better accuracy and lower computational complexity, especially for Clifford and $T$ gates.


<details>
  <summary>Details</summary>
Motivation: Address floating-point errors in decision diagrams used for quantum computing, specifically focusing on improving accuracy and efficiency for circuits involving Clifford and $T$ gates.

Method: Developed an algebraic representation of complex numbers, proving that the sizes of these representations are linearly bounded by the number of $T$ gates and qubits, while maintaining constant size with Clifford gates. Established runtime and node count bounds for decision diagrams based on gate counts and qubits.

Result: Proved linear bounds on algebraic representations and upper bounds on runtime and node counts, specifically $2^t 	imes poly(g,n)$. These results link quantum state characteristics to decision diagram width and demonstrate improved accuracy over floating-point methods.

Conclusion: Presented the first scaling guarantees for the runtime of quantum decision diagram simulations, significantly mitigating numerical instabilities and showcasing better performance with fewer nodes in open-source implementations.
...
### [8] [Polariton-polariton coherent coupling in a molecular spin-superconductor chip](https://arxiv.org/abs/2602.18103)
...
TL;DR: This paper explores interactions between polaritons in superconducting resonators for scalable quantum communication, demonstrating coherent interactions and entanglement through microwave transmission experiments.


<details>
  <summary>Details</summary>
Motivation: The study aims to enhance coherent communication in quantum devices by establishing interactions between distant polaritons.

Method: The researchers engineered interactions between polaritons using capacitively and inductively coupled superconducting resonators, incorporating organic free radicals as spin ensembles to study polariton behavior under varying magnetic fields and resonator configurations.

Result: Experiments showed that spins couple to both local and empty cavity modes, with an avoided level crossing indicating coherent polariton interactions when tuned to resonance, confirmed by pump-probe experiments revealing information transfer between polaritons.

Conclusion: The findings demonstrate effective control and detection of photon-photon and spin-spin correlations, suggesting pathways for scalable quantum communication applications.
...
### [9] [High-quality single photons from cavity-enhanced biexciton-to-exciton transition](https://arxiv.org/abs/2602.18153)
...
TL;DR: The paper explores a method for generating high-quality single photons using a three-level cascade in a semiconductor quantum dot, addressing common challenges like spectral overlap and emitter re-excitation.


<details>
  <summary>Details</summary>
Motivation: Current solutions for generating single photons face challenges of spectral overlap and purity loss, prompting the investigation of few-level systems with separated excitation and emission pathways.

Method: The authors study a semiconductor quantum dot with resonant cavity-enhanced excitation of the biexciton-to-exciton transition, collecting emitted photons via a selective strategy that avoids re-excitation.

Result: Theoretical demonstrations indicate that the proposed method yields competitive purity and indistinguishability metrics for single-photon emission, comparable to existing high-quality sources.

Conclusion: The approach is positioned as a promising alternative for advancing deterministic single-photon sources based on quantum dots, achieving notable qualities without extensive optimization.
...
### [10] [Manipulating heterogeneous quantum resources over a network](https://arxiv.org/abs/2602.17803)
*Ray Ganardi,Jeongrak Son,Jakub Czartowski,Seok Hyung Lie,Nelly H. Y. Ng*

Main category: quant-ph

TL;DR: This paper introduces a unified framework for composite quantum resource theories that address the manipulation of resources in distributed networks, overcoming limitations of previous models focusing on isolated resources, and it establishes fundamental bounds and new operational methods.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the lack of a comprehensive framework for manipulating multiple quantum resources in distributed settings where different constraints coexist.

Method: A unified framework is developed from axioms that respect local structures, leading to derivation of universal bounds on resource manipulation applicable across various network configurations.

Result: The results provide fundamental bounds on resource manipulation, introduce methods for constructing new resource monotones, and reveal new phenomena in remote certification of quantum resources.

Conclusion: The framework sets foundational laws for the manipulation of distributed quantum resources, applicable to diverse physical platforms.
...
### [11] [Higher-order spatial photon interference versus dipole blockade effect](https://arxiv.org/abs/2602.18269)
*Arthur Rotari,Mihai A. Macovei*

Main category: quant-ph

TL;DR: The paper investigates three coupled two-level emitters in an equilateral triangle, showing they can generate sub-Poissonian single-photon streams through interactions with a thermal reservoir and demonstrating that photon statistics depend on emitter arrangement and distance.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics of dipole-dipole coupled emitters and their interaction with a thermal environment in generating non-classical light.

Method: The authors derive populations of cooperative atomic states and spatial photon correlation functions analytically, analyzing the system's dynamics at varying inter-atomic distances.

Result: The study reveals spontaneous generation of single photons with sub-Poissonian statistics and identifies that these features arise from the geometry of emitters and their thermal environment, with significant interference effects at larger atomic separations.

Conclusion: The findings indicate that the nature of interactions among symmetrically arranged emitters leads to unique quantum optical features, including sub-wavelength interference patterns in photon correlations.
...
### [12] [Digital Quantum Simulation of the Holstein-Primakoff Transformation on Noisy Qubits](https://arxiv.org/abs/2602.17806)
*Kelvin Yip,Alessandro Monteros,Sahel Ashhab,Lin Tian*

Main category: quant-ph

TL;DR: This work advances digital quantum simulation of bosonic systems using the Holstein-Primakoff transformation on cloud-based superconducting quantum processors, addressing algorithmic and hardware errors.


<details>
  <summary>Details</summary>
Motivation: To explore collective quantum dynamics of bosonic systems, which are complex due to their large Hilbert space, using quantum simulation techniques.

Method: Implemented the Holstein-Primakoff transformation on a cloud-based superconducting quantum processor, simulating a driven harmonic oscillator and the Jaynes-Cummings model.

Result: Identified dominant algorithmic errors from qubit limitations and Trotter steps, and hardware errors from gate infidelity and decoherence, optimizing simulation parameters.

Conclusion: This study enhances the digital quantum simulation of many-body bosonic systems and provides a framework for future complex spin-boson and multimode cavity models.
...
### [13] [Impossibility of Refrigeration and Engine Operation in Minimal Qubit Repeated-Interaction Models](https://arxiv.org/abs/2602.18300)
*Gabrielle Barsky-Giles,Alessandro Prositto,Matthew Gerry,Dvira Segal*

Main category: quant-ph

TL;DR: The paper explores qubit operation as a quantum thermal device, analyzing both alternating and simultaneous coupling to heat baths, proving a no-go theorem for quantum refrigeration under strong coupling conditions.


<details>
  <summary>Details</summary>
Motivation: To understand the limitations and behaviors of qubit-based thermal machines under Markovian interactions.

Method: Two models are considered: alternating coupling (sequential interactions with hot/cold baths) and simultaneous coupling (interaction with both baths at once). An exact solution for the limit-cycle state is obtained in the alternating model, and perturbative analysis is used for the simultaneous model.

Result: The findings prove that while local work generation is possible, total work over a cycle is nonpositive, limiting engine operation, and heat conduction is described with a nonmonotonic current behavior.

Conclusion: The results indicate fundamental constraints on qubit-based quantum thermal machines and suggest that more complex models are needed for practical applications.
...
### [14] [Quantum superresolution and noise spectroscopy with quantum computing](https://arxiv.org/abs/2602.17862)
*James W. Gardner,Federico Belliardo,Gideon Lee,Tuvia Gefen,Liang Jiang*

Main category: quant-ph

TL;DR: Quantum computing can enhance the detection of weak incoherent signals by using methods like weak Schur sampling and quantum signal processing, providing faster algorithms compared to traditional state tomography.


<details>
  <summary>Details</summary>
Motivation: The research addresses the need for efficient methods to detect weak incoherent signals amidst uncertainty in signal and noise characteristics.

Method: The authors investigate quantum computing techniques like weak Schur sampling, density matrix exponentiation, and quantum signal processing to assess properties like rank and purity of quantum states.

Result: These quantum algorithms significantly outperform traditional full-state tomography in efficiency, particularly in high-dimensional Hilbert spaces.

Conclusion: The findings have practical implications for detecting various phenomena such as exoplanets and stochastic gravitational waves, demonstrating the potential of quantum metrology.
...
### [15] [Comparison of security mechanisms of Mathematical cipher, Wyner scheme, QKD, and Quantum stream cipher](https://arxiv.org/abs/2602.17933)
*Gikyu Yamamoto,Osamu Hirota*

Main category: quant-ph

TL;DR: Emerging global communications technology requires high speeds, low costs, and strong security, facing challenges particularly in physical layer security. The Y-00 protocol, a new cryptographic method, is explained in comparison to existing schemes to enhance understanding among different research fields.


<details>
  <summary>Details</summary>
Motivation: To address the urgent security challenges in global communication systems spanning from microwave to quantum optical communications.

Method: The paper compares the Y-00 protocol with other cryptographic methods, such as mathematical ciphers and QKD, to facilitate comprehension across various research domains.

Result: This comparative analysis helps elucidate differing security principles among cryptographic technologies, particularly the new Y-00 protocol.

Conclusion: Promoting mutual understanding among researchers in different sectors will be beneficial for addressing security challenges in communication technologies.
...
### [16] [Distributed Hyperbolic Floquet Codes under Depolarizing and Erasure Noise](https://arxiv.org/abs/2602.17969)
*Aygul Azatovna Galimova*

Main category: quant-ph

TL;DR: The paper presents hyperbolic Floquet codes for distributed quantum error correction, demonstrating their potential across various QPUs and under multiple noise models.


<details>
  <summary>Details</summary>
Motivation: The goal is to develop scalable quantum error correcting codes that can operate across distributed quantum processing units, leveraging shared entanglement.

Method: Hyperbolic Floquet codes are constructed from different tessellations using the Wythoff kaleidoscopic construction and distributed across QPUs via spectral bisection. Simulations are conducted under four noise models: depolarizing, SDEM3, correlated EM3, and erasure.

Result: The distributed codes achieve significant pseudo-thresholds under various noise models, specifically noting thresholds of up to 3.0% for depolarizing noise and 35-40% for erasure noise across different tessellations.

Conclusion: The study confirms the viability of hyperbolic Floquet codes as effective distributed quantum error correction strategies, ensuring robustness against various noise types.
...
### [17] [Recursive Sketched Interpolation: Efficient Hadamard Products of Tensor Trains](https://arxiv.org/abs/2602.17974)
*Zhaonan Meng,Yuehaw Khoo,Jiajia Li,E. Miles Stoudenmire*

Main category: quant-ph

TL;DR: This paper introduces Recursive Sketched Interpolation (RSI) for computing the Hadamard product of tensors in tensor-train format efficiently, reducing the computational cost from $	ext{O}(χ^4)$ to $	ext{O}(χ^3)$.


<details>
  <summary>Details</summary>
Motivation: Conventional methods for computing the Hadamard product of tensors suffer from high computational costs, making them inefficient for practical applications in various fields.

Method: The authors combine randomized tensor-train sketching with slice selection via interpolative decomposition to formulate the Recursive Sketched Interpolation (RSI) algorithm.

Result: Benchmarks show that RSI significantly improves scalability compared to traditional methods and achieves similar accuracy while maintaining the computational cost at $	ext{O}(χ^3)$.

Conclusion: RSI not only simplifies the computation of Hadamard products but also generalizes to more complex tensor operations without increasing computational complexity.
...
### [18] [Enhanced Maximum Independent Set Preparation with Rydberg Atoms Guided by the Spectral Gap](https://arxiv.org/abs/2602.17991)
*Seokho Jeong,Minhyuk Kim*

Main category: quant-ph

TL;DR: The paper presents ADGLB, a method to enhance adiabatic quantum computation using Rydberg atoms by modifying laser detuning to reduce ground-state leakage, improving performance in combinatorial optimization problems like the maximum independent set.


<details>
  <summary>Details</summary>
Motivation: Adiabatic quantum computation with Rydberg atoms is promising for solving complex optimization problems but is hindered by spectral gap reduction leading to state leakage during evolution.

Method: The authors introduce the Adjusted Detuning for Ground-Energy Leakage Blockade (ADGLB), which adjusts the laser detuning profile to minimize leakage without complicating the Hamiltonian or requiring iterative optimization.

Result: Experimental results show that ADGLB significantly increases the probability of preparing the maximum independent set for a 10-atom chain, and its effectiveness extends to larger instances up to 37 atoms on two-dimensional lattices.

Conclusion: The study reveals that spectral-gap-guided schedule engineering is a scalable, efficient approach for improving adiabatic quantum optimization on neutral-atom platforms.
...
### [19] [A Tailored Fidelity Estimation and Purification Method for Entangled Quantum Networks](https://arxiv.org/abs/2602.18011)
*Takafumi Oka,Michal Hajdušek,Shota Nagayama,Rodney Van Meter*

Main category: quant-ph

TL;DR: This paper presents a novel method for simultaneous quantum state reconstruction and entanglement purification, significantly reducing the required Bell pairs for high fidelity estimation compared to existing methods.


<details>
  <summary>Details</summary>
Motivation: To enhance the efficiency of quantum networks by reducing the number of Bell pairs needed for state reconstruction and to correct both bit-flip and phase-flip errors.

Method: The method allows for estimation of fidelity while purifying lower fidelity Bell pairs multiple times, achieving high confidence in the fidelity range.

Result: The new approach requires approximately 2,841 Bell pairs to achieve a fidelity estimate within a $0.01$ range with $99.7\%$ confidence, compared to $10^5$ pairs in previous methods.

Conclusion: This research provides numerical estimates and practical insights for improving the bootstrapping process of quantum networks, enabling the correction of both error types simultaneously.
...
TL;DR: This paper establishes that non-interactive classical verification of quantum computation cannot be reduced to any falsifiable assumption, thereby limiting the potential for fewer-message protocols.


<details>
  <summary>Details</summary>
Motivation: The work responds to Mahadev's breakthrough in classical verification of quantum computation, questioning the possibility of achieving shorter interactive protocols in the plain model.

Method: The authors demonstrate that no quantum black-box reduction exists for non-interactive classical verification of QMA to any falsifiable assumption, using a construction relative to a quantum unitary oracle.

Result: The findings imply that non-interactive classical verification of quantum computation is fundamentally limited and cannot leverage standard cryptographic assumptions like LWE.

Conclusion: This negative result strengthens the understanding of the complexity boundaries between QMA and QCMA and highlights the specific requirements for proving such gaps.
...
TL;DR: This paper introduces a method for dynamically tomographing multi-mode Bosonic Gaussian states using a single-mode measurement, requiring only control over measurement timing, expanding the applicability of quantum state tomography.


<details>
  <summary>Details</summary>
Motivation: To provide an alternative to standard quantum state tomography that requires less control over the system and can still achieve accurate state reconstruction.

Method: The scheme extends the concept of Dynamical Quantum State Tomography (DQST) to multi-mode Bosonic Gaussian states by employing a fixed single-mode homodyne measurement while varying only the time of measurement.

Result: The method successfully enables tomography for all discrete homogeneous Gaussian evolutions and Gaussian quantum dynamical semigroups, with exceptions for unitary evolution and a small null set. For pure states, fewer measurement times are necessary.

Conclusion: The proposed scheme enhances the practicality of quantum state tomography in scenarios with limited control, making it easier to reconstruct quantum states under specific conditions.
...
### [22] [Pulsed coherent spectroscopy of a quantum emitter in hexagonal Boron Nitride](https://arxiv.org/abs/2602.18096)
*Jake Horder,Hugo Quard,Kenji Watanabe,Takashi Taniguchi,Nathan Coste,Igor Aharonovich*

Main category: quant-ph

TL;DR: The study investigates B centers in hexagonal Boron Nitride (hBN) as deterministic quantum emitters, showcasing significant coherence and photon purity.


<details>
  <summary>Details</summary>
Motivation: To explore solid-state defects as quantum emitters for photonic applications, focusing on the properties of B centers in hBN.

Method: Coherence of individual B centers was analyzed using pulsed resonant excitation, measuring power-dependent Rabi oscillations and employing Ramsey interferometry.

Result: Power-dependent Rabi oscillations up to 5π were observed with a single photon purity of 93% at π-pulse and an inhomogeneous coherence time of T_2*=0.60 ns.

Conclusion: B centers in hBN are established as promising candidates for coherent quantum emitters, aiding in their future integration into quantum photonic systems.
...
### [23] [Directional Dynamics of the Non-Hermitian Skin Effect](https://arxiv.org/abs/2602.18106)
*Bin Yi*

Main category: quant-ph

TL;DR: This paper explores the dynamical aspects of the non-Hermitian skin effect (NHSE) using quantum Liang information flow as a measure of causal influence, revealing a linear relationship with non-reciprocity and various interesting temporal regimes.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamical consequences of the non-Hermitian skin effect, which have been under-explored compared to static properties.

Method: The study applies quantum Liang information flow (QLIF) to the non-Hermitian Su-Schrieffer-Heeger model with non-reciprocal hopping to analyze directional information dynamics.

Result: The findings demonstrate a scissors effect with a linear relation between asymmetry and non-reciprocity, and a non-monotonic dependency on skin length, highlighting NHSE-induced blocking of information flow.

Conclusion: This work establishes a quantitative link between static skin localization and directional information dynamics, providing new insights into information propagation in non-reciprocal quantum systems.
...
### [24] [Flux-Activated Resonant Control of a Bosonic Quantum Memory](https://arxiv.org/abs/2602.18122)
*Fernando Valadares,Aleksandr Dorogov,Tanjung Krisnanda,May Chee Loke,Ni-Ni Huang,Pengtao Song,Yvonne Y. Gao*

Main category: quant-ph

TL;DR: The paper presents a method for efficiently controlling bosonic systems for quantum information processing using a novel flux-control setup integrated with a 3D superconducting cavity, enabling flexible manipulation of Fock levels.


<details>
  <summary>Details</summary>
Motivation: To overcome limitations in controlling bosonic degrees of freedom in cQED, specifically the challenges posed by nearly degenerate cavity transitions.

Method: Integration of an on-chip flux-control architecture with a long-lived bosonic memory in a 3D superconducting cavity to dynamically access Jaynes-Cummings interactions for arbitrary rotations between Fock levels.

Result: Demonstrated efficient on-demand access to JC interactions, allowing for manipulation of any pair of Fock levels and implementation of robust Fock-basis qudits.

Conclusion: This work provides a versatile toolbox for high-dimensional quantum information processing by enhancing control over bosonic systems.
...
### [25] [Clock Synchronization with Weakly Correlated Photons](https://arxiv.org/abs/2602.18147)
*Justin Yu Xiang Peh,Darren Ming Zhi Koh,Zifang Xu,Xi Jie Yeo,Peng Kian Tan,Christian Kurtsiefer*

Main category: quant-ph

TL;DR: This study demonstrates effective synchronization of crystal clocks using weakly correlated photons, achieving low timing jitter over long durations and considerable optical loss.


<details>
  <summary>Details</summary>
Motivation: The need for precise clock synchronization in communication and distributed computing systems.

Method: Synchronization achieved using weakly time-correlated photons from a bunched light source, with a focus on timing jitter and coherence peak probabilities.

Result: A timing jitter of 10 ns is achieved over -102 dB optical channel loss for 25 hours, and a model improves estimates of coherence peak finding success under low signal conditions.

Conclusion: The findings suggest that weakly time-correlated photons can be effective for long-term clock synchronization despite significant optical losses.
...
### [26] [Dispersive Hong-Ou-Mandel Interference with Finite Coincidence Windows](https://arxiv.org/abs/2602.18156)
*T. J. Walstra,A. J. Hasenack,P. W. H. Pinkse,B. Skoric*

Main category: quant-ph

TL;DR: This study investigates the impact of finite detection windows on Hong-Ou-Mandel interference, revealing that real-world measurement constraints affect dispersion cancellation and the resultant HOM dip shape.


<details>
  <summary>Details</summary>
Motivation: The interplay between chromatic dispersion and finite detection windows in quantum measurements is not well understood, despite its importance in quantum information processing.

Method: An analytical model for type-II SPDC processes is derived, predicting changes in the HOM dip shape due to finite timing resolution, which is then validated experimentally using a ppKTP source and optical fibers.

Result: The experiment demonstrates excellent concordance with the model, particularly revealing oscillations and dip broadening influenced by the coincidence window, and allows precise extraction of fiber dispersion parameters.

Conclusion: The findings highlight the necessity of considering finite timing resolution in designing and characterizing dispersive quantum communication systems.
...
### [27] [Experimental realization of a photonic weighted graph state for quantum metrology](https://arxiv.org/abs/2602.18177)
*Unathi Skosana,Byron Alexander,Changhyoup Lee,Mark Tame*

Main category: quant-ph

TL;DR: The paper demonstrates that photonic two-qubit weighted graph states can be used for quantum-enhanced phase sensing, achieving precision beyond classical limits without requiring maximal entanglement.


<details>
  <summary>Details</summary>
Motivation: To explore alternative states for quantum metrology that are easier to produce and maintain than maximally entangled states.

Method: Experimental realization of a tunable photonic two-qubit weighted graph state and characterization of its performance in quantum-enhanced phase sensing.

Result: Achieved a gain in precision that exceeds classical limits, even at weights lower than maximal entanglement, with strong theoretical correlation.

Conclusion: This work shows that less entanglement suffices for quantum advantage and lays groundwork for scalable implementations in photonic systems.
...
### [28] [High-Fidelity Teleportation of Continuous-Variable Quantum States Via Non-Ideal Qutrit Entangled Resources](https://arxiv.org/abs/2602.18180)
*Fatemeh Taghipoor,Mojtaba Golshani,Mostafa Motamedifar,Khatereh Jafari*

Main category: quant-ph

TL;DR: This paper explores quantum teleportation using entangled qutrit resources, achieving high fidelity even in noisy conditions.


<details>
  <summary>Details</summary>
Motivation: Conventional approaches using two-mode squeezed vacuum states cannot achieve near-unity fidelity in quantum teleportation due to fundamental limitations.

Method: The authors propose a novel scheme employing entangled qutrit resources, analyzing its performance under both ideal and realistic noisy conditions.

Result: The proposed scheme successfully achieves high-fidelity quantum teleportation, demonstrating resilience to noise and maintaining a reasonable success probability.

Conclusion: Utilizing entangled qutrits offers a viable alternative for achieving high-fidelity quantum teleportation, overcoming limitations seen in traditional methods.
...
### [29] [Geometry-Controlled Work Extraction in a Non-Markovian Quantum Battery](https://arxiv.org/abs/2602.18192)
*Maryam Hadipour,Soroush Haseli*

Main category: quant-ph

TL;DR: This study explores how spatial geometry influences energy dynamics in a non-Markovian quantum battery system with two qubits.


<details>
  <summary>Details</summary>
Motivation: Understanding how geometric factors affect quantum energy storage and extraction could lead to advancements in quantum technology.

Method: The research employs a model with two identical qubits in a structured waveguide, analyzing the effects of their separation on energy dynamics.

Result: Results indicate that the geometric phase affects collective interference, thereby modulating energy storage and work extraction capabilities.

Conclusion: The findings highlight the significance of spatial geometry in optimizing the performance of quantum battery systems.
...
TL;DR: This paper explores instability in quantum resource theory, defining coherence, athermality, and nonuniformity as sub-resources of instability and deriving universal laws governing these resources.


<details>
  <summary>Details</summary>
Motivation: To better understand the role of instability in quantum systems and its resources—coherence, athermality, and nonuniformity—by formulating a comprehensive theory of instability.

Method: Instability is formulated axiomatically as transient information in decaying systems, analyzing specific decay mechanisms and calculating one-shot distillation yields and dilution costs.

Result: Identified extremal additive monotones for resource conversion, establishing that all asymptotic conversion rates are dictated by a single additive monotone.

Conclusion: A universal second law for instability is established, clarifying the relationship between various quantum resources within the framework of instability.
...
TL;DR: This paper presents a state-independent protocol for protecting quantum coherence from decoherence using the Quantum Zeno Effect, validated experimentally on polarization qubits.


<details>
  <summary>Details</summary>
Motivation: To address the limitations imposed by decoherence on the scalability of quantum technologies, particularly in the context of quantum state preservation.

Method: The protocol embeds the system in a larger Hilbert space, swapping quantum information to an ancillary decoherence-free degree of freedom, without needing prior knowledge of the quantum state.

Result: The experimental validation on a quantum optical platform shows robust preservation of coherence and purity for arbitrary polarization qubits, demonstrating the effectiveness of the protocol.

Conclusion: The introduced method allows for the universal safeguarding of unknown quantum states, overcoming previous limitations regarding state knowledge.
...
TL;DR: A new framework for evaluating the reliability of noisy quantum circuits using Noise Proxy Circuits to provide accurate and efficient reliability metrics without requiring execution.


<details>
  <summary>Details</summary>
Motivation: To address the challenges posed by diverse noise mechanisms in current quantum hardware complicating reliable evaluation of quantum circuits.

Method: Introduced a state-independent analysis and Noise Proxy Circuit (NPC) to model cumulative noise without logical operations, allowing the calculation of Proxy Fidelity under various noise channels.

Result: The method provides accurate estimates of circuit fidelity, showing an average absolute difference ranging from 0.031 to 0.069 across varied circuits and devices.

Conclusion: The framework offers fidelity-level reliability estimation that is execution-free, scalable, and interpretable, effectively addressing circuit reliability evaluation challenges.
...
TL;DR: This paper presents a quantum feature extraction method that improves multi-class image classification accuracy, achieving a significant enhancement compared to traditional methods.


<details>
  <summary>Details</summary>
Motivation: To leverage quantum processing for improved accuracy in complex image classification tasks, particularly for space applications.

Method: The approach combines quantum feature extraction using many-body spin Hamiltonians with classical image classification techniques, specifically utilizing a ResNet50 baseline.

Result: Achieved an accuracy of 87% with the quantum-classical method, surpassing classical accuracy of 84% with transfer learning and 83% with the classical baseline.

Conclusion: The findings demonstrate the promising application of hybrid quantum-classical methods in high-stakes data-driven tasks, suggesting wider implications for machine learning across various domains.
...
TL;DR: This study demonstrates a novel approach to achieving quantum advantage in optical phase estimation using a fibered Mach-Zehnder interferometer, showcasing a 10% increase in sensitivity over classical methods.


<details>
  <summary>Details</summary>
Motivation: To harness quantum photonic advancements for optical phase estimation with sensitivities surpassing classical limits, despite intrinsic losses.

Method: Experimental demonstration using a fibered Mach-Zehnder interferometer, converting polarization-entangled photons to energy-time entanglement, analyzing system imperfections through Fisher information.

Result: Achieved a measured quantum advantage of 10% in sensitivity compared to classical approaches, demonstrating feasibility for practical applications.

Conclusion: The findings indicate the potential for compact, alignment-free quantum interferometers in real-world sensing scenarios.
...
TL;DR: The study enhances single photon emission from Rydberg ensembles in optical cavities through the DRAG technique, improving excitation fidelity and photon indistinguishability.


<details>
  <summary>Details</summary>
Motivation: To address the degradation of photon indistinguishability caused by imperfect Rydberg blockade leading to double excitations in photon sources.

Method: The Derivative Removal by Adiabatic Gate (DRAG) technique is adapted for optical pulse shaping, combined with analytical modeling and numerical optimization to suppress double excitations.

Result: DRAG optimized the single excitation probability from 77% to 91.9%, outperforming conventional techniques, and tested against GRAPE showed it approaches optimal control limits while keeping pulse shapes feasible.

Conclusion: The results demonstrate DRAG's effectiveness and versatility for achieving high-fidelity single photon sources across different platforms.
...
TL;DR: The paper presents a novel n-qubit control framework that simplifies specifying control targets through a diagonal phase map, significantly reducing complexity and improving the synthesis of multi-qubit entangling gates.


<details>
  <summary>Details</summary>
Motivation: To reduce the complexity of control objectives in n-qubit systems by focusing on diagonal entries of the target matrix.

Method: Introducing a diagonal phase map representation for n-qubit unitary transformations and using discrete derivative operators to construct phase invariants for control target formulation.

Result: Successfully synthesized two types of tripartite entangling gates using a single microwave pulse, achieving a 10-100 times reduction in operation time compared to existing methods.

Conclusion: The proposed method allows for efficient control and synthesis of multi-qubit interactions, enhancing quantum gate operations.
...
TL;DR: This paper discusses quantum extreme learning machines (QELMs) as efficient quantum reservoir computers for machine learning tasks, analyzing their performance using the Pauli transfer matrix formalism.


<details>
  <summary>Details</summary>
Motivation: The need for efficient and easily trainable quantum machine learning models drives the exploration of quantum reservoir computers.

Method: Utilizing the Pauli transfer matrix (PTM) formalism, the authors analyze the effects of encoding, reservoir dynamics, and measurement operations on QELM performance, treating optimization as a decoding problem.

Result: The study shows that QELMs can learn surrogate approximations of nonlinear dynamical systems, effectively capturing their underlying flow maps.

Conclusion: The PTM formalism facilitates the design and optimization of QELMs, improving their performance in machine learning tasks.
...
TL;DR: The paper discusses frustrated down conversion processes that enable observable interference, potentially revealing non-classical phenomena through multiple measurement stations and violations of Bell inequalities.


<details>
  <summary>Details</summary>
Motivation: To explore the interference effects in frustrated down conversion processes and understand their implications for non-classical phenomena.

Method: Utilizing an interwoven configuration of parametric down-conversion sources and measurement stations, the authors test for violations of the WWWZB inequalities across multiple measurement stations.

Result: The study demonstrates a violation of the WWWZB inequalities, indicating potential for non-classicality in quantum systems.

Conclusion: The findings suggest a novel approach for revealing non-classical behavior in quantum phenomena, with implications for future research on quantum interference and measurement. The GHZ/Hardy-type argument emphasizes the paradoxical nature of the interference.
...
TL;DR: This study analyzes qubit error bursts in transmon processors, highlighting device-specific characteristics and unique behaviors associated with Dolan junctions, including reduced recovery times and unexpected burst rate dynamics.


<details>
  <summary>Details</summary>
Motivation: Understanding error bursts in qubit processors is crucial for improving quantum computing reliability, as different qubit technologies may exhibit varying behaviors under similar conditions.

Method: The researchers conducted measurements on 5- and 7-transmon processors with different Josephson junction types across two refrigerators to separate device-specific behaviors from those influenced by environmental factors.

Result: The study found that burst durations and rates were consistent with previous findings, showing two novel behaviors in processors with Dolan junctions: faster recovery times and a distinct time-dependent burst rate behavior.

Conclusion: The findings suggest that device design significantly influences qubit behavior, particularly with Dolan junctions, which may require further investigation to optimize qubit performance in quantum computing.
...
TL;DR: The study connects quantum localization to classical transport dynamics by using the kicked top system, showing that the participation ratio reveals a similar hierarchical structure in both domains.


<details>
  <summary>Details</summary>
Motivation: To understand how quantum localization influences transport in mixed classical phase spaces and to find correlations between quantum and classical chaos indicators.

Method: Utilized the periodically driven kicked top to analyze the participation ratio of coherent states in the Floquet eigenbasis and compared it to a Gaussian coarse graining of finite-time Lyapunov exponents.

Result: The participation ratio reveals a multimodal structure akin to classical FTLE distributions, with both quantum and classical measures aligning within a specific time window.

Conclusion: The findings enhance the role of the participation ratio as a diagnostic tool for transport phenomena in quantum systems, particularly in the context of localization.
...
### [41] [Undetected past contacts with technological species: implications for technosignature science](https://arxiv.org/abs/2602.17736)
*Claudio Grimaldi*

Main category: astro-ph.IM

TL;DR: This paper investigates the detectability of technosignatures from extraterrestrial intelligence using Bayesian analysis, revealing that high detectability would require implausibly large numbers of undetected signals over 65 years.


<details>
  <summary>Details</summary>
Motivation: The study addresses the longstanding lack of detections in SETI by exploring whether technosignatures may have already reached Earth but went unnoticed.

Method: The authors use a Bayesian inference framework to estimate detectability based on the assumption of $n \ge 1$ undetected contacts in the last 65 years.

Result: The analysis shows that high detectability demands unrealistic values of $n$, suggesting only a few detectable emissions would be expected even if technosignatures exist within a few hundred light-years.

Conclusion: To enhance detection prospects, searches should extend thousands of light-years, although the likelihood of finding detectable signals remains low.
...
### [42] [Improved Identification of Satellite Trails in ACS/WFC Imaging Using a Modified Radon Transform](https://arxiv.org/abs/2602.17816)
*David V. Stark,Norman Grogin,Jenna Ryon,Ray Lucas*

Main category: astro-ph.IM

TL;DR: This paper introduces a modified Radon Transform for identifying satellite trails in ACS/WFC imaging, achieving an 85% recovery rate with a 2.5% false detection rate.


<details>
  <summary>Details</summary>
Motivation: The increasing prevalence of satellite trails in astronomical data necessitates an effective method for their identification to ensure data integrity.

Method: The authors leverage a modified Radon Transform to detect linear artifacts in imaging data, demonstrating its sensitivity and resistance to bright celestial sources.

Result: The method achieves an 85% recovery rate of satellite trails and a 2.5% false detection rate, with insights on algorithm reliability across varying conditions and a noted increase in contamination rates.

Conclusion: The frequency of satellite trail contamination in science data has doubled over the last two decades, with no significant change in trail brightness; the identification program is included in the acstools package.
...
### [43] [dfcosmic: A Python package for cosmic ray removal](https://arxiv.org/abs/2602.17938)
...
TL;DR: dfcosmic is a fast, efficient Python implementation of the L.A.Cosmic edge detection algorithm for astronomical images, achieving at least 20% speed improvement over prior versions.


<details>
  <summary>Details</summary>
Motivation: Astronomical images often suffer from distortion due to cosmic rays, hot pixels, or non-Gaussian noise, necessitating effective edge detection.

Method: dfcosmic is a direct Python port of L.A.Cosmic, utilizing PyTorch and C++ for enhanced performance on both CPUs and GPUs.

Result: dfcosmic offers a minimum 20% speed increase compared to earlier Python implementations of L.A.Cosmic.

Conclusion: The development of dfcosmic supports the enhanced processing needs of large volumes of data from the MOTHRA array.
...
### [44] [Euclid: An automated system to match Rubin transient alerts to Euclid observations](https://arxiv.org/abs/2602.18173)
...
TL;DR: The paper presents a prototype system that automatically matches transient alerts from the Vera C. Rubin observatory with observations from the Euclid telescope, enhancing light-curve data and host galaxy analysis.


<details>
  <summary>Details</summary>
Motivation: With millions of transient alerts anticipated from the Vera C. Rubin observatory, there is a need for efficient methods to connect these alerts with Euclid's observations to enhance scientific understanding of transient events.

Method: A system is developed to automatically match Rubin transient alerts with Euclid observations, producing joint light-curves and image cutouts, and is tested using alerts from the Zwicky Transient Facility.

Result: The system demonstrates improved insights for both detected and undetected transients. For detected transients, it better constrains the explosion time of supernovae. For undetected transients, it enhances host morphology measurements.

Conclusion: The prototype system effectively adds value to the analysis of transient alerts by integrating data from two major astronomical observatories, improving both detection and characterization of transient astronomical events.
...
### [45] [Mathematical derivation and verification of the amplitude of LISA's interferometric signals on an ultra-stable interferometer testbed](https://arxiv.org/abs/2602.18239)
...
TL;DR: This paper analyzes the impact of beam tilt on the sensitivity of the LISA mission's interferometers, providing insights on mitigating phase noise through advanced models and measurements.


<details>
  <summary>Details</summary>
Motivation: To enhance the measurement sensitivity of LISA’s interferometers amidst the challenges posed by beam tilts affecting interferometric amplitude and noise.

Method: An analytical model linking beam tilt to heterodyne signal amplitude is developed, validated through simulations and experiments, analyzing both infinite and finite detector cases.

Result: The study quantifies phase-noise amplification due to reduced SNR under tilt and introduces a function that describes phase noise dependencies in quadrant photodiode-based readouts, predicting new noise features.

Conclusion: Controlling wavefront curvature mismatch is crucial for reducing excess phase noise in the test mass interferometer, with models applicable to various interferometric topologies.
...
### [46] [Chromaticity-Optimized Antenna Design and Bayesian Foreground Validation for the CANTAR Global 21 cm Experiment](https://arxiv.org/abs/2602.18276)
...
TL;DR: This paper presents a simulation framework for optimizing antenna design and site selection for detecting the global 21 cm signal, addressing challenges posed by foregrounds and systematics.


<details>
  <summary>Details</summary>
Motivation: Detect the global 21 cm signal from the epoch of reionization, which is hindered by bright foregrounds and systematics.

Method: A simulation framework evaluates antenna chromaticity, instrument design, and site suitability, using frequency-dependent beam models and Haslam-based sky maps.

Result: Optimized antennas show improved spectral smoothness and identify mid-latitude sites as optimal for foreground suppression; Bayesian analysis suggests models are consistent only without a 21 cm absorption feature.

Conclusion: Support a two-phase strategy for CANTAR, enhancing foreground modeling and defining a validated path for detecting the global 21 cm signal.
