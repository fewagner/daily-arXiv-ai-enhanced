...
TL;DR: This paper reanalyzes X-ray data of IRAS 13224-3809, confirming a strong ultra-fast outflow (UFO) with significant variability and acceleration linked to ACN feedback mechanisms.


<details>
  <summary>Details</summary>
Motivation: To address open questions regarding the nature and driving mechanisms of the UFO in IRAS 13224-3809.

Method: Systematic reanalysis of 2016 XMM-Newton and NuSTAR datasets using three spectral models, applying careful background treatment and uniform spectral selections.

Result: Confirmed strong, variable outflow with velocities >0.2$c$, revealing a velocity-luminosity correlation and evidence for wind acceleration in response to X-ray flares.

Conclusion: Findings reconcile previous conflicting interpretations and suggest a multiphase, clumpy wind driven by magnetic reconnection.
...
TL;DR: The study explores the physics of choked jets in collapsing massive stars, focusing on their formation and implications for high-energy phenomena.


<details>
  <summary>Details</summary>
Motivation: To understand the mechanisms behind choked jets in massive stars and their impact on high-energy astrophysical processes.

Method: The authors used relativistic, non-resistive magnetohydrodynamical simulations to analyze the plasma physics in collapsing massive stars.

Result: The study identifies the parameter space for jet choking and quantifies the acceleration of charged particles in strong shocks.

Conclusion: Choked jets in blue and red supergiant progenitors may play a crucial role in producing high-energy neutrinos and electromagnetic transients.
...
TL;DR: This study presents the first detection of linear polarization in the radio afterglow of GRB 260310A, marking a significant advancement in understanding gamma-ray burst environments and jet properties.


<details>
  <summary>Details</summary>
Motivation: To investigate polarization in GRB afterglows and understand the magnetic field structure within the jets and surrounding environments.

Method: Analysis of radio afterglow polarization at frequencies between 11-25 GHz, measuring polarization fractions and interpreting these in terms of synchrotron self-absorption and Faraday rotation.

Result: Detected linear polarization that decreases with frequency and identified a rotation measure of -8300 ± 90 rad/m², suggesting a magnetized environment around the GRB.

Conclusion: The findings indicate that GRB afterglows have measurable polarization at centimeter wavelengths, providing insights into jet magnetization and surrounding media, with implications for future polarization studies.
...
TL;DR: The study investigates the X-ray spectral variability of PG 1553+113 using XMM-Newton data, revealing significant insight into particle acceleration and cooling in the jet.


<details>
  <summary>Details</summary>
Motivation: To understand the X-ray spectral variability and the underlying physical mechanisms in the TeV photon-emitting BL Lacertae object PG 1553+113.

Method: Analyzed X-ray spectra from the XMM-Newton EPIC-PN camera over multiple observations using absorbed Power-law and Log-Parabola models.

Result: 14 out of 30 spectra were best described by Log-Parabola models, with significant parameters found; two observations showed evidence of an inverse Compton component.

Conclusion: Spectral evolution likely results from changes in particle acceleration or cooling processes within the jet.
...
TL;DR: The study investigates the extended gamma-ray source 4FGL J1626.0-4917 using 17 years of Fermi and Chandra data, revealing significant GeV emission and a point source, discussing potential origin mechanisms.


<details>
  <summary>Details</summary>
Motivation: To understand the characteristics and potential origins of the unassociated gamma-ray source 4FGL J1626.0-4917.

Method: Analysis of 17 years of Fermi Large Area Telescope data and Chandra X-ray Observatory data for extended GeV emission and X-ray spectral analysis.

Result: Discovery of extended GeV emission with a 0.28 degree radius and a photon index of 2.73, alongside a point X-ray source. Investigation into its potential counterparts, including NGC 6134 and G335.2+0.1.

Conclusion: The findings reveal the complexity of unidentified extended gamma-ray sources, suggesting interactions between accelerated protons and surrounding gas, necessitating further observations.
...
TL;DR: This paper challenges the traditional view of symmetric radio emission beams from pulsar magnetic poles, supported by evidence of asymmetry and underfill through polarization profile analysis of interpulse pulsars.


<details>
  <summary>Details</summary>
Motivation: To investigate the long-held assumption of symmetry in pulsar radio emission and the implications of observed asymmetries.

Method: Polarization profiles of 11 interpulse pulsars were collected and analyzed using a rotating vector model that accounts for aberration and retardation effects, focusing on key parameters of the emission regions.

Result: Analysis of eight pulsars with confirmed double-pole geometry revealed dissimilarities in azimuth width, similarities in beam radius for only two, and comparable emission intensities for six within certain parameter spaces.

Conclusion: The findings suggest that the emission beams from the two magnetic poles of pulsars differ in size and physical conditions, indicating potential inhomogeneity in the polar cap due to varying local magnetic field structures or surface properties.
...
TL;DR: The paper interprets a unique γ-ray flare from blazar 3C 279 using a two-zone model, presenting a mechanism for its asymmetric light curve and predicting delayed enhancements in other wavelengths.


<details>
  <summary>Details</summary>
Motivation: To provide a new understanding of the orphan γ-ray flare from blazar 3C 279, which exhibited rapid variability and lacked optical signatures.

Method: A two-zone model was developed, where one zone emits the quiescent state and another accelerates within the broad-line region (BLR), utilizing the EMBLEM code for radiative output calculations including various processes.

Result: The model successfully replicated the characteristics of the flare, such as the short, intense γ-ray spike and absence of optical variability, attributing the phenomena to the blob's interactions within the BLR and its Lorentz factors.

Conclusion: The findings suggest that the dynamics of plasma blobs within the jet can explain high-energy flares and associated asymmetric light curves, with predicted delayed emissions in other spectral ranges.
...
### [8] [Naturally Resonant Emitters: Approaching Fundamental Antenna Limits](https://arxiv.org/abs/2604.26980)
*Damir Latypov*

Main category: quant-ph

TL;DR: The paper extends antenna theory to electrically small emitters (ESEs), deriving efficiency limits and comparing various ESE types, revealing that mechanical ESEs operate near theoretical limits.


<details>
  <summary>Details</summary>
Motivation: To address challenges in antenna miniaturization across various frequency scales and improve efficiency in small emitters.

Method: The authors extend existing theories of electrically small antennas to derive efficiency limits and create a figure of merit for different ESE types, utilizing public Navy data and literature examples for validation.

Result: The study shows that mechanical antennas operate close to the theoretical efficiency limit, challenging notions of further significant gains, and establishes constraints on atomic ESE properties based on Chu-Harrington principles.

Conclusion: While resonant emitters approach limits, they are still constrained by fundamental principles, indicating a ceiling on potential improvements in ESE technology.
...
### [9] [Geometric-Phase (Pancharatnam-Berry) Correction for Time-Bin Photonic Qudits: A Calibration and Feed-Forward Algorithm](https://arxiv.org/abs/2604.27009)
*Ryan Rae-Cheng Wee,Josef Bruzzese*

Main category: quant-ph

TL;DR: The paper presents a framework for handling geometric phases in time-bin photonic qudits, including a calibration algorithm to differentiate various phase contributions, with practical applications for quantum communication.


<details>
  <summary>Details</summary>
Motivation: To address the challenges associated with phase contributions in time-bin photonic qudits and improve the stability and performance in high-dimensional quantum systems.

Method: Development of a geometric-phase framework employing a parallel-transport gauge, modeling with unbalanced Mach-Zehnder interferometers, and implementing interferometric tomography.

Result: Successful separation and compensation of total, dynamical, and geometric phases through a feed-forward protocol, validated by numerical simulations and practical experimental setups.

Conclusion: Offers a practical and scalable approach for high-dimensional temporal encoding in quantum communication using standard optical components.
...
### [10] [Congestion-free routing on quantum chips](https://arxiv.org/abs/2604.27015)
*Mithilesh Kumar,Yusuf Tahir,Varun Daiya,Sanjana Mattaparthi,Aarav Shaurya*

Main category: quant-ph

TL;DR: This paper introduces a swap-free routing framework for nonlocal quantum gates in near-neighbor quantum hardware, significantly reducing routing depth and congestion.


<details>
  <summary>Details</summary>
Motivation: To address overhead and congestion in compiling nonlocal quantum gates using SWAP transport in limited connectivity hardware.

Method: The framework employs higher-level qudit states as spectral buses to route control information without moving the computational state, requiring local Hilbert-space expansion and achieving routing with fewer logical primitives.

Result: The proposed model reduces the required logical routing primitives from 3L to 2L + 1 for nonlocal operations, confirming correctness and decodability for CNOT and Boolean fan-in operations through simulations and benchmarks.

Conclusion: Spectral qudit routing effectively alleviates congestion and enhances control delivery in quantum circuits, offering a minimal solution to routing limitations in qubit architectures.
...
### [11] [Ground state energy of particle in space with minimal length and momentum](https://arxiv.org/abs/2604.27018)
*Arsen Panas,Volodymyr Tkachuk*

Main category: quant-ph

TL;DR: The paper presents a method to determine a lower bound on the ground-state energy of one-dimensional quantum systems in deformed space with uncertainties, focusing on both harmonic and anharmonic oscillator potentials.


<details>
  <summary>Details</summary>
Motivation: To establish a rigorous lower bound for the ground-state energy in quantum systems facing minimal uncertainties in coordinates and momenta.

Method: The authors derive a lower bound on ground-state energy, analyze a harmonic oscillator case, generalize to arbitrary potentials, and solve for coordinate uncertainty numerically while employing a linear approximation for deformation parameters.

Result: A general expression for ground-state energy is formulated, and the existence domains for solutions in the context of anharmonic oscillator potentials are identified based on deformation parameters.

Conclusion: The findings provide essential insights into the behavior of quantum systems under deformed conditions, revealing how uncertainties impact ground-state energy.
...
### [12] [Efficient mapping of multi-constraint satisfaction problems to Rydberg platforms](https://arxiv.org/abs/2604.27030)
*Robert Gloeckner,Shahram Panahiyan,Frederik Koch,Dieter Jaksch,Joseph Doetsch*

Main category: quant-ph

TL;DR: A framework is introduced for solving constraint satisfaction problems on Rydberg quantum architectures using a new $xor_1$ gadget, which improves efficiency by reducing detuning requirements and resource overhead compared to traditional methods.


<details>
  <summary>Details</summary>
Motivation: To enhance the implementation of combinatorial optimization problems on Rydberg quantum computers, addressing the limitations of existing encodings and detuning constraints.

Method: Introducing a compact $xor_1$ gadget that enforces exactly-one constraints via geometric embedding and blockade interactions, tailored to the geometric connectivity of Rydberg atom arrays.

Result: Achieved reductions in detuning range by up to 99% and atom count/connectivity overhead by up to 54% compared to QUBO formulations.

Conclusion: This framework paves the way for scalable combinatorial optimization on Rydberg platforms, significantly enhancing their practicality and efficiency.
...
### [13] [Macroscopic photon counting beating the Poisson noise limit](https://arxiv.org/abs/2604.27761)
*Timon Schapeler,Fabian Schlue,Isabell Mischke,Michael Stefszky,Benjamin Brecht,Christine Silberhorn,Tim J. Bartley*

Main category: quant-ph

TL;DR: Demonstrated precise photon counting from 0 to 9000 photons with sub-single-photon precision, surpassing Poisson noise limits by 4.1 dB. Utilized multiplexing of superconducting nanowire detectors and characterized detection bins for optimal precision.


<details>
  <summary>Details</summary>
Motivation: To improve photon counting precision beyond Poisson noise limits, facilitating advancements in quantum optics and high-sensitivity measurements.

Method: Multiplexed eight photon-number-resolving superconducting nanowire detectors over 128 temporal modes and characterized detection bins through a model-informed approach and quantum detector tomography.

Result: Achieved precise counting up to 9000 photons with 4.1 dB improvement over Poisson noise, and sub-single-photon precision for pulses of up to 276 photons.

Conclusion: This advanced photon-number-resolving detector will enhance characterization of large quantum states and improve precision metrology and optical power standards.
...
TL;DR: The paper explores Choi polynomials, emphasizing their significance in positive linear maps in matrix algebras. It highlights a link between Hermitian symmetric biquadratic forms and positive maps.


<details>
  <summary>Details</summary>
Motivation: To enhance the understanding of positive linear maps and their implications in quantum information theory, particularly regarding entanglement.

Method: The study examines Hermitian symmetric biquadratic forms, investigates indecomposable positive maps, and analyzes their role in detecting PPT entangled states.

Result: The paper establishes connections between the positivity of forms and positive maps, leading to a refined framework for identifying non-separable states beyond the PPT criterion.

Conclusion: This work contributes to the theory of quantum entanglement and provides insights into entanglement distillation and the classification of edge PPT states.
...
TL;DR: This paper presents a framework using permutation invariance and Schur-Weyl duality to optimize semidefinite programs in quantum information, leading to improved algorithms for channel fidelity computation.


<details>
  <summary>Details</summary>
Motivation: The exponential scaling of semidefinite programs in quantum information necessitates efficient computational techniques.

Method: A systematic framework leveraging Schur-Weyl duality, focusing on operations within the permutation invariant subspace for tasks like applying channels and computing quantum relative entropy.

Result: The symmetric seesaw method yields improved lower bounds on channel fidelity for both depolarizing and amplitude-damping channels, successfully applied in a recent study on superactivation of quantum capacity.

Conclusion: An open-source Python package implements these methods, enhancing accessibility for quantum information theoretic optimization problems.
...
TL;DR: This work investigates the superactivation of quantum channels with zero capacity, demonstrating that, when used together, they can achieve a positive capacity in a finite-blocklength setting.


<details>
  <summary>Details</summary>
Motivation: The motivation is to explore superactivation in the non-asymptotic regime, expanding the understanding of quantum channels' capabilities in limited uses.

Method: A definition for finite-blocklength superactivation is provided, alongside numerical methods for its certification.

Result: The study shows that using only 17 joint channel uses can facilitate qubit transmission with enhanced fidelity compared to utilizing either channel individually, indicating strong finite-blocklength superactivation.

Conclusion: This work paves the way for experimental demonstrations of superactivation in quantum channels under practical constraints.
...
TL;DR: This paper introduces a polynomial-time method to evaluate non-local magic for fermionic Gaussian states, overcoming computational challenges associated with quantum many-body systems.


<details>
  <summary>Details</summary>
Motivation: The complexity of quantum many-body systems requires effective measures for capturing entanglement and magic, especially given the computational inaccessibility of traditional methods.

Method: The authors propose a closed-form expression for non-local stabilizer entropies of fermionic Gaussian states, computable from the eigenvalues of the reduced Majorana covariance matrix.

Result: They derive results including a Page-like curve for random states, logarithmic scaling at a quantum critical point, and a quasiparticle model for magic generation in quantum quenches.

Conclusion: This approach enables experimental estimation of fermionic non-local magic in large-scale quantum processors, leveraging the simplicity of two-point correlation functions.
...
### [18] [Resolving spurious topological entanglement entropy in stabilizer codes](https://arxiv.org/abs/2604.27053)
*Peilun Han,Zijian Liang,Yifei Wang,Bowen Yang,Yingfei Gu,Yu-An Chen*

Main category: quant-ph

TL;DR: This paper addresses spurious contributions to topological entanglement entropy (TEE) in two-dimensional quantum systems and proposes a new approach to accurately compute TEE for stabilizer codes, also exploring the impact of geometry on entanglement in bicycle codes.


<details>
  <summary>Details</summary>
Motivation: To clarify the origins of spurious contributions in TEE calculations and to provide a reliable method for computing TEE in topological phases.

Method: The authors introduce a concave partitioning scheme for long-range entanglement in Levin-Wen stabilizer codes and prove its efficacy in avoiding spurious contributions.

Result: The new method reliably computes TEE without spurious contributions and shows that entanglement entropy in bivariate bicycle codes varies with cylinder geometry, indicating topological frustration among anyons.

Conclusion: The findings enhance the understanding of TEE in topological phases and demonstrate the significance of geometry in influencing entanglement properties.
...
### [19] [Nonlocal nonstabilizerness in free fermion models](https://arxiv.org/abs/2604.27055)
*Mario Collura,Benjamin Béri,Emanuele Tirrito*

Main category: quant-ph

TL;DR: The paper explores nonlocal magic in pure fermionic Gaussian states, establishing a closed-form entanglement spectrum bound and examining average nonlocal magic using random matrix theory. It reveals behavior in Gaussian ground states and differences in growth rates with random circuits and specific quantum chains.


<details>
  <summary>Details</summary>
Motivation: To quantify the nonlocal magic of bipartite quantum states and understand its implications in fermionic Gaussian states and ground state physics.

Method: Derive a closed-form bound for the entanglement spectrum using the covariance matrix, benchmark using simulated annealing, analyze average nonlocal magic via random matrix theory, and study Gaussian ground states and their evolutions.

Result: The study finds a closed-form entanglement spectrum bound, confirms optimality with simulated annealing, shows extensive average nonlocal magic, identifies suppression and peaks in nonlocal magic in quantum phases, and notes growth patterns in different quantum systems.

Conclusion: Nonlocal magic behaves distinctly across different states and configurations, highlighting its role in quantum phase transitions and dynamics.
...
### [20] [Clifft: Fast Exact Simulation of Near-Clifford Quantum Circuits](https://arxiv.org/abs/2604.27058)
*Bradley A. Chase,Farrokh Labib*

Main category: quant-ph

TL;DR: Clifft is a new open-source simulator for fault-tolerant quantum circuits, improving efficiency by modifying quantum state factoring and enabling exact simulation of complex operations.


<details>
  <summary>Details</summary>
Motivation: To address limitations in simulating fault-tolerant quantum circuits, specifically the trade-offs in state vector scaling and tracking overhead.

Method: Clifft factors quantum state into an offline Clifford frame, an online Pauli frame, and an active state vector, resolving coordinate transformations in advance to generalize existing execution models.

Result: It achieves significant throughput gains compared to current tools, performing efficient simulations on both pure and non-Clifford operations and enabling large-scale simulations of magic state cultivation.

Conclusion: Clifft successfully simulates complex scenarios in fault-tolerant quantum computing, shedding light on the behavior of quantum protocols under various thresholds.
...
### [21] [Long-lived local quantum coherences from hydrodynamic large deviations](https://arxiv.org/abs/2604.27074)
*Ewan McCulloch,J. Alexander Jacoby,Sarang Gopalakrishnan*

Main category: quant-ph

TL;DR: This paper presents a framework detailing the evolution of quantum coherences in charge-conserving dynamics, emphasizing their collective behavior with low charge entropy voids and analyzing their properties under varying noise conditions.


<details>
  <summary>Details</summary>
Motivation: To understand how quantum coherences and hydrodynamic behaviors interplay in systems with conserved charge, particularly addressing gaps in existing literature regarding spectral properties and dynamical behavior.

Method: A theoretical framework is developed to analyze the interactions between quantum coherences and voids, with specific results drawn from random charge-conserving circuits and validated through tensor-network simulations.

Result: The lifetime of quantum coherences is enhanced due to binding to voids, and it is shown that gapped Ruelle-Pollicott resonances are absent in weak-noise conditions. The void-coherence polaron exhibits subdiffusion in the noiseless scenario.

Conclusion: The findings provide insights into the nonperturbative nature of quantum dynamics with conserved charge and highlight key differences in behavior across varying noise regimes, establishing the importance of void-coherence interactions.
...
### [22] [Structure-Aware Transformers for Learning Near-Optimal Trotter Orderings with System-Size Generalization in 1D Heisenberg Hamiltonians](https://arxiv.org/abs/2604.27171)
*Shamminuj Aktar,Reuben Tate,Stephan Eidenbenz*

Main category: quant-ph

TL;DR: This paper introduces a transformer encoder for predicting optimal Trotter orderings for simulating quantum time evolution, significantly improving fidelity without exhaustive fidelity evaluations.


<details>
  <summary>Details</summary>
Motivation: The need for accurate simulation of quantum systems using Trotterization, specifically focusing on the challenge of non-commuting Hamiltonian terms affecting simulation fidelity.

Method: A transformer encoder is trained on Hamiltonian and Trotter-configuration features from smaller quantum systems (3 to 14 qubits) to predict the best ordering of Hamiltonian terms for larger systems (16 to 20 qubits) without direct fidelity computation.

Result: The model achieves a mean test fidelity gap of 0.00115 relative to the best candidate on out-of-range systems, showing effective generalization from training on smaller qubit systems.

Conclusion: This study is the first to apply learned models for Trotter ordering, suggesting potential for future AI-driven improvements in quantum simulation across different Hamiltonian families.
...
### [23] [Quantum Coordination without Conditioning under Restricted Information](https://arxiv.org/abs/2604.27173)
*Faisal Shah Khan*

Main category: quant-ph

TL;DR: The paper explores how quantum systems can coordinate under restricted information where classical models fail, highlighting advantages in implementing joint distributions using separable states.


<details>
  <summary>Details</summary>
Motivation: The motivation is to examine coordination capabilities under restricted information, a scenario where classical models struggle due to the inability to condition on past history.

Method: The authors compare classical models with quantum systems, demonstrating that quantum systems, even using separable states, can implement unattainable joint distributions through latent-variable coordination.

Result: The findings indicate that both classically diagonal encodings and separable states with noncommuting structures enable coordination that classical methods can't achieve under similar information constraints.

Conclusion: The study concludes that quantum correlations provide a partial substitute for perfect recall, given that they are limited by existing information structures.
...
TL;DR: CrossBench is a system for generating crosstalk benchmarks for NISQ devices, making crosstalk metrics accessible and usable for error mitigation and other applications.


<details>
  <summary>Details</summary>
Motivation: The increasing complexity of quantum computers makes it difficult to obtain relevant crosstalk metrics, which are essential for applications like error mitigation and security.

Method: CrossBench utilizes a custom graph labeling algorithm to generate crosstalk benchmarks based on a given quantum topology and gate set.

Result: Evaluation of CrossBench on IBM quantum computers showed it can reliably identify significant crosstalk contributors with strong statistical validity (p < 0.05).

Conclusion: CrossBench provides a simple and effective means to obtain crosstalk benchmarks for modern NISQ systems, thereby aiding in error mitigation and related applications.
...
### [25] [Tuning of quantum nanoscaled friction within the Prandtl-Tomlinson model](https://arxiv.org/abs/2604.27216)
*Dai-Nam Le,Lilia M. Woods*

Main category: quant-ph

TL;DR: This study explores the control of nanoscaled friction using the Prandtl-Tomlinson framework, identifying parameters that influence frictional dynamics and revealing new motion types beyond stick-slip.


<details>
  <summary>Details</summary>
Motivation: To understand and manipulate nanoscaled frictional phenomena, which exhibit complex behaviors at both quantum and classical levels.

Method: Utilization of the Prandtl-Tomlinson framework to analyze the control methods of frictional force through parameters like corrugation and characteristic length ratio.

Result: Identification of controllable factors influencing frictional dynamics, discovery of motion types beyond the common stick-slip regime, and analysis of Landau-Zener tunneling in quantum friction.

Conclusion: The insights gained enhance the interpretation of experimental data and offer guidance for controlling frictional behavior in nanoscale systems.
...
### [26] [Multirate characterization of relaxation mechanisms for two nonequivalent nuclear spins 1/2 in a liquid using maximally entangled pseudo-pure quantum states](https://arxiv.org/abs/2604.27220)
*Georgiy Baroncha,Alexander Perepukhov,Boris V. Fine*

Main category: quant-ph

TL;DR: The paper explores multirate characterization of nuclear spins in NMR to analyze molecular complexity, revealing new insights into relaxation mechanisms using advanced techniques.


<details>
  <summary>Details</summary>
Motivation: To fingerprint complex molecules using multiple relaxation rates in NMR, regardless of relaxation mechanisms' complexity.

Method: Investigated 8 relaxation rates through traditional measurements (inversion recovery and nuclear Overhauser effect) and innovative methods involving Bell PPSs generated by detuned Hartmann-Hahn double resonance.

Result: Demonstrated theoretical and experimental consistency in relaxation rate analysis, revealing unconventional mechanisms and a universal ratio for diagonal relaxation rates influenced by magnetic dipolar interactions.

Conclusion: The research enhances understanding of spin dynamics in NMR, providing a framework for analyzing complex molecular structures via multi-relaxation rate methodologies.
...
### [27] [Cylindrical Matter: A beyond-quantum many-body system for efficient classical simulation of quantum pure-Ising like systems](https://arxiv.org/abs/2604.27248)
*Sahar Atallah,Peter Carrekmor,Michael Garn,Yukuan Tao,Shashank Virmani*

Main category: quant-ph

TL;DR: The paper investigates alternative models for quantum many-body systems using a toy model called 'cylindrical bits' to simulate certain quantum entangled states classically, allowing efficient sampling of measurement outcomes.


<details>
  <summary>Details</summary>
Motivation: To explore practical advantages of alternative, non-quantum descriptions of many-body systems by leveraging insights from physics.

Method: A theoretical model is constructed using 'cylindrical bits' to analyze interactions and spatial constraints necessary for valid probabilities, leading to the exploration of entangled states.

Result: The model can replicate certain pure quantum entangled systems, enabling classical simulations of previously unknown quantum systems, with concrete examples of states from pure Ising interactions.

Conclusion: The study suggests that modifying the concept of particles in the model may enhance classical simulation capabilities and outlines a figure-of-merit to assess this potential.
...
### [28] [Quantum Anonymous Secret Sharing with Permutation Invariant Codes](https://arxiv.org/abs/2604.27284)
*Varin Sikand,Andrew Nemec*

Main category: quant-ph

TL;DR: The paper presents a quantum secret sharing scheme that ensures sender-anonymity using permutation-invariant QEC codes and anonymous transmission algorithms, measures information leakage, and evaluates various codes.


<details>
  <summary>Details</summary>
Motivation: To enhance security in quantum secret sharing by ensuring sender-anonymity during the decoding process.

Method: The authors utilize permutation-invariant quantum error correction codes and anonymous transmission methods to develop a scheme that allows for sender-anonymity, quantifying information leakage through quantum conditional min-entropy.

Result: The scheme achieves sender-anonymity and provides a framework for measuring information leakage in ramp quantum secret sharing using quantum conditional min-entropy as a metric.

Conclusion: The study successfully demonstrates that sender-anonymity can be integrated into quantum secret sharing and provides insights on the information leakage associated with different encoding strategies.
...
### [29] [High-Rate Free-Space Continuous-Variable QKD with Self-Referenced Passive State Preparation](https://arxiv.org/abs/2604.27299)
*H. W. Yin,X. J. Liao,Y. H. Xu,P. Huang,K. T. Zhu,T. Wang,G. H. Zeng*

Main category: quant-ph

TL;DR: The study proposes a novel self-referenced local oscillator CVQKD system, improving stability and secret key rates over high-loss channels.


<details>
  <summary>Details</summary>
Motivation: To overcome the limitations of existing passive state preparation CVQKD schemes that suffer from photon leakage noise and instability.

Method: A local local oscillator system employing a self-referenced passive state preparation (SR-PSP) scheme, alongside new algorithms for frequency and phase compensation based on temporal-mode theory.

Result: Achieved an asymptotic secret key rate of 10.34 Mbps over a 23.5 dB loss channel with improved signal-to-noise ratio and stability.

Conclusion: Demonstrates the practicality of SR-LLO CVQKD for secure quantum communication even in challenging real-world conditions.
...
TL;DR: Q3SAT-GPT is a generative model that efficiently discovers quantum circuits for the Max-E3-SAT problem via learning from advanced QAOA-style ansätze and utilizing a novel adaptive circuit construction strategy.


<details>
  <summary>Details</summary>
Motivation: To enhance the discovery and efficiency of quantum circuits in solving combinatorial problems, specifically the Max-E3-SAT problem.

Method: Introduces Q3SAT-GPT, a generative model trained on circuits from MosaicADAPT-QAOA, which adapts the selection of mixer operators, enabling low-depth circuit construction without sequential operator insertion.

Result: Experiments demonstrated Q3SAT-GPT produces high-quality solutions with shallow circuits, outperforming both the adaptive procedure and traditional variational methods.

Conclusion: Generative modeling proves to be a promising avenue for scalable quantum circuit discovery, effectively capturing circuit logic and paving the way for future enhancements with instance-aware inductive biases.
...
### [31] [High-key-rate Fully-Passive Quantum Access Network with Thermal Source](https://arxiv.org/abs/2604.27327)
*H. W. Yin,B. D. Zhu,H. Peng,T. Wang,X. Q. Jiang,Y. K. Xu,G. H. Zeng*

Main category: quant-ph

TL;DR: This study presents a novel fully passive quantum access network protocol that significantly enhances key generation rates while remaining compatible with existing classical communication systems.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of current quantum access networks in achieving high-speed and stable communication, with a focus on integrating quantum technologies into existing classical infrastructures.

Method: An experimental demonstration of a downstream fully passive quantum access network protocol using passive state preparation with hybrid free-space and single-mode fiber channels.

Result: Achieved a record key generation rate of 19.48 Mbps per quantum network unit, demonstrating the feasibility of high-key-rate communications in quantum networks.

Conclusion: The proposed PSP-QPON scheme offers a practical and efficient solution for integrating quantum access networks into local area networks, enabling high performance without significant infrastructural changes.
...
### [32] [Semiclassical Ehrenfest paths in open quantum systems](https://arxiv.org/abs/2604.27328)
*Xiao-Kan Guo*

Main category: quant-ph

TL;DR: This work analyzes semiclassical Ehrenfest trajectories in open quantum systems by deriving a Fokker-Planck equation and using a phase-space approach to clarify the dynamics of observables.


<details>
  <summary>Details</summary>
Motivation: The aim is to enhance the understanding of classical trajectories within the context of open quantum systems, exploring their time evolution and contributions.

Method: The researchers derive a Fokker-Planck equation for a Gaussian mixture and incorporate a generalized Ehrenfest theorem, examining observable expectations in phase space.

Result: The study provides a clear distinction between coherent and irreversible contributions to the dynamics, offering insights into how classical trajectories emerge in an open quantum framework.

Conclusion: The findings contribute to a deeper understanding of quantum dynamics by revealing a coherent phase-space interpretation of semiclassical trajectories.
...
### [33] [Fixed-PVM Born Rule Uniqueness from Fisher Non-Expansion and Operational Calibration](https://arxiv.org/abs/2604.27339)
*Aaron Lax*

Main category: quant-ph

TL;DR: The paper demonstrates that three specific conditions necessitate the application of the Born rule for a fixed rank-1 PVM in a finite-dimensional Hilbert space.


<details>
  <summary>Details</summary>
Motivation: To establish the foundational principles that lead to the Born rule for quantum measurements described by rank-1 projection-valued measures (PVMs).

Method: The authors analyze the properties of the readout map and its geometric implications by proving a rigidity theorem related to Fisher-non-expanding self-maps on the probability simplex.

Result: Establishes that the Born rule is enforced by square-root regularity, a universal Cramer-Rao bound, and operational calibration specific to the measurement setup.

Conclusion: The findings indicate a dimensionwise and operationally robust requirement of the Born rule under these conditions, with implications for escort-class uniqueness and alternative derivations of quantum measurement principles.
...
### [34] [Nonadiabatic Renormalization Group for Strongly Coupled Multiscale Quantum Systems](https://arxiv.org/abs/2604.27381)
*Bing Gu*

Main category: quant-ph

TL;DR: Introduces a nonadiabatic renormalization group method for efficiently managing multiscale strongly correlated quantum systems by suppressing high-energy degrees of freedom.


<details>
  <summary>Details</summary>
Motivation: To address the complexity of multiscale strongly correlated quantum systems and the limitations of traditional methods like tracing out degrees of freedom.

Method: A nonadiabatic renormalization group approach that iteratively suppresses high-energy states and leads to a nested fiber bundle structure in quantum systems.

Result: A new type of tensor network state is created that enhances the representation of quantum entanglement and allows application to various quantum problems, such as interacting boson models and quantum chemistry.

Conclusion: This innovative approach provides a more effective means to handle complex quantum systems with overlapping energy scales and improves our understanding of entanglement in these settings.
...
### [35] [Demonstration of Exponential Quantum Speedup with Constant-Depth Compiled Circuits for Simon's Problem](https://arxiv.org/abs/2604.27457)
*Phattharaporn Singkanipa,Victor Kasatkin,Daniel A. Lidar*

Main category: quant-ph

TL;DR: This study showcases exponential quantum speedup for a restricted version of Simon's problem using a hardware-aware compilation strategy on superconducting quantum processors.


<details>
  <summary>Details</summary>
Motivation: To achieve quantum speedup in practical implementations of Simon's problem on superconducting quantum processors.

Method: Develop a hardware-aware compilation strategy that compiles Simon query circuits to constant depth ($O(1)$) with linear connectivity, suitable for existing quantum device layouts.

Result: The compiled circuits exhibit exponential speedup over classical counterparts in terms of query efficiency across various Hamming weights, demonstrating high fidelity without error suppression.

Conclusion: Careful hardware-aware compilation enables significant quantum speedup for Simon's problem on NISQ devices, making it experimentally feasible.
...
### [36] [Galilean boost invariance does not survive the trace: symmetry breaking in open quantum systems](https://arxiv.org/abs/2604.27459)
*Leonardo F. Calderón,Esteban Marulanda,Santiago Morales,Leonardo A. Pachón*

Main category: quant-ph

TL;DR: This study reveals that Galilean invariance is violated in certain dissipative quantum systems while preserving spatial symmetries, linking this breakdown to damping parameters and stochastic processes.


<details>
  <summary>Details</summary>
Motivation: The paper aims to explore the implications of Galilean invariance in dissipative environments and its relation to quantum dynamics and thermodynamics.

Method: An operator-level analysis of the Hu-Paz-Zhang master equation is performed, focusing on the anticommutator term associated with dissipation, combined with a stochastic decomposition of the influence functional to extend findings beyond quadratic effects.

Result: The research shows that for bilinear-coupled systems, Galilean invariance, fluctuation-dissipation theorem, and boost covariance can't coexist, emphasizing how the damping coefficient affects these relationships.

Conclusion: Parametric driving can mitigate the effects of boost-breaking while preserving entanglement, highlighting a significant crossover for cold atoms and ultracold molecules.
...
TL;DR: This paper presents FinITE, a method for implementing finite imaginary-time evolution in quantum computations while overcoming challenges associated with nonunitary processes.


<details>
  <summary>Details</summary>
Motivation: To develop a reliable quantum approach for ground-state preparation using finite imaginary-time evolution, which is essential for solving optimization problems in quantum computing.

Method: FinITE leverages the linear-combination-of-unitaries (LCU) framework to create an exact scalable imaginary-time propagator for cost Hamiltonians, providing closed-form expressions for fidelity thresholds.

Result: The proposed method produces simulations that confirm the theoretical predictions, demonstrating an effective finite-beta threshold and confirming amplitude amplification in practical QUBO and HUBO instances.

Conclusion: FinITE significantly enhances ground-state preparation for polynomial optimization problems in quantum computing by efficiently implementing finite imaginary-time evolution with proven fidelity thresholds.
...
TL;DR: This paper demonstrates the observation of antibunching in thermal light using single-photon detectors, revealing insights into classical and nonclassical phenomena.


<details>
  <summary>Details</summary>
Motivation: Investigating the boundary between classical and nonclassical phenomena is crucial for quantum optics and information applications.

Method: Antibunching was measured in a Hanbury Brown-Twiss interferometer using single-photon detectors configured for photon-number projection measurements.

Result: Temporal and spatial antibunching was observed, linked to the photon statistics of thermal light and the measurement technique.

Conclusion: The findings deepen the understanding of classical versus nonclassical correlations and suggest potential applications in quantum imaging and multiphoton interference.
...
TL;DR: The paper uses the extended Nikiforov-Uvarov method on the non-relativistic limit of the Dirac equation in curved spaces, revealing issues with polynomial solutions and limitations of the method in quantum mechanics.


<details>
  <summary>Details</summary>
Motivation: To explore the extended Nikiforov-Uvarov method's application to the non-relativistic limit of the Dirac equation with a Coulomb potential in curved spaces.

Method: The radial equation is reduced to the Heun equation, and the quantization condition is derived using the extended Nikiforov-Uvarov method.

Result: The energy spectrum aligns closely with that of a spinless particle in the Schrödinger equation, lacking a 'geometric potential' and reflecting non-commutativity in the non-relativistic limit.

Conclusion: The inability to satisfy necessary conditions for polynomial solutions questions the reliability of the extended Nikiforov-Uvarov method in similar quantum mechanics scenarios.
...
TL;DR: This paper presents a protocol for preparing magnonic Gottesman-Kitaev-Preskill states using a hybrid magnon-qubit system, facilitating fault-tolerant quantum computation.


<details>
  <summary>Details</summary>
Motivation: To explore efficient methods for bosonic quantum error correction without the need for extensive qubit arrays, leveraging the properties of GKP states.

Method: An ellipsoidal magnetic crystal coupled to a superconducting qubit via microwave cavity is used to realize conditional-displacement interactions, leading to the creation of magnonic GKP-like states.

Result: The demonstrated protocol produces three- and four-component magnonic GKP-like states and enables single logical qubit gate operations, establishing a framework for bosonic code states.

Conclusion: Hybrid magnon-qubit systems are effective for preparing bosonic code states, with significant implications for fault-tolerant quantum computation and quantum sensing.
...
TL;DR: The paper investigates entanglement properties of multimode Gaussian states using intensity correlation moments derived from their covariance matrices, facilitating characterization without a local oscillator.


<details>
  <summary>Details</summary>
Motivation: To characterize the entanglement properties of Gaussian states efficiently, leveraging their covariance matrices using intensity correlation moments, which eliminate the need for coherent local oscillators.

Method: The study employs high-order intensity correlation moments (up to sixth-order) measured through a pseudo-photon-number-resolving detector, constructed from 32 threshold superconducting nanowire single photon detectors, to analyze multimode Gaussian states prepared via spontaneous and cascaded parametric down-conversion.

Result: Successful detection of entanglement in two-mode and three-mode Gaussian states, with methods applicable for extending to $N$-mode Gaussian states where $N>3$.

Conclusion: The proposed method enhances the understanding and detection of entanglement in Gaussian states, presenting a scalable approach for higher modes.
...
TL;DR: Spectral moments in non-Hermitian systems offer robust bulk observables across varied boundary geometries, challenging traditional views on dynamics in these systems.


<details>
  <summary>Details</summary>
Motivation: This research addresses the discrepancy between spectral sensitivity to boundaries and the stability of bulk physics in non-Hermitian systems, particularly under the skin effect.

Method: Leveraging a unified acoustic platform, the study experimentally probes different-dimensional lattices, measuring spectral moments and establishing a loop-counting theory to analyze finite-size effects and corrections.

Result: Spectral moments remain largely invariant across different geometries, while the spectra show significant variation, supporting the presence of a dispersive-to-proliferative transition in dynamics governed by bulk moment structure.

Conclusion: The findings position spectral moments as effective descriptors for bulk behavior in finite non-Hermitian systems, enabling better control in wave-based devices.
...
TL;DR: This paper introduces a transient quantum sensing method for cavity-magnon systems that enhances short-time SNR by addressing initial-state quantum property losses, allowing for precise magnetic field detection with potential scaling in multi-sensor setups.


<details>
  <summary>Details</summary>
Motivation: Conventional steady-state quantum sensing approaches suffer from loss of initial quantum properties and limitations in signal-to-noise ratio, which impedes effective magnetometry.

Method: The authors developed a framework considering finite-time dynamics and engineered steady states to derive a transient noise spectrum and enable crosstalk-free measurements of magnetic signals.

Result: The transient setup demonstrates enhanced SNR through initial quantum correlations, achieving noise cancellation and improved bandwidth with injected squeezing, while a collective mode with N YIG spheres reduces noise further as 1/N.

Conclusion: The findings propose a scalable approach for high-precision multidimensional quantum magnetometry in cavity-magnon platforms, overcoming limitations of previous methods.
...
TL;DR: This paper introduces a noise-mitigation strategy using Quantum Circuit Learning for simulating quantum spin chains, yielding robust, shorter circuits with improved accuracy.


<details>
  <summary>Details</summary>
Motivation: To address noise issues in near-term quantum devices, especially during the simulation of quantum spin chains.

Method: The approach involves training a shallow variational circuit to replicate a deeper circuit by learning conserved quantities and limited dynamical information.

Result: The method significantly improves the accuracy of conserved quantities and observables compared to the original noisy simulation.

Conclusion: Quantum Circuit Learning proves to be a practical error mitigation technique, enabling effective quantum simulations without excessive computational demands.
...
TL;DR: This paper presents an analytical framework for optimizing waveguide-mediated quantum state transfer in multi-core quantum computing, offering significant computational efficiency and insights into fidelity issues.


<details>
  <summary>Details</summary>
Motivation: The need for fast, high-fidelity quantum state transfer in multi-core quantum computing systems and limitations of expensive numerical simulations.

Method: The authors derive analytical expressions using a Jaynes-Cummings Hamiltonian, Lindblad master equation, and the Monte Carlo wave-function method to obtain closed-form solutions for qubit probabilities.

Result: The analytical framework provides computational speedup, allows large-scale parameter sweeps, and identifies low-fidelity regions due to interference effects, which are hard to analyze numerically.

Conclusion: This work lays a robust foundation for optimizing interconnect designs in multi-core quantum processors, with a proposed simplified latency model for identifying optimal operating points.
...
TL;DR: The paper reports on the observation of controlled transitions among nonlinear attractors in an active magnon-polariton system, enabling low-power attractor-switching and novel applications in microwave technologies.


<details>
  <summary>Details</summary>
Motivation: The study aims to advance the observation of nonlinear attractor transitions in magnon-polariton systems, which are difficult to achieve in passive systems without strong external driving.

Method: Utilization of a self-oscillating microwave cavity coupled to a YIG sphere, employing feedback mechanisms to enhance nonlinearity, along with stability analysis of fixed-point landscapes.

Result: Observation of explosive bistability growth, multifrequency limit cycles, fractal spectra, and chaotic dynamics with significant spectral shifts, exemplifying the transition between nonlinear emission states.

Conclusion: Active magnon-polaritons facilitate low-power attractor transitions, enabling applications in high-precision sensing, nonlinear microwave signal generation, and neuromorphic computing.
...
TL;DR: The paper presents a high-fidelity iSWAP gate using a capacitively shunted DTC to enable efficient operations between fixed-frequency transmon qubits without static flux biasing.


<details>
  <summary>Details</summary>
Motivation: To realize high-fidelity quantum gates while avoiding complications caused by static flux biasing and large amplitude baseband flux pulses.

Method: Experimental demonstration of a parametrically driven iSWAP gate at zero flux bias with a simple flux-drive waveform, achieving high fidelity without predistortion.

Result: Achieved an average gate fidelity of 99.92(2)% with a total gate time of 112 ns, maintaining low qubit-coupler hybridization and minimal effective ZZ interaction.

Conclusion: The findings support the effectiveness of the theoretical model in predicting both spectral and time-domain dynamics, contributing to advancements in superconducting quantum computing.
...
TL;DR: The paper examines extensions of the Eigenstate Thermalization Hypothesis (ETH) in isolated quantum systems through numerical studies, revealing that while both deep thermalization and full thermalization exhibit exponential relaxation, full thermalization occurs faster for higher order correlators.


<details>
  <summary>Details</summary>
Motivation: To explore extensions of ETH in isolated quantum systems and understand thermalization processes beyond the standard framework.

Method: Numerical studies on a paradigmatic model for chaotic many-body quantum dynamics to compare deep thermalization and full thermalization.

Result: Both deep and full thermalization show exponential relaxation; however, higher order correlators in full thermalization relax faster than in deep thermalization.

Conclusion: Full thermalization is more effective at achieving thermal equilibrium than deep thermalization when considering higher order correlation functions.
...
TL;DR: The paper presents quantum methods for identifying the densest k-vertex subgraph in arbitrary graphs, highlighting a significant speedup over classical approaches.


<details>
  <summary>Details</summary>
Motivation: The densest k-vertex subgraph problem is NP-hard with relevance across various fields.

Method: The authors propose two quantum techniques: a reduction to QUBO and an application of Grover's search algorithm with a specific oracle circuit.

Result: Numerical simulations indicate a quadratic speedup compared to classical brute-force methods in finding the densest subgraph.

Conclusion: The proposed quantum approaches offer a promising direction for efficiently solving NP-hard problems like the densest k-vertex subgraph.
...
TL;DR: The study develops square-base CSS hypergraph-product codes for high-girth quantum LDPC designs, providing conditions for regularity and exclusion of short cycles, while presenting a specific girth-8 code with robust decoding results.


<details>
  <summary>Details</summary>
Motivation: To design efficient quantum LDPC codes with high-girth properties, optimizing their performance in practical applications.

Method: Investigated square-base CSS hypergraph-product codes with checkable conditions for regularity, and analyzed CPM lifts; performed experiments leading to a girth-8 example with zero decoding failures.

Result: Achieved a girth-8 $(3,6)$-regular CSS-LDPC code with zero decoding failures in extensive trials, demonstrating practical applicability at a specific depolarizing probability.

Conclusion: The research validates the effectiveness of the proposed CSS-LDPC codes at finite lengths, exemplified by a successful zero-failure code in trials, underscoring their potential for quantum error correction.
...
TL;DR: This paper presents a method using compressed sensing to estimate the fidelity of GHZ states, reducing measurement overhead while ensuring accuracy.


<details>
  <summary>Details</summary>
Motivation: The need for efficient characterization of multipartite entangled states in quantum information processing.

Method: The authors apply compressed sensing techniques, leveraging the sparsity of GHZ states to reduce measurement requirements and maintain high fidelity accuracy.

Result: The protocol was tested successfully on GHZ states via quantum simulators and trapped-ion hardware, with added error detection techniques applied during hardware evaluations.

Conclusion: Compressed sensing proves to be a robust method for fidelity estimation in noisy experimental environments, enhancing the feasibility of accurately characterizing entangled states.
...
TL;DR: The paper presents a method for creating multi-qubit entangled states from weighted tripartite graphs, relating quantum properties to graph structures and demonstrating these concepts through examples.


<details>
  <summary>Details</summary>
Motivation: To explore the entanglement properties of multi-qubit states derived from weighted tripartite graphs, and to link these quantum properties to the structural characteristics of the graphs.

Method: The authors derive an expression for the entanglement distance corresponding to tripartite graphs, examine the effects of graph structures on quantum states, and compute quantum correlators. An illustrative case is analyzed using quantum simulations.

Result: Numerical results from simulations on a tripartite triangular graph align well with theoretical expectations, demonstrating a solid connection between quantum entanglement and graph structure.

Conclusion: The findings indicate that quantum graph states are a promising tool for exploring both quantum entanglement and the underlying structural properties of tripartite graphs, with potential applications in various practical fields.
...
TL;DR: HADOF enables scalable quantum optimisation by decomposing QUBOs into manageable subproblems, demonstrating significant performance improvements in execution time on quantum hardware.


<details>
  <summary>Details</summary>
Motivation: To tackle scalability issues of quantum optimisation posed by limited qubit counts and hardware noise in near-term devices.

Method: The Hamiltonian Auto Decomposition Optimisation Framework (HADOF) decomposes large QUBOs into smaller, iteratively solvable subproblems, benchmarking on IBM QPUs.

Result: Demonstrated 3-4x wall clock time reduction with multi-QPU use, and up to 3x speedup in single-QPU executions, with competitive accuracy on genome assembly tasks.

Conclusion: HADOF shows that parallelism at algorithmic and system levels is crucial, making it an effective approach for scalable quantum optimisation.
...
TL;DR: The paper presents a method for learning Hamiltonians in quantum systems without the need for short-time dynamics, overcoming practical experimental constraints.


<details>
  <summary>Details</summary>
Motivation: The traditional methods for Hamiltonian learning rely on accessing short-time dynamics, which is challenging experimentally due to finite control capabilities.

Method: A framework is introduced for Hamiltonian learning that mandates a minimum query duration and allows for emulating continuous quantum control using lower-bounded evolution times, reducing the task to sparse pure-state tomography.

Result: The algorithm achieves optimal scaling for logarithmically sparse Hamiltonians, and establishes a tradeoff for many-body systems, allowing relaxed minimum evolution times at a polynomial increase in total evolution time.

Conclusion: The results solve a key problem in quantum learning, demonstrating that ultra-short pulses are not essential for optimal Hamiltonian learning, thereby broadening the practical applications of quantum information techniques.
...
TL;DR: This paper presents a wavelet-based framework for the quantification of quantum fractality in dynamics, overcoming limitations of previous spectral and geometric approaches.


<details>
  <summary>Details</summary>
Motivation: The study aims to quantify quantum fractality in systems with spatial discontinuities, addressing shortcomings in existing methods related to scale choice and truncation effects.

Method: A wavelet-based multiresolution framework is introduced, extracting fractal dimensions from scale-dependent wavelet energies without requiring prior hypotheses.

Result: The method successfully applies to both space and time quantum fractals, yielding robust fractal dimensions consistent with theoretical predictions by Berry.

Conclusion: This unified framework offers a computationally efficient way to analyze quantum fractality in various dynamics, applicable to space, time, and space-time fractals.
...
### [56] [Geometric complexity in thermodynamics](https://arxiv.org/abs/2604.27858)
*Tan Van Vu,Keiji Saito*

Main category: quant-ph

TL;DR: The paper derives a universal limit on implementing state-agnostic reset maps in thermodynamics, showing that zero-error operations require infinite geometric complexity.


<details>
  <summary>Details</summary>
Motivation: To establish a universal bound for realizing a state-agnostic reset map beyond specific transitions, addressing the limitations set by the third law of thermodynamics.

Method: The authors derive a trade-off relation based on geometric complexity by analyzing continuous paths of maps on a geometric manifold.

Result: They prove that the geometric complexity of any classical stochastic map or quantum channel is bounded from below by its execution error, leading to a conclusion that zero-error state reset requires divergent geometric complexity.

Conclusion: This establishes a geometric limit on reset operations in both classical and quantum contexts, emphasizing the universal nature of the unattainability principle.
...
### [57] [Unentangled stoquastic Merlin-Arthur proof systems: the power of unentanglement without destructive interference](https://arxiv.org/abs/2604.27886)
*Yupan Liu,Pei Wu*

Main category: quant-ph

TL;DR: This paper studies ${	ext{StoqMA}(2)}$, a class of unentangled stoquastic Merlin-Arthur proof systems, revealing its strong computational capabilities in relation to classes such as ${	ext{NP}}$, ${	ext{EXP}}$, and ${	ext{PSPACE}}$.


<details>
  <summary>Details</summary>
Motivation: To explore the computational power of unentangled quantum proofs without destructive interference, specifically through the lens of ${	ext{StoqMA}(2)}$.

Method: Utilizes distribution testing for lower bounds and introduces a new framework for upper bounds in the context of ${	ext{StoqMA}(2)}$.

Result: Demonstrates that ${	ext{NP} 	ext{}} 	ext{subseteq} {	ext{StoqMA}(2)}$ and establishes various inclusions and optimality results related to ${	ext{StoqMA}(2)}$, ${	ext{EXP}}$, and ${	ext{PSPACE}}$.

Conclusion: ${	ext{StoqMA}(2)}$ is a powerful class with significant implications for unentangled proof systems; achieving a deeper understanding of its boundaries is pivotal for quantum computation.
...
### [58] [Adaptable Continuous Variable Quantum Network with Finite Size Security](https://arxiv.org/abs/2604.27943)
*Runjia Zhang,Akash nag Oruganti,Huy Q Nguyen,Adnan A. E. Hajomer,Vladyslav C. Usenko,Ulrik L. Andersen,Tobias Gehring*

Main category: quant-ph

TL;DR: This paper reports an experimental demonstration of a scalable multi-user continuous-variable quantum key distribution network, achieving high secret key generation rates while ensuring practical security.


<details>
  <summary>Details</summary>
Motivation: The motivation behind this work is to enhance secure communication in quantum networks, specifically to support multiple users leveraging common telecommunication infrastructure.

Method: The method involved an experimental setup of a $1:4$ multi-user continuous-variable quantum network, utilizing $1.25	ext{ billion}$ coherent states over $11 	ext{ km}$ quantum channels.

Result: The experimental results yielded a peak secret key generation rate of $0.19$ bits per channel use, indicating robust performance under the finite-size regime.

Conclusion: The findings affirm the practical security of continuous-variable quantum networks, enabling their deployment in existing telecommunications systems and enhancing user capabilities.
...
### [59] [Learning quantum disentanglement scheduling from reduced states via modular hybrid policies](https://arxiv.org/abs/2604.28009)
*Y. -X. Xiao,J. -Z. Han,Z. Zheng,Z. -H. Zhang,M. Xue,J. Li,X. Lv*

Main category: quant-ph

TL;DR: This paper investigates quantum control using limited information through a framework that combines classical and quantum processes. It highlights the importance of preprocessing and offers design principles for effective hybrid policies.


<details>
  <summary>Details</summary>
Motivation: The study addresses the challenge of quantum control with limited access to state information, which is vital for current quantum devices.

Method: The authors propose a hybrid quantum-classical framework for controlling multiqubit disentanglement based on partial observations, utilizing classical preprocessing, a parameterized quantum circuit, and classical postprocessing for pair selection.

Result: Benchmarking across different multiqubit tasks, the research finds that classical preprocessing significantly impacts performance, while the quantum component provides a useful but conditional representation.

Conclusion: The findings suggest practical design principles for developing hybrid policies in quantum control contexts where access to full system information is restricted.
...
### [60] [Branch-Resolved Characterization of Feed-Forward Error in Dynamic Teleportation via Classical Choi Shadows](https://arxiv.org/abs/2604.28037)
*Mason Edwards,Prabhat Mishra*

Main category: quant-ph

TL;DR: This paper presents a framework to understand feed-forward errors in dynamic circuit teleportation on superconducting quantum processors, evaluating three correction methods and their impact on different qubit layouts with varying measurement errors.


<details>
  <summary>Details</summary>
Motivation: To address the poorly understood error characteristics in measurement-conditioned corrective operations during dynamic-circuit teleportation, specifically focusing on individual measurement branches.

Method: The authors analyze three methods for applying measurement-conditioned corrections: physical application, post-processing adjustments, and a mitigated physical application using BFA-based PROM. They reconstruct branch Choi operators via experimentation and validate estimators against full tomography.

Result: Experiments reveal differing branch qualities based on qubit layouts with varying readout errors, showing that in one layout, PROM outperforms post-processing, while the opposite is true in a layout with lower readout errors.

Conclusion: The presented framework effectively uncovers branch-specific error structures and mitigation behaviors that traditional outcome-averaged analyses overlook.
...
### [61] [A No-Cloning Trade-off Between Black Hole No-Hair and Horizon Smoothness](https://arxiv.org/abs/2604.28050)
*Sudhanva Joshi,Sunil Kumar Mishra*

Main category: quant-ph

TL;DR: The paper derives a quantitative version of the black hole no-hair theorem, linking exterior states to interior accessibility and horizon smoothness, and presents mathematical relationships between distinguishability and smoothness of black holes.


<details>
  <summary>Details</summary>
Motivation: To establish a quantitative understanding of the black hole no-hair theorem in relation to unitarity, horizon causality, and interior accessibility in the context of semiclassical black holes.

Method: The authors utilize trace distance metrics and diamond norm analysis to show the relationship between exterior states due to infalling charges and horizon properties, mathematically formalizing trade-off inequalities relating to distinguishability and horizon smoothness.

Result: The study proves that the trace distance between exterior states is bounded in relation to interior fidelity and finds that nonzero exterior quantum hair requires a violation of the equivalence principle, with implications for the nature of black holes and their horizons.

Conclusion: Observable exterior quantum hair cannot coexist with perfect horizon smoothness under unitary evolution; pre-existing entanglement is essential for compatibility.
...
### [62] [Source-independent quantum key distribution without pre-sending entanglement](https://arxiv.org/abs/2604.28089)
*Rong-Zheng Liu,Hua-Lei Yin*

Main category: quant-ph

TL;DR: This paper proposes a source-independent quantum key distribution (SI QKD) protocol that enhances security and doubles transmission distance, addressing vulnerabilities from side-channel attacks.


<details>
  <summary>Details</summary>
Motivation: To address vulnerabilities in existing QKD systems, particularly those arising from side-channel attacks on sources, and to improve transmission distance and security.

Method: The authors propose a source-independent QKD protocol that does not rely on pre-sent entangled sources and can withstand known and unknown source-side attacks.

Result: The proposed SI QKD protocol shows improved security against source vulnerabilities and enables longer transmission distances, providing practical advantages over traditional methods using conventional lasers.

Conclusion: The theoretical analysis confirms that utilizing non-classical light sources enhances security in ways that conventional laser-based systems cannot achieve.
...
### [63] [Quantum Lattice Boltzmann Solutions for Transport under 3D Spatially Varying Advection on Trapped Ion Hardware](https://arxiv.org/abs/2604.28121)
*Sayonee Ray,Jezer Jojo,Jason Iaconis,Abeynaya Gnanasekaran,Apurva Tiwari,Martin Roetteler,Chris Hill,Jay Pathak*

Main category: quant-ph

TL;DR: This paper advances the Quantum Lattice Boltzmann Method (QLBM) for simulating fluid dynamics on quantum hardware, addressing challenges like non-uniform velocity fields and readout bottlenecks, and proposing strategies to enhance scalability.


<details>
  <summary>Details</summary>
Motivation: The QLBM is positioned as a key approach for simulating transport phenomena in computational fluid dynamics (CFD), which necessitates a move towards realistic settings in quantum applications.

Method: The authors implemented QLBM on IonQ's trapped-ion systems, focusing on transport phenomena under non-uniform velocity fields and introducing new methods for wall boundaries and density readouts.

Result: The study highlights challenges in density readout and proposes MPS shadow tomography to improve scalability. Novel techniques for implementing wall boundaries are also presented.

Conclusion: The findings pave the way for applying QLBM to more complex fluid dynamics problems, demonstrating its potential for future advancements in quantum simulations.
...
### [64] [Nodal algebraic curves and entropy diagnostics in degenerate two-dimensional harmonic-oscillator shells](https://arxiv.org/abs/2604.28127)
*C A Escobar Ruiz,H Olivares-Pilon,A M Escobar-Ruiz*

Main category: quant-ph

TL;DR: The paper analyzes nodal geometry changes in degenerate quantum eigenspaces, particularly for the two-dimensional harmonic oscillator, revealing a hierarchy of effects across quantum shells using algebraic curves and entropy diagnostics.


<details>
  <summary>Details</summary>
Motivation: Understanding the geometry of nodal surfaces in degenerate quantum eigenspaces can provide insights into the underlying physical and mathematical structures of quantum systems.

Method: The authors examine nodal structures using the Hermite-constrained algebraic curve and apply entropy diagnostics like nodal-domain entropy, Cartesian mutual information, and the entropic uncertainty sum to characterize topological changes across quantum shells.

Result: They identify a hierarchical structure in nodal geometries for the first three shells of the harmonic oscillator, noting specific transitions and varying responses in entropic measures across different energy states.

Conclusion: The findings suggest that algebraic stratification governs nodal geometry and that entropy diagnostics are effective in quantifying changes in probability distributions and correlations, with implications for experimental applications in quantum optics and trapped atoms.
...
### [65] [Weak-to-Strong Measurement Transition with Thermal Instabilities](https://arxiv.org/abs/2604.28137)
*Marcos V. S. Lima,Carlos H. S. Vieira,Irismar G. da Paz,Pedro R. Dieguez,Lucas S. Marinho*

Main category: quant-ph

TL;DR: The study investigates quantum measurement transitions, particularly how thermal noise and decoherence affect weak and strong measurements.


<details>
  <summary>Details</summary>
Motivation: To address the gap in understanding the impact of thermal instabilities and pre-/post-selection on quantum measurement in non-ideal conditions.

Method: A framework is developed that models a thermal Gaussian state with temperature-dependent fluctuations, accounting for open-system dynamics and pre-/post-selection.

Result: Measurement statistics are altered by the temperature of thermal instabilities and the properties of the measuring probe.

Conclusion: Thermal effects significantly reshape weak-value conditions and influence projective behavior in quantum measurements.
...
TL;DR: The paper presents a novel defense framework using a quantum autoencoder to purify adversarial samples without adversarial training, achieving improved prediction accuracy under attacks.


<details>
  <summary>Details</summary>
Motivation: To address the vulnerability of quantum machine learning models to adversarial attacks, particularly in image classification, and the limitations of existing defenses.

Method: The proposed framework employs a quantum autoencoder to reconstruct adversarial samples and includes a confidence metric to identify samples that are not successfully purified.

Result: The framework significantly enhances prediction accuracy by up to 68% compared to state-of-the-art defenses in the context of adversarial attacks.

Conclusion: The adversarial training-free defense using a quantum autoencoder effectively mitigates vulnerabilities in quantum machine learning models, demonstrating superior performance in adversarial scenarios.
...
### [67] [Finding Strongly Lensed Supernovae from Blended Light Curves](https://arxiv.org/abs/2604.27511)
*Sangwoo Park,Arman Shafieloo,Alex G. Kim,Eric V. Linder,Xiaosheng Huang*

Main category: astro-ph.IM

TL;DR: A new method for detecting strongly lensed supernovae in blended images is presented, validated using ZTF data. It estimates time delays and scaling through Bayesian analysis, yielding minimal false positives.


<details>
  <summary>Details</summary>
Motivation: To effectively identify strongly lensed supernovae in situations where multiple images blend into a single source, enhancing data analysis from large surveys.

Method: The framework uses a superposition model of two time-shifted components, applying Bayesian inference to assess relative scaling and time delays based on ZTF data.

Result: Out of 445 supernovae, one meets the conservative selection criteria (Δt ≥ 12 days) and 14 under laxer criteria (Δt ≥ 10 days), with low false positive rates of 0.22% and 3.15% respectively.

Conclusion: This method provides a scalable and model-independent approach for the preliminary filtering of lens-like candidates in extensive time-domain surveys.
...
### [68] [An Extended Evaluation Split for DeepSpaceYoloDataset](https://arxiv.org/abs/2604.27593)
*Olivier Parisot*

Main category: astro-ph.IM

TL;DR: The paper updates the DeepSpaceYoloDataset to enhance the detection of Deep Sky Objects using YOLO models, adding a new test set for improved model evaluation.


<details>
  <summary>Details</summary>
Motivation: To democratize astronomy through effective detection solutions accessible via smart telescopes, enhancing public engagement.

Method: Updated the DeepSpaceYoloDataset with a newly added test split, test2026, to train and evaluate YOLO models for detecting Deep Sky Objects.

Result: The inclusion of the test2026 split aims to provide a more diverse testing environment for detection models, improving their accuracy and effectiveness.

Conclusion: The updated dataset facilitates better training and assessment of YOLO-based models, supporting advancements in Electronically Assisted Astronomy.
...
### [69] [Radio signal generation in milliseconds: enabling multi-parameter reconstruction of ultra-high-energy cosmic rays](https://arxiv.org/abs/2604.27684)
*Arsène Ferrière*

Main category: astro-ph.IM

TL;DR: A machine-learning emulator for the radio detection of ultra-high-energy cosmic rays allows rapid and accurate simulations, achieving state-of-the-art reconstruction of cosmic-ray properties.


<details>
  <summary>Details</summary>
Motivation: To address the computational intensity of simulating radio emissions from ultra-high-energy cosmic rays, enhancing efficiency while preserving accuracy.

Method: A machine-learning emulator is developed to replicate simulations from Monte Carlo codes, paired with a Markov Chain Monte Carlo approach for reconstructing primary particle properties.

Result: Achieved 8.9% resolution on electromagnetic energy and 0.08° angular resolution, successfully applied to real data with cosmic-ray candidate detection.

Conclusion: The emulator demonstrates a significant improvement in simulation speed and accuracy, facilitating effective analysis of cosmic rays in experimental setups.
...
### [70] [The Large Array Survey Telescope-Pipeline. II. Image Subtraction and Transient Detection](https://arxiv.org/abs/2604.27921)
...
TL;DR: The Large Array Survey Telescope (LAST) processes transient sky data in real-time, focusing on image calibration and transient detection using ZOGY algorithm without machine learning.


<details>
  <summary>Details</summary>
Motivation: To develop a reliable pipeline for detecting transient astronomical events with high efficiency and purity.

Method: Utilizes the ZOGY algorithm along with a sequence of deterministic filtering steps for image subtraction and transient identification.

Result: Achieves a $5σ$ limiting magnitude of $20.3$-$20.7$mag, with $	ext{~80	ext{	extperthousand}}$ transient detection efficiency and purity of $	ext{~90	ext{	extperthousand}}$ at S/N $	ext{~7.5σ}$.

Conclusion: The proposed transient detection pipeline provides a robust framework for identifying transient candidates in astronomical surveys.
...
### [71] [Gaseous forms of $^{76}$Ge, $^{82}$Se, $^{96}$Zr, $^{100}$Mo, $^{124}$Sn, and $^{130}$Te: new avenues to future $0νββ$ time projection chambers](https://arxiv.org/abs/2604.27027)
*Aneesha Avasthi,Benjamin Monreal,Ivana Moya*

Main category: physics.ins-det

TL;DR: This paper explores alternatives to xenon for large-scale neutrinoless double beta decay (0νββ) searches by identifying affordable electropositive gases suitable for electron-drift time projection chambers (TPCs).


<details>
  <summary>Details</summary>
Motivation: To address the scarcity of xenon for large-scale 0νββ searches, the paper seeks non-xenon materials for TPCs, emphasizing the need for scalability in the search for neutrinoless double beta decay.

Method: The paper identifies and evaluates a range of affordable gases that allow for electron drift and gain in gas-phase TPCs, focusing on their suitability for detecting 0νββ events with background rejection based on track topology.

Result: Several compounds, including $^{76}$Ge, $^{82}$Se, $^{96}$Zr, $^{100}$Mo, $^{124}$Sn, and $^{130}$Te, are identified as potential candidates for TPCs, with certain gases also viable for liquid-phase systems.

Conclusion: The study concludes that large-scale (100 T to kiloton) gas TPCs are feasible without needing unprecedented underground infrastructure, enhancing the search for 0νββ decays.
...
### [72] [Optical effects in Gaseous Electron Multipliers (GEMs)](https://arxiv.org/abs/2604.27399)
...
TL;DR: This study investigates the optical broadening effect observed in the MIGDAL experiment using glass GEM-based OTPCs, demonstrating that scintillation light from avalanches causes increased track intensity and width compared to simulations.


<details>
  <summary>Details</summary>
Motivation: To understand the discrepancies in track intensity and width observed in the MIGDAL experiment when comparing optical readout with charge readout simulations.

Method: Lab measurements were conducted on three types of GEM substrates (glass, ceramic, and FR4) to quantify optical broadening caused by scintillation light. Geant4 simulations were used to reproduce and quantify these effects in realistic charge avalanches.

Result: The study found that optical broadening was strongest in glass GEMs, leading to increases in track intensity and widths by up to roughly 26% and 31% in simulations.

Conclusion: The optical broadening effect may account for the larger tracking parameters observed in the MIGDAL OTPC, suggesting it is a general phenomenon in all GEM-based OTPCs.
...
### [73] [Optimisation of a silicon-tungsten electromagnetic calorimeter energy response to photons](https://arxiv.org/abs/2604.27853)
*Yukun Shi,Vincent Boudry*

Main category: physics.ins-det

TL;DR: The study presents ML-based optimizations for the SiW-ECAL, enhancing energy resolution by 20%, and addresses design reoptimizations for future collider applications.


<details>
  <summary>Details</summary>
Motivation: The necessity for improved detector performance at future colliders and adaptability for circular machines drive the optimization of the SiW-ECAL.

Method: The study employs machine learning techniques to reconstruct particle energy measurements in the SiW-ECAL, leading to significant enhancements in both low and high-energy performance.

Result: Achieved a 20% improvement in energy resolution at low energies and corrected energy leakage at high energies through ML-based methods.

Conclusion: The approach not only improves the SiW-ECAL's performance but also suggests necessary design modifications for evolving collider technologies.
...
### [74] [$\mathcal{H}$olographic $\mathcal{N}$aturalness and Information See-Saw Mechanism for Neutrinos](https://arxiv.org/abs/2604.26982)
*Andrea Addazi,Giuseppe Meluccio*

Main category: hep-ph

TL;DR: The paper explores the de Sitter entropy's origin in quantum gravity, proposing 'hairons' as key degrees of freedom, and unifying neutrino mass generation with the cosmological constant using gravitational topology.


<details>
  <summary>Details</summary>
Motivation: To address the mystery of de Sitter entropy and its link to the cosmological constant problem in quantum gravity.

Method: Construct new orbifold gravitational instantons ($S^4/	ext{Z}_N$) and identify moduli as hairon fields; apply gravitational topology to unify neutrino mass generation and the cosmological constant.

Result: Demonstrates a mass scale for hairons near the Hubble scale, suggests the de Sitter vacuum acts as a Bose-Einstein condensate, and provides predictions for neutrino behavior and dark matter.

Conclusion: The findings connect de Sitter entropy to neutrino mass generation, suggesting profound implications for dark matter, the strong CP problem, and cosmological observations.
...
### [75] [Chiral-Transport-Induced Collective Modes in Strong Magnetic Fields and Their Implications for Neutron Star Phenomenology](https://arxiv.org/abs/2604.27020)
*Sota Hanai*

Main category: hep-ph

TL;DR: This thesis explores the effects of chirality in magnetized media on neutron stars, predicting the existence of chiral magnetic waves and their implications for seismic oscillations and gravitational waves, as well as a unique dynamical screening effect linked to the chiral anomaly.


<details>
  <summary>Details</summary>
Motivation: Understanding the collective modes and phenomena related to chirality in neutron stars can enhance insights into their behavior and characteristics in astrophysical contexts.

Method: Theoretical analysis of chiral magnetic waves and their impact on quark matter within neutron stars, examining induced seismic oscillations and the response to electromagnetic fields.

Result: Prediction of novel seismic oscillations and gravitational waves arising from chiral magnetic waves, alongside identification of a new dynamical screening effect related to the chiral anomaly.

Conclusion: The findings could significantly advance the understanding of neutron star physics, particularly in the realm of asteroseismology and the role of chirality in astrophysical contexts.
...
### [76] [Mesogenesis through the Ephemeral Dark Decay of Beauty](https://arxiv.org/abs/2604.27099)
*Hooman Davoudiasl,Rachel Houtz,Seyda Ipek*

Main category: hep-ph

TL;DR: The paper explores a model of Mesogenesis to generate the baryon asymmetry of the Universe through decays of B mesons, constrained by existing data but potentially modified by interactions with an ultralight scalar and thermal effects from muons in the early Universe.


<details>
  <summary>Details</summary>
Motivation: To investigate the potential of Mesogenesis as a mechanism for baryon asymmetry generation using Standard Model CP violation, despite constraints from experimental data on B mesons.

Method: The study examines the role of an ultralight scalar field that interacts with the Standard Model leptons and the dark sector, focusing on how early thermal conditions involving muons can alter the effective mass of dark fermions and enhance B meson decays.

Result: The proposed model shows that the dominant decay channel via dark fermions occurs in the early Universe, where muon density is high, and later becomes suppressed, aligning with observational flavor data and existing experimental limits.

Conclusion: The model offers a viable framework for exploring baryon asymmetry through Mesogenesis, with implications for future experimental searches for associated heavy bosons and potential signals in flavor physics and astrophysical events.
...
### [77] [Rydberg states of muonic helium in quantum electrodynamics](https://arxiv.org/abs/2604.27121)
*A. V. Eskin,A. P. Martynenko,F. A. Martynenko,D. K. Pometko*

Main category: hep-ph

TL;DR: This paper employs the variational method to analyze energy levels in muonic helium, achieving a series of Rydberg muon states that can be experimentally measured.


<details>
  <summary>Details</summary>
Motivation: The study aims to deepen the understanding of muonic helium, particularly its excited states using a variational approach.

Method: The variational method is applied, utilizing Gaussian wave functions for calculation of Hamiltonian matrix elements in a nonrelativistic framework while accounting for vacuum polarization and relativistic effects.

Result: A series of energy levels for Rydberg muon states has been derived, with specific quantum numbers identified that highlight the interaction of muon and electron in helium.

Conclusion: The findings provide valuable energy state information for experimental investigation of muonic helium.
...
### [78] [Optimised Inference of Quantum Phenomena in High-Energy Collider Experiments](https://arxiv.org/abs/2604.27130)
*Hai-Chau Nguyen,Gilberto Tetlalmatzi-Xolocotzi,Carmen Diez Pardos,Otfried Gühne,Matthias Kleinmann*

Main category: hep-ph

TL;DR: The paper presents a framework for analyzing spin-spin entanglement in high-energy physics, particularly in collider experiments, using shadow tomography techniques.


<details>
  <summary>Details</summary>
Motivation: To address the conceptual and technical challenges in characterizing quantum effects in relativistic physics.

Method: A general framework based on shadow tomography is developed to analyze spin-spin correlations in collider experiments, accommodating the coupling of spin and momentum in relativistic conditions.

Result: Application of the framework to top quark pair production at the Large Hadron Collider demonstrates its effectiveness; the approach is adaptable to more complex scenarios.

Conclusion: The proposed framework is versatile and can enhance the analysis of quantum entanglement in various particle interactions.
...
### [79] [Planar master integrals for two-loop NLO electroweak light-fermion contributions to $g g \rightarrow Z H$](https://arxiv.org/abs/2604.27314)
*Shu-Xiang Li,Ren-You Zhang,Xiao-Feng Wang,Pan-Feng Li,Xiang-Jie Wei,Yi Wang,Yi Jiang,Qing-hai Wang*

Main category: hep-ph

TL;DR: This paper details the analytic computation of master integrals for electroweak corrections to a specific particle interaction using a systematic approach to radical structures.


<details>
  <summary>Details</summary>
Motivation: To enhance the understanding of two-loop NLO EW corrections in particle physics, specifically for the process $gg ightarrow ZH$.

Method: Utilizes the canonical differential-equations method for computing master integrals of planar topologies and applies the Magnus-expansion method for constructing canonical bases.

Result: Identified radical structures of the master integrals and organized them into subsystems, with several integrals expressed as one-fold integrals over Goncharov polylogarithms due to complexity in radical forms.

Conclusion: The framework developed aids in managing the complexity of master integrals which involve nontrivial radicals, contributing to the computation of NLO EW corrections.
...
### [80] [Electroweak Baryogenesis from Collapsing Domain Walls](https://arxiv.org/abs/2604.27376)
*Yang Bai,Kun-Feng Lyu,Yue Zhao*

Main category: hep-ph

TL;DR: This paper introduces a new mechanism for electroweak baryogenesis using collapsing domain walls formed by an axion-like field, which creates an asymmetry through electroweak processes and leads to unique gravitational-wave signatures.


<details>
  <summary>Details</summary>
Motivation: To explore alternative mechanisms for achieving baryon asymmetry in the universe during the electroweak phase transition, using axion-like fields and their interactions.

Method: The authors propose the use of collapsing domain walls resulting from an axion-like field to separate different electroweak phases, where the collapse triggers baryogenesis through effective chemical potential and sphaleron processes.

Result: The proposed mechanism can yield the observed baryon asymmetry either through late-time entropy injection or sphaleron suppression, and leads to the generation of a distinctive gravitational-wave background.

Conclusion: This novel approach to baryogenesis not only accounts for the baryon asymmetry but also offers a unique gravitational-wave emission profile that differs from standard models.
...
### [81] [Constraints on a Light Singlet Scalar from Combined Exotic Higgs Decays](https://arxiv.org/abs/2604.27471)
*F. Azari,M. Haghighat*

Main category: hep-ph

TL;DR: This paper explores the effects of adding a real gauge-singlet scalar field to the Standard Model, particularly focusing on new decay channels for the Higgs boson. It derives conditions for the model parameters based on decay rate constraints and provides specific predictions for exotic decay rates.


<details>
  <summary>Details</summary>
Motivation: To examine the effects of a gauge-singlet scalar field on Higgs boson decay modes and to identify observable consequences of this extension of the Standard Model.

Method: Analytical expressions for exotic Higgs decay rates were derived and constraints were imposed to ensure the total decay width does not exceed that of the Standard Model. A fourth-order inequality in terms of the singlet vacuum expectation value was formulated.

Result: An upper bound on the mixing parameter was established as A9cos θ< 0.12 - 0.13, resulting in specific upper bounds for exotic decay rates: Γ_{h ightarrow φφ} < 0.06 MeV and Γ_{h ightarrow φφφ} < 5 	imes 10^{-6} MeV.

Conclusion: The findings provide additional constraints on the model, aligning them with existing direct search limits while predicting decay rates for the extended model.
...
### [82] [Low mass scalars at $e^+e-$ colliders](https://arxiv.org/abs/2604.27541)
*Tania Robens*

Main category: hep-ph

TL;DR: The paper discusses the search for low mass scalars at Higgs factories, highlighting recent model developments.


<details>
  <summary>Details</summary>
Motivation: To update the understanding and research on low mass scalars since previous reviews.

Method: The author reviews available models and developments related to low mass scalars in the context of Higgs physics.

Result: Recent models and updates improve the feasibility of observing low mass scalars in experiments.

Conclusion: Ongoing research advances the potential discovery of low mass scalars at Higgs factories.
...
### [83] [A theoretical account of tiny multi-Higgs vacuum expectation values from non-invertible symmetry](https://arxiv.org/abs/2604.27612)
*Takaaki Nomura,Hiroshi Okada*

Main category: hep-ph

TL;DR: The paper presents a mechanism using non-invertible symmetries to explain small vacuum expectation values (VEVs) in exotic multi-Higgs fields without additional particles.


<details>
  <summary>Details</summary>
Motivation: To understand naturally small VEVs of exotic Higgs fields in particle physics.

Method: Introduce an $SU(2)_L$ quartet $H_4$ and quintet $H_5$ constrained by minimal Fibonacci fusion rule (FFR) to forbidding tree-level VEVs, allowing loop-level generation post-symmetry breaking.

Result: VEVs generated radiatively at one-loop scale are suppressed to $10^{-3}-10^{-2}$ GeV, meeting constraints from the $ρ$ parameter.

Conclusion: The approach is phenomenologically viable, applicable to various neutrino mass models including type-III seesaw, Dirac seesaw, and inverse seesaw.
...
### [84] [Dark photon search status in $τ-c$ energy region](https://arxiv.org/abs/2604.27703)
*Zhijun Li,Zhengyun You*

Main category: hep-ph

TL;DR: The paper reviews the experimental status of dark photons, particularly in the τ-c energy region, suggesting its potential for future dark matter detection.


<details>
  <summary>Details</summary>
Motivation: To address the open question of dark photon existence and its implications for dark matter research.

Method: Summary of current experimental findings at the τ-c facility and analysis of dark photon search strategies.

Result: The τ-c energy region shows promising potential for dark photon searches, albeit without confirmed signals.

Conclusion: Larger data samples and innovative methods are necessary for advancing investigations into the connection between dark photons and cosmic dark matter.
...
### [85] [Strangeness enhancement in pp collisions from string closepacking in Pythia 8.3](https://arxiv.org/abs/2604.27752)
*Javira Altmann,Lorenzo Bernardinis,Peter Skands,Valentina Zaccolo*

Main category: hep-ph

TL;DR: This paper addresses enhanced production of strange hadrons in pp collisions at the LHC, proposing a closepacking mechanism that improves upon the Lund String Model.


<details>
  <summary>Details</summary>
Motivation: The increased production of strange hadrons in data from LHC is inconsistent with current models, necessitating a new approach to understand hadronization.

Method: The closepacking model is introduced, incorporating overlapping strings to enhance strangeness production and introducing options for baryon suppression and strange junctions.

Result: The modified model aligns qualitatively with many particle ratios from LHC data, although certain ratios and spectra remain problematic.

Conclusion: The closepacking model with Trieste tunes offers a better description of strangeness in pp collisions than existing PYTHIA models while minimizing excess proton production.
...
### [86] [Stochastic Axion Mixing: A General Mechanism Beyond Decay Constant Constraints](https://arxiv.org/abs/2604.27784)
*Hai-Jun Li*

Main category: hep-ph

TL;DR: The paper introduces stochastic axion mixing, a generalized mechanism for multi-axion systems that operates independently of decay constant hierarchies, offering broader implications for axion cosmology.


<details>
  <summary>Details</summary>
Motivation: To expand the understanding of axion mixing beyond conventional frameworks by introducing a mechanism applicable to diverse axion mass scenarios.

Method: The authors propose stochastic axion mixing for multiple axion-like particles, contingent on distinct and lighter masses compared to the QCD axion, without relying on stringent decay constant conditions.

Result: Stochastic mixing encompasses maximal mixing as a special case, revealing broader mixing possibilities in axion frameworks.

Conclusion: This novel mechanism enhances the theoretical landscape of axion cosmology, hinting at new avenues for exploration.
...
### [87] [Semi-analytic bounds on axion-like-particle supernovae emission](https://arxiv.org/abs/2604.28062)
*Ana Luisa Foguel,Eduardo S. Fraga*

Main category: hep-ph

TL;DR: This paper presents a semi-analytic framework for constraining axion-like particles (ALPs) using core-collapse supernovae data, improving upon previous models by incorporating finite ALP mass and demonstrating robustness against various astrophysical uncertainties.


<details>
  <summary>Details</summary>
Motivation: The study aims to refine constraints on axion-like particles (ALPs) derived from supernova cooling, addressing uncertainties in astrophysical and nuclear modeling that affect previous numerical simulations.

Method: The authors extend a semi-analytic framework to include the effects of finite ALP mass, deriving constraints in the axion-nucleon coupling versus mass parameter space based on observed proto-neutron star (PNS) characteristics.

Result: The derived constraints align well with previous numerical simulation results and are sensitive to variations in PNS parameter calibrations and nuclear effects.

Conclusion: The study validates the semi-analytic method as a robust approach for exploring new-physics constraints from core-collapse supernovae, effectively informing future research on ALPs.
...
### [88] [New gravitational-wave templates for metastable cosmic strings: Loop breaking versus network collapse](https://arxiv.org/abs/2604.28097)
*Doa Hashemi Asl,Kai Schmitz*

Main category: hep-ph

TL;DR: This paper analyzes the gravitational-wave background from metastable cosmic strings, emphasizing the distinction between loop breaking and network collapse time scales, and proposes a three-parameter model to unify previous work with new data analysis methods.


<details>
  <summary>Details</summary>
Motivation: To address the gravitational-wave background from metastable cosmic strings and its potential to explain recent pulsar timing array signals.

Method: The study distinguishes between time scales of loop breaking and network collapse and develops a three-parameter model to analyze these effects on the gravitational-wave signal.

Result: The model allows for a unified approach, providing a compact analytical expression for the gravitational-wave spectrum that aligns with existing numerical results in the field.

Conclusion: The proposed templates for the gravitational-wave spectrum are valuable for future pulsar timing array data analysis.
...
TL;DR: This paper introduces a new method using near-side energy-energy correlators to access the transversity parton distribution function (PDF) of nucleons, overcoming limitations of prior models.


<details>
  <summary>Details</summary>
Motivation: The need to access the transversity PDF without relying on complicated models of parton transverse momentum or resonances.

Method: The authors develop a strategy based on collinear factorization and near-side energy-energy correlators within the dihadron fragmentation context.

Result: They derive leading-order analytical results for transverse-spin observables and establish their similarity to existing expressions for (un)polarized PDFs, predicting relevant kinematics for experimental facilities.

Conclusion: The approach promises a viable pathway for extracting transversity PDFs, facilitating future investigations in high-energy physics.
...
### [90] [Mapping data sensitivities in global QCD analysis with linear response and influence functions](https://arxiv.org/abs/2604.28154)
*Richard Whitehill*

Main category: hep-ph

TL;DR: This paper introduces a framework using linear response and influence functions to clarify how experimental data influences hadron structure in QCD analyses.


<details>
  <summary>Details</summary>
Motivation: The complexity of QCD fits makes it challenging to understand how experimental data constrains non-perturbative functions essential for hadron structure analysis.

Method: The authors propose a method based on linear response and influence functions, which quantify the sensitivity of fitted quantities to experimental data.

Result: This framework reveals how data influences central values, uncertainties, and correlations of quantum correlation functions, enhancing interpretability of information flow in QCD.

Conclusion: The proposed approach offers a transparent and general method for diagnosing information propagation in QCD inverse problems.
...
### [91] [Deeply virtual pion production through two-loop order](https://arxiv.org/abs/2604.28164)
*Wen Chen,Feng Feng,Yu Jia,Qing-Tao Song,Guang Tang,Zhe-Yu Wang*

Main category: hep-ph

TL;DR: The paper calculates the next-to-next-to-leading order (NNLO) QCD radiative corrections for deeply virtual meson production (DVMP) processes, improving predictions for nucleon structure studies.


<details>
  <summary>Details</summary>
Motivation: To enhance the extraction of generalized parton distributions (GPDs) from deeply virtual meson production, which is crucial for understanding nucleon's internal structure.

Method: The authors employ next-to-next-to-leading order QCD radiative corrections for DVπP processes, focusing on the generalized Bjorken limit and collinear factorization framework.

Result: The NNLO QCD corrections significantly improve the agreement between perturbative predictions and existing JLab data, affecting the differential cross section and transverse single-spin asymmetries (TSSA).

Conclusion: The findings highlight the importance of NNLO corrections in reliably extracting nucleon structure information from DVMP experiments.
...
### [92] [Observation of a Doubly-strange Hyperon $Ξ(1720)$ in $J/ψ\rightarrow{}K^{-}Σ^0\barΞ^{+}+c.c.$](https://arxiv.org/abs/2604.27028)
...
TL;DR: First observation of the decay $J/ψightarrow K^- Σ^0 arΞ^++c.c.$ at BESIII reveals a new hyperon $Ξ(1720)$ with significant statistical evidence and established spin-parity.


<details>
  <summary>Details</summary>
Motivation: To investigate excited states involved in the decay $J/ψightarrow K^- Σ^0 arΞ^++c.c.$ using a large dataset of $J/ψ$ events.

Method: Partial wave analysis of the decay events collected by the BESIII detector to identify and characterize excited states, including mass and width measurements of the new hyperon $Ξ(1720)$.

Result: Observation of a new hyperon $Ξ(1720)$ with mass $1721.0 	ext{ MeV}/c^2$ and a width of $31.3 	ext{ MeV}$, with a statistical significance exceeding $10σ$; branching fraction determined to be $(2.68 	imes 10^{-5})$.

Conclusion: The study provides evidence for the new hyperon $Ξ(1720)$ and favors its spin-parity as $J^P = rac{3}{2}^+$. The findings enhance understanding of the decay mechanisms in particle physics.
...
### [93] [Improved results on Higgs boson pair production in the 4b final state](https://arxiv.org/abs/2604.27044)
*CMS Collaboration*

Main category: hep-ex

TL;DR: The paper reports improved upper limits on Higgs boson pair production in the 4b final state using CMS data, with significant enhancements in analysis methods.


<details>
  <summary>Details</summary>
Motivation: To measure Higgs boson pair production (HH) in the four bottom quark (4b) final state and constrain associated couplings.

Method: Analysis of pp collision data at 13.6 TeV with integrated luminosity of 62 fb$^{-1}$, including both resolved and merged topologies.

Result: Observed (expected) upper limit on HH signal strength is 4.4 (4.4) at 95% CL, improved by more than a factor of two in resolved topology compared to prior results.

Conclusion: These results provide the most stringent constraints on Higgs boson couplings in the 4b final state to date.
...
### [94] [Energy efficiency of a GPU-based computing system for High Energy Physics experiments](https://arxiv.org/abs/2604.27523)
*Jiahui Zhuo,Arantza Oyanguren,Álvaro Fernández Casani,Luca Fiorini,Valerii Kholoimov*

Main category: hep-ex

TL;DR: This paper introduces energy efficiency as a metric for evaluating GPU hardware and algorithms in High Energy Physics experiments, specifically focusing on the LHCb experiment.


<details>
  <summary>Details</summary>
Motivation: The need for sustainable computing in High Energy Physics necessitates new metrics for performance evaluation, particularly in the context of energy consumption.

Method: The authors develop a method to compute energy efficiency by relating throughput to GPU specifications like core count, clock frequency, memory bandwidth, and thermal design power.

Result: The model successfully quantifies energy efficiency for the first high-level trigger of the LHCb experiment and demonstrates potential adaptability to other HEP experiments.

Conclusion: The proposed model can support decision-making for achieving more sustainable computing ecosystems in High Energy Physics.
...
### [95] [Search for light charged Higgs bosons decaying to charm and strange quarks in $\mathrm{t\bar{t}}$ events in proton-proton collisions at $\sqrt{s}$ = 13 TeV](https://arxiv.org/abs/2604.27795)
*CMS Collaboration*

Main category: hep-ex

TL;DR: The paper presents a search for light charged Higgs bosons (H$^	imes$) in top quark pair production, analyzing decay channels and setting upper limits on branching fractions based on proton-proton collision data.


<details>
  <summary>Details</summary>
Motivation: To explore the existence of light charged Higgs bosons in top quark decays, testing predictions beyond the Standard Model.

Method: The analysis utilizes proton-proton collision data at 13 TeV, focusing on invariant mass spectra of jets from specific decay pathways of top quarks.

Result: The observed yields align with Standard Model predictions, establishing upper limits on the branching fraction of t $	o$ H$^	imes$ b in the 40-160 GeV mass range.

Conclusion: These results represent the first direct limits on charged Higgs bosons from top quark decays for 40-50 GeV and provide the most stringent limits for the 70-110 GeV mass range.
...
### [96] [The DAMSA Experiment](https://arxiv.org/abs/2604.28133)
...
TL;DR: DAMSA is a novel experiment aimed at probing short-lived particle physics, targeting MeV-to-sub-GeV dark-sector messengers and rare Standard Model signals, using an ultra-short baseline to enhance sensitivity.


<details>
  <summary>Details</summary>
Motivation: The experiment seeks to address questions in neutrino physics and the lack of evidence for weakly interacting massive particles, exploring new physics realms.

Method: DAMSA employs a beam-dump production scheme with a compact detector, optimized to detect rare decays and mitigate neutron-induced backgrounds, alongside a proof-of-concept experiment (DPF).

Result: The DPF aims to validate the DAMSA approach, focusing on axion-like particles as a benchmark, using an 8 GeV electron beam at SLAC.

Conclusion: The successful realization of DPF will pave the way for DAMSA's broader program, enabling exploration of new physics and precision measurements in previously inaccessible regions.
