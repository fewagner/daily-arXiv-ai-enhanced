...
TL;DR: The paper measures prompt and non-prompt J/$ψ$ yields and their multiplicity dependence in pp collisions at 13 TeV, revealing a stronger-than-linear increase in self-normalized yields with multiplicity.


<details>
  <summary>Details</summary>
Motivation: Understanding the behavior of J/$ψ$ mesons in high-energy pp collisions can provide insights into the underlying mechanisms of particle production and the effects of charged-particle multiplicity.

Method: Yields of prompt and non-prompt J/$ψ$ are measured via the dielectron decay channel at midrapidity, normalized by the average value in inelastic collisions, and analyzed across different azimuthal regions relative to J/$ψ$ momentum.

Result: Both prompt and non-prompt J/$ψ$ yield ratios show a stronger-than-linear increase as a function of charged-particle multiplicity, particularly in the toward region, with a weaker increase in the transverse and opposite regions.

Conclusion: The findings indicate a significant multiplicity dependence in J/$ψ$ production, suggesting shared underlying dynamics between prompt and non-prompt J/$ψ$ processes.
...
TL;DR: The T2K experiment in Japan advances the study of neutrino oscillations and charge-parity violation through precise measurements and systematic uncertainty mitigation, leveraging new data and cross-section results.


<details>
  <summary>Details</summary>
Motivation: To investigate leptonic charge-parity violation and enhance measurements of neutrino mixing and mass splitting parameters.

Method: Utilizing a near detector complex for high-statistics neutrino-nucleus cross-section measurements alongside a gadolinium-loaded far detector for oscillation results.

Result: Latest T2K oscillation results include first data with a gadolinium-loaded detector and new world-first measurements of rare interaction channels.

Conclusion: These findings illustrate the essential link between interaction modeling and oscillation analysis in the ongoing search for charge-parity violation, particularly in the T2K-II phase.
...
TL;DR: This study reports the first search for lepton-flavour violating decays in proton-proton collisions, setting a stringent upper limit on the branching fraction and providing the first constraint on specific quark transitions at the LHC.


<details>
  <summary>Details</summary>
Motivation: To investigate lepton-flavour violating decays $B^+ 	o π^+ μ^{	ilde} e^{	ilde}$ and to establish constraints beyond the Standard Model.

Method: Data from the LHCb experiment collected between 2011 and 2018, with a total integrated luminosity of 9 fb$^{-1}$, was analyzed for evidence of the decay. Limits on branching fractions and transition types were derived.

Result: No significant signal was observed; an upper limit on the branching fraction was established at $	ext{B}(B^+ 	o π^+ μ^{	ilde} e^{	ilde}) < 1.8 	imes 10^{-9}$ at the 90% confidence level, which is two orders of magnitude more restrictive than the prior world average.

Conclusion: This study marks the first constraint on lepton-flavour violating $b 	o d$ transitions at the LHC, providing the most stringent limits currently available and expanding the understanding of potential physics beyond the Standard Model.
...
TL;DR: This study evaluates the long-term performance of GEM chamber prototypes using a $^{55}$Fe source to assess gain, efficiency, and energy resolution under various conditions.


<details>
  <summary>Details</summary>
Motivation: The research is motivated by the need to ensure the reliability and stability of GEM detectors in large-scale experiments prior to deployment.

Method: The methodology involved using a $^{55}$Fe radiation source with an Argon and CO$_2$ gas mixture, measuring gain, efficiency, and energy resolution over 98 days under controlled ambient conditions.

Result: The results include measurements of gain and energy resolution alongside variations in temperature, pressure, and relative humidity, along with the long-term behavior of the count rate.

Conclusion: The findings are significant for improving the design and application of Micro Pattern Gaseous Detectors (MPGD) like GEM in large-scale scientific experiments.
...
TL;DR: SPIROS, a dedicated optical simulator for particle physics detectors, offers a lightweight and user-friendly design, outperforming GEANT4 in speed and providing an intuitive input configuration.


<details>
  <summary>Details</summary>
Motivation: Develop a specialized optical simulation tool for efficient design and analysis of particle physics detectors, addressing limitations in general-purpose frameworks.

Method: SPIROS features an optimized simulation engine for optical processes, imports geometries from CAD models, and utilizes a single human-readable input file for configurations.

Result: Validation against GEANT4 shows excellent agreement in photon behavior, with over two times improvement in processing speed for typical configurations.

Conclusion: SPIROS is validated, faster than existing tools, and effectively applied in neutrino experiments, available as open-source.
...
TL;DR: This study investigates afterpulse effects in silicon photomultipliers (SiPMs) using single-cell readout, enabling detailed measurements of intrinsic properties and pulse events, validated by Monte Carlo simulations.


<details>
  <summary>Details</summary>
Motivation: To understand afterpulse effects in SiPMs and their dependence on device properties and irradiation conditions.

Method: Three analysis methods were developed: charge integration and two multi-linear regression techniques for transient waveform reconstruction, enabling event counting and characterization of afterpulse behavior.

Result: The study measured afterpulse probabilities and time constants for fresh and irradiated SiPM samples, finding afterpulse probabilities <6% and time constants <10 ns, with minimal dependency on irradiation fluence.

Conclusion: Afterpulse characteristics are primarily reliant on bias voltage rather than irradiation fluence, informing device optimization in high-radiation environments.
...
TL;DR: This study uses Graph Neural Networks to enhance energy measurement and particle identification in a new detector for the Electron Ion Collider, showing superior performance over traditional methods.


<details>
  <summary>Details</summary>
Motivation: To improve energy measurement and particle identification for a second detector at the future Electron Ion Collider using advanced machine learning techniques.

Method: Graph Neural Networks (GNNs) are applied to simulate particle hits as graphs, enabling classification and prediction tasks. A scintillator optical photon simulation is parameterized to increase simulation speed significantly, and GNNs are integrated into a Multi-Objective Optimization framework.

Result: The GNN approach outperforms classical techniques in tasks of energy measurement and particle classification/discrimination, with reported results on energy and timing resolution along with identification accuracy.

Conclusion: This research demonstrates enhanced capabilities for proton energy measurement and particle identification in calorimeters, with optimized designs yielding better performance metrics at varying energy levels.
...
### [8] [GW190711_030756 and GW200114_020818: astrophysical interpretation of two asymmetric binary black hole mergers in the IAS catalog](https://arxiv.org/abs/2604.07388)
...
TL;DR: This paper analyzes two significant binary black hole mergers, GW190711_030756 and GW200114_020818, revealing their mass properties and spins, contributing to the understanding of massive, rapidly spinning black hole mergers.


<details>
  <summary>Details</summary>
Motivation: To investigate the properties and implications of two notable binary black hole merger candidates within the IAS catalog, contributing to the larger understanding of black hole formation and environments.

Method: Utilized numerical relativity surrogate models to infer source and remnant properties of the binary black hole mergers, specifically focusing on mass ratios, spins, and probability of remnant retention in various environments.

Result: Identified that both candidates are asymmetric-mass binaries with high spinning rates and characteristics indicating a potential emerging population of massive BBH mergers, particularly GW200114_020818, which exhibits significant spin precession and effective inspiral spin.

Conclusion: The findings suggest complications in explaining the formation of these systems in globular clusters, and highlight the necessity for ongoing exploration of black hole merger environments.
...
### [9] [Detection and Evolution of Linear Polarization of the Galactic Center Transient MAXI J1744-294](https://arxiv.org/abs/2604.07431)
...
TL;DR: Detection of variable linear polarization in MAXI J1744$-$294 suggests it's part of the Galactic center nuclear star cluster, consistent with nearby magnetar RM, indicating intrinsic Faraday rotation properties.


<details>
  <summary>Details</summary>
Motivation: To investigate the characteristics and environment of MAXI J1744$-$294 as a potential member of the Galactic center's nuclear star cluster.

Method: Four epochs of observations captured at 33 and 43 GHz measured normalized Stokes parameters q and u, allowing for the calculation of rotation measures (RM) and assessment of polarized components.

Result: First detection of a common Faraday rotation screen with RM = -63,606 rad m$^{-2}$, linked to the Galactic center's magnetar, plus a transient secondary polarized component with RM ≈ -6000 rad m$^{-2}$ on one date, implying local magnetic field strength of 15–30 gauss.

Conclusion: MAXI J1744 is confirmed as part of the Galactic center's environment; the observed properties support the existence of a jetted X-ray binary structure with a possible transient knot.
...
### [10] [From Internal Collision to Photon Escape: First-Principles Modeling of Radiation-Mediated Shocks in Gamma-Ray Burst Photospheres](https://arxiv.org/abs/2604.07453)
*Jona Nordin Nobuoka,Filip Alamaa,Felix Ryde,Christoffer Lundman*

Main category: astro-ph.HE

TL;DR: This paper presents a novel radiation-hydrodynamic simulation of subphotospheric shocks in gamma-ray bursts, highlighting their complex interactions and implications for observed light curves and spectra.


<details>
  <summary>Details</summary>
Motivation: The study aims to address the intricate modeling challenges of subphotospheric shocks in gamma-ray bursts, which involve multiple timescales and radiation-mediated dynamics.

Method: The authors developed a self-consistent radiation-hydrodynamic simulation tracking forward and reverse radiation-mediated shocks, accounting for full Compton coupling and feedback on plasma flow, from formation to photon decoupling.

Result: The simulation reveals that reverse shocks remain radiation-mediated even at lower optical depths, with photons scattering over a range of radii, leading to a late quasi-thermal post-cursor in the light curve and producing a GRB-like emitted spectrum.

Conclusion: The research demonstrates the evolution of radiation-mediated shocks near the photosphere and their significant role in shaping the emitted photon field, offering new insights for observational searches.
...
### [11] [Second-Generation Mass Peak in the Gravitational-Wave Population as a Probe of Globular Clusters](https://arxiv.org/abs/2604.07456)
*Yonadav Barry Ginat,Fabio Antonini,Beth Flanagan,Mark Gieles*

Main category: astro-ph.HE

TL;DR: The paper explores the formation of binary black hole mergers around 35 and 70 solar masses, connecting them to dynamical processes in dense stellar systems and constraints on globular clusters' birth properties.


<details>
  <summary>Details</summary>
Motivation: To understand the observed excess of binary black hole mergers at specific mass ranges and determine their origins through dynamical formation in dense stellar environments.

Method: Analyzing gravitational-wave data and employing a suite of cluster population-synthesis models to explore black hole mergers and their mass distributions.

Result: Current data suggests a robust second peak near 70 solar masses, influenced by first-generation mass suppression and cluster initial conditions, alongside constraints on merger rates in globular clusters.

Conclusion: A confirmed mass excess near 70 solar masses would support a dynamical formation model for black hole mergers and provide evidence for a pair-instability mass gap below 50 solar masses.
...
### [12] [Development of Faster and More Accurate Supernova Localization at Super-Kamiokande](https://arxiv.org/abs/2604.07702)
...
TL;DR: Recent upgrades to Super-Kamiokande's SNWATCH enhance the speed and accuracy of core-collapse supernova direction reconstruction, enabling alerts within 90 seconds.


<details>
  <summary>Details</summary>
Motivation: The urgency to understand core-collapse supernovae through early detection of shock breakout emissions and precise progenitor star characterization.

Method: Introduced a HEALPix-based approach (HP-Fitter) for rapid SN direction calculation, alongside improvements to the existing maximum-likelihood fitter (ML-Fitter) by using additional event data and optimizing the code.

Result: The implementation of HP-Fitter and improved ML-Fitter leads to a significant reduction in direction reconstruction time, achieving alerts with accurate pointing information in under 90 seconds.

Conclusion: Upgrades to Super-Kamiokande's SNWATCH system enhance multi-messenger observations of supernovae, revolutionizing our ability to detect and alert on nearby core-collapse events.
...
### [13] [Which Neutron Stars Reach the Stiffening Regime? Multimessenger Constraints on Core Sound Speed and Stellar-Mass Thresholds](https://arxiv.org/abs/2604.07542)
*Nicolás Viaux,Sebastián Mendizabal*

Main category: astro-ph.HE

TL;DR: This study infers the sound-speed profile in neutron-star cores using multimessenger data from GW170817 and 	extit{NICER} mass-radius measurements, indicating a preference for stiffness at intermediate densities.


<details>
  <summary>Details</summary>
Motivation: To better understand the density-dependent properties of neutron-star matter and how they relate to gravitational wave observations and neutron-star mass-radius measurements.

Method: The authors conducted a multimessenger inference combining gravitational wave data from GW170817 and mass-radius posteriors from specific pulsars using Bayesian techniques to assess the sound-speed profile.

Result: The findings suggest an 85.4% probability of intermediate-density stiffening at $3.5 n_{sat}$, indicating that neutron stars with masses near or above $1.6 M_	extodot$ likely enter this stiffening regime, with access to the peak stiffness at around $2.1 M_	extodot$.

Conclusion: Current observational data primarily indicate whether massive neutron stars have begun to exhibit stiffening, rather than confirming their full transition through the peak stiffness region.
...
### [14] [Stochastic problems in pulsar timing](https://arxiv.org/abs/2604.08373)
*Reginald Christian Bernardo*

Main category: astro-ph.HE

TL;DR: This study utilizes Langevin stochastic differential equations to derive analytical solutions for pulsar timing noise and GWB signals, enhancing understanding of their dynamics.


<details>
  <summary>Details</summary>
Motivation: To provide insights into pulsar timing noise and gravitational wave backgrounds, and improve state space algorithms in pulsar timing array analysis.

Method: Analytical solutions to Langevin equations were derived using diffusion theory, focusing on red noise and GWB signals, including examples of Ornstein-Uhlenbeck processes and a two-component neutron star model.

Result: The study reveals inconsistencies in modeling the pulsar spin frequency and presents a random process that aligns with a stationary GWB signal, along with analytical expressions for neutron star dynamics.

Conclusion: Nonstationarity in pulsar timing signals originates from damped and diffusive eigenmodes, providing a deeper understanding of timing noise and its underlying physical mechanisms.
...
TL;DR: The study explores methods to enhance the detection of very-high-energy emissions from gamma-ray bursts through optimized follow-up strategies, improving detection rates significantly compared to traditional methods.


<details>
  <summary>Details</summary>
Motivation: To address the challenges faced in detecting very-high-energy emissions from gamma-ray bursts, particularly during the prompt and early afterglow phases.

Method: The authors simulate a realistic population of GRBs using data from Fermi/GBM and Swift/XRT and propose optimized follow-up strategies involving rapid tiling of large localization regions with next-generation Imaging Atmospheric Cherenkov Telescopes.

Result: The proposed method increases detection rates significantly; instruments like ASTRI and LACT can achieve up to double the detections, while CTAO could yield up to four VHE detections per year.

Conclusion: Optimized observational strategies can dramatically improve the chances of detecting very-high-energy emissions from poorly localized gamma-ray bursts.
...
TL;DR: The study employs Poissonian Generalized Morphological Component Analysis to disentangle overlapping X-ray emissions from Sgr A East and surrounding plasma, revealing new insights into the supernova remnant's properties and environmental interactions.


<details>
  <summary>Details</summary>
Motivation: The complexity of the X-ray environment near the Milky Way's center makes it difficult to assess individual components' properties, particularly regarding the supernova remnant Sgr A East and its interaction with surrounding plasma.

Method: Poissonian Generalized Morphological Component Analysis (pGMCA) was applied to deep, stacked Chandra ACIS-I observations to separate overlapping X-ray components and analyze their properties.

Result: The analysis identified the reflected shock in Sgr A East, constructed spatially resolved emission maps, and revealed that Sgr A East has a lower ionization age and higher electron density than previously recorded, indicating strong interactions with dense material.

Conclusion: Isolating the supernova remnant emission enhances the understanding of its intrinsic properties and strengthens the overall spectral modeling, providing a clearer picture of its interaction with surrounding gases.
...
### [17] [Resolving the 2024 Outburst of Magnetar 1E 1841-045 from its host Supernova Remnant with EP-FXT](https://arxiv.org/abs/2604.07734)
...
TL;DR: The magnetar 1E 1841-045 has undergone a new active episode characterized by X-ray bursts, with detailed analysis of its timing and spectral properties showing significant changes in pulse profile and intensity.


<details>
  <summary>Details</summary>
Motivation: To investigate the X-ray behavior of magnetar 1E 1841-045 during a recent outburst and understand the pulse profile evolution and spectral characteristics.

Method: Utilizing data from the Einstein Probe (EP), the study performed timing and spectral analyses, including energy-resolved pulse profile analysis and phase-resolved spectroscopy, to assess the nature of the outburst.

Result: The study found a multi-peaked pulse profile with phase shifts, a notable flux increase post-outburst, and a correlation between blackbody temperature and pulse intensity, alongside spectral hardening at specific pulse phases.

Conclusion: The findings reveal significant insights into the interplay between magnetar outbursts, pulse profiles, and spectral properties, highlighting the importance of high spatial resolution in separating emissions for accurate analysis.
...
### [18] [A study of periodic nulling in PSR B0751+32 with FAST](https://arxiv.org/abs/2604.07742)
*W. M. Yan,N. Wang,F. F. Kou,Z. Y. Liu,J. P. Yuan,Z. G. Wen S. N. Sun,M. Y. Zou,Y. R. Wen,X. J. Chen*

Main category: astro-ph.HE

TL;DR: This study provides new insights into periodic nulling in pulsar PSR B0751+32, confirming a nulling fraction of 35.1%.


<details>
  <summary>Details</summary>
Motivation: To investigate periodic nulling in PSR B0751+32 and understand its modulation characteristics.

Method: Utilized mixture model methods and three independent approaches to analyze nulling and pulse profiles at 1250 MHz with FAST.

Result: Confirmed periodic nulling with a 35.1% nulling fraction and observed significant temporal evolution in modulation.

Conclusion: Findings challenge existing geometric models for periodic nulling, highlighting the complexity of pulsar behavior.
...
### [19] [Does the spectral break in the IceCube diffuse neutrino spectrum originate from AGN evolution?](https://arxiv.org/abs/2604.07824)
*Caijin Xie,Zijian Qiu,Yudong Cui,Sujie Lin,Lili Yang*

Main category: astro-ph.HE

TL;DR: The paper proposes that the diffuse neutrino background detected by IceCube, particularly its spectral break, can be explained by the evolution of active galactic nuclei (AGNs) and their contributions throughout different evolutionary phases.


<details>
  <summary>Details</summary>
Motivation: To address the enigmatic origin of the diffuse neutrino background and the spectral break observed in recent data.

Method: A unified framework incorporating AGN evolution was developed, positing that cosmic rays generated during AGN activity produce a long-lived hadronic afterglow as they diffuse in the host galaxy post-activity.

Result: The model successfully reproduces the spectral characteristics of the diffuse background and the neutrino emissions from notable AGNs like TXS 0506$+$056 and NGC 1068, suggesting enhanced CR reservoir efficiency in AGN host galaxies.

Conclusion: The findings indicate that most AGNs favor a lepton-dominated scenario, explaining IceCube's low point-like source detection rates and highlighting the necessity for next-gen neutrino telescopes with improved sensitivity.
...
### [20] [The deci-Hz gravitational wave signal from the collapse of rotating very massive stars](https://arxiv.org/abs/2604.07878)
*Bailey Sykes,Jade Powell,Bernhard Müller,Alexander Heger*

Main category: astro-ph.HE

TL;DR: The paper estimates the gravitational wave signal from a collapsing 300 $M_	extodot$ star, predicting a strong detectable signal in the deci-Hz range with potential detection rates for future detectors.


<details>
  <summary>Details</summary>
Motivation: To understand the gravitational wave emissions from the collapse of massive stars, especially in the pair-instability regime.

Method: The study involves calculating the gravitational wave signal resulting from the collapse of a rotating 300 $M_	extodot$ star and analyzing the asymmetries during the collapse.

Result: The analysis shows a strong gravitational wave signal in the deci-Hz range, potentially detectable by advanced detectors up to 200 Mpc away, at a predicted rate of 0.5 events per year.

Conclusion: The findings suggest that deci-Hz detectors could effectively detect gravitational waves from massive star collapses, offering insights into stellar evolution and the dynamics of such events.
...
### [21] [Oblique Shocks at Supernova Remnants in Massive Star Clusters: A Model for the Cosmic-Ray Knee Observed by LHAASO](https://arxiv.org/abs/2604.07977)
*Luana N. Padilha,Rita C. Anjos*

Main category: astro-ph.HE

TL;DR: This study proposes that oblique shocks in Massive Star Clusters are key to cosmic ray acceleration, achieving multi-PeV energies and explaining the cosmic-ray knee observed by LHAASO.


<details>
  <summary>Details</summary>
Motivation: To understand the mechanisms behind cosmic ray acceleration in Massive Star Clusters and explain the cosmic-ray knee in the energy spectrum.

Method: Develop a model incorporating oblique shocks from supernova and collective wind interactions, focusing on the shock obliquity angle's impact on particle energy.

Result: The model shows that oblique shocks enhance acceleration efficiency, allowing particles to reach multi-PeV energies and reproducing the all-particle spectrum observed by LHAASO.

Conclusion: The study presents a unified framework linking particle acceleration in Massive Star Clusters to cosmic-ray observations, including gamma-ray and neutrino emissions.
...
### [22] [Flux variability of the "10 keV feature" of 4U 0115+63](https://arxiv.org/abs/2604.08051)
...
TL;DR: This study analyzes the "10 keV feature" in the X-ray spectrum of the Be X-ray binary 4U 0115+63, revealing its independence from other spectral components and suggesting a different formation mechanism.


<details>
  <summary>Details</summary>
Motivation: To understand the origins of the distinct spectral component, the "10 keV feature," in relation to continuum and cyclotron resonant scattering features in X-ray pulsars.

Method: A flux-resolved analysis of two NuSTAR observations during the 2015 outburst was conducted to investigate the behavior of the "10 keV feature" against the broadband continuum and CRSFs.

Result: Changes in spectral shape were observed at the "10 keV feature," with indications of an anticorrelation between its flux and the continuum flux, supporting its independence from other features.

Conclusion: The findings suggest that the "10 keV feature" likely originates from a different mechanism than the continuum emission while still being situated in the same physical environment.
...
### [23] [How many VHE gamma-ray binaries with young pulsars can be observed?](https://arxiv.org/abs/2604.08175)
*A. M. Bykov,A. G. Kuranov,A. E. Petrov,K. A. Postnov*

Main category: astro-ph.HE

TL;DR: The paper explores the emerging population of Galactic gamma-ray binaries, focusing on their potential as cosmic ray accelerators, driven by multi-wavelength observations and population synthesis calculations.


<details>
  <summary>Details</summary>
Motivation: The study investigates the relationship between gamma-ray binaries and their ability to accelerate very high energy (VHE) particles, driven by recent detections and the unique configurations of binary systems.

Method: Population synthesis calculations were performed for Galactic binaries with young massive stars and pulsars; factors like binary eccentricities, orbital periods, and pulsar braking energy losses were modeled to estimate VHE acceleration conditions.

Result: The model predicts that strong magnetic fields and the interaction of pulsar outflows with stellar winds can accelerate particles to PeV energies under certain conditions, with the anisotropic structure impacting gamma-ray observations.

Conclusion: The findings suggest that the anisotropic nature of particle acceleration in these systems may influence both gamma-ray emission and absorption, potentially affecting the number of detectable gamma-ray binaries.
...
### [24] [The Stack Search Tests on FAST Data: Discovery of Six Faint Isolated Millisecond Pulsars in NGC 6517 and NGC 7078 (M15)](https://arxiv.org/abs/2604.08268)
...
TL;DR: Six new millisecond pulsars (MSPs) discovered in globular clusters NGC 6517 and NGC 7078 using enhanced signal processing techniques.


<details>
  <summary>Details</summary>
Motivation: To explore faint MSPs in dense stellar environments and improve detection methods.

Method: Stacking power spectra from multiple observations to improve the signal-to-noise ratio.

Result: Four new MSPs in NGC 6517 and two in M15, with varying spin periods and dispersion measures. Phase-coherent timing achieved for one MSP.

Conclusion: Stacking technique increases sensitivity for detecting faint pulsars, revealing previously undetected MSPs in globular clusters.
...
### [25] [A parametric study of plasma instability cooling and its impact on intergalactic magnetic field constraints in GeV cascades](https://arxiv.org/abs/2604.08375)
*Suman Dey,Simone Rossoni,Günter Sigl*

Main category: astro-ph.HE

TL;DR: The study examines how plasma instabilities influence electromagnetic cascades and constrains the intergalactic magnetic field (IGMF) using observations of the blazar 1ES 0229+200.


<details>
  <summary>Details</summary>
Motivation: To understand the role of weak intergalactic magnetic fields and plasma instabilities in shaping the cascade spectrum initiated by TeV gamma rays in cosmic voids.

Method: A parameterized model of plasma instabilities was introduced into the CRPropa Monte Carlo framework to evaluate their effects on the cascade spectrum using observations from Fermi-LAT.

Result: The analysis provides the best-fit photon spectrum considering plasma instability and IGMF parameters, showing that a characteristic length scale of order 100 kpc reproduces the observed data, yielding an IGMF strength of approximately 10^-17 G.

Conclusion: The findings suggest that plasma instabilities significantly affect the cascade spectrum, allowing for improved constraints on the IGMF in cosmic voids.
...
### [26] [Optical images of Kerr-Sen black hole illuminated by thick accretion disks](https://arxiv.org/abs/2604.08439)
*Yu-Kang Wang,Chen-Yu Yang,Xiao-Xiong Zeng*

Main category: astro-ph.HE

TL;DR: This paper examines the shadow and polarization images of Kerr-Sen black holes with two accretion disk models, revealing how variations in charge, spin, and observer angle affect the resulting images.


<details>
  <summary>Details</summary>
Motivation: To understand how accretion disk characteristics impact the visual properties of Kerr-Sen black hole images, focusing on shadow and polarization effects.

Method: The study employs the RIAF and BAAF models, applying radiative transfer theory to analyze the influence of black hole charge, spin, and observer inclination on shadow images.

Result: As the black hole charge increases, the images show shrinking photon rings and dark regions; higher spin and inclination enhance brightness asymmetry, with differences in image characteristics observed between isotropic and anisotropic radiation models.

Conclusion: The polarization vector arrangement is shaped by lensing and frame dragging, while charge significantly affects intensity near photon rings and higher order image scales.
...
### [27] [Finite Volume Effects on Transverse Momentum Spectra at LHC and RHIC Using a Blast-Wave Model with Planck Transformed Temperatures](https://arxiv.org/abs/2604.07410)
*A. S. Parvan,A. A. Aparin,E. V. Nedorezov*

Main category: hep-ph

TL;DR: This study analyzes the finite volume effects on charged pion transverse momentum spectra in heavy-ion collisions, employing a finite volume Boltzmann-Gibbs model that ensures Lorentz covariance through Planck transformations, yielding consistent results with relativistic thermodynamics, unlike the conventional infinite volume model which produces unphysical outcomes.


<details>
  <summary>Details</summary>
Motivation: To explore how finite volume impacts the transverse momentum spectra of charged pions, improving the reliability of freeze-out parameter extraction in heavy-ion collisions.

Method: A cylindrically symmetric finite volume Boltzmann-Gibbs blast-wave model is used, incorporating Planck transformations for temperature and chemical potential adjustments to ensure Lorentz covariance, compared against a conventional infinite volume model.

Result: The finite volume model aligns with relativistic thermodynamics and produces realistic cylinder volumes, while the infinite volume model leads to unphysical results such as infinite maximum lengths and velocities.

Conclusion: Accurate treatment of finite system size and Lorentz transformations is crucial for reliable extraction of freeze-out parameters in heavy-ion collisions.
...
### [28] [Probing Majoron Dark Matter with Gravitational Wave Detectors](https://arxiv.org/abs/2604.08193)
*Ippei Obata,Tsutomu T. Yanagida*

Main category: hep-ph

TL;DR: This paper explores using optical cavities in gravitational wave detectors to investigate Majoron dark matter, focusing on the effects of photon birefringence due to dark matter interactions.


<details>
  <summary>Details</summary>
Motivation: To assess the Majoron as a candidate for dark matter and examine its interactions with photons in the context of existing detection technology.

Method: The study utilizes a linear optical cavity setup in interferometric gravitational wave detectors, analyzing the oscillatory photon birefringence caused by Majoron dark matter coupling through a QED anomaly.

Result: Ground-based laser interferometers can potentially probe specific regions of Majoron dark matter parameter space, given the sensitivity of the optical setups to detect the induced birefringence.

Conclusion: The proposed method could provide valuable insights into Majoron dark matter, making significant contributions to ongoing and future gravitational wave observational campaigns.
...
TL;DR: This study explores high-energy particle interactions in the Cosmological Collider framework, focusing on primordial non-Gaussianity and the bispectrum, leading to an extension of previous findings.


<details>
  <summary>Details</summary>
Motivation: The research aims to investigate particle interactions and primordial non-Gaussianity at high energies, revealing potential insights into fundamental physics during inflation.

Method: It evaluates three contributing processes to the bispectrum ('single exchange', 'double exchange', 'triple exchange'), deriving shape functions and analyzing Planck data for evidence of non-Gaussianity.

Result: No evidence for non-Gaussianity was found in the initial search; however, extensions of the minimal scenario showed 1.5σ evidence for non-zero NG in a specific parameter space.

Conclusion: The study opens pathways to explore interactions under high-energy conditions and suggests modifications in particle mass and chemical potential to observe non-Gaussian features.
...
TL;DR: The paper explores gauged Q-balls—scalar particle systems with gauge symmetry—in flat potentials, analyzing their properties and comparing them to established gauged Q-balls in thin-wall scenarios.


<details>
  <summary>Details</summary>
Motivation: To investigate the nature and properties of gauged Q-balls in flat potentials, particularly in the context of supersymmetric models, and to understand their similarities and differences with global and thin-wall Q-balls.

Method: Analytic approximations are developed for gauged Q-balls in flat potentials, followed by numerical comparisons. The study also examines Proca Q-balls to bridge global and gauged behaviors.

Result: The gauged Q-balls in flat potentials display remarkable similarities to their counterparts in thin-wall scenarios, despite the qualitative differences seen in their global analogs.

Conclusion: The findings contribute valuable insights into the behavior of gauged Q-balls in the context of supersymmetry and provide groundwork for further exploration of their properties.
...
TL;DR: This paper explores a new class of symmetries in two Higgs doublet models through unique transformations, establishing fermion field interactions and identifying invariant parameter regions under perturbation theory.


<details>
  <summary>Details</summary>
Motivation: The study investigates the novel symmetries of two Higgs doublet models to enhance understanding of their properties and interactions.

Method: The authors derive fermion field transformations and analyze Yukawa matrix textures that align with the new symmetries, extending the analysis to two-loop order.

Result: The research identifies new regions of parameter space that remain invariant under renormalization to all orders of perturbation theory, encompassing scalar-fermion interactions.

Conclusion: The findings broaden the theoretical framework of two Higgs doublet models, suggesting robust connection with perturbative phenomena.
...
TL;DR: The Mu2e experiment investigates lepton flavor violation through the process $μ^- e^- \to e^- e^-$ within an axion-like particle framework, revealing constraints on its branching ratio due to existing experimental limits.


<details>
  <summary>Details</summary>
Motivation: To probe lepton-flavor violation in a muonic atom using axion-like particles with flavor-violating couplings.

Method: The study computes the ALP-mediated transition rate and evaluates constraints from various muon decay processes and magnetic moments.

Result: The branching ratio for $μ^- e^- \to e^- e^-$ in aluminum is limited to $\,\mathcal{O}(10^{-20})$, with significant suppression in the resonant region of mediator mass.

Conclusion: Existing constraints, particularly from $Δa_e$ and muon decays, heavily restrict the observable rates, highlighting Mu3e's potential to identify promising signals.
...
TL;DR: This study computes $Λ$ polarization in heavy-ion collisions using a Core--Corona model, highlighting the importance of intrinsic polarization and environmental factors in the interaction.


<details>
  <summary>Details</summary>
Motivation: To understand the polarization of $Λ$ in semicentral heavy-ion collisions and its dependence on the environment and collision energy.

Method: The Core--Corona framework is employed, calculating intrinsic polarization functions with an effective fermion propagator that includes vortical motion, and utilizing gluons and $σ$-mesons as mediators at varying temperatures and baryon chemical potentials.

Result: The model accurately describes $Λ$ polarization across experimental data, revealing that the corona contributes predominantly, especially at lower energies, and predicts a robust maximum near 3 GeV.

Conclusion: The framework effectively captures the excitation function over a wide energy range, indicating critical roles of corona dynamics and energy-dependent properties in $Λ$ polarization.
...
TL;DR: This study investigates forward trijet production in proton-nucleus collisions, focusing on gluon-initiated processes at leading order using the Color Glass Condensate effective theory.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics of forward trijet production in proton-nucleus collisions and validate the CGC framework in capturing complex interactions.

Method: Calculations were performed using the Color Glass Condensate theory with a focus on light-like Wilson lines and perturbative impact factors, employing covariant perturbation theory to analyze amplitudes.

Result: Results reveal the first observation of a four-gluon vertex's structure resembling instantaneous contributions, and identify divergences affecting parton distribution and fragmentation functions.

Conclusion: These findings support the validity of the dilute-dense hybrid formalism and are crucial for advancing towards next-to-leading order calculations in related processes.
...
### [35] [$\bar B\to D^{(*)}\ell\bar ν$ Branching Ratios and Evidence for Isospin Breaking in $Υ(4S)$ Decays](https://arxiv.org/abs/2604.08391)
*Martin Jung,Stefan Schacht*

Main category: hep-ph

TL;DR: A new method for determining the ratio of branching fractions $R^{	ext{±0}}$ in $ar B 	o D^{(*)}	ext{ℓ}ar ν$ decays is presented, yielding a precise value that suggests isospin violation in $Υ(4S)$ decays.


<details>
  <summary>Details</summary>
Motivation: To refine the current understanding of isospin violation and improve the accuracy of branching fraction measurements in B-meson decays.

Method: A comprehensive analysis of available data in $ar B	o D^{(*)}	ext{ℓ}ar ν$ decays was conducted to extract branching fractions and the ratio $R^{	ext{±0}}$, ensuring all correlations were accounted for to avoid data duplication.

Result: The study yields a precise measurement of $R^{	ext{±0}}=1.062(19)$, about $2σ$ from unity, indicating significant evidence for isospin violation.

Conclusion: The findings underline the need to incorporate isospin violation in experimental and phenomenological analyses and provide improved branching fraction values for $ar B	o D^{(*)}	ext{ℓ}ar ν$, addressing existing literature discrepancies.
...
### [36] [Lecture notes on Machine Learning applications for global fits](https://arxiv.org/abs/2604.07520)
*Jorge Alda*

Main category: hep-ph

TL;DR: This paper presents a framework for using machine learning in global statistical fits in high-energy physics, detailing methods for model building, data generation, and analysis of particle decay anomalies.


<details>
  <summary>Details</summary>
Motivation: To address the computational challenges of traditional statistical fitting methods in high-energy physics by leveraging machine learning techniques.

Method: The framework incorporates Boosted Decision Trees for log-likelihood approximation, employs active learning for data generation, optimizes hyperparameters, and uses SHAP values for interpretability, alongside MCMC for posterior sampling.

Result: Applied to the $B^pm 	o K^pm νarν$ anomaly at Belle II, the two-stage ML model effectively explored parameter space for Axion-Like Particles under experimental constraints.

Conclusion: The integration of ML techniques significantly enhances the efficiency and interpretability of global statistical fits in high-energy physics, offering a robust approach for analyzing complex particle decay scenarios.
...
### [37] [Transverse energy-momentum tensor distributions in polarized nucleons](https://arxiv.org/abs/2604.07616)
*Ho-Yeon Won,Cédric Lorcé*

Main category: hep-ph

TL;DR: The paper investigates the relativistic spatial distributions of the energy-momentum tensor in polarized nucleons, focusing on transverse components and their multipole structure, and demonstrates alignment with established light-front distributions in infinite momentum frames.


<details>
  <summary>Details</summary>
Motivation: Understanding the relativistic spatial distributions of energy-momentum tensors in polarized nucleons is essential for improving theoretical models in particle physics.

Method: The authors use quantum phase-space formalism to analyze transverse components of the energy-momentum tensor and assess their multipole structure in a moving nucleon context.

Result: The formalism effectively reproduces standard light-front distributions, even those with a 'bad' component, and elucidates the structural origin of these distributions.

Conclusion: The findings align with established models, offering insights into the multipole structures of energy-momentum distributions in polarized nucleons.
...
### [38] [Memory effect on the heavy quark dynamics in hot QCD matter](https://arxiv.org/abs/2604.07982)
*Jai Prakash,Ling Hai Li,Ying Shan Zhao,Yifeng Sun*

Main category: hep-ph

TL;DR: The paper investigates heavy quark dynamics influenced by memory effects using a generalized Langevin equation and fractional calculus.


<details>
  <summary>Details</summary>
Motivation: To understand how memory effects impact heavy quark dynamics in quark-gluon plasma.

Method: Utilizes a generalized Langevin equation incorporating memory through time-correlated thermal noise modeled by a fractional differential equation with a Caputo derivative.

Result: Finds that time-correlated thermal noise significantly affects momentum correlation, average squared momentum, displacement, and kinetic energy of heavy quarks.

Conclusion: The study demonstrates that memory effects notably alter heavy quark dynamics in the quark-gluon plasma.
...
### [39] [Constraining Ultralight Scalar Dark Matter in the Galactic Center with the S2 Orbit](https://arxiv.org/abs/2604.08053)
*Jiang-Chuan Yu,Yan Cao,Lijing Shao*

Main category: hep-ph

TL;DR: This paper investigates ultralight dark matter's effects on the dynamics of S-stars near the supermassive black hole in the Galactic Center, using orbital precession data to set constraints on ULDM mass and coupling constants.


<details>
  <summary>Details</summary>
Motivation: To probe ultralight dark matter in the unique dense environment of the Galactic Center and its influence on star dynamics.

Method: The study analyzes the orbital dynamics of S-stars under the influence of a scalar ULDM field with linear and quadratic couplings, focusing on the observed precession rate of the S2 star.

Result: Constraints were established on ULDM mass ratios and coupling constants, significantly improving upon current limits within the mass range of $10^{-20} 	ext{eV} \leq m \leq 10^{-18} 	ext{eV}$.

Conclusion: The research demonstrates the potential of using stellar dynamics around supermassive black holes to investigate ultralight dark matter, providing key limits on its properties.
...
TL;DR: The paper explores the role of multiple vector-like fermions in SU(5) GUT, enhancing gauge coupling unification and extending proton lifetime.


<details>
  <summary>Details</summary>
Motivation: To address limitations in conventional SU(5) GUT, including gauge coupling unification and proton decay rates.

Method: Analyzing threshold effects from extra fermions to match gauge couplings and studying the impact on nucleon decay and Yukawa relations.

Result: Unification scale raised to approximately $10^{15.5}\,	ext{GeV}$, extended proton lifetimes, and relaxed Yukawa coupling relations.

Conclusion: Multi-fermion SU(5) GUTs offer a viable framework to reconcile various theoretical challenges and highlight the need for next-generation proton decay experiments.
...
### [41] [Kinetic and canonical momentum broadening in the Glasma](https://arxiv.org/abs/2604.08520)
*Dana Avramescu,Carlos Lamas,Tuomas Lappi,Meijian Li,Carlos A. Salgado*

Main category: hep-ph

TL;DR: This paper presents a quantum framework for the real-time dynamics of particles in the Glasma phase of heavy-ion collisions, emphasizing gauge invariance in momentum definitions.


<details>
  <summary>Details</summary>
Motivation: To describe particle dynamics in the Glasma phase more accurately by integrating gauge invariance into quantum formalism.

Method: Establish correspondence between Wong's equations and Heisenberg equations, derive equations of motion for both kinetic and canonical momentum in a classical non-Abelian background field.

Result: Kinetic momentum broadening is shown to be influenced by transverse field components, even in the eikonal limit. Enforcing a transverse Coulomb gauge mitigates numerical errors in calculations.

Conclusion: The developed framework enhances the accuracy and reliability of numerical simulations for future quantum implementations.
...
### [42] [Borns Rule from Reversible Evolution and Irreversible Outcomes](https://arxiv.org/abs/2604.07418)
*Oskar Axelsson*

Main category: quant-ph

TL;DR: The paper derives the quadratic measure of probability from the fundamental structural features of physical processes, specifically reversible evolution and multiplicative weight composition.


<details>
  <summary>Details</summary>
Motivation: To demonstrate that the quadratic measure does not need to be assumed but can emerge from basic physical principles.

Method: The authors analyze the compatibility between linear reversible evolution and the multiplicative assignment of weight to outcomes after records form, establishing the constraints on weight assignment.

Result: They show that requiring consistency between reversible and irreversible processes results in a quadratic weight assignment, leading to the emergence of the Born rule.

Conclusion: The Born rule is established as the unique measure arising from reversible evolution and record formation, independent of specific quantum frameworks.
...
### [43] [Comment on "Quantum theory based on real numbers cannot be experimentally falsified": On the compatibility of physical principles with information theory for fermions](https://arxiv.org/abs/2604.07425)
*Fatemeh Moradi Kalarde,Xiangling Xu,Marc-Olivier Renou*

Main category: quant-ph

TL;DR: The paper challenges a proposed postulate for quantum theory's formulation, showing it fails in Fermionic Information Theory (FIT), indicating that the postulate is not general.


<details>
  <summary>Details</summary>
Motivation: The need to establish a universally applicable postulate for quantum theory that is compatible across different frameworks, including Fermionic Information Theory.

Method: An analysis of the proposed postulate from [arXiv:2603.19208] in the context of Fermionic Information Theory, assessing its validity.

Result: Demonstrated that the proposed postulate does not hold in the framework of FIT, thereby challenging its universality as a foundational principle for quantum theory.

Conclusion: The findings emphasize the necessity of testing foundational principles against various information theories, suggesting further investigation into their applicability.
...
### [44] [Observation of genuine $2+1$D string dynamics in a U$(1)$ lattice gauge theory with a tunable plaquette term on a trapped-ion quantum computer](https://arxiv.org/abs/2604.07436)
*Rohan Joshi,Yizhuo Tian,Kevin Hemery,N. S. Srivatsa,Jesse J. Osborne,Henrik Dreyer,Enrico Rinaldi,Jad C. Halimeh*

Main category: quant-ph

TL;DR: The study conducts quantum simulations of string dynamics in 2+1D using a U(1) quantum link model on a quantum computer, revealing new insights into gauge field dynamics and string-breaking phenomena.


<details>
  <summary>Details</summary>
Motivation: To explore high-energy physics scenarios in 2+1 dimensions that cannot be easily simulated classically, particularly focusing on string dynamics related to hadronization.

Method: A U(1) quantum link model is realized on a Quantinuum System Model H2 quantum computer, simulating a $5 \times 4$ lattice with 51 qubits. The simulation uses a shallow circuit design and implements string-breaking dynamics experiments under varying conditions, particularly examining the influence of a plaquette term.

Result: The presence of a plaquette term is crucial for demonstrating genuine 2+1D dynamics, with observed phenomena including string propagation, annihilation of string segments, and the generation of electron-positron pairs that indicate non-local matter creation across the lattice.

Conclusion: The results confirm the emergence of dynamical gauge fields in 2+1D and pave the way for photon-like excitations in quantum simulations of gauge theories.
...
### [45] [Ten-Second Electron-Spin Coherence in Isotopically Engineered Diamond](https://arxiv.org/abs/2604.07439)
...
TL;DR: This study enhances spin coherence times of nitrogen-vacancy centres in diamond, crucial for quantum networks.


<details>
  <summary>Details</summary>
Motivation: To develop solid-state spin defects that exhibit long spin-coherence times and coherent optical transitions necessary for quantum networking.

Method: The authors utilize isotopically engineered diamond with controlled $^{13}	ext{C}$ and low nitrogen concentrations, and employ real-time noise mitigation and decoupling sequences.

Result: Achieved spin-coherence times of $T_2 = 6.8(1)$ ms and $T_2^{DD} = 11.2(8)$ s; observed a linewidth of 16.9(4) MHz for optical transitions with controlled spectral diffusion.

Conclusion: Findings suggest potential advancements in spin-qubit control, paving the way for enhanced quantum technologies.
...
### [46] [Locked Subharmonic Oscillations in the Entanglement Spectrum of a Periodically Driven Topological Chain](https://arxiv.org/abs/2604.07442)
*Rishabh Jha*

Main category: quant-ph

TL;DR: This paper reveals a subharmonic response in the entanglement spectrum of a free-fermion system under periodic driving, demonstrating that entanglement spectroscopy can effectively probe Floquet topological coherence.


<details>
  <summary>Details</summary>
Motivation: To explore the characteristics of periodically driven quantum systems, particularly through the lens of entanglement and to identify how it conveys information about topological phases.

Method: The study focuses on a two-step driven Su-Schrieffer-Heeger chain, examining the entanglement spectrum and correlation matrices at specific quasienergies while analyzing influences of initial states and symmetries.

Result: A distinctive subharmonic feature appears in the entanglement spectrum, exhibiting robust period-doubling response linked to initial coherent superposition states, while other observables remain invariant due to symmetry.

Conclusion: The findings underscore the crucial role of zero-$	ext{π}$ Floquet topology and coherent state preparation in observing topological properties, positioning entanglement spectroscopy as a vital tool for understanding Floquet topological coherence.
...
### [47] [When is randomization advantageous in quantum simulation?](https://arxiv.org/abs/2604.07448)
*Francesco Paganelli,Michele Grossi,Andrea Giachero,Thomas E. O'Brien,Oriel Kiss*

Main category: quant-ph

TL;DR: This study explores how randomization in Hamiltonian simulation can be beneficial, particularly through a novel sparse-QSVT method, and identifies conditions under which this benefit has practical significance.


<details>
  <summary>Details</summary>
Motivation: To investigate the optimal use of randomization in Hamiltonian simulation and to understand its impact on efficiency based on different parameters of Hamiltonians.

Method: The authors introduce a sparse-QSVT construction that utilizes composite stochastic decompositions. By analyzing how errors propagate in these techniques, the study benchmarks random Hamiltonians with varying properties to evaluate the effectiveness of randomization.

Result: Randomized approaches can significantly reduce gate counts for Hamiltonians with numerous terms and inhomogeneous coefficients, achieving improvements of up to an order of magnitude. However, these benefits are mostly observed in moderate-precision situations (around $rac{	ext{target error}}{10^{-3}}$.

Conclusion: While randomization aids in reducing complexity in specific scenarios, deterministic methods become increasingly advantageous as precision requirements tighten, particularly in systems with more complex Hamiltonian structures.
...
### [48] [Operational criteria for quantum advantage in latency-constrained nonlocal games](https://arxiv.org/abs/2604.07451)
*Changhao Li,Seigo Kikura,Akihisa Goban,Hayata Yamasaki,Shinichi Sunami*

Main category: quant-ph

TL;DR: The study develops a framework for analyzing quantum advantages in latency-constrained tacit coordination (LCTC), incorporating real-world factors like finite operation times and entanglement rates, and proposes practical implementations using trapped-atom quantum networks.


<details>
  <summary>Details</summary>
Motivation: To address limitations in existing analyses of quantum-classical gaps in LCTC by considering practical constraints such as finite-duration operations and entanglement rates.

Method: A comprehensive framework is created that adapts statistical certification methods from nonlocal games to analyze operational criteria for achieving quantum advantage in LCTC.

Result: Implementation of time-multiplexed operations in trapped-atom quantum networks can achieve decision latencies of a microsecond and rates of 8000 decisions per second in metropolitan-scale networks.

Conclusion: The findings connect theoretical frameworks of quantum advantage to practical implementations, enabling robust quantum decision-making in fast-evolving environments.
...
### [49] [Quantum Simulation of Collective Neutrino Oscillations using Dicke States](https://arxiv.org/abs/2604.07452)
*Katarina Bleau,Nikolina Ilic,Joachim Kopp,Ushak Rahaman,Xin Yue Yu*

Main category: quant-ph

TL;DR: This paper introduces an efficient qubit-based algorithm for simulating entangled neutrino states, enhancing current quantum simulations by utilizing system symmetries.


<details>
  <summary>Details</summary>
Motivation: To accurately simulate entangled states of neutrinos in supernovae, where existing quantum simulations are currently suboptimal.

Method: Development of new qubit-efficient algorithms leveraging Dicke states and $su(2)$ spin algebra.

Result: The proposed algorithms show improved performance in both classical and quantum computing environments.

Conclusion: These advancements pave the way for better simulations of dense neutrino gases in astrophysical contexts.
...
### [50] [Optimal Quantum State Testing Even with Limited Entanglement](https://arxiv.org/abs/2604.07460)
*Chirag Wadhwa,Sitan Chen*

Main category: quant-ph

TL;DR: The study improves quantum state certification by establishing upper bounds on copy complexity when measuring multiple copies at once, achieving optimal rates with fewer entangled measurements.


<details>
  <summary>Details</summary>
Motivation: To tackle the challenge of certifying quantum states efficiently, particularly under constraints of high precision and limited entangled measurements.

Method: The authors derive smooth copy complexity upper bounds as a function of the number of simultaneous measurements, extending these techniques to related quantum tasks and benchmarking against entangled measurement protocols.

Result: They demonstrate a near-optimal certification rate when measuring $t = d^2$ copies, improving upon existing protocols in the high-precision regime, and provide lower bounds ensuring sufficient copies for optimal performance.

Conclusion: The findings highlight the potential for enhanced quantum state testing methodologies by using fewer entangled copies, which is crucial for practical implementations in quantum information science.
...
### [51] [On Lorentzian symmetries of quantum information](https://arxiv.org/abs/2604.07471)
*James Fullwood,Vlatko Vedral,Edgar Guzmán-González*

Main category: quant-ph

TL;DR: This paper demonstrates that Lorentzian symmetries in quantum information emerge from an information-theoretic principle, revealing a connection between quantum states and spacetime structure.


<details>
  <summary>Details</summary>
Motivation: The paper is motivated by the 'It from Qubit' paradigm, which posits a foundational link between quantum information and spacetime.

Method: The authors derive the action of the restricted Lorentz group on a qubit's internal degrees of freedom based on a principle called preservation of linear entropy, and explore the Lorentz invariance of the linear entropy and related spectral invariants.

Result: They show that linear $n$-partite mutual information and the correlation function for qubits in a singlet state yield invariant scalars under transformations of the Lorentz group.

Conclusion: Their findings indicate that the structure of spacetime can be intrinsically derived from the properties of quantum information, supporting the 'It from Qubit' perspective.
...
### [52] [Fermionic entanglement and quantum correlation measures in molecules](https://arxiv.org/abs/2604.07633)
*J. Garcia,J. A. Cianciulli,R. Rossignoli*

Main category: quant-ph

TL;DR: The paper investigates fermionic entanglement in the water molecule, analyzing electronic states as a function of internuclear distance using configuration interaction methods.


<details>
  <summary>Details</summary>
Motivation: To characterize electronic eigenstates of the water molecule through entanglement measures and correlations, enhancing understanding of molecular interaction.

Method: Utilized full configuration interaction to assess the entanglement and correlation measures of ground and thermal states, including one- and two-body density matrices, Schmidt decomposition, and new metrics for mutual information and negativity.

Result: Introduced new entanglement measures, revealing insights into fermionic correlations and their behavior as internuclear distances change, with key results at the dissociation limit.

Conclusion: The study provides a comprehensive framework for characterizing entanglement in molecular systems, highlighting significant findings in the electronic structure and thermal states of the water molecule.
...
### [53] [Exponential quantum advantage in processing massive classical data](https://arxiv.org/abs/2604.07639)
*Haimeng Zhao,Alexander Zlokapa,Hartmut Neven,Ryan Babbush,John Preskill,Jarrod R. McClean,Hsin-Yuan Huang*

Main category: quant-ph

TL;DR: This paper demonstrates that small quantum computers can outperform classical counterparts in large-scale classification and dimension reduction, achieving significant efficiency gains in real-world applications.


<details>
  <summary>Details</summary>
Motivation: To address the open problem of quantum advantage in classical data processing and machine learning.

Method: The authors utilize quantum oracle sketching to perform tasks on massive classical data with limited qubit resources, circumventing the data loading and readout bottlenecks.

Result: The quantum computer shows four to six orders of magnitude improvement in size and efficiency compared to classical machines, even under challenging conditions.

Conclusion: The findings demonstrate that quantum computing offers a tangible advantage in machine learning tasks on classical data, supporting the relevance of quantum mechanics in practical applications.
...
### [54] [A Thermodynamic SU(1,1) Witness Framework for Double-Quantum NMR Signals in Neural Tissue](https://arxiv.org/abs/2604.07641)
*Christian Kerskens*

Main category: quant-ph

TL;DR: This paper establishes a thermodynamic framework that bounds classical fluctuation estimates for double-quantum observables in spin systems, revealing limitations on classical correlations at finite temperatures.


<details>
  <summary>Details</summary>
Motivation: The need to extend entanglement criteria, typically grounded in compact algebras, to non-compact sectors like double-quantum observables is crucial for understanding fluctuations in quantum systems.

Method: A thermodynamic witness framework is developed, utilizing finite-temperature detailed-balance conditions and analyzing the quantum dynamical semigroup of spin-bath interactions.

Result: Spontaneous transient pair correlations are shown to be limited to around an amplitude of 10^{-9}, with classical coherent sequence amplification capped at ^{-2} in motionally narrowed tissue.

Conclusion: The study provides a theoretical basis for classifying macroscopic double-quantum anomalies as classically inexplicable, contingent upon verifying macro-scale structural stability.
...
### [55] [Control-centric quantum noise spectroscopy of time-ordered polyspectra](https://arxiv.org/abs/2604.07682)
*Kaiah Steven,Elliot Coupe,Qi Yu,Gerardo A. Paz-Silva*

Main category: quant-ph

TL;DR: This paper presents a method for precise environmental-noise characterization in open quantum systems using a control-centric approach to enhance quantum noise spectroscopy (QNS).


<details>
  <summary>Details</summary>
Motivation: The goal is to achieve high-fidelity quantum control and mitigate decoherence in computing and sensing, necessitating accurate noise characterization under realistic experimental constraints.

Method: The authors propose a control-centric reformulation of noise spectroscopy that focuses on time-ordered polyspectra and simplifies control filter functions for better noise correlation estimation.

Result: The approach successfully generalizes frequency-comb QNS protocols to arbitrary control scenarios and demonstrates effective reconstruction of polyspectra in various environments via simulations.

Conclusion: Adopting a control-centric viewpoint improves the practical applicability of QNS, enhancing the understanding of noise correlations under typical limitations.
...
### [56] [Trotterization with Many-body Coulomb Interactions: Convergence for General Initial Conditions and State-Dependent Improvements](https://arxiv.org/abs/2604.07704)
*Di Fang,Xiaoxu Wu*

Main category: quant-ph

TL;DR: This paper establishes rigorous error bounds for Trotter formulas in simulating many-body quantum systems with Coulomb interactions, demonstrating quantum computational efficiency without regularization for initial conditions, especially relevant for hydrogen states.


<details>
  <summary>Details</summary>
Motivation: The paper addresses challenges in simulating many-body quantum systems due to unbounded operators and exponential growth of Hilbert space dimension, focusing on the Coulomb potential's complexity.

Method: The authors derive error bounds for second-order Trotter formulas, showing a convergence rate of $1/4$ and investigating specific conditions that improve rates to first and second order for physically relevant initial states.

Result: Second-order Trotter achieves $1/4$ convergence with polynomial error dependence on particle number; improvement under specific initial state conditions noted, especially for hydrogen-like systems with high angular momentum.

Conclusion: The findings align with numerical observations and affirm the relevance of the Trotter formula in practical quantum simulations of many-body systems.
...
### [57] [Critical Entanglement Dynamics at Dynamical Quantum Phase Transitions](https://arxiv.org/abs/2604.07714)
*Kaiyuan Cao,Mingzhi Li,Xiang-Ping Jiang,Shu Chen,Jian Wang*

Main category: quant-ph

TL;DR: This paper explores the role of momentum-space entanglement entropy in understanding dynamical quantum phase transitions in two-band insulators and superconductors, revealing new insights into critical behavior and basis dependence.


<details>
  <summary>Details</summary>
Motivation: The study aims to analyze the critical behavior of momentum-space entanglement entropy in the context of dynamical quantum phase transitions, providing a deeper understanding of the interplay between entanglement and quantum criticality in various models.

Method: Using models like the Su-Schrieffer-Heeger model, quantum XY chain, and Haldane model, the researchers investigate entanglement properties and critical behaviors at dynamical quantum phase transitions, particularly focusing on momentum-space entanglement entropy.

Result: The investigation reveals that the condition for geometric DQPTs corresponds to a specific degeneracy in the entanglement spectrum, with critical momentum manifesting differently in one and two dimensions, and highlights the significant effect of bipartition basis on entropy behavior.

Conclusion: The findings suggest that momentum-space entanglement entropy is a powerful, basis-dependent diagnostic tool for identifying DQPTs, linking critical phenomena in quantum systems to topological and entanglement properties.
...
### [58] [Ghost imaging with zero photons](https://arxiv.org/abs/2604.07782)
*Meixue Chen,Yiqi Song,Yu Gu,Huafan Zhang,Huaibin Zheng,Yuchen He,Hui Chen,Yu Zhou,Fuli Li,Zhuo Xu,Jianbin Liu*

Main category: quant-ph

TL;DR: Ghost imaging can be executed using zero photons, where image reconstruction relies on photon statistics and measurement techniques, contributing to discussions on quantum versus classical correlations.


<details>
  <summary>Details</summary>
Motivation: The paper aims to explore the boundaries of ghost imaging techniques and their fundamental implications, particularly concerning the role of photons in image retrieval.

Method: The authors conduct an experiment dubbed 'ghost imaging with zero photons,' utilizing photon-number projection measurement and thermal light statistics to reconstruct an image without any direct interaction with the object.

Result: The study successfully demonstrates that an image can be reconstructed even when no photons interact with the object or when there are no incoming photons in either beam.

Conclusion: The findings challenge traditional understandings of ghost imaging, offering insights into quantum and classical correlations and the fundamental nature of imaging processes.
...
### [59] [Inverse Laplace and Mellin integral transforms modified for use in quantum communications](https://arxiv.org/abs/2604.07787)
*Gustavo Alvarez,Igor Kondrashuk*

Main category: quant-ph

TL;DR: This paper reviews integral transformations vital for signal processing in electronics and proposes modifications for quantum computer security protocols.


<details>
  <summary>Details</summary>
Motivation: To explore how integral transformations from quantum field theory can enhance signal processing and security in quantum applications.

Method: Review of existing integral transforms, with proposed modifications to enable their application in extended domains for quantum security.

Result: The modified inverse integral transformations are suggested to be effective in improving security protocols for quantum computers.

Conclusion: The modifications to integral transformations broaden their applicability, particularly in quantum security contexts.
...
### [60] [Complexity phase transition for continuous-variable cluster state](https://arxiv.org/abs/2604.07804)
*Byeongseon Go,Hyunseok Jeong,Changhun Oh*

Main category: quant-ph

TL;DR: This paper investigates the impact of finite squeezing on the computational power of continuous-variable cluster states in measurement-based quantum computation (MBQC).


<details>
  <summary>Details</summary>
Motivation: To understand how finite squeezing constrains the computational capabilities of CV cluster states due to the challenges of incorporating non-Gaussian resources.

Method: The authors analyze measurement-based linear optics (MBLO) using a newly developed framework that assesses the relationship between squeezing levels and classical simulation complexity.

Result: They identify thresholds of squeezing that distinguish between classically tractable and intractable output states, leading to a squeezing-driven complexity phase transition.

Conclusion: The study highlights the necessity of increasing squeezing levels or employing error-correction to enable reliable large-scale quantum computation with CV cluster states.
...
### [61] [Optimal noisy quantum phase estimation with finite-dimensional states](https://arxiv.org/abs/2604.07828)
*Jin-Feng Qin,Jing Liu*

Main category: quant-ph

TL;DR: This paper explores optimal finite-dimensional probe states for phase estimation in quantum interferometry under particle loss noise, revealing new true optimal states and proposing a measurement strategy to achieve ultimate precision.


<details>
  <summary>Details</summary>
Motivation: The necessity to adapt optimal probe states for phase estimation in the presence of unavoidable noise, particularly particle loss, which undermines previously established optimal states.

Method: Investigation of optimal finite-dimensional probe states under particle loss noise using a constrained optimization by linear approximation approach and proposing a two-step measurement strategy.

Result: Identified new true optimal finite-dimensional probe states (OFPSs) that are valid under noise conditions, supported by numerical simulations demonstrating the effectiveness of the proposed measurement strategy.

Conclusion: The study provides insights into the true OFPSs amid noise and offers a practical strategy for achieving maximal precision in quantum interferometry.
...
### [62] [Quantum Simulation of Hyperbolic Equations and the Nonexistence of a Dirac Path Measure](https://arxiv.org/abs/2604.07847)
*Sumita Datta*

Main category: quant-ph

TL;DR: The paper addresses the lack of a probability measure for the Dirac equation's path integral in Minkowski space by examining distributional properties and the Minkowski metric.


<details>
  <summary>Details</summary>
Motivation: To explore why a classical path integral for the Dirac equation lacks a well-defined probability measure in Minkowski space.

Method: The paper compares two perspectives: the distributional nature of the Dirac propagator and the oscillatory behavior induced by the Minkowski metric, unifying them into a single measure-theoretical obstruction.

Result: Identified a unified mathematical obstruction that prevents the construction of a nonnegative transition kernel in the context of the Dirac equation.

Conclusion: The findings illuminate the implications for stochastic representations of first-order relativistic equations.
...
### [63] [Analysis of State Teleportation using Noisy Quantum Gates](https://arxiv.org/abs/2604.07849)
*Imama Tul Birrah Khan,Muhammad Faryad*

Main category: quant-ph

TL;DR: This paper investigates the effects of various noise types on quantum state teleportation, revealing that fidelity generally decreases polynomially with noise strength, but persists linearly at low noise levels.


<details>
  <summary>Details</summary>
Motivation: To address the significant challenge noise poses to the reliability of quantum protocols in quantum computing.

Method: Analytical study modeling noise processes (depolarization, bit flip, phase flip) as quantum channels applied to qubits after unitary operations, evaluating fidelity of teleported states.

Result: Fidelity typically decreases polynomially with increased noise strength; at low noise levels, fidelity decline is linear, demonstrating robustness.

Conclusion: Findings enhance understanding of error characterization and guide noise reduction strategies in quantum computing.
...
### [64] [Hardware-Aware Quantum Support Vector Machines](https://arxiv.org/abs/2604.07856)
*Adil Mubashir Chaudhry,Ali Raza Haider,Hanzla Khan,Muhammad Faryad*

Main category: quant-ph

TL;DR: A hardware-aware Neural Architecture Search method designs efficient quantum feature maps for IBM quantum processors, achieving notable performance improvements on NISQ devices.


<details>
  <summary>Details</summary>
Motivation: To create compatible quantum machine learning circuits for IBM quantum hardware without the overhead of transpilation, leveraging hardware-specific gate sets and characteristics.

Method: The study employs genetic algorithms within a hardware-aware NAS framework to evolve quantum circuit architectures using IBM native gates, focusing on the design of quantum Support Vector Machine feature maps.

Result: The NAS method discovers a 12-gate circuit achieving 91.23% accuracy on the UCI Breast Cancer Wisconsin dataset, significantly outperforming hand-crafted options (64% accuracy) and closely matching classical methods (93%).

Conclusion: Hardware-aware NAS enhances the practical deployment of quantum kernel methods on NISQ devices, allowing for direct execution of optimized circuits with reduced errors.
...
### [65] [Fast and Coherent Transfer of Atomic Qubits in Optical Tweezers using Fiber Array Architecture](https://arxiv.org/abs/2604.07862)
*Jia-Chao Wang,Zai-Zheng Zhang,Xiao Li,Guang-Wei Wang,Xiao-Dong He,Min Liu,Peng Xu*

Main category: quant-ph

TL;DR: The paper presents a neutral-atom quantum computing architecture that achieves fast and coherent qubit transfer with low motional heating, addressing key limitations in quantum circuit performance.


<details>
  <summary>Details</summary>
Motivation: To enhance quantum computing by improving qubit interconnectivity and reducing resource overhead through faster and more reliable qubit transfer mechanisms.

Method: Using a fiber array setup with site-resolved control over trap depths, the authors performed smooth amplitude exchange between static and moving traps for efficient qubit transfer.

Result: Achieved a 10 $μ$s in situ transfer with low heating rates (0.156(9) $μ$K), high fidelity (0.99992(5)), and negligible atom loss over 500 cycles; demonstrated 120 $μ$s transfer between static traps with similar low heating and fidelity metrics over repeated cycles.

Conclusion: The developed architecture enables fast, low-heating quantum operations, representing a significant advance in atom-shuttling based quantum computing by integrating speed, fidelity, and reduced heating effects.
...
### [66] [Hybrid Quantum--Classical k-Means Clustering via Quantum Feature Maps](https://arxiv.org/abs/2604.07873)
*Syed M. Abdullah,Alisha Baba,Muhammad Siddique,Muhammad Faryad*

Main category: quant-ph

TL;DR: This study presents a quantum-enhanced k-means clustering approach that utilizes quantum kernels for improved clustering performance over classical methods.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of classical k-means clustering, particularly its sensitivity to initialization and inability to capture complex data structures, the study explores quantum enhancements.

Method: The proposed method employs quantum kernels derived from inner products of feature-mapped quantum states, utilizing multiple quantum feature maps like entangled SU2 and ZZ circuits to represent classical data in a higher-dimensional Hilbert space.

Result: The approach demonstrates enhanced clustering stability and accuracy, achieving 88.6% accuracy on the Iris dataset and 91.0% on the breast cancer dataset, outperforming classical k-means.

Conclusion: The findings indicate that quantum kernels can significantly improve the similarity metric used in clustering, suggesting a viable method for advancing unsupervised learning in quantum computing environments.
...
### [67] [Quantum Thermal Field Effect Transistor](https://arxiv.org/abs/2604.07893)
*Abhijeet Kumar,Soniya Malik,P. Arumugam*

Main category: quant-ph

TL;DR: The paper introduces a quantum thermal field-effect transistor (qtFET) that consists of qubit and qutrit subsystems, demonstrating its potential to modulate thermal currents similarly to conventional transistors.


<details>
  <summary>Details</summary>
Motivation: To explore quantum thermal devices and their functionalities in emerging quantum technologies.

Method: The qtFET is structured with left and right qubits and a middle qutrit, each independently interacting with thermal baths, allowing for modulation of thermal currents.

Result: The qtFET exhibits functionality comparable to eFETs, with precise thermal current modulation.

Conclusion: The qtFET can serve as a fundamental component in quantum thermal devices and amplifiers.
...
### [68] [Non-variational supervised quantum kernel methods: a review](https://arxiv.org/abs/2604.07896)
*John Tanner,Chon-Fai Kam,Jingbo Wang*

Main category: quant-ph

TL;DR: This review analyzes non-variational quantum kernel methods (QKMs) in supervised quantum machine learning, examining their foundations, estimation methods, and quantum advantages over classical models.


<details>
  <summary>Details</summary>
Motivation: To clarify the regimes where non-variational QKMs can provide advantages in quantum machine learning and identify the challenges impeding practical implementation.

Method: The review covers classical kernel theory foundations, constructions of quantum kernels, estimation methods, and quantum advantage assessments, including comparison with classical models.

Result: Identifies key challenges such as exponential concentration and spectral properties, and discusses structured problems that may allow quantum advantages.

Conclusion: QKMs may provide genuine advantages in specific contexts, but significant methodological and technical challenges remain to be addressed for practical applications.
...
### [69] [A Review of Variational Quantum Algorithms: Insights into Fault-Tolerant Quantum Computing](https://arxiv.org/abs/2604.07909)
...
TL;DR: The paper reviews the evolution of variational quantum algorithms (VQAs) in the context of transitioning from Noisy Intermediate-Scale Quantum (NISQ) systems to fault-tolerant regimes, analyzing algorithmic frameworks, training bottlenecks, and applications across multiple domains.


<details>
  <summary>Details</summary>
Motivation: To reassess the principles and future viability of VQAs as quantum technologies transition to fault-tolerant regimes.

Method: The paper examines ansatz design, classical optimization strategies, training bottlenecks like barren plateaus, and evaluates integration strategies for error mitigation and correction in VQAs.

Result: The review highlights the evolution and challenges of VQAs, especially addressing training bottlenecks and defense strategies while synthesizing their applications in various fields.

Conclusion: A theoretical roadmap is proposed for adapting VQAs to future hardware, ensuring their efficiency and relevance in error-corrected quantum computing environments.
...
### [70] [Informational Mpemba Effect for Fast State Purification in Non-Hermitian System](https://arxiv.org/abs/2604.07926)
*C. G. Feyisa,Huan-YuKu,J. -S. You,H. H. Jen*

Main category: quant-ph

TL;DR: The paper demonstrates rapid state purification in noisy quantum systems through collective reservoir engineering and entanglement, highlighting an informational Mpemba effect and new advantages of non-Hermitian systems.


<details>
  <summary>Details</summary>
Motivation: Quantum systems are sensitive to decoherence, hindering their practical use in quantum technologies; state purification can help restore system purity under these conditions.

Method: The authors utilize collective reservoir engineering in non-Hermitian qubit systems to achieve rapid purification of mixed states and generate multipartite entanglement in larger systems.

Result: They find that efficient purification-assisted entanglement generation is influenced by the degeneracy of collective subradiant modes, and observe an informational Mpemba effect where more mixed states achieve high purity faster.

Conclusion: This work reveals significant advantages of non-Hermitian quantum systems with engineered dissipation, paving the way for improved quantum engineering applications.
...
### [71] [Investigation of Automated Design of Quantum Circuits for Imaginary Time Evolution Methods Using Deep Reinforcement Learning](https://arxiv.org/abs/2604.07951)
*Ryo Suzuki,Shohei Watabe*

Main category: quant-ph

TL;DR: An automated framework for Variational Imaginary Time Evolution (VITE) circuit design using Double Deep-Q Networks (DDQN) significantly reduces circuit complexity and gate counts on Noisy Intermediate-Scale Quantum (NISQ) devices.


<details>
  <summary>Details</summary>
Motivation: Improving the efficiency of ground state searches in combinatorial optimization and quantum chemistry, particularly on NISQ devices with limited resources.

Method: An automated approach to circuit construction as a multi-objective optimization problem, minimizing energy expectation values and circuit complexity through DDQN.

Result: An agent autonomously designed circuits with 37% fewer gates and 43% less depth for Max-Cut problems and achieved Full-CI limit for molecular hydrogen with a shallower circuit.

Conclusion: Deep reinforcement learning effectively discovers optimal circuit structures, aiding in the design of efficient quantum algorithms for hardware limitations.
...
### [72] [Quantum Property Testing for Bounded-Degree Directed Graphs](https://arxiv.org/abs/2604.07954)
*Pan Peng,Jingyu Wu*

Main category: quant-ph

TL;DR: This paper addresses quantum property testing in directed graphs, demonstrating a significant query reduction in a quantum setting compared to classical methods.


<details>
  <summary>Details</summary>
Motivation: The research aims to explore the advantages of quantum algorithms over classical ones in the context of property testing for directed graphs, focusing on query efficiency in different graph models.

Method: The authors analyze the ability to test graph properties within a quantum unidirectional model using fewer queries compared to the classical bidirectional model. They provide both upper and lower bounds on the number of queries needed for various scenarios.

Result: They achieve a quantum speedup, using $n^{1/2 - Ω_{	ext{ε,d}}(1)}$ queries in the unidirectional model, and show the almost tightness of their transformation by presenting a property that requires significantly more quantum queries.

Conclusion: The findings indicate that quantum computing can significantly enhance the efficiency of property testing in directed graphs, particularly in unidirectional models, thereby offering a notable advance over classical algorithms.
...
### [73] [Simultaneous ground-state cooling of six mechanical modes of two levitated nanoparticles](https://arxiv.org/abs/2604.07971)
*Qian Zhang,Yi Xu,Jie-Qiao Liao*

Main category: quant-ph

TL;DR: The paper presents a method for achieving ground-state cooling of two levitated nanoparticles using a coupled cavity system, enabling control over multiple mechanical modes through polarization tuning.


<details>
  <summary>Details</summary>
Motivation: The need for ground-state cooling to explore quantum effects in massive mechanical systems.

Method: A polarization-angle-controllable coupled cavity setup is utilized to achieve simultaneous cooling of six mechanical modes of two nanoparticles through a derived Hamiltonian that identifies coupling and cooling mechanisms.

Result: Simultaneous ground-state cooling of multiple motional modes was achieved using controlled coupling channels based on polarization angle adjustments.

Conclusion: This work advances the manipulation of collective macroscopic quantum effects in levitated nanoparticle systems.
...
### [74] [Belief Propagation Convergence Prediction for Bivariate Bicycle Quantum Error Correction Codes](https://arxiv.org/abs/2604.07995)
*Anton Pakhunov*

Main category: quant-ph

TL;DR: The paper shows that the convergence of Belief Propagation in Bivariate Bicycle quantum error correction can be predicted using a single modulo operation based on syndrome defect counts, demonstrating high accuracy in distinguishing converging from non-converging syndromes.


<details>
  <summary>Details</summary>
Motivation: To enhance the efficiency and reliability of decoding BB quantum error correction codes by predicting the convergence of Belief Propagation without executing it to completion.

Method: Analyzed the relationship between the syndrome defect count and the code's column weight using a modulo operation; validated predictions on five BB codes with AUC metrics.

Result: Predicted BP convergence with high accuracy (AUC = 0.995) depending on syndrome defect count divisibility by column weight; confirmed structural reasons for BP failures.

Conclusion: This predictive method is robust across different BP strategies and applicable to emerging quantum codes, potentially aiding future quantum error correction implementations.
...
### [75] [Harnessing dark states: coherent control in coupled cavity-Rydberg-atom systems](https://arxiv.org/abs/2604.08023)
*Ying-Zhi Li,Xuan Zhao,Le-Man Kuang,Jie-Qiao Liao*

Main category: quant-ph

TL;DR: The study investigates the dark-state effect in a coupled cavity-Rydberg-atom system, emphasizing its significance in quantum physics and applications, revealing dark states for various atom configurations, and suggesting experimental ways to characterize them.


<details>
  <summary>Details</summary>
Motivation: The dark-state effect is crucial in fundamental atomic physics and has promising applications in quantum information science.

Method: Utilizing the arrowhead-matrix method, the research examines the dark-state effect in a system of $N$ Rydberg atoms with dipole-dipole interactions coupled to a single-mode cavity field.

Result: The study identifies and characterizes dark states in multi-atom scenarios and explores the effect in realistic conditions, considering variable interaction strengths based on atomic positions.

Conclusion: The results advance the understanding of dark-state physics and highlight potential applications in the cavity-Rydberg-atom framework.
...
### [76] [Fixing semi-classical physics from first principles: how to derive effective classical-quantum dynamics from open quantum theory](https://arxiv.org/abs/2604.08024)
*Isaac Layton*

Main category: quant-ph

TL;DR: The paper critiques the standard mean-field semi-classical approach, highlighting its limitations and proposing the inclusion of environmental decoherence for improved modeling of quantum dynamics.


<details>
  <summary>Details</summary>
Motivation: To address the inadequacies of standard semi-classical approaches in accurately representing quantum dynamics.

Method: Utilizes a toy model to illustrate the shortcomings of standard mean-field approaches and proposes incorporating environmental decoherence.

Result: Demonstrates that including decoherence leads to more accurate semi-classical models that reflect the full quantum dynamics.

Conclusion: Consistent classical-quantum dynamics models can emerge as effective representations of open quantum systems.
...
### [77] [Local Marking of Locally Implementable Unitary Operations](https://arxiv.org/abs/2604.08054)
*Adil Imam,Satyaki Manna*

Main category: quant-ph

TL;DR: The paper explores local marking of independently chosen multipartite quantum unitary operations, showing that local marking doesn't guarantee local or global distinguishability and presents examples demonstrating nonlocality without entanglement.


<details>
  <summary>Details</summary>
Motivation: To analyze the complexity of locally marking quantum unitary operations and understand the relationship between marking and distinguishability in quantum systems.

Method: The authors examine locally implementable unitary operations through local operations and classical communication (LOCC) and construct specific examples of multipartite quantum unitary channels to illustrate their points.

Result: They find that a set of globally distinguishable tripartite product unitaries cannot be locally marked, and that local marking does not imply the capability to mark larger subsets of unitaries.

Conclusion: The study reveals the nuanced distinctions between marking and discrimination in quantum operations, emphasizing the role of nonlocality without entanglement and the complexity of local marking tasks.
...
### [78] [Orthogonalised Self-Guided Quantum Tomography: Insights from Single-Pixel Imaging](https://arxiv.org/abs/2604.08057)
...
TL;DR: Introduces self-guided imaging (SGI), equating it to single-pixel imaging (SPI), enhancing efficiency and accuracy in measurements without extra overhead.


<details>
  <summary>Details</summary>
Motivation: To improve imaging techniques and foster faster and more accurate convergence in measurements.

Method: Introduced orthogonalised SGQT, inspired by orthogonalised ghost imaging, demonstrating it through numerical and experimental results.

Result: Numerical fidelity improved from 95.2% to 99.17%; experimental fidelity improved from 92.1% to 95.3%.

Conclusion: Suggests that integrating routines from SPI and SGQT can further enhance measurement optimisation and convergence speed.
...
### [79] [Divide et impera: hybrid multinomial classifiers from quantum binary models](https://arxiv.org/abs/2604.08094)
*Simone Roncallo,Angela Rosy Morgillo,Seth Lloyd,Chiara Macchiavello,Lorenzo Maccone*

Main category: quant-ph

TL;DR: This paper proposes a method to combine quantum binary models into a multinomial classifier using various strategies and benchmarks their performance.


<details>
  <summary>Details</summary>
Motivation: To explore efficient ways of aggregating quantum binary models into a single classifier while assessing computational efficiency and quantum advantage.

Method: The authors use a hybrid approach, implementing one-vs-one, one-vs-rest, and a binary decision tree strategies for model combination and benchmark their computational overhead.

Result: The decision tree method offers a cost-effective solution with comparable accuracies to other methods and logarithmic overhead in relation to the number of classes.

Conclusion: Combining quantum binary models using decision trees presents a promising approach to achieve optimal accuracy with manageable computational costs.
...
### [80] [Photon pairs, squeezed light and the quantum wave mixing effect in a cascaded qubit system](https://arxiv.org/abs/2604.08139)
*R. D. Ivanovskikh,W. V. Pogosov,A. A. Elistratov,S. V. Remizov,A. Yu. Dmitriev,T. R. Sabirov,A. V. Vasenin,S. A. Gunin,O. V. Astafiev*

Main category: quant-ph

TL;DR: This paper presents a theoretical framework for quantum wave mixing in a two-qubit cascaded system, highlighting the role of source fluorescence and providing insights into photon statistics.


<details>
  <summary>Details</summary>
Motivation: To better understand the dynamics of quantum wave mixing in systems of superconducting qubits, particularly in the context of correlated photon pair emissions.

Method: Develops a master-equation framework to analyze the influence of resonance fluorescence from a driven source qubit on a probe qubit in the context of quantum wave mixing.

Result: Demonstrates an effective equivalence between the probe's dynamics under certain conditions and the behavior of qubits driven by coherent light, leading to a selection rule for the QWM spectrum peaks.

Conclusion: The study suggests that peak amplitudes in the QWM spectrum can serve as a tool for investigating the photon statistics of nonclassical light fields.
...
### [81] [Charging Quantum Batteries via Dissipative Quenches](https://arxiv.org/abs/2604.08151)
*Riccardo Grazi,Donato Farina,Niccolò Traverso Ziani,Dario Ferraro*

Main category: quant-ph

TL;DR: This study analyzes work extraction in open quantum batteries using interacting spin chains and how dissipation and dephasing affect ergotropy under various environments.


<details>
  <summary>Details</summary>
Motivation: To understand how environmental factors impact work extractability in quantum systems, particularly in the context of open quantum batteries.

Method: The paper investigates two- and four-qubit XX models in thermal Gibbs states, examining dissipation and dephasing effects on work extraction through the characterization of noise channels.

Result: The study finds that purely dissipative dynamics can generate usable ergotropy from passive states, leading to transient regimes influenced by initial temperatures, while collective dissipation results in a dependency between initial temperature, system size, and passive steady states.

Conclusion: Dephasing channels hinder both transient and steady-state work extraction, underscoring the distinct roles of dissipative versus dephasing environments.
...
### [82] [Evaluating the performance of a weak-field homodyne receiver in quadrature phase-shift keying optical communication](https://arxiv.org/abs/2604.08241)
*Silvia Cassina,Alex Pozzoli,Michele N. Notarnicola,Marco Lamperti,Stefano Olivares,Alessia Allevi*

Main category: quant-ph

TL;DR: This paper explores a new weak-field receiver for quantum communication that utilizes wave-particle features, enhancing quaternary communication using coherent states and phase control.


<details>
  <summary>Details</summary>
Motivation: The motivation is to improve the efficiency of quantum communication protocols by developing a more effective detection scheme.

Method: The authors propose a weak-field receiver and investigate its performance in quaternary communication, focusing on coherent states with controlled phase values and implementing a feedback system to manage phase noise.

Result: The results demonstrate enhanced mutual information and secret key generation rates, validating the potential of this receiver and suggesting the feasibility of expanding to continuous phase modulation.

Conclusion: The findings encourage further exploration into increasing the communication alphabet for more efficient quantum communication.
...
### [83] [Optimized Gottesman-Kitaev-Preskill Error Correction via Tunable Preprocessing](https://arxiv.org/abs/2604.08247)
*Xiang-Jiang Chen,Hao-Miao Jiang,Liu-Jun Wang,Qing Chen*

Main category: quant-ph

TL;DR: The paper proposes a new preprocessing-based Steane-type scheme (P-Steane) for the Gottesman-Kitaev-Preskill (GKP) code to enhance error correction in quantum computing by reshaping noise propagation through tunable parameters.


<details>
  <summary>Details</summary>
Motivation: To address limitations in the existing Steane-type error-correction protocols for the GKP code due to their intrinsic noise propagation patterns.

Method: The P-Steane scheme introduces a preprocessing stage with tunable squeezing parameters $a$ and $b$, allowing the reshaping of noise propagation and creating a parameter framework that encompasses various existing protocols.

Result: P-Steane reproduces the performance of established schemes and, important for small-noise conditions, it minimizes output noise variance when $2a = b$, while outperforming the ME-Steane scheme in specific parameter ranges.

Conclusion: The P-Steane scheme presents a versatile and effective enhancement to error correction in GKP code, particularly in regimes where noise levels vary between data and ancilla qubits.
...
### [84] [QARIMA: A Quantum Approach To Classical Time Series Analysis](https://arxiv.org/abs/2604.08277)
*Nishikanta Mohanty,Bikash K. Behera,Badshah Mukherjee,Pravat Dash*

Main category: quant-ph

TL;DR: This paper introduces a quantum-inspired methodology for ARIMA that leverages quantum techniques for lag discovery and parameter estimation while maintaining fixed configurations to streamline the process and enhance forecasting accuracy, as validated through various performance metrics.


<details>
  <summary>Details</summary>
Motivation: To address meta-optimization challenges in ARIMA modeling while leveraging quantum techniques to improve lag discovery and parameter estimation.

Method: Quantum-assisted lag discovery via QACF and QPACF, using a fixed variational quantum circuit (VQC) for estimation and weak-lag refinement on ARIMA parameters.

Result: The proposed methodology demonstrated reduced meta-optimization overhead and improved accuracy in forecasting compared to classical ARIMA methods, validated through various performance metrics and tests.

Conclusion: The integration of quantum techniques in ARIMA enhances the modeling process, clearly delineating their impact on order discovery, lag refinement, and parameter estimation.
...
### [85] [Kirkwood-Dirac distributions in classical optics](https://arxiv.org/abs/2604.08325)
*Alfredo Luis,Lorena Ballesteros Ferraz*

Main category: quant-ph

TL;DR: The paper analyzes Kirkwood-Dirac distributions in classical optics, linking them to optical coherence and offers methods for their experimental determination.


<details>
  <summary>Details</summary>
Motivation: To uncover the relationship between Kirkwood-Dirac distributions and optical coherence in classical optics.

Method: A comprehensive analysis of generalized mutual coherence functions involving two bases is conducted, along with proposed experimental methods for determining these distributions via interference.

Result: The study identifies complex and negative values of the distributions as manifestations of coherence, applicable to various optical phenomena.

Conclusion: The findings provide a unified understanding of optical coherence and propose experimental methods supporting the theoretical interpretations.
...
### [86] [Thermal Time and Irreversibility from Non-Commuting Observables in Accelerated Quantum Systems](https://arxiv.org/abs/2604.08349)
*Marcello Rotondo*

Main category: quant-ph

TL;DR: The paper investigates how temporal ordering in relativistic quantum field theory becomes meaningful through localized detector models, emphasizing the role of the KMS condition and non-commuting observables in distinguishability.


<details>
  <summary>Details</summary>
Motivation: To understand when sequences of operations in relativistic quantum field theory can be distinguished based on temporal ordering.

Method: Analyzes uniformly accelerated two-level detectors interacting with a quantum field in the Minkowski vacuum, specifically examining the effects of the KMS condition on the distinguishability of states through quantum relative entropy.

Result: Demonstrates that the detector state is influenced by the ordering of interactions, and provides a closed-form expression for distinguishability based on temperature and detector energy scale using a minimal model with non-commuting Gibbs states.

Conclusion: Temporal ordering becomes operationally meaningful under specific conditions, with distinguishability linked to the KMS condition and non-commuting observables.
...
### [87] [Scalable Neural Decoders for Practical Fault-Tolerant Quantum Computation](https://arxiv.org/abs/2604.08358)
*Andi Gu,J. Pablo Bonilla Ataides,Mikhail D. Lukin,Susanne F. Yelin*

Main category: quant-ph

TL;DR: This paper introduces a convolutional neural network decoder for quantum error correction, demonstrating significant improvements in error rates and throughput for scalable quantum computing.


<details>
  <summary>Details</summary>
Motivation: The need for fast and accurate decoders in quantum computing to realize effective fault tolerance with quantum low-density parity-check codes.

Method: A convolutional neural network decoder is developed that leverages the geometric structure of quantum error correction codes.

Result: The decoder achieves logical error rates up to 17 times lower than existing methods, with enhanced throughput and effective confidence estimates, facilitating real-time use in quantum hardware.

Conclusion: The findings indicate that the space-time costs for fault-tolerant quantum computation could be much lower than previously thought.
...
### [88] [Per-Shot Evaluation of QAOA on Max-Cut: A Black-Box Implementation Comparison with Goemans-Williamson](https://arxiv.org/abs/2604.08367)
*Evgenii Dolzhkov,Franz G. Fuchs,Dirk Oliver Theis*

Main category: quant-ph

TL;DR: This paper evaluates the Quantum Approximate Optimization Algorithm (QAOA) for the Max-Cut problem using a black-box approach and compares it to the classical Goemans-Williamson algorithm, focusing on practical applicability under default settings.


<details>
  <summary>Details</summary>
Motivation: To assess the real-world effectiveness of QAOA on near-term quantum hardware without prior parameter tuning, which is necessary for users lacking optimization expertise.

Method: Empirical evaluation of QAOA as a black-box optimizer for Max-Cut, employing default parameter settings and utilizing benchmark instances generated from established graph models, paired with a per-shot statistical analysis to compare performance with the classical GW algorithm.

Result: QAOA was evaluated directly against the GW algorithm, with findings showing when QAOA can surpass classical benchmarks, though limitations of QAOA were also identified.

Conclusion: The study illustrates the strengths and weaknesses of QAOA for the Max-Cut problem, providing a framework for evaluating future QAOA implementations.
...
### [89] [Sufficiency and Petz recovery for positive maps](https://arxiv.org/abs/2604.08380)
*Lauritz van Luijk,Henrik Wilming*

Main category: quant-ph

TL;DR: This paper examines the conversion of quantum state families via positive trace-preserving maps, highlighting the role of minimal sufficient Jordan algebras and generalizing previous work on the Koashi-Imoto decomposition.


<details>
  <summary>Details</summary>
Motivation: The goal is to understand the mathematical framework governing the interconversion of quantum states, which has implications for quantum information theory and statistical experiments.

Method: The paper employs positive, trace-preserving maps and explores the structure of minimal sufficient Jordan algebras, deriving results from Neyman-Pearson tests and reviewing relevant mathematical foundations.

Result: It shows that equality in data-processing inequalities and the interconversion of dichotomies via PTP maps are closely tied to underlying algebraic structures, specifically minimal sufficient Jordan algebras and their corresponding *-algebras.

Conclusion: The findings extend the current understanding of quantum state interconversion, paving the way for new applications in quantum information theory and enhancing existing mathematical tools like Frenkel's formula in the context of von Neumann algebras.
...
### [90] [Rapid mixing for high-temperature Gibbs states with arbitrary external fields](https://arxiv.org/abs/2604.08408)
*Ainesh Bakshi,Xinyu Tan*

Main category: quant-ph

TL;DR: The paper explores how external fields impact the entanglement and complexity of high-temperature Gibbs states, revealing that they can induce entanglement in separable states and pose challenges for classical sampling.


<details>
  <summary>Details</summary>
Motivation: Understanding the interplay between external fields and entanglement in thermal quantum systems is crucial for advancements in quantum computing and thermodynamics.

Method: A quasi-local Lindbladian is introduced that achieves rapid mixing to the Gibbs state, and complexity results are proven regarding classical sampling under conditions with significant external fields.

Result: External fields can create entanglement in Gibbs states that normally don’t exhibit it; faster mixing is achieved to Gibbs states even with diverse external fields, and certain conditions lead to sampling difficulties in classical settings.

Conclusion: The findings suggest that high-temperature Gibbs states under external fields are optimal models for exploring entanglement and complexity in quantum systems, highlighting their potential for providing quantum computational advantages.
...
### [91] [Multivariate quantum reservoir computing with discrete and continuous variable systems](https://arxiv.org/abs/2604.08427)
*Tobias Fellner,Jonas Merklinger,Christian Holm*

Main category: quant-ph

TL;DR: The paper presents a framework for multivariate data processing in quantum reservoir computing, introducing three encoding schemes and a new metric for evaluating reservoir performance, with findings suggesting that optimal encoding varies with the reservoir type and task specifics.


<details>
  <summary>Details</summary>
Motivation: To address the gap in quantum reservoir computing's application to multivariate temporal data, as prior work focused primarily on univariate time series.

Method: The study proposes three encoding schemes for multivariate data and introduces a 'mixing capacity' metric for evaluation. It assesses performance on the Lorenz-63 prediction task with two types of quantum reservoirs.

Result: The results show that the best encoding scheme varies based on the reservoir system and task. Peak performance is associated with non-classical effects, emphasizing quantum advantages in multivariate data processing.

Conclusion: The study highlights the need for task-specific input design in quantum reservoir computing, demonstrating that optimal performance is linked to both the type of encoding and the quantum nature of the reservoirs.
...
### [92] [Time evolution of impurity models and their universality for quantum computation](https://arxiv.org/abs/2604.08466)
*N. C. Mai Pham,Raul A. Santos*

Main category: quant-ph

TL;DR: Time-independent impurity Hamiltonians can perform universal quantum computation under specific conditions, scaling with computation depth.


<details>
  <summary>Details</summary>
Motivation: To determine if time-independent impurity Hamiltonians can achieve universal quantum computation similar to their time-dependent counterparts.

Method: The proof involves analyzing the time evolution of generic time-independent impurity Hamiltonians on $O(N)$ qubits when the input state is a product state of fermions.

Result: It is shown that these Hamiltonians are universal for computation on $N$ qubits, scaling the impurity size as $O(S\log S)$ where $S$ is the computation depth.

Conclusion: Time-independent impurity Hamiltonians can perform universal quantum computation, expanding the understanding of fermionic systems in quantum computing.
...
### [93] [Accelerating Quantum Tensor Network Simulations with Unified Path Variations and Non-Degenerate Batched Sampling](https://arxiv.org/abs/2604.08467)
*Taylor Lee Patti,Paavai Pari,Yang Gao,Azzam Haidar,Thien Nguyen,Tom Lubowe,Daniel Lowell,Brucek Khailany*

Main category: quant-ph

TL;DR: This paper enhances the efficiency of quantum trajectory methods, achieving significant speedups in tensor network data collection for noisy quantum simulations.


<details>
  <summary>Details</summary>
Motivation: To reduce the computational burden of simulating noisy quantum systems by improving data collection processes in tensor network implementations.

Method: Developing error-independent unified path variation, non-degenerate tensor network sampling, and a flexible contraction framework to enhance the PTSBE approach.

Result: Achieved a data collection rate over 10^8 times faster for tensor networks, compared to traditional methods, and demonstrated over a 1000 times speedup for general quantum simulations.

Conclusion: The proposed enhancements significantly improve the speed and efficiency of tensor network methods in quantum simulations.
...
### [94] [Measurement-induced state transitions across the fluxonium qubit landscape](https://arxiv.org/abs/2604.08515)
*Alex A. Chapple,Boris M. Varbanov,Alexander McDonald,Alexandre Blais*

Main category: quant-ph

TL;DR: The paper examines measurement-induced state transitions in fluxonium qubits, finding lighter fluxoniums less prone to these transitions due to structural and resonance factors.


<details>
  <summary>Details</summary>
Motivation: To optimize circuit quantum electrodynamics by understanding factors that limit high-fidelity readout, specifically measurement-induced state transitions in fluxonium qubits.

Method: The study involves a theoretical analysis of measurement-induced state transitions across various parameters in fluxonium qubits, complemented by time-dependent readout simulations.

Result: It was discovered that lighter fluxonium qubits demonstrate reduced susceptibility to state transitions compared to heavier ones, attributed to lower multi-photon resonance density and a more harmonic charge operator structure.

Conclusion: The findings enhance understanding of fluxonium qubits' behavior during readout and suggest the influence of superinductor array modes on measurement-induced transitions.
...
### [95] [PowerSpectR: An R Package for Radial Power Spectrum Estimation](https://arxiv.org/abs/2604.07374)
*Rafael S. de Souza*

Main category: astro-ph.IM

TL;DR: PowerSpectR is an R package for computing median-based radial Fourier power spectra from imaging data, enhancing analysis of spatial structures in images.


<details>
  <summary>Details</summary>
Motivation: Analyzing spatial structures and morphological complexity in imaging data is important, and standard methods can be influenced by artifacts and bright sources.

Method: PowerSpectR employs a workflow that integrates Hann windowing for edge-effect mitigation, Fourier-domain analysis, and radial binning with median statistics for robust slope estimation.

Result: The package effectively provides low-dimensional summaries of morphological complexity, reducing bias from localized features in imaging data.

Conclusion: PowerSpectR offers a robust tool for researchers to analyze spatial structures in imaging data, ensuring reduced sensitivity to biases and artifacts.
...
### [96] [ASTRAFier: A Novel and Scalable Transformer-based Stellar Variability Classifier](https://arxiv.org/abs/2604.07437)
*Paul F. X. Gregory,Jeroen Audenaert,Mykyta Kliapets,Daniel Muthukrishna,Andrew Tkachenko,Marek Skarka,George R. Ricker*

Main category: astro-ph.IM

TL;DR: ASTRAFier is a Transformer-based model for classifying stellar variability in light curves from Kepler and TESS missions, achieving high accuracy without feature engineering.


<details>
  <summary>Details</summary>
Motivation: To leverage machine learning for efficient classification of stellar variability in millions of available light curves from photometric missions.

Method: ASTRAFier utilizes a combination of Bidirectional Long Short-Term Memory (BiLSTM) and Convolutional Neural Networks (CNNs) in a Transformer framework, processing time series data directly.

Result: Achieved a classification accuracy of 94.26% on Kepler light curves and 88.22% on TESS light curves, with scalability demonstrated through deployment on approximately 2.8 million TESS light curves.

Conclusion: The ASTRAFier model offers an efficient and easy-to-maintain solution for classifying stellar variability, contributing to a new catalog of variability using large datasets.
...
### [97] [First Lunar Farside SETI Observations for Periodic Signals with the Low-frequency Radio Spectrometer of Chang'E-4 Mission](https://arxiv.org/abs/2604.07920)
*Jian-Kang Li,Zhen-Zhao Tao,Bo-Lun Huang,Kang-Jiao,Tong-Jie Zhang,Ming-Yuan Wang,Jin-Song Ping*

Main category: astro-ph.IM

TL;DR: The CE4 mission seeks periodic technosignatures via lunar farside radio observations; no credible signals detected, but a framework for lunar SETI is established.


<details>
  <summary>Details</summary>
Motivation: To utilize the shielded environment of the lunar farside for radio observations in the search for extraterrestrial intelligence (SETI).

Method: Dynamic spectra analysis utilizing PCA, cross-antenna alignment, and diagnostics for periodicity and frequency comb structures.

Result: No credible periodic artificial signals are found in the CE4 data analyzed.

Conclusion: The study establishes a framework for future lunar radio SETI analyses, indicating the lunar farside's potential for such research.
...
### [98] [Scalable continuous gravitational wave detection in PTA data with non-parametric red noise suppression and optimal pulsar selection](https://arxiv.org/abs/2604.07942)
*Yi-Qian Qian,Yan Wang,Soumya D. Mohanty,Siyuan Chen*

Main category: astro-ph.IM

TL;DR: This paper presents a computationally efficient frequentist method for detecting continuous gravitational waves in Pulsar Timing Array data, outperforming traditional Bayesian methods in speed and scalability.


<details>
  <summary>Details</summary>
Motivation: The computational costs of Bayesian methods for detecting continuous gravitational waves increase significantly with the size of the Pulsar Timing Array, limiting scalability for future large-scale PTAs.

Method: An adaptive spline fitting algorithm is used to non-parametrically suppress red noise, eliminating the need for complex noise modeling, alongside a novel optimization scheme for selecting pulsar subsets in the search.

Result: The proposed method, on simulated NANOGrav data, yields relative strain and frequency errors of 1.0% and 0.072%, respectively, compared to 1.7% and 0.16% for Bayesian analysis, all while reducing computation time to under 5 hours.

Conclusion: The new method is shown to be an efficient and scalable tool capable of rigorously searching for continuous gravitational waves with large-scale Pulsar Timing Arrays.
...
### [99] [A Statistical-AI Framework for Detecting Transient Flares in SDSS Stripe 82 Quasar Light Curves](https://arxiv.org/abs/2604.08196)
*Atal Agrawal*

Main category: astro-ph.IM

TL;DR: The paper introduces FLARE, a framework for detecting quasar flares in the SDSS Stripe 82 dataset, achieving successful identification of 27 flaring quasars.


<details>
  <summary>Details</summary>
Motivation: Understanding quasar flares provides insights into the dynamics of accretion discs and supermassive black holes, with existing surveys lacking systematic flare detection.

Method: FLARE employs a three-stage process: DRW modeling for normal behavior, anomaly scoring to identify potential flares, and a recognition engine for final candidate verification, utilizing GRUs and EVT.

Result: 27 quasars showing distinct flaring activity were identified from the SDSS Stripe 82 dataset using the FLARE framework.

Conclusion: The FLARE framework effectively identifies quasar flares, contributing to the study of supermassive black hole behavior and accretion dynamics.
