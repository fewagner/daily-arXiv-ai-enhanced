...
TL;DR: This paper presents a novel method to reduce radon background radiation in rare-event searches by using electroplating of copper.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of background radiation from radon, which complicates rare-event searches in fundamental physics, especially concerning dark matter and neutrino properties.

Method: Developed an electroplating technique for copper that significantly lowers radon emanation from stainless steel samples implanted with radium-226.

Result: Achieved a reduction in the radon emanation rate by a factor of one thousand from the treated samples.

Conclusion: This technique effectively mitigates a major source of background noise in rare-event searches, enhancing the potential for detecting rare phenomena.
...
TL;DR: The paper describes the development and implementation of a wavelength-shifting reflective system to enhance scintillation-light collection in the SBND neutrino detector.


<details>
  <summary>Details</summary>
Motivation: To improve scintillation-light collection uniformity for better neutrino detection and measurements in the SBND liquid argon time projection chamber.

Method: 64 double-sided plates made of FR4 were coated with TPB using physical vapor deposition, then assembled and installed in situ with protective measures against UV exposure.

Result: The system, featuring the largest TPB-coated area in a neutrino detector, displayed high uniformity and effective light response in initial measurements.

Conclusion: These enhancements in light collection are expected to aid in better triggering, calorimetry, and position reconstruction in the SBND detector.
...
TL;DR: The paper discusses the testing of new SuperCDMS High Voltage detectors for low mass dark matter searches, focusing on Ge detectors' performance, calibration methods, and unexpected high energy measurement capabilities.


<details>
  <summary>Details</summary>
Motivation: To prepare for the search for low mass dark matter particles using advanced cryogenic detectors and to assess their performance under low background conditions.

Method: A set of six SuperCDMS HV detectors (four Ge and two Si) were tested in the CUTE facility, focusing on Ge detectors' voltage bias, calibration via electron capture peaks, and performance assessment.

Result: The Ge detectors demonstrated good resolution in high energy measurements (better than 3% at 356 keV) and effective calibration in the keV to sub-keV range.

Conclusion: The SuperCDMS HV detectors show promising capabilities for measuring low and high energy interactions, which is encouraging for upcoming dark matter searches.
...
TL;DR: The study presents a method for creating high-purity vanadium-based nanoparticles for neutron scattering, optimizing their characteristics for investigating short-range interactions.


<details>
  <summary>Details</summary>
Motivation: The research aims to enhance neutron scattering experiments to explore new, gravity-like interactions in the submicron scale.

Method: Vanadium and V-Ni nanoparticles were synthesized through various methods, characterized using multiple analytical techniques, and optimized via RF thermal plasma for reproducibility and contamination minimization.

Result: The study found a minimum average coherent scattering length of 0.719(23) fm, comparable to natural vanadium, and calibrated the oxygen's impact on scattering lengths.

Conclusion: The findings suggest that tailored vanadium-based nanoparticles can effectively reduce nuclear scattering backgrounds, facilitating coherent neutron scattering measurements for short-range interaction investigations.
...
TL;DR: HERETIX is a proposed multi-tonne liquid xenon observatory designed to optimize searches for weakly interacting massive particles and neutrinoless double beta decay using nested time projection chambers and ultra-low-background techniques.


<details>
  <summary>Details</summary>
Motivation: The need for sensitive detection methods for rare events in fundamental physics, particularly in the search for dark matter and neutrinoless double beta decay.

Method: HERETIX employs two nested time projection chambers, a hermetically sealed sapphire vessel containing 90% enriched $^{136}$Xe, and Monte Carlo studies to mitigate material-induced backgrounds.

Result: Projected half-life sensitivity for $0νββ$ is $3.2 	imes 10^{28} 	ext{ years}$ at 90% CL after 10 years, while also maintaining excellent dark matter detection capabilities.

Conclusion: HERETIX represents a revolutionary approach for addressing key questions in fundamental physics concerning dark matter and neutrinos.
...
TL;DR: The paper observes anomalously long-delayed afterpulses in various photomultipliers, noting specific delay times and characteristics of these phenomena.


<details>
  <summary>Details</summary>
Motivation: To investigate the presence and characteristics of long-delayed afterpulses in different photomultiplier tubes used in neutrino detection.

Method: Measurements of afterpulse delay times and probabilities across several types of photomultipliers from Hamamatsu and NNVT.

Result: Observation of afterpulses with mean delays of 85μs to 260μs and very low probabilities (≤0.1%) per photoelectron, consistent across types and independent of operating voltage.

Conclusion: The study confirms the existence of long-delayed afterpulses in photomultipliers, which may have implications for neutrino detection methodology.
...
### [7] [Fast Simultaneous Surveys with On-the-Fly Mapping](https://arxiv.org/abs/2606.26209)
...
TL;DR: MeerKAT's MeerKLASS survey uses advanced OTF imaging to enhance radio galaxy research, aiming for large area coverage with high sensitivity despite challenges like smearing.


<details>
  <summary>Details</summary>
Motivation: To prepare for the SKA Observatory, understanding precursor surveys helps address the scientific and technical challenges of the MeerKLASS survey.

Method: The survey employs On-the-Fly (OTF) imaging to cover 10,000 sq. degrees at a resolution of $14''$ and sensitivity of 25 $μ$Jy/beam, mitigating smearing effects during fast scanning.

Result: Achieved a fast survey speed of approximately 3.5 sq. deg per minute, providing valuable data for ${H_I}$ intensity mapping and continuum images.

Conclusion: Insights gained from MeerKLASS will facilitate advancements in the upcoming SKA-Mid, enhancing resolution and sensitivity while reducing imaging smearing.
...
### [8] [Nautilus Space Observatory: The Evolution of Planets and their Atmospheres](https://arxiv.org/abs/2606.26214)
...
TL;DR: The Nautilus Space Observatory aims to advance our understanding of planetary evolution from formation to maturity by addressing key scientific objectives and utilizing advanced observational capabilities.


<details>
  <summary>Details</summary>
Motivation: Exploration of the evolution of planets from disks to mature systems is in its early stages, and current facilities lack the capability for extensive atmospheric studies over long timescales.

Method: The paper proposes using the Nautilus Space Observatory, a constellation of large-diameter space telescopes, to achieve high spatial resolution and broad-wavelength coverage.

Result: The study aims to determine evolution timescales, track atmospheric mass-loss, characterize mean molecular weight and C/O ratio, and identify Helium-dominated worlds.

Conclusion: The proposed objectives align with NASA's Cosmic Origins and Exoplanet Exploration Programs, enhancing our understanding of planetary formation and evolution.
...
### [9] [A nonrelativistic radiative transfer module for Idefix](https://arxiv.org/abs/2606.26268)
*Nicolas Scepi,Geoffroy Lesur*

Main category: astro-ph.IM

TL;DR: This paper presents an RMHD module for the IDEFIX code that utilizes exascale computing capabilities and performance portability to enhance radiative fluid simulations.


<details>
  <summary>Details</summary>
Motivation: To advance the capabilities of RMHD simulations for better comparisons with observational data, especially in fluid-radiation dynamics, on modern accelerated computing architectures.

Method: A nonrelativistic radiative transfer module was developed for IDEFIX using the Kokkos library, implementing the M1 approximation with a split explicit-implicit scheme, supporting various geometries and opacities.

Result: The radiative transfer module achieves outstanding performance on accelerated architectures, reaching up to 7 x 10^8 cell updates per second with minimal additional computational cost compared to pure RMHD simulations.

Conclusion: The IDEFIX module is a high-performance, robust, and portable tool for RMHD simulations, suited for both current and future exascale supercomputers.
...
### [10] [Low Thrust Electric Propulsion Mission Concepts For a 3-Meter Class Space Telescope](https://arxiv.org/abs/2606.26282)
...
TL;DR: The paper analyzes mission concepts for a space-based 3-meter telescope to optimize conditions for exoplanet discovery, focusing on transfer trajectories and radiation environments.


<details>
  <summary>Details</summary>
Motivation: To enhance the effectiveness of exoplanet discovery and characterization through stable orbital environments for a space-based telescope.

Method: Evaluation of transfer trajectories and radiation environments for a 3-meter telescope mission, particularly examining a 2:1 lunar resonant orbit and a Sun-Earth L2 halo orbit.

Result: Identification of optimal operating orbits that maximize scientific return for detecting exoplanets.

Conclusion: The analysis highlights suitable orbits for ensuring high-quality observations while considering radiation exposure and mission constraints.
...
### [11] [Indigenizing the Drake Equation: how Indigenous methods can help us understand life in the Milky Way Galaxy](https://arxiv.org/abs/2606.26296)
*Hilding R. Neilson*

Main category: astro-ph.IM

TL;DR: The paper reviews the Drake Equation, highlighting traditional biases in its interpretation and proposing Indigenous perspectives that could reshape our understanding of extraterrestrial life.


<details>
  <summary>Details</summary>
Motivation: To explore the assumptions and biases associated with the traditional interpretation of the Drake Equation for extraterrestrial life.

Method: The paper offers a review of the Drake Equation, analyzing traditional scientific biases and contrasting them with Indigenous approaches to understanding life in the galaxy.

Result: It identifies how biases in discussing the Drake Equation have influenced searches for biological and technological signatures.

Conclusion: Indigenous methods could provide a transformative perspective on the ingredients needed for life and advanced civilizations in the galaxy.
...
### [12] [Extending the SKA Across Africa: The Case for a Continental African VLBI Network](https://arxiv.org/abs/2606.26365)
...
TL;DR: The African continent can enhance global Very Long Baseline Interferometry (VLBI) through a proposed African VLBI Network (AVN) that will increase imaging resolution and foster education and innovation.


<details>
  <summary>Details</summary>
Motivation: Africa's strategic placement offers critical baselines missing in the current VLBI network, enhancing scientific capabilities.

Method: Advocating for the deployment of SKA-Mid-type telescopes across Africa to create an integrated continental network.

Result: The AVN will achieve a maximum baseline of ~9000 km, surpassing the next generation Very Large Array's resolution by ~10% and improving global coverage.

Conclusion: The AVN fosters not just scientific growth but also sustainable development in education, local industry, and public engagement in science.
...
### [13] [In situ cryogenic characterization of proton damage in thick p-channel skipper CCDs](https://arxiv.org/abs/2606.26409)
...
TL;DR: Skipper CCDs enable non-destructive charge measurements and single-photon counting in extreme conditions, showing radiation hardness even at cryogenic temperatures after significant damage exposure.


<details>
  <summary>Details</summary>
Motivation: To evaluate the radiation hardness of Skipper CCDs in deep-space conditions, essential for future astronomical applications.

Method: Conducted radiation hardness tests on p-channel Skipper CCDs at cryogenic temperatures, measuring floating-gate output, charge transfer inefficiency, and other performance metrics.

Result: Demonstrated that Skipper CCDs maintain excellent performance after equivalent radiation exposure of ~10 years at Earth/Sun L2, confirming their suitability for space applications.

Conclusion: Skipper CCDs are viable for deep-space missions, remaining radiation-hard and effective in cryogenic environments.
...
### [14] [Detectors for CLASS-W2: The second 90 GHz telescope of the Cosmology Large Angular Scale Surveyor](https://arxiv.org/abs/2606.26576)
...
TL;DR: The CLASS project has introduced a new 90 GHz receiver to enhance CMB mapping speed, utilizing advanced TES bolometers to achieve high sensitivity and efficiency.


<details>
  <summary>Details</summary>
Motivation: To investigate cosmic inflation and reionization by measuring CMB polarization anisotropy at large angular scales.

Method: Commissioned a second 90 GHz receiver (CLASS-W2) with 296 TES bolometers, analyzing performance including noise, optical efficiency, and suppression of unwanted radiation.

Result: Achieved a noise-equivalent temperature of NET= 16 uKrtS and a 41% increase in mapping speed compared to before.

Conclusion: The new receiver significantly improves the CLASS project's capability to study CMB polarization.
...
### [15] [Single object observations: Large telescopes vs. multiple small telescopes](https://arxiv.org/abs/2606.26635)
*Sagi Ben-Ami,Eran Oded Ofek*

Main category: astro-ph.IM

TL;DR: This study analyzes the cost-effectiveness of various telescope architectures for spectroscopy and photometry, focusing on the performance metrics of survey speed per unit cost.


<details>
  <summary>Details</summary>
Motivation: To evaluate the efficiency of different telescope designs in maximizing observing time and minimizing costs for single-object spectroscopy and photometry.

Method: The authors compare single seeing- and diffraction-limited telescopes and arrays, measuring the survey speed per unit cost as the primary performance metric.

Result: Diffraction-limited telescopes become more cost-effective in certain magnitude ranges, with arrays of seeing-limited telescopes being generally more efficient for unresolved observations. Cost-effectiveness varies significantly with target brightness.

Conclusion: Insights can guide future telescope designs, emphasizing the need for cautious interpretation of results based on specific architectural assumptions.
...
### [16] [Interferometric Analysis of Air-shower Radio Emission in the Near Field with an Information Field Theory Approach](https://arxiv.org/abs/2606.26702)
...
TL;DR: The chapter discusses the limitations of current air-shower radio emission reconstruction techniques and presents Information Field Theory (IFT) as an advanced approach for comprehensive parameter reconstruction and near-field interferometry of cosmic ray air showers.


<details>
  <summary>Details</summary>
Motivation: Current techniques for reconstructing air-shower radio emissions face limitations in computational cost and reconstruction accuracy due to simplified approximations and partial signal information.

Method: The chapter introduces Information Field Theory (IFT), a Bayesian inference-based framework, for improving the reconstruction of air showers by extracting comprehensive signal information to infer distributions of field-like quantities.

Result: Novel approaches utilizing IFT are presented, demonstrating their potential to enhance air shower reconstruction and support near-field interferometry, particularly in relation to future radio observatories like SKA-Low.

Conclusion: IFT provides a promising path forward for more accurate and comprehensive reconstruction of cosmic ray air showers, thus advancing the field of radio detection in astrophysics.
...
### [17] [Characterizing robotic positioners under the influence of changing gravity vectors for future spectroscopic surveys](https://arxiv.org/abs/2606.26821)
...
TL;DR: The paper presents an automated test stand for evaluating robotic fiber positioners used in future spectroscopic surveys, focusing on replicating on-telescope conditions to ensure high mechanical performance.


<details>
  <summary>Details</summary>
Motivation: With ambitious goals of mapping billions of galaxies, the performance of robotic fiber positioners must meet stringent mechanical requirements during telescope operations.

Method: An automated telescope simulator test stand was developed to assess position stability, focus stability, and tilt variations by simulating the gravity conditions experienced on a telescope.

Result: The test stand measures position stability within 1 um and focus stability within 5 um, while also compensating for enclosure deformation and assessing image quality affected by turbulence.

Conclusion: This test setup is crucial for integrated testing of advanced focal plane prototypes, ensuring they meet performance standards similar to those expected on telescopes.
...
### [18] [Cascade adaptive optics with a second stage based on a Zernike wavefront sensor for exoplanet observations II. Validation in broadband light on the ESO/GHOST testbed](https://arxiv.org/abs/2606.26895)
...
TL;DR: This study validates a Zernike wavefront sensor (ZWFS)-based control loop for high-contrast imaging in polychromatic light, demonstrating significant contrast gains under various conditions.


<details>
  <summary>Details</summary>
Motivation: To improve image contrast in high-contrast exoplanet observations, especially in the presence of residual errors from extreme adaptive optics (XAO).

Method: Experiments were conducted on the GHOST testbed to evaluate a ZWFS-based control loop in both narrowband and broadband light, simulating residual aberrations from XAO systems.

Result: The ZWFS control loop consistently improved contrast, achieving up to one order of magnitude gain after addressing quasi-static aberrations, with similar performance in narrowband and broadband for bright sources, and slightly better for faint targets in narrowband.

Conclusion: These findings confirm the effectiveness of broadband ZWFS control for high-contrast imaging, highlighting future potential with achromatic masks and better calibration techniques.
...
### [19] [VLBI with SKAMPI, the SKA-Mid MPIfR dish demonstrator](https://arxiv.org/abs/2606.26940)
...
TL;DR: The SKA-MPIfR telescope (SKAMPI) has conducted its first fringe-finding experiments, showing successful integration and imaging in S-Band with international radio astronomical networks.


<details>
  <summary>Details</summary>
Motivation: To test and optimize the SKA-MPIfR telescope's capabilities in international radio astronomical collaborations.

Method: Conducted fringe-finding experiments using the SKAMPI telescope connected with the European VLBI Network and the southern hemisphere Long Baseline Array.

Result: Successful fringe detections were made in S-Band, showcasing SKAMPI's performance and its integration with international telescopes.

Conclusion: The early results confirm SKAMPI's ability to serve in large-scale VLBI observations and collaborations.
...
### [20] [How to access astronomical observation facilities ?](https://arxiv.org/abs/2606.26996)
*Michaël De Becker*

Main category: astro-ph.IM

TL;DR: This paper outlines the framework for telescope time applications and offers guidelines to enhance proposal success rates in astrophysics.


<details>
  <summary>Details</summary>
Motivation: Junior researchers often lack the necessary skills to prepare successful telescope time proposals due to the competitive nature of the selection process.

Method: The paper presents a thorough overview of the application framework and delineates mandated and advisory guidelines for proposal preparation.

Result: The guidelines aim to help proposers navigate the application process, reduce common pitfalls, and improve proposal selection chances.

Conclusion: By equipping researchers with effective strategies, this paper seeks to minimize rejection risks and enhance the proposal preparation experience.
...
### [21] [SMR: Scheduler with Multi-Channel Map-Encoded Reinforcement Learning for Radio Telescopes](https://arxiv.org/abs/2606.27021)
*Zhenyang Huang,Na Wang,Zhiyong Liu,Chuhao Gao*

Main category: astro-ph.IM

TL;DR: SMR (Scheduler with Map-encoded Reinforcement Learning) optimizes observation scheduling for radio telescopes by using a spatially-informed RL approach, achieving significant improvements over traditional methods.


<details>
  <summary>Details</summary>
Motivation: The need to maximize scientific return in observation scheduling under mechanical and environmental constraints, addressing limitations of previous heuristic and RL methods.

Method: SMR encodes target attributes onto an Az–El grid, integrating direction-dependent cues, which enables learning from the sky state directly and helps in making more informed scheduling decisions.

Result: SMR shows about a 10% improvement in time utilization compared to a tuned greedy approach and performs better in key metrics like LIER and HGOR relative to MLP algorithms, while maintaining higher utilization in various observational timeframes.

Conclusion: SMR represents a significant advancement in data-driven scheduling for single-dish telescopes, offering a flexible and effective solution to complex multi-objective optimization challenges.
...
### [22] [The Line Emission Terahertz Observatory (LETO): Exploring the lifecycle of the ISM and the origins of water](https://arxiv.org/abs/2606.27060)
...
TL;DR: The Line Emission Terahertz Observatory (LETO) aims to investigate the Interstellar Medium's (ISM) role in star and planet formation through extensive spectroscopic observations of key FIR lines across the Galactic Plane and nearby galaxies.


<details>
  <summary>Details</summary>
Motivation: To understand the complex interactions within the ISM that influence star and planet formation, essential for studying the evolution of galaxies.

Method: LETO will perform deep, velocity-resolved wide-area spectroscopic observations of key FIR lines, mapping approximately 900 square degrees of the Galactic Plane and about 200 nearby galaxies.

Result: LETO's observations will enable detailed studies of the physical and chemical properties of proto-planetary disks and stellar cores, enhancing our understanding of gas transformation into stars.

Conclusion: LETO is positioned as a significant FIR mission, leveraging advanced technology for high sensitivity and resolution, contributing valuable insights to galactic evolution and star formation processes.
...
### [23] [Frequency Phase Transfer for Future Millimetre Arrays with Arbitrary Frequency Ratios](https://arxiv.org/abs/2606.27143)
*Senkhosi Simelane,Athol Kemball,Roger Deane*

Main category: astro-ph.IM

TL;DR: The paper introduces a new Frequency Phase Transfer algorithm, phase-wrap counting (PWC), which overcomes limitations of existing methods by effectively addressing non-integer frequency ratios in sub-millimetre astronomy, enhancing calibration accuracy for the Event Horizon Telescope.


<details>
  <summary>Details</summary>
Motivation: To improve imaging fidelity and dynamic range in (sub-)millimetre astronomy, particularly due to turbulence-induced phase delays that limit performance in current observations.

Method: The paper presents phase-wrap counting (PWC), a new FPT algorithm capable of working with any frequency ratio, and utilizes the HITOPS software package to apply this method to dual-band observations.

Result: PWC successfully calibrates 230-GHz phases using 86-GHz solutions, showing improved coherence and peak flux recovery compared to conventional techniques.

Conclusion: PWC has significant potential for improving phase calibration in future observations of the Event Horizon Telescope, particularly for new frequency bands being considered.
...
### [24] [Realistic Time-Domain Synthesis of Gravitational-Wave Detector Glitches using Class-Conditional Derivative Generative Adversarial Networks](https://arxiv.org/abs/2606.27227)
*Tom Dooney,Mees de Boer,Harsh Narola,Melissa Lopez,Stefano Bromuri,Daniel Stanley Tan,Chris Van Den Broeck*

Main category: astro-ph.IM

TL;DR: GlitchGAN synthesizes realistic glitches in gravitational-wave data, trained on seven glitch types, enabling effective data analysis and validation for LIGO.


<details>
  <summary>Details</summary>
Motivation: To address challenges posed by short-duration transient noise (glitches) in gravitational-wave detectors during data analysis.

Method: A class-conditional generative model, GlitchGAN, synthesizes glitches directly from their high-quality reconstructions, allowing for hybrid glitch generation and efficient performance on a CPU.

Result: GlitchGAN generates 1000 synthetic glitches swiftly and is validated against real glitches using Gravity Spy, achieving high classification accuracy and substantial overlap in latent space with real samples.

Conclusion: A limitation of current classifiers is their reliance on magnitude spectrograms, which can misclassify unrealistic glitches, highlighting the importance of using methods that encompass phase information for validation.
...
### [25] [The SPOTLIGHT Multibeam Real-Time Transient Detection System](https://arxiv.org/abs/2606.27262)
...
TL;DR: The SPOTLIGHT project uses the upgraded GMRT to develop a GPU-accelerated real-time search pipeline for Fast Radio Bursts (FRBs), achieving high sensitivity and extensive detection capabilities.


<details>
  <summary>Details</summary>
Motivation: The need for advanced instruments to effectively search for and analyze Fast Radio Bursts due to their enigmatic nature and the challenges in detecting them in real-time.

Method: Utilization of a high-performance computing facility with 90 NVIDIA A100 GPUs to create a real-time transient search pipeline, featuring brute-force dedispersion and an optimization framework for candidate bursts.

Result: Detected 2870 bursts from 42 known sources during initial deployment, with sensitivity matching predicted thresholds.

Conclusion: SPOTLIGHT establishes a scalable platform for wide-field transient discovery, laying the groundwork for future radio transient surveys.
...
### [26] [3D Kinematic Reconstruction of the Crab Nebula That Includes the Northern Ejecta `Jet'](https://arxiv.org/abs/2606.26231)
*Ziwei Ding,Dan Milisavljevic,Thomas Martin,Tea Temim,John C. Raymond,Soham Mandal,Laurent Drissen*

Main category: astro-ph.HE

TL;DR: This paper presents 3D kinematic reconstructions of the Crab Nebula using hyperspectral data from the SITELLE instrument, revealing new insights into its morphology and the role of the pulsar wind nebula.


<details>
  <summary>Details</summary>
Motivation: To enhance understanding of the Crab Nebula's kinematics and morphology, especially in relation to its jet structure and formation mechanisms.

Method: Utilized hyperspectral cubes from SITELLE covering a range of emission lines, focusing on the 'chimney' or 'jet' structure, and performed 3D kinematic reconstructions.

Result: Confirmed a cavity at the jet's base, establishing a physical connection between the filamentary network and the jet funnel, and analyzed various formation scenarios for the jet's structure.

Conclusion: Further hydrodynamic simulations are necessary to discriminate among the viable formation scenarios affecting the jet's collimation and characteristics.
...
### [27] [Debiasing the Observed Fast Radio Burst Population with the CHIME/FRB Selection Function](https://arxiv.org/abs/2606.26334)
...
TL;DR: This study uses the CHIME/FRB Catalog~2 to analyze fast radio bursts (FRBs) through an upgraded framework that addresses intrinsic distributions of various observables, focusing on scattering timescales.


<details>
  <summary>Details</summary>
Motivation: To analyze the intrinsic distributions of FRBs, particularly scattering timescales, using the largest available sample from the CHIME/FRB Catalog~2.

Method: The study employs a resampling-based framework to infer intrinsic distributions and develops a logistic regression model to create an explicit selection function for FRB observables, integrating this into a simulation-based inference framework.

Result: The analysis suggests a slight downturn in the intrinsic scattering timescale distribution of FRBs, although flat or slightly rising distributions remain possible, confirmed by comparisons with the CRAFT survey data.

Conclusion: The study enhances understanding of FRB intrinsic properties, particularly scattering timescales, providing insights that could influence future research.
...
### [28] [A Census of Variable and Transient Radio Sources Within High-Energy Neutrino Fields](https://arxiv.org/abs/2606.26395)
*Florian Rösch,Matthias Kadler,Roger P. Deane,Philip G. Edwards,Karl Mannheim,Jack F. Radcliffe*

Main category: astro-ph.HE

TL;DR: This paper investigates the origins of high-energy cosmic neutrinos, suggesting that many emissions may come from unnoticed low-frequency radio sources rather than only known active galactic nuclei.


<details>
  <summary>Details</summary>
Motivation: Understanding the origins of high-energy cosmic neutrinos is crucial for astroparticle physics, as their detection is linked to the acceleration of cosmic particles and high-energy processes.

Method: The study utilizes SKA-Mid continuum observations and wide-field VLBI analysis to detect faint radio sources in regions associated with cosmic neutrino emissions, particularly targeting the IceCube alert IC240929A.

Result: In prior MeerKAT observations, about 550 faint radio sources were identified within the uncertainty region of a neutrino field, with flux densities ranging from 169 μJy to 140 mJy.

Conclusion: The SKA-Mid's superior sensitivity will enable the detection of even fainter sources, potentially leading to a better understanding of the origins of cosmic neutrinos by identifying more candidate radio sources associated with them.
...
### [29] [Nuclear Isomers and Their Impact on Gamma-Ray Emission in Binary Neutron Star Mergers](https://arxiv.org/abs/2606.26447)
*M. C. Babiuc Hamilton,A. P. Gross,O. T. Odney*

Main category: astro-ph.HE

TL;DR: The study enhances models of $γ$-ray emissions from binary neutron star mergers by incorporating nuclear isomers, predicting detectable γ-ray lines in observatories.


<details>
  <summary>Details</summary>
Motivation: To improve the accuracy of $γ$-ray emissions modeling from neutron star mergers by considering nuclear isomers, which are often neglected in current models.

Method: The authors model nuclear isomers as independent states within a nuclear reaction network, using temperature-dependent transition rates and calculated $β$-feeding probabilities for specific nuclei.

Result: The study predicts that the 743.3 keV line of Nb-97m and the 555.6 keV line of Y-91m could be detectable by current and future γ-ray observatories at galactic distances.

Conclusion: Inclusion of nuclear isomers in reaction networks is crucial for accurate γ-ray spectroscopy, emphasizing their role in characterizing observational signals from neutron star mergers.
...
### [30] [Hunting for extreme high-energy-peaked BL Lacs: Rare to find and difficult to classify](https://arxiv.org/abs/2606.26475)
*Loredana Bassani,Raffaella Landi,Nicola Masetti*

Main category: astro-ph.HE

TL;DR: This study investigates a potential new class of BL Lacs known as ultra extreme high-energy-peaked BL Lacs (UEHBLs), which exhibit synchrotron emission peaking in the MeV range. Analyzing 10 hard X-ray sources from Swift/BAT, the authors classify 6 candidates as line-emitting AGNs, ruling out extreme BL Lacs. Among the remaining, only 2 show compatibility with UEHBL characteristics, with one having a possible alternative identification. The findings suggest UEHBLs are rare and challenging to classify, but may provide a new perspective on hard X-ray sources.


<details>
  <summary>Details</summary>
Motivation: To explore the existence of a new class of BL Lacs, identified as UEHBLs, which display unique spectral properties not previously documented.

Method: Analysis of Swift/XRT follow-up observations of 10 hard X-ray sources from the Swift/BAT catalog to determine their classifications and spectral energy distributions.

Result: 6 out of 10 candidates were classified as line-emitting AGNs, excluding the possibility of being extreme BL Lacs, while only 2 of the remaining candidates align with characteristics expected from UEHBLs.

Conclusion: UEHBLs are likely rare and difficult to classify, but they could serve as an alternative classification for hard X-ray sources with minimal counterparts.
...
### [31] [Long-Period Transients as a new frontier in time-domain astronomy](https://arxiv.org/abs/2606.26572)
...
TL;DR: This paper discusses long-period radio transients (LPTs), a new class of astrophysical objects, their characteristics, potential energy sources, and observational challenges, along with the role of upcoming surveys in expanding our understanding of these objects.


<details>
  <summary>Details</summary>
Motivation: To explore a new class of astrophysical objects that fill the observational void between pulsars and slow radio variables, addressing their unique properties and energy mechanisms.

Method: Employing fast imaging surveys with SKAO and precursors for systematic detection and monitoring of LPTs, while analyzing their multiwavelength counterparts for insights into their progenitors and emission mechanisms.

Result: Identification of a diverse progenitor population for LPTs, including ultra-long period magnetars and magnetic white dwarf binaries, along with challenges posed by existing observational limitations.

Conclusion: The investigation of LPTs presents an opportunity to examine coherent radio emissions in various compact-object systems, enhancing our understanding of associated physical processes.
...
### [32] [A Boundary-Consistent Two-Zone Electron Kernel for Distant Pulsar Contributions to Positron Flux and Anisotropy](https://arxiv.org/abs/2606.26597)
*Yiwei Bao,Jie-Shuang Wang,Hao Zhou*

Main category: astro-ph.HE

TL;DR: A novel semi-analytical method for modeling electron and positron diffusion in a two-zone environment shows nearby and distant pulsars significantly contribute to cosmic-ray lepton flux, compatible with existing data, yet halo size remains undetermined without external validation.


<details>
  <summary>Details</summary>
Motivation: To develop a robust model for electron and positron propagation in cosmic rays that addresses inefficiencies of direct integral evaluations and accurately reflects radiative cooling boundaries.

Method: A semi-analytical series solution is employed to solve the diffusion equations, incorporating both slow diffusion near the source and standard diffusion in interstellar space, with cooling effects included.

Result: The model reveals that distant pulsars can collectively account for a significant portion of the local lepton flux, particularly in the energy range of tens to hundreds of GeV, while slow-diffusion halos are consistent with existing data after adjustments for local conditions.

Conclusion: The pulsar contributions to cosmic-ray lepton flux are predominantly from sources beyond $0.3\,\text{kpc}$, yet the precise size of the halo remains ambiguous, necessitating further external data to clarify.
...
### [33] [The Emerging Population of High-energy Emitting Radio Galaxies](https://arxiv.org/abs/2606.26878)
...
TL;DR: The paper discusses high-energy emission in radio galaxies, revealing efficient particle acceleration across the AGN population. It emphasizes the integration of various processes and the predictive capability of future technologies, like the SKA, in studying AGN dynamics and their impact on galaxies.


<details>
  <summary>Details</summary>
Motivation: To explore how high-energy emissions from different types of radio galaxies can inform our understanding of active galactic nuclei and their associated physical processes.

Method: Utilizing the capabilities of the Square Kilometre Array (SKA) for detailed imaging and spectral studies of AGN, and integrating data with high-energy missions such as NewAthena and CTAO.

Result: The study indicates that particle acceleration is prevalent among various types of radio galaxies, challenging previous assumptions that it primarily occurs in blazars.

Conclusion: The findings support a unified model of particle acceleration in AGN while highlighting the pivotal role of future observational tools in connecting central engine dynamics to host galaxy evolution.
...
### [34] [Supernova remnants in the new radio astronomy era](https://arxiv.org/abs/2606.26889)
...
TL;DR: The paper discusses the significance of supernova remnants (SNRs) and how advancements from SKA precursors improve their observation.


<details>
  <summary>Details</summary>
Motivation: To address unresolved questions about the role of SNRs in Galactic cosmic rays and particle energetics through better observational data.

Method: Utilizes SKA precursors for high sensitivity and resolution imaging of SNRs, allowing for detailed flux density measurements and spectral-index mapping.

Result: Enhanced understanding of SNRs through detection of fainter remnants, improved mapping of structures, and exploration of new frequency ranges.

Conclusion: The SKA will revolutionize SNR studies by improving observational capabilities, thereby fostering deeper insights into their interaction with the interstellar medium and their contribution to cosmic rays.
...
### [35] [Transforming X-ray Binary Astrophysics with SKA+VLBI](https://arxiv.org/abs/2606.26914)
*Tao An,Ailing Wang,James C. A. Miller-Jones,Valeriu Tudose,Pikky Atri,Lang Cui,Hua Feng,Benito Marcote,Sara E. Motta*

Main category: astro-ph.HE

TL;DR: The SKA-Mid will advance the study of X-ray binaries (XRBs) with enhanced VLBI capabilities, allowing for detailed investigations of jets, accretion, and magnetic fields through time-domain observations.


<details>
  <summary>Details</summary>
Motivation: To leverage the unique properties of XRBs for studying accretion processes, jets, strong gravity, and magnetic fields in real time.

Method: Utilizing the phased SKA-Mid in combination with global VLBI networks for improved sensitivity, precision (microarcsecond), and fast-response capabilities, focusing on time-domain observations and multi-band constraints.

Result: Enhanced capability for tracking compact ejecta and jets, measuring magnetic fields and distances, as well as resolving the dynamics of disk-jet interactions, alongside developing a quantitative observational program.

Conclusion: The integration of SKA+VLBI will establish a new standard for astrophysical studies of XRBs, laying the groundwork for understanding jet physics across various astronomical scales.
...
### [36] [Unraveling the mysteries of supernovae with SKA+VLBI](https://arxiv.org/abs/2606.26934)
...
TL;DR: The paper discusses how SKA-Mid and VLBI advancements will enhance our understanding of supernovae by providing high-resolution imaging and sensitivity to investigate progenitor characteristics and explosion mechanisms.


<details>
  <summary>Details</summary>
Motivation: To address the poorly constrained relationship between supernova progenitors and explosion outcomes by resolving early phases through radio emission.

Method: Utilizing SKA-Mid phased into global VLBI for high-sensitivity imaging of supernovae, allowing observation of expanding shocks and circumstellar medium characteristics at sub-beam resolutions.

Result: The combined capabilities will enable measurement of deceleration indices and geometry of mass loss, advancing understanding of explosion mechanisms and progenitor environments up to 25 Mpc.

Conclusion: SKA+VLBI will enable comprehensive studies of supernovae, transforming them into laboratories for shock physics and progenitor characterization, alongside other observational technologies.
...
### [37] [Broad-band Spectral Modeling of Large-Scale X-ray Jets in High-Redshift Quasars: An MHD-Informed Approach](https://arxiv.org/abs/2606.26961)
*Patryk Liniewicz,Łukasz Stawarz,C. C. Cheung,Giulia Migliori,Aneta Siemiginowska*

Main category: astro-ph.HE

TL;DR: The study analyzes high-redshift quasar jets using a novel model that accounts for their structure and radiation mechanisms, revealing greater jet powers than previous models and no significant redshift trends in derived parameters.


<details>
  <summary>Details</summary>
Motivation: To provide a more accurate model of quasar jets by moving beyond the simplified one-zone approximation commonly used, allowing for a detailed understanding of jet dynamics and emission.

Method: The jets are modeled as current-carrying, axially symmetric outflows with a toroidal magnetic field, incorporating pressure, magnetic field, and velocity profiles in a self-consistent manner, and comparing this model against a sample of ten quasar jets.

Result: Bayesian analysis indicates that electron distributions based on gas pressure are preferable, with derived jet powers around $10^{49}\,\mathrm{erg\,s^{-1}}$, notably larger than previous estimates; global jet magnetization is low and no significant trend with redshift is observed for key parameters.

Conclusion: This model provides a better understanding of jet characteristics in high-redshift quasars, highlighting the limitations of the one-zone approach and offering new insights into jet power and structure.
...
### [38] [Exploring Tidal Disruption Events with SKA and VLBI: Unveiling the Mystery of Black Hole Feeding and Outflows](https://arxiv.org/abs/2606.26998)
...
TL;DR: This paper discusses the role of tidal disruption events (TDEs) in understanding black hole behavior and outlines how the SKA Mid will enhance observations and analyses of TDEs through high-resolution imaging and astrometry.


<details>
  <summary>Details</summary>
Motivation: TDEs provide insights into black hole accretion flows, jets, and their evolution on human timescales, which are critical for understanding fundamental astrophysical processes.

Method: The paper details the capabilities of the SKA Mid in conjunction with global networks for observing TDEs, utilizing milliarcsecond imaging, high-precision astrometry, and a wide frequency range to enhance data collection and analysis.

Result: SKA Mid is expected to enable precise measurements of proper motions, resolved morphologies, and the localization of black holes, thus enhancing the understanding of TDEs and their associated phenomena.

Conclusion: The program aims to position TDEs as key laboratories for investigating jet dynamics, particle acceleration, and black hole demographics, facilitating a deeper comprehension of the circumnuclear environment.
...
### [39] [Gamma-ray Bursts and Kilonovae from Gravitational Wave Events](https://arxiv.org/abs/2606.27037)
*Alberto Colombo,Marcello Giroletti,Susanna D. Vergani,Lauren Rhodes*

Main category: astro-ph.HE

TL;DR: This paper discusses the evolution of gravitational wave (GW) and electromagnetic (EM) observations in astrophysics, particularly focusing on the role of future detectors and the SKA Observatory.


<details>
  <summary>Details</summary>
Motivation: To highlight the advancements and future prospects of multimessenger astrophysics, particularly in the context of gravitational wave detections and the role of radio observations in identifying counterparts.

Method: Analysis of current GW and EM observations, potential future detections with advanced instruments like SKAO, and their implications for studying gamma-ray bursts and gravitational wave events.

Result: SKAO will enhance long-term monitoring capabilities for GW events, improve characterization of GRB jets, and facilitate population studies of types of GRBs.

Conclusion: The future of multimessenger astrophysics is promising, with advanced observational tools like SKAO set to address key scientific questions surrounding gravitational waves and gamma-ray bursts.
...
### [40] [Optical observations of candidate host galaxies of eight fast X-ray transients](https://arxiv.org/abs/2606.27048)
...
TL;DR: The paper investigates the origins of fast X-ray transients (FXTs) by analyzing deep optical observations of candidate host galaxies, leading to potential classifications of their progenitors.


<details>
  <summary>Details</summary>
Motivation: To identify the origins of FXTs, especially those without multi-wavelength counterparts, by studying their environments and energetics.

Method: Conducted deep optical observations of eight FXTs to identify candidate host galaxies and utilized spectral energy distribution fitting via BAGPIPES to derive redshifts, stellar masses, star formation rates, metallicities, and stellar population ages.

Result: Identified multiple candidate host galaxies for several FXTs, with consistency found for several progenitor scenarios including WD-IMBH TDE and BNS mergers; noted complexities with multiple candidates.

Conclusion: FXTs from Chandra and XMM-Newton likely have diverse origins; a subset of FXTs detected by Einstein Probe show different characteristics, potentially linked to collapsar scenarios.
...
### [41] [Stellar black hole binaries from two common envelope evolution phases in triple stellar systems](https://arxiv.org/abs/2606.27193)
*Lotem Unger,Noam Soker*

Main category: astro-ph.HE

TL;DR: This study proposes a triple-star evolutionary scenario involving two common envelope phases that generate close binary black hole systems with varying effective spins, explaining observed gravitational wave characteristics.


<details>
  <summary>Details</summary>
Motivation: To understand the formation mechanisms of close binary black holes (BBHs) and their spin distributions as detected by gravitational waves.

Method: A triple-star evolutionary model including two common envelope evolution phases, with the first black hole forming due to a core-collapse supernova after engulfing a low-mass star, and the second forming after a second common envelope phase and subsequent supernova.

Result: The model predicts a merging BBH to core-collapse supernova explosion rate ratio that is up to twice the observed rate, contributing significantly to the population of observed merging BBHs and explaining their spin characteristics.

Conclusion: This evolutionary channel enhances our understanding of BBH formation and aligns theoretical predictions with the characteristics observed in gravitational wave data.
...
### [42] [A search for Fast Radio Bursts from globular clusters in M49 with FAST](https://arxiv.org/abs/2606.27225)
...
TL;DR: No FRBs were detected in a search of globular clusters in M49, challenging the link between FRBs and magnetars in ancient stellar populations.


<details>
  <summary>Details</summary>
Motivation: To investigate the origins of FRBs, specifically whether magnetars can produce them in globular clusters, and to expand the sample of FRBs in older stellar environments.

Method: Conducted a 9-hour observation of M49, targeting approximately 4230 globular clusters using FAST, and performed a single-pulse search over a defined dispersion measure range.

Result: No unambiguous astrophysical FRBs were detected; the most significant signal was consistent with thermal noise and did not confirm an FRB event.

Conclusion: The study imposes an upper limit on the FRB occurrence rate in globular clusters, indicating that bright bursts are less likely than previously thought in these environments.
...
### [43] [Origins of Cosmic Rays in the Galactic-extragalactic Transition Energy Range](https://arxiv.org/abs/2606.27270)
...
TL;DR: The paper discusses measuring the mass composition of high-energy cosmic rays using SKA-Low and particle detectors to distinguish their origins and improve our understanding of cosmic ray acceleration.


<details>
  <summary>Details</summary>
Motivation: To address the origin of the highest-energy cosmic rays and the transition from Galactic to extragalactic sources, particularly focusing on mass composition as a key factor.

Method: Utilizing SKA-Low in conjunction with small particle detectors to measure the mass composition of cosmic rays within the energy range of $10^{16}$ to $10^{18}$ eV.

Result: The proposed setup is expected to provide detailed measurements of mass composition, which is crucial for validating source and propagation models of cosmic rays.

Conclusion: The integration of radio detection techniques with particle detection can significantly enhance our understanding of the nature and origins of high-energy cosmic rays.
...
### [44] [Dissipative Quantum Multiplicative Weights with Sampling Feedback: A Classically Hard Primitive Realized via Engineered Open-System Dynamics](https://arxiv.org/abs/2606.26162)
*Agung Trisetyarso,Lenny Putri Yulianti,Kridanto Surendro*

Main category: quant-ph

TL;DR: DQMW-Sample is an online-learning model using engineered open quantum dynamics for Gibbs sampling, achieving sublinear regret over constant-regret classical learners.


<details>
  <summary>Details</summary>
Motivation: To create an online-learning primitive that utilizes quantum dynamics to enhance learning performance and outpace classical methods.

Method: DQMW-Sample employs a Davies-type dissipator to prepare a Gibbs state with feedback through computational measurements, demonstrating significant computational advantages over classical methods.

Result: DQMW-Sample achieves asymptotically sublinear regret while classical learners experience constant average regret on tailored instances; it also mitigates hardware noise effectively.

Conclusion: The study positions DQMW-Sample as a potentially revolutionary advancement in online learning, demonstrating its relevance in the context of quantum computing and complexity theory.
...
### [45] [Criterion for qubit-assisted quantum metrology approaching Heisenberg scaling](https://arxiv.org/abs/2606.26167)
*Peng Chen,Jun Jing*

Main category: quant-ph

TL;DR: The study reveals that restricting probe-qubit coupling to one or two directions enables Heisenberg-limited precision in quantum metrology. Quantum Fisher information (QFI) becomes the mean square expectation of the effective generator. Two systems are analyzed: a bosonic probe where QFI increases with temperature, and a spin-ensemble probe that maintains Heisenberg scaling even at finite temperatures.


<details>
  <summary>Details</summary>
Motivation: To investigate how the configuration of probe-qubit coupling impacts the precision of quantum measurements.

Method: Analysis of quantum Fisher information in the presence of probe-qubit coupling, applied to bosonic and spin-ensemble probe systems.

Result: Coupling restriction leads to Heisenberg limit precision; QFI behaves differently in bosonic and spin-ensemble probes, with enhanced sensitivity at higher temperatures.

Conclusion: The proposed coupling criterion effectively facilitates Heisenberg-limit precision under various conditions.
...
### [46] [Interpretable rule-based learning in an autonomous thermodynamic network](https://arxiv.org/abs/2606.26220)
*Sparrow Suderman,Giulia Rubino*

Main category: quant-ph

TL;DR: This paper introduces a stochastic learning architecture that leverages thermodynamic principles for classification, achieving comparable accuracy to deterministic models despite operating in noisy environments.


<details>
  <summary>Details</summary>
Motivation: The study aims to bridge the gap between machine learning's deterministic approach and the inherently stochastic nature of physical systems, exploring how noise and irreversibility can enhance computational capabilities.

Method: A classifier is developed using thermodynamic neurons—quantum thermal machines that perform operations via heat flow. The architecture incorporates thermodynamic gates (AND, NOT, OR) and an autonomous coupling mechanism to create a stochastic version of the Tsetlin machine.

Result: The resulting classifier demonstrates classification accuracy similar to the conventional Tsetlin machine, effectively utilizing thresholding and redundancy for reliability despite noise.

Conclusion: The research establishes that accurate and interpretable machine learning can be achieved through autonomous stochastic processes, promoting thermodynamic computation as a viable alternative in machine learning frameworks.
...
### [47] [A fidelity metric for quantum annealing benchmarked by extreme scaling quantum Monte-Carlo simulations](https://arxiv.org/abs/2606.26233)
*Gabriel Gouraud,Miha Srdinsek,Xavier Waintal*

Main category: quant-ph

TL;DR: The paper proposes a new metric to evaluate quantum annealers based on the quality of the annealing process, highlighting its advantages over traditional performance measures.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of current performance measurements of quantum annealers that depend heavily on specific problems and classical benchmarks.

Method: Introduces a new metric analogous to fidelity-per-gate, defined as accuracy $ε$ for the equation of state of the annealer, evaluated using simulated quantum annealing techniques for Rydberg atom systems.

Result: The first approach reaches accuracies of $ε	ext{ }	ext{similar to} 10^{-2}-10^{-3}$ for up to 100 million atoms on a single CPU, while the second achieves $ε	ext{ }	ext{similar to} 10^{-4}$ for up to 100,000 atoms.

Conclusion: The proposed metric vastly outperforms existing quantum annealing experimental platforms in precision and scale, placing important constraints on future quantum hardware development.
...
### [48] [Measures of Chirality in Mixed-State Topological Phases](https://arxiv.org/abs/2606.26235)
*Shijun Sun,Bader Aldossari,Rasmit Devkota,Zhu-Xi Luo*

Main category: quant-ph

TL;DR: The paper explores chirality in mixed-state topological phases, proposing new diagnostics beyond traditional pure-state methods.


<details>
  <summary>Details</summary>
Motivation: To understand the distinct nature of chirality in mixed-state topological phases compared to pure states.

Method: Two relative-entropy-based measures are proposed to characterize chirality and extract the chiral central charge in mixed states.

Result: The traditional diagnostics for topology in pure states are found unreliable in mixed states, necessitating new methods.

Conclusion: New diagnostics are essential for exploring mixed-state topology, highlighting its differences from pure-state scenarios.
...
### [49] [Permutation asymmetry unlocks emergent advantage in randomized Bell tests](https://arxiv.org/abs/2606.26242)
*Wieslaw Laskowski,Tamas Vertesi,Jan Wojcik*

Main category: quant-ph

TL;DR: This paper examines how maximally entangled two-qubit states interact in randomized Bell tests, particularly focusing on the impact of permutation symmetry on nonlocality outcomes.


<details>
  <summary>Details</summary>
Motivation: To explore the behavior of maximally entangled states in randomized Bell tests and their interaction with permutation symmetry and local realism.

Method: The authors analyze statistical relations derived from exchanging measurement settings in sequential Bell experiments, differentiating between permutationally invariant and asymmetric states.

Result: Permutationally invariant states show identical nonlocality outcomes in both experiments, while asymmetric states may violate local realism in only one scenario. This has implications for detecting correlations in measurement choices and enhancing nonlocality visibility.

Conclusion: The study highlights the importance of permutation asymmetry in Bell tests, revealing symmetry's new role in quantum nonlocality and suggesting operational strategies to utilize this feature.
...
### [50] [Optimal observables for quantum-enhanced sensing and applications in a Floquet time crystal sensor](https://arxiv.org/abs/2606.26248)
*M. A. Manya,Andrei Tsypilnikov,Fernando Iemini*

Main category: quant-ph

TL;DR: This work outlines a method to implement optimal observables for metrology that meet the quantum Fisher information (QFI) bound, particularly using the method of moments (MoM) and simpler alternatives to the complex symmetric logarithmic derivative (SLD) operator.


<details>
  <summary>Details</summary>
Motivation: To determine feasible observables for metrology protocols that effectively utilize the QFI bound without the complexity of the SLD operator.

Method: The study applies the method of moments (MoM) to derive observables and approximates the SLD operator with simpler ones like bare spin magnetization and parity observables within a Floquet time crystal model.

Result: The approximation retains quantum-enhanced sensitivity and demonstrates successful application in a nuclear magnetic resonance system as a practical metrology solution.

Conclusion: Simpler observables can be used in place of the SLD for effective metrology in FTC sensors, ensuring performance near optimal sensitivity.
...
### [51] [A Survey of Quantum Programming Languages](https://arxiv.org/abs/2606.26254)
*Quan Do,Hersh Gupta,Xiyuan Cao,Aarav Pabla,Pranav Singamsetty,Evan O'Grady,Keli Huang,Jens Palsberg*

Main category: quant-ph

TL;DR: This paper introduces a classification framework for surveying quantum programming languages, revealing challenges for future design based on comparisons of existing languages.


<details>
  <summary>Details</summary>
Motivation: To address the need for high-level programming languages in quantum computing, which are essential for effectively expressing quantum solutions.

Method: A classification framework was developed to survey and analyze ten popular quantum programming languages, allowing for conceptual and experimental comparisons.

Result: The paper identifies key challenges in the design of quantum programming languages based on the survey findings.

Conclusion: The work lays the groundwork for future advancements in quantum programming language design.
...
### [52] [Complex frequency-dependent quadrature squeezing in semiconductor lasers](https://arxiv.org/abs/2606.26266)
*Daniele Nello,Giuseppe Patera,Lorenzo Columbo*

Main category: quant-ph

TL;DR: This study explores quadrature squeezing in quantum well lasers using a quantum Langevin approach, revealing novel frequency-dependent squeezing properties.


<details>
  <summary>Details</summary>
Motivation: To investigate the properties of quadrature squeezing in semiconductor lasers and their potential applications in quantum technologies.

Method: Utilizing a fully quantum Langevin approach to compute frequency-resolved squeezing maps of laser fields and analyze the role of the linewidth enhancement factor.

Result: Identification of optimal squeezing curves and discovery of frequency-dependent and complex hidden squeezing in a semiconductor laser for the first time.

Conclusion: Semiconductor lasers can generate non-classical light, suggesting new avenues for applications in quantum communication and sensing.
...
### [53] [Mechanisms governing photon-pair generation and emission directionality in quantum metasurfaces](https://arxiv.org/abs/2606.26303)
*Alberto Paniate,Ivano Ruo-Berchera,Francesco Monticone*

Main category: quant-ph

TL;DR: This paper investigates the mechanisms of photon-pair generation in metasurfaces, enhancing understanding and design efficiency in quantum experiments.


<details>
  <summary>Details</summary>
Motivation: Despite their promise in photon-pair generation, the mechanisms influencing metasurface performance remain poorly understood, leading to trial-and-error optimizations.

Method: The study theoretically explores how various pump configurations and measurement geometries impact key parameters like generation efficiency and emission directionality of photon pairs.

Result: Results indicate that substrate thickness and multilayer designs serve as additional parameters that can optimize both generation efficiency and emission directionality.

Conclusion: The work offers insights for future metasurface designs and experimental setups, facilitating better optimization of quantum photon-pair sources.
...
### [54] [A hardware-safety-gated system for LLM-written native ARTIQ control code on a trapped-ion platform](https://arxiv.org/abs/2606.27231)
*Duanyang Wang,Lu Qi,Yuanheng Xie,Norbert M. Linke,Kenneth R. Brown*

Main category: quant-ph

TL;DR: This paper addresses the safety issues of using LLM agents for autonomously conducting laboratory work by introducing a control system that ensures human oversight and authorization before operational execution.


<details>
  <summary>Details</summary>
Motivation: The motivation is to enable laboratory autonomy using LLM agents while mitigating safety risks associated with unchecked code execution, which could damage equipment.

Method: The authors present a system where an LLM agent operates within a defined per-operation boundary enforced by an authorization mechanism tied to simulated hardware validation or human oversight for sensitive tasks.

Result: Deployment on trapped-ion systems demonstrated the agent's ability to autonomously develop experiments and perform complex operations under controlled conditions, while testing confirmed robustness against adversarial scripts.

Conclusion: The study clarifies that the agent's limitations are primarily in metacognitive control rather than domain knowledge, suggesting areas for further development toward greater autonomy.
...
### [55] [Tailor Made Embeddings for Quantum Machine Learning](https://arxiv.org/abs/2606.26312)
*Aldo Lamarre,Dominik Šafránek*

Main category: quant-ph

TL;DR: The paper introduces a variational autoencoder for quantum machine learning that effectively compresses high-dimensional classical data into a 13-qubit quantum representation, demonstrating high validation accuracy and practical reconstruction capabilities.


<details>
  <summary>Details</summary>
Motivation: To enhance quantum machine learning by addressing the challenges of dimensionality and effective data representation, while demonstrating the feasibility of quantum embeddings for classical datasets.

Method: A variational autoencoder framework learning quantum embeddings, validated through experiments on datasets like ImageNet and MNIST, leveraging quantum hardware for stability under noise.

Result: Achieved 98.5% validation accuracy on MNIST while maintaining strong performance on ImageNet, outperforming traditional amplitude embeddings and approaching classical neural network performance.

Conclusion: The developed framework allows for efficient data representation in quantum contexts, offering significant advantages in measurement efficiency and stability compared to existing methods.
...
### [56] [Improving device-independent quantum key distribution protocols through multiple routed Bell tests](https://arxiv.org/abs/2606.26329)
*Sujan Vijayaraj,Mauro Paternostro*

Main category: quant-ph

TL;DR: This paper proposes a device-independent quantum key distribution (DI-QKD) protocol using routed Bell tests to enhance detection efficiencies, allowing for long-distance applications.


<details>
  <summary>Details</summary>
Motivation: The implementation of DI-QKD faces challenges requiring local tests for reliability, especially over practical distances, needing close-to-ideal test violations.

Method: A protocol is proposed that utilizes multiple sources and measurement devices, performing routed Bell tests on randomly selected local devices and checking local Bell test violations conditionally based on successful BSM projections.

Result: Improvements in critical detection efficiencies of approximately 4-12% for high visibilities were achieved, facilitating long-distance DI-QKD operations with efficient routing setups.

Conclusion: The proposed method not only enables efficient local testing for DI-QKD but extends the routing concept to dimension witnesses, presenting a semi-device-independent framework.
...
### [57] [Equivalence of non-local computation tasks beyond Clifford operations](https://arxiv.org/abs/2606.26354)
*Andreas Bluhm,Simon Höfer,Alex May,Florian Speelman,Philip Verduyn Lunel*

Main category: quant-ph

TL;DR: The paper explores reductions among non-local quantum computation tasks, particularly in quantum position-verification, revealing structured relationships and implications for security and entanglement costs.


<details>
  <summary>Details</summary>
Motivation: To investigate the structural relationships among non-local quantum computation tasks, particularly in the context of quantum position-verification, and to understand their implications for security.

Method: The study employs strategies from gate teleportation and measurement-based quantum computation to identify new relationships and reductions among NLQC tasks, focusing on large classical inputs with fixed-size quantum inputs.

Result: The authors discover new relationships among NLQC tasks, showing that specific protocols imply others, leading to similar entanglement costs and security levels across feasible position-verification schemes.

Conclusion: The findings highlight structured relationships among NLQC tasks, suggesting they share a common asymptotic scaling for entanglement costs and security, which may influence practical implementations.
...
### [58] [Algebraic structures of the Lindblad equation](https://arxiv.org/abs/2606.26477)
...
TL;DR: The paper presents an algebraic framework for the dynamics of finite-dimensional open quantum systems described by the Lindblad equation, highlighting the complexity and computational efficiency of the approach.


<details>
  <summary>Details</summary>
Motivation: To explore the algebraic structure underlying the Lindblad equation and facilitate efficient computation in open quantum systems.

Method: Introduces an operator representation of the Liouville superoperator, deriving a closed algebra of Hermitian operators and recursion relations for system dimensions.

Result: The new framework leads to efficient parametrization of the dynamical map and reduced computational cost in constructing the Liouville superoperator, with a practical Mathematica example provided.

Conclusion: The proposed algebraic formulation offers a general mathematical description and improves analytical and numerical implementations of finite-dimensional Lindblad dynamics.
...
### [59] [Non-Hermitian Bloch Oscillations](https://arxiv.org/abs/2606.26480)
*Yanyan He,Tomoki Ozawa*

Main category: quant-ph

TL;DR: The paper presents a framework for non-Hermitian Bloch oscillations, revealing anomalous wave-packet dynamics in 1D non-Hermitian lattices under a dc force.


<details>
  <summary>Details</summary>
Motivation: To explore and characterize wave-packet behavior in non-Hermitian systems, specifically focusing on Bloch oscillations driven by external forces.

Method: Derivation of equations governing momentum, center of mass, and group velocity, along with analysis of finite-size effects in the context of non-Hermitian lattices.

Result: Identification of anomalous group velocities and the emergence of nonreciprocal, non-smooth Bloch oscillations and periodic temporal Goos–Hänchen shifts.

Conclusion: The study enhances the understanding of wave dynamics in non-Hermitian systems, revealing complex behaviors and phenomena related to group velocity and propagation.
...
### [60] [Scattering theory for cavity-assisted spin-motion-photon interactions](https://arxiv.org/abs/2606.26542)
*Seigo Kikura,Aruku Senoo,Akihisa Goban,Shinichi Sunami*

Main category: quant-ph

TL;DR: The paper presents an analytical framework for cavity-assisted photon scattering (CAPS), integrating atomic motion into the interaction model, which aids in reducing motion-induced errors in quantum communication protocols.


<details>
  <summary>Details</summary>
Motivation: To address the challenges in analyzing the impact of atomic motion on cavity-assisted photon scattering, which is crucial for quantum information processing involving remote entanglement and atom-photon interactions.

Method: An analytical framework is developed that extends scattering theory to include the motional degree of freedom, resulting in a compact operator-based input-output relation applicable across various cavity setups and atomic configurations.

Result: The framework reveals how atomic motion influences CAPS-based atom-photon gates and identifies parameter regimes that minimize motion-induced errors.

Conclusion: This theoretical framework not only mitigates motion-induced errors in CAPS but also offers opportunities to exploit motion-photon interactions, enhancing the performance of quantum communication protocols.
...
### [61] [Graph Structures for Local Distinguishability of Quantum Product States](https://arxiv.org/abs/2606.26558)
*Sooyeong Kim,David W. Kribs,Michael Nathanson,Rajesh Pereira,Sarah Plosker*

Main category: quant-ph

TL;DR: This paper investigates the distinguishability of quantum product states using two-way LOCC and graph theory.


<details>
  <summary>Details</summary>
Motivation: The need for a deeper understanding of quantum product states distinguishability beyond one-way LOCC protocols.

Method: Employing graph theory to analyze and classify bipartite product states distinguishable through two-way LOCC.

Result: Identified closure properties of distinguishable graphs and classified certain graphs regarding their local distinguishability.

Conclusion: The paper sets a foundation for future research in quantum state distinguishability using two-way local operations.
...
### [62] [Quantum Fast-Forwarding Beyond Reversibility: The $α$-Perturbed $n$-Cycle](https://arxiv.org/abs/2606.26584)
*Avah Banerjee,Asim Sharma,Sooraj Sooman*

Main category: quant-ph

TL;DR: This paper explores the limitations of quantum fast-forwarding (QFF) in nonreversible dynamics of an $α$-perturbed $n$-cycle Markov chain, highlighting fundamental challenges due to eigenvalues leaving the bound of $[-1,1]$ and ultimately proposing a finite-time approximation method instead.


<details>
  <summary>Details</summary>
Motivation: The study aims to determine if quantum fast-forwarding, which is effective in reversible systems, can be adapted to nonreversible quantum processes.

Method: The authors analyze a $α$-perturbed $n$-cycle Markov chain, focusing on the eigenvalue behavior of its transition matrix $P_α$ and utilizing truncated Chebyshev and LCU techniques to achieve finite-time approximations.

Result: It is shown that for $α
eq 0$, the eigenvalues leave the $[-1,1]$ interval affecting QFF applicability, yet a finite-time approximation allows adaptation with complexity $	au=O(|α|t+\\sqrt{t\log(t/η)})$ in a nearly reversible regime.

Conclusion: While exact quantum fast-forwarding does not extend to nonreversible cases, a perturbative regime exists where the speedup is quantifiable, indicating potential adaptations for irreversibility.
...
### [63] [Non-Hermiticity of an anomalous superradiant phase](https://arxiv.org/abs/2606.26770)
*Jun-Ling Wang,You-Qi Lu,Qing-Hu Chen,Yu-Yu Zhang*

Main category: quant-ph

TL;DR: This paper introduces a Hermitian squeezing-Dicke model to explore non-Hermitian physics in many-body light-matter systems, revealing a unique mechanism for effective parity-time symmetry and a novel superradiant phase.


<details>
  <summary>Details</summary>
Motivation: The paper seeks to establish a framework for exploring non-Hermitian phenomena through a Hermitian model, challenging conventional approaches driven by dissipation.

Method: The authors utilize a Hermitian quadratic bosonic system to construct a non-Hermitian Hamiltonian centered on squeezing effects, leading to the observation of $	ext{PT}$ symmetry.

Result: They identify an anomalous superradiant phase characterized by spontaneous $	ext{PT}$ symmetry breaking, a distinct excitation spectrum, and a dynamical phase transition to a conventional superradiant phase at an exceptional point.

Conclusion: This approach opens new avenues for studying non-Hermitian systems and enhances our understanding of quantum amplification in light-matter interactions.
...
### [64] [Nonadiabatic Holonomic Single-Qubit Gates in Non-Hermitian Systems](https://arxiv.org/abs/2606.26798)
*Wei Li,Yue Zhang,Yu Kun Chen,Jia Yao Liang*

Main category: quant-ph

TL;DR: Develops a nonadiabatic holonomic scheme for three-level systems to enable robust quantum gates despite decoherence.


<details>
  <summary>Details</summary>
Motivation: To address the issue of decoherence in holonomic quantum computation, enabling reliable quantum gate implementations.

Method: Utilizes a nonadiabatic holonomic scheme with tailored complex pulses within a biorthogonal framework, leading to closure of computational-subspace evolution.

Result: Arbitrary single-qubit holonomic gates are achievable without relying on cyclic evolution, with fidelity maintained in the presence of dissipation.

Conclusion: Incorporating decay and dephasing directly into pulse design ensures gate performance despite underlying nonunitary dynamics.
...
### [65] [Dissipation-Induced Deviations from Kibble-Zurek Scaling in Non-Hermitian Quantum Annealing](https://arxiv.org/abs/2606.26870)
*H. Najafzadeh,S. Sadeghizade,R. Jafari,A. Langari*

Main category: quant-ph

TL;DR: This study analyzes quantum annealing in a non-Hermitian transverse-field Ising model, revealing unique behaviors in defect density and transition dynamics compared to the Hermitian case.


<details>
  <summary>Details</summary>
Motivation: To explore quantum annealing dynamics in the non-Hermitian transverse-field Ising model and its implications for defect formation during phase transitions.

Method: Both analytical and numerical approaches were employed to determine intrinsic transition probabilities and defect density during quantum annealing.

Result: The defect density shows varied behaviors including standard Kibble-Zurek scaling, anti-Kibble-Zurek behavior, and faster suppression due to non-Hermitian effects.

Conclusion: Deviations from standard Kibble-Zurek scaling arise from unique excitation probabilities influenced by dissipation, affecting defect density beyond the gap-closing points.
...
### [66] [Scalable Message-Passing Quantum Graph Neural Networks in the Weisfeiler-Leman Hierarchy](https://arxiv.org/abs/2606.26873)
*Snehal Raj,Brian Coyle,Léo Monbroussou,André J. Ferreira-Martins,Renato M. S. Farias,Elham Kashefi*

Main category: quant-ph

TL;DR: The paper introduces a quantum graph neural network (GNN) designed for message passing that ensures permutation equivariance and adheres to the Weisfeiler-Leman hierarchy, focusing on scalability and expressivity.


<details>
  <summary>Details</summary>
Motivation: To enhance the capabilities of quantum models, particularly their trainability and applicability in relational data contexts, leveraging the principles of classical GNNs.

Method: Developed a quantum GNN that performs message passing, ensuring permutation equivariance and hierarchical graph separation, allowing for pre-training on smaller graph instances.

Result: Demonstrated the framework's efficacy through simulations involving up to 56 qubits, validating its ability to tackle complex problems that classical message passing fails to address.

Conclusion: The proposed quantum GNN offers a promising approach for near-term quantum algorithms, combining theoretical robustness with practical scalability in graph learning.
...
### [67] [Shallow Quantum Circuits for Deep Chemistry via Valence Bond Embeddings](https://arxiv.org/abs/2606.26882)
*Francisco Javier del Arco Santos,Jakob S. Kottmann*

Main category: quant-ph

TL;DR: This paper presents a method to construct quantum circuits for larger molecular systems in quantum chemistry by combining hybrid encodings and Quantum Valence Bond Theory.


<details>
  <summary>Details</summary>
Motivation: There is a growing need for reliable approximations for larger quantum systems in computational chemistry due to limitations in current quantum hardware and simulation methods.

Method: The authors integrate hybrid Fermionic-Bosonic encodings with Quantum Valence Bond Theory to create a single quantum circuit for larger molecular systems.

Result: The proposed method enhances the capabilities of variational quantum eigensolvers, producing circuit designs that surpass active space techniques and provide accurate approximations.

Conclusion: This approach enables more effective quantum simulations of chemically relevant systems, addressing existing bottlenecks in quantum chemistry.
...
### [68] [An ultralow-loss integrated photonic platform for discrete-variable quantum information processing](https://arxiv.org/abs/2606.26910)
...
TL;DR: This paper presents an ultralow-loss silicon nitride photonic integrated circuit for scalable quantum information technologies, addressing previous limitations in optical loss and achieving high-fidelity EPR states and four-photon entangled states with substantial count rates.


<details>
  <summary>Details</summary>
Motivation: To tackle critical system-level bottlenecks in scaling photon-based quantum information technologies due to rapidly compounding optical losses in existing platforms.

Method: The authors develop a monolithic silicon nitride integrated photonic platform that combines narrowband photon-pair sources, low-loss qubit-fusion circuits, and reconfigurable state-analysis interferometers for effective discrete-variable quantum information processing.

Result: They achieve a fidelity of 0.9875(3) for on-chip generated EPR states and utilize these states to create four-photon Greenberger-Horne-Zeilinger states with a fidelity of 0.943(8) and an unprecedented count rate of 27 Hz.

Conclusion: The study establishes ultralow-loss Si$_3$N$_4$ integrated photonics as a viable platform for large-scale quantum information processors, compatible with standard CMOS fabrication.
...
### [69] [On the simple derivation of the Casimir effect](https://arxiv.org/abs/2606.26946)
*Hai-Chau Nguyen,Matthias Kleinmann*

Main category: quant-ph

TL;DR: The paper revisits Casimir's original derivation of the Casimir effect, highlighting important nuances.


<details>
  <summary>Details</summary>
Motivation: To provide a comprehensive understanding of Casimir's derivation of the effect, highlighting nuances often overlooked in simplified explanations.

Method: A detailed examination of Casimir's original paper and its mathematical formulation.

Result: Identification of subtle nuances that enhance the clarity and completeness of the Casimir effect's derivation.

Conclusion: The paper emphasizes the importance of understanding the original derivation for appreciating the full scope of the effect.
...
### [70] [Lattice patch structure for fixed-frequency transmon quantum computer with high-fidelity CNOT gates](https://arxiv.org/abs/2606.27017)
*Chanpyo Kim,Jeongsoo Kang,Younghun Kwon*

Main category: quant-ph

TL;DR: The paper introduces a lattice-patch architecture for superconducting transmon processors, addressing challenges in qubit connectivity and scalability, with demonstrated high fidelity in gate operations.


<details>
  <summary>Details</summary>
Motivation: Conventional qubit architectures face critical issues such as frequency crowding and inefficiencies in mapping to surface codes as systems scale, hindering quantum computing advancements.

Method: A novel lattice-patch architecture is proposed, coupling four fixed-frequency transmons to a single fixed-frequency coupler, which enhances connectivity and aligns with surface-code lattices to reduce logical qubit implementation overhead.

Result: CNOT gate fidelities exceed 0.98 in multi-level simulations, despite challenges from residual phase accumulation during driving necessitating calibration using virtual $R_z$ gates.

Conclusion: The lattice-patch architecture is validated as an efficient and robust framework for building future fault-tolerant quantum computers.
...
### [71] [Witness expansion: A unified framework for analytical and measurable mixed-state resource detection](https://arxiv.org/abs/2606.27105)
*Yifan Tang,Chengkai Zhu,Yuzhen Zhang,Jens Eisert,Zi-Wen Liu,Ingo Roth,Otfried Gühne,Xin Wang,Zhenhuan Liu*

Main category: quant-ph

TL;DR: The paper presents 'witness expansion,' a framework for detecting quantum resources across various quantum states, enhancing detection methods and providing new analytical tools.


<details>
  <summary>Details</summary>
Motivation: To develop effective methods for identifying quantum resources, which are crucial for quantum information science and understanding quantum dynamics.

Method: The authors propose 'witness expansion,' a framework that uses nonlinear criteria based on polynomial functions of quantum states to identify quantum resources from free unitaries.

Result: The framework recovers known resource detection measures and introduces new criteria for detecting qubit and qudit magic states, including an analytical method for mixed-state fermionic non-Gaussianity.

Conclusion: The proposed framework significantly enhances the capabilities of quantum resource detection, demonstrating its broad applicability and unifying power in quantum theory.
...
### [72] [Efficient foundation decoders for fault-tolerant quantum computing](https://arxiv.org/abs/2606.27119)
*Ge Yan,Shanchuan Li,Shiyi Xiao,Pengyue Ma,Hanyan Cao,Feng Pan,Yuxuan Du*

Main category: quant-ph

TL;DR: This paper introduces NTU, a framework for efficient foundation decoders in quantum computing, overcoming scaling issues by utilizing knowledge transfer across different code distances.


<details>
  <summary>Details</summary>
Motivation: The increasing complexity and cost of building high-capacity foundation decoders for fault-tolerant quantum computing necessitates a solution that enhances efficiency while scaling across larger code distances.

Method: Neural Transfer Unification (NTU) leverages algebraic structures of scalable code families to align and transfer knowledge learned from smaller codes to improve training and performance of decoders on larger codes, implemented as NTU-Transformer.

Result: NTU-Transformer demonstrates superior performance to traditional methods in several code configurations, including significant advancements for planar surface and bivariate bicycle codes in terms of decoding accuracy and efficiency.

Conclusion: The NTU framework presents a promising approach to scalable training of foundation decoders, facilitating advancements in fault-tolerant quantum processors.
...
### [73] [Rate-2/3 Girth-8 (3,18)-Regular Quantum LDPC Codes from Two-Branch Finite-Field Bases and CPM Lifts](https://arxiv.org/abs/2606.27130)
*Koki Okada,Kenta Kasai*

Main category: quant-ph

TL;DR: The paper introduces a rate-$2/3$ quantum LDPC code using a specific construction method, achieving a CSS code with notable parameters and successful decoding results.


<details>
  <summary>Details</summary>
Motivation: To construct an efficient quantum LDPC code with a finite-distance performance and practical decoding capabilities.

Method: The code is built from a $(3,18)$-regular finite-field base and utilizes a circulant-permutation-matrix lift of degree $P=101$, resulting in a Calderbank-Shor-Steane (CSS) code with specific parameters.

Result: Achieved a code with parameters $[[34542,23032,d	ime 310]]$, and demonstrated successful decoding without failures over $10^8$ trials at $p=0.01$, with an estimated transition near $p=0.029$.

Conclusion: The constructed quantum LDPC code shows promise in performance, maintaining error-free decoding in extensive trials and establishing a usable distance bound.
...
### [74] [Loss-aware pulse sequence optimization for generating photonic Fock states](https://arxiv.org/abs/2606.27158)
*Benjamin Stodd,Priyanshu Tiwari,René Sondenheimer,Sina Saravi,Martin Gärttner*

Main category: quant-ph

TL;DR: This paper explores the creation of frequency-tunable photonic Fock states using a hybrid cavity system, optimized through multipulse driving protocols to enhance robustness against dissipation.


<details>
  <summary>Details</summary>
Motivation: The aim is to prepare photonic Fock states with high fidelity and stability in practical setups, addressing challenges posed by dissipation and photon loss.

Method: Utilizing a gradient-based optimization approach, the authors develop multipulse protocols adjusting amplitudes, phases, and delays. The optimization framework extends to open-system dynamics leveraging the Lindblad master equation to include atomic decay and photon loss.

Result: The study achieves nearly deterministic preparation of low-photon-number Fock states, demonstrating enhanced robustness against dissipation and identifying optimal pulse sequences with strict phase constraints.

Conclusion: The findings highlight the importance of phase restrictions and provide guidelines for designing pulse sequences to achieve robust Fock state preparation in realistic conditions.
...
### [75] [From Approximate Floquet Engineering to Full Floquet Theory: Coherent Control of Chiral Spin Systems in Spintronics](https://arxiv.org/abs/2606.27183)
*Andrea Simion,Claudiu Filip,Coriolan Tiusan*

Main category: quant-ph

TL;DR: This paper presents a Floquet-space formalism for modeling the dynamics of interacting spin systems under periodic driving, revealing intricate behaviors influenced by exchange coupling and Dzyaloshinskii-Moriya interactions.


<details>
  <summary>Details</summary>
Motivation: The need for effective modeling of driven coupled electron spins in quantum technologies, particularly under external magnetic fields, is pressing to enhance coherent control capabilities.

Method: We apply a full Floquet-space formalism adapted from NMR methodologies, incorporating factors like isotropic exchange coupling and Dzyaloshinskii-Moriya interaction, and validate it numerically through Fourier-space truncation checks.

Result: In the presence of DMI, there's a significant change in spin expectation values, reflected in altered Bloch-sphere trajectories; under certain conditions, this leads to multi-frequency dynamics.

Conclusion: The results affirm the utility of Floquet-space modeling for deeply understanding and manipulating coherent dynamics in complex spin systems, offering insights beyond basic coherent rotation.
...
### [76] [Quantum group codes for non-Clifford logic: enhanced decoding, addressability and parallelizability](https://arxiv.org/abs/2606.27211)
*Jean Gasnier,Virgile Guémard*

Main category: quant-ph

TL;DR: The paper presents quantum group codes derived from classical quasi group codes, enhancing gate operations' efficiency and decoding complexity.


<details>
  <summary>Details</summary>
Motivation: To improve the implementation efficiency of quantum circuits, especially for non-Clifford gates, through better qubit codes.

Method: The authors utilize a lifting procedure from classical AG codes based on class field theory to construct quantum group codes that support efficient multi-control-Z gates.

Result: The proposed quantum group codes over alphabet \(\mathbb{F}_{q^2}\) provide significant reductions in decoding complexity, achieving quasi-quadratic time decoders instead of cubic, enabling more efficient quantum operations.

Conclusion: This advancement implies a substantial reduction in the time complexity of existing magic-state distillation protocols, enhancing their practical applicability.
...
### [77] [A 0.651-approximation to quantum Max Cut via Rydberg atoms](https://arxiv.org/abs/2606.27224)
*Tomás Crosta,Matthieu Saubanere,Felix Huber*

Main category: quant-ph

TL;DR: The paper introduces a hybrid approximation algorithm for the Quantum Max Cut problem, leveraging Rydberg atom systems with semidefinite programming, achieving a better approximation ratio than previous methods.


<details>
  <summary>Details</summary>
Motivation: Quantum Max Cut is a challenging QMA-complete problem that benchmarks quantum approximation algorithms.

Method: A hybrid algorithm combines natural quantum dynamics of Rydberg atom systems with semidefinite programming and randomized rounding.

Result: Achieved a conditional approximation ratio of 0.651, surpassing the previous best of 0.614 from semidefinite programming alone.

Conclusion: The robust performance of the algorithm suggests new possibilities for hybrid quantum-classical approaches in optimization.
...
### [78] [Quantum computer architecture with ions in tweezer arrays](https://arxiv.org/abs/2606.27249)
*Benjamin F. Schiffer,Christopher Monroe,Peter Zoller,J. Ignacio Cirac*

Main category: quant-ph

TL;DR: This paper presents a novel architecture for quantum computing using ions in optical tweezers, allowing for long coherence times and parallel operations, thus paving the way for scalable quantum processors.


<details>
  <summary>Details</summary>
Motivation: To leverage the advantages of trapped-ion qubits and optical tweezer reconfigurability for quantum computing.

Method: The architecture involves using optical tweezer arrays to manipulate ions, generating effective electric dipoles for entangling gates via Coulomb interactions, while transporting ions to interaction zones.

Result: The proposed mechanisms achieve robust entanglement and eliminate residual motions, which could enhance the fidelity of quantum operations and reduce errors during parallel gate executions.

Conclusion: The study presents a feasible pathway for developing scalable ion-tweezer quantum processors, advancing the field of quantum computation.
...
### [79] [Particle-preserving fermionic shadows with mode-independent sample complexity](https://arxiv.org/abs/2606.27254)
*Maxwell West,M. Cerezo,Martin Larocca*

Main category: quant-ph

TL;DR: This paper improves the sample complexity for learning expectation values of particle-preserving operators in fermionic states using classical shadows, achieving better performance in both sample requirements and computational efficiency.


<details>
  <summary>Details</summary>
Motivation: To enhance the estimation methods for overlaps with Slater determinant states in quantum systems, reducing sample complexity and improving computational efficiency.

Method: Introduced a framework to estimate overlaps with arbitrary Slater states, achieving a sample cost of \( \mathcal{O}(η \log η) \), and computational complexity involving classical processing that scales as \( \mathcal{O}(nη^2) \).

Result: The improved method leads to a mode-independent sample cost and a new sample complexity bound of \( \mathcal{O}(η\|h_0\|_2^2) \) for estimating quadratic fermionic observables.

Conclusion: The study not only provides better bounds for sampling in quantum state estimation but also presents technical insights that may contribute to the broader field of quantum analysis, particularly through its connections with harmonic analysis and orthogonal polynomials.
...
### [80] [Large-scale multimode entangling-gate synthesis in trapped-ion systems](https://arxiv.org/abs/2606.27266)
*YingYe Huang,Wentao Chen,Guoyu Zou,Xuan Fan,Jing-Ning Zhang,Kihwan Kim*

Main category: quant-ph

TL;DR: A numerical framework for synthesizing multimode entangling gates in large trapped-ion systems is developed, showing efficient control over high-dimensional interactions without a rapid increase in resource requirements.


<details>
  <summary>Details</summary>
Motivation: Trapped-ion systems are key for scalable quantum information processing, yet increasing ion counts complicate gate synthesis due to dense collective motional modes.

Method: The study introduces a numerical framework utilizing an alternating-minimization strategy to directly search for control fields that satisfy competing requirements for gate synthesis.

Result: Gates were successfully synthesized for ion chains up to 1000 ions, implementing all-to-all and nearest-neighbor interaction patterns, with no significant growth in control resources needed for high-fidelity interactions.

Conclusion: The framework enhances the feasibility of multimode gate synthesis, promoting programmable interaction engineering in large-scale quantum processors.
...
### [81] [Quantum-Limited Subdiffraction Telescopy Requires Genuine Multi-Telescope Interference](https://arxiv.org/abs/2606.27276)
*Yujie Zhang,Yunkai Wang,Wilson Wu,Thomas Jennewein*

Main category: quant-ph

TL;DR: Pairwise measurements in traditional stellar interferometry are insufficient for optimal imaging in a multi-telescope setup; higher-order moment estimation requires multi-telescope interference, which can be enhanced using array-SPADE measurements.


<details>
  <summary>Details</summary>
Motivation: To determine if pairwise mutual coherence measurements are adequate for quantum-limited imaging with an array of telescopes.

Method: Analysis of quantum Fisher information (QFI) scaling for image moments in a multi-telescope framework, leading to the construction of array-SPADE measurements to optimize QFI scaling.

Result: Proven that pairwise measurements reach full-array QFI scaling only to second-order, necessitating multi-telescope interference for higher-order moments; the array-SPADE method optimally achieves QFI scaling up to finite-array cutoff.

Conclusion: Array-SPADE measurements can be integrated into advanced quantum-network architectures, facilitating improved long-baseline telescopy.
...
### [82] [Exploring dynamics of individual vortices in a superconductor via a levitated magnetic transducer](https://arxiv.org/abs/2606.27297)
*Yiqi Wang,Trisha Madhavan,J. DaLi Schaefer,Addison NewRingeisen,Frankie Fung,Mikhail D. Lukin*

Main category: quant-ph

TL;DR: The study investigates the dynamics of trapped vortices in superconductors using micron-scale levitated magnetic particles, revealing complex interactions and insights into dissipation mechanisms.


<details>
  <summary>Details</summary>
Motivation: Understanding trapped vortices is crucial for applications like magnetic levitation, yet their dynamics are not well understood.

Method: Micron-scale levitated magnetic particles were used to probe vortex dynamics in a YBCO superconducting film, observing signals related to vortex tunneling and interaction.

Result: Random telegraph signals indicated that vortex dynamics affect the mechanical properties of levitated magnets, and non-exponential decay showed a complex potential landscape.

Conclusion: The findings enhance knowledge of dissipation in superconductors and suggest new applications for levitated magnets as probes of vortex dynamics.
...
### [83] [Self-Sifting quantum key distribution](https://arxiv.org/abs/2606.27299)
*Saman Sarshar,Mostafa Annabestani*

Main category: quant-ph

TL;DR: A new two-way quantum key distribution protocol utilizing a single qubit from a Bell state is presented, featuring delayed sifting and detection, a novel scrambling operator for security, and enhanced eavesdropper detection capabilities.


<details>
  <summary>Details</summary>
Motivation: To enhance the security and efficiency of quantum key distribution (QKD) protocols by addressing vulnerabilities in conventional two-way systems.

Method: The protocol uses a maximally entangled Bell state with a scrambling operator for security, postpones sifting and detection until after quantum communication, and detects eavesdropper attacks more effectively by utilizing previously discarded rounds.

Result: The proposed protocol limits information extraction during attacks on the quantum channel and successfully detects a broad class of ancilla-based attacks, showing resilience against various eavesdropping strategies.

Conclusion: The new two-way QKD protocol significantly improves security and efficiency, demonstrating effective eavesdropper detection without compromising the integrity of the key exchange process.
...
### [84] [Magnetic monopole plasma oscillations and implications for TeV blazars](https://arxiv.org/abs/2606.26229)
*Mariia Khelashvili,Takeshi Kobayashi,Andrew J. Long*

Main category: hep-ph

TL;DR: This paper explores the effects of magnetic monopoles on intergalactic magnetic fields and their implications for blazar astrophysics.


<details>
  <summary>Details</summary>
Motivation: The existence of magnetic monopoles could provide insights into charge quantization and symmetry in Maxwell's equations, with potential observable effects in astrophysical contexts.

Method: The authors analyze monopole-induced oscillations in the intergalactic magnetic field and their influence on charged particle trajectories, particularly focusing on blazar observations and electromagnetic cascades.

Result: They derive constraints on magnetic monopole abundance from observations of blazar 1ES 0229+200, establishing stronger flux limits than current laboratory and astrophysical measures, depending on intergalactic magnetic field strength.

Conclusion: If the intergalactic magnetic field is stronger than a certain threshold, existing monopole abundance constraints weaken; additionally, revising lower bounds based on TeV observations leads to stricter limits on monopole density.
...
### [85] [Constraining Multiple Kinetically Mixed Dark Photons](https://arxiv.org/abs/2606.26240)
*Joerg Jaeckel,Sebastian Monath*

Main category: hep-ph

TL;DR: The paper explores the interaction of multiple dark photons (U(1) gauge bosons) with Standard Model particles, using a statistical framework to analyze their parameters through various experimental probes.


<details>
  <summary>Details</summary>
Motivation: To extend the understanding of dark photons beyond a single instance to a multiple dark photon scenario, providing insight into their potential interactions with Standard Model particles.

Method: Employs a statistical approach to examine high-dimensional parameter spaces related to dark photon masses and kinetic mixing, considering various experimental setups to gauge their effects.

Result: Findings indicate that exploring multiple dark photons significantly alters the interpretations of experimental results and expands the theoretical landscape.

Conclusion: The study highlights the importance of considering multiple dark photons in future theoretical and experimental investigations of beyond Standard Model physics.
...
### [86] [Axial-Vector Lattice Benchmarks Reveal a Common Medium Response of Meson Screening in Hot QCD](https://arxiv.org/abs/2606.26245)
*Jie Ren,Chen Chen,Fei Gao,Si-xue Qin*

Main category: hep-ph

TL;DR: The study explores meson screening masses in hot QCD, combining lattice-QCD data with Dyson-Schwinger equations to analyze hadronic correlations and predict spectra for various quark flavors.


<details>
  <summary>Details</summary>
Motivation: To understand the dissolution of hadronic correlations in hot QCD and its implications for particle spectra.

Method: The research uses lattice-QCD benchmarks and symmetry-preserving Dyson-Schwinger equations to analyze meson screening masses and their flavor dependencies.

Result: Identified a flavor-dependent axial-vector quasi-free onset and a validated finite-interval medium response, confirming predictions of light, charm, and bottom-containing spectra.

Conclusion: The framework supports lower estimates for chiral partners and validates the findings through vector screening masses without external input.
...
### [87] [Double-real corrections to color singlet decay in a parton-shower inspired scheme](https://arxiv.org/abs/2606.26247)
*John M. Campbell,Stefan Höche,Max Knobbe*

Main category: hep-ph

TL;DR: This paper presents a local infrared subtraction method for calculating next-to-next-to-leading order QCD in color singlet decays, addressing overlapping singularities and ensuring finite results.


<details>
  <summary>Details</summary>
Motivation: The need for improved techniques in QCD calculations to handle overlapping singularities and ensure finiteness in higher-order processes.

Method: The authors develop a local infrared subtraction technique using scalar radiators and pure splitting functions, supplemented by numerical sector decomposition for phase-space integrals.

Result: The method successfully renders the double-real remainder for the process $e^+e^-\to\,q\bar{q}$ finite in unresolved limits and demonstrates improved numerical convergence in Monte-Carlo integrals.

Conclusion: The proposed approach effectively simplifies next-to-next-to-leading order calculations, enhancing computational feasibility in QCD analyses.
...
### [88] [Supercool with PPO: Exploring Supercooled Phase Transitions via Reinforcement Learning](https://arxiv.org/abs/2606.26251)
*Wan-Zhe Feng,Zong-Huan Ye,Zi-Hui Zhang*

Main category: hep-ph

TL;DR: A study using reinforcement learning to enhance the search for gravitational wave signals from phase transitions in dark sectors, demonstrating its efficiency over traditional methods.


<details>
  <summary>Details</summary>
Motivation: To probe hidden sectors and beyond the Standard Model physics using gravitational waves, while overcoming computational challenges in identifying relevant benchmark points.

Method: Introduced a reinforcement learning strategy based on Proximal Policy Optimization (PPO) to accelerate the search for gravitational wave signals, constructing an environment that maps model parameters to observables.

Result: PPO scans were shown to be more efficient than conventional Monte Carlo scans in identifying regions with substantial gravitational wave signals across parameter spaces.

Conclusion: PPO offers a goal-directed search approach for gravitational wave phenomenology and serves as a flexible framework for exploring high-dimensional scientific parameter spaces.
...
### [89] [Thermal Emission of Dark Photons from Earth's Core](https://arxiv.org/abs/2606.26253)
*Hooman Davoudiasl*

Main category: hep-ph

TL;DR: The paper explores dark photon production in the Earth's hot core and its implications for constraints on the kinetic mixing parameter, suggesting future experiments could significantly improve these constraints.


<details>
  <summary>Details</summary>
Motivation: To investigate the viability of dark photon production in a less extreme environment (the Earth's core) compared to stellar cores and its implications for dark matter interactions.

Method: The authors apply Earth core cooling arguments and analyze dark matter direct detection bounds from SENSEI and DAMIC-M experiments to estimate constraints on the kinetic mixing parameter $b$ for dark photons.

Result: Current experimental results place constraints on the kinetic mixing parameter $b$, with the Oscura experiment potentially improving these constraints by two to three orders of magnitude for dark photon masses around $10^{-4}$ eV.

Conclusion: The findings indicate significant room for exploration in dark photon parameter space, urging further experimental efforts to probe this regime.
...
### [90] [Kinetic freeze-out and diffusion dynamics in small-system asymmetric collisions at sqrt(sNN)=200 GeV in light of a generalized Fokker-Planck distribution](https://arxiv.org/abs/2606.26301)
*M. Waqas,Wolfgang Bietenholz,Khusniddin K. Olimov,Muhammad Ajaz,Jihane Ben Slimane,Laila A. Al-Essa,A. Haj Ismail*

Main category: hep-ph

TL;DR: This study uses a generalized Fokker-Planck solution to analyze the transverse momentum spectra of neutral pions in small asymmetric collisions, establishing a link between collision dynamics and thermal properties of the medium.


<details>
  <summary>Details</summary>
Motivation: To provide a comprehensive framework for understanding particle production and dynamics in small-system asymmetric collisions at high energies.

Method: Utilized a generalized Fokker-Planck solution to fit data from PHENIX experiment, extracting effective temperature and transition scales.

Result: The effective temperature increases with collision centrality and system size, from 0.33 GeV in peripheral $p$-Al to 0.45 GeV in central $^3$He-Au; established consistent transition scales across different systems.

Conclusion: The findings highlight the influence of collision dynamics on the thermal properties of the quark-gluon plasma and confirm the utility of the Fokker-Planck solution in interpreting pion spectra.
...
### [91] [Flavor Alignment and Mass Hierarchy: Doing Everything Scotogenically](https://arxiv.org/abs/2606.26319)
*Ernest Ma*

Main category: hep-ph

TL;DR: A renormalizable theory unifies flavor alignment and mass hierarchy in quarks through the dark sector, using only the standard model's Higgs doublet.


<details>
  <summary>Details</summary>
Motivation: To explore a theoretical framework that reconciles flavor alignment and mass hierarchy in quarks without expanding the Higgs sector.

Method: The authors propose a renormalizable theory that incorporates the dark sector, maintaining a single Higgs doublet from the standard model.

Result: The theory successfully achieves both flavor alignment and mass hierarchy within quarks, suggesting a potential pathway for further investigation in particle physics.

Conclusion: The findings indicate that it is possible to unify complex quark properties under specific theoretical constraints while adhering to existing model structures.
...
### [92] [An Ultraviolet Finite Theory of Scalars](https://arxiv.org/abs/2606.26450)
*Francesco Calisto,Clifford Cheung*

Main category: hep-ph

TL;DR: The paper presents a theory of scalars eliminating short-distance infinities through momentum-dependent interactions, achieving finite results for scalar self-energy and beta functions while having a variant with zero one-loop mass renormalization.


<details>
  <summary>Details</summary>
Motivation: To address the issue of short-distance infinities in scalar theories within perturbation theory.

Method: Utilizing momentum-dependent interactions that are ghost free and polynomially bounded to neutralize loop divergences.

Result: Finite computations for typical one-loop scalar self-energy and beta functions; a variant shows zero mass renormalization due to an inversion of ultraviolet and infrared sectors.

Conclusion: The proposed theory successfully avoids infinities in perturbation calculations, presenting a novel framework for scalar theories.
...
### [93] [Unitarity Cuts, t-channel Divergences and the KLN Theorem for Unstable Particles](https://arxiv.org/abs/2606.26586)
*Marko Beocanin,Michael A. Schmidt*

Main category: hep-ph

TL;DR: This paper addresses divergences in phenomenological calculations involving massless or unstable particles using the KLN theorem, providing practical prescriptions for its implementation and exploring technical challenges.


<details>
  <summary>Details</summary>
Motivation: To tackle divergences in calculations of massless or unstable particles and ensure finite, inclusive observables in particle physics.

Method: Studied KLN cancellation in a model with t-channel divergence, exploring various regularization schemes and the complex-analytic structure of amplitudes.

Result: Demonstrated intricate cancellations in multiple regularization approaches and made progress towards a finite, fixed-order t-channel collider observable.

Conclusion: The study underscores the utility of the KLN theorem while revealing technical challenges and unresolved questions in its practical application.
...
### [94] [Unified study of hyperon semileptonic decays in a relativistic three-quark model](https://arxiv.org/abs/2606.26596)
*Ru-Hui Ni,Zhen-Yang Wang,Jia-Jun Wu,Bing-Song Zou*

Main category: hep-ph

TL;DR: The paper presents a theoretical framework for studying semileptonic decays of octet hyperons using a relativistic three-quark model, emphasizing a parameter-free approach for calculating weak transition amplitudes and form factors, with results aligning well with existing experimental data.


<details>
  <summary>Details</summary>
Motivation: To explore semileptonic decays of octet hyperons using a theoretical model that integrates baryon wave functions determined from a semirelativistic potential model, aiming for accurate predictions without free parameters.

Method: A relativistic three-quark model is employed, where baryon wave functions are fixed by fitting to the mass spectrum. This leads to calculations of branching fractions, lepton flavor universality ratios, and a complete set of transition form factors for octet baryons.

Result: The branching fractions and lepton flavor universality ratios calculated from the model align with experimental data, particularly the $Λ	o p 	ext{e}^-arν_e$ channel, showing agreement with recent lattice QCD results and BESIII measurements for the $g_1/f_1$ ratio.

Conclusion: This study establishes a framework linking hyperon weak form factors to baryon structure at the quark level, paving the way for future experimental measurements of semileptonic decays.
...
### [95] [Holographic light-quark energy loss in a spinning plasma](https://arxiv.org/abs/2606.26598)
*Yan-Qing Zhao,Zhou-Run Zhu*

Main category: hep-ph

TL;DR: This study explores light-quark energy loss in a strongly coupled plasma using a spinning black-brane model. It employs falling-string and shooting-string probes to analyze energy loss dynamics influenced by temperature and rotation parameters.


<details>
  <summary>Details</summary>
Motivation: To understand the effects of rotation on light-quark dynamics in a holographic plasma setup, particularly regarding energy loss mechanisms.

Method: The authors use two techniques, falling-string and shooting-string, to compute the stopping distance and energy loss of light quarks in a rotating black-brane background.

Result: It was observed that higher temperature and increased rotation/boost parameter 'a' decrease stopping distance and increase energy loss, with a more significant effect on transverse motion.

Conclusion: The study highlights an anisotropic energy-loss pattern due to the spinning/boosted plasma, aligning with previous research on jet quenching and heavy-quark behavior in rotating environments.
...
### [96] [RG Running of Multiple Neutrino Mixing Parameters at Oscillation Experiments](https://arxiv.org/abs/2606.26720)
*Peter B. Denton,Shao-Feng Ge,Chui-Fan Kong,Pedro Pasquini*

Main category: hep-ph

TL;DR: The paper explores how new physics at low energy scales can influence neutrino oscillation experiments through renormalization group effects, suggesting the use of multiple experiments for parameter disentanglement.


<details>
  <summary>Details</summary>
Motivation: To explore the impact of new physics on neutrino oscillation experiments, particularly in scenarios where the new physics scale overlaps with the energy scales of these experiments.

Method: The authors adopt a model-independent framework to analyze the RG running effects across various neutrino oscillation experiments, focusing on different neutrino flavor combinations and their detection.

Result: The study shows heightened sensitivity to new physics effects when combining results from upcoming experiments like DUNE-ND, JUNO-TAO, and FASER$ν$2, particularly in managing degeneracies in parameter space.

Conclusion: Leveraging multiple neutrino interactions can provide insights into new physics through RG running effects, enhancing our understanding of flavor structures in neutrino physics.
...
### [97] [Torsional four-fermion interaction for Majorana neutrinos](https://arxiv.org/abs/2606.26676)
*Indrajit Ghose,Amitabha Lahiri*

Main category: hep-ph

TL;DR: This study analyzes how fermions influence spacetime torsion, leading to effective four-fermion interactions that can impact neutrino mass and behavior, particularly with sterile neutrinos.


<details>
  <summary>Details</summary>
Motivation: To explore the implications of fermion-induced spacetime torsion on neutrino mass and interactions, particularly within the context of the Type I SeeSaw mechanism and sterile neutrinos.

Method: The paper examines scenarios involving one sterile and one or two active neutrinos, considering both diagonal and non-diagonal interactions between torsion and mass fields, and analytically derives modifications to neutrino behavior.

Result: The study identifies new mixing parameters and potential contributions to neutrino mass from the torsion-induced terms, particularly emphasizing T violation in specific scenarios.

Conclusion: This research contributes to understanding the role of torsion in neutrino physics, suggesting that sterile neutrinos may have significant effects due to their interactions with four-fermion terms.
...
### [98] [CHESS: CHEbyshev pSeudo-Spectral transport for Feynman integral differential equations](https://arxiv.org/abs/2606.26691)
*Yuanche Liu,Yang Zhang*

Main category: hep-ph

TL;DR: The paper introduces CHESS, a Wolfram Language package for accurately solving one-dimensional transport of differential equations related to Feynman integrals using advanced numerical methods.


<details>
  <summary>Details</summary>
Motivation: To provide a high-precision solver for ε-factorized differential equations involved in Feynman master integrals, addressing the efficiency and accuracy of existing techniques.

Method: CHESS employs Chebyshev-Lobatto spectral collocation, along with sparse matrix assembly, sequential propagation in ε-expansion, and residue-based regularization at singular endpoints.

Result: The benchmarks demonstrate rapid convergence of nodes and alignment with independent reference data, achieving efficiency in computation times and memory usage.

Conclusion: The CHESS package shows significant improvements in efficiency for large multi-scale integral families, offering short processing times and comparable or lower memory usage in parallel runs.
...
### [99] [Coherent collective response in many-qubit systems for dark matter detection](https://arxiv.org/abs/2606.26736)
*Ryuichiro Kitano,Ryoto Takai*

Main category: hep-ph

TL;DR: The paper introduces a Ramsey-type interferometer using $N$ qubit superposition states to detect wave-like dark matter, achieving high sensitivity without needing entangled states.


<details>
  <summary>Details</summary>
Motivation: To develop a sensitive and scalable method for detecting dark matter using quantum sensing techniques.

Method: Utilizing an array of Ramsey-type interferometers with $N$ qubits in superposition states to measure the probability imbalance caused by dark matter-induced transitions.

Result: The proposed scheme achieves a signal-to-noise ratio proportional to $rac{
u}{ho} 	imes rac{eta 	imes 	heta}{	au}$, with sensitivity scaling $δα 	imes rac{1}{	au} eta 	imes 
u$.

Conclusion: The method surpasses existing detection limits and can be adapted for various quantum sensing technologies.
...
### [100] [Global analysis of a minimally extended scotogenic model](https://arxiv.org/abs/2606.26752)
*Huchan Lee,Sin Kyu Kang*

Main category: hep-ph

TL;DR: This paper analyzes a minimally extended scotogenic model to address non-zero neutrino masses and dark matter, focusing on vacuum stability and precision observables.


<details>
  <summary>Details</summary>
Motivation: To explore a minimally extended scotogenic model addressing non-zero neutrino masses, viable dark matter candidates, and the instability of the Standard Model vacuum at high energies.

Method: The study investigates conditions for boundedness, vacuum stability, renormalization group-driven perturbativity, and a range of flavor and electroweak precision observables through a numerical scan.

Result: Key findings include potential exclusion of inverted hierarchy by DESI BAO, expected feasibility of measuring oblique parameters, constraints on viable dark matter candidate mass, and compatibility of results with current experimental data at the 3σ level.

Conclusion: The analysis enhances understanding of the scotogenic model and its implications for dark matter and neutrino physics, while providing predictions for future experimental tests.
...
### [101] [Magnetic moments of decuplet baryons in isospin asymmetric magnetized strange matter](https://arxiv.org/abs/2606.26759)
*Hrishika P,Manpreet Kaur,Suneel Dutt,Harleen Dahiya,Arvind Kumar*

Main category: hep-ph

TL;DR: This study examines the in-medium properties of decuplet baryons in magnetized strange matter using a chiral effective framework.


<details>
  <summary>Details</summary>
Motivation: To understand the effects of dense, hot, and magnetized environments on baryon properties.

Method: Utilizes the chiral SU(3) quark mean-field model to obtain baryon masses, and the chiral constituent quark model to calculate magnetic moments, incorporating Landau quantization and sea effects.

Result: Findings reveal how medium conditions alter the masses and magnetic moments of decuplet baryons.

Conclusion: The research enhances our comprehension of baryon behavior in extreme environments, with implications for astrophysical contexts.
...
### [102] [Stochastic gravitational wave spectrum from cosmic string emitting gauge bosons and Majorana fermions](https://arxiv.org/abs/2606.26805)
*Nobuchika Okada,Osamu Seto*

Main category: hep-ph

TL;DR: This paper investigates how particle radiation affects the stochastic gravitational wave background from cosmic strings, particularly in a model involving Majorana fermions and Higgs fields, highlighting a high frequency cutoff in the SGWB spectrum.


<details>
  <summary>Details</summary>
Motivation: The study is motivated by the potential coupling of Majorana fermions to the Higgs field in a gauged $U(1)_{B-L}$ model, specifically identifying these fermions with right-handed neutrinos.

Method: The authors analyze the impact of particle radiation on the SGWB spectrum generated by cosmic strings in an Abelian-Higgs framework, incorporating energy loss mechanisms into their calculations.

Result: The findings reveal a significant alteration in the SGWB spectrum, particularly the emergence of a very high frequency cutoff as a result of particle radiation effects.

Conclusion: The research concludes that particle radiation plays a crucial role in shaping the characteristics of the SGWB from cosmic strings, suggesting new implications for cosmic string theories.
...
### [103] [Thermodynamical analysis of QGP using effective PNJL model with Quasiparticle approach](https://arxiv.org/abs/2606.26956)
...
TL;DR: The study enhances the thermodynamic modeling of quark-gluon plasma using a Two flavor PNJL model, integrating quasiparticle dynamics and temperature-dependent quark masses, with significant agreement found with lattice QCD results.


<details>
  <summary>Details</summary>
Motivation: The motivation is to improve the understanding of quark-gluon plasma thermodynamics using a more sophisticated model that incorporates the effects of quasiparticle masses and medium responses.

Method: The research employs an extended Two flavor PNJL model combined with a quasiparticle description for quarks and gluons, utilizing two variants (Quasiparticle Model-I and Model-II) to analyze key thermodynamic properties.

Result: The study demonstrates strong agreement with lattice QCD results, highlighting improvements over traditional PNJL models and illustrating the complementary nature of the two quasiparticle variants in understanding mass effects and medium dynamics.

Conclusion: The quasiparticle model enhances the PNJL framework, transitioning it from a descriptive to a more qualitative approach, thereby better capturing the dynamics of the strong interacting quark-gluon plasma.
...
### [104] [Hard-Region Fermion Self-Energy and Fermion--Photon Vertex in Thermal QED through Two Loops](https://arxiv.org/abs/2606.27137)
*Ali Hataei*

Main category: hep-ph

TL;DR: The paper computes contributions to the fermion self-energy and vertex in massless thermal QED, emphasizing hard-region effects and symmetries in the soft-momentum expansion.


<details>
  <summary>Details</summary>
Motivation: To advance understanding in massless thermal QED by calculating hard-region contributions and addressing the implications of chiral invariance and symmetry constraints.

Method: The authors compute the fermion self-energy and off-shell fermion--photon vertex at one-loop and two-loop levels, including zero-temperature counterterms, and analyze the contributions through symmetry constraints and decomposition of amplitudes.

Result: The findings show that hard-region self-energy corrections do not produce a finite contribution to the fermion damping rate, with results influencing mass shifts and inclusive rates for further theoretical developments.

Conclusion: This work offers critical insights for next-to-leading-order fermionic effective Lagrangian construction and enhances the understanding of the interplay between hard-region dynamics and chiral symmetry in thermal QED.
...
### [105] [StringSpinner 2.0: Enabling quark spin effects in PYTHIA for $e^+e^-$ annihilation](https://arxiv.org/abs/2606.27162)
*A. Kerbizi,L. Lönnblad*

Main category: hep-ph

TL;DR: The StringSpinner package is enhanced to replicate quark spin dynamics in high-energy processes, specifically for $e^+e^- ightarrow hadrons$ using the string+${}^3P_0$ model.


<details>
  <summary>Details</summary>
Motivation: To improve the simulation of quark spin effects in hadronization processes, aiding the understanding of spin correlations in particle production.

Method: Extended the StringSpinner package to handle spin correlations with a joint spin density matrix, applying the string+${}^3P_0$ model in simulations of $e^+e^-$ annihilation.

Result: The new version simulates spin effects and reproduces the Collins and Artru-Collins asymmetries; analysis of back-to-back pions showed good alignment with experimental data.

Conclusion: The enhanced StringSpinner package is a valuable tool for studying quark spin dynamics and validating theoretical predictions in high-energy physics.
...
### [106] [The Effect of Topological Defects and Magnetic Flux on Fully-Heavy Tetraquarks and Mass Spectra of Heavy Quarkonia Using the Analytical Exact Iteration Method](https://arxiv.org/abs/2606.27363)
*N. H. Gerish,M. Abu-Shady,E. M. Khokha*

Main category: hep-ph

TL;DR: This study explores the non-perturbative aspects of Quantum Chromodynamics (QCD) affecting heavy quarkonia and tetraquarks, utilizing an analytical method to derive energy levels influenced by topological defects.


<details>
  <summary>Details</summary>
Motivation: Understanding the intricacies of QCD in heavy quarkonia and fully-heavy tetraquarks is essential for advancing theoretical physics and experimental validation.

Method: The analytical exact iteration method (AEIM) computes eigenvalue solutions of the non-relativistic Schrödinger equation within a modified Cornell potential framework, factoring in topological defects and an external magnetic field.

Result: Energy levels were successfully computed for heavy quarkonia and inner configurations of tetraquarks, showing shifts due to topological defects and aligning with theoretical predictions and experimental data.

Conclusion: The study highlights the significant impact of geometry on mass hierarchies for exotic hadronic states, reinforcing consistency with theoretical models and experimental findings.
...
### [107] [Charged-lepton identification at Belle~II](https://arxiv.org/abs/2606.26274)
...
TL;DR: This paper discusses the algorithms used for particle identification in the Belle II experiment and presents their performance data from Run 1.


<details>
  <summary>Details</summary>
Motivation: To enhance particle identification capabilities, a strategic priority for the Belle II experiment.

Method: Algorithms were developed for identifying electrons and muons and differentiating them from charged hadrons, utilizing data from the SuperKEKB collider.

Result: Performance metrics were derived from the data collected during Run 1, amounting to 428 fb$^{-1}$ at specific center-of-mass energies.

Conclusion: The findings highlight the efficiency of the algorithms in distinguishing between various particle types, contributing to the success of the Belle II physics program.
...
### [108] [Precision luminosity measurement in proton-proton collisions at a center-of-mass energy of 13 TeV with the CMS detector at the Large Hadron Collider](https://arxiv.org/abs/2606.26832)
*CMS Collaboration*

Main category: hep-ex

TL;DR: CMS experiment achieves 0.73% precision in integrated luminosity measurement for 13 TeV proton-proton collisions, enhancing fundamental physics tests and future LHC studies.


<details>
  <summary>Details</summary>
Motivation: The need for precise integrated luminosity measurements to improve comparisons between theoretical predictions and experimental results in high-energy physics.

Method: Calibration of multiple independent monitors using beam-separation techniques and validation against Z boson production rates to control systematic uncertainties.

Result: Achieved total integrated luminosity precision of 0.73%, the highest ever at a bunched-beam hadron collider.

Conclusion: This precision enhances the capability to test the standard model and lays groundwork for future experiments at the High-Luminosity LHC.
...
### [109] [Calibration and Performance of proANUBIS: A proof-of-concept detector for the ANUBIS experiment](https://arxiv.org/abs/2606.26856)
...
TL;DR: The ANUBIS experiment aims to detect long-lived particles predicted by many extensions of the Standard Model through the use of new detector technology in the ATLAS cavern. Initial results from the proANUBIS detector confirm its efficiency and timing capabilities.


<details>
  <summary>Details</summary>
Motivation: To improve the detection of long-lived particles, which are potential dark matter candidates, by enhancing experimental sensitivity in the ATLAS cavern.

Method: The ANUBIS experiment uses Resistive Plate Chamber detectors installed in the ATLAS cavern's ceiling to reconstruct decay vertices of long-lived particles based on $pp$ collision data from the LHC.

Result: The proANUBIS detector's performance, including detection efficiency and timing resolution, has been validated against expectations and satisfies ANUBIS's performance criteria.

Conclusion: The proANUBIS detector effectively meets the objectives set for the future ANUBIS experiment, confirming its capability for detecting long-lived particles.
...
### [110] [Projected sensitivity of the ANUBIS detector to heavy neutral leptons](https://arxiv.org/abs/2606.26862)
*Martin Bauer,Rachel Bentham,Oleg Brandt,Sofie Nordahl Erner,Anna Mullin,David Peng,Theo Reymermier,Paul Swallow*

Main category: hep-ex

TL;DR: The ANUBIS detector enhances ATLAS sensitivity to long-lived particles (LLPs), particularly heavy neutral leptons (HNLs), demonstrating notable reach in HNL parameter-space with potential for further improvements.


<details>
  <summary>Details</summary>
Motivation: The study aims to address gaps in the Standard Model by exploring the sensitivity of new experimental setups to long-lived particles, specifically heavy neutral leptons, which are relevant for various extensions to the SM.

Method: ANUBIS is integrated into the ATLAS cavern at LHC to measure sensitivity projections for HNLs, using the SET-ANUBIS framework to evaluate different LLP models and analyze data.

Result: For a minimal Majorana HNL model, ANUBIS achieves maximum sensitivities of $|V_{1e}|^2=1.8\times10^{-8}$ and $|V_{1μ}|^2=1.9\times10^{-8}$ at HNL masses close to 6.4 GeV and 6.3 GeV, respectively.

Conclusion: ANUBIS provides complementary coverage in the HNL parameter-space, with significant potential for improvements in sensitivity through innovative analysis strategies during data-taking.
...
### [111] [Study of Supernova Neutrinos at ESSnuSB](https://arxiv.org/abs/2606.27007)
...
TL;DR: The paper analyzes the ESSnuSB far detector's sensitivity to supernova neutrinos, assessing expected event rates for different flux models and the impact of systematic errors and detector efficiency.


<details>
  <summary>Details</summary>
Motivation: To evaluate the potential of the ESSnuSB experiment in detecting and distinguishing supernova neutrino events during its runtime.

Method: Estimated event rates at the ESSnuSB detector for three supernova flux models and examined the capability to differentiate between these models considering systematic errors and detector efficiency.

Result: The expected number of detected events varies significantly with the neutron flux model and depends on factors like distance from the explosion and systematic errors.

Conclusion: The ESSnuSB far detector has strong potential to distinguish between various supernova neutrino flux models.
...
### [112] [High Multiplicity Trigger for Long-Lived Particles in CMS detector](https://arxiv.org/abs/2606.27165)
...
TL;DR: The CMS experiment has introduced a High Multiplicity Trigger (HMT) to enhance the detection of long-lived particles (LLPs) during LHC Run 3 by efficiently selecting events with high hit multiplicity in the muon detectors.


<details>
  <summary>Details</summary>
Motivation: Traditional trigger strategies struggle with unconventional event topologies related to LLPs, necessitating a more effective detection method during LHC Run 3.

Method: The HMT was developed to identify events with a high number of hits in the CMS CSC muon detectors, optimizing hit multiplicity thresholds to manage trigger rates under high-luminosity conditions while maintaining efficiency across various LLP lifetime scenarios.

Result: The performance of the HMT was assessed using simulated samples and actual LHC data, demonstrating significant improvement in CMS's sensitivity to LLP signatures.

Conclusion: The HMT enhances the ability to search for LLP decays, providing a robust platform for exploring physics beyond the Standard Model.
