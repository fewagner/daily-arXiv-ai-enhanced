...
TL;DR: This paper addresses challenges in characterizing nonequilibrium dynamics in integrable quantum systems, specifically using the Rule 201 quantum cellular automaton. It develops local conditions for exact local dynamics solutions and proposes a numerical bootstrap method for influence matrices, revealing a variety of nonequilibrium behaviors and initial-state dependencies.


<details>
  <summary>Details</summary>
Motivation: The paper aims to tackle the difficulty of characterizing nonequilibrium dynamics in integrable systems, an area that remains less understood compared to equilibrium properties.

Method: Utilizing the influence matrix tensor-network approach, the paper introduces generalized zipper conditions for solving local dynamics and develops a numerical bootstrap method for influence matrices.

Result: The study uncovers complex nonequilibrium behaviors influenced by initial states, shows persistent oscillations in the presence of local perturbations, and reveals entanglement growth characteristics for various initial conditions.

Conclusion: The research provides a comprehensive framework for examining both nonthermalizing and thermalizing dynamics in integrable systems, with practical implications for experiments using advanced quantum simulators.
...
TL;DR: The paper reviews operational approaches to quantum foundations, focusing on indefinite causal orders in quantum processes and their implications for information processing.


<details>
  <summary>Details</summary>
Motivation: The drive for understanding causality in quantum theory, its relationship with general relativity, and applications in higher-order quantum computing.

Method: The paper discusses the process matrix formalism to describe indefinite causal order in quantum processes.

Result: Highlights key results and experimental implementations related to indefinite quantum causality.

Conclusion: The review summarizes the current advancements and potential applications of indefinite causal orders in quantum information science.
...
TL;DR: This paper presents an efficient classical method for preparing multi-reference CAS states in quantum computing, significantly reducing the complexity of state preparation.


<details>
  <summary>Details</summary>
Motivation: Quantum computing can effectively solve the electronic structure problem, particularly for molecules with strong electron correlation, but efficient state preparation remains a challenge.

Method: The authors introduce the Quantum Paldus Transform (QPT) to represent CAS states in a symmetry-adapted basis, which can be efficiently expressed as a matrix product state (MPS) with polynomial bond dimension.

Result: The new state preparation routine reduces complexity to O(d^3), showing an exponential improvement over prior methods.

Conclusion: The proposed method enables efficient preparation of CAS states, facilitating their use in quantum computing and enhancing the feasibility of studying complex molecular systems.
...
TL;DR: This paper investigates the impact of q-deformation and h-deformation on multi-qubit systems and compares the resulting states with standard quantum states, revealing distinct behaviors between the two deformations.


<details>
  <summary>Details</summary>
Motivation: To understand how different deformations of the Hopf algebra affect quantum states and correlations in multi-qubit systems, linking theoretical constructs with experimental applications.

Method: Constructs states using Clebsch-Gordan coefficients from the deformed algebras and calculates fidelities with undeformed states for both few-qubit and macroscopic systems.

Result: The study finds that q-deformation leads to a smooth modification of states with residual overlap, while h-deformation results in rapid orthogonality to undeformed states. Both require N^{-1} rescaling for fidelity stability as N approaches infinity.

Conclusion: The findings highlight the differing effects of q- and h-deformation on quantum states, providing important insights for quantum information applications.
...
TL;DR: This paper investigates how heralding techniques expand the range of accessible quantum states in photonic linear optical networks by analyzing the rank of the output state's Jacobian, focusing on local controllability.


<details>
  <summary>Details</summary>
Motivation: The paper aims to address the limitations of passive linear optics in generating quantum states and to explore the impact of ancillary resources on state reachability through heralding techniques.

Method: The authors analyze the Jacobian of the output state with respect to the unitary circuit to quantify the dimension of the accessible tangent space, comparing passive linear optics to heralded linear optics.

Result: The study shows how different ancillary resources can increase local accessibility of states and identifies the resources required to achieve maximum Jacobian rank, suggesting conditions for local and global reachability.

Conclusion: The framework developed allows for systematic assessment of the state space in measurement-based photonic architectures, providing criteria for resources needed in high-dimensional quantum state engineering.
...
### [6] [Optimized Quantum States for Sensing in the Presence of Loss and Phase Noise](https://arxiv.org/abs/2606.19649)
*Shruti Maliakal,Zachary Mann,Christopher Wipf,Rana X Adhikari,Su Direkci,Yanbei Chen*

Main category: quant-ph

TL;DR: Squeezed vacuum states can enhance quantum sensor performance over Gaussian states despite phase noise. Non-Gaussian states, categorized into Fock-like, cubic-phase-like, and discrete symmetry states, show superior performance, achieving up to 2.2 dB advantage under specific loss and noise conditions.


<details>
  <summary>Details</summary>
Motivation: To overcome the limitations imposed by phase noise in quantum sensing and improve the performance of gravitational-wave detectors.

Method: Numerical optimization of quantum Fisher information across loss and phase noise, identifying non-Gaussian states that outperform Gaussian states.

Result: Achieved a non-Gaussian advantage of up to 2.2 dB in specific conditions (5% photon loss, 200 mrad phase noise) with a maximum input photon number of 5.

Conclusion: Non-Gaussian states can significantly enhance measurement precision, even in the presence of phase noise and with homodyne detection strategies.
...
TL;DR: The paper presents a family of quantum low-density parity-check codes that utilize planar layouts and nearest-neighbour gates, achieving significant improvements in fault-tolerant quantum computation without the need for long-range connectivity.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of implementing high-performance quantum low-density parity-check codes in superconducting architectures, which typically require long-range connectivity.

Method: The authors introduce a new code family using planar open-boundary layouts and nearest-neighbour iSWAP walks to dynamically generate check-data connectivity, maintaining optimal constant-depth stabiliser measurement.

Result: Finite-size instances, such as a [[323,14,15]] code, show a remarkably higher code-efficiency ratio compared to rotated surface codes, with significant reductions in logical error rates.

Conclusion: The findings suggest that quantum low-density parity-check codes can be effectively implemented in planar nearest-neighbour circuits, enhancing the viability of low-overhead fault-tolerant quantum memories for near-term hardware.
...
TL;DR: This work introduces a computationally efficient, control-free algorithm for learning an ansatz-free Hamiltonian using Pauli product state preparation and measurement, optimizing evolution time for quantum systems.


<details>
  <summary>Details</summary>
Motivation: Characterizing Hamiltonians is crucial for quantum device operations but existing methods are impractical for near-term experiments due to reliance on complex protocols and precision requirements.

Method: The proposed algorithm employs a randomized-sampling framework integrating band-limited kernel-based time sampling and a displacement sieve, achieving optimal evolution time without needing deep circuits or controls.

Result: The algorithm learns Hamiltonians with total evolution time optimal for control-free protocols, and adapts well under SPAM noise conditions for local Hamiltonian after calibration.

Conclusion: This method offers a practical approach to Hamiltonian learning, enabling rigorous in situ characterization of quantum systems while being suitable for high-precision applications.
...
TL;DR: The paper investigates the relationship between entanglement and algorithmic performance in variational quantum algorithms, focusing on QAOA applied to the MaxCut problem.


<details>
  <summary>Details</summary>
Motivation: To understand how entanglement impacts problem structure and algorithm effectiveness in near-term quantum algorithms like QAOA.

Method: The authors analyze QAOA on the MaxCut problem, studying the effects of variational parameter training and utilizing a high-performance optimizer to assess entanglement behavior.

Result: They find that suboptimal training alters entanglement observables, while a suitable optimizer reveals QAOA's entanglement scaling akin to fermionic Gaussian states over various MaxCut instances.

Conclusion: The study highlights distinct entanglement scaling between QAOA and adiabatic quantum computation, emphasizing entanglement's role in computational efficiency and problem characteristics.
...
TL;DR: The GKLS equation can't provide an exact description of quantum systems under regular energy conditions; it shows linear decay in dissipation, while survival probability exhibits sublinear decay.


<details>
  <summary>Details</summary>
Motivation: To explore the limitations of the GKLS equation in characterizing open quantum systems under realistic energy conditions.

Method: Analyzed the decay properties of the open-system survival probability and compared them with the decay characteristics of GKLS semigroups.

Result: Survival probability decays sublinearly, contrasting with the linear decay exhibited by dissipative GKLS semigroups, indicating the necessity of singular energy resources for Markovian dissipation.

Conclusion: The GKLS equation is an effective but not exact description of quantum dynamics when adhering to physically regular energy constraints.
...
TL;DR: Presents a novel method using autonomous distinction machines ($\mathsf{MAD}$) for distinguishing multi-time quantum processes, optimizing memory use and process evaluation.


<details>
  <summary>Details</summary>
Motivation: The need for efficient methods to distinguish multi-time quantum processes that require coherent memory and time-dependent control.

Method: Introduces $\mathsf{MAD}$s, a strategy employing the same quantum instrument at each step while retaining classical outcomes and optimizing coherent memory to define a new distinguishability measure.

Result: Proves the hierarchy of $\mathsf{MAD}$ is monotone in coherent memory and can match the strategy-norm benchmark, providing a tractable way to evaluate distinguishability.

Conclusion: $\mathsf{MAD}$ distinguishability offers a scalable framework for understanding multi-time quantum processes under constraints of coherent memory.
...
TL;DR: The paper examines the decision problem related to non-identity Pauli matrices and their trace with a quantum state. If the problem is solvable in BQP, it implies NP problems can also be solved in BQP. This helps clarify the absence of efficient methods for finding coefficients of quantum states in the Pauli basis under certain complexity assumptions.


<details>
  <summary>Details</summary>
Motivation: To explore the feasibility of efficiently determining certain characteristics of quantum states through the lens of complexity theory, particularly focusing on the decision problem involving Pauli matrices and their traces with quantum states.

Method: The paper analyzes the problem using reductions from the minimum-weight code problem and investigates the implications of this problem being in QCMA and what it implies for the relationship between complexity classes BQP and NP.

Result: The study establishes that the problem is in QCMA and demonstrates that if it lies in BQP, then it leads to the conclusion that NP is a subset of BQP. It also confirms the non-existence of efficient methods to perform quantum state tomography for coefficients in the Pauli basis under certain assumptions.

Conclusion: The findings offer a resolution to an open question in quantum computing, indicating that efficient tomographic procedures for quantum states in the Pauli basis cannot exist under the standard assumption that NP does not fit within BQP.
...
TL;DR: This paper introduces a Bell-state extension of Loop-Back quantum key distribution (QKD) that allows secure key establishment between two passive users without the need for quantum transmitters or detectors, relying solely on an active station to provide entangled states.


<details>
  <summary>Details</summary>
Motivation: The motivation is to enhance the security and efficiency of QKD protocols by utilizing a Bell-state framework, enabling secure transmissions even when all users are passive.

Method: The proposed architecture involves a single active station (Alice) who generates a Bell pair, retains one qubit, and sends the traveling qubit through two passive users (B1 and B2), who apply local Pauli operations. Alice later measures the Bell state to determine the effective operation applied.

Result: The protocol allows Alice to deterministically identify the effective combined operation applied by the passive users, while keeping individual user operations hidden, thereby enabling secure key establishment with enhanced capabilities compared to traditional single-qubit schemes.

Conclusion: The Bell-state implementation offers improved security and efficiency for guided key establishment, emphasizing the need for careful protection of passive modulators against potential attacks.
...
TL;DR: Electric field noise in ion traps varies significantly and is influenced by nearby microscopic particles, affecting quantum computing fidelity.


<details>
  <summary>Details</summary>
Motivation: To elucidate the unclear microscopic origins of electric field noise in ion traps that impact quantum computing operations.

Method: Measurement of electric field noise along the symmetry axis of a linear surface Paul trap, combined with optical and scanning electron microscopy to observe adjacent particles, and modeling these particles as lossy dielectrics.

Result: Noise levels varied by three orders of magnitude over a 600$\,μ$m segment, correlating high noise with the presence of micron-sized particles, modeled effectively as lossy dielectrics.

Conclusion: The findings may account for the discrepancies in reported electric field noise levels across different studies.
...
TL;DR: This study presents a quantum-classical method for optimizing emergency operation center placement in disaster response, formulating it as a graph problem and demonstrating effective solutions using quantum technology.


<details>
  <summary>Details</summary>
Motivation: The research addresses the need for efficient emergency response by optimizing the placement of operation centers to quickly cover affected areas during disasters.

Method: A hybrid quantum-classical approximation framework utilizing neutral-atom quantum computers to sample independent sets, which are refined to generate candidate dominating sets for the problem.

Result: The approach was successfully benchmarked on synthetic data and real case studies, solving up to 100-node instances on a quantum processor, yielding near-optimal solutions despite hardware noise.

Conclusion: The findings indicate that analog-mode neutral-atom quantum devices can be effectively employed for real-world graph optimization problems.
...
TL;DR: This paper introduces a pipelined execution framework for fault-tolerant quantum computation that decomposes logical operations, introduces speculation strategies, and shows significant reductions in total pipeline steps with improved load balancing.


<details>
  <summary>Details</summary>
Motivation: To improve efficiency in fault-tolerant quantum computation by addressing the sequential operation and idling in classical control logic and quantum hardware.

Method: The framework breaks down logical operations into Control, Execute, and Decode stages, employing speculation strategies to initiate successor operations early.

Result: Pipelining with speculation reduces total pipeline steps by 20-40% and improves load balancing, despite occasional partial rollbacks.

Conclusion: Aggressive speculation strategies outperform conservative ones because they yield higher parallelism, effectively utilizing idle time.
...
TL;DR: This paper explores quantum computing methods to study the dynamics of a (2+1)D U(1) pure gauge theory by implementing a quantum link model, yielding effective calculations of string dynamics and confirming results through digital quantum simulations.


<details>
  <summary>Details</summary>
Motivation: The study of string dynamics in confining gauge theories is critical for advancing quantum computing applications, particularly in simulating non-perturbative effects.

Method: A minimal U(1) quantum link model is implemented on a quantum computer, utilizing qubits to represent dual height variables. The lattice geometry is tailored for IBM quantum hardware to reduce non-adjacent qubit interactions, enabling real-time dynamics calculations beyond traditional quantum Monte Carlo methods.

Result: The quantum quenches performed display good agreement with tensor-network calculations and thermal averages, with experimental results from digital quantum simulations showing accurate predictions even near the phase transition, despite fluctuations in the string dynamics.

Conclusion: The findings illustrate the potential of quantum computing to effectively simulate non-perturbative behaviors in gauge theories, with acceptable accuracy levels in challenging regimes.
...
TL;DR: Subsystem error correction simplifies metrological protocols by using fewer ancilla qubits while achieving the Heisenberg limit.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of existing quantum error correction methods that require multiple noiseless ancillae and lack efficient encoding/decoding.

Method: Developed subsystem stabilizer codes and derived general conditions for achieving the Heisenberg limit with syndrome-free protocols using a single ancilla qubit.

Result: Demonstrated that subsystem error correction can significantly streamline metrology, enhancing precision under noise conditions, and extended the framework to dynamical error correction with Floquet codes.

Conclusion: Subsystem error correction represents a promising advancement for efficient quantum metrology, maintaining high precision with reduced resources.
...
TL;DR: This paper establishes a foundational framework for quantum dynamics based on axioms regarding observables and isospectral evolution, leading to the derivation of key quantum equations and concepts.


<details>
  <summary>Details</summary>
Motivation: To derive the fundamental equations of quantum mechanics from a minimal set of axioms related to observables without assuming a Hamiltonian.

Method: The authors employ an axiomatic approach, asserting that time evolution is a continuous flow of Hermitian observables that preserves spectra, and utilize Lax pair theory as a bridge to standard quantum evolution.

Result: The approach successfully derives the Heisenberg equation and Schrödinger equations as theorems, demonstrating that many quantum principles emerge naturally from the chosen axioms.

Conclusion: This work illustrates that standard quantum dynamics can be reconstructed from minimal assumptions, with a novel perspective on the role of the Hamiltonian as an emergent property rather than a primary postulate.
...
TL;DR: The paper presents a method of topological quantum interferometry using an interaction-based geometric phase for improved characterization of high-dimensional quantum states.


<details>
  <summary>Details</summary>
Motivation: To address limitations in current characterization methods of structured light, which fail to account for spatial mode evolution and typically require precise experimental conditions.

Method: Introduce the exchange Berry phase (BPX) as a geometric marker for spatial interference, enabling generalization of state generation and characterization with arbitrary topological charges in varying conditions.

Result: BPX allows decomposing two-photon spatial patterns into fundamental modes determined by geometric properties, revealing topological invariants and singularities that aid in estimating state dimensionality without full reconstruction.

Conclusion: This scalable, device-independent approach enhances high-dimensional characterization and supports applications in quantum metrology and quantum networks.
...
TL;DR: The paper investigates sparse positive maps on qutrits and establishes exact boundaries for positivity, decomposability, and PPT entanglement for specific families, detailing relationships and thresholds between separability and entanglement.


<details>
  <summary>Details</summary>
Motivation: To analyze the intricate relationships between positivity, decomposability, and PPT entanglement in qutrits using sparse positive maps that offer explicit structural insights.

Method: The study employs the block structure of Choi matrices to simplify the positivity analysis into a Hermitian biquadratic form, identifying transition points for decomposable vs. non-decomposable maps and constructing PPT states.

Result: Exact positivity boundaries and transition thresholds between different classes of maps are determined, alongside constructs for witness-adapted deformations and analytically manageable families under fixed positive maps.

Conclusion: The findings clarify the distinctions between various types of positivity within sparse maps and provide explicit thresholds for evaluating separability and bound entanglement.
...
TL;DR: This study introduces an adiabatic passage method to enhance biphoton fidelity in topological waveguide arrays despite structural disorder, preserving quantum properties and improving robustness for quantum information processing.


<details>
  <summary>Details</summary>
Motivation: The study addresses the limitations of topological waveguide arrays in nonlinear biphoton generation, particularly how structural disorder can degrade the quantum properties of generated states.

Method: The authors propose an adiabatic passage connecting an isolated site to a topological defect array, which initiates nonlinear processes in a controlled manner to suppress unwanted modes and maintain quantum fidelity.

Result: Numerical simulations show that the adiabatic scheme achieves high biphoton fidelity and a unit Schmidt number even with waveguide gap disorder, outperforming conventional topological structures.

Conclusion: The proposed method serves as an effective design strategy for enhancing the robustness of integrated quantum photonic devices against fabrication imperfections.
...
TL;DR: QMCtwin is a quantum Monte Carlo framework for simulating quantum error correction circuits, addressing limitations of conventional noise models in accurately representing syndrome statistics.


<details>
  <summary>Details</summary>
Motivation: As quantum error correction scales, accurate translation of hardware noise into syndrome statistics is crucial for effective decoding.

Method: A quantum Monte Carlo framework (QMCtwin) simulates master-equation dynamics during syndrome extraction in a distance-7 rotated surface code using realistic noise models.

Result: QMCtwin reveals syndrome-extraction biases and correlations that are not captured by standard Pauli-twirled models, providing detailed comparisons and insights into noise effects.

Conclusion: This framework enhances the accuracy of syndrome models in quantum error correction by exposing features overlooked in conventional models.
...
TL;DR: This paper introduces qutrit random cubic codes that maintain the no-string property and improve self-correction mechanisms in quantum error-correcting codes, diverging from traditional fracton codes.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of passive self-correcting quantum error-correcting codes caused by string logical operators.

Method: Introducing a family of local qutrit Calderbank-Shor-Steane stabilizer Hamiltonians, which maintain a cube-check structure similar to Haah's Codes but with spatially varying stabilizers.

Result: The qutrit random cubic codes retain the no-string property and exhibit unique characteristics, such as differing ground-state degeneracy exponents and the absence of self-similar fractal logical operators.

Conclusion: Constrained randomness in the construction of quantum codes can enhance self-correction properties, suggesting a pathway to explore broader quantum error-correcting codes and phases.
...
TL;DR: The paper explores ancilla-assisted work extraction in quantum batteries, emphasizing the role of bound energy and purity in predicting and maximizing daemonic gain.


<details>
  <summary>Details</summary>
Motivation: To understand the relationship between bound energy, purity, and daemonic gain in quantum batteries and improve work extraction protocols.

Method: Analysis of the role of bound energy and purity, introduction of a purity-based gain without explicit optimization, and exploration of dissipation and interactions effects under varied environments.

Result: Bound energy serves as a tight upper limit for daemonic gain in pure systems; purity-based gain predicts this without optimization; dissipation enhances gain in correlated environments, while interactions reshape accessible gains.

Conclusion: Daemonic gain is influenced by both system correlations and the spectral characteristics of the Hamiltonian, linking energy bounds and purity metrics.
...
TL;DR: This paper presents two regularizers for reliable quantum control in open systems under decoherence, outperforming traditional methods.


<details>
  <summary>Details</summary>
Motivation: To improve quantum control amid environmental noise and decoherence effects.

Method: Introduced two regularizers (Wiener KL and drift-variance) based on Girsanov's theorem to estimate KL divergence and drive states towards minimal decoherence effects.

Result: The regularizers showed significant improvements in final-state fidelity and robustness across various open quantum systems and conditions, reducing infidelity up to 50%.

Conclusion: These regularizers enhance quantum control by focusing on observable effects of decoherence, outperforming traditional methods.
...
TL;DR: This paper explores a hybrid Kitaev ladder with two superconducting chains featuring different pairing interactions, revealing a complex topological phase diagram with Majorana and Dirac modes.


<details>
  <summary>Details</summary>
Motivation: The paper aims to understand the effects of distinct pairing interactions in hybrid Kitaev systems on topological phenomena, particularly with long-range pairing.

Method: The authors analyze a hybrid Kitaev ladder consisting of two superconducting chains—one with conventional $p$-wave pairing and the other with long-range pairing—calculating the influence of inter-leg coupling on topological properties.

Result: The study uncovers a rich topological phase diagram including multiple Majorana zero modes and massive Dirac modes, showing transitions and coexistence of these states dependent on parameters like the long-range pairing exponent.

Conclusion: This research suggests that long-range hybrid systems can be engineered to create tunable topological states, which may have significant applications in quantum information.
...
TL;DR: This paper presents a method for independent dual sensing of temperature and magnetic fields using quantum emitters in hexagonal boron nitride, overcoming challenges in simultaneous measurements.


<details>
  <summary>Details</summary>
Motivation: The need for simultaneous quantum sensing of multiple parameters in various applications drives the exploration of new methods and materials.

Method: The authors utilize single quantum emitters in hBN to independently measure the zero-phonon line (ZPL) for temperature and optically detected magnetic resonance (ODMR) for magnetic fields.

Result: They experimentally confirm the independent responses of ZPL to temperature and ODMR to magnetic fields, demonstrating effective local temperature sensing of a microcircuit alongside magnetic field measurements.

Conclusion: Quantum emitters in hexagonal boron nitride offer a promising platform for multifunctional quantum sensing effective in realistic conditions.
...
TL;DR: This paper resolves the minimal measurement bases needed for optimal shadow estimation, proving that Θ(d^2) are necessary for worst-case scenarios, while only Θ(d) are sufficient for average-case optimality, leading to significant implications in quantum information theory.


<details>
  <summary>Details</summary>
Motivation: Understanding the minimal measurement requirements for optimal quantum property estimation improves efficiency in quantum computing practices.

Method: The authors prove the necessity and sufficiency of Θ(d^2) measurement bases for worst-case outcomes, while also demonstrating that state 2-designs are sufficient for average case optimal performance, backed by strong concentration results.

Result: The paper establishes a complexity separation: Θ(d^2) bases are essential for worst-case shadow estimation, whereas Θ(d) bases suffice for average-case performance, with confirmed concentration and constant sample complexity results.

Conclusion: The findings highlight crucial distinctions between worst-case and average-case measurement strategies in shadow estimation, suggesting implications for future quantum information experiments.
...
TL;DR: This paper highlights the application of Peres lattices in periodically driven quantum systems for analyzing resonances, chaos onset, and Floquet modes.


<details>
  <summary>Details</summary>
Motivation: To extend the use of Peres lattices, traditionally employed in stationary systems, to periodically driven quantum systems.

Method: Utilizing Peres lattices to detect resonances, monitor chaos, and study Floquet modes across different driving Hamiltonians.

Result: Efficient identification of critical properties and spectral comparisons of Floquet modes, validating iterative approximation techniques.

Conclusion: The method proves advantageous for exploring the dynamics of periodically driven quantum systems.
...
TL;DR: This study evaluates the variational quantum eigensolver (VQE) using higher-order binary optimization (HOBO) for solving the traveling salesperson problem (TSP), showing that an all-valid-state HOBO approach enhances performance on noisy intermediate-scale quantum (NISQ) devices.


<details>
  <summary>Details</summary>
Motivation: The study is motivated by the need to apply quantum computing advancements to real-world NP-hard problems, particularly in delivering efficient solutions for practical applications like the traveling salesperson problem (TSP).

Method: The authors develop an all-valid-state HOBO (AVS-HOBO) encoding to address TSP instances using VQE, conducting simulations and real hardware experiments to analyze performance under various conditions, including error mitigation.

Result: AVS-HOBO encoding significantly improves energy convergence behavior and increases the scalability of VQE for larger TSP instances, outperforming original HOBO encoding in key metrics.

Conclusion: The findings suggest that AVS-HOBO enhances the reliability and efficiency of VQE for quantum optimization problems, indicating its potential for broader applications in constrained quantum optimization.
...
TL;DR: Wei's TFSE effectively simulates non-Markovian quantum dynamics, revealing an acceleration mechanism influenced by environmental memory effects, outperforming Naber's TFSE in accuracy and efficiency.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics of non-Markovian quantum systems and optimize their evolution speed by using an advanced mathematical framework.

Method: Utilizing Wei's Time-Fractional Schrödinger Equation (TFSE) for simulating the Resonant Dissipative Jaynes-Cummings model and solving the Quantum Speed Limit time for a single-qubit open system.

Result: Demonstrated that system evolution can be accelerated through the fractional order, coupling strength, and photon number; Wei's TFSE captures non-Markovian effects across all fractional orders, unlike Naber's TFSE.

Conclusion: Wei's TFSE is superior in accurately and efficiently simulating the accelerated dynamics of non-Markovian quantum systems.
...
TL;DR: This paper introduces Mirror Quantum Awesomeness (MQA), a protocol that enhances Mirror Randomized Benchmarking (MRB) by adding a structured entangling layer to track correlation dynamics, leading to the identification of critical circuit depths for error mitigation.


<details>
  <summary>Details</summary>
Motivation: To improve the error metrics of quantum processing units (QPUs) and to analyze quantum circuits' performance more effectively by incorporating entanglement structures into traditional benchmarking methods.

Method: MQA adds an entangling layer to MRB circuits and uses mutual information to track correlation dynamics, while also introducing a topological variant, Topological MQA, which includes a decoder based on surface-code decoding.

Result: The analysis identifies a critical circuit depth for effective error mitigation, validated in simulations and on real QPU processors, showing that MQA aligns closely with MRB for entanglement infidelity measures.

Conclusion: MQA and its topological variant provide new insights into error metrics and critical thresholds in quantum circuits, reinforcing the importance of entanglement in benchmarking quantum systems.
...
TL;DR: This paper presents a methodology for optimizing Noisy Intermediate-Scale Quantum (NISQ) algorithms, focusing on balancing accuracy and resource costs.


<details>
  <summary>Details</summary>
Motivation: To enable quantum algorithms to reach optimal performance with minimal resource expenditure, especially in the context of noisy hardware.

Method: Developed a phenomenological model based on simulations of a Variational Quantum Eigensolver (VQE) to analyze the trade-offs between algorithm accuracy, resource costs, and noise.

Result: Identified a 'sweet spot' for circuit size and iterations that minimizes resource costs while achieving desired accuracy, as well as maximum accuracy for a fixed cost.

Conclusion: The methodology offers practical guidelines for deploying variational algorithms on realistic noisy quantum hardware, facilitating the use of error mitigation strategies.
...
TL;DR: The paper presents a computational framework to optimize single-photon sources by balancing purity, brightness, and indistinguishability, achieving nearly 60% design success in complex scenarios.


<details>
  <summary>Details</summary>
Motivation: The need for high-quality single-photon sources for photonic quantum platforms and the challenges in balancing performance metrics in their design.

Method: A computational framework utilizing Liouville-space adjoint formulation and a Jacobian-based update, combined with simulated annealing for effective optimization in open quantum systems.

Result: Achieved a design success rate of nearly 60% for photon blockade with low multiphoton emission and theoretically bounded brightness across diverse parameters.

Conclusion: The proposed framework offers a systematic approach for the multi-objective design of open quantum systems.
...
TL;DR: This paper presents a modified Quantum Annealer Eigensolver to compute magnetic dipole hyperfine structure constants for alkali-like atoms, achieving results aligned with established methods.


<details>
  <summary>Details</summary>
Motivation: The research aims to enhance the calculation of hyperfine structure constants for neutral and Li-like alkali metals using quantum computing techniques.

Method: A modified Quantum Annealer Eigensolver (QAE) algorithm was utilized, employing a zooming-and-sigma-annealing approach and a floating-point encoding scheme to analyze ground-state eigenvalues and eigenvectors from relativistic Dirac-Coulomb Hamiltonian matrices.

Result: The results from the QAE were benchmarked against MCDHF calculations, showing consistency within the 3 decimal places of precision for magnetic dipole HFS constants across different atomic systems and matrix sizes.

Conclusion: The modified QAE effectively provides reliable estimates of hyperfine structure constants using quantum computing, showcasing its potential in advanced atomic structure calculations.
...
TL;DR: The Grover Adaptive Search Self-consistent Field (GAS-SCF) algorithm utilizes quantum arithmetic for efficient state marking, yielding a quadratic speed-up in self-consistent field optimization in quantum chemistry.


<details>
  <summary>Details</summary>
Motivation: To improve optimization efficiency in self-consistent field quantum chemistry using quantum algorithms.

Method: GAS-SCF employs quantum arithmetic to create an oracle for marking target Fock states and applies amplitude amplification to enhance state measurement probabilities.

Result: The algorithm is classically simulated for three examples, reaching up to 26 qubits, and extends to larger systems such as O3 with 330 qubits, tackling classically challenging SCF regimes.

Conclusion: Successful application of GAS-SCF in chemistry requires advanced quantum hardware capable of fault tolerance.
...
TL;DR: This paper presents a variational framework for transforming operators into compact quantum circuits, enhancing both quantum simulations and engineering applications by optimizing through backpropagation and a regularization term.


<details>
  <summary>Details</summary>
Motivation: Efficient quantum algorithms are limited by inadequate data structures for operators and state preparation, affecting the practical use of quantum hardware.

Method: The proposed full-stack variational framework transforms arbitrary operators into compact circuits tailored for specific hardware, employing backpropagation for optimization while utilizing a single ancilla qubit and incorporating a regularization term to minimize approximation errors.

Result: This method successfully learns propagators for quantum simulations and implements a second-order approximation for the Laplace operator, demonstrating improved resource scaling and error metrics compared to existing methods.

Conclusion: The framework's versatility allows its application beyond quantum mechanics to general problem-solving in engineering contexts, potentially expanding the scope of quantum computing applications.
...
TL;DR: This paper presents a deterministic algorithm for optimizing optical detection in quantum protocols, achieving a significant improvement in visibility and squeezing efficiency.


<details>
  <summary>Details</summary>
Motivation: To enhance resource levels in quantum information technologies through optimized detection processes, specifically for multi-spectral squeezing.

Method: A deterministic sequential algorithm is developed based on the physical description of optical processes, optimizing the visibility in a pixel basis and operating linearly with the number of pixels.

Result: The optimized mask significantly increases visibility from 76% to 84%, leading to a 20% gain in mode-matching efficiency and an improvement in squeezing from -2.08 dB to -2.64 dB.

Conclusion: Deterministic spatial phase shaping is an effective method for improving multimode squeezing in waveguide platforms.
...
TL;DR: The paper presents a framework for estimating nonlinear properties of quantum states using multi-copy measurements and random projections onto lower-dimensional subspaces, optimizing the use of coherent quantum resources based on hardware capabilities.


<details>
  <summary>Details</summary>
Motivation: The need for efficient measurement protocols in quantum information science, particularly for nonlinear properties of states, without overwhelming experimental limitations.

Method: Introduces random projections prior to collective measurements on reduced Hilbert spaces, allowing for balanced trade-offs between coherent operations and statistical sampling overhead.

Result: Explicit formulas connect Haar-averaged projected moments to multivariate traces, revealing a specific sampling cost in terms of copies needed based on the dimension reduction.

Conclusion: Coherent multi-copy operations can be effectively traded for additional state copies, providing a path to optimize quantum protocols based on available hardware resources.
...
TL;DR: This work presents a symmetry-based protocol for mitigating Trotter errors in quantum simulations, maintaining ideal dynamics while accommodating complex symmetries.


<details>
  <summary>Details</summary>
Motivation: Trotterization can disrupt the symmetries of quantum systems, causing unphysical dynamics and algorithmic errors.

Method: A symmetry-based approach involves applying symmetry transformations to states and interleaving them in Trotter layers, followed by classical averaging of outcomes to remove errors.

Result: The protocol is tested on the XY model to suppress leading-order errors and on the Schwinger model to effectively manage local Gauss's law violations.

Conclusion: This method substantially enhances the fidelity of Trotterized simulations without increasing depth, beneficial for near-term quantum devices.
...
TL;DR: The paper introduces Vine Codes, a novel form of quantum low-density parity check codes, which can be implemented on superconducting platforms with fewer qubits than traditional surface codes, improving efficiency in quantum computing.


<details>
  <summary>Details</summary>
Motivation: To address the high qubit overheads in surface codes while retaining compatibility with superconducting hardware.

Method: The authors propose Vine Codes, which utilize nearest-neighbour gates on a planar grid and allow for open boundary conditions via routing qubits, enhancing previous directional code designs.

Result: Vine codes demonstrate a significant reduction in required qubits (up to ~28% less than surface codes at circuit distance 7). They outperform surface codes in terms of performance under realistic noise conditions while using fewer qubits.

Conclusion: Vine Codes, along with the introduction of Flip-Vine Codes, present an efficient pathway for fault-tolerant quantum computing with practical implementations on superconducting platforms.
...
TL;DR: This paper introduces a new quasiprobability measure for interpreting eigenstates in open quantum systems, revealing coherence connections and dynamic properties retained in phase space despite damping.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of interpreting the distinct right and left eigenstates in open quantum systems, which decay with time and lack clear physical meaning.

Method: A new quasiprobability measure that combines right and left eigenstates of the Liouvillian, visualizing them as distributions in a 'doubled' phase space.

Result: The measure demonstrates that oscillators maintain quantized 'orbits' in phase space across various damping scenarios, with these orbits showing measurable dynamical features affected by thermal baths.

Conclusion: The findings extend semiclassical quantization concepts for open systems and offer a new perspective on invariant tori in the context of quadratic systems.
...
TL;DR: This paper proposes using a Bose-Einstein condensate to measure particle arrival times indirectly through flux detection, aiming to resolve a longstanding quantum theory question.


<details>
  <summary>Details</summary>
Motivation: The study aims to address the ambiguous nature of particle arrival times in quantum theory, which has been debated for decades.

Method: The authors propose an experimental setup to measure arrival flux as a function of position rather than direct arrival times, circumventing issues with detector proximity.

Result: This approach enables the differentiation of theoretical models based on the signals obtained, potentially offering clarity in the understanding of particle dynamics.

Conclusion: This novel method could lead to a resolution of longstanding debates in quantum mechanics regarding the time it takes for particles to reach detectors.
...
TL;DR: This paper explores the use of finite bosonic quantum batteries to replace or duty-cycle the pump tone in quantum-limited parametric amplifiers, revealing that phase-coherence in the pump is essential for effective amplification.


<details>
  <summary>Details</summary>
Motivation: The research aims to investigate whether quantum batteries can effectively replace traditional microwave drives in superconducting quantum technologies, which could lead to more efficient operation.

Method: The study quantizes the pump of a nondegenerate parametric amplifier and compares coherent versus phase-randomized pumps using a closed trilinear model to examine their effects on signal-idler photon generation and two-mode coherence.

Result: The coherent pump yields lower minimum intensity at matched collector bandwidth, demonstrating superior two-mode coherence and an EPR-squeezed interference dip compared to the phase-randomized pump, despite both having similar photon-number distributions.

Conclusion: Effective battery-powered parametric amplification requires phase-coherent stored energy, highlighting the role of pump phase coherence in achieving optimal amplification rather than relying on energy storage alone.
...
TL;DR: The paper explores the relationship between spin-bath entanglement and dynamics in the sub-Ohmic spin-boson model using tree tensor network methods. It finds that spin entanglement reaches a plateau before polarization relaxes, providing insights into the dynamics through an entropy landscape.


<details>
  <summary>Details</summary>
Motivation: To investigate the link between different dynamical regimes in the sub-Ohmic spin-boson model and the corresponding spin-bath entanglement structures.

Method: Utilized tree tensor network states with projector-splitting time evolution (TTN-TDVP-PS) to analyze the dynamics across the sub-Ohmic $(s, α)$ parameter space.

Result: Identified a stationary entanglement entropy plateau and a single-valued entropy ridge, with low-frequency modes dominating the environmental entropy scale and coherent dynamics enhancing bath-mode correlations.

Conclusion: The stationary spin entanglement entropy serves as a valuable observable to complement existing classifications of dissipative quantum dynamics.
...
TL;DR: This study explores the design of variational quantum models by integrating symmetries and strategically placing trainable parameters, using Tic-Tac-Toe as a test case to analyze the benefits of symmetry and task-specific interactions.


<details>
  <summary>Details</summary>
Motivation: To improve variational quantum learning by efficiently incorporating the inherent symmetries of the problem into the model architecture.

Method: The authors study design choices in equivariant circuits through symmetry-based parameter sharing, focusing on the extent of enforced symmetry and trainable interactions.

Result: Experimentation with Tic-Tac-Toe reveals that while symmetry contributes to generalization, substantial gains come from interactions aligned with key task features.

Conclusion: Effective quantum model design necessitates leveraging both symmetry constraints and informed choices regarding parameterization to enhance performance.
...
TL;DR: This paper demonstrates a controllable light-nuclear spin interface using metastability-exchange collisions in helium-3, enabling enhanced quantum sensing and metrology through optical access to nuclear spins.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the challenge of establishing a controllable interface between light and nuclear spins to leverage the long coherence times of helium-3 for advanced quantum technologies.

Method: The authors utilize metastability-exchange collisions in a low-pressure helium-3 gas cell at room temperature, facilitated by a radio-frequency discharge, to create an effective Faraday interaction between nuclear spins and an optical probe.

Result: The strength of the optical interaction is quantitatively characterized based on nuclear polarization, magnetic field, and probe parameters, with significant enhancement from using a multi-pass cell that increases optical depth.

Conclusion: The study indicates a practical method for optical manipulation of helium-3 nuclear spins and suggests the potential for producing long-lived nuclear spin-squeezed states beneficial for quantum metrology.
...
TL;DR: The study investigates metastable alignment tensor contributions to nuclear spin dynamics in highly polarized 3He, enhancing understanding and applications in precision magnetometry and nuclear spin-squeezed states.


<details>
  <summary>Details</summary>
Motivation: To explore the previously overlooked effects of the metastable alignment tensor in highly polarized 3He ensembles prepared by MEOP, which impact precision measurements in fundamental physics.

Method: A linearized model under mean-field approximation was developed to analyze the alignment tensor effects, complemented by free-induction-decay (FID) measurements to observe the phenomena experimentally.

Result: An experimental dependence on nuclear polarization was identified, aligning well with theoretical predictions, demonstrating the significant impact of the tensor-induced phenomena on the behavior of hybrid 3He ensembles under varying magnetic fields.

Conclusion: The findings enhance the understanding of nuclear spin dynamics and open avenues for systematic error correction in high-accuracy magnetometry and the generation of nuclear spin-squeezed states.
...
TL;DR: This study demonstrates phase locking of a ${}^{29}$Si nuclear spin ensemble in a silicon quantum dot using electronic spin-orbit coupling, allowing for coherent control and measurement.


<details>
  <summary>Details</summary>
Motivation: The use of nuclear spins in quantum information processing is promising due to their long coherence times, yet effective control typically relies on external phase references.

Method: The researchers phase-locked the nuclear spin ensemble to the internal electronic spin-orbit coupling without external fields, allowing the nuclear spins to align according to the electronic drive protocol.

Result: Coherent precession and inhomogeneous dephasing of the nuclear spins were measured and confirmed through numerical simulations.

Conclusion: This approach paves the way for new methods of coherent control over solid-state nuclear spin ensembles.
...
TL;DR: This paper presents a quantum communication approach to enhance the efficiency and security of distributed machine learning training, achieving superior performance in bandwidth and privacy.


<details>
  <summary>Details</summary>
Motivation: The increase in size and complexity of machine learning models necessitates more efficient and secure training methods across distributed devices.

Method: Introduces a quantum all-reduce algorithm that utilizes pre-shared entanglement and superdense coding to achieve optimal communication efficiency, while ensuring information-theoretic privacy through composable ε-secure aggregation.

Result: Demonstrates a 2x reduction in per-link communication and highlights quantum advantages in gradient conflict detection, showing significant communication complexity benefits for specific problems.

Conclusion: Quantum communications can significantly improve both the communication efficiency and privacy of distributed training in machine learning, creating advantageous trade-offs regardless of model type.
...
TL;DR: This study enhances the security analysis of continuous variable quantum key distribution (CV-QKD) by removing restrictive assumptions, allowing for practical implementations with positive key rates for finite block sizes.


<details>
  <summary>Details</summary>
Motivation: To address limitations in current security proofs of CV-QKD that rely on restrictive assumptions and impractically large block sizes, ensuring both theoretical and practical viability.

Method: A finite-size security analysis using dimension reduction, marginal-constrained entropy accumulation, and a trusted detector model to account for receiver imperfections.

Result: Positive key rates in the finite-size regime for block sizes around $10^8$, demonstrating practical applicability of the approach.

Conclusion: This work bridges the gap between theoretical and practical aspects of discrete-modulated CV-QKD, enhancing its security and feasibility in real-world applications.
...
TL;DR: The paper presents efficient entanglement-assisted discrimination schemes for genuinely nonlocal multipartite orthogonal states, classifying them into reducible and irreducible types and demonstrating that minimal quantum resources are sufficient for their discrimination.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of discriminating genuinely nonlocal orthogonal states in quantum information, particularly when they are locally indistinguishable under any bipartition.

Method: The paper categorizes genuine nonlocality into Type I and Type II based on local irreducibility and proposes discrimination protocols utilizing minimal quantum resources for both types.

Result: For low-dimensional systems, Type I sets require one EPR pair, while Type II sets need one GHZ state. In higher-dimensional cases, both types require a single maximally entangled state, adapting to management of additional EPR pairs in Type II sets for larger systems.

Conclusion: The findings contribute a robust framework for efficiently discriminating genuinely nonlocal sets, emphasizing resource minimalism in quantum protocols.
...
TL;DR: The paper explores regularity results of eigenfunctions in the discrete spectrum of the Schrödinger equation, revealing ways to alleviate dimensionality challenges in computational approximations.


<details>
  <summary>Details</summary>
Motivation: To understand how regularity in eigenfunctions affects approximation complexity in solving the electronic Schrödinger equation.

Method: The paper analyzes convergence rates when employing sparse grid constructions, focusing on the dimensionality of the problem and the number of electrons.

Result: It demonstrates that the leading algebraic exponent in convergence rates can be made independent of the number of electrons, mitigating the curse of dimensionality.

Conclusion: These findings suggest improvements for classical numerical solvers and enhanced efficiency in quantum-computing implementations of wavefunction encodings.
...
TL;DR: The paper explores how the geometry of sparse long-range quantum models influences their low-energy phases, revealing distinct behaviors based on graph types like power-of-$p$ and Fibonacci graphs.


<details>
  <summary>Details</summary>
Motivation: To understand the impact of interaction geometry on ground-state phase transitions in sparse quantum models with tunable connectivity.

Method: Analyzing various graph structures, particularly focusing on power-of-$p$ graphs and Fibonacci graphs, to investigate the role of symmetry and frustration in the phase behavior of quantum systems.

Result: Identified distinct phase behaviors for even- and odd-$p$ power-of-$p$ graphs, with even-$p$ maintaining a rich phase structure and odd-$p$ exhibiting geometric frustration; Fibonacci graphs showed a contrasting behavior without discrete self-similarity but connecting short- and long-range dynamics.

Conclusion: The phase structure and criticality across different models are governed by a unified effective-geometry principle, offering insights for long-range quantum systems in experimental contexts.
...
TL;DR: The paper highlights that small measurement errors in quantum measurement can lead to incorrect certification of entanglement in high-dimensional systems. It demonstrates this vulnerability through experimental examples and calls for more secure verification methods.


<details>
  <summary>Details</summary>
Motivation: To address the inaccurate verification of entanglement due to the assumption of perfect quantum measurements, especially as system complexity increases.

Method: The authors introduce adversarial measurement errors in entanglement verification tests and experimentally validate this using classical photonic states with controlled measurement errors.

Result: They show that small measurement errors can falsely certify high-dimensional entanglement in systems that are actually separable, with experimental tests revealing significant vulnerabilities.

Conclusion: The findings indicate a critical issue in current entanglement detection methods and emphasize the necessity for secure and resilient verification protocols in quantum technologies.
...
TL;DR: This paper presents a method for analyzing quantum kernels using Fourier representations and tensor networks, revealing a compression relationship between quantum representations and classical computations.


<details>
  <summary>Details</summary>
Motivation: To understand the relationship between quantum kernels and classical representations, particularly focusing on their compressibility and computational tractability.

Method: The authors identify quantum kernels as spectral tensor networks by relating them to Fourier representations and demonstrate a method for grouping configurations of data-encoding gates that simplifies the representation of quantum kernels.

Result: The study finds that layered quantum kernels can be represented accurately with small bond dimensions, indicating a compressibility that reflects correlations between Fourier modes.

Conclusion: This compressibility may indicate the classical replicability of quantum kernel evaluations, suggesting conditions under which these evaluations remain computationally feasible.
...
TL;DR: The paper presents a hybrid error-mitigation framework integrating classical Pauli propagation with quantum processors, enhancing observable estimation beyond traditional limits and enabling better resource efficiency.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of quantum simulation accuracy caused by error rates and sampling overheads, as well as the constraints on classical simulation methods due to exponential operator paths.

Method: A hybrid framework embedding Pauli propagation within noise-canceling inverse channels modifies observables for direct measurement on quantum processors, balancing truncation errors and resource use.

Result: Prototypes were benchmarked on models challenging traditional methods, and experiments with 56 superconducting qubits showed tradeoffs in truncation strategies, enhancing observable estimation.

Conclusion: This integration of classical and quantum resources lays the groundwork for advances in quantum-centric supercomputing and progress toward achieving quantum advantage.
...
TL;DR: This paper defines many-body chirality in quantum states using entanglement structure, proving it is an obstruction to transforming states into their complex conjugates via local operations.


<details>
  <summary>Details</summary>
Motivation: To provide a quantum-information theoretic framework for chirality based on many-body quantum state entanglement, addressing gaps in current theoretical understanding.

Method: Introduces many-body chirality as an obstruction in state transformation, establishing conditions under which complex conjugation can be achieved using local quantum channels.

Result: Proves that many-body chirality exists for $	ext{Z}_d^{(k)}$ anyon theories and identifies additional forms of chirality, including those undetectable by traditional methods.

Conclusion: Demonstrates that $	ext{Z}_d^{(k)}$ states are intrinsically many-body imaginary, with irreducible complex phase structures, influencing their classification as chiral or non-chiral.
...
TL;DR: This paper extends previous results on average gate fidelity to include time-dependent dissipation in quantum-computing architectures, revealing significant fidelity reductions in superconducting quantum computers during adiabatic operations.


<details>
  <summary>Details</summary>
Motivation: Understanding fidelity limitations due to noise is essential for developing effective utility-scale quantum processors.

Method: The authors generalize existing fidelity-reduction formulas to handle time-dependent dissipation and apply it to adiabatic operations in quantum systems.

Result: A fidelity bound for adiabatic operations is established, highlighting the impact of flux-dependent noise and qubit-coupler hybridization on fidelity during controlled-Z gates.

Conclusion: The findings offer crucial theoretical insights for optimizing quantum operations and can benefit other quantum technologies affected by time-dependent noise.
...
TL;DR: This paper presents a mathematical framework to optimize qubit transfers in neutral atom quantum computers, improving compilation efficiency and reducing movement-induced errors.


<details>
  <summary>Details</summary>
Motivation: The need for efficient qubit movement in neutral atom quantum computers due to circuit execution demands.

Method: The authors develop a graph-theoretic combinatorial optimization model to determine the minimal number of qubit transfers, encoded as a nonlinear integer program solved with a genetic algorithm.

Result: The proposed approach consistently finds fewer transfers compared to existing scalable compilers, offering trade-offs between travel distance and parallel transfer operations.

Conclusion: The framework provides practical tools for efficient quantum circuit compilation, enhancing execution on NAQC devices by minimizing errors and exploiting parallelism.
...
TL;DR: This study explores estimating von Neumann entropy in multi-qutrit systems using variational quantum algorithms (VQAs) and classical convolutional neural networks (CNNs), demonstrating different effectiveness based on system size.


<details>
  <summary>Details</summary>
Motivation: To enhance Von Neumann entropy estimation in multi-qutrit quantum systems, leveraging both VQAs and CNNs to improve performance and scalability.

Method: The study evaluates 11 SU(3)-inspired ansatzes for up to three qutrits and employs a CNN on measurement outcomes from tensor-product mutually unbiased bases for larger systems (two to five qutrits).

Result: VQAs are effective for small systems, with 120 parameters yielding sufficient accuracy; the CNN achieves 90th-percentile errors of 0.13-0.16 nats with just 12.5% of the measurements needed for full state tomography, improving systematically with system size.

Conclusion: The results indicate that while VQAs suit smaller systems, CNNs provide enhanced scalability and robustness when estimating von Neumann entropy in larger multi-qutrit systems.
...
TL;DR: The Frontier decoder is a new method for efficient sparse quantum decoding that combines error variable processing and pruning techniques to achieve near-optimal performance with linear complexity.


<details>
  <summary>Details</summary>
Motivation: To address the inefficiencies in quantum decoding, particularly in sparse quantum codes, and to lower computational complexity while maintaining performance.

Method: It processes error variables in a specified order, merges similar prefixes, approximates logical-coset posterior masses, and retains a narrow scored frontier to reduce complexity.

Result: In the code-capacity setting, it achieves near-optimal thresholds for the surface and color codes; in circuit-level noise models, it outperforms existing methods with an average retained list size under 100 at a low error rate.

Conclusion: The Frontier decoder demonstrates potential for low-latency implementations due to its linear complexity when the list size is fixed, indicating significant advancements in quantum decoding efficiency.
...
TL;DR: The study investigates quantum correlations in non-fixed causal orders via the Guess-Your-Neighbour's-Input game, finding that increasing local dimensions beyond 5 does not yield a significant winning probability improvement, suggesting the need for new strategies or that the upper bound of 0.7592 may not be tight.


<details>
  <summary>Details</summary>
Motivation: To understand quantum correlations in scenarios where causal orders are not fixed, particularly through the lens of causal games like Guess-Your-Neighbour's-Input.

Method: Utilizing a see-saw optimization approach implemented as a semidefinite program, enhanced by GPU computing for efficiency, to explore local dimensions up to d=8.

Result: The optimization did not reveal significant improvements in winning probabilities beyond the established value of approximately 0.6218 found with d=5.

Conclusion: The findings imply that either new strategies are needed to approach the upper bound or that the bound may not be tight.
...
TL;DR: The paper presents an algorithm for learning local Lindbladians from black-box dynamics, focusing on estimation of Hamiltonian and dissipative coefficients. It utilizes finite-time channel probes and classical shadows to achieve efficient estimations with near-optimal complexity.


<details>
  <summary>Details</summary>
Motivation: To estimate local Lindbladians accurately with minimal resource usage, particularly for Hamiltonian and dissipative coefficients in quantum systems.

Method: The algorithm leverages finite-time evolution runs combined with Pauli measurements through classical shadows to infer Lindbladian coefficients via stable local Fourier inversions.

Result: The proposed algorithm achieves a complexity scaling of $	ilde{O}(Λ^2/ε^2)$ for quantum channel accesses and $	ilde{O}(Λ/ε^2)$ for total evolution time, demonstrating its efficiency and non-adaptiveness.

Conclusion: The study establishes a near-optimal learning algorithm for local Lindbladians, complemented by lower bounds indicating the inherent limitations when estimating dissipative coefficients, highlighting the challenges against Heisenberg-limited scaling.
...
TL;DR: This paper introduces space-group codes, extending the class of topological codes by incorporating point-group operations, leading to potentially better locality in practical implementations.


<details>
  <summary>Details</summary>
Motivation: To explore topological codes beyond translation invariance and incorporate point group operations for a broader design space in quantum computing.

Method: Introducing a new class of Calderbank-Shor-Steane (CSS) codes called space-group codes, analyzed using ring-modules and invariant theory.

Result: Space-group codes can exhibit greater locality and do not overly complicate practical implementation, unlike traditional topological codes.

Conclusion: The study expands the landscape of topological codes, offering more options for co-design in quantum computing.
...
TL;DR: This paper compares various algorithms for ground-state preparation in noisy environments, highlighting the phase-dependent performance of each algorithm and showing that cooling protocols offer advantages in certain conditions.


<details>
  <summary>Details</summary>
Motivation: To understand and benchmark the effectiveness of different ground-state preparation algorithms under depolarizing noise conditions.

Method: The study utilizes an exactly solvable family of quadratic fermionic Hamiltonians, examining their behavior under varying noise rates and analyzing performance via numerical simulations.

Result: Adiabatic evolution excels in the trivial phase, while a multi-frequency cooling algorithm performs better in the topological phase; the quantum approximate optimization algorithm competes in the trivial phase but is generally inferior in the topological regime.

Conclusion: Cooling protocols show enhanced robustness to parameter imperfections, suggesting a potential advantage for practical noisy quantum state preparations.
...
### [68] [Scintillation of the first-known pulsar planetary system](https://arxiv.org/abs/2606.19406)
*J. M. Yao,L. Zhang,A. Wolszczan,William A. Coles,D. Li,Richard N. Manchester,N. Wang,C. H. Niu,P. Wang,F. F. Kou,J. P. Yuan*

Main category: astro-ph.HE

TL;DR: This study investigates the scintillation properties of the pulsar planetary system PSR B1257+12 using FAST, revealing insights into scattering characteristics and the environment around the pulsar.


<details>
  <summary>Details</summary>
Motivation: To understand the scintillation characteristics of PSR B1257+12 and the effects of plasma structures along the propagation path of its radio signals.

Method: Analysis of 31 observations including autocorrelation function analysis, spectral analysis of secondary spectra, and delay-profile analysis, focusing on scintillation timescales, bandwidth, and scattering characteristics.

Result: Observations revealed scintillation timescales, bandwidths, and detection of inner, middle, and outer arcs, indicating isotropic scattering, identifying distances to scattering screens, and suggesting DM variations influenced by further plasma structures.

Conclusion: The environment around PSR B1257+12 appears relatively clean based on DM variations, though undetected nearby scattering screens may require more sensitive observations for further study.
...
### [69] [Evidence for protostellar jets as a population of hadronic gamma-ray sources](https://arxiv.org/abs/2606.19445)
*Javier Méndez-Gallego,Rubén López-Coto,Emma de Oña Wilhelmi,Stefano Menchiari,Iván Agudo,Rubén Fedriani*

Main category: astro-ph.HE

TL;DR: Detection of gamma rays from young stellar objects confirms non-thermal activity, indicating proton acceleration in protostellar jets and its implications for star formation.


<details>
  <summary>Details</summary>
Motivation: To explore the energetic non-thermal activity in young stellar objects, particularly in the context of proton acceleration and its effects on star formation.

Method: Statistical detection of gamma rays using observations of young stellar objects to analyze particle acceleration processes within protostellar jets.

Result: Significant detection of gamma rays correlated with cosmic-ray output and bolometric luminosity, indicating that proton interactions are key in shaping surrounding molecular conditions.

Conclusion: Gamma-ray studies reveal the energetic feedback mechanisms in protostellar evolution and their impact on future star and planet formation.
...
### [70] [Damping of Fast Radio Bursts in the Inner Magnetospheres of Magnetars](https://arxiv.org/abs/2606.19448)
*Siddhant Solanki,Jens Mahlmann,Alexander Philippov,Andrei Beloborodov*

Main category: astro-ph.HE

TL;DR: This study reveals that fast radio bursts (FRBs) interact with magnetar magnetospheres, leading to significant signal attenuation through nonlinear processes until certain radii, constrained by charge starvation in quiescent and eruptive magnetospheres.


<details>
  <summary>Details</summary>
Motivation: To understand the behavior of fast radio bursts (FRBs) as they propagate through magnetar magnetospheres and assess how nonlinear processes affect their signal strength.

Method: Utilizing three-dimensional force-free electrodynamics simulations to analyze the propagation of GHz radio waves and their interactions with Alfvén waves within the magnetar magnetosphere.

Result: FRBs induce Alfvénic fluctuations that cause substantial nonlinear signal attenuation, remaining effective within 10 to 100 magnetar radii before charge starvation halts further decay.

Conclusion: Nonlinear plasma processes significantly hinder the escape of FRBs from the inner regions of magnetars, impacting their detectability.
...
### [71] [Nonlinear Decay of Fast Magnetosonic Waves through Weak Turbulence: Force-Free Electrodynamics Simulations](https://arxiv.org/abs/2606.19450)
*Siddhant Solanki,Jens Mahlmann,Alexander Philippov*

Main category: astro-ph.HE

TL;DR: The study shows that low-frequency fast-magnetosonic waves in magnetar environments undergo significant energy dissipation through nonlinear interactions, challenging their escape from magnetospheres.


<details>
  <summary>Details</summary>
Motivation: To explore if low-frequency fast-magnetosonic waves can escape magnetar environments without reprocessing, especially in the context of GHz fast radio bursts.

Method: Relativistic force-free electrodynamics simulations were employed to analyze the propagation of FMS waves and their interactions leading to the formation of secondary wave types.

Result: The study confirms prior theoretical predictions and reveals that primary FMS waves convert into secondary FMS and Alfvén waves through parametric decay instability, leading to broad energy distribution.

Conclusion: FMS waves likely cannot escape magnetar magnetospheres without undergoing significant energy dissipation and spectral broadening.
...
### [72] [Short-Range Forces Can Catalyze Extreme Orbital Evolution in Hierarchical Triples](https://arxiv.org/abs/2606.19456)
*Ygal Y. Klein,Chris Hamilton*

Main category: astro-ph.HE

TL;DR: This paper explores how relaxing the double-averaged approximation in hierarchical triples reveals that short-range forces can enhance eccentricity in binaries, contrary to previous beliefs.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics of black hole mergers and hot Jupiters in hierarchical triples, particularly the role of the von Zeipel-Lidov-Kozai effect and the impact of short-range forces.

Method: The authors relax the double-averaged approximation to the ZLK effect and analyze the influence of short-range forces on the eccentricity and angular momentum of binary systems through a quadrupole-order, three-body mechanism.

Result: SRFs can cause significant nonadiabatic jumps in a binary's effective adiabatic invariants, altering maximum/minimum eccentricity and secular period, even affecting the angular momentum component j_z in new ways.

Conclusion: Binaries may utilize a broader phase space than previously thought, suggesting that extreme dynamical behavior in hierarchical triples is more common when considering full dynamics beyond the traditional ZLK theories.
...
### [73] [On the Contribution of Local Sources to the Galactic Cosmic-Ray Spectrum: An Exact Series Solution for Two-Zone Diffusion](https://arxiv.org/abs/2606.19701)
*Zi-Hang Liu,Yiwei Bao,Ruo-Yu Liu*

Main category: astro-ph.HE

TL;DR: This paper explores how inefficient transport of cosmic rays near their sources affects the statistical likelihood of these sources contributing to local cosmic-ray spectra, particularly around the knee region.


<details>
  <summary>Details</summary>
Motivation: To explain deviations in cosmic-ray spectra below the knee, particularly the potential contribution from nearby sources, in light of existing transport models.

Method: The authors derive a Green's function for efficient calculations of particle distributions in scenarios of inefficient transport, employing Monte Carlo simulations for different Galactic source populations.

Result: The enhanced models show an increase in the probability of a dominant local source contributing at 10 TeV from 0.4% to 1.7-2.2%, indicating that while inefficient transport helps, it does not eliminate the statistical challenges.

Conclusion: Local source contributions to cosmic-ray spectra are plausible but highly dependent on the underlying transport models, requiring further examination of injection history and transport mechanisms.
...
### [74] [On the braking index evolution of PSR B0540-69: wind braking of pulsars](https://arxiv.org/abs/2606.19856)
*H. Tong*

Main category: astro-ph.HE

TL;DR: The pulsar PSR B0450-69 exhibits an increasing braking index post spin-down state change, suggesting a relationship with particle wind variations and predicting a steady braking index evolution for PSR B0540-69.


<details>
  <summary>Details</summary>
Motivation: To investigate the discrepancies in braking index measurements of pulsars and their relationship to particle wind variations.

Method: Analysis of braking index evolution, prediction of steady states, and a phenomenological treatment of wind braking models in pulsars.

Result: PSR B0450-69 shows a transient increase in braking index linked to particle density variations, while PSR B0540-69 is expected to stabilize at a constant braking index.

Conclusion: Future measurements could clarify pulsar braking index evolution and aid in testing different acceleration potentials in pulsar magnetospheres.
...
### [75] [Accreting stellar-mass black holes](https://arxiv.org/abs/2606.19952)
*Greg Marcel,Bailey Tetarenko,Adam Ingram,Tom Maccarone,Alexandra Veledina,Phil Charles*

Main category: astro-ph.HE

TL;DR: This review discusses the complex behavior of accreting stellar-mass black holes, highlighting recent advances in understanding their emission characteristics and the interplay between accretion mechanisms, while calling for more comprehensive studies to address lingering questions.


<details>
  <summary>Details</summary>
Motivation: Accreting stellar-mass black holes exhibit significant variability in their behavior, making them essential for exploring strong gravitational field dynamics and accretion processes.

Method: The review synthesizes findings related to continuum emission, timing properties, emission lines, and X-ray polarization, emphasizing the roles of the accretion disk, corona, and jets.

Result: It illustrates how quasi-periodic oscillations, noise, and emission lines serve as diagnostics, with polarization studies revealing complexities in the corona's geometry and an unclear understanding of the soft state.

Conclusion: Despite progress, critical questions about state transitions, the influence of magnetic fields, and disk instability connections persist, necessitating further multi-wavelength and timing investigations.
...
### [76] [SS433 PeV neutron jet feeding the far TeV gamma beam](https://arxiv.org/abs/2512.07012)
*Daniele Fargion,Pier Giorgio De Sanctis Lucentini,Sara Turriziani,Danila Sopin,Maxim Yu. Khlopov*

Main category: astro-ph.HE

TL;DR: This paper proposes that ultra high-energy neutron jets from the SS433 binary system are responsible for recently observed disconnected gamma-ray emissions at TeV energies, suggesting a novel connection between high-energy astrophysical events and gamma-ray sources.


<details>
  <summary>Details</summary>
Motivation: Understanding the origin of observed disconnected gamma-ray emissions in the context of high-energy astrophysical processes, particularly related to the SS433 binary system.

Method: The authors posit that tens of PeV neutron jets, produced during rare tidal eruptions, undergo beta decay and Inverse Compton scattering, generating gamma-ray emissions observed by telescopes like H.E.S.S., HAWC, and LHAASO.

Result: The proposed model aligns with observational data on gamma-ray emissions and offers a plausible explanation for their source, contrasting it with less competitive alternative models.

Conclusion: The findings support the idea that the SS433 system could be a source of ultra high-energy cosmic radiation through its disruptive events, providing insights into the mechanisms of high-energy astrophysics.
...
### [77] [Supernova Remnants in the IXPE era: a review](https://arxiv.org/abs/2606.19979)
*Riccardo Ferrazzoli,IXPE Collaboration*

Main category: astro-ph.HE

TL;DR: IXPE's X-ray polarimetry provides insights into magnetic fields and particle acceleration in young supernova remnants, revealing varying polarization and magnetic field structures across six observed cases.


<details>
  <summary>Details</summary>
Motivation: To explore the physics of supernova remnants through spatially resolved X-ray polarimetry, enabling a better understanding of magnetic fields and particle acceleration processes.

Method: Utilizing IXPE, the first instrument for X-ray polarimetry, to observe six young supernova remnants, analyzing their polarization and magnetic field structures.

Result: Observations indicate significant polarization (5%-30%) in all studied remnants; Cas A, Tycho, and SN 1006 show radial fields, while RX J1713.7-3946 and Vela Jr. have tangential morphologies, revealing diverse magnetic field topologies.

Conclusion: The findings challenge previous beliefs about magnetic field structures in SNRs and indicate that shock velocity and circumstellar conditions significantly influence particle acceleration.
...
### [78] [A Whisper from Within: Response of a Pulsar Timing Array to an Internal Gravitational-wave Source](https://arxiv.org/abs/2606.20021)
*Houyuan Qi,Xian Chen,Lin Wang,Kuo Liu*

Main category: astro-ph.HE

TL;DR: This study models the timing residuals of millisecond pulsars in globular clusters and galactic nuclei affected by gravitational waves, highlighting near-field effects that enhance detection capabilities.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of millisecond pulsars in globular clusters and galactic nuclei for detecting nanohertz gravitational waves via a mini-PTA.

Method: A comprehensive model that incorporates near-field effects such as wavefront curvature and self-field interactions to calculate timing residuals induced by gravitational wave sources.

Result: Timing residuals can reach up to 1 μs in globular clusters and milliseconds in galactic centers for pulsars within a few wavelengths of the gravitational wave source, with a steep rise in residuals due to non-radiative fields.

Conclusion: Mini-PTAs in globular clusters and galactic nuclei can effectively probe invisible gravitational wave sources, including black hole binaries.
...
### [79] [A FAST search for radio pulsations during the dormant state of the AMSPs IGR J00291+5934 and MAXI J1957+032](https://arxiv.org/abs/2606.20086)
...
TL;DR: The study investigates radio pulsations in quiescent accreting millisecond pulsars (AMSPs) using extensive observations, finding no significant signals and establishing stringent upper limits on radio flux density for the sources studied.


<details>
  <summary>Details</summary>
Motivation: To explore why radio pulsations are absent in quiescent AMSPs, despite their detection in transitional millisecond pulsars (tMSPs), and to establish upper limits for the radio emissions from two specific AMSPs.

Method: Conducted two observational campaigns on IGR J00291+5934 and MAXI J1957+032 using the FAST at L-band frequencies, measuring X-ray and optical flux to confirm quiescent states, and searching for coherent radio periodicities.

Result: No significant candidate signals for radio pulsations were detected at known spin frequencies, with upper limits established as 3.3 μJy and 5.6 μJy for the respective AMSPs, marking the strictest limits recorded for persistent AMSPs.

Conclusion: The findings suggest that radio pulsations are unlikely present in quiescent AMSPs, reinforcing the distinct behaviors between AMSPs and tMSPs regarding radio emissions.
...
### [80] [On the impact of the carbon fusion rate over the properties of superbursts -- Numerical simulations of superbursts with MESA](https://arxiv.org/abs/2606.20088)
*Martin Nava-Callejas,Stéphane Goriely,Nicolas Chamel*

Main category: astro-ph.HE

TL;DR: This study investigates how variations in the carbon fusion rate affect superbursts in neutron stars.


<details>
  <summary>Details</summary>
Motivation: The need to understand the impact of recent findings on the carbon fusion rate on superburst dynamics in neutron stars.

Method: Utilizing MESA v.24.08.1 to simulate superbursts with different carbon fusion rates.

Result: Increasing the carbon fusion rate by a factor of 1000 reduces superburst recurrence and decay times, while decreasing it results in the opposite; temperature and synthesis of α-nuclides also show sensitivity to these rate changes.

Conclusion: The carbon fusion rate significantly influences superburst characteristics, comparable to changes in base heating.
...
### [81] [Kick bimodality of neutron stars and mode dependence of their parameters](https://arxiv.org/abs/2606.20201)
*Anton D. Lazarev,Sergei B. Popov*

Main category: astro-ph.HE

TL;DR: 15% of normal isolated radio pulsars are low-velocity; magnetic fields differ significantly between low- and high-velocity modes.


<details>
  <summary>Details</summary>
Motivation: To investigate the natal velocity kick distribution of neutron stars and analyze the properties of pulsars across different velocity modes.

Method: Analyze observational data from approximately 200 normal isolated radio pulsars, categorizing them into low- or high-velocity modes and comparing various properties.

Result: 30% of pulsars belong to the low-velocity mode; significant differences observed in the magnetic field distribution, with lower field pulsars being more common in the low-velocity mode.

Conclusion: The origin of the discrepancy in magnetic fields between low- and high-velocity pulsars is unclear, suggesting further investigation is needed.
...
### [82] [Evidence for candidate X-ray pulsations from the ultraluminous X-ray source NGC 7456 ULX-1](https://arxiv.org/abs/2606.20308)
*Yuanle Yao,Xiang-Dong Li,Xiao-Jie Xu*

Main category: astro-ph.HE

TL;DR: Evidence for a pulsational signal was detected from NGC7456 ULX-1, suggesting it may host an accreting neutron star.


<details>
  <summary>Details</summary>
Motivation: To investigate the nature of NGC7456 ULX-1 and identify potential pulsational signals that could indicate the presence of an accreting neutron star.

Method: Using the 2023 XMM-Newton observation, independent timing techniques were applied, including accelerated searches, $Z^2_n$ statistics, and orbital-demodulation analysis to study the signal.

Result: A candidate pulsation signal at $ast 0.22$~Hz was found, with indications of frequency drift and estimated surface dipole magnetic field strength of $B	extsim10^{12}-10^{14}$ G.

Conclusion: The findings suggest NGC7456 ULX-1 may host an accreting neutron star, but additional observations are necessary for confirmation.
...
### [83] [The Silicon Tracking System of the E16 experiment at J-PARC: construction, installation and commissioning in beam test experiments](https://arxiv.org/abs/2606.19400)
...
TL;DR: The J-PARC E16 experiment investigates chiral symmetry restoration through vector meson modifications, utilizing upgraded tracking detectors in tests with high-energy protons and electrons.


<details>
  <summary>Details</summary>
Motivation: To explore chiral symmetry restoration and study in-medium modifications of vector mesons through advanced experimental techniques.

Method: High-intensity 30 GeV proton beams with C and Cu targets were used; 15 detector modules were developed and tested to enhance tracking capabilities in the context of the E16 experiment.

Result: Successful commissioning and performance assessment of the E16-STS modules during beam tests, with data from a 3 GeV electron beam validating the setup.

Conclusion: The paper details the achievements in constructing and operating enhanced tracking detectors, contributing to the E16 experiment's goals.
...
### [84] [PiMiX 2.0: AI-enhanced Data Fusion for Radiographic Imaging and Tomography](https://arxiv.org/abs/2606.19670)
...
TL;DR: PiMiX 2.0 is an AI-enhanced framework merging multimodal imaging, physics-informed reasoning, and scalable workflows for advanced data analysis in experiments.


<details>
  <summary>Details</summary>
Motivation: To enhance data processing, improve reproducibility, and integrate analyses across a range of complex experimental environments.

Method: Integrates multi-experiment radiographic imaging with automated data processing, 3D/4D reconstruction, and agentic AI workflows.

Result: Supports advanced processing and knowledge extraction from diverse experimental setups, including high-temperature plasmas and nuclear fusion.

Conclusion: PiMiX 2.0 significantly improves the automation and integration of experimental data analysis, enhancing workflow efficiency in various scientific fields.
...
### [85] [Operational characterization of LAPPD Generation 2: charge sharing, delayed pulses, and dark-count behavior](https://arxiv.org/abs/2606.19766)
*S. -W. Stradleigh,J. A. Foot,R. Zhang,V. A. Li*

Main category: physics.ins-det

TL;DR: This study investigates charge sharing and cross-talk in second-generation Large-Area Picosecond Photodetectors (LAPPD), examining signal distributions, dark-count rates, and resonance behavior using simulations and experimental methods.


<details>
  <summary>Details</summary>
Motivation: To understand the performance and limitations of LAPPD Gen 2, specifically focusing on charge sharing and electronic cross-talk effects which impact detection accuracy.

Method: Utilizing a picosecond pulsed laser for signal measurement, we analyze the coupling between pixels and assess dark-count rates under various voltage settings. A Monte Carlo simulation is also implemented to model signal distributions and effects like backscatter and ion afterpulsing.

Result: The study identifies significant coupling between pixels, distinct decay behaviors at various relaxation timescales, and additional signal characteristics at specific temporal intervals, with simulations aligning well with experimental classifications.

Conclusion: The findings enhance understanding of LAPPD's performance, providing insights into its signal processing capabilities and potential improvements for future photodetector designs.
...
### [86] [Raw-Hit Muon Tomography: A Measurement-Domain Formulation for Cosmic-Ray Muon Imaging](https://arxiv.org/abs/2606.20180)
*Zhizheng Zhao,Changhao Qin,Rongfeng Zhang,Zibo Qin,Qite Li*

Main category: physics.ins-det

TL;DR: The paper introduces Raw-Hit Muon Tomography (RHMT), a novel method that analyzes raw detector hits for improved muon momentum and energy-loss estimates, outperforming traditional techniques in controlled benchmarks.


<details>
  <summary>Details</summary>
Motivation: Existing muon tomography techniques often compress data, limiting the resolution of material information obtained from cosmic-ray muons.

Method: RHMT leverages raw detector hits without summarizing per-muon data, employing a measurement-domain approach to derive momentum and energy-loss information directly from scattering contrasts and energy integrals.

Result: In benchmarks using Geant4, RHMT outperformed conventional methods in ROC-AUC metrics and provided distinct energy-loss contrasts for materials with weak scattering.

Conclusion: RHMT represents a significant advancement in muon tomography, allowing for more precise material characterization compared to traditional techniques.
...
### [87] [Characterization of a symmetric-facet dual-ruled grating for spatial heterodyne spectroscopy](https://arxiv.org/abs/2606.19424)
*Cole Meyer,Joanne Flores,Jason Corliss,Walter Harris*

Main category: astro-ph.IM

TL;DR: Experimental validation of first-generation dual-ruled gratings shows potential for improved DB-SHS spectroscopy despite minor defects.


<details>
  <summary>Details</summary>
Motivation: To enhance throughput in dual-bandpass spatial heterodyne spectrometers (DB-SHS) for astrophysical diagnostics by reducing the dead space in gratings.

Method: Manufactured dual-ruled grating with distinct ruling densities; measured diffraction efficiencies across various orders and wavelengths, comparing with RCWA predictions.

Result: Experimental measurements indicated a facet asymmetry of less than 1° and a ~70% duty cycle, revealing minor manufacturing defects while validating the grating's performance.

Conclusion: Mechanically ruled dual-ruled gratings are viable for future DB-SHS applications, enabling advanced spectroscopy in relevant spectral regions.
...
### [88] [NNNN: Neural Networks for Newtonian Noise Mitigation at the Einstein Telescope](https://arxiv.org/abs/2606.19907)
*Jan Kelleter,Patrick Schillings,Jonathan Kuckert,David Bertram,Markus Bachlechner,Achim Stahl,Johannes Erdmann*

Main category: astro-ph.IM

TL;DR: Neural networks can effectively predict Newtonian noise from seismic data and outperform traditional Wiener filters under certain conditions.


<details>
  <summary>Details</summary>
Motivation: Future gravitational wave detectors will face limitations due to gravitational effects of seismic waves, necessitating improved noise mitigation techniques.

Method: The study employs neural networks trained on synthetic data from seismometer arrays to predict Newtonian noise, comparing performance with Wiener filters.

Result: Neural networks show comparable performance to Wiener filters for stationary wave fields, and significantly outperform them (by factors of 15-80) in specific long-term and short-term events.

Conclusion: Using advanced neural network models can greatly enhance the prediction of Newtonian noise, improving the sensitivity of gravitational wave detectors.
...
### [89] [VASTER: The ASKAP real-time fast-imaging pipeline -- overview and discovery of two long period transients](https://arxiv.org/abs/2606.20067)
...
TL;DR: VASTER is a new real-time imaging and transient detection pipeline for widefield radio telescopes, enabling the discovery of long period transients and other phenomena with an operational timeline of 15 minutes.


<details>
  <summary>Details</summary>
Motivation: To explore under-researched transient phenomena in the time domain, specifically on timescales of seconds to minutes.

Method: VASTER runs in real-time on the ASKAP, imaging survey project data every 15 minutes, allowing for the detection of new transient sources.

Result: During its first two weeks of operation, VASTER identified two long period transients, expanding the known population of these sources.

Conclusion: VASTER demonstrates the potential for real-time detection and exploration of long period transients, contributing to our understanding of transient astronomical phenomena.
...
### [90] [MOSAIC at ELT: Design and First Performance Results of Novel Robotic Optical-Relay Positioners](https://arxiv.org/abs/2606.20194)
...
TL;DR: The paper discusses the MOSAIC spectrograph for the Extremely Large Telescope (ELT), focusing on the design and challenges of its robotic positioners.


<details>
  <summary>Details</summary>
Motivation: To leverage the ELT's capabilities and overcome the unique challenges presented by its scale in order to improve astronomical observations.

Method: The design includes 300 robotic positioners with relay mirrors and multiple Atmospheric Dispersion Correctors (ADCs) for effective light collection and focusing.

Result: Initial designs and prototypes of the positioners have been developed, addressing the focal surface challenges and ensuring proper adaptation to the ELT's requirements.

Conclusion: The paper outlines the promising designs of the positioners that will enhance the performance of the MOSAIC spectrograph on the ELT.
...
### [91] [Instruments for Focal Plane X-Ray Polarimetry in the Next Decade](https://arxiv.org/abs/2606.20337)
...
TL;DR: The IXPE mission has successfully detected X-ray polarization from various celestial sources, and new instrumentation is being developed to enhance sensitivity and energy range for future studies in X-ray astronomy.


<details>
  <summary>Details</summary>
Motivation: To explore new scientific topics in X-ray astronomy and improve current detection capabilities following the success of the IXPE mission.

Method: Development of a focal-plane polarimeter that extends IXPE's energy range using multilayer mirrors and a combination of imaging photoelectric and active Compton polarimeters.

Result: The new instrumentation aims to achieve better sensitivity and lower background, proving its readiness for future space applications.

Conclusion: With flight heritage and ongoing development, this polarimeter could effectively address important scientific questions in X-ray polarimetry.
...
### [92] [Lightstack: A Python Package for Creating Photometric Data Cubes](https://arxiv.org/abs/2606.20360)
*Andressa Wille,Rafael S. de Souza,Ana L. Chies-Santos,Thallis Pessi,Emille E. O. Ishida,Alberto Krone-Martins*

Main category: astro-ph.IM

TL;DR: The paper introduces 'lightstack', a Python package for creating photometric data cubes from multi-band imaging datasets, facilitating studies in multi-band photometry.


<details>
  <summary>Details</summary>
Motivation: The growth of multi-imaging datasets from telescopes necessitates efficient tools for processing and analyzing diverse physical phenomena across various wavelengths.

Method: The workflow features cropping of interest areas, stacking images to form a data cube, and PSF matching, allowing enhanced data analysis.

Result: The 'lightstack' package provides an effective solution for combining images, streamlining the preparation of data for multi-band photometry studies.

Conclusion: The package is openly available to the community on GitHub and archived on Zenodo, supporting ongoing research in astronomy.
...
### [93] [Advancing Astrophysics with the SKA II](https://arxiv.org/abs/2606.20366)
...
TL;DR: The SKA II report outlines the scientific advancements expected from the SKA telescopes, highlighting the evolution of telescope designs and the new phenomena observed in astrophysics.


<details>
  <summary>Details</summary>
Motivation: To document the transformative potential of SKA telescopes in the field of astrophysics and to provide context for ongoing scientific inquiries.

Method: The report organizes contributions into six thematic categories, featuring overview chapters from science working groups that outline key scientific questions and community focus areas.

Result: The volume emphasizes the broad range of research enabled by SKA telescopes and the insights gained from precursor and pathfinder telescopes.

Conclusion: AASKAII sets the framework for future discoveries in radio astronomy, anticipating significant advancements in the coming decades.
...
### [94] [ELMA: ELlipse-based bar MAjor axis estimator](https://arxiv.org/abs/2606.20370)
*Bruna R. Bragança de Lima,Andressa Wille,Rafael S. de Souza,Ana L. Chies-Santos*

Main category: astro-ph.IM

TL;DR: The paper presents 'elma', an automated Python package for estimating bar lengths in galaxies, addressing the challenges of manual measurement in large imaging surveys.


<details>
  <summary>Details</summary>
Motivation: Accurate measurements of galactic bar lengths are crucial for understanding their role in galaxy evolution but are hindered by time-consuming manual methods.

Method: The elma package utilizes elliptical-isophote fitting on two-dimensional imaging data to determine the radial ellipticity profile and estimate bar length based on the semi-major axis at the local maximum ellipticity.

Result: The effectiveness of elma is demonstrated using JWST/NIRCam imaging, providing robust bar-length estimates for barred galaxy systems.

Conclusion: elma offers a reliable, automated solution for bar-length measurement in galaxies, facilitating future studies and improving the efficiency of large astronomical surveys.
...
### [95] [The ESSnuSB Experiment](https://arxiv.org/abs/2606.19391)
*Monojit Ghosh*

Main category: hep-ex

TL;DR: The ESSnuSBplus project aims to measure neutrino oscillations and cross-sections with high precision.


<details>
  <summary>Details</summary>
Motivation: To achieve unprecedented precision in measuring $δ_{m CP}$ and explore various neutrino physics cases.

Method: Utilizing a long-baseline neutrino oscillation experiment, a low energy monitored beam, and a nuSTORM facility.

Result: The setup aims to facilitate precise measurements of $δ_{m CP}$ and various neutrino interactions, including solar and atmospheric neutrinos.

Conclusion: ESSnuSBplus will advance the field of neutrino physics significantly with its comprehensive experimental approach.
...
### [96] [Towards Engineering Scaling Laws with Pretraining Data Composition](https://arxiv.org/abs/2606.19781)
*Jan-Lucas Uslu,Kevin Greif,Daniel Whiteson,Benjamin Nachman*

Main category: hep-ex

TL;DR: The paper explores how scaling laws in particle physics, particularly in classifying hadronic jets, can be optimized through data engineering, prioritizing additional data over model size for improved performance.


<details>
  <summary>Details</summary>
Motivation: Investigating neural scaling laws in the context of particle physics to optimize performance on tasks where high-fidelity simulators are available for creating diverse data.

Method: The authors engineered a pretraining dataset to be more diverse and aligned with the classification task of hadronic jets, promoting the use of more data rather than larger models.

Result: Empirical studies demonstrated that this engineered scaling behavior allows for performance improvements with increased data availability, rather than scaling up model size.

Conclusion: This approach can significantly enhance machine learning applications in particle physics by leveraging diversity in data to improve model performance efficiently.
...
### [97] [Resonant heterodyne conversion applied to a low-frequency haloscope for dark matter axion searches in the 1-35 MHz range](https://arxiv.org/abs/2606.20422)
*Navarro-Madrid Jose R.,Reina-Valero José,Díaz-Morcillo Alejandro,Gimeno Benito*

Main category: hep-ex

TL;DR: The paper presents a method for detecting low-mass dark matter axions via heterodyne up-conversion in RADES-BabyIAXO, focusing on optimizing cavity configurations for increased sensitivity.


<details>
  <summary>Details</summary>
Motivation: The research aims to enhance the search for low-mass dark matter axions using microwave cavities, addressing limitations in current detection methods.

Method: The study derives an axion-induced source term to calculate power extraction in a two-port cavity, extending the BI-RME 3D model to account for pump leakage, and identifying optimal mode pairs for resonance.

Result: The findings indicate a favorable mode pair that allows sensitivity to axion frequencies between 0.9 and 34.6 MHz, with predictions showing excellent resonance agreement and accurate off-resonance behavior.

Conclusion: Under ideal conditions, the RADES-BabyIAXO can probe axion-photon couplings to $10^{-15}\,	ext{GeV}^{-1}$ at 90% confidence, marking a significant advancement in detection capabilities.
...
### [98] [HEPTv2: End-to-End Efficient Point Transformer for Charged Particle Reconstruction](https://arxiv.org/abs/2606.20437)
*Siqi Miao,Shitij Govil,Jack P. Rodgers,Mia Liu,Javier Duarte,Shih-Chieh Hsu,Yuan-Tang Chou,Pan Li*

Main category: hep-ex

TL;DR: HEPTv2 is a novel end-to-end point-transformer architecture for charged-particle tracking at the HL-LHC, achieving state-of-the-art efficiency and accuracy without the need for graph construction or auxiliary stages.


<details>
  <summary>Details</summary>
Motivation: Accurate and efficient charged-particle tracking is critical at HL-LHC due to high collision densities; existing graph neural networks and transformer methods have limitations.

Method: HEPTv2 employs a locality-aware point encoder and a track decoder, leveraging locality-sensitive hashing and sectorized decoding for effective trajectory reconstruction in one trainable pipeline.

Result: HEPTv2 achieves 98.6% tracking efficiency at a 0.8% fake rate and demonstrates a significant reduction in latency and memory usage compared to previous methods.

Conclusion: HEPTv2 sets a new benchmark in the accuracy-latency trade-off for real-time particle reconstruction at HL-LHC, outperforming existing approaches significantly.
...
### [99] [Observation of electroweak production of pairs of Z bosons in proton-proton collisions at 13 TeV](https://arxiv.org/abs/2606.20558)
*CMS Collaboration*

Main category: hep-ex

TL;DR: First evidence of electroweak production of ZZ pairs with two jets reported by CMS, confirming standard model predictions.


<details>
  <summary>Details</summary>
Motivation: To investigate electroweak production mechanisms of Z boson pairs and search for potential new physics through anomalous gauge couplings.

Method: Analysis on proton-proton collisions at 13 TeV, selecting events with two leptons (same flavor, opposite charge), large missing transverse momentum, and two jets with specific properties.

Result: Measured electroweak production cross section of 0.37 fb, with significance of 3.1 standard deviations, consistent with the expected 0.39 fb from the standard model.

Conclusion: Combined significance with previous results increases to 5.0 standard deviations, strengthening the evidence for EW production of Z boson pairs.
...
### [100] [The next-to-leading order of the differential cross-section of the subprocess of Compton scattering of quark-gluon of prompt photon production in proton-proton collisions at NICA energies](https://arxiv.org/abs/2606.19389)
*Mohsun Rasim Alizada,Azar Inshalla Ahmadov*

Main category: hep-ph

TL;DR: The article presents next-to-leading-order calculations for Compton scattering in proton-proton collisions, showing significant contributions and polarization effects at NICA energies.


<details>
  <summary>Details</summary>
Motivation: Understanding the detailed dynamics of prompt photon production in high-energy proton collisions, particularly through Compton scattering processes.

Method: Next-to-leading-order calculations of the differential cross-section for the subprocess $qg \rightarrow q\gamma$, considering both polarized and unpolarized protons.

Result: The next-to-leading-order contribution is about 15% of the leading-order calculation and has pronounced effects from proton polarization.

Conclusion: Polarization of colliding protons plays a critical role, with greater significance on next-to-leading-order calculations compared to leading-order results.
...
### [101] [Emergent Gauge Symmetries in Particle Physics and Cosmology](https://arxiv.org/abs/2606.19403)
*Steven D. Bass*

Main category: hep-ph

TL;DR: The paper discusses the emergence of gauge symmetries in the Standard Model, suggesting they may originate from a phase transition in the ultraviolet regime, linking concepts of dark energy and neutrino masses and proposing potential experimental tests.


<details>
  <summary>Details</summary>
Motivation: To explore the origin of gauge symmetries and their implications in high-energy physics, particularly concerning the Higgs vacuum and possible emergent phenomena.

Method: Analyzing the stability of the Higgs vacuum and connecting it to high energy scales, along with proposing dark matter candidates and experimental tests involving neutrinos and gravitational waves.

Result: It posits that the dark energy scale is comparable to light Majorana neutrino masses, both arising around the same high energy scale of approximately $10^{16}$ GeV, and identifies potential dark matter candidates.

Conclusion: The study suggests a deep connection between low energy physics and ultraviolet phenomena, with implications for understanding dark matter and guiding future experimental investigations.
...
### [102] [LeWRON: Agentic Analysis of Electroweak Phase Transitions](https://arxiv.org/abs/2606.19425)
*Isaac R. Wang*

Main category: hep-ph

TL;DR: LeWRON is a framework that streamlines the electroweak phase transition analysis by automating processes from Lagrangian input to generating outputs with reproducibility.


<details>
  <summary>Details</summary>
Motivation: The complexity of analyzing the electroweak phase transition necessitates a robust, user-friendly tool that can handle various models and ensure reproducibility.

Method: LeWRON orchestrates the entire analysis pipeline, featuring an Explorer module that generates model-specific code and auditor agents that verify outputs, accessible via a command-line interface and Python API.

Result: LeWRON automates and simplifies the finite-temperature effective potential analysis, bubble nucleation rates, and gravitational-wave predictions, successfully demonstrating its functionality with various beyond-the-Standard-Model scenarios.

Conclusion: The framework enhances reproducibility and facilitates exploration of new models, making it a significant contribution to the field of particle physics and cosmology.
...
### [103] [Partial-wave unitarity and long-range interactions](https://arxiv.org/abs/2606.19432)
*Ryan Plestid,Pablo Quílez Lasanta*

Main category: hep-ph

TL;DR: This paper addresses the issue of ill-defined partial-wave amplitudes in theories with massless particles, proposing a modified perturbation theory that incorporates off-shell Coulomb modes to generate well-defined amplitudes.


<details>
  <summary>Details</summary>
Motivation: The motivation stems from the complications introduced by massless particles, specifically the presence of $t$-channel singularities that affect the validity of standard partial-wave unitarity bounds.

Method: The authors propose a modified perturbation theory that focuses on off-shell Coulomb modes and emphasizes a universal description for the forward scattering region, allowing for computations order-by-order without dependence on infrared regulators.

Result: The study finds that this approach leads to scale-independent amplitudes that are well-defined in the forward scattering region, enhancing the reliability of theoretical predictions.

Conclusion: The paper concludes that the constructed partial-wave amplitudes represent single-scale objects, thus resolving previous issues related to infrared regulation and enhancing perturbative calculations.
...
### [104] [From Rags to Jeans: Axion Miniclusters from Early matter domination](https://arxiv.org/abs/2606.19439)
*Ariel Angulo,Paola Arias,Nicolás Bernal,Javier Redondo*

Main category: hep-ph

TL;DR: The paper explores how temperature-dependent axion mass variations in a matter-dominated universe create density fluctuations, potentially leading to significant axion overdensities and the formation of miniclusters and substructures.


<details>
  <summary>Details</summary>
Motivation: To investigate the role of temperature-dependent axion mass in enhancing density fluctuations during a matter-dominated era, contrasting with standard cosmological models.

Method: The authors analyze the growth of spatial fluctuations in axion mass induced by density and temperature inhomogeneities, focusing on scenarios where the reheating temperature is just below the mass-saturation scale.

Result: The mechanism can produce axion overdensities up to order unity by matter-radiation equality, with a nonlinear spectrum showing two distinct regions influenced by gravitational effects and temperature-dependent mass.

Conclusion: The study provides insights into the possible formation of axion miniclusters and axion-star substructure, which could have implications for dark matter observations.
...
### [105] [Spin Identification of Dark Sector Mediators through Angular Distributions](https://arxiv.org/abs/2606.19543)
*D. Aristizabal Sierra,S. Fuenzalida Garrido,F. Kling,T. Mäkelä,N. Viaux*

Main category: hep-ph

TL;DR: The paper discusses an angular observable for determining the quantum numbers of newly discovered dark sector particles and demonstrates that experiments like DUNE, SHiP, and FASER2 can exploit this observable to distinguish between vector and scalar bosons.


<details>
  <summary>Details</summary>
Motivation: The need to classify the quantum numbers of light long-lived dark sector particles upon their discovery drives the research.

Method: An angular observable is identified and analyzed, reconstructible from the four-momenta of decay products, distinguishing between the decay patterns of vector bosons (anisotropic) and scalars (isotropic).

Result: The proposed method can identify the spin of the mediator particle in untested parameter spaces at future experiments.

Conclusion: Experiments such as DUNE, SHiP, and FASER2 are capable of employing this observable to explore significant regions of parameter space for dark sector particles.
...
### [106] [Real and Virtual Propagation in Neutrino Oscillations](https://arxiv.org/abs/2606.19548)
*Kenji Nishiwaki,Kin-ya Oda,Juntaro Wada*

Main category: hep-ph

TL;DR: The paper analyzes flavor oscillations in vacuum through propagation times, revealing thresholds for oscillations based on energy uncertainty and particle decay width.


<details>
  <summary>Details</summary>
Motivation: To understand flavor oscillations better, especially under shorter propagation times, and extend the Jacob--Sachs theorem's applicability.

Method: The paper employs the saddle-point method to evaluate integrals related to flavor-changing amplitudes, deriving an extended formula that remains relevant for shorter propagation.

Result: Oscillations occur only when propagation time exceeds a threshold defined by the energy uncertainty and decay width. The Jacob--Sachs theorem is shown to hold with greater accuracy than previously thought, even for short times.

Conclusion: The findings suggest that the transition from virtual to real propagation could be observable with improved energy resolution, and the formalism can apply broadly beyond neutrinos.
...
### [107] [Freeze-in at all couplings](https://arxiv.org/abs/2606.19564)
*Andreas Goudelis,Andre Lessa,Lucas Magno Dantas Ramos,Thomas Reggio*

Main category: hep-ph

TL;DR: The paper analyzes a charged freeze-in dark matter model under low reheating temperatures, revealing significant coupling possibilities and dynamics affecting dark matter production and mediator behavior.


<details>
  <summary>Details</summary>
Motivation: To explore dark matter production mechanisms in scenarios where reheating temperatures are low compared to mass scales, which can enhance coupling strengths while aligning with observed relic abundances.

Method: The authors employ a detailed analysis of particle number density evolution of both dark matter and mediators, considering the interactions and potential non-equilibration effects of mediators due to rapid decays.

Result: The study discovers that strong couplings can exist between dark matter and the Standard Model while still obeying thermal constraints; it also finds unexpected mediator dynamics leading to non-equilibrium states.

Conclusion: The findings have important implications for LHC searches and lepton flavour-violating decays, suggesting new avenues to probe the parameters of viable dark matter scenarios.
...
### [108] [Sensitivity of the photon-induced processes to the proton radius](https://arxiv.org/abs/2606.19604)
*Nikhil Krishna,Mariola Klusek-Gawenda,Rafal Staszewski*

Main category: hep-ph

TL;DR: The study investigates dilepton production in proton-proton collisions to probe the proton radius, finding sensitivity linked to different models, but not resolving the proton radius puzzle.


<details>
  <summary>Details</summary>
Motivation: To explore the proton radius using dilepton production in proton-proton collisions, enhancing understanding of proton structure.

Method: Employing a dipole form factor model, the research compares conventional and alternative values of the proton radius based on dilepton invariant masses and rapidity.

Result: Fitting ATLAS and CMS data yields a value of $Λ^2 = 0.465 \, 	ext{GeV}^2$, leading to an effective radius of $r_p = 1.002 \, 	ext{fm}$, suggesting some sensitivity to proton radius variations.

Conclusion: While results indicate sensitivity to the proton radius, they do not provide a definitive resolution to the existing proton radius puzzle.
...
### [109] [Massive right-handed neutrinos in $\bar{B} \to D^* τ\bar X$ decay](https://arxiv.org/abs/2606.16166)
*Nilakshi Das,Alakabha Datta,Tejhas Kapoor,Danny Marfatia,Lopamudra Mukherjee*

Main category: hep-ph

TL;DR: This paper investigates the impact of a massive right-handed neutrino on certain decay processes, providing new differential distributions and sensitivity evaluations for potential new physics insights.


<details>
  <summary>Details</summary>
Motivation: To understand the effects of a massive right-handed neutrino in the context of the standard model effective field theory and its implications for particle decays.

Method: The paper derives full differential angular distributions for the decay process $ar{B} 	o D^* 	au ar X$, incorporating the decay of the $τ$ lepton and analyzing its visible final states.

Result: The authors present the first comprehensive calculations of differential distributions for the decay process, highlighting how these distributions can reveal signatures of new physics related to RHNs.

Conclusion: The results enhance sensitivity to explore new physics operators, aiding in the search for signatures of right-handed neutrinos in particle decays.
...
### [110] [$U(1)_{B-L}$ Dark Matter Constrains Smooth (SUSY) Hybrid Inflation](https://arxiv.org/abs/2606.19612)
*Karim M. Selim,A. Y. Ellithi,M. Abolmahassen,Shaaban Khalil*

Main category: hep-ph

TL;DR: This paper presents a framework linking inflationary dynamics to dark matter production within a supersymmetric model, revealing significant constraints on the inflationary sector based on dark matter relic abundance.


<details>
  <summary>Details</summary>
Motivation: To connect inflationary dynamics with dark matter production in a theoretically consistent framework, addressing both cosmic inflation and dark matter physics.

Method: A unified framework is developed based on smooth hybrid inflation in supergravity, involving three scalar fields: the inflaton, an auxiliary field, and a singlet mediator. Dark matter is produced non-thermally through reheating dynamics.

Result: Reproducing the observed dark matter relic abundance leads to strong constraints on the inflationary parameters, narrowing the parameter space and constraining the scalar spectral index to around 0.972 - 0.974.

Conclusion: The coupling between the inflaton and dark matter has negligible background effects but modifies observable quantities, linking dark matter physics directly to inflationary observables.
...
### [111] [Self-Calibration of the Neutrino-Argon Cross Section with Solar Neutrinos](https://arxiv.org/abs/2606.18347)
*Rasmi Hajjar,Obada Nairat,John F. Beacom*

Main category: hep-ph

TL;DR: This paper reveals the potential for precise measurement of the charged-current cross section for $ν_e+	ext{^{40}Ar}$ using solar-neutrino data, achieving a precision of $	extless 2%$ under controlled conditions.


<details>
  <summary>Details</summary>
Motivation: Understanding the charged-current cross section is vital for DUNE's MeV physics program but existing measurements have high uncertainties.

Method: Utilizing solar-neutrino data with known $^8$B flux and survival probability, the authors propose methods, including Principal Component Analysis, to extract transition strengths.

Result: Achieved a potential precision of $	extless 2%$ on the cross section in the 9-15 MeV energy range, even under conservative detection assumptions.

Conclusion: This method lays the groundwork for future studies of the cross section at higher energies, critical for advancing supernova and atmospheric neutrino research.
...
### [112] [Charged Lepton Flavor Violation at Neutrino Telescopes](https://arxiv.org/abs/2606.19723)
*Writasree Maitra,Carlos A. Argüelles,P. S. Bhupal Dev,Ivan Martinez-Soler,Manibrata Sen*

Main category: hep-ph

TL;DR: The paper proposes a novel method for searching charged lepton flavor violation (CLFV) using neutrino telescopes, specifically through muon-to-tau conversion within the IceCube detector, leveraging a recent muon dataset and model-independent Effective Field Theory (EFT) operators.


<details>
  <summary>Details</summary>
Motivation: The observation of CLFV would indicate physics beyond the Standard Model, and existing methods could be enhanced using large cosmic-ray muon samples from neutrino telescopes.

Method: The study utilizes the IceCube muon dataset to search for muon-to-tau conversion, illustrating interactions via Effective Field Theory (EFT) operators and assessing sensitivities in terms of mass-coupling planes for specific interactions like axial-vector $Z'$.

Result: Sensitivities on the relevant EFT scales and comparisons with low-energy CLFV searches, as well as current and future collider experiments, are established.

Conclusion: Next-generation neutrino telescopes like IceCube-Gen2 and HUNT can significantly enhance CLFV search capabilities, providing complementary insights to existing methods.
...
TL;DR: The paper investigates constraints on microscopic black holes at the LHC using the ADD model, revealing how black hole mass limits change with varying loss parameter ζ and reduced Planck scale Λ_D.


<details>
  <summary>Details</summary>
Motivation: To explore the properties and constraints of microscopic black holes formed at high-energy experiments such as the LHC.

Method: The analysis uses data from LHC with a center-of-mass energy of 14 TeV and integrated luminosity of 349.4 fb⁻¹, examining the influence of black hole formation loss (parameter ζ) on mass limits.

Result: For ζ=0, the mass of disfavored black holes is 11.83 TeV for three extra dimensions and about 10.33 TeV for a reduced Planck scale of 9 TeV. Increasing ζ leads to significantly lower mass limits, e.g., 7.65 TeV at ζ=0.35 and Λ_D=1 TeV.

Conclusion: The study quantifies the influence of black hole formation losses on mass limits, showing considerable reductions in allowable mass as ζ increases and highlighting the importance of loss during black hole formation.
...
### [114] [Extraction of charmonium branching fractions from $J/ψ\toγη_c$ radiative decays](https://arxiv.org/abs/2606.19902)
*Magnus C. Schaaf,Antonio Vairo*

Main category: hep-ph

TL;DR: This paper examines the discrepancies between theoretical predictions and Particle Data Group (PDG) values for the radiative decay of J/ψ to η_c and proposes a new method for analyzing the decay spectra to improve accuracy.


<details>
  <summary>Details</summary>
Motivation: To address the inconsistencies between theoretical predictions for the radiative decay of J/ψ and the experimental data provided by the PDG.

Method: The authors conduct a profile scan of PDG data on the branching fraction and propose a new photon line shape for the decay spectrum that avoids empirical damping functions.

Result: They find that the measured branching fractions are compatible with lattice QCD results, providing a consistent theoretical framework for understanding the decay process.

Conclusion: The proposed method offers a more precise way to extract branching fractions and eliminates ambiguities in previous empirical approaches.
...
### [115] [New Avenues of Heavy Neutral Lepton at Muon Collider](https://arxiv.org/abs/2606.19906)
*Fa-Xin Yang,Feng-Lan Shao,Zhi-Long Han,Honglei Li*

Main category: hep-ph

TL;DR: This paper examines new production processes of heavy neutral leptons in a multi-TeV muon collider, leveraging vector boson fusion involving a new gauge boson $Z'$ and heavy Higgs $H$, with implications for lepton number violation.


<details>
  <summary>Details</summary>
Motivation: To explore production mechanisms for heavy neutral leptons beyond the standard model at high-energy muon colliders, focusing on novel vector boson fusion channels.

Method: Analyzing processes like $Z'Z'	o H	o NN$ and $Z'Z'	o NN$, both with and without heavy Higgs involvement, to assess the associated lepton number violation signals.

Result: The new fusion processes are less suppressed than canonical methods due to minimal mixing angle effects and can still be effective even for heavy Higgs masses exceeding the collider's energy.

Conclusion: These strategies open new avenues for probing heavy neutral leptons and their interactions, enhancing the potential for discovering new physics beyond the standard model.
...
### [116] [$Ξ_{cc}^{++}-Ξ_{cc}^{+}$ Transitions as a Two-Charm-Selective Portal to Ultra-Low-$Q$ Charged Currents](https://arxiv.org/abs/2606.19991)
*Yong Du*

Main category: hep-ph

TL;DR: The paper discusses the implications of the LHCb observation of $Ξ_{cc}^{+}$ for testing new physics via the ultra-low-$Q$ transition $Ξ_{cc}^{++}	oΞ_{cc}^{+}$, establishing sensitivity to effective baryon-level couplings, and outlining limitations imposed by existing electroweak-precision and beta-decay constraints on potential new scalar mediators.


<details>
  <summary>Details</summary>
Motivation: To explore experimental opportunities for probing new physics through transitions involving doubly charmed baryons, particularly in light of recent experimental observations.

Method: The authors perform two- and three-body analyses to assess the sensitivity of $Ξ_{cc}^{++}	oΞ_{cc}^{+}$ transitions to baryonic couplings, while also identifying specific interactions that only manifest in certain baryon types.

Result: They show that existing constraints on a universal light charged scalar exceed the sensitivity expected from future LHCb experiments, leading to a no-go result under these conditions. Moreover, they propose a novel charged-current portal interaction relevant for doubly charmed baryons.

Conclusion: The transitions $Ξ_{cc}^{++}	oΞ_{cc}^{+}$ could serve as valuable probes for new interactions, specifically in contexts where traditional meson-level couplings do not apply.
...
### [117] [NLO QCD and EW corrections to semileptonic vector-boson scattering at the LHC](https://arxiv.org/abs/2606.19999)
*Ansgar Denner,Robert Franken,Daniele Lombardi,Santiago Lopez Portillo Chavez*

Main category: hep-ph

TL;DR: This paper presents the NLO QCD and electroweak corrections for vector-boson scattering with semileptonic final states, focusing on the process p p → ℓ⁺ νₗ + 4j and provides results for fiducial cross sections and distributions.


<details>
  <summary>Details</summary>
Motivation: The recent measurements at the LHC have highlighted the need for precise theoretical predictions for vector-boson scattering, particularly as future experiments promise increased precision.

Method: The authors calculate NLO QCD and electroweak corrections using a fully off-shell approach, focusing on the leading electroweak contribution of O(α⁶) and higher-order corrections of O(α⁷) and O(αₛ α⁶).

Result: Results are presented for fiducial cross sections and a selection of differential distributions, incorporating significant electroweak contributions and corrections.

Conclusion: The findings are expected to enhance the theoretical framework for vector-boson scattering, providing crucial predictions that are needed as experimental precision increases.
...
### [118] [Two Flavon Froggatt-Nielsen Models with Genetic Algorithms](https://arxiv.org/abs/2606.20000)
*Miguel Crispim Romão,Stephen F. King*

Main category: hep-ph

TL;DR: A comprehensive scan of two-flavon Froggatt-Nielsen models using AI reveals numerous viable models, contributing to CP violation and charged fermion mass predictions.


<details>
  <summary>Details</summary>
Motivation: To explore the extension of single-flavon Froggatt-Nielsen models and address CP violation through a systematic parameter search.

Method: Utilized Non-dominated Sorting Genetic Algorithm III for multi-objective optimization across a mixed discrete-continuous parameter space, fitting 18 FN charges, 45 Wilson coefficients, and flavon parameters against experimental constraints.

Result: Discovered over 100,000 unique viable models with low duplication, accommodating both normal and inverted neutrino mass orderings and distinct predictions for neutrinoless double beta decay mass.

Conclusion: Identified minimal FN realizations with small exponents and accurate predictions of charged fermion masses without extensive continuous parameter optimization.
...
### [119] [Non-standard decays of vector-like top partners in a $2$-Higgs doublet model at the HL-LHC](https://arxiv.org/abs/2606.20054)
*Tanumoy Mandal,Stefano Moretti,Rachit Sharma*

Main category: hep-ph

TL;DR: This paper explores the discovery potential of vector-like quarks (VLQs) in extended Higgs sectors at the HL-LHC, focusing on unique decay channels involving charged Higgs and resulting in distinctive collider signals.


<details>
  <summary>Details</summary>
Motivation: To enhance probe capabilities of VLQs that may decay through non-standard Higgs interactions, providing a new avenue in Higgs physics analysis.

Method: A model-independent collider analysis utilizing global kinematic observables and polarization-sensitive factors to suppress backgrounds and enhance sensitivity to VLQ decays leading to final states with two tau leptons, two b-jets, and missing energy.

Result: The analysis indicates that the search for the decay channel of $T	o H^{	ext{±}} 	o τν$ is feasible, enabling discovery-level sensitivity for VLQs up to approximately 1.9 TeV with an integrated luminosity of 3 ab$^{-1}$ at 14 TeV.

Conclusion: The $2τ	ext{ + }2b	ext{ + missing }E_T$ channel is a promising method to explore non-standard VLQ decay processes, potentially enhancing our understanding of extended Higgs sectors.
...
### [120] [Toward Precision Fragmentation of $Ω_{3Q}$ Baryons: The OMG3Q1.1 Framework](https://arxiv.org/abs/2606.20063)
*Francesco Giovanni Celiberto*

Main category: hep-ph

TL;DR: The OMG3Q1.1 framework offers a precise and uncertainty-controlled approach for studying the fragmentation of same-flavor all-heavy baryons in high-energy collisions, aiming at improved understanding of rare triply heavy baryons.


<details>
  <summary>Details</summary>
Motivation: The renewed interest in heavy hadronic systems, especially after observing doubly charmed states, necessitates precise descriptions of their production mechanisms.

Method: The framework integrates diquark-inspired inputs for heavy quark and gluon channels with threshold-aware DGLAP evolution within the HF-NRevo scheme, while implementing a strategy to quantify perturbative and nonperturbative uncertainties.

Result: The framework produces the first uncertainty-resolved fragmentation-function set for the $Ω_{3Q}$ sector, with LHAPDF6 grids facilitating the study of semi-inclusive $Ω_{3Q}$ plus jet production at high-energy colliders.

Conclusion: OMG3Q1.1 serves as a precision baseline for investigating rare triply heavy baryons and sets the stage for future research in heavy-flavor baryon physics.
...
### [121] [The Simplest Dirac Scoto-Seesaw Realization](https://arxiv.org/abs/2606.20119)
*Sin Kyu Kang,Ranjeet Kumar,Hemant Kumar Prajapati*

Main category: hep-ph

TL;DR: The paper proposes a Dirac scoto-seesaw framework leveraging an anomaly-free $U(1)_{B-L}$ charge assignment to explain neutrino mass differences and provide a stable dark matter candidate.


<details>
  <summary>Details</summary>
Motivation: To create a simple framework that connects neutrino mass generation with dark matter stability through a specific $U(1)_{B-L}$ symmetry.

Method: Utilizes a chiral charge assignment $(-4,-4,5)$ for right-handed neutrinos, generating neutrino mass-squared differences with both tree-level and radiative contributions, and investigates minimal realizations under $Z_6$ symmetry.

Result: Both normal and inverted neutrino mass orderings are viable in one instance, while only normal ordering persists in another, leading to distinct neutrino observable features; the $Z'$ portal enhances dark matter phenomenology.

Conclusion: The framework provides a predictive model for neutrino and dark matter interactions that can be tested in future experimental setups.
...
### [122] [Theory Calculations for LDMX and LOHENGRIN beyond Coherent Bethe-Heitler Scattering](https://arxiv.org/abs/2606.20327)
*Martin Schürmann,Herbert K. Dreiner,Rhorry Gauld*

Main category: hep-ph

TL;DR: This study investigates the differential cross sections for dark photon production in bremsstrahlung processes, highlighting the need for updated experimental setups to improve signal detection.


<details>
  <summary>Details</summary>
Motivation: The experiments LDMX, DarkSHINE, and LOHENGRIN aim to detect dark photons via missing momentum signals in electron scattering processes, which could help understand dark matter interactions.

Method: Calculations were performed for differential cross sections of all contributing processes up to third order in the electromagnetic coupling and fourth order in the kinetic mixing parameter, incorporating both real and virtual dark photon emissions.

Result: Numerical results demonstrated signal characteristics, including cross sections and distributions, emphasizing the need for LOHENGRIN's HCAL extension to filter specific background processes.

Conclusion: Contributions beyond coherent Bethe-Heitler scattering have a limited effect on the observed signal and background, underlining the importance of precise experimental configurations.
...
### [123] [New Gauge Forces, Neutron Stars and Schwinger Neutrino Production](https://arxiv.org/abs/2606.20393)
*Yuxin Liu,Zhen Liu,Andrey Shkerin,Jing Shu,Yue Zhao*

Main category: hep-ph

TL;DR: The paper analyzes the effects of new long-range forces from specific symmetries on neutrino interactions, finding observable effects for the $L_μ-L_τ$ force in neutron stars but weak effects for others.


<details>
  <summary>Details</summary>
Motivation: To explore the implications of newly gauged symmetries in the Standard Model on neutrino behavior under the influence of astronomical bodies.

Method: The authors examine the neutrino potential created by massive astronomical objects, resulting in the Schwinger pair production of neutrinos and the formation of a degenerate Fermi gas of oppositely charged particles while others escape.

Result: They determine that the $B-L$ and $L_e-L_{μ/τ}$ forces have negligible effects, while significant effects for the $L_μ-L_τ$ force arise in neutron stars for gauge coupling $g	extgreater10^{-18}$.

Conclusion: The findings suggest that the gauge coupling can lead to detectable neutrino flux from neutron stars, with implications for existing constraints on gauge coupling from neutron star mergers.
...
### [124] [Addressing uncertainties of model predictions for extensive air showers initiated by high energy cosmic rays](https://arxiv.org/abs/2606.20221)
*Sergey Ostapchenko,Tanguy Pierog,Günter Sigl*

Main category: hep-ph

TL;DR: A new Monte Carlo generator, QGSb, assesses model uncertainties in extensive air showers (EAS) caused by high-energy cosmic rays, focusing on air shower maximum and muon counts.


<details>
  <summary>Details</summary>
Motivation: Understand and quantify uncertainties in model predictions for cosmic ray studies using EAS characteristics.

Method: Modification of QGSb model predictions for air shower maximum depth and ground-level muon number, with analyses of underlying physics mechanisms.

Result: Analysis of model modifications and their impact in relation to accelerator data for better understanding of cosmic ray composition.

Conclusion: Insight into the reliability of current models for cosmic ray research, emphasizing the need for rigorous testing against experimental data.
...
### [125] [The $B^+ \to K^+ ν\bar ν$ decay as a QCD axion search: comparing reinterpretation approaches](https://arxiv.org/abs/2606.20525)
*Merna Abumusabh,Giulio Dujany,Diego Guadagnoli,Méril Reboud,Claudio Toni*

Main category: hep-ph

TL;DR: Two analyses of Belle II data on the decay $B^+ \to K^+\nu\bar\nu$ yield differing limits for a related decay mode $B^+ \to K^+ a$, attributable to variable space choices affecting kinematic resolution.


<details>
  <summary>Details</summary>
Motivation: To resolve discrepancies in decay limits for the invisible particle decay mode by analyzing the impact of kinematic variable selection.

Method: The study examines the resolution of the di-neutrino invariant mass $q^2_{\rm rec}$ and tests various kinematic variable spaces, demonstrating how fine or coarse binning affects signal identification.

Result: The differential limits for $B^+ \to K^+ a$ stem from how well the decay shapes are resolved; fine binning reveals signals while coarse binning dilutes them. BDT-trained axes don't significantly improve discrimination in this context.

Conclusion: It is recommended that collaborations publish likelihood projections in physical variable spaces to enhance the reinterpretability of measurements, given the limitations of BDT based likelihoods in cases of shape discrepancy.
...
### [126] [Three-particle di-light-cone distribution amplitudes of the $B$-meson in heavy-quark effective theory](https://arxiv.org/abs/2606.20267)
*Riccardo Bartocci,Philipp Böer,Thorsten Feldmann,Max Ferré,Nico Gubernari,Daniel Vladimirov*

Main category: hep-ph

TL;DR: This study investigates the three-particle di-light-cone distribution amplitudes (DLCDAs) of B-mesons, extending conventional light-cone distributions to include configurations with soft fields and their correlation with non-perturbative dynamics in exclusive B-meson decays.


<details>
  <summary>Details</summary>
Motivation: To understand the non-factorisable soft-gluon contributions in rare and non-leptonic exclusive B-meson decays through a thorough analysis of B-meson di-light-cone distribution amplitudes (DLCDAs).

Method: We derive the complete Lorentz decomposition of trilocal HQET operator matrix elements, identify eight independent DLCDAs, and establish their relations and normalization integrals using local operator identities and equations-of-motion constraints.

Result: The study successfully organizes DLCDAs in a basis of definite twist, providing tree-level normalization relations and constructing models for independent DLCDAs, including perturbative corrections.

Conclusion: The findings enhance the understanding of the dynamics of B-mesons, particularly the role of soft gluons in exclusive decays, informing future calculations and models in particle physics.
...
### [127] [Dyonic lattices, $θ$-angles and axions in the Standard Model](https://arxiv.org/abs/2606.20319)
*Rodrigo Alonso,Francesca Chadha-Day,Despoina Dimakou,Yunji Ha,Valentin V. Khoze*

Main category: hep-ph

TL;DR: This study explores the implications of the Witten effect in the Standard Model, focusing on the classification of dyonic charge lattices and the relationship between the $θ$-parameters and CP-invariance.


<details>
  <summary>Details</summary>
Motivation: To understand the implications of the Witten effect within the Standard Model's gauge structure and its effects on dyonic spectra and CP invariance.

Method: The authors investigate the values of three $θ$-parameters and classify dyonic charge lattices, examining the resulting periodicities and CP-invariant points in $θ$-space.

Result: The study identifies how the electromagnetic subgroup arises prior to electroweak symmetry breaking and reduces the $θ$-parameter space, revealing implications for axion physics and monopole charge.

Conclusion: Discovery of a charged $U(1)_{	ext{em}}$ monopole could finalize unknown parameters in the Standard Model, and a single axion cannot achieve full CP invariance.
...
### [128] [Renormalization of axial anomaly in SU(N)$\times$U(1)](https://arxiv.org/abs/2606.20342)
*Tanmoy Pati,Narayan Rana*

Main category: hep-ph

TL;DR: This paper introduces a novel method to compute renormalization constants for $γ_5$ in dimensional regularization, extending known techniques to mixed gauge sectors and providing three-loop results for a specific gauge group.


<details>
  <summary>Details</summary>
Motivation: To meet the precision requirements of Standard Model phenomenology, particularly regarding the treatment of $γ_5$ in mixed gauge sectors.

Method: A new technique using form factors and the universality of infrared divergences to compute renormalization constants is proposed.

Result: New three-loop results for the renormalization constants and pure-singlet contributions to the quark axial-vector form factor for a mixed $SU(N) \times U(1)$ gauge group are presented.

Conclusion: The method advances the understanding of $γ_5$ within dimensional regularization, offering crucial insights for quantum field theory calculations in mixed gauge sectors.
...
### [129] [Revisiting the role of saturation in diffractive vector meson production](https://arxiv.org/abs/2606.20362)
*Heikki Mäntysaari,Hendrik Roch,Björn Schenke,Chun Shen,Wenbin Zhao*

Main category: hep-ph

TL;DR: A Bayesian analysis of diffractive J/ψ photoproduction in γ+p and γ+Pb collisions shows a consistent description using a CGC framework, aided by EMD corrections.


<details>
  <summary>Details</summary>
Motivation: To resolve the tension in model parameters between proton and nuclear datasets in diffractive J/ψ photoproduction.

Method: Global Bayesian analysis using a CGC-based framework, Gaussian-process emulators, and corrected LHC data for the electromagnetic dissociation effect.

Result: The EMD-corrected γ+Pb data reduce tension between datasets, allowing for consistent modeling of diffractive J/ψ production across γ+p and γ+Pb collisions.

Conclusion: A unified description of diffractive J/ψ production is achieved in both collision types using the CGC framework.
...
### [130] [Phase Transitions and Gravitational Wave Production at the End of Thermal Inflation](https://arxiv.org/abs/2606.20392)
*Hyukjung Kim,İlayda Kuzu,Kerem Özsoy,Zeynep Kahraman,Wan-Il Park,Heeseung Zoe*

Main category: hep-ph

TL;DR: The paper explores a first-order phase transition linked to thermal inflation, assessing gravitational-wave signals through semi-analytic and numerical methods.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics of first-order phase transitions and their implications for gravitational wave signals post-thermal inflation.

Method: Characterization through bounce action calculations, comparison with CosmoTransitions, and real-time evolution simulation in a three-dimensional Langevin lattice framework.

Result: The phase transition is driven by localized bubble nucleation, with the gravitational-wave spectra from bubble collisions and acoustic motions predicted to be detectable by future observatories.

Conclusion: The findings indicate that the gravitational-wave signals generated are within the sensitivity range of advanced gravitational-wave observatories.
...
### [131] [The X17 Anomaly: Experimental Evidence and Theoretical Interpretations](https://arxiv.org/abs/2606.20423)
*Raoul Serao,Aniello Quaranta,Antonio Capolupo*

Main category: hep-ph

TL;DR: The review evaluates evidence for the X17 particle, its theoretical frameworks, implications for the Standard Model, and future experimental prospects.


<details>
  <summary>Details</summary>
Motivation: To explore the existence and significance of the hypothetical X17 particle in the context of particle physics.

Method: Review of experimental evidence and theoretical frameworks surrounding the X17 particle.

Result: Identification of how the X17 particle could integrate into existing physics models and its interactions with known particles.

Conclusion: The X17 particle presents potential challenges and opportunities for advancements in the Standard Model and future experimental research.
...
### [132] [String Axiverse Enhancement of Superradiant Dark Matter Production](https://arxiv.org/abs/2606.20524)
*Diogo S. Gorgulho,Jacob A. Litterer,João G. Rosa*

Main category: hep-ph

TL;DR: The paper explores how string axion emissions impact dark matter production from light primordial black holes via evaporation and superradiance, expanding the viable parameter space for dark matter and PBHs in the axiverse context.


<details>
  <summary>Details</summary>
Motivation: To investigate the influence of axions from string theory on dark matter and primordial black hole dynamics, particularly in enhancing superradiance and altering black hole evaporation rates.

Method: The authors analyze the effects of Hawking radiation from a range of light axion species on the efficiency of superradiance and the resulting dark matter configurations stemming from primordial black holes.

Result: The study finds that an optimal number of light axion species enhances superradiance and allows for the formation of micro-boson stars, while too many species lead to rapid PBH evaporation, limiting superradiant growth.

Conclusion: Assuming all dark matter is produced via PBHs, the contribution of axions from BH evaporation to the relativistic degrees of freedom at recombination is negligible.
...
### [133] [Rotating magnetized pion gas of finite transverse size: condensation constraints and transport properties](https://arxiv.org/abs/2606.20530)
*Ankit Kumar,Diwakar Gaur,Vinod Chandra*

Main category: hep-ph

TL;DR: This study explores the electric, thermal, and thermoelectric responses of a rotating pion gas in a magnetic field, revealing unique transport properties and interactions between rotation and magnetic field effects.


<details>
  <summary>Details</summary>
Motivation: To understand the effects of rotation and magnetic fields on the transport properties of a pion gas, particularly in the context of $π^+$ condensation.

Method: Utilizing the Boltzmann Transport Equation under the Relaxation Time Approximation to calculate transport coefficients such as electrical conductivity, thermal conductivity, and the Seebeck coefficient.

Result: Rotational effects enhance transport coefficients in a magnetized medium, showing a transition where rotation overcomes magnetic suppression beyond a certain angular velocity.

Conclusion: The study provides insights into the transport characteristics of a rotating magnetized pion medium and the interplay between charge and heat transport through the Lorenz number.
