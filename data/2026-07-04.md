...
TL;DR: The paper reviews planned upgrades to HEP detectors at major experiments, focusing on the integration of precision timing technology and its potential to create triggerless detectors, enhancing real-time data processing and physics research.


<details>
  <summary>Details</summary>
Motivation: The increasing data output from HEP experiments and the need for efficient processing methods drive the introduction of precision timing in detector upgrades.

Method: Reviews upcoming upgrades for CMS, ATLAS, and LHCb experiments, focusing on the integration of picosecond timing with networking technologies to enable triggerless designs.

Result: The combination of timing and networking technologies could revolutionize detector design, improving data selection and processing capabilities.

Conclusion: Adopting a triggerless approach could lead to significant advancements in the efficiency and effectiveness of high-energy physics experiments.
...
TL;DR: This paper presents a more efficient method for depth-of-interaction (DOI) and energy calibration of PET detector arrays using uncollimated gamma-ray irradiation, demonstrating effective results compared to traditional methods.


<details>
  <summary>Details</summary>
Motivation: Traditional gold-standard DOI calibration is impractical for large detector arrays, prompting the need for a more efficient calibration method.

Method: The study compares the calibration of a dual-ended readout PET detector using collimated and uncollimated gamma-ray irradiation, focusing on MLP and physics-informed approaches for DOI calibration.

Result: The MLP-based approach outperformed the physics-informed model, achieving better DOI resolution and a mean energy resolution of 15.6%.

Conclusion: The MLP-based DOI and energy calibration is simpler to implement and suitable for real-time calibration of PET detector panels.
...
TL;DR: The paper introduces WavePID, a log-likelihood-ratio classifier utilizing nanosecond-scale timing to enhance neutrino flavor identification, improving classification performance in the 5–100 GeV energy range.


<details>
  <summary>Details</summary>
Motivation: Improving neutrino flavor classification in the challenging 5–100 GeV range, crucial for oscillation measurements and new physics searches.

Method: WavePID employs a log-likelihood-ratio approach based on timing information from individual detector modules, using observables like distance to the vertex, early-charge fraction, and time differences between modules.

Result: WavePID outperforms traditional classifiers, demonstrating improved cascade purity and classification performance when coupled with a graph neural network.

Conclusion: The findings highlight the potential of utilizing nanosecond-scale pulse timing in future low-energy neutrino classifiers and upcoming neutrino telescope designs.
...
TL;DR: APEIRON is a distributed processing framework for multi-FPGA systems, designed for smart trigger and data acquisition in high energy physics.


<details>
  <summary>Details</summary>
Motivation: To enhance the capabilities of TDAQ systems in high energy physics through a comprehensive software and hardware architecture.

Method: The framework encompasses low-level drivers to a dataflow programming model based on High-Level Synthesis, facilitating efficient processing.

Result: APEIRON includes a core communication infrastructure and demonstrates effectiveness through a particle identification application in the NA62 experiment.

Conclusion: APEIRON provides a robust solution for TDAQ systems, showcasing its applicability in high energy physics experiments.
...
TL;DR: This study evaluates a prototype superconducting niobium cavity designed for gravitational-wave detection, highlighting its RF characteristics and mechanical properties at cryogenic temperatures.


<details>
  <summary>Details</summary>
Motivation: The motivation is to develop effective resonant sensors for gravitational-wave detection in the kHz-MHz range using superconducting radio-frequency cavities.

Method: Cryogenic RF characterization of the niobium cavity, including surface preparation, mechanical tuning, and measurement of electromagnetic quality factors and eigenmodes at temperatures down to 2 K.

Result: Achieved 11 kHz mode splitting, observed high electromagnetic quality factors, and identified phase transfer characteristics; mechanical quality factors were below theoretical expectations.

Conclusion: Demonstrates that established SRF techniques can be applied to unconventional geometries, providing insights for the development of future SRF-based gravitational-wave detectors.
...
### [6] [Study of ZZ and ZH production in the bb$ττ$ final state and search for high-mass spin-0 and spin-1 resonances in proton-proton collisions at $\sqrt{s}$ = 13 TeV](https://arxiv.org/abs/2607.01589)
*CMS Collaboration*

Main category: hep-ex

TL;DR: This study investigates ZZ and ZH production processes in bb$ττ$ final states using LHC data, setting limits on beyond-standard-model resonances without observing any deviations from standard model predictions.


<details>
  <summary>Details</summary>
Motivation: To analyze the standard model processes involving ZZ and ZH productions in bb$ττ$ final states, and to search for nonresonant Higgs boson pair production and potential new physics.

Method: Utilizing proton-proton collision data at $fs=13$ TeV from the CMS experiment, the study examines both nonresonant and resonant analyses, focusing on heavy resonances that decay into ZZ and ZH.

Result: Upper limits are established on the production rates and branching fractions for resonances X (decaying into ZZ) and Z' (decaying into ZH), with specific ranges from 300 pb to 24 fb and 0.4 pb to 12 fb, respectively.

Conclusion: The analysis finds no significant deviations from standard model predictions, marking it as the first measurement to probe the bb$ττ$ processes in ZZ/ZH events.
...
### [7] [Heavy-Flavor Electron Classification Using Hadronic Environment as Point Cloud](https://arxiv.org/abs/2607.02225)
*Jingyu Zhang,Wanbing He,Long Ma*

Main category: hep-ex

TL;DR: This study introduces a machine learning approach to distinguish electrons from charm and bottom hadrons in high-energy collisions, using hadronic environment as a point cloud.


<details>
  <summary>Details</summary>
Motivation: Electrons from semi-leptonic decays of D and B hadrons play a significant role in high-energy physics, but differentiating them is challenging due to similar decay topologies.

Method: The authors utilize set-based machine learning architectures, including Transformers, to analyze the point cloud representation of the hadronic environment for electron classification.

Result: The classifier reaches ~40% efficiency with close to 80% purity, surpassing the performance of traditional BDT methods and revealing the importance of geometric and topological features.

Conclusion: The learned representations provide meaningful discrimination beyond basic observables, highlighting the potential of machine learning in particle physics analysis.
...
### [8] [Measurement of solar $pp$ neutrino flux with the new PandaX-4T data](https://arxiv.org/abs/2607.02405)
...
TL;DR: The paper reports a new measurement of the solar $pp$ neutrino flux using the PandaX-4T data, showing a positive indication of solar $pp$ neutrino--electron scattering.


<details>
  <summary>Details</summary>
Motivation: To measure the solar proton--proton neutrino flux through neutrino--electron elastic scattering, enhancing our understanding of solar processes.

Method: Utilized the PandaX-4T Run 2 data set (2024-2026), conducted upgrades to the detector, constrained impurities, improved data processing, and performed a blind spectral analysis on electronic-recoil data from 20 to 1000 keV.

Result: The fitted solar $pp$ flux was found to be $(8.5 	imes 10^{10} 	ext{ cm}^{-2}	ext{s}^{-1})$ with a statistical significance of $2.2σ$, consistent with the Standard Solar Model predictions.

Conclusion: This study provides the first positive indication of solar $pp$ neutrino--electron scattering below 165 keV, confirming earlier model predictions.
...
### [9] [TEQUILA: Mechanism-free polarimetry for astronomy](https://arxiv.org/abs/2607.01325)
*Alan M. Watson,Noémie Globus*

Main category: astro-ph.IM

TL;DR: TEQUILA is a cutting-edge optical imaging polarimeter designed for the COLIBRÍ telescope, enabling efficient simultaneous measurement of Stokes parameters for transient astronomical sources, utilizing commercial components and without moving parts.


<details>
  <summary>Details</summary>
Motivation: To provide accurate polarimetric imaging of transient sources such as gamma-ray bursts and variable stars, enhancing observational capabilities at OAN-SPM.

Method: TEQUILA employs a CMOS sensor and a wire-grid micro-polarizer for simultaneous measurement of Stokes parameters without moving optical components.

Result: TEQUILA achieves precise polarimetric measurements with RMS uncertainties of 0.15% and 0.20% in pupil-tracking and field-tracking modes respectively, despite facing challenges like low quantum efficiency.

Conclusion: The initial performance of TEQUILA is promising, with a need for continued calibration efforts for resolved-source polarimetry.
...
### [10] [Efficient high-order explicit symplectic splitting methods for post-Newtonian Hamiltonian systems](https://arxiv.org/abs/2607.01596)
*Yujie Jiang,Lijie Mei*

Main category: astro-ph.IM

TL;DR: This paper introduces a new approach for explicit symplectic integrators in post-Newtonian Hamiltonian systems, addressing issues of order reduction and computational efficiency.


<details>
  <summary>Details</summary>
Motivation: Post-Newtonian Hamiltonian systems require costly implicit integrators due to nonseparability, and existing explicit methods experience order reduction with small time step sizes.

Method: A novel extension and splitting approach for the doubled Hamiltonian is proposed, enabling the construction of explicit symplectic integrators that maintain high-order convergence.

Result: The proposed integrators provide genuine high-order convergence without order reduction and successfully leverage the small PN parameter $bvarepsilon$.

Conclusion: Numerical simulations with 2PN spinning binaries reveal that the new integrators offer better long-term conservation of invariants and greater computational efficiency compared to previous methods.
...
### [11] [Architecture and Validation of the CRS F-Engine for the CHORD Radio Telescope](https://arxiv.org/abs/2607.01625)
*Ian Hendricksen,Jean-François Cliche,Matt Dobbs,Joshua Montgomery*

Main category: astro-ph.IM

TL;DR: The paper presents the CRS F-Engine for the CHORD radio interferometer, detailing its architecture, functionalities, and performance validation.


<details>
  <summary>Details</summary>
Motivation: To enhance the digital signal processing capabilities for the CHORD radio interferometer, allowing for efficient handling of multiple RF signals.

Method: Utilizing an array of CRS boards with RFSoC architecture, the system digitizes RF signals, channelizes them into frequency bins, and supports various post-processing options including correlators and a packet assembler.

Result: The implementation of the chFPGA firmware was demonstrated to successfully process and channelize signals, with test results aligning closely with expected outcomes.

Conclusion: The CRS F-Engine effectively meets the digital processing needs of CHORD, supporting scalability and multiple processing applications.
...
### [12] [Development of a cosmic ray detector using CMOS sensors embedded in smartphones and Raspberry Pi devices](https://arxiv.org/abs/2607.02106)
*Wakiko Takano,Shigeharu Udo,Atsushi Shiomi,Kinya Hibino*

Main category: astro-ph.IM

TL;DR: SORAMAME is a smartphone app that transforms CMOS image sensors into particle detectors, enabling real-time particle event recording and visualization without specialized hardware, promoting educational outreach and global citizen science.


<details>
  <summary>Details</summary>
Motivation: To reduce barriers in cosmic ray detection for non-specialists, allowing schools and communities access to scientific observation.

Method: The app repurposes smartphone cameras as particle detectors, incorporating on-device processing and cloud data management for real-time analysis.

Result: In-flight tests and Raspberry Pi measurements showed that the system could capture variations in particle flux influenced by geomagnetic shielding, demonstrating the app's effectiveness.

Conclusion: SORAMAME not only facilitates education but also has the potential to advance scientific research through widespread community participation.
...
### [13] [Development of a Retrieval-Augmented Generation Virtual Assistant for Enhanced Information Discovery at Rubin Observatory](https://arxiv.org/abs/2607.01659)
...
TL;DR: The paper discusses a prototype virtual assistant using Retrieval Augmented Generation (RAG) to enhance access to heterogeneous documentation related to the Legacy Survey of Space and Time (LSST) at the Vera C. Rubin Observatory.


<details>
  <summary>Details</summary>
Motivation: The Vera C. Rubin Observatory will produce extensive data but faces challenges in efficiently retrieving and using diverse supporting documentation, as material is scattered across various platforms and formats.

Method: The prototype integrates RAG with tools like Weaviate for embeddings, LangChain for query orchestration, and an OpenAI GPT model, enabling semantic search through a conversational interface.

Result: The RAG-based assistant provides context-aware responses, reduces inaccuracies, and demonstrates improved information discovery and workflow efficiency.

Conclusion: The system showcases RAG's potential to streamline access to distributed knowledge and support effective utilization of LSST data products.
...
### [14] [Periodic Radio Technosignature Search toward 3I/ATLAS with FAST](https://arxiv.org/abs/2607.01666)
*Jian-Kang Li,Zhen-Zhao Tao,Tong-Jie Zhang,Men-Quan Liu*

Main category: astro-ph.IM

TL;DR: The study conducted a targeted search for periodic technosignatures from the interstellar object 3I/ATLAS using advanced signal processing techniques, but found no credible signals.


<details>
  <summary>Details</summary>
Motivation: To explore potential artificial signals from 3I/ATLAS, the third interstellar object, enabling the search for technosignatures using advanced methodologies.

Method: Utilizing the FAST L-band multibeam receiver, canonical polyadic decomposition (CPD) was applied to analyze multibeam dynamic spectra, followed by periodogram and autocorrelation diagnostics for signal selection.

Result: No credible periodic radio technosignature above 0.146 W was detected from the direction of 3I/ATLAS.

Conclusion: The search demonstrates CPD as a promising approach for analyzing multibeam data in technosignature searches, while expanding the types of signals investigated.
...
### [15] [$J$ and $H$ band sky brightness measurements from polar day to polar night at Dome A, Antarctica](https://arxiv.org/abs/2607.01923)
...
TL;DR: This study provides the first continuous measurements of near-infrared (NIR) sky brightness at Dome A, Antarctica, showcasing significant variations between polar and non-polar conditions.


<details>
  <summary>Details</summary>
Motivation: To evaluate the performance of ground-based infrared observatories by measuring NIR sky brightness, particularly at Dome A, known for its exceptional atmospheric conditions.

Method: Continuous $J/H$-band measurements were conducted from February to May 2024 using the Antarctic Infrared Binocular Telescope (AIRBT) to monitor the NIR sky background across polar day and night.

Result: The median NIR sky brightness was found to be $5.2/2.9$ and $15.3/13.4~	ext{mag arcsec}^{-2}$ during daytime and nighttime, respectively, with notable differences in brightness associated with solar elevation and sunspot number.

Conclusion: The findings indicate significant differences in NIR sky background between polar and non-polar environments, with implications for long-term monitoring and the influence of the solar cycle on measurements.
...
### [16] [Current status of the High-Resolution Multi-Object Spectrograph (MOS-HR) for the Wide-field Spectroscopic Telescope](https://arxiv.org/abs/2607.01968)
...
TL;DR: The paper discusses the status of the HR-MOS module for the WST, including design, organization, budget estimates, and structural analysis.


<details>
  <summary>Details</summary>
Motivation: To develop a high-resolution spectrograph facilitating massive spectroscopic surveys while meeting scientific and technical requirements.

Method: An international collaborative design approach is described, with trade-off studies informing the optical design, mass, and volume budgets, followed by structural analysis.

Result: The paper lays out detailed design parameters, including fiber specifications and structural stability, establishing critical requirements for HR-MOS.

Conclusion: The HR-MOS is positioned to meet the specified astronomical community needs while ensuring performance and mechanical stability.
...
### [17] [Pulsar Backend for 21 CentiMeter Array: Implementation of Data Acquisition and Initial Results](https://arxiv.org/abs/2607.01975)
*Yukai Zhou,Junhua Gu,Mengyao Xue,Faxin Shen,Jian Li,Qiuyang Fu,Cijie Zhang,Youling Yue,Weiwei Zhu,Kejia Lee,Renxin Xu*

Main category: astro-ph.IM

TL;DR: The paper details the implementation of a new data acquisition system for the 21CMA, focusing on pulsar and fast radio burst observations, with successful verification of its capabilities using PSR B0329+54 and other sources.


<details>
  <summary>Details</summary>
Motivation: The aim is to enhance the capabilities of the 21CMA for high-sensitivity observations of pulsars and fast radio bursts, leveraging advanced radio frequency technology.

Method: The system utilizes an RFSoC platform for baseband observations, with multi-board synchronization and a bandwidth from 50 to 350 MHz. Observations were conducted on PSR B0329+54 and phase relations were derived using bright radio sources.

Result: A signal-to-noise ratio of 699.09 was achieved in a 2.5-hour multi-station observation, demonstrating effective low-frequency pulsar observations capabilities with eight stations.

Conclusion: The successful implementation opens the door for sophisticated tied-array observations of pulsars at low frequencies using the 21CMA.
...
### [18] [Quantum-optimal coronagraphy with spatial mode sorting for direct exoplanet observations](https://arxiv.org/abs/2607.02065)
*Yinzi Xin,Sebastiaan Haffert,Yoo Jung Kim,Jonathan Lin*

Main category: astro-ph.IM

TL;DR: This study improves coronagraphic performance for exoplanet detection near stars by calculating optimal nulling modes using quantum information techniques, aiming to overcome limitations presented by complex apertures and partially resolved stars.


<details>
  <summary>Details</summary>
Motivation: Conventional coronagraphs face challenges in detecting exoplanets close to stars, especially with complex telescope apertures and partially resolved stellar images, necessitating advanced methods for optimal performance.

Method: The authors utilize numerical calculations and quantum information theory tools to derive optimal nulling modes and spatial mode-sorting techniques tailored to specific observational conditions, accounting for the size of the star and planet parameters.

Result: The research identifies optimal measurement modes that improve the classical signal-to-noise ratio when measuring exoplanets, with results indicating tradeoffs when targeting multiple planetary locations. Three example designs are proposed for various scientific objectives.

Conclusion: By employing these optimal modes, coronagraphs can enhance detection capabilities at close angles, thereby advancing the study of exoplanets, specifically for various observational endeavors including high-resolution spectroscopy.
...
### [19] [HARMONI at ELT: line spread functions in a diffraction limited spectrometer](https://arxiv.org/abs/2607.02223)
...
TL;DR: HARMONI is a near-IR integral field spectrograph for the ELT, designed with adaptive optics for improved imaging quality. It explores the effects of diffraction on its line spread function, crucial for its design.


<details>
  <summary>Details</summary>
Motivation: To enhance imaging quality and spectral resolution in astronomy using adaptive optics in integral field spectroscopy.

Method: Analysis of the impact of pupil diffraction and spatial filtering effects on the line spread function in HARMONI's design.

Result: Identified significant diffraction effects that influence the line spread function, affecting the spectrograph's resolution and performance.

Conclusion: Optimal design parameters must be considered to achieve a diffraction-limited spectrograph performance.
...
### [20] [Design and development of a near-IR integral field spectrograph for the HWO Coronagraph Instrument](https://arxiv.org/abs/2607.02243)
*Stephen P. Todd,Dan Dicken,Raziye Artan,Beth A. Biller,Cassandra Mercury,Katherine Morris,Vinooja Thurairethinam,Geng Zhao*

Main category: astro-ph.IM

TL;DR: The paper discusses the design of an infrared integral field spectrometer for the Habitable Worlds Observatory aimed at identifying habitable planets, emphasizing the need for broad wavelength coverage and optical efficiency.


<details>
  <summary>Details</summary>
Motivation: The need for accurate identification and characterization of habitable worlds necessitates advanced spectroscopic techniques.

Method: The paper evaluates design options for an integral field spectrometer, including lenslet and image slicer architectures, focusing on optical efficiency and spectral integrity.

Result: Design considerations are presented, highlighting the critical parameters required for effective speckle measurement and contrast enhancement.

Conclusion: Identifying necessary technological advancements will be crucial for achieving the specifications needed for the HWO coronagraph instrument.
...
### [21] [Logarithmic negativity typically equals exact entanglement cost](https://arxiv.org/abs/2607.01320)
*Bowen Ouyang,Jonah Kudler-Flam*

Main category: quant-ph

TL;DR: The paper establishes a link between logarithmic negativity and entanglement cost in large random quantum states, providing an efficient method for quantifying entanglement in complex systems.


<details>
  <summary>Details</summary>
Motivation: To find operationally meaningful quantifiers of entanglement in large quantum systems, where traditional methods fail due to computational complexity.

Method: The authors analyze large random induced mixed states and demonstrate that logarithmic negativity aligns with the exact entanglement cost under specific operations.

Result: Logarithmic negativity coincides with the exact entanglement cost for large random states, confirming its efficiency and operational relevance.

Conclusion: Logarithmic negativity serves as a precise and tractable measure of entanglement for many-body quantum states.
...
### [22] [Noisy quantum circuit simulation with the tensor jump method](https://arxiv.org/abs/2607.01323)
*Maximilian Fröhlich,Aaron Sander,Martin Eigel,Robert Wille,Michael Hintermüller*

Main category: quant-ph

TL;DR: A new variance-aware tensor network framework effectively simulates noisy quantum circuits, improving accuracy and efficiency over classical methods.


<details>
  <summary>Details</summary>
Motivation: To address limitations in classical simulation of noisy quantum circuits due to exponential costs and high variance in methods.

Method: A variance-aware tensor network framework combining tensor jump method with local TDVP gate evolution, using Pauli-Lindblad noise models for accurate circuit noise simulation.

Result: Achieved improved simulation of noisy circuits with reduced variance and bond-dimension growth on multiple architectures, outperforming standard Kraus-insertion methods.

Conclusion: The developed methods demonstrate scalable and accurate noisy-circuit simulations, particularly effective against both weak and strong noise.
...
### [23] [Integrated Photon-Memory Entanglement Generation using Dual Photonic Resonators](https://arxiv.org/abs/2607.01324)
*Alexander Kolar,Ian Chin,Conner Fong,Daniil M. Lukin,Melissa A. Guidry,Milan Palei,Jelena Vučković,Tian Zhong*

Main category: quant-ph

TL;DR: This paper presents an integrated photonic architecture for generating entanglement between telecom photons and quantum memories, achieving high efficiency and scalability for quantum networks.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of integrating photon sources and quantum memories for scalable quantum networks and enhance multiplexing capabilities.

Method: The authors utilize dual silicon-carbide microring resonators: one as a photon-pair source and the other as a cavity-enhanced quantum memory, optimized for spectral matching.

Result: They achieved a photon-memory entanglement verification with a visibility of 88.1%, and demonstrated high-dimensional qudit entanglement across 63 temporal modes, resulting in a photon information efficiency of 5.1 Ebits per photon.

Conclusion: This work demonstrates a first integrated platform for achieving photon-memory entanglement, facilitating the development of scalable quantum repeaters and memory-enabled quantum networks.
...
### [24] [One-Body Purity, Non-Gaussianity, and Entanglement in Interacting Integrable Models](https://arxiv.org/abs/2607.01326)
*Rafał Świętek,Maksymilian Kliczkowski,Lev Vidmar,Marcos Rigol*

Main category: quant-ph

TL;DR: This paper investigates entanglement in many-body lattice Hamiltonians, contrasting integrable and nonintegrable systems through random superpositions of Gaussian states.


<details>
  <summary>Details</summary>
Motivation: To better understand the entanglement properties and non-Gaussian nature of eigenstates in integrable vs. nonintegrable many-body lattice systems.

Method: The authors compare analytical and numerical results of one-body purity, non-Gaussianity, and entanglement entropy for random superpositions of differing amounts of Gaussian states against Hamiltonian eigenstates.

Result: The research finds that integrable systems are well represented by random superpositions of polynomially many Gaussian states, while nonintegrable systems align with random superpositions of exponentially many Gaussian states.

Conclusion: The study provides a comprehensive framework for understanding the entanglement behavior in different types of many-body systems, highlighting a new paradigm linking Gaussianity and entanglement.
...
TL;DR: The study analyzes the geometric structure of quantum cost landscapes (QCLs) using a modified nudged elastic band algorithm to identify low-cost paths, or ravines, for optimizing variational quantum algorithms (VQAs). It introduces a prediction framework that enhances performance and reduces costs in quantum neural network (QNN) applications.


<details>
  <summary>Details</summary>
Motivation: To improve the optimization and predictive capabilities of variational quantum algorithms (VQAs) by analyzing the geometric and topological features of quantum cost landscapes (QCLs).

Method: An adapted nudged elastic band (NEB) algorithm is employed to systematically analyze ravines in QCLs, while training quantum neural networks (QNNs) to classify the concentratable entanglement of quantum states.

Result: The NEB approach helps visualize ravine structures and enables the construction of an ensemble prediction framework that significantly enhances QNN performance. It demonstrates reduced computational costs and accelerates convergence compared to naive QNN alternatives.

Conclusion: The study indicates that the identified ravine structures persist across different scaling scenarios, allowing for improved optimization efficiency and reduced resource requirements in VQAs.
...
TL;DR: This work addresses limitations in collective dissipative spin systems by exploring initial-state inhomogeneities to control waiting-time statistics and mitigate detector resolution issues.


<details>
  <summary>Details</summary>
Motivation: To overcome challenges posed by finite temporal resolution of detectors in collective spin systems, especially in relation to postselection barriers.

Method: Investigates a collectively monitored spin model with inhomogeneities introduced by partitioning the ensemble into two subsystems at an angle $θ$, analyzing the effects on waiting-time statistics and entanglement scaling.

Result: Measurement-induced phase transitions persist under inhomogeneities; waiting time scales as $1/N$ with an enhanced prefactor, remaining finite in the anti-aligned limit ($θ= π$) and addressing resolution barriers.

Conclusion: A trade-off exists between improved detector resolution and the entanglement saturation time, with implications for observing measurement-induced phenomena experimentally.
...
TL;DR: This paper explores criticality in quadratic bosonic Hamiltonians, linking long-range correlations to dynamical stability boundaries, and illustrates the relevance of topology and boundary physics.


<details>
  <summary>Details</summary>
Motivation: To understand criticality in systems governed by quadratic bosonic Hamiltonians and its connection to dynamical stability and long-range correlations.

Method: Analyzing a two-parameter family of bosonic Su-Schrieffer-Heeger models via auxiliary pseudo-Hermitian dynamical systems and investigating stability regions and their topological implications.

Result: Identified distinct stability regions in dynamical systems, with long-range correlations linked to exceptional points and Krein collisions, along with implications for topological classification regardless of stability.

Conclusion: Bosonic topological physics remains robust despite issues of dynamical stability, indicating a fundamental insensitivity to non-interacting criticality.
...
TL;DR: The study explores entanglement dynamics in boundary time crystals (BTC) and identifies two distinct regimes during entanglement spread among spin ensembles.


<details>
  <summary>Details</summary>
Motivation: To understand how time-crystalline order affects entanglement dynamics in quantum systems, particularly through seeding mechanisms involving dissipative channels.

Method: Analysis of entanglement dynamics along quantum trajectories during the seeding of BTC behavior onto static spin ensembles, examining both time-dependent growth and steady-state properties.

Result: The seeded BTC phase displays growing steady-state entanglement with system size, while the non-seeded phase shows exponential decay of entanglement and fluctuations.

Conclusion: The findings reveal a measurement-induced phase transition (MIPT) driven by dissipative seeding, highlighting its potential for controlling quantum correlations in many-body systems.
...
TL;DR: This paper explores how Neural Quantum States (NQS) represent and capture physical observables through an analysis of their internal activations, revealing significant correlations and interpretability without explicit optimization.


<details>
  <summary>Details</summary>
Motivation: To understand how Neural Quantum States, trained solely on variational objectives, accurately represent physical observables that they haven't been directly optimized for.

Method: Analyzing NQS using sparse autoencoders to extract features from their internal residual stream and correlating these with physical observables, followed by targeted post-training interventions to assess causal effects on observables.

Result: Identified strong correlations between extracted features and physical observables such as order parameters and correlators, demonstrating that a single feature can influence the corresponding observable while minimally affecting variational energy.

Conclusion: NQS exhibit rich internal representations of physical information, indicating they are more than functional approximators, paving the way for better mechanistic interpretability and reliability.
...
### [30] [Design rules for fault-tolerant multi-gate teleportation](https://arxiv.org/abs/2607.01342)
*Mathys Rennela*

Main category: quant-ph

TL;DR: Multi-gate teleportation consolidates multiple gates into a single ebit, demonstrating fault tolerance under specific conditions while optimizing entanglement usage.


<details>
  <summary>Details</summary>
Motivation: To optimize entanglement consumption in quantum teleportation while maintaining fault tolerance in the presence of network faults.

Method: Introducing a design rule for fault-tolerant packet sizes and simulating with PyMatching to analyze performance against noise ratios in quantum circuits.

Result: The MGT approach corrects correlated errors effectively, achieving comparable or superior error rates to traditional sequential methods under certain network noise conditions.

Conclusion: Noise-aware distributed circuit compilers can leverage fan-out packetization to reduce entanglement costs without compromising fault tolerance.
...
### [31] [Decohered toric code under quantum damping noise and its mapping to a classical spin model](https://arxiv.org/abs/2607.01364)
*Nihar Ranjan Dash,Sanjoy Dutta,R. Srikanth,Subhashish Banerjee*

Main category: quant-ph

TL;DR: This paper examines the behavior of toric codes subjected to realistic damping error channels, analyzing their properties under various environmental influences.


<details>
  <summary>Details</summary>
Motivation: To understand how toric codes perform in realistic conditions, which include various types of damping errors that affect quantum error correction.

Method: The authors utilize the double Hilbert-space formalism to map the decoherent toric code onto statistical-mechanical models, and apply Pauli twirling to relate quantum channels to stochastic error models, providing a framework to analyze failure probabilities.

Result: The study identifies how the GAD and SGAD channels impact toric codes by producing asymmetric depolarizing channels and calculates logical failure probabilities influenced by temperature and squeezing parameters.

Conclusion: The findings establish a connection between quantum channel parameters and statistical-mechanical models, enhancing understanding of error dynamics in toric codes under realistic conditions.
...
### [32] [Bit flips are erasures in dissipative cat qubits](https://arxiv.org/abs/2607.01375)
*Filippo Ferrari,Joachim Cohen,Vincenzo Savona,Fabrizio Minganti*

Main category: quant-ph

TL;DR: The study reveals that bit flips in dissipatively stabilized cat qubits produce detectable photon bursts, allowing for real-time monitoring of logical errors in quantum error correction (QEC).


<details>
  <summary>Details</summary>
Motivation: Exploring whether emitted signals during quantum error correction contain useful information on logical failures, particularly when these signals are often discarded.

Method: Utilizing quantum trajectories, the authors analyze the emitted photon signals from dissipatively stabilized cat qubits and develop a framework to quantify the detectability of logical failures based on these signals.

Result: Findings show that logical bit flips are associated with strong, localized photon emissions, allowing for monitoring of logical errors without interrupting stabilization processes.

Conclusion: Emitted signals from engineered reservoirs can serve as effective failure monitors for autonomous QEC, transforming logical faults into detectable erasures and reducing fault-tolerance overhead.
...
TL;DR: This paper systematically analyzes coherent states in minimal-length quantum mechanics, revealing the loss of canonical equivalence and introducing new dynamics under the Generalized Uncertainty Principle (GUP).


<details>
  <summary>Details</summary>
Motivation: To address the challenges in characterizing coherent states in minimal-length quantum mechanics, which emerges from certain quantum gravity theories suggesting a fundamental length scale.

Method: A systematic analysis of coherent states for a one-dimensional harmonic oscillator under the framework of GUP, comparing generalized coherent states with GUP-saturating states.

Result: Demonstrated the loss of canonical equivalence among standard coherent state characterizations and identified nontrivial phase-space deformations and an intrinsic squeezing mechanism resulting from minimal-length effects.

Conclusion: This work establishes a unified framework for analyzing coherence in GUP-based quantum theories and presents distinctive semiclassical signatures, paving the way for exploring quantum-gravitational effects.
...
### [34] [High-Precision Calibration Workflow Achieves Above $99.9\%$ CZ Gate Fidelity on a Scalable Superconducting Processor](https://arxiv.org/abs/2607.01422)
*Huili Zhang,Meiling Li,Shuang Yang,Yaqing Feng,Yulong Li,Cheng Chen,Pei Liu,Guangming Xue,Haifeng Yu*

Main category: quant-ph

TL;DR: This paper presents a closed-loop workflow for enhancing the calibration precision of CZ gates in superconducting quantum processors, achieving a fidelity exceeding 99.9% and significantly reducing coherent errors.


<details>
  <summary>Details</summary>
Motivation: The need for high-fidelity two-qubit gates is crucial for developing fault-tolerant quantum computers, particularly in the presence of incoherent errors due to shortened coherence times in superconducting processors.

Method: The authors employed a closed-loop workflow incorporating echoed leakage error amplification (ELEA) and context-aware fidelity estimation (CAFE) circuits to improve the calibration precision and suppress population leakage.

Result: The workflow achieved a CZ gate fidelity greater than 99.9% on an 84-qubit processor, with coherent errors reduced to 0.007%, and a median fidelity of 99.25% for 72 parallel CZ gates.

Conclusion: Automated calibration enhances the stability of CZ gates, providing a scalable and efficient pathway for quantum computation on domestic superconducting platforms.
...
### [35] [Surface code logical operations on a superconducting quantum processor](https://arxiv.org/abs/2607.01473)
...
TL;DR: This paper presents the experimental realization of fault-tolerant logical operations using patch-based surface codes on a 107-qubit superconducting quantum processor, advancing from logical memory to active operations.


<details>
  <summary>Details</summary>
Motivation: To explore fault-tolerant quantum computation by manipulating encoded information while maintaining quantum error-correction protection.

Method: Implementing a reusable primitive layer for patch-based surface-code logical processing, utilizing operations such as merge, split, and defect-mediated deformations, to perform logical gates.

Result: Successful execution of logical state routing and essential logical gates (CNOT, Hadamard, phase) on distance-three surface-code patches with advanced decoding techniques.

Conclusion: The results mark a significant progression in superconducting surface-code experiments, enabling active fault-tolerant logical operations.
...
TL;DR: This paper explores how anomalous weak values of the CHSH operator in pre- and post-selected quantum ensembles serve as generalized bounds on nonlocal correlations, demonstrating the distinct roles of post-selection and entanglement in enhancing correlations beyond separable limits.


<details>
  <summary>Details</summary>
Motivation: To investigate the interaction between post-selection and entanglement in quantum correlations, specifically in the context of Bell inequality violations and weak values of the CHSH operator.

Method: The study analyzes three scenarios involving pre- and post-selected ensembles, deriving maximal weak values and optimizing over CHSH operators to explore correlations and bounds in different configurations of boundary states.

Result: Post-selection can enhance correlations, but entanglement is necessary to surpass separable bounds; the strongest correlations arise from combining both resources. Additionally, nonlocal weak values serve as effective entanglement witnesses.

Conclusion: The findings advocate for hybrid protocols utilizing both post-selection and entanglement, with implications for quantum sensing, weak-value amplification, and quantum information processing.
...
### [37] [Lamb Shift of a Static Atom Facing a Rotating Surface](https://arxiv.org/abs/2607.01495)
*César D. Fosco,Fernando C. Lombardo,Francisco D. Mazzitelli*

Main category: quant-ph

TL;DR: This paper examines how the Lamb shift of a static atom is altered by a nearby rotating planar surface, identifying contributions from both orbital and spin angular momentum.


<details>
  <summary>Details</summary>
Motivation: To understand the modifications in atomic energy levels due to the interaction with rotating surfaces, with applications in quantum friction and material interactions.

Method: A general formula is derived for the Lamb shift, incorporating angularly Doppler-shifted reflection coefficients for axially symmetric planar materials, and is expanded to second order in angular velocity.

Result: The study reveals distinct orbital and spin contributions to the Lamb shift, with implications for different materials like graphene and metallic surfaces; rotation alters the Casimir-Polder interaction in significant ways.

Conclusion: The findings indicate that rotation can enhance or weaken quantum interactions, and a finite linewidth above a certain angular velocity may serve as a signature of quantum friction.
...
### [38] [Symmetry conservation with Trotterization and Quantum Phase Estimation](https://arxiv.org/abs/2607.01560)
*Edith Leal-Sánchez,Fanny Vain,Jong-Kwon Ha,Ryan J. MacDonell*

Main category: quant-ph

TL;DR: This paper investigates Trotterization errors in quantum algorithms for fermionic systems, proposing a method for conserving symmetries using Hermitian operators and 'operator kirigami' to address non-commutativity.


<details>
  <summary>Details</summary>
Motivation: The study aims to improve quantum algorithms by addressing Trotterization errors that can violate Hamiltonian symmetries essential for accurate quantum chemistry simulations.

Method: The authors express the Hamiltonian using Hermitian excitation operators and apply 'operator kirigami' techniques to manage non-commuting operators, employing orthogonal projections and unitary rotations.

Result: Tests reveal that symmetry-conserving pools minimize errors, especially when second-order Trotterization is applied, showing better performance with larger molecules.

Conclusion: The research suggests that methods used in classical electronic structure theory can enhance the accuracy of quantum computing algorithms by conserving symmetries.
...
### [39] [An Information-Theoretic Principle for Optimal Quantum Encoding: Tight Frames and Equiangular Ensembles](https://arxiv.org/abs/2607.01564)
*Farhad Farokhi,Shuixin Xiao*

Main category: quant-ph

TL;DR: This paper explores optimal encoding strategies for classical data in quantum-assisted statistical inference, showing that maximal quantum leakage serves as a universal quality metric for such encodings.


<details>
  <summary>Details</summary>
Motivation: To understand how the encoding of classical data affects the performance of quantum inference procedures, identifying a universal measure of encoding quality.

Method: The authors prove that the accuracy of quantum inference is bounded by maximal quantum leakage from the classical data, establishing constraints for encoding strategies and exploring pure states and different encoding methods (basis and phase encoding).

Result: Optimal universal encoding is achieved with pure states and basis encoding when enough qubits are present; phase encoding is optimal in lower dimensions, with equiangular tight frames recognized as the uniquely symmetric optimal encodings.

Conclusion: The study provides a comprehensive framework for encodings in quantum inference, highlighting the significance of maximal quantum leakage and identifying specific optimal encoding structures.
...
### [40] [A Validation Framework for Quantum Simulation of Spin Dynamics against Inelastic Neutron Scattering and Classical Simulation](https://arxiv.org/abs/2607.01568)
...
TL;DR: The paper presents a framework for validating quantum simulations of dynamical spin response using inelastic neutron scattering and classical simulations, addressing the discrepancies in observables and uncertainties.


<details>
  <summary>Details</summary>
Motivation: The need for reliable validation methods for quantum simulations has grown with advancements in quantum simulation protocols and their practical hardware implementations.

Method: A cross-pipeline validation framework is introduced, incorporating explicit observable maps, uncertainty propagation methods, and robust tests to distinguish between stochastic uncertainty and robustness-induced distortion.

Result: The framework enables comprehensive validation across multiple levels (pipeline, solver, model) and improves agreement between quantum simulations and experiments through actuator-aware feedback logic.

Conclusion: Future work will expand the methodology to include adaptive feedback, uncertainty modeling, and infrastructure for reproducible validation in quantum simulations.
...
### [41] [Structured Factorization Approaches for Quantum State Tomography](https://arxiv.org/abs/2607.01608)
*Zhen Qin,Joseph M. Lukens,Brian T. Kirby,Zhihui Zhu*

Main category: quant-ph

TL;DR: This paper presents a unified framework for quantum state tomography (QST) that utilizes structured factorization to enhance scalability and efficiency by incorporating priors and operating within a structured factor space.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the exponential complexity challenge of quantum state tomography (QST) as system size increases, emphasizing the need for effective priors to manage sample and parameter complexity.

Method: The authors introduce a structured factorization approach that parametrizes the density matrix as $FF^\dagger$, constrained within a structured model class, and formulate QST as an optimization problem using measurement data.

Result: A unified statistical analysis of sample complexity for various structured quantum states is developed, along with a projected gradient descent method and a power method that optimizes performance in factor space, achieving fast convergence.

Conclusion: The framework allows for scalable QST, directly incorporates a range of structural priors, and provides efficient computational methods, including a step-size-free power method that recovers known methods under specific conditions.
...
### [42] [Noise Suppression via Pulsed All-Optical Magnetometry with Nitrogen-Vacancy Ensembles](https://arxiv.org/abs/2607.01615)
*Xiechen Zheng,Jeyson Támara-Isaza,John W. Blanchard,Ronald L. Walsworth*

Main category: quant-ph

TL;DR: A pulsed all-optical (AO) protocol for magnetometry using nitrogen-vacancy (NV) centers in diamond improves noise resistance and contrast resolution compared to continuous-wave methods.


<details>
  <summary>Details</summary>
Motivation: To enhance the performance of AO magnetometry by mitigating systematic noise issues such as optical intensity fluctuations.

Method: A new pulsed AO protocol is introduced, using two photoluminescence (PL) measurements within an optical pulse to suppress common-mode noise.

Result: The protocol achieves up to a 10$	imes$ improvement in low-frequency noise compared to conventional continuous-wave AO techniques and reveals the impact of PL readout timing and dark time duration on AO-PL contrast.

Conclusion: Insights gained can optimize NV-diamond samples for various applications in AO magnetometry.
...
### [43] [Shallow Unitary Circuits for Kramers-Wannier Dualities](https://arxiv.org/abs/2607.01624)
*Yanting Cheng,Shang Liu*

Main category: quant-ph

TL;DR: The paper presents a method for efficiently implementing quantum Kramers-Wannier dualities through logarithmic depth, spatially nonlocal unitary circuits, applicable to both $	ext{Z}_2$ and $	ext{Z}_n$ dualities, enabling exploration of phase transitions and topological dualities.


<details>
  <summary>Details</summary>
Motivation: To understand the speed limits of unitary circuits with nonlocal connectivity in realizing quantum dualities.

Method: Construction of logarithmic depth, spatially nonlocal unitary circuits that perform exact $	ext{Z}_2$ and generalized $	ext{Z}_n$ KW dualities in one and two dimensions.

Result: These circuits transform any non-fixed-point SRE states into their corresponding LRE duals in the symmetric sector.

Conclusion: The work provides an efficient means to explore phase transitions and topological dualities on quantum platforms.
...
TL;DR: The paper presents a chiral interaction scheme that enhances magnon bundle emission through a cascaded-cavity setup, improving lifetime and quality for quantum applications.


<details>
  <summary>Details</summary>
Motivation: To enhance the emission of magnon bundles and improve their quality for quantum information processing.

Method: Utilizing a qubit and a magnon in a cascaded-cavity configuration to create a unidirectional interaction.

Result: The unidirectional interaction increases the lifetime of the excited state, reduces magnon re-excitation, and enhances both the average purity and number of two-magnon bundles.

Conclusion: Chiral interaction provides directional control and improves multi-magnon source quality, offering potential benefits for quantum information applications.
...
TL;DR: The paper presents a unified geometric framework for multiparameter Bayesian quantum estimation, introducing Bayesian monotone metrics to provide computable lower bounds on Bayes risk, outperforming existing bounds.


<details>
  <summary>Details</summary>
Motivation: The need for a unified geometric framework for multiparameter Bayes risk in quantum sensing and metrology is addressed.

Method: Bayesian monotone metrics are introduced by evaluating Petz monotone metrics on prior-averaged states, leading to derivation of quantum Bayesian dual Fisher-information matrices and computable bounds on Bayes risk.

Result: The paper establishes that the derived bounds surpass traditional Bayesian SLD and RLD bounds and show universal dominance over quantum van Trees bounds.

Conclusion: Bayesian monotone metrics provide a systematic and unified approach to understanding performance limits in multiparameter Bayesian quantum estimation.
...
TL;DR: Quantum relative entropy is uniquely determined by operational principles in quantum state discrimination, unlike the classical case, which has multiple divergence measures.


<details>
  <summary>Details</summary>
Motivation: To clarify the unique role of quantum relative entropy in the landscape of quantum measures of distinguishability, especially in relation to physical processes and resource conversion.

Method: Analyzing binary guessing games with optimal measurements to evaluate state distinguishability and proving conditions under which an additive divergence measure must align with Umegaki relative entropy.

Result: Demonstrated that all additive measures respecting optimal measurement odds coincide with the Umegaki relative entropy, establishing it as the sole suitable measure in quantum contexts.

Conclusion: The work establishes quantum relative entropy as the unique additive distinguishability measure compatible with single-shot quantum discrimination, highlighting a fundamental difference from classical divergence measures.
...
TL;DR: This paper explores a two-mode superposition operator applied to Glauber's coherent states, analyzing the resultant quantum state’s nonclassicality and non-Gaussianity, and its role in enhancing teleportation fidelity in continuous-variable quantum protocols.


<details>
  <summary>Details</summary>
Motivation: To investigate the unique properties of two-mode coherent superposed quantum states and their practical applications in continuous-variable quantum information protocols.

Method: Introduction of a two-mode superposition operator acting on two-mode coherent states, followed by analysis of the resultant state's nonclassicality and non-Gaussianity using Wigner distribution and logarithmic negativity; application in a CV teleportation protocol.

Result: The study establishes enhanced nonclassical and non-Gaussian characteristics in the two-mode coherent superposed state, leading to teleportation fidelities exceeding classical limits under specific parameter regimes.

Conclusion: Engineered two-mode quantum states can significantly improve teleportation efficiency, underscoring their importance in quantum information processing.
...
TL;DR: This paper presents methods to optimize quantum gate compilation on neutral-atom arrays by reducing addressing and transport overhead.


<details>
  <summary>Details</summary>
Motivation: To address the hardware constraints in structured quantum gate implementations on two-dimensional neutral atoms, aiming for efficient operations.

Method: The paper employs algebraic structures for single-qubit gates and graph-theoretic models for controlled-Z gates to develop efficient compilation algorithms.

Result: The proposed methods cut addressing layers by up to 50% for single-qubit gates and reduce transport operations by approximately 50% for C-Z gates, enhancing performance for QAOA circuits.

Conclusion: The findings demonstrate that translating physical constraints into algebraic and graph-theoretic frameworks can effectively resolve hardware-level challenges in quantum gate implementations.
...
TL;DR: This paper presents a method to measure the phase between x-ray free-electron laser pulses, enhancing coherence-based spectroscopy.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of measuring relative delays and phases in high-energy photon pulse sequences.

Method: The method employs Ramsey-type interference with long-lived Mössbauer resonances to measure the phase between XFEL pulses, bridging temporal gaps.

Result: The technique allows for accurate measurement of the relative phase between transform-limited XFEL pulses, which can be utilized for enhanced analysis in spectroscopy.

Conclusion: Implementing this phase measurement improves coherence-based spectroscopy, facilitating better exploration of matter's structure and dynamics.
...
TL;DR: This paper establishes a limit on the efficiency of non-Markovian quantum heat engines with finite baths, highlighting penalties from correlations and non-equilibrium states.


<details>
  <summary>Details</summary>
Motivation: To understand the operational limits and efficiencies of quantum heat engines in realistic scenarios involving finite baths and non-Markovian dynamics.

Method: Analytically derive an upper bound on extractable work and evaluate it through a quantum polytropic cavity-optomechanical cycle.

Result: Maximal efficiency requires quasi-static operation to harness non-Markovian effects, while maximum power optimizes for finite-time operation that may incur errors.

Conclusion: Optimizing for power introduces operational trade-offs, indicating distinct regimes for exploiting quantum memory versus operating at finite power.
...
TL;DR: This study explores single photon storage in nanofibers using stimulated Brillouin scattering, presenting methods to enhance storage time and reduce losses.


<details>
  <summary>Details</summary>
Motivation: The need for efficient memory devices for single photons in quantum information processing and communications.

Method: Utilizes stimulated Brillouin scattering with coherent buffers and an innovative configuration of counter-propagating pump fields to achieve negligible gains or losses during photon storage.

Result: Achieved a slow signal storage method for single photons with minimal thermal phonon scattering effects.

Conclusion: The proposed method effectively enhances single photon storage capacity in nanofibers while minimizing loss, addressing limitations of existing techniques.
...
TL;DR: The paper presents a novel single-ancilla construction for block encodings in quantum algorithms, enabling approximate Hamiltonian evolution with reduced ancilla qubit overhead and optimized circuit depth.


<details>
  <summary>Details</summary>
Motivation: Standard block encoding methods in quantum algorithms require significant ancilla resources and are complicated to implement. Recent findings highlight the inherent limitations of ancilla overhead in exact constructions. This research aims to overcome these limitations in an approximate setting.

Method: A single-ancilla construction converts Hamiltonian evolution into a block encoding of a Hermitian operator using generalized quantum signal processing. Two approaches are detailed: one employs higher-order Trotterization with a specific circuit depth bound, while the other utilizes multiproduct formulas with additional ancilla qubits.

Result: The higher-order Trotterization method achieves an $eta$-approximate block encoding with one ancilla qubit and a depth of $	ilde{O}(L(α/eta)^{o(1)})$. The multiproduct formula method offers a depth of $	ilde{O}(L)$, requiring $O(	ext{log log}(1/eta))$ ancilla qubits.

Conclusion: The proposed constructions present efficient alternatives to traditional LCU frameworks, significantly minimizing ancilla requirements while achieving near-optimal circuit performance.
...
TL;DR: This paper presents a reset-free LUCI framework for error suppression in quantum computation, demonstrating its efficacy compared to traditional methods on IBM hardware.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of traditional error correction protocols in quantum computing, particularly regarding vulnerability to hardware defects and rigid connectivity constraints.

Method: A reset-free scenario within the LUCI framework was benchmarked on IBM quantum hardware, focusing on asymmetrical scaling of logical distances and comparing error suppression capabilities.

Result: The LUCI approach achieved error suppression ratios of 1.75(10) for logical $X$ errors and 1.93(12) for logical $Z$ errors, outperforming standard methods which yielded 1.58(13) and 2.44(7) respectively, despite a reduced syndrome density in time.

Conclusion: The study validates the LUCI framework's effectiveness on physical hardware and suggests its potential for hybrid code designs, challenging reliance on traditional static fault-tolerant architectures.
...
TL;DR: The paper explores generating squeezed Schrödinger cat states using photon-number-resolving measurements on multimode Gaussian states, deriving analytical expressions and analyzing fidelity and scaling behavior.


<details>
  <summary>Details</summary>
Motivation: To enhance the quality of generated squeezed Schrödinger cat states through multimode Gaussian state manipulations.

Method: The authors derive analytical formulas for two- and three-mode schemes and examine the scaling of generated state amplitude relative to detected particles.

Result: They establish an upper bound on achievable generation fidelity and identify conditions for optimizing state quality in multimode setups.

Conclusion: The paper concludes that certain multimode configurations can significantly improve the fidelity of squeezed Schrödinger cat state generation.
...
TL;DR: The study reveals vulnerabilities in measurement-device-independent quantum key distribution (MDI-QKD) due to adversarial control of the measurement device, allowing significant retrieval of the secret key.


<details>
  <summary>Details</summary>
Motivation: To investigate the security limitations of MDI-QKD due to potential vulnerabilities in single-photon detectors used in practical QKD systems.

Method: We present a novel attack exploiting an adversary's control over the measurement node to extract information from the secret key, noting the impact on key recovery and error rates.

Result: An adversary can recover up to 70% of the sifted key with only a 5.6% quantum bit error rate, revealing a fundamental flaw in the standard security model of MDI-QKD.

Conclusion: The findings suggest a need for stricter independence assumptions or stronger security analyses to ensure MDI-QKD robustness against realistic adversarial threats.
...
### [56] [False vacuum decay in a two-dimensional quantum spin system](https://arxiv.org/abs/2607.01994)
*Luka Pavešić,Ian G. Moss,Simone Montangero*

Main category: quant-ph

TL;DR: This paper explores false vacuum decay in the quantum Ising model using tree tensor network simulations, providing numerical evidence supporting the critical-bubble picture in 2+1 dimensions.


<details>
  <summary>Details</summary>
Motivation: To investigate the underexplored quantum nucleation theory and its predictions in two-dimensional systems, which hold significant relevance across various fields.

Method: Tree tensor network simulations were employed to study the quantum Ising model, extracting the decay rate, effective interface tension, and critical bubble size, with results compared to new semi-classical field theory calculations.

Result: The results demonstrate excellent agreement between the numerical data and semi-classical predictions, reinforcing the validity of the critical-bubble model in a quantum context.

Conclusion: This study validates the critical-bubble picture in an interacting quantum spin system in 2+1 dimensions, bridging gaps in the quantum version of nucleation theory.
...
### [57] [Partially-Blind Single-Qubit Classification over a Prototype Hybrid Quantum Network](https://arxiv.org/abs/2607.01998)
...
TL;DR: This paper presents a framework for a partially-blind single-qubit classifier (PB-SQC) integrated into a quantum network, enabling secure data classification without revealing specific information, and demonstrates its effectiveness using simulation on a real-world data set.


<details>
  <summary>Details</summary>
Motivation: The study addresses the need for resource-efficient quantum experiments in the NISQ era to develop practical applications, particularly focusing on secure data classification through quantum computing.

Method: The authors propose a PB-SQC framework, where a server knows that classification is happening without access to the data or results, and simulate its performance on a credit card fraud detection database while exemplifying the use of entanglement swapping in a quantum network setup.

Result: Simulation results indicate that the PB-SQC yields classification outcomes comparable to those from a classical deep-belief network, showcasing its potential for practical applications.

Conclusion: This work demonstrates a viable path toward establishing secure quantum applications in short- to mid-term quantum networks, highlighting the capabilities of PB-SQC and TQC in practical settings.
...
### [58] [Compressive Spectrum Sensing via Spectral Multiplexing in Rydberg Atomic Receiver](https://arxiv.org/abs/2607.02001)
*Jun-Rong Chen,Yi-Ming Yin,Le-Bin Chen,Kai Wang,Bang Liu,Li-Hua Zhang,Hao Tian,Ming-Min Zhao,Bin-Bin Wei,Dong-Sheng Ding*

Main category: quant-ph

TL;DR: The paper presents a new framework for enhancing Rydberg-atomic receivers' bandwidth using compressive spectral multiplexing, increasing sensitivity without added system complexity.


<details>
  <summary>Details</summary>
Motivation: Rydberg-atomic receivers are highly sensitive but limited by their narrow bandwidth, hindering broadband applications.

Method: A compressive spectral multiplexing framework is proposed, utilizing a frequency-modulated local oscillator (FMLO) to create parallel sensing channels that compress a broadband signal into narrowband responses.

Result: The framework compresses a 640 MHz bandwidth signal into a 126 kHz atomic bandwidth, achieving over 1000:1 compression while enhancing signal redundancy and noise ratio by about 10 dB.

Conclusion: This approach simplifies the design of quantum receivers, making them viable for advanced communication and sensing applications without the need for auxiliary fields or complex electronics.
...
### [59] [Quantum sensing of aging transitions](https://arxiv.org/abs/2607.02004)
*Huining Zhang,Yunbo Zhang,Xiaoguang Wang,X. X. Yi*

Main category: quant-ph

TL;DR: The paper discusses a novel quantum sensing strategy to detect aging transitions in quantum networks, emphasizing the enhanced sensitivity of a qubit probe as it approaches a critical threshold.


<details>
  <summary>Details</summary>
Motivation: Understanding aging transitions is vital for predicting network stability in quantum information processing and various biological systems.

Method: The strategy involves using a single qubit probe, coupled to oscillator nodes, to detect changes in the inactive fraction as it nears the aging transition point, enhancing the Fisher information at this threshold.

Result: The proposed approach shows a significant increase in Fisher information, allowing for high-precision estimation of the transition point, even in classical oscillator regimes.

Conclusion: This work provides a practical method for sensing aging transitions in quantum networks, contributing to the understanding of critical phenomena in quantum many-body systems.
...
### [60] [Local distinguishability of six bipartite orthogonal product states](https://arxiv.org/abs/2607.02006)
*Guang-Bao Xu,Hua-Kun Wang,Yu-Guang Yang,Dong-Huan Jiang*

Main category: quant-ph

TL;DR: This study investigates the local distinguishability of six orthogonal product states (OPSs) in bipartite quantum systems, classifying them into eight categories based on orthogonality relations, with most cases being perfectly distinguishable via LOCC.


<details>
  <summary>Details</summary>
Motivation: Understanding local distinguishability enhances the design of quantum protocols, reducing transmission challenges and operational costs.

Method: The authors analyze six bipartite OPSs, categorizing them into eight groups based on pairwise orthogonality and studying their distinguishability through LOCC.

Result: Of the 78 distinct cases identified, 73 are perfectly distinguishable via LOCC, while 5 cases are examined in detail regarding their distinguishability.

Conclusion: The study provides a thorough characterization of local distinguishability among six bipartite orthogonal product states, contributing valuable insights for future quantum information protocols.
...
### [61] [Mid-infrared pure-state quantum light source based on lithium niobate waveguides](https://arxiv.org/abs/2607.02016)
*Huang Yuhang,Wang Dongzhou,Ke Shaolin,Jin Ruibo*

Main category: quant-ph

TL;DR: This paper presents a theoretical scheme for generating high-purity, high-brightness mid-infrared quantum light sources using lithium niobate thin films, surpassing the limitations of bulk PPLN crystals.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of brightness and integration in current mid-infrared quantum light sources that rely on bulk periodically poled lithium niobate (PPLN) crystals.

Method: Utilizes lithium niobate thin films with 1556.9 nm pumping to create entangled photon pairs at 3113.8 nm, achieving type-II phase matching and group velocity matching through optimized waveguide structures.

Result: Achieved high purity (0.999) and brightness (6.18×10^6 cps/mW), three orders of magnitude greater than bulk PPLN crystal sources, using customized polarization direction design.

Conclusion: The findings present an effective method for developing high-brightness, high-purity quantum light sources on-chip for mid-infrared applications.
...
### [62] [Idling error suppression through gate scheduling](https://arxiv.org/abs/2607.02031)
*Hoiki Madison Liu,Kazunori Maruyama,Hirotaka Oshima,Shintaro Sato*

Main category: quant-ph

TL;DR: This paper introduces a novel method for suppressing idling errors in quantum computation by optimizing quantum circuit scheduling instead of adding control gates, demonstrating improvements in computational accuracy.


<details>
  <summary>Details</summary>
Motivation: High-precision quantum computation is hindered by idling errors during inactive periods of qubits, necessitating effective mitigation strategies.

Method: The authors propose a scheduling-based approach that adjusts the timing of quantum gate executions to mitigate idling errors without additional gate operations, supplemented by numerical simulations and hardware experiments.

Result: The proposed method shows a significant impact on the overall computational accuracy, often leading to improvements compared to conventional techniques.

Conclusion: The paper provides a theoretical framework for understanding density-matrix evolution under idling noise, validating the efficacy of the scheduling approach.
...
### [63] [Undamped Modes in an N-Qubit Heisenberg Chain with Collective Dissipation](https://arxiv.org/abs/2607.02054)
*Chun Hei Leung*

Main category: quant-ph

TL;DR: The study explores undamped behaviors in a spin-1/2 Heisenberg chain influenced by an environment, revealing robust undamped modes through Bethe ansatz analysis.


<details>
  <summary>Details</summary>
Motivation: To understand undamped behaviors in open integrable quantum systems and their resilience to environmental changes.

Method: Utilizing the Bethe ansatz approach, the authors investigate the existence of undamped modes in the Heisenberg chain for various system parameters.

Result: The research demonstrates that undamped modes exist for chain lengths N >= 3 and are stable against parameter variations, identifying their frequencies and dynamics.

Conclusion: The findings highlight long-lived coherent dynamics in open quantum systems, showcasing the robustness of these undamped modes.
...
### [64] [Quantum Convolutional Autoencoders for Reconstruction-Based Anomaly Detection](https://arxiv.org/abs/2607.02135)
*Donovan Slabbert,Francesco Petruccione*

Main category: quant-ph

TL;DR: This paper explores quantum convolutional neural networks in a quantum autoencoder framework for effective anomaly detection in time-series data.


<details>
  <summary>Details</summary>
Motivation: To enhance anomaly detection using QCNN architectures, adapting them to reconstruct normal data and identify anomalies through reconstruction error.

Method: The authors adapted QCNNs into two types of quantum autoencoders: one with a hierarchical structure and another with a bottleneck, training them semi-supervisedly on normal samples using a real-world dataset.

Result: Findings highlight a trade-off between latent-space size and model capacity, with bottleneck architectures outperforming hierarchical ones in anomaly detection accuracy.

Conclusion: Explicit latent-space compression enhances anomaly detection, emphasizing design considerations in quantum machine learning models.
...
### [65] [Extending the computational reach of Quantum Annealing using Reverse Annealing](https://arxiv.org/abs/2607.02146)
*Lucas Joshua Menger,Thomas Lippert,Manpreet Singh Jattana*

Main category: quant-ph

TL;DR: Combining forward and reverse annealing enhances solution quality and efficiency in quantum annealing for complex combinatorial problems, outperforming extended forward annealing.


<details>
  <summary>Details</summary>
Motivation: Investigate the effectiveness of reverse annealing compared to standard forward annealing on current quantum hardware with noise and energy gap issues.

Method: Conducted systematic experiments on a D-Wave Advantage system, benchmarking reverse annealing for Max-Cut, Number Partitioning, and sparse clustering while varying key parameters like reverse distance and pause duration.

Result: Reverse annealing consistently improves solution quality and efficiency, particularly for large and complex problems, more so than simply extending forward annealing times.

Conclusion: Reverse annealing shows significant advantage as quantum annealing hardware evolves, suggesting it will be crucial for tackling high-complexity optimization challenges.
...
### [66] [Thermodynamics of Quantum Reservoir Computing](https://arxiv.org/abs/2607.02157)
*Lixiang Ding,Xingze Qiu*

Main category: quant-ph

TL;DR: This paper explores the energetic limitations of quantum reservoir computing through a non-equilibrium thermodynamic framework, establishing a trade-off between predictive performance and thermodynamic costs.


<details>
  <summary>Details</summary>
Motivation: To address unresolved questions regarding the computational and energetic limits of quantum reservoir computing, particularly in relation to temporal data processing.

Method: The paper develops a non-equilibrium thermodynamic framework, connecting macroscopic performance and microscopic costs, while analyzing Holevo capacities and deriving a generalized Landauer bound for continuous processing.

Result: The study shows that the peak computational performance arises from spectral resonance in the quantum critical region, linking efficient data processing to increased informational dissipation and irreversible work.

Conclusion: The findings delineate the energetic boundaries for quantum learning devices, offering insights for the development of energy-efficient quantum neuromorphic systems.
...
### [67] [A Structure Theorem for Phase-Space Representations of Continuous-Variable Quantum Error-Correcting Codes](https://arxiv.org/abs/2607.02164)
*Enrico Bozzetto,Jonte R. Hance*

Main category: quant-ph

TL;DR: The paper connects quasiprobability representation with quantum error correction codes, presenting a phase-space framework for continuous-variable codes and specific examples including Gottesman-Knill-Preskill codes.


<details>
  <summary>Details</summary>
Motivation: To enhance the understanding of error correction in continuous-variable quantum systems using a structured mathematical approach.

Method: The authors utilize the structure theorem for quasiprobability representation to derive a general phase-space representation for continuous-variable error-correcting codes, exemplified by specific types of codes.

Result: A comprehensive phase-space representation is established for various quantum error correction codes, detailing error structures that can occur within this framework, particularly addressing single photon loss errors.

Conclusion: The findings offer a unified way to understand the mathematical nature of errors in error-correcting codes, contributing to the development of robust quantum information technologies.
...
### [68] [Computable measures of fermionic non-Gaussianity from the covariance matrix](https://arxiv.org/abs/2607.02242)
*Poetri Sonya Tarabunga,Bernhard Jobst,Raúl Morral-Yepes,Marc Langer,Barbara Kraus,Frank Pollmann,Sheng-Hsuan Lin*

Main category: quant-ph

TL;DR: The paper develops a convex resource theory of fermionic non-Gaussianity, introducing two computable measures for pure fermionic states and establishing a framework to assess their complexity and classical simulability.


<details>
  <summary>Details</summary>
Motivation: To quantify fermionic non-Gaussianity due to its significance in the computational complexity of fermionic quantum systems, addressing the lack of tractable and meaningful measures.

Method: The authors introduce two families of measures—occupation number entropies and natural-orbital participation entropies—derived from the covariance matrix. They prove monotonicity for one and analyze both families for specific states, including stabilizer and translation-invariant states.

Result: The first family of measures offers a computable convex resource monotone and lower bounds the non-Gaussian gates needed for state preparation, while the second family provides an upper bound on the classical simulation cost for these states.

Conclusion: The proposed framework unifies concepts from quantum information, condensed-matter physics, and quantum chemistry, offering new avenues for exploring quantum many-body complexity and enhancing the understanding of fermionic states.
...
### [69] [A transition-metal qubit in diamond with all-optical control and millisecond quantum memory](https://arxiv.org/abs/2607.02258)
*I. M. Morris,T. Alberth,L. Crooks,T. Lühmann,D. J. Twitchen,S. Pezzagna,J. Meijer,S. S. Nicley,J. N. Becker*

Main category: quant-ph

TL;DR: Transition-metal defects in diamond, specifically nickel-vacancy centers, are proposed as a solution for scalable qubit systems due to their superior optical control and enhanced coherence times.


<details>
  <summary>Details</summary>
Motivation: To overcome the limitations of existing qubit platforms that struggle to simultaneously achieve efficient optical access, coherent control, and long-lived quantum memory.

Method: The study presents the use of a single nickel-vacancy (NiV$^-$) defect in diamond, demonstrating all-optical control and performing techniques such as Raman Rabi oscillations and Ramsey interferometry to extend coherence times.

Result: Coherence times of over one millisecond at 1.65 K were achieved, with coherence extended from 371 ns to 1.27 ms using all-optical dynamical decoupling.

Conclusion: NiV$^-$ defects in diamond establish a practical spin-photon interface, enhancing prospects for scalable quantum networks.
...
### [70] [Bockstein braiding statistics](https://arxiv.org/abs/2607.02280)
*Po-Shen Hsin,Yu-An Chen*

Main category: quant-ph

TL;DR: This paper introduces Bockstein braiding statistics for $	ext{Z}_N$ excitations, highlighting new mutual statistics when $p+q=d-1$ and discussing their implications on phase transitions and symmetry breaking.


<details>
  <summary>Details</summary>
Motivation: To explore braiding statistics and their implications in quantum physics, particularly in the context of $	ext{Z}_N$ excitations and their mutual interactions in various dimensions.

Method: Identification of Bockstein braiding statistics through closed unitary processes and field-theoretic descriptions involving Aharonov-Bohm phases and the Bockstein operation.

Result: Bockstein braiding statistics emerge for adjacent cases where the sum of dimensions of excitations is one less than spatial dimensions, affecting the allowed phases and symmetry behavior in systems of $	ext{Z}_N$ excitations.

Conclusion: The paper concludes that nontrivial Bockstein braiding statistics inhibit simultaneous condensation of certain excitations and suggest symmetry fractionalization upon the breaking of $	ext{Z}_N$ symmetries.
...
### [71] [Neural-Network Inverse Design of SRF Cavities and Transmons for Bosonic Quantum Computation](https://arxiv.org/abs/2607.02289)
*Joseph Yaker,Jovan Markovic,Alessandro Reineri,Doga Murat Kurkcuoglu,Silvia Zorzetti*

Main category: quant-ph

TL;DR: The paper presents two deep learning approaches for the inverse design of superconducting radio-frequency cavities and transmon qubits, improving efficiency in achieving desired electromagnetic properties and coupling parameters.


<details>
  <summary>Details</summary>
Motivation: To overcome the limitations of conventional iterative simulation in designing superconducting systems, especially as complexity increases.

Method: Two deep neural network approaches are introduced: one for designing SRF cavities to achieve target observables, and another for optimizing transmon qubits to meet specified coupling rates, frequencies, and anharmonicity.

Result: Candidate designs achieved targets within 5% for cavities and 2% for transmons, validated by end-to-end re-simulation.

Conclusion: The deep learning methods provide a faster and more efficient alternative to traditional design methods, enabling better scalability in the development of superconducting quantum systems.
...
### [72] [Time-Reversal and Reversible Dynamics in Cavity QED for Quantum Metrology](https://arxiv.org/abs/2607.02320)
*Simone Colombo,Edwin Pedrozo-Peñafiel*

Main category: quant-ph

TL;DR: The review explores using many-body interactions in cavity QED to enhance quantum metrology by decoding entangled states for improved sensitivity in measurements.


<details>
  <summary>Details</summary>
Motivation: While entangled many-body states offer potential metrological advantages, accessing the encoded information remains challenging due to measurement limitations.

Method: The paper discusses interaction-based readout and time-reversal protocols that use controlled non-linear dynamics to convert weakly encoded signals into accessible observables, particularly in cavity QED settings.

Result: It highlights how advancements in reversible many-body dynamics and associated protocols, such as SATIN, have facilitated better signal amplification and enhanced metrology through interaction-based methods.

Conclusion: The review posits that decoding quantum information may be as crucial as its generation, underscoring the significance of reversible many-body dynamics in quantum-enhanced sensing.
...
### [73] [Temporal nonlocality of a qudit resides in the input state, not the channel, and certifies temporal teleportation up to a fundamental limit](https://arxiv.org/abs/2607.02331)
*Karol Bartkiewicz,Patrycja Tulewicz*

Main category: quant-ph

TL;DR: The paper explores temporal nonlocality in quantum systems, showing that the strength of this nonlocality is determined by the initial state, vanishing when maximally mixed. It establishes that this nonlocality can enhance temporal teleportation fidelity, while also revealing limits on over-certification of quantum channels.


<details>
  <summary>Details</summary>
Motivation: To understand the robustness of temporal nonlocality in quantum systems and its implications for quantum information theory, particularly in relation to state transmission over time through noisy channels.

Method: The authors analyze the concept of temporal nonlocality robustness (TNR) in quantum systems, employing a unified semidefinite-programming approach to investigate temporal entanglement and nonlocality robustness across different dimensions (d=2 to 5).

Result: TNR is shown to vanish when the initial state is maximally mixed. The results establish a universal cap on TNR and provide solutions to over-certification phenomena, verifying the findings numerically for dimensions 2 to 5.

Conclusion: The study reveals a complex relationship between initial state mixedness and the certification of quantum channel capabilities, leading to insights about temporal nonlocality and its applications, while introducing a structured way to analyze quantum robustness in time.
...
### [74] [Kardar-Parisi-Zhang dynamics in an open integrable system: beyond the spontaneous-symmetry-breaking ansatz](https://arxiv.org/abs/2607.02341)
*Guo-Qiang Wang,Chang-Ling Zou,Guang-Can Guo,and Xu-Bo Zou*

Main category: quant-ph

TL;DR: This paper examines the limitations of a phenomenological ansatz based on spontaneous symmetry breaking (SSB) for describing charge transport in open quantum systems. It shows that in certain conditions, Kardar-Parisi-Zhang (KPZ) dynamics arise instead of diffusion from SSB.


<details>
  <summary>Details</summary>
Motivation: To explore the conditions under which the SSB-based ansatz may fail in describing emergent hydrodynamics in quantum many-body systems, particularly in non-equilibrium settings.

Method: The study investigates the B3 model, demonstrating its equivalence to two interacting asymmetric XXZ spin chains and analyzing the influence of inter-chain interactions on dynamics.

Result: It is shown that KPZ dynamics emerges in the B3 model under specific initial states, revealing KPZ scaling behavior even with negative hopping rates.

Conclusion: The findings suggest the need for a revised theoretical framework for charge transport in open systems that goes beyond the traditional SSB-based approach.
...
### [75] [Recovery Algorithm for Correlated Errors in Permutation-Invariant Quantum Codes](https://arxiv.org/abs/2607.02346)
*Omprakash Chandra,Yingkai Ouyang,Gopikrishnan Muraleedharan,Gavin Brennen*

Main category: quant-ph

TL;DR: The paper presents an efficient Quantum Error Recovery (QER) method utilizing permutation invariant (PI) codes that outperform traditional quantum error correction techniques against certain noise types.


<details>
  <summary>Details</summary>
Motivation: To enhance quantum error correction by introducing optimal recovery maps that outperform those used in noise parameter independent methods, particularly under complex noise models.

Method: A coherent QER map implemented via a quantum circuit on a system with ancillary qubits, focusing on PI codes that allow tunable parameters and simplify recovery operations.

Result: The proposed CAD codes, particularly CAD9, significantly improve error correction efficiency, outperforming existing codes by over an order of magnitude against specific symmetric correlated noise types.

Conclusion: This work advances the practical implementation of quantum error recovery protocols by providing optimized recovery maps that are experimentally feasible and reduce the overhead typically required.
...
### [76] [Stable Self-Modulating Quantum Fast-Weight Programmers with Bounded Memory Gates](https://arxiv.org/abs/2607.02363)
...
TL;DR: The paper introduces a bounded old-state modulation rule for Quantum Fast-Weight Programmers (QFWPs) to enhance stability and performance in quantum sequence modeling, particularly addressing issues of divergence in long sequences.


<details>
  <summary>Details</summary>
Motivation: The need for stable and efficient quantum sequence modeling methods, particularly for long sequences, is crucial in various quantum computing applications.

Method: A sign-preserving tanh gate is applied to the recurrent memory branch of QFWPs, maintaining existing update rules while preventing divergence in old-state multipliers.

Result: Old-state modulation consistently improves performance, stabilizing long-sequence processing, while unbounded Self-Modulating QFWP shows advantages in certain contexts, like longer input windows.

Conclusion: Accumulated-memory modulation is vital for QFWPs, and implementing a bounded old-state gating enhances robustness and prevents divergence.
...
### [77] [Copying Quantum States](https://arxiv.org/abs/2607.02408)
*Hans Maassen,Burkhard Kümmerer*

Main category: quant-ph

TL;DR: This paper discusses and proves the no-broadcasting theorem in quantum information, relating state broadcasting to the commutativity of density matrices and explores its implications within quantum probability theory.


<details>
  <summary>Details</summary>
Motivation: To clarify the relationship between state broadcasting in quantum systems and the algebraic properties of their density matrices.

Method: The paper employs a theoretical framework based on finite dimensional C*-algebras and unital completely positive maps to prove the no-broadcasting and no-cloning theorems.

Result: It establishes that a set of quantum states can be broadcasted if and only if their respective density matrices commute, thereby connecting these findings with quantum probability theory.

Conclusion: The results provide a deeper understanding of the limitations imposed by quantum mechanics on state manipulation, reinforcing the significance of commutation in quantum information processes.
...
### [78] [Optimal stellar rank approximation of squeezed cat states with photon catalysis](https://arxiv.org/abs/2607.02427)
*Julian K. Nauth,Nathan Walk,Ananga M. Datta,Kurt Busch,Jens Eisert,Oliver Benson,Roger A. Kögler*

Main category: quant-ph

TL;DR: The paper analyzes photon catalysis for generating non-Gaussian quantum states in optical systems, emphasizing its efficiency and robustness compared to other protocols.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of generating non-Gaussian states crucial for quantum computation and error correction in optical settings, often through probabilistic methods.

Method: The authors utilize the stellar rank formalism to compare the fidelity of catalyzed states to their targets, benchmarking performance against Gaussian boson sampling protocols and modeling optical losses.

Result: Identified optimal catalysis protocols producing high-fidelity state approximations with minimal resources, and demonstrated the advantages of deterministic Fock state sources.

Conclusion: The study provides insights into trade-offs in non-Gaussian resource complexity, fidelity, and loss, offering guidelines for practical photonic applications.
...
### [79] [Optimal Stabilizer Testing and Learning with Limited Quantum Memory](https://arxiv.org/abs/2607.02444)
*Srinivasan Arunachalam,Louis Schatzki*

Main category: quant-ph

TL;DR: This paper investigates stabilizer state testing and learning under constraints of coherent quantum memory, revealing that limited memory alters the complexity relationships between testing and learning tasks.


<details>
  <summary>Details</summary>
Motivation: To explore how limited coherent quantum memory impacts the complexity of testing and learning stabilizer states compared to the unrestricted cases.

Method: The study establishes the sample complexities for testing and learning stabilizer states using a novel connection to the hidden shift problem and new combinatorial approaches to average case bounds.

Result: The sample complexity for testing with $k$-qubit memory is $Θ(n-k)$ and for learning is $Θ(n^2/k)$; the paper also identifies exponential lower bounds for purity testing under certain memory conditions.

Conclusion: Coherent quantum memory is crucial for distinguishing the complexities of testing and learning stabilizer states; even near-maximal memory fails to create efficient testing, indicating strong separations in complexity.
...
### [80] [A Quantum-Walk Representation of Color-Ordered MHV Scattering Amplitudes](https://arxiv.org/abs/2607.02456)
*Anirudh Verma,C. M. Chandrashekar*

Main category: quant-ph

TL;DR: This paper proposes a graph-theoretic framework using quantum walks on permutation trees to represent MHV scattering amplitudes in quantum chromodynamics, integrating quantum systems for simulating scattering processes.


<details>
  <summary>Details</summary>
Motivation: To develop a unified framework for representing color-ordered MHV scattering amplitudes in quantum chromodynamics using quantum computation techniques.

Method: The approach employs quantum walks on permutation trees, assigns transition amplitudes based on Parke-Taylor structures, and utilizes quantum channels with Kraus operators to manage sector contributions and a quantum Fourier transform for amplitude combination.

Result: The method successfully represents low-point gluon amplitudes, capturing the Parke--Taylor structure and aligning with known analytical results.

Conclusion: The proposed framework effectively integrates graph theory, quantum walks, and open quantum systems, offering potential for quantum algorithms to simulate quantum field theory scattering processes.
...
### [81] [Quantum mutual information as a robust probe of integrability in open quantum systems](https://arxiv.org/abs/2607.02462)
*Nirupam Sen,Keshav Das Agarwal,Aditi Sen De*

Main category: quant-ph

TL;DR: This paper presents a framework for analyzing quantum information scrambling using the average of total correlations (aSTC) and entanglement in systems with varying dynamics.


<details>
  <summary>Details</summary>
Motivation: To provide robust measures for distinguishing between integrable and chaotic quantum dynamics, which have implications for quantum information processing.

Method: An information-theoretic framework using the Haar-averaged sum of total correlations (aSTC) and average multipartite entanglement applied to the long-range quantum XYZ spin model across different coupling regimes.

Result: The fluctuations of the aSTC successfully differentiate between integrable and chaotic dynamics, particularly under non-Markovian conditions, while conventional measures like OTOC fail in certain regimes.

Conclusion: The aSTC serves as a reliable probe for quantum scrambling dynamics, particularly in non-Markovian environments, enhancing our understanding of quantum system behavior.
...
### [82] [Topological Control of Quantum Chaos Diagnostics: OTOCs, Spectral Statistics, and Information Scrambling in Ising Model](https://arxiv.org/abs/2607.02463)
*Reza Pirmoradian,Soheir Rouhani,M. Reza Tanhayi*

Main category: quant-ph

TL;DR: The paper explores the transition from integrability to chaos in Ising spin networks, highlighting the role of topology, non-local interactions, and information scrambling using various metrics.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics of quantum information propagation and chaos in systems modeled by Ising spin networks through a graph-theoretic approach.

Method: Using topologies like Erdős--Rényi and Watts--Strogatz, the study examines the effects of long-range couplings and degree distributions on quantum scrambling, employing metrics like out-of-time-order correlators (OTOCs) and mutual information.

Result: Findings reveal that increased non-local interactions enhance information scrambling, characterized by significant changes in mutual/tripartite information and the behavior of OTOCs, with spectrum statistics indicating chaotic transitions.

Conclusion: This work provides a framework linking network topology and quantum chaos, enhancing understanding of thermalization and non-equilibrium dynamics in quantum many-body systems.
...
### [83] [Symmetries of Pauli Noise from Lindbladian Dynamics](https://arxiv.org/abs/2607.02481)
*Moein Malekakhlagh,Edward H. Chen,Luke C. G. Govia,Alireza Seif*

Main category: quant-ph

TL;DR: This paper explores how to characterize noise in quantum circuits by leveraging symmetry constraints on gate noise channels, deriving methods to identify and mitigate state preparation and measurement errors without needing to know their magnitudes.


<details>
  <summary>Details</summary>
Motivation: The challenge of characterizing quantum noise is complicated by gauge degrees of freedom that obscure contributions from state preparation and measurement (SPAM) errors.

Method: The authors use Lindbladian perturbation theory to analyze Clifford gates and derive selection rules based on symmetry constraints that relate the fidelity of Pauli operators and their gate-conjugates.

Result: The study shows that coherent errors do not induce first-order asymmetry, while certain off-diagonal dissipative errors can break the symmetry only at first order, and common single-qubit noise sources induce asymmetry only at second order.

Conclusion: By utilizing these symmetries to fix the gauge, systematic identification of SPAM errors is achievable, simplifying quantum error characterization and leading to potential mitigation strategies.
...
### [84] [Automated logical Clifford gadgets for heterogeneous architectures via chain maps](https://arxiv.org/abs/2607.02482)
*Asmae Benhemou,Noah Berthusen*

Main category: quant-ph

TL;DR: The paper presents an automated method for synthesizing logical CNOT circuits between different CSS codes using chain maps, discovering new low-depth solutions and practical applications.


<details>
  <summary>Details</summary>
Motivation: To address the limited existing strategies for entangling logical qubits from distinct CSS codes, especially when most known methods apply only to related code families.

Method: An automated framework uses chain maps to construct the affine space for logical CNOT networks and searches for shallow, sparse physical circuit candidates across heterogeneous CSS code pairs.

Result: The method identifies known transversal constructions and discovers new low-depth circuits, including distance-preserving solutions that can be enhanced with flag measurements.

Conclusion: The framework facilitates applications in code switching and other operations on concatenated codes, enabling advantageous spacetime tradeoffs, and can be extended to logical CZ gates.
...
### [85] [Can Primordial Black Holes Be Seeds for Early Galaxies in Models Satisfying the Covariant Entropy Bound?](https://arxiv.org/abs/2607.01292)
*Sidan A,Tom Banks,Willy Fischler*

Main category: hep-ph

TL;DR: The paper proposes a cosmological model where localized excitations are minimal and a large black hole contains all initial energy, explaining dark matter via primordial black holes and their decay into radiation, supported by General Relativity and quantum gravity concepts.


<details>
  <summary>Details</summary>
Motivation: The study aims to explore cosmological models adhering to the Covariant Entropy Bound and to address the origin of dark matter and the structure of early galaxies.

Method: The model employs approximate solutions to General Relativity and incorporates a speculative quantum gravity framework to fulfill conditions that match the flat FRW model saturating the CEB.

Result: The proposed model successfully explains the presence of dark matter as primordial black holes, aligning with observations from the Cosmic Microwave Background and early galaxies detected by the James Webb Space Telescope.

Conclusion: The findings suggest that early tiny black holes and their remnants play a crucial role in cosmology, offering insights into the universe's structure and the nature of dark matter.
...
### [86] [No Evidence for Superradiant Axions in LIGO-Virgo-KAGRA GWTC-5 Binary Black Hole Spins](https://arxiv.org/abs/2607.01317)
*Orion Ning,Benjamin R. Safdi,Catherine Welch*

Main category: hep-ph

TL;DR: The paper analyzes binary black hole spin data from LIGO-Virgo-KAGRA to constrain the mass range of quantum chromodynamics (QCD) axion and axion-like particles, finding no evidence for them within a specific mass range.


<details>
  <summary>Details</summary>
Motivation: To constrain the existence and mass of QCD axions and axion-like particles by studying their effect on black hole spin via superradiance instability.

Method: A hierarchical Bayesian analysis of binary black hole spin measurements from the LIGO-Virgo-KAGRA GWTC-5 catalog.

Result: The analysis finds no evidence for axions and excludes masses in the range of $1.7 \times 10^{-14} \, {\rm eV} \lesssim m_a \lesssim 3.3 \times 10^{-12} \, {\rm eV}$ at 95% confidence.

Conclusion: This study provides one of the strongest lower bounds on the mass of the QCD axion, surpassing previous bounds derived from X-ray spin measurements.
...
### [87] [Refined Sensitivity Estimates for Single-Molecule Magnet Dark Matter Detectors](https://arxiv.org/abs/2607.01868)
...
TL;DR: This paper improves the sensitivity of Single Molecule Magnet (SMM) crystals for detecting low-mass dark matter by refining the criteria for spin relaxation and demonstrating significant contributions to magnetic avalanche formation from localized heating.


<details>
  <summary>Details</summary>
Motivation: To enhance the detectability of low-mass dark matter using Single Molecule Magnet crystals, which previously relied on conservative criteria for spin relaxation.

Method: A refined analytic estimate for SMM sensitivity is developed, considering the stochastic nature of spin relaxation and its impact on energy thresholds for magnetic avalanches, supported by simulations and experimental validation of the thermal properties of two SMM materials.

Result: The study reveals that the stochastic nature of spin relaxation allows for a lower energy threshold for avalanche formation than previously estimated, confirmed through simulations and experiments on Mn$_{12}$-acetate and Mn$_{32}$.

Conclusion: The findings advance the development of SMM-based dark matter detectors with improved sensitivity by enabling better control over material properties.
...
### [88] [Axion Misalignment Across First-Order Phase Transitions](https://arxiv.org/abs/2607.01333)
*Galymzhan Baltabay,Francesco D'Eramo,Ville Vaskonen*

Main category: hep-ph

TL;DR: The paper explores how axion mass generation during a first-order phase transition affects dark matter production in an expanding universe, presenting two regimes of behavior and deriving a semi-analytical expression for relic density.


<details>
  <summary>Details</summary>
Motivation: To understand the impact of axion mass generation during first-order phase transitions on dark matter production and cosmological parameters.

Method: Lattice simulations in an expanding universe are utilized to analyze dark matter production, identifying two regimes based on the speed of the phase transition.

Result: The study finds that rapid transitions delay oscillations, increasing relic abundance, while slower transitions suppress the effective misalignment angle due to spatial gradients from expanding bubbles.

Conclusion: A derived semi-analytical expression for relic density unifies the two regimes and demonstrates the mechanism's effects on isocurvature perturbations and the matter power spectrum, influencing axion minicluster formation.
...
### [89] [Electron stability constrains neutrino time delays](https://arxiv.org/abs/2607.01339)
*Mauricio Bustamante,José Manuel Carmona,José Luis Cortés,Ardit Gkioni,Maykoll A. Reyes*

Main category: hep-ph

TL;DR: The paper examines the implications of Lorentz-invariance violation (LIV) on neutrino propagation and electron stability, suggesting that recent observations limit LIV explanations for neutrino time delays, necessitating alternative astrophysical or theoretical explanations.


<details>
  <summary>Details</summary>
Motivation: To analyze the constraints on superluminal and subluminal neutrino propagation induced by LIV, especially in relation to observed time delays between high-energy cosmic neutrinos and gamma rays.

Method: The study evaluates the implications of low-energy vacuum pair emission and derives constraints on LIV by analyzing the stability of TeV–PeV astrophysical electrons in light of newly discovered decay channels.

Result: The findings indicate that electron stability limits rule out LIV as a viable explanation for neutrino time delays, thereby constraining observable time delays for neutrinos on both sides of the speed of light.

Conclusion: Observable neutrino time delays must have purely astrophysical origins, require equal LIV effects across all particle species, or suggest new physics beyond current effective-field-theory frameworks.
...
### [90] [New constraints on non-unitary neutrino mixing from 8 years of IceCube DeepCore atmospheric neutrino data](https://arxiv.org/abs/2607.02355)
*Sharmistha Chattopadhyay,Anil Kumar,Sanjib Kumar Agarwalla*

Main category: hep-ph

TL;DR: The study investigates non-unitary neutrino mixing using IceCube DeepCore atmospheric neutrino data, finding strong consistency with standard unitary mixing and establishing stringent bounds on non-unitary parameters.


<details>
  <summary>Details</summary>
Motivation: To explore potential effects of non-unitary mixing in active neutrinos due to additional sterile states and how atmospheric neutrinos can illuminate these effects.

Method: Analysis of 8 years of data from IceCube DeepCore, focusing on the $ν_μ$ CC sample to assess non-unitary mixing parameters in neutrino oscillations, particularly in the $ν_μightarrow ν_μ$ channel.

Result: The data shows strong consistency with standard unitary mixing, establishing the most stringent bound of $α_{33} > -0.027$ at 90% CL, while also constraining other non-unitary parameters.

Conclusion: Atmospheric neutrino data does not indicate significant deviation from unitary mixing, providing strong constraints on non-unitary parameters.
...
### [91] [Local Conformal Predictions for Calibrated Surrogates](https://arxiv.org/abs/2607.01354)
*Suprio Dubey,Henning Bahl,Anja Butter,Jürgen Hesser,Tilman Plehn*

Main category: hep-ph

TL;DR: The paper introduces FALCON, a novel conformal prediction method for generating trustworthy uncertainty estimates in neural network surrogates for LHC scattering amplitudes, improving on standard techniques.


<details>
  <summary>Details</summary>
Motivation: The need for reliable uncertainty estimates in neural network surrogates for LHC scattering amplitudes due to complex non-Gaussian systematics.

Method: FALCON is proposed as a new conformal prediction method that learns to provide locally calibrated confidence intervals, enhancing standard approaches.

Result: FALCON demonstrates enhanced performance in providing locally calibrated uncertainties compared to traditional conformal predictions.

Conclusion: The research showcases the effectiveness of FALCON for distribution-free uncertainty quantification, aiding ultra-fast event generation in high-energy physics.
...
### [92] [Subensemble Acceptance Method 3.0: General Corrections to Cumulants from Exact Conservation Constraints](https://arxiv.org/abs/2607.01783)
*Roman Poberezhnyuk,Volodymyr A. Kuznietsov,Grégoire Pihan,Volodymyr Vovchenko*

Main category: hep-ph

TL;DR: The paper introduces SAM-3.0, an advanced method for correcting observables in large systems considering global conservation laws, improving upon previous versions with enhanced accuracy and broader applicability.


<details>
  <summary>Details</summary>
Motivation: To address inaccuracies in measuring cumulants in subsystems of large systems due to global conservation laws for various charges.

Method: The method employs a closed recursion using joint grand-canonical cumulants and partial exponential Bell polynomials to derive canonical cumulants for any number of observables and conserved charges.

Result: SAM-3.0 produces refined cumulants for net protons at RHIC-BES energies, aligning closely with previous results and demonstrating accuracy with direct Monte Carlo sampling.

Conclusion: The framework effectively integrates various observable measurements and conservations, validating its performance against established Monte Carlo methods while encompassing earlier versions of the subensemble acceptance method.
...
### [93] [Neutron stars as thermometers for reheating induced dipole dark matter](https://arxiv.org/abs/2607.01390)
*Sahabub Jahedi*

Main category: hep-ph

TL;DR: This paper examines dipole dark matter interactions within an effective field theory, evaluating production mechanisms and implications for neutron star heating.


<details>
  <summary>Details</summary>
Motivation: To explore dipole dark matter interactions and their implications in both standard and non-standard cosmological frameworks.

Method: Utilizing an effective field theory approach, the study analyzes dark matter production mechanisms and the effects of non-standard cosmological scenarios on parameter space.

Result: Identifies viable parameter space modifications due to reheating effects and discusses constraints from current observations, alongside future detection prospects.

Conclusion: Neutron star heating serves as an efficient method to investigate and constrain dipole dark matter parameters due to enhanced capturing dynamics.
...
### [94] [One-loop matching of QCD currents to power-suppressed two-jet operators](https://arxiv.org/abs/2607.01413)
*Martin Beneke,Aleksey V. Rusov,Michel Stillger*

Main category: hep-ph

TL;DR: This paper computes the matching of QCD quark-antiquark currents onto two- and three-particle jet operators in SCET at NLO, addressing power corrections for event shapes and deep-inelastic scattering.


<details>
  <summary>Details</summary>
Motivation: To advance the understanding of power corrections and logarithmic enhancements in the context of jets and deep-inelastic scattering.

Method: The authors compute the matching of quark-antiquark currents in QCD to SCET operators, incorporating higher-order corrections in transverse momentum over energy.

Result: The derived coefficients for three-particle operators demonstrate endpoint factorization, facilitating the cancellation of endpoint singularities in power corrections.

Conclusion: These findings enhance the theoretical framework for analyzing jet shapes and contribute to the full factorization treatments in power corrections.
...
### [95] [A Comprehensive Analysis of $B_s \to D_s^{**}\ellν_\ell$ Decays Within and Beyond the Standard Model](https://arxiv.org/abs/2607.02276)
*Karthik Jain,Tarun Kumar,Barilang Mawlong,Shantanu Sahoo*

Main category: hep-ph

TL;DR: This paper analyzes exclusive semileptonic decays of $B_s$ mesons using Heavy Quark Effective Theory, extracts form factors, and predicts lepton flavor universality ratios, while exploring potential new physics contributions.


<details>
  <summary>Details</summary>
Motivation: The investigation aims to enhance understanding of semileptonic decays of $B_s$ mesons, particularly in relation to Standard Model predictions and the potential for new physics.

Method: The study employs a data-driven approach to extract Heavy Quark Effective Theory parameters and uses the $z$-expansion for form factors, computing observables from angular decay distributions.

Result: Predicted lepton flavor universality ratios are $R_{D_{s0}^*}= 0.158(20)$, $R_{D_{s1}^*}= 0.045(5)$, $R_{D_{s1}}= 0.073(4)$, $R_{D_{s2}^*} = 0.066(9)$; deviations from Standard Model predictions are noted for certain observables due to new physics effects.

Conclusion: The findings suggest significant sensitivity of decay observables to new physics, particularly from scalar and tensor operators, indicating potential for future measurements to reveal deviations from the Standard Model.
...
### [96] [The theory of electric dipole moments: the view from below](https://arxiv.org/abs/2607.01443)
*Jordy de Vries*

Main category: hep-ph

TL;DR: This review discusses permanent electric dipole moments (EDMs) as probes of CP violation, linking fundamental interactions to observable EDMs in various systems.


<details>
  <summary>Details</summary>
Motivation: To explore the connection between CP violation and the matter-antimatter asymmetry through EDMs across different scales, from elementary particles to macroscopic systems.

Method: Theoretical analysis using a CP-odd effective Lagrangian, chiral perturbation theory, and nonperturbative QCD to derive hadronic low-energy constants and their implications for nuclear and atomic EDMs.

Result: Establishes a comprehensive framework connecting quark-gluon level interactions to observables in systems like atoms and molecules, highlighting the role of CP violation in paramagnetic systems.

Conclusion: Identifying sensitivity to hadronic CP violation in paramagnetic systems presents new research avenues; the interplay of different EDM sources enhances our understanding of CP violation origins.
...
### [97] [An introduction to Hammer v2: Helicity Amplitude Module for Matrix Element Reweighting](https://arxiv.org/abs/2607.01459)
*Michele Papucci,Dean J. Robinson*

Main category: hep-ph

TL;DR: Hammer library optimizes reweighting of simulated datasets for BSM theories, enhancing performance and usability for experimental analyses.


<details>
  <summary>Details</summary>
Motivation: To facilitate the efficient analysis of large datasets from semileptonic b-hadron decays in relation to various BSM theories, minimizing biases in findings.

Method: Improvements in Hammer's API and tensor library to ensure faster reweighting capabilities and maintain Monte Carlo uncertainties, alongside updated Python bindings.

Result: Achieved almost linear scaling of computational complexity with amplitude tensor rank; enhanced library functionalities and usability.

Conclusion: Hammer 2.x significantly upgrades usability and performance for analyzing complex BSM models through improved computational efficiency and user-friendly API.
...
### [98] [Event-axis TMD measurements in $e^+e^-$ and SIDIS](https://arxiv.org/abs/2607.02438)
*Daniel Diaz Fernandez,Patricia Andrea Gutierrez Garcia,Ignazio Scimemi,Wouter Waalewijn*

Main category: hep-ph

TL;DR: This paper explores transverse-momentum-dependent fragmentation in $e^+e^-$ collisions, proposing a model to analyze hadron correlations with the thrust axis, validated against simulated data.


<details>
  <summary>Details</summary>
Motivation: To study TMD fragmentation without disentangling two functions in conventional measurements, providing a new approach.

Method: Utilizes factorization theorems, completes operator-level formulations, performs one-loop checks, and presents a nonperturbative model while resumming transverse-momentum and thrust logarithms, implemented in artemide.

Result: The model effectively describes simulated $e^+e^-$ data, yielding parameters consistent with expectations, though the logarithm resummation alters fit parameters without significantly affecting quality.

Conclusion: The proposed model is a viable tool for analyzing TMD fragmentation in $e^+e^-$ collisions and reveals the importance of logarithmic corrections.
...
### [99] [Hadronization of $Λ_c^+$ baryons from recombination model in Pb+Pb collisions at the Large Hadron Collider](https://arxiv.org/abs/2607.01637)
*Jing-Zong Zhang,Hua Zheng,Lilin Zhu*

Main category: hep-ph

TL;DR: This paper investigates $Λ_c^+$ baryon production in Pb+Pb collisions using a quark recombination framework, addressing transverse momentum spectra and azimuthal anisotropy.


<details>
  <summary>Details</summary>
Motivation: To understand the production dynamics of $Λ_c^+$ baryons in the Quark-Gluon Plasma and validate the quark recombination mechanism as a hadronization process in heavy-ion collisions.

Method: The investigation employs a quark recombination framework, accounting for energy loss of quarks and analyzing transverse momentum spectra, yield ratios, and azimuthal anisotropy.

Result: The model effectively describes the $Λ_c^+$ transverse momentum spectra, the $Λ_c^+/D^0$ yield ratio, and the azimuthal anisotropy related to minijets, supporting the dominance of quark recombination in QGP.

Conclusion: The findings confirm that the quark recombination model is a valid mechanism for hadronization in heavy-ion collisions, extending predictions to other collision energies.
...
### [100] [Gravitational Waves from Multiple First-Order Phase Transitions in a Scenario with Early Matter Domination](https://arxiv.org/abs/2607.01697)
*Rouzbeh Allahverdi,Fazlollah Hajkarim*

Main category: hep-ph

TL;DR: This paper investigates early matter domination in cosmology, focusing on non-standard temperature evolution due to a time-dependent decay rate of associated species, which may lead to multiple phase transitions and characteristic gravitational wave signatures.


<details>
  <summary>Details</summary>
Motivation: To explore the implications of non-standard cosmological histories during early matter domination, which arise in certain theoretical frameworks.

Method: Analyzing the effects of a time-dependent decay rate on temperature evolution, leading to potential multiple first-order phase transitions, and studying the resulting gravitational wave spectra.

Result: Identified significant changes in temperature dynamics, including potential heating phases, and characterized the gravitational wave spectrum with features such as multiple peaks, aiding in determining phase transition and reheating temperatures.

Conclusion: Future gravitational wave detectors can provide insights into early universe physics by probing these distinctive features in the gravitational wave spectrum.
...
### [101] [Hybrid Residual Correction of VMC Charmonium Masses with a Screened Funnel Interaction](https://arxiv.org/abs/2607.01797)
*Tarik Akan,Metin Yalvac*

Main category: hep-ph

TL;DR: This study demonstrates that Machine Learning (ML) can significantly improve the accuracy of charmonium mass calculations within a Quantum Chromodynamics (QCD) potential-model framework using variational Monte Carlo (VMC) methods.


<details>
  <summary>Details</summary>
Motivation: To assess the efficacy of ML correction applied to VMC baseline estimates of charmonium masses, leveraging a standardized screened funnel potential instead of generating new spectrum proposals.

Method: The study employs a combination of variational Monte Carlo (VMC) analysis and deterministic eigenvalue diagonalization, then utilizes a neural network to correct the residual mass differences from the VMC calculations against experimental reference targets.

Result: The hybrid approach calculated ten charmonium states, achieving a significant reduction in mean absolute error (MAE) from 438.1 MeV to 24.1 MeV for seven experimentally validated states, reflecting a 94.5% improvement.

Conclusion: Machine Learning serves as an effective tool for reducing systematic offsets in potential-model spectroscopy of charmonium states.
...
### [102] [Phenomenology of genuine twist-three distributions from a global QCD analysis](https://arxiv.org/abs/2607.01866)
*Guillermo Portela,Alexey Vladimirov*

Main category: hep-ph

TL;DR: This paper studies twist-three parton distribution functions through QCD analysis of deep-inelastic scattering, confirming their universality and validating QCD theories.


<details>
  <summary>Details</summary>
Motivation: To investigate genuine twist-three PDFs and their role in understanding the proton's structure through various deep-inelastic scattering processes.

Method: Global QCD analysis of structure function $g_2$, its moment $d_2$, and spin asymmetries in DIS and SIDIS, with validation tests and comparisons with existing literature.

Result: Genuine twist-three PDFs were successfully extracted, affirming their universality and the QCD factorization theorems; Sivers and worm-gear-T TMD distributions were also derived.

Conclusion: A comprehensive understanding of the proton's structure is achieved through the extraction and analysis of multiple distribution functions, supported by broader data sources.
...
### [103] [Dynamics of Self-Interacting Dark Sectors](https://arxiv.org/abs/2607.01920)
*Esau Cervantes*

Main category: hep-ph

TL;DR: This thesis explores self-interacting dark sectors from the early Universe via freeze-in mechanisms, focusing on self-number-changing reactions and their impact on thermal history.


<details>
  <summary>Details</summary>
Motivation: To understand how self-interacting dark sectors, specifically through self-number-changing reactions, influence the early Universe dynamics and the phenomenology of dark matter.

Method: The thermal evolution is analyzed by solving coupled Boltzmann equations for number densities and temperatures, considering both freeze-in production and cannibal interactions across various theoretical models.

Result: The parameter space reveals varying constraints, ranging from strongly constrained to effectively invisible, and offers insights into future experimental accessibility based on the scenarios studied.

Conclusion: The exploration of a hidden U(1) gauge sector illustrates how energy injection can lead to phase transitions, linking dynamics with chemical equilibria in hidden sectors.
...
### [104] [One-loop proton decay from Peccei-Quinn symmetry](https://arxiv.org/abs/2607.02026)
*H. B. Câmara*

Main category: hep-ph

TL;DR: Accidental $B+L$ symmetry in the Standard Model is promoted to a Peccei-Quinn symmetry, which induces a framework for spontaneous proton decay and addresses the strong CP problem via axion solutions.


<details>
  <summary>Details</summary>
Motivation: The paper aims to provide a resolution to the strong CP problem and explore proton decay mechanisms within an extended symmetry framework, specifically focusing on the role of Peccei-Quinn symmetry.

Method: The authors use vector-like quarks to create a PQ anomaly sector that allows for induced one-loop proton decay through a specific effective operator, while ensuring tree-level proton decay is forbidden by a residual $\\mathcal{Z}_2$ symmetry.

Result: The study results in distinct models with varying predictions for the axion-to-photon coupling and introduces new decay channels such as $p \rightarrow e^+ \pi^0 a$, leading to implications for experimental tests and dark matter scenarios.

Conclusion: The proposed framework not only resolves the strong CP problem but also leads to a rich phenomenology concerning proton decay and axion dark matter in cosmological contexts.
...
### [105] [$Λ$ hyperons in core-collapse supernovae: Equilibration and neutrino opacities](https://arxiv.org/abs/2607.02086)
*Ruben Zatini,Jorge Martin Camalich,Pasquale Dario Serpico,Tobias Fischer*

Main category: hep-ph

TL;DR: The paper investigates $Λ$-hyperon production rates in post-collapse proto-neutron stars to assess the establishment of local chemical equilibrium and its influence on neutrino transport and star evolution.


<details>
  <summary>Details</summary>
Motivation: To systematically assess weak-interaction timescales for establishing chemical equilibrium of strange hadrons in dense matter during core-collapse supernovae.

Method: The authors compute $Λ$-hyperon production rates in hot, dense, isospin-asymmetric conditions using effective-field theory and assess local chemical equilibration via nonleptonic strangeness-changing reactions.

Result: Local $Λ$ chemical equilibration occurs on timescales of $10^{-11}$-$10^{-10}$ s, significantly shorter than proto-neutron-star evolution, with short-range contact interactions dominating the nonleptonic rates.

Conclusion: The findings support the existence of local equilibrium for $Λ$ hyperons and enhance understanding of neutrino transport and proto-neutron-star evolution.
...
### [106] [Light tetraquark states with $J^{PC}=1^{--}$ from QCD sum rules](https://arxiv.org/abs/2607.02109)
*Yi-Wei Jiang,Hua-Xing Chen,Er-Liang Cui,Ding-Kun Lian,Wen-Ying Liu,Niu Su*

Main category: hep-ph

TL;DR: This study systematically analyzes light tetraquark states with quantum numbers $J^{PC}=1^{--}$ using QCD sum rules, providing mass estimates for various flavor-isospin configurations and comparing these results to existing tetraquark and hybrid state data.


<details>
  <summary>Details</summary>
Motivation: To explore the properties and mass spectrum of light tetraquark states in the diquark-antidiquark framework, contributing to the understanding of light hadron spectroscopy.

Method: A systematic QCD sum rule approach was employed to construct local interpolating currents for various flavor-isospin configurations of light tetraquarks, and mass estimates were derived for these states.

Result: Masses derived for different configurations are: $1.64^{+0.15}_{-0.14}$~GeV for isoscalar $qqar{q}ar{q}$, $1.86^{+0.14}_{-0.14}$~GeV for isoscalar $qsar{q}ar{s}$, among others, leading to a comprehensive spectrum comparison.

Conclusion: The findings enhance the understanding of tetraquark and hybrid state distinctions in light hadron physics, with complete results for previously missing isotensor tetraquark configurations.
...
### [107] [Searching for single production of a vector-like $Y$ quark decaying into $bW$ at the FCC-eh](https://arxiv.org/abs/2607.02177)
*Liangliang Shang,Weifan Zhu,Bingfang Yang,Stefano Moretti*

Main category: hep-ph

TL;DR: This paper analyzes the potential to exclude or discover a vector-like $Y$ quark at the FCC-eh, focusing on its production and decay channels with polarized electron beams.


<details>
  <summary>Details</summary>
Motivation: To explore the single production of a vector-like $Y$ quark with unique charge properties and its decay mechanism, contributing to the search for new physics at high-energy colliders.

Method: The analysis involves detector simulations for electron-beam polarization at multiple center-of-mass energies, considering both leptonic and hadronic decay channels. Kinematic observables are utilized to reduce Standard Model backgrounds.

Result: The study presents $2σ$ exclusion limits and $5σ$ discovery potential in the $g^*$--$m_Y$ parameter space, revealing stronger results in hadronic channels with increasing energy.

Conclusion: The hadronic channel offers superior sensitivity for the exclusion and discovery of the $Y$ quark, particularly as the center-of-mass energy increases.
...
### [108] [Sideband Structure of Axion Electrodynamics](https://arxiv.org/abs/2607.02232)
*Run-Min Yao,Xiao-Jun Bi,Peng-Fei Yin,Qing-Guo Huang*

Main category: hep-ph

TL;DR: The paper presents a new Floquet--Bloch formulation regarding the interaction between photons and axions in a periodic axion background, demonstrating how these interactions lead to unique photon and axion branches, with implications for stability and resonance.


<details>
  <summary>Details</summary>
Motivation: To explore the dynamics of photon-axion interactions in a coherent periodic axion background and identify the conditions under which they exhibit different stability characteristics and resonances.

Method: A Floquet--Bloch sideband framework is employed to analyze the linearized Maxwell--axion system, focusing on the generation of photon and axion branches due to pump fields and examining collision behaviors in fixed-momentum and fixed-frequency scenarios.

Result: The study reveals that collisions with the same symplectic signature lead to stable behaviors, while those with opposite signatures induce instabilities. It also defines clear distinctions in signatures and behaviors between different modes of forward conversion and reflection.

Conclusion: The findings enhance the understanding of axion-photon interactions, offer insights into resonance phenomena, and establish the validity of the proposed sideband selection rules and instability features.
...
### [109] [A Maximum-Entropy Method for Zero-Skewness Valence GPDs Constrained by Nucleon Electromagnetic Form Factors](https://arxiv.org/abs/2607.02302)
*Seung-il Nam*

Main category: hep-ph

TL;DR: This study presents a reduced-profile maximum-entropy method for constructing constrained zero-skewness quark generalized parton distribution profiles using nucleon electromagnetic form factors, emphasizing a controlled approach to integrating elastic moments and transverse structure.


<details>
  <summary>Details</summary>
Motivation: The need for a systematic method to construct quark generalized parton distributions (GPDs) that incorporates existing experimental constraints while avoiding complex functional inversions.

Method: A reduced-profile MEM framework is developed, applying constraints from nucleon electromagnetic form factors and employing an ansatz for GPDs, coupled with an entropy functional for regularization on a low-dimensional manifold.

Result: The framework successfully reproduces elastic moment constraints, maintains forward normalizations, and generates plausible impact-parameter distributions reflecting expected transverse shrinkage for large x values.

Conclusion: This method serves as a reliable baseline for linking elastic form-factor constraints to x-dependent transverse profiles, paving the way for future analyses that incorporate higher accuracy empirical data.
...
### [110] [Symmetry Analysis of Compact Tetraquark States and Implications for the Level Ordering of the Fully Charmed Candidates $X(6600)$, $X(6900)$, and $X(7100)$](https://arxiv.org/abs/2607.02382)
*Shuai Yin,Ti Gong,Jingya Zhu*

Main category: hep-ph

TL;DR: This study analyzes the $J^P$ distribution of low-energy compact tetraquark states, finding that they likely favor $J^P=2^+$ and are governed by symmetry constraints rather than underlying dynamics.


<details>
  <summary>Details</summary>
Motivation: The research is motivated by recent experimental findings on low-energy tetraquark states and aims to understand their $J^P$ distribution.

Method: The authors utilize restricted representations of the permutation group $S_4$ to explore the nodal structure of $qqar qar q$ systems, focusing on configurations with orbital angular momentum $L 	extless= 3$.

Result: The analysis reveals a preferential distribution of $J^P$ states around $J^P=2^+$ and shows consistency with the distribution obtained from three-flavor four-quark systems. Incorporating chromomagnetic interaction effects does not alter the peak's location.

Conclusion: The findings suggest that symmetry constraints primarily dictate the characteristics of the low-lying spectrum of fully charmed tetraquark candidates, indicating the need for additional mechanisms beyond chromomagnetic dynamics.
...
### [111] [Chebyshev Approximations of Feynman Integrals for Collider Physics](https://arxiv.org/abs/2607.02411)
*Samuel Abreu,Afonso Guerreiro,Ben Page*

Main category: hep-ph

TL;DR: This paper presents a method for efficiently solving Feynman integrals using Chebyshev polynomials and adaptive sampling.


<details>
  <summary>Details</summary>
Motivation: To improve the numerical evaluation of Feynman integrals by enhancing convergence and stability.

Method: Chebyshev polynomial approximations are used for integral evaluation, coupled with an adaptive sampling technique for optimization.

Result: The implementation shows competitive performance against existing methods with stable results across various physical scenarios.

Conclusion: The proposed method provides an efficient, low-maintenance approach to Feynman integral calculations, addressing singularities effectively.
...
### [112] [Transverse-spin dependent energy-energy correlators in proton-proton collisions within the dihadron fragmentation framework](https://arxiv.org/abs/2607.02441)
*Zhong-Bo Kang,Andreas Metz,Daniel Pitonyak,Congyue Zhang*

Main category: hep-ph

TL;DR: This paper analyzes energy-energy correlations of hadrons within jets in polarized proton-proton collisions, yielding predictions that match recent data and underscore transverse-spin effects.


<details>
  <summary>Details</summary>
Motivation: To explore energy-energy correlations in jets produced from transversely polarized proton-proton collisions and their implications for understanding transverse-spin effects and non-perturbative QCD mechanisms.

Method: Numerical predictions were made using a model grounded in prior QCD analyses of dihadron fragmentation and transversity parton distribution functions.

Result: The predictions align well with recent STAR measurements, especially at high jet transverse momentum, where extractions of transversity are consistent with lattice QCD results.

Conclusion: The findings support the non-perturbative nature of energy-energy correlators and their utility in examining transverse-spin phenomena within the nucleon.
...
### [113] [The $D_{s1}(2460)$ and other open-charm $1^+$ states in relativistic chiral effective field theory](https://arxiv.org/abs/2607.02452)
*Ze-Rui Liang,Qi-Chao Xiao,Zhi-Hui Guo,De-Liang Yao*

Main category: hep-ph

TL;DR: This paper presents a derivation of chiral potentials for charmed vector meson interactions with light pseudoscalar bosons using U(3) chiral effective field theory, providing scattering length predictions that align well with lattice QCD data.


<details>
  <summary>Details</summary>
Motivation: To explore charmed vector meson interactions with light pseudoscalar bosons and to validate low energy constants through comparison with lattice QCD data.

Method: Utilizing a relativistic U(3) chiral effective field theory framework to derive relevant chiral potentials and calculate scattering lengths up to next-to-leading order.

Result: Predicted scattering lengths for various elastic channels show good agreement with lattice QCD data, particularly for the $S$-wave $I=1/2$ $D^ulletackslashpi$ scattering length. The paper also identifies the $D_{s1}(2460)$ as a bound state and characterizes the $D_1(2430)$ as involving two poles.

Conclusion: The findings support the notion that the $D_{s1}(2460)$ and lower $D_1(2430)$ are part of the same flavor SU(3) triplet, while the higher $D_1(2430)$ pole belongs to the SU(3) sextet, with implications for future lattice QCD and femtoscopic studies.
...
### [114] [Identifying $Σ(1380)$ and $Σ(1430)$ in the $J/ψ\to Λπ\barΣ$ reaction](https://arxiv.org/abs/2607.02485)
*Wen-Tao Lyu,Eulogio Oset,De-Min Li,En Wang*

Main category: hep-ph

TL;DR: This study investigates the $J/ψ	o ΛπarΣ$ reaction to identify low-lying $Σ^+$ states, confirming the presence of $Σ(1385)$ and a smaller peak for $Σ(1430)$, with implications for the $Σ(1380)$ state.


<details>
  <summary>Details</summary>
Motivation: To explore low-lying $Σ^+$ states through the $J/ψ	o ΛπarΣ$ reaction and the $π^+ Λ$ mass distribution.

Method: Analyzed the $π^+ Λ$ mass spectrum, considering both $πΛ$ and $πarΣ$ interactions to identify peaks corresponding to $Σ(1385)$ and $Σ(1430)$ states.

Result: Confirmed a clear signal for $Σ(1385)$ and observed a smaller peak for $Σ(1430)$. The low energy spectrum is well-explained by including contributions from these states, while the $Σ(1380)$ state's necessity diminishes with $πarΣ$ interactions.

Conclusion: The findings refine the understanding of $Σ^+$ states in low-energy interactions, indicating significant contributions from $Σ(1385)$ and $Σ(1430)$, while questioning the role of the $Σ(1380)$.
...
### [115] [A critical look at low-scale cosmological phase transitions in the PTA era](https://arxiv.org/abs/2607.02505)
*Simone Biondini,Philipp Schicho*

Main category: hep-ph

TL;DR: This study examines low-scale phase transitions in a dark Abelian Higgs sector in relation to recent gravitational-wave observations, highlighting the effects of thermal corrections on predictions and identifying parameter regions for dark matter scenarios.


<details>
  <summary>Details</summary>
Motivation: To analyze the implications of recent pulsar timing array (PTA) findings on gravitational-wave backgrounds by focusing on cosmological phase transitions in a minimal gauge theory.

Method: Utilizing dimensionally reduced high-temperature effective field theory, we assess the effects of thermal resummation and higher-order corrections on phase-transition thermodynamics and the gravitational-wave signal.

Result: The parameter space aligned with current PTA data is near the effective field theory's validity limit, where higher-dimensional operators start influencing predictions, yet the observed signals still do not align with PTA results.

Conclusion: Controlled finite-temperature calculations are essential for accurate predictions of gravitational waves from low-scale cosmological phase transitions, especially regarding dark matter phenomenology.
...
### [116] [A possible high-redshift origin for the short GRB 061201: implications of a compact binary merger beyond cosmic noon](https://arxiv.org/abs/2607.01337)
*E. Troja,B. O'Connor,Y. -H. Yang,T. M. Gaudin,M. Yadav,N. Passaleva,S. Dichiara*

Main category: astro-ph.HE

TL;DR: The paper argues that GRB 061201, a rare short gamma-ray burst, likely originated from a faint galaxy at redshift z>2, aiding in the understanding of early Universe compact binary mergers.


<details>
  <summary>Details</summary>
Motivation: To elucidate the significance of short gamma-ray bursts in tracing compact binary mergers and their role in r-process element production in the early Universe.

Method: The authors analyze the afterglow data of GRB 061201 and utilize deep near-infrared imaging from JWST to support the hypothesis that the burst originated from a faint galaxy.

Result: The findings suggest a coherent explanation for the characteristics of GRB 061201, aligning with a distant origin from a faint galaxy at z>2.

Conclusion: Confirming this origin could position GRB 061201 as one of the most distant short GRBs, enriching the understanding of compact mergers in the early Universe.
...
### [117] [X-ray polarization in magnetized neutron stars](https://arxiv.org/abs/2607.01357)
*Tanuman Ghosh,Shiv Sethi*

Main category: astro-ph.HE

TL;DR: The paper investigates X-ray polarization from magnetized compact objects, emphasizing the effects of incoming light properties on the polarization observed in scattering processes, while highlighting the complexities involved in magnetar polarization compared to normal pulsars.


<details>
  <summary>Details</summary>
Motivation: To enhance understanding of X-ray polarization mechanisms in magnetized compact objects and reconcile theoretical models with IXPE observations.

Method: The study focuses on the relationship between the polarization of scattered light and the geometry/polarization of incoming light, including analysis of vacuum birefringence effects across varying magnetic field strengths.

Result: The findings indicate that magnetars exhibit a higher degree of linear polarization than normal pulsars, aligning with IXPE results; however, complexities in magnetar emission suggest a need for multi-component models.

Conclusion: The present study's limitations in explaining magnetar polarization suggest the necessity for advanced studies and future X-ray polarimeter observations to explore additional spectral properties.
...
### [118] [Constraining the near-source relativistic wind medium using Fast Radio Burst circular polarization data](https://arxiv.org/abs/2607.01369)
*Om Gupta,Pawan Kumar,Paz Beniamini*

Main category: astro-ph.HE

TL;DR: This study examines circular polarization in Fast Radio Bursts (FRBs), suggesting it results from Faraday conversion in the magnetar wind rather than being intrinsic to the source.


<details>
  <summary>Details</summary>
Motivation: To understand the source and propagation mechanisms of FRBs through polarimetric studies.

Method: An analysis of circular polarization through calculations of Faraday conversion effects in the near-source wind of magnetars, accounting for varying effective mass of electrons and positrons in the presence of FRB waves.

Result: The model effectively explains the observed range and non-detection of circular polarization in FRBs, and provides constraints on various wind parameters and allows for measurable polarization in bursts with lower luminosities.

Conclusion: This work uniquely links wind properties of compact objects with FRBs to polarization data, offering a novel framework for understanding their physical environments.
...
### [119] [AI-enabled gravitational-waves searches for binary neutron stars at optimal sensitivity](https://arxiv.org/abs/2607.01372)
...
TL;DR: This paper presents Aframe, a neural network-based approach for real-time detection of gravitational waves from binary neutron star mergers, demonstrating comparable sensitivity to traditional methods with reduced computational costs.


<details>
  <summary>Details</summary>
Motivation: The need for real-time detection of gravitational waves (GWs) from binary neutron star (BNS) mergers has led to challenges in computational efficiency when processing large datasets in LIGO-Virgo-KAGRA (LVK) detectors.

Method: Aframe utilizes neural networks to identify signals in gravitational wave data, employing a novel approach to handle longer-duration signals through heterodyning, and requires only a single GPU for online analysis.

Result: Aframe achieved sensitivity similar to matched-filter pipelines for detecting BNS signals while significantly reducing computational demands and latency, facilitating both live detection and archival data analysis.

Conclusion: The successful implementation of Aframe showcases its potential for both real-time and archival analysis of gravitational wave data, marking a significant advancement in multi-messenger astronomy.
...
### [120] [Magneto-rotational instabilities in solids: application to neutron-star crusts](https://arxiv.org/abs/2607.01505)
*Arthur G. Suvorov,Thomas Celora,Kostas D. Kokkotas*

Main category: astro-ph.HE

TL;DR: This paper investigates how magneto-rotational instability interacts with solid materials, specifically examining the conditions necessary for magnetic growth in solid regions such as planetary crusts.


<details>
  <summary>Details</summary>
Motivation: To explore magneto-rotational instability's applicability in solids, particularly in contexts where solid and liquid layers rotate differently, as seen in planets and degenerate stars.

Method: A simplified, plane-parallel analysis was employed to assess conditions under which elasticity suppresses the magneto-rotational instability.

Result: Magnetic growth is possible in solids only when fluid flow is strongly sheared enough that the magnetic tension surpasses the shear modulus of the solid material; for binary neutron-star mergers, this requires a spin frequency of at least 300Hz, with potential reductions if viscous heating occurs.

Conclusion: The findings suggest that solid crusts in astrophysical objects can enhance magnetic fields under specific rotational conditions, impacting phenomena such as binary neutron-star mergers.
...
### [121] [Signatures of Two Distinct Epochs of FRB 20240114A from January to August 2024 Based on its Energy and Waiting Time Analysis](https://arxiv.org/abs/2607.01576)
*Xiao Li,Ying Gu,En-Wei Liang*

Main category: astro-ph.HE

TL;DR: The study analyzes energy and waiting time distributions of FRB 20240114A observations, revealing differing characteristics across two epochs.


<details>
  <summary>Details</summary>
Motivation: To understand the statistical properties of burst emissions from FRB 20240114A and how they change over time.

Method: Energy and waiting time distributions were examined using various fitting models (SPL, BPL, TPL, Band function for energy; Poisson, Weibull for waiting time) across full and subsample datasets.

Result: Full sample distribution models failed to fit; subsamples fitted well with BPL/TPL for energy and Weibull for waiting times. Notable variations found in fitting parameters between two observational epochs.

Conclusion: Different burst characteristics in two epochs suggest varying physical properties of the emission region.
...
### [122] [Bolometric correction factor and radiative efficiency for the super-Eddington accretion flow in tidal disruption events](https://arxiv.org/abs/2607.01604)
*Yongxin Wu,Erlin Qiao,Xuan Fang,Yiyang Lin,Jifeng Liu,Meng Guo*

Main category: astro-ph.HE

TL;DR: This paper estimates the bolometric luminosity and radiative efficiency of super-Eddington accretion in tidal disruption events using simulations and emergent spectra analysis.


<details>
  <summary>Details</summary>
Motivation: Understanding accretion flow properties around supermassive black holes is crucial, especially during tidal disruption events.

Method: Conducted radiation hydrodynamic simulations of super-Eddington accretion and performed post-processing to derive emergent spectra, enabling the calculation of bolometric correction factor and radiative efficiency.

Result: Discovered that both the bolometric correction factor and radiative efficiency are dependent on black hole mass and viewing angle, with specific ranges identified for each.

Conclusion: The derived parameters can help address the missing energy problem in tidal disruption events by allowing for better estimates of accreted mass.
...
### [123] [X-ray Fourier lag-frequency spectra modulated by stochastic turbulent acceleration in the jets of high-frequency-peaked BL Lac](https://arxiv.org/abs/2607.01606)
*Guang-Cheng Xiao,Wen Hu,Da-Guo Jiang,Jun-Xian Wang,Zhen-Yi Cai,Da-Hai Yan,Fang-Wu Lu*

Main category: astro-ph.HE

TL;DR: This study investigates X-ray interband time lags in high-frequency peaked BL Lac objects using a leptonic model to explain the influence of stochastic acceleration on lags.


<details>
  <summary>Details</summary>
Motivation: Understanding the X-ray time lags in BL Lac objects is critical for diagnosing jet physics and variability.

Method: We developed a one-zone leptonic model including stochastic turbulent acceleration and analyzed the resulting Fourier lag-frequency spectra.

Result: The model predicts distinct time-lag regimes shaped by the interplay of stochastic acceleration, cooling, and escape processes, with a transition between positive and negative lags.

Conclusion: The findings provide a unifying framework for interpreting observed X-ray flare properties in HBLs, linking lag amplitude to flare duration and explaining large lags in TeV-bright flares.
...
### [124] [Polarization Architecture of Steady GRMHD Jets from the Horizon to Infinity](https://arxiv.org/abs/2607.01820)
*Zhenyu Zhang,Yehui Hou,Yu Song,Yosuke Mizuno,Bin Chen*

Main category: astro-ph.HE

TL;DR: The study presents a semi-analytic framework for generating polarized images of GRMHD jets, revealing distinct scale-dependent features in jet morphology and polarization influenced by black hole spin and jet dynamics.


<details>
  <summary>Details</summary>
Motivation: To explore how gravity and magnetohydrodynamic flows affect jet morphology and polarization across a wide range of parameters.

Method: A semi-analytic framework is developed to generate resolved images of stationary, axisymmetric GRMHD jets, analyzing the polarization-angle profile and its scale-dependent characteristics.

Result: A new scale-dependent separation in polarimetric diagnostics is identified, showing how different effects influence the polarization angle at varying distances from the black hole, linking polarimetric characteristics to jet dynamics and structure.

Conclusion: The findings provide an achromatic diagnostic connecting GRMHD jet dynamics to resolved image characteristics, with implications for high-resolution polarimetry and understanding black hole spin and jet formation.
...
### [125] [Colour evolution in the radio afterglow of GRB 241025A](https://arxiv.org/abs/2607.01941)
...
TL;DR: This study analyzes the afterglow of gamma-ray burst GRB241025A using multi-wavelength observations, revealing inconsistencies with standard afterglow models, and proposing an enhanced optical depth to explain the findings.


<details>
  <summary>Details</summary>
Motivation: To understand the afterglow behavior of GRB241025A and its discrepancies with conventional afterglow models, enhancing the understanding of gamma-ray bursts.

Method: A comprehensive observing campaign across radio, near-infrared, optical, and X-ray wavelengths, followed by semi-empirical and semi-analytical modeling to fit the observed data.

Result: The afterglow was detected in all bands, but standard models did not match observed colour evolution; a model with enhanced optical depth improved agreement.

Conclusion: Enhancing optical depth due to unaccelerated electrons in the shock may reconcile model predictions with observations, highlighting the need for extensive multi-frequency follow-ups.
...
### [126] [Testing Gravity with Binary Pulsars in the SKA Era](https://arxiv.org/abs/2607.02064)
...
TL;DR: This paper discusses the role of binary and trinary radio pulsars in testing gravity in strong fields, emphasizing the capabilities of the Square Kilometre Array (SKA) telescope.


<details>
  <summary>Details</summary>
Motivation: Binary and trinary pulsars serve as effective tools for conducting tests of gravity under strong conditions, which is crucial for understanding fundamental principles like the strong equivalence principle and the nature of gravitational radiation.

Method: The paper proposes a Galactic census of pulsars and highlights the improved timing precision offered by the SKA telescope, facilitating the examination of potential deviations from general relativity and enabling the discovery of new relativistic pulsar systems.

Result: The expected outcome is the identification of numerous relativistic pulsar binaries, including pulsar-black hole pairs, which will provide platforms for rigorous tests of key gravitational theories.

Conclusion: SKA is poised to significantly enhance the investigation of gravity through binary pulsars by enabling precise measurements and new discoveries, thereby advancing our understanding of fundamental gravitational phenomena.
...
### [127] [Timing and spectral analysis of the 2025 outburst of 4U 1630$-$47 with \textit{NICER}](https://arxiv.org/abs/2607.02228)
*Haifan Zhu,Mariano Méndez,Xiao Chen,Wei Wang*

Main category: astro-ph.HE

TL;DR: This study analyzes NICER observations of the black hole binary 4U~1630$-$47 during its 2025 outburst, focusing on low-frequency quasi-periodic oscillations (QPOs) and quasi-regular modulation (QRM).


<details>
  <summary>Details</summary>
Motivation: To understand the spectral-timing properties of transient QPOs and QRMs in the context of black hole X-ray binaries during outbursts.

Method: NICER observations were analyzed using wavelet-based state separation and phase-resolved Hilbert-Huang analysis to relate QPOs, QRM, and disk parameters.

Result: QPO frequencies increased significantly during the outburst, with correlations observed between disk temperature and X-ray flux, while QRM represented weaker variability compared to prior observations.

Conclusion: Short-timescale spectral-timing variability is dominated by disk parameters, indicating transient QPOs reflect disk behavior, while QRM suggests a different variability mode near the outburst peak.
...
### [128] [SN 2020bij and a Possible Slow-Rise High-Velocity Subclass of Type IIP Supernovae](https://arxiv.org/abs/2607.02253)
...
TL;DR: This study identifies a new subclass of Type IIP supernovae (SNe) with slow light curve rises and high expansion velocities, suggesting minimal interaction with circumstellar material (CSM).


<details>
  <summary>Details</summary>
Motivation: To understand the explosion properties of Type II supernovae and their progenitors, particularly the role of circumstellar material in Type IIP SNe.

Method: Analysis of Type IIP supernova SN 2020bij and comparison with other similar events, using both analytical and numerical models.

Result: Identification of five Type IIP SNe with slow rises and high velocities, indicating weak to no CSM interaction, suggesting a new subclass.

Conclusion: The findings propose that these Type IIP events may be linked to confined CSM, and future observations could enhance understanding of late-stage mass loss in red supergiants.
