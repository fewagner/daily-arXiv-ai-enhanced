...
TL;DR: A unified framework for hybrid quantum mechanics is proposed, combining algebraic deformation and spatial non-locality, leading to new uncertainty relations and a quantum speed limit theorem.


<details>
  <summary>Details</summary>
Motivation: To create a comprehensive operator formalism that integrates aspects of hybrid quantum mechanics and facilitates deeper understanding of quantum dynamics.

Method: A self-adjoint hybrid kinetic operator is constructed using spectral calculus to derive generalized uncertainty relations and quantum speed limits.

Result: The framework shows how deformation parameters and external potentials affect evolution speed, supports coherent dynamics, and establishes limiting cases for different quantum mechanics variants.

Conclusion: The proposed framework not only subsumes existing quantum theories but also offers experimental signatures for testing in various platforms.
...
TL;DR: This paper explores quantum gravimetry with uncertain interrogation times, using a two-parameter quantum Fisher information framework to analyze how this uncertainty impacts effective gravity measurement across different models.


<details>
  <summary>Details</summary>
Motivation: The study is motivated by the fundamental energy-time uncertainty relation, which imposes limits on temporal resolution in quantum gravimetry.

Method: The authors profile the interrogation time via the two-parameter quantum Fisher information (QFI) matrix, applying this to three models: a freely falling Gaussian wavepacket, the Kasevich-Chu light-pulse atom interferometer, and an idealized closed-unitary optomechanical model.

Result: Results show that treating interrogation time as a nuisance parameter alters the effective gravity information, yielding specific mathematical expressions for QFI in each benchmark model, especially highlighting how nuisance-time profiling affects the measurement quality.

Conclusion: The paper concludes with explicit conditions minimizing information loss from nuisance time, along with constraints related to momentum spread, spatial localization, and performance over long interrogation times.
...
TL;DR: The study explores periodically driven Rydberg atoms, revealing emergent prethermal Bethe integrability at specific drive frequencies, supported by analytic expressions and numerical simulations.


<details>
  <summary>Details</summary>
Motivation: To investigate the dynamics of periodically driven Rydberg atoms and identify conditions for emergent integrability.

Method: The authors derive a perturbative analytic expression for the Floquet Hamiltonian and map it to the spin-$1/2$ XXZ chain, using numerical exact diagonalization for validation.

Result: Emergent integrability is demonstrated at specific drive frequencies, observed through level statistics, entanglement entropy, and longitudinal magnetization, indicating robust prethermal behavior.

Conclusion: The results confirm that certain drive protocols lead to emergent integrable dynamics in a driven Rydberg atom chain, which remains valid over extended timescales.
...
TL;DR: This paper presents a method to measure entanglement dynamics in quantum systems using a novel randomised measurement protocol that eliminates the need for universal local control, implemented on a neutral-atom quantum simulator.


<details>
  <summary>Details</summary>
Motivation: To explore many-body phenomena out of equilibrium by measuring entanglement dynamics, which provides insights into information scrambling and thermalisation in disordered systems.

Method: A randomised measurement protocol utilizing local energy tuning and a global field is developed to measure entanglement entropy without needing local gate control, executed on QuEra's Aquila simulator.

Result: The experiment demonstrates a clear transition from chaotic to localised entanglement dynamics due to programmable disorder in local Hamiltonian parameters, revealing disorder-specific entanglement spreading in small systems.

Conclusion: The study enhances the capabilities of programmable analogue quantum simulators and suggests broader applications of randomised measurement techniques in various analogue systems.
...
TL;DR: This paper reports an experimental demonstration of quantum random number generation (QRNG) using photon arrival times from nitrogen vacancy centres in nanodiamonds, achieving improved generation rates.


<details>
  <summary>Details</summary>
Motivation: To leverage quantum mechanical unpredictability for efficient generation of high-quality random numbers applicable in cryptography and simulations.

Method: Experimental demonstration of QRNG through measuring arrival times of photons from nitrogen vacancy centres in fluorescent nanodiamonds; testing various regions with differing numbers of NV centres.

Result: Achieved generation rates of 0.173 Mbits/s to 4.77 Mbits/s, with the latter representing a significant improvement over previous rates; generated bits passed statistical tests without post-processing.

Conclusion: The study validates the efficiency of QRNG in compact on-chip settings, indicating a promising direction for future cryptographic applications.
...
TL;DR: The paper explores physics-informed large-scale quantum neural networks, addressing challenges in training due to noise and large parameter spaces, and demonstrating their ability to classify quantum states effectively.


<details>
  <summary>Details</summary>
Motivation: The need to overcome challenges in understanding and utilizing quantum neural networks, particularly in the presence of noise and large system complexities.

Method: Development of large-scale quantum neural networks trained through limited noisy measurements, with a focus on constructing decision boundaries for quantum state classification.

Result: The proposed architecture successfully classifies quantum states by measuring an order parameter, enabling effective processing of quantum data from simulators and computers.

Conclusion: The approach shows potential robustness against noise, making it suitable for current quantum hardware and applications in quantum state classification.
...
TL;DR: HAML is a framework for rapid adaptation of Hamiltonian models in superconducting quantum processors, combining supervised training with online adaptation to efficiently identify unknown parameters.


<details>
  <summary>Details</summary>
Motivation: To improve the calibration and control of superconducting quantum processors in real-time without relying on perturbation theory, especially in regimes where conventional methods fail.

Method: HAML employs a two-phase approach: an offline training phase utilizing simulated devices to learn Hamiltonian coefficients and an online adaptation phase that measures actual device parameters for effective Hamiltonian retrieval.

Result: HAML successfully adapted to a transmon-coupler-transmon system, retrieving effective two-qubit coefficients even in challenging regimes typically disregarded by existing methods.

Conclusion: HAML provides a scalable and efficient method for Hamiltonian characterization that enhances calibration and error mitigation in quantum processors.
...
### [8] [Bell Test of Photons from Electron-Positron Annihilation via POVM-based Compton Polarimetry](https://arxiv.org/abs/2604.25034)
*Jack Clarke,Preslav Asenov,Jesse Smeets,Jia-Shian Wang,David B. Cassidy,Alessio Serafini*

Main category: quant-ph

TL;DR: This paper presents a framework for measuring polarization entanglement of gamma-ray photons from electron-positron annihilation using Compton polarimetry, demonstrating that repeated interactions can lead to ideal measurement outcomes.


<details>
  <summary>Details</summary>
Motivation: To verify polarization entanglement of gamma-ray photons, which has been challenging due to the lack of effective measurement schemes.

Method: Utilizes Compton polarimetry and the formalism of positive operator-valued measures (POVMs) to model polarization measurements, extending it to repeated interactions.

Result: Shows that repeated interactions in measurements can approximate ideal projective measurements of polarization and enable the violation of CHSH inequalities.

Conclusion: The method proposed can enhance the sharpness of polarization measurements in high-energy photons, potentially allowing for the experimental demonstration of entanglement.
...
### [9] [Use case study: benchmarking quantum breadth-first search for maximum flow problems](https://arxiv.org/abs/2604.24962)
*Andreea-Iulia Lefterovici,Lara Lelakowski,Michael Perk*

Main category: quant-ph

TL;DR: The paper assesses the potential of quantum BFS in optimizing the maximum flow problem through a hybrid approach, revealing significant challenges in achieving practical quantum advantages.


<details>
  <summary>Details</summary>
Motivation: The study aims to explore the application of quantum speedups in solving the maximum flow problem, a common challenge in optimization tasks.

Method: The researchers use a hybrid methodology that involves measuring the runtime of classical BFS implementations and estimating the quantum cycles required for qBFS with classically logged data.

Result: Findings show that for quantum advantages to be practical, quantum gate operation times must exceed current physical limitations.

Conclusion: The analysis indicates substantial obstacles in utilizing quantum approaches for large-scale maximum flow problems with existing technology.
...
### [10] [Approximate Sparse State Preparation with the Grover-Rudolph Algorithm](https://arxiv.org/abs/2604.24973)
*Debora Ramacciotti,Martin Steinbach,Bence Temesi,Andreea-Iulia Lefterovici,Antonio F. Rotundo*

Main category: quant-ph

TL;DR: The paper proposes enhancements to the Grover-Rudolph algorithm for efficient sparse quantum state preparation by optimizing gate usage and introducing approximate merging of rotations.


<details>
  <summary>Details</summary>
Motivation: Sparse quantum state preparation is essential for efficiency in quantum algorithms, particularly in loading classical data into quantum states.

Method: The authors enhance the Grover-Rudolph algorithm through a gate-merging procedure that incorporates virtual zero-angle gates and introduces an approximate variant for merging rotations with controlled errors.

Result: Improvements lead to a reduction in the number of CNOTs and control qubits, with a method for estimating the overlap with the target state to inform merging decisions.

Conclusion: The proposed enhancements optimize sparse quantum state preparation, balancing efficiency with manageable error.
...
### [11] [Nonlocal correlations for bosonic fields in black hole quantum atmosphere](https://arxiv.org/abs/2604.24976)
*Adam Z. Kaczmarek,Johann Gil,Zygmunt Bąk,Ewa A. Drzazga-Szczȩśniak,Dominik Szczȩśniak*

Main category: quant-ph

TL;DR: This paper explores how Hawking radiation from the quantum atmosphere affects nonlocal quantum correlations in bosonic systems near a Schwarzschild black hole, revealing notable differences from fermionic systems.


<details>
  <summary>Details</summary>
Motivation: To investigate the effects of the quantum atmosphere on nonlocal quantum correlations in bosonic systems, expanding beyond earlier studies focused on fermionic systems.

Method: By using measurement-induced nonlocality (MIN) as a quantifier, we analyze bosonic fields' responses to thermal and geometric aspects of the Hartle-Hawking vacuum at a distance from a black hole.

Result: Findings show that bosonic nonlocal correlations degrade significantly at a finite distance from the event horizon, vanishing as the distance increases, which contrasts with the behavior observed in fermionic systems.

Conclusion: Bosonic fields exhibit a more pronounced sensitivity to the quantum atmosphere's influence, highlighting the differences between bosonic and fermionic responses in the context of black hole physics.
...
### [12] [Networked Realization of Quantum LDPC Codes](https://arxiv.org/abs/2604.25026)
*Swayangprabha Shaw,Narayanan Rengaswamy*

Main category: quant-ph

TL;DR: This study proposes networked implementations of quantum low-density parity-check codes, specifically bivariate bicycle codes, addressing challenges in fault-tolerant quantum computing.


<details>
  <summary>Details</summary>
Motivation: QLDPC codes promise low-overhead fault-tolerant quantum computing, but their non-local stabilizers pose practical challenges.

Method: The paper implements networked surface codes in Stim and explores bipartitions of bivariate bicycle codes using balanced min-cut partitioning and teleported CNOTs for stabilizers.

Result: The study reveals insights into the circuit-level noise performance of networked QLDPC codes and compares their efficiency to monolithic implementations.

Conclusion: The work outlines the advantages and limitations of networked QLDPC codes and suggests directions for future research.
...
TL;DR: This paper addresses fault-tolerance and compilation in quantum computing through the use of error-correcting codes, allowing for more efficient implementation of quantum algorithms.


<details>
  <summary>Details</summary>
Motivation: The aim is to improve quantum algorithm implementation by addressing fault-tolerance and compilation challenges associated with noisy quantum components.

Method: The authors utilize error-correcting codes to introduce redundancy, making distinct operators logically indistinguishable, allowing flexibility in operator choices for compilation. They present a method to reduce compilation choices to a least squares problem with a closed-form solution.

Result: The approach enables the realization of a logical target operator without the need for costly swaps, using an accessible physical Hamiltonian instead, illustrated with the $[[4,2,2]]$ code.

Conclusion: The framework developed may establish connections to compressed sensing, potentially leading to efficient quantum compilation that effectively leverages available physical degrees of freedom.
...
TL;DR: The paper explores quantum particle dynamics in a bistable potential, challenging claims about the impossibility of chaos in Bohmian mechanics, and demonstrates that chaotic behavior can arise under certain conditions.


<details>
  <summary>Details</summary>
Motivation: To contest the belief that Bohmian trajectories cannot exhibit chaotic behavior in one-dimensional systems, thus expanding understanding of Bohm's quantum mechanics.

Method: Analysis of dynamics in a one-dimensional bistable potential, focusing on initial conditions and wave packet choices that affect particle motion.

Result: Demonstrated that particles can exhibit periodic, quasiperiodic, or chaotic motion based on the initial conditions, with smooth transitions between these states.

Conclusion: Bohmian trajectories can indeed display chaotic behavior, contradicting previous literature.
...
TL;DR: This paper presents a SWAP-free framework for implementing the Quantum Approximate Optimization Algorithm (QAOA) on noisy intermediate-scale quantum (NISQ) devices, addressing limitations due to sparse qubit connectivity and proposing heuristics for practical implementation.


<details>
  <summary>Details</summary>
Motivation: The performance of QAOA is hindered by the need for SWAP gates caused by misalignment of interactions and hardware topology, which increases circuit complexity and noise in NISQ devices.

Method: A mixed-integer semidefinite program (MISDP) is proposed to modify the cost Hamiltonian for native hardware implementation, optimizing variable allocation to physical qubits and ensuring compatibility with hardware constraints.

Result: The proposed approach shows competitive performance in a quadratic optimization model under conditions of SWAP-induced noise, compared to ideal QAOA, demonstrating that hardware-aware adaptations can yield better results on sparse architectures.

Conclusion: The research indicates that approximating the objective function in a hardware-compatible manner can be more effective than using exact Hamiltonians with extensive transpilation.
...
TL;DR: INJEQT is a novel two-factory design for near-term fault-tolerant quantum computation (FTQC) that significantly reduces error rates and execution time.


<details>
  <summary>Details</summary>
Motivation: Limited error budgets and sequential execution constraints in near-term FTQC systems necessitate reductions in error-prone instructions for effective program execution.

Method: INJEQT employs a two-factory design to synthesize Rz(θ) states with lower error rates, utilizing an auxiliary code and minimizing inter-module measurements.

Result: The proposed method reduces overall error rates by up to 22x and improves wall-clock time by up to 13x, while decreasing space-time cost by up to 7.2x, evaluated across various state preparation techniques.

Conclusion: INJEQT enhances FTQC architectural designs and is robust across diverse factory choices and device technologies.
...
TL;DR: The paper introduces a method for solving the time-dependent Schrödinger equation by utilizing score functions on Bohmian trajectories, demonstrating its effectiveness in quantum dynamics.


<details>
  <summary>Details</summary>
Motivation: To offer a novel approach for solving the time-dependent Schrödinger equation using modern generative modeling techniques.

Method: The authors learn the score function parametrized by a neural network, minimizing a self-consistent Fisher divergence between the network and the evolving density's score, specifically for nodeless wave functions.

Result: The approach successfully recovers Schrödinger dynamics for nodeless wave functions and demonstrates its applicability through simulations such as wavepacket splitting and anharmonic vibrations.

Conclusion: This framework transforms real-time quantum dynamics into a self-consistent score-driven normalizing flow, integrating it with advanced generative modeling methods.
...
TL;DR: A new parallel protocol is introduced for distributed quantum gates using dual-species quantum emitters, facilitating communication without traditional constraints.


<details>
  <summary>Details</summary>
Motivation: The need for efficient, scalable distributed quantum computing and networks without relying on prior entanglement or quantum frequency conversion.

Method: Using entangled photon pairs as a quantum data bus to connect stationary qubits in different locations, while facilitating parallel gate operations on multiple qubit pairs with high-dimensional encoding.

Result: Demonstrated feasibility of implementing multiple nonlocal quantum gates using a single entangled photon pair, enhancing quantum capacity through optical qudits.

Conclusion: The proposed protocol offers a scalable framework for distributed quantum networks, aiding the advancement of large-scale quantum computing architectures.
...
TL;DR: This paper proposes a scheme for nonreciprocal unconventional magnon blockade using a hybrid system of two microwave cavities and a YIG sphere, leveraging nonlinear interactions.


<details>
  <summary>Details</summary>
Motivation: To explore alternative methods for achieving nonreciprocal magnon blockade for applications in quantum information processing.

Method: The study involves a hybrid system where two microwave cavities interact nonlinearly, and the signal cavity is coupled to a YIG sphere to produce a magnon blockade through weak parametric driving.

Result: The authors demonstrate that nonlinear coupling between the pump cavity and magnon modes can facilitate the establishment of a nonreciprocal magnon blockade.

Conclusion: This approach offers a novel method for preparing single magnon resources, which can be beneficial for advancements in quantum information technologies.
...
TL;DR: This paper introduces a classical emulator for the quantum HHL algorithm, providing an exponential scaling advantage for sampling linear systems compared to direct quantum simulation.


<details>
  <summary>Details</summary>
Motivation: To address the overhead in simulating quantum algorithms for linear systems while leveraging classical emulation techniques.

Method: The study extends the Unconventional Noiseless Intermediate Quantum Emulator to classically emulate the HHL algorithm, focusing on sampling from linear systems.

Result: The emulator demonstrates exponential scaling advantages for fewer qubits, showing improved runtime compared to both the HHL algorithm and Intel's Quantum Simulator for small linear systems.

Conclusion: The classical emulator offers a viable and efficient alternative for sampling solutions from linear systems using the HHL algorithm, particularly for smaller cases.
...
TL;DR: This paper introduces a sandbox platform for hybrid quantum-classical workflows in graph optimization, focusing on systematically studying combinatorial problems and reporting practical experiments on IBM Quantum systems.


<details>
  <summary>Details</summary>
Motivation: The need for practical end-to-end case studies that combine problem modeling, quantum execution, and classical refinement to demonstrate quantum advantage in combinatorial optimization.

Method: The authors develop a platform to experiment with hybrid workflows for solving graph problems, employing QAOA on reduced problem instances after classical preprocessing and mapping quantum outputs through classical postprocessing.

Result: The approach was evaluated on synthetic, benchmark, and real-world graphs, showing effective hardware experiments capable of handling graphs with up to 128 vertices on IBM's quantum systems.

Conclusion: The results highlight the importance of end-to-end experimentation in revealing bottlenecks and clarifying the classical-quantum workload partitioning, aiding practitioners in interpreting quantum optimization outputs.
...
TL;DR: The paper discusses the integration of silicon T centres into nanophotonic cavities to achieve spectral tuning, enhancing their utility for scalable quantum technologies.


<details>
  <summary>Details</summary>
Motivation: To improve the performance and scalability of silicon T centres as emitters for quantum technologies by addressing spectral distribution and emitter linewidth issues.

Method: Integration of single T centres into silicon nanophotonic cavities with p-i-n diodes, allowing Stark tuning and observing effects on resonance and entanglement rates.

Result: Achieved Stark tuning capacity of 30 GHz for 55% of T centres, increased entanglement rate, and identified transitions related to dark charge states and spin mixing mechanisms.

Conclusion: Localized spectral tuning significantly enhances the effectiveness of silicon spin-photon interfaces, facilitating large-scale integration for quantum information applications.
...
TL;DR: This paper presents a method for inferring network link transmissivities using quantum probes and proposes a routing algorithm to optimize probe deployment in an optical network.


<details>
  <summary>Details</summary>
Motivation: The goal is to improve the estimation of network link transmissivities through the use of quantum probes, which are believed to offer advantages over classical methods.

Method: The paper introduces a probe construction algorithm that ensures link identifiability and maximizes orthogonal sets of transmissivities. It employs a Fisher information matrix (FIM) to evaluate probe performance.

Result: Two metrics, the determinant of the FIM and the trace of its inverse, are derived to quantify the effectiveness of the probe routing in estimating transmissivities.

Conclusion: The approach provides a framework to leverage quantum technology for better estimations in optical networks, showcasing potential quantum advantages.
...
TL;DR: A novel, simplified method for fabricating Al/AlO$_x$/Al Josephson junctions enables precise control over junction resistance and enhanced performance in quantum devices.


<details>
  <summary>Details</summary>
Motivation: To streamline the fabrication process of Al/AlO$_x$/Al Josephson junctions for improved performance in superconducting quantum technologies.

Method: Use of photolithography and argon etching followed by metallization and oxidation to create JJs of varied areas with significant control over resistance.

Result: Successful fabrication of JJs with minimal grain boundaries, reduced resistance variation in SQUIDs, and stable performance through thermal cycles. Demonstrated effective low-photon parametric amplification in a SQUID resonator.

Conclusion: This method presents the simplest approach for JJs thus far, potentially advancing superconducting circuits in quantum applications.
...
TL;DR: This paper addresses transmitter-device-dependence in quantum key distribution (QKD) through a one-sided device-independent (1sDI) framework, demonstrating an experimental implementation with a notable secure key-rate.


<details>
  <summary>Details</summary>
Motivation: To overcome the limitations of transmitter-device-dependence in quantum key distribution, which can compromise security.

Method: A composable transmitter in a 1sDI configuration was developed, with the entanglement source integrated into the transmitter and a detection module treated as a black box.

Result: Achieved a secure key-rate of 1 kbps over 20 km of fiber in a proof-of-principle experiment, marking the first implementation of discrete-variable 1sDI-QKD.

Conclusion: The proposed scheme delivers a balance between strong security and practicality, enhancing the feasibility of real-world applications for 1sDI-QKD.
...
TL;DR: This paper presents a novel quantum algorithm for simulating Maxwell's equations on quantum hardware, aiming to advance computational electromagnetics.


<details>
  <summary>Details</summary>
Motivation: To leverage quantum computing for efficient Hamiltonian simulations of electromagnetic fields, which are complex and computationally intensive on classical systems.

Method: The approach employs a Schrodingerisation technique with finite-difference discretization and maps non-unitary matrices to Trotter blocks. A new measurement procedure retrieves both field amplitudes and physical directions using phase-based sign reconstruction.

Result: Results from IonQ QPU demonstrate alignment with analytical solutions of benchmark problems in both two and three dimensions, showing the feasibility of the method.

Conclusion: This research is a significant step towards employing quantum hardware for practical computational electromagnetics, suggesting future applications in this domain.
...
TL;DR: This paper introduces a graph-conditioned meta-optimizer for the Quantum Approximate Optimization Algorithm (QAOA) that enhances parameter transferability across combinatorial optimization problems.


<details>
  <summary>Details</summary>
Motivation: There is a need for improved transferability of parameters in QAOA across different combinatorial optimization problems to enhance efficiency and performance.

Method: A problem-aware, graph-conditioned meta-optimizer is developed that learns to generate parameter trajectories over a fixed horizon, utilizing compact graph embeddings and trained end-to-end with differentiable feedback from the QAOA objective.

Result: The meta-optimizer demonstrates reduced optimization effort and better performance compared to standard initialization across various graph problem classes, successfully exhibiting transferable behavior.

Conclusion: The study confirms that the proposed optimizer significantly improves parameter transferability in QAOA, leading to enhanced optimization results across multiple problem classes.
...
TL;DR: The paper explores how nonlinear interactions in discrete time crystals enhance quantum sensing capabilities by increasing precision and information retention, while also analyzing the effects of imperfections.


<details>
  <summary>Details</summary>
Motivation: To improve quantum sensing mechanisms using discrete time crystals, particularly by exploring the role of nonlinear interactions.

Method: The authors extend the sensing mechanism of disorder-free discrete time crystals to include nonlinear interactions and rigorously analyze the scaling of quantum Fisher information.

Result: Nonlinearity is shown to augment sensing precision by enhancing the scaling exponent of quantum Fisher information while retaining quadratic growth with Floquet cycles.

Conclusion: The study establishes that while stronger nonlinearities improve sensitivity, they also reduce the stability of time crystals, with practical implications for quantum sensing using superconducting qubits.
...
TL;DR: This paper presents a superconducting digital-to-analog converter (DAC) integrated with fluxonium qubits, enabling in-situ tuning without compromising qubit coherence, which aids in scaling superconducting quantum processors.


<details>
  <summary>Details</summary>
Motivation: Address the limitations in wiring, heat load, and calibration for scaling quantum processors due to analog signal delivery from room temperature to qubits at millikelvin temperatures.

Method: Development of a superconducting DAC integrated with fluxonium qubits, programmed using single-flux-quantum pulses, to generate persistent analog flux signals for qubit tuning.

Result: The DAC operates effectively at millikelvin temperatures, allowing for in-situ tuning of qubit parameters without degrading coherence, thus simplifying control design by reducing room-temperature bias line requirements.

Conclusion: The proposed SFQ-programmable milikelvin DACs serve as foundational components for future digitally controlled superconducting quantum processors.
...
TL;DR: Investigates continuous measurement and postselection effects on entanglement in a transmon-cavity-transmon system, revealing how these factors can preserve entanglement in dissipative environments.


<details>
  <summary>Details</summary>
Motivation: To understand how continuous measurement and postselection influence the dynamics of entanglement in quantum systems, particularly under realistic conditions of detector inefficiency.

Method: Developed a stochastic master equation for the coupled system, derived its postselected counterpart, and analyzed the dynamics using the Liouvillian superoperator spectrum, focusing on identifying exceptional points and their associated phases.

Result: Postselection was found to significantly slow the decay of entanglement compared to a system without monitoring, highlighting the role of measurement in preserving quantum correlations.

Conclusion: The findings enhance the understanding of entanglement dynamics in dissipative systems and suggest valuable implications for quantum information applications.
...
TL;DR: This paper presents a systematic framework for quantum algorithms addressing matrix equations and functions through matrix-sign embeddings and logarithmic-sinc approximations, achieving efficient query complexities.


<details>
  <summary>Details</summary>
Motivation: The goal is to enhance quantum algorithms for solving matrix equations and functions, improving efficiency and applicability under various conditions.

Method: The approach involves creating an augmented matrix for sign embedding, using logarithmic-sinc approximations, and incorporating structure-aware multiplexing and rebalancing techniques.

Result: The framework enables linear query complexity in inverse-conditioning parameters and logarithmic complexity in target error tolerance, applicable to various matrix equations and functions.

Conclusion: Matrix-sign embeddings and nodewise rebalancing are proposed as reusable principles to advance structured operator-output quantum linear algebra.
...
TL;DR: Proposes a bounded distance decoding strategy for stabilizer codes, enabling effective error correction through a graph-based approach.


<details>
  <summary>Details</summary>
Motivation: To improve error correction methods for both CSS and non-CSS stabilizer codes using a unified decoding strategy.

Method: Utilizes a local Clifford equivalence and graphical representation of stabilizers to form a bounded distance decoding strategy, adapting maximum likelihood decoding principles.

Result: Achieves satisfactory performance in optimal non-CSS codes for distances up to 11 and near-optimal results for CSS codes under specific error types, while reducing runtime through strategic graph pruning.

Conclusion: Introduces an efficient decoding method applicable to various stabilizer codes, supported by an open-source library, QGDecoder.
...
TL;DR: The paper analyzes the mechanism of superconducting strip single photon detectors (SSPDs) with optical cavities, deriving key absorptance formulas and validating them through numerical simulations.


<details>
  <summary>Details</summary>
Motivation: Understanding the absorptance of SSPDs in optical cavities is crucial for improving their efficiency and performance in photon detection.

Method: The study employs transmission line models to derive analytical formulas for absorptance and uses impedance models to analyze input impedance matching for maximum absorptance.

Result: The derived formulas for absorptance align closely with numerical simulations across different optical cavity configurations, confirming their validity.

Conclusion: The insights gained can enhance the design of various superconducting detectors, suggesting a broader applicability of the findings beyond just SSPDs.
...
TL;DR: Ember is an open-source framework for benchmarking minor embedding algorithms in quantum annealing, addressing inconsistencies in prior studies by providing standardized metrics and a diverse graph library.


<details>
  <summary>Details</summary>
Motivation: The lack of standardized benchmarks for comparing minor embedding algorithms hinders reliable cross-algorithm comparisons.

Method: Ember offers a unified algorithm interface, a diverse graph library with 24,016 instances, and a standardized analysis pipeline for three D-Wave hardware topologies.

Result: Benchmarking five algorithms on Chimera shows no universal dominance; performance is influenced by graph structure and family.

Conclusion: Ember improves evaluative reproducibility for minor embedding algorithms, demonstrating the adaptation of algorithms based on specific structures and topologies.
...
TL;DR: This paper presents a novel photon level image classification method utilizing quantum compressed sensing, achieving high efficiency in low photon scenarios.


<details>
  <summary>Details</summary>
Motivation: The traditional sequential imaging and processing approach is inefficient for image classification in low photon conditions.

Method: The method treats classification as a sparse signal measurement problem, using quantum compressed sensing and a diffractive deep neural network for adaptive compressive measurement.

Result: Achieved a classification accuracy of 69.0% with a single-photon detection and 95.0% with four-photon detections.

Conclusion: The approach demonstrates energy-efficient image classification and lays the groundwork for intelligent sensing in challenging conditions.
...
TL;DR: This study explores finite-size adiabatic state preparation on Boolean hypercubes using graph-local drivers connected to Gray-code representatives, revealing mixed results in performance based on system geometry and control parameters.


<details>
  <summary>Details</summary>
Motivation: To investigate the effectiveness of various drivers in finite-size adiabatic state preparation on Boolean hypercubes.

Method: Utilized graph-local drivers derived from monotone Gray-code coordinates and performed numerical experiments to evaluate the performance of different Hamiltonians.

Result: Uncovered that ordinary diagonal-cost transverse-field annealing does not provide robust advantages, yet hybrid drivers significantly improve ground-state fidelity for specific Hamiltonians, achieving a fidelity of approximately 0.9799 with optimal parameters.

Conclusion: The effectiveness of the drivers is geometry-dependent, and the study provides substantial evidence for the sector-preserving skeleton's primacy in enhancing outcomes, accompanied by supporting materials for traceability.
...
TL;DR: This paper presents a hybrid quantum-classical genetic algorithm for constructing bent Boolean functions, demonstrating a significant computational advantage of quantum evaluation over classical methods.


<details>
  <summary>Details</summary>
Motivation: Bent Boolean functions are difficult to construct for many variables, and existing classical methods are inefficient for large n.

Method: A hybrid quantum-classical GA uses a quantum circuit to evaluate the Gowers $U_2$ norm as a fitness function, requiring fewer resources than classical methods.

Result: The quantum evaluation circuit requires $3n$ qubits and $igO(n^2)$ gates, while classical computation needs $igO(2^{2n})$ operations; validation showed that for $n=8$, the GA achieves fitness matching the theoretical bent threshold.

Conclusion: The quantum-enhanced evaluation shows promise for scalable computation in generating bent Boolean functions, providing a clear advantage beyond 25 variables.
...
TL;DR: Simon's algorithm effectively deciphers the Even-Mansour cipher on NISQ hardware for small bit lengths, revealing scalability issues in current optimization tools.


<details>
  <summary>Details</summary>
Motivation: To explore the practical implementation of Simon's algorithm on noisy intermediate-scale quantum (NISQ) hardware for cryptanalysis of the Even-Mansour cipher.

Method: A proof of concept quantum cryptanalysis was executed using Simon's period-finding algorithm on the ibm_miami processor, focusing on N = 3 and N = 4 to recover secret keys.

Result: Successful secret key recovery was achieved for N-bit constructions at small values of N, but DORCIS faced memory limitations at N = 5, hindering circuit optimization for larger keys.

Conclusion: Simon's algorithm is promising for short key lengths on NISQ devices, but there is a significant need for more efficient synthesis tools to scale up to larger key lengths in Even-Mansour scenarios.
...
TL;DR: This paper addresses the challenge of performing logical operations on deformed surface-code geometries through a new defect-adaptive lattice-surgery method.


<details>
  <summary>Details</summary>
Motivation: The need for executing fault-tolerant computations on irregular geometries resulting from defects in surface-code hardware.

Method: A defect-adaptive lattice-surgery approach reconstructing joint logical parity from seam-related measurements, framed as a GF(2) binary-support synthesis problem.

Result: The method improves compile yield, maintains effective distance, and incurs modest logical-error overhead compared to defect-free scenarios; it certifies whether requested parities are realizable.

Conclusion: This framework effectively links defect-adaptive patch construction and executable operations in faulty surface-code hardware.
...
TL;DR: This paper examines quantum optimization approaches for the Generalized Traveling Salesman Problem (GTSP), proposing a QUBO formulation and a gate-based pipeline using QAOA, while comparing their effectiveness against classical methods and addressing scalability challenges.


<details>
  <summary>Details</summary>
Motivation: To explore quantum optimization techniques for the GTSP, which involves complex routing and sequencing problems that can benefit from quantum computational strategies.

Method: The authors present a novel QUBO formulation for the GTSP, implement a constrained QAOA with an XY-mixer to maintain Hamming weight, and compare quantum approaches with classical solvers on benchmark datasets, while considering instance cluster reductions.

Result: The quantum solvers demonstrated competitive solution quality on smaller instances, although they suffered from increased runtimes and scalability issues as instance sizes grew, highlighting areas of concern such as sampling rates and runtime problems.

Conclusion: While quantum optimizers show promise for specific instances, significant algorithmic and hardware-related challenges must be resolved to achieve broader application and effective scalability in the GTSP.
...
TL;DR: The study reveals a crucial missing local-refinement stage in the cotengra tensor-network contraction process, showing significant improvements in contraction efficiency with bond dimension. The new method demonstrates a linear growth in predicted cost-model gaps, outperforming control families in various scenarios.


<details>
  <summary>Details</summary>
Motivation: To address inefficiencies in tensor-network contraction, particularly in Sycamore-like topologies, by introducing a local-refinement stage to improve contraction results.

Method: The method integrates a nearest-neighbor interchange (NNI) search with cotengra outputs, evaluating performance using predicted cost-model gaps as metrics across different bond dimensions.

Result: The NNI search showed a monotonically increasing median predicted cost-model gap ( bits at χ=2 to 116 bits at χ=16), consistently outperforming other control graphs in all tests, indicating the refinement's effectiveness is topology-dependent.

Conclusion: The study concludes that the local-refinement significantly enhances efficiency in tensor-network contraction, particularly in relevant bond dimensions for practical applications.
...
TL;DR: This paper explores quantum annealing-inspired algorithms tailored for NISQ devices, highlighting approximate quantum annealing and evolving Hamiltonian quantum optimization.


<details>
  <summary>Details</summary>
Motivation: To enhance variational quantum optimization performance in the NISQ era using reduced-resource methods inspired by quantum annealing.

Method: Analysis of approximate quantum annealing with a non-traditional discretized approach and introduction of evolving Hamiltonian quantum optimization for optimized intermediate steps.

Result: Parameter scans reveal configurations that maintain annealing-like behavior with fewer resources; numerical simulations indicate that these methods improve optimization outcomes.

Conclusion: Quantum annealing-inspired algorithms present viable strategies for effective variational optimization in the context of NISQ technologies.
...
TL;DR: This paper presents autoresearch, a method using AI coding agents to optimize hyperparameter choices for quantum computing ground-state preparation protocols.


<details>
  <summary>Details</summary>
Motivation: To enhance the efficiency of quantum programming by automating protocol tuning and improving coding agent capabilities.

Method: Autoresearch is employed to optimize hyperparameters for VQE, DMRG, and AFQMC, validated on spin models and molecular Hamiltonians.

Result: The AI agents successfully evolved simple baselines into complex protocols that yielded better energy estimates within limited computational resources.

Conclusion: The study suggests that the method can automate a significant portion of quantum protocol tuning, allowing for enhanced scalability and efficiency.
...
TL;DR: This paper establishes convergence guarantees for the Rotosolve algorithm in optimizing parametrized quantum circuits, contrasting it with other methods.


<details>
  <summary>Details</summary>
Motivation: There has been a lack of formal convergence guarantees for interpolation-based coordinate descent methods like Rotosolve in the field of quantum optimization.

Method: The authors rigorously analyze Rotosolve's convergence behavior in non-convex and smooth optimization landscapes, deriving explicit worst-case rates of convergence, and conducting numerical experiments for comparison.

Result: Rotosolve converges to $B5$-stationary points under smooth conditions and to $B5$-suboptimal points under the PL condition, with competitive rates compared to RCD.

Conclusion: Rotosolve, being hyperparameter-free and utilizing derivatives in its updates, shows promise in quantum machine learning optimization, as evidenced by both theoretical and numerical findings.
...
TL;DR: This paper presents a method to achieve high indistinguishability in photons from distant quantum dot-cavity sources, overcoming challenges in spectral noise and wavelength matching.


<details>
  <summary>Details</summary>
Motivation: The need for scalable optical quantum technologies necessitates the interference of indistinguishable single-photons from independent sources, particularly from semiconductor quantum dots.

Method: The authors utilize nanofabrication to create numerous quantum dot-cavity sources with ultra-low spectral noise and minimal wavelength dispersion, employing two tuning mechanisms for spectral overlap optimization.

Result: Achieved two-photon indistinguishability of 88±1%, which is near the theoretical limit of intrinsic indistinguishability for each source.

Conclusion: This work marks a significant advancement for developing scalable photon-based quantum technologies, enabling better integration of distant quantum sources.
...
TL;DR: This paper investigates the vulnerability of fiber-optic attenuators in quantum key distribution systems to pulsed laser attacks, revealing significant damage and new eavesdropping risks.


<details>
  <summary>Details</summary>
Motivation: To highlight the underestimation of pulsed laser threats in QKD systems, especially in contrast to well-studied laser-damage attacks using continuous-wave lasers.

Method: Experimental evaluation of four types of fiber-optic attenuators subjected to sub-picosecond pulses at 1061 nm and average power of 1 W, analyzing performance and damage.

Result: Mechanical variable and air-gap attenuators showed resistance, while MEMS-based attenuators suffered up to 3.8 dB irreversible damage. Fixed absorptive attenuators had a reduced optical damage threshold compared to cw attacks, achieving 7 dB attenuation reduction at 1550 nm.

Conclusion: The findings indicate a significant risk of hidden side-channel vulnerabilities and the inadequacy of current countermeasures against advanced laser-damage attack scenarios.
...
TL;DR: The paper introduces a framework to reduce the computational cost of quantum machine learning by creating fast classical tensor-train surrogates for quantum models, addressing inference inefficiencies.


<details>
  <summary>Details</summary>
Motivation: The main motivation is to alleviate the high computational expense of repeated quantum circuit evaluations in quantum machine learning, particularly during inference.

Method: The authors propose a framework that uses Taylor polynomial approximation combined with tensor-train representation and incorporates empirical risk minimization to construct surrogates that ensure controlled generalization error.

Result: The framework enables a polynomial scaling of parameter count with respect to the number of dimensions, reducing the complexity compared to naive approaches, while defining three error sources that can be independently controlled.

Conclusion: The approach successfully separates representation complexity from feature-induced constants, enhancing efficiency and control over surrogate model accuracy.
...
TL;DR: The study explores reset-induced entanglement phase transitions in random unitary quantum circuits, highlighting the role of qudit dimension, $d$, in these transitions.


<details>
  <summary>Details</summary>
Motivation: To understand the effects of reset channels in quantum circuits, particularly in relation to many-body statistical physics.

Method: Numerical simulations of stabilizer circuits for qudits with $d=2$, focusing on the nature of phase transitions at varying reset rates.

Result: Observations of large fluctuations near the critical point suggest a continuous reset-induced phase transition, indicating a second-order mixed phase transition.

Conclusion: The findings challenge classical statistical models by demonstrating different transition behaviors influenced by the qudit dimension.
...
TL;DR: This paper introduces two enhancements to quantum state preparation using an architecture-aware framework, aiming for improved efficiency in amplitude encoding within quantum algorithms.


<details>
  <summary>Details</summary>
Motivation: To improve quantum state preparation for better efficiency in processing large classical data, which is essential for achieving quantum advantages in various applications.

Method: Remove the $U_{2	ext{CR}}$ subroutine by precomputing and storing rotation angles in BBQRAM, and extend to complex matrices by adding a leaf phase with a two-step magnitude-then-phase approach.

Result: Achieves $	ext{O}(	ext{log}_2^2(MN))$ query complexity while reducing the QPU procedure to simpler BBQRAM retrievals and controlled-rotation cascades, with memory usage of $	ext{O}(MN)$ per matrix.

Conclusion: The proposed improvements result in a more efficient quantum state preparation method suitable for larger matrices and without the need for reversible arithmetic.
...
TL;DR: This paper proposes a quantum control protocol using nitrogen-vacancy centers for nanoscale surface analysis, addressing challenges like anisotropy and dipole-dipole interactions, and providing a method for characterizing samples.


<details>
  <summary>Details</summary>
Motivation: There is a growing demand for high-sensitivity nanoscale surface analysis, and NV centers provide a promising solution due to their proximity operation and sensitivity.

Method: The proposed protocol synchronizes a slowly rotating magnetic field with tailored RF decoupling and microwave control to detect isotropic chemical shifts at the nanoscale in solid-state environments.

Result: An analytical mapping is established that connects the measured spectrum to the control sequence features and system parameters, facilitating sample characterization.

Conclusion: The proposed method effectively addresses inherent challenges in solid-state environments and enhances nanoscale analytic capabilities using NV centers.
...
TL;DR: This paper explores a modified concept of quantum memory for time-dependent quantum systems, revealing its distinct characteristics compared to out-of-time-ordered correlators (OTOC).


<details>
  <summary>Details</summary>
Motivation: The study aims to broaden the understanding of quantum memory beyond simple models, addressing its application in realistic quantum systems and its relation to fundamental uncertainties in measurements.

Method: The authors propose a time-dependent formulation of quantum memory, analyze it in relation to OTOC, and conduct experiments on an atomic helical spin chain. A neural network is also used for predictive analysis.

Result: Quantum memory exhibits faster oscillations than OTOC and demonstrates non-equilibrium behavior alongside sensitivity to broken inversion symmetry and nonreciprocal effects.

Conclusion: The findings indicate that quantum memory can effectively be applied to realistic systems, offering deeper insight into quantum correlations and measurement uncertainties.
...
TL;DR: A novel method for characterizing classical stochastic noise affecting qubit dephasing using Ramsey interferometry is presented. It allows direct measurement of noise correlations without complex pulse sequences.


<details>
  <summary>Details</summary>
Motivation: To provide a simpler, more direct way to characterize classical noise processes that cause qubit dephasing, overcoming limitations of existing methods that require intricate decoupling strategies.

Method: The method utilizes repetitive Ramsey interferometry measurements (RIMs) to sample noise fields directly, capturing n-point correlations of outcomes that relate to the underlying noise processes.

Result: Numerical demonstrations confirm the efficacy of this method on classical noise types, specifically Ornstein-Uhlenbeck processes (Gaussian) and two-level fluctuators (non-Gaussian).

Conclusion: This approach is robust against decoherence and measurement errors, making it a versatile tool for qubit noise spectroscopy across various experimental platforms.
...
TL;DR: This study evaluates four measurement strategies for classifying quantum circuits, finding that $Z$-basis measurements significantly outperform others, especially for small qubit counts.


<details>
  <summary>Details</summary>
Motivation: To compare various polynomial-resource measurement techniques for their effectiveness in classifying different quantum circuit families.

Method: The study examines four strategies: $Z$-basis-only, nearest-neighbor $ZZ$, multi-basis ($Z$, $X$, $Y$), and classical shadows, assessing their performance on IQP, Clifford, and Clifford$+T$ circuits.

Result: $Z$-basis measurements achieve the highest Random Forest accuracy (0.91 at 4–5 qubits), with nearest-neighbor measurements closely following (0.89). All strategies perform poorly beyond approximately 12 qubits under a quadratic shot budget.

Conclusion: While the $Z$-basis provides the best results, the findings highlight limitations under a quadratic shot budget for larger qubit counts, leaving open the question of finding more efficient classification methods.
...
TL;DR: The paper explores ground-state energy calculations of the Ising model using the CVQE algorithm and GSA with up to 63 qubits, highlighting quantum error boundaries and performance insights.


<details>
  <summary>Details</summary>
Motivation: To find an efficient method for calculating the ground-state energy of the Ising model using quantum computing techniques, paving the way for near-term applications.

Method: Utilizing the Cascaded Variational Quantum Eigensolver (CVQE) with the Guided-Sampling Ansatz (GSA) on a heavy-hex lattice tailored for qubit architecture, analyzing both homogeneous and random-coupling models.

Result: Identified the boundary of acceptable quantum errors depending on qubit count and coupling strength, and performed an entropic analysis to evaluate quantum performance.

Conclusion: The Ising model is particularly suited for implementation on near-term quantum computers, indicating a promising direction for quantum simulations.
...
TL;DR: The paper investigates the integration of quantum spatial distribution and gauge symmetry in quantum error correction using a specific particle configuration, demonstrating resilience against noise and architectural flexibility for quantum operations.


<details>
  <summary>Details</summary>
Motivation: To enhance quantum error correction through the integrated use of quantum spatial distribution and gauge symmetry.

Method: Utilizing a configuration of $3+2$ particles on nested squares, employing gate operations on spin and position states, and formulating a unified noise model.

Result: The integration of gauge symmetry leads to resilience against multiple noise types, and quantum spatial distribution offers flexible architectures for performing quantum operations.

Conclusion: The proposed error-correcting scheme is effective in managing noise, and the system supports various quantum operations with minimal neighboring particle interactions.
...
TL;DR: This paper presents a new quantum-simulation approach for two-dimensional spectroscopy (2DS) utilizing bath-engineering techniques, demonstrating its application to both theoretical models and real compound analysis.


<details>
  <summary>Details</summary>
Motivation: To enhance the extraction of information on electronic and vibrational dynamics in complex systems via precise simulations for two-dimensional spectroscopy (2DS) experiments.

Method: The authors propose a quantum-simulation approach utilizing bath-engineering techniques and demonstrate it through simulations of a four-level system and an actual compound, analyzing time correlation functions using the center-line slope method.

Result: Simulation results align with experimental data, successfully reproducing spectral patterns of RDC in chloroform and validating the CLS method for time correlation functions extraction.

Conclusion: The developed framework offers both numerically-exact simulations and computational efficiency, advancing the study of open quantum systems through two-dimensional spectroscopy.
...
TL;DR: This study investigates tensor networks for SAR image classification, focusing on robustness against noise and model size efficiency for deployment on edge devices.


<details>
  <summary>Details</summary>
Motivation: To improve SAR image classification in noisy environments while optimizing model size for edge deployment.

Method: Evaluation of tensor networks to assess their robustness to data poisoning and ability for model reduction, contrasting them with conventional neural networks.

Result: Tensor networks demonstrate enhanced robustness and efficiency in classifying SAR images compared to traditional neural networks.

Conclusion: The findings indicate that tensor networks are valuable for radar applications and deepen understanding of deep learning methodologies.
...
TL;DR: Hybrid Quantum Walk (HQW) enhances quantum optimization by coherently superposing multiple trajectories, improving upon QAOA with better performance metrics.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of QAOA's fixed evolution by incorporating coherent superposition of multiple paths in quantum optimization.

Method: Introduced a hybrid quantum walk (HQW) ansatz using a dynamical coin operator and optimal control theory to derive an expressive Hamiltonian framework.

Result: HQW shows superior performance over QAOA in numerical experiments on Max-Cut and Maximum Independent Set problems, evidenced by faster convergence, better accuracy, and greater robustness.

Conclusion: HQW establishes a new paradigm for quantum optimization by integrating optimal control and algebraic structure, paving the way for advanced quantum algorithms.
...
TL;DR: GECKO is a novel method enhancing quantum control pulses' quality using Riemannian geometry after a high-fidelity pulse is found.


<details>
  <summary>Details</summary>
Motivation: The effectiveness of quantum control pulses relies not only on fidelity but also on experimental constraints, necessitating improved methods.

Method: GECKO leverages Riemannian geometry to optimize control pulses by navigating the pulse space while keeping the unitary unchanged to first order.

Result: GECKO substantially improves pulse properties such as spectral filtering, smoothness, robustness, and duration on a transverse-field Ising Hamiltonian.

Conclusion: The method offers a model-agnostic approach to refine quantum control pulses after achieving high fidelity.
...
TL;DR: The paper presents a mathematical framework for characterizing quantum error-correcting codes and maximally entangled states in mixed-dimensional Hilbert spaces, utilizing multisets to enhance traditional quantum metrics.


<details>
  <summary>Details</summary>
Motivation: To advance quantum error correction in heterogeneous networks with mixed-dimensional qubits and qudits. Traditional scalar metrics have proven inadequate.

Method: Introducing dimension multisets to replace scalar weights for describing quantum error-correcting codes and their error supports; formulating mixed-dimensional quantum MacWilliams identity and bounds for code parameters.

Result: Development of the mixed-dimensional shadow identity and generalized constraints, including new bounds for pure mixed-dimensional codes and application of enumerator machinery to analyze AME states.

Conclusion: The framework allows for systematic evaluation and construction of mixed-dimensional quantum codes and AME states, with new insights into their existence and properties.
...
TL;DR: The paper resolves an anomaly in the non-Hermitian Nakajima-Zwanzig projected Liouvillian QLQ, showing it is pseudo-Hermitian with a real spectrum due to a positive-definite metric.


<details>
  <summary>Details</summary>
Motivation: The study addresses the unexplained anomaly of QLQ having a real spectrum despite being manifestly non-Hermitian in the Jaynes-Cummings model.

Method: Demonstrates that QLQ is pseudo-Hermitian by identifying a positive-definite metric that satisfies the condition (QLQ)†η = η(QLQ), ensuring real eigenvalues.

Result: The metric is shown to remain stable across bath-truncation limits, and a continuous deformation to the Rabi model reveals a re-entrant pseudo-Hermitian phase.

Conclusion: This work provides a structural justification for the analyticity of the memory kernel in canonical quantum optics.
...
TL;DR: The paper provides a rigorous mathematical proof for the performance of Universally Robust dynamical decoupling (UR$n$) sequences, confirming their claimed error suppression capabilities and enhancing understanding of their robustness.


<details>
  <summary>Details</summary>
Motivation: To address the lack of a complete mathematical proof for the effectiveness of UR$n$ sequences in error suppression due to pulse imperfections.

Method: Utilizing a series expansion of fidelity and deriving conditions for the cancellation of coefficients up to order $n$, we show that the UR$n$ phase prescription meets these conditions.

Result: The proof confirms that the error 1-F is of order $O(ε^n)$, validating the UR$n$ sequences' robustness against arbitrary pulse imperfections.

Conclusion: The work establishes a solid analytical foundation for UR$n$ sequences and elucidates the mechanisms behind their high-order error compensation.
...
TL;DR: A quantum subroutine is proposed to solve second-order linear PDEs efficiently using Quantum Block Encoding, overcoming limitations of traditional methods in high-dimensional spaces.


<details>
  <summary>Details</summary>
Motivation: Classical numerical schemes struggle with high-dimensional PDEs due to the curse of dimensionality, necessitating exploration of alternatives like quantum computing.

Method: The proposed method employs Quantum Block Encoding and reversible arithmetic to exploit the structure of filters in Fourier space, enhancing matrix inversion processes beyond current quantum techniques.

Result: The methodology is validated against classical methods, showing correctness and promising efficiency improvements in solving second-order linear PDEs.

Conclusion: This work lays the groundwork for future applications in quantum Fourier transforms, wavelet analysis, and potentially nonlinear PDEs, demonstrating the versatility of quantum approaches in computational science.
...
TL;DR: This paper explores singular σ-additive states in quantum mechanics, relating them to the cardinality of sets and providing structural insights into their representation and application in quantum channels.


<details>
  <summary>Details</summary>
Motivation: To understand the properties and implications of singular σ-additive states in quantum physics, particularly their connection to Ulam measurability and set theory.

Method: The authors establish that any σ-additive state can be represented as a Pettis integral over a singular σ-additive measure, and they design quantum channels using σ-complete ultrafilters that transform normal states into singular σ-additive states.

Result: The paper elucidates the structural representation of σ-additive states and introduces a new class of quantum channels capable of encoding information into the singular component of the state space.

Conclusion: The findings extend classical representation theory to a broader context in quantum mechanics, highlighting the significance of singular σ-additive states and their practical applications.
...
TL;DR: This paper introduces a teleportation-based decomposition for multi-controlled Toffoli gates, achieving unit Toffoli depth and lower gate count, while requiring additional ancilla qubits.


<details>
  <summary>Details</summary>
Motivation: Decomposing complex quantum operations into practical gate sets is essential for advancing quantum computing, particularly for efficient use of multi-controlled Toffoli gates in quantum algorithms.

Method: A teleportation-based approach that allows for the implementation of an arbitrary multi-controlled Toffoli gate with unit depth and fewer gates using ancilla qubits.

Result: The proposed decomposition method maintains low gate count and unit depth, improving the performance of circuits relying on MCT gates over existing techniques.

Conclusion: The paper demonstrates that this decomposition is advantageous for various quantum circuits, enabling more efficient quantum computations in platforms that can manage entangled states.
...
TL;DR: The paper presents MCMit, a co-designed hardware-software solution addressing the challenges of Mid-Circuit Measurements and classical feedback in Distributed Quantum Computing, significantly reducing error rates and improving circuit performance.


<details>
  <summary>Details</summary>
Motivation: The high error rates and latencies associated with Mid-Circuit Measurements in Quantum Computing hinder the efficiency of Quantum Error Correction and the overall performance of DQC.

Method: MCMit integrates a multi-control branch instruction and employs two types of qubit-state discriminators (a transformer and a CNN), alongside software improvements like static MCM elimination and stochastic branching to reduce errors.

Result: The proposed method reduces feedback latency by up to 70%, increases circuit depths by up to 7 times, and improves discrimination accuracy by 37-73%, resulting in up to 80% lower logical error rates in Quantum Error Correction.

Conclusion: MCMit demonstrates significant enhancements in the fidelity and performance of quantum circuits, validating its effectiveness compared to baseline methods.
...
TL;DR: This paper presents a class of multi-mode bosonic models exhibiting limit-cycle behavior, achievable through coherent parametric driving while maintaining continuous internal symmetry, leading to exact solutions for their quantum dissipative steady states.


<details>
  <summary>Details</summary>
Motivation: The research addresses the challenge of achieving limit-cycle behavior in many-body quantum systems using coherent driving and continuous symmetry, two seemingly incompatible requirements.

Method: The authors introduce multi-mode bosonic limit cycle models driven by coherent parametric methods, establishing conditions under which an O(N) continuous symmetry exists and deriving exact solutions for their full quantum dissipative steady states.

Result: The models reveal phenomena such as steady state entanglement, reduced phase diffusion, and the potential for quantum limit tori, all while being compatible with various experimental platforms.

Conclusion: The study provides insights into the mechanisms behind coherent parametric driving and its role in yielding symmetry-enriched limit cycles, enhancing understanding of related quantum systems where symmetries may be weakly broken.
...
TL;DR: QCalEval introduces a benchmark for evaluating vision-language models on quantum calibration plots, revealing performance discrepancies among models in zero-shot and in-context learning settings.


<details>
  <summary>Details</summary>
Motivation: To systematically evaluate how well vision-language models interpret quantum calibration plots, which are essential for quantum computing calibration.

Method: The study introduces QCalEval, a benchmark consisting of 243 samples and 87 scenario types assessed against six question types in zero-shot and in-context learning settings.

Result: The best zero-shot model achieved a mean score of 72.3, while closed models improved under in-context learning, and a supervised fine-tuning at the 9-billion-parameter scale enhanced zero-shot performance but didn't resolve in-context learning gaps.

Conclusion: The QCalEval benchmark reveals distinct performance trends among various models, emphasizing the potential of supervised fine-tuning and the need for continued exploration in multimodal learning for better calibration interpretation.
...
TL;DR: The study demonstrates that sequential measurements in continuous-variable quantum systems can violate Bell inequalities, providing new insights into quantum mechanics and expanding the potential of photonic-encoded systems.


<details>
  <summary>Details</summary>
Motivation: To explore the limitations of noncontextual hidden-variable models in continuous-variable systems during sequential measurements.

Method: The experiment involved mapping spatial modes of a photon from an InAs/GaAs quantum emitter to operations in the Gottesman-Kitaev-Preskill code, utilizing a black-box approach to assess measurement outcomes.

Result: A violation of the Bell-like noncontextual hidden-variable inequality was observed by 380 standard deviations, indicating that sequential measurements can challenge previously held beliefs.

Conclusion: The findings reveal conceptual loopholes in prior research, paving the way for further investigations in fundamental quantum physics with photonic continuous-variable systems.
...
TL;DR: This paper addresses the optimization of conditional quantum state preparation schemes for generating non-classical states of light, emphasizing the maximization of heralding probability via polynomial equations.


<details>
  <summary>Details</summary>
Motivation: The motivation stems from the need for efficient optical quantum state preparation schemes, which are crucial for advancements in quantum information processing and metrology, particularly when experimental capabilities increase.

Method: The authors present a method to maximize heralding probability by formulating it as a problem of solving polynomial equations, incorporating experimental constraints on single-mode quadrature squeezing.

Result: They demonstrate that their approach effectively identifies optimal configurations for generating finite superpositions of Fock states and can be adapted for squeezed superpositions.

Conclusion: This methodology can streamline quantum state preparation, allowing for higher state-preparation rates and advancing experimental applications in quantum optics.
...
### [71] [Measurement of muon (anti-)neutrino charged-current quasielastic-like cross section using off-axis NuMI beam at ICARUS](https://arxiv.org/abs/2604.24925)
...
TL;DR: The paper presents the first neutrino cross-section measurement by the ICARUS detector at Fermilab, focusing on CCQE-like events with no pion production, and discusses the implications of the findings for neutrino event generators.


<details>
  <summary>Details</summary>
Motivation: To improve understanding of neutrino interactions and reduce uncertainty in neutrino oscillation measurements by providing a cross-section measurement that addresses complex nuclear effects.

Method: Utilizing NuMI beam data for $2.5\times10^{20}$ protons-on-target, the study measures flux-averaged differential cross sections based on event topologies, examining angular and kinematic imbalance variables.

Result: Cross sections were reported for angular variables and kinematic imbalances; predictions from neutrino event generators were compared using $p$-values, showing agreement with the data.

Conclusion: While predictions align with the measurements, the current uncertainties are insufficient to strongly distinguish between models.
...
### [72] [Simultaneous measurements of $N$-subjettiness observables in jets from gluons and light-flavour quarks, and in decays of boosted W bosons and top quarks](https://arxiv.org/abs/2604.25538)
*CMS Collaboration*

Main category: hep-ex

TL;DR: The paper presents a measurement of 25 substructure observables for large-radius jets from proton-proton collisions at 13 TeV, focusing on dijet and $	ext{t}ar{	ext{t}}$ events, and emphasizes the utility of these measurements for improving jet radiation models.


<details>
  <summary>Details</summary>
Motivation: The study aims to enhance the understanding of jet substructure in high-energy collisions, which is critical for precise particle physics measurements.

Method: The authors analyzed jets categorized by prong structures, utilizing a comprehensive 6-body basis of $N$-subjettiness observables and unfolding the measurements to stable particle levels.

Result: Data from collisions, with an integrated luminosity of 138 fb$^{-1}$, provided insights into the correlations between various jet observables, facilitating a systematic assessment of jet radiation modeling.

Conclusion: The results offer a detailed characterization of jet substructure that aids in refining theoretical models and improving the accuracy of jet-related measurements in high-energy physics.
...
### [73] [Search for electroweakinos in compressed-spectrum scenarios with low-momentum isolated tracks in proton-proton collisions at $\sqrt{s}$ = 13 TeV](https://arxiv.org/abs/2604.25604)
*CMS Collaboration*

Main category: hep-ex

TL;DR: This study searches for supersymmetric particles, specifically higgsino-like charginos and neutralinos, using soft tracks and missing transverse momentum, but finds no significant excess, setting constraints on their masses and mass splittings.


<details>
  <summary>Details</summary>
Motivation: To investigate the presence of supersymmetric electroweakinos, which could provide insights into natural supersymmetry and the properties of dark matter candidates.

Method: Utilized events with soft isolated tracks and large missing transverse momentum, employing a parameterized neural network to distinguish signal from background, analyzing 138 fb$^{-1}$ of data from proton-proton collisions at 13 TeV with the CMS detector.

Result: No significant excess over the standard model was found; the analysis excluded the higgsino model for mass splittings of 0.28-1.15 GeV and chargino masses up to 185 GeV.

Conclusion: The study sets stringent constraints on natural supersymmetry scenarios, emphasizing the need for further searches or theoretical exploration in these parameter spaces.
...
### [74] [Measurement of the Z $\to$ $μ^+μ^-$ angular coefficients in pp collisions at $\sqrt{s}$ = 13 TeV as functions of transverse momentum and rapidity](https://arxiv.org/abs/2604.25678)
*CMS Collaboration*

Main category: hep-ex

TL;DR: This paper presents a detailed measurement of angular polarization coefficients in Drell-Yan production of muon pairs, using LHC data.


<details>
  <summary>Details</summary>
Motivation: Understanding the angular polarization coefficients helps clarify the partonic dynamics and Z boson production mechanisms in high-energy collisions.

Method: The analysis was conducted using proton-proton collision data from the CMS detector, focusing on double differential measurements across various transverse momentum and rapidity intervals for muon pairs.

Result: Eight angular polarization coefficients were measured in the invariant mass range of 81-101 GeV, with comparisons made to theoretical predictions from quantum chromodynamics.

Conclusion: These measurements enhance the understanding of the dynamics behind Drell-Yan processes and the associated production mechanisms.
...
### [75] [Sub-keV energy calibration of CONUS+ via 71Ge M-shell neutron activation](https://arxiv.org/abs/2604.25748)
...
TL;DR: The CONUS+ experiment achieved a significant reduction in measurement uncertainty for coherent elastic neutrino-nucleus scattering by improving energy calibration methods.


<details>
  <summary>Details</summary>
Motivation: The need to minimize uncertainties in detecting coherent elastic neutrino-nucleus scattering, crucial for precision measurements in neutrino research and beyond Standard Model physics.

Method: Conducting a neutron activation campaign with a 241AmBe source to irradiate a 2.4 kg germanium detector, aimed at improving energy calibration and resolution.

Result: Achieved a substantial reduction in uncertainty to below 4% for signal prediction and successfully resolved the 71Ge M-shell X-ray line.

Conclusion: The results enhance the energy calibration for the CONUS+ experiment, setting the stage for advanced CEvNS research and potential discoveries in particle physics.
...
### [76] [Background Remover -- an effective tool for processing noisy microscopy images](https://arxiv.org/abs/2604.25558)
*Anna Kilian,Paweł Bilski,Małgorzata Sankowska*

Main category: physics.ins-det

TL;DR: BGR is a plugin for ImageJ that enhances fluorescent microscopy image analysis by effectively removing noise and preserving signal in low signal-to-noise conditions.


<details>
  <summary>Details</summary>
Motivation: To improve analysis of fluorescent microscopy images with low signal-to-noise ratios and heterogeneous backgrounds.

Method: An algorithm that differentiates between signal and noise pixels, enhancing object identification and intensity determination.

Result: Demonstrated effectiveness in preserving signal while eliminating noise, allowing for reliable analysis in challenging conditions.

Conclusion: BGR enhances the utility of image analysis for researchers and is available for free download.
...
### [77] [A radon emanation measurement system at the Carleton Noble Liquid Detector Laboratory](https://arxiv.org/abs/2604.25609)
*P. Adhikari,M. G. Boulay,R. Crampton,D. Gallacher,M. Perry*

Main category: physics.ins-det

TL;DR: A radon detection system was developed to investigate radon emanation from materials in low-background experiments, crucial for dark matter and neutrino searches.


<details>
  <summary>Details</summary>
Motivation: Radon emanation is a significant source of background interference in rare event searches, necessitating accurate detection and mitigation strategies.

Method: The detection system includes a stainless steel emanation chamber and a low-background ZnS(Ag) cell, designed for radon detection under vacuum and in nitrogen gas, using a charcoal trap for collection.

Result: The system effectively measured radon emanation from materials, calculated radon levels in critical environments, and is calibrated for practical use.

Conclusion: The COLD Lab radon emanation counter is vital for minimizing background noise in future rare event detection experiments.
...
### [78] [NTL-amplified cryogenic light detectors with optically transparent electrodes](https://arxiv.org/abs/2604.25730)
...
TL;DR: This paper introduces a silicon light-detector technology enhancing sensitivity through the Neganov-Trofimov-Luke (NTL) effect using transparent ITO electrodes at millikelvin temperatures. The electrodes simplify fabrication and improve detector robustness while serving dual functions as electric fields and anti-reflective coatings.


<details>
  <summary>Details</summary>
Motivation: To improve light sensitivity in cryogenic detectors, enabling detection of minimal optical signals.

Method: The paper presents a new silicon light-detector design using transparent indium-tin-oxide (ITO) electrodes for NTL amplification, alongside a comprehensive characterization of the devices at room and millikelvin temperatures.

Result: Successful operation of two cryogenic calorimeters using the ITO-based detectors, with verified structural and optical characteristics, and an analytical model describing NTL gain for various particles and photons.

Conclusion: The integration of ITO electrodes effectively enhances detector performance while simplifying manufacturing, paving the way for more efficient light-sensitive devices.
...
### [79] [Embedded underwater front-end electronics for the 3-inch photomultipliers in the JUNO experiment](https://arxiv.org/abs/2604.25835)
...
TL;DR: The paper details the design and performance of underwater electronics for the SPMT system in the JUNO neutrino detector, highlighting system integration and validation results.


<details>
  <summary>Details</summary>
Motivation: To enhance the detection capabilities of the JUNO neutrino observatory by developing a reliable and efficient underwater front-end electronics system for the SPMT.

Method: The design incorporates individual electronics boards, system-level architecture, inter-board interfaces, and firmware for data acquisition and control, focusing on noise reduction and bandwidth management.

Result: The electronics system achieves low noise levels of 0.04 photoelectrons, minimal crosstalk (below 0.4%), and a bandwidth of 57 MB/s, confirming its readiness for JUNO's physics objectives.

Conclusion: The SPMT underwater electronics are fully integrated into JUNO, poised for commissioning, with comprehensive performance metrics supporting future physics research.
...
### [80] [Next-to-next-to-leading QCD corrections to the $\mathbf{B^+}$-$\mathbf{B_d^0}$, $\mathbf{D^+}$-$\mathbf{D^0}$, and $\mathbf{D_s^+}$-$\mathbf{D^0}$ lifetime ratios](https://arxiv.org/abs/2604.24841)
*Francesco Moretti,Ulrich Nierste,Pascal Reeck,Matthias Steinhauser*

Main category: hep-ph

TL;DR: The study systematically calculates heavy meson decay widths, focusing on lifetime ratios and the effects of quark mass and coupling constant.


<details>
  <summary>Details</summary>
Motivation: To provide accurate predictions for heavy meson lifetimes using a systematic expansion in quark mass and coupling constant.

Method: Calculates three-loop contributions to lifetime ratios and presents new corrections to Cabibbo-suppressed terms, combining with hadronic matrix elements from Heavy Quark Effective Theory.

Result: Finds lifetime ratios: τ(B^+)/τ(B_d^0) = 1.072 ± 0.024, τ(D^+)/τ(D^0) = 2.344 ± 0.170, and τ(D_s^+)/τ(D^0) = 1.289 ± 0.042, showing good agreement with experimental data.

Conclusion: Results strengthen the validity of hadronic matrix element calculations and allow estimates of higher-order contributions.
...
### [81] [Accidental Peccei-Quinn Symmetry from Chiral Gauge Symmetry and Mirror QCD](https://arxiv.org/abs/2604.24849)
*Hajime Fukuda,Keisuke Harigaya*

Main category: hep-ph

TL;DR: The paper proposes a novel solution to the strong CP problem using chiral U(1) gauge symmetry, eliminating massless fermions and light QCD axions, while accommodating high reheating temperatures for baryon asymmetry via leptogenesis. It also predicts a gravitational wave background and identifies a pseudo-Nambu-Goldstone boson as a dark matter candidate, leveraging a vector portal to connect dark matter with the Standard Model, and suggesting experimental probes at the LHC.


<details>
  <summary>Details</summary>
Motivation: To address the long-standing strong CP problem in particle physics without introducing massless fermions or light QCD axions.

Method: The model utilizes a chiral U(1) gauge symmetry that leads to an accidental Peccei-Quinn symmetry, broken by mirror QCD dynamics, while incorporating mechanisms for baryon asymmetry and dark matter candidates.

Result: The framework avoids unstable domain walls and colored relics, predicts stochastic gravitational waves, and identifies specific particles that can be searched for at the LHC.

Conclusion: The proposed model successfully connects key aspects of particle physics and cosmology, providing new avenues for experimental verification and a consistent solution to the strong CP problem.
...
### [82] [CP violation in $Σ^+\to p\ell^+\ell^-$ within the standard model and beyond](https://arxiv.org/abs/2604.24335)
*Xiao-Gang He,Jusak Tandean,German Valencia*

Main category: hep-ph

TL;DR: The LHCb collaboration has observed the rare decay of Σ+ and is positioned to measure CP violation, potentially revealing new physics due to significant absorptive phases in standard model contributions.


<details>
  <summary>Details</summary>
Motivation: To investigate CP violation in rare hyperon decays and explore its potential connections to new physics.

Method: The decay modes Σ+→pμ+μ−, Σ+→pe+e−, and Σ+→pγ are analyzed for decay rate asymmetries and their implications for CP violation.

Result: Decay rate asymmetry could reach tens of percent, which LHCb plans to probe soon, indicating possible new physics effects.

Conclusion: Current understanding allows for significant CP violation in these decay modes, inviting further investigation with upcoming LHCb experiments.
...
### [83] [Muon $g$$-$$2$: correlation-induced uncertainties in precision data combinations](https://arxiv.org/abs/2604.25004)
*Alexander Keshavarzi,Daisuke Nomura,Thomas Teubner,Aidan Wright*

Main category: hep-ph

TL;DR: The paper introduces a framework for quantifying uncertainties from unknown correlations in data combinations, applied to $e^+e^- ightarrow 	ext{hadrons}$ cross section data and HVP contributions to the muon magnetic moment.


<details>
  <summary>Details</summary>
Motivation: To systematically quantify uncertainties due to unknown systematic correlations in data combinations, enhancing accuracy in precision measurements.

Method: A generalized method allows controlled variation of the correlation structure to create covariance matrices directly on the data combination.

Result: The method was applied to cross section data, revealing that correlation-induced uncertainties, although often subdominant, play a non-negligible role and do not fully explain discrepancies in data combinations.

Conclusion: The framework is applicable to broader contexts of correlated data combinations, contributing significantly to future analyses like the KNTW data combination for $a_μ^	ext{HVP}$.
...
### [84] [Can LLP detectors probe the reheating temperature? A case study of vector dark matter](https://arxiv.org/abs/2604.25090)
*Paulo Areyuna C,Giovanna Cottin,Bastián Díaz Sáez,Zeren Simon Wang,Yu Zhang*

Main category: hep-ph

TL;DR: This paper investigates a model with a dark vector and a long-lived scalar, focusing on dark matter production and collider signatures.


<details>
  <summary>Details</summary>
Motivation: To explore new physics beyond the standard model, particularly in the context of dark matter and long-lived particles.

Method: The model involves a dark vector as a dark matter candidate and a scalar that decays through higher-dimensional operators, with analysis of DM production mechanisms at varying reheating temperatures and experimental searches at colliders.

Result: The study finds that LLP decay provides unique signatures helpful for probing dark matter parameters, and that long-distance detectors can extend the search scope and constrain reheating temperatures.

Conclusion: The findings suggest potential for uncovering new dark matter physics and improving sensitivity to reheating scenarios through collider experiments.
...
### [85] [Basis for non-derivative baryon-number-violating operators](https://arxiv.org/abs/2604.25134)
*Julian Heeck,Brandon B. Le*

Main category: hep-ph

TL;DR: This paper introduces a streamlined basis for non-derivative baryon-number-violating operators in Standard Model Effective Field Theory, enhancing simplicity and efficiency, especially up to mass dimension 11 and for specific cases at dimension 12.


<details>
  <summary>Details</summary>
Motivation: To improve upon existing bases for baryon-number-violating operators by reducing term complexity and enhancing computational efficiency in the Standard Model Effective Field Theory.

Method: The authors develop a minimal basis encompassing non-derivative operators up to mass dimension 11 and analyze specific (ΔB, ΔL) operators at dimension 12, comparing their structure and complexity to existing bases.

Result: The new bases are generally more compact and feature simpler contractions than existing results, although some instances reveal incompatibility with minimal structural assumptions.

Conclusion: This work presents a more efficient framework for exploring baryon-number-violating operators in the Standard Model, highlighting both the strengths and limitations of minimal bases.
...
### [86] [On the Role of Prompt Photons in the Anisotropic Emission of Direct Photons -- Direct Photons from Au+Au collisions at $\sqrt{s_{NN}}=200$ GeV with IP-Glasma Initial Condition](https://arxiv.org/abs/2604.25165)
*Fu-Ming Liu*

Main category: hep-ph

TL;DR: The study uses a viscous hydrodynamic model to analyze direct photon emissions in Au+Au collisions, finding variable agreement with RHIC data based on centrality.


<details>
  <summary>Details</summary>
Motivation: To understand the anisotropic emission of direct photons in heavy-ion collisions and reconcile theoretical predictions with experimental measurements.

Method: A (3+1)-dimensional viscous hydrodynamic model with Glasma initial conditions was employed to calculate transverse momentum spectra and elliptic/triangular flow of direct photons.

Result: The calculated transverse momentum spectra align well with experimental data across different centrality bins, although the flow predictions vary: good for 20-40%, underpredictive for 0-20%, and overpredictive for 40-60% centrality.

Conclusion: Adjusting for prompt photon contributions clarifies the direct photon flow measurements, highlighting that overestimating prompt photons can lead to inconsistencies in flow predictions.
...
### [87] [Les Houches study on inclusive jet production at NNLO+NNLL](https://arxiv.org/abs/2604.25490)
*Terry Generet,Joey Huston,Kyle Lee,Ian Moult,Rene Poncelet,Xiaoyuan Zhang*

Main category: hep-ph

TL;DR: This paper reassesses scale variation methods in NNLO QCD calculations for inclusive jet production at the LHC, highlighting significant uncertainties and the inadequacy of traditional approaches.


<details>
  <summary>Details</summary>
Motivation: To enhance the precision of jet production analyses at the LHC and accurately account for uncertainties in QCD calculations.

Method: Reassessment of scale variation methods using NNLO QCD calculations combined with small-jet-radius resummation to NNLL accuracy.

Result: NNLL resummation notably affects scale uncertainties and can lead to significant changes in central inclusive jet cross sections for specific scale choices.

Conclusion: Scale variations in both fixed and resummed calculations may underestimate higher-order effects, indicating the need for improved methodologies in jet production analyses.
...
### [88] [A study of $J/ψ$ mass shift and bound states: Impact of $D D$ and $DD^*$ meson loops](https://arxiv.org/abs/2604.25449)
*Manpreet Kaur,Arvind Kumar*

Main category: hep-ph

TL;DR: This study explores the mass modification of the $J/ψ$ meson in asymmetric nuclear matter, finding a negative mass shift with increased baryonic density, indicating potential meson-nucleus bound states.


<details>
  <summary>Details</summary>
Motivation: To understand how nuclear medium affects the mass and behavior of the $J/ψ$ meson, especially in the context of experimental studies involving charmed mesons.

Method: An effective Lagrangian approach was employed, considering $DD$ and $DD^*$ loops, along with the hadronic chiral SU(3) model to evaluate $D$ meson mass changes and using QCD sum rules.

Result: The study shows that increased baryonic density leads to a negative shift in the $J/ψ$ meson mass, suggesting attraction to nuclear mean fields and the possibility of meson-nucleus bound states.

Conclusion: The findings provide insights relevant for future experiments at Jefferson Lab and other facilities, which aim to explore low-momentum charmed mesons in nuclear environments.
...
### [89] [Determination of the $Z_c(3900)$ and the $Z_{cs}(3985)$ states from joint analysis of experimental and lattice data](https://arxiv.org/abs/2604.25607)
*Yun-Hua Chen,Meng-Lin Du,Feng-Kun Guo*

Main category: hep-ph

TL;DR: The study analyzes the $Z_c(3900)$ and $Z_{cs}(3985)$ states using experimental and lattice data, revealing them as SU(3) flavor partners in the same octet multiplet.


<details>
  <summary>Details</summary>
Motivation: To provide a unified understanding of the $Z_c(3900)$ and $Z_{cs}(3985)$ states by integrating different data sources and considering their interactions.

Method: The analysis incorporates various experimental processes, lattice QCD simulations, and considers open-charm meson loops with triangle singularities, coupled-channel interactions, and final-state interactions.

Result: The findings confirm that the $Z_c(3900)$ and $Z_{cs}(3985)$ are resonance states, with extracted pole masses of $(3879.6 	ext{ MeV}, 3976.9 	ext{ MeV})$ and widths of $(32.2 	ext{ MeV}, 28.8 	ext{ MeV})$, respectively.

Conclusion: The results indicate the necessity of additional components beyond the $Dar D^*$ states for the formation of these exotic resonances.
...
### [90] [Collective neutrino-antineutrino pair oscillations](https://arxiv.org/abs/2604.25687)
*Shih-Jie Huang,Meng-Ru Wu*

Main category: hep-ph

TL;DR: This study examines the conditions leading to collective neutrino-antineutrino pairing instabilities in dense neutrino gases, identifying criteria related to phase space distributions and instability growth rates.


<details>
  <summary>Details</summary>
Motivation: The investigation aims to understand the pairing phenomena between neutrinos and antineutrinos, potentially influencing astrophysical and cosmological dynamics.

Method: The authors use simplified toy models of discretized neutrino-antineutrino pairs in homogeneous gases to explore conditions for pairing instabilities.

Result: Instabilities emerge when the phase space distribution of excessive pair-occupation numbers changes signs, with growth rates comparable to collective fast neutrino flavor instabilities.

Conclusion: The findings underscore the importance of neutrino-antineutrino pairing effects, suggesting further research in realistic astrophysical contexts is warranted.
...
### [91] [Coherent deeply virtual Compton scattering on helium-4 beyond leading power](https://arxiv.org/abs/2604.25677)
*Víctor Martínez-Fernández,B. Pire,P. Sznajder,J. Wagner*

Main category: hep-ph

TL;DR: This study presents the first tomography of the helium-4 nucleus at the quark-gluon level via coherent hard exclusive reactions, highlighting the importance of higher-order corrections in the analysis.


<details>
  <summary>Details</summary>
Motivation: The research aims to understand the quark and gluon structure of light nuclei, specifically helium-4, through deeply virtual Compton scattering.

Method: The study incorporates kinematic twist-3 and twist-4 corrections and next-to-leading-order corrections to the twist-2 amplitude within the framework of strong coupling $α_s$.

Result: The incorporation of these higher-order corrections enables a precise fit to the experimental data, leading to the generation of the first detailed tomographic image of the helium-4 nucleus.

Conclusion: The findings demonstrate that advanced correction terms are key to accurately probing the internal structure of light nuclei.
...
### [92] [A Speculative Benchmark for the AMS-02 Electron and Positron Spectra from a Time-Symmetric Transport Hypothesis](https://arxiv.org/abs/2604.25542)
*Yi Yang*

Main category: hep-ph

TL;DR: The paper explores a time-symmetric interpretation of antiparticles, linking it to AMS-02 electron and positron data without altering local radiative loss laws.


<details>
  <summary>Details</summary>
Motivation: To investigate the connection between time-symmetric antiparticle interpretations and spectral features observed in cosmic electron and positron data.

Method: Utilizes the standard energy-loss model for Galactic leptons, layering a time-symmetric hypothesis on effective propagation, and conducts a parameter space scan to assess spectral morphology.

Result: Identifies benchmark regions in spectra based on the interplay of retarded and advanced propagation components, revealing insights into the turnover region in spectral data.

Conclusion: The model captures distinct energy scales without considering complex diffusion and solar modulation, indicating a need for theoretical backing for the advanced component's reduced effective radiative exposure.
...
### [93] [Jarvis-HEP: A lightweight Python framework for workflow composition and parameter scans in high-energy physics](https://arxiv.org/abs/2604.25557)
*Erdong Guo,Paul Jackson,Jin Min Yang,Pengxuan Zhu*

Main category: hep-ph

TL;DR: Jarvis-HEP is a new Python framework for efficiently conducting parameter scans and workflow composition in high-energy physics.


<details>
  <summary>Details</summary>
Motivation: There is a need for a unified computational tool that links various functionalities for high-energy physics studies, particularly in managing complex parameter spaces.

Method: Jarvis-HEP employs a YAML-based specification for workflows, offers dependency-aware execution, integrates modular calculators, and allows asynchronous task scheduling.

Result: The framework demonstrates capabilities through built-in sampling backends and user-friendly interfaces, effectively showcasing computational studies with synthetic and phenomenological examples.

Conclusion: Jarvis-HEP facilitates improved efficiency and usability in high-energy physics phenomenology, allowing researchers to easily manage and execute complex workflows.
...
### [94] [$CP$ violation in singly Cabibbo suppressed $D\to πa_0(980)$ decays](https://arxiv.org/abs/2604.25875)
*Yu-Kuo Hsiao,Shu-Ting Cai,Yan-Li Wang*

Main category: hep-ph

TL;DR: The study measures singly Cabibbo suppressed decays $D\to πa_0$, finding significant deviations from short-distance predictions, indicating long-distance rescattering effects and establishing a new probe for $CP$ violation.


<details>
  <summary>Details</summary>
Motivation: To explore the mechanisms behind singly Cabibbo suppressed decays of $D$ mesons and their implications for $CP$ violation.

Method: Branching-fraction ratios of the decays $D^0\to π^- a_0^+$ and $D^+\to π^0 a_0^+$ were measured, analyzing the contributions from long-distance rescattering effects and calculating direct $CP$ asymmetries.

Result: Measured branching-fraction ratios significantly deviate from theoretical predictions; $CP$ asymmetries were calculated, indicating a new pathway for detecting $CP$ violation.

Conclusion: SCS $D\to πa_0$ decays provide a valuable new approach to study $CP$ violation due to their observed discrepancies with theoretical expectations.
...
### [95] [Probing the hadronic molecular nature of the $Ω(2012)$, $Ω(2380)$, and $Ω_c(3120)$ via femtoscopy correlation functions](https://arxiv.org/abs/2604.25630)
*Si-Wei Liu,Wen-Tao Lyu,Ju-Jun Xie*

Main category: hep-ph

TL;DR: This study explores the femtoscopic correlation functions of $Ω$ resonances to understand their internal structures through effective potential models.


<details>
  <summary>Details</summary>
Motivation: To elucidate the internal structures of the $Ω(2012)$, $Ω(2380)$, and $Ω_c(3120)$ resonances by analyzing their correlation functions.

Method: Utilizing effective potential models with both $s$-wave and $d$-wave interactions to compute correlation functions in relevant coupled channels.

Result: Identification of significant enhancements in the $Ξ^0K^-$, $Ξ_c^0K^-$, $Ξ^{*0}K^-$, and $Ξ^{*0}K^{*-}$ correlation functions, indicating the dynamically generated nature of the resonances.

Conclusion: The findings offer crucial insights for future measurements at LHC and RHIC and provide a novel approach to understanding the hadronic molecular nature of these $Ω$ states.
...
### [96] [Explainable AI for Jet Tagging: A Comparative Study of GNNExplainer, GNNShap, and GradCAM for Jet Tagging in the Lund Jet Plane](https://arxiv.org/abs/2604.25885)
*Pahal D. Patel,Sanmay Ganguly*

Main category: hep-ph

TL;DR: The paper explores explainability methods for graph neural networks in jet tagging, revealing correlations between model predictions and known QCD features.


<details>
  <summary>Details</summary>
Motivation: To understand the opaque predictions of state-of-the-art graph neural networks applied to jet tagging at the Large Hadron Collider.

Method: Utilizes perturbation-based, Shapley-value-based, and gradient-based methods adapted for the Lund-plane graph representation, alongside Monte Carlo truth explanation masks.

Result: The analysis indicates a correlation between explainer-assigned node importance and classical observables, showing how explanation quality varies across momentum bins.

Conclusion: The study reveals that neural networks learn aspects of jet substructure, confirmed by correlations with known QCD features, and provides an open-source implementation for future research.
...
### [97] [Axion-like particle-meson production in semileptonic $τ$ decays](https://arxiv.org/abs/2604.25673)
*Yu-Xuan Bai,Jin Hao,Zhi-Hui Guo*

Main category: hep-ph

TL;DR: This study investigates semileptonic $τ$ decays into axion-like particle meson states using chiral effective field theory, focusing on hadronic form factors and their implications for future searches for axion-like particles.


<details>
  <summary>Details</summary>
Motivation: To explore the semileptonic decays of $τ$ leptons into axion-like particle final states, providing a framework for future experimental searches for these particles.

Method: Chiral effective field theory is employed to analyze the mixing matrix and calculate hadronic form factors for the $τ$ decays, utilizing parameters fitted from experimental data on specific decay channels.

Result: Predictions for branching ratios, invariant-mass distributions, and forward-backward asymmetries in the $τ^-	o P a ν_τ$ decays with $P=π^-$ and $K^-$ are presented.

Conclusion: The results lay a foundation for future experiments aimed at detecting axion-like particles in the context of semileptonic $τ$ decays.
...
### [98] [Imprint of domain wall annihilation on induced gravitational waves](https://arxiv.org/abs/2604.25726)
*Rishav Roshan*

Main category: hep-ph

TL;DR: The paper investigates how domain wall annihilation affects the gravitational wave spectrum, leading to observable peaks in multiple frequency bands.


<details>
  <summary>Details</summary>
Motivation: To understand the impact of domain wall annihilation on gravitational waves and early universe dynamics.

Method: Analyzed the energy transformation during domain wall annihilation and its effects on gravitational wave generation.

Result: Demonstrated that the decay of long-lived scalars post-annihilation enhances gravitational waves, producing a spectrum with two distinguishable peaks.

Conclusion: Multi-band detection of these gravitational wave peaks can provide insights into early universe symmetry breaking.
...
### [99] [Covariant Construction of Generalized Form Factors](https://arxiv.org/abs/2604.25771)
*Hao Sun,Tuo Tan,Jiang-Hao Yu*

Main category: hep-ph

TL;DR: This paper develops a systematic method for constructing Lorentz-covariant structures of hadronic matrix elements using spinor Young tableaux, presenting form factors for various particle spins and unveiling redundancies in existing literature.


<details>
  <summary>Details</summary>
Motivation: To construct comprehensive and systematic Lorentz-covariant structures for hadronic matrix elements of local operators in particle physics.

Method: Utilizes spinor Young tableaux to derive all possible matrix element structures for arbitrary operators, incorporating relativistic wave functions and momenta for particles of various spins.

Result: Introduces new form factor bases for scalar, vector, and rank-2 tensor operators, presenting novel results for spin-$rac{3}{2}$ and spin-$2$ particles and identifying redundant structures in existing literature.

Conclusion: The developed framework allows for the decomposition of nonlocal operators into local operator matrix elements via the newly constructed form factor bases, enhancing our understanding of hadronic interactions.
...
### [100] [Four-Loop Gluon Anomalous Dimension of General Lorentz Spin: Transcendental Part](https://arxiv.org/abs/2604.25833)
*B. A. Kniehl,S. -O. Moch,V. N. Velizhanin,A. Vogt*

Main category: hep-ph

TL;DR: The paper analyzes the four-loop anomalous dimension of a twist-two gluon operator in gauge theories, employing algorithms and techniques to derive contributions and reduce uncertainties in parton distribution functions.


<details>
  <summary>Details</summary>
Motivation: To study the four-loop anomalous dimension of the twist-two gluon operator in gauge theories and its implications for QCD.

Method: Utilized the Lenstra-Lenstra-Lovász algorithm for low-$N$ moments, generalized Gribov-Liptov reciprocity, and incorporated data from $	ext{N=}1,4$ supersymmetric Yang-Mills theories to derive contributions analytically.

Result: Obtained contributions to the anomalous dimension proportional to $ζ(3)$ and the rational part with a specific color factor, improving calculations of the four-loop splitting function $P_{gg}^{(3)}(x)$ through inverse Mellin transformation.

Conclusion: The findings enhance the precision of QCD predictions related to parton distribution functions by reducing theoretical uncertainties.
...
### [101] [Analysis of quarkonium polarization in proton-proton (p-p) collisions at LHC using PYTHIA model](https://arxiv.org/abs/2604.25838)
*Deekshit Kumar,Ekata Nandy,Biswarup Paul,Subikash Choudhury,Tinku Sinha,Partha Pratim Bhaduri*

Main category: hep-ph

TL;DR: This paper analyzes quarkonia polarization in proton-proton collisions at LHC using PYTHIA8, incorporating realistic detector conditions and comparing results with ALICE measurements.


<details>
  <summary>Details</summary>
Motivation: Understanding the production mechanism of quarkonia through polarization measurements can provide insights into the behavior of heavy quark pairs in collisions.

Method: The study employs the PYTHIA8 Monte Carlo event generator to calculate polarization of charmonia and bottomonia in p-p collisions, factoring in detector inefficiencies and muon momentum smearing.

Result: Transverse momentum differential distributions were computed, revealing changes in polarization parameters due to realistic experimental conditions, and these results were aligned with ALICE data.

Conclusion: The findings emphasize the importance of correcting for detector effects to accurately gauge quarkonia polarization in high-energy collisions.
...
### [102] [$\texttt{cuSkyrmion}$: A CUDA-OpenGL framework for interactive simulation and visualization of nuclei as Skyrmions](https://arxiv.org/abs/2604.25876)
*Sven Bjarke Gudnason,Paul Leask*

Main category: hep-ph

TL;DR: Introducing $	exttt{cuSkyrmion}$, a CUDA C software for 3D Skyrme model computation and visualization, enabling user-defined Skyrmion creation through configuration files or interactive input.


<details>
  <summary>Details</summary>
Motivation: To provide an efficient tool for computing and visualizing Skyrmions, utilizing advanced computational techniques for rapid results.

Method: The software is structured into three modules: computational, rendering, and the main program, facilitating interactive user input and random configuration generation.

Result: Users can create and visualize Skyrmions using either pre-defined or real-time inputs, with support for rational map ansatz.

Conclusion: The Python-fork enhances code reusability, making the visualization module accessible for other computations.
...
### [103] [Gauging Axionic Symmetries and Dark Matter: In memory of George Lazarides](https://arxiv.org/abs/2604.25888)
*Claudio Corianò*

Main category: hep-ph

TL;DR: The paper discusses the cosmology of a gauged axion, connecting it with gauge symmetries and dark matter, and highlights insights from George Lazarides.


<details>
  <summary>Details</summary>
Motivation: To honor George Lazarides and revisit the connection between axion models and gauge symmetries in cosmology.

Method: The study analyzes models with anomalous extra $U(1)$ symmetry, focusing on Stueckelberg pseudoscalars and their role in gauge invariance, Higgs-Stueckelberg mixing, and dark matter.

Result: The work reveals that the cosmological history of the gauged axion differs from typical Peccei-Quinn axions, with implications for dark-matter abundance depending on the Stueckelberg scale.

Conclusion: The insights into axion models and their gauge embedding provide a clearer understanding of their vacuum structure and cosmological implications.
...
### [104] [The effects of image augmentations when training machine learning models in astronomy](https://arxiv.org/abs/2604.24862)
*Leon H. Butterworth,Ashley Spindler*

Main category: astro-ph.IM

TL;DR: Image augmentations improve deep learning model performance for galaxy classification but have diminishing returns with larger datasets.


<details>
  <summary>Details</summary>
Motivation: To assess the effectiveness of image augmentations and dataset size in training deep neural networks for galaxy morphology classification.

Method: Multiple versions of a pre-existing Zoobot model were trained using varying image augmentations and dataset sizes from 230,000 galaxy images.

Result: Generally, augmentations improve performance, but effectiveness decreases as dataset size increases; augmentation choices have similar positive impacts.

Conclusion: Careful consideration of image augmentations is necessary to optimize training efficiency and resources.
...
### [105] [Seismic background mitigation with the Lunar Gravitational-wave Antenna](https://arxiv.org/abs/2604.24866)
*Han Yan,Jan Harms*

Main category: astro-ph.IM

TL;DR: The paper evaluates the mitigation of seismic noise in Lunar gravitational-wave detectors, emphasizing the optimal placement of two seismic stations to improve sensitivity.


<details>
  <summary>Details</summary>
Motivation: To address the fundamental sensitivity limitation posed by seismic background noise in lunar gravitational-wave detectors.

Method: Analytical expressions for the optimal squared signal-to-noise ratio were derived, involving two seismic stations in a random Gaussian seismic field, followed by a numerical analysis of noise mitigation.

Result: Optimal placement of two stations can reduce equivalent seismic noise amplitude spectrum density by approximately 2.3 times at 0.3 Hz compared to a single station, with observed oscillatory features in the noise correlation.

Conclusion: The study highlights the importance of station placement in effectively mitigating seismic noise for improved lunar gravitational-wave detection.
...
### [106] [Joint Multiband Photometry with crowdsource](https://arxiv.org/abs/2604.24875)
*Jayashree Behera,Edward F. Schlafly,Aaron M. Meisner,Lucas Napolitano*

Main category: astro-ph.IM

TL;DR: The paper introduces a multiband extension to a crowdsource photometric pipeline that enables simultaneous fitting across multiple imaging bands in crowded fields, improving flux consistency and astrometric stability.


<details>
  <summary>Details</summary>
Motivation: To enhance source detection and flux consistency in crowded fields by leveraging data from multiple imaging bands.

Method: A new mathematical framework for multiband fitting that aligns sources across different images while allowing variations in flux according to bandpass characteristics. The technique is tested with WISE W1 and W2 imaging.

Result: The multiband algorithm shows improved flux consistency and reduced positional scatter compared to independent-band fitting, with quantifiable gains in photometric agreement and astrometric stability on unWISE coadded tiles.

Conclusion: This framework sets a foundation for creating robust multiband crowded-field catalogs, benefiting future astronomical research.
...
### [107] [Enabling real-time multi-messenger follow-up of transient events with Astro-COLIBRI](https://arxiv.org/abs/2604.25529)
*Bernardo Cornejo Avila,Sofia Bisero,Mickäel Costa,Antoine Ciric,Ilja Jaroschewski,Weizmann Kiendrébéogo,Fabian Schüssler*

Main category: astro-ph.IM

TL;DR: Astro-COLIBRI is a platform for processing and contextualizing data on transient astrophysical events through a multi-messenger and multi-wavelength approach.


<details>
  <summary>Details</summary>
Motivation: To efficiently share and contextualize data on transient phenomena in time-domain astrophysics.

Method: Astro-COLIBRI integrates a RESTful API, real-time databases, and a cloud-based alert system to process alerts and provide context.

Result: It offers user-friendly interfaces for clear data visualization and concise summaries of key event properties.

Conclusion: Astro-COLIBRI effectively supports the study of transient astrophysical events by enhancing data sharing and contextualization.
...
### [108] [Impact of segmented deformable mirrors on high-contrast testbeds for exoplanet imaging with future large space telescopes: contrast stability assessment on the HiCAT bench](https://arxiv.org/abs/2604.25675)
...
TL;DR: This study examines the stability of segmented deformable mirrors in high-contrast imaging for exoplanet observation, revealing that even minor misalignments can significantly degrade image quality.


<details>
  <summary>Details</summary>
Motivation: To ensure the effectiveness of large segmented mirrors in future astronomical missions focusing on exoplanet detection and imaging.

Method: Utilized the High-contrast Imager for Complex Aperture Telescopes (HiCAT) with a 37-segment DM to analyze the effects of misalignments on imaging contrast, and simulated these conditions through a digital twin.

Result: Demonstrated that misalignments can cause a contrast degradation by a factor of 2.5, closely aligning with empirical observations on HiCAT.

Conclusion: The study emphasizes the critical need for effective segment cophasing and control strategies to maintain necessary contrast levels for observing exo-Earths with the Habitable Worlds Observatory.
...
### [109] [A Physics Informed Bayesian Neural Network for the Neutron Star Equation of State](https://arxiv.org/abs/2604.24949)
*J. D. Baker,C. A. Bertulani,R. V. Lobato*

Main category: astro-ph.HE

TL;DR: The paper introduces a Bayesian neural-network framework to derive neutron-star equations of state (EoS) and their uncertainties, validating its findings against observational data from NICER and gravitational waves.


<details>
  <summary>Details</summary>
Motivation: To accurately infer the equations of state for neutron stars and assess the associated uncertainties based on existing theoretical and observational constraints.

Method: A physics-informed Bayesian neural network trained on a comprehensive set of hadronic EoSs using stochastic variational inference and soft constraints for accuracy in predictions.

Result: The framework yielded consistent posterior predictions for neutron-star characteristics, including mass-radius and mass-tidal deformability relations, aligning with NICER measurements and maximum-mass constraints.

Conclusion: This model offers a robust, flexible approach to connect microphysical uncertainties in EoS with observable properties of neutron stars, enhancing our understanding of their nature.
...
### [110] [Pair-Rich Corona of an Accreting Kerr Black Hole](https://arxiv.org/abs/2604.24961)
*Jonathan Zhang,Christopher Thompson*

Main category: astro-ph.HE

TL;DR: The paper presents a self-consistent model of a warm scattering corona near a Kerr black hole, utilizing Monte Carlo simulations to evaluate Compton scattering and pair creation effects, ultimately analyzing X-ray luminosity and polarization in relation to observer orientation.


<details>
  <summary>Details</summary>
Motivation: To understand the behavior of matter and radiation in the vicinity of accreting black holes, specifically focusing on the effects of Compton scattering and electron-positron pair creation in a warm scattering corona.

Method: An iterative Monte Carlo procedure is developed, simulating photon interactions involving Compton scattering and pair formation, while also considering general relativistic effects, to create a self-consistent model of a warm scattering corona.

Result: The derived spectrum and polarization of escaping X-rays show consistency with binary black hole data in the hardest spectral state, with polarization degrees rising to 4-10% across the 2-8 keV range due to electron-positron dynamics.

Conclusion: The study highlights the significant impact of pair creation and Compton scattering on the X-ray emission characteristics near black holes, providing insights into the observed polarization and temperature which correlate with existing astrophysical observations.
...
### [111] [Moving-Mesh Simulations of Mini-Common Envelope Ejection in Classical Novae](https://arxiv.org/abs/2604.24963)
*Nicholas Nelson,Philip Chang*

Main category: astro-ph.HE

TL;DR: The paper investigates the mass ejection mechanisms in cataclysmic variables via hydrodynamic simulation, revealing that binary interaction significantly influences ejection dynamics and long-term evolution.


<details>
  <summary>Details</summary>
Motivation: To enhance understanding of the role of binary interactions in mass ejection processes of cataclysmic variables which are not fully understood.

Method: Three-dimensional moving-mesh hydrodynamic simulations of a cataclysmic variable system are conducted to analyze mass ejection due to binary interactions.

Result: Ejected material is found to be distributed isotropically after crossing the ${m L}_1$ Lagrange point; the ${m L}_2$ point has negligible effect, and ejected material displays increased specific angular momentum compared to its initial state.

Conclusion: The findings suggest that binary interactions are critical in shaping mass ejection dynamics, which may influence the long-term evolution of cataclysmic variable systems.
...
### [112] [Core Collapse Supernova Modeling: The Next Ten Years](https://arxiv.org/abs/2604.24970)
*Anthony Mezzacappa*

Main category: astro-ph.HE

TL;DR: This paper discusses advancements in core collapse supernova modeling, highlighting the need for improved predictive capabilities and collaboration across related fields.


<details>
  <summary>Details</summary>
Motivation: To address the complexities of core collapse supernovae through refined modeling techniques and interdisciplinary collaboration for accurate predictions.

Method: The paper reviews recent developments in three-dimensional models, emphasizing the treatment of neutrino kinetics, fluid dynamics, and other fundamental aspects of supernova physics.

Result: Models have shown the significance of various components, such as neutrinos and magnetic fields, affecting simulation outcomes, and the neutrino shock reheating mechanism has been validated.

Conclusion: There is a pressing need for more sophisticated models and interdisciplinary cooperation to enhance predictive capabilities for core collapse supernovae and their associated emissions.
...
### [113] [Non-Monotonic Rotation Imprint on Time-Integrated Neutrino Spectral Moments in a 15\,$M_\odot$ Core-Collapse Supernova Sequence](https://arxiv.org/abs/2604.25084)
*Nicolas Viaux*

Main category: astro-ph.HE

TL;DR: The study analyzes neutrino signals from a $15 M_\odot$ CCSN model, revealing that slowly and fast-rotating stars affect neutrino spectra in opposite ways compared to non-rotating stars, suggesting a non-monotonic response to rotation.


<details>
  <summary>Details</summary>
Motivation: To understand the influence of rotation on the early neutrino signals in core-collapse supernovae, specifically through analyzing existing simulation data rather than generating new models.

Method: Analysis of three existing 3D CCSN models (non-rotating, slowly rotating, fast rotating) to measure shifts in neutrino spectral moments during the accretion phase.

Result: Fast rotation intensifies the softening of neutrino spectra, while slow rotation leads to weaker hardening, with distinct shifts observed in the spectral parameters for electron neutrinos and antineutrinos.

Conclusion: These findings indicate possible non-linear rotational effects on neutrino emission, but the study is limited to one progenitor sequence, leaving further exploration of its generality open.
...
### [114] [The GMRT High-Resolution Southern Sky Survey for pulsars and transients -- VIII: Orbital Variability and the Evolution of a 1-Day He-WD Millisecond Pulsar J2101-4208](https://arxiv.org/abs/2604.25278)
...
TL;DR: This study analyzes the millisecond pulsar J2101$-$4802, revealing its binary nature and unique orbital characteristics.


<details>
  <summary>Details</summary>
Motivation: To investigate the properties and dynamics of MSP J2101$-$4802 and its potential evolutionary connections within stellar binaries.

Method: Timing and orbital phase-resolved polarimetry over 3.7 years, along with fitting a rotating-vector model for emission geometry.

Result: Identified a ~1-day binary orbit with a likely He-WD companion, an unusually large orbital period derivative, and detailed polarization variations across the orbital phase.

Conclusion: PSR J2101$-$4802 may bridge the gap between redback-like spiders and detached He–WD MSP binaries, highlighting its unique evolutionary stage.
...
### [115] [Rotation Measure Substructures Induced by the Ponderomotive Force of Inertial \alfven Waves](https://arxiv.org/abs/2604.25469)
*Qing Zhao,Di Xiao,Xue-Feng Wu*

Main category: astro-ph.HE

TL;DR: The study links rapid fluctuations in rotation measure (RM) of repeating fast radio bursts (FRBs) to inertial Alfvén waves (IAWs) impacting plasma density, offering a new model for understanding RM variability in these sources.


<details>
  <summary>Details</summary>
Motivation: To understand the short-term RM variations observed in repeating FRBs, particularly those that cannot be attributed to intergalactic medium fluctuations.

Method: The authors propose a model where inertial Alfvén waves, generated in low-$β$ plasma environments, exert a ponderomotive force leading to nonlinear density perturbations and plasma density redistribution.

Result: The model explains the RM suppression and substructure phenomena observed in repeating FRBs, attributing them to wave-driven density cavitation and highlighting dependencies on various plasma parameters.

Conclusion: This research provides a new framework for interpreting short-term RM variability in FRBs, emphasizing the role of localized plasma dynamics and wave interactions.
...
### [116] [Intergalactic Magnetic Field constraints from detected very high-energy Gamma-Ray Bursts using the Cherenkov Telescope Array Observatory](https://arxiv.org/abs/2604.25647)
*Ténéman Keita,Renaud Belmont,Thierry Stolarczyk*

Main category: astro-ph.HE

TL;DR: This paper explores the detection of the Intergalactic Magnetic Field (IGMF) using observational data from the Cherenkov Telescope Array Observatory (CTAO).


<details>
  <summary>Details</summary>
Motivation: The IGMF, linked to the Big Bang, remains undetected despite its significance; leveraging VHE photons from GRBs may provide insights into its strength.

Method: The authors simulate CTAO observation data under realistic conditions and perform spectral-temporal fits for GRBs similar to those detected at VHE.

Result: CTAO is expected to probe IGMF strengths up to $	ext{10}^{-15}$ G, and current observations suggest a strength of $3	imes 10^{-17}$ G for GRB 221009A.

Conclusion: CTAO has the potential to significantly enhance our understanding of the IGMF, pushing constraints further than previous studies.
