...
TL;DR: The paper examines the X-ray properties of early obscured AGNs post-Big Bang, using Monte Carlo simulations influenced by low metallicity, and suggests enhanced detection prospects for these AGNs in future X-ray surveys.


<details>
  <summary>Details</summary>
Motivation: To investigate the early growth of obscured AGNs during the first 500 Myr after the Big Bang, especially in light of shifts in metallicity.

Method: Monte Carlo simulations were employed to model X-ray radiative transfer through a cold gas torus surrounding an AGN, assessing the effects of metallicity, torus opening angle, and column density on the emitted spectrum.

Result: Lower metallicity was found to increase the fraction of escaping X-ray photons, enhancing the observability of high-redshift AGNs, while the torus geometry influenced photon escape dynamics.

Conclusion: The findings indicate improved detection prospects for highly obscured $z=10$ AGNs in upcoming X-ray surveys, highlighting the need for considering non-solar abundance ratios.
...
TL;DR: This paper reviews the detection prospects of gravitational waves (GWs) emitted by gas-embedded massive black hole binaries, emphasizing the role of the Square Kilometre Array Observatory (SKAO) and LISA in coincident GW-electromagnetic (EM) signal detection.


<details>
  <summary>Details</summary>
Motivation: To explore the concurrent detection of gravitational and electromagnetic signals from massive black hole binaries and assess the capabilities of SKAO and LISA.

Method: Numerical simulations and mock catalogs were used to predict detectable coincident GW-EM signals, analyzing different electromagnetic models for radio emissions from black hole binaries.

Result: The detection of coincident GW-EM signals is largely insensitive to the specific electromagnetic models used, and the combination of SKAO and LISA enables the possibility of detecting low-frequency multi-band GWs from the same astrophysical events.

Conclusion: Correlating multi-band gravitational waves will offer unprecedented insights into the environments of the most massive black holes, providing valuable data for understanding their dynamics.
...
TL;DR: This study investigates the formation of ultracompact binaries in globular clusters, focusing on black hole and white dwarf systems, and their potential as multimessenger sources for X-ray and gravitational wave observations.


<details>
  <summary>Details</summary>
Motivation: To understand the formation mechanisms of ultracompact binary systems in globular clusters and their implications for multimessenger astronomy.

Method: Simulations using Cluster Monte Carlo dynamics and smoothed particle hydrodynamics (StarSmasher) to model binary formation through common envelope events and creation of a mock catalog of X-ray sources.

Result: The primary formation mechanism is identified as black hole+giant collisions, leading to ultracompact binaries that can be detected in X-ray and gravitational wave observations; potential resolvability of sources by LISA in the Milky Way is highlighted.

Conclusion: Ultracompact binaries in globular clusters represent a promising area for multimessenger research, with the potential to observe new black holes through both X-ray and gravitational wave signals.
...
TL;DR: The paper analyzes Fast Radio Burst (FRB) emission mechanisms, providing model-independent constraints on density, size, and particle energy, and evaluates three main FRB models with respect to their constraints and implications.


<details>
  <summary>Details</summary>
Motivation: To establish constraints on FRB emission mechanisms and determine their implications for existing FRB models.

Method: Derivation of model-independent constraints to analyze density, size, and particle Lorentz factor of emitting regions across different FRB models.

Result: The analysis indicates that inner-magnetospheric models and forced-reconnection scenarios face significant limitations, while external-shock maser models are constrained by optically thick conditions. Continuous particle acceleration is essential for viability.

Conclusion: Magnetospheric models with continuous particle acceleration at the neutron-star surface emerge as the most viable FRB emission scenario, pending successful wave escape from the magnetosphere.
...
TL;DR: This study highlights GRS 1915+105 as a significant particle accelerator, revealing extended $γ$-ray emission shifted from the binary system, and supporting the notion of effective cosmic ray acceleration to multi-PeV energies.


<details>
  <summary>Details</summary>
Motivation: To explore the particle acceleration capabilities of microquasars, particularly GRS 1915+105, through analysis of its broadband $γ$-ray emission.

Method: Utilized data from LHAASO and Fermi-LAT over several years, performing a joint analysis to examine $γ$-ray emission characteristics, spectral energy distribution, and shifts in emission centroid.

Result: Identified extended $γ$-ray emission shifted ~0.13° from the binary system and a log-parabola spectral distribution, indicative of protons accelerated beyond 5 PeV with a significant proportion of jet power contributing to these energies.

Conclusion: Microquasars like GRS 1915+105 are confirmed as highly efficient particle accelerators within the Galaxy, with implications for cosmic ray physics.
...
TL;DR: This study models the interaction between a pulsar wind and an accretion disk, focusing on transitional millisecond pulsars and the newly identified 'sub-luminous disk state', providing insights into their observational features through simulations.


<details>
  <summary>Details</summary>
Motivation: To explore the unmodeled interactions between pulsar winds and accretion disks, particularly during the sub-luminous disk state observed in transitional millisecond pulsars.

Method: Three-dimensional particle-in-cell simulations of a pulsar magnetosphere interacting with a conducting accretion disk torus are utilized to analyze magnetospheric reconfiguration and radiation effects.

Result: The simulations revealed that the disk significantly alters the pulsar's magnetosphere, increasing plasma density and magnetic field strength, leading to enhanced synchrotron radiation and distinct light curve patterns.

Conclusion: The model aligns well with observed optical and X-ray emissions from PSR J1023+0038, supporting the hypothesis that pulsar wind-disk interaction generates these emissions.
...
TL;DR: This paper discusses advancements in Space Very Long Baseline Interferometry (SVLBI) using SKA-Mid to explore extreme brightness temperatures in blazars and study AGN jets, enhancing our understanding of the universe.


<details>
  <summary>Details</summary>
Motivation: To leverage advanced SVLBI missions for in-depth investigations into unresolved astrophysical phenomena, such as extreme brightness temperatures in blazars and the dynamics of AGN jets.

Method: Utilizing the sensitivity and frequency coverage of the phased SKA-Mid in combination with existing SVLBI techniques for high-resolution observations and astrometry.

Result: Expected results include improved understanding of particle (re-)acceleration mechanisms, evolution of AGN, and high-precision astrometry leading to the detection of exoplanets and properties of supermassive black holes.

Conclusion: The integration of SKA-Mid with SVLBI techniques will significantly enhance astronomical observations, facilitating breakthroughs in the understanding of cosmic phenomena.
...
TL;DR: The paper presents a mechanism for late-time magnetogenesis involving a coupled axion-dilaton system that generates a chiral dark magnetic field without needing fine-tuning.


<details>
  <summary>Details</summary>
Motivation: To develop a mechanism for magnetogenesis that avoids plasma conductivity suppression in the visible sector.

Method: Utilizing a coupled axion-dilaton system, where dilaton coupling enhances tachyonic amplification and the axion controls helicity, the authors numerically evolve the system's parameters from redshift 10^5 to matter-radiation equality to study field generation.

Result: The model successfully produces a moderately chiral dark magnetic field, with significant amplification of gauge helicities. A resulting magnetic field strength of approximately 0.9 nG is found at 1 Mpc scale with effective kinetic mixing transferring the field to the visible sector.

Conclusion: The magnetogenesis mechanism is robust across varying scalar masses and couplings, demonstrating potential relevance for observable cosmic magnetic fields.
...
TL;DR: This paper establishes a correlation between neutron star radii across different masses using a common causal equation of state (EoS), showing that causality imposes an upper limit on radius differences and clarifying the implications for neutron star observations.


<details>
  <summary>Details</summary>
Motivation: To reduce uncertainties in neutron star radius measurements derived from independent observations by correlating them through a common causal equation of state.

Method: The study applies chiral effective field theory (χEFT) near saturation density to derive a closed-form upper bound on the radius difference of neutron stars, constructing a family of EoSs that adheres to this criterion.

Result: The new causal bound narrows the joint product distribution of the NICER posteriors of several pulsars, notably eliminating the large-radius tail from PSR J0740+6620, while retaining only 7.5% of the posteriors.

Conclusion: This approach distinguishes the effects of generic physical assumptions from specific EoS priors, offering a clearer framework for interpreting neutron star observational data.
...
TL;DR: The chapter discusses the scientific potential of the SKA in supernova research, highlighting advancements in radio astronomy, particularly in detecting various supernova types.


<details>
  <summary>Details</summary>
Motivation: To showcase how recent advancements in radio astronomy and instrumentation can enhance the understanding of supernovae and their environments.

Method: Utilizing SKA1 and its pathfinders for wide-field surveys and targeted observations to analyze core-collapse and thermonuclear supernovae.

Result: SKA is expected to discover hundreds of core-collapse supernovae annually and provide insights into ejecta interactions, supernova progenitors, and population statistics through collaborations with other astronomical facilities.

Conclusion: The SKA will significantly advance the field of radio supernova astrophysics, transforming it from discovery-limited to a quantitatively-rich area of study.
...
TL;DR: The study analyzes the line-of-sight acceleration of compact binaries observed by LIGO and Virgo, finding that it is generally consistent with zero, while introducing a new method for modeling Doppler shifts in gravitational waves.


<details>
  <summary>Details</summary>
Motivation: Understanding line-of-sight (LOS) acceleration can provide insights into the environments of compact binaries, indicating their presence in dense settings like AGN disks or star clusters.

Method: A novel method is developed to model LOS acceleration via time-domain application of time-varying Doppler shifts in the gravitational wave signal, allowing for treatment of complex waveform models.

Result: All known compact binaries analyzed show LOS acceleration consistent with zero, indicating no significant effects from surrounding dense environments, but derivatives of eccentricity and acceleration are observed to be partially degenerate.

Conclusion: Current sensitivity limits of ground-based observatories restrict the ability to detect LOS accelerations; however, next-generation observatories could provide clearer constraints on accelerations in dense environments.
...
TL;DR: This paper presents a neural posterior estimation framework for constraining parameters in neutron-star equations of state, demonstrating rapid and accurate inference through simulation.


<details>
  <summary>Details</summary>
Motivation: To improve the precision in constraining microscopic relativistic mean-field parameters relevant to neutron stars.

Method: Neural posterior estimation is applied to DDB and RMF-NL models using key nuclear properties and constraints; posteriors are validated against a conventional nested sampler and a diagnostics test.

Result: The neural posterior accurately reproduces nested-sampling constraints without significant bias, generating a large number of samples quickly on a CPU.

Conclusion: The framework proves that validated NPE-emulated RMF models can be used for rapid exploratory inference in astrophysics, while fixing specific parameters leads to consistent maximum-mass predictions.
...
TL;DR: Accreting binary systems are crucial for studying accretion and jet processes in compact objects, with the SKA enhancing our understanding across various classes.


<details>
  <summary>Details</summary>
Motivation: The study of accreting binary systems is vital for understanding the dynamics of accretion and ejection processes across different classes of compact objects.

Method: Comparative analysis of jets in different compact objects to assess the influences of mass, spin, magnetic fields, and stellar surfaces, supported by advanced observations from the SKA.

Result: Enhanced capabilities of the SKA will allow the detection of fainter systems and help expand knowledge of black hole populations and feedback mechanisms in the interstellar medium.

Conclusion: The SKA will significantly advance our understanding of accreting neutron stars and white dwarfs, revealing essential aspects of black hole growth and evolution.
...
### [14] [Hybrid radio and particle detection of air showers: potential for ultra-high-energy photon identification](https://arxiv.org/abs/2606.25833)
*Paul Minodier,Kaoru Takahashi,Kumiko Kotera,Takashi Sako*

Main category: astro-ph.HE

TL;DR: This study explores the potential of hybrid radio and scintillator detectors for differentiating between extensive air showers from ultra-high-energy photons and cosmic rays, demonstrating the effectiveness of this method using a proposed setup.


<details>
  <summary>Details</summary>
Motivation: The motivation behind this work is to investigate the capabilities of hybrid radio detectors, supported by scintillators, in detecting ultra-high-energy (UHE) photons, especially for air showers with inclined zenith angles.

Method: The study utilizes two key observables: the total root mean square of the radio signal and the energy deposit recorded in scintillators, to distinguish between cosmic-ray and photon-induced air showers.

Result: The analysis indicates that effective separation between the two types of showers can be achieved using a hybrid setup of radio antennas and scintillators, exemplified by a case study on a proposed hybrid array configuration.

Conclusion: The findings suggest that such a hybrid array could provide competitive upper limits on the integral photon flux in the energy range of 0.3 to 3 EeV.
...
### [15] [Compact Objects Revealed by SKA and SKA-VLBI](https://arxiv.org/abs/2606.25543)
*Z. H. Lin,Y. J. Li,C. J. Hao,J. J. Li,Y. W. Dong,D. J. Liu,Y. Xu*

Main category: astro-ph.HE

TL;DR: The SKA will facilitate groundbreaking research on compact objects through precise measurements and methods for black hole-neutron star binaries and intermediate-mass black holes.


<details>
  <summary>Details</summary>
Motivation: To explore the connection between astronomy and fundamental physics by studying compact objects.

Method: Utilizing the SKA/SKA-VLBI for high-sensitivity and high-precision measurements of orbital dynamics.

Result: Identification of black hole-neutron star binaries and measurement of orbital parameters and intermediate-mass black holes.

Conclusion: The SKA is poised to significantly enhance our understanding of ultra-dense nuclear matter, stellar structures, and the evolution of black holes.
...
### [16] [Probing Physical Conditions in Classical and Symbiotic Novae with the Square Kilometre Array Observatory](https://arxiv.org/abs/2606.25609)
...
TL;DR: The study of cataclysmic variables and symbiotic stars focuses on classical novae and their thermonuclear explosions, utilizing advanced radio and multiwavelength observations for insights into astrophysical processes, with the SKAO enhancing monitoring and characterisation of these systems.


<details>
  <summary>Details</summary>
Motivation: To investigate the astrophysical processes related to classical novae, including binary evolution and mass ejection, through detailed observational studies.

Method: Employ multi-frequency, multi-epoch, and multi-scale interferometric observations, leveraging the SKAO, particularly SKA-Mid, for monitoring Galactic novae and characterising emissions.

Result: Recent progress has enhanced understanding of classical and symbiotic novae through coordinated observations, revealing dynamics of thermonuclear explosions and their aftermaths.

Conclusion: The SKAO will significantly improve ongoing monitoring and characterization of various binary systems, providing comprehensive data on their physical conditions.
...
### [17] [Observation of A Solar Like Magnetic Reconnection Event in an AGN Corona with XRISM](https://arxiv.org/abs/2606.25636)
...
TL;DR: This study provides the first observational evidence of magnetic reconnection in the corona of an active galactic nucleus (AGN) through a flare observed in NGC 3783.


<details>
  <summary>Details</summary>
Motivation: To investigate the heating mechanism of AGN coronae, which is suggested to be magnetic reconnection akin to that observed in stellar coronae, despite lack of direct evidence.

Method: The study involved observational data from XRISM/Xtend and XMM-Newton/EPIC-PN, focusing on a flare in NGC 3783 with analysis of soft and hard X-rays, and detection of an Ultra-Fast Outflow (UFO).

Result: The flare exhibited distinct differences in X-ray temporal evolution and demonstrated the Neupert effect, indicating magnetic reconnection involvement, with the UFO comparable to a solar Coronal Mass Ejection (CME).

Conclusion: The study establishes that the observed magnetic reconnection flare in AGN coronae supports the hypothesis of magnetic reconnection as the heating mechanism, with quantifiable magnetic field strengths derived.
...
### [18] [A magnetically-supported disk-corona model for Changing-Look AGN transitions](https://arxiv.org/abs/2606.25654)
*Marios Kouzis,Agata Różańska,Debora Lančová,Bożena Czerny,Dominik Gronkiewicz*

Main category: astro-ph.HE

TL;DR: This study presents a model that explains the rapid transitions in Changing-Look Active Galactic Nuclei (CLAGN) using magnetically supported disk-corona mechanisms, validating its predictions against observational data.


<details>
  <summary>Details</summary>
Motivation: To understand the phenomenon of rapid spectral and luminosity transitions in CLAGN, impacting our knowledge of supermassive black holes.

Method: A magnetically supported disk-corona model is used alongside the 	exttt{diskvert} code to analyze the vertical structure of the disk under gas, radiation, and magnetic pressure support, and to compute S-curves and timescales.

Result: The model shows that magnetized disks lower the S-curve knee Eddington ratio to about 0.01-0.03 and creates a stable, high luminosity branch, fitting observations for black hole masses between $10^{7}$ and $10^{9}\,	ext{M}_	ext{o}$ and transition durations in the months-to-years range.

Conclusion: For the examined CLAGN sample, strong magnetization in the inner disk is essential to reproduce observed Eddington rates and transition durations, particularly for Mkn 590.
...
### [19] [Multi-Band Optical Variability of Blazar 1ES 2344+514 on Diverse Time-Scales](https://arxiv.org/abs/2606.25741)
*Aykut Özdönmez*

Main category: astro-ph.HE

TL;DR: The study analyzes the flux variability of the blazar 1ES 2344+514 using multi-band observations and ZTF data, highlighting its complex variability patterns over short and long timescales.


<details>
  <summary>Details</summary>
Motivation: To investigate the flux variability of the blazar 1ES 2344+514 across different optical bands and time scales.

Method: Utilization of multi-band observations from 2022-2024 and ZTF data from 2018-2023, along with statistical tests (F-test, ANOVA) and periodicity analysis (WWZ, LS methods).

Result: The blazar exhibits mild short-term and long-term variability with no minute-scale variability, a moderate RWB trend on intra-day scales, and significant QPO signals at 1.02, 1.3, and 2.85 years.

Conclusion: The results indicate the complexity of 1ES 2344+514's variability, suggesting a need for further observations to understand its mechanisms.
...
### [20] [Study for curvature radiation and magnetic pair creation process on polar-cap region of magnetic white dwarf](https://arxiv.org/abs/2606.25806)
*Bingyan Wang,Jumpei Takata*

Main category: astro-ph.HE

TL;DR: This study investigates radiation processes and pair creation in rapidly rotating, magnetized white dwarfs (WDs), focusing on the effects of magnetic field geometry using numerical and analytical methods.


<details>
  <summary>Details</summary>
Motivation: The paper explores the potential of rapidly rotating, strongly magnetized WDs to exhibit activities similar to neutron star pulsars, particularly in particle acceleration and radiation.

Method: Using a space-charge-limited flow model, the study assesses the effects of spin period and surface magnetic field on particle acceleration and radiation, including both dipole and quadrupole field configurations in one-dimensional numerical and analytical calculations.

Result: The inclusion of a quadrupole magnetic field significantly enhances the accelerating field, allowing for more efficient radiation and pair creation processes, revealing a WD death line under certain magnetic conditions.

Conclusion: Pair creation is possible for spin periods less than 100 seconds and dipole field strengths under 10^10 G, suggesting that sustaining pair creation is challenging in observed magnetic WDs, with implications for understanding rotation-powered activities and long-period radio transients.
...
TL;DR: The paper investigates the variability of the blazar 3C 279 through multiwavelength observations and modeling, revealing critical insights into jet dynamics and emission mechanisms.


<details>
  <summary>Details</summary>
Motivation: To understand the physical processes governing the blazar 3C 279 and its electromagnetic variability.

Method: A coordinated multiwavelength campaign was conducted alongside EHT observations, involving light curve analysis and the turbulent extreme multi-zone (TEMZ) model for phenomenological modeling.

Result: The observations showed significant flux variations, including a clear increase in the innermost core and variations in polarization, with gamma-ray activity preceding the EHT observations' end.

Conclusion: The results support a jet scenario with compressed turbulent plasma, while acknowledging alternative models, enhancing understanding of jet and gamma-ray emission in 3C 279.
...
TL;DR: The study investigates the supernova SN 2019vxm through two years of multi-wavelength observations, revealing key characteristics such as slow rise and decline, high luminosity, significant circumstellar material, and evidence of dust formation.


<details>
  <summary>Details</summary>
Motivation: To understand the evolution and properties of the long-lived interacting supernova SN 2019vxm, focusing on its photometric and spectroscopic behavior over an extended observational period.

Method: Multi-wavelength photometric and optical spectroscopic observations are analyzed, including light-curve modeling and comparisons with theoretical models to estimate the parameters of the supernova.

Result: The analysis reveals an R-band peak absolute magnitude of ~-20.3, a total radiated luminosity of 5x10^50 erg, and circumstellar material mass estimates of 3-8 M_sun, alongside signs of dust formation in the late phase.

Conclusion: SN 2019vxm presents as an energetic supernova with unique interaction-dominated phases and signs of dust influence, indicating complex underlying ejecta conditions.
...
TL;DR: The paper discusses the detection of PeVatrons, high-energy cosmic ray sources in the Galaxy, proposing that SKA-Low can effectively measure air showers at lower energies than previously possible.


<details>
  <summary>Details</summary>
Motivation: Identifying PeVatrons is crucial for understanding cosmic ray origins and the extreme energy processes in our Galaxy.

Method: Utilizing SKA-Low's extensive antenna array to detect radio emissions from air showers, aiming to lower the energy threshold for detection while measuring PeV fluxes.

Result: SKA-Low could enable the detection of PeV air showers, potentially leading to new insights into cosmic ray accelerators.

Conclusion: This approach represents a novel method for $γ$-ray astronomy, enhancing our knowledge about high-energy astrophysical phenomena.
...
### [24] [Collaborating with Artists in the Search for Life](https://arxiv.org/abs/2606.24943)
*Jack Madden,Cybele Collins,Mia Rollins,Ashika Capirala*

Main category: astro-ph.IM

TL;DR: The paper discusses the benefits of integrating art with science in astrobiology, emphasizing novel approaches and interdisciplinary collaboration to enhance understanding and exploration of life beyond Earth.


<details>
  <summary>Details</summary>
Motivation: To highlight how art-science collaborations can offer new perspectives on astrobiology that traditional scientific methods may overlook.

Method: The authors present historical examples, including Robert Irwin’s and Carl Sagan’s contributions, along with the Transition Design framework, to illustrate the potential of artscience integration.

Result: Art-science collaborations can break conventional thought patterns, address ethical considerations, and enhance efficiency in complex problem-solving within astrobiology.

Conclusion: Recommendations include funding artist consultations in research grants, reviving NASA's artist-in-residence program, and supporting artscience training initiatives to foster deeper collaboration in the astrobiology field.
...
### [25] [Empirical-Bayes Unfolding of $γ$-ray Spectra](https://arxiv.org/abs/2606.24971)
*A. H. Mjøs,E. Lima,A. Kvellestad,A. C. Larsen,M. Hjorth-Jensen*

Main category: astro-ph.IM

TL;DR: The paper proposes a robust empirical-Bayes hierarchical unfolding method for $γ$-ray spectra, addressing Poisson inverse problems while quantifying uncertainty and maintaining non-negativity.


<details>
  <summary>Details</summary>
Motivation: To overcome the challenges of direct inversion in Poisson inverse problems that amplify statistical noise and obscure distinct $γ$-ray spectra due to detector response and energy resolution.

Method: An empirical-Bayes hierarchical method that preserves Poisson counting structure, uses a joint ON/OFF likelihood for background inclusion, and employs the No-U-Turn Sampler for posterior inference with uncertainty quantification.

Result: The method yields highly consistent unfolded spectra compared to a frequentist approach, even in varying statistical conditions, providing robust uncertainty bands for resolution-limited data.

Conclusion: The Bayesian framework enhances the reliability of $γ$-ray spectrum unfolding and effectively quantifies uncertainties, making it a valuable tool in experimental analysis.
...
### [26] [Synergies Between Pulsar Timing Array and Astrometry](https://arxiv.org/abs/2606.24992)
*Gabriele Perna,Nicola Bellomo,Daniele Bertacca*

Main category: astro-ph.IM

TL;DR: The chapter discusses the detection of gravitational wave backgrounds through pulsar timing arrays and astrometric observations, highlighting enhanced sensitivity when combining these methods, with improvements in forecast sensitivity of 10% to 50%.


<details>
  <summary>Details</summary>
Motivation: To explore alternative methods of establishing a gravitational wave background, emphasizing the synergy between pulsar timing arrays and astrometric observations.

Method: The chapter analyzes the capabilities of the SKA Observatory and future astrometric probes in detecting gravitational wave backgrounds, particularly focusing on joint-analysis techniques.

Result: An increase in sensitivity from 10% to 50% for joint PTA and astrometry analyses is demonstrated, providing a compelling case for their combined use.

Conclusion: The integration of SKAO measurements with astrometric data significantly enhances the sensitivity of gravitational wave background detection.
...
### [27] [Low-frequency VLBI with the SKA-Low](https://arxiv.org/abs/2606.25017)
*R. Timmerman,E. L. Escott,T. Vernstrom,L. K. Morabito,C. Reynolds*

Main category: astro-ph.IM

TL;DR: The SKAO will enhance radio astronomy with SKA-Low for low-frequency observations, but LAMBDA aims to improve angular resolution through an extended baseline setup in Australia, enabling diverse scientific applications.


<details>
  <summary>Details</summary>
Motivation: Many science cases demand higher angular resolutions than SKA-Low's design, necessitating enhancements to the observational capabilities.

Method: The LAMBDA project constructs multiple SKA-Low-like stations across Australia to extend the baselines to megameters, enhancing angular resolution and serving as a performance testbed.

Result: LAMBDA will enable the SKA-Low to unlock scientific opportunities requiring finer angular resolutions and facilitate calibration strategies as part of a VLBI network.

Conclusion: With LAMBDA, SKA-Low is positioned to significantly contribute to various scientific fields, including exoplanets, AGN, and fast radio bursts.
...
### [28] [Analysis of Laser-Satellite Deconfliction for Astronomical Observatories](https://arxiv.org/abs/2606.25238)
*Christoph Baranec,Reed Riddle,Yuhei Takagi,Jim Lyke*

Main category: astro-ph.IM

TL;DR: The study analyzes laser-satellite deconfliction in astronomy, focusing on new visualization tools, the impact of exposure durations, and the efficiency of laser keep-out-cones, while assessing the effects of satellite mega-constellations.


<details>
  <summary>Details</summary>
Motivation: To enhance operational efficiency and safety in laser-based astronomical observations amid increasing satellite interference.

Method: Utilizing visualization tools to evaluate observing conditions, analyzing exposure durations, and comparing open-time across different observation targets and keep-out-cone angles.

Result: Findings indicate varying open-time availability based on target type and exposure duration, with significant impacts from satellite mega-constellations noted.

Conclusion: Optimizing laser keep-out-cone angles and understanding satellite trends is crucial for maintaining effective ground-based laser astronomy.
...
### [29] [M-EPDet: Real-Time Real-Bogus Classification and Transient Candidate Judgement for the EP-WXT Pipeline via Multi-Modal Data](https://arxiv.org/abs/2606.25352)
*Lang Chen,Yunfei Xu,Zhen Zhang,Dongyue Li,Hui Sun,Yuan Liu,Chenzhou Cui,Jinhui Xie,XiaoXiong Zuo,Shirui Wei,Wujun Shao*

Main category: astro-ph.IM

TL;DR: The paper introduces M-EPDet, a framework for vetting candidate astrophysical sources from Wide-field X-ray Telescope data, achieving high recall rates while significantly reducing candidate volume.


<details>
  <summary>Details</summary>
Motivation: To differentiate genuine astrophysical sources from artifacts and Cosmic Ray events in the large candidate stream produced by the EP-WXT.

Method: M-EPDet utilizes a three-step approach: a ResNet-based Arm filter, a dual-branch temporal-spectral Cosmic Ray filter, and a background-aware Bayesian Blocks module for variability screening.

Result: Achieved a Real-Bogus Recall of 98.31% for genuine sources and rejection rates of 92.99% for artifacts and 98.18% for Cosmic Rays, with a 99.25% reduction in candidate volume after filtering.

Conclusion: M-EPDet significantly reduces the need for manual inspection in candidate vetting, functioning as a lightweight real-time service in the EP-WXT pipeline.
...
### [30] [Gravitational Light Deflection with SKA-VLBI and Its Application to Precision Tests of General Relativity](https://arxiv.org/abs/2606.25549)
*Y. J. Li,J. J. Li,Z. H. Lin,D. J. Liu,Y. W. Dong,C. J. Hao,Y. Xu*

Main category: astro-ph.IM

TL;DR: The paper discusses advancements in radio astrometry using SKA-VLBI to test general relativity, aiming for high precision measurements of light deflection and improvements in parameter estimation.


<details>
  <summary>Details</summary>
Motivation: To rigorously test general relativity and distinguish between gravitational theories using precise measurements of light deflection.

Method: Utilizing SKA-VLBI for long-duration observations to track extragalactic sources and measure light deflection, employing the Sun and Jupiter as gravitational lenses.

Result: Achieved estimated accuracies for the parameter $γ$ up to $	ext{10}^{-7}$ using the Sun and $	ext{10}^{-4}$ using Jupiter, with significant astrometric precision enhancements.

Conclusion: These methods could advance the testing of gravitational theories and establish a new standard for astrometric precision in astrophysics.
...
### [31] [argosim: a Python package for radio interferometric simulations](https://arxiv.org/abs/2606.25573)
*Ezequiel Centofanti,Emma Ayçoberry,Samuel Farrens,Samuel Gullin,Manal Bensahli,Jean-Luc Starck,John Antoniadis*

Main category: astro-ph.IM

TL;DR: This paper introduces argosim, a modular Python package for simulating radio interferometric observations, designed for performance and ease of use.


<details>
  <summary>Details</summary>
Motivation: To provide an efficient and user-friendly tool for simulating radio interferometric observations in various research and educational settings.

Method: The argosim package utilizes a JAX-based computational backend for performance, and it comprises several modules to handle different aspects of the observation simulation process.

Result: The package is lightweight, compatible across major operating systems, and enables users to generate complete observational data from antenna configurations to image cleaning.

Conclusion: argosim serves as a valuable open-source resource for researchers in radio astronomy, facilitating efficient simulation and analysis.
...
### [32] [The Galaxy's Guide to the Tokenizer: A Benchmark for Scientific Foundation Models](https://arxiv.org/abs/2606.25610)
*Sogol Sanjaripour,Michael J. Smith,Manuel Pérez-Carrasco,Juan Rafael Martínez-Galarza,Bahram Mobasher,Gabriela Canalizo*

Main category: astro-ph.IM

TL;DR: This study evaluates four tokenization strategies for transformer models using astronomical data, highlighting trade-offs in performance across different tasks.


<details>
  <summary>Details</summary>
Motivation: Understanding the impact of tokenization on representations formed by transformer models in scientific contexts, especially with astronomical imaging data.

Method: Comparison of four tokenization strategies (Affine, AIM, JetFormer, VQ-VAE) within a unified framework using galaxy images from the DESI Legacy Survey.

Result: JetFormer shows superior reconstruction quality, VQ-VAE excels in predicting physical properties, while Affine and AIM retain localized morphological details.

Conclusion: No single tokenization method outperforms others universally; the study advocates for using scientific data to create interpretable benchmarks for foundation models.
...
### [33] [Application of Bayesian Statistical Tools to SKA Telescopes Polarization Surveys to Study Magnetization of the Large-scale Structure of the Universe](https://arxiv.org/abs/2606.25630)
...
TL;DR: The paper proposes a Bayesian approach to study large-scale cosmic magnetic fields using Faraday rotation measurements from radio sources, emphasizing the need for a substantial sample size and high-precision data for effective analysis.


<details>
  <summary>Details</summary>
Motivation: To enhance understanding of cosmological magnetic fields across various cosmic structures, especially in areas with limited existing data.

Method: Utilizing a Bayesian statistical framework to analyze Faraday rotation in samples of polarized radio sources, planned through the SKA-Mid and SKA-Low surveys.

Result: Identification of the need for around 50,000 Faraday rotation measurements and high-precision redshifts to constrain magnetic fields in galaxy clusters, with a preliminary approach for lower density environments requiring fewer measurements.

Conclusion: While studying weakly-magnetized filaments poses challenges, the proposed survey methodologies have the potential to provide significant insights into cosmic magnetization.
...
### [34] [A Non-Negativity Iterative Approach to Image Deconvolution for SKA](https://arxiv.org/abs/2606.25631)
*Le Zhang,Shiyu Li*

Main category: astro-ph.IM

TL;DR: The paper presents a new algorithm for image deconvolution in radio observations, achieving fast and efficient image reconstruction.


<details>
  <summary>Details</summary>
Motivation: To provide a method for image deconvolution that is efficient and does not rely on prior training, especially useful for interferometric radio data.

Method: The algorithm is iterative and assumes non-negative source fluxes, with computational costs scaling linearly with image size.

Result: The method successfully reconstructs images of both point sources and extended galaxies, performing well with realistic PSF and sparse $uv$-coverage in simulations without noise.

Conclusion: The algorithm demonstrates a strong potential for use in SKA and VLBI observations, providing improved reconstructions compared to existing methods.
...
### [35] [A Wideband Millimeter-wave Receiver at 120-350 GHz for LMT-FINER](https://arxiv.org/abs/2606.25637)
...
TL;DR: The FINER project is developing advanced receivers for identifying high-redshift galaxies, enhancing spectral-scanning capabilities with significant bandwidth improvements.


<details>
  <summary>Details</summary>
Motivation: To efficiently identify high-redshift galaxy candidates in the early universe, leveraging advanced receiver technology.

Method: Development and initial characterization of dual-polarization receivers covering 120-350 GHz, utilizing superconductor-insulator-superconductor mixer technology and assessing performance metrics like noise temperature and image rejection.

Result: Characterization of the 210-350 GHz receiver showed a noise temperature of ~100 K and a digital sideband separation with an image rejection ratio of ~20 dB.

Conclusion: These results mark key progress towards achieving a wideband spectral-scanning receiver system for the FINER project.
...
### [36] [VLT Beyond 2030 and Call for White Papers](https://arxiv.org/abs/2606.25664)
*Céline Péroux,Antoine Mérand,Martyna Chruślińska*

Main category: astro-ph.IM

TL;DR: The VLT Beyond 2030 conference facilitated discussions on future scientific and technological advancements for the VLT and VLTI, encouraging ideas for upcoming projects and a call for White Papers to shape a long-term research roadmap.


<details>
  <summary>Details</summary>
Motivation: The conference aimed to unify science and engineering perspectives to foster innovative ideas for the future of the VLT and its interferometer, addressing key scientific inquiries of the future.

Method: Participants, including experts and community members, engaged in discussions emphasizing cross-disciplinary collaboration to generate new project ideas.

Result: A strong interest in new projects for VLT/I was noted, leading to the call for White Papers to identify vital research areas for the period beyond 2030.

Conclusion: The article summarizes conference outcomes and highlights the importance of collaborative efforts in shaping the long-term strategic plan for VLT/I initiatives.
...
### [37] [DANTE: A Reference-Guided Unsupervised Pipeline for Extended-Transient Anomaly Characterization in LIGO O4a](https://arxiv.org/abs/2606.25702)
*Luca Cirfeta*

Main category: astro-ph.IM

TL;DR: DANTE is an unsupervised pipeline for detecting non-stationary noise in gravitational-wave data, utilizing a modified Vision Transformer and an adaptive analysis approach to improve anomaly identification.


<details>
  <summary>Details</summary>
Motivation: The need to accurately differentiate between instrumental noise and actual gravitational-wave signals in detector data during the fourth observing run (O4).

Method: Using a pre-trained Vision Transformer for extracting local embeddings from time-frequency spectrograms, coupled with a Dirichlet Process Mixture Model to manage taxonomy instability and a recalibration method to resolve domain shifts.

Result: DANTE showed effective mapping of transient anomalies and demonstrated that many morphologies initially seen as novel were actually stationary artifacts when analyzed correctly.

Conclusion: For effective unsupervised anomaly detection, native recalibration is essential to mitigate domain-shift issues, while accurate classification of anomalies necessitates multi-channel analysis.
...
### [38] [On-Sky Single-photon Time resolution of 35 ps with White Rabbit synchronization: towards the measurement of the size of a White Dwarf star](https://arxiv.org/abs/2606.25817)
*F. Izraelevitch-Patitucci,S. Tolilla,I. Ellafi,J. -P. Rivet,M. Hugbart,G. Labeyrie,O. Lai,A. Zmija,W. Guerin,R. Kaiser*

Main category: astro-ph.IM

TL;DR: The IC4Stars project measures the diameter of Sirius B using advanced time resolution and synchronization techniques.


<details>
  <summary>Details</summary>
Motivation: To accurately determine the diameter of the white dwarf Sirius B through Intensity Interferometry.

Method: Utilized laboratory characterization of single-photon detectors, TDCs, and synchronization electronics, achieved sub-35 ps RMS time resolution, and synchronized TDCs with the White Rabbit protocol.

Result: Demonstrated effective on-sky time resolution and developed algorithms for data acquisition and second-order correlation function computation.

Conclusion: The project has made significant progress in the measurement techniques necessary for determining the size of Sirius B.
...
### [39] [Observations of the Cosmic Dawn and Epoch of Reionization with the SKAO: Observational Lessons Learned from Precursors and Pathfinder Instruments](https://arxiv.org/abs/2606.26072)
...
TL;DR: The chapter discusses two decades of Cosmic Dawn and Epoch of Reionization observations, focusing on simulation pipelines and mitigation of systematic effects for SKAO.


<details>
  <summary>Details</summary>
Motivation: To improve the design and analytical approaches for future SKAO observations based on past experiences with CD and EoR.

Method: Developing accurate simulation pipelines and calibrating methods to address systematic issues like sky model limitations and antenna interactions.

Result: A summary of various approaches taken by research groups to enhance observation accuracy and mitigate systematic effects.

Conclusion: The findings inform the design and analysis of future SKAO observations.
