...
TL;DR: GravNet introduces a method for detecting high-frequency gravitational waves using synchronized signals from multiple detectors, enhancing detection reliability through correlation analysis.


<details>
  <summary>Details</summary>
Motivation: To explore high-frequency gravitational waves and their implications for cosmology, particularly in distinguishing genuine signals from noise.

Method: Synchronous measurements are conducted across geographically separated detectors, improving detection significance through correlation of signals, particularly in strong magnetic field cavities.

Result: A preliminary demonstration using a non-superconducting cavity has been successfully conducted, supporting the proposed data-analysis strategies.

Conclusion: GravNet holds promise as a framework for establishing a global network dedicated to high-frequency gravitational-wave research.
...
TL;DR: This paper introduces a probabilistic autoencoder (PAE) for modeling galaxy SEDs and estimating redshifts, outperforming traditional template fitting methods in various metrics and offering faster inference alternatives.


<details>
  <summary>Details</summary>
Motivation: To improve galaxy SED modeling and redshift estimation using synthetic SPHEREx data, addressing limitations in traditional methods.

Method: A PAE framework utilizes a normalizing flow for Gaussian base density transformation, with joint Bayesian inference on SED parameters and redshift, alongside a simulation-based inference approach using a Transformer.

Result: The PAE showed better source recovery, reduced outlier rates, and enhanced posterior calibration in testing, while an alternative approach offered similar performance with significantly faster processing.

Conclusion: The 	exttt{PAESpec} tool establishes a robust foundation for accurate redshift estimation in photometric surveys, improving data interpretation and analysis.
...
TL;DR: A novel Bayesian method for estimating galaxy redshifts and detecting emission lines is introduced, designed for efficiency with large datasets from modern telescopes.


<details>
  <summary>Details</summary>
Motivation: Estimating galaxy redshifts is essential for understanding dark energy and relies on accurate spectroscopic data from modern telescopes.

Method: A Bayesian approach is proposed to estimate redshifts and test for emission line presence simultaneously, efficiently handling multimodal posterior distributions.

Result: The method remains computationally efficient, suitable for large-scale data sets and can be implemented in parallel.

Conclusion: This framework improves redshift estimation accuracy while managing the complexities of modern spectroscopic surveys.
...
TL;DR: This paper discusses a new relative flux calibration method for grism observations in the Roman High Latitude Wide Area Survey, aiming for precise calibration via a simplified model and examining the impact of various factors on calibration accuracy.


<details>
  <summary>Details</summary>
Motivation: Accurate relative flux calibration is essential for interpreting astronomical observations and minimizing systematic errors in measurements.

Method: We propose an independent flat field for each detector with a wavelength-dependent throughput model, examining calibration residuals and optimal dither scales to enhance accuracy.

Result: Calibration residuals can be reduced to less than 1.5 mmag (0.15% flux) within a dither range of 50-240", allowing flexibility in observing programs.

Conclusion: While the focus is on the spectroscopic aspects, our calibration methodology can also apply to imaging surveys, necessitating further improvements before real data application.
...
TL;DR: This paper presents the development and characterization of CXPOL, a prototype hard X-ray polarimeter aimed at enhancing polarization measurements in the hard X-ray regime, focusing on improvements in sensitivity and spectroscopic capabilities.


<details>
  <summary>Details</summary>
Motivation: The scientific potential of X-ray polarimetry is underutilized due to the challenges in measuring polarization, especially in hard X-ray ranges. Existing technologies have limitations that hinder the understanding of high-energy astrophysical processes.

Method: The CXPOL prototype uses a plastic scintillator as an active scatterer and is surrounded by CsI(Tl) scintillators in a cylindrical array, with readout from SiPMs. The paper explores the use of NaI(Tl) scintillator absorbers, position-sensitive configurations, and simultaneous readouts to enhance sensitivity and reduce systematic effects.

Result: Initial results demonstrated detection sensitivity with a 100x20x5 mm^3 NaI(Tl) absorber read out by SiPM arrays in coincidence, significantly reducing background noise and improving polarimetric sensitivity. Energy and position resolution were characterized along with the effects of light output variation.

Conclusion: The advancements in the detector prototype and techniques introduced in this work are expected to enhance polarization measurement capabilities in hard X-ray astrophysical applications, contributing to a better understanding of high-energy processes.
...
TL;DR: The East Asia VLBI Network (EAVN) has enhanced polarimetric observations, showing stable performance at high frequencies with promising calibration results compared to VLBA.


<details>
  <summary>Details</summary>
Motivation: To verify the polarimetric performance of the EAVN, enabling advanced observational capabilities for astrophysical studies.

Method: Utilized dual-polarization observations of various astrophysical sources, calibrated using the GPCAL pipeline, and compared results with VLBA images.

Result: Most stations exhibited stable polarimetric leakages of 5-10%, with some correction needed for field-rotator offsets, leading to agreement with VLBA results in linear-polarization morphologies and EVPAs.

Conclusion: EAVN demonstrates reliable polarimetric capabilities and paves the way for enhanced studies in East Asia.
...
### [7] [Dynamical Causal Horizons and the Quarkonium Flow Paradox](https://arxiv.org/abs/2603.24623)
*Yi Yang*

Main category: hep-ph

TL;DR: This paper proposes a geometric explanation for the suppression of bottomonium in heavy-ion collisions, suggesting it's driven by extreme spacetime geometry during initial fragmentation rather than late-stage scattering, leading to observable implications like vanishing elliptic flow.


<details>
  <summary>Details</summary>
Motivation: To resolve contradictions in quarkonium suppression interpretations, specifically the unexpected elliptic flow behavior of bottomonium in heavy-ion collisions.

Method: The paper suggests that quarkonium suppression is determined by extreme spacetime geometry and local deceleration, resulting in a causal horizon which affects the dissociation of bound states at early stages of the collision.

Result: A new analytical formula for the nuclear modification factor is derived, capturing the observed suppression hierarchy in lead-lead collisions without fine-tuning.

Conclusion: The proposed framework connects subatomic dynamics with causal event horizons and explains the observed isotropy and elliptic flow characteristics in a unified manner.
...
### [8] [ACT-Planck data and phase transitions from a viable no-scale Standard Model completion](https://arxiv.org/abs/2603.24664)
*Filippo Cutrona,Francesco Rescigno,Alberto Salvio*

Main category: hep-ph

TL;DR: The paper presents a realistic model of classical scale-invariant theories that explains large hierarchies, features phase transitions, and aligns with recent inflationary observational constraints.


<details>
  <summary>Details</summary>
Motivation: The paper aims to explore the implications of classical scale-invariant theories for understanding cosmological phenomena, particularly concerning inflation.

Method: The authors construct a model based on classical scale invariance that includes an inflationary process occurring in two distinct stages: slow-roll and thermal, interspersed with a radiation-dominated era.

Result: The model aligns well with observational data from major cosmology collaborations, demonstrating its compatibility with inflationary constraints.

Conclusion: This work highlights how classical scale invariance can lead to non-standard cosmological scenarios and offers a framework for understanding inflation through a two-stage process.
...
### [9] [Constraints on Light Sterile Neutrinos and Scalar Non-Standard Interactions Using the First Reactor Antineutrino Oscillation Results at JUNO](https://arxiv.org/abs/2603.24677)
*L. J. Flores,R. Pacheco-Aké,Eduardo Peinado,G. Sanchez Garcia,E. Vázquez-Jáuregui*

Main category: hep-ph

TL;DR: JUNO's first reactor antineutrino results yield constraints on light sterile neutrinos and scalar non-standard interactions, showing sensitivity to specific mass-splitting and mixing amplitudes.


<details>
  <summary>Details</summary>
Motivation: To explore the existence of light sterile neutrinos and non-standard neutrino interactions using precise reactor antineutrino data.

Method: A spectral $χ^2$ fit was conducted on prompt-energy distributions from 59.1 days of JUNO data, extending three-flavor oscillations to include a $3+1$ framework and effective scalar NSI contributions.

Result: JUNO constrains light sterile neutrinos in the mass-splitting range $10^{-5} 	ext{eV}^2 < Δm^2_{41} < 10^{-2} 	ext{eV}^2$ and mixing amplitudes $	ext{sin}^2 2θ_{14} 	ext{ of} 	ext{ } 	ext{O}(10^{-1})$. Additionally, it establishes a limit on the scalar NSI parameter with $|η_{ee}| < 	ext{O}(10^{-2})$.

Conclusion: The results highlight JUNO's capability to detect subtle new physics deviations from the Standard Model, with improved measurements anticipated as data collection and systematic control advance.
...
### [10] [UV-complete and stable Quintom Dark Energy models in the light of DESI DR2](https://arxiv.org/abs/2603.24685)
*Fotis Koutroulis*

Main category: hep-ph

TL;DR: The paper proposes a 5D model for Quintom dark energy, integrating it into a framework that avoids fine-tuning and instability issues, while fitting observational data effectively.


<details>
  <summary>Details</summary>
Motivation: To provide a robust theoretical framework for Quintom dark energy that can accommodate crossing the cosmological-constant boundary and avoid the instability issues common in such models.

Method: The authors propose a 5D SU(2) gauge field in an anisotropic orbifold lattice that projects onto a 4D boundary, resulting in a modified Quintom model with effective higher-derivative operators.

Result: The model yields an excellent fit to DESI data with minimal fine-tuning, while maintaining absence of ghost instabilities and a finite low-energy cutoff, allowing consistency under perturbations.

Conclusion: This framework offers a predictive and natural embedding of Quintom dark energy in a fundamental theory, demonstrating robustness against potential instabilities.
...
### [11] [Gluon Wigner Distributions in boost-invariant longitudinal position space](https://arxiv.org/abs/2603.24694)
*Sonia,Tanmay Maji,Hemant Kumar*

Main category: hep-ph

TL;DR: The study presents Wigner distributions for various gluon polarizations in a proton, utilizing a light-front gluon spectator model. Results show oscillatory behavior in longitudinal space, resembling diffraction patterns.


<details>
  <summary>Details</summary>
Motivation: To examine the Wigner distributions of gluons in different polarization states within a proton using a light-front framework inspired by AdS/QCD.

Method: Focuses on Wigner distributions in boost-invariant longitudinal space via Fourier transformation of gluon-gluon correlators associated with generalized transverse momentum dependent distributions (GTMDs).

Result: Model results indicate oscillatory behavior in gluon WDs in σ-space, with patterns influenced by momentum fraction x and energy transfer -t, akin to diffraction phenomena.

Conclusion: Explores gluon WDs and spin-OAM correlations extensively, showing sensitivity to polarization states in comparison with other models and lattice computations.
...
### [12] [Photon production from gluon splitting and fusion induced by a magnetic field in heavy-ion collisions](https://arxiv.org/abs/2603.24964)
*Alejandro Ayala,Santiago Bernal-Langarica,José Jorge Medina-Serna,Ana Julia Mizher*

Main category: hep-ph

TL;DR: The study investigates photon production mechanisms in heavy-ion collisions, focusing on gluon splitting and fusion, particularly in magnetic fields. It finds that splitting is more significant than fusion at low photon energies and compares results with experimental data.


<details>
  <summary>Details</summary>
Motivation: The direct photon puzzle in heavy-ion collisions involves unexplained excess photon production and elliptic flow, prompting the need to explore photon production mechanisms during the pre-equilibrium stage.

Method: The study analyzes the two-gluon one-photon vertex at one-loop level under arbitrary magnetic fields, calculating contributions from gluon splitting and fusion to photon yield.

Result: Gluon splitting is shown to dominate photon production at low energies, with findings aligned with experimental data from the PHENIX collaboration.

Conclusion: Incorporating longitudinal anisotropy in the initial gluon distribution does not significantly change the photon yield compared to an isotropic distribution.
...
### [13] [$DD^*$ correlation functions in deciphering the nature of $T_{cc}(3875)^+$](https://arxiv.org/abs/2603.24980)
*Duo-Lun Ge,Zhi-Wei Liu,Li-Sheng Geng*

Main category: hep-ph

TL;DR: This study evaluates the scattering lengths and femtoscopic correlation functions for the doubly charmed tetraquark $T_{cc}(3875)^+$ to distinguish between molecular and compact multiquark assignments.


<details>
  <summary>Details</summary>
Motivation: Understanding near-threshold strong interactions is crucial for differentiating between hadronic molecules and compact multiquark states in heavy-flavor spectroscopy.

Method: The study evaluates $D^*$-$D$ scattering lengths and femtoscopic correlation functions to distinguish between molecular and compact configurations of the $T_{cc}(3875)^+$.

Result: While the invariant-mass line shapes appear similar for different assignments, their femtoscopic correlation functions are distinct and can be differentiated in LHC experiments.

Conclusion: Femtoscopy can effectively probe the near-threshold dynamics of $T_{cc}(3875)^+$, offering important insights for future LHC measurements.
...
### [14] [Exploring two-body strong decay properties for possible single charm molecular pentaquarks with strangeness $|S|=1,2$](https://arxiv.org/abs/2603.24998)
*Xiao-Mei Tang,Jin-Yu Huo,Qi Huang,Rui Chen*

Main category: hep-ph

TL;DR: This study examines two-body strong decay properties of single-charm molecular pentaquarks in the $Y_car{K}^{(*)}$ systems, revealing distinctive decay patterns and stability in branching ratios, which inform future experiments.


<details>
  <summary>Details</summary>
Motivation: Investigating exotic hadrons enhances understanding of quantum chromodynamics in non-perturbative conditions.

Method: Utilized an effective Lagrangian approach and hadronic molecular wave functions from the one-boson-exchange model to compute decay widths and branching ratios.

Result: Identified decay widths ranging from < 1 MeV to tens of MeV, with stable branching ratios suggesting the dominance of light meson exchange.

Conclusion: Findings provide solid, testable predictions for experimental searches at LHCb and Belle II, emphasizing the importance of coupled-channel effects and isospin interference.
...
### [15] [$θ$ Angle and Axial Anomaly in Holographic QCD](https://arxiv.org/abs/2603.25729)
*Csaba Csáki,Eric Kuflik,Wei Xue,Taewook Youn*

Main category: hep-ph

TL;DR: This paper presents a holographic model of the QCD $θ$-vacuum and $U(1)_A$ anomaly in five dimensions, elucidating how the $η'$ meson's mass is linked to these concepts through a dual coupling.


<details>
  <summary>Details</summary>
Motivation: To provide a holographic perspective on the $θ$-vacuum and the $U(1)_A$ anomaly in Quantum Chromodynamics (QCD).

Method: The authors utilize a five-dimensional gauge theory framework, employing a Stückelberg coupling corresponding to a Chern-Simons term to describe the multi-branched structure of the $θ$-vacuum.

Result: The framework results in the identification of the $η'$ meson as a zero mode of fluctuations, with its mass derived from the anomaly-induced Stückelberg term, confirming the Witten-Veneziano relation.

Conclusion: The construction offers a clearer understanding of the relationship between the $η'$ mass and topological aspects of Yang-Mills theory, affirming the holographic approach's effectiveness in studying QCD phenomena.
...
### [16] [Physics at the Edge: Benchmarking Quantisation Techniques and the Edge TPU for Neutrino Interaction Recognition](https://arxiv.org/abs/2603.24607)
*Stefano Vergani,Hilary Utaegbulam,Michael Wang,Leigh H. Whitehead,Arden Tsang,Lorenzo Uboldi*

Main category: physics.ins-det

TL;DR: This paper benchmarks quantisation techniques for convolutional neural networks in recognizing neutrino interactions, using various models on edge devices and analyzing performance metrics.


<details>
  <summary>Details</summary>
Motivation: To evaluate the performance and energy efficiency of quantised CNNs for neutrino interaction recognition, aiming for effective deployment on edge devices.

Method: Different quantisation techniques, specifically post-training integer quantisation and quantisation-aware training, were applied to four Keras models tested on a Google Coral Edge TPU, with comparisons made against an AMD EPYC CPU and NVIDIA A100 GPU.

Result: Experimental results indicate that accuracy degradation is minimal, with Inception V3 showing almost no degradation. The edge TPU performs comparably to the CPU but slower than the GPU, while exhibiting significantly lower energy consumption.

Conclusion: The study indicates the feasibility of deploying quantised CNN models on edge devices for neutrino physics applications, highlighting potential for future integrations of edge AI technologies.
...
### [17] [On peculiarities of the annealing process for highly transparent silica based aerogel tiles manufactured in Novosibirsk](https://arxiv.org/abs/2603.24630)
*A. Yu. Barnyakov,A. F. Danilyuke,A. A. Kattsin,E. A. Kravchenko*

Main category: physics.ins-det

TL;DR: This paper discusses advancements in the production technology of silica aerogel for Cherenkov detectors, focusing on optimizing the annealing process to improve yield and performance characteristics.


<details>
  <summary>Details</summary>
Motivation: The research aims to enhance the production quality and efficiency of silica aerogel, critical for various high-energy physics experiments utilizing RICH detectors.

Method: Investigated and optimized the annealing process during the production of silica aerogel tiles.

Result: The new annealing procedure led to improved yields and enhanced optical and mechanical properties of the aerogel samples.

Conclusion: Optimized annealing significantly enhances the production of silica aerogel for use in advanced Cherenkov detectors.
...
### [18] [PySiPMGUI: A Universal Python-Based Software for Photodetector I-V Quality Assurance: From Underground Dark Matter Searches to Astroparticle Cherenkov Cameras](https://arxiv.org/abs/2603.24781)
*Tanay Dey,Suraj Shaw,Ritabrata Banerjee,Pratik Majumdar,Satyaki Bhattacharya*

Main category: physics.ins-det

TL;DR: This study introduces an open-source GUI for the automated characterization of Silicon Photomultipliers (SiPMs), crucial for various physics experiments.


<details>
  <summary>Details</summary>
Motivation: Characterizing SiPMs is essential due to the dependence of performance metrics on bias voltage and temperature.

Method: An open-source GUI using PyVISA-controlled instruments was developed for automated characterization of SiPMs.

Result: The GUI offers a free, open, and platform-independent tool for systematic SiPM characterization.

Conclusion: This tool aids in detector R&D and enhances large-scale SiPM evaluation.
...
### [19] [A Telescope System for Charge and Position Measurement of High Energy Nuclei](https://arxiv.org/abs/2603.25080)
...
TL;DR: A high-granularity telescope system with low material budget achieves exceptional charge and spatial resolution for nuclear measurements using silicon microstrip detectors.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the need for precise nuclear charge measurement in high-energy heavy ion beam tests while maintaining a low material budget.

Method: A telescope with nine layers of silicon microstrip detectors (SSDs) is developed and validated through heavy ion beam tests, aided by a hybrid machine learning algorithm for charge measurement.

Result: The system shows a spatial resolution of $	ext{O}(1) \, 	ext{μm}$ and a charge resolution better than 0.16 units for nuclei from $Z = 1$ to $Z = 29$, covering a sensitive area of $8 	imes 8 \, 	ext{cm}^2$.

Conclusion: This work represents the highest precision in charge and spatial resolution achieved by a silicon telescope to date.
...
### [20] [Beam Test Characterization of Silicon Microstrip Detector Flight-Model Ladders for the AMS-02 Upgrade](https://arxiv.org/abs/2603.25085)
...
TL;DR: This study evaluates the performance of a new microstrip tracker layer designed for the AMS-02 experiment, focusing on spatial resolution, response consistency, and incidence angle effects.


<details>
  <summary>Details</summary>
Motivation: The AMS-02 experiment aims to enhance cosmic-ray detection capabilities by adding a new silicon microstrip tracker layer, Layer-0, which increases acceptance significantly.

Method: Performance was assessed using flight-model ladders with a 350 GeV mixed hadron beam at the CERN SPS, analyzing resolution across different SSD configurations and response consistency across ladder regions.

Result: Ladders with varying numbers of SSDs showed intrinsic spatial resolutions ranging from 9.5 μm to 11.4 μm, with consistency in response across different ladder regions and varying incidence angles observed.

Conclusion: The findings suggest that the new Layer-0 design will improve cosmic-ray detection performance, achieving a balance between configuration complexity and detector responsiveness.
...
### [21] [Real-Time Wiener Deconvolution for feature reconstruction in JUNO](https://arxiv.org/abs/2603.25436)
...
TL;DR: The paper discusses a Real-Time Wiener deconvolution algorithm for FPGA-based data processing in neutrino physics to enhance signal reconstruction from PMTs, enabling better detection of low-energy deposits.


<details>
  <summary>Details</summary>
Motivation: To improve data processing for neutrino experiments and avoid losing crucial signals amidst high background noise.

Method: An advanced Real-Time Wiener deconvolution algorithm is implemented on FPGAs integrated into the JUNO readout boards for real-time signal reconstruction.

Result: The algorithm effectively manages high-throughput data with minimal latency, demonstrating enhanced detection of low-energy depositions typically lost in previous methods.

Conclusion: FPGA-based solutions significantly advance neutrino physics, providing improved feature extraction and real-time processing capabilities.
...
### [22] [Diffractive and photon-induced processes at the LHC: from the odderon discovery, the evidence for saturation to the search for axion-like particles](https://arxiv.org/abs/2603.24808)
*C. Royon*

Main category: hep-ex

TL;DR: The paper discusses the discovery of the odderon and its implications in high-energy physics, focusing on jet measurements in gluon-dense environments, potential saturation phenomena, and connections to beyond Standard Model physics.


<details>
  <summary>Details</summary>
Motivation: To explore the implications of recent discoveries in high-energy particle physics and their relationships with theoretical phenomena such as saturation and potential new particles.

Method: Analyzing measurements from the TOTEM and D0 collaborations, focusing on jet dynamics and high gluon density scenarios in heavy ion collisions.

Result: Identifies a gap between jet measurements and theoretical predictions related to saturation, and discusses the potential for new physics, including axion-like particle production.

Conclusion: The findings underscore the need for further investigations into high-density gluon behaviors and their implications for beyond Standard Model physics.
...
### [23] [Further search for magnetic-field-induced neutron disappearance in an ultracold neutron beam](https://arxiv.org/abs/2603.25376)
...
TL;DR: No evidence of neutron-hidden-neutron oscillations found; limits set on oscillation period based on varying magnetic fields.


<details>
  <summary>Details</summary>
Motivation: To investigate the existence of neutron-hidden-neutron oscillations using ultracold neutrons.

Method: Neutron disappearance was tested under varying magnetic fields to enhance oscillation probabilities across specific mass splittings, using a phenomenological two-parameter model.

Result: No evidence for neutron disappearance was observed; conservative limits on the oscillation period were established at a 95% confidence level.

Conclusion: Limits on the neutron-hidden-neutron oscillation period are significantly constrained based on the observed data.
...
### [24] [Measurement of dijet angular distributions and search for beyond the standard model physics in proton-proton collisions at $\sqrt{s}$ = 13 TeV](https://arxiv.org/abs/2603.25458)
*CMS Collaboration*

Main category: hep-ex

TL;DR: This paper presents a measurement of dijet angular distributions in proton-proton collisions at the LHC, comparing data with quantum chromodynamics predictions, and sets stringent limits on various high-energy physics scenarios.


<details>
  <summary>Details</summary>
Motivation: To investigate dijet angular distributions at high energies and search for signatures of new physics beyond the Standard Model.

Method: Dijet angular distributions were analyzed using data from the CMS detector, corrected for detector effects, and compared with perturbative quantum chromodynamics predictions at next-to-next-to-leading order, including electroweak corrections.

Result: Generally, the observed distributions agree with predictions, but discrepancies are found in specific mass ranges, leading to stringent limits on models of quark compositeness, extra dimensions, and other new physics scenarios.

Conclusion: Quark contact interactions are excluded up to 17 TeV (destructive) and 37 TeV (constructive) at 95% CL, while limits on axion-like particle couplings and triple-gluon coupling are also established.
...
### [25] [Amplitude analysis and branching fraction measurement of the decay $D^0 \to K^+K^-π^0π^0$](https://arxiv.org/abs/2603.25649)
*BESIII Collaboration*

Main category: hep-ex

TL;DR: This paper presents an amplitude analysis of the decay process $D^0 	o K^+ K^- π^0 π^0$, determining intermediate processes and their contributions for the first time.


<details>
  <summary>Details</summary>
Motivation: Previous studies on $D^0$ decays lacked detailed analysis of intermediate processes and their amplitudes, necessitating this comprehensive investigation.

Method: An amplitude analysis was conducted using $e^+e^-$ collision data from the BESIII detector, focusing on the decay $D^0 	o K^+ K^- π^0 π^0$ at a center-of-mass energy of 3.773 GeV.

Result: The branching fraction for $D^0 	o K^+ K^- π^0 π^0$ was determined, with the dominant intermediate process identified as $D^0 	o K^{*}(892)^+K^{*}(892)^-$, which has a branching fraction of $(2.79 	imes 10^{-3})$. The decay is shown to be S-wave dominant, with a longitudinal polarization fraction of $0.468$.

Conclusion: This analysis enhances the understanding of $D^0$ decays and highlights the significance of the identified intermediate processes and their influence on the decay dynamics.
...
### [26] [Worldwide Reactor Neutrino Propagation to Underground Labs: Matter Effects and Flux Predictions](https://arxiv.org/abs/2603.25655)
*Keyu Han,Juncheng Qian,Shaomin Chen*

Main category: hep-ex

TL;DR: The study enhances geoneutrino experiments by accurately predicting reactor antineutrino fluxes through advanced modeling, accounting for Earth's geological structure.


<details>
  <summary>Details</summary>
Motivation: To improve the precision of geoneutrino measurements by addressing the complications introduced by background reactor antineutrinos.

Method: Developed a high-precision framework utilizing global reactor data, distances, and a second-order Strang-splitting solver to model antineutrino propagation, considering MSW effects in both one-dimensional and three-dimensional Earth models.

Result: Calculated reactor neutrino oscillation probabilities, revealing differences between the MSW effect and vacuum oscillation, crucial for refining flux predictions based on Earth's structure.

Conclusion: The study highlights the importance of considering Earth's inhomogeneities for enhanced accuracy in reactor neutrino flux predictions, which can improve geophysical research outcomes.
...
### [27] [Neutrino and electromagnetic signatures from Superluminous Supernovae: a case study for SN 2017egm](https://arxiv.org/abs/2603.24655)
*Mainak Mukhopadhyay,Shigeo S. Kimura,Indrek Vurm,Brian D. Metzger*

Main category: astro-ph.HE

TL;DR: This study investigates superluminous supernovae (SLSNe) powered by millisecond magnetars, modeling their multi-wavelength and multi-messenger emissions.


<details>
  <summary>Details</summary>
Motivation: To understand the energy source of SLSNe, which are significantly more luminous than ordinary supernovae.

Method: The authors model a magnetar system, analyzing the emissions from the magnetar, wind, nebula, and ejecta while assessing their electromagnetic and neutrino signatures.

Result: Predicted high-energy gamma rays for SN 2017egm align with Fermi LAT observations, and a potential detection method for neutrinos during the Vera C. Rubin Observatory's operation is proposed.

Conclusion: This work suggests that multi-messenger studies can significantly advance our understanding of SLSNe and facilitate future detections of both gamma rays and neutrinos.
...
### [28] [BLAZ4R and the eROSITA view of z>4 blazars](https://arxiv.org/abs/2603.24659)
...
TL;DR: BLAZ4R is a new catalog of confirmed high-redshift ($z>4$) blazars, leveraging eROSITA data to explore the evolution of blazars and their jets in the early universe, featuring 54 sources with extensive X-ray and multiwavelength data.


<details>
  <summary>Details</summary>
Motivation: To investigate the evolution and characteristics of blazars at high redshifts, which serve as indicators of supermassive black hole activity and relativistic jet formation in the early universe.

Method: Compilation of a catalog (BLAZ4R) of 54 confirmed $z>4$ blazars utilizing eROSITA's all-sky surveys for X-ray detection and subsequent analysis of their multiwavelength properties.

Result: BLAZ4R reveals that jetted sources are more common than non-jetted ones at high redshifts, with similar features across blazars and the broader AGN population, indicating fast accretion processes are necessary for jetted AGN existence at $z>4$.

Conclusion: Despite the catalog's diverse properties, specific signatures of the underlying fast accretion processes remain unidentified; ongoing updates to BLAZ4R aim to uncover these signatures and enhance understanding of early jetted AGN formation.
...
### [29] [Systematic Monitoring of Extreme X-ray Variability from Weak-line Quasars](https://arxiv.org/abs/2603.24673)
*Madison Reich,W. N. Brandt,Bin Luo,Richard Plotkin,Ohad Shemmer,Fabio Vito,Weimin Yi*

Main category: astro-ph.HE

TL;DR: A multi-cycle Chandra program reveals significant X-ray variability in weak-line quasars (WLQs), with notable cases showing extreme fluctuations in flux. The study suggests that this variability may stem from intrinsic motions in the thick disk and outflow model rather than disk height changes.


<details>
  <summary>Details</summary>
Motivation: To improve understanding of X-ray variability in weak-line quasars, which previously lacked extensive multi-epoch observations.

Method: Utilized a multi-cycle Chandra program to monitor X-ray variability in 10 WLQs, conducting new observations and analyzing flux changes over specific periods.

Result: Significant X-ray variability observed, especially in two WLQs, with a fraction of 20% exhibiting extreme variability. WLQs were found to have a 6.8 times higher likelihood of extreme X-ray variability compared to general radio-quiet quasars.

Conclusion: The findings may indicate that the extreme X-ray variability in WLQs is primarily driven by intrinsic motions in the TDO wind, contributing to our understanding of quasar behavior.
...
### [30] [The background gas humming and multi-messenger transients of stalled supermassive black hole binaries](https://arxiv.org/abs/2603.24678)
...
TL;DR: The paper details the mechanisms of episodic mass transfer in supermassive black hole binaries using wavelet transforms and Airy differential equations, resulting in non-linear shock formations and multi-wavelength emissions, culminating in high-frequency gravitational wave signals.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics of mass transfer and gravitational waves in supermassive black hole binaries within circumbinary discs.

Method: Utilizing wavelet transforms for isolating gas clumps, regularizing fluid equations via the Airy differential equation, and modeling thermal luminosity to derive power spectral density and binary mass ratio.

Result: Identification of shock-associated multi-wavelength emissions and a new high-frequency gravitational wave signature linked to accretion dynamics.

Conclusion: The findings predict discrete high-frequency bursts from gas dynamics, serving as precursors to gravitational wave events during black hole inspirals.
...
### [31] [The rise of the black hole X-ray binary AT2019wey observed with TESS](https://arxiv.org/abs/2603.24683)
*Alyana Jusino,Kishalay De,Andrea Antoni*

Main category: astro-ph.HE

TL;DR: This study utilizes TESS data to analyze the early optical light curves of the black hole X-ray binary AT 2019wey, providing insights into its outburst mechanism.


<details>
  <summary>Details</summary>
Motivation: To leverage optical time-domain surveys for early detection and understanding of BHXRB outbursts, which have been traditionally monitored using X-ray surveys.

Method: Analyzed TESS light curves at 30-minute cadence before and after the outburst, applying a piece-wise power law fit to determine outburst onset and rise characteristics.

Result: Identified an outburst onset time of MJD 58817.86±0.09 with a rise index of n=0.74±0.04; the optical rise followed faint X-ray activity, and no significant periodic modulation was detected.

Conclusion: The findings reveal the potential of optical surveys for early detection of BHXRB outbursts, establishing a timeline for future observational strategies.
...
### [32] [Photon Ring Astrometry I: A Simple Spin Measurement Technique for High-Resolution Images of M87*](https://arxiv.org/abs/2603.24722)
*Delilah E. A. Gates,Dominic O. Chang,Aaron Held,Daniel C. M. Palumbo*

Main category: astro-ph.HE

TL;DR: The paper proposes a method to measure the spin of the black hole in M87 using the displacement between photon ring sub-images and the direct image, offering a new approach to constrain spin based on observed astrometry.


<details>
  <summary>Details</summary>
Motivation: To measure the spin of the supermassive black hole in M87 with high precision using horizon-scale imaging.

Method: The authors propose measuring the displacement between the ${n}~{=}~{1}$ photon-ring sub-image and the direct image, separating shifts into components along and perpendicular to the spin axis, utilizing GRMHD simulations for realistic conditions.

Result: Achieving relative astrometric resolutions of less than $0.1\;μ\text{as}$ can constrain the black hole spin to better than 9% with prograde flow, 22% with retrograde flow, or 26% if flow direction is unknown.

Conclusion: This work outlines a promising technique for constraining black hole spin and understanding spacetime geometry through relative photon ring astrometry.
...
### [33] [The Diffuse Gamma-ray Sky of a Milky Way Analogue: Local Diversity and Global Constraints](https://arxiv.org/abs/2603.24741)
...
TL;DR: This paper investigates how gamma-ray emissions from cosmic rays in the Milky Way vary based on environment and observation location, using CR-MHD simulations.


<details>
  <summary>Details</summary>
Motivation: To interpret the complex gamma-ray emissions from the Milky Way, which are influenced by cosmic ray distributions and observer location.

Method: CR-MHD simulations of a Milky Way analogue were used to analyze gamma-ray emissions under various conditions and observer positions, computing luminosities and spectra in a steady-state framework.

Result: The simulated emissions match observed gamma-ray luminosities and spectra, with angular power spectra revealing that gas column density primarily affects emission morphology.

Conclusion: Self-consistent CR-MHD simulations effectively model the key features of Galactic gamma-ray emissions, highlighting the significance of local gas density in shaping emission properties.
...
### [34] [Production of heavy $α$-elements and $^{44}$Ti in Cas A: comparison to abundances from 1D core-collapse supernova models and evidence for Carbon-Oxygen shell mergers](https://arxiv.org/abs/2603.24758)
*Luca Boccioli,Lorenzo Roberti,Chris L Fryer,Samar Safi-Harb,Samuel Jones,Marco Pignatari*

Main category: astro-ph.HE

TL;DR: This study examines the impact of carbon-oxygen shell mergers on nucleosynthesis in core-collapse supernovae, particularly focusing on the production of $^{44}$Ti and the diagnostic ratios of elements like Ar/Ne in comparing models to supernova remnants.


<details>
  <summary>Details</summary>
Motivation: To understand how C-O shell mergers influence nucleosynthesis and elemental ratios in massive stars before they explode as supernovae.

Method: The authors analyze nucleosynthesis yields from eight CCSNe models, comparing the elemental ratios observed in Cassiopeia A with model predictions, especially focusing on Ar/Ne ratios and $^{44}$Ti production.

Result: C-O shell merger models produce higher Ar/Ne ratios consistent with observations, suggesting they provide the best fit for the X-ray and infrared characteristics of Cassiopeia A; expected $^{44}$Ti from these mergers is significant but likely hidden from current detection methods.

Conclusion: While C-O shell mergers significantly impact $^{44}$Ti production in Cassiopeia A, the models predict these will not be detectable by current instruments, and the merger hypothesis for $^{44}$Ti in SN 1987A is not supported by the observed data.
...
### [35] [Distance estimate to NGC 6951 from supernova siblings Type IIP SN 2020dpw and Type Ib SN 2021sjt](https://arxiv.org/abs/2603.24769)
...
TL;DR: This study provides distance estimates for NGC 6951 using Supernova siblings, improving measurement accuracy through the expanding photosphere method for both Type IIP and Type Ib SNe.


<details>
  <summary>Details</summary>
Motivation: To enhance distance measurement methods using the calibration potential of supernova siblings and reduce systematic uncertainties in distances to their host galaxies.

Method: Photometric observations were conducted with 80cm RC telescopes, and spectra were utilized from existing databases. The expanding photosphere method (EPM) was applied to derive distances for Type IIP and Type Ib supernovae.

Result: Distance estimates were obtained as 25.76 ± 0.34 (random) ± 5.51 (systematic) Mpc for SN 2020dpw and 24.57 ± 1.27 (random) ± 4.64 (systematic) Mpc for SN 2021sjt.

Conclusion: The distances align with each other and existing literature, validating the methods used and demonstrating EPM's applicability to Type Ib SNe.
...
### [36] [Investigation on the X-ray emission of NGC 4051 during its 2009 optical/UV-X-ray dissociation phase](https://arxiv.org/abs/2603.24945)
*Minhua Zhou,Xinling Wu,Lei Xu,Nannan Chen*

Main category: astro-ph.HE

TL;DR: The study analyzes the X-ray behavior of jet-associated radio-quiet AGNs, revealing distinct observational phases with varying X-ray characteristics during optical/UV flares.


<details>
  <summary>Details</summary>
Motivation: To explore the X-ray characteristics of radio-quiet AGNs and their correlation with optical/UV emissions.

Method: Quasi-simultaneous observations of NGC 4051 using Swift and XMM-Newton, along with multi-method analyses including variability assessment and spectral analysis.

Result: Significant differences in X-ray emissions were identified between correlated and flaring phases, highlighting attenuated variability and enhanced soft X-ray absorption during flares.

Conclusion: The results contradict existing models of emission processes but align with predictions from the inhomogeneous accretion disk perturbation framework.
...
### [37] [Constraints on the Physical Association between ICECAT1 Neutrinos and Fast Radio Bursts Using the Second CHIME/FRB Catalogue](https://arxiv.org/abs/2603.24983)
...
TL;DR: This paper investigates potential neutrino emissions associated with fast radio bursts (FRBs) but finds no significant correlation.


<details>
  <summary>Details</summary>
Motivation: To explore the relationship between FRBs and neutrinos, addressing inconsistencies in current emission models.

Method: Utilized cross-matching between the CHIME/FRB and IceCube neutrino catalogues, applying a two-sided temporal hypothesis test and accounting for exposure and multiple trials.

Result: No significant association is discovered; the most noteworthy correlation shows a post-trial probability of 0.076, consistent with chance.

Conclusion: Current neutrino limits are more stringent than previous studies but still exceed predictions from magnetar models, suggesting some hadronic energy dissipation scenarios may be plausible.
...
### [38] [X-ray spectral and temporal evolution of atoll source 4U 1820-30 with AstroSat: detection of high frequency quasi-periodic oscillation](https://arxiv.org/abs/2603.25036)
*Subhasish Das,Vivek Kumar Agrawal,Parijat Thakur,G. C. Dewangan,Raj Kumar,Pragati Sahu,Vineet Kumar Mannaday*

Main category: astro-ph.HE

TL;DR: The study analyzes the X-ray spectral behavior of the low-mass X-ray binary 4U 1820-30 using data from AstroSat, revealing details about its accretion dynamics and spectral components across a defined spectral state.


<details>
  <summary>Details</summary>
Motivation: To investigate the spectral and timing properties of the low-mass X-ray binary 4U 1820-30 during its banana state, improving understanding of its accretion processes and variability.

Method: Analyzed AstraSat/LAXPC and SXT data across 11 segments of the color-color diagram (CCD) and fitted the spectral data using a multi-color-disk model combined with Comptonized emission to characterize the X-ray spectrum.

Result: Identified distinct components in the X-ray spectrum with a truncation radius of 19-40 km, significant variation in optical depth across the CCD, and strong kHz QPO peaks at approximately 710 Hz and 740 Hz in the lower left banana branch.

Conclusion: The study highlights the relationship between spectral evolution and source motion, with a dominant contribution from the Comptonized component, shedding light on the complex dynamics of the accreting neutron star.
...
### [39] [The 'Forgotten' Neutrons: Implications for the Propagation of High-Energy Cosmic Rays in Magnetized Astrophysical and Cosmological Structures](https://arxiv.org/abs/2603.25060)
*Ellis R. Owen,Kinwah Wu,Yoshiyuki Inoue,Tatsuki Fujiwara,Qin Han,Hayden P. H. Ng*

Main category: astro-ph.HE

TL;DR: This study examines how cosmic rays (CRs) interact within various cosmic structures, highlighting that CR neutrons can escape confinement and impact CR propagation more than previously understood.


<details>
  <summary>Details</summary>
Motivation: To explore the limitations of existing CR transport models that typically assume charged particles remain magnetically confined, particularly in high-energy interactions involving CR neutrons.

Method: The authors utilize a diffusion/streaming propagation model to analyze CR proton populations in different environments, incorporating hadronic interactions and stochastic neutron production/decay processes.

Result: Neutron-mediated escape mechanisms significantly increase CR transmission from large-scale structures, challenging traditional assumptions of CR confinement at high energies.

Conclusion: Recognizing neutron propagation shifts our understanding of CR distribution across cosmic environments, impacting how we perceive CR dynamics in the Universe.
...
### [40] [Binary neutron star mergers with a subsolar mass star](https://arxiv.org/abs/2603.25102)
*Maxence Corman,William E. East,Jocelyn S. Read*

Main category: astro-ph.HE

TL;DR: The study explores the merger dynamics of binary neutron stars with a subsolar mass component, revealing significant effects on ejected matter and deformation, but showing current gravitational wave detectors remain sensitive to these events.


<details>
  <summary>Details</summary>
Motivation: To determine if gravitational waves from binary mergers can confirm the existence of subsolar mass compact objects given the lack of conclusive observational evidence.

Method: The authors performed fully general-relativistic simulations of a $1.7 M_{	ext{⨀}}$ star merging with a $0.8 M_{	ext{⨀}}$ star, focusing on merger dynamics, gravitational and electromagnetic signals.

Result: Higher tidal deformabilities led to increased dynamically ejected matter and lower disruption frequencies, but current gravitational waveform models do not account for these factors.

Conclusion: Despite the unaccounted effects, the sensitivity of LIGO and Virgo detectors to detect these binary mergers remains unchanged for signal-to-noise ratios less than 100.
...
### [41] [Jet Power Estimates of FSRQs PKS 1441+25 and Ton 599 from Broadband SED Modeling](https://arxiv.org/abs/2603.25331)
*Hritwik Bora,Ranjeev Misra,Rukaiya Khatoon,Rupjyoti Gogoi*

Main category: astro-ph.HE

TL;DR: The study analyzes jet power in Flat-Spectrum Radio Quasars (FSRQs) using various particle distribution models, finding that jet power estimates are consistent across models, unlike in High Synchrotron Peaked Blazars (HBLs).


<details>
  <summary>Details</summary>
Motivation: To understand jet power dynamics in FSRQs and compare it with HBLs, focusing on how particle distribution models impact power estimates.

Method: Broadband spectral energy distribution (SED) modeling of FSRQs PKS 1441+25 and Ton 599 using observational data from Swift-XRT/UVOT, NuSTAR, Fermi-LAT, and VERITAS from 2015 and 2021, respectively, across four different particle distribution models.

Result: Jet power estimates from models with intrinsic curvature (log-parabola and energy-dependent) align with those from broken power-law distribution, indicating a consistency across these models for FSRQs.

Conclusion: FSRQs show relatively insensitive jet power estimates to particle energy distribution assumptions, contrasting with HBLs due to lower electron break energies and a stronger influence of external Compton processes.
...
### [42] [Double-Adiabatic Equations of State for Relativistic Plasmas](https://arxiv.org/abs/2603.25669)
*Agnieszka Wierzchucka,Pablo J. Bilbao,Alexander G. R. Thomas,Dmitri A. Uzdensky,Alexander A. Schekochihin*

Main category: astro-ph.HE

TL;DR: This paper derives adiabatic equations of state for isotropic and collisionless plasmas, including a relativistic extension, using first-principle symmetries.


<details>
  <summary>Details</summary>
Motivation: To provide a theoretical framework for understanding the pressure evolution in isotropic and anisotropic plasmas without heat flux or dissipation.

Method: Utilizing first-principle formalism and system symmetries to derive adiabatic laws for both isotropic plasmas and double-adiabatic scenarios for magnetised, collisionless plasmas.

Result: Recovery of known adiabatic equations for isotropic plasmas and formulation of double-adiabatic equations for collisionless plasmas, extended to relativistic conditions.

Conclusion: The derived double-adiabatic equations are relevant for both simple geometries and complex astrophysical phenomena, highlighting the role of pressure anisotropy.
...
### [43] [The Born Rule as the Unique Refinement-Stable Induced Weight on Robust Record Sectors](https://arxiv.org/abs/2603.24619)
*Marko Lela*

Main category: quant-ph

TL;DR: This paper establishes a uniqueness theorem for induced weight on robust record sectors in an admissible Hilbert record layer, differing from standard approaches by applying additivity to disjoint admissible continuation bundles.


<details>
  <summary>Details</summary>
Motivation: The study aims to explore conditions under which distinct forms of additivity can lead to unique induced weights in a specific mathematical framework, providing clarity on the relationship between sector weight and bundle valuation.

Method: The authors investigate disjoint admissible continuation bundles and establish conditions for induced sector weight via an extensive bundle valuation and binary refinement profiles.

Result: Under specified structural conditions, particularly regarding refinement profiles, the quadratic assignment emerges as the sole non-negative refinement-stable induced weight.

Conclusion: This work contributes a unique theorem that, under certain conditions, secures a distinctive additive law, reducing to the standard Born assignment when normalized.
...
### [44] [Implementing non-Abelian Hatano-Nelson model in electric circuits](https://arxiv.org/abs/2603.24642)
*Xiangru Chen,Jien Wu,Xingyu Chen,Zhenhang Pu,Yejian Hu,Jiuyang Lu,Manzhu Ke,Weiyin Deng,Zhengyou Liu*

Main category: quant-ph

TL;DR: This paper introduces a non-Abelian Hatano-Nelson model with a nonreciprocal U(2) gauge field, exploring new non-Hermitian phenomena not previously studied in artificial systems.


<details>
  <summary>Details</summary>
Motivation: The study aims to expand the understanding of non-Hermitian physics, particularly in systems incorporating gauge fields, to explore new phenomena and practical applications.

Method: The authors propose a model implementing a non-Abelian gauge field and examine its effects on energy spectra and specific non-Hermitian phenomena through electric circuits.

Result: The model demonstrates a Hopf-link-shaped complex energy braiding and exhibits bipolar skin effects, validated through experimental observations in electric circuits.

Conclusion: This research advances non-Hermitian physics and presents new opportunities for creating multifunctional non-Hermitian devices.
...
### [45] [Spectral methods: crucial for machine learning, natural for quantum computers?](https://arxiv.org/abs/2603.24654)
*Vasilis Belis,Joseph Bowles,Rishabh Gupta,Evan Peters,Maria Schuld*

Main category: quant-ph

TL;DR: Quantum computers may revolutionize machine learning by enhancing spectral methods that utilize the Fourier spectrum, which are essential for various ML models.


<details>
  <summary>Details</summary>
Motivation: To explore how quantum computing could lead to more efficient methods in machine learning, specifically through the manipulation of the Fourier spectrum.

Method: The paper discusses the application of Quantum Fourier Transform in generative ML models using quantum states, emphasizing the advantages over classical approaches.

Result: Quantum computing may enable new and resource-efficient methods for designing spectral properties in machine learning models.

Conclusion: The potential of quantum computing to improve machine learning invites researchers to focus on the foundational question of 'why quantum?' in this field.
...
### [46] [A versatile neural-network toolbox for testing Bell locality in networks](https://arxiv.org/abs/2603.24665)
*Antoine Girardin,Mohammad Massi Rashidi,Géraldine Haack,Nicolas Brunner,Alejandro Pozas-Kerstjens*

Main category: quant-ph

TL;DR: The paper presents a software solution using neural networks to parameterize local models in quantum networks, facilitating the determination of Bell nonlocality.


<details>
  <summary>Details</summary>
Motivation: The difficulty of confirming whether a quantum network's event distribution is Bell local necessitates innovative approaches.

Method: A software tool leverages neural networks to parameterize local models and employs optimization techniques for analyzing Bell nonlocality in networks.

Result: The approach reveals nonlocality in previously unexplored networks and provides insights into quantum nonlocal sets and possible realizations of quantum correlations.

Conclusion: The developed solution is user-friendly, technically advanced, and enhances performance, contributing to the understanding of nonlocal phenomena in quantum networks.
...
### [47] [Inequality for Strong-Weak Spontaneous Symmetry Breaking in Fermionic Open Quantum systems](https://arxiv.org/abs/2603.24671)
*Abhijat Sarma,Cenke Xu*

Main category: quant-ph

TL;DR: The paper explores how decoherence transforms an initial Gaussian fermionic state into a non-Gaussian mixed state, demonstrating that decoherence facilitates spontaneous symmetry breaking in fermionic quantum matter.


<details>
  <summary>Details</summary>
Motivation: To understand the impact of decoherence on fermionic states and its connection to symmetry breaking.

Method: An inequality is established relating Rényi-2 correlators of decohered states to those indicating spontaneous symmetry breaking in U(1) symmetry.

Result: Rényi-2 correlators of the decohered state are upper-bounded by those indicating strong-weak spontaneous symmetry breaking, regardless of decoherence strength.

Conclusion: Decoherence drives fermionic quantum matter toward U(1) spontaneous symmetry breaking, with implications for quantum materials such as spin Hall insulators and Dirac spin liquids.
...
### [48] [Multipartite entanglement dynamics in quantum walks](https://arxiv.org/abs/2603.24679)
*Emil K. F. Donkersloot,René Sondenheimer,Jan Sperling*

Main category: quant-ph

TL;DR: This study investigates multipartite entanglement in quantum walks, employing geometric measures for analysis in single and multi-walker setups, predicting entanglement dynamics, and showcasing typicality in random optical networks.


<details>
  <summary>Details</summary>
Motivation: Understanding multipartite entanglement in quantum walks is crucial for leveraging quantum advantages over classical systems in quantum information science.

Method: The paper presents methods to compute a geometric measure of entanglement for single and multiple walkers, utilizing numerical studies and exact analytical expressions for various initial conditions to explore the dynamics of entanglement in large systems.

Result: The study reveals explicit entanglement dynamics for given bipartitions and demonstrates the presence of entanglement typicality in ensembles of random optical networks.

Conclusion: The findings enhance comprehension of entanglement behavior in quantum walks, with implications for the efficiency of quantum systems over classical counterparts.
...
### [49] [Test of the essential collapse-locality loophole](https://arxiv.org/abs/2603.24909)
*Mónica Agüero,Juliana Bourdieu,Alejandro Hnilo,Marcelo Kovalsky,Myriam Nonaka*

Main category: quant-ph

TL;DR: This paper addresses the collapse-locality loophole in Bell's inequalities by presenting an optical experiment that closes this loophole, regardless of the quantum collapse theory.


<details>
  <summary>Details</summary>
Motivation: To explore the implications of the collapse-locality loophole in Bell's inequalities and the unknown time delay of photon detection due to quantum state collapse.

Method: Conducting an optical Bell test that utilizes classical signals for time referencing and maintains constant parameters while varying the distance between detection stations.

Result: The experiment successfully closes the essential form of the collapse-locality loophole, suggesting that past violations of Bell's inequalities could be due to superluminal signaling.

Conclusion: This work reinforces the importance of considering collapse-locality in discussions of quantum non-locality and the validity of Bell's theorem results.
...
### [50] [Causality is rare: some topological properties of causal quantum channels](https://arxiv.org/abs/2603.25315)
*Robin Simmons*

Main category: quant-ph

TL;DR: The paper explores the constraints of causality in quantum channels, demonstrating that causal channels form a set of measure zero within local channels, linking this to quantum information and recent QFT measurement models.


<details>
  <summary>Details</summary>
Motivation: To understand the extent of constraints imposed by causality in quantum operations within quantum field theory (QFT).

Method: The authors show that the set of causal channels is nowhere dense in local channels and that causal unitaries have Haar measure $0$ in the space of all unitaries on a lattice.

Result: The findings indicate that causal channels are significantly constrained within the broader framework of local channels, having a measure of zero in quantum operational contexts.

Conclusion: Causality imposes substantial limitations on quantum operations, which has important implications for quantum information theory and measurement models in QFT.
...
### [51] [Can every set of incompatible measurements lead to genuine multipartite steering?](https://arxiv.org/abs/2603.25345)
*Lucas E. A. Porto,Lucas Tendick,Daniel Cavalcanti,Roope Uola,Marco Túlio Quintino*

Main category: quant-ph

TL;DR: Measurement incompatibility is both necessary and sufficient for genuine multipartite steering with a single uncharacterized party, but this does not extend to scenarios with multiple uncharacterized parties.


<details>
  <summary>Details</summary>
Motivation: To explore the link between measurement incompatibility and genuine multipartite steering in multipartite settings, building on established bipartite results.

Method: Proving the necessity and sufficiency of incompatibility for genuine multipartite steering using specialized methods for multipartite correlations.

Result: Genuine multipartite steering can emerge from incompatible measurements with non-SLOCC equivalent states; however, this doesn't apply to cases with multiple uncharacterized parties where incompatible measurements may not lead to steering.

Conclusion: Incompatibility is crucial for genuine multipartite steering with one uncharacterized party, but its role is limited in scenarios with more than one such party.
...
TL;DR: The paper presents a stochastic multipath routing strategy for quantum repeater networks, enhancing entanglement distribution over lossy links.


<details>
  <summary>Details</summary>
Motivation: To improve entanglement distribution efficiency in quantum networks, existing methods are either too rigid or computationally demanding.

Method: A stochastic multipath rule sends requests randomly along several edge-disjoint paths, controlled by a bias parameter between short and long routes.

Result: An analytic model and simulations show that intermediate bias improves entanglement rates across various conditions, outperforming deterministic routing methods.

Conclusion: Stochastic multipath routing is an effective, lightweight control strategy for enhancing the performance of quantum repeater networks.
...
TL;DR: This paper enhances Quantum Computing Quantum Monte Carlo (QCQMC) methods to estimate excited-state spectra and finite-temperature observables, demonstrating improvements in energy accuracy across various domains.


<details>
  <summary>Details</summary>
Motivation: To extend QCQMC capabilities beyond ground-state energy and tackle excited states and finite-temperature scenarios effectively.

Method: Replace VQE with tailored unitaries for state preparation; implement Variational Fast Forwarding, VUMPO, and symmetry-preserving ansatz.

Result: Benchmarks show significant energy accuracy improvement due to the QMC diffusion step, achieving near-exact energies for weakly correlated systems and essential corrections for strongly correlated systems.

Conclusion: Haar-random basis state preparation within QCQMC can yield finite-temperature estimates from pure-state dynamics, indicating the method's versatility.
...
### [54] [Robust continuous-variable multipartite entanglement in circular arrays of nonlinear waveguides](https://arxiv.org/abs/2603.25610)
*Sugar Singh Meena,David Barral,Ankan Das Roy,Sunita Meena,Amit Rai*

Main category: quant-ph

TL;DR: The paper introduces a new protocol for generating robust multipartite entanglement using optical waveguides and provides a comprehensive theoretical framework for its implementation.


<details>
  <summary>Details</summary>
Motivation: To address challenges in generating robust multipartite entangled states in the optical domain for scalable quantum protocols.

Method: The proposed protocol utilizes spontaneous parametric down-conversion in a circular array of quadratic nonlinear waveguides, establishing a rigorous theoretical framework with propagation equations and conditions for full inseparability.

Result: The method successfully identifies the requisite pump and detection configurations that sustain multipartite inseparability across any number of waveguides and distances.

Conclusion: This approach is robust against variations in experimental conditions and offers a promising path for implementing scalable quantum protocols.
...
### [55] [Weighted Nested Commutators for Scalable Counterdiabatic State Preparation](https://arxiv.org/abs/2603.25625)
*Jialiang Tang,Xi Chen,Zhi-Yuan Wei*

Main category: quant-ph

TL;DR: The paper presents a new method, the weighted nested-commutator (WNC) ansatz, for efficient quantum state preparation using local operators, outperforming existing methods in various scenarios.


<details>
  <summary>Details</summary>
Motivation: Efficient quantum state preparation via counterdiabatic driving requires impractical adiabatic gauge potentials, motivating the need for a more feasible approach.

Method: The WNC ansatz approximates AGP using local operators with independent variational weights for nested commutators, allowing local optimization.

Result: The WNC ansatz is shown to systematically outperform the nested-commutator ansatz in preparing one-dimensional matrix product states and the ground state of a nonintegrable quantum Ising model.

Conclusion: CD driving based on the WNC ansatz significantly accelerates the preparation of 1D matrix product states and the 2D Affleck-Kennedy-Lieb-Tasaki state for large systems.
...
### [56] [Symplectic Split-Operator Propagators from Tridiagonalized Multi-Mode Bosonic Hilbert Spaces for Bose-Hubbard Hamiltonians](https://arxiv.org/abs/2603.25639)
*Denys I. Bondar,Ole Steuernagel*

Main category: quant-ph

TL;DR: The paper presents a method for tridiagonalizing bosonic multimode systems using number theory, resulting in efficient diagonalization and representation of large systems.


<details>
  <summary>Details</summary>
Motivation: To enhance the computational efficiency for diagonalizing complex bosonic multimode systems, allowing larger basis states than current methods permit.

Method: The authors employ number theory to convert optomechanical and Bose-Hubbard Hamiltonians into exact tridiagonal symmetric matrices, which can be diagonalized efficiently using sparse-matrix algorithms requiring $D 	imes 	ext{ln}(D)$ steps.

Result: The proposed method enables the handling of much larger systems compared to existing approaches, while facilitating a diagonal representation of symplectic split-operator propagators with minimal computational overhead for basis changes.

Conclusion: This innovative approach significantly enhances the capacity to analyze large bosonic multimode systems efficiently.
...
### [57] [Scalable Qauntum Interference from Indistinguishable Quantum Dots](https://arxiv.org/abs/2603.25684)
...
TL;DR: This paper presents a method for achieving scalable interference from multiple indistinguishable quantum dots on a single chip, overcoming limitations in solid-state emitters.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the challenge of scaling quantum interference from pairs to multiple indistinguishable photons, which is crucial for the advancement of photonic quantum technologies.

Method: The authors utilize wavefront shaping with programmable spatial light modulators to independently excite and collect light from distinct quantum dots that are spectrally identical.

Result: Successful interference was demonstrated with up to five indistinguishable emitters, evidenced by cooperative-emission phenomena and Hong-Ou-Mandel interference measurements.

Conclusion: This work establishes a pathway for developing large-scale, programmable quantum photonic systems, advancing the field of quantum technologies.
...
### [58] [Provably Efficient Long-Time Exponential Decompositions of Non-Markovian Gaussian Baths](https://arxiv.org/abs/2603.25708)
*Zhen Huang,Zhiyan Ding,Ke Wang,Jason Kaye,Xiantao Li,Lin Lin*

Main category: quant-ph

TL;DR: This paper explores the complexity of simulating Gaussian baths in non-Markovian environments, emphasizing the challenges posed by nonanalytic spectral densities.


<details>
  <summary>Details</summary>
Motivation: To understand the cost of accurate long-time simulation in non-Markovian environments, particularly with challenging spectral densities.

Method: The authors bound the complexity of representing bath correlation functions through sums of complex exponentials, showing how various factors like simulation time and spectral density characteristics influence this complexity.

Result: For many spectral densities, the number of required exponentials is independent of long simulation times, with complexities emerging only as polylogarithmic factors for specific singularities. Temperature effects are mild or negligible.

Conclusion: The primary challenge for long-time simulations is not duration but sharp nonanalytic features in the bath spectrum, with implications for various quantum systems and Langevin equations.
