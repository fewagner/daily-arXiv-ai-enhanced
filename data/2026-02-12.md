...
### [1] [Structural Theory of Information Backflow in Non-Markovian Relaxation: TC/TCL Formalism and Minimal Phase Diagrams](https://arxiv.org/abs/2602.09054)
*Koichi Nakagawa*
...
### [3] [Volume-law protection of metrological advantage](https://arxiv.org/abs/2602.09086)
...
### [4] [Almost all graphs are vertex-minor universal](https://arxiv.org/abs/2602.09049)
...
### [5] [Eigenstate Thermalization for Local versus Translationally Invariant Observables](https://arxiv.org/abs/2602.09087)
...
### [6] [Universality classes split by strong and weak symmetries](https://arxiv.org/abs/2602.09090)
...
### [8] [Quantum annealing and condensed matter physics](https://arxiv.org/abs/2602.09149)
...
### [12] [Framework for (non-)adiabatic chiral state conversion: from non-Hermitian Hamiltonians to Liouvillians](https://arxiv.org/abs/2602.09881)
...
### [13] [Universal Foundations of Thermodynamics: Entropy and Energy Beyond Equilibrium and Without Extensivity](https://arxiv.org/abs/2602.09986)
*Gian Paolo Beretta*
...
### [14] [Anyon Permutations in Quantum Double Models through Constant-depth Circuits](https://arxiv.org/abs/2602.10110)
*Yabo Li,Zijian Song*
...
### [15] [Surface code off-the-hook: diagonal syndrome-extraction scheduling](https://arxiv.org/abs/2602.09099)
...
### [16] [Constant-space-overhead fault-tolerant quantum input/output and communication](https://arxiv.org/abs/2602.09103)
...
### [17] [Quantum Phaselift](https://arxiv.org/abs/2602.09119)
...
### [18] [Quantum State Characterization of Gravitational Waves via Graviton Counting Statistics](https://arxiv.org/abs/2602.09125)
...
### [21] [A Trainable-Embedding Quantum Physics-Informed Framework for Multi-Species Reaction-Diffusion Systems](https://arxiv.org/abs/2602.09291)
...
### [22] [Architectural Foundations for Checkpointing and Restoration in Quantum HPC Systems](https://arxiv.org/abs/2602.09325)
...
### [23] [Spin-entanglement of an atomic pair through coupling to their thermal motion](https://arxiv.org/abs/2602.09327)
...
### [24] [Compressing Quantum Fisher Information](https://arxiv.org/abs/2602.09358)
...
### [25] [Surrogate-Guided Quantum Discovery in Black-Box Landscapes with Latent-Quadratic Interaction Embedding Transformers](https://arxiv.org/abs/2602.09374)
...
### [26] [The Trouble with Weak Values](https://arxiv.org/abs/2602.09380)
*Jacob A. Barandes*
...
### [27] [Separating Quantum and Classical Advice with Good Codes](https://arxiv.org/abs/2602.09385)
...
### [28] [Efficient and deterministic high-dimensional controlled-swap gates on hybrid linear optical systems with high fidelity](https://arxiv.org/abs/2602.09393)
...
### [29] [Near-optimal entanglement-communication tradeoffs for remote state preparation](https://arxiv.org/abs/2602.09428)
...
### [30] [Resources of the advantage in quantum Illumination: Discord and entanglement](https://arxiv.org/abs/2602.09468)
...
### [31] [Rigorous no-go theorems for heralded linear-optical state generation tasks](https://arxiv.org/abs/2602.09495)
...
### [32] [Fidelity-Age-Aware Scheduling in Quantum Repeater Networks](https://arxiv.org/abs/2602.09562)
...
### [33] [Amplitude-Phase Separation toward Optimal and Fast-Forwardable Simulation of Non-Unitary Dynamics](https://arxiv.org/abs/2602.09575)
*Qitong Hu,Shi Jin*
...
### [34] [Device-independent quantum key distribution over 100 km with single atoms](https://arxiv.org/abs/2602.09596)
...
### [35] [Strategy optimization for Bayesian quantum parameter estimation with finite copies: Adaptive greedy, parallel, sequential, and general strategies](https://arxiv.org/abs/2602.09655)
...
### [36] [Quantum-accelerated conjugate gradient methods via spectral initialization](https://arxiv.org/abs/2602.09696)
...
### [37] [Sample- and Hardware-Efficient Fidelity Estimation by Stripping Phase-Dominated Magic](https://arxiv.org/abs/2602.09710)
...
### [38] [SAQNN: Spectral Adaptive Quantum Neural Network as a Universal Approximator](https://arxiv.org/abs/2602.09718)
...
### [39] [Error-mitigated quantum state tomography using neural networks](https://arxiv.org/abs/2602.09733)
...
### [40] [Beyond Sparsity: Quantum Block Encoding for Dense Matrices via Hierarchically Low Rank Compression](https://arxiv.org/abs/2602.09745)
*Kun Tang,Jun Lai*
...
### [41] [Questioning the reasonableness of the quantum nonlocality debate](https://arxiv.org/abs/2602.09758)
...
### [42] [Construction of the full logical Clifford group for high-rate quantum Reed-Muller codes using only transversal and fold-transversal gates](https://arxiv.org/abs/2602.09788)
...
### [43] [$k$-Positivity and high-dimensional bound entanglement under symplectic group symmetry](https://arxiv.org/abs/2602.09860)
*Sang-Jun Park*
...
### [44] [Polycontrolled PROPs for Qudit Circuits: A Uniform Complete Equational Theory For Arbitrary Finite Dimension](https://arxiv.org/abs/2602.09873)
*Colin Blake*
...
### [45] [Simpler Presentations for Many Fragments of Quantum Circuits](https://arxiv.org/abs/2602.09874)
*Colin Blake*
...
### [46] [The quantum multinomial distribution: a combinatorial formulation of multiphoton interference](https://arxiv.org/abs/2602.09894)
...
### [47] [Gravitationally-induced Conversion of Local Coherence to Entanglement](https://arxiv.org/abs/2602.09900)
...
### [48] [Protection of quantum steering ellipsoids in non-Markovian environments](https://arxiv.org/abs/2602.09903)
...
### [49] [Tucker iterative quantum state preparation](https://arxiv.org/abs/2602.09909)
...
### [50] [Dissipative phase transitions of the Dicke-Ising model](https://arxiv.org/abs/2602.09912)
...
### [51] [Information Theory of Action : Reconstructing Quantum Dynamics from Inference over Action Space](https://arxiv.org/abs/2602.09984)
...
### [52] [Emergence of a Luttinger Liquid Phase in an Array of Chiral Molecules](https://arxiv.org/abs/2602.10002)
...
### [53] [Preventing Barren Plateaus in Continuous Quantum Generative Models](https://arxiv.org/abs/2602.10049)
...
### [54] [An Interactive Metrics Dashboard for the Keck Observatory Archive](https://arxiv.org/abs/2602.09126)
...
### [55] [Spectral response of SPHEREx](https://arxiv.org/abs/2602.09139)
...
### [56] [NIAC project report: Solar system-scale VLBI to dramatically improve cosmological distance measurements](https://arxiv.org/abs/2602.09141)
...
### [57] [astromorph: Self-supervised machine learning pipeline for astronomical morphology analysis](https://arxiv.org/abs/2602.09223)
...
### [58] [A new strategy for achieving multiple continuous cooling stages in an adiabatic demagnetization refrigerator](https://arxiv.org/abs/2602.09513)
...
### [59] [Talking with the Latents -- how to convert your LLM into an astronomer](https://arxiv.org/abs/2602.09670)
...
### [60] [The Pollux European instrument concept for HWO: a high-resolution spectrograph and spectropolarimeter from the far-UV to the near-IR](https://arxiv.org/abs/2602.09828)
...
### [61] [Reference File Updates Following the Application of New Geometric Distortion and Walk Corrections I: Overview](https://arxiv.org/abs/2602.09917)
...
### [62] [Operational Mass Measurement for Flyby Reconnaissance Missions of Potentially Hazardous Asteroid](https://arxiv.org/abs/2602.10040)
