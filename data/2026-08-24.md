...
TL;DR: The study analyzes the binary AGN candidate SDSS J095036.75+512838.1 through multiwavelength data to investigate its accretion properties and assess the binary SMBH hypothesis.


<details>
  <summary>Details</summary>
Motivation: To probe the accretion characteristics of SDSS J095036 and test whether it is a binary SMBH system based on observed spectral anomalies.

Method: Utilized infrared-to-X-ray observations, including recent Chandra data, to characterize the X-ray emission and build a comprehensive multiwavelength spectral energy distribution (SED).

Result: The X-ray spectrum is consistent with a single AGN; however, anomalies in the SED such as infrared excess and UV deficits suggest complex behaviors, with reddening explaining some but not all spectral features.

Conclusion: The SED aligns with a single, reddened AGN model, while future high-resolution observations are essential to further investigate the infrared excess and the binary SMBH scenario.
...
TL;DR: This study reports the first X-ray detection of the supernova impostor AT 2016blu in NGC 4559, revealing its outbursts are likely due to a massive star in an eccentric binary system.


<details>
  <summary>Details</summary>
Motivation: The study aims to enhance understanding of the mechanisms driving outbursts in supernova impostors, specifically the role of binary interactions.

Method: Utilized archival Chandra observations and a Target of Opportunity program to monitor AT 2016blu's variability and obtain X-ray data.

Result: AT 2016blu exhibited 27 quasiperiodic outbursts with an X-ray luminosity of approximately 38.64 erg/s and an accretion rate indicative of a compact companion.

Conclusion: AT 2016blu is identified as the first LBV SN impostor with outbursts likely driven by intermittent accretion onto a compact object, resembling a high-mass X-ray binary.
...
TL;DR: The paper investigates relativistic radio-galaxy jets, focusing on FR~I jet morphologies and their evolution in varying ambient media, using relativistic magnetohydrodynamic simulations.


<details>
  <summary>Details</summary>
Motivation: To understand the morphological difference and dynamics of FR~I and FR~II jets in relation to their ambient environments.

Method: 2D and 3D relativistic magnetohydrodynamic simulations of magnetized jets in stratified media with various ambient profiles.

Result: Findings include a kink-stability criterion based on jet power and ambient pressure, and that recollimation shocks produce distinct brightness features in emission maps.

Conclusion: The study elucidates how different jet conditions lead to varying morphologies, specifically highlighting the characteristics of FR~I jets compared to jet features resembling HST-1 of the M87 jet.
...
TL;DR: This study investigates the impact of compact dark matter halos on X-ray reflection spectroscopy used for measuring black hole spin, finding that such halos can shift line profiles and introduce measurement uncertainties.


<details>
  <summary>Details</summary>
Motivation: To examine the environmental effects of compact dark matter halos on the accuracy of black hole spin and accretion geometry measurements via X-ray reflection spectroscopy.

Method: Implemented numerical black hole-dark matter spacetime models and conducted general-relativistic ray-tracing calculations to analyze Fe Kα line profiles.

Result: Compact dark matter halos were shown to shift observed line energies lower than those predicted by Kerr models, leading to discrepancies in inferred black hole spin and inclination.

Conclusion: Compact dark matter halos could introduce significant uncertainties in reflection-based measurements, but including these factors in models could help constrain dark matter halo properties.
...
TL;DR: GRB 220101A is a long gamma-ray burst with over $10^{54}$ erg energy at redshift $z=4.61$, interpreted via a Binary driven peta nova (BdP-N) model involving a massive, magnetized CO core, a neutron star, and a white dwarf, leading to multiple energetic episodes of stellar evolution and emissions.


<details>
  <summary>Details</summary>
Motivation: To propose an explanation for the extreme energy and multi-wavelength emission characteristics of GRB 220101A using a novel astrophysical model.

Method: The BdP-N model describes a sequence of events starting from the collapse of a magnetized CO core, triggering multiple supernova episodes and interactions that encompass the long GRB process.

Result: The study outlines seven distinct episodes, including a unique pair supernova, the formation of a new neutron star, and a black hole, culminating in various emissions observed across different wavelengths.

Conclusion: The sequence of energetic events and interactions provides insight into the mechanisms driving GRB 220101A, suggesting a complex interplay of stellar bodies in a binary system leading to the observed phenomena.
...
TL;DR: The paper reviews X-ray pulsars, focusing on their accretion mechanisms, pulse profile characteristics, and the interplay between observations and theoretical models.


<details>
  <summary>Details</summary>
Motivation: To provide a comprehensive overview of the physics behind X-ray pulsations in magnetized neutron stars and their accretion processes.

Method: The paper discusses different accretion mechanisms and observational techniques to analyze X-ray pulsar pulse profiles, emphasizing the relationship between X-ray luminosity, energy, and theoretical models.

Result: It summarizes the dependency of pulse profiles on various factors, including luminosity and space-time properties around neutron stars, while highlighting gaps in current understanding.

Conclusion: Future studies are needed to enhance observational techniques and develop more robust theoretical models regarding magnetic accretion in neutron stars.
...
TL;DR: This paper presents new atomic data for Neodymium relevant to the opacity and spectra of kilonovae from neutron star mergers, focusing on ionization stages, recombination rates, and excitation processes.


<details>
  <summary>Details</summary>
Motivation: To improve the understanding of Neodymium's role in kilonovae by providing essential atomic data for non-LTE modelling.

Method: Utilization of the {	extsc autostructure} code to compute energy levels, radiative and dielectronic recombination rates, and excitation data for the first five ionization stages of Neodymium.

Result: Demonstrated that resonance-mediated excitation significantly enhances collision strengths, especially for low-charge ions, and identified that dielectronic recombination dominates at higher ionization stages across various temperatures.

Conclusion: The findings underscore the importance of non-LTE atomic physics in analyzing kilonovae and improving our ability to connect electromagnetic signals to the mechanisms of compact object mergers and heavy element generation.
...
TL;DR: The paper explores how repulsive interactions from a dark-sector vector portal can modify the equation of state (EOS) of hyperonic neutron stars, potentially supporting the existence of two-solar-mass stars.


<details>
  <summary>Details</summary>
Motivation: To address the challenge posed by hyperons softening the EOS and the existence of observed two-solar-mass neutron stars.

Method: The baryonic sector is modeled using modified quark-meson coupling (MQMC), with baryons interacting through σ, ω, and ρ fields. The dark sector includes fermionic dark matter interacting via a neutral vector mediator Z′, enhancing the EOS with additional repulsive pressure.

Result: The enhanced EOS leads to mass-radius relations that accommodate observed massive pulsars, including PSR J0740 + 6620, with maximum neutron star masses around 2 M⊙. It also yields changes in tidal deformability and moment of inertia.

Conclusion: These findings suggest new ways to test dark-sector interactions through multimessenger observations of neutron stars.
...
TL;DR: This study explores the accretion-induced collapse of a rotating white dwarf, examining its potential role in neutron-star formation and stellar nucleosynthesis.


<details>
  <summary>Details</summary>
Motivation: The research investigates an alternative mechanism for neutron-star formation via the accretion-induced collapse of a white dwarf, emphasizing the significance of magnetism and rotation in this process.

Method: Five 3D general-relativistic neutrino-(magneto)hydrodynamic simulations of AIC were used, assessing the impact of different initial rotation rates on nucleosynthesis through a nuclear reaction network.

Result: Results show that ejecta mass and nucleosynthesis outcomes improve with higher rotation rates and stronger magnetic fields; notably, the highest rotation model achieved an $r$-process abundance peak at mass $A 	ext{≈} 130$.

Conclusion: Rapidly rotating, magnetised AIC events might significantly contribute to the Galactic abundance of trans-iron and weak $r$-process elements, though no robust third $r$-process peak was observed.
...
TL;DR: This study presents an extensive analysis of diffuse X-ray emissions from the Westerlund 1 star cluster, highlighting the contributions from point sources and various emission mechanisms.


<details>
  <summary>Details</summary>
Motivation: To understand stellar feedback on the interstellar medium in Westerlund 1, particularly through the analysis of diffuse X-ray emissions.

Method: Analyzed 36 Chandra ACIS-I observations, removing point sources, correcting for background, and applying spectral fitting to characterize the diffuse emissions in different energy bands.

Result: Identified shocked thermal plasma in the core with high temperatures and charge-exchange emission in the outer region. Total diffuse luminosity measured at ~9.6x10^33 erg/s, indicating a low-density intracluster medium and subluminous X-ray emissions compared to other clusters.

Conclusion: The study suggests a low wind-to-X-ray efficiency, emphasizing that the diffuse X-ray emission from Westerlund 1 is comparatively weak.
...
TL;DR: This paper presents CtaAgnVar, a new analysis pipeline for studying blazar variability using CTAO data, which can detect high-energy emission patterns with high precision.


<details>
  <summary>Details</summary>
Motivation: Blazars are crucial for understanding the physics of black holes and jets, and the CTAO aims to enhance our ability to study their variability at very high energies.

Method: CtaAgnVar is a Python-based pipeline developed on Gammapy that simulates the full observational process for blazars, providing tools for variability analysis and reconstructing light curves and spectra.

Result: Simulations indicate that CTAO can recover periodic high-energy emissions in blazar PG 1553+113, detecting this periodicity above 5 sigma after 15 years of observations at a specified cadence.

Conclusion: The developed pipeline significantly enhances observational sensitivity and enables precise variability analysis of blazars, potentially revolutionizing high-energy astrophysics.
...
TL;DR: The paper presents an enhanced BEANSP package for analyzing thermonuclear X-ray bursts, introducing an efficient ensemble mode and demonstrating its application to specific sources, revealing key insights and limitations in deducing neutron star properties.


<details>
  <summary>Details</summary>
Motivation: To improve the understanding of host neutron stars from thermonuclear X-ray bursts amid challenges of incomplete data and complex parameter spaces.

Method: Development of the BEANSP package with a new ensemble analysis mode, tested on GS 1826-24 and simulated data, alongside an extended study of SRGA J144459.2-604207 using SETTLE model predictions.

Result: Good agreement with previous studies for GS 1826-24 and reasonable parameter recovery in simulations, but limitations observed in distance, mass, and radius estimations; specific H-fraction and CNO metallicity found for SRGA J144459.2-604207.

Conclusion: Inferred neutron star properties may not be accurately represented due to model limitations; further research with improved models is needed.
...
TL;DR: The paper explores connections between ultra-high-energy (UHE) neutrinos and UHE photons, proposing a mechanism that links their production through neutrino-nucleon interactions in compact astrophysical environments.


<details>
  <summary>Details</summary>
Motivation: Recent detections of UHE neutrinos and TeV-PeV photons suggest extreme environments that can accelerate particles to ultra-high energies, warranting an investigation into their interrelation.

Method: The authors calculate UHE photon production from neutrino-nucleon interactions, particularly in optically thin regions of dense astrophysical environments, focusing on how secondary parton interactions lead to pion decay into photons.

Result: For (anti)neutrinos above 1 PeV, they find over 13% probability for producing photons above 1 TeV. This model accounts for the preburst TeV photons in GRB 221009A, explaining their energy and lead times effectively.

Conclusion: The study establishes a viable link between UHE neutrino events and gamma-ray observations, enhancing understanding of hadronic processes in extreme environments and advancing multi-messenger astronomy.
...
TL;DR: This paper analyzes the radio transient VT J1906+0849, linking its unique characteristics to a possible young microquasar scenario.


<details>
  <summary>Details</summary>
Motivation: To understand the unusual properties and origins of the radio transient VT J1906+0849, detected as a bright source in the VLASS after being non-detected in previous surveys.

Method: A comprehensive multiwavelength analysis including radio observations, near-infrared spectroscopy, and very high-resolution imaging was conducted to study the source's behavior, properties, and potential origins.

Result: VT J1906+0849 exhibits a declining radio luminosity with a potential rebrightening, lacks X-ray emissions typical of known Galactic binaries, and features a unique spectral behavior suggestive of synchrotron emission with a possible persistent high-speed outflow.

Conclusion: The characteristics of VT J1906+0849 align it closely with a young microquasar model, where jets interact with a wind, explaining its compact nature and low X-ray activity.
...
### [15] [Ion Irradiation of GridPix Detector at Bonn Isochronous Cyclotron](https://arxiv.org/abs/2608.20987)
...
TL;DR: The paper describes irradiation tests on the GridPix detector for the EXPO X-ray polarimeter, assessing performance under proton and nitrogen ion beams, showing robustness against radiation damage.


<details>
  <summary>Details</summary>
Motivation: To certify the performance of the GridPix detector in high-radiation environments expected for future X-ray polarimetry applications.

Method: Irradiation tests were conducted using proton and nitrogen ion beams at the Bonn Isochronous Cyclotron to evaluate the detector's performance and reliability under different radiation conditions.

Result: Ion rates experienced during tests exceeded expected limits without notable performance degradation of the detector chip.

Conclusion: The GridPix detector demonstrates resilience and maintained functionality after exposure to high radiation levels, confirming its suitability for the EXPO mission.
...
### [16] [Reconstruction Bias in Timepix4 Subpixel Centroiding for Electron Imaging](https://arxiv.org/abs/2608.21072)
*Nina Dimova,Richard Plackett,Daniela Bortoletto*

Main category: physics.ins-det

TL;DR: This paper proposes a new framework for understanding subpixel centroiding in electron imaging, emphasizing the limitations of localization accuracy on modulation transfer function and virtual-pixel rebinning.


<details>
  <summary>Details</summary>
Motivation: The need to improve spatial resolution in hybrid pixel detectors for electron imaging by accurately determining interaction positions within entry pixels.

Method: A unified interpretation of centroid estimators as solving a non-unique inverse problem, considering entry-phase-dependent reconstruction bias and its impact on imaging performance.

Result: Evaluation via simulated and measured data shows varying MTFs and rebinned flat-field behaviors for different centroiding strategies, despite similar localization accuracies.

Conclusion: Future centroid optimization should factor in subpixel phase bias and rebinnability, not just localization accuracy.
...
### [17] [Preventing quart-NaI adhesion in Bridgman growth using ammonium iodide](https://arxiv.org/abs/2608.21171)
*Lam Tan Truc,N. T. Luan,Gul Rooh,O. Gileva,K. A. Shin,H. S. Lee,A. Iltis,C. R. Byeon,C. H. Lee,H. J. Kim*

Main category: physics.ins-det

TL;DR: This study addresses adhesion issues in NaI(Tl) crystal growth by using NH4I to inhibit unwanted reactions, resulting in larger, high-quality crystals for dark matter applications.


<details>
  <summary>Details</summary>
Motivation: To overcome the adhesive challenges encountered during Bridgman growth of NaI(Tl) crystals in sealed conditions, crucial for high-purity scintillators.

Method: NH4I is introduced as an additive to generate HI, suppressing the formation of adhesive sodium silicate during the growth process. Small crystals were grown to ascertain the optimal NH4I concentration before applying it to larger crystal growth.

Result: A large NaI(Tl) crystal measuring 3 inches in diameter and 3 inches in length was successfully grown without cracks or bubbles, achieving a light output of 59,000 photons/MeV, surpassing that of commercial reference crystals.

Conclusion: The addition of NH4I effectively mitigates adhesion problems, enabling the growth of high-quality NaI(Tl) crystals suitable for ultra-radiopure applications.
...
### [18] [Comment on "Scalable Quantum Machine Learning: Trainability, Expressivity and Efficiency": Polynomial Evaluation of the Triplet-Block Readout](https://arxiv.org/abs/2608.20435)
*Erfan Amidi*

Main category: quant-ph

TL;DR: This paper critiques the complexity claim of a classical algorithm for triplet-block two-body readout, showing a more efficient deterministic algorithm for correlators based on reduced density matrices.


<details>
  <summary>Details</summary>
Motivation: To address the classical-cost claim tied to triplet-block two-body readout and show that existing algorithms can be refined.

Method: Utilizes passive fermionic linear optics on a computable diagonal two-particle reduced density matrix, resulting in a deterministic polynomial-time algorithm for correlator vectors.

Result: Demonstrates an $O(n^4)$ algorithm for the correlator vector $(\langle n_i n_j\rangle)_{i<j}$, independent of the triplet-block input size.

Conclusion: Polynomials can be computed efficiently for fixed-body observables, challenging previous conclusions about computational limits in supervised two-body readout.
...
### [19] [Granthi: Higher-Order Quantum Programming via Unitary Wiring](https://arxiv.org/abs/2608.20443)
*Samson Abramsky,Radha Jagadeesan*

Main category: quant-ph

TL;DR: Granthi is a higher-order quantum programming language that allows first-class quantum programs and preserves superposition in control flow, enabling more flexible quantum programming without classical limitations.


<details>
  <summary>Details</summary>
Motivation: Existing quantum programming languages limit quantum operations to first-order and bind them to classical constructs, which restricts flexibility and expressiveness in quantum programming.

Method: Granthi employs a purely unitary design where quantum programs are first-class values, allows tag-preserving routing for control flow, and provides named reversible operations for better domain-level control while avoiding explicit tag management.

Result: The compiler converts well-typed terms into quantum circuits, ensuring that each term denotes a unitary operation and realizes its wiring correctly on physical qubits using the pytket backend.

Conclusion: Granthi supports advanced quantum programming features, including quantum switches and structured control flow, all while maintaining a purely unitary framework conducive to higher-order quantum computations.
...
### [20] [Practical Error Suppression and Mitigation for Reliable Quantum Computing](https://arxiv.org/abs/2608.20453)
*Han-Ze Li,Mengjie Yang,Xianquan Yan,Dax Enshan Koh,Ching Hua Lee,Ruizhe Shen*

Main category: quant-ph

TL;DR: This paper reviews techniques for error suppression and mitigation in the transition phase between noisy intermediate-scale quantum processing and fault-tolerant quantum computation.


<details>
  <summary>Details</summary>
Motivation: The paper aims to synthesize different error management strategies as complementary methods to enhance computational reliability in quantum computing.

Method: It provides an overview of error sources, suppression methods, and mitigation strategies, focusing on their practical implementation in quantum processors.

Result: Enhanced understanding of how to combine various error management techniques to tackle residual errors in quantum computations at the NISQ-FTQC transition.

Conclusion: The integration of error suppression methods with quantum error correction can significantly improve computation accuracy in quantum systems.
...
### [21] [Minimization of micromotion for nanoparticles in a Paul trap](https://arxiv.org/abs/2608.21011)
*Jamie Morley,Jean Paul Louys Sansó,Dmitry Bykov,Simon Baier,Tracy Northup*

Main category: quant-ph

TL;DR: The paper addresses and experimentally demonstrates methods to minimize excess micromotion of nanoparticles in a Paul trap, enhancing localization precision and reducing decoherence effects.


<details>
  <summary>Details</summary>
Motivation: Excess micromotion in Paul traps contributes to heating, localization limits, and decoherence in quantum experiments, necessitating effective compensation methods.

Method: The authors present and validate three distinct experimental methods for reducing micromotion of a nanoparticle in a linear Paul trap across three axes.

Result: The most effective method achieved stray field nullification to within 2.9 V/m, comparable to values in trapped-ion experiments, showcasing significant improvements in micromotion compensation.

Conclusion: The demonstrated techniques offer a standardized approach for micromotion compensation, enhancing the precision of particle localization and reducing decoherence risks in quantum mechanical systems.
...
### [22] [To Scale Up or To Scale Out: Evaluating Space-Time Costs of Compiled Logical Circuits on Modular Superconducting Quantum Processors](https://arxiv.org/abs/2608.20462)
*Nikiforos Paraskevopoulos,Sebastian de Bone,Mick Christophersen,Simon Storz,A. Mert Bozkurt,Arno Bargerbos,Sebastian Feld*

Main category: quant-ph

TL;DR: This paper evaluates two strategies for scaling superconducting quantum processing units: chiplet-based and distributed architectures, highlighting the performance penalties of distributed systems.


<details>
  <summary>Details</summary>
Motivation: Modular integration is vital for scaling superconducting QPUs, addressing challenges related to fabrication yield and physical footprint restrictions.

Method: A quantitative stress test measuring execution costs of random logical entangling operations was conducted using a surface code scheme, analyzing space-time costs as network nodes increase.

Result: Distributed architectures experience an exponential space-time performance penalty relative to monolithic designs, with distinct scaling regimes emerging as network size grows.

Conclusion: The performance impact of distributed architectures is influenced by both noise factors related to fidelity and generation rates, as well as connectivity issues from routing congestion.
...
### [23] [Collective Quantum Logic Spectroscopy](https://arxiv.org/abs/2608.20471)
*Raphael Kaubruegger,Matthew Patkowski,Yicheng Zhang,Robert J. Lewis-Swan,David B. Hume,Ana Maria Rey*

Main category: quant-ph

TL;DR: The paper discusses a scalable framework for trapped-ion quantum sensors, focusing on collective quantum logic spectroscopy that addresses challenges in precision measurements and state detection.


<details>
  <summary>Details</summary>
Motivation: Scaling trapped-ion quantum sensors to improve precision measurements while overcoming limitations of ion species lacking suitable transitions for cooling and state detection.

Method: Collective quantum logic spectroscopy is employed, coupling ensembles of spectroscopy ions with logic ions for sympathetic cooling and state readout.

Result: Identified performance limits and operating regimes, showing that a single logic ion retains quantum-limited sensitivity, while more logic ions improve efficiency and robustness.

Conclusion: Collective quantum logic spectroscopy is a scalable framework applicable to optical clocks, quantum sensing, and quantum information processing.
...
### [24] [Energetics in daemonic work extraction protocols via non-ideal QND-energy measurement](https://arxiv.org/abs/2608.20487)
*Daniele Morrone,Francesco Albarelli,Vittorio Giovannetti,Mauro Paternostro,Marco G. Genoni*

Main category: quant-ph

TL;DR: This paper explores the limitations of work extraction from a quantum system using quantum non-demolition measurements when the auxiliary bath has a finite temperature.


<details>
  <summary>Details</summary>
Motivation: To understand how the performance of quantum work-extraction protocols deteriorates under non-ideal conditions, particularly finite temperature baths, compared to ideal conditions.

Method: The authors implement a work-extraction protocol and evaluate its performance in scenarios with finite temperature baths, considering both measurement and erasure costs. They introduce the concept of daemonic net gain to quantify work extraction efficiency.

Result: They establish that with a thermal bath, the daemonic net gain is always non-positive, indicating energy extraction is not feasible; whereas with unitary operations alone, it can yield positive values.

Conclusion: The study highlights how thermal effects limit the efficiency of work extraction in quantum systems, emphasizing the significant role of the thermal bath temperature in quantum measurement strategies.
...
### [25] [Nonlinear Diamagnetic Interactions in Ultrastrongly Coupled 2D Electrons](https://arxiv.org/abs/2608.20578)
...
TL;DR: This paper investigates the reduction of the diamagnetic response in Landau polaritons under strong terahertz fields, leading to a proposed nonlinear extension of the quantum Hopfield model.


<details>
  <summary>Details</summary>
Motivation: The motivation stems from understanding the modifications in the diamagnetic response of light-matter interactions under strong external fields, particularly in relation to traditional models.

Method: Experimental observation of Landau polaritons' diamagnetic response with varying terahertz field excitation, supported by a microscopic hot-electron model to explain the nonlinear behavior and a proposed nonlinear Hopfield model.

Result: The diamagnetic response was found to decrease under strong terahertz excitation, attributed to electron redistribution in the conduction band of GaAs, validated by experimental data and a theoretical model.

Conclusion: This research paves the way for advancements in cavity quantum electrodynamics, suggesting a nonlinear framework for exploring quantum optical phenomena such as squeezed light.
...
### [26] [Clifford-efficient sparse state preparation for molecular wavefunctions](https://arxiv.org/abs/2608.20593)
...
TL;DR: This paper introduces a method for efficient sparse quantum state preparation by leveraging affine relationships over GF(2) to minimize qubit and gate count during the encoding process.


<details>
  <summary>Details</summary>
Motivation: Existing methods for sparse quantum state preparation focus on compressing selected basis states into a smaller set of qubits, but they rely on permutation-based techniques that may not optimize resource usage.

Method: The proposed method utilizes invertible affine transformations over the finite field GF(2) for better compression, reducing the dense register size with Clifford gates only and no ancillary qubits. An optional binary encoding further minimizes qubits at the expense of additional gates.

Result: The method achieves the fewest ancillary qubits compared to other approaches while keeping non-Clifford gate counts similar when binary encoding is applied, particularly effective for wavefunctions from configuration interaction calculations.

Conclusion: This affine transformation approach significantly enhances resource efficiency in preparing sparse quantum states, especially in chemical applications where patterns in wavefunctions provide beneficial relationships.
...
### [27] [Scaling Behavior of Parameterized Quantum Circuits from a Lie-Algebraic Perspective](https://arxiv.org/abs/2608.20603)
*Hiroshi Ohno*

Main category: quant-ph

TL;DR: This study analyzes how the performance of parameterized quantum circuits relates to their resources and dimensions, highlighting the Jacobian effective dimension as a key scaling parameter.


<details>
  <summary>Details</summary>
Motivation: The study aims to characterize the trainability and capacity of parameterized quantum circuits by understanding how their performance scales with available resources.

Method: A numerical investigation of data scaling, model scaling, and compute scaling in parameterized quantum circuits is conducted, examining Lie-algebraic quantities along with traditional parameter counts.

Result: Results show decreased loss with increased training data size, parameter size, and optimization iterations, with notable behaviors in dynamical Lie algebra and Jacobian effective dimensions.

Conclusion: The Jacobian effective dimension is a geometry-aware measure of observable degrees of freedom, proving useful for scaling analysis in quantum circuits.
...
### [28] [Predicting Resource Efficient Hamiltonian Decomposition for Continuous-Time Quantum Walk Simulations](https://arxiv.org/abs/2608.20660)
*Mostafa Atallah,Rebekah Herrman,Zain H. Saleem*

Main category: quant-ph

TL;DR: This study evaluates two Hamiltonian decompositions for quantum walk simulations on graphs, using machine learning to predict which results in fewer critical CX gates.


<details>
  <summary>Details</summary>
Motivation: Optimizing Hamiltonian decompositions is essential for efficient quantum simulations on current hardware, as minimizing CX gate counts reduces error and runtime.

Method: The authors trained machine learning models on 11,117 connected eight-vertex graphs, using features like graph topology and characteristics of the decompositions to predict the better method for reducing CX gate counts.

Result: The model achieves a Matthews correlation coefficient (MCC) of 0.593 after tuning, with significant predictive power derived from decomposition counts rather than intrinsic graph properties; performance improved when applied to larger graphs.

Conclusion: A single-hidden-layer neural network effectively predicts the preferable decomposition for a range of graph sizes, indicating the model's generalizability for optimizing quantum circuits.
...
### [29] [Continuous-angle logical rotations in the Steane code](https://arxiv.org/abs/2608.20676)
*Eric Huang,Daiwei Zhu,Matteo Ippoliti,Christopher Monroe,Michael J. Gullans*

Main category: quant-ph

TL;DR: This paper demonstrates continuous-angle logical $Z$ rotations using the $[[7,1,3]]$ Steane code on an IonQ trapped-ion processor, analyzing the effects of dephasing noise and validating the protocol through experimental observations.


<details>
  <summary>Details</summary>
Motivation: Exploring fault-tolerant quantum computation with continuously tunable logical gates is crucial for advancing practical quantum error correction and logic operations.

Method: The protocol involves a transversal physical $Z$ rotation, syndrome extraction, and decoding to achieve logical $Z$ rotation, followed by logical Ramsey interferometry measurements to observe the effects of dephasing noise and logical rotation angles.

Result: The experimental results show coherent, syndrome-dependent logical rotations and the logical channel behaves as a noisy $Z$ rotation consistent with a dephasing model, including successful cancellation of angles with low dephasing.

Conclusion: This work serves as a proof-of-principle for implementing continuously tunable non-Clifford logical gates via transversal rotations and standard error correction in small quantum codes.
...
### [30] [Quantum Zeno and Anti-Zeno Responses: Universal Spectral Criterion for Measurement-Induced Decay](https://arxiv.org/abs/2608.20702)
*Yu-Xiang Chen,Yuan-De Jin,Wen-Long Ma*

Main category: quant-ph

TL;DR: The paper presents a framework for understanding how repetitive quantum measurements affect evolving quantum systems, focusing on the role of the Liouvillian spectral gap in determining measurement-induced decay rates and differentiating between Zeno and anti-Zeno responses.


<details>
  <summary>Details</summary>
Motivation: To characterize how quantum systems respond to repetitive measurements and the implications for manipulating these responses in practical applications.

Method: The authors model each evolution-measurement cycle as a quantum channel using an effective Liouvillian generator, analyzing the spectral gap's behavior with measurement frequency and defining Zeno and anti-Zeno responses accordingly.

Result: They identify the transition between Zeno and anti-Zeno responses through spectral coalescence and crossings in discrete models, and smooth extrema in continuous models, providing a universal criterion for measurement-induced decay.

Conclusion: The findings offer insights for manipulating quantum decay effects in systems, contributing to the broader understanding of quantum measurement dynamics.
...
### [31] [Difference-Set Weyl Channels: Exact Capacity, Optimizer Bifurcation, and Scalable Entanglement Separation](https://arxiv.org/abs/2608.20726)
*Se-Wan Ji*

Main category: quant-ph

TL;DR: This paper investigates the interaction of stochastic phase-space dynamics and entanglement within a framework of Wigner positivity in quantum channels, establishing various capacity bounds and characterizing conditions for tensor-output purity and entanglement-breaking phenomena.


<details>
  <summary>Details</summary>
Motivation: To understand the implications of complete Wigner positivity on quantum channel capacities in the presence of entanglement and varying input states within stochastic phase-space dynamics.

Method: Employing a subsystem-resolved Weyl decomposition, the paper analyzes tensor-output purity, cyclic difference sets, and their relationships to collision modes. It also studies the impacts of shift-phase noise on the capacities and entanglement properties of quantum states.

Result: The study derives specific capacity expressions, including an unrestricted capacity of C=log2(D/r) and an unassisted capacity that remains constant for variable interpolation parameters. It identifies distinct regimes of entanglement behavior based on the parameter ε.

Conclusion: The findings reveal that while complete Wigner positivity can exist alongside persistent channel entanglement, it also suggests a scalable advantage when using entanglement assistance, leading to a more nuanced understanding of channel capacities.
...
### [32] [Restoring heat and particle flow in strongly coupled non-equilibrium devices](https://arxiv.org/abs/2608.20737)
*Noa Ludwin,Ohad Cremerman,Milan Šindelka,David Gelbwaser-Klimovsky*

Main category: quant-ph

TL;DR: The paper investigates the turnover effect in quantum systems under strong coupling, revealing that total reflection limits energy exchange and proposing a tunneling protocol to enhance current performance.


<details>
  <summary>Details</summary>
Motivation: To understand the turnover effect in energy transport through quantum systems under varying coupling strengths, which has been predicted but is not well understood.

Method: The authors employ scattering theory to analyze particle currents through a quantum system influenced by localized potentials and low-density reservoirs.

Result: Total reflection is identified as a key mechanism that prevents reservoir particles from reaching the quantum system, leading to a decrease in energy exchange.

Conclusion: A quantum tunneling-based protocol is proposed to mitigate the turnover effect, potentially optimizing the performance of temperature and chemical potential gradient-based devices.
...
### [33] [Activate genuine nonlocality from distinguishable sets in tripartite systems](https://arxiv.org/abs/2608.20741)
*Hui-Juan Zuo,Ying-Ying Lu,Shao-Ming Fei*

Main category: quant-ph

TL;DR: This paper investigates genuine nonlocality in multipartite quantum states, categorizing it into two types, and discusses the activation of nonlocality in tripartite systems.


<details>
  <summary>Details</summary>
Motivation: The goal is to explore genuine nonlocality in multipartite quantum systems, especially focusing on local distinguishability and the activation of nonlocality, addressing previous unanswered questions in the field.

Method: The authors analyze the properties of orthogonal quantum states in multipartite systems, introducing classifications of genuine nonlocality and conducting investigations using partial trace operations and numeral systems to simplify proofs.

Result: They establish that both type-I and type-II genuine nonlocality can be activated in tripartite systems, clarifying the local irredundancy issue and making significant strides in understanding nonlocality activation.

Conclusion: The findings open new avenues for utilizing nonlocality in state discrimination applications, while resolving an open question in the literature.
...
### [34] [Hybrid dynamical decoupling and coherent driving for high-fidelity nuclear-spin control in diamond](https://arxiv.org/abs/2608.20742)
*Jiwon Jeon,Donghun Jung,Eunsang Lee,Junghyun Lee*

Main category: quant-ph

TL;DR: The paper presents a new control method for NV centers that improves quantum memory operations by merging dynamical-decoupling strategies with RF control, enhancing efficiency while maintaining fidelity.


<details>
  <summary>Details</summary>
Motivation: To enhance coherent control of large nuclear-spin registers in quantum systems, tackling the limitations of existing methods regarding electron-spin coherence and addressability.

Method: The authors propose hybrid dynamical-decoupling and radio-frequency (H-DDrf) control, integrating DD-induced evolution with a phase-matched RF drive to optimize operations.

Result: H-DDrf control reduces RF power and gate duration without sacrificing fidelity, enabling better control over 13C nuclear-spin registers.

Conclusion: This new method significantly expands the capabilities of NV-based quantum memories and processors, facilitating improved quantum sensing and information processing.
...
### [35] [The four-dimensional Chamon code](https://arxiv.org/abs/2608.20775)
*Zhipeng Liang,Xuan Wang*

Main category: quant-ph

TL;DR: This paper explores the 4D Chamon code's ground-state degeneracy and excitation properties, establishing a correspondence with lattice structures and developing a two-layer decoding strategy that outperforms existing methods.


<details>
  <summary>Details</summary>
Motivation: The 4D Chamon code's potential as a quantum memory requires deeper understanding of its excitation properties and an effective decoding strategy due to its complex structure.

Method: The authors establish the relationship between the 4D Chamon code and the 4D lattice, analyze its excited states, and develop a two-layer decoding strategy leveraging geometric and algebraic properties.

Result: The study identifies three types of restricted-mobility excitations in the 4D Chamon code and discovers key structural properties that enhance decoding, achieving significant improvements over BP-OSD decoding accuracy.

Conclusion: The findings validate the 4D Chamon code as a generalization of the 3D version, highlighting its promising application in quantum memory through improved decoding strategies.
...
### [36] [Classical versus non-classical photon states for detecting vacuum non-linearity](https://arxiv.org/abs/2608.21361)
*N. Ahmadiniaz,C. Kohlfürst,R. Shaisultanov,R. Schützhold*

Main category: quant-ph

TL;DR: The paper explores enhancing the detectability of QED vacuum non-linearity by using classical or squeezed photon states instead of the traditional vacuum state.


<details>
  <summary>Details</summary>
Motivation: To verify predictions of quantum electrodynamics concerning vacuum behavior and improve detection methods.

Method: Modification of schemes by employing classical or non-classical photon states for detection of vacuum non-linearity.

Result: Significant improvement in the detectability of QED vacuum non-linearity using the proposed approach.

Conclusion: Utilizing classical or squeezed photon states enhances the likelihood of observing QED vacuum effects.
...
### [37] [Quantum phase estimation for nondestructive monitoring and Wigner tomography of bosonic fields](https://arxiv.org/abs/2608.20787)
*Lucas R. S. Santos,Ciro M. Diniz,Daniel Z. Rossatto,Celso J. Villas-Boas*

Main category: quant-ph

TL;DR: The paper presents a method to utilize quantum phase estimation as a nondestructive tool for monitoring bosonic fields through dispersive light-matter interaction, achieving state tomography and monitoring during dissipative evolution.


<details>
  <summary>Details</summary>
Motivation: To enhance the techniques for monitoring and characterizing bosonic fields in quantum systems, especially within superconducting architectures.

Method: Implement quantum phase estimation through a multi-qubit register coupled with a bosonic field, calibrating photon-number dependent phase shifts for number-resolved readouts, followed by phase-space displacements for Wigner tomography.

Result: Numerical reconstructions demonstrate high fidelity in reconstructing nonclassical phase-space structures for various quantum states, including Fock states and Schrödinger cat states.

Conclusion: The proposed protocol effectively enables nondestructive monitoring and state tomography of bosonic fields, which is crucial for advancements in quantum architecture.
...
### [38] [Coherence-Based Identification of Carbon-Based Spin Qubits in Hexagonal Boron Nitride from First Principles](https://arxiv.org/abs/2608.20833)
*Hyeonsu Kim,Jaewook Lee,Huijin Park,Hosung Seo*

Main category: quant-ph

TL;DR: Identifying carbon defects in hexagonal boron nitride through electron-spin decoherence and Hahn-echo dynamics, revealing their unique atomic structures based on spin coherence.


<details>
  <summary>Details</summary>
Motivation: Understanding the atomic structures of carbon-related defects in hexagonal boron nitride for applications in quantum computing and sensing.

Method: Utilized first-principles calculations and mapped Hahn-echo dynamics of carbon defects across magnetic fields and nuclear-spin baths to analyze electron-spin decoherence.

Result: Identified defect-specific magnetic fields and modulation frequencies that relate to the atomic structure of carbon defects, establishing separate classes based on carbon's sublattice location.

Conclusion: Decoherence fingerprints provide a new structural identification method for carbon defects, complementing existing optical spectroscopy techniques.
...
### [39] [Revealing Physical Redundancy in the Two-dimensional Fermi-Hubbard Model via Transferable Observable Reconstruction](https://arxiv.org/abs/2608.20836)
*Ao-Ning Wang,Min-Quan He,Z. D. Wang*

Main category: quant-ph

TL;DR: This study explores the redundancy of physical information among different observables in the two-dimensional Fermi-Hubbard model, revealing significant transferability of information between them.


<details>
  <summary>Details</summary>
Motivation: To determine if charge, interaction, and spin observables in the Fermi-Hubbard model contain overlapping physical information.

Method: Transferability tests were conducted among total density, double occupancy, and spin-spin correlation using a neural-network reconstruction framework to assess the ability to reconstruct one observable from another.

Result: The study found that the phase diagram of one observable can be accurately reconstructed from another, especially in trivial phase regimes, demonstrating observable-level redundancy.

Conclusion: Different observables in the Fermi-Hubbard model share substantial physical information, indicating redundancy that persists across temperature variations and noise.
...
### [40] [Non-Hermitian sensing via end-to-end Green's functions](https://arxiv.org/abs/2608.20847)
*Hui-Qiang Liang,Yu-Shi Cheng,Guo-Fu Xu*

Main category: quant-ph

TL;DR: The paper presents a sensing scheme that combines high sensitivity and noise resilience by leveraging non-Hermitian effects, particularly through the use of Green's functions, ensuring robustness against disorder.


<details>
  <summary>Details</summary>
Motivation: To develop a sensing framework that balances sensitivity and noise resilience, which are critical for accurate sensing applications.

Method: The authors utilize end-to-end Green's functions influenced by the non-Hermitian skin effect and characterize the sensitivity scaling to the system size.

Result: The proposed scheme offers exponential sensitivity scaling with system size and maintains this sensitivity in the presence of disorder under specific topological conditions.

Conclusion: This approach paves the way for practical implementations in synthetic non-Hermitian systems, enhancing the performance of sensors in noisy environments.
...
### [41] [Spin models with critical ground space degeneracy from Lie algebra relations](https://arxiv.org/abs/2608.20849)
*Andras Molnar,Efekan Kökcü,Norbert Schuch,Bojko N. Bakalov*

Main category: quant-ph

TL;DR: A new $	ext{SO}(3)$-symmetric spin model is introduced, characterized by unique ground spaces under specific boundary conditions. The study highlights its algebraic structure and scaling, contrasting it with related works on parent Hamiltonians.


<details>
  <summary>Details</summary>
Motivation: To explore a spin model based on the properties of $	ext{SO}(3)$ and its quantum state representations, focusing on its ground space characteristics both with open and periodic boundary conditions.

Method: The model is derived as the nearest-neighbor parent Hamiltonian of a matrix product state constructed from the Lie algebra generators of $	ext{so}(3)$ and the identity matrix, allowing for the characterization of its ground states.

Result: For open boundary conditions, the model displays a quadratic ground space degeneracy related to integer spins, while for periodic boundaries, it shows linear degeneracy leading to gapless excitations with a specific singlet and maximal spin state.

Conclusion: This model demonstrates unique scaling behavior in its ground space, differing from previous works, and can be generalized to $	ext{SO}(d)$ and other compact simple Lie groups.
...
### [42] [Characterizing Multimode Effects in a Guided Matterwave Gyroscope](https://arxiv.org/abs/2608.20889)
*Jessica K. Eastman,Ellen Zheng,Stuart S. Szigeti,Simon A. Haine*

Main category: quant-ph

TL;DR: The study investigates a compact matterwave vortex gyroscope using a two-component Bose-Einstein condensate, highlighting its robustness against geometric drifts compared to traditional gyroscopes.


<details>
  <summary>Details</summary>
Motivation: To explore a new type of gyroscope that maintains performance despite geometric changes, leveraging the unique properties of vortex states in BECs.

Method: The research employs quantum multimode simulations to analyze the effects of interparticle interactions and their impact on gyroscope sensitivity.

Result: Identified interaction-driven mechanisms that reduce performance and outlined conditions for maximizing sensitivity through parameter tuning.

Conclusion: The vortex gyroscope offers superior precision and robustness over traditional Sagnac interferometers, indicating its potential for compact rotation sensing applications.
...
### [43] [Anisotropic dynamical reconstruction of quantum geometry in quenched Chern insulators](https://arxiv.org/abs/2608.20895)
*Nan Li,Zhiyong Liu,Zhaoxin Liang,Ying Hu*

Main category: quant-ph

TL;DR: The paper investigates the conservation of the Chern number in evolving quantum states under unitary dynamics, revealing anisotropic changes in the quantum metric after a sudden quench in a Chern insulator.


<details>
  <summary>Details</summary>
Motivation: To understand how quantum metrics change dynamically following a quench and to explore the implications for topological phase transitions.

Method: The authors analyze the quantum metric evolution post-quench, examining eigenvalue behavior and the alignment of axes with energy gradient directions in a two-dimensional Chern insulator.

Result: The study finds that one eigenvalue of the quantum metric increases over time while the other remains relatively stable, leading to different dynamical signatures.

Conclusion: The findings suggest that coherent dynamics can reorganize quantum geometry in unprecedented ways, indicating potential for dynamic control of quantum systems.
...
### [44] [Tools for Reducing Service Time in Near-Term Quantum Networks](https://arxiv.org/abs/2608.20954)
*Jake Smith,Thomas R. Beauchamp,Scarlett Gauthier,Oumayma Bouchmal,Stephanie Wehner*

Main category: quant-ph

TL;DR: The paper proposes a method to optimize entanglement generation in multi-user quantum networks by reducing idle time caused by fixed separations, achieving significant reductions in service time for applications.


<details>
  <summary>Details</summary>
Motivation: To improve network utilization in multi-user quantum networks where fixed separations during entanglement generation lead to idle time, reducing overall efficiency.

Method: The proposed method optimizes by shortening the scheduled separation between entanglement generation attempts, using an analytical execution model to respect hardware constraints.

Result: Evaluations in the Arqon architecture demonstrated service time reductions of up to 42 minutes for single applications and 16-29 minutes per application when co-scheduled.

Conclusion: The approach significantly enhances the efficiency of quantum network architectures that share hardware, and it is suitable for online use by network schedulers.
...
### [45] [A Classification of Translation-Invariant Quantum Codes in Any Dimension](https://arxiv.org/abs/2608.20981)
*Andrew Li,Dominic J. Williamson*

Main category: quant-ph

TL;DR: This paper classifies D-dimensional translation-invariant quantum codes using length-D chain complexes, showing their equivalence to D-dimensional toric codes, thereby generalizing results from two-dimensional cases.


<details>
  <summary>Details</summary>
Motivation: Understanding the classification of higher-dimensional translation-invariant quantum error-correcting codes, which is complex due to diverse toric and fracton code families.

Method: The study focuses on D-dimensional translation-invariant codes derived from length-D chain complexes and multivariate multicycle codes.

Result: It establishes a direct equivalence between these D-dimensional codes and D-dimensional toric codes.

Conclusion: This work extends the simpler classification of two-dimensional codes to higher dimensions, providing a clear framework for analyzing D-dimensional quantum codes.
...
### [46] [When More Becomes Less: Topology-Reversed Three-Qubit Gate Performance on IBM Quantum Processors](https://arxiv.org/abs/2608.21004)
*Simona K. Grigorova,Stancho S. Stanchev,Nikolay V. Vitanov*

Main category: quant-ph

TL;DR: This study contrasts two Toffoli gate decompositions ( 0CCX_6 and CCX_8) regarding their performance on linear three-qubit topologies in quantum circuits, demonstrating that the circuit with more two-qubit gates can lead to better real-world results despite higher theoretical complexity.


<details>
  <summary>Details</summary>
Motivation: To assess the efficiency of different Toffoli gate decompositions on specific quantum hardware topologies and understand their operational effectiveness in real-world applications.

Method: Experiments were conducted using two IBM Quantum processors to compare CCX_6, which contains both nearest-neighbor and non-nearest-neighbor CX gates, with CCX_8, which utilizes only nearest-neighbor gates. Circuit performance was evaluated using hypergraph states and phase-altered randomized benchmarking.

Result: The findings revealed that the eight-CZ implementation ( 0CCX_8) performed better than the twelve-CZ implementation on the sampled linear triples, despite higher gate complexity in the circuit structure.

Conclusion: The study concludes that hardware connectivity can significantly influence the effectiveness of quantum circuits, allowing circuits with more abstract two-qubit gates to outperform theoretically simpler configurations.
...
### [47] [Degeneracy beyond the parity-symmetry protection in the Lipkin-Meshkov-Glick model](https://arxiv.org/abs/2608.21010)
*Jamil Khalouf-Rivera,Miguel Carvajal,Francisco Pérez-Bernal*

Main category: quant-ph

TL;DR: The paper explores the existence of doubly-degenerate states in a modified Lipkin-Meshkov-Glick model, demonstrating that such states can persist even in the absence of parity conservation due to an underlying $	ext{Z}_2$ symmetry.


<details>
  <summary>Details</summary>
Motivation: To investigate the relationship between symmetries in quantum mechanics and degeneracy patterns, particularly in the context of the Lipkin-Meshkov-Glick model.

Method: Utilized an anharmonic LMG Hamiltonian exhibiting a second-order ground-state quantum phase transition and incorporated terms that induce a first-order GSQPT, analyzing the resulting effects on parity symmetry and energy degeneracy.

Result: Established that energy doublets can persist despite broken parity symmetry, attributable to the presence of a $	ext{Z}_2$ symmetry in the classical limit phase space, which manifests as an anti-unitary symmetry in the quantum regime.

Conclusion: The findings reveal deeper insights into how symmetry and degeneracy are interrelated in quantum systems, suggesting that certain degeneracies can remain resilient against symmetry breaking.
...
### [48] [Symmetry Constrained Quantum Error Mitigation for the Schwinger Model](https://arxiv.org/abs/2608.21103)
*Alexander Tomlinson,Graham Van Goffrier,Bipasha Chakraborty,Zhenyu Cai*

Main category: quant-ph

TL;DR: The paper explores quantum error mitigation using symmetries in the (1+1)-dimensional Schwinger model, demonstrating effective bias reduction through post-selection but limited benefits in variational quantum eigensolvers.


<details>
  <summary>Details</summary>
Motivation: To enhance quantum error mitigation by leveraging physical symmetries in quantum simulations for lattice gauge theories, particularly under depolarizing noise.

Method: The study employs symmetry-sector post-selection during adiabatic state preparation and investigates symmetry verification within a variational quantum eigensolver (VQE), analyzing its effectiveness in reducing quantum noise and bias in measurements.

Result: Post-selection effectively reduces the chiral condensate noise by up to 60%, and global-noise calibration recovers noiseless values. In VQE, symmetry verification reduces bias in ground-state energy estimates but doesn't improve optimized parameters or state fidelity.

Conclusion: Symmetry verification is beneficial for quantum error mitigation in certain setups but its effectiveness varies based on its application stage in computational workflows, guiding further applications in quantum simulations.
...
### [49] [Quantifying Entangling Power of Controlled Unitary Gates](https://arxiv.org/abs/2608.21105)
*Ankur Haldar,Pankaj Agrawal,Prasenjit Deb*

Main category: quant-ph

TL;DR: This paper introduces a new computable quantity, ζ, to quantify entanglement generated by controlled unitary gates without needing to construct output states.


<details>
  <summary>Details</summary>
Motivation: Current entanglement prediction tools for controlled unitary gates either rely on circuit simulation or average over input distributions, which can be inefficient or limited.

Method: The authors define the quantity ζ to determine entanglement generation and quantify it for specific inputs, extending to higher dimensions and deriving a universal upper bound.

Result: The study identifies conditions for extremum values of ζ and establishes functional relationships between ζ and other entropy measures while demonstrating its optimality in certain cases.

Conclusion: The proposed quantity provides a more efficient and comprehensive tool for evaluating the entanglement power of controlled unitary gates, improving upon previous methodologies.
...
### [50] [Quantum thermodynamics and semidefinite optimization: Boltzmann, Fermi-Dirac, and Bose-Einstein frameworks](https://arxiv.org/abs/2608.21123)
*Michele Minervini,Nana Liu,Dhrumil Patel,Mark M. Wilde*

Main category: quant-ph

TL;DR: The paper explores how quantum thermodynamics provides a framework for understanding various semidefinite programs in quantum information, linking them to statistical mechanics and enabling new solution approaches.


<details>
  <summary>Details</summary>
Motivation: To unify interpretations of semidefinite programs (SDPs) in quantum information through a thermodynamic lens and investigate their implications for quantum-classical algorithms.

Method: The authors identify three types of SDP constraints and relate them to thermodynamic regularizations based on statistical mechanics (Boltzmann, Fermi-Dirac, Bose-Einstein). They analyze the dual relationships and their concavity in the context of chemical potentials.

Result: The study shows that the dual gradient and Hessian correspond to thermal expectation values, which facilitate the development of hybrid quantum-classical algorithms for SDPs.

Conclusion: Quantum thermodynamics not only unifies interpretations of SDPs but also enhances the computational methods available for addressing complex quantum information problems.
...
### [51] [Entangling Power Dynamics: Ergodicity and Mixing](https://arxiv.org/abs/2608.21151)
*Rahul V,Ranjan Modak,Shaon Sahoo,S Aravinda*

Main category: quant-ph

TL;DR: This paper analyzes quantum dynamics via entanglement, establishing a framework distinguishing between ergodicity and mixing, revealing insights into two-qubit gates and many-body systems' behaviors regarding entangling power and integrability.


<details>
  <summary>Details</summary>
Motivation: To understand quantum dynamics through entanglement generation and to characterize unitary evolution distinctly by its entangling power over time.

Method: Characterization of unitary operators through long-time-averaged entangling power, defining concepts of ergodicity and mixing, and applying these definitions to two-qubit gates and the kicked Ising chain in many-body dynamics.

Result: Two-qubit gates are shown to be neither ergodic nor mixing; integrable and nonintegrable chains exhibit different behaviors regarding long-time-averaged entangling power, with mixing occurring in nonintegrable but not in integrable cases.

Conclusion: Entanglement generation provides a powerful framework for assessing dynamical systems, uncovering distinct signatures of integrability beyond traditional measures.
...
### [52] [Distributed synthesis of arbitrary graph states in quantum networks via rank-two GF(2) reduction](https://arxiv.org/abs/2608.21166)
*Xiaoyi Zheng,Lin Chen,Chan-Tong Lam*

Main category: quant-ph

TL;DR: The paper presents a novel approach for synthesizing graph states in quantum networks that reduces resource overhead and time-slot depth, providing significant improvements over existing methods, especially for denser graphs.


<details>
  <summary>Details</summary>
Motivation: Existing methods for graph state synthesis are inefficient, as their resource demands increase with the edge density of the target graph, necessitating a more efficient approach.

Method: The authors utilize the mathematical equivalence between joint Pauli-X measurements and graph pivot operations to restructure graph state synthesis as a rank-2 reduction of a difference matrix over GF(2), achieving an upper bound of floor(N/2) steps for synthesis independent of edge density.

Result: The proposed method outperformed traditional approaches in simulations based on Waxman topologies, showing improved time-slot depth and reduced entanglement resource overhead as the edge density of the target graph increases, with notable advantages starting near p = 0.3.

Conclusion: This new protocol offers a more efficient strategy for synthesizing graph states in quantum networks, especially beneficial for dense graphs, confirming its potential over existing synthesis methods.
...
### [53] [A Bayesian formulation of hybrid quantum-classical dynamics](https://arxiv.org/abs/2608.21169)
*Hilbert Kappen*

Main category: quant-ph

TL;DR: This paper presents a Bayesian framework for quantum-classical dynamics by modeling wave functions and classical variables as a stochastic process, leading to a unified treatment of quantum and classical noise.


<details>
  <summary>Details</summary>
Motivation: The aim is to provide a coherent and unified description of quantum-classical dynamics and noise using Bayesian methods, overcoming limitations in existing formulations.

Method: A Bayesian approach is developed using the Fokker-Planck equation for joint probability density. It establishes a connection between quantum states and classical variables, allowing for state estimation through Bayesian inference.

Result: The framework yields the hybrid Lindblad equation, enabling the reconstruction of quantum-classical trajectories with enhanced accuracy through filtering and smoothing. Numerical results demonstrate improved estimation of hidden trajectories and the retention of complex structures.

Conclusion: This work bridges quantum filtering and retrodiction, providing robust tools for analyzing quantum-classical systems through Bayesian time-series methods.
...
### [54] [The Entanglement Content of Quantum Measurement Bases](https://arxiv.org/abs/2608.21185)
*Jef Pauwels,Otfried Gühne*

Main category: quant-ph

TL;DR: The paper generalizes Bell-state measurements to multiple particles and introduces a framework for understanding measurement bases arising from local transformations of a single state.


<details>
  <summary>Details</summary>
Motivation: To extend the concept of Bell-state measurements to more than two particles, addressing their significance in various quantum protocols.

Method: A framework of measurement bases is developed, categorized by local transformations from a single state, leading to a generalization of maximally entangleable states and identification of a new four-qubit maximally entangled basis.

Result: A novel maximally entangled basis for four qubits is identified, suitable for applications in data-hiding and distillation protocols. Furthermore, it demonstrates that not all forms of entanglement can be represented in a complete measurement basis.

Conclusion: This framework enhances understanding of how entangled measurements can be constructed and utilized, while highlighting limitations in encoding entanglement.
...
### [55] [Fixed-ray escort representations of sandwiched and $α$--$z$ Rényi divergences on von Neumann algebras](https://arxiv.org/abs/2608.21214)
*Tanay Kibe,Pratik Roy*

Main category: quant-ph

TL;DR: The paper establishes a representation of sandwiched and α-z Rényi divergences in terms of averages of relative entropy, utilizing non-commutative L^p spaces and interpolation techniques.


<details>
  <summary>Details</summary>
Motivation: To provide a clear representation of sandwiched and α-z Rényi divergences and their relation to relative entropy, expanding the understanding of these divergences in quantum information theory.

Method: The authors employ Haagerup non-commutative L^p spaces and interpolation to show that α-z Rényi divergences can be expressed as integrals over relative entropy of fixed-ray escort states along the ray defined by z=cα.

Result: The representation holds for normal states across arbitrary von Neumann algebras, with specific conditions on state support for α<1 and α>1; it reveals a monotone escort profile and convex order potential.

Conclusion: The findings facilitate a reformulation of one-shot testing converses and related concepts, contributing to a deeper understanding of pair-conversion rates in quantum information.
...
### [56] [Probing quantumness of superpositions of Gaussian states via Tsirelson probability](https://arxiv.org/abs/2608.21217)
*Yue Zhang*

Main category: quant-ph

TL;DR: This paper investigates the Tsirelson probability for superpositions of Gaussian states, revealing violations of classical bounds in certain cases.


<details>
  <summary>Details</summary>
Motivation: To explore the nonclassical features of superpositions of Gaussian states and understand their quantum dynamics through the Tsirelson probability framework.

Method: Analytical calculations of Tsirelson probability for circular and generalized circular states, particularly focusing on superpositions of coherent states and incorporating squeezing effects.

Result: Tsirelson probability is computed for circular states, showing violations of classical bounds for specific dimensions and providing a general expression for generalized circular states.

Conclusion: The findings enhance our understanding of nonclassicality in superpositions of Gaussian states, supporting their use in nonclassicality testing.
...
### [57] [Eavesdropper-Blind Remote State Preparation and Applications to Quantum Public-Key Encryption](https://arxiv.org/abs/2608.21241)
*Kaniuar Bacho,Alexandru Cojocaru*

Main category: quant-ph

TL;DR: The paper introduces eavesdropper-blind remote state preparation (EB-RSP), a weaker form of remote state preparation that maintains utility in cryptographic applications while relaxing adversarial assumptions.


<details>
  <summary>Details</summary>
Motivation: To explore a weaker form of remote state preparation that remains useful for cryptography without relying on strong cryptographic assumptions like trapdoor functions.

Method: The authors define EB-RSP, focusing on its resistance to external eavesdroppers, and demonstrate the construction of two-message EB-RSP protocols from one-way group actions.

Result: Two-message EB-RSP facilitates quantum public-key encryption using classical keys and quantum ciphertexts, indicating its practical cryptographic applications.

Conclusion: The study opens avenues for RSP-type primitives based on weaker assumptions and suggests adaptability of existing constructions to the new model.
...
### [58] [Random quantum circuits, chaos and quantum thermalization](https://arxiv.org/abs/2608.21303)
*J. T. Chalker*

Main category: quant-ph

TL;DR: The paper discusses random quantum circuits as models for many-body quantum systems, emphasizing their foundations, motivations, and key physical insights.


<details>
  <summary>Details</summary>
Motivation: The introduction of random quantum circuits is motivated by concepts from random matrix theory, aiming to understand generic many-body quantum systems.

Method: The paper outlines calculations using an ensemble average over random quantum circuits to derive key physical quantities.

Result: Findings include insights into operator spreading, entanglement dynamics, and spectral correlations in quantum systems.

Conclusion: The study contributes to the understanding of complex many-body quantum phenomena through the lens of random quantum circuits.
...
### [59] [Tomographic Limits of the Petz Recovery Map](https://arxiv.org/abs/2608.21309)
*Peter Sidajaya,Clive Cenxin Aw,Mingxuan Liu,Valerio Scarani*

Main category: quant-ph

TL;DR: This paper explores the application of the Petz recovery map in quantum state tomography, illustrating its connection to Bayesian inference and the challenges of direct Petz iteration.


<details>
  <summary>Details</summary>
Motivation: To investigate the Petz recovery map as a quantum analogue of Bayesian inference and its relevance to state tomography.

Method: The authors examine iterated Petz recovery and its limitations, proposing an extended Petz construction that incorporates a classical distribution over candidate quantum states.

Result: The extended Petz construction successfully aligns the outcomes with Bayesian and maximum likelihood approaches for quantum state tomography.

Conclusion: This work enhances understanding of how quantum retrodiction can be adapted for effective quantum state tomography using a Petz-based framework.
...
### [60] [Hypothesis testing between quantum ensembles](https://arxiv.org/abs/2608.21321)
*Jian Yao,Quntao Zhuang*

Main category: quant-ph

TL;DR: The paper investigates quantum state ensembles and their application in quantum information processing, presenting new findings on binary hypothesis testing and error probability limits.


<details>
  <summary>Details</summary>
Motivation: To examine the operational information in quantum state ensembles and their utility in various quantum information contexts, particularly in hypothesis testing scenarios.

Method: The authors formulate binary hypothesis testing for finite quantum ensembles, derive error probability limits, and describe the sampled state via power-weighted ensemble moments to obtain Bayes-optimal measurement.

Result: The study reveals that discrimination in these ensembles is determined by a moment hierarchy and establishes exact finite-sample error limits; in the many-sample limit, it derives Chernoff bounds and exact error exponents for uniform pure-state ensembles.

Conclusion: Results indicate that for finite uniform pure-state $t$-designs, larger values of $t$ lead to significantly better discrimination exponents, which requires considerably fewer samples for equal-prior testing.
...
### [61] [Quantum annealing through a first-order phase transition: field theory approach](https://arxiv.org/abs/2608.21329)
*Diego Andrés Rivera Orona,Predrag Punoševac,Nikolai A. Sinitsyn*

Main category: quant-ph

TL;DR: The paper presents a field theory for understanding defect kinetics in quantum annealing during first-order phase transitions, predicting power law behaviors in error generation rates and highlighting the significance of critical points.


<details>
  <summary>Details</summary>
Motivation: To study the kinetics of defects which emerge during quantum annealing while a system transitions through its metastable state during first-order phase transitions.

Method: A field theory approach is employed to model the defect kinetics and predict power laws for error rates based on changes in system parameters.

Result: The theory predicts distinct changes in power exponents during quantum annealing as the system approaches first-order phase transitions, indicative of critical behavior.

Conclusion: Identifying signature behaviors associated with first-order critical points can enhance quantum annealing computations by allowing for the avoidance of regions with high error generation.
...
### [62] [Dissipative framework for subsystem dynamics of noninteracting quantum chains](https://arxiv.org/abs/2608.21336)
*Michele Coppola,Zala Lenarčič*

Main category: quant-ph

TL;DR: This paper presents a framework for modeling local dynamics in many-body quantum systems, focusing on noninteracting quantum chains under varying coupling scenarios.


<details>
  <summary>Details</summary>
Motivation: The need to efficiently describe the dynamics of local observables in many-body quantum systems while tracing out the rest of the system as an environment.

Method: The authors develop a polynomial-time algorithm to reconstruct the local dynamical generator for noninteracting quantum chains, using the assumptions of initially uncorrelated states and Gaussian environments.

Result: Two models—bipartitioned Kitaev chain and Kitaev chain coupled to free-fermion environments—demonstrate that strong subsystem-environment coupling results in non-Markovian dynamics, while weak coupling leads to Markovian dissipation characterized by boundary-localized effects.

Conclusion: Subsystem-environment correlations significantly affect local dynamics, challenging traditional weak-coupling assumptions and offering new insights into quantum many-body systems.
...
TL;DR: Virtual distillation enhances dominant eigenvector components but cannot create new concentration in measurement outcomes; its success probability is limited by a Slepian concentration operator.


<details>
  <summary>Details</summary>
Motivation: To explore the limitations of virtual distillation as an error-mitigation technique in quantum computing, particularly its role as a spectral filter.

Method: Analysis of finite-band variational states and the application of Slepian concentration operators, including empirical demonstrations using noisy-QAOA calculations for Max-Cut.

Result: The success probability of outcome concentration is bounded by the leading eigenvalue of the Slepian operator, with finite robust spectral components constrained by active dimension.

Conclusion: The findings indicate both improvements within target outcomes and failures outside the expected outcomes in virtual distillation, highlighting its spectral filtering limitations.
...
### [64] [Tunneling from a Slowly Rolling Multifield Background Using Tadpole Subtraction](https://arxiv.org/abs/2608.20451)
*Masaki Yamada*

Main category: hep-ph

TL;DR: The paper explores semiclassical tunneling in scalar field theories with evolving backgrounds, particularly during slow-roll inflation, using a combination of tadpole subtraction and adiabatic expansion methods.


<details>
  <summary>Details</summary>
Motivation: To analyze semiclassical tunneling processes in scalar field theories with slowly evolving backgrounds, especially in the context of slow-roll inflation.

Method: Combining tadpole subtraction to map the system to a multi-field tunneling problem and adiabatic expansion to track background evolution, specifically for tunneling directions transverse to the rolling inflaton.

Result: The real tunneling exponent does not receive linear corrections from the rolling velocity, although the tunneling rate evolves due to a changing tadpole-subtracted potential. Furthermore, the exponent reaches a finite, nonanalytic limit as tangential curvature approaches zero, indicating a similar order exponent from weakly tachyonic directions.

Conclusion: The study provides insights into the behavior of tunneling rates during slow-roll inflation, highlighting the importance of background evolution and potential implications for scenarios involving time-reflection-symmetric bounces.
...
### [65] [Poles in $πN$ scattering from forward dispersion relations and revised total cross-section data](https://arxiv.org/abs/2608.20458)
*José Ramón Peláez,Pablo Rabán,Jacobo Ruiz de Elvira*

Main category: hep-ph

TL;DR: The paper presents a model-independent analysis of πN forward dispersion relations, identifying stable poles relevant to the Δ(1232) and Roper resonances and deriving sum rules for resonance residues.


<details>
  <summary>Details</summary>
Motivation: To investigate πN interactions and identify resonances without reliance on partial-wave analyses.

Method: Model-independent calculations of forward dispersion relations using revised π±p total cross-section data and Regge asymptotics for analytic continuation.

Result: Identification of four stable poles for each isospin channel, including the Δ(1232) and Roper resonances, while elucidating unresolved multiple resonances in total cross-section data.

Conclusion: The study provides insights into resonance characteristics and establishes sum rules connecting resonance residues, enhancing our understanding of πN interactions.
...
### [66] [First Search for Ultraheavy Dark Matter Using a Magnetically Levitated Particle](https://arxiv.org/abs/2608.20464)
...
TL;DR: This paper reports the POLONAISE experiment's search for ultraheavy dark matter using a magnetically levitated particle, achieving significant sensitivity and excluding specific neutron coupling values.


<details>
  <summary>Details</summary>
Motivation: To explore interactions of ultraheavy dark matter with neutrons using a novel levitation technique, thereby expanding the search into previously unexplored mass ranges.

Method: The POLONAISE experiment employs a milligram-scale ferromagnet in a superconducting trap to measure forces and impulses indicative of potential dark matter events, offering high sensitivity to analyze neutron couplings.

Result: Upper limits on the neutron coupling α_n are set for dark matter with masses ranging from 10^6 to 10^{15} GeV/c^2, excluding couplings as low as 3.2×10^{-9} at a 95% confidence level and placing leading constraints on dark matter-neutron cross sections.

Conclusion: The findings significantly advance the detection capabilities for ultraheavy dark matter, extending the range of mass exploration far beyond previous optical levitation techniques.
...
### [67] [Muon Capture on the Proton with Heavy-Light Currents](https://arxiv.org/abs/2608.20468)
*Evan Combes,Emanuele Mereghetti,Lucas Platter*

Main category: hep-ph

TL;DR: The paper presents a non-relativistic Lagrangian for muon-proton electroweak interactions, calculates capture rates in muonic hydrogen, and provides key results for radiative corrections and capture rates.


<details>
  <summary>Details</summary>
Motivation: To accurately describe muon-proton electroweak interactions and compute effective capture rates in muonic hydrogen.

Method: Construct a non-relativistic Lagrangian, match coefficients from non-relativistic to relativistic theories, determine leading order corrections, and calculate capture rates including radiative corrections.

Result: Capture rates obtained: Γ({}^1 S_0) = 724.07 ± 5.45 s⁻¹ and Γ({}^3 S_1) = 11.55 ± 0.18 s⁻¹, incorporating key corrections.

Conclusion: The non-relativistic framework effectively captures the electroweak interactions and provides precise predictions for capture rates in muonic hydrogen.
...
### [68] [Intensity-Frontier Signals of Warped Extra Dimensions](https://arxiv.org/abs/2608.20482)
*Doojin Kim,Deepak Sathyan,Ankur Verma*

Main category: hep-ph

TL;DR: This paper investigates the emergence of warped extra dimensions at the intensity frontier, focusing on a model where gravity exists at MeV scales leading to a Kaluza-Klein graviton tower.


<details>
  <summary>Details</summary>
Motivation: To explore the possibility of detecting warped extra dimensions through gravitational effects rather than through conventional collider physics, particularly at low energy (intensity frontier) scenarios.

Method: The authors propose an extended warped model with a photon-portal realization and analyze graviton production due to photon interaction with intermediate scales in a beam-dump environment, focusing on wave-function overlap effects.

Result: Heavy Kaluza-Klein gravitons can be produced through GeV-scale photon interactions, leading to a unique decay signature characterized by intratower showering and macroscopic decays into photon pairs, while also discussing constraints on the theory.

Conclusion: This approach to warped extra dimensions provides a distinctive signal at the intensity frontier, suggesting new pathways for detection beyond conventional collider methods.
...
### [69] [Probing Non-Holomorphic Modular $A_4$ Double Seesaw: Signatures in Neutrino Oscillation Experiments and Implications for Leptogenesis](https://arxiv.org/abs/2608.20508)
*Pratik Adarsh,Dinesh Kumar Singha,Mitesh Kumar Behera,Sudhanwa Patra*

Main category: hep-ph

TL;DR: This paper presents a non-holomorphic modular framework using the $A_4$ symmetry to extend the Standard Model, incorporating right-handed and sterile neutrinos to realize a double seesaw mechanism. This approach is consistent with neutrino oscillation data and provides testable predictions for upcoming experiments.


<details>
  <summary>Details</summary>
Motivation: The study aims to investigate the double seesaw mechanism within a modular framework, providing a new approach to understand neutrino masses and their implications for thermal leptogenesis.

Method: The authors extend the Standard Model by integrating three generations of right-handed neutrinos, left-handed sterile neutrinos, and an $A_4$-singlet scalar, utilizing modular structures that inhibit bare Majorana mass terms and induce mass hierarchies through sterile sectors.

Result: The analysis reveals viable normal ordering solutions with respect to current neutrino oscillation data, identifying an induced RHN spectrum conducive to thermal leptogenesis, with Boltzmann evolution providing a baryon asymmetry close to observations.

Conclusion: The findings position the non-holomorphic modular $A_4$ double seesaw mechanism as a robust framework relevant for linking low-energy phenomenology and thermal leptogenesis, with predictions that are directly testable at upcoming neutrino experiments like DUNE, T2HK, and JUNO.
...
### [70] [A window for the mixed same-sign signature in the type-II seesaw models](https://arxiv.org/abs/2608.20708)
*Cheng-Wei Chiang*

Main category: hep-ph

TL;DR: The mass splitting in the Higgs triplet of the type-II seesaw model has specific constraints at collider energies, influencing the decay processes and exclusion limits in experiments.


<details>
  <summary>Details</summary>
Motivation: To identify the mass splitting between doubly and singly charged Higgs bosons, which is often treated as a free variable, and its implications for collider physics.

Method: Electroweak loop calculations determine the mass splitting under certain conditions, with varying renormalization scales affecting outcomes significantly.

Result: The calculated mass splitting is 767 to 841 MeV, influencing decay widths and the validity of partonic counting, which shows discrepancies at certain split values.

Conclusion: Understanding the mass splitting's impact on decay rates and exclusion boundaries is crucial for interpreting collider data and constraining the type-II seesaw model.
...
### [71] [Dielectric Response for Light Dark Matter Direct Detection Beyond the Longitudinal Approximation](https://arxiv.org/abs/2608.20715)
*Zheng-Liang Liang,Lei Wu,Wen-Na Yang,Lin Zhang,Bin Zhu*

Main category: hep-ph

TL;DR: This paper addresses the neglect of transverse dielectric functions in dark matter-electron scattering in semiconductors, providing a detailed derivation and evaluation of the transverse response.


<details>
  <summary>Details</summary>
Motivation: To complete the understanding of dielectric effects in light dark matter interactions with electrons in semiconductors, particularly addressing the previously neglected transverse dielectric response.

Method: The study employs the random phase approximation to derive and evaluate the transverse dielectric function in a homogeneous electron gas, specifically applied to silicon.

Result: The transverse energy loss function is found to be significantly lower than the longitudinal function in the bulk plasmon regime, validating the use of the longitudinal approximation, while also revealing sizable transverse corrections at lower energy deposits.

Conclusion: This research offers a critical evaluation of existing longitudinal calculations and highlights specific energy regimes where transverse effects should be considered, especially in the context of relativistic dark matter interactions.
...
### [72] [Qubits for Dark Matter Hunting](https://arxiv.org/abs/2608.20745)
*Takeo Moroi*

Main category: hep-ph

TL;DR: This paper reviews the application of qubits and quantum excitations for dark matter detection, emphasizing techniques, dynamics, and the sensitivity-enhancing potential of quantum sensing.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of quantum technologies, particularly qubits, in advancing dark matter detection and understanding physics beyond the Standard Model.

Method: The paper discusses qubits' properties, their excitation by dark matter, Jaynes-Cummings dynamics of coupled systems, and noise effects, alongside concepts in quantum sensing.

Result: It highlights the critical role of quantum entanglement in enhancing sensitivity for detecting wave-like dark matter and addresses noise factors affecting detection.

Conclusion: Harnessing quantum sensing techniques can significantly improve the detection capabilities for dark matter, emphasizing the coherence properties of dark matter.
...
### [73] [Anomaly-free axion-like particle in Nelson-Barr models](https://arxiv.org/abs/2608.20773)
*Mohammad Aghaie,Ryoma Masuda,Ryosuke Sato*

Main category: hep-ph

TL;DR: This study examines Nelson--Barr models predicting an axion-like particle (ALP) that solves the strong CP problem through spontaneous CP violation, revealing potential for detection through rare meson decays and cosmological production methods.


<details>
  <summary>Details</summary>
Motivation: To address the strong CP problem in particle physics through spontaneous CP violation while exploring the properties and detectability of a light axion-like particle.

Method: Analysis of the ALP's properties, including its anomaly-free status and flavor-violating interactions, and study of its cosmological production via freeze-in and misalignment mechanisms.

Result: The freeze-in mechanism's viable parameter space is constrained by precision flavor experiments and stellar cooling, while misalignment remains a robust explanation for dark matter, with prospects for future observations.

Conclusion: Precision flavor measurements and cosmological observations can serve as complementary methods for investigating the anomaly-free ALP and the Nelson--Barr mechanism, paving the way for future experimental tests.
...
### [74] [The role of triangle singularity in the $B^0 \to D^- π^+ a_0(980)(π^0 η)$ decay](https://arxiv.org/abs/2608.20835)
*Wei Wang,Dazhuang He,Xuan Luo*

Main category: hep-ph

TL;DR: This study investigates the triangle mechanism in the decay of $B^0$ to explore the nature of the $a_1(1420)$ state, confirming existing interpretations through observed peaks in invariant mass distributions.


<details>
  <summary>Details</summary>
Motivation: To examine the triangle singularity interpretation of the $a_1(1420)$ in the context of $B^0$ decay and the role of dynamically generated states.

Method: The decay $B^0 	o D^- π^+ a_0(980)(π^0 η)$ is analyzed, employing a triangle loop involving $ar{K}^{*0}$, $K^+$, and $K^-$, with calculations of differential decay widths and invariant mass distributions.

Result: The triangle amplitude reveals pronounced peaks in invariant mass spectra at approximately 1420 MeV and 980 MeV, confirming the triangle singularity interpretation of the $a_1(1420)$.

Conclusion: The findings suggest that the identified decay mode of $B^0$ can help further investigate the triangle-singularity characteristics of the $a_1(1420)$ in upcoming experiments.
...
### [75] [The excited baryon spectrum from a unified quark model](https://arxiv.org/abs/2608.20892)
*Yan-Ke Chen,Liang-Zhen Wen,Wei-Lin Wu,Lu Meng,Shi-Lin Zhu*

Main category: hep-ph

TL;DR: A new nonrelativistic quark potential model is developed to study multiquark states, achieving accurate reproduction of meson and baryon spectra but struggling with excited light baryons.


<details>
  <summary>Details</summary>
Motivation: To create a reliable model that simultaneously describes meson and baryon spectra across all flavor sectors with a single parameter set.

Method: The authors developed a nonrelativistic constituent quark potential model incorporating spin-orbit and tensor interactions and refitted parameters based on experimental data, excluding excited light hadrons.

Result: The model accurately reproduces most spectra with deviations below 20 MeV, but fails to resolve discrepancies in excited light baryon spectra.

Conclusion: The model provides a foundation for studying multiquark states but has limited accuracy for certain excited states, warranting further experimental investigations.
...
### [76] [The ABC of RPV III: Classification of R-parity Violating Signatures from LQD Couplings and their Coverage at the LHC](https://arxiv.org/abs/2608.21033)
*Herbi K. Dreiner,Yong Sheng Koay,Tina Potter,Martin Schürmann,Rhitaja Sengupta,Apoorva Shah,Nadja Strobbe*

Main category: hep-ph

TL;DR: This paper analyzes R-parity violating Minimal Supersymmetric Standard Model (RPV-MSSM) focusing on $LQ\bar D$ operators, categorizing collider signatures, assessing LHC search coverage, and identifying research gaps for future experiments.


<details>
  <summary>Details</summary>
Motivation: To explore the RPV-MSSM and its implications for LHC searches, particularly highlighting the $LQ\bar D$ operators not covered in prior studies.

Method: Systematic classification of collider signatures for different LSPs and $LQ\bar D$ couplings, using data from ATLAS and CMS analyzed by $	exttt{CheckMATE 2}$ to evaluate current coverage.

Result: Identified substantial sensitivity to colored sectors, but gaps for wino- and higgsino-like LSPs remain, particularly involving $τ$ leptons. Found that slepton LSPs are unconstrained at LHC, whereas some sensitivity exists for bino-like LSPs.

Conclusion: Highlights the need for dedicated LHC searches targeting specific $LQ\bar D$ signatures and points out gaps in the existing $	exttt{CheckMATE 2}$ database.
...
### [77] [Unraveling QCD dynamics with heavy quark energy correlators](https://arxiv.org/abs/2608.21145)
*Ivan Vitev*

Main category: hep-ph

TL;DR: The paper analyzes how heavy-quark jets and their substructure are influenced by quark mass in QCD, focusing on energy-energy correlators that reveal mass effects through angular distributions and energy flow.


<details>
  <summary>Details</summary>
Motivation: Understanding the influence of quark mass on QCD radiation and its alterations in nuclear environments is crucial for exploring heavy-flavor jets.

Method: The study employs effective field theory to analyze heavy-quark energy-energy correlators, considering their angular distributions and the dead-cone effect, alongside nuclear medium effects on radiation.

Result: The findings indicate that the finite mass of charm and bottom quarks modifies the radiation pattern, causing suppression at small angles and deviations from massless jet predictions, especially in nuclear reactions.

Conclusion: The paper highlights distinct regimes of jet modification due to quark mass and proposes experimental tests in small collision systems to validate the theory.
...
### [78] [The electron parton distribution functions at the NNLO in QED](https://arxiv.org/abs/2608.21181)
*Stefano Frixione,Kay Schönwald*

Main category: hep-ph

TL;DR: The paper computes electron Parton Distribution Functions (PDFs) at NNLO in QED using two factorisation schemes, highlighting the benefits of the $Δ$ scheme over the standard $ar{m MS}$ scheme.


<details>
  <summary>Details</summary>
Motivation: To improve precision in cross-section calculations at lepton colliders by calculating electron PDFs at next-to-next-to-leading order (NNLO) and exploring different factorisation schemes.

Method: The authors compute the PDFs using the $ar{m MS}$ and $Δ$ schemes, extending the definition of the $Δ$ scheme and presenting analytical results for large-$z$ behaviour.

Result: The study shows that the soft-logarithm enhancement present in the $ar{m MS}$ scheme is absent in the $Δ$ scheme, making the latter more efficient for both numerical and analytical computations.

Conclusion: NNLO PDFs are essential for achieving high precision (10^-4 or better) in collider physics, particularly for colliders with energies around the hundred-GeV range.
...
### [79] [Higgs Boson plus Quark Pair Production at High Energies as di-Higgs Background](https://arxiv.org/abs/2608.21195)
*Andreas Maier,Giacomo Ruisi*

Main category: hep-ph

TL;DR: The paper studies the role of high-energy QCD resummation in Higgs boson production, specifically in scenarios relevant for Higgs-pair production at the LHC, highlighting significant modifications to QCD contributions and extending predictions by incorporating quark-pair resummation.


<details>
  <summary>Details</summary>
Motivation: To improve Higgs boson production predictions at high energies for more accurate studies at the LHC, particularly in distinguishing between production processes.

Method: High-energy QCD resummation techniques are applied to analyze Higgs boson production in association with a bottom-quark pair and two hard jets, focusing on the gluon-fusion channel.

Result: The QCD contributions in VBF-like regions are significantly altered by resummation, revealing that traditional fixed-order calculations may overestimate gluon-fusion background interference.

Conclusion: Extending HEJ predictions to include quark-pair resummation enhances the understanding of Higgs boson production, providing valuable insights for Higgs-pair studies.
...
### [80] [Implications of two-channel rescattering for charm CP violation from precise dispersive data](https://arxiv.org/abs/2608.21212)
*Antonio Pich,Eleftheria Solomonidi,Luiz Vale Silva*

Main category: hep-ph

TL;DR: This paper analyzes CP violation in charm-meson decays, finding existing predictive approaches insufficient due to uncertainties, but offering new predictions for CP asymmetries.


<details>
  <summary>Details</summary>
Motivation: The study seeks to address the unexplained large CP violation observed in charm-meson decays that isn't accounted for by the Standard Model.

Method: The authors utilize a data-driven approach that focuses on a well-determined strong-scattering parameter while considering branching ratios.

Result: The findings suggest that the current methods still cannot adequately explain the experimental CP violation signal and lead to new predictions for CP asymmetries in pion and kaon channels.

Conclusion: The work confirms the limitations of existing models in explaining CP violation and provides constraints for future studies on CP asymmetries.
...
### [81] [Efficient Event Generation for High-Multiplicity LHC Processes: An End-to-End GPU Workflow with Normalizing Flows](https://arxiv.org/abs/2608.21338)
*Enrico Bothmann,Joshua Isaacson,Claudius Krause,Carla J. López-Zurita,Maximilian Spannring,Daohan Wang*

Main category: hep-ph

TL;DR: The paper presents a GPU-accelerated event-generation workflow combining normalizing flows with the Pepper generator, significantly accelerating the production of unweighted event samples for complex high-multiplicity processes.


<details>
  <summary>Details</summary>
Motivation: To overcome limitations in generating large unweighted samples for high-multiplicity processes, which hinder research due to expensive evaluations and low efficiencies.

Method: An end-to-end, GPU-resident workflow integrates normalizing-flow proposals with Pepper, utilizing a Python control layer for phase-space point generation and evaluations in device memory with subprocess-specific and grouped conditional flows.

Result: Achieved generation of $10^9$ unweighted events for various benchmark processes on H100 GPUs, with end-to-end speedups of up to 100 times compared to standalone generation methods.

Conclusion: This workflow facilitates practical billion-event production and addresses the Monte Carlo statistics bottleneck in high-multiplicity collider physics.
...
### [82] [A Multi-instrument Generalized Lomb-Scargle Periodogram Implementation](https://arxiv.org/abs/2608.20436)
*Giulia Martos,Néstor Espinoza,Jorge Meléndez*

Main category: astro-ph.IM

TL;DR: The paper introduces a new implementation of the Generalized Lomb-Scargle Periodogram (GLS) that accommodates offsets from different instruments—a 'multi-instrument' GLS—demonstrating its application on TOI-481 b.


<details>
  <summary>Details</summary>
Motivation: To improve the analysis of radial-velocity data from multiple instruments, addressing individual offsets that can affect signal detection.

Method: The developed multi-instrument GLS is a closed-form implementation that incorporates data from various instruments simultaneously, enhancing period recovery.

Result: The method recovers the period of TOI-481 b with greater significance than the standard GLS approach.

Conclusion: The implementation offers an effective alternative for analyzing multi-instrument radial-velocity data, improving results significantly.
...
### [83] [High-contrast aperture masking interferometry: detecting companions within the diffraction limit](https://arxiv.org/abs/2608.20456)
*Benjamin Calvin,Michael Fitzgerald,Jessica Castellanos*

Main category: astro-ph.IM

TL;DR: This paper explores the integration of high contrast coronagraphy and non-redundant masking interferometry to improve the detection of Earth-like exoplanets within traditional imaging limits.


<details>
  <summary>Details</summary>
Motivation: To advance the direct discovery and characterization of Earth-like exoplanets through enhanced imaging techniques.

Method: The study combines high contrast coronagraphy with non-redundant masking interferometry to address the limitations of existing imaging methods and face sensitivity issues.

Result: We predict improved contrast in photon-limited observations and establish wavefront stability requirements for the combined system.

Conclusion: Combining these techniques may significantly enhance the discovery potential for high-contrast astrophysical targets closer to the inner working angle.
...
### [84] [Amplifying the imaging power of digital sky surveys with space telescopes data and generative AI](https://arxiv.org/abs/2608.20666)
*Sai Teja Erukude,Lior Shamir*

Main category: astro-ph.IM

TL;DR: This paper presents a method using generative AI to enhance the quality of galaxy images from ground-based telescopes to match that of space-based telescopes, combining high throughput with superior image detail.


<details>
  <summary>Details</summary>
Motivation: To improve the imaging capabilities of ground-based telescopes, which are limited compared to space-based telescopes, despite their large data throughput.

Method: The method leverages generative AI trained on high-quality space-based images to enhance low-quality images from ground-based telescopes by converting weak signals into detailed galaxy visuals.

Result: The approach successfully merges high throughput from ground surveys with high-quality imaging, providing a catalog of 63,202 enhanced galaxy images and an accessible software tool for the public.

Conclusion: The integration of generative AI offers a promising solution to bridge the imaging quality gap between ground-based and space-based telescopes, facilitating better astronomical observations.
...
### [85] [Chang'e 7 Lunar Lander Optical Camera-Telescope: Optical Astronomy from the Moon](https://arxiv.org/abs/2608.20806)
...
TL;DR: A new lightweight optical camera-telescope for lunar missions has been designed for the Chang'e 7 mission, with capabilities for wide-field panchromatic imagery.


<details>
  <summary>Details</summary>
Motivation: To establish sustainable astronomical operations from the Moon's south pole, enhancing lunar observational capabilities.

Method: The design and manufacture of a wide-field optical camera-telescope, including ground-based performance testing and simulations of astronomical observations.

Result: Preliminary performance indicates the camera can operate effectively over a wide temperature range, achieving static panchromatic imagery within specified wavelengths.

Conclusion: The camera's design supports its scientific goals, balancing sensitivity and angular resolution for optimal lunar astronomical observations.
...
### [86] [EXPO: a quantum leap in fast, wide-band X-ray polarimetry for astrophysics](https://arxiv.org/abs/2608.20898)
...
TL;DR: EXPO is a proposed ESA mission aiming to enhance X-ray polarimetry through wider energy range and faster repointing, facilitating advanced studies in astrophysics.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of IXPE and enhance scientific capabilities in the exploration of high-energy astrophysical phenomena.

Method: EXPO utilizes five X-ray telescopes and gas photoelectric polarimeters for a 2-35 keV energy range, complemented by additional instruments for monitoring and imaging.

Result: Enables extensive research on magnetars, black holes, gamma-ray bursts, and more, broadening the scope of X-ray polarimetry.

Conclusion: EXPO promises to expand observational capabilities in time-domain astrophysics and multi-messenger astronomy.
...
### [87] [NAIR-APREXIS: Enabling photonics-based instruments for long-baseline interferometry and integral-field spectroscopy](https://arxiv.org/abs/2608.21001)
...
TL;DR: The NAIR project advances photonic technologies for infrared long-baseline interferometry and precision spectroscopy through ultrafast-laser inscription techniques, demonstrating significant results in beam combining and exoplanet detection instrumentation.


<details>
  <summary>Details</summary>
Motivation: To enhance astronomical instrumentation capabilities using advanced photonic technologies, particularly in infrared applications.

Method: Development of single-mode K-band beam combiners and integral field units through ultrafast-laser inscription, with subsequent on-sky testing and measurement of performance metrics.

Result: Achieved 1% precision on interferometric visibilities and over 40% throughput with a K~5 limiting magnitude. The IFU aims for 1e-3 contrast between adjacent spaxels while maintaining >50% throughput.

Conclusion: The successes in the NAIR project underscore the promise of integrated photonic technologies in advancing astronomical instrumentation.
...
### [88] [NestyNet. III. Symbolic Regression from Analytic Neural Surrogates](https://arxiv.org/abs/2608.21051)
*Rodrigo Ibata,Wassim Tenachi,Foivos Diakogiannis,Neil Ibata,Anirudh Shankar*

Main category: astro-ph.IM

TL;DR: NestyNet-SR achieves exact symbolic recovery of physical laws from data by combining neural networks with a novel symbolic search technique, supporting feature discovery and dimensional analysis.


<details>
  <summary>Details</summary>
Motivation: To find the right representation of physical laws from data, as traditional symbolic regression techniques struggle with combinatorial complexity.

Method: NestyNet-SR leverages neural surrogate models with analytic derivatives to transform complex multivariate problems into simpler components, employing a tiered symbolic search to derive closed-form expressions.

Result: NestyNet-SR exactly recovers all 120 noiseless equations on the SRBench AI~Feynman benchmark, and effectively deduces physical relationships from real data, exemplified by its analysis of SPARC-survey galaxies.

Conclusion: The method demonstrates how analytic derivatives can bridge neural networks and interpretable empirical laws, advancing both symbolic regression and automated feature discovery.
...
### [89] [DOLPHIN (Device of Line Photometry in Nasmyth): A Switchable Multiband Photometer for the ISAS 1.3-m Telescope](https://arxiv.org/abs/2608.21054)
*Kohei Miyakawa,Hirokazu Kataza,Teruyuki Hirano,Hajime Kawahara,Shotaro Tada,Takehiko Wada*

Main category: astro-ph.IM

TL;DR: DOLPHIN, a new instrument for switchable photometry, has been developed for a 1.3-m telescope, offering broad and narrow-band capabilities with efficient filter switching and strong performance metrics.


<details>
  <summary>Details</summary>
Motivation: The aim is to create a cost-effective instrument for precise differential measurements in astrophysics using modest-size telescopes.

Method: DOLPHIN utilizes a motorized eight-position filter wheel with standard optical paths to switch between various filters quickly, employing a CMOS detector and characterizing its performance in a laboratory setting.

Result: Characterization shows excellent detector linearity and low noise, and commissioning observations validate its operational effectiveness and relative photometric stability with RMS varying from 0.34% to 0.94%.

Conclusion: DOLPHIN proves to be a viable tool for differential photometric monitoring, highlighting its future potential while identifying areas for improvement.
...
### [90] [Measurement of the muon flux at SNOLAB using the DEAP-3600 experiment](https://arxiv.org/abs/2608.20504)
...
TL;DR: The DEAP-3600 experiment at SNOLAB measures muon flux using water as a veto detector, yielding results consistent with previous findings and simulations.


<details>
  <summary>Details</summary>
Motivation: To provide a direct measurement of muon flux at SNOLAB, which is crucial for dark matter searches and future rare-event experiments.

Method: Muon flux measured through a cut-and-count analysis of events in the muon veto detector and liquid argon target, using data from November 2016 to March 2020.

Result: Muon flux measured at $(3.71 	 0.25_{	extrm{stat}} 	 0.09_{	extrm{sys}}) 	imes 10^{-10}	 	/cm^2/s, compatible with prior results from the SNO experiment.

Conclusion: These findings serve as a benchmark for future rare-event searches at SNOLAB, affirming the consistency with earlier measurements and simulations.
...
### [91] [Evidence for $η_{c}(2S)\to p\bar{p}π^{+}π^{-}π^{0}$ and observation of $χ_{cJ} \to p\bar{p}π^{+}π^{-}π^{0}$](https://arxiv.org/abs/2608.21006)
...
TL;DR: The study investigates the decay processes of $ψ(3686)$, providing evidence for $η_{c}(2S)$ decay and measuring several branching fractions with improved precision.


<details>
  <summary>Details</summary>
Motivation: To investigate the decay process of $ψ(3686)$ and the hadronic decays of $χ_{cJ}$, enhancing knowledge about these particle interactions.

Method: Analysis of $(2.712	ext{ billion})$ $ψ(3686)$ events collected by the BESIII detector to identify decay processes and measure branching fractions.

Result: Evidence for $η_{c}(2S)	o par{p}π^{+}π^{-}π^{0}$ is found. Branching fractions for $χ_{cJ} 	o par{p}π^+π^-π^0$ and $χ_{cJ} 	o par{p}ω$ are measured with improved precision.

Conclusion: The results enhance our understanding of the hadronic decays of the $χ_{cJ}$ states and are expected to contribute to future studies in particle physics.
...
### [92] [Angular analysis of the decay ${\it Λ}_{\it b}^{0} \to {\it Λ}(1520){\it μ^{+}μ^{-}}$](https://arxiv.org/abs/2608.21082)
...
TL;DR: This paper presents the first angular analysis of Λb0 decays using LHCb data, finding results consistent with Standard Model predictions.


<details>
  <summary>Details</summary>
Motivation: To investigate Λb0 decays and test the predictions of the Standard Model through angular distributions.

Method: The analysis uses LHCb data from 2011 to 2018, examining angular distributions and determining asymmetries across dimuon invariant mass intervals.

Result: Calculated the leptonic forward-backward asymmetry and the CP-averaged angular observable, showing agreement with Standard Model predictions.

Conclusion: The results affirm the validity of the Standard Model in describing Λb0 decay processes.
...
### [93] [New Limits on $n \rightarrow n'$ Transformation from HFIR Cold Neutron Beam](https://arxiv.org/abs/2608.21120)
...
TL;DR: This paper reports a new search for neutron to sterile neutron transformations, improving the lower limit on the transformation probability based on experimental results.


<details>
  <summary>Details</summary>
Motivation: To investigate the potential existence of sterile neutrons as a clue to the nature of Dark Matter and to explore baryon number violation.

Method: Utilized an intense cold neutron beam and a theoretical model with a mass difference and mixing angle to search for neutron transformations using a superconducting magnet and a cadmium wafer.

Result: No significant signal was detected, leading to an order of magnitude improvement in the lower limit for the transformation probability over a range of mass differences.

Conclusion: The findings contribute to the understanding of baryon number violation and the properties of Dark Matter, refining constraints on hypothetical neutron transformations.
...
### [94] [Development of A Novel Compton Camera for MeV Gamma-Ray Measurement in Space](https://arxiv.org/abs/2608.21216)
...
TL;DR: This paper presents a novel three-layer Compton camera designed for detecting MeV gamma rays, addressing the technology gap in this energy region and showcasing its imaging capabilities for future missions.


<details>
  <summary>Details</summary>
Motivation: The need to explore gamma rays in the MeV region, historically under-researched due to technological limitations, which is crucial for various studies in astrophysics and astro-particle physics.

Method: Development of a novel three-layer Compton camera with energy resolution under 4% and position resolution around 2 mm, including its design and calibration process.

Result: Successful calibration and validation of the Compton camera, demonstrating its capability for imaging MeV gamma-ray sources.

Conclusion: The camera's performance supports its use in upcoming in-orbit missions, enhancing gamma-ray astronomy and related research fields.
...
### [95] [On-Detector Machine Learning for Beam-Induced Background Rejection at a 10 TeV Muon Collider](https://arxiv.org/abs/2608.21327)
...
TL;DR: The paper explores on-detector Machine Learning techniques for rejecting beam-induced background (BIB) in a Muon Collider's vertex detector, achieving significant data reduction while maintaining high signal efficiency.


<details>
  <summary>Details</summary>
Motivation: To enhance detection capabilities and manage data overload caused by intense beam-induced backgrounds in a 10 TeV Muon Collider.

Method: Utilized lightweight neural-network architectures to analyze pixel cluster shapes for distinguishing background signals from actual collision events, evaluated using high-level synthesis for implementation feasibility.

Result: The proposed architectures achieved 88-90% data reduction with 99% signal efficiency, compatible with ASIC hardware resources.

Conclusion: Directly implementing BIB rejection in pixel readout is a viable strategy to address the tracker readout demands in future Muon Colliders.
