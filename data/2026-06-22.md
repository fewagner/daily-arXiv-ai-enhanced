...
TL;DR: The paper presents experimental validation of dual-ruled gratings, enhancing throughput for dual-bandpass spatial heterodyne spectrometers used in astrophysical measurements.


<details>
  <summary>Details</summary>
Motivation: To improve throughput in dual-bandpass spatial heterodyne spectrometers by addressing the gap created by separate ruling densities and blaze angles in diffraction gratings.

Method: Experimental validation of a symmetric-facet dual-ruled grating; measurements conducted with a deuterium source and Czerny-Turner monochromator, analyzing diffraction efficiencies across multiple orders.

Result: Experimental results showed diffraction efficiencies consistent with theoretical predictions, revealing minor manufacturing defects.

Conclusion: The study validates the efficacy of dual-ruled gratings for high-resolution spectroscopy, paving the way for enhanced observational capabilities in astrophysics and planetary science.
...
TL;DR: Neural networks can predict Newtonian noise from seismic waves more effectively than Wiener filters, especially under certain conditions.


<details>
  <summary>Details</summary>
Motivation: To address the limitation of low-frequency sensitivity in future gravitational wave detectors caused by Newtonian noise from seismic activity.

Method: Synthetic data was generated using a simulation of seismometer arrays to compare the performance of neural networks against a Wiener filter in predicting Newtonian noise.

Result: Neural networks showed comparable performance to Wiener filters in stationary wave fields, but significantly outperformed them in specific cases by factors of 15-80 and reduced noise amplitude spectral density by factors of 10-30.

Conclusion: Neural networks, particularly CNNs and GNNs, are promising tools for predicting and mitigating Newtonian noise in gravitational wave detection.
...
TL;DR: VASTER, a real-time transient detection pipeline on the ASKAP, has identified new long period transients and demonstrated the capability to explore previously overlooked regions in time domain astronomy.


<details>
  <summary>Details</summary>
Motivation: To address the gap in transient detection across seconds to minutes, leveraging advancements in widefield radio telescopes.

Method: VASTER processes ASKAP survey data in real time, generating images every 15 minutes to identify short-timescale astronomical transients.

Result: In its first two weeks of operation, VASTER detected two long period transients with periods of 6.48 and 4.69 hours, contributing to a new population of astronomical sources.

Conclusion: VASTER highlights the potential for real-time processing in discovering and studying long period transients and enhances the understanding of time-domain phenomena.
...
TL;DR: The paper discusses the design and prototyping of MOSAIC, a multi-object spectrograph for the Extremely Large Telescope, addressing significant challenges related to positioner design and atmospheric correction.


<details>
  <summary>Details</summary>
Motivation: To utilize the capabilities of the Extremely Large Telescope through an innovative multi-object spectrograph that can manage large-scale astronomical observations.

Method: The design involves 300 robotic positioners equipped with individual atmospheric dispersion correctors, utilizing relay mirrors to accommodate focal surface challenges.

Result: Initial designs and prototypes for the positioners have been developed, emphasizing solutions for local telecentricity and light beam focus.

Conclusion: The paper outlines the foundational steps in designing MOSAIC's positioners while addressing the unique challenges posed by the ELT's scale.
...
TL;DR: The IXPE mission successfully detects X-ray polarization, prompting the development of a new focal-plane polarimeter to extend its energy range and improve sensitivity.


<details>
  <summary>Details</summary>
Motivation: The IXPE mission's successes have highlighted the need for advanced instrumentation in X-ray astronomy to tackle more scientific questions.

Method: Developing a focal-plane polarimeter using multilayer mirrors and stacked instrumentation for better sensitivity at higher energy ranges in X-ray polarimetry.

Result: The design aims to extend the IXPE's energy capabilities up to tens of keV while maintaining lower background noise.

Conclusion: The hardware, grounded in previous flight heritage, shows promise for enhancing X-ray polarimetry and meeting the demands of future space applications.
...
TL;DR: The paper introduces 'lightstack', a Python package for integrating standalone images into photometric data cubes, facilitating multi-band photometry analysis.


<details>
  <summary>Details</summary>
Motivation: To leverage advancements in multi-imaging datasets from telescopes like Hubble and Webb while addressing the need for efficient data processing in multi-band photometry.

Method: The lightstack workflow involves cropping images from a mosaic, stacking these images into a data cube, and matching point spread functions (PSF) for consistent analysis across bands.

Result: The package efficiently prepares photometric data cubes for studies in multi-band photometry, streamlining the process for researchers.

Conclusion: The lightstack package is now available under an MIT license, aiming to support researchers in photometric studies using diverse imaging datasets.
...
TL;DR: The AASKAII outlines the scientific advancements anticipated from SKA telescopes, reflecting on design evolution and new discoveries since its last edition.


<details>
  <summary>Details</summary>
Motivation: To highlight the advancements and transformative impact of the SKA telescopes on radio astronomy and related scientific research.

Method: Contributions are organized into six thematic categories, with overview chapters from SKA Science Working Groups providing context for ongoing research questions.

Result: The call for collaborative insights showcases the broad range of future discoveries in radio astronomy anticipated from SKA-Mid and SKA-Low.

Conclusion: AASKAII plays a crucial role in setting the stage for upcoming innovations and discoveries in the field, emphasizing the SKA's contributions to addressing major scientific questions.
...
TL;DR: Elma is a Python package for automated estimation of bar lengths in barred galaxies, helping overcome challenges in manual measurements.


<details>
  <summary>Details</summary>
Motivation: The measurement of bar lengths in galaxies is essential for understanding their evolutionary processes but is hampered by time-consuming manual methods and methodological variability.

Method: Elma uses elliptical-isophote fitting on 2D imaging data to derive the radial ellipticity profile, identifying bar lengths from the semi-major axis of the local maximum in ellipticity.

Result: The package successfully processes JWST/NIRCam imaging data, providing accurate bar length estimates for galaxies in the GOODS-South field.

Conclusion: Elma offers an efficient and automated solution for bar-length estimation, facilitating large imaging surveys and enhancing galaxy structure analysis.
...
### [9] [Solving Nonequilibrium Dynamics via Influence Matrix Bootstrap: Floquet-PXP Model](https://arxiv.org/abs/2606.19430)
*Xiao-Yang Yang,He-Ran Wang,Zhong Wang*

Main category: quant-ph

TL;DR: This paper addresses the challenges of characterizing nonequilibrium dynamics in integrable systems using the 'Rule 201' quantum cellular automaton and proposes methods for obtaining exact local solutions and understanding dynamics under perturbations.


<details>
  <summary>Details</summary>
Motivation: Characterizing nonequilibrium dynamics in integrable systems remains a significant challenge beyond equilibrium properties, necessitating new methods for investigation.

Method: The authors develop generalized zipper conditions using a tensor-network approach to influence matrices, introduce a numerical bootstrap method for finite bond dimensions, and analyze entanglement growth and correlations.

Result: The approach reveals complex nonequilibrium behaviors influenced by initial states, solutions for oscillating dynamics under perturbations, and insights into multitime correlations.

Conclusion: This unified method allows for investigating both nonthermalizing and thermalizing regimes in nonequilibrium dynamics, potentially enabling experimental verification in quantum simulators.
...
### [10] [Indefinite Quantum Causality](https://arxiv.org/abs/2606.19438)
*Fabio Costa,Giulia Rubino,Cyril Branciard,Časlav Brukner,Marco Túlio Quintino*

Main category: quant-ph

TL;DR: The paper reviews advances in operational approaches to quantum foundations, focusing on indefinite causal order as a valuable resource in quantum information processing.


<details>
  <summary>Details</summary>
Motivation: The need to explore quantum theory's causal structure relaxes traditional assumptions about causality, with implications for fundamental physics, general relativity, and quantum computing.

Method: The review discusses the 'process matrix formalism' to understand indefinite quantum causality.

Result: It outlines key findings and highlights experimental implementations of indefinite causal order.

Conclusion: Recent advances show potential for indefinite causal order in enhancing quantum information processing capabilities.
...
### [11] [Efficient classical representation and quantum state preparation of complete active space wavefunctions](https://arxiv.org/abs/2606.19457)
*Hamza Jnane*

Main category: quant-ph

TL;DR: The paper presents an efficient method for preparing multi-reference quantum states (CAS) using a matrix product state representation, significantly improving gate complexity compared to existing protocols.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of preparing initial quantum states for electronic structure problems in molecules with strong electron correlation.

Method: The authors utilize the Quantum Paldus Transform (QPT) to represent complete active space (CAS) states as matrix product states (MPS) with polynomially scaling complexity.


Result: The new state preparation method achieves a bond dimension that scales as O(d^2) and complexity growing as O(d^3), marking a significant improvement over traditional methods.

Conclusion: This approach enables efficient state preparation for CAS states in quantum computing, facilitating advancements in solving complex electronic structure problems.
...
TL;DR: The paper examines the effects of quantum $q$-deformation and $h$-deformation on multi-qubit states, showing how these relate to the Hamiltonian of deformed models and how fidelity with undeformed states varies.


<details>
  <summary>Details</summary>
Motivation: To bridge algebraic constructions of quantum states with practical applications in quantum information experiments.

Method: States of an $N$-qubit Hilbert space are constructed using Clebsch-Gordan coefficients based on $q$- and $h$-deformations of the Hopf algebra $	ext{U}(	ext{sl}(2,	ext{R}))$, and fidelities with undeformed states are calculated.

Result: The study finds that $q$-deformation modifies states with residual overlap to undeformed ones, while $h$-deformation leads to orthogonal states, with implications for fidelity scaling in the macroscopic limit.

Conclusion: Both deformations require an $N^{-1}$ rescaling to maintain fidelity stability, indicating different behaviors in quantum correlations for varying qubit systems.
...
### [13] [Optimized Quantum States for Sensing in the Presence of Loss and Phase Noise](https://arxiv.org/abs/2606.19649)
*Shruti Maliakal,Zachary Mann,Christopher Wipf,Rana X Adhikari,Su Direkci,Yanbei Chen*

Main category: quant-ph

TL;DR: Non-Gaussian states outperform Gaussian states in squeezed vacuum applications for gravitational-wave detectors under loss and phase noise conditions.


<details>
  <summary>Details</summary>
Motivation: To enhance the performance of quantum sensors like gravitational-wave detectors beyond the standard quantum limit, which is hindered by phase noise.

Method: Numerical optimization of quantum Fisher information considering loss and phase noise, identifying non-Gaussian states and categorizing them into Fock-like, cubic-phase-like, and states with discrete rotational symmetry.

Result: With a maximum average photon number of 5 and specific loss and phase noise conditions, non-Gaussian states demonstrated a performance advantage of up to 2.2 dB over Gaussian states.

Conclusion: Non-Gaussian states can maintain their advantage in measurement strategies, including homodyne detection, offering a potential pathway for improved sensitivity in quantum sensors.
...
TL;DR: This paper examines the enhancement of state generation in photonic linear optical networks through heralding techniques, focusing on local controllability and the quantification of resource requirements for maximizing accessible states.


<details>
  <summary>Details</summary>
Motivation: Existing passive linear optical networks are limited by bosonic symmetries; heralding is a method to overcome these constraints and expand the range of reachable photonic states.

Method: The paper analyzes the rank of the Jacobian matrix representing the output state relative to the unitary circuit for both passive and heralded optical systems to gauge local controllability.

Result: The analysis demonstrates how different ancillary resources increase locally accessible states compared to passive networks, identifies the resources needed for maximal Jacobian rank, and establishes conditions for global reachability.

Conclusion: The framework provides a comprehensive tool for evaluating and comparing the state space of measurement-based photonic systems, informing practical criteria for resources necessary in advanced quantum state engineering.
...
### [15] [Nearest-neighbour gates are all you need: High-rate quantum low-density parity-check codes on a planar grid](https://arxiv.org/abs/2606.19482)
*Boren Gu,Tamas Noszko,Vincent Steffan,Jens Niklas Eberhardt,Joschka Roffe,Jens Eisert,Stergios Koutsioumpas*

Main category: quant-ph

TL;DR: This paper presents a novel approach to quantum low-density parity-check codes that enhances fault-tolerant quantum computation with planar layouts and nearest-neighbour gates, achieving higher efficiency and reduced error rates compared to existing methods.


<details>
  <summary>Details</summary>
Motivation: The aim is to address challenges in implementing quantum low-density parity-check codes in superconducting architectures, specifically the limitations of long-range connectivity and qubit shuttling.

Method: The study introduces quantum codes utilizing planar open-boundary layouts and dynamic check-data connectivity via nearest-neighbour iSWAP walks, enabling efficient stabiliser measurement without long-range connections.

Result: The proposed codes exhibit higher code-efficiency ratios and significantly lower error rates compared to rotated surface-code memories, particularly in finite-size instances like the [[323,14,15]] code.

Conclusion: The benefits of quantum low-density parity-check codes can be realized in near-term hardware, paving the way for improved fault-tolerant quantum memories.
...
### [16] [Optimal Ansatz-free Hamiltonian Learning In Situ](https://arxiv.org/abs/2606.19486)
*Taiqi Zhou,Weiyuan Gong*

Main category: quant-ph

TL;DR: This paper presents a novel algorithm for Hamiltonian learning in quantum systems, optimizing for computational efficiency and practicality without needing deep circuits or extensive control.


<details>
  <summary>Details</summary>
Motivation: To improve methods for characterizing Hamiltonians in quantum systems, which is crucial for device calibration and error correction.

Method: A control-free, ancilla-free algorithm using Pauli product state preparation and measurement, achieving Hamiltonian learning with optimal evolution time.

Result: An evolution time of Θ(Λ/ε² log(Λ/ε)) is proven to be optimal, while showing robustness against SPAM noise for local Hamiltonians post-calibration.

Conclusion: The proposed method offers an efficient and practically viable approach for Hamiltonian learning, facilitating advancements in near-term quantum device applications.
...
### [17] [Entanglement Scaling and Problem Structure in Quantum Approximate and Adiabatic Optimization Algorithms](https://arxiv.org/abs/2606.19502)
*Georgios Arapantonis,Paraj Titum,Gregory Quiroz*

Main category: quant-ph

TL;DR: This paper examines the relationship between entanglement and performance in the Quantum Approximate Optimization Algorithm (QAOA) for the MaxCut problem, revealing how parameter training affects entanglement scaling, and comparing it with adiabatic quantum computation.


<details>
  <summary>Details</summary>
Motivation: To understand the role of entanglement in variational quantum algorithms, specifically in relation to problem structure and algorithmic performance.

Method: The study analyzes the Quantum Approximate Optimization Algorithm (QAOA) applied to the MaxCut problem, investigating the effects of variational parameter training on entanglement profiles and comparing them to adiabatic quantum computation.

Result: Findings indicate that suboptimal training alters entanglement profiles, with QAOA demonstrating scaling of entanglement consistent with fermionic Gaussian states across various MaxCut instances.

Conclusion: The research highlights the distinct behaviors of entanglement in QAOA versus adiabatic methods, linking it to computational efficiency and problem structure.
...
### [18] [Exact Markovian Dissipation Requires Singular Energy Resources](https://arxiv.org/abs/2606.19510)
*Hiroki Nakabayashi*

Main category: quant-ph

TL;DR: The GKLS equation fails to provide a precise description of irreversible quantum dynamics under normal energy conditions, showing that sublinear decay in survival probability contradicts linear decay in GKLS semigroups, indicating singular energy resources are required for Markovian dissipation.


<details>
  <summary>Details</summary>
Motivation: To explore the limitations of the GKLS equation in modeling irreversible quantum dynamics under realistic energy conditions.

Method: The authors prove that the survival probability in open systems exhibits sublinear decay under physically regular energy conditions, contrasting with the linear decay characteristic of GKLS semigroups.

Result: Under normal energy conditions, we find that the open-system survival probability decays sublinearly, suggesting that the GKLS description is not exact and that it relies on singular energy scenarios.

Conclusion: Dissipative time-independent GKLS equations serve as effective models rather than precise representations of Hamiltonian dynamics conforming to regular energy conditions.
...
### [19] [Distinguishing quantum processes with bounded coherent memory](https://arxiv.org/abs/2606.19511)
*Magdalini Zonnios,Felix C. Binder*

Main category: quant-ph

TL;DR: This paper introduces a framework called $	ext{MAD}$ for distinguishing multi-time quantum processes using coherent memory, providing a more scalable alternative to traditional methods.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of distinguishing and learning temporally correlated quantum dynamics, which require significant resources in terms of memory and control.

Method: The authors propose machines for autonomous distinction ($	ext{MAD}$) that utilize a consistent quantum instrument across time steps, optimizing probe strategies with bounded classical memory.

Result: The $	ext{MAD}$ framework can compile any $N$-step strategy into a single $	ext{MAD}$, achieving performance close to the strategy-norm benchmark, especially as coherent memory increases.

Conclusion: The $	ext{MAD}$ distinguishability measure offers a practical and efficient means to understand multi-time quantum processes while effectively utilizing limited coherent memory.
...
### [20] [Complexity of detecting large coefficients in the Pauli basis](https://arxiv.org/abs/2606.19545)
*Santiago Cifuentes*

Main category: quant-ph

TL;DR: This paper analyzes a quantum state decision problem related to finding non-identity Pauli matrices that meet a specific trace condition, demonstrating its complexity implications in the context of quantum computing classifications.


<details>
  <summary>Details</summary>
Motivation: To explore the feasibility of efficiently identifying the largest coefficients in the Pauli basis of quantum states and its implications for quantum complexity classes.

Method: The authors investigate whether a non-identity Pauli matrix $P$ exists such that $|Tr(P ρ)| 
eq 0$ given a quantum state $ρ$, leveraging reductions from the minimum-weight code problem for classification.

Result: The problem is established to belong to the QCMA complexity class, and if it resides in BQP, it leads to the conclusion that NP is included in BQP, suggesting a significant relationship between quantum and classical complexity classes.

Conclusion: The findings indicate that efficient procedures for quantum state tomography in this context do not exist unless NP can be efficiently solved by quantum computers under standard complexity assumptions.
...
### [21] [Passive-User Bell-State Loop-Back Key Establishment without Quantum Detectors at the User Nodes](https://arxiv.org/abs/2606.19551)
*Luis Adrián Lizama-Pérez*

Main category: quant-ph

TL;DR: This paper presents a Bell-state-based quantum key distribution protocol using passive users without needing quantum transmitters or detectors. Alice, the active sender, manages the entangled states while passive users apply operations that are concealed from her. The protocol allows secure key establishment through Bell-state measurements and offers resilience against certain attacks.


<details>
  <summary>Details</summary>
Motivation: To create a secure quantum key distribution method that enables passive users to securely establish a key without quantum transmitters or detectors, leveraging Bell states.

Method: Alice retains one qubit of an entangled Bell pair and sends the other qubit to two passive users, who apply local Pauli operations. Alice then performs a Bell-state measurement to identify an effective operation while keeping the individual user operations hidden.

Result: The protocol allows Alice to learn only the composition of the operations applied by the passive users, ensuring that the individual actions of each user remain concealed despite their ability to infer each other's operations from their own.

Conclusion: The Bell-state version enhances distributed transformation in QKD with improved success rates, reliant primarily on Bell-state measurement success, while providing strong theoretical foundations and protections against specific types of attacks.
...
### [22] [Electrical Noise Produced by Micron-Sized Particles above a Surface Paul Trap](https://arxiv.org/abs/2606.19585)
*Ben Saarel,Ozgur Sahin,Hartmut Häffner,Alpha T. N'Diaye*

Main category: quant-ph

TL;DR: Electric field noise from ion trap electrodes impairs quantum computing fidelity, with noise levels varying significantly due to nearby particles, which can be modeled as lossy dielectrics.


<details>
  <summary>Details</summary>
Motivation: To understand the causes of electric field noise in ion trap electrodes affecting quantum computing performance.

Method: Measurements were taken along the symmetry axis of a linear surface Paul trap, correlating noise levels with optical and scanning electron microscope images showing particles near trapping locations.

Result: Noise levels varied by three orders of magnitude in a 600μm segment, with particles modeled as lossy dielectrics explaining the observed noise characteristics.

Conclusion: The findings provide insights that may account for discrepancies in previously reported electric field noise levels.
...
### [23] [Emergency hub placement with a neutral-atom quantum computer](https://arxiv.org/abs/2606.19589)
*Sara Tarquini,Matteo Vandelli,Francesco Ferrari,Daniele Dragoni,Francesco Tudisco*

Main category: quant-ph

TL;DR: This paper presents a hybrid quantum-classical approach to optimize emergency operation center placement in disaster response using a graph-based minimum dominating set formulation.


<details>
  <summary>Details</summary>
Motivation: To address the critical need for timely disaster response through optimal placement of emergency operation centers.

Method: The proposed method utilizes a hybrid quantum-classical framework that generates candidate dominating sets using quantum samplers and refines them with classical algorithms, benchmarked on synthetic and real cases.

Result: The approach successfully solves instances up to 100 nodes on a quantum processor, yielding near-optimal solutions despite hardware noise.

Conclusion: Neutral-atom quantum devices can effectively tackle graph optimization challenges, facilitating real-world applications in disaster response.
...
### [24] [Stalls and Spequlation: Pipelined Execution for Fault Tolerant Quantum Computation](https://arxiv.org/abs/2606.19593)
*Aditi Awasthi,Gokul Subramanian Ravi,Jonathan Mark Baker*

Main category: quant-ph

TL;DR: The paper introduces a pipelined execution framework for fault-tolerant quantum computation, improving efficiency by decomposing logical operations and employing speculation strategies, resulting in a 20-40% reduction in pipeline steps.


<details>
  <summary>Details</summary>
Motivation: Current models for scheduling logical operations in quantum computing are inefficient as they don't account for idle times in subsystems, necessitating a better approach to enhance performance.

Method: A pipelined execution framework decomposes logical operations into Control, Execute, and Decode stages and applies speculation strategies to allow overlapping processing of operations.

Result: Implementing pipelining with speculation reduces total pipeline steps by 20-40% compared to a no-speculation baseline, with aggressive strategies outperforming conservative methods despite occasional rollbacks.

Conclusion: The proposed framework improves load balancing and execution efficiency in quantum computation systems by minimizing idle times and maximizing computational output.
...
### [25] [String dynamics of a (2+1)D U(1) quantum link model on a digital quantum computer](https://arxiv.org/abs/2606.19601)
...
TL;DR: The paper presents a quantum link model for studying string dynamics in (2+1)D U(1) gauge theory on quantum hardware, achieving effective real-time simulations and accurate results compared to tensor-network calculations.


<details>
  <summary>Details</summary>
Motivation: To explore the dynamics of confining gauge theories using quantum computing methods, particularly in the context of U(1) pure gauge theory.

Method: A minimal U(1) quantum link model is implemented on quantum hardware, utilizing qubits to represent dual height variables, with tailored lattice geometry matching the hardware design to enable efficient calculations of plaquette interactions.

Result: Digital quantum simulations up to 112 qubits demonstrate agreement with tensor-network calculations at short times and with thermal averages at long times, revealing significant fluctuations near phase transitions.

Conclusion: The study validates the use of quantum hardware for probing string dynamics in gauge theories, with accurate predictions even in regimes affected by noise.
...
### [26] [Subsystem Quantum Error Correction for Noisy Quantum Metrology](https://arxiv.org/abs/2606.19628)
*Qiushi Liu,Sisi Zhou*

Main category: quant-ph

TL;DR: Subsystem error correction simplifies quantum parameter estimation, achieving Heisenberg limit with fewer ancillae.


<details>
  <summary>Details</summary>
Motivation: Existing quantum error correction methods for parameter estimation are resource-intensive and inefficient.

Method: By employing subsystem stabilizer codes, we derive conditions for achieving the Heisenberg limit, minimizing the need for multiple ancillae, utilizing syndrome-free protocols.

Result: Demonstrated achievement of Heisenberg limit with minimal ancilla qubits and extended the approach to dynamical error correction using Floquet codes.

Conclusion: Subsystem error correction represents a significant advance, making quantum metrology more efficient and feasible.
...
### [27] [Quantum Dynamics from Lax Pair Theory: A Reconstruction from Spectrum Preservation](https://arxiv.org/abs/2606.19664)
*Péter Szabó*

Main category: quant-ph

TL;DR: The paper establishes a framework for unitary quantum dynamics using minimal axioms from Hilbert-space observables and isospectral evolution, leading to key quantum equations as theorems.


<details>
  <summary>Details</summary>
Motivation: To provide a foundational perspective on unitary quantum dynamics that connects measurement and dynamical evolution through axioms rather than conventional postulates.

Method: The approach leverages isospectral evolution and continuous flows of Hermitian observables to derive quantum equations and conservation laws.

Result: The derivation includes the Heisenberg equation, Schrödinger equations, and conservation laws as theorems, demonstrating consistency between measurement outcomes and quantum dynamics.

Conclusion: Lax pair theory reveals the Hamiltonian as an emergent generator in quantum dynamics, unifying the concepts of measurement and evolution in a rigorous framework.
...
### [28] [Topological Quantum Interferometry](https://arxiv.org/abs/2606.19730)
*Tianyou Ying,Yufeng Zhou,Chengwei Pan,Ryan Hogan,Ruoyang Zhang,Hui Liu,Shining Zhu,Xiaoqin Gao*

Main category: quant-ph

TL;DR: The paper introduces a method for characterizing high-dimensional quantum states using topological quantum interferometry and the Berry phase, allowing for scalable applications in quantum technologies.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of current methods in characterizing structured light and to enhance the understanding of spatial mode evolution in quantum optics.

Method: The authors develop a topological quantum interferometry formalism driven by the exchange Berry phase (BPX), generalizing state generation and characterization to any topological charge under various tuning conditions.

Result: BPX serves as a geometric marker that decomposes two-photon spatial patterns into fundamental modes determined by geometry, revealing invariants and phase singularities useful for non-tomographic state dimensionality estimation.

Conclusion: The proposed method is device-independent and scalable, offering significant advantages for quantum metrology and the development of high-capacity quantum networks.
...
### [29] [Sparse positive maps on qutrits with exact nondecomposability thresholds and PPT-entanglement transitions](https://arxiv.org/abs/2606.19765)
*Davide Poderini,Angela Rosy Morgillo,Fabio Benatti,Fabio Anselmi,Chiara Macchiavello,Massimiliano F. Sacchi*

Main category: quant-ph

TL;DR: This study investigates sparse positive maps on qutrits, analyzing their positivity, decomposability, and PPT entanglement through Choi matrices, yielding explicit thresholds for separability and bound entanglement.


<details>
  <summary>Details</summary>
Motivation: To gain deeper insights into the behavior of sparse positive maps on qutrits and to establish clear criteria for their entanglement properties.

Method: The study employs an analysis of the Choi matrices of the maps to transform the problem into a Hermitian biquadratic form, allowing for calculating positivity boundaries and transition thresholds between decomposable and non-decomposable maps.

Result: Identified exact positivity boundaries for three parametric families of maps and constructed associated PPT states, revealing conditions for separability, non-decomposability, and bound entanglement.

Conclusion: The analysis provides a comprehensive understanding of the relationships between positivity, decomposability, and entanglement properties in qutrits, as well as clarifying the distinction between positivity and higher-order positivity in trace-preserving maps.
...
### [30] [Robust Generation of Topological Biphoton Mode via Adiabatic Passage](https://arxiv.org/abs/2606.19786)
*Jaesung Lim,Jihwan Kim,Dong-Gil Im,Kyungdeuk Park,Dongkyu Kim,Yonggi Jo,Yong Sup Ihn*

Main category: quant-ph

TL;DR: The paper proposes an adiabatic passage to improve biphoton generation in topological waveguide arrays, overcoming challenges posed by structural disorder.


<details>
  <summary>Details</summary>
Motivation: To address the degradation of quantum properties in biphoton generation due to structural disorder in topological waveguide arrays.

Method: An adiabatic passage connects an isolated site to a topological defect array, initiating the nonlinear process in an isolated regime to suppress unwanted mode coupling.

Result: Numerical simulations show that the adiabatic scheme maintains high biphoton fidelity and a unit Schmidt number despite waveguide disorder, and extends to path entangled NOON states with high quantum interference visibility.

Conclusion: The proposed method offers a practical design for disorder-tolerant integrated quantum photonic devices.
...
### [31] [QMCtwin: Master-Equation Simulation of Syndrome Statistics Beyond Pauli Noise](https://arxiv.org/abs/2606.19848)
*Tong Shen,Huo Chen,Benchen Huang,Tyler Takeshita,Arian Vezvaee,Izhar Medalsy,Daniel A. Lidar*

Main category: quant-ph

TL;DR: This paper introduces QMCtwin, a quantum Monte Carlo framework designed to simulate quantum error correction circuits more accurately by incorporating realistic noise factors and preserving coherent information that standard models might neglect.


<details>
  <summary>Details</summary>
Motivation: The need for improved decoder performance in quantum error correction (QEC) as experimental implementations scale and the limitations of conventional noise modeling approaches.

Method: QMCtwin employs a quantum Monte Carlo framework to simulate master-equation dynamics for a distance-7 rotated surface code involving 97 physical qubits, considering various realistic noise mechanisms.

Result: QMCtwin predicts distinct syndrome-extraction biases and correlations absent in conventional Pauli model simulations, demonstrating the importance of realistic noise features.

Conclusion: The study illustrates that QMC-based simulations can reveal critical noise characteristics overlooked in conventional models, enhancing the accuracy of decoder-facing syndrome models for quantum error correction."
...
### [32] [Random Local Stabilizer Codes in Three Dimensions without String or Self-Similar Fractal Logical Operators](https://arxiv.org/abs/2606.19873)
*Han Yan*

Main category: quant-ph

TL;DR: Introduces qutrit random cubic codes to overcome limitations of string logical operators in quantum error-correcting codes, demonstrating improved self-correction properties and unique characteristics compared to traditional fracton codes.


<details>
  <summary>Details</summary>
Motivation: To address the challenges posed by string logical operators in passive self-correcting quantum error-correcting codes (QECs).

Method: Developed qutrit random cubic codes with varying stabilizers that maintain the no-string property while utilizing a cube-check structure similar to Haah's Codes.

Result: Showed distinct properties from translation-invariant fracton codes, including ground-state degeneracies of $k=2$ for odd $L$ and $k=4$ for even $L$, and absence of self-similar fractal operators.

Conclusion: Constrained randomness in stabilizer codes leads to improved self-correction and reveals new families of QECs and quantum phases beyond traditional classifications.
...
### [33] [Purity and bound energy in ancilla-assisted work extraction](https://arxiv.org/abs/2606.19945)
*B. Vigneshwar,Farhaan Khan,R. Sankaranarayanan*

Main category: quant-ph

TL;DR: This paper explores ancilla-assisted work extraction in quantum batteries, focusing on the relationship between bound energy and purity to predict daemonic gain.


<details>
  <summary>Details</summary>
Motivation: To understand how bound energy and purity influence work extraction efficiency in quantum batteries.

Method: Introduces a purity-based gain metric and a protocol for analyzing dissipation and interactions on daemonic gain under different environmental conditions.

Result: Demonstrates a clear connection between bound energy, purity, and the daemonic gain, revealing how dissipation and spectral structure impact energy extraction.

Conclusion: Daemonic gain is influenced by correlations, the Hamiltonian's spectral structure, and information loss, indicating a complex interplay between these factors.
...
### [34] [QMaxCal: Path-Space Regularization for Open Quantum Control via Girsanov's Theorem](https://arxiv.org/abs/2606.19947)
*Merijn Moody,Zier Mensch,Miranda C. N. Cheng,Peter G. Bolhuis,Max Welling*

Main category: quant-ph

TL;DR: The paper presents regularizers to enhance quantum control under decoherence, showing improved performance in various open quantum systems.


<details>
  <summary>Details</summary>
Motivation: To develop effective strategies for quantum control against decoherence, addressing the challenges posed by environmental noise.

Method: Utilizing Girsanov's theorem to derive differentiable estimators of KL divergence, two regularizers (Wiener KL and Drift-Variance) are introduced, which focus on minimizing decoherence effects instead of control amplitude.

Result: The introduced regularizers significantly outperform traditional gradient-based and reinforcement-learning methods across several tests, demonstrating substantial improvements in fidelity and robustness against noise model mismatches.

Conclusion: The regularizers lead to a marked reduction in control infidelity, achieving up to 50% improvement, indicating their potential for practical applications in open quantum systems.
...
### [35] [Majorana bound states in a hybrid Kitaev ladder with long-range pairing](https://arxiv.org/abs/2606.19963)
*Rajiv Kumar,Tapan Mishra,Levan Chotorlishvili,Sunil Kumar Mishra*

Main category: quant-ph

TL;DR: The paper explores a hybrid Kitaev ladder with superconducting chains exhibiting different pairing types, demonstrating a complex topological phase diagram influenced by long-range pairing, chemical potential, and coupling strength.


<details>
  <summary>Details</summary>
Motivation: To understand how long-range pairing affects the topological properties in superconducting systems and to explore potential applications in quantum information.

Method: The study employs theoretical analysis to examine the interplay between long-range pairing, chemical potential, and inter-leg coupling in a hybrid Kitaev ladder, characterizing the resulting topological phases and modes.

Result: The findings reveal multiple Majorana zero modes and massive Dirac modes, with a transition from a two to four Majorana zero mode phase as the pairing exponent is varied, and indicative hybridization effects.

Conclusion: The research demonstrates the significant role of long-range pairing in shaping topological states, highlighting its potential for creating tunable quantum states in hybrid systems.
...
### [36] [On chip, multifunctional quantum sensing using single spins in a van der Waals crystal](https://arxiv.org/abs/2606.19978)
...
TL;DR: Demonstration of independent dual sensing of temperature and magnetic fields using single quantum emitters in hexagonal boron nitride.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of simultaneous sensing of multiple parameters using a single spin sensor due to cross-sensitivity.

Method: Utilization of optically addressable spins in hexagonal boron nitride for independent measurement of temperature and magnetic fields.

Result: Experimental verification of distinct responses of the zero-phonon line (ZPL) with temperature changes and of ODMR in magnetic fields; successful local temperature sensing while measuring external magnetic fields.

Conclusion: Quantum emitters in hBN are established as an effective platform for multifunctional quantum sensing in real-world scenarios.
...
### [37] [Optimal Shadow Estimation with Minimal Measurement Settings](https://arxiv.org/abs/2606.20003)
*Zhiyao Yang,Datong Chen,Huangjun Zhu*

Main category: quant-ph

TL;DR: This paper addresses the measurement bases needed for optimal shadow estimation in quantum properties, distinguishing between worst-case and average-case scenarios.


<details>
  <summary>Details</summary>
Motivation: To determine the minimal number of measurement bases required for optimal shadow estimation in quantum systems.

Method: The authors prove that $Θ(d^2)$ measurement bases are necessary and sufficient for worst-case optimality, and explore the implications of $2$-designs for average-case scenarios with a focus on sample complexity.

Result: $Θ(d^2)$ bases are needed for worst-case estimation, while $Θ(d)$ bases suffice for average-case; simple implementations achieve average-case optimality with minimal complexity.

Conclusion: The findings reveal a significant complexity difference between worst-case and average-case scenarios in quantum shadow estimation, influencing future quantum information theory and practical applications.
...
### [38] [The use of Peres lattices in periodically driven systems](https://arxiv.org/abs/2606.20009)
*Lukáš Honsa,Jan Střeleček,Jakub Novotný,Pavel Cejnar*

Main category: quant-ph

TL;DR: This paper explores the application of Peres lattices in periodically driven quantum systems, highlighting their efficiency in detecting resonances, chaos onset, and critical Floquet mode properties.


<details>
  <summary>Details</summary>
Motivation: To prove the utility of Peres lattices for analyzing periodically driven quantum systems, an area where efficient resonance detection and chaos monitoring is critical.

Method: The authors apply the Peres lattice method to evaluate the spectral properties of Floquet modes in response to various driving Hamiltonians.

Result: The application reveals the ability to efficiently detect resonances, monitor chaos onset, and assess critical properties of Floquet modes.

Conclusion: Peres lattices significantly enhance the analysis of periodically driven quantum systems, providing a robust framework for spectral comparisons and iterative approximation techniques.
...
### [39] [All-valid-state HOBO encoding for constrained combinatorial optimization on NISQ devices](https://arxiv.org/abs/2606.20017)
*Juncheng Wang,Takumi Kanezashi,Daisuke Tsukayama,Koki Awaya,Reo Saito,Jun-ichi Shirakashi,Tetsuo Shibuya,Hiroshi Imai*

Main category: quant-ph

TL;DR: This study evaluates a variational quantum eigensolver (VQE) for the traveling salesperson problem (TSP) using higher-order binary optimization (HOBO) encodings and different error-mitigation strategies on quantum devices.


<details>
  <summary>Details</summary>
Motivation: Advancements in quantum computing necessitate practical applications for NP-hard problems, making this investigation valuable.

Method: The study employs noiseless simulations and analyzes a new all-valid-state HOBO (AVS-HOBO) scheme to optimize the VQE for TSP instances, comparing it with original HOBO encodings.

Result: AVS-HOBO encoding improves the reliability and scalability of VQE for larger TSP instances, outperforming traditional methods and benefiting from robust error mitigation.

Conclusion: The findings suggest that AVS-HOBO encoding not only enhances VQE performance for TSP on NISQ devices but also has implications for other constrained quantum optimization problems.
...
### [40] [Simulation of Non-Markovian Quantum Accelerated Dynamics via Time-Fractional Schrödinger Equation](https://arxiv.org/abs/2606.20024)
*Dongmei Wei,Junxiang Wang,Hanxiu Xu,Cancan Chen,Jiaying Wu*

Main category: quant-ph

TL;DR: Wei's Time-Fractional Schrödinger Equation effectively simulates the acceleration of non-Markovian quantum systems, demonstrating improved speed and computational efficiency.


<details>
  <summary>Details</summary>
Motivation: To explore efficient simulation methods for the dynamics of non-Markovian quantum systems using the QSL time as a measure of evolution speed.

Method: The study uses Wei's TFSE to analyze the RDJC model, focusing on the influence of non-Markovian memory effects on evolution speed and optimizing parameters such as fractional order and coupling strength.

Result: Wei's TFSE accurately represents the accelerated dynamics across a wider fractional order range compared to Naber's TFSE and shows a marked advantage in computational efficiency for simulating the excited-state probability trajectory.

Conclusion: Wei's TFSE is superior in accuracy and efficiency for simulating non-Markovian quantum system dynamics.
...
### [41] [QPU-scale randomized benchmarking via Bell-pair injection](https://arxiv.org/abs/2606.20123)
*Haripriya Pettugani,María Aguado-Yáñez,Astryd Park,Daniel Bultrini,James R. Wootton*

Main category: quant-ph

TL;DR: This paper introduces Mirror Quantum Awesomeness (MQA), a hybrid protocol enhancing Mirror Randomized Benchmarking (MRB) by integrating a structured entangling layer to better assess quantum processing unit (QPU) error metrics and dynamics.


<details>
  <summary>Details</summary>
Motivation: To improve error analysis in quantum processors and identify limitations of basic error mitigation techniques.

Method: MQA utilizes a structured entangling layer in MRB circuits to track correlation dynamics through mutual information while retaining MRB's error estimates. A topological variant, Topological MQA, introduces a surface-code decoder to locate critical circuit depths.

Result: The study demonstrates that MQA closely aligns with MRB results on entanglement infidelity, identifying critical circuit depths—about 50 for the 	exttt{ibmez} processor, where basic error mitigation falls short.

Conclusion: MQA enhances error analysis capabilities in QPUs by effectively tracking correlation dynamics, offering insights into circuit depth limits for error mitigation strategies.
...
### [42] [Optimizing resource allocation for accuracy in noisy variational quantum algorithms](https://arxiv.org/abs/2606.20153)
*Harshit Verma,Thomas Ayral,Alexia Auffèves,Robert Whitney*

Main category: quant-ph

TL;DR: The paper presents a methodology to optimize Noisy Intermediate-Scale Quantum (NISQ) algorithms, focusing on minimizing resource costs while achieving desired accuracy.


<details>
  <summary>Details</summary>
Motivation: To enable quantum algorithms to perform efficiently, it is crucial to optimize them with minimal resource expenditures, especially in the NISQ era.

Method: The methodology utilizes simulations of the Variational Quantum Eigensolver (VQE) to develop a model that analyzes the trade-offs between accuracy, resource costs (quantum gate operations), and noise in quantum circuits.

Result: The study identifies optimal circuit sizes and iteration counts that balance algorithmic resource costs and accuracy, establishing guidelines for practical implementations on noisy quantum hardware.

Conclusion: The findings offer a framework for efficiently deploying variational quantum algorithms in realistic conditions, taking noise and error mitigation into account.
...
### [43] [Multi-objective design of photon blockade for bright single-photon sources](https://arxiv.org/abs/2606.20160)
*Sunkyu Yu,Xianji Piao,Namkyoo Park*

Main category: quant-ph

TL;DR: The paper introduces a computational framework for optimizing single-photon sources, enhancing performance metrics like purity, brightness, and indistinguishability through an effective optimization method.


<details>
  <summary>Details</summary>
Motivation: The need for high-quality single-photon sources in photonic quantum platforms necessitates balancing conflicting requirements such as purity, brightness, and indistinguishability.

Method: A computational framework using a Liouville-space adjoint formulation is developed, incorporating Jacobian-based updates and simulated annealing for multi-objective optimization in quantum systems.

Result: The framework achieves nearly 60% design success rate for photon blockade with g2(0) < 0.1 and ensures theoretically bounded brightness across varied parameters.

Conclusion: This framework provides a versatile approach for the multi-objective design of open quantum systems, enabling optimized single-photon source development.
...
TL;DR: First results on magnetic dipole hyperfine structure constants of Li, Be, Na, and Mg using a modified Quantum Annealer Eigensolver on D-Wave's quantum hardware.


<details>
  <summary>Details</summary>
Motivation: To explore magnetic dipole hyperfine structure constants using quantum computational methods, which could enhance precision in atomic structure calculations.

Method: Utilized a modified Quantum Annealer Eigensolver with zooming-and-sigma-annealing and floating-point encoding to estimate eigenvalues and eigenvectors of the relativistic Dirac-Coulomb Hamiltonian.

Result: Results benchmarked against MCDHF calculations show consistency with GRASP in determining HFS constants, demonstrating accuracy across different systems and matrix dimensions.

Conclusion: The modified QAE provides a promising quantum computational approach for calculating atomic hyperfine structure constants, potentially improving upon traditional computational methods.
...
TL;DR: The GAS-SCF algorithm uses quantum techniques to enhance SCF optimization in quantum chemistry, achieving theoretical improvements and showcasing its viability through classical simulations of up to 330 qubits.


<details>
  <summary>Details</summary>
Motivation: To improve the efficiency of self-consistent field (SCF) methods in quantum chemistry by leveraging quantum computing.

Method: The GAS-SCF algorithm uses a quantum oracle for marking target Fock states based on a classical energy estimate and applies amplitude amplification to boost measurement probabilities.

Result: The algorithm demonstrates a theoretical quadratic speed-up and successfully simulates systems up to 330 qubits, tackling classically difficult SCF problems.

Conclusion: GAS-SCF shows promise for future large-scale applications in quantum chemistry but necessitates advancements in quantum hardware.
...
TL;DR: This paper presents a variational framework that transforms operators into compact quantum circuits, enhancing efficiency in quantum algorithms and reducing approximation errors through a specialized learning process.


<details>
  <summary>Details</summary>
Motivation: The need for efficient primitives in quantum operators and state preparation limits the capability of quantum hardware and fault-tolerant algorithms, necessitating innovative solutions.

Method: A full-stack variational framework transforms operators into adaptable quantum circuits, using backpropagation and a cost function to optimize both unitary and non-unitary operators, along with a regularization term for error reduction.

Result: The approach was validated in quantum mechanics and engineering applications, showing improved resource scaling in quantum simulations and better error metrics in numerical methods such as the Laplace operator approximation.

Conclusion: This versatile framework not only enhances current quantum and engineering problems but also has potential applications in broader domains, facilitating solutions to more complex problems.
...
TL;DR: A deterministic algorithm for optimizing optical detection in quantum information technologies improves visibility and squeezing efficiency.


<details>
  <summary>Details</summary>
Motivation: To enhance resource levels in quantum protocols through multi-spectral squeezing while minimizing losses during detection.

Method: Development of a deterministic sequential algorithm based on physical principles for optimizing optical beam detection, focusing on achieving global maximum visibility in a pixel basis.

Result: The algorithm increased detection visibility from 76% to 84%, translating to a significant improvement in mode-matching efficiency and quantum readout, with squeezing improvements from -2.08 dB to -2.64 dB.

Conclusion: Deterministic spatial phase shaping is an effective method for enhancing multimode squeezing in waveguide platforms, providing an interpretable alternative to traditional optimization techniques.
...
TL;DR: This work proposes a novel framework for estimating nonlinear properties of quantum states using multi-copy measurements with random projections, optimizing the balance between coherent operations and sampling overhead.


<details>
  <summary>Details</summary>
Motivation: Estimating nonlinear properties of quantum states is essential in quantum information science, but existing methods become impractical for larger systems due to their reliance on extensive coherent operations.

Method: The authors introduce a framework that uses random projections onto lower-dimensional subspaces before performing collective measurements, enabling measurements in a reduced Hilbert space while controlling the balance of coherent operations and sampling overhead.

Result: The study derives explicit formulas connecting projected moments to original states and quantifies the sampling overhead, showing that reducing state dimensions significantly influences the number of required copies for accurate estimations.

Conclusion: This framework allows for optimizing quantum protocols by leveraging the trade-off between coherent operations and the number of state copies, making them more feasible for practical hardware limitations.
...
TL;DR: The paper introduces a symmetry-based error mitigation protocol for Trotterized quantum simulations, enhancing fidelity by preserving symmetries and reducing unphysical dynamics.


<details>
  <summary>Details</summary>
Motivation: Trotterization in quantum simulations often fails to maintain symmetries of the target Hamiltonian, leading to algorithmic errors and unphysical results.

Method: The proposed method applies symmetry transformations to the initial state and interleaves them between Trotter layers, followed by classical post-processing to average measurement outcomes, mitigating Trotter errors.

Result: The protocol was benchmarked on the XY model and the Schwinger model, showing that reflection symmetry and interleaving gauge transformations significantly reduce Trotter errors and maintain validity of physical laws.

Conclusion: The symmetry-based post-processing approach effectively improves the fidelity of Trotterized simulations in near-term quantum devices without increasing circuit depth.
...
TL;DR: Vine Codes are new quantum low-density parity check codes designed for superconducting platforms, utilizing nearest-neighbour gates that promise reduced qubit overheads compared to traditional surface codes.


<details>
  <summary>Details</summary>
Motivation: To address the high qubit overhead of surface codes while leveraging the advantages of superconducting hardware.

Method: Introduction of 'Vine Codes', a type of qLDPC code designed for planar square grids, employing nearest-neighbour gates (iSWAP and CZ) and utilizing routing qubits for open boundary conditions.

Result: Candidate vine codes, such as [[121,4,6]], show up to ~28% fewer qubits than surface codes at circuit distances of 7, with further reductions at higher distances. Simulations indicate better performance under realistic noise conditions compared to surface codes.

Conclusion: Vine Codes and Flip-Vine Codes provide a promising alternative for scalable quantum computing, with reduced qubit requirements and enhanced fault tolerance capabilities.
...
TL;DR: This paper presents a new quasiprobability measure for interpreting Liouville eigenmodes in open quantum systems, highlighting that an oscillator maintains quantized orbits in phase space despite damping effects.


<details>
  <summary>Details</summary>
Motivation: To improve the understanding of eigenstates in open quantum systems, specifically how they decay and their physical interpretation.

Method: A quasiprobability measure is introduced, linking right and left eigenstates of the Liouvillian and visualizing them in doubled phase space as coherences.

Result: The oscillator preserves quantized orbits in phase space across various damping scenarios, with measurable signatures and broadened effects in a thermal bath.

Conclusion: The approach extends semiclassical quantization and invariant tori concepts to open quantum systems, enhancing the understanding of their dynamics.
...
TL;DR: The paper proposes a novel approach using Bose-Einstein condensates to measure particle arrival times indirectly through detector flux, aiming to resolve a longstanding quantum theory question.


<details>
  <summary>Details</summary>
Motivation: The study addresses the fundamental question of the time it takes for particles to reach detectors in quantum mechanics.

Method: A realistic experimental setup is proposed that measures the arrival flux on a detector based on its position rather than direct arrival times.

Result: This approach resolves practical issues related to detector positioning and provides distinct signals to differentiate among various theoretical predictions.

Conclusion: The proposal holds promise for advancing the understanding of particle detection time, contributing to resolving a longstanding debate in quantum theory.
...
TL;DR: This paper investigates the potential of quantum batteries in powering parametric amplifiers and highlights the critical role of pump phase coherence.


<details>
  <summary>Details</summary>
Motivation: To explore whether a finite bosonic quantum battery can replace or reduce the need for continuous microwave drives in parametric amplifiers.

Method: The study quantizes the pump of a nondegenerate parametric amplifier and compares the effects of coherent versus phase-randomized pumps using a closed trilinear model while considering leakage and emitted fields in cascaded temporal modes.

Result: The coherent pump provides significantly better performance metrics, achieving a minimum intensity of 0.553 versus 1.94 for the phase-randomized pump, indicating better phase coherence leads to enhanced amplification properties.

Conclusion: For efficient battery-powered parametric amplification, phase-coherent stored energy is critical, augmented by potential number-noise reduction.
...
### [54] [Entanglement structure of the dynamical phases in the sub-Ohmic spin-boson model](https://arxiv.org/abs/2606.20313)
*Cunxi Gong,Zirui Sheng,Weitang Li*

Main category: quant-ph

TL;DR: The study uses tree tensor network states to investigate the relationship between dynamical regimes in the sub-Ohmic spin-boson model and spin-bath entanglement, revealing that stationary entanglement entropy is an informative observable for understanding quantum dynamics.


<details>
  <summary>Details</summary>
Motivation: To explore the connection between distinct dynamical regimes in the sub-Ohmic spin-boson model and their corresponding spin-bath entanglement structures.

Method: Utilizing tree tensor network states with projector-splitting time evolution (TTN-TDVP-PS) to analyze the spin population dynamics across a grid in the sub-Ohmic parameter space.

Result: The spin entanglement entropy reaches a stationary value on a faster timescale than polarization relaxation, allowing the creation of a stationary entropy landscape that reveals distinct behaviors in different regions of parameter space.

Conclusion: The findings highlight stationary spin entanglement entropy as a critical observable for understanding dissipative quantum dynamics, elucidating its role beyond mere population-based classifications.
...
### [55] [Exploiting More Than Symmetry in Variational Quantum Machine Learning](https://arxiv.org/abs/2606.20316)
*Markus Baumann,Claudia Linnhoff-Popien*

Main category: quant-ph

TL;DR: The paper explores how to effectively impose and design symmetry in variational quantum circuits to enhance model performance, using Tic-Tac-Toe as a case study.


<details>
  <summary>Details</summary>
Motivation: To improve variational quantum learning models by appropriately incorporating symmetry into their parametrizations.

Method: The study analyzes architectural choices in equivariant variational quantum circuits, focusing on symmetry enforcement and trainable interactions, through parameter sharing and subgroup selection.

Result: Suitable symmetry subgroups maintain generalization benefits, while optimal performance is achieved through task-specific interactions on crucial game elements.

Conclusion: Symmetry guides the design space of variational models, but task-informed choices for trainable interactions are essential for effective performance.
...
### [56] [Effective Faraday interaction between light and Helium-3 nuclear spins in a multi-pass cell](https://arxiv.org/abs/2606.20328)
*Kaiwen Yi,Yida Sha,Zejia Lin,Matteo Fadel,Xiang Peng*

Main category: quant-ph

TL;DR: This paper demonstrates a controllable light-nuclear spin interface using metastable helium-3 atoms, enabling enhanced precision for quantum technologies through nuclear spin squeezing.


<details>
  <summary>Details</summary>
Motivation: The motivation is to harness the long coherence time of helium-3 nuclear spins for improved sensing and tests of new physics by creating a light-nuclear spin interface.

Method: The method involves using metastability-exchange collisions in a low-pressure helium-3 gas cell, utilizing a radio-frequency discharge to create metastable atoms for efficient optical pumping and interaction with an optical probe.

Result: The strength of the interaction is characterized based on nuclear polarization, magnetic field, and probe parameters, with a projected measurement-induced squeezing rate of 0.52 s$^{-1}$ after enhancing probe power.

Conclusion: The results offer a practical approach to optical access in helium-3 nuclear spins, facilitating the creation of macroscopic nuclear spin-squeezed states for quantum metrology.
...
### [57] [Observation of alignment tensor effects in metastability-exchange collisions with highly polarized 3He ensembles](https://arxiv.org/abs/2606.20330)
*Yida Sha,Kaiwen Yi,Xingqing Jin,Matteo Fadel,Xiang Peng*

Main category: quant-ph

TL;DR: This paper develops a linearized model to study the effects of alignment tensor in highly polarized 3He ensembles due to metastability-exchange optical pumping, revealing significant dependencies on nuclear polarization and demonstrating experimental-theoretical agreement.


<details>
  <summary>Details</summary>
Motivation: To address the significance of the metastable alignment tensor in highly polarized 3He, which has been overlooked in previous studies when exploring MEOP effects.

Method: A linearized model using mean-field approximation is developed to investigate alignment tensor contributions, and free-induction-decay measurements are conducted to observe polarization-dependent responses in hybrid 3He ensembles under an external magnetic field.

Result: The experiments reveal a pronounced dependence on nuclear polarization and show strong agreement with the theoretical model regarding tensor-induced phenomena.

Conclusion: The findings enhance the understanding of nuclear spin dynamics in 3He and have implications for high-accuracy magnetometry and the generation of nuclear spin-squeezed states.
...
### [58] [Phase locking nuclear spins in silicon with spin-orbit coupling](https://arxiv.org/abs/2606.20340)
*Habitamu Y. Walelign,Manas Ranjan Sahu,John M. Nichol*

Main category: quant-ph

TL;DR: This study demonstrates phase-locking of a silicon nuclear spin ensemble using electronic spin-orbit coupling, enabling coherent control without external references.


<details>
  <summary>Details</summary>
Motivation: The aim is to utilize nuclear spins for quantum information processing by achieving coherent control without needing external phase references.

Method: Internal electronic spin-orbit coupling is used as a phase reference to phase-lock a $^{29}$Si nuclear spin ensemble in a silicon quantum dot.

Result: The nuclear spins align to a phase defined by the electronic spin-orbit coupling, allowing measurement of coherent precession and inhomogeneous dephasing, supported by numerical simulations.

Conclusion: This work significantly advances the control of solid-state nuclear spin ensembles, paving the way for enhanced quantum information processing.
...
### [59] [Quantum ring all-reduce: communication and privacy advantages for distributed learning](https://arxiv.org/abs/2606.20344)
*María Gragera Garcés,Lirandë Pira*

Main category: quant-ph

TL;DR: This paper explores enhancing distributed training with quantum communications, achieving efficiency and privacy improvements over classical methods.


<details>
  <summary>Details</summary>
Motivation: To improve the efficiency and privacy of distributed machine learning training using quantum communication techniques.

Method: Introducing a quantum version of the ring all-reduce communication primitive that leverages pre-shared entanglement and superdense coding, achieving optimal communication reductions and enhanced privacy.

Result: The quantum approach reduces online communication by a factor of two and enables information-theoretic privacy guarantees not achievable by classical protocols, while also revealing advantages in conflict detection for gradient information under bandwidth constraints.

Conclusion: A hybrid quantum-classical communication architecture can significantly enhance both efficiency and security in large-scale distributed training setups, providing distinct advantages for both quantum and classical learning models.
...
### [60] [Effective discrete-modulated continuous variable QKD under general attacks](https://arxiv.org/abs/2606.20346)
*Mariana Navarro,Antonio Acín,Carlos Pascual-García*

Main category: quant-ph

TL;DR: A new finite-size security analysis for continuous variable quantum key distribution (CVQKD) protocols removes previous limitations, allowing for practical implementations with positive key rates.


<details>
  <summary>Details</summary>
Motivation: To ensure secure quantum communications with CVQKD while overcoming restrictive assumptions in existing security proofs.

Method: Employs dimension reduction techniques and marginal-constrained entropy accumulation in a model that accounts for receiver imperfections for security analysis.

Result: Achieves positive key rates for block sizes around $10^8$, enhancing practical security in CVQKD systems.

Conclusion: This work narrows the gap between theoretical security and practical applications for discrete-modulated CVQKD.
...
### [61] [Discrimination of genuinely nonlocal sets without entanglement in multipartite systems](https://arxiv.org/abs/2606.20380)
*Ziying Hou,Huaqi Zhou,Limin Gao*

Main category: quant-ph

TL;DR: This paper presents minimal resource schemes for entanglement-assisted discrimination of genuinely nonlocal orthogonal product states, classifying them into reducible (Type I) and irreducible (Type II).


<details>
  <summary>Details</summary>
Motivation: The study aims to improve discrimination methods for genuinely nonlocal orthogonal product sets in quantum information science.

Method: It introduces entanglement-assisted discrimination protocols for both Type I and Type II nonlocal sets, utilizing minimal resources and extending these protocols to higher-dimensional systems.

Result: For Type I sets, low-dimensional cases require a single EPR pair; Type II requires one GHZ state. In higher dimensions, single maximally entangled states suffice for both types across varying party numbers, with Type II needing one extra EPR pair for n-partite systems (n > 3).

Conclusion: These findings present a solid methodology for efficiently discriminating genuinely nonlocal sets with minimal quantum resources.
...
### [62] [Sparse Configuration Interaction for the Electronic Schrödinger Equation Revisited: Complete Basis Set Limit Complexity and Quantum-Encoding Impact](https://arxiv.org/abs/2606.20385)
*Michael Griebel,Jan Hamaekers*

Main category: quant-ph

TL;DR: This paper explores regularity results of eigenfunctions in the electronic Schrödinger equation, focusing on convergence and approximation complexity.


<details>
  <summary>Details</summary>
Motivation: To address how dimensionality affects convergence in numerical methods for the electronic Schrödinger equation.

Method: The study revisits regularity results and examines convergence rates via sparse grid constructions.

Result: The leading algebraic exponent in convergence can be made independent of the number of electrons, easing the curse of dimensionality.

Conclusion: The findings enhance classical numerical solvers and may improve quantum-computing methods through efficient wavefunction encodings.
...
### [63] [Interaction geometry and ground-state properties of sparse quantum lattice models](https://arxiv.org/abs/2606.20387)
*Alex Gunning,Sebastian Schmid,Zhengxiao Liu,Sridevi Kuriyattil,Aydin Deger,Andrew J. Daley*

Main category: quant-ph

TL;DR: The paper explores how the geometry of interaction in sparse long-range quantum models affects their low-energy phases, highlighting the role of graph connectivity in governing ground-state transitions.


<details>
  <summary>Details</summary>
Motivation: To understand the influence of interaction geometry on the phases of long-range quantum models in a sparse connectivity context.

Method: The study focuses on various graph structures, specifically power-of-$p$ graphs and Fibonacci graphs, analyzing how symmetry and geometric frustration affect phase transitions.

Result: Different graphs show distinct phase behaviors; even-$p$ graphs mirror the phase structure of the power-of-two model, while odd-$p$ grapples with geometric frustration, and Fibonacci graphs provide a unique mapping between short- and long-range phases.

Conclusion: The research establishes that a common effective-geometry principle governs phase structure and criticality in the studied long-range quantum systems, suggesting a unified framework for experimental investigations.
...
### [64] [Faking entanglement with imperceptible measurement deviations](https://arxiv.org/abs/2606.20396)
*Jaime Moreno,Elna Svegborn,Simon Morelli,Markus Hiekkamäaki,Lea Kopf,Robert Fickler,Armin Tavakoli*

Main category: quant-ph

TL;DR: This paper reveals that small measurement errors in quantum systems can falsely certify entanglement, demonstrating vulnerabilities in current verification methods.


<details>
  <summary>Details</summary>
Motivation: To accurately verify quantum entanglement amidst growing complexities in quantum systems and measurement assumptions that may not hold true.

Method: The authors introduce adversarially encoded measurement errors to test the integrity of entanglement verification, utilizing classical photonic states in high-dimensional spaces up to 61 dimensions.

Result: They demonstrate that low measurement fidelity errors (0.23%) can lead to false positive certifications of entanglement in separable systems.

Conclusion: This research highlights a critical vulnerability in high-dimensional entanglement detection methods, advocating for more secure verification approaches that account for potential errors.
...
### [65] [Quantum Kernels are Spectral Tensor Networks](https://arxiv.org/abs/2606.20402)
*Erik M. Åsgrim,Stefano Markidis*

Main category: quant-ph

TL;DR: The paper explores the relationship between quantum kernels and Fourier representations, demonstrating that quantum kernels can be represented as spectral tensor networks via entangled tensor kernels. It introduces a grouped Fourier form for a compact representation, linking kernel target alignment to Fourier coefficients, and shows that layered quantum kernels exhibit compressibility, which aids in assessing classical representability.


<details>
  <summary>Details</summary>
Motivation: To understand the structural properties of quantum kernels and their relationship to Fourier representations, particularly in terms of computational efficiency and representability.

Method: The authors identify entangling tensor kernels as matrix product operator factorizations of Fourier coefficients, leading to a grouped Fourier form that offers a compact representation and linking kernel target alignment to cosine similarities of the Fourier coefficients.

Result: Numerical experiments reveal that layered quantum kernels can be accurately represented with relatively small bond dimensions, showing a compressibility influenced by correlations between Fourier modes.

Conclusion: The findings indicate that the compressibility of quantum kernels can provide insights into their classical representability and the computational feasibility of kernel evaluation.
...
### [66] [Computing noise-canceling observables via Pauli propagation](https://arxiv.org/abs/2606.20441)
...
TL;DR: This paper presents a hybrid error-mitigation framework combining Pauli propagation with quantum processing to enhance simulation accuracy and reduce overhead.


<details>
  <summary>Details</summary>
Motivation: To advance quantum simulation accuracy, addressing limitations of both quantum processors and classical methods is essential.

Method: The authors integrate Pauli propagation into a hybrid framework that utilizes noise-canceling inverse channels for improved observable measurement.

Result: Numerical benchmarks on challenging models and experiments on a 56-qubit quantum processor demonstrate reduced truncation errors and computational resource demands.

Conclusion: This work paves the way for enhanced observable estimation, supporting advancements in quantum-centric supercomputing and exploring quantum advantage.
...
### [67] [Many-body chirality of topological stabilizer states](https://arxiv.org/abs/2606.20472)
*Tyler D. Ellison,Dongjin Lee,Zhi Li,Amin Moharramipour,Yasamin Panahi,Beni Yoshida*

Main category: quant-ph

TL;DR: This paper introduces a quantum-information theoretic framework for characterizing chirality in many-body quantum states, revealing intricate properties related to complex conjugation and intrinsic many-body imaginarity.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the lack of a quantum-information theoretic understanding of chirality in many-body quantum systems, focusing on the entanglement structure.

Method: A formal definition of many-body chirality is introduced as an obstruction to the transformation of a quantum state into its complex conjugate through finite-depth local operations, specifically analyzing stabilizer realizations of $	ext{Z}_d^{(k)}$ anyon theories.

Result: It is established that complex conjugation can occur via local quantum channels only if anyon data are mirror invariant, revealing unexpected forms of chirality that aren't identified by traditional measures.

Conclusion: The study indicates that many-body chirality is a four-partite phenomenon and demonstrates that states in $	ext{Z}_d^{(k)}$ with $d>2$ have an inherent complex phase structure that resists removal by local operations, highlighting complexities even in non-chiral states.
...
### [68] [Fidelity bounds for adiabatic gates and other quantum operations with time-dependent dissipation](https://arxiv.org/abs/2606.20501)
*Simon Pettersson Fors,Aniket Patel,Anton Frisk Kockum,Tahereh Abad*

Main category: quant-ph

TL;DR: This paper investigates the impact of time-dependent noise on the fidelity of quantum operations, particularly adiabatic controlled-Z gates in superconducting quantum computers.


<details>
  <summary>Details</summary>
Motivation: The fidelity of quantum operations is limited by decoherence, which is crucial for developing utility-scale quantum processors. Previous work focused on static noise, necessitating an exploration of time-dependent dissipation.

Method: The authors generalize previous fidelity-reduction formulae to include time-dependent dissipation and apply it to analyze adiabatic operations, particularly focusing on flux-dependent noise sensitivity and qubit-coupler hybridization.

Result: The generalized formula yields a fidelity bound for adiabatic operations, showing that the combination of flux-dependent noise sensitivity and hybridization significantly decreases the fidelity of controlled-Z gates.

Conclusion: The findings provide valuable theoretical tools for assessing error budgets and optimizing quantum operation designs in tunable architectures, with potential implications for quantum sensing and communication.
...
### [69] [General circuit mapping algorithm for neutral atom quantum computers](https://arxiv.org/abs/2606.20503)
*Neven Gentil,Lous S. Rianne,Aida Todri-Sanial*

Main category: quant-ph

TL;DR: The paper proposes a mathematical framework for optimizing qubit transfers in neutral atom quantum computers, reducing transfers and improving execution efficiency by encoding the problem as a nonlinear integer program solved with a genetic algorithm.


<details>
  <summary>Details</summary>
Motivation: The need for effective qubit transfer optimization in neutral atom quantum computers due to physical movement requirements during circuit execution.

Method: A graph-theoretic combinatorial optimization framework is introduced, encoding the qubit mapping problem as a nonlinear integer program and solved using a genetic algorithm to achieve trade-offs between distance minimization and transfer operations.

Result: The proposed method consistently finds fewer qubit transfers compared to the state-of-the-art compiler, allowing users to prioritize either distance or transfer operation reduction based on their specific optimization goals.

Conclusion: This framework provides a robust tool for quantum circuit compilation, aiding in reducing movement-induced errors and enhancing execution efficiency on neutral atom quantum computer platforms.
...
### [70] [Entropy Estimation in Multi-Qutrit Systems via Variational and Classical Neural Networks](https://arxiv.org/abs/2606.20504)
*Sai Sakunthala Guddanti,Anil Prabhakar,Ria Rushin Joseph*

Main category: quant-ph

TL;DR: This study explores von Neumann entropy estimation in multi-qutrit systems using variational quantum algorithms and classical CNNs, highlighting different accuracies based on system size and method.


<details>
  <summary>Details</summary>
Motivation: To improve von Neumann entropy estimation in multi-qutrit quantum systems efficiently and robustly, especially as system size scales.

Method: The study employs VQAs for small systems (up to three qutrits) and CNNs for larger systems (two to five qutrits), evaluating accuracy based on variational parameters and measurement strategies.

Result: The results show that VQAs are suitable for smaller systems while CNNs excel for larger ones, achieving 90th-percentile absolute errors of 0.13-0.16 nats with reduced measurement requirements.

Conclusion: The findings suggest a shift in methodology based on system size, recommending VQAs for smaller and CNN estimators for larger qutrit systems to enhance scalability and robustness.
...
### [71] [Approximating optimal decoding of quantum LDPC codes with narrow frontiers](https://arxiv.org/abs/2606.20513)
*Anthony Leverrier,Rüdiger Urbanke*

Main category: quant-ph

TL;DR: The Frontier decoder is a dynamic-programming approach for sparse quantum decoding that optimizes error processing while maintaining low complexity and achieving near-optimal thresholds for specific codes.


<details>
  <summary>Details</summary>
Motivation: To efficiently solve sparse quantum decoding problems, minimizing complexity while maintaining accuracy in error variable processing.

Method: The Frontier decoder prunes the search space through dynamic programming, processes error variables in a specific order, merges prefixes, and retains a narrow frontier to approximate posterior masses efficiently.

Result: The decoder approaches optimal thresholds for surface and color codes and shows superior performance in a circuit-level noise model, with a small average retained list size.

Conclusion: The Frontier decoder demonstrates linear complexity when the list size is constant, indicating its potential for low-latency applications in quantum error correction.
...
### [72] [GPU-accelerated semidefinite programming for causal games](https://arxiv.org/abs/2606.20519)
*Emanuel-Cristian Boghiu,Kyrylo Simonov*

Main category: quant-ph

TL;DR: This paper investigates quantum correlations in causal games, specifically enhancing strategies in the Guess-Your-Neighbour's-Input game using higher local dimensions. It concludes that increasing the dimension beyond 5 does not yield significant improvements in winning probabilities, suggesting the need for different strategies or that existing upper bounds may not be tight.


<details>
  <summary>Details</summary>
Motivation: To explore the potential for higher local dimensions to improve the winning probability in causal quantum games and understand the nature of quantum correlations without fixed causal order.

Method: A see-saw optimization scheme employing semidefinite programming for analyzing local dimensions, with a custom SCS solver that utilizes GPU for efficient computation.

Result: No significant enhancements in winning probability found by increasing local dimensions from 5 to 8; maintains a winning probability near 0.6218, significantly below a known upper bound of 0.7592.

Conclusion: Further investigation is necessary, either through new strategies or reassessing the tightness of the current upper bounds.
...
### [73] [Near-Optimal Learning of Local Lindbladians](https://arxiv.org/abs/2606.20535)
*Itai Arad,Zhili Chen,Naixu Guo,Patrick Rebentrost,Zhan Yu*

Main category: quant-ph

TL;DR: The paper presents an algorithm to learn local Lindbladians from black-box access to quantum evolution, estimating both Hamiltonian and dissipative coefficients efficiently using finite-time probes and Pauli measurements.


<details>
  <summary>Details</summary>
Motivation: The aim is to accurately estimate the coefficients of local Lindbladians necessary for understanding quantum dynamics, especially when dealing with dissipative processes.

Method: An algorithm utilizes finite-time channel probes to estimate Pauli transfer matrices, converting these estimates into Lindbladian coefficients via stable Fourier inversions. It is non-adaptive, requires no ancillas, and uses random product states followed by random Pauli measurements.

Result: The algorithm operates with complexity scaling as \widetilde{O}(Λ^2/\varepsilon^2) for channel uses and \widetilde{O}(Λ/\varepsilon^2) for total evolution time, and is matched by lower bounds confirming near-optimal performance.

Conclusion: The study demonstrates the fundamental limitations in learning dissipative coefficients, which prevent achieving Heisenberg-limited scaling in the presence of dissipation.
...
### [74] [Topological Codes Based on Space Groups](https://arxiv.org/abs/2606.20548)
*Chong-Yuan Xu,Ze-Chuan Liu,Yong Xu*

Main category: quant-ph

TL;DR: The paper introduces space-group codes, a new class of topological codes incorporating point group operations, enhancing their design and practicality.


<details>
  <summary>Details</summary>
Motivation: To expand the traditional framework of topological codes, which often rely on translation invariance, by incorporating more complex symmetries.

Method: The authors introduce space-group codes, utilizing group-algebra templates and analyzing their topological properties with ring-modules and invariant theory.

Result: Space-group codes, despite initial complexity, can demonstrate better locality than traditional translation-based codes, suggesting more efficient practical implementations.

Conclusion: This work broadens the understanding of topological codes and offers new avenues for integrating them with quantum computing technologies.
...
### [75] [Benchmark of quantum algorithms for ground state preparation in the presence of noise](https://arxiv.org/abs/2606.20551)
*Daniel Molpeceres,Sirui Lu,J. Ignacio Cirac,Barbara Kraus*

Main category: quant-ph

TL;DR: This paper evaluates cooling, adiabatic, and optimization algorithms for ground-state preparation under noise, revealing their performance varies with the phase of the system and emphasizing the robustness of cooling protocols.


<details>
  <summary>Details</summary>
Motivation: The need for efficient ground-state preparation algorithms in noisy quantum systems to improve implementation viability.

Method: Comparison of cooling, adiabatic, and optimization algorithms on a solvable family of quadratic fermionic Hamiltonians under depolarizing noise, backed by numerical simulations.

Result: Adiabatic evolution excels in the trivial phase, while cooling algorithms outperform in the topological phase; the quantum approximate optimization algorithm is competitive in the trivial phase but less effective in the topological phase.

Conclusion: Cooling protocols demonstrate enhanced robustness to parameter imperfections, suggesting they are favorable for noisy quantum state preparation.
...
### [76] [The Silicon Tracking System of the E16 experiment at J-PARC: construction, installation and commissioning in beam test experiments](https://arxiv.org/abs/2606.19400)
...
TL;DR: The J-PARC E16 experiment investigates chiral symmetry restoration by analyzing modifications of vector mesons through dielectron decay, utilizing upgraded detection technology with a high-intensity proton beam.


<details>
  <summary>Details</summary>
Motivation: To explore chiral symmetry restoration in a high-energy physics context, focusing on in-medium vector meson modifications.

Method: Upgrading the tracking system by integrating 15 newly constructed detector modules, similar to those used in the CBM experiment, and conducting beam tests with a 3 GeV electron beam to evaluate performance.

Result: Successful assembly, characterization, and operation of the E16-STS modules were achieved during the beam test, demonstrating the setup's capability.

Conclusion: The paper provides an overview of the upgrades and operational success of the E16-STS modules, facilitating further research in chiral symmetry restoration.
...
### [77] [PiMiX 2.0: AI-enhanced Data Fusion for Radiographic Imaging and Tomography](https://arxiv.org/abs/2606.19670)
...
TL;DR: PiMiX 2.0 is an AI-driven framework for enhanced data fusion and analysis, integrating multimodal radiographic imaging with physics-informed reasoning, scalable for various computational environments.


<details>
  <summary>Details</summary>
Motivation: To improve data processing, knowledge extraction, and reproducibility in experiments involving complex systems like high-temperature plasmas and nuclear fusion.

Method: Integrates multi-experiment radiographic imaging and tomography with automated data ingestion, image processing, 3D/4D reconstruction, and physics-aware interpretation using agentic AI workflows.

Result: Accelerates data processing and enhances integrated analysis, making it suitable for high-performance computing and experimental workflows.

Conclusion: PiMiX 2.0 aims to empower experimental analysis across diverse fields, improving efficiency and reproducibility.
...
### [78] [Operational characterization of LAPPD Generation 2: charge sharing, delayed pulses, and dark-count behavior](https://arxiv.org/abs/2606.19766)
*S. -W. Stradleigh,J. A. Foot,R. Zhang,V. A. Li*

Main category: physics.ins-det

TL;DR: This study investigates charge sharing and cross-talk in Gen 2 LAPPDs, analyzing signal distributions, dark-count rates, and resonant behavior, while developing a Monte Carlo simulation for modeling observed signals.


<details>
  <summary>Details</summary>
Motivation: The aim is to understand and quantify charge sharing and electronic cross-talk in LAPPD Gen 2 devices to improve their performance in applications like time resolution and detection efficiency.

Method: Signal distributions were measured using a picosecond pulsed laser, while relationships between dark-count rates and voltage settings were analyzed. A pulse-classification method was developed, and a first-principles Monte Carlo simulation modeled observed signal distributions.

Result: The study found significant coupling between pixels, identified decay behavior in dark counts with multiple timescales, and observed resonant cavity behavior in the LAPPD. The simulation results aligned well with experimental pulse classifications.

Conclusion: This research enhances the understanding of charge sharing and cross-talk in LAPPDs, demonstrating that Monte Carlo simulations can effectively model the performance of these detectors.
...
### [79] [Raw-Hit Muon Tomography: A Measurement-Domain Formulation for Cosmic-Ray Muon Imaging](https://arxiv.org/abs/2606.20180)
*Zhizheng Zhao,Changhao Qin,Rongfeng Zhang,Zibo Qin,Qite Li*

Main category: physics.ins-det

TL;DR: Raw-Hit Muon Tomography (RHMT) offers a novel approach to analyze cosmic-ray muon data by focusing on raw detector hits rather than summarizing them into nominal values, leading to improved imaging of material properties.


<details>
  <summary>Details</summary>
Motivation: Traditional muon tomography methods compress raw data into summaries that obscure important information. This paper aims to retain more raw data for better resolution and accuracy in material detection.

Method: Introduces RHMT, which evaluates muon hits directly. RHMT-S uses covariance projections to estimate hit contrasts, while RHMT-E fits data in a magnetic spectrometer to assess log momentum loss via a Bethe--Bloch model.

Result: RHMT-S shows improved mean ROC-AUC scores in comparisons with existing methods, while RHMT-E effectively differentiates energy loss in materials with low scattering contrast, such as aluminium.

Conclusion: The proposed RHMT framework allows for more accurate muon tomography by leveraging raw hit data, improving the analysis of material properties in various contexts.
...
### [80] [The ESSnuSB Experiment](https://arxiv.org/abs/2606.19391)
*Monojit Ghosh*

Main category: hep-ex

TL;DR: This proceedings outlines the ESSnuSBplus project's phase-I, focusing on its goals to measure the CP phase and explore diverse physics cases related to neutrinos.


<details>
  <summary>Details</summary>
Motivation: The ESSnuSB project targets the accurate measurement of CP violation in neutrinos, crucial for understanding matter-antimatter asymmetry in the universe.

Method: The experiment utilizes a long-baseline neutrino beam aimed at a large detector, coupled with low-energy technologies for enhanced precision and additional physics studies.

Result: The project is expected to provide unprecedented precision in measuring δ_cp and insights into other neutrino phenomena including solar, atmospheric, and supernova neutrinos.

Conclusion: ESSnuSBplus is poised to significantly advance neutrino physics, enabling the detailed study of both beam-based and diverse neutrino interactions.
...
### [81] [Towards Engineering Scaling Laws with Pretraining Data Composition](https://arxiv.org/abs/2606.19781)
*Jan-Lucas Uslu,Kevin Greif,Daniel Whiteson,Benjamin Nachman*

Main category: hep-ex

TL;DR: This study explores how neural scaling laws apply to large models in particle physics, emphasizing the importance of synthetic data and pretraining datasets in optimizing performance.


<details>
  <summary>Details</summary>
Motivation: To investigate scaling laws in particle physics models and leverage synthetic data for improved performance compared to natural language models.

Method: We analyze the classification of hadronic jets in high-energy collisions, optimizing pretraining datasets for diversity and alignment with classification tasks.

Result: Empirical results demonstrate that performance can be enhanced by engineering pretraining data to favor data scaling over model parameter scaling.

Conclusion: The findings indicate that in particle physics, well-structured pretraining datasets can shift the scaling behavior towards requiring more data instead of larger models for optimal performance.
...
### [82] [Resonant heterodyne conversion applied to a low-frequency haloscope for dark matter axion searches in the 1-35 MHz range](https://arxiv.org/abs/2606.20422)
*Navarro-Madrid Jose R.,Reina-Valero José,Díaz-Morcillo Alejandro,Gimeno Benito*

Main category: hep-ex

TL;DR: This paper investigates resonant heterodyne up-conversion in the RADES-BabyIAXO haloscope to detect low-mass dark matter axions, leading to improved sensitivity projections for axion-photon couplings.


<details>
  <summary>Details</summary>
Motivation: To enhance the search for low-mass dark matter axions through a more effective detection method using microwave cavities.

Method: Derives an axion-induced source term and power extraction formula considering finite axion linewidth; employs full-wave formulations to assess heterodyne detection in a realistic cavity layout.

Result: Identifies optimal configurations for axion detection, showing significant agreement between analytical and full-wave models, and determines coupling settings that optimize scanning rates.

Conclusion: The experiment is poised to achieve sensitivity down to $10^{-15}\,\mathrm{GeV}^{-1}$ at a 90% confidence level, significantly improving upon previous heterodyne-based searches.
...
### [83] [HEPTv2: End-to-End Efficient Point Transformer for Charged Particle Reconstruction](https://arxiv.org/abs/2606.20437)
*Siqi Miao,Shitij Govil,Jack P. Rodgers,Mia Liu,Javier Duarte,Shih-Chieh Hsu,Yuan-Tang Chou,Pan Li*

Main category: hep-ex

TL;DR: HEPTv2 is an end-to-end point-transformer architecture designed for charged-particle tracking in high-energy physics, achieving state-of-the-art accuracy and efficiency without the complexities of graph-building or clustering.


<details>
  <summary>Details</summary>
Motivation: The need for accurate and efficient particle tracking at the HL-LHC amidst high collision densities presents significant challenges due to combinatorial ambiguity in trajectory reconstruction.

Method: HEPTv2 utilizes a locality-aware point encoder and a sectorized track decoder, enabling direct hit-to-track predictions and optimizing the pipeline end-to-end without auxiliary stages.

Result: HEPTv2 achieves a 98.6% double-majority tracking efficiency at a 0.8% fake rate, with efficient inference times and linear scaling for high hit events.

Conclusion: HEPTv2 outperforms existing methods by significantly improving both accuracy and latency, demonstrating the feasibility of end-to-end transformers for real-time particle tracking.
...
### [84] [Observation of electroweak production of pairs of Z bosons in proton-proton collisions at 13 TeV](https://arxiv.org/abs/2606.20558)
*CMS Collaboration*

Main category: hep-ex

TL;DR: First evidence of electroweak production of ZZ pairs associated with two jets reported by CMS, consistent with SM predictions.


<details>
  <summary>Details</summary>
Motivation: To investigate the electroweak production of Z boson pairs in association with jets and to measure the associated cross section.

Method: Data from pp collisions at 13 TeV (138 fb$^{-1}$) was analyzed, selecting events with specific lepton and jet criteria.

Result: The measured cross section for EW production is 0.37$^{+0.14}_{-0.12}$(stat)$^{+0.06}_{-0.06}$(syst) fb, with observed significance of 3.1 standard deviations, consistent with SM prediction.

Conclusion: Combining results with previous ZZ decay findings yields a combined significance of 5.0 standard deviations for the electroweak production of Z pairs.
...
### [85] [The next-to-leading order of the differential cross-section of the subprocess of Compton scattering of quark-gluon of prompt photon production in proton-proton collisions at NICA energies](https://arxiv.org/abs/2606.19389)
*Mohsun Rasim Alizada,Azar Inshalla Ahmadov*

Main category: hep-ph

TL;DR: The paper calculates the next-to-leading-order differential cross-section for Compton scattering in proton collisions at NICA energies, highlighting the significant impact of proton polarization.


<details>
  <summary>Details</summary>
Motivation: To enhance the accuracy of predictions for prompt photon production in proton-proton collisions by considering next-to-leading-order effects and proton polarization.

Method: Next-to-leading-order calculations were performed for the differential cross-section of the subprocess $qg \rightarrow qγ$.

Result: The next-to-leading-order contributes approximately 15% to the leading-order differential cross-section, especially notable at high energies.

Conclusion: Proton polarization has a more substantial effect on the next-to-leading-order calculation compared to the leading-order calculation, emphasizing its importance in high-energy scenarios.
...
### [86] [Emergent Gauge Symmetries in Particle Physics and Cosmology](https://arxiv.org/abs/2606.19403)
*Steven D. Bass*

Main category: hep-ph

TL;DR: The paper explores the emergence of the Standard Model's gauge symmetries from high-energy physics, suggesting connections between Higgs stability, dark energy, and dark matter candidates, alongside potential experimental tests.


<details>
  <summary>Details</summary>
Motivation: To understand the origins of gauge symmetries and their implications for fundamental physics, especially regarding the Standard Model and high-energy phenomena.

Method: The concept of emergent behavior is proposed, where gauge symmetries result from phase transitions at ultraviolet scales, linking the Higgs vacuum stability to new critical phenomena.

Result: Emerges theory predicts that dark energy and light Majorana neutrino masses are on the same order, leading to dark matter candidates like axions and phononic excitations.

Conclusion: Potential experimental tests, involving neutrinos and gravitational waves, could validate the theories connecting low-energy physics with the emergent high-energy framework.
...
### [87] [LeWRON: Agentic Analysis of Electroweak Phase Transitions](https://arxiv.org/abs/2606.19425)
*Isaac R. Wang*

Main category: hep-ph

TL;DR: LeWRON is a framework for analyzing the electroweak phase transition, facilitating reproducibility and exploration of model-specific scenarios in particle physics and cosmology.


<details>
  <summary>Details</summary>
Motivation: The electroweak phase transition connects various fields in physics but requires a complex and sensitive analysis pipeline that is often challenging to navigate.

Method: LeWRON orchestrates the EWPT analysis pipeline from an input Lagrangian, combining toolbox construction with an Explorer module for further analysis, while employing auditor agents for result verification.

Result: LeWRON successfully demonstrated its capabilities through various beyond-the-Standard-Model scenarios and enables reproducibility and structured exploration in its reproduction and discovery modes.

Conclusion: The framework is publicly released on GitHub, providing a user-friendly interface for researchers in particle physics and cosmology to analyze electroweak phase transitions.
...
### [88] [Partial-wave unitarity and long-range interactions](https://arxiv.org/abs/2606.19432)
*Ryan Plestid,Pablo Quílez Lasanta*

Main category: hep-ph

TL;DR: This work addresses the issue of ill-defined partial-wave amplitudes in massless particle theories by introducing a modified perturbation theory that accounts for long-range interactions, leading to scale-independent expressions.


<details>
  <summary>Details</summary>
Motivation: Massless particle theories exhibit $t$-channel singularities, complicating the derivation of systematic partial-wave unitarity bounds.

Method: The study develops a modified perturbation theory incorporating long-range interactions, focusing on the impact of off-shell Coulomb modes to construct partial-wave amplitudes.

Result: A universal framework for the forward scattering region is established, resulting in well-defined, scale-independent partial-wave amplitudes that are free from infrared regulator dependence.

Conclusion: The new method allows for practical, systematic computation of partial-wave amplitudes in a renormalization group invariant manner.
...
### [89] [From Rags to Jeans: Axion Miniclusters from Early matter domination](https://arxiv.org/abs/2606.19439)
*Ariel Angulo,Paola Arias,Nicolás Bernal,Javier Redondo*

Main category: hep-ph

TL;DR: This paper explores how temperature-dependent axion mass can amplify density perturbations during a matter-dominated era, leading to significant axion overdensities and minicluster formation.


<details>
  <summary>Details</summary>
Motivation: To investigate the effect of radiation bath inhomogeneities on axion density perturbations, particularly when the axion mass is temperature-dependent.

Method: Analyzes the growth of density inhomogeneities during the early matter-dominated era and their impact on axion mass fluctuations, modeling the conditions at reheating.

Result: Identifies that density perturbations can drive axion overdensities to order unity by the time of matter-radiation equality, particularly when the reheating temperature is just below the mass-saturation scale.

Conclusion: The study provides a mechanism for axion minicluster formation and contributes to understanding the role of axion mass variability in dark matter abundance.
...
### [90] [Massive right-handed neutrinos in $\bar{B} \to D^* τ\bar X$ decay](https://arxiv.org/abs/2606.16166)
*Nilakshi Das,Alakabha Datta,Tejhas Kapoor,Danny Marfatia,Lopamudra Mukherjee*

Main category: hep-ph

TL;DR: This paper investigates the potential signals of a right-handed neutrino in specific decay processes, calculating angular distributions and assessing sensitivity to new physics in a defined mass range.


<details>
  <summary>Details</summary>
Motivation: To identify the presence of a massive right-handed neutrino in particle decays, contributing to new physics beyond the standard model.

Method: The authors utilize the standard model effective field theory framework and calculate full differential distributions in decay processes involving visible final states of $D^*$ and $τ$ lepton decays.

Result: The study presents novel calculations of the angular distributions and demonstrates varying sensitivities of these distributions to the new physics operators.

Conclusion: The findings could enhance the understanding of new physics signatures in particle physics, particularly through the search for right-handed neutrinos.
...
### [91] [Spin Identification of Dark Sector Mediators through Angular Distributions](https://arxiv.org/abs/2606.19543)
*D. Aristizabal Sierra,S. Fuenzalida Garrido,F. Kling,T. Mäkelä,N. Viaux*

Main category: hep-ph

TL;DR: The paper discusses experiments aimed at discovering light long-lived dark sector particles, presenting a method to determine their quantum numbers based on angular observables from decay products, with implications for identifying mediator spin in new parameter regions.


<details>
  <summary>Details</summary>
Motivation: To understand the characteristics of light long-lived dark sector particles following their potential discovery.

Method: An angular observable is derived from the decay products' four-momenta to distinguish between vector bosons and scalars based on their decay distributions.

Result: Experiments like DUNE, SHiP, and FASER2 can use this observable to uncover the spin of the mediator in previously unexplored parameter spaces.

Conclusion: The technique offers a promising pathway to classify dark sector particle interactions and significantly expands the search for new physics.
...
### [92] [Self-Calibration of the Neutrino-Argon Cross Section with Solar Neutrinos](https://arxiv.org/abs/2606.18347)
*Rasmi Hajjar,Obada Nairat,John F. Beacom*

Main category: hep-ph

TL;DR: This paper discusses how solar-neutrino data can be utilized to accurately measure the charged-current cross section for neutrinos interacting with argon, proposing methods to achieve a precision of less than 2% in specific energy ranges.


<details>
  <summary>Details</summary>
Motivation: The DUNE experiment's MeV physics program relies on a precise understanding of the charged-current cross section for neutrino interactions, which is currently hindered by high uncertainties in measurements.

Method: The authors propose using solar-neutrino data, combined with known $^8$B flux and survival probabilities, to extract transition strengths of nuclear interactions. They employ techniques like Principal Component Analysis to refine these measurements.

Result: The study indicates that, under controlled detector uncertainties, a precision of less than 2% on the charged-current cross section can be achieved in the 9-15 MeV range, despite existing pessimistic assumptions about detection.

Conclusion: The findings provide a crucial basis for further investigation into the charged-current cross section at higher energies, which is essential for understanding complex interactions in supernova and atmospheric neutrino studies.
...
### [93] [Real and Virtual Propagation in Neutrino Oscillations](https://arxiv.org/abs/2606.19548)
*Kenji Nishiwaki,Kin-ya Oda,Juntaro Wada*

Main category: hep-ph

TL;DR: This paper analyzes flavor oscillations in vacuum by examining intermediate states and their propagation time, leading to an extended expression for flavor-changing amplitude valid at shorter distances.


<details>
  <summary>Details</summary>
Motivation: The aim is to enhance understanding of flavor oscillations in Quantum Field Theory by considering how the propagation of intermediate states impacts oscillatory behavior.

Method: The authors utilize the saddle-point method to evaluate integrals relevant to flavor oscillations, deriving an expression for the flavor-changing amplitude that incorporates conditions for shorter propagation times.

Result: They discover that oscillations are contingent upon surpassing a certain propagation time threshold related to energy uncertainty and decay width, indicating that virtual states do not propagate over long distances.

Conclusion: The findings suggest that the Jacob--Sachs theorem is more robust than previously thought, applicable at shorter propagation times, and could have implications for experimental observations in various particle types.
...
### [94] [Freeze-in at all couplings](https://arxiv.org/abs/2606.19564)
*Andreas Goudelis,Andre Lessa,Lucas Magno Dantas Ramos,Thomas Reggio*

Main category: hep-ph

TL;DR: The paper analyzes a charged freeze-in dark matter model under low reheating temperatures, examining the interplay of various mass scales and their implications for dark matter production and search constraints.


<details>
  <summary>Details</summary>
Motivation: Understanding dark matter dynamics in scenarios with low reheating temperatures to explore viable parameter spaces and interactions with the Standard Model.

Method: Detailed analysis of dark matter and mediator number density evolution, examining how reheating temperature, mass scales, and couplings affect predictions and experimental searches.

Result: Identified novel behaviors such as mediator non-equilibration, emphasizing the importance of tracking particle number densities for accurate forecasts in this model.

Conclusion: Updated constraint implications from LHC and other experiments provide insights into cosmologically viable parameter spaces, highlighting the relevance of diverse experimental searches.
...
### [95] [Sensitivity of the photon-induced processes to the proton radius](https://arxiv.org/abs/2606.19604)
*Nikhil Krishna,Mariola Klusek-Gawenda,Rafal Staszewski*

Main category: hep-ph

TL;DR: The paper examines dilepton production in proton-proton collisions to investigate the proton radius using a dipole form factor model, contrasting conventional and experimental values of $r_p$.


<details>
  <summary>Details</summary>
Motivation: To explore the proton radius via exclusive dilepton production in high-energy proton collisions, providing insights into ongoing debates about its measurement.

Method: Employs a dipole form factor model to compare the conventional and PDG test scenarios for the proton radius, fitting data from ATLAS and CMS experiments.

Result: Finds a fitted value of $Λ^2 = 0.465 \, 	ext{GeV}^2$ and an effective proton radius of $r_p = 1.002 \, 	ext{fm}$, reflecting a significant sensitivity to proton radius measurements.

Conclusion: While the findings suggest valuable insights into the proton radius, they do not resolve the existing 'proton radius puzzle' definitively.
...
### [96] [Charged Lepton Flavor Violation at Neutrino Telescopes](https://arxiv.org/abs/2606.19723)
*Writasree Maitra,Carlos A. Argüelles,P. S. Bhupal Dev,Ivan Martinez-Soler,Manibrata Sen*

Main category: hep-ph

TL;DR: This paper proposes a method for searching for charged lepton flavor violation (CLFV) using neutrino telescopes by exploring muon-to-tau conversion, leveraging IceCube's cosmic-ray muon dataset, and assesses sensitivity in comparison with other experimental approaches.


<details>
  <summary>Details</summary>
Motivation: Observing charged lepton flavor violation (CLFV) could signal physics beyond the Standard Model, making it a significant area of research.

Method: The study utilizes neutrino telescopes, particularly IceCube, to look for muon-to-tau conversion using an Effective Field Theory framework, analyzing both model-independent operators and a specific $Z'$ interaction.

Result: The results demonstrate potential sensitivities to the EFT scale and the $Z'$ mass-coupling plane, showing that neutrino telescopes can effectively probe CLFV up to new limits.

Conclusion: The findings imply that next-generation neutrino telescopes could serve as crucial tools in the search for CLFV, complementing existing low-energy searches and collider experiments.
...
### [97] [$U(1)_{B-L}$ Dark Matter Constrains Smooth (SUSY) Hybrid Inflation](https://arxiv.org/abs/2606.19612)
*Karim M. Selim,A. Y. Ellithi,M. Abolmahassen,Shaaban Khalil*

Main category: hep-ph

TL;DR: This paper presents a framework linking inflationary dynamics and dark matter production in a supersymmetric model, revealing tight constraints on parameters related to dark matter abundance and observational inflationary metrics.


<details>
  <summary>Details</summary>
Motivation: To connect inflationary dynamics to dark matter production within a theoretical framework, enhancing the understanding of both phenomena within the context of a supersymmetric extension of the Standard Model.

Method: The model utilizes smooth hybrid inflation in supergravity with a non-minimal Kahler potential and involves three scalar fields: the inflaton $σ$, an auxiliary field $ζ$, and a singlet mediator $η$. Dark matter is modeled as an inert scalar and produced non-thermally during reheating.

Result: The requirement to match the observed dark matter relic abundance imposes strong constraints on inflationary parameters, particularly narrowing the parameter space and constraining the scalar spectral index to $n_s 	ext{simeq 0.972 - 0.974}$, which aligns with current observations.

Conclusion: The coupling between inflaton and dark matter slightly affects background evolution but importantly modifies gravitational wave spectra, linking inflation with dark matter observables.
...
### [98] [Extraction of charmonium branching fractions from $J/ψ\toγη_c$ radiative decays](https://arxiv.org/abs/2606.19902)
*Magnus C. Schaaf,Antonio Vairo*

Main category: hep-ph

TL;DR: This study examines the discrepancies between theoretical predictions and Particle Data Group (PDG) values for the radiative decay of $J/ψ$ into $η_c$, proposing a new method for characterizing the photon line shape to refine branching fraction calculations.


<details>
  <summary>Details</summary>
Motivation: The need to reconcile theoretical predictions with experimental data for $J/ψ	oγη_c$ decay, addressing inconsistencies in measurements and models.

Method: Conducting a profile scan of the latest PDG data to assess correlations with lattice QCD decay widths, while proposing a new photon line shape model for the decay spectrum.

Result: The correlation assessments demonstrate compatibility between experimental and lattice QCD results, and the proposed photon line shape method reduces reliance on empirical adjustments previously used to extract branching fractions.

Conclusion: This research provides a more consistent theoretical framework for analyzing $J/ψ	oγη_c$ decays, facilitating accurate extractions of branching fractions without the ambiguities of previous empirical methods.
...
### [99] [Constraining ADD black holes at the LHC with $\sqrt{s} = 14$ TeV](https://arxiv.org/abs/2606.19839)
*Ashfaque Ahmad,Sudhir Kumar Gupta,Abbas Ali*

Main category: hep-ph

TL;DR: The study examines the constraints on microscopic black holes at the LHC using the ADD model, revealing mass limits that vary based on loss during formation and the number of extra dimensions.


<details>
  <summary>Details</summary>
Motivation: To investigate the potential mass of microscopic black holes produced at the LHC and their dependence on dimensionality and formation loss.

Method: Analysis of data from the LHC with an integrated luminosity of $349.4~	ext{fb}^{-1}$, focusing on black hole mass constraints under varying parameters including black hole formation loss ($ζ$) and the reduced Planck scale ($Λ_{	ext{D}}$).

Result: For $ζ=0$, black holes with mass $M_{	ext{B}} 	able{11.83~	ext{TeV}}$ are disfavored for three extra dimensions at $Λ_{	ext{D}}=1~	ext{TeV}$. Higher loss values significantly reduce mass limits down to $6.82~	ext{TeV}$.

Conclusion: The limits on black hole mass are dependent on the loss parameter and the dimensionality of space, with a notable reduction in mass constraints as loss increases.
...
TL;DR: The paper explores the production of heavy neutral leptons at a multi-TeV muon collider through new vector boson fusion processes, highlighting distinct pathways that circumvent traditional model limitations.


<details>
  <summary>Details</summary>
Motivation: To expand the understanding of heavy neutral lepton production and its implications in new physics beyond the standard model, specifically under the $U(1)$ gauged extension of seesaw models.

Method: The authors investigate new vector boson fusion processes involving $Z'$ and heavy Higgs $H$, focusing on reactions such as $Z'Z'	o H	o NN$ and $Z'Z'	o NN$, as well as lepton number violation signals associated with these processes.

Result: New production avenues for heavy neutral leptons are identified that are less constrained than conventional methods, especially under conditions where the heavy Higgs mass is greater than the collider energy.

Conclusion: The findings suggest that the new vector boson fusion processes offer feasible mechanisms for probing heavy neutral leptons, with potential significant implications for exploring physics beyond the standard model.
...
### [101] [New Gauge Forces, Neutron Stars and Schwinger Neutrino Production](https://arxiv.org/abs/2606.20393)
*Yuxin Liu,Zhen Liu,Andrey Shkerin,Jing Shu,Yue Zhao*

Main category: hep-ph

TL;DR: This study explores the effects of new long-range forces in neutrinos resulting from additional symmetries in the Standard Model, assessing their observability in astrophysical settings.


<details>
  <summary>Details</summary>
Motivation: The paper aims to examine how new gauge symmetries, particularly those involving lepton number conservation, influence neutrino behavior when influenced by massive astronomical bodies.

Method: The authors investigate the leptonic potential produced by astronomical entities, leading to Schwinger pair production of neutrinos, resulting in a flux of neutrinos and formation of a degenerate Fermi gas.

Result: While the effects of $B-L$ and $L_e-L_{μ/τ}$ forces are deemed too weak to observe, the $L_μ-L_τ$ force shows significant effects in neutron stars, impacting element abundances and neutrino production, especially for gauge couplings above $10^{-18}$.

Conclusion: The study suggests the possibility of observing neutrino signals from neutron stars, potentially redefining existing constraints on the gauge coupling involved.
...
### [102] [$Ξ_{cc}^{++}-Ξ_{cc}^{+}$ Transitions as a Two-Charm-Selective Portal to Ultra-Low-$Q$ Charged Currents](https://arxiv.org/abs/2606.19991)
*Yong Du*

Main category: hep-ph

TL;DR: The observation of $Ξ_{cc}^{+}$ by LHCb enables a test of charged-current new physics through the $Ξ_{cc}^{++}	oΞ_{cc}^{+}$ transition, with significant sensitivity to baryon-level couplings. A no-go result for universal light charged scalars indicates that current constraints surpass LHCb's sensitivity, while a novel charged-current portal offers a unique avenue for exploration in doubly charmed baryons.


<details>
  <summary>Details</summary>
Motivation: To investigate charged-current interactions and test for new physics using the recently observed $Ξ_{cc}^{+}$.

Method: Performed two- and three-body analyses to assess the sensitivity to baryon-level couplings in the context of $Ξ_{cc}^{++}	oΞ_{cc}^{+}$ transitions.

Result: Demonstrated that existing electroweak-precision and beta-decay constraints are stronger than the sensitivity expected from LHCb for universal light charged scalars, and identified a charged-current portal interaction specific to doubly charmed baryons.

Conclusion: The $Ξ_{cc}^{++}	oΞ_{cc}^{+}$ transition is a promising mechanism to probe the newly identified charged-current portal, offering insights into new physics.
...
### [103] [Non-standard decays of vector-like top partners in a $2$-Higgs doublet model at the HL-LHC](https://arxiv.org/abs/2606.20054)
*Tanumoy Mandal,Stefano Moretti,Rachit Sharma*

Main category: hep-ph

TL;DR: The paper explores the discovery potential of vector-like quark decays in extended Higgs sectors at the HL-LHC, focusing on a channel producing two tau leptons, two b-jets, and missing energy.


<details>
  <summary>Details</summary>
Motivation: Extensions of the Standard Model involve vector-like fermions and an enlarged scalar sector, which can lead to unique decay modes and collider signatures that remain largely untested experimentally.

Method: The analysis investigates the decay of a vector-like top partner into a charged Higgs, which then decays to tau leptons, producing a final state with two tau leptons, two b-jets, and missing transverse energy. It employs global kinematic observables to suppress background and examines polarization-sensitive observables for additional insights.

Result: The analysis indicates that the $2τ + 2b +$ missing $E_T$ channel is effective for probing non-standard VLQ decays, with sensitivity for VLQ masses up to approximately 1.9 TeV at the HL-LHC.

Conclusion: This channel provides a promising and largely independent avenue for discovering vector-like quarks in extended Higgs frameworks, meeting discovery-level sensitivity criteria.
...
### [104] [Toward Precision Fragmentation of $Ω_{3Q}$ Baryons: The OMG3Q1.1 Framework](https://arxiv.org/abs/2606.20063)
*Francesco Giovanni Celiberto*

Main category: hep-ph

TL;DR: The OMG3Q1.1 framework provides precision-driven descriptions of same-flavor heavy baryon fragmentation in high-energy collisions, utilizing advanced techniques to quantify uncertainties and facilitate future studies in the baryon sector.


<details>
  <summary>Details</summary>
Motivation: The discovery of doubly charmed states has intensified interest in the production mechanisms of heavy hadronic systems, necessitating precise and controlled descriptions of these processes.

Method: The OMG3Q1.1 framework integrates diquark-inspired models and threshold-aware DGLAP evolution under the HF-NRevo scheme to analyze fragmentation, quantifying both perturbative and nonperturbative uncertainties through a replica-based strategy.

Result: The framework produces an uncertainty-resolved set of fragmentation functions for the $Ω_{3Q}$ baryon sector and generates LHAPDF6 grids for examining semi-inclusive $Ω_{3Q}$ plus jet production at upcoming colliders like the HL-LHC and FCC.

Conclusion: OMG3Q1.1 establishes a benchmark for studying rare triply heavy baryons and lays the groundwork for comprehensive investigations in the heavy-flavor baryon domain.
...
### [105] [NLO QCD and EW corrections to semileptonic vector-boson scattering at the LHC](https://arxiv.org/abs/2606.19999)
*Ansgar Denner,Robert Franken,Daniele Lombardi,Santiago Lopez Portillo Chavez*

Main category: hep-ph

TL;DR: The paper presents calculations of NLO QCD and electroweak corrections for vector-boson scattering processes at the LHC, specifically $	ext{p}	ext{p} 	o 	ext{ℓ}^+ ν_	ext{ℓ} + 4	ext{j}$.


<details>
  <summary>Details</summary>
Motivation: Improving the precision of theoretical predictions for vector-boson scattering, given recent measurements at the LHC and future experimental plans.

Method: Calculations involve NLO QCD and electroweak corrections in a fully off-shell framework for the process and focus on fiducial regions.

Result: Leading electroweak contributions of $	ext{O}(α^6)$ and related corrections of $	ext{O}(α^7)$ and $	ext{O}(α_	ext{s} α^6)$ were provided for both fiducial cross sections and differential distributions.

Conclusion: The results offer important theoretical insights needed for future experiments aiming for precise measurements in vector-boson scattering.
...
### [106] [Theory Calculations for LDMX and LOHENGRIN beyond Coherent Bethe-Heitler Scattering](https://arxiv.org/abs/2606.20327)
*Martin Schürmann,Herbert K. Dreiner,Rhorry Gauld*

Main category: hep-ph

TL;DR: The paper discusses calculations for new experiments LDMX, DarkSHINE, and LOHENGRIN that aim to detect dark photons through bremsstrahlung processes and presents differential cross sections calculations critical for understanding signals and backgrounds related to dark photon detection.


<details>
  <summary>Details</summary>
Motivation: To search for dark photons in the MeV-GeV mass range using new experimental setups and to understand the scattering processes involved.

Method: Calculating differential cross sections for all contributing real emission processes up to third order in the fine structure constant and fourth order in kinetic mixing; considering both target nucleus and constituents.

Result: Numerical results are presented, which suggest that while contributions beyond coherent Bethe-Heitler scattering have limited effects, the LOHENGRIN experiment will need an HCAL extension for better background control.

Conclusion: The findings indicate limitations in the impact of complex processes on signal predictions, emphasizing the need for specific experimental adaptations.
...
### [107] [Two Flavon Froggatt-Nielsen Models with Genetic Algorithms](https://arxiv.org/abs/2606.20000)
*Miguel Crispim Romão,Stephen F. King*

Main category: hep-ph

TL;DR: The paper systematically scans two-flavon Froggatt-Nielsen models using AI, revealing comprehensive results and over 100,000 unique models that exhibit enhanced CP violation and fit various experimental constraints efficiently.


<details>
  <summary>Details</summary>
Motivation: To explore the two-flavon Froggatt-Nielsen model's potential in generating CP violation and to find phenomenologically viable models efficiently.

Method: Artificial intelligence techniques are employed, formulating the search as a multi-objective optimization problem using the Non-dominated Sorting Genetic Algorithm III to fit a large parameter space.

Result: The analysis yields over 100,000 unique viable models with low duplication, demonstrating a vast space of valid two-flavon FN realizations.

Conclusion: The study not only identifies minimal FN realizations with low flavon exponent but also presents models reproducing fermion masses to within 6%, indicating significant findings in neutrino mass hierarchies and effective decay mass predictions.
...
### [108] [The $B^+ \to K^+ ν\bar ν$ decay as a QCD axion search: comparing reinterpretation approaches](https://arxiv.org/abs/2606.20525)
*Merna Abumusabh,Giulio Dujany,Diego Guadagnoli,Méril Reboud,Claudio Toni*

Main category: hep-ph

TL;DR: Two analyses of Belle II data show differing limits on the decay mode $B^+ \to K^+ a$, attributed to the chosen kinematic variables. Fine binning improves signal resolution, while BDT offers minimal benefit. A reanalysis suggests BDT likelihoods may hinder reinterpretation due to signal shape discrepancies, advocating for physical variable publication alongside BDT results.


<details>
  <summary>Details</summary>
Motivation: To resolve discrepancies in limits on the $B^+ \to K^+ a$ decay mode derived from Belle II data analyses.

Method: Comparative analysis of two approaches: one with fine-grained binning of the di-neutrino invariant mass $q^2_{m rec}$ and another utilizing a BDT axis. Numerical tests are performed to assess sensitivity differences based on kinematic variables.

Result: The choice of kinematic variables alone accounts for a factor of four difference in sensitivity. The analysis revealed that BDT likelihoods do not enhance discrimination power for the axion signal and may obscure interpretations.

Conclusion: The authors recommend that experimental collaborations provide likelihood projections in both physical variable spaces and BDT-based likelihoods to improve reinterpretability of measurements.
...
### [109] [The Simplest Dirac Scoto-Seesaw Realization](https://arxiv.org/abs/2606.20119)
*Sin Kyu Kang,Ranjeet Kumar,Hemant Kumar Prajapati*

Main category: hep-ph

TL;DR: The paper proposes a Dirac scoto-seesaw framework that utilizes a chiral anomaly-free $U(1)_{B-L}$ charge assignment to explain neutrino mass differences and dark matter stability, presenting two realizations with different neutrino patterns and exploring their implications for dark matter.


<details>
  <summary>Details</summary>
Motivation: To provide a unified framework addressing neutrino mass generation and dark matter stability under a chiral $U(1)_{B-L}$ charge assignment.

Method: The paper employs a Dirac scoto-seesaw mechanism with specific anomaly-free charge assignments, analyzing two minimal realizations to explore neutrino mass ordering and dark matter phenomenology.

Result: Both normal and inverted neutrino orderings are viable in one scenario, while the other supports only normal ordering; the framework produces lighter mass bounds for dark matter candidates due to suppressed dilepton branching fractions.

Conclusion: The developed framework demonstrates predictive qualities for neutrino and dark matter interactions, offering avenues for experimental exploration.
...
### [110] [Addressing uncertainties of model predictions for extensive air showers initiated by high energy cosmic rays](https://arxiv.org/abs/2606.20221)
*Sergey Ostapchenko,Tanguy Pierog,Günter Sigl*

Main category: hep-ph

TL;DR: This paper presents a new Monte Carlo generator, QGSb, for analyzing uncertainties in extensive air shower (EAS) characteristics related to cosmic ray interactions.


<details>
  <summary>Details</summary>
Motivation: To address model uncertainties in EAS simulations, specifically related to high-energy cosmic ray interactions in the atmosphere.

Method: The study uses QGSb to modify predictions for air shower maximum depth and muon number, analyzing the underlying physics mechanisms.

Result: The paper systematically evaluates changes in model predictions and compares them with relevant accelerator data.

Conclusion: Findings suggest significant impacts of model modifications on EAS characteristics, which can enhance understanding of cosmic ray composition.
...
### [111] [Three-particle di-light-cone distribution amplitudes of the $B$-meson in heavy-quark effective theory](https://arxiv.org/abs/2606.20267)
*Riccardo Bartocci,Philipp Böer,Thorsten Feldmann,Max Ferré,Nico Gubernari,Daniel Vladimirov*

Main category: hep-ph

TL;DR: This study explores the three-particle di-light-cone distribution amplitudes (DLCDAs) of $B$-mesons, focusing on their structure and implications for non-perturbative dynamics in $B$-decays.


<details>
  <summary>Details</summary>
Motivation: To better understand the non-factorisable contributions of soft gluons in rare and non-leptonic exclusive $B$-meson decays and how they affect theoretical predictions.

Method: The study involves deriving the complete Lorentz decomposition of trilocal HQET operator matrix elements, identifying eight independent DLCDAs, and using local operator identities to relate them to hadronic parameters.

Result: The authors establish relations between the independent DLCDAs and hadronic parameters, and present momentum-space models while considering the perturbative radiative tail for the leading-twist distribution.

Conclusion: The findings enhance our understanding of the non-perturbative dynamics in $B$-decays and provide a framework for modeling DLCDAs relevant to rare processes.
...
### [112] [Dyonic lattices, $θ$-angles and axions in the Standard Model](https://arxiv.org/abs/2606.20319)
*Rodrigo Alonso,Francesca Chadha-Day,Despoina Dimakou,Yunji Ha,Valentin V. Khoze*

Main category: hep-ph

TL;DR: This paper explores the Witten effect in the Standard Model, investigating the implications of $θ$-parameters on dyonic spectra and CP invariance, with connections to axion physics.


<details>
  <summary>Details</summary>
Motivation: To understand the implications of the Witten effect within a general framework of the Standard Model and its gauge group structure.

Method: The authors classify dyonic charge lattices and analyze $θ$-parameters and their periodicities, as well as the effects of anomalous transformations on the structure of $θ$-space.

Result: The research reveals the connection between $U(1)_{	ext{em}}$ and the Standard Model parameters, indicating that a $U(1)_{	ext{em}}$ monopole discovery could complete the parameter space of the Standard Model.

Conclusion: The findings emphasize that a single axion does not achieve full CP invariance in the Standard Model and that the behavior of $θ$-space is crucial for axion physics.
...
### [113] [Renormalization of axial anomaly in SU(N)$\times$U(1)](https://arxiv.org/abs/2606.20342)
*Tanmoy Pati,Narayan Rana*

Main category: hep-ph

TL;DR: This paper addresses the calculation of renormalization constants for $\gamma_5$ in dimensional regularization, extending previous methods to mixed gauge sectors and presenting new results at three loops.


<details>
  <summary>Details</summary>
Motivation: The need for accurate renormalization constants to uphold standard and chiral Ward identities in high-precision Standard Model predictions.

Method: A novel technique leveraging form factors and the universality of infrared divergences to compute the necessary renormalization constants.

Result: New three-loop results for renormalization constants and pure-singlet contributions to the quark axial-vector form factor in a mixed $SU(N) \times U(1)$ gauge context.

Conclusion: The proposed technique successfully extends the calculations to mixed gauge sectors, providing essential insights for precision calculations in the Standard Model.
...
### [114] [Revisiting the role of saturation in diffractive vector meson production](https://arxiv.org/abs/2606.20362)
*Heikki Mäntysaari,Hendrik Roch,Björn Schenke,Chun Shen,Wenbin Zhao*

Main category: hep-ph

TL;DR: The paper presents a global Bayesian analysis of diffractive $	ext{J}/ψ$ photoproduction in proton and lead collisions using a CGC framework, revealing improved model consistency through EMD correction of LHC data.


<details>
  <summary>Details</summary>
Motivation: To address discrepancies in diffractive $	ext{J}/ψ$ photoproduction data from proton and nuclear collisions by employing a coherent theoretical framework.

Method: Utilizing a Color Glass Condensate model and Gaussian-process emulators to analyze ultraperipheral collision data, along with a Bayesian statistical approach to infer model parameters.

Result: The application of EMD corrections to the $γ+	ext{Pb}$ dataset alleviates tensions between datasets from different collision types, enhancing model consistency.

Conclusion: Simultaneous modeling of diffractive $	ext{J}/ψ$ production across different collision types is achieved, supporting the validity of the CGC framework in addressing previously observed discrepancies.
...
### [115] [Phase Transitions and Gravitational Wave Production at the End of Thermal Inflation](https://arxiv.org/abs/2606.20392)
*Hyukjung Kim,İlayda Kuzu,Kerem Özsoy,Zeynep Kahraman,Wan-Il Park,Heeseung Zoe*

Main category: hep-ph

TL;DR: This study investigates the first-order phase transition that ends thermal inflation, analyzing gravitational-wave signals arising from this transition through semi-analytic and numerical methods.


<details>
  <summary>Details</summary>
Motivation: Understanding phase transitions in the early universe is crucial for cosmology and astrophysics, particularly regarding gravitational wave signals.

Method: The phase transition is studied using semi-analytic calculations and numerical simulations via CosmoTransitions and a Langevin lattice model that simulates Hubble expansion and temperature changes.

Result: The study finds that the transition involves localized bubble nucleation and growth, with dynamics consistent across methods. Estimates show that generated gravitational waves fall within future observatories' sensitivity ranges.

Conclusion: The findings indicate that there is a significant potential for detecting stochastic gravitational waves from this phase transition with upcoming observatories.
...
### [116] [The X17 Anomaly: Experimental Evidence and Theoretical Interpretations](https://arxiv.org/abs/2606.20423)
*Raoul Serao,Aniello Quaranta,Antonio Capolupo*

Main category: hep-ph

TL;DR: The review discusses the X17 particle's experimental evidence, theoretical frameworks, implications on the Standard Model, and future experimental prospects.


<details>
  <summary>Details</summary>
Motivation: To explore the implications of the X17 particle on fundamental physics and its integration into existing theoretical models.

Method: The review synthesizes experimental data and theoretical perspectives on the X17 particle.

Result: Provides insights into how the X17 particle could influence the Standard Model and details opportunities for future research.

Conclusion: The X17 particle may have significant implications for particle physics, warranting further experimental investigation.
...
### [117] [String Axiverse Enhancement of Superradiant Dark Matter Production](https://arxiv.org/abs/2606.20524)
*Diogo S. Gorgulho,Jacob A. Litterer,João G. Rosa*

Main category: hep-ph

TL;DR: This paper investigates how string axion emission influences dark matter production by primordial black holes (PBHs), particularly through evaporation and superradiance effects.


<details>
  <summary>Details</summary>
Motivation: The study aims to explore the impact of light axion emissions from string theory on the dynamics and characteristics of dark matter, specifically in the context of primordial black holes.

Method: The authors analyze Hawking emission of light axions and its effects on PBH spin and the formation of micro-boson stars, considering different parameter regions for dark matter and PBH properties.

Result: They find that realistic constructions of string theory can enhance superradiance efficiency, allowing a broader range of PBH characteristics to yield substantial dark matter in the form of micro-boson stars, but excessive axion species can hinder growth of superradiant clouds.

Conclusion: The study concludes that while PBHs can produce dark matter, axions emitted during their evaporation have a negligible impact on the relativistic degrees of freedom at recombination.
...
### [118] [Rotating magnetized pion gas of finite transverse size: condensation constraints and transport properties](https://arxiv.org/abs/2606.20530)
*Ankit Kumar,Diwakar Gaur,Vinod Chandra*

Main category: hep-ph

TL;DR: This study explores the effects of rotation and magnetic fields on the transport properties of a pion gas, revealing significant interactions between these elements and their influence on conductivity and thermoelectric responses.


<details>
  <summary>Details</summary>
Motivation: Understanding the transport properties of a rotating pion gas under a magnetic field is crucial for applications in high-energy physics and related fields.

Method: The Boltzmann Transport Equation under the Relaxation Time Approximation was employed to calculate the longitudinal electrical and thermal conductivities and the Seebeck coefficient, with a focus on parameter limits for $π^+$ condensation.

Result: Findings indicate a condensation asymmetry where $π^+$ condenses but $π^-$ does not under certain conditions. The interplay between rotation and the magnetic field significantly affects transport properties, with rotation enhancing transport coefficients despite magnetic suppression.

Conclusion: The research underscores the complex interplay of rotation and magnetic fields in altering the transport characteristics of the pion medium, especially beyond certain angular velocities where rotational effects become dominant.
...
TL;DR: This study utilizes FAST to analyze scintillation effects in PSR B1257+12, revealing key insights into its environment and pulsar-distances.


<details>
  <summary>Details</summary>
Motivation: To understand scintillation characteristics of the first-known pulsar planetary system, PSR B1257+12, and the impact of surrounding plasma on measurements.

Method: 31 observations were analyzed using one-dimensional autocorrelation functions to derive scintillation timescales, bandwidths, and frequency-drift rates over various epochs.

Result: Key findings include isotropic scattering with a screen distance of 233±28 pc, revealing inner, middle, and outer arcs, and highlighting low DM-change rates in the pulsar's immediate environment.

Conclusion: The results indicate that external plasma dominates DM variations, with potential for undetected scattering screens close to the pulsar. Further observations may clarify these environments.
...
TL;DR: Discovery of gamma rays from young stellar objects indicates non-thermal processes and proton acceleration in protostellar jets.


<details>
  <summary>Details</summary>
Motivation: To explore the energetic activity in protostars and confirm proton acceleration processes.

Method: Statistical detection of gamma rays from a population of young stellar objects, correlating cosmic-ray output with luminosity.

Result: Identification of a new class of Gamma-Loud Protostars and confirmation of particle acceleration in protostellar jets.

Conclusion: Gamma-ray emissions from protostars provide insights into non-thermal processes that influence star and planet formation.
...
TL;DR: This paper investigates how fast radio bursts (FRBs) propagate through magnetar magnetospheres, revealing that nonlinear plasma processes restrict their escape from these environments.


<details>
  <summary>Details</summary>
Motivation: To understand the interaction of FRBs with magnetar magnetospheres and identify the mechanisms that limit their propagation and energy transfer.

Method: Utilizing three-dimensional force-free electrodynamics simulations to analyze the propagation of GHz radio waves as they interact with Alfvén waves in magnetar magnetospheres.

Result: FRBs excite Alfvénic fluctuations leading to significant nonlinear signal attenuation. The efficient decay of signals occurs within $	ext{~}10$--$100$ magnetar radii, and charge starvation halts this decay at larger distances.

Conclusion: Nonlinear plasma processes significantly restrict the escape of FRBs from the inner magnetospheres of magnetars, pointing to the complex interplay between FRBs and magnetar environments.
...
TL;DR: The study confirms that low-frequency fast-magnetosonic waves cannot escape magnetar magnetospheres without significant energy loss and spectral broadening.


<details>
  <summary>Details</summary>
Motivation: To explore the feasibility of GHz fast radio bursts escaping from highly magnetized environments like those around magnetars.

Method: Using relativistic force-free electrodynamics simulations to analyze the dynamics of fast-magnetosonic waves and their interactions with Alfvén waves.

Result: FMS waves are shown to undergo nonlinear conversion into secondary FMS and Alfvén wave components due to parametric decay instability, draining energy from the primary waves even after equipartition.

Conclusion: FMS waves likely experience substantial dissipation and spectral broadening, making escape from magnetar magnetospheres unlikely.
...
TL;DR: Relaxing the double-averaged approximation shows that short-range forces can increase eccentricity in binary systems, challenging existing ZLK theories.


<details>
  <summary>Details</summary>
Motivation: To investigate the effects of short-range forces on eccentricity behavior in hierarchical triples beyond the traditional double-averaged approximation.

Method: Analyzing the impact of SRFs on the effective adiabatic invariants of binary systems during high-eccentricity episodes.

Result: SRFs can enhance extreme eccentricity instead of suppressing it, altering the understanding of maximum/minimum eccentricity and secular periods in astrophysically relevant triples.

Conclusion: Binaries may explore a larger phase space than previously believed, suggesting the need for a revised view of ZLK dynamics.
...
TL;DR: The paper explores how inefficient transport of cosmic rays near sources affects the statistical likelihood of a strong local source contributing to cosmic-ray spectra observed below the knee, showing increased probabilities under modified diffusion models but highlighting model dependence.


<details>
  <summary>Details</summary>
Motivation: To understand discrepancies in cosmic-ray spectra below the knee and evaluate the likelihood of local sources under different diffusion scenarios due to observations of gamma-ray emissions around Galactic accelerators.

Method: The authors derive a series Green's function to model cosmic-ray particle distribution under inefficient transport near sources, making it possible to conduct Monte Carlo simulations for Galactic source populations.

Result: The probability of a strong local source contributing comparably to the background at 10 TeV increases from 0.4% in homogeneous diffusion to 1.7-2.2% in models with slow diffusion regions, but the statistical challenge remains.

Conclusion: The plausibility of local source contributions is confirmed, yet remains highly dependent on the chosen transport models, requiring further constraints on source injection and transport mechanisms.
...
TL;DR: The pulsar PSR B0450-69 exhibits an evolving braking index post a spin-down change, suggesting influences from particle winds and leading to implications for pulsar behavior and modeling.


<details>
  <summary>Details</summary>
Motivation: To investigate the evolution of the braking index in pulsars, specifically how changes in spin-down state influence it and to explore the underlying physics of particle winds in pulsars.

Method: Analyzing the braking index measurements of PSR B0450-69 and PSR B0540-69, while considering the impact of variations in particle number density and applying a wind braking model.

Result: The braking index of PSR B0450-69 is found to increase over time, aligning with previous predictions about its change due to enhanced particle winds, and a specific exponential evolution form is noted. The braking index for PSR B0540-69 is anticipated to stabilize.

Conclusion: Future measurements will clarify the mechanisms driving braking index evolution, contributing to understanding pulsar magnetospheres and offering a simplified model for pulsar braking dynamics.
...
TL;DR: The review discusses variability in stellar-mass black holes, focusing on emissions, behaviors, and unresolved questions in accretion physics.


<details>
  <summary>Details</summary>
Motivation: To explore accreting stellar-mass black holes as laboratories for understanding strong gravitational field accretion processes.

Method: Review of recent advancements in continuum emission, timing properties, emission lines, and X-ray polarization associated with accretion systems.

Result: Identifies the interplay between accretion disk, corona, and jet, highlighting specific behaviors like quasi-periodic oscillations and the role of emission lines and polarization.

Conclusion: Calls for multi-wavelength and polarimetric studies to address remaining questions about state transitions, magnetic fields, and jet dynamics.
...
TL;DR: The IXPE has provided crucial X-ray polarimetry data on supernova remnants (SNRs), revealing significant magnetic field geometries and turbulence that influence particle acceleration.


<details>
  <summary>Details</summary>
Motivation: To explore the physics of supernova remnants through advanced X-ray polarimetry, enhancing our understanding of particle acceleration mechanisms influenced by magnetic fields.

Method: Using IXPE, spatially resolved X-ray polarimetry measurements were obtained from six young SNRs, analyzing polarization and magnetic field topologies.

Result: Significant polarization (5-30%) observed in all SNRs; radial magnetic fields in Cas A, Tycho, and SN 1006, and tangential fields in RX J1713.7-3946 and Vela Jr., demonstrating complex magnetic field configurations that challenge previous assumptions.

Conclusion: IXPE's findings indicate that shock velocity and circumstellar medium density shape magnetic-field topology, advancing the understanding of cosmic-ray acceleration processes in young SNR shocks.
...
TL;DR: This paper models the timing residuals of millisecond pulsars in mini-pulsar timing arrays (mini-PTAs) affected by gravitational waves (GWs), revealing significant near-field effects that enhance detection capabilities for GW sources in globular clusters and galactic nuclei.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of using millisecond pulsars in globular clusters and galactic nuclei as a means to detect nanohertz gravitational-wave sources through precise timing measurements.

Method: A comprehensive model is developed to account for near-field effects on the timing residuals of pulsars due to gravitational waves, incorporating realistic configurations of gravitational-wave sources in globular clusters and galactic nuclei.

Result: Close proximity of millisecond pulsars to gravitational wave sources can result in timing residuals of up to 1 microsecond in globular clusters and milliseconds in galactic centers, making them detectable with current radio telescopes.

Conclusion: Mini-PTAs in globular clusters or galactic nuclei could serve as effective tools for detecting otherwise hidden gravitational-wave sources, including those from intermediate-mass and supermassive black hole binaries.
...
TL;DR: This study presents the results of observational campaigns aimed at detecting radio pulsations from two accreting millisecond pulsars (AMSPs) during quiescent states, with no significant signals found.


<details>
  <summary>Details</summary>
Motivation: To investigate the radio emissions of AMSPs in quiescence, as they have not been detected previously except for one case.

Method: Two observational campaigns were conducted using the Five-hundred-meter Aperture Spherical Telescope (FAST) in L-band, alongside upper limits on X-ray and optical flux.

Result: No significant candidate radio pulsations were found in either source, producing the most stringent upper limits on pulsed radio flux density for known persistent AMSPs.

Conclusion: The lack of detected radio pulsations suggests challenges in observing AMSPs in quiescence, potentially impacting our understanding of their evolution.
...
TL;DR: This study examines how varying the carbon fusion rate affects superbursts in neutron stars, revealing significant implications for their recurrence and explosion characteristics.


<details>
  <summary>Details</summary>
Motivation: To understand the impact of a newly revised carbon fusion rate on the physics of superbursts in LMXBs, particularly given the potential for changes by factors up to $10^{3}$.

Method: The study utilizes MESA v.24.08.1 to simulate superbursts under different carbon fusion reaction rates, analyzing the effects of both enhanced and reduced rates on superburst characteristics.

Result: Enhanced carbon fusion rates lead to decreased recurrence and decay times, as well as changes in ignition conditions and nucleosynthesis, while reduced rates have the opposite effects.

Conclusion: The results indicate that both the carbon fusion rate and base heating significantly influence the dynamics and nuclear processes of superbursts, necessitating a careful consideration of these factors in future models.
...
TL;DR: The paper proposes that the disconnected gamma-ray tails observed from SS433 are due to PeV neutron jets ejected from the system, which undergo decay and scattering processes resulting in high-energy gamma-rays.


<details>
  <summary>Details</summary>
Motivation: To explain the recently discovered gamma-ray tails that are seemingly disconnected from the SS433 binary system.

Method: Suggesting that ultra high-energy PeV neutron beams formed during rare tidal eruptions can create secondary gamma-rays through decay and scattering with thermal photons.

Result: The proposed PeV neutron jets can effectively explain the observed distant gamma-ray emissions, aligning well with observations and surpassing alternative models.

Conclusion: This model offers a plausible mechanism for the high-energy gamma-ray emissions associated with the SS433 system, indicating the importance of understanding transient events in binary systems.
...
TL;DR: Observational data suggests a bimodal distribution for neutron star natal velocities, with about 30% of isolated radio pulsars in the low-velocity mode. Key differences exist between pulsars in both modes, notably in magnetic field distribution, but some observed differences may stem from selection bias.


<details>
  <summary>Details</summary>
Motivation: To understand the velocity kick distribution of neutron stars and analyze the properties of normal isolated radio pulsars based on their velocities.

Method: The study involved analyzing observational data of approximately 200 radio pulsars, categorizing them into low- and high-velocity modes based on their kinematic parameters, and comparing various physical properties between these categories.

Result: Approximately 30% of the pulsars were identified in the low-velocity mode; differences found in characteristics such as radio luminosities were attributed to selection bias, while significant differences were observed in the magnetic field distributions between the two modes.

Conclusion: The low-velocity mode pulsars show an overabundance of lower magnetic field strengths, with no high-velocity mode pulsars found in the very low magnetic field range. The reason for this discrepancy remains uncertain, warranting further discussion.
...
TL;DR: Evidence suggests NGC7456 ULX-1 may host an accreting neutron star, indicated by a pulsational signal at 0.22 Hz and rapid spin evolution.


<details>
  <summary>Details</summary>
Motivation: To investigate the nature of NGC7456 ULX-1 as a potential source of pulsation and rapidly evolving spin, contributing to the understanding of ultraluminous X-ray sources.

Method: Utilized XMM-Newton observations with timing techniques like accelerated searches, $Z^2_n$ statistics, and orbital-demodulation analysis to identify a candidate pulsational signal.

Result: Detected a pulsational signal at ~0.22 Hz, with a frequency drift implying rapid spin evolution and estimated magnetic field strength between $10^{12}$ and $10^{14}$ G.

Conclusion: Results suggest NGC7456 ULX-1 may be an accreting neutron star, pending further confirmation through independent datasets or observations.
