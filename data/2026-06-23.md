...
### [1] [The Silicon Tracking System of the E16 experiment at J-PARC: construction, installation and commissioning in beam test experiments](https://arxiv.org/abs/2606.19400)
...
TL;DR: The J-PARC E16 experiment investigates chiral symmetry restoration through in-medium vector mesons using a 30 GeV proton beam and advanced tracking technology.


<details>
  <summary>Details</summary>
Motivation: To search for signatures of chiral symmetry restoration in particle physics by studying vector mesons in high-energy conditions.

Method: The experiment upgrades its tracking system using 15 advanced detector modules similar to the CBM's Silicon Tracking System, tested and characterized in a beam test with 3 GeV electrons.

Result: Successful construction, characterization, commissioning, and operation of the E16-STS modules were achieved, validating the tracking setup in beam tests.

Conclusion: The study confirms the readiness of the E16-STS detector modules for further experiments in the J-PARC E16 project.
...
### [2] [PiMiX 2.0: AI-enhanced Data Fusion for Radiographic Imaging and Tomography](https://arxiv.org/abs/2606.19670)
...
TL;DR: PiMiX 2.0 is an AI-enhanced framework for advanced data fusion and analysis in radiographic imaging, featuring automation, 3D and 4D reconstruction, and physics-aware interpretations.


<details>
  <summary>Details</summary>
Motivation: To enhance data processing, knowledge extraction, and reproducibility in experimental workflows involving multi-modal radiographic imaging and tomography.

Method: Integrates AI workflows with automated ingestion, multimodal image processing, and physics-informed reasoning, supporting deployment on various computing environments.

Result: Accelerates RadIT data processing and enables integrated analyses in high-temperature plasmas, nuclear fusion, and advanced manufacturing.

Conclusion: PiMiX 2.0 enhances experimental workflows by providing scalable, efficient analysis and improved reproducibility across various scientific disciplines.
...
### [3] [Operational characterization of LAPPD Generation 2: charge sharing, delayed pulses, and dark-count behavior](https://arxiv.org/abs/2606.19766)
*S. -W. Stradleigh,J. A. Foot,R. Zhang,V. A. Li*

Main category: physics.ins-det

TL;DR: Study of charge sharing and electronic cross-talk in LAPPD Gen 2 using pulsed laser measurements, revealing pixel coupling and dark-count rate behavior, with pulse classification and Monte Carlo simulations confirming findings.


<details>
  <summary>Details</summary>
Motivation: To investigate the charge sharing and cross-talk effects in advanced photodetector technology, enhancing understanding of signal distribution and noise characteristics.

Method: Experiments involve measuring signal distributions across a resistive anode with a picosecond pulsed laser, analyzing dark-count rates at various LAPPD voltage settings, and developing a pulse-classification method along with a Monte Carlo simulation for modeling signal behavior.

Result: Measurements quantify pixel coupling and reveal the dark-count rate's decay behavior across several relaxation times, while the simulation aligns well with pulse classifications and identifies signal features.

Conclusion: The study enhances understanding of LAPPD Gen 2's performance, particularly in charge sharing and electronic cross-talk, providing insights useful for optimizing photodetector applications.
...
### [4] [Raw-Hit Muon Tomography: A Measurement-Domain Formulation for Cosmic-Ray Muon Imaging](https://arxiv.org/abs/2606.20180)
*Zhizheng Zhao,Changhao Qin,Rongfeng Zhang,Zibo Qin,Qite Li*

Main category: physics.ins-det

TL;DR: The paper introduces Raw-Hit Muon Tomography (RHMT), enhancing muon detection by analyzing raw hits instead of processed data, improving accuracy in material characterization through better statistical modeling.


<details>
  <summary>Details</summary>
Motivation: To address limitations in traditional muon tomography methods which compress data and lose detailed information about scattering and energy loss.

Method: RHMT employs a measurement-domain approach using raw detector hits, with RHMT-S projecting out unknown tracks and using a Student-$t$-likelihood, while RHMT-E estimates log momentum loss through a Bethe--Bloch line integral.

Result: RHMT-S achieves a higher mean ROC-AUC (0.84-0.86) compared to traditional methods (0.81 for ASR) in a controlled Geant4 benchmark; RHMT-E offers energy-loss contrast, particularly effective for materials like aluminium.

Conclusion: The new RHMT methods improve the efficacy of muon tomography by utilizing raw hits, enhancing both scattering and energy loss assessment in materials.
...
### [5] [The ESSnuSB Experiment](https://arxiv.org/abs/2606.19391)
*Monojit Ghosh*

Main category: hep-ex

TL;DR: The ESSnuSBplus project is a phase-I initiative aiming to measure CP violation in neutrino oscillations with high precision and to explore various neutrino physics cases.


<details>
  <summary>Details</summary>
Motivation: To improve measurements of $δ_{m CP}$ and explore other neutrino phenomena, enhancing our understanding of neutrino properties and interactions.

Method: The project utilizes a long-baseline neutrino oscillation experiment with a low energy monitored beam and nuSTORM facility for cross-section measurements.

Result: The large far detector will enable comprehensive studies of neutrinos from multiple sources, achieving unprecedented precision in CP violation measurements and the ability to investigate solar, atmospheric, and supernova neutrinos.

Conclusion: ESSnuSBplus aims to significantly advance neutrino physics and broaden the experimental landscape for future neutrino studies.
...
### [6] [Towards Engineering Scaling Laws with Pretraining Data Composition](https://arxiv.org/abs/2606.19781)
*Jan-Lucas Uslu,Kevin Greif,Daniel Whiteson,Benjamin Nachman*

Main category: hep-ex

TL;DR: Neural scaling laws apply to model performance in particle physics, emphasizing the advantage of data diversity over model size in scaling behavior for high-energy jet classification.


<details>
  <summary>Details</summary>
Motivation: To understand how model performance in particle physics can be enhanced through engineered scaling laws, especially given the availability of high-fidelity simulators.

Method: Investigate how diverse and task-aligned pretraining data affects model performance for classifying hadronic jets in high-energy collisions, leveraging empirical scaling laws.

Result: The study demonstrates that scaling behavior can be optimized by prioritizing data diversity, enabling models to improve performance with more data instead of larger parameters.

Conclusion: In particle physics, specifically for classifying hadronic jets, engineering the pretraining dataset yields better scaling outcomes, emphasizing the significance of data quality and variety.
...
### [7] [Resonant heterodyne conversion applied to a low-frequency haloscope for dark matter axion searches in the 1-35 MHz range](https://arxiv.org/abs/2606.20422)
*Navarro-Madrid Jose R.,Reina-Valero José,Díaz-Morcillo Alejandro,Gimeno Benito*

Main category: hep-ex

TL;DR: The paper explores resonant heterodyne up-conversion as a method for detecting low-mass dark matter axions using microwave cavities, focusing on axion electrodynamics, effective quality factors, and the optimization of cavity configurations for enhanced sensitivity.


<details>
  <summary>Details</summary>
Motivation: The study aims to improve detection of low-mass dark matter axions, which are challenging to identify using conventional methods.

Method: The authors develop a formalism for axion-induced signals in microwave cavities, considering finite linewidth effects, and extend a 3D full-wave formulation to analyze heterodyne detection in a realistic cavity setup.

Result: The analysis identifies a specific mode pairing in the RADES-BabyIAXO cavity that enhances sensitivity to axion frequencies between 0.9 and 34.6 MHz, with predictions showing strong agreement between analytical and numerical models.

Conclusion: Under optimal conditions, this approach could probe axion-photon couplings down to $10^{-15}\,\mathrm{GeV}^{-1}$, marking a significant advancement in the field of axion searches.
...
### [8] [HEPTv2: End-to-End Efficient Point Transformer for Charged Particle Reconstruction](https://arxiv.org/abs/2606.20437)
*Siqi Miao,Shitij Govil,Jack P. Rodgers,Mia Liu,Javier Duarte,Shih-Chieh Hsu,Yuan-Tang Chou,Pan Li*

Main category: hep-ex

TL;DR: HEPTv2, an end-to-end point-transformer architecture, offers a highly efficient and accurate solution for charged-particle tracking in high-energy physics, optimizing performance at HL-LHC with significant improvements over previous methods.


<details>
  <summary>Details</summary>
Motivation: The complex nature of charged-particle tracking under extreme collision conditions necessitates solutions that balance accuracy and efficiency, prompting the need for innovative methodologies.

Method: HEPTv2 integrates a locality-aware point encoder with a track decoder in a singular pipeline, eliminating graph construction and auxiliary stages, and featuring sectorized decoding for effective hit-to-track predictions.

Result: HEPTv2 achieved 98.6% tracking efficiency with a 0.8% fake rate, demonstrating significantly lower latency and memory usage compared to existing methods, establishing new benchmarks in the field.

Conclusion: End-to-end transformers like HEPTv2 can successfully meet the demands of real-time particle detection and tracking at the HL-LHC, marking a significant advancement in the technology used for high-energy physics experiments.
...
### [9] [Observation of electroweak production of pairs of Z bosons in proton-proton collisions at 13 TeV](https://arxiv.org/abs/2606.20558)
*CMS Collaboration*

Main category: hep-ex

TL;DR: The CMS experiment reports the first evidence of electroweak production of ZZ boson pairs with jets, confirming predictions of the standard model.


<details>
  <summary>Details</summary>
Motivation: To study the electroweak production of Z boson pairs in proton-proton collisions and investigate anomalous quartic gauge couplings.

Method: Events with two same-flavor opposite-charge leptons, large missing transverse momentum, and two jets are analyzed in proton-proton collisions at 13 TeV with 138 fb$^{-1}$ integrated luminosity.

Result: The measured electroweak production cross section is 0.37$^{+0.14}_{-0.12}$ (stat)$^{+0.06}_{-0.06}$ (syst) fb, consistent with the standard model prediction. The significance of the result is observed at 3.1 standard deviations, and combined with previous results, it reaches 5.0 standard deviations.

Conclusion: The study reinforces standard model predictions for Z boson pair production and provides limits on anomalous quartic gauge couplings.
...
### [10] [Characterization of a symmetric-facet dual-ruled grating for spatial heterodyne spectroscopy](https://arxiv.org/abs/2606.19424)
*Cole Meyer,Joanne Flores,Jason Corliss,Walter Harris*

Main category: astro-ph.IM

TL;DR: Dual-bandpass spatial heterodyne spectrometers utilize dual-ruled gratings for improved throughput in high-resolution spectral measurements, validated by experimental results of a first-generation grating.


<details>
  <summary>Details</summary>
Motivation: To enhance high-resolution measurements in spectroscopy for astrophysical and planetary diagnostics while addressing throughput limitations of conventional dual-bandpass spectrometers.

Method: Experimental validation of a symmetric-facet dual-ruled grating with specific rulings and blaze angle, using a deuterium source and Czerny-Turner monochromator to measure diffraction efficiencies across several orders.

Result: Measured diffraction efficiencies showed agreement with theoretical predictions, revealing minor manufacturing defects and facet characteristics beneficial for high-resolution applications.

Conclusion: The study confirms the potential of dual-ruled gratings for advancing dual-bandpass spatial heterodyne spectrometry, paving the way for improved spectroscopy in relevant scientific fields.
...
### [11] [NNNN: Neural Networks for Newtonian Noise Mitigation at the Einstein Telescope](https://arxiv.org/abs/2606.19907)
*Jan Kelleter,Patrick Schillings,Jonathan Kuckert,David Bertram,Markus Bachlechner,Achim Stahl,Johannes Erdmann*

Main category: astro-ph.IM

TL;DR: This study demonstrates that neural networks can effectively predict Newtonian noise from seismic data, potentially surpassing traditional methods like the Wiener filter.


<details>
  <summary>Details</summary>
Motivation: To address the limitation posed by Newtonian noise on the sensitivity of ground-based gravitational wave detectors.

Method: Utilized synthetic data from seismometer arrays to train and test neural networks, comparing their performance against the Wiener filter on different seismic wave scenarios.

Result: Neural networks achieved comparable performance to the Wiener filter in stationary wave fields and significantly outperformed it in specific long- and short-term events, improving noise prediction by factors of 15-80.

Conclusion: Neural networks provide a promising approach to mitigate Newtonian noise, enhancing the sensitivity of future gravitational wave detectors.
...
### [12] [VASTER: The ASKAP real-time fast-imaging pipeline -- overview and discovery of two long period transients](https://arxiv.org/abs/2606.20067)
...
TL;DR: VASTER is a real-time imaging and transient detection pipeline for widefield radio telescopes, successfully discovering two new long period transients during its initial operation on ASKAP.


<details>
  <summary>Details</summary>
Motivation: To explore time domain sources that have been overlooked in traditional radio telescope surveys, specifically events on timescales of seconds to minutes.

Method: VASTER processes data in real time, performing short-timescale imaging and transient detection on the Australian SKA Pathfinder (ASKAP) within 15-minute intervals.

Result: During its first two weeks of operation, VASTER discovered two long period transients with periods of 6.48 hours and 4.69 hours, contributing to the understanding of this new population.

Conclusion: The successful detection of new transients demonstrates VASTER's capability to explore long period transient phenomena and enhance our understanding of time domain astronomy.
...
### [13] [MOSAIC at ELT: Design and First Performance Results of Novel Robotic Optical-Relay Positioners](https://arxiv.org/abs/2606.20194)
...
TL;DR: This paper discusses the initial design and prototypes of MOSAIC, a multi-object spectrograph for the Extremely Large Telescope (ELT), focusing on the challenges of positioner design due to the telescope's scale.


<details>
  <summary>Details</summary>
Motivation: To optimize the capabilities of the ELT, the MOSAIC spectrograph is being developed to effectively utilize its advanced observational capabilities.

Method: The design involves 300 robotic positioners equipped with relay mirrors and individual Atmospheric Dispersion Correctors (ADC) for each positioner to adapt to ELT's unique requirements.

Result: The initial prototypes of the positioners have been designed, addressing the challenges posed by the ELT's focal surface configuration and scale.

Conclusion: The paper offers insights into the innovative design solutions for the MOSAIC positioners, aiming to enhance their functionality in the ELT's observational framework.
...
### [14] [Instruments for Focal Plane X-Ray Polarimetry in the Next Decade](https://arxiv.org/abs/2606.20337)
...
TL;DR: The IXPE mission's detection of X-ray polarization has highlighted the need for advanced instrumentation to explore new scientific areas.


<details>
  <summary>Details</summary>
Motivation: To enhance the energy range and sensitivity in X-ray astronomy, addressing unanswered scientific questions.

Method: Development of a focal-plane polarimeter using multilayer mirrors, with integrated low/medium-energy photoelectric and active Compton polarimeters.

Result: The design is based on proven technology, showing promise for efficient space application.

Conclusion: This innovative approach aims to improve X-ray polarimetry and facilitate significant scientific discoveries.
...
### [15] [Lightstack: A Python Package for Creating Photometric Data Cubes](https://arxiv.org/abs/2606.20360)
*Andressa Wille,Rafael S. de Souza,Ana L. Chies-Santos,Thallis Pessi,Emille E. O. Ishida,Alberto Krone-Martins*

Main category: astro-ph.IM

TL;DR: Lightstack is a Python package for creating photometric data cubes from multi-band images, aiding studies in photometry.


<details>
  <summary>Details</summary>
Motivation: The growth of multi-imaging datasets from advanced telescopes necessitates efficient tools for analyzing diverse physical processes across different wavelengths.

Method: Lightstack offers a workflow that includes cropping selected areas, stacking images to form data cubes, and performing PSF matching.

Result: The package provides a streamlined approach for preparing multi-band photometric data, with a release under MIT license and documentation on GitHub.

Conclusion: Lightstack facilitates advanced photometric studies by simplifying the image processing workflow for researchers.
...
### [16] [Advancing Astrophysics with the SKA II](https://arxiv.org/abs/2606.20366)
...
TL;DR: AASKAII outlines the transformative potential of the SKA telescopes in advancing astrophysics, highlighting recent developments in telescope design and construction, and the insights gained from precursor telescopes.


<details>
  <summary>Details</summary>
Motivation: To present the scientific advancements and research opportunities enabled by the SKA telescopes and to outline the progress made since the previous edition.

Method: The volume is organized into six thematic categories reflecting the diverse scientific focus areas, with overview chapters from the SKA Science Working Groups providing broader context.

Result: The SKA telescopes are anticipated to enable groundbreaking discoveries in radio astronomy over the next decades, addressing longstanding challenges and revealing new phenomena.

Conclusion: AASKAII serves as a roadmap for ongoing and future research in radio astronomy, emphasizing the collaborative efforts of the scientific community in advancing knowledge through the SKA.
...
### [17] [ELMA: ELlipse-based bar MAjor axis estimator](https://arxiv.org/abs/2606.20370)
*Bruna R. Bragança de Lima,Andressa Wille,Rafael S. de Souza,Ana L. Chies-Santos*

Main category: astro-ph.IM

TL;DR: The paper introduces 'elma', a Python package for automating the estimation of bar lengths in barred galaxies, addressing challenges in manual measurements.


<details>
  <summary>Details</summary>
Motivation: Current methods for measuring bar lengths in galaxies are time-consuming and vary based on methodological approaches, making robust measurements difficult.

Method: The elma package uses iterative elliptical-isophote fitting on two-dimensional imaging data to derive the radial ellipticity profile and estimate the bar length from the semi-major axis of the local ellipticity maximum.

Result: Demonstrated successful application using JWST/NIRCam imaging in the GOODS-South field, showing elma’s capability to automate and standardize bar-length measurements.

Conclusion: The elma package provides a reliable, automated solution for estimating bar lengths in barred galaxies, facilitating further studies in galaxy evolution.
...
TL;DR: The study investigates scintillation characteristics of the pulsar PSR B1257+12 using FAST, highlighting isotropic scattering and DM variations.


<details>
  <summary>Details</summary>
Motivation: Understanding the scintillation properties and propagation effects of PSR B1257+12 to reveal insights about its environment and planetary system.

Method: Analyzed 31 observations of PSR B1257+12 using autocorrelation functions and secondary spectra for scintillation metrics and dispersion measures.

Result: Identified scintillation timescale, bandwidth, and transverse velocities; found isotropic scattering and dispersion measure variations primarily from distant plasma.

Conclusion: The pulsar's vicinity is likely clean from nearby scattering screens, but undetected screens may exist, needing more sensitive observations.
...
TL;DR: Detection of gamma rays from young stellar objects reveals a new class of Gamma-Loud Protostars, indicating particle acceleration in protostellar jets and linking cosmic-ray output to system luminosity.


<details>
  <summary>Details</summary>
Motivation: To explore the energetic non-thermal activity in young stellar objects and confirm proton acceleration, a previously elusive phenomenon.

Method: Statistical detection of gamma rays from young stellar objects, analyzing correlations with bolometric luminosity and particle acceleration processes.

Result: Discovery of a Galactic class of Gamma-Loud Protostars, demonstrating significant gamma-ray emission associated with proton interactions in molecular clouds.

Conclusion: Gamma-ray studies of protostars enhance understanding of non-thermal processes in their evolution, impacting star and planet formation dynamics.
...
TL;DR: This paper investigates how fast radio bursts (FRBs) propagate through magnetar magnetospheres and highlights the significant role of nonlinear plasma interactions.


<details>
  <summary>Details</summary>
Motivation: To understand the impact of magnetar magnetospheres on the propagation and attenuation of FRBs.

Method: Utilizes three-dimensional force-free electrodynamics simulations to analyze FRB propagation and interactions with Alfvén waves.

Result: Findings show that FRBs excite Alfvénic fluctuations, leading to nonlinear attenuation of signals, with effects persisting within 10–100 magnetar radii; charge starvation halts decay at further distances.

Conclusion: Nonlinear plasma processes severely restrict FRB escape from the inner magnetospheres of magnetars.
...
TL;DR: Low-frequency fast-magnetosonic waves in magnetized environments were studied, revealing that they likely do not escape without significant reprocessing and dissipation.


<details>
  <summary>Details</summary>
Motivation: To understand the propagation of FMS waves in magnetospheres and their potential role in escaping magnetars, particularly regarding GHz fast radio bursts.

Method: Utilized relativistic force-free electrodynamics simulations to analyze the behavior and interactions of FMS waves in a highly magnetized environment.

Result: Confirmed theoretical predictions and demonstrated efficient nonlinear conversion of FMS waves into secondary FMS and Alfvén waves, driven by parametric decay instability, affecting energy transfer and wave spectrum.

Conclusion: FMS waves likely do not escape from magnetar magnetospheres without considerable energy dissipation and spectral broadening.
...
TL;DR: This paper explores how relaxing the double-averaged approximation in the von Zeipel-Lidov-Kozai effect allows short-range forces to enhance extreme eccentricity behaviors in hierarchical triples, challenging previous assumptions.


<details>
  <summary>Details</summary>
Motivation: To investigate the role of short-range forces in the eccentricity dynamics of hierarchical triple systems, particularly in relation to black hole mergers and exoplanet formation.

Method: The study relaxes the double-averaged approximation of the ZLK effect, examining the influence of short-range forces on the effective adiabatic invariants during high-eccentricity events.

Result: It was found that short-range forces can lead to significant, discrete changes in the binary's parameters, enhancing eccentricity behavior and affecting the secular evolution of angular momentum in triples.

Conclusion: This indicates that the dynamics of hierarchical binaries are more complex than previously understood, with potential implications for the formation of exotic astrophysical objects.
...
TL;DR: The study investigates the impact of inefficient cosmic ray transport near sources on the probability of local contributions to cosmic ray spectra below the knee, revealing that this can increase the likelihood of strong local sources though still requires additional model constraints.


<details>
  <summary>Details</summary>
Motivation: To explore deviations in cosmic-ray spectra, particularly below the knee, and assess the likelihood of local sources contributing significantly to the observed spectra under different diffusion models.

Method: The authors derive a series Green's function for particle distribution, allowing for faster Monte Carlo simulations of cosmic ray transport near sources, specifically considering scenarios of inefficient transport and two-zone diffusion models.

Result: The likelihood of nearby supernova remnants being significant local sources increases in inefficient transport scenarios but remains low; from about 0.4% in homogeneous diffusion to 1.7-2.2% in two-zone models, indicating that while statistical challenges are alleviated, they persist.

Conclusion: Local interpretations of cosmic ray sources are plausible but depend heavily on transport models and additional assumptions regarding injection spectra and diffusion coefficients.
...
TL;DR: This study analyzes the braking index behavior of pulsar PSR B0450-69 after a spin-down state change, revealing effects of particle winds and predicting its future evolution.


<details>
  <summary>Details</summary>
Motivation: To understand the braking index evolution in pulsars, particularly in relation to spin-down state changes and particle wind dynamics.

Method: The research involves measuring the braking index over time and hypothesizing its relationship with particle number density variations and enhanced particle winds.

Result: The braking index shows an increasing trend post spin-down state change, aligning with predictions and suggesting a transition to a steady value.

Conclusion: Future measurements can clarify the mechanics behind braking index evolution, contributing to the broader understanding of particle dynamics in pulsar magnetospheres.
...
TL;DR: This review highlights recent advancements in understanding accreting stellar-mass black holes, focusing on their emission properties and the complex dynamics of their accretion processes.


<details>
  <summary>Details</summary>
Motivation: The variability of accreting black holes across the electromagnetic spectrum provides a unique context for studying accretion in strong gravitational fields.

Method: The review synthesizes findings on continuum emission, timing properties, emission lines, and X-ray polarization, emphasizing the interactions between the accretion disk, corona, and jets.

Result: Observations reveal a complex relationship influencing spectral and timing behaviors, with critical insights from emission lines and polarization studies, particularly concerning disk structures and outflows.

Conclusion: Significant unanswered questions persist regarding state transitions and the influence of magnetic fields, highlighting the necessity for future interdisciplinary studies.
...
TL;DR: The IXPE has unveiled significant X-ray polarimetry measurements in supernova remnants, revealing magnetic field structures and polarization levels that challenge traditional models of cosmic-ray acceleration.


<details>
  <summary>Details</summary>
Motivation: To explore the physics of supernova remnants by utilizing X-ray polarimetry, enhancing our understanding of particle acceleration.

Method: Spatially resolved X-ray polarimetry measurements were conducted on six young supernova remnants, analyzing the resulting polarization levels and magnetic field geometries.

Result: Significant polarization was detected in all observed remnants, with degrees ranging from 5% to over 30%, and distinct magnetic field structures identified in different remnants.

Conclusion: The findings challenge existing models of magnetic-field dynamics in SNRs and suggest that shock velocity and medium density are crucial in shaping magnetic-field topology.
...
TL;DR: This paper presents a model incorporating near-field effects to calculate timing residuals in millisecond pulsar timing arrays (mini-PTAs) for detecting nanohertz gravitational waves in globular clusters and galactic nuclei.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of millisecond pulsars in globular clusters and galactic nuclei as a method for detecting nanohertz gravitational waves, considering the limitations of traditional methods due to the small scale of the array.

Method: The authors develop a comprehensive model that includes near-field effects like wavefront curvature and the non-radiative field of the gravitational wave source, applicable to scenarios in globular clusters and galactic nuclei.

Result: They find that timing residuals can reach $1~μ	ext{s}$ in globular clusters and up to milliseconds in galactic nuclei for pulsars within a few wavelengths of the gravitational wave source, with non-radiative fields causing residuals to rise steeply compared to conventional models.

Conclusion: The results indicate that mini-PTAs could effectively probe hidden gravitational wave sources, such as intermediate-mass and supermassive black hole binaries.
...
### [28] [SS433 PeV neutron jet feeding the far TeV gamma beam](https://arxiv.org/abs/2512.07012)
*Daniele Fargion,Pier Giorgio De Sanctis Lucentini,Sara Turriziani,Danila Sopin,Maxim Yu. Khlopov*

Main category: astro-ph.HE

TL;DR: SS433, a binary system with a black hole, is proposed to have ejected PeV neutron jets that may explain disconnected gamma-ray emissions observed at tens of TeV.


<details>
  <summary>Details</summary>
Motivation: Understanding the origin of high-energy gamma-ray emissions and the dynamics of SS433's black hole system.

Method: The paper posits that PeV neutron jets created during intense tidal eruptions of SS433 could lead to gamma-ray emissions via in-flight decay and scattering processes.

Result: The theoretical model suggests that these neutron jets align well with recent observational data on distant gamma-ray emissions.

Conclusion: The findings indicate that the PeV neutron jets are a plausible source for observed gamma-ray emissions, outperforming alternative models.
...
### [29] [A FAST search for radio pulsations during the dormant state of the AMSPs IGR J00291+5934 and MAXI J1957+032](https://arxiv.org/abs/2606.20086)
...
TL;DR: This study investigates radio pulsations in quiescent accreting millisecond pulsars (AMSPs) IGR J00291+5934 and MAXI J1957+032, finding no detectable signals and establishing new upper limits on pulsed radio flux density.


<details>
  <summary>Details</summary>
Motivation: To understand the radio emission characteristics of AMSPs during quiescence, particularly the lack of detected pulsations despite previous findings in transitional millisecond pulsars (tMSPs).

Method: Two observational campaigns using the Five-hundred-meter Aperture Spherical Telescope (FAST) in L-band (1-1.5 GHz) focused on IGR J00291+5934 and MAXI J1957+032; upper limits on X-ray and optical flux were obtained with Swift and Las Cumbres Observatory to confirm their quiescent state.

Result: No significant candidate signals for radio pulsations were found at known spin frequencies, leading to upper limits on radio flux densities of 3.3 μJy and 5.6 μJy for the two AMSPs, respectively.

Conclusion: The results provide the most stringent limits on pulsed radio emission from persistent AMSPs, supporting the notion that AMSPs may not emit detectable radio pulsations in their quiescent states.
...
### [30] [On the impact of the carbon fusion rate over the properties of superbursts -- Numerical simulations of superbursts with MESA](https://arxiv.org/abs/2606.20088)
*Martin Nava-Callejas,Stéphane Goriely,Nicolas Chamel*

Main category: astro-ph.HE

TL;DR: This study investigates how variations in carbon fusion rates affect superbursts in neutron stars, revealing significant impacts on ignition properties and explosive outcomes.


<details>
  <summary>Details</summary>
Motivation: To understand the implications of updated carbon fusion rates on the characteristics of superbursts in neutron stars.

Method: Utilized the MESA code to simulate superbursts with different carbon fusion reaction rates.

Result: Increasing the carbon fusion rate leads to shorter recurrence times, reduced decay times, and altered ignition conditions, affecting temperature and $α$-nuclide synthesis.

Conclusion: Modifying carbon fusion rates significantly influences superburst dynamics and energy output, akin to variations in base heating in the stellar envelope.
...
### [31] [Kick bimodality of neutron stars and mode dependence of their parameters](https://arxiv.org/abs/2606.20201)
*Anton D. Lazarev,Sergei B. Popov*

Main category: astro-ph.HE

TL;DR: The study identifies bimodal distributions of neutron star kick velocities and analyzes pulsar properties, revealing significant differences in magnetic field distributions between low- and high-velocity modes.


<details>
  <summary>Details</summary>
Motivation: To investigate the natal velocity kick of neutron stars and classify isolated radio pulsars according to their velocity modes.

Method: Analyze approximately 200 radio pulsars' spin and kinematic parameters to categorize them into low- and high-velocity modes and compare their properties.

Result: Findings indicate 30% of analyzed pulsars are in the low-velocity mode, with distinct differences in magnetic field distributions but similarities in parameters less affected by selection bias.

Conclusion: The study concludes that lower magnetic field pulsars are more common in the low-velocity mode; the reasons behind this discrepancy require further exploration.
...
### [32] [Evidence for candidate X-ray pulsations from the ultraluminous X-ray source NGC 7456 ULX-1](https://arxiv.org/abs/2606.20308)
*Yuanle Yao,Xiang-Dong Li,Xiao-Jie Xu*

Main category: astro-ph.HE

TL;DR: Discovery of a pulsational signal in NGC7456 ULX-1 suggests it contains an accreting neutron star, requiring further validation.


<details>
  <summary>Details</summary>
Motivation: To investigate the pulsational characteristics of the ultraluminous X-ray source NGC7456 ULX-1 and establish its nature as an accreting neutron star.

Method: Utilized timing techniques from the 2023 XMM-Newton observation including accelerated searches, $Z^2_n$ statistics, and orbital-demodulation analysis.

Result: Detected a candidate pulsational signal at $	ext{∼}0.22$~Hz and estimated a surface dipole magnetic field strength of $B	ext{∼}10^{12}-10^{14}$ G, indicating rapid spin evolution.

Conclusion: Evidence suggests that NGC7456 ULX-1 may host an accreting neutron star, but further observations are needed for confirmation.
...
### [33] [The next-to-leading order of the differential cross-section of the subprocess of Compton scattering of quark-gluon of prompt photon production in proton-proton collisions at NICA energies](https://arxiv.org/abs/2606.19389)
*Mohsun Rasim Alizada,Azar Inshalla Ahmadov*

Main category: hep-ph

TL;DR: The article examines next-to-leading-order calculations of Compton scattering in proton collisions at NICA energies, revealing significant contributions from both the higher-order effects and proton polarization.


<details>
  <summary>Details</summary>
Motivation: To enhance the accuracy of predictions for differential cross-sections in proton-proton collisions, particularly for prompt photon production through Compton scattering.

Method: Next-to-leading-order calculations of the differential cross-section for the subprocess $qg \rightarrow qγ$ were performed, considering both polarized and unpolarized protons.

Result: The next-to-leading-order calculation contributes about 15% to the leading-order result at high collision energies, with polarization effects being more pronounced in the next-to-leading-order scenario.

Conclusion: Proton polarization markedly affects next-to-leading-order differential cross-sections, emphasizing its importance in high-energy proton collisions.
...
### [34] [Emergent Gauge Symmetries in Particle Physics and Cosmology](https://arxiv.org/abs/2606.19403)
*Steven D. Bass*

Main category: hep-ph

TL;DR: The paper proposes that the Standard Model may be an emergent theory arising from deep ultraviolet physics, indicating potential new phenomena at high energy scales, particularly related to the stability of the Higgs vacuum and implications for dark energy and dark matter.


<details>
  <summary>Details</summary>
Motivation: To explore the origin of gauge symmetries in the Standard Model and investigate the potential of its emergence from high-energy physics phenomena.

Method: Analysis of the relationship between the Higgs vacuum stability, emergent gauge symmetries, and critical phenomena at high energy scales, along with examining implications for dark matter and dark energy.

Result: The emergence scenario suggests a correlation between dark energy and light Majorana neutrino masses, both around $10^{16}$ GeV, and identifies potential dark matter candidates such as axions.

Conclusion: The study emphasizes the importance of high-energy phenomena and offers paths for experimental tests involving neutrinos and gravitational waves to validate the emergent nature of the Standard Model.
...
### [35] [Massive right-handed neutrinos in $\bar{B} \to D^* τ\bar X$ decay](https://arxiv.org/abs/2606.16166)
*Nilakshi Das,Alakabha Datta,Tejhas Kapoor,Danny Marfatia,Lopamudra Mukherjee*

Main category: hep-ph

TL;DR: The paper investigates the impact of a heavy right-handed neutrino on specific B-meson decay distributions, providing new insights into potential physics beyond the Standard Model.


<details>
  <summary>Details</summary>
Motivation: To probe new physics beyond the Standard Model via signatures of a right-handed neutrino in B-meson decays.

Method: Utilizing effective field theory, the authors calculate full differential decay distributions in B-meson decays involving a right-handed neutrino and an invisible state.

Result: The study offers a comprehensive analysis of angular distributions and their sensitivity to new physics operators, highlighting distinct patterns in decay distributions.

Conclusion: The findings present a novel approach to identifying the influence of right-handed neutrinos in particle decays, potentially guiding future experimental searches for new physics.
...
### [36] [LeWRON: Agentic Analysis of Electroweak Phase Transitions](https://arxiv.org/abs/2606.19425)
*Isaac R. Wang*

Main category: hep-ph

TL;DR: LeWRON is a new framework for analyzing the electroweak phase transition, automating pipelines from Lagrangian input to gravitational-wave predictions.


<details>
  <summary>Details</summary>
Motivation: To streamline the complex processes involved in studying the electroweak phase transition, allowing for easier reproducibility and exploration of new models.

Method: LeWRON integrates an automated pipeline that includes toolbox construction, model-specific coding, auditing, and outputs reproducible artifacts for further analysis via a user-friendly interface.

Result: Demonstration of functionality across various beyond-the-Standard-Model scenarios, ensuring reproducibility and enabling exploration of new physics models.

Conclusion: LeWRON facilitates enhanced research on the electroweak phase transition and is publicly available for further development and use.
...
### [37] [Self-Calibration of the Neutrino-Argon Cross Section with Solar Neutrinos](https://arxiv.org/abs/2606.18347)
*Rasmi Hajjar,Obada Nairat,John F. Beacom*

Main category: hep-ph

TL;DR: The abstract discusses enhancing the precision of charged-current $
u_e$ interactions with $^{40}Ar$ in DUNE by leveraging solar-neutrino data to improve upon existing measurement uncertainties.


<details>
  <summary>Details</summary>
Motivation: Improving the precision of the CC $
u_e+	ext{^{40}Ar}$ cross section is crucial for DUNE's MeV physics program, given current indirect constraints are only at the 10% level and existing direct measurements have a 50% uncertainty.

Method: The authors propose utilizing solar-neutrino data, combined with the known $^8$B flux and survival probabilities, to measure the cross section with greater accuracy. They introduce new techniques for analyzing transition strengths through intuitive groupings and Principal Component Analysis.

Result: They demonstrate that under controlled detection uncertainties, it is feasible to achieve less than 2% precision in measuring the cross section between 9-15 MeV, despite inherent challenges.

Conclusion: The findings are expected to significantly aid in understanding the cross section at higher energies, which is essential for further neutrino studies related to supernovae and atmospheric events.
...
### [38] [Partial-wave unitarity and long-range interactions](https://arxiv.org/abs/2606.19432)
*Ryan Plestid,Pablo Quílez Lasanta*

Main category: hep-ph

TL;DR: The paper addresses the issues with ill-defined partial-wave amplitudes in theories with massless particles due to forward scattering singularities. It introduces a modified perturbation theory considering long-range interactions and off-shell Coulomb modes, leading to universal, renormalization scale-independent amplitudes.


<details>
  <summary>Details</summary>
Motivation: To resolve the ill-defined nature of fixed order expressions for the partial-wave amplitudes arising from singularities in massless particle theories, which hinder the establishment of unitarity bounds.

Method: A modified perturbation theory is developed that incorporates long-range interactions and focuses on off-shell Coulomb modes to construct partial-wave amplitudes.

Result: The amplitudes are shown to depend universally on a single scale and become independent of the renormalization scale, allowing exact order-by-order computation without reliance on infrared regulators.

Conclusion: The findings provide a systematic framework for calculating well-defined partial-wave amplitudes in theories with massless particles, improving upon existing theoretical approaches.
...
### [39] [Spin Identification of Dark Sector Mediators through Angular Distributions](https://arxiv.org/abs/2606.19543)
*D. Aristizabal Sierra,S. Fuenzalida Garrido,F. Kling,T. Mäkelä,N. Viaux*

Main category: hep-ph

TL;DR: This paper proposes a method to identify the quantum numbers of long-lived dark sector particles by analyzing angular distributions of decay products, enabling upcoming experiments to differentiate between vector and scalar mediators.


<details>
  <summary>Details</summary>
Motivation: The need to categorize quantum numbers of newly discovered particles in the dark sector for better understanding of particle physics.

Method: The paper identifies an angular observable based on the four-momenta of decay products to distinguish between isotropic and anisotropic distributions linked to scalar and vector particles, respectively.

Result: The proposed method shows that upcoming experiments like DUNE, SHiP, and FASER2 can effectively determine the spin of mediators in unexplored regions of parameter space.

Conclusion: The findings suggest that angular distributions of decay products can serve as a powerful tool for identifying particle properties in dark sector searches.
...
### [40] [From Rags to Jeans: Axion Miniclusters from Early matter domination](https://arxiv.org/abs/2606.19439)
*Ariel Angulo,Paola Arias,Nicolás Bernal,Javier Redondo*

Main category: hep-ph

TL;DR: The paper examines how early universe temperature fluctuations can affect axion mass and density perturbations, proposing a mechanism for the formation of axion miniclusters.


<details>
  <summary>Details</summary>
Motivation: To explore the influence of primordial density inhomogeneities on axion mass and density in a matter-dominated universe, particularly regarding dark matter.

Method: The authors analyze axion mass fluctuations induced by radiation bath inhomogeneities at reheating temperatures near the mass-saturation scale, simulating their effects on axion density perturbations.

Result: The mechanism can create significant axion overdensities leading to observable structures like miniclusters that could contribute to dark matter.

Conclusion: The findings suggest a novel avenue for understanding the formation of axion miniclusters and their implications for axion dark matter scenarios.
...
### [41] [Real and Virtual Propagation in Neutrino Oscillations](https://arxiv.org/abs/2606.19548)
*Kenji Nishiwaki,Kin-ya Oda,Juntaro Wada*

Main category: hep-ph

TL;DR: This paper revisits flavor oscillations by examining the propagation time of intermediate states, deriving new insights into the behavior of these states across various time scales.


<details>
  <summary>Details</summary>
Motivation: To refine the understanding of flavor oscillations in vacuum and address the accuracy of the Jacob--Sachs theorem in different propagation scenarios.

Method: The paper employs the saddle-point method to evaluate integrals, leading to an extended expression for flavor-changing amplitude applicable at both long and short propagation times.

Result: Oscillations are shown to occur only when propagation time exceeds a specific threshold determined by energy uncertainty and decay width; below this threshold, intermediate particles act as virtual states.

Conclusion: The findings suggest the Jacob--Sachs theorem applies with greater accuracy than previously assumed, and the formalism is relevant for various propagating particles, raising potential for future experimental observability.
...
### [42] [Charged Lepton Flavor Violation at Neutrino Telescopes](https://arxiv.org/abs/2606.19723)
*Writasree Maitra,Carlos A. Argüelles,P. S. Bhupal Dev,Ivan Martinez-Soler,Manibrata Sen*

Main category: hep-ph

TL;DR: This paper proposes a new search for charged lepton flavor violation (CLFV) using neutrino telescopes, specifically focusing on muon-to-tau conversion in IceCube's dataset.


<details>
  <summary>Details</summary>
Motivation: The detection of CLFV would indicate physics beyond the Standard Model, motivating the search for new processes and interactions.

Method: The study utilizes a cosmic-ray muon dataset from IceCube to explore muon-to-tau conversion via model-independent Effective Field Theory (EFT) operators, examining sensitivities related to an axial-vector $Z'$ interaction.

Result: The analysis presents IceCube's sensitivity to the relevant EFT scale and compares it with sensitivities from low-energy CLFV searches and collider experiments, also extending to next-generation neutrino telescopes.

Conclusion: Neutrino telescopes can serve as powerful complementary tools in probing CLFV, especially in future iterations like IceCube-Gen2 and HUNT.
...
### [43] [Freeze-in at all couplings](https://arxiv.org/abs/2606.19564)
*Andreas Goudelis,Andre Lessa,Lucas Magno Dantas Ramos,Thomas Reggio*

Main category: hep-ph

TL;DR: This paper analyzes a freeze-in dark matter model with a focus on low reheating temperatures, investigating dark matter production dynamics and its implications for experimental constraints.


<details>
  <summary>Details</summary>
Motivation: To investigate dark matter production under conditions of low reheating temperatures and its impact on particle physics parameters.

Method: The authors analyze the interplay between reheating temperature, mass scales of dark matter and its mediator, emphasizing the tracking of their number density evolution.

Result: The study reveals the possibility of stronger couplings while still achieving the observed dark matter abundance, alongside unexpected behaviors like mediator non-equilibration.

Conclusion: The paper updates constraints from LHC searches and lepton flavour-violating decays, underscoring the complementary nature of these searches in understanding dark matter parameters.
...
### [44] [Extraction of charmonium branching fractions from $J/ψ\toγη_c$ radiative decays](https://arxiv.org/abs/2606.19902)
*Magnus C. Schaaf,Antonio Vairo*

Main category: hep-ph

TL;DR: The paper addresses discrepancies between theoretical predictions and Particle Data Group (PDG) values for radiative charmonium decay, proposing a new method for analyzing the decay spectrum that eliminates ambiguities in empirical approaches.


<details>
  <summary>Details</summary>
Motivation: To resolve tensions between theoretical decay predictions and PDG measurements for the decay involving $J/ψ$ and $	ext{η}_c$ and to improve the accuracy of branching fraction extractions.

Method: Conduct a profile scan over recent PDG data to analyze the correlation between measured branching fractions and utilize a theoretically grounded photon line shape for the decay spectrum.

Result: Findings indicate that the correlation aligns with lattice QCD determinations, and the new method avoids previous ambiguities in deriving observables.

Conclusion: The proposed approach provides a more reliable framework for extracting branching fractions related to the M1 transition $J/ψ	oγη_c$, enhancing the consistency between theory and experimental data.
...
### [45] [Sensitivity of the photon-induced processes to the proton radius](https://arxiv.org/abs/2606.19604)
*Nikhil Krishna,Mariola Klusek-Gawenda,Rafal Staszewski*

Main category: hep-ph

TL;DR: The study investigates dilepton production in proton-proton collisions to measure the proton radius using various models and current data from ATLAS and CMS.


<details>
  <summary>Details</summary>
Motivation: To address the proton radius puzzle and gain insights into the proton structure through dilepton production analysis.

Method: A dipole form factor model is utilized, comparing conventional and PDG test scenarios of the proton radius, focusing on sensitivity at high dilepton invariant masses and rapidity.

Result: Fitting to ATLAS and CMS data yields a new value for the dipole parameter, $Λ^2 = 0.465 	ext{ GeV}^2$, indicating an effective radius of $r_p = 1.002 	ext{ fm}$.

Conclusion: While the findings show significant sensitivity to the proton radius, they do not provide a definitive resolution to the existing proton radius puzzle.
...
### [46] [New Avenues of Heavy Neutral Lepton at Muon Collider](https://arxiv.org/abs/2606.19906)
*Fa-Xin Yang,Feng-Lan Shao,Zhi-Long Han,Honglei Li*

Main category: hep-ph

TL;DR: This paper explores heavy neutral lepton production at a multi-TeV muon collider through new vector boson fusion processes, revealing alternative pathways that are less suppressed compared to traditional methods.


<details>
  <summary>Details</summary>
Motivation: To investigate heavy neutral lepton production in the context of a multi-TeV muon collider and explore new pathways in electroweak physics that leverage potential new interactions with a $U(1)$ gauged extension of seesaw models.

Method: The paper analyzes the production of heavy neutral lepton $N$ through processes $Z'Z'\to H\to NN$ and $Z'Z'\to NN$, focusing on their implications for lepton number violation signals involving heavy Higgs and muon interactions.

Result: The processes $Z'Z'\to H\to NN$ and $Z'Z'\to NN$ do not suffer from suppression due to small mixing angles, allowing for viable production of heavy neutral leptons even when the heavy Higgs mass exceeds center-of-mass energies.

Conclusion: The findings present new experimental avenues for studying heavy neutral leptons, enhancing our understanding of physics beyond the standard model through less inhibited production mechanisms.
...
### [47] [$U(1)_{B-L}$ Dark Matter Constrains Smooth (SUSY) Hybrid Inflation](https://arxiv.org/abs/2606.19612)
*Karim M. Selim,A. Y. Ellithi,M. Abolmahassen,Shaaban Khalil*

Main category: hep-ph

TL;DR: The paper presents a framework connecting inflation and dark matter in a supersymmetric $U(1)_{B-L}$ model, incorporating three scalar fields and showing constraints on parameters affecting dark matter abundance and inflationary observables.


<details>
  <summary>Details</summary>
Motivation: The study aims to unify inflationary dynamics with dark matter production in a theoretical framework, exploring their interdependence.

Method: The model employs smooth hybrid inflation in supergravity, using a non-minimal Kahler potential and three scalar fields: inflaton $σ$, auxiliary field $ζ$, and a singlet mediator $η$. Dark matter is treated as an inert scalar linked to inflation via a $	ext{Z}_2$ symmetry with non-thermal production during reheating.

Result: The analysis reveals that to match the observed dark matter relic abundance, significant constraints arise for the inflationary sector, narrowing the allowed parameter space and fixing the scalar spectral index at $n_s 	ext{simeq} 0.972 - 0.974$, aligning with observations.

Conclusion: The study establishes a relationship between dark matter characteristics and inflationary phenomena, indicating observable implications for parameters such as the tensor-to-scalar ratio and gravitational wave spectrum.
...
### [48] [$Ξ_{cc}^{++}-Ξ_{cc}^{+}$ Transitions as a Two-Charm-Selective Portal to Ultra-Low-$Q$ Charged Currents](https://arxiv.org/abs/2606.19991)
*Yong Du*

Main category: hep-ph

TL;DR: The LHCb's discovery of $Ξ_{cc}^{+}$ aids the study of the charged-current transition $Ξ_{cc}^{++}	o Ξ_{cc}^{+}$ to test new physics at low scales, revealing constraints on scalar couplings and identifying a new interaction portal in doubly charmed baryons.


<details>
  <summary>Details</summary>
Motivation: To explore the implications of the LHCb's observation of $Ξ_{cc}^{+}$ for new physics, particularly through the transition $Ξ_{cc}^{++}	o Ξ_{cc}^{+}$ as a test of charged-current interactions.

Method: The paper employs two- and three-body analyses to assess sensitivity to effective baryon-level couplings and investigates the influence of a light charged scalar and a specific two-charm-selective charged-current interaction.

Result: The analysis establishes that existing constraints from electroweak-precision measurements and beta decay are significantly stronger than the expected sensitivity from the $Ξ_{cc}^{++} 	o Ξ_{cc}^{+}$ transition, particularly concerning a universal light charged scalar.

Conclusion: The study identifies a unique interaction portal relevant to double charm baryons that could enable direct probing of new physics through the $Ξ_{cc}^{++}	o Ξ_{cc}^{+}$ transitions.
...
### [49] [Non-standard decays of vector-like top partners in a $2$-Higgs doublet model at the HL-LHC](https://arxiv.org/abs/2606.20054)
*Tanumoy Mandal,Stefano Moretti,Rachit Sharma*

Main category: hep-ph

TL;DR: The paper explores non-standard decay modes of vector-like quarks in extended scalar sectors, focusing on a unique collider signature involving a charged Higgs and tau leptons at the HL-LHC.


<details>
  <summary>Details</summary>
Motivation: The need to probe unexplored decay modes of vector-like quarks in theories extending the Standard Model, particularly involving additional Higgs states.

Method: A model-independent analysis using global kinematic observables is performed, with emphasis on polarization-sensitive observables from hadronic tau decay products to enhance sensitivity against background noise.

Result: The analysis indicates that the decay channel with two taus, two b-jets, and missing transverse energy can achieve discovery-level sensitivity for vector-like quark masses up to about 1.9 TeV at the HL-LHC with an integrated luminosity of 3 ab−1.

Conclusion: The 2τ + 2b + missing ET decay channel is a promising method to investigate non-standard vector-like quark decays in extended Higgs sectors.
...
### [50] [Constraining ADD black holes at the LHC with $\sqrt{s} = 14$ TeV](https://arxiv.org/abs/2606.19839)
*Ashfaque Ahmad,Sudhir Kumar Gupta,Abbas Ali*

Main category: hep-ph

TL;DR: The study sets constraints on black hole masses at the LHC under the ADD model, factoring in loss during formation, revealing that higher loss leads to lower mass limits.


<details>
  <summary>Details</summary>
Motivation: Investigate the formation of microscopic black holes at the LHC and their mass limits under the ADD model with varying parameters.

Method: Analyzed black hole mass constraints using integrated luminosity at 14 TeV center-of-mass energy, considering loss effects through the parameter ζ.

Result: For ζ=0, black holes with mass ≤ 11.83 TeV are disfavored; this limit decreases with increasing ζ, impacting masses significantly at different reduced Planck scales.

Conclusion: Higher values of ζ lead to lower mass constraints, particularly evident for different sets of reduced Planck scales, suggesting the importance of loss during black hole formation.
...
### [51] [Toward Precision Fragmentation of $Ω_{3Q}$ Baryons: The OMG3Q1.1 Framework](https://arxiv.org/abs/2606.20063)
*Francesco Giovanni Celiberto*

Main category: hep-ph

TL;DR: The OMG3Q1.1 framework aims to accurately model the fragmentation of heavy baryons in high-energy collisions, addressing uncertainties in the production of triply heavy baryons.


<details>
  <summary>Details</summary>
Motivation: Recent experimental findings in baryon physics necessitate detailed and controlled approaches to understand the production mechanisms of heavy hadronic systems.

Method: The framework combines diquark-inspired models with DGLAP evolution in a novel scheme, using a replica-based method to quantify perturbative and nonperturbative uncertainties in fragmentation functions.

Result: The framework produces the first systematic set of fragmentation functions for the $Ω_{3Q}$ sector, which are implemented in LHAPDF6 grids for practical applications.

Conclusion: The OMG3Q1.1 framework sets a precision benchmark for studying rare triply heavy baryons and facilitates future research in heavy-flavor baryon production.
...
### [52] [Theory Calculations for LDMX and LOHENGRIN beyond Coherent Bethe-Heitler Scattering](https://arxiv.org/abs/2606.20327)
*Martin Schürmann,Herbert K. Dreiner,Rhorry Gauld*

Main category: hep-ph

TL;DR: The paper discusses new experiments (LDMX, DarkSHINE, LOHENGRIN) designed to detect dark photons via bremsstrahlung processes, analyzing differential cross sections and signal contributions from various emissions.


<details>
  <summary>Details</summary>
Motivation: To advance the search for dark photons in the MeV-GeV mass range and understand the implications for missing momentum signals in relevant experimental setups.

Method: Calculations of differential cross sections for real emission processes up to third order in the electromagnetic fine structure constant, including virtual dark photon contributions.

Result: Numerical results of cross sections and differential distributions indicate that LOHENGRIN requires modifications to its HCAL to mitigate diffractive scattering backgrounds, and that additional contributions beyond current models have limited impact on predictions for signals and backgrounds.

Conclusion: The findings shape our understanding of dark photon detection, emphasizing the need for experimental adjustments and validating existing theoretical frameworks.
...
### [53] [The $B^+ \to K^+ ν\bar ν$ decay as a QCD axion search: comparing reinterpretation approaches](https://arxiv.org/abs/2606.20525)
*Merna Abumusabh,Giulio Dujany,Diego Guadagnoli,Méril Reboud,Claudio Toni*

Main category: hep-ph

TL;DR: The differing limits on the decay mode $B^+ \to K^+ a$ arise from the selection of kinematic variables; using a fine binning approach enables better resolution of the axion signal compared to coarse binning, which dilutes it. A BDT axis does not significantly enhance the discriminative power for $B^+ \to K^+ a$. The study promotes the importance of using physical variable spaces in addition to BDT-based likelihoods for improving interpretability in experimental results.


<details>
  <summary>Details</summary>
Motivation: To resolve the limits on the decay of $B^+ \to K^+ a$ into light particles such as the QCD axion, and understand why different analyses yield differing results.

Method: Examined the role of kinematic variable choices in analyzing Belle II data, particularly focusing on the di-neutrino invariant mass and using numerical tests to assess the impact of binning strategies and BDT axes.

Result: The factor-of-four difference in sensitivity is attributed to the choice of kinematic axes, specifically the binning of the invariant mass variable $q^2_{\rm rec}$ and the effectiveness of BDT in discriminating between signal and background.

Conclusion: Collaborations should publish likelihood projections in both physical variable spaces and BDT-based likelihoods to enhance the reinterpretability of their findings.
...
### [54] [New Gauge Forces, Neutron Stars and Schwinger Neutrino Production](https://arxiv.org/abs/2606.20393)
*Yuxin Liu,Zhen Liu,Andrey Shkerin,Jing Shu,Yue Zhao*

Main category: hep-ph

TL;DR: The study explores the neutrino effects of new long-range forces from specific gauged symmetries in the Standard Model, determining that the $B-L$ and $L_e-L_{μ/τ}$ forces have weak observable effects, while the $L_μ-L_τ$ force is significant in neutron stars at certain gauge coupling strengths, with detectable neutrino flux implications.


<details>
  <summary>Details</summary>
Motivation: To investigate new long-range forces stemming from gauged symmetries in the Standard Model and their effect on neutrinos in astrophysical settings.

Method: The study examines the leptonic potential generated by large astronomical bodies, considers Schwinger pair production of neutrinos, and analyzes the behavior of charged particles under new gauge symmetries.

Result: For the $B-L$ and $L_e-L_{μ/τ}$ forces, effects are too weak to observe. The $L_μ-L_τ$ force has significant effects in neutron stars if the gauge coupling exceeds $10^{-18}$, influencing element abundances and $L_μ-L_τ$ charge.

Conclusion: If gauge coupling is $	extgreater 10^{-17}$, significant neutrino flux from neutron stars may be detectable, reasserting bounds on gauge coupling from neutron star mergers.
...
### [55] [NLO QCD and EW corrections to semileptonic vector-boson scattering at the LHC](https://arxiv.org/abs/2606.19999)
*Ansgar Denner,Robert Franken,Daniele Lombardi,Santiago Lopez Portillo Chavez*

Main category: hep-ph

TL;DR: This paper provides NLO QCD and electroweak corrections to semileptonic vector-boson scattering processes, crucial for LHC measurements.


<details>
  <summary>Details</summary>
Motivation: Enhancing theoretical predictions to match the increasing precision of LHC measurements of vector-boson scattering.

Method: Calculation of NLO QCD and electroweak corrections for the process pp → ℓ⁺νₗ + 4j, under fully off-shell conditions.

Result: Derived the leading electroweak contributions of O(α⁶) and corrections of O(α⁷) and O(αₛα⁶) for relevant fiducial cross sections and differential distributions.

Conclusion: Results aim to improve theoretical understanding and prediction accuracy for future particle physics experiments at the LHC.
...
### [56] [Two Flavon Froggatt-Nielsen Models with Genetic Algorithms](https://arxiv.org/abs/2606.20000)
*Miguel Crispim Romão,Stephen F. King*

Main category: hep-ph

TL;DR: This paper explores two-flavon Froggatt-Nielsen models using AI techniques to identify viable models with CP violation, demonstrating superior efficiency over previous methods.


<details>
  <summary>Details</summary>
Motivation: To expand the single-flavon Froggatt-Nielsen framework to include two-flavons and investigate their implications for CP violation and fermion mass predictions.

Method: The study utilizes a multi-objective optimisation approach with the Non-dominated Sorting Genetic Algorithm III, integrating various experimental constraints into the model search.

Result: Over 100,000 unique viable models were identified, suggesting the validity of the two-flavon FN realization space remains largely unexplored, with distinct predictions for neutrino decay masses.

Conclusion: The findings highlight minimal FN realizations with small maximal flavon exponents and the ability to reproduce charged fermion masses accurately without extensive parameter tuning.
...
### [57] [The Simplest Dirac Scoto-Seesaw Realization](https://arxiv.org/abs/2606.20119)
*Sin Kyu Kang,Ranjeet Kumar,Hemant Kumar Prajapati*

Main category: hep-ph

TL;DR: This paper proposes a Dirac scoto-seesaw framework using an anomaly-free $U(1)_{B-L}$ charge assignment, explaining neutrino masses and supporting dark matter candidates.


<details>
  <summary>Details</summary>
Motivation: The goal is to account for the observed neutrino mass differences while providing a viable dark matter framework under a specific symmetry.

Method: A Dirac scoto-seesaw model is developed with a $U(1)_{B-L}$ charge assignment, incorporating residual symmetry to stabilize dark matter and exploring two realizations affecting neutrino ordering.

Result: Both normal and inverted neutrino orderings are viable in one case; the chiral nature of the charges influences the branching fraction of $Z'$ and eases dark sector constraints.

Conclusion: The framework enhances the understanding of neutrino masses and dark matter phenomenology, indicating future experimental opportunities.
...
### [58] [Addressing uncertainties of model predictions for extensive air showers initiated by high energy cosmic rays](https://arxiv.org/abs/2606.20221)
*Sergey Ostapchenko,Tanguy Pierog,Günter Sigl*

Main category: hep-ph

TL;DR: The paper presents the QGSb Monte Carlo generator for analyzing uncertainties in extensive air shower (EAS) models due to cosmic ray interactions, focusing on air shower maximum depth and muon number.


<details>
  <summary>Details</summary>
Motivation: To address model uncertainties in EAS predictions for high-energy cosmic ray interactions and improve interpretations of experimental results.

Method: Utilizing the QGSb Monte Carlo generator to modify model parameters and analyze their effects on EAS characteristics compared to accelerator data.

Result: The study reveals the influence of model modifications on key EAS features like maximum depth and muon number, enhancing understanding of cosmic ray composition.

Conclusion: This research provides insights into the physics behind EAS characteristics and suggests potential improvements for cosmic ray studies.
...
### [59] [Three-particle di-light-cone distribution amplitudes of the $B$-meson in heavy-quark effective theory](https://arxiv.org/abs/2606.20267)
*Riccardo Bartocci,Philipp Böer,Thorsten Feldmann,Max Ferré,Nico Gubernari,Daniel Vladimirov*

Main category: hep-ph

TL;DR: This study focuses on the three-particle di-light-cone distribution amplitudes (DLCDAs) of $B$-mesons, extending traditional light-cone analyses to include non-factorisable soft-gluon interactions.


<details>
  <summary>Details</summary>
Motivation: To better understand the non-perturbative dynamics in rare and non-leptonic exclusive $B$-meson decays, particularly the role of soft-gluon contributions that traditional models may overlook.

Method: The authors define DLCDAs through $B$-meson-to-vacuum matrix elements of trilocal HQET operators, derive their Lorentz decomposition, identify eight independent DLCDAs based on twist, and apply operator identities for normalization and moments.

Result: They obtain tree-level relations for normalization integrals and moments, enabling the construction of momentum-space models for independent DLCDAs, and account for perturbative effects on leading-twist distribution amplitudes.

Conclusion: This work provides a comprehensive framework for analyzing the non-factorisable contributions in $B$-meson decays, offering new insights into their dynamics and aiding future research.
...
### [60] [Dyonic lattices, $θ$-angles and axions in the Standard Model](https://arxiv.org/abs/2606.20319)
*Rodrigo Alonso,Francesca Chadha-Day,Despoina Dimakou,Yunji Ha,Valentin V. Khoze*

Main category: hep-ph

TL;DR: The paper explores the Witten effect's implications in the Standard Model, classifies dyonic charge lattices, derives properties of θ parameters, and discusses axion physics.


<details>
  <summary>Details</summary>
Motivation: To understand how the Witten effect influences dyon spectra and the implications for CP violation in the Standard Model.

Method: Analyzing the θ-parameters in the context of a general global gauge group, constructing dyonic charge lattices, and studying their implications in θ-space for axion physics.

Result: Identified specific θ-values corresponding to distinct dyon families, analyzed the reduction of θ-parameter space, and highlighted the role of electric charge in monopoles.

Conclusion: Discovery of a charged monopole would determine a key Standard Model parameter; a single axion fails to achieve full CP invariance.
...
### [61] [Renormalization of axial anomaly in SU(N)$\times$U(1)](https://arxiv.org/abs/2606.20342)
*Tanmoy Pati,Narayan Rana*

Main category: hep-ph

TL;DR: This paper addresses the challenge of defining $γ_5$ in dimensional regularization by extending Larin's prescription with new techniques to derive three-loop renormalization constants for a mixed gauge group.


<details>
  <summary>Details</summary>
Motivation: To meet the precision requirements of Standard Model phenomenology by extending known renormalization constants to mixed gauge sectors.

Method: A novel technique using form factors and the universality of infrared divergences to compute renormalization constants up to three loops.

Result: New three-loop results for renormalization constants and pure-singlet contributions to the quark axial-vector form factor are presented.

Conclusion: The proposed method successfully extends existing knowledge in dimensional regularization for mixed gauge groups, enhancing precision in quantum field theory calculations.
...
### [62] [Revisiting the role of saturation in diffractive vector meson production](https://arxiv.org/abs/2606.20362)
*Heikki Mäntysaari,Hendrik Roch,Björn Schenke,Chun Shen,Wenbin Zhao*

Main category: hep-ph

TL;DR: This study employs a Bayesian analysis of diffractive $J/ψ$ photoproduction using a CGC framework, addressing tensions between proton and nuclear data.


<details>
  <summary>Details</summary>
Motivation: To resolve inconsistencies in diffractive $	ext{J}/ψ$ production data from proton and nuclear collisions and improve understanding within the CGC framework.

Method: Utilizing Gaussian-process emulators for CGC calculations, the analysis combines data from HERA and LHC, applying corrections for electromagnetic dissociation.

Result: The $γ+	ext{Pb}$ data, adjusted for EMD, significantly mitigates discrepancies between proton and nuclear datasets.

Conclusion: A consistent description of diffractive $	ext{J}/ψ$ production is achieved for both $γ+p$ and $γ+	ext{Pb}$ collisions.
...
### [63] [Phase Transitions and Gravitational Wave Production at the End of Thermal Inflation](https://arxiv.org/abs/2606.20392)
*Hyukjung Kim,İlayda Kuzu,Kerem Özsoy,Zeynep Kahraman,Wan-Il Park,Heeseung Zoe*

Main category: hep-ph

TL;DR: The paper examines a first-order phase transition that ends thermal inflation and its resultant gravitational-wave signals using semi-analytical and numerical approaches, concluding that the predicted signals are detectable by future observatories.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics of first-order phase transitions in thermal inflation and assess their implications for gravitational wave signals.

Method: The study utilizes semi-analytical calculations of bounce action, numerical simulations via CosmoTransitions, and three-dimensional Langevin lattice simulations that account for Hubble expansion and temperature variations during the phase transition.

Result: The transition is characterized by localized bubble nucleation and growth, aligning with bounce-action estimates and generating gravitational-wave spectra corresponding to bubble collisions and acoustic motions.

Conclusion: The stochastic gravitational-wave background predicted from this transition is expected to be within the sensitivity range of upcoming gravitational-wave observatories like BBO and DECIGO.
...
### [64] [The X17 Anomaly: Experimental Evidence and Theoretical Interpretations](https://arxiv.org/abs/2606.20423)
*Raoul Serao,Aniello Quaranta,Antonio Capolupo*

Main category: hep-ph

TL;DR: This review covers the X17 particle, its theoretical frameworks, implications for the Standard Model, and future experimental prospects.


<details>
  <summary>Details</summary>
Motivation: To analyze the existence and implications of the X17 particle within the context of particle physics.

Method: The review synthesizes experimental evidence and theoretical structures supporting the X17 particle.

Result: It provides insights into how the X17 could affect current particle physics frameworks and interactions.

Conclusion: Future experiments could validate the existence of the X17 particle, impacting our understanding of the Standard Model.
...
### [65] [String Axiverse Enhancement of Superradiant Dark Matter Production](https://arxiv.org/abs/2606.20524)
*Diogo S. Gorgulho,Jacob A. Litterer,João G. Rosa*

Main category: hep-ph

TL;DR: This paper investigates how string axion emissions influence dark matter production from light primordial black holes (PBHs), particularly focusing on enhanced superradiance and micro-boson star formation.


<details>
  <summary>Details</summary>
Motivation: Understanding the relationship between string axion emissions and dark matter generated by PBHs could provide insights into dark matter's properties and origins.

Method: The study analyzes both the evaporation and superradiance processes of PBHs influenced by the emission of light axions predicted by string theory.

Result: The findings reveal that string axion emissions can significantly enhance PBH efficiency in producing micro-boson stars at certain mass ranges, while excessively many axions can lead to rapid PBH evaporation.

Conclusion: The paper concludes that assuming all dark matter comes from PBHs, the emitted axions from their evaporation contribute insignificantly to relativistic degrees of freedom during recombination.
...
### [66] [Rotating magnetized pion gas of finite transverse size: condensation constraints and transport properties](https://arxiv.org/abs/2606.20530)
*Ankit Kumar,Diwakar Gaur,Vinod Chandra*

Main category: hep-ph

TL;DR: This study explores the electric, thermal, and thermoelectric properties of rotating pion gas under a magnetic field, demonstrating how rotation counteracts the suppressive effects of magnetic fields on transport coefficients.


<details>
  <summary>Details</summary>
Motivation: To understand how rotation and magnetic fields influence transport properties in a pion gas, particularly focusing on the behavior of charged pions during condensation.

Method: The Boltzmann Transport Equation with the Relaxation Time Approximation is employed to calculate transport coefficients like electrical and thermal conductivity, and the Seebeck coefficient.

Result: The analysis reveals that rotation enhances transport coefficients, countering the suppression from the magnetic field; at high angular velocities, this enhancement dominates, leading to improved transport properties even with increasing magnetic strength.

Conclusion: The interaction of rotation and magnetic fields significantly alters the transport characteristics of pion gases, as indicated by the Lorenz number analysis, suggesting essential implications for understanding such systems in a broader context.
...
### [67] [Solving Nonequilibrium Dynamics via Influence Matrix Bootstrap: Floquet-PXP Model](https://arxiv.org/abs/2606.19430)
*Xiao-Yang Yang,He-Ran Wang,Zhong Wang*

Main category: quant-ph

TL;DR: This study addresses the challenges of characterizing nonequilibrium dynamics in integrable systems, specifically using the Rule 201 quantum cellular automaton. It introduces generalized zipper conditions, a numerical bootstrap method, and investigates nonequilibrium behavior under local perturbations, revealing insights into entanglement growth and multitime correlations.


<details>
  <summary>Details</summary>
Motivation: The study aims to enhance understanding of nonequilibrium dynamics in quantum many-body systems, an area where challenges persist despite advancements in equilibrium properties.

Method: Utilizing the tensor-network approach and influence matrices, the study develops generalized zipper conditions for exact local dynamics solutions and a numerical bootstrap method for solving matrices with finite bond dimensions.

Result: The research uncovers diverse nonequilibrium behaviors that depend on initial states, demonstrates analytical results on non-thermal relaxation, provides numerically exact results for entanglement growth, and presents a refined structure of multitime correlations called hidden Markov order.

Conclusion: The proposed methods facilitate the study of both thermalizing and nonthermalizing dynamics in a single model and offer experimental validation avenues in advanced quantum simulators, enhancing the understanding of quantum many-body physics.
...
### [68] [Indefinite Quantum Causality](https://arxiv.org/abs/2606.19438)
*Fabio Costa,Giulia Rubino,Cyril Branciard,Časlav Brukner,Marco Túlio Quintino*

Main category: quant-ph

TL;DR: The paper reviews operational approaches to quantum foundations addressing indefinite causal orders in quantum processes, highlighting their implications for quantum information.


<details>
  <summary>Details</summary>
Motivation: The exploration of quantum indefiniteness in causal order is motivated by fundamental and applied interests, including quantum theory's relationship with causality and general relativity, and its potential in higher-order quantum computing.

Method: The methodology focuses on the 'process matrix formalism,' which helps in understanding indefinite quantum causality.

Result: Key results include advancements in experimental implementations and new insights into the uses of indefinite causal order as a resource in quantum information processing.

Conclusion: The review provides a comprehensive overview of current advancements in indefinite quantum causality, emphasizing its significance in the field.
...
### [69] [Efficient classical representation and quantum state preparation of complete active space wavefunctions](https://arxiv.org/abs/2606.19457)
*Hamza Jnane*

Main category: quant-ph

TL;DR: This paper introduces an efficient method for preparing multi-reference CAS states for quantum computers, significantly improving the scalability of state preparation protocols.


<details>
  <summary>Details</summary>
Motivation: Quantum computers aim to tackle the electronic structure problem of complex molecules, but traditional state preparation for these systems is exponentially complex with respect to active space size.

Method: The paper utilizes the Quantum Paldus Transform (QPT) to derive a classical representation of CAS states, enabling their efficient representation as matrix product states (MPS) with polynomial scaling in complexity.

Result: The developed method achieves a bond dimension scaling of O(d²) and improves state preparation complexity to O(d³), a significant enhancement compared to existing techniques.

Conclusion: This research offers a promising and efficient pathway for preparing CAS states on quantum computers, facilitating advancements in simulations of complex molecular systems.
...
### [70] [Quantum deformations of $\mathcal{U}(\mathfrak{sl}(2, \mathbb{R}))$. Part I: Fidelity and experimental benchmarking](https://arxiv.org/abs/2606.19462)
*V. Mariscal,J. J. Relancio,L. Santamaría-Sanz*

Main category: quant-ph

TL;DR: This study investigates how standard and non-standard deformations of the Hopf algebra affect multi-qubit systems, revealing distinct behaviors in quantum correlations and fidelity.


<details>
  <summary>Details</summary>
Motivation: To understand the impact of $q$- and $h$-deformations on quantum states and their practical implications in quantum information experiments.

Method: States of a Hilbert space of $N$ qubits are constructed using Clebsch-Gordan coefficients from the deformed algebras; fidelities with undeformed states are computed for various systems.

Result: The $q$-deformation leads to smooth modifications and residual overlaps with undeformed states, while the $h$-deformation results in rapid orthogonality to undeformed states; both require $N^{-1}$ scaling for fidelity stability.

Conclusion: The distinct behaviors of quantum correlations under $q$- and $h$-deformations highlight their different impacts on multi-qubit systems, bridging algebraic theory and experimental relevance.
...
### [71] [Local controllability of heralded quantum linear optics](https://arxiv.org/abs/2606.19470)
*Tommaso Francalanci,Nicolò Spagnolo,Mario Sigalotti,Eliott Z. Mamon,Ulysse Chabaud,Fabio Sciarrino*

Main category: quant-ph

TL;DR: This paper explores how local controllability of photonic states in linear optical networks can be enhanced through heralding and ancillary resources, focusing on the Jacobian rank as a measure of accessible states.


<details>
  <summary>Details</summary>
Motivation: The study addresses the limitations imposed by bosonic symmetries in generating quantum states using passive linear optics and seeks to enhance the reachability of quantum states through heralding techniques.

Method: The authors analyze the rank of the Jacobian of the output state concerning the unitary circuit, investigating both passive and heralded linear optical setups to quantify the enlargement of the state space.

Result: Results demonstrate that specific ancillary resources significantly enhance the locally accessible state space and identify conditions for achieving maximal local Jacobian rank, which is necessary for global reachability.

Conclusion: The framework developed serves as a systematic tool for assessing the effectiveness of various resources in measurement-based photonic architectures, offering criteria for achieving high-dimensional quantum state engineering.
...
### [72] [Nearest-neighbour gates are all you need: High-rate quantum low-density parity-check codes on a planar grid](https://arxiv.org/abs/2606.19482)
*Boren Gu,Tamas Noszko,Vincent Steffan,Jens Niklas Eberhardt,Joschka Roffe,Jens Eisert,Stergios Koutsioumpas*

Main category: quant-ph

TL;DR: This paper presents a new family of quantum low-density parity-check codes that utilize planar layouts and nearest-neighbour gates, significantly enhancing efficiency for superconducting architectures.


<details>
  <summary>Details</summary>
Motivation: The aim is to reduce overhead for fault-tolerant quantum computation, addressing the challenges of long-range connectivity in superconducting systems.

Method: The proposed codes dynamically generate check-data connectivity via nearest-neighbour iSWAP walks, allowing efficient stabiliser measurement without long-range connections.

Result: The circuits achieve constant-depth stabiliser measurement and significant code efficiency improvements, demonstrated by finite-size instances showing higher efficiency than surface codes.

Conclusion: The findings indicate that these low-density parity-check codes can effectively operate within planar nearest-neighbour constraints, advancing fault-tolerant quantum memory technology.
...
### [73] [Optimal Ansatz-free Hamiltonian Learning In Situ](https://arxiv.org/abs/2606.19486)
*Taiqi Zhou,Weiyuan Gong*

Main category: quant-ph

TL;DR: This paper presents a novel algorithm for learning Hamiltonians in quantum systems, achieving optimal evolution time and avoiding deep circuits and controls.


<details>
  <summary>Details</summary>
Motivation: Efficiently characterizing Hamiltonians is crucial for quantum device calibration and error correction, but existing methods are difficult to implement in real-world quantum experiments.

Method: The proposed algorithm is control-free and ancilla-free, utilizing Pauli product state preparation and measurement to learn Hamiltonians in time $Θ(\frac{Λ}{ε^2}\log(\frac{Λ}{ε}))$.

Result: The algorithm achieves optimal evolution time, proven via a lower bound, and is effective in high-precision sensing and calibration, even under SPAM noise.

Conclusion: This work provides a practical approach to Hamiltonian learning that is aligned with the needs of near-term quantum technology, facilitating better experimental characterization.
...
### [74] [Entanglement Scaling and Problem Structure in Quantum Approximate and Adiabatic Optimization Algorithms](https://arxiv.org/abs/2606.19502)
*Georgios Arapantonis,Paraj Titum,Gregory Quiroz*

Main category: quant-ph

TL;DR: This paper investigates the relationship between entanglement and algorithm performance in the Quantum Approximate Optimization Algorithm (QAOA) applied to the MaxCut problem, revealing that entanglement scaling varies with optimization methods and can differentiate QAOA from adiabatic quantum computation.


<details>
  <summary>Details</summary>
Motivation: To explore how entanglement influences algorithmic performance in variational quantum algorithms, particularly QAOA, and its connection to computational problems like MaxCut.

Method: We analyze entanglement profiles in QAOA through empirical studies, employing a high-performance optimizer and comparing results with adiabatic quantum computation.

Result: Our findings demonstrate that suboptimal training alters entanglement observation, while optimal training shows QAOA's entanglement scaling resembles that of fermionic Gaussian states. In contrast, adiabatic quantum computation exhibits distinctly different entanglement profiles based on the annealing schedule.

Conclusion: The study elucidates the vital role of entanglement in differentiating the performance of variational algorithms like QAOA from adiabatic approaches, linking it to both algorithmic efficiency and problem structure.
...
### [75] [Optimized Quantum States for Sensing in the Presence of Loss and Phase Noise](https://arxiv.org/abs/2606.19649)
*Shruti Maliakal,Zachary Mann,Christopher Wipf,Rana X Adhikari,Su Direkci,Yanbei Chen*

Main category: quant-ph

TL;DR: Non-Gaussian states can outperform Gaussian states in quantum sensors under specific loss and noise conditions.


<details>
  <summary>Details</summary>
Motivation: To enhance the performance of quantum sensors like gravitational-wave detectors beyond the standard quantum limit, particularly in the presence of phase noise and photon loss.

Method: Numerical optimization of quantum Fisher information across loss and phase-noise parameters to identify superior non-Gaussian states.

Result: Non-Gaussian states exhibit up to a 2.2 dB advantage over Gaussian states when limited to 5 photons and under specific losses and phase noise conditions.

Conclusion: The advantage of non-Gaussian states persists even with homodyne detection strategies.
...
### [76] [Exact Markovian Dissipation Requires Singular Energy Resources](https://arxiv.org/abs/2606.19510)
*Hiroki Nakabayashi*

Main category: quant-ph

TL;DR: The GKLS equation cannot describe irreversible quantum dynamics under regular energy conditions, as it leads to inconsistencies in survival probability decay rates.


<details>
  <summary>Details</summary>
Motivation: To explore the limitations of the GKLS equation in describing open quantum systems under typical energy constraints.

Method: Analysis of survival probability and decay rates in relation to physically regular energy conditions.

Result: Proved that the survival probability exhibits sublinear decay, contradicting the linear decay expected from GKLS semigroups, under regular energy conditions.

Conclusion: The GKLS equation serves as an effective model but does not accurately represent reduced dynamics of Hamiltonian systems under normal energy conditions.
...
### [77] [Distinguishing quantum processes with bounded coherent memory](https://arxiv.org/abs/2606.19511)
*Magdalini Zonnios,Felix C. Binder*

Main category: quant-ph

TL;DR: This paper introduces machines for autonomous distinction (MADs) as a way to optimize the distinguishability of multi-time quantum processes using bounded coherent memory, providing a practically scalable framework for learning these processes.


<details>
  <summary>Details</summary>
Motivation: The need for effective methods to distinguish complex quantum processes is essential for applications in diagnosis and benchmarking of quantum dynamics.

Method: The authors define MADs as probing strategies that utilize the same quantum instrument at each time step and include a coherent memory of dimension d_A, leading to a memory-parametrized measure of distinguishability.

Result: The proposed MAD strategies are shown to be monotone in coherent memory and complete at finite times, effectively achieving the strategy-norm benchmark with tractable evaluations.

Conclusion: MAD distinguishability offers an operational framework to quantify learning from multi-time quantum interactions while maintaining reasonable memory constraints.
...
### [78] [Complexity of detecting large coefficients in the Pauli basis](https://arxiv.org/abs/2606.19545)
*Santiago Cifuentes*

Main category: quant-ph

TL;DR: The paper investigates the decision problem involving quantum states and non-identity Pauli matrices, proving implications for complexity classes QCMA and BQP.


<details>
  <summary>Details</summary>
Motivation: To determine whether efficient tomographic procedures exist for identifying the largest coefficients of quantum states in the Pauli basis under standard complexity assumptions.

Method: The study describes a mechanism to assess if a non-identity Pauli matrix exists such that its trace with a quantum state meets a specified threshold, utilizing a reduction from the minimum-weight code problem.

Result: The problem is categorized in QCMA, and the finding shows that if it is in BQP, then it would imply NP is contained in BQP, suggesting limitations on efficient tomographic strategies under certain complexity assumptions.

Conclusion: The research concludes that efficient tomographic procedures do not exist for determining the largest coefficients in the Pauli basis under the hypothesis that NP is not a subset of BQP.
...
### [79] [Passive-User Bell-State Loop-Back Key Establishment without Quantum Detectors at the User Nodes](https://arxiv.org/abs/2606.19551)
*Luis Adrián Lizama-Pérez*

Main category: quant-ph

TL;DR: A Bell-state extension of Loop-Back quantum key distribution allows secret-key exchange between passive users using entangled qubits without requiring quantum transmitters or detectors.


<details>
  <summary>Details</summary>
Motivation: To create a secure key distribution method that leverages passive users in a quantum environment while minimizing the need for complex equipment.

Method: The framework involves one active station (Alice) sending a Bell pair to two passive users who apply local Pauli operations, then Alice measures the outcome to identify the effective operation without directly knowing each user's actions.

Result: The effective composition of operations remains hidden from Alice, enhancing security while allowing users to derive information about each other's actions through their individual choices.

Conclusion: This approach successfully integrates distributed transformations and passive-user mechanics in quantum key distribution, ensuring better efficiency and robustness against potential attacks.
...
### [80] [Electrical Noise Produced by Micron-Sized Particles above a Surface Paul Trap](https://arxiv.org/abs/2606.19585)
*Ben Saarel,Ozgur Sahin,Hartmut Häffner,Alpha T. N'Diaye*

Main category: quant-ph

TL;DR: Electric field noise from ion trap electrodes impacts quantum computing fidelity. Noise levels vary significantly, influenced by nearby micron-sized particles modeled as lossy dielectrics.


<details>
  <summary>Details</summary>
Motivation: Understanding the microscopic origins of electric field noise in ion traps is crucial for improving the fidelity of quantum computing operations.

Method: Measured electric field noise along the symmetry axis of a linear surface Paul trap and used optical and scanning electron microscopy to analyze nearby particles.

Result: Noise levels were found to vary by three orders of magnitude within a small section of the trap, correlating with the presence of micron-sized particles.

Conclusion: Modeling the particles as lossy dielectrics explains the noise magnitude and its dependencies, offering insights into variability in noise levels reported in existing literature.
...
### [81] [Emergency hub placement with a neutral-atom quantum computer](https://arxiv.org/abs/2606.19589)
*Sara Tarquini,Matteo Vandelli,Francesco Ferrari,Daniele Dragoni,Francesco Tudisco*

Main category: quant-ph

TL;DR: The study focuses on optimizing emergency operation center placement during disasters using a hybrid quantum-classical approach, achieving near-optimal solutions despite hardware noise.


<details>
  <summary>Details</summary>
Motivation: To ensure timely coverage of all affected locations during disasters by efficiently placing emergency operation centers.

Method: A hybrid quantum-classical framework employing neutral-atom quantum computers to sample independent sets, refining them to form dominating sets for graph-based optimization.

Result: The approach can tackle instances of up to 100 nodes, demonstrating effectiveness through benchmarking against synthetic and realistic scenarios.

Conclusion: Neutral-atom quantum devices in analog mode can effectively address graph optimization challenges in real-world disaster response applications.
...
### [82] [Stalls and Spequlation: Pipelined Execution for Fault Tolerant Quantum Computation](https://arxiv.org/abs/2606.19593)
*Aditi Awasthi,Gokul Subramanian Ravi,Jonathan Mark Baker*

Main category: quant-ph

TL;DR: The paper presents a pipelined execution framework for fault-tolerant quantum computation that improves efficiency by decomposing logical operations and employing speculation strategies, leading to a 20-40% reduction in pipeline steps.


<details>
  <summary>Details</summary>
Motivation: To enhance the efficiency of fault-tolerant quantum computation by addressing idle times in classical control logic, quantum hardware, and error decoders.

Method: A pipelined execution framework is introduced, breaking down logical operations into Control, Execute, and Decode stages, along with speculation strategies that allow early processing of successor operations.

Result: The framework achieves a 20-40% reduction in total pipeline steps compared to a no-speculation baseline, with aggressive strategies outperforming conservative ones despite some necessary partial rollbacks.

Conclusion: Speculation not only reduces execution time but also improves load balancing across subsystems, effectively utilizing idle resources.
...
### [83] [String dynamics of a (2+1)D U(1) quantum link model on a digital quantum computer](https://arxiv.org/abs/2606.19601)
...
TL;DR: This paper demonstrates a quantum computing approach to study string dynamics in a (2+1)D U(1) pure gauge theory using a quantum link model, achieving experimental results that align with tensor-network calculations and explore thermalization dynamics of strings.


<details>
  <summary>Details</summary>
Motivation: The goal is to utilize quantum computing methods to investigate the dynamics of string tensions in confining gauge theories, particularly given the limitations of traditional computational methods.

Method: A minimal U(1) quantum link model is implemented on a quantum computer, using qubits to represent dual height variables. Plaquette interactions are realized efficiently on a tailored lattice geometry compatible with IBM quantum hardware, facilitating studies of real-time dynamics through quantum quenches.

Result: Experiments with up to 112 qubits show that the quantum simulations align with reference tensor-network results at short time scales and thermal averages at longer times, effectively capturing the dynamics of the string fluctuations across the lattice.

Conclusion: The research reveals significant fluctuations near the phase transition and achieves accurate predictions in the regime of interest, offering a novel approach to studying lattice gauge theories using quantum computing techniques.
...
### [84] [Subsystem Quantum Error Correction for Noisy Quantum Metrology](https://arxiv.org/abs/2606.19628)
*Qiushi Liu,Sisi Zhou*

Main category: quant-ph

TL;DR: Subsystem error correction simplifies quantum parameter estimation by achieving the Heisenberg limit with minimal ancilla resources.


<details>
  <summary>Details</summary>
Motivation: Existing error correction methods are too reliant on multiple noiseless ancillae and complex procedures, limiting their practicality in quantum metrology.

Method: The paper introduces subsystem stabilizer codes and derives conditions for achieving the Heisenberg limit using syndrome-free protocols with a single ancilla qubit, extending the approach to Floquet codes for dynamical error correction.

Result: The derived conditions allow for the realization of the Heisenberg limit under broad noise conditions, enhancing efficiency in quantum parameter estimation.

Conclusion: Subsystem error correction and Floquet codes represent significant advancements in simplifying quantum metrology protocols, potentially enabling robust precision measurement.
...
### [85] [Quantum Dynamics from Lax Pair Theory: A Reconstruction from Spectrum Preservation](https://arxiv.org/abs/2606.19664)
*Péter Szabó*

Main category: quant-ph

TL;DR: The paper reconstructs unitary quantum dynamics using axioms based on observables and isospectral evolution, demonstrating that minimal assumptions lead to comprehensive quantum dynamics results.


<details>
  <summary>Details</summary>
Motivation: To provide a foundational framework for quantum dynamics that relies fundamentally on observable characteristics rather than traditional postulates.

Method: The authors assume physical time evolution as a continuous flow of Hermitian observables preserving spectra, leading to the application of Lax pair theory.

Result: This approach necessitates the Lax form of quantum dynamics, establishing theorems for important equations and conservation laws without assuming a Hamiltonian.

Conclusion: The study offers a novel perspective that connects measurement structures to quantum evolution, suggesting that the Hamiltonian naturally arises from the dynamics.
...
### [86] [Topological Quantum Interferometry](https://arxiv.org/abs/2606.19730)
*Tianyou Ying,Yufeng Zhou,Chengwei Pan,Ryan Hogan,Ruoyang Zhang,Hui Liu,Shining Zhu,Xiaoqin Gao*

Main category: quant-ph

TL;DR: This paper presents a method for characterizing structured light using an interaction-based geometric phase, enhancing the understanding of spatial mode evolution in quantum optics without requiring perfect conditions.


<details>
  <summary>Details</summary>
Motivation: To overcome limitations in existing characterization methods for structured light, which assume perfectly tuned conditions and fail to account for geometric effects.

Method: The authors introduce topological quantum interferometry based on the exchange Berry phase (BPX), which generalizes state generation and characterization to various topological charges and conditions.

Result: BPX serves as a geometric marker for spatial interference, enabling the decomposition of two-photon spatial patterns into fundamental modes influenced by geometry, revealing topological invariants and acting as a non-tomographic witness for estimating state dimensionality.

Conclusion: The proposed method is device-independent, highly scalable, and applicable to quantum metrology and high-capacity quantum networks, providing robust characterization of high-dimensional quantum states.
...
### [87] [Sparse positive maps on qutrits with exact nondecomposability thresholds and PPT-entanglement transitions](https://arxiv.org/abs/2606.19765)
*Davide Poderini,Angela Rosy Morgillo,Fabio Benatti,Fabio Anselmi,Chiara Macchiavello,Massimiliano F. Sacchi*

Main category: quant-ph

TL;DR: This paper investigates sparse positive maps on qutrits, focusing on explicit positivity, decomposability, and PPT entanglement through block structures in Choi matrices.


<details>
  <summary>Details</summary>
Motivation: Understanding the structure and behavior of sparse positive maps is crucial for quantum information theory, particularly with regard to entanglement and quantum states.

Method: The authors analyze Choi matrices to reveal positivity boundaries and the transition between decomposable and non-decomposable maps, constructing associated PPT states.

Result: Exact positivity boundaries and transitions between decomposable and non-decomposable maps are identified, along with exact thresholds for separability and bound entanglement.

Conclusion: The findings clarify the relationship between positivity and higher-order positivity, providing a comprehensive understanding of sparsity in positive maps and their entanglement properties.
...
### [88] [Robust Generation of Topological Biphoton Mode via Adiabatic Passage](https://arxiv.org/abs/2606.19786)
*Jaesung Lim,Jihwan Kim,Dong-Gil Im,Kyungdeuk Park,Dongkyu Kim,Yonggi Jo,Yong Sup Ihn*

Main category: quant-ph

TL;DR: This study introduces an adiabatic method to enhance biphoton generation in topological waveguide arrays, overcoming challenges posed by structural disorder.


<details>
  <summary>Details</summary>
Motivation: The robustness of topological waveguide arrays in quantum processing is limited by structural disorder affecting nonlinear biphoton generation.

Method: An adiabatic passage connects an isolated site to a topological defect array, suppressing unwanted mode coupling and preserving the Schmidt number during nonlinear interactions.

Result: Numerical simulations show that the adiabatic method ensures high biphoton fidelity and a unit Schmidt number, despite waveguide gap disorder, also extending this robustness to path entangled NOON states.

Conclusion: The proposed strategy offers a viable design for disorder-tolerant integrated quantum photonic devices, enhancing their practical application in quantum information processing.
...
### [89] [QMCtwin: Master-Equation Simulation of Syndrome Statistics Beyond Pauli Noise](https://arxiv.org/abs/2606.19848)
*Tong Shen,Huo Chen,Benchen Huang,Tyler Takeshita,Arian Vezvaee,Izhar Medalsy,Daniel A. Lidar*

Main category: quant-ph

TL;DR: QMCtwin offers a quantum Monte Carlo approach to simulate QEC circuits under realistic noise conditions, revealing critical noise features ignored by traditional models.


<details>
  <summary>Details</summary>
Motivation: To enhance quantum error correction (QEC) implementations by better capturing and decoding hardware noise in syndrome statistics.

Method: QMCtwin employs a quantum Monte Carlo framework for master-equation simulation to model realistic noise in QEC circuits, specifically applied to a distance-7 rotated surface code with 97 physical qubits.

Result: QMCtwin provides a more nuanced view of syndrome extraction, predicting biases and correlations in syndromes that are not captured in standard Pauli-twirled simulations, along with new information-theoretic diagnostics.

Conclusion: This framework reveals hidden noise characteristics and offers a pathway to improve decoder performance in quantum error correction by employing master-equation models.
...
### [90] [Random Local Stabilizer Codes in Three Dimensions without String or Self-Similar Fractal Logical Operators](https://arxiv.org/abs/2606.19873)
*Han Yan*

Main category: quant-ph

TL;DR: The paper presents qutrit random cubic codes that retain the no-string property while exhibiting distinct self-correction properties compared to translation-invariant fracton codes.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of passive self-correcting quantum error-correcting codes, particularly the issue of string logical operators.

Method: Introduction of qutrit random cubic codes with spatially varying stabilizers, maintaining a cube-check structure similar to Haah's Code 1.

Result: The codes demonstrate a no-string property and reveal unique ground-state degeneracy characteristics, alongside absent self-similar fractal operators.

Conclusion: This work suggests that introducing constrained randomness into stabilizer codes can enhance their self-correction capabilities and lead to new types of quantum error-correcting codes.
...
### [91] [Purity and bound energy in ancilla-assisted work extraction](https://arxiv.org/abs/2606.19945)
*B. Vigneshwar,Farhaan Khan,R. Sankaranarayanan*

Main category: quant-ph

TL;DR: The study explores ancilla-assisted work extraction in quantum batteries, revealing that bound energy and purity significantly influence daemonic gain via correlations and spectral structures.


<details>
  <summary>Details</summary>
Motivation: The research aims to understand how bound energy and purity affect work extraction efficiency in quantum batteries, particularly in relation to daemonic gain.

Method: The study introduces a purity-based gain metric and a protocol for analyzing dissipation and interactions, emphasizing their impact on dynamical properties and correlations in quantum systems.

Result: It was found that bound energy provides a tight upper limit to daemonic gain and that both correlations and spectral characteristics of the Hamiltonian are crucial in determining this gain.

Conclusion: The outcomes show that effective work extraction hinges on both correlation dynamics and the intrinsic spectral properties of the system, indicating a complex interplay between energy bounds and purity.
...
### [92] [QMaxCal: Path-Space Regularization for Open Quantum Control via Girsanov's Theorem](https://arxiv.org/abs/2606.19947)
*Merijn Moody,Zier Mensch,Miranda C. N. Cheng,Peter G. Bolhuis,Max Welling*

Main category: quant-ph

TL;DR: The paper presents two regularizers for controlling open quantum systems under decoherence, significantly improving performance over existing methods.


<details>
  <summary>Details</summary>
Motivation: To enhance reliable quantum control despite environmental noise and decoherence effects.

Method: Utilizes Girsanov's theorem to estimate KL divergence between trajectories, creating two regularizers based on reference measures: Wiener KL and drift-variance regularizer.

Result: The regularizers demonstrate improved outcomes in final-state fidelity, robustness to noise model mismatch, and reduced occupation of forbidden states, outperforming baseline methods.

Conclusion: Both regularizers effectively minimize decoherence impact, achieving up to 50% reduction in infidelity, with significant gains on quantum systems including the IBM Kingston processor.
...
### [93] [Majorana bound states in a hybrid Kitaev ladder with long-range pairing](https://arxiv.org/abs/2606.19963)
*Rajiv Kumar,Tapan Mishra,Levan Chotorlishvili,Sunil Kumar Mishra*

Main category: quant-ph

TL;DR: This paper studies a hybrid Kitaev ladder with different pairing interactions, revealing complex topological phases and Majorana modes influenced by inter-leg coupling.


<details>
  <summary>Details</summary>
Motivation: To explore the effects of long-range pairing and inter-leg coupling on topological phases in superconducting chains.

Method: Analyze a hybrid Kitaev ladder with one chain having conventional $p$-wave pairing and another with algebraically decaying long-range pairing, examining the resulting phase diagram.

Result: Identified multiple topological phases characterized by Majorana zero modes and Dirac modes; inter-leg coupling alters phase boundaries and energy scales.

Conclusion: The hybrid Kitaev ladder serves as a platform for realizing tunable topological states, enhancing potential applications in quantum information.
...
### [94] [On chip, multifunctional quantum sensing using single spins in a van der Waals crystal](https://arxiv.org/abs/2606.19978)
...
TL;DR: This paper presents a method for independent dual sensing of temperature and magnetic fields using quantum emitters in hexagonal boron nitride, addressing existing challenges in simultaneous measurements.


<details>
  <summary>Details</summary>
Motivation: To overcome the limitations in simultaneous quantum sensing of multiple parameters with current spin sensors, due to cross-sensitivity issues.

Method: Utilizing single quantum emitters in hexagonal boron nitride to independently measure temperature via the zero-phonon line and magnetic fields using optically detected magnetic resonance.

Result: Demonstrated the independent responsiveness of the zero-phonon line position to temperature changes and the efficacy of ODMR for magnetic field measurement, achieving localized temperature sensing of a microcircuit.

Conclusion: Quantum emitters in hBN provide a reliable platform for multifunctional quantum sensing, capable of operating effectively in real-world conditions.
...
### [95] [Optimal Shadow Estimation with Minimal Measurement Settings](https://arxiv.org/abs/2606.20003)
*Zhiyao Yang,Datong Chen,Huangjun Zhu*

Main category: quant-ph

TL;DR: The paper establishes that worst-case shadow estimation requires Θ(d²) measurement bases, while average-case optimality is achievable with only Θ(d) bases, introducing efficient measurement strategies for quantum property prediction.


<details>
  <summary>Details</summary>
Motivation: To clarify the minimal number of measurement bases necessary for optimal performance in shadow estimation, distinguishing between worst-case and average-case scenarios.

Method: The authors proved the necessity and sufficiency of Θ(d²) measurement bases for worst-case optimal shadow estimation, and they explored the efficacy of various state 2-designs for average-case performance.

Result: The explicit construction of measurement bases for worst-case scenarios and the demonstration that state 2-designs suffice for average-case optimality, ensuring bounded sample complexity and leading to practical measurement strategies.

Conclusion: The findings highlight a complexity separation in quantum measurement approaches, with substantial implications for quantum information theory and practical applications.
...
### [96] [The use of Peres lattices in periodically driven systems](https://arxiv.org/abs/2606.20009)
*Lukáš Honsa,Jan Střeleček,Jakub Novotný,Pavel Cejnar*

Main category: quant-ph

TL;DR: The Peres lattice method effectively analyzes periodically driven quantum systems, revealing resonances, chaos onset, and critical Floquet mode properties.


<details>
  <summary>Details</summary>
Motivation: The motivation is to extend the applicability of Peres lattices from stationary to driven quantum systems, enhancing the understanding of their dynamics.

Method: The method involves utilizing Peres lattices to efficiently detect resonances, monitor chaos onset, and analyze Floquet modes in driven systems.

Result: The approach reveals key insights into resonances, chaos, and the spectral properties of Floquet modes across different driving Hamiltonians.

Conclusion: Peres lattices provide a powerful tool for studying and comparing the spectra and behavior of periodically driven quantum systems.
...
### [97] [All-valid-state HOBO encoding for constrained combinatorial optimization on NISQ devices](https://arxiv.org/abs/2606.20017)
*Juncheng Wang,Takumi Kanezashi,Daisuke Tsukayama,Koki Awaya,Reo Saito,Jun-ichi Shirakashi,Tetsuo Shibuya,Hiroshi Imai*

Main category: quant-ph

TL;DR: This study evaluates the variational quantum eigensolver (VQE) for solving the traveling salesperson problem (TSP) using a novel encoding method (AVS-HOBO) to improve reliability and scalability on quantum devices.


<details>
  <summary>Details</summary>
Motivation: The study aims to bridge the gap between quantum computing advancements and their application to NP-hard problems, especially in practical scenarios.

Method: The researchers employ a variational quantum eigensolver (VQE) with higher-order binary optimization (HOBO) encodings, specifically an all-valid-state HOBO (AVS-HOBO) scheme, to address the TSP, both in simulations and on real quantum hardware.

Result: AVS-HOBO encoding significantly enhances energy convergence and scalability for TSP instances while demonstrating improved reliability on different quantum device architectures.

Conclusion: The findings suggest that AVS-HOBO encoding could be effectively applied to various constrained quantum optimization problems, enhancing the performance of quantum algorithms in practical applications.
...
### [98] [Simulation of Non-Markovian Quantum Accelerated Dynamics via Time-Fractional Schrödinger Equation](https://arxiv.org/abs/2606.20024)
*Dongmei Wei,Junxiang Wang,Hanxiu Xu,Cancan Chen,Jiaying Wu*

Main category: quant-ph

TL;DR: The paper demonstrates that Wei's Time-Fractional Schrödinger Equation (TFSE) effectively simulates non-Markovian quantum dynamics, revealing mechanisms for enhanced evolution speed and superior computational efficiency over Naber's TFSE.


<details>
  <summary>Details</summary>
Motivation: To explore the dynamics of non-Markovian quantum systems and determine an effective simulation method for quantum speed limit characteristics.

Method: Using Wei's TFSE to analyze a Resonant Dissipative Jaynes-Cummings model and studying the impacts of fractional order, coupling strength, and photon number.

Result: Characterization of QSL time for a time-fractional single-qubit system, revealing enhanced speed of evolution due to non-Markovian effects, and demonstrating greater accuracy and efficiency of Wei's TFSE compared to Naber's.

Conclusion: Wei's TFSE outperforms Naber's TFSE in modeling non-Markovian accelerated dynamics, providing insights into system behavior and improved computational speed.
...
### [99] [QPU-scale randomized benchmarking via Bell-pair injection](https://arxiv.org/abs/2606.20123)
*Haripriya Pettugani,María Aguado-Yáñez,Astryd Park,Daniel Bultrini,James R. Wootton*

Main category: quant-ph

TL;DR: The paper introduces Mirror Quantum Awesomeness (MQA), an enhanced benchmarking method that tracks error dynamics in quantum processors (QPU) by adding an entangling layer to mirror randomized benchmarking (MRB).


<details>
  <summary>Details</summary>
Motivation: To improve the error characterization of quantum processors and locate critical circuit depths where error mitigation techniques become ineffective.

Method: MQA combines MRB with structured entangling layers to measure per-edge correlation dynamics using mutual information, maintaining MRB's error metric, and introduces a topological variant based on surface-code decoding.

Result: Validation in simulation alongside experiments on 156-qubit processors shows MQA's results align closely with MRB, with a critical depth of approximately 50 for the 	exttt{ibm	extunderscore fez} processor.

Conclusion: MQA proves effective in identifying circuit depths where error mitigation fails, enhancing the error estimation framework for quantum processors.
...
### [100] [Optimizing resource allocation for accuracy in noisy variational quantum algorithms](https://arxiv.org/abs/2606.20153)
*Harshit Verma,Thomas Ayral,Alexia Auffèves,Robert Whitney*

Main category: quant-ph

TL;DR: The paper presents a methodology to optimize NISQ algorithms for accuracy with minimal resource costs, focusing on the Variational Quantum Eigensolver (VQE) by balancing circuit size and iteration number.


<details>
  <summary>Details</summary>
Motivation: To enable quantum algorithms to efficiently achieve desired accuracy while minimizing resource usage, especially relevant in NISQ contexts.

Method: Development of a phenomenological model based on simulations of VQE capturing the interplay between algorithm accuracy, resource costs, and realistic hardware noise.

Result: Identification of optimal circuit size and iteration count that minimize resource costs and maximize accuracy, providing guidelines for deploying variational algorithms on noisy quantum hardware.

Conclusion: The proposed methodology offers practical insights for implementing variational algorithms in near-term quantum systems, effectively managing the trade-offs between accuracy and resource expenditures.
...
### [101] [Multi-objective design of photon blockade for bright single-photon sources](https://arxiv.org/abs/2606.20160)
*Sunkyu Yu,Xianji Piao,Namkyoo Park*

Main category: quant-ph

TL;DR: The paper proposes a computational framework to optimize the design of single-photon sources by balancing purity, brightness, and indistinguishability using a Jacobian-based update and simulated annealing, achieving a nearly 60% design success rate for specific photon blockade conditions.


<details>
  <summary>Details</summary>
Motivation: The need for high-quality single-photon sources in photonic quantum platforms, while facing challenges in balancing competing metrics of purity, brightness, and indistinguishability.

Method: A computational framework using a Liouville-space adjoint formulation and Jacobian-based updates, combined with simulated annealing to address multi-objective optimization in open quantum systems.

Result: Achieved a design success rate of nearly 60% for photon blockade with g2(0) < 0.1 and theoretically bounded brightness across a wide parameter space.

Conclusion: The proposed framework offers a valuable approach to the multi-objective design of open quantum systems, improving the practical implementation of single-photon sources.
...
### [102] [Applications of quantum annealing to magnetic dipole hyperfine structure constants: First results beyond energies for atoms](https://arxiv.org/abs/2606.20166)
*Boni Paul,Subimal Deb,Per Jönsson,Jörgen Ekman,Bhanu Pratap Das*

Main category: quant-ph

TL;DR: This study presents the first results of magnetic dipole hyperfine structure constants for several lithium and sodium isotopes using a modified Quantum Annealer Eigensolver on D-Wave's quantum hardware, benchmarked against traditional computational methods.


<details>
  <summary>Details</summary>
Motivation: To explore the feasibility and accuracy of using quantum computing methods for calculating hyperfine structure constants in atomic systems, contributing to advancements in quantum information processing and atomic physics.

Method: The modified Quantum Annealer Eigensolver (QAE) utilizes a zooming-and-sigma-annealing approach with floating-point encoding, estimating eigenvalues and eigenvectors of relativistic Dirac-Coulomb Hamiltonian matrices derived from a limited number of configuration state functions.

Result: The quantum calculations yielded results entirely consistent with those from GRASP, demonstrating the potential of quantum computing in producing accurate atomic structure constants, albeit with varying precision depending on the complexity of the atomic system.

Conclusion: The modified QAE performed effectively on the D-Wave quantum hardware, achieving results comparable to traditional methods, indicating its promise for future computational applications in atomic and molecular physics.
...
### [103] [Quantum-Accelerated Self-Consistent Field: A Hybrid Algorithm](https://arxiv.org/abs/2606.20176)
*Alexis Ralli,Tim Weaving,Thomas M. Bickley,Peter V. Coveney,Peter J. Love*

Main category: quant-ph

TL;DR: The GAS-SCF algorithm enhances SCF quantum chemistry optimization by using quantum arithmetic for efficient state marking and amplitude amplification, demonstrating potential with simulated examples.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the need for efficient algorithms in self-consistent field (SCF) quantum chemistry, proposing GAS-SCF as a solution for optimization challenges.

Method: GAS-SCF employs quantum arithmetic to create an oracle for marking Fock states, followed by amplitude amplification to boost the probability of measuring these states, offering a quadratic speed-up.

Result: Simulations show GAS-SCF can handle systems up to 330 qubits, including three examples that represent challenging SCF scenarios.

Conclusion: The effectiveness of GAS-SCF suggests it could significantly advance SCF quantum chemistry, though practical application awaits advancements in quantum hardware.
...
### [104] [Operator Learning for efficient Quantum Computation](https://arxiv.org/abs/2606.20184)
*Paul Over,Sergio Bengoechea,Leonardo Borello Busilacchi,Martin Kiffner,Thomas Rung,Alexios A. Michailidis*

Main category: quant-ph

TL;DR: The paper proposes a variational framework to efficiently transform operators into compact quantum circuits, addressing limitations in quantum algorithm implementations.


<details>
  <summary>Details</summary>
Motivation: To overcome challenges in quantum hardware's ability to simulate complex problems and to enhance fault-tolerant algorithms for practical quantum advantage.

Method: A full-stack variational framework is introduced that transforms arbitrary operators to compact quantum circuits, utilizing backpropagation and a cost function for optimization, with a novel regularization term to reduce approximation errors.

Result: Validated for quantum mechanical applications, improving resource scaling compared to standard methods, and successfully applied to engineering problems, enhancing error metrics for approximations of differential operators.

Conclusion: The framework's universality allows it to tackle a variety of problems beyond the initial applications, demonstrating significant potential for future quantum algorithm development.
...
### [105] [Optimal multi-spectral squeezing via deterministic 2D-phase optimization](https://arxiv.org/abs/2606.20192)
*Bastien Oriot,Peter Namdar,Emilie Gillet,RL Rincon Celis,Valentina Parigi*

Main category: quant-ph

TL;DR: The paper presents a deterministic optimization method for enhancing multi-spectral squeezing in quantum protocols, increasing visibility and squeezing efficiency in a waveguide-based setup.


<details>
  <summary>Details</summary>
Motivation: To enhance multi-spectral squeezing in quantum information technologies while maintaining minimal losses during optical detection.

Method: A deterministic sequential algorithm is developed, focused on the physical description of the optical process, achieving global optimization of visibility in pixel space with linear scaling to the number of pixels.

Result: Visibility increased from 76% to 84%, translating to a mode-matching efficiency gain of 20% and an increase in squeezing from -2.08 dB to -2.64 dB for the most squeezed spectral mode.

Conclusion: Deterministic spatial phase shaping is an effective and interpretable method for improving multimode squeezing in waveguide platforms.
...
### [106] [Random Projections for Multi-Copy Quantum Algorithms](https://arxiv.org/abs/2606.20238)
*Xiaoyu Liu,Jordi Tura,Johannes Knörzer*

Main category: quant-ph

TL;DR: The paper presents a new method for estimating nonlinear quantum state properties that reduces the need for coherent operations, enabling more efficient measurements using lower-dimensional projections.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of estimating nonlinear properties of quantum states using large systems where traditional protocols are unfeasible.

Method: A framework utilizing random projections onto lower-dimensional subspaces prior to collective measurements, allowing for a tunable balance between coherent operations and statistical sampling.

Result: The approach provides explicit formulas for projected moments related to multivariate traces and elucidates the sampling overhead for estimating nonlinear properties in quantum states.

Conclusion: The proposed method allows optimization of multi-copy quantum protocols by balancing coherent operations with additional state copies, adapting to hardware capabilities.
...
### [107] [Mitigating Trotter Errors via Post-Processed Symmetry Restoration](https://arxiv.org/abs/2606.20242)
*Sangjin Lee,Sangkook Choi*

Main category: quant-ph

TL;DR: This paper presents a symmetry-based error mitigation protocol for Trotterized quantum simulations that preserves target Hamiltonian symmetries and improves fidelity through classical post-processing.


<details>
  <summary>Details</summary>
Motivation: The conventional Trotterization method often fails to maintain the symmetries of the target Hamiltonian in quantum simulations, leading to unphysical dynamics and errors.

Method: A symmetry-based Trotter error mitigation protocol is proposed, applying symmetry transformations to initial states or interleaving them between Trotter layers, followed by classical post-processing to average measurement outcomes.

Result: The technique was benchmarked on the one-dimensional XY model and the Schwinger model, demonstrating effective suppression of Trotter errors by enforcing reflection symmetry and gauge-twirling.

Conclusion: This approach offers a practical method to enhance the fidelity of Trotterized simulations on near-term quantum devices while maintaining the depth of quantum circuits.
...
### [108] [Vine Codes: Low-Overhead Quantum LDPC Codes on a Planar Square Grid](https://arxiv.org/abs/2606.20263)
*Georgia M. Nixon,Campbell K. McLauchlan,Charles C. L. van Rest*

Main category: quant-ph

TL;DR: Introducing vine codes, a novel implementation of qLDPC codes on superconducting platforms that reduces qubit overheads compared to surface codes while maintaining nearest-neighbour gate requirements.


<details>
  <summary>Details</summary>
Motivation: The surface code is effective for quantum computing but incurs significant qubit overhead, and qLDPC codes offer a potential solution, albeit requiring long-range connections that are challenging for superconducting hardware.

Method: Vine codes are developed as qLDPC codes compatible with planar square grids and implemented via nearest-neighbour gates. The approach generalizes existing directional codes, enabling open boundary conditions using routing qubits.

Result: Extensive numeric searches yield candidates like [[121,4,6]], with a qubit reduction of ~28% compared to surface codes and better performance under a noise model. Including routing qubits, vine codes still show reduced total qubit counts (e.g., ~18% at distance 10).

Conclusion: Vine codes present a promising alternative to surface codes, optimizing qubit usage while enabling fault-tolerant logic and accommodating a variety of boundary conditions.
...
### [109] [Extracting the physical content of Liouvillian eigenmodes: Semiclassical quantization](https://arxiv.org/abs/2606.20271)
*Ashlin V Thomas,Felix Fritzsch,Masudul Haque,Shovan Dutta*

Main category: quant-ph

TL;DR: This paper introduces a quasiprobability measure for interpreting Liouvillian eigenstates in open quantum systems, revealing that oscillators maintain quantized orbits in various damping scenarios and extending concepts like invariant tori from Hamiltonian systems.


<details>
  <summary>Details</summary>
Motivation: To address the interpretational difficulties posed by right and left eigenstates of the Liouvillian in open quantum systems by providing a clearer conceptual framework.

Method: A new quasiprobability measure is proposed that combines right and left eigenstates, allowing for the visualization of Liouville eigenmodes as distributions in a doubled phase space.

Result: The findings indicate that oscillators preserve quantized orbits even under linear and nonlinear damping, with implications for observable dynamics and the extension of invariant tori concepts.

Conclusion: This work presents a semiclassical quantization framework for open systems, highlighting measurable signatures that may be observed experimentally.
...
### [110] [Proposal of quantum arrival-time measurement with a Bose-Einstein condensate](https://arxiv.org/abs/2606.20278)
*Pascal Naidon,Lucas Happ,Denis Boiron*

Main category: quant-ph

TL;DR: The paper proposes using a Bose-Einstein condensate to investigate the time it takes for particles to reach a detector by measuring arrival flux, offering a novel solution to longstanding quantum questions.


<details>
  <summary>Details</summary>
Motivation: To address the fundamental question in quantum theory regarding the time taken for particles to reach a detector.

Method: A realistic experimental setup that measures arrival flux on the detector based on its position rather than directly measuring arrival times.

Result: This approach resolves practical challenges of detector placement and provides clear signals to differentiate between theoretical predictions.

Conclusion: The proposal offers a promising way to clarify a longstanding debate in quantum mechanics.
...
### [111] [Quantum Batteries as Work Sources for Phase-Locked Parametric Amplification](https://arxiv.org/abs/2606.20306)
*Borhan Ahmadi*

Main category: quant-ph

TL;DR: Quantum batteries can enhance superconducting quantum technologies by potentially replacing continuous microwave drives, but phase coherence is crucial for optimal amplification.


<details>
  <summary>Details</summary>
Motivation: The study investigates whether a quantum-limited parametric amplifier's pump tone can be substituted with a finite bosonic quantum battery, aiming to reduce reliance on continuous microwave power.

Method: The method involves quantizing the pump of a nondegenerate parametric amplifier, comparing the effects of coherent versus phase-randomized pumps on photon generation and two-mode coherence.

Result: The coherent pump outperforms the phase-randomized pump, producing better coherence and lower minimum intensity values under matched collector bandwidth conditions.

Conclusion: Efficient quantum battery-powered parametric amplification requires not just stored energy but also phase coherence, potentially enhanced by number-noise reduction.
...
### [112] [Entanglement structure of the dynamical phases in the sub-Ohmic spin-boson model](https://arxiv.org/abs/2606.20313)
*Cunxi Gong,Zirui Sheng,Weitang Li*

Main category: quant-ph

TL;DR: The sub-Ohmic spin-boson model has distinct dynamical regimes, with the paper exploring the relationship between these regimes and spin-bath entanglement using advanced tensor network techniques.


<details>
  <summary>Details</summary>
Motivation: The study examines whether the dynamical regimes of the sub-Ohmic spin-boson model also indicate different structures of spin-bath entanglement.

Method: Tree tensor network states with projector-splitting time evolution (TTN-TDVP-PS) are employed, scanning a wide grid in the ($s, α$) parameter space.

Result: The stationary spin entanglement entropy reaches a plateau before polarization relaxation, revealing a stationary entropy landscape with specific geometric interpretations and dependencies on environmental modes.

Conclusion: The findings position stationary spin entanglement entropy as a valuable observable that enhances the understanding of dissipative quantum dynamics beyond traditional population metrics.
...
### [113] [Exploiting More Than Symmetry in Variational Quantum Machine Learning](https://arxiv.org/abs/2606.20316)
*Markus Baumann,Claudia Linnhoff-Popien*

Main category: quant-ph

TL;DR: The paper explores how to design equivariant variational quantum circuits by balancing symmetry enforcement and trainable interactions, demonstrating that task-specific gates yield significant performance improvements.


<details>
  <summary>Details</summary>
Motivation: To enhance variational quantum learning models by utilizing symmetries present in problems, ensuring that model design reflects these dependencies.

Method: The study examines architectural choices in equivariant circuits, specifically how much symmetry to maintain and which interactions to train, utilizing Tic-Tac-Toe as a case study.

Result: Findings indicate that while preserving certain symmetries aids generalization, gains are mainly achieved through targeted gates that interact with key features of the task.

Conclusion: Successful variational circuit design requires both symmetry awareness and a focus on task-specific interactions to optimize learning outcomes.
...
### [114] [Effective Faraday interaction between light and Helium-3 nuclear spins in a multi-pass cell](https://arxiv.org/abs/2606.20328)
*Kaiwen Yi,Yida Sha,Zejia Lin,Matteo Fadel,Xiang Peng*

Main category: quant-ph

TL;DR: Demonstrates an interface for light-nuclear spin interactions in helium-3, enabling precision sensing and quantum metrology.


<details>
  <summary>Details</summary>
Motivation: To enhance precision in quantum sensing tasks using helium-3 nuclear spins and address challenges in creating an effective light-nuclear spin interface.

Method: Experimental demonstration utilizing metastability-exchange collisions in a low-pressure helium-3 gas cell, with optical pumping and Faraday interaction mediated by metastable atoms.

Result: Characterized interaction strength with varying nuclear polarization and probe parameters; predicted measurement-induced squeezing rate of 0.52 s$^{-1}$ with increased probe power.

Conclusion: Provides a practical method for optical manipulation of helium-3 nuclear spins, paving the way for long-lived nuclear spin-squeezed states in quantum metrology.
...
### [115] [Observation of alignment tensor effects in metastability-exchange collisions with highly polarized 3He ensembles](https://arxiv.org/abs/2606.20330)
*Yida Sha,Kaiwen Yi,Xingqing Jin,Matteo Fadel,Xiang Peng*

Main category: quant-ph

TL;DR: The study explores the effects of alignment tensor on highly polarized 3He in MEOP, revealing significant contributions to relaxation and frequency shift through experiments and theoretical models.


<details>
  <summary>Details</summary>
Motivation: To investigate the unexplored effects of alignment tensor in highly polarized 3He prepared by MEOP, which has implications for precision measurements in physics.

Method: Developed a linearized model using mean-field approximation and conducted free-induction-decay measurements to assess tensor effects in response to external magnetic fields.

Result: Demonstrated a pronounced dependence on nuclear polarization and achieved good agreement between experimental results and theoretical predictions.

Conclusion: The study enhances the understanding of nuclear spin dynamics in polarized 3He and informs applications in correcting systematic errors in magnetometry and generating nuclear spin-squeezed states.
...
### [116] [Phase locking nuclear spins in silicon with spin-orbit coupling](https://arxiv.org/abs/2606.20340)
*Habitamu Y. Walelign,Manas Ranjan Sahu,John M. Nichol*

Main category: quant-ph

TL;DR: This paper discusses a novel method for coherently controlling nuclear spins in silicon quantum dots without the need for external phase references, utilizing internal spin-orbit coupling instead.


<details>
  <summary>Details</summary>
Motivation: To enhance the use of nuclear spins in quantum information processing by eliminating the reliance on external phase references for coherent control.

Method: The authors phase-lock a $^{29}$Si nuclear spin ensemble in a silicon quantum dot using internal electronic spin-orbit coupling as a phase reference, allowing for alignment with a drive protocol based on electron spins.

Result: They demonstrate coherent precession and measure inhomogeneous dephasing of nuclear spins, corroborated by numerical simulations of the electron-nuclear system.

Conclusion: The research paves the way for improved coherent control of nuclear spin ensembles in solid-state systems, advancing quantum information processing methods.
...
### [117] [Quantum ring all-reduce: communication and privacy advantages for distributed learning](https://arxiv.org/abs/2606.20344)
*María Gragera Garcés,Lirandë Pira*

Main category: quant-ph

TL;DR: This study proposes a quantum-enhanced ring all-reduce communication method to improve efficiency and privacy in distributed machine learning training, achieving significant communication reductions and unique security advantages.


<details>
  <summary>Details</summary>
Motivation: With the rise of large-scale distributed machine learning, there is a need for communication-efficient and secure training methods, particularly in quantum and classical settings.

Method: A quantum version of the ring all-reduce communication primitive is introduced, utilizing pre-shared entanglement and superdense coding to optimize communication and enhance privacy without altering learning models.

Result: Achieves a 2x reduction in communication across links, providing information-theoretic privacy guarantees and improved gradient conflict detection, showcasing clear communication advantages in both quantum and classical contexts.

Conclusion: The proposed hybrid architecture not only enhances communication efficiency but also addresses privacy concerns, setting a new standard for secure large-scale distributed training.
...
### [118] [Effective discrete-modulated continuous variable QKD under general attacks](https://arxiv.org/abs/2606.20346)
*Mariana Navarro,Antonio Acín,Carlos Pascual-García*

Main category: quant-ph

TL;DR: This paper presents a finite-size security analysis for continuous variable quantum key distribution with discrete modulations, addressing limitations in current security proofs and incorporating realistic experimental conditions.


<details>
  <summary>Details</summary>
Motivation: The motivation is to develop a security analysis for continuous variable quantum key distribution that overcomes restrictive assumptions and enhances practical implementation.

Method: The method employs dimension reduction, marginal-constrained entropy accumulation for security proofs, and incorporates a trusted detector model that accounts for imperfections in receivers.

Result: The analysis reveals positive key rates in the finite-size regime for block sizes around $10^8$, indicating feasible security in practical scenarios.

Conclusion: The findings help align theoretical security proofs with practical implementations, thereby advancing the viability of quantum key distribution systems.
...
### [119] [Discrimination of genuinely nonlocal sets without entanglement in multipartite systems](https://arxiv.org/abs/2606.20380)
*Ziying Hou,Huaqi Zhou,Limin Gao*

Main category: quant-ph

TL;DR: The paper explores efficient methods for entanglement-assisted discrimination of genuinely nonlocal orthogonal product states, categorizing them into Type I (reducible) and Type II (irreducible) based on local irreducibility, and detailing resource requirements for both types across varying dimensions.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of distinguishing genuinely nonlocal multipartite states with minimal quantum resources in quantum information theory.

Method: The authors develop entanglement-assisted discrimination schemes based on the local irreducibility criterion, outlining resource requirements for both Type I and Type II sets.

Result: For low-dimensional cases, Type I sets need one EPR pair, while Type II sets require a GHZ state. In higher dimensions, one maximally entangled state suffices for discrimination in both Type I (two-qutrit) and Type II (three-qutrit) systems, with Type I requiring only one maximally entangled state for n-partite systems with n > 3, and Type II needing one additional EPR pair.

Conclusion: These findings lay out a robust framework for efficiently discriminating genuinely nonlocal states, minimizing the quantum resources needed.
...
### [120] [Sparse Configuration Interaction for the Electronic Schrödinger Equation Revisited: Complete Basis Set Limit Complexity and Quantum-Encoding Impact](https://arxiv.org/abs/2606.20385)
*Michael Griebel,Jan Hamaekers*

Main category: quant-ph

TL;DR: This paper explores regularity results for eigenfunctions in the discrete spectrum of the Schrödinger equation, highlighting improved convergence rates for numerical approximations.


<details>
  <summary>Details</summary>
Motivation: To address the curse of dimensionality in approximating eigenfunctions of the Schrödinger equation and improve convergence rates in numerical methods.

Method: The paper analyzes regularity results and convergence properties in the context of sparse grid constructions in numerical approximation.

Result: It shows that the leading convergence rate remains independent of the number of electrons, mitigating the curse of dimensionality.

Conclusion: This suggests enhanced efficiency for classical numerical solvers and quantum-computing approaches by employing new wavefunction encodings.
...
### [121] [Interaction geometry and ground-state properties of sparse quantum lattice models](https://arxiv.org/abs/2606.20387)
*Alex Gunning,Sebastian Schmid,Zhengxiao Liu,Sridevi Kuriyattil,Aydin Deger,Andrew J. Daley*

Main category: quant-ph

TL;DR: This paper explores how interaction geometry influences low-energy phases in sparse long-range quantum models, highlighting distinct behaviors in power-of-$p$ and Fibonacci graphs.


<details>
  <summary>Details</summary>
Motivation: To understand the effects of graph connectivity on ground-state phase transitions in quantum systems, particularly how symmetry and frustration shape these transitions.

Method: The study examines graphs with logarithmic degree growth, focusing on power-of-$p$ graphs for even and odd $p$, and contrasting them with Fibonacci graphs to illustrate geometric influences on phase structure.

Result: Findings reveal that even-$p$ power-of-$p$ graphs replicate complex phase structures from power-of-two models, while odd-$p$ graphs exhibit geometric frustration. Fibonacci graphs show a geometric relationship between short and long-range limits without discrete self-similarity.

Conclusion: The research unifies the concepts of phase structure and criticality through a principle of effective geometry, providing insights into long-range quantum systems for experimental applications.
...
### [122] [Faking entanglement with imperceptible measurement deviations](https://arxiv.org/abs/2606.20396)
*Jaime Moreno,Elna Svegborn,Simon Morelli,Markus Hiekkamäaki,Lea Kopf,Robert Fickler,Armin Tavakoli*

Main category: quant-ph

TL;DR: Measurement errors can falsely certify high-dimensional quantum entanglement, emphasizing the need for robust verification methods.


<details>
  <summary>Details</summary>
Motivation: Ensure accuracy in verifying quantum entanglement as it underpins advanced quantum technologies.

Method: Introduces adversarial measurement errors in entanglement verification tests and demonstrates their impact experimentally with classical photonic states.

Result: Found that small measurement errors can lead to misclassification of separable states as entangled, demonstrated experimentally in systems with high dimensions and low fidelity errors.

Conclusion: Current entanglement detection methods are vulnerable to small perturbations, indicating the necessity for more secure verification approaches.
...
### [123] [Quantum Kernels are Spectral Tensor Networks](https://arxiv.org/abs/2606.20402)
*Erik M. Åsgrim,Stefano Markidis*

Main category: quant-ph

TL;DR: This paper connects quantum kernels to spectral tensor networks by showing that entangling tensor kernels can be factored into Fourier coefficient tensors, enabling compact representations and insights into classical tractability.


<details>
  <summary>Details</summary>
Motivation: To understand and enhance the efficiency of quantum kernels in quantum machine learning through a spectral tensor network perspective.

Method: The authors demonstrate that entangling tensor kernels can be expressed as matrix product operator factorizations and derive a grouped Fourier form for compact spectral representations.

Result: A numerical study shows that layered quantum kernels can be accurately represented with a small bond dimension, indicating a compressibility influenced by Fourier mode correlations.

Conclusion: Compressibility offers insights into the classical representability of quantum kernels and their likely classical tractability in evaluations.
...
### [124] [Computing noise-canceling observables via Pauli propagation](https://arxiv.org/abs/2606.20441)
...
TL;DR: The paper presents a hybrid error-mitigation framework that integrates Pauli propagation with quantum processors to improve observable estimation and achieve quantum advantage.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of quantum simulation accuracy due to error rates and sampling overheads, as well as the challenges faced by classical simulation methods like Pauli propagation.

Method: The proposed framework embeds Pauli propagation within error-canceling inverse channels, reducing sampling overhead and truncation errors while requiring fewer classical resources.

Result: Two implementations were prototyped and benchmarked on canonical models, with empirical testing conducted on a quantum processor with 56 superconducting qubits, revealing performance tradeoffs.

Conclusion: The findings demonstrate the synergistic potential of combining classical and quantum resources to enhance observable estimation, paving the way for advancements in quantum-centric supercomputing and exploiting quantum advantages.
...
### [125] [Many-body chirality of topological stabilizer states](https://arxiv.org/abs/2606.20472)
*Tyler D. Ellison,Dongjin Lee,Zhi Li,Amin Moharramipour,Yasamin Panahi,Beni Yoshida*

Main category: quant-ph

TL;DR: This paper defines many-body chirality in quantum states as an obstruction to transforming a state into its complex conjugate using local operations, establishing criteria based on anyon theories.


<details>
  <summary>Details</summary>
Motivation: To characterize chirality in quantum many-body systems through a quantum-information theoretic perspective, focusing on entangled states.

Method: Introduces many-body chirality as a condition under which complex conjugation cannot be achieved via finite-depth local operations, specifically in stabilizer realizations of $B_d^{(k)}$ anyon theories.

Result: Establishes that complex conjugation through local quantum channels is possible only if the anyon data are mirror invariant, highlighting forms of chirality undetected by traditional methods.

Conclusion: Demonstrates that $B_d^{(k)}$ states with $d>2$ show intrinsic many-body imaginarity, indicating their complex phase structure is not removable by finite-depth local unitaries, even if they are not chiral.
...
### [126] [Fidelity bounds for adiabatic gates and other quantum operations with time-dependent dissipation](https://arxiv.org/abs/2606.20501)
*Simon Pettersson Fors,Aniket Patel,Anton Frisk Kockum,Tahereh Abad*

Main category: quant-ph

TL;DR: This paper generalizes fidelity-reduction formulae for quantum operations to account for time-dependent dissipation, focusing on adiabatic controlled-Z gates in superconducting quantum computers.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of fidelity in quantum operations due to noise and time-dependent dissipation in quantum-computing architectures.

Method: The authors generalize existing analytical formulae for average gate fidelity to include time-dependent dissipation and analyze its impact on fidelity for adiabatic operations, particularly in the context of superconducting qubits.

Result: A new fidelity bound for adiabatic operations is derived, indicating that flux-dependent noise sensitivity significantly decreases the fidelity of controlled-Z gates in superconducting quantum computers.

Conclusion: The findings provide crucial theoretical tools for assessing error budgets and enhancing design in tunable quantum-computing systems, with implications for quantum-sensing and communication.
...
### [127] [General circuit mapping algorithm for neutral atom quantum computers](https://arxiv.org/abs/2606.20503)
*Neven Gentil,Lous S. Rianne,Aida Todri-Sanial*

Main category: quant-ph

TL;DR: This paper presents a mathematical framework and genetic algorithm for optimizing qubit transfers in neutral atom quantum computers to improve execution efficiency.


<details>
  <summary>Details</summary>
Motivation: To address the critical optimization challenge of qubit movement during circuit execution in neutral atom quantum computers.

Method: A graph-theoretic combinatorial optimization framework is used to model the qubit mapping problem as a nonlinear integer program solved via genetic algorithms.

Result: The proposed method consistently finds fewer qubit transfers compared to existing scalable compilers, with options to minimize either traveled distance or parallel operations.

Conclusion: The framework enhances execution efficiency on neutral atom quantum computers by facilitating hardware-aware mappings that reduce movement-related errors.
...
### [128] [Entropy Estimation in Multi-Qutrit Systems via Variational and Classical Neural Networks](https://arxiv.org/abs/2606.20504)
*Sai Sakunthala Guddanti,Anil Prabhakar,Ria Rushin Joseph*

Main category: quant-ph

TL;DR: This study explores von Neumann entropy estimation in multi-qutrit systems using variational quantum algorithms (VQAs) and convolutional neural networks (CNNs), revealing that while VQAs work well for small systems, CNNs excel in scalability and robustness for larger systems.


<details>
  <summary>Details</summary>
Motivation: Estimation of von Neumann entropy is crucial in quantum information theory as it provides insights into the disentanglement and state characteristics of multi-qutrit systems.

Method: The authors systematically evaluate two approaches: (1) VQAs using 11 SU(3)-inspired ansatzes for up to three qutrits and (2) CNNs trained on measurement outcomes from mutually unbiased bases for larger systems, particularly from two to five qutrits.

Result: The research found that the estimation accuracy with VQAs depends on trainable parameters and sufficient entanglement; for CNNs, stable predictions and improved performance with system size were achieved, requiring only 12.5% of full state tomography measurements to reach acceptable error rates.

Conclusion: Overall, VQAs are suitable for smaller systems, whereas CNN approaches show enhanced capacity to handle larger multi-qutrit systems, demonstrating a shift towards CNN-based estimators for improved scalability and robustness.
...
### [129] [Approximating optimal decoding of quantum LDPC codes with narrow frontiers](https://arxiv.org/abs/2606.20513)
*Anthony Leverrier,Rüdiger Urbanke*

Main category: quant-ph

TL;DR: The Frontier decoder is an efficient method for sparse quantum decoding that balances accuracy and complexity, achieving near-optimal results for specific codes with low latency.


<details>
  <summary>Details</summary>
Motivation: To address sparse quantum decoding problems more efficiently, particularly in the presence of noise, while controlling the computational complexity.

Method: The Frontier decoder uses a pruned dynamic programming approach that processes error variables systematically, merges similar error patterns, and approximates posterior probabilities effectively with a limited scope.

Result: The decoder achieves thresholds close to optimal for surface and color codes and shows significant performance improvement in the circuit-level noise model with a small retained list size.

Conclusion: The Frontier decoder demonstrates linear complexity and potential for low-latency implementation, making it suitable for practical quantum computing applications.
...
### [130] [GPU-accelerated semidefinite programming for causal games](https://arxiv.org/abs/2606.20519)
*Emanuel-Cristian Boghiu,Kyrylo Simonov*

Main category: quant-ph

TL;DR: This study examines quantum correlations in causal games, specifically focusing on strategies for the Guess-Your-Neighbour's-Input game. It finds that increasing local dimension beyond 5 does not significantly improve winning probabilities, hinting at the need for different strategies or potential looseness of the upper bound.


<details>
  <summary>Details</summary>
Motivation: To explore the effects of increasing local dimensions on the winning probabilities in causal games, particularly in the context of quantum correlations without fixed causal order.

Method: The authors employed a see-saw optimization scheme formulated as a semidefinite program and developed a GPU-accelerated solver to investigate local dimensions up to 8 in the Guess-Your-Neighbour's-Input game.

Result: The best strategy found achieved approximately 0.6218 with local dimension 5, and no significant improvements were observed with dimensions up to 8, indicating a potential need for different strategies or reconsideration of the upper bound of 0.7592.

Conclusion: Increasing local dimensions does not yield better winning probabilities than the existing strategy at d=5, suggesting either new strategic approaches are necessary or that the current upper bound is not tight.
...
### [131] [Near-Optimal Learning of Local Lindbladians](https://arxiv.org/abs/2606.20535)
*Itai Arad,Zhili Chen,Naixu Guo,Patrick Rebentrost,Zhan Yu*

Main category: quant-ph

TL;DR: The paper presents an algorithm for estimating local Lindbladians from black-box dynamics, achieving efficient learning without prior knowledge of the Lindbladian's support.


<details>
  <summary>Details</summary>
Motivation: To efficiently learn local Lindbladians, particularly Hamiltonian and dissipative coefficients, from a black-box access framework without prior information about the system.

Method: An algorithm utilizing finite-time channel probes and classical shadows to derive Lindbladian coefficients from Pauli transfer matrices through stable local Fourier inversions, with non-adaptive measurements.

Result: The algorithm achieves optimal scaling in terms of channel uses and total evolution time, with bounds established for adaptive methods; it shows that learning the dissipative dynamics is fundamentally different from Hamiltonian learning.

Conclusion: The results indicate that the learning algorithm is near-optimal, and achieving Heisenberg-limited scaling for Hamiltonian learning is infeasible when considering dissipative components.
...
### [132] [Topological Codes Based on Space Groups](https://arxiv.org/abs/2606.20548)
*Chong-Yuan Xu,Ze-Chuan Liu,Yong Xu*

Main category: quant-ph

TL;DR: This paper introduces space-group codes, a new class of topological codes that combine translations with point-group operations, expanding the design space for topological codes in quantum computing.


<details>
  <summary>Details</summary>
Motivation: To explore topological codes beyond the traditional assumption of translation invariance and to incorporate point group operations for enhanced designs.

Method: The authors develop a class of CSS codes called space-group codes, analyzing their topological properties through ring-modules and invariant theory.

Result: Space-group codes can exhibit greater locality than previously known translation-based codes, potentially simplifying practical implementation despite initial appearances to the contrary.

Conclusion: The study expands the landscape of topological codes, enabling more versatile design options within quantum computing frameworks.
...
### [133] [Benchmark of quantum algorithms for ground state preparation in the presence of noise](https://arxiv.org/abs/2606.20551)
*Daniel Molpeceres,Sirui Lu,J. Ignacio Cirac,Barbara Kraus*

Main category: quant-ph

TL;DR: This paper compares cooling, adiabatic, and optimization algorithms for ground-state preparation under noise using quadratic fermionic Hamiltonians, identifying conditions under which each algorithm excels.


<details>
  <summary>Details</summary>
Motivation: To understand the performance of various algorithms for preparing quantum ground states in the presence of noise.

Method: The authors analyze a family of quadratic fermionic Hamiltonians with depolarizing noise, examining the algorithms' effectiveness in different quantum phases through both analytical and numerical methods.

Result: Adiabatic methods are effective in the trivial phase, while a multi-frequency cooling algorithm performs better in the topological phase; the quantum approximate optimization algorithm is competitive in trivial phases but underperforms in topological regimes.

Conclusion: The cooling protocol shows improved robustness against parameter imperfections, suggesting its practical advantages for noisy quantum state preparation.
