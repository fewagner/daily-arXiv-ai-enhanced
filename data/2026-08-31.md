...
TL;DR: This paper explores the effects of data corruption on identifying extreme-lensing signatures in gravitational lensing around black holes, using spatiotemporal correlation functions derived from blurred movies.


<details>
  <summary>Details</summary>
Motivation: To understand the observational limitations and enhance the detection of gravitational lensing effects around black holes, particularly in light of upcoming observations of M87* and Sgr A*.

Method: The study develops a correlation function analysis to assess the impact of data corruption on identifying extreme-lensing signatures, comparing original and blurred movies derived from simulations.

Result: Corruptions in the observational data were found not to hinder the identification of extreme-lensing effects, with specific monitoring and cadence recommendations for M87* and Sgr A* observations.

Conclusion: A new analysis method was proposed, facilitating the reduction of complex datasets to a two-dimensional histogram for further black-hole parameter inference.
...
TL;DR: PolPy is a universal polarimetry tool for analyzing high-energy astrophysical transients, designed to standardize data formats and improve joint analysis between different instruments.


<details>
  <summary>Details</summary>
Motivation: The need for standardized analysis frameworks due to challenges in cross-instrument comparisons and joint multi-mission studies in high-energy astrophysics.

Method: PolPy serves as a plugin for the 3ML framework, providing standardized data formats, common reference frames, and a robust likelihood-based template-matching algorithm. Validation involved simulated GRBs analyzed through POLAR and Daksha models.

Result: PolPy effectively recovers injected polarization angles and fractions without bias, and simultaneous fits across instruments enhance parameter constraints.

Conclusion: By offering a unified methodology, PolPy facilitates reliable joint polarimetric analysis for current and future astrophysical missions.
...
TL;DR: JUG is a high-speed, independent pulsar timing package that efficiently processes complex datasets, offering both a Python API and GUI for interactive use, significantly outperforming existing tools.


<details>
  <summary>Details</summary>
Motivation: To provide an efficient and user-friendly solution for analyzing large pulsar timing array datasets without dependence on existing software.

Method: JUG implements a complete pulsar timing pipeline using JAX, focusing on fast data handling, clock corrections, and timing model fitting, and is designed for GPU use.

Result: JUG is over 50 times faster than PINT, can handle millions of arrival times, matches PINT's precision at the picosecond level, and recovers known timing model values reliably.

Conclusion: JUG's design and performance enhancements make it a superior option for pulsar timing data analysis, suitable for both frequentist and Bayesian approaches.
...
TL;DR: The paper proposes a new heterodyne detection architecture using mode-locked lasers and numerical correlation to enhance SNR and allow simultaneous J- and H-band operations for astronomical interferometry.


<details>
  <summary>Details</summary>
Motivation: To overcome sensitivity limitations in infrared heterodyne interferometry due to electronic detection bandwidth and shot noise, thus enabling better performance in long-baseline telescope arrays.

Method: The proposed architecture employs highly dispersed broadband pulses from a mode-locked laser, fast photoreceivers, and numerical correlation for spectral multiplexing, applied to a two-arm interferometer model.

Result: The experimental validation shows an SNR exceeding 2 at a spectral flux density of 188 pW/nm using a single-spectral-channel interferometer, with promising scaling for larger telescopes.

Conclusion: This approach significantly advances the capabilities of heterodyne interferometry by facilitating broadband spectral multiplexing and high-resolution imaging, potentially transforming astronomical observations in the J+H bands.
...
TL;DR: The CGEM radio telescope maps polarized Galactic foregrounds to assist in CMB B-mode searches, featuring optimized optics for minimal intensity to polarization leakage and showcasing strong early performance with observational data.


<details>
  <summary>Details</summary>
Motivation: To facilitate the detection of B-modes in the Cosmic Microwave Background by accurately mapping polarized Galactic foregrounds and minimizing leakage in measurements.

Method: The telescope uses an on-axis, hat feed optical design, optimizing optics through a novel framework that reduces simulated intensity to polarized intensity leakage, with a low-loss secondary mirror support made from Astroquartz composite.

Result: The optimized optics show T→P leakage significantly below projected C_ℓ^{BB} at r = 10^{-3}, and early performance is validated by observations, confirming high beam quality.

Conclusion: CGEM's design and early observations demonstrate its capability for effective CMB research, with excellent alignment between simulations and on-sky performance.
...
### [6] [Development, Configuration and Performance Characterization of a Scalable BETA ASIC-Based Readout System for Multi-Channel SiPM Detectors](https://arxiv.org/abs/2608.28287)
...
TL;DR: The paper discusses a scalable readout system designed using the BETA ASIC for multi-channel SiPM detectors, highlighting its noise performance, linearity, dynamic range, and power efficiency.


<details>
  <summary>Details</summary>
Motivation: To develop a robust readout system for spaceborne multi-channel SiPM detectors, meeting specific operational requirements.

Method: The system uses modular interface boards that integrate multiple BETA ASICs, controlled by an FPGA for configuration and data acquisition, tested with Hamamatsu SiPM arrays in a dedicated optical setup.

Result: Performance tests demonstrate effective gain calibration, linearity, threshold response, and a global internal trigger logic for ionizing particle detection, validating the system's performance metrics.

Conclusion: The BETA-based readout system is stable, scalable, and suitable for large-scale SiPM applications in space experiments.
...
### [7] [Design and implementation of an SLM-driven coherent differential imaging scheme](https://arxiv.org/abs/2608.28225)
*L. Lin,L. Marquis,R. Tandon,J. Kühn*

Main category: astro-ph.IM

TL;DR: This paper discusses a framework for using coherent differential imaging (CDI) with spatial light modulators to enhance direct imaging of exoplanets by reducing wavefront errors and speckles.


<details>
  <summary>Details</summary>
Motivation: To overcome the limitations of current direct imaging techniques for exoplanets affected by post-adaptive optics wavefront errors and quasi-static speckles.

Method: The authors propose a framework for an SLM-based CDI integrator and conduct simulations to analyze various parameters affecting its performance.

Result: Simulations reveal the impact of phase step variations, modulation ring width, planet separation, and contrast on exoplanet detection. Initial laboratory validation supports the numerical findings.

Conclusion: With advances in ultra-low-noise near-infrared detectors, time-domain CDI methods may effectively mitigate rapid wavefront errors, improving exoplanet imaging.
...
### [8] [The PLACID active coronagraphic imager instrument: commissioning status](https://arxiv.org/abs/2608.28226)
...
TL;DR: The PLACID coronagraph enables dynamic phase adjustment for high-contrast imaging, aimed at exoplanet and binary star observation, with expected operational readiness by early 2027.


<details>
  <summary>Details</summary>
Motivation: To enhance high-contrast imaging capabilities for astrophysical observations, addressing challenges in detecting exoplanets and related celestial objects.

Method: Utilizing a spatial light modulator for software-based adjustments of the focal-plane phase mask, installed on the 4-m DAG telescope with preliminary tests for alignment and calibration.

Result: Successful installation, optical alignment, and preliminary tests, indicating readiness for on-sky commissioning to achieve targeted imaging objectives.

Conclusion: PLACID is poised to facilitate advanced imaging of various astronomical entities by late 2026 or early 2027.
...
TL;DR: The paper presents methods for correcting velocities of meteors captured by cameras using rolling shutter technology, emphasizing the importance of determining the sensor's rolling period for accurate measurements.


<details>
  <summary>Details</summary>
Motivation: To ensure accurate determination of meteor velocities from video captured by rolling shutter cameras, as current specifications often lack rolling period data.

Method: The study discusses four experimental methods to determine the rolling period, highlighting the most accurate method using the New EXposure Timing Analyser (NEXTA).

Result: The paper provides a list of rolling periods measured for several different cameras, enabling better corrections in meteor velocity calculations.

Conclusion: Correcting for the rolling shutter effect is essential for accurate meteor velocity determination, and the presented methods facilitate this process.
...
TL;DR: The study quantifies the technological gap between JWST and HWO for exo-Earth imaging, identifying wavefront stability as a critical factor.


<details>
  <summary>Details</summary>
Motivation: To assess the capability of HWO in achieving exo-Earth imaging goals compared to JWST.

Method: Simulation of a JWST-like telescope with advanced coronagraph technology and wavefront control.

Result: Achieved $10^{-10}$ raw contrast for bright stars, but insufficient for fainter stars; required improvement in wavefront stability quantified.

Conclusion: Wavefront stability must be enhanced for HWO to meet its imaging objectives.
...
TL;DR: This paper introduces pyEDITH, a Python-based tool for simulating exposure times and S/N ratios for NASA's Habitable Worlds Observatory, enabling effective analysis of exoplanets.


<details>
  <summary>Details</summary>
Motivation: To facilitate the search for habitable planets by providing accurate simulations of astrophysical and instrumental noise.

Method: pyEDITH calculates wavelength-dependent exposure times and S/N ratios, adaptable to evolving mission requirements with a user-friendly interface.

Result: The code has been validated against existing tools and is available as open-source, supporting various skill levels in the scientific community.

Conclusion: pyEDITH aids in understanding HWO capabilities for exoplanet research and is integrated into scientific workflows.
...
TL;DR: This paper introduces a TensorFlow-based nested sampling implementation for Bayesian evidence computation that efficiently utilizes modern vectorized likelihoods.


<details>
  <summary>Details</summary>
Motivation: To enhance the efficiency of nested sampling methods, which are limited by their sequential structure, especially with modern vectorized likelihoods and emulators.

Method: The new sampler employs clustering and slice sampling, allowing for simultaneous updates of multiple live points, with bias corrections to account for batching.

Result: The sampler maintains accurate evidence estimates for moderate batch sizes, with results showing that up to 10% of live points can be effectively batched, alongside a significant decrease in wall-clock time in multi-dimensional settings.

Conclusion: The new implementation in 	extsc{best} significantly improves nested sampling efficiency, making it suitable for fast, vectorized likelihoods and emulator-based inference.
...
### [13] [Quantum Information at Infinity](https://arxiv.org/abs/2608.27498)
*L. Barbieri-Viale*

Main category: quant-ph

TL;DR: The paper introduces Quinfinity, a framework uniting quantum information and classical statistics through algebraic structures, revealing new insights into quantum mechanics and statistical behavior.


<details>
  <summary>Details</summary>
Motivation: To formalize and bridge quantum and classical information spaces, enhancing understanding of state behaviors and the underlying algebraic structures.

Method: The use of inverse limits of symbolic Quantum $N$-Spaces and the algebraic colimit of direct systems of real radical ideals to define the pure state pro-variety and to achieve structural regularization of quantum principles.

Result: The formalization leads to insights such as the identification of the pro-variety with the Fisher-Rao manifold and a new interpretation of the Heisenberg uncertainty principle at infinity.

Conclusion: This framework enables a deeper understanding of quantum information dynamics, particularly in relation to statistical mechanics, through innovative algebraic approaches.
...
### [14] [Quantized Low-Rank Quantum State Tomography: Hyperbolic Quantization and Riemannian Least-Squares Recovery](https://arxiv.org/abs/2608.27503)
*HanQin Cai,Longxiu Huang,Juntao You*

Main category: quant-ph

TL;DR: This paper introduces HyperQuant, a quantization method for low-rank quantum state tomography that maintains mean preservation and enables efficient recovery, validated by numerical experiments.


<details>
  <summary>Details</summary>
Motivation: To address biases in quantum state tomography caused by generic quantization methods.

Method: HyperQuant is developed as a mean-preserving hyperbolic quantizer tailored to second-moment scales; the paper establishes guarantees for distortion and recovery alongside a new Riemannian gradient method called QuantRGD.

Result: Minimax distortion guarantees and nonasymptotic recovery predictions are established, showing that finite-bit responses can retain error orders similar to unquantized averages with fewer bits; QuantRGD demonstrates linear convergence under specific conditions.

Conclusion: The findings support the efficacy of HyperQuant for low-rank quantum state tomography, enabling accurate recovery and efficient computation, as confirmed by numerical experiments.
...
### [15] [Reverse Quantum Mechanics](https://arxiv.org/abs/2608.27543)
*Gabriele Carcassi,Tobias Thrien,Christine A. Aidala*

Main category: quant-ph

TL;DR: Reverse Physics deconstructs physical theories to address issues in quantum mechanics, proposing new explanations and methods that unify classical and quantum mechanics under a cohesive framework.


<details>
  <summary>Details</summary>
Motivation: To clarify and resolve conflicts within existing quantum mechanical theories by breaking them down into logical relationships and addressing foundational issues.

Method: The methodology involves modifying the standard Hilbert-space formulation with minimal topological adjustments and utilizing ensemble spaces for theoretical distinctions.

Result: The work shows that unitary evolution aligns with deterministic processes, and it draws connections between various quantum states and classical mechanics through high-entropy limits.

Conclusion: These findings present a unified framework for understanding physical theories, applicable for teaching and future research in quantum mechanics.
...
### [16] [Pulling strings in real time: flux tube dynamics in (2+1)-d $\mathbb{Z}_2$-Higgs Gauge Theories](https://arxiv.org/abs/2608.27561)
*Zeno Bacciconi,Martina Frau,Luca Tagliacozzo,Michele Caselle,Marcello Dalmonte*

Main category: quant-ph

TL;DR: This paper explores two-dimensional flux-tube dynamics in a $	ext{Z}_2$ Higgs gauge theory using a new computational framework, revealing long-lived string dynamics and a prethermal regime.


<details>
  <summary>Details</summary>
Motivation: To investigate the complex dynamics of flux tubes in confinement across multiple spatial dimensions, which has been challenging for experiments and numerical simulations.

Method: The study utilizes the Clifford-augmented matrix product states (CAMPS) framework to enable larger system simulations and assess string theory predictions, including a novel string-pull protocol for real-time analysis.

Result: The simulations show that both universal spectral features and the behavior of flux tubes in various regimes align with effective string theory predictions, displaying collective dynamics and long-lived, localized behaviors.

Conclusion: These findings provide significant insights into the dynamics of strongly confined flux tubes, suggesting that effective string theory effectively captures the complexity of nonequilibrium dynamics in two-dimensional settings.
...
### [17] [Spectral Theory of Semisimple Bivariate Bicycle Codes](https://arxiv.org/abs/2608.27565)
*Eric Sabo,Mahir Bilen Can,David Marquis*

Main category: quant-ph

TL;DR: This paper presents an algebraic framework for bivariate bicycle codes by extending classical cyclic code theory, deriving logical dimensions, establishing minimum distance bounds, and developing a theory of code symmetries.


<details>
  <summary>Details</summary>
Motivation: The paper aims to advance the study of bivariate bicycle codes by providing a structured methodology that simplifies code generation and analysis.

Method: An algebraic approach is employed, utilizing Frobenius-orbit idempotents to derive formulas for logical dimensions and establish lower bounds on minimum distances.

Result: The formulation of code symmetries allowed for the construction of a structured block-monomial subgroup of coordinate permutations and demonstrated explicit code generation without numerical searches.

Conclusion: The work extends the understanding of bicycle codes and introduces systematic methods for their construction and analysis, with implications for BCH-based product codes.
...
### [18] [Quantifying the Dual-isotope Advantage for Ytterbium-array Surface Codes using Realistic Noise Models](https://arxiv.org/abs/2608.27568)
*Fumiyoshi Kobayashi,Toshi Kusano,Nicholas Fazio,Yuma Nakamura*

Main category: quant-ph

TL;DR: This study assesses the benefits of dual-isotope Yb architectures in neutral-atom quantum computers for reducing logical error rates during syndrome extraction, presenting a noise model and simulation results that highlight their advantages over single-isotope setups.


<details>
  <summary>Details</summary>
Motivation: To evaluate how systemic noise factors impact the performance of logical qubits in fault-tolerant quantum computing.

Method: Development of a Clifford-compatible noise model for dual-isotope Yb systems, leading to the creation of DualYbSim, an open-source simulation tool for analyzing performance under various conditions.

Result: Simulations reveal dual-isotope arrangements with in-place measurement significantly reduce logical error rates compared to single-isotope architectures.

Conclusion: Rydberg-state decay is identified as the primary error source, emphasizing the need for targeted experimental improvements to enhance fault-tolerant quantum computation.
...
### [19] [Quantum Resource Estimation for Simulating the SYK Model with Trotterization, qDRIFT, and Asymmetric Qubitization](https://arxiv.org/abs/2608.27573)
*Brian Goldsmith,Larissa Kroell,Nishna Aerabati*

Main category: quant-ph

TL;DR: This paper explores methods for simulating the SYK model on quantum computers, offering an open-source library for three simulation techniques.


<details>
  <summary>Details</summary>
Motivation: The SYK model's relevance to fault-tolerant quantum computing and its complex physics necessitates clear simulation strategies.

Method: We investigate Trotterization, qDRIFT, and asymmetric qubitization using PsiQuantum's Construct platform, providing an open-source library for each method.

Result: qDRIFT and Trotterization show lower qubit requirements, but asymmetric qubitization is more advantageous due to lower T gate counts.

Conclusion: The findings support theoretical predictions and aim to help researchers further study the SYK model with efficient simulation resources.
...
### [20] [Diamond optomechanical crystals for high-frequency strain and comb generation](https://arxiv.org/abs/2608.27581)
*Elham Zohari,Waleed El-Sayed,Aria Jafari,Ahmas El-hamamsy,Peyman Parsa,Joseph E. Losby,Natália C. Carvalho,Paul E. Barclay*

Main category: quant-ph

TL;DR: The paper presents a diamond optomechanical crystal cavity with high-frequency mechanical resonances and a frequency comb generation, enabling potential control of spin qubits.


<details>
  <summary>Details</summary>
Motivation: To advance quantum optomechanical technologies using diamond due to its favorable mechanical and optical properties.

Method: Demonstration of a diamond optomechanical crystal cavity supporting multiple 12 GHz mechanical resonances and analysis of its coupling and generated frequency comb.

Result: Generation of a frequency comb spanning 143 GHz with a mechanical oscillation amplitude of 130 pm and dynamic strain of $1.1 \times 10^{-3}$.

Conclusion: These results indicate the potential for effective optomechanical control of diamond spin qubits.
...
TL;DR: The paper presents a method to achieve quantum steering in networks, enabling observation at low detection efficiencies, thereby closing major loopholes in experiments.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the limited technological capabilities that have restricted the experimental observation of quantum nonlocality and steering, despite their significance.

Method: The authors propose a quantum network setup allowing for swap-steering between two parties at any non-zero detection efficiency, contingent on high visibility states generated by the sources.

Result: The study shows that with perfect sources, swap-steering is achievable even with low detection efficiency, facilitating entangled measurements regardless of detection limitations.

Conclusion: Using quantum networks, the paper concludes that major loopholes in quantum steering experiments can be effectively closed, enhancing the potential for practical applications.
...
### [22] [Plateau-Constrained Selection of Commuting Phase-Term Orderings Under a Fixed Maintained-Parity Compiler Contract](https://arxiv.org/abs/2608.27592)
*Owen Friedewald,Ali Shiri Sichani,Chi-Ren Shyu*

Main category: quant-ph

TL;DR: This paper explores the optimization of commuting phase terms using a two-stage permutation search, demonstrating a method that identifies equal optima and enhances quantum circuit efficiency.


<details>
  <summary>Details</summary>
Motivation: The motivation is to characterize and exploit multiple optimal solutions in commuting phase terms, which is crucial for improving quantum circuit performance.

Method: The authors employ a two-stage permutation search that certifies primary support optimum in Stage 1, and samples equal-cost tours in Stage 2, using fixed placements and maintained-parity quantum lowering.

Result: Experimental results on synthetic 16-qubit instances show significant reductions in routed controlled-NOT gates, with depth reductions across various sampled orderings and consistent performance across routing seeds.

Conclusion: While equal-primary-cost tours can enhance router-conditioned compiler flexibility, they do not guarantee improved hardware performance.
...
### [23] [Quantum SEDONet: Spectrally-Embedded Quantum Deep Operator Networks for Partial Differential Equations](https://arxiv.org/abs/2608.27626)
*Muhammad Abid,Arth Sojitra,Bipin Tiwari,Omer San*

Main category: quant-ph

TL;DR: Quantum SEDONet improves Quantum DeepONet by embedding spectral features based on boundary conditions, achieving significant accuracy gains in operator inference while maintaining quantum efficiency.


<details>
  <summary>Details</summary>
Motivation: To enhance the performance of Quantum DeepONet by addressing the limitations of its trunk network in learning oscillatory features from limited spectral structures.

Method: Quantum SEDONet employs coordinate-wise spectral basis assignment using Fourier and Chebyshev features, tailored to boundary conditions, without increasing quantum resource costs.

Result: Quantum SEDONet achieved a mean relative L2 error reduction of 54.1% for antiderivative tasks, 49.6% for advection, and 36.0% for Burgers, with consistent performance across benchmarks, and quantum-classical evaluations aligned to 10^-8.

Conclusion: The proposed method enables efficient quantum operator inference with enhanced accuracy through coordinated boundary-matched spectral embeddings.
...
### [24] [Machine Learning-Based Characterisation of the Non-Markovian Dynamics of a Nitrogen-Vacancy Centre](https://arxiv.org/abs/2608.27632)
*Tom Lannon,Mauro Paternostro,John Martin Gregg,Amit Kumar*

Main category: quant-ph

TL;DR: This paper presents a machine learning approach for reconstructing spectral density parameters from quantum system dynamics, outperforming previous methods by providing a comprehensive analysis of all parameters and validating results against established benchmarks.


<details>
  <summary>Details</summary>
Motivation: To optimize quantum technologies, it is essential to accurately characterize the interaction between quantum systems and their environments through spectral density functions.

Method: A machine learning model is employed to reconstruct reaction-coordinate spectral density parameters from the dynamics of NV centres, and performance is benchmarked against the Cramér-Rao bound and maximum likelihood estimator.

Result: The neural network reliably reproduces NV dynamics and provides parameter estimates with variances comparable to the maximum likelihood estimates, demonstrating its effectiveness.

Conclusion: The study illustrates a significant advancement in employing machine learning for spectral density parameter estimation in quantum systems, enhancing optimization in quantum technology applications.
...
### [25] [Topological Winding Readout of an Emergent Page-Wootters Clock](https://arxiv.org/abs/2608.27650)
*Hesam Zaravashan,Gabriele Gradoni,Mohsen Khalily*

Main category: quant-ph

TL;DR: The paper explores a photonic architecture utilizing the Page-Wootters construction to measure a topological invariant associated with a clock degree of freedom in a coupled microring array.


<details>
  <summary>Details</summary>
Motivation: To investigate if a clock degree of freedom can hold a topological invariant and explore new measurement techniques in photonics.

Method: A photonic architecture is proposed where signal–idler pairs undergo spontaneous four-wave mixing; a clock-system partition is formed to cyclically manipulate a Rice-Mele band through adiabatic changes, leading to measurable geometric phases.

Result: The setup allows for direct measurement of a topological invariant via readout processes that rely on traversing the Brillouin zone and reversing optical loops to isolate geometric phases, while maintaining resilience to noise.

Conclusion: The architecture provides a viable experimental framework for measuring topological invariants in quantum systems, facilitated by accessible parameters via thin-film lithium niobate technology.
...
TL;DR: The paper introduces a high-dimensional DSQC protocol utilizing Reed-Solomon coding for noise resilience, eliminating the need for quantum memory or entanglement and improving transmission rates with commercially available technology.


<details>
  <summary>Details</summary>
Motivation: The motivation is to enhance deterministic secure quantum communication by addressing challenges in noise resilience and implementation without prior key distribution.

Method: The authors propose a high-dimensional prepare and measure DSQC protocol that integrates Reed-Solomon erasure coding for error correction and data resilience.

Result: The proposed protocol successfully demonstrates higher data capacity and improved transmission rates while simplifying technology requirements.

Conclusion: The article concludes that the new protocol advances DSQC and makes practical quantum communication more accessible with its resilience and reduced resource demands.
...
TL;DR: The paper presents Logical Neural Belief Propagation (L-NBP), a novel quantum error correction decoder that enhances logical accuracy while maintaining linear complexity, outperforming traditional decoders on surface codes.


<details>
  <summary>Details</summary>
Motivation: Quantum error correction requires efficient decoders that provide high logical accuracy, especially for surface codes, where traditional decoders struggle.

Method: L-NBP uses a neural BP module to compute posterior beliefs, which are then processed by a logical classifier to produce a soft syndrome and predict the logical operator. The entire system is trained end-to-end using backpropagation.

Result: L-NBP matches or surpasses the performance of conventional decoders like BP-OSD and MWPM in terms of logical accuracy and achieves a threshold of $17.5\%$ under depolarizing noise, with only $0.2\%$ of the complexity of BP-OSD for distance-$9$ surface codes.

Conclusion: L-NBP effectively integrates belief propagation with neural networks and logical-level decoding, leading to scalable and accurate quantum decoding solutions.
...
TL;DR: This paper introduces a novel quantum algorithm for solving a variable-coefficient advection-diffusion equation, achieving efficient qubit usage and stable evolution.


<details>
  <summary>Details</summary>
Motivation: To develop a more efficient quantum algorithm for transport PDEs with variable coefficients and forcing that reduces the qubit requirement and enhances stability.

Method: The algorithm employs a skew-symmetric discretization to enable an ancilla-free unitary realization, using a Gray-code Trotter sequence for controlled rotations, with diffusion applied in the Fourier basis and classical source incorporation through Strang splitting.

Result: Simulation results show second-order temporal convergence and fourth-order accuracy via Richardson extrapolation, confirming efficacy across various grid sizes, while maintaining stable evolution without error growth across many time steps.

Conclusion: The proposed fixed-width kernel demonstrates significant qubit efficiency for quantum hardware applications, although challenges in classical readout and state re-preparation remain critical for implementation.
...
TL;DR: This paper addresses the tradeoff between reliability and scalability in topological quantum memories by evaluating decoder performance using a local recoverability diagnostic for the dephased toric code.


<details>
  <summary>Details</summary>
Motivation: The need for decoders that are both reliable (accurate near threshold) and scalable (fast and efficient) in topological quantum memories.

Method: An operational tradeoff is established using a decoder-level local recoverability diagnostic, comparing global MWPM corrections to quasi-local corrections, with quantification through the matching ratio $R_{\mathrm{match}}$ and its mismatch $ε_{\mathrm{match}}$.

Result: The analysis reveals strong buffer-controlled suppression of $ε_{\mathrm{match}}$, organized by a two-geometry scaling. A clear crossing is observed in $R_{\mathrm{match}}$ near $p\sim0.09$, indicating a growing recoverability scale.

Conclusion: Adaptive buffer selection and distance-scaled initialization for a composite quasi-local RG decoder improves performance, with logical-failure curves suggesting a threshold just below that of conventional MWPM.
...
TL;DR: This study explores how different quantum feature encoding strategies affect Quantum Support Vector Machine performance and circuit complexity, revealing that incorporating statistical relationships enhances classification but more complex circuits do not guarantee better outcomes.


<details>
  <summary>Details</summary>
Motivation: To understand how classical data encoding into quantum states impacts classification and circuit complexity in Quantum Machine Learning.

Method: Investigated various quantum feature encoding strategies, particularly using statistical relationships incorporated through specific quantum gates, in the context of Quantum Support Vector Machines applied to five binary classification datasets.

Result: Incorporating statistical relationships improved classification performance; however, more complex circuits did not consistently lead to superior results. A comprehensive evaluation metric was developed to assess performance alongside circuit cost.

Conclusion: The choice of quantum feature encoding should consider data structure, and predictive performance should be assessed with quantum circuit complexity in mind.
...
TL;DR: The study showcases the effectiveness of ABAA in enhancing Josephson junction tunability, achieving high precision and yield in quantum processors.


<details>
  <summary>Details</summary>
Motivation: To improve qubit frequency tuning and scaling in quantum processors while addressing fabrication variations.

Method: Characterization of ABAA tuning performance in a 150-mm wafer process, extending it for multi-channel tuning, and applying it to a quad-module quantum processor.

Result: Achieved a JJ resistance tuning precision of $σ=0.50	ext{±}0.05	ext{%}$ and a yield of $	ext{≥}98.8	ext{%}$, with a correlation between yield, tuning speed, and junction breakdown voltage.

Conclusion: ABAA tuning proves effective and scalable for high-precision targeting, essential for modular superconducting quantum processors.
...
TL;DR: This paper investigates a hybrid noiseless linear amplifier system comprising quantum scissors and squeezers, revealing how gain is enhanced through finite cutoff adjustments.


<details>
  <summary>Details</summary>
Motivation: To analyze how a noiseless linear amplifier can enhance optical state amplification while minimizing noise, contrasting with deterministic methods.

Method: The study employs a combination of a quantum-scissor NLA and two single-mode squeezers, examining gain enhancement as the cutoff increases, and tracking the performance in relation to fidelity and coherent amplitude phases.

Result: The analysis shows that with low cutoffs, enhancement stems from truncated Fock space, with cutoff 3 allowing contributions from both even and odd photon components, though affecting fidelity. Higher cutoffs improve fidelity but introduce phase dependency relative to squeezing axes.

Conclusion: The device's performance mimics ideal transformations with sufficiently high cutoffs, underscoring the significance of cutoff selection and phase orientation in achieving effective amplification.
...
TL;DR: This paper challenges the notion that environment suppresses quantum chaos by showing that a Majorana SYK model coupled to a Markovian bath can exhibit positive Lyapunov exponents, suggesting environments can induce many-body quantum chaos for certain conditions.


<details>
  <summary>Details</summary>
Motivation: To investigate the conditions under which quantum chaos persists in the presence of an environment, particularly in many-body systems.

Method: The authors compute the Lyapunov exponent of a $q$-body Majorana SYK model while considering its coupling to a Markovian bath with isotropic random $k > 2$-body Majoranas fields.

Result: The computed Lyapunov exponent is positive for any coupling strength to the bath, notably for $q=2$ (integrable case) and $q > 2$ (quantum chaotic case), revealing how many-body chaos can be induced by the environment.

Conclusion: The findings suggest a novel way to induce and control quantum scrambling in many-body systems, which may have implications for the development of quantum information technology.
...
TL;DR: The paper presents a DPU-based architecture for real-time quantum error correction using qLDPC codes, achieving significant performance improvements in throughput and latency compared to traditional CPU methods.


<details>
  <summary>Details</summary>
Motivation: The need for efficient classical decoding in quantum error correction, particularly with qLDPC codes, due to increasing syndrome workloads and the requirement for low-latency processing.

Method: Mapping the normalized Min-Sum BP decoding of the [[144,12,12]] Bivariate Bicycle qLDPC code onto a DPU-based Processing-in-Memory architecture, utilizing multiple DPUs to handle independent syndrome instances in parallel.

Result: Achieved an aggregate kernel throughput of 1.071 x 10^7 decodes/s with 2560 DPUs, an 8.8x improvement over a CPU, and maintained logical error rates below the physical error probability after two iterations, with latency under 1 ms for up to five iterations.

Conclusion: The DPU-based near-memory processing architecture offers high throughput and low latency for qLDPC BP decoding, demonstrating its potential for efficient quantum error correction.
...
TL;DR: This paper analyzes pulsed single-photon magnetometry utilizing a Zeeman-sensitive three-level system, focusing on how environmental coupling influences the extraction of magnetic-field information through scattering response.


<details>
  <summary>Details</summary>
Motivation: The study aims to enhance the efficiency of single-photon magnetometry, which is crucial for various applications in quantum sensing and measurement.

Method: The authors derive the output state and analyze the quantum Fisher information by decomposing it into distinct contributions from photon loss, spectral intensity, and spectral phase, while exploring the effects of environmental coupling on scattering responses.

Result: The research finds that critical coupling can optimize the information capture about magnetic fields and that the capacity to measure this information is improved by aligning real-frequency zeros of the scattering amplitude within the pulse bandwidth.

Conclusion: For longer Gaussian pulses, the additional contributions to spectral intensity and spectral phase information constraints diminish rapidly, indicating a potential for advanced magnetometry with high-resolution measurements.
...
TL;DR: This paper presents a graph-based transformer model for efficient estimation of multipartite entanglement in parameterized quantum circuits, addressing computational challenges in measuring entanglement.


<details>
  <summary>Details</summary>
Motivation: Multipartite entanglement is essential for the performance of parameterized quantum circuits in hybrid quantum-classical algorithms, yet measuring entanglement is computationally demanding.

Method: The authors propose the QIG-Fusion model, which uses a qubit-interconnected graph encoding that allows transformers to predict entanglement measures $Q_1$ and $Q_2$, improving over traditional methods.

Result: The QIG-Fusion model demonstrates high accuracy with RMSE values of 0.037 for $Q_2$ and 0.038 for $Q_1$, and achieves Spearman rank correlations of up to 0.95 on a dataset of 50,000 circuits.

Conclusion: This methodology streamlines the process of quantum architecture search by providing an efficient framework for estimating entanglement in large-scale quantum circuits.
...
TL;DR: This paper presents a novel method using a physics-constrained conditional GAN for efficient quantum state and process tomography, mitigating computational challenges associated with increasing qubit numbers.


<details>
  <summary>Details</summary>
Motivation: Standard quantum state and process tomography face computational limitations as qubit numbers increase, necessitating a more efficient approach.

Method: The authors propose a conditional GAN that learns a forward mapping from Pauli expectation values, integrating a Cholesky layer to enforce quantum properties like Hermiticity and positive semidefiniteness.

Result: Experiments show that the strength of the $L^1$ penalty affects the training coherence and convergence speed. Additionally, an over-complete measurement basis is needed for high-temperature states to minimize fluctuations.

Conclusion: The proposed method provides a scalable approach to quantum tomography, making it feasible for noisy intermediate-scale quantum devices by leveraging tensor-network structures.
...
TL;DR: This study examines the effects of spatial configuration and environment interactions on the coherence dynamics and work extraction in a two-qubit quantum battery.


<details>
  <summary>Details</summary>
Motivation: Understanding how spatial dynamics and environmental factors influence the performance of quantum batteries could enhance their design and efficiency.

Method: The analysis involves two-qubit systems with variable configurations and interactions, utilizing measures like local $l_{1}$-norm coherence and ergotropy under different noise conditions and thermal environments.

Result: Findings indicate that stronger exchange interactions can redistribute coherence but do not guarantee improved work retention, with spatial arrangement impacting extractable work efficiency.

Conclusion: The initial coherence distribution and arrangement significantly influence both local and collective work outputs in quantum batteries, revealing distinct performance characteristics.
...
TL;DR: The paper proposes a quantum generative model to generate high fidelity in silico patients, particularly for rare diseases, showing improved performance over classical models.


<details>
  <summary>Details</summary>
Motivation: To enhance clinical trial methods for rare or heterogeneous diseases using in silico approaches, overcoming limitations of classical models with scarce training data.

Method: A quantum generative model is developed to combine asymmetric databases into a quantum circuit, evaluated using Myelodysplastic Syndrome patient data.

Result: The quantum model outperforms classical generative models in generalization and expressivity metrics.

Conclusion: The proposed method demonstrates significant potential for generating high fidelity in silico patients, suggesting its utility for clinical trials.
...
TL;DR: This paper presents a fiber-based platform for Bell tests using time-bin entanglement that closes key experimental loopholes and certifies nonlocality with high precision, paving the way for practical quantum communication.


<details>
  <summary>Details</summary>
Motivation: The motivation is to explore the use of time-bin entanglement in closing loopholes in Bell tests, as previous works have not adequately addressed this, particularly with respect to the postselection loophole.

Method: The authors demonstrate a fiber-based platform that conducts Bell tests while simultaneously closing the locality, freedom-of-choice, and postselection loopholes, utilizing time-bin encoding for photonic entanglement.

Result: They report a CHSH violation of $S=2.583 \pm 0.002$, surpassing the local-realistic limit by over 265 standard deviations, at a distance of 49.0 m.

Conclusion: The results confirm the feasibility of time-bin entanglement for rigorous nonlocality certification and suggest its potential application in device-independent quantum communication and future quantum internet designs.
...
TL;DR: This paper extends adaptive Bell-test methods for entangled high-dimensional states using a CSPSA approach, demonstrating effective entanglement detection without reconstructing state density matrices.


<details>
  <summary>Details</summary>
Motivation: To improve entanglement detection methods for high-dimensional states, which are increasingly complex to characterize due to additional measurement parameters.

Method: The authors extend CSPSA to perform Bell tests using the CGLMP inequality for bipartite qudits, enabling detection of Bell-nonlocal correlations within both pure and mixed states.

Result: The method showed certified CGLMP violations from dimensions d=2 to d=8, even for isotropic mixed states at low visibility, and is more efficient in measurement configurations compared to traditional quantum state tomography.

Conclusion: The CSPSA approach provides an efficient and dimension-independent method for certifying high-dimensional entanglement, making it promising for practical quantum applications.
...
TL;DR: This study demonstrates that two qubits can exhibit quantum correlations via a shared cavity, influenced by driving methods and temperature. While discord can exist without entanglement at higher temperatures, a specific drive can create genuine entanglement, which diminishes as heating increases.


<details>
  <summary>Details</summary>
Motivation: To explore how different types of cavity-driven interactions impact the correlation between two qubits, specifically focusing on the relationship between quantum discord and entanglement.

Method: Utilizing a numerically exact master equation, the study examines the effects of various cavity drive configurations (parametric, coherent, resonantly modulated, and time-modulated parametric) on qubit correlations, concentrating on measurements of quantum discord and logarithmic negativity at varying temperatures.

Result: The results reveal that discord increases with cavity temperature for parametric, coherent, and resonantly modulated drives, while entanglement is only generated by the time-modulated parametric drive, reaching values of approximately 0.15-0.32 under specific conditions, before being weakened by heating effects.

Conclusion: The findings indicate a temperature-driven transition from entanglement to discord in qubits, with the parametric drive effectively preserving single-qubit coherence, and highlight the role of collective dephasing in generating discord without entanglement.
...
### [43] [Variationally Optimized Imaginary-time Polynomial Filters for Ground State Projection](https://arxiv.org/abs/2608.28357)
*Bahman Seifi,Ibsal Assi,J. P. F. LeBlanc*

Main category: quant-ph

TL;DR: Development of a variational framework for effective quantum state simulation via polynomial filtering, enhancing accuracy in imaginary-time evolution.


<details>
  <summary>Details</summary>
Motivation: Improve efficiency and stability in simulating quantum systems, particularly in finding ground-state energies.

Method: An imaginary-time evolution framework using polynomial filtering, focusing on variational formulas instead of traditional methods like Trotter-Suzuki decompositions.

Result: Significantly increased accuracy and stability in ground-state energy convergence, achieving enhanced success probabilities.

Conclusion: Variational polynomial filtering demonstrates superior performance over conventional methods, making it viable for higher-fidelity quantum computations.
...
### [44] [Quantum Federated Learning Based on Bures--Uhlmann Geometry for Heterogeneous Noisy Clients](https://arxiv.org/abs/2608.28379)
*Haruki Emori,Masaki Uchihara,Yuuki Tokunaga*

Main category: quant-ph

TL;DR: This paper extends quantum federated learning to mixed states, using a geometric approach to improve model training reliability in noisy quantum devices.


<details>
  <summary>Details</summary>
Motivation: The paper addresses challenges in quantum federated learning caused by data and hardware heterogeneity in noisy quantum devices that hinder accurate model training.

Method: The authors utilize the Bures metric and mean Uhlmann curvature from the mixed-state geometric tensor to create a local preconditioner and an aggregation rule that down-weights less reliable clients.

Result: Empirical evaluations showed that the method maintains high accuracy and outperforms standard federated averaging, especially in noisy conditions.

Conclusion: The proposed method offers significant improvements for collaborative learning in heterogeneous and noisy quantum environments, supported by theoretical guarantees.
...
### [45] [A Single Spin Switches the Steady-State Phase of an Open Quantum System](https://arxiv.org/abs/2608.28390)
*Jianwen Jie*

Main category: quant-ph

TL;DR: Adding a single spin to a many-body system can induce a significant change in the steady state beyond typical expectations, leading to a first-order dissipative phase transition under specific conditions.


<details>
  <summary>Details</summary>
Motivation: To challenge the conventional understanding that changing one constituent in a many-body system yields negligible effects on intensive observables, particularly in dissipative systems.

Method: The study employs a theoretical framework to analyze how the addition of a single spin alters the steady state between different phases, with special attention to parity and Dicke ladder sampling behavior at varying dissipation imbalances.

Result: The findings reveal a first-order phase transition along the odd-N sequence, whereby the addition of an integer spin creates transient states, while half-integer spins do not experience similar changes due to their connectivity properties.

Conclusion: This work presents a novel mechanism for controlling steady-state phases through the manipulation of jump-operator zeros, significantly deviating from previous models of sensing in dissipative systems.
...
### [46] [Energy Internet Routing using Quantum Optimization Algorithms](https://arxiv.org/abs/2608.28401)
*Alireza Alamgir Tehrani,Mehrdad Boroushaki,Abbas Rajabi*

Main category: quant-ph

TL;DR: The paper presents a new QUBO formulation to optimize energy routing in the Energy Internet, evaluating it against classical and quantum methods in two case studies.


<details>
  <summary>Details</summary>
Motivation: To enhance the integration of renewable energy sources with the energy grid through efficient energy routing methods, addressing the NP-hard nature of path selection.

Method: Introduced a QUBO and Ising Hamiltonian formulation, validated through quantum-inspired annealing and quantum gate optimization, tested on 9-node and 30-node EI networks.

Result: The proposed formulation matches the exact solution in simulations but with longer runtime compared to classical techniques, while the Simulated Annealing sampler performs the fastest among quantum options.

Conclusion: The study demonstrates the potential of quantum approaches in energy optimization, despite classical methods being more time-efficient.
...
### [47] [Optomechanical inertial reference for atom interferometry](https://arxiv.org/abs/2608.28418)
*A. Rajagopalan,K. Stolzenberg,D. Thomas,A. Herbst,S. Abend,E. M. Rasel,F. Guzmán,D. Schlippert*

Main category: quant-ph

TL;DR: This paper presents a hybrid sensor combining an atom interferometer and an optomechanical resonator to enhance sensitivity to inertial measurements and reduce vibration noise.


<details>
  <summary>Details</summary>
Motivation: The deployment of atom interferometers in environments outside the lab is limited due to vibration noise, which traditional methods mitigate using external sensors or bulky isolation systems.

Method: A hybrid sensor merges an optomechanical resonator with an atom interferometer, using the resonator's test mass as the interferometer's reference mirror, allowing for better correlation and static response from one component instead of two.

Result: The system achieves a displacement sensitivity of $8.6\cdot 10^{-15}$ m/$\sqrt{\mathrm{Hz}}$ and a minimum acceleration sensitivity of $1.1\cdot10^{-6}$ m/s$^2$/$\sqrt{\mathrm{Hz}}$ over a bandwidth from sub-Hertz to 2.5 kHz, effectively eliminating vibration-induced phase ambiguity for certain acceleration levels.

Conclusion: This integrated system surpasses the performance limits of conventional sensors, enabling broader application of atom interferometry in precision measurement without significant design constraints.
...
### [48] [Kerr nonlinearity and three-wave mixing in superconducting resonators hosting Al-InAs weak links](https://arxiv.org/abs/2608.28428)
...
TL;DR: The study explores a superconducting resonator with tunable cubic nonlinearity and suppressed quartic effects, demonstrating applications in quantum information processing.


<details>
  <summary>Details</summary>
Motivation: To engineer resonators with finite cubic nonlinearity while suppressing quartic terms for better quantum processing capabilities.

Method: Characterization of Kerr nonlinearity as a function of magnetic flux and gate bias in a superconducting resonator with two weak links from an aluminum-capped indium arsenide nanowire; experimental demonstration of three-wave mixing.

Result: Kerr nonlinearity can be tuned to zero via magnetic flux or gate bias, with successful observation of nonzero cubic nonlinearity.

Conclusion: Semiconductor-superconductor hybrid devices are validated as effective platforms for tunable nonlinear superconducting circuits with various quantum applications.
...
### [49] [From quantum reservoirs to quantum extreme learning machines through a nearest-neighbor spin chain with tunable quantum memory](https://arxiv.org/abs/2608.28440)
*Carlos Ramon-Escandell,Arnau Riera,Marcin Płodzień*

Main category: quant-ph

TL;DR: This paper connects Quantum Reservoir Computing (QRC) and Quantum Extreme-Learning Machines (QELM) through a shared architecture that varies memory retention based on qubit re-encoding length.


<details>
  <summary>Details</summary>
Motivation: To explore the relationship between QRC and QELM, demonstrating they represent extremes of a single computational framework based on input-encoding length.

Method: The study examines how varying the number of re-encoded qubits changes the system's behavior, utilizing Bayesian optimization to tune parameters like the reservoir Hamiltonian and evolution time.

Result: Recurrent quantum memory is vital for tasks requiring longer-term memory. For simpler tasks, a memoryless approach suffices. Optimal performance occurs at the edge of chaos, independent of connectivity type.

Conclusion: The findings underline the importance of dynamical regulation over connectivity in effective temporal data processing.
...
### [50] [Constant-time equilibration of observables under rapid Lindbladian dynamics](https://arxiv.org/abs/2608.28451)
*Štěpán Šmíd,Richard Meister,Mario Berta,Roberto Bondesan*

Main category: quant-ph

TL;DR: This paper introduces observable-specific mixing times in Markovian open-system dynamics, demonstrating faster equilibration for certain observables, leading to improved runtime for quantum algorithms and a classical algorithm with a linear scaling.


<details>
  <summary>Details</summary>
Motivation: To refine convergence measures in Markovian open systems, focusing on observables of physical relevance rather than global trace distance.

Method: Analyzed quasi-local Lindbladians and established that sums of geometrically local observables equilibrate in a time independent of system size; developed a classical algorithm for similar estimations with specific scaling characteristics.

Result: Asserts faster mixing for certain observables and shows linear runtime in system size for both quantum and classical algorithms, with no significant hidden constants in finite-size simulations.

Conclusion: The study presents a significant enhancement in runtime for quantum Gibbs samplers and lays groundwork for further exploration in non-traditional observables within open system dynamics.
...
### [51] [Fabrication-free assessment of microwave losses in germanium-based dielectrics and superconductors](https://arxiv.org/abs/2608.28463)
...
TL;DR: A flip-chip sensing method evaluates microwave losses in materials for quantum technologies, showing high losses in PtSiGe and improvements with Nb coating, aiding design for quantum circuits.


<details>
  <summary>Details</summary>
Motivation: To measure effective microwave losses in target materials for quantum technologies without requiring device fabrication on the materials themselves.

Method: A flip-chip-based sensing approach to quantify microwave losses in a strain-engineered Ge/SiGe quantum well heterostructure and other materials, utilizing microwave resonators for comparison.

Result: High microwave losses in PtSiGe limit its use as a superconductor, but Nb coating significantly reduces losses and enhances transport critical temperature.

Conclusion: Identifies constraints on material choices for quantum circuits and offers a quick testing method for evaluating new materials.
...
### [52] [Input-Output Analysis of Quantum Dot SUPER Excitation](https://arxiv.org/abs/2608.28470)
*Johannes Kerber,Christoph Hotter,Helmut Ritsch,Klaus Mølmer*

Main category: quant-ph

TL;DR: The SUPER scheme utilizes red detuned light for nearly complete excitation of two-level quantum emitters, analyzing its nonlinear dynamics and photon-number changes with a full quantum framework.


<details>
  <summary>Details</summary>
Motivation: Understanding efficient excitation methods for two-level quantum emitters is crucial in quantum optics and related technologies.

Method: The study uses a quantum input-output approach with a cumulant expansion to analyze coherent free-space pulses under the SUPER scheme, focusing on photon-number dynamics and high-fidelity inversion.

Result: The SUPER mechanism results in a photon-number change of -2 and +1 in two modes, requiring high pulse photon numbers for effective excitation, confirmed by full-quantum calculations.

Conclusion: High coherent-state amplitudes and adequate photon numbers are essential for implementing the SUPER mechanism effectively in practical applications.
...
### [53] [Approaching Resource-Theoretic Optimal Performance with Structured Environments](https://arxiv.org/abs/2608.28488)
*Lea Lautenbacher,Giovanni Spaventa,Susana F. Huelga,Martin B. Plenio*

Main category: quant-ph

TL;DR: The paper explores resource-theoretic bounds on thermodynamic efficiency through a model of photoisomerization, demonstrating how environmental memory can enhance permissible transformations in thermal operations.


<details>
  <summary>Details</summary>
Motivation: To investigate if resource-theoretic efficiency bounds can be approached in realistic dynamics involving system-environment interactions.

Method: A tunable microscopic model of a molecular photoswitch is coupled to a structured vibrational environment, allowing analysis from Markovian to non-Markovian regimes.

Result: It was found that Markovian Thermal Operations yield strictly lower results than general Thermal Operations, and environmental memory increases the set of available dynamical transformations.

Conclusion: Achieving the thermal operation bound depends critically on the coupling structure of the system-environment interactions that introduce memory into the dynamics.
...
### [54] [Classical Commitment over Quantum Channels with Limited Entanglement Assistance](https://arxiv.org/abs/2608.28500)
*Remi A. Chou*

Main category: quant-ph

TL;DR: This paper analyzes string commitment over quantum channels with limited preshared entanglement, establishing capacity limits for both noninteractive and interactive protocols.


<details>
  <summary>Details</summary>
Motivation: To understand the capabilities of quantum channels in string commitment scenarios, especially with the constraint of limited preshared entanglement.

Method: The study involves determining the commitment capacity of quantum channels characterized by Heisenberg–Weyl operators and random variables, with a focus on both noninteractive and interactive protocols.

Result: For noninteractive protocols, the commitment capacity is given by $	ext{min}igra{H(Z|F),	ext{log}_2d+Eigra}$. For interactive protocols, the rate cannot exceed $	ext{log}_2d+E$, limiting capacity when $H(Z|F) 	ext{ is greater than or equal to } 	ext{log}_2d+E$.

Conclusion: The findings clarify the commitment capacities of quantum channels, revealing significant limitations in interactive protocols under certain conditions.
...
### [55] [Langevin Theory of Non-Markovian Quantum Dynamics: Application to Delayed Coherent Feedback and the Laser Linewidth](https://arxiv.org/abs/2608.28506)
*Marc Cuenca-Laràs,Ming Li,Carlos Navarrete-Benlloch,Germán J. de Valcárcel*

Main category: quant-ph

TL;DR: The paper extends phase-space methods to non-Markovian open quantum systems, providing a general Langevin framework that integrates both deterministic and stochastic dynamics, applicable to various system sizes.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of extending phase-space methods for non-Markovian dynamics in open quantum systems, filling a significant gap in quantum dynamics analysis.

Method: The authors apply phase-space representations to the full system-environment interaction, resulting in Langevin equations characterized by deterministic contributions influenced by memory kernels and stochastic contributions that vanish under vacuum conditions.

Result: The framework successfully describes delayed coherent feedback effects, demonstrating the ability to predict narrowing of laser linewidths both above and just above the threshold, while scaling linearly with system size.

Conclusion: This work enables more systematic studies of non-Markovian driven-dissipative quantum systems, using phase-space methods that have been effective in Markovian dynamics.
...
### [56] [Sufficient positive maps between von Neumann algebras: Rényi divergences](https://arxiv.org/abs/2608.28510)
*Anna Jenčová,Lauritz van Luijk*

Main category: quant-ph

TL;DR: The paper establishes recovery theorems for $α$-$z$ Rényi divergences using positive maps and relaxes the requirement from 2-positivity to positivity, employing techniques related to JW*-subalgebras and $L^p$-spaces.


<details>
  <summary>Details</summary>
Motivation: The study enhances the understanding of recovery theorems in the context of von Neumann algebras by relaxing the previously necessary assumption of 2-positivity.

Method: The paper demonstrates the use of sufficiency conditions for JW*-subalgebras and $L^p$-spaces to address equality in data processing inequalities, while also resolving a significant problem related to conditional expectations.

Result: The findings indicate a successful relaxation of the 2-positivity requirement, and provide a framework for factoring conditional expectations of von Neumann algebras through JW*-subalgebras.

Conclusion: The results contribute to both the theoretical landscape of quantum information theory and practical applications regarding conditional expectations in von Neumann algebras.
...
### [57] [Beyond sensitivity: mechanism-resolved error budgets for designing quantum sensors](https://arxiv.org/abs/2608.28519)
...
TL;DR: The paper presents a framework to analyze quantum sensors by evaluating their sensitivity, accuracy, and robustness, attributing each to specific limiting mechanisms. The findings reveal significant trade-offs in sensor performance, particularly highlighting the risks of optimizing for sensitivity alone.


<details>
  <summary>Details</summary>
Motivation: To address the need for understanding and optimizing various performance metrics of quantum sensors beyond sensitivity, ensuring applications rely on accurate and reliable measurements.

Method: A computational framework is introduced that evaluates a sensor's sensitivity, accuracy, and robustness from an open-system simulation, linking each performance metric to its respective limiting mechanism.

Result: The analysis shows that for a nitrogen-vacancy diamond ensemble, different mechanisms limit sensitivity, accuracy, and robustness, indicating that focusing solely on sensitivity can lead to substantial inaccuracies in other metrics. Similar methodology applies to a cesium optically pumped magnetometer.

Conclusion: Implementing this framework allows for the design of quantum sensors that meet specific performance requirements by addressing the most critical limiting factors.
...
### [58] [Hardware-Efficient Error Mitigation and Shot-Efficient Sampling on IBM Quantum Hardware](https://arxiv.org/abs/2608.28535)
*Sumit Chongder*

Main category: quant-ph

TL;DR: This paper explores error mitigation techniques on superconducting quantum hardware, analyzing the impact of various factors on performance with a fixed execution budget.


<details>
  <summary>Details</summary>
Motivation: The motivation is to enhance the accuracy of quantum computations despite the limitations of current quantum hardware, focusing on effective error mitigation strategies.

Method: The authors use a combination of methods including qubit selection, circuit-depth scaling, zero-noise extrapolation, and repeated-shot estimation, organized across simulations and physical-device execution.

Result: The study quantifies how different mitigation strategies affect accuracy, revealing the balance between mitigation benefits and finite-shot fluctuations across various conditions.

Conclusion: The findings characterize the effective conditions for error mitigation in quantum processors and provide guidelines for shot allocation strategies within limited execution budgets.
...
### [59] [Exact quantification of nonlocal magic](https://arxiv.org/abs/2608.28563)
*Piotr Sierant*

Main category: quant-ph

TL;DR: This paper resolves how to measure nonlocal magic in pure multiqubit states by examining their entanglement spectra, revealing its role in resource-based quantum tasks and providing methods for practical experiments.


<details>
  <summary>Details</summary>
Motivation: To understand the distribution of 'magic' or nonstabilizerness in shared multiqubit states, particularly how much derives from correlations versus local bases.

Method: The authors compute the nonlocal magic of pure multiqubit states by measuring the distance of their entanglement spectrum from that of Bell pairs, addressing the optimization issue around local bases.

Result: They establish a direct relationship between nonlocal magic and a family of states that embezzle entanglement under local operations, demonstrating that the spectrum's distribution governs this property.

Conclusion: Nonlocal magic serves as a key indicator of quantum correlations and has practical implications for quantum simulations and experimentation.
...
### [60] [Quantum Fourier transform for the symmetric group](https://arxiv.org/abs/2608.28569)
*Carli Bruinsma,Dmitry Grinko,Maris Ozols*

Main category: quant-ph

TL;DR: This paper revisits and revises the quantum Fourier transform (QFT) construction for the symmetric group, enhancing gate complexity and providing a simpler realization.


<details>
  <summary>Details</summary>
Motivation: The motivation is to improve the gate complexity and circuit depth of the non-abelian QFT for the symmetric group, building on previous work by Kawano and Sekigawa.

Method: The authors perform a detailed analysis of the QFT construction, leading to revised gate complexity and circuit depth, and propose an optimized choice of transversal elements.

Result: Gate complexity is improved to \(\widetilde{\mathcal{O}}(n^{3.5})\) and circuit depth to \(\widetilde{\mathcal{O}}(n^3)\).

Conclusion: The paper concludes that the proposed realization of the symmetric group QFT is simpler and more efficient than previous constructions.
...
### [61] [Learning to Decode Concatenated Quantum Codes with Hierarchical Message Passing](https://arxiv.org/abs/2608.28571)
*Jiahui Wu,Chao Zhang,Zipeng Wu,Shilin Huang*

Main category: quant-ph

TL;DR: A neural message-passing framework enhances the decoding of concatenated stabilizer codes, achieving significantly improved thresholds compared to existing methods.


<details>
  <summary>Details</summary>
Motivation: To improve the efficiency and performance of decoding processes for concatenated stabilizer codes, particularly for quantum error correction.

Method: The proposed framework uses bidirectional soft belief propagation across concatenation levels with lightweight neural networks for message aggregation.

Result: The decoder for the concatenated [[15,7,3]] quantum Hamming code significantly raises the depolarizing pseudo-threshold from 6.5% to 12.3%, outperforming state-of-the-art decoders.

Conclusion: This framework offers a versatile tool for developing concatenated code decoders, facilitating advancements in low-overhead fault tolerance and enabling exploration of diverse code constructions.
...
### [62] [Quantum Fourier transform toolbox](https://arxiv.org/abs/2608.28573)
*Carli Bruinsma,Pietro M. Posta,Joppe Stokvis,Dmitry Grinko,Maris Ozols*

Main category: quant-ph

TL;DR: This paper presents two new methods for quantum Fourier transform (QFT) circuit construction, providing significant improvements for specific non-abelian groups.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the inefficiency of QFT circuits for non-abelian groups, which traditionally have limited efficient constructions compared to abelian groups.

Method: The authors develop QFT circuit construction methods using Mackey theory and Clifford theory, demonstrating polynomial scaling in relation to group size.

Result: The Mackey-theoretic approach leads to QFT circuits for $	ext{GL}_2(F_q)$ with polynomial scaling in $	ext{log } q$, while the Clifford-theoretic approach yields efficient circuits for wreath products, expanding the applicability beyond previous constraints.

Conclusion: These methods introduce systematic tools that enhance QFT construction for various finite groups, potentially allowing for exponential efficiency gains.
...
### [63] [How Long-Range Tails Reshape Non-Hermitian Spectra](https://arxiv.org/abs/2608.28577)
*Ding Gu,Zhanpeng Fu,Yu-Min Hu,Zhong Wang*

Main category: quant-ph

TL;DR: Non-Hermitian systems exhibit significant spectral changes due to infinitesimal long-range hoppings, challenging traditional tight-binding approximations.


<details>
  <summary>Details</summary>
Motivation: To investigate the effects of exponentially decaying long-range hoppings in non-Hermitian systems under open boundary conditions and the limitations of standard truncation methods.

Method: Analyzed the competition between the decay length of long-range hoppings and localization lengths of skin modes, deriving new spectral characteristics in one and higher dimensions.

Result: In one dimension, a squeezed GBZ emerges, replacing the conventional GBZ, while in higher dimensions, a squeezed amoeba structure describes the spectral density. Long-range hoppings can also significantly alter Green's function, observable in experiments.

Conclusion: Infinitesimal long-range hoppings lead to nonperturbative modifications in non-Hermitian systems, indicating that traditional finite-range truncation can be misleading.
...
### [64] [Detecting Axion-Like Particles With Coiled Optical Fibers I: Silica Fibers](https://arxiv.org/abs/2608.27551)
*Gia Dvali,Sebastian Zell,Tongxuan Zhang*

Main category: hep-ph

TL;DR: The paper presents a novel method for detecting axion-like particles using coiled optical fibers in magnetic fields, highlighting new theoretical insights and potential for enhanced signal detection.


<details>
  <summary>Details</summary>
Motivation: To improve detection methods for axion-like particles (ALPs) and explore new parameter regions in the search for these particles.

Method: The study develops a theoretical framework to explain photon-ALP conversion in coiled optical fibers, including transverse boundary conditions and fiber bending effects.

Result: The leading signal detected is a photon phase shift; solid silica fibers show minimal loss from ALP production, and specific conditions can enhance signals, particularly in hollow-core fibers.

Conclusion: The proposed setup offers a promising pathway for establishing new constraints on larger ALP masses and understanding boundary effects in fiber optics.
...
### [65] [Imperfect axions with no domain wall problem](https://arxiv.org/abs/2608.27553)
*Marco Gorghetto,Edward Hardy,Gilad Perez,Stefan Stelzl*

Main category: hep-ph

TL;DR: The paper addresses the domain wall problem in post-inflationary axion theories with multiple domain wall numbers. It finds a viable parameter space with additional PQ-violating operators that can prevent axion string formation before QCD axion potential matters, suggesting specific axion mass ranges and implications for neutron electric dipole moment experiments.


<details>
  <summary>Details</summary>
Motivation: To resolve the domain wall problem in post-inflationary axion theories with $N>1$, which can lead to cosmological difficulties due to stable domain walls.

Method: The authors use analytical methods and simulations to explore parameter spaces in these theories with extra PQ-violating operators, investigating their effects on axion dynamics and the resulting implications.

Result: The study identifies a viable parameter space where additional PQ violation eliminates axion strings before the QCD potential becomes relevant and suggests a QCD axion mass in the $10^{-3}-10^{-2}\,{m eV}$ range.

Conclusion: These findings indicate that the observed neutron electric dipole moment could approach current experimental limits, making it a feasible target for future experiments.
...
### [66] [KOFFEE: Kaon Observables at Future Fermilab Experimental Extensions](https://arxiv.org/abs/2608.27558)
*Cari Cesarotti,Samuel Homiller*

Main category: hep-ph

TL;DR: The paper proposes a rare-kaon program at Fermilab to explore $K^+	oπ^+νarν$ and $K_L	oπ^0νarν$ decays, enhancing measurements of the CKM matrix and probing new physics up to $	ext{O}(100)$ TeV.


<details>
  <summary>Details</summary>
Motivation: To improve precision in measuring the CKM matrix and its CP-violating phase, as well as to explore potential new physics beyond collider capabilities.

Method: A dedicated rare-kaon program utilizing Fermilab's high-intensity proton complex, estimating kaon flux and sensitivity thresholds for rare kaon decay modes.

Result: The program could achieve unprecedented precision in measuring the expected decays and probe new physics at energy scales up to $	ext{O}(100)$ TeV by using an effective field theory framework.

Conclusion: The proposed rare-kaon program at Fermilab has the potential to be a significant contributor to particle physics, allowing for crucial measurements while sharing resources with other high-energy programs.
...
### [67] [Next-to-Leading-Order Electroweak Corrections to Quantum Observables in Lepton-Lepton Collisions](https://arxiv.org/abs/2608.27559)
*Spencer Chang,Thomas Driscoll,Sokratis Trifinopoulos*

Main category: hep-ph

TL;DR: This study investigates the impact of virtual electroweak corrections on quantum observables like entanglement and magic in lepton--lepton collisions.


<details>
  <summary>Details</summary>
Motivation: To understand how electroweak corrections influence quantum properties in lepton colliders, which could offer insights into new physics.

Method: The authors treat outgoing particles as multi-qudit systems, calculating entanglement and stabilizer second Rényi entropy for specific collision processes at one-loop accuracy.

Result: Radiative corrections modify the final state's quantum structure, changing entanglement and magic regions compared to leading order predictions.

Conclusion: The findings suggest that quantum observables can serve as precision probes of electroweak dynamics and may aid in the search for new physics.
...
### [68] [A doubly critical point in the color-superconducting regime of the RG-consistent NJL model](https://arxiv.org/abs/2608.27677)
*Hosein Gholami,Marco Hofmann,Michael Buballa*

Main category: hep-ph

TL;DR: The study addresses cutoff artifacts in NJL models of quark matter by applying RG consistent regularization, mapping the phase diagram, and identifying gapless domains, particularly focusing on the melting of the CFL phase.


<details>
  <summary>Details</summary>
Motivation: To eliminate cutoff artifacts in NJL models of quark matter and accurately describe phase transitions in beta-equilibrated quark matter.

Method: A systematic study using the three-flavor NJL model with RG consistent regularization, varying the scalar diquark coupling to analyze the phase diagram across chemical potential and temperature.

Result: The research identified distinct phases, including $dSC$ and $uSC$, and demonstrated a doubly critical point where these phases meet, validating long-held theoretical predictions.

Conclusion: Renormalization-group consistent regularization reveals a complex phase structure of neutral beta-equilibrated quark matter, including explicitly the anticipated doubly critical point.
...
### [69] [Constraining Light and Strange Flavor Equilibration in Relativistic Heavy-Ion Collisions](https://arxiv.org/abs/2608.27687)
*Andrew Gordeev*

Main category: hep-ph

TL;DR: This dissertation explores the chemical equilibration of light and strange quarks during the hydrodynamic phase of relativistic heavy-ion collisions, introducing a framework that considers time-dependent quark fugacities and their effects on hydrodynamic evolution and observables.


<details>
  <summary>Details</summary>
Motivation: To address the uncertainty in the assumption that quark and gluon compositions reach chemical equilibrium by the start of the hydrodynamic phase in relativistic heavy-ion collisions.

Method: The dissertation develops a dynamical framework incorporating time-dependent quark fugacities within a multistage model that includes fluctuating initial conditions, viscous hydrodynamics, particlization, and hadronic transport, and employs Bayesian analysis with Gaussian process emulators for data inference.

Result: The analysis indicates that strange quarks begin extensively undersaturated compared to light quarks and exhibits slower equilibration timescales for strangeness, although these timescales are not well-constrained by data.

Conclusion: The findings suggest that the quark-gluon plasma's flavor composition may still be approaching chemical equilibrium during the hydrodynamic phase, prompting further investigation into different collision systems.
...
### [70] [Future of Artificial Intelligence for Science in Japan 2024 Community Report](https://arxiv.org/abs/2608.27807)
...
TL;DR: The paper identifies AI/ML research opportunities in accelerator physics, cosmology, and neutrino physics, highlighting common technical challenges.


<details>
  <summary>Details</summary>
Motivation: To explore scientific challenges and research opportunities in AI/ML through collaborative discussions in physics domains.

Method: Gather insights from the FAIRS Japan 2024 unconference process targeting three physics areas.

Result: Identification of shared technical themes across three distinct domains: reconstruction, simulation, uncertainty, anomaly detection, decision-making, and infrastructure.

Conclusion: Despite distinct goals in each physics area, commonalities in technical challenges suggest potential for unified AI/ML research approaches.
...
### [71] [Vector-boson-fusion timing references for four-dimensional displaced-vertex searches](https://arxiv.org/abs/2608.27868)
*Renjie Wang*

Main category: hep-ph

TL;DR: This paper examines the detection of long-lived particles through the spatial displacement of decay vertices and utilizes precision timing techniques at the High Luminosity LHC (HL-LHC) to enhance detection sensitivity.


<details>
  <summary>Details</summary>
Motivation: The study aims to improve the search for long-lived particles by leveraging precision timing layers that can provide additional insights into displaced vertex searches, which traditionally do not utilize timing information.

Method: The authors analyze the exotic decay of a Higgs boson produced via vector-boson fusion, focusing on the decay pathways of the Higgs and the resultant particle tracks. A normalization-free figure of merit is used to compare timing-enhanced and spatial-only sensitivity, taking advantage of timing data from a CMS-MTD-like barrel layer.

Result: The introduction of the timing layer leads to an enhancement in sensitivity by a factor of approximately 2.8 in nominal conditions, with possible improvements of up to an order of magnitude under stringent vertex delay requirements, especially affecting high-background conditions.

Conclusion: The timing layer significantly extends detection sensitivity for long-lived particles in a mass-independent manner, particularly benefiting searches for lighter scalars at short lifetimes and heavier scalars at longer lifetimes.
...
### [72] [Deep-neural-network extraction of unpolarized transverse-momentum-dependent parton distributions in $b_T$ space from Drell-Yan data](https://arxiv.org/abs/2608.27907)
*I. P. Fernando,D. Keller*

Main category: hep-ph

TL;DR: This paper introduces a method for extracting unpolarized transverse-momentum-dependent parton distribution functions (TMDPDFs) from Drell-Yan data using physics-informed deep neural networks, emphasizing a smooth TMD ensemble and robust validation techniques.


<details>
  <summary>Details</summary>
Motivation: To enhance the extraction of TMDPDFs in impact-parameter space using advanced computational techniques while ensuring precision and stability in results obtained from Drell-Yan processes.

Method: A physics-informed deep neural network is employed to extract TMDPDFs by computing the perturbative contributions with resummed W terms, utilizing N3LL evolution alongside fixed collinear PDFs and Fourier-Bessel transforms.

Result: The study yields a smooth light-flavor $b_T$-space TMD ensemble validated against cross-section levels; results are stable across various robustness tests and fixed nonperturbative factors.

Conclusion: The methodology provides a reliable framework for TMDPDF extraction, offering stable results and contributing to the understanding of partonic structure through advanced modeling approaches.
...
### [73] [Celestial probes of dark matter electromagnetic interactions](https://arxiv.org/abs/2608.27957)
*Alejandro Ibarra,Merlin Reichard,Gaurav Tomar*

Main category: hep-ph

TL;DR: This paper analyzes the neutrino flux from the Sun and Earth and the heating effects on Jupiter and white dwarfs due to dark matter annihilation. It establishes constraints on the electromagnetic moments of dark matter using celestial observations and compares these with results from direct investigations.


<details>
  <summary>Details</summary>
Motivation: The study aims to enhance understanding of dark matter by investigating electromagnetic interactions in celestial contexts, which may reveal new constraints on dark matter properties.

Method: The authors derive constraints on the electromagnetic moments of dark matter by examining neutrino flux and heating patterns in celestial bodies, correlating these findings with existing data from laboratory and astrophysical experiments.

Result: Celestial bodies, notably the Earth and white dwarfs, are identified as significant sources of constraints on dark matter parameters, particularly for millicharged dark matter and electromagnetic moments in regions overlooked by direct searches.

Conclusion: The research demonstrates the importance of using celestial phenomena to complement direct dark matter searches, emphasizing the insightful relationships between these approaches for understanding dark matter's properties.
...
### [74] [CGC and saturation approach: Impact-parameter dependent model of perturbative QCD and combined HERA data](https://arxiv.org/abs/2311.06406)
*Michael Roa,José Garrido,Miguel Guevara*

Main category: hep-ph

TL;DR: This paper investigates the CGC/saturation model against HERA data, using a non-linear BK evolution equation and a novel saturation momentum dependent on impact parameter.


<details>
  <summary>Details</summary>
Motivation: To provide a reliable theoretical framework for analyzing high-energy QCD processes, particularly in light of new experimental data from HERA and future facilities.

Method: Employs the non-linear Balitsky-Kovchegov evolution equation and models saturation momentum as an exponential function of impact parameter, comparing results with various experimental observables.

Result: Achieves good agreement with experimental observations for various structure functions and exclusive production processes at small-$x$ across a wide kinematic range.

Conclusion: The findings strengthen the applicability of the CGC/saturation framework for future high-energy experiments and help refine predictions based on first principles.
...
### [75] [Magnetic Moments and Radiative Transitions of the $T_{cc}(3875)^+$ and its partner states](https://arxiv.org/abs/2608.27961)
*Jing Wu,Yi-Kun Wang,Kai-Bao Chen,Yan-Rui Liu,Jian-Bo Cheng,Wei-Hua Yang*

Main category: hep-ph

TL;DR: This paper investigates the magnetic moments and decay widths of S-wave doubly heavy tetraquarks, using chromomagnetic interaction to differentiate between compact and molecular structures.


<details>
  <summary>Details</summary>
Motivation: To provide a method of distinguishing compact tetraquark structures from molecular states and to predict their magnetic moments and decay properties.

Method: The authors used chromomagnetic interaction eigenvectors to compute magnetic moments and M1 transition rates for compact tetraquark states.

Result: Predicted magnetic moments for the observed $T_{cc}(3875)^+$ as 0.45 $μ_N$, in contrast to $-0.07 μ_N$ for the molecular model, with five radiative transition widths varying from 6.07 keV to 306.37 keV identified.

Conclusion: The findings enhance the understanding of tetraquark structures and provide a basis for future research in particle physics.
...
### [76] [Quantum computation of partonic Drell-Yan scattering cross sections and interference effects](https://arxiv.org/abs/2608.28057)
*Erik Bashore,Stefano Moretti,Timea Vitos*

Main category: hep-ph

TL;DR: This paper explores constructing Feynman diagrams in quantum devices, focusing on Drell-Yan lepton pair creation and developing quantum gates for efficient amplitude computation.


<details>
  <summary>Details</summary>
Motivation: To provide a framework for efficiently utilizing quantum devices in particle physics, specifically for complex scattering processes.

Method: The authors design quantum gates that utilize Feynman rules to perform computations for Drell-Yan lepton pair creation, facilitating simultaneous amplitude calculations and interference analysis.

Result: They demonstrate a quantum circuit capable of computing integrated cross-sections and isolating interference effects in scattering diagrams through a basis rotation.

Conclusion: This work progresses towards a versatile approach for computing arbitrary scattering processes and enhances the analysis of interference in quantum physics.
...
### [77] [Expansion attractor in classical Yang-Mills theory](https://arxiv.org/abs/2608.28106)
*Clemens Werthmann*

Main category: hep-ph

TL;DR: The paper explores hydrodynamic attractors beyond heavy ion collisions, focusing on systems that do not hydrodynamize but still exhibit memory loss through expansion, identifying three distinct behavior stages over time.


<details>
  <summary>Details</summary>
Motivation: To generalize the understanding of hydrodynamic attractors beyond specific scenarios and identify universal characteristics.

Method: The authors analyze a non-hydrodynamizing system's behavior through its evolution stages: initial memory loss, intermediate restoration, and late-stage information shuffling.

Result: The study reveals that early expansion drives a convergence in the energy density ratio, while interactions later affect memory retention without loss.

Conclusion: The findings highlight that memory dynamics in expanding systems can follow non-trivial patterns that are not exclusive to hydrodynamic contexts.
...
### [78] [Fixed points of the CKM matrix renormalization group running to all orders in perturbation theory](https://arxiv.org/abs/2608.28149)
*Brian P Dolan*

Main category: hep-ph

TL;DR: The paper proves that the six fixed points of the massless 1-loop renormalization group for the CKM matrix are fixed at all orders in perturbation theory.


<details>
  <summary>Details</summary>
Motivation: To establish the universality of fixed points in the context of the CKM matrix without additional assumptions.

Method: The proof builds on previous findings while eliminating the need for an extra assumption regarding the running of the matrix.

Result: Confirming that the six fixed points remain invariant across all perturbative orders without extra conditions.

Conclusion: This demonstrates the robustness of the fixed points in the CKM matrix within the Standard Model framework.
...
### [79] [Three-loop QCD corrections to heavy-to-light form factors and applications to inclusive $B$ decays](https://arxiv.org/abs/2608.28172)
*Matteo Fael,Tobias Huber,Fabian Lange,Jakob Müller,Kay Schönwald,Matthias Steinhauser*

Main category: hep-ph

TL;DR: This paper presents calculations of heavy-to-light form factors at N$^3$LO for inclusive $B$-decays, detailing a loop calculation and its implications for decay rates and the determination of $|V_{ub}|$.


<details>
  <summary>Details</summary>
Motivation: To enhance the precision of decay rate calculations in inclusive $B$ decays and improve the determination of the CKM matrix element $|V_{ub}|$.

Method: Calculation of heavy-to-light form factors at N$^3$LO, extracting hard functions, and establishing relations for heavy-quark parameters in the shape-function scheme up to four loops.

Result: Preliminary results on N$^3$LO corrections to decay rates in $ar B 	o X_u l ar ν_l$, and improved models for the $B$ meson shape-function.

Conclusion: The study provides significant improvements in theoretical understanding and precision of heavy-quark parameters affecting $B$-decay phenomenology.
...
### [80] [System-size dependence of strangeness production from p+p to Pb+Pb: quantitative tests of the $K^+/π^+$ horn](https://arxiv.org/abs/2608.28189)
*Neeraj,Amal Sarkar*

Main category: hep-ph

TL;DR: The study investigates the $K^+/π^+$ excitation function across various collision systems, revealing differing frameworks for data interpretation and highlighting the complexity of strangeness dependence on system size.


<details>
  <summary>Details</summary>
Motivation: Understanding the $K^+/π^+$ excitation function's dependence on system size in heavy-ion collisions, particularly the pronounced maximum known as the 'horn'.

Method: The analysis utilizes hadronic and partonic transport models, alongside statistical models, to compare experimental data from multiple collision systems using $χ^2$ quantification.

Result: No single model explains the data comprehensively; core-corona fits intermediate systems, while SMES is applicable to heavy systems. Supported evidence shows significant strangeness enhancement in heavier systems with distinct stepping in $K^+/π^+$ ratios.

Conclusion: Preliminary results indicate a preference for core-corona modeling over hadronic approaches, emphasizing the need for refined data to further clarify results.
...
### [81] [Minimal-Length Deformations of Chiral Quark Matter in a 2+1-Flavor NJL Model](https://arxiv.org/abs/2608.28201)
*Sameer Ahmad Mir*

Main category: hep-ph

TL;DR: This paper explores a minimal-length deformation of chiral quark matter using a Nambu-Jona-Lasinio model, revealing how it impacts chiral symmetry breaking and thermodynamic properties.


<details>
  <summary>Details</summary>
Motivation: To understand the effects of minimal-length deformations on chiral quark matter and their implications for thermodynamic properties in high-density environments.

Method: Utilizing a 2+1-flavor Nambu-Jona-Lasinio framework and a Jacobi-consistent three-dimensional quadratic GUP algebra to modify the phase-space density while maintaining quasiparticle spectra, ultimately deriving coupled gap equations.

Result: The analysis indicates that ultraviolet phase-space suppression diminishes dynamical chiral symmetry breaking, reduces constituent masses, and alters the chiral transition boundary towards lower temperatures and chemical potentials.

Conclusion: The findings present an effective model illustrating how minimal-length deformations can reorganize chiral dynamics and influence quark-matter thermodynamics.
...
### [82] [Investigation of S-wave tetraquark bound and resonant states with all Jacobi coordinates](https://arxiv.org/abs/2608.28284)
*Xin-He Zheng,Yao Ma,Liang-Zhen Wen,Shi-Lin Zhu*

Main category: hep-ph

TL;DR: The study explores $S$-wave tetraquark systems using a quark potential model, revealing the importance of K-type configurations for identifying resonances and challenges in interpreting certain states.


<details>
  <summary>Details</summary>
Motivation: To understand the structure and properties of diverse $S$-wave tetraquark systems, enhancing the identification of their bound and resonant states.

Method: Adopting the constituent quark potential model, we incorporate various Jacobi coordinates, optimize basis expansions via stochastic methods, and use complex scaling to analyze bound and resonant states.

Result: Incorporating K-type configurations enables the identification of higher-energy resonances that are missed in conventional H-type analyses; resonance candidates for the $T_{cs0}(2900)$ and others are identified, while certain compact tetraquark interpretations face challenges.

Conclusion: The findings emphasize the necessity of K-type configurations for accurate resonance extraction and question the classification of some existing states as compact tetraquarks.
...
### [83] [HEPToolBench 1.2: Testing How Reliably Language Models Can Drive Particle Physics Software](https://arxiv.org/abs/2608.28232)
*Aadarsh Singh,Sudhir K. Vempati*

Main category: hep-ph

TL;DR: HEPToolBench benchmarks natural-language requests for collider-simulation tasks, showing structured interfaces significantly improve the generation of machine-readable outputs compared to native syntax.


<details>
  <summary>Details</summary>
Motivation: To enable scientists to interact with research software using natural language while ensuring the generated outputs are correct, machine-readable artifacts.

Method: Introduced HEPToolBench with 28 collider-simulation tasks evaluated by deterministic, task-specific scorers; compared outputs using direct native syntax versus a structured debugging interface.

Result: Using structured interfaces, average scores rose from 0.418 to 0.902, and task passes improved significantly from 21/210 to 159/210 across multiple model deployments.

Conclusion: Transitioning syntax generation into deterministic software enhances reliability for various models, making it more effective for accurate scientific computations.
...
### [84] [HEPLocalAgent 1.0: Running Collider Simulations from Plain-Language Requests on Your Own Computer](https://arxiv.org/abs/2608.28244)
*Aadarsh Singh,Sudhir K. Vempati*

Main category: hep-ph

TL;DR: HEPLocalAgent is a local interface for collider simulation workflows driven by natural language, demonstrating improvements in artifact generation and validation through a deterministic pipeline, but requiring expert review due to its current limitations.


<details>
  <summary>Details</summary>
Motivation: To create a user-friendly interface that enables the construction of collider simulation workflows from natural language inputs, thereby streamlining the simulation process in high energy physics (HEP).

Method: The system employs a locally served language model to interpret user requests, generate a typed workflow, validate it via deterministic software, and present results for user approval before execution.

Result: In comparative evaluations, the system improved from 7 to 19 satisfying artifacts using the full pipeline, while the fixed representation normalization showed an increase from 11 to 43 artifacts, despite discrepancies in bookkeeping conventions between the builder and bench markers.

Conclusion: HEPLocalAgent is a prototype that produces validated workflows, but is not yet an autonomous tool; expert approval is necessary to ensure accuracy and safety in execution.
...
### [85] [Color screening versus thermal decay as the mechanism of $Υ$ suppression in high energy nuclear collisions](https://arxiv.org/abs/2608.28277)
*Yida Yang,Baoyi Chen,Jiaxing Zhao,Pengfei Zhuang*

Main category: hep-ph

TL;DR: The study investigates the suppression mechanisms of $Υ$ production in heavy-ion collisions, concluding that thermal decay is responsible for suppression rather than color screening.


<details>
  <summary>Details</summary>
Motivation: To understand the mechanisms of heavy quarkonium suppression during relativistic heavy-ion collisions.

Method: The transport equation for $Υ$ production is solved using suppression rates, and the nuclear modification factor is computed and compared with experimental data.

Result: The study shows that while color-screening cannot explain both ground and excited states of $Υ$, thermal decay aligns well with the observed data.

Conclusion: This indicates that inelastic scatterings with thermal partons are the primary cause of quarkonium suppression in heavy-ion collisions.
...
### [86] [Searching for vectorlike $T$ quarks in the $T\to tZ$ channel at a future muon-proton collider](https://arxiv.org/abs/2608.28285)
*Yin-Hao Gao,Yao-Bei Liu*

Main category: hep-ph

TL;DR: The paper explores the discovery potential of singly produced vector-like top quarks decaying to a top and Z boson at future muon-proton colliders across three energy benchmarks, finding the decay mode to be highly sensitive for high-mass quark detection.


<details>
  <summary>Details</summary>
Motivation: To assess the discovery potential of vector-like top quarks in the context of future muon-proton colliders, leveraging the unique decay channel to enhance sensitivity.

Method: The authors perform full detector-level Monte Carlo simulations for signal and Standard Model backgrounds, deriving discovery contours and exclusion limits based on the vector-like quark mass and coupling.

Result: They find that the $T\to tZ$ decay channel offers complementary sensitivity compared to other decay modes, specifically enhancing the detection of high-mass vector-like top quarks.

Conclusion: The research underscores the advantages of using the $T\to tZ$ decay mode in muon-proton colliders for probing vector-like top quarks, particularly in a boosted jet topology.
...
### [87] [Effect of Thermal Broadening on Light Hadron Production in Heavy-Ion Collisions](https://arxiv.org/abs/2608.28456)
*Q'inich Coc,Oscar Garcia-Montero,Aleksas Mazeliauskas*

Main category: hep-ph

TL;DR: This study investigates the impact of thermal broadening of light vector-meson spectral functions on hadron production in heavy-ion collisions, revealing a notable increase in low-momentum pion spectra.


<details>
  <summary>Details</summary>
Motivation: To address the discrepancy between hadron yields in heavy-ion collisions and thermal particle production models by considering in-medium effects in spectral functions.

Method: The authors generalize the FastReso decay framework for resonances with finite-width spectral functions, computing spectra for pions, kaons, and protons using a simultaneous blast-wave fit to data from Pb-Pb and Xe-Xe collisions at the LHC.

Result: Thermally broadened ρ and ω mesons lead to an increase in low-momentum pion spectra, which helps mitigate the gap between theoretical predictions and experimental data but does not fully resolve the soft pion puzzle.

Conclusion: The inclusion of finite-resonance widths improves the agreement between model predictions and measured hadron distributions but leaves the issue of the soft pion puzzle unresolved.
...
### [88] [Impact of NLO EW and QCD corrections to dimension-6 SMEFT coefficients constraints in Higgs decays](https://arxiv.org/abs/2608.28464)
...
TL;DR: The paper discusses how next-to-leading-order corrections influence Higgs decay predictions in the context of the Standard Model Effective Field Theory, highlighting their significance for future measurements at the HL-LHC.


<details>
  <summary>Details</summary>
Motivation: To improve Higgs and electroweak measurements at the HL-LHC by including higher-order corrections in SMEFT predictions.

Method: The authors analyze NLO QCD and EW corrections to dimension-6 SMEFT predictions for Higgs decays and compare these results with previous ATLAS studies.

Result: NLO QCD/EW corrections significantly affect Higgs decay channels, particularly for operators involving third-generation fermions, and sensitivity to the Higgs tri-linear coupling is assessed.

Conclusion: Inclusion of NLO corrections is crucial for precise measurements of Higgs properties at HL-LHC, guiding future experiments and analyses.
...
### [89] [Deciphering Matter Invariants via Renormalization Group Equations for Neutrino Oscillations](https://arxiv.org/abs/2608.28540)
*Xin Wang,Shun Zhou*

Main category: hep-ph

TL;DR: This paper analyzes neutrino oscillations in matter using renormalization group equations to identify and classify matter invariants across three and four flavor frameworks.


<details>
  <summary>Details</summary>
Motivation: The study aims to deepen the understanding of the structure of matter invariants in neutrino physics, particularly under different flavor scenarios.

Method: It employs renormalization group equations for neutrino oscillations, combined with permutation covariance and the treatment of matter potential as a spurion.

Result: In the three-flavor framework, it identifies two independent monomial invariants, while in the four-flavor framework, it finds a complete set of eleven algebraically independent matter invariants.

Conclusion: The presence of a rank-two electron–sterile spurion in the four-flavor framework poses challenges for the cancellation of common poles necessary for nontrivial multiplicative invariants.
...
### [90] [The Pomeron loop as a perturbative correction to single Pomeron exchange revisited](https://arxiv.org/abs/2608.28544)
*Martin Hentschinski,Karina Mendoza-Ramírez,Miguel A. Ocaña-Bribiesca*

Main category: hep-ph

TL;DR: This paper reviews the role of Pomeron loops in high energy scattering amplitudes, finding significant corrections in contrast to some previous claims.


<details>
  <summary>Details</summary>
Motivation: To investigate the impact of Pomeron loops on high energy scattering amplitudes and clarify disagreements in existing literature.

Method: The authors review the single Pomeron loop derivation and numerically evaluate its contributions using Korchemsky's representation of the triple Pomeron vertex.

Result: The study shows Pomeron loops can yield 24%-39% corrections at low $x$ and hard scales, differing from earlier claims.

Conclusion: While previous studies suggested minimal corrections from Pomeron loops, this paper finds them to be considerably larger, emphasizing the importance of these contributions at current LHC energies.
...
### [91] [Observation of the $Ξ_c^0 \to pK^-$ decay and measurement of its decay asymmetry](https://arxiv.org/abs/2608.27894)
...
TL;DR: This paper reports the first observation of the decay $Ξ_c^0 \to pK^-$ and provides its branching fraction and decay asymmetry parameter.


<details>
  <summary>Details</summary>
Motivation: To investigate the Cabibbo-suppressed decay processes in particle physics, specifically the $Ξ_c^0$ baryon.

Method: Data from $pp$ collisions at the LHC with an integrated luminosity of $5.4\,\mathrm{fb}^{-1}$ was analyzed to identify the decay $Ξ_c^0 \to pK^-$.

Result: The decay was observed for the first time with a branching fraction of $(4.5\pm0.5\pm0.2\pm0.9)\times10^{-5}$ and an asymmetry parameter $α_{Ξ_c^0}=0.32\pm0.15\pm0.01$.

Conclusion: The findings enhance the understanding of decay mechanisms and confirm theoretical predictions in particle physics regarding Cabibbo-suppressed processes.
...
### [92] [Next generation tracking and vertexing detectors](https://arxiv.org/abs/2608.28089)
*Armin Ilg*

Main category: hep-ex

TL;DR: This paper reviews the requirements and challenges for track and vertex reconstruction in future collider experiments, emphasizing precision in measurements and the need for innovative detector technologies.


<details>
  <summary>Details</summary>
Motivation: To enhance the physics potential of collider experiments through advanced tracking and vertexing techniques.

Method: The study examines various collider types and their specific needs, highlighting trends in detector designs and technologies such as monolithic active pixel sensors and different tracking technologies.

Result: Identifies common trends including the need for precise spatial measurements, low material designs, and radiation tolerance in tracking systems for future colliders.

Conclusion: Future collider tracking and vertexing systems will require significant research and development to integrate various technological components effectively.
...
### [93] [Characterizing Single-Signal Events from Atmospheric-Neutrino Neutral-Current Interactions in Large Liquid Scintillator Detectors](https://arxiv.org/abs/2608.28095)
*Zhenning Qu,Jie Cheng,Wan-lei Guo,Gaosong Li,Yu-Feng Li,Liang-jian Wen*

Main category: hep-ex

TL;DR: The paper investigates neutrino interactions in liquid scintillator detectors, focusing on single-signal events and their model dependencies.


<details>
  <summary>Details</summary>
Motivation: To explore atmospheric neutrinos' interactions in liquid scintillator detectors and enhance understanding of neutrino-nucleus interactions.

Method: Systematic investigation of model dependencies in neutrino-nucleus interactions and their implications for event rates and energy spectra.

Result: Dominant model dependence is linked to the primary neutrino-nucleus interaction, particularly on carbon; de-excitation and secondary interactions have lesser effects.

Conclusion: The findings emphasize the significant physics potential of large liquid scintillator detectors for studying atmospheric neutrinos and improving rare-event search background estimates.
...
### [94] [Vertex reconstruction for a search for neutron-antineutron conversions with HIBEAM](https://arxiv.org/abs/2608.28314)
...
TL;DR: The study compares traditional and machine-learning methods for reconstructing vertex coordinates from charged particles produced by antineutron annihilation in the HIBEAM/NNBAR program.


<details>
  <summary>Details</summary>
Motivation: To enhance the analysis of neutrons converting to antineutrons at the European Spallation Source by improving vertex reconstruction techniques.

Method: Both classical methods (deterministic clustering, trackless projection) and machine-learning approaches (graph-neural-network methods, including a hybrid strategy) were tested for track clustering and vertex reconstruction.

Result: Classical methods matched the performance of machine-learning methods for simple geometrical events, but machine learning offered additional insights on event shapes that could be valuable for further analyses.

Conclusion: While classical methods are effective for basic reconstruction, custom machine-learning approaches provide supplementary shape information important for subsequent analysis.
...
### [95] [Search for scalar leptoquarks produced via muon-quark scattering in proton-proton collisions at $\sqrt{s}$ = 13 TeV](https://arxiv.org/abs/2608.28377)
*CMS Collaboration*

Main category: hep-ex

TL;DR: This paper reports the first search for TeV-scale scalar leptoquarks produced in muon-quark interactions using 13 TeV proton-proton collision data from the LHC, setting new limits on their mass and coupling parameters.


<details>
  <summary>Details</summary>
Motivation: The study aims to investigate leptoquarks, which offer insights into unifying quarks and leptons and probing new physics beyond the Standard Model.

Method: The analysis is conducted using collision data collected at a center-of-mass energy of 13 TeV, focusing on muon-quark interactions that produce scalar leptoquarks (LQs) and their decay products, measured through the invariant mass of the muon-jet system.

Result: The results show no significant excess beyond the expected background, leading to upper limits on the LQ production cross section and its branching fraction to the muon-quark final state, extending the parameter coverage relative to previous searches.

Conclusion: This research excludes new regions for leptoquark mass and coupling parameters, particularly enhancing the understanding of scalar LQs in the mass range of 1.5 to 3.6 TeV for LQ(uμ) and above 1.8 TeV for LQ(bμ).
...
### [96] [A High- and Variable-Dimensional Measurement of the $Z$+jets Differential Cross Section with the ATLAS Experiment and Artificial Intelligence](https://arxiv.org/abs/2608.28449)
*Kevin Greif*

Main category: hep-ex

TL;DR: The paper explores the use of AI in analyzing large datasets from LHC proton-proton collisions, focusing on measuring the Z+jets production cross section using an AI-based unfolding algorithm, marking a novel contribution to particle physics.


<details>
  <summary>Details</summary>
Motivation: The complexity and high dimensionality of datasets from LHC experiments necessitate advanced analysis techniques to extract meaningful physics results and potentially discover new interactions.

Method: An AI-based unfolding algorithm is employed to measure the Z+jets production cross section differentially, considering the kinematics of every final state charged particle.

Result: This research yields the first full-phase-space measurement of the Z+jets production cross section at the LHC, significantly enhancing our understanding of this process.

Conclusion: The measurement provides a complete experimental characterization of Z+jets production and sets a foundation for similar analyses of other LHC processes.
...
### [97] [Multimessenger Constraints on the Central Engine in SN 2023ixf: Neutron Star or Black Hole?](https://arxiv.org/abs/2608.27468)
*Maryam Aghaei Abchouyeh,Maurice H. P. M. van Putten,Massimo Della Valle*

Main category: astro-ph.HE

TL;DR: The study analyzes the supernova SN 2023ixf using a multi-messenger approach to explore neutron star or black hole formation, finding no gravitational wave signals indicating black hole formation, suggesting instead a neutron star may have formed.


<details>
  <summary>Details</summary>
Motivation: To explore the physical triggers of core-collapse supernovae through joint electromagnetic and gravitational wave analysis, focusing on the implications of neutron star or black hole formation.

Method: The study conducted a model-independent broadband search for gravitational waves associated with SN 2023ixf, using detection thresholds for chirps and noise-like emissions, and analyzed EM photometric-spectroscopic data.

Result: No gravitational wave signal was detected in association with SN 2023ixf over a significant observational period, implying the absence of black hole formation.

Conclusion: The findings support neutron star formation from the supernova, indicating a progenitor mass likely below 20 solar masses.
...
### [98] [A first-principles binary neutron star merger model of GW170817, GRB170817A, and AT2017gfo](https://arxiv.org/abs/2608.27555)
...
TL;DR: Simulation of binary neutron star merger GW170817 links gravitational waves, gamma-ray bursts, and kilonovae.


<details>
  <summary>Details</summary>
Motivation: To provide a unified physical explanation for the multifaceted nature of the GW170817 event.

Method: Conducted end-to-end simulations using general-relativistic magnetohydrodynamics for merger dynamics, followed by nucleosynthesis and photon transfer calculations to model light curves.

Result: Generated kilonova light curves, showing consistency with observed GRB170817A afterglow and AT2017gfo kilonova emissions.

Conclusion: The framework offers a comprehensive interpretation of binary neutron star mergers integrating gravitational waves, gamma-ray bursts, and kilonova observations.
...
### [99] [Exploring the capabilities of combined modelling strategies for supernova with relativistic jets using Redback](https://arxiv.org/abs/2608.27567)
*L. Cotter,N. Sarin,A. Martin-Carrillo*

Main category: astro-ph.HE

TL;DR: This paper critiques traditional methods of analysing supernovae (SN) associated with Gamma-ray Bursts (GRB) by demonstrating that joint modelling yields more accurate parameters than individual analyses.


<details>
  <summary>Details</summary>
Motivation: To address biases in parameter estimation when analyzing light curves of GRB-SN events, especially given complexities due to jet emissions and supernovae interactions.

Method: The study evaluates three common modeling strategies against a joint model approach, using 1000 simulated GRB-SN datasets and examining specific light curve morphologies.

Result: Independent modelling leads to significant biases despite apparently good fits, while joint modelling improves parameter reliability, especially with multi-band observations.

Conclusion: Joint modelling of SN and relativistic jet components is essential for accurate analysis of GRB-SN light curves, revealing pitfalls in current methodologies.
...
### [100] [Dynamical formation of high-eccentricity compact binaries through BH--BH*/TZO collisions](https://arxiv.org/abs/2608.27595)
*Qingru Hu,Yanlong Shi,Douglas N. C. Lin,Norman Murray*

Main category: astro-ph.HE

TL;DR: This paper investigates the formation of high-eccentricity binary stellar-mass black holes through sequential captures by massive stars, revealing potential distinctive signatures detectable by LIGO and LISA.


<details>
  <summary>Details</summary>
Motivation: The study aims to understand the formation and evolution of compact binaries and their potential signatures in gravitational wave observations.

Method: The authors utilize hydrodynamical and semianalytic few-body simulations to explore how stellar-mass black holes can be captured by massive stars and form high-eccentricity binaries.

Result: The simulations indicate that black holes with masses less than 0.2 times that of massive stars can form high-eccentricity binaries with eccentricities greater than 0.5, potentially observable by LISA.

Conclusion: This formation channel may occur in dense stellar environments and offers a distinctive signature for detected high-eccentricity binaries in LIGO observations.
...
### [101] [Formation of black hole stars via star--black hole collisions](https://arxiv.org/abs/2608.27596)
*Yanlong Shi,Qingru Hu,Zhenghao Xu,Douglas N. C. Lin,Norman Murray*

Main category: astro-ph.HE

TL;DR: This study examines collisions between stellar-mass black holes and massive stars in dense environments, revealing distinct outcomes based on black hole mass.


<details>
  <summary>Details</summary>
Motivation: The study aims to understand the interactions between stellar-mass black holes and massive stars in dense stellar environments, with implications for black hole growth and structural evolution.

Method: The authors employed semi-analytic models, 3D hydrodynamical simulations, and 1D stellar evolution calculations to investigate the collision processes, focusing on interactions with a 100 M⊙ star.

Result: Results indicate that gas drag retains black holes in stellar envelopes unless the impact velocity is sufficiently high, with different outcomes based on the black hole's mass: higher mass results in an unstable dynamic envelope, while lower mass leads to a stable 'black hole star' formation.

Conclusion: The formation of black hole stars is contingent on black hole mass relative to the stellar mass, providing insights into black hole growth in dense environments and potential connections to astronomical phenomena observed by JWST.
...
### [102] [Spin-disc misalignment drives periodic accretion and pulse profile asymmetry in X-ray pulsars](https://arxiv.org/abs/2608.27691)
*A. A. Mushtukov,V. Ganesh,S. S. Tsygankov,S. Portegies Zwart,A. Palyam*

Main category: astro-ph.HE

TL;DR: The paper explores the effects of non-perpendicular neutron star spin axes on accretion patterns in X-ray pulsars, revealing how geometric orientation influences mass accretion and X-ray emissions.


<details>
  <summary>Details</summary>
Motivation: To understand magnetospheric accretion dynamics in X-ray pulsars with tilted neutron star spin axes, and its impact on emission characteristics.

Method: Numerical simulations model plasma motion from the inner disc edge to the neutron star, investigating how inclination affects mass accretion rates and pulse profiles.

Result: The study finds that even steady mass supply leads to periodic modulation in mass accretion rates due to geometric effects, resulting in asymmetrical X-ray pulse profiles and phase-resolved spectral features.

Conclusion: This geometric influence not only alters the dynamics of pulsar emissions but may also be significant for ultra-luminous X-ray pulsars (ULX) by maintaining strong pulsations amidst geometric beaming.
...
### [103] [Magnetospheric birefringence breaks the rotating-vector model and depolarises X-ray pulsars](https://arxiv.org/abs/2608.27699)
*Alexander A. Mushtukov,Sergey S. Tsygankov,Silvia Zane,Nabil Brice,Ruth M. E. Kelly,Roberto Taverna,Roberto Turolla*

Main category: astro-ph.HE

TL;DR: The study explores the unexpected low linear polarization observed in accreting X-ray pulsars, suggesting that propagation through the neutron star's magnetosphere alters polarization angles and reduces overall polarization, contrary to standard models.


<details>
  <summary>Details</summary>
Motivation: To address discrepancies between expected high polarization in X-ray pulsars and actual observations which show lower polarization fractions and unexpected angle swings.

Method: Utilizes general-relativistic ray tracing and Stokes-parameter transport to analyze photon behavior in the neutron star's magnetosphere.

Result: Demonstrates that photons encounter polarization angle offsets due to crossing non-adiabatic regions and interacting with plasma in the magnetosphere, leading to broader angle distributions and lower integrated polarization.

Conclusion: Magnetospheric propagation significantly impacts polarimetric observations in X-ray pulsars, suggesting a reevaluation of standard models is needed to explain observed phenomena.
...
### [104] [The Impact of Errors in the Shape Function of Rotating Neutron Stars in the Oblate Schwarzschild Approximation](https://arxiv.org/abs/2608.27744)
*John Ming Ngo,Charlee Amason,Sharon M. Morsink*

Main category: astro-ph.HE

TL;DR: The paper assesses the accuracy of five shape functions used for modeling the oblate surfaces of rapidly rotating neutron stars to improve flux estimations and radius calculations.


<details>
  <summary>Details</summary>
Motivation: Understanding the properties of neutron stars is crucial for constraining the equation of state of dense matter, particularly through measurements of thermal X-ray flux, which depend on accurate models of their surface shape.

Method: The study compares five different shape functions against numerical relativistic stellar surfaces across various equations of state, analyzing errors in surface radius and its derivative due to neutron star compactness and spin.

Result: Distinct error patterns in the surface radius and solid angle dΩ were identified, with polynomial corrections reducing errors to within 0.5% for several functions; and contributions to errors were categorized into area and projection effects.

Conclusion: The research provides guidelines for developing improved shape functions to enhance radius estimation accuracy, emphasizing the need for precise modeling of shape and its derivative across relevant compactness and spin ranges.
...
### [105] [Low-energy antinuclei measurements for background-free indirect dark matter searches and PBH signatures](https://arxiv.org/abs/2608.27787)
...
TL;DR: The ASTRA Initiative Mission Concept explores low-energy cosmic ray antinuclei as probes for dark matter and new physics, emphasizing the necessity for a flagship mission based on recent tentative findings.


<details>
  <summary>Details</summary>
Motivation: To assess the potential of cosmic ray antinuclei in understanding dark matter and other new physics.

Method: Review of theoretical frameworks and current experimental efforts regarding cosmic ray antinuclei.

Result: Identifies promising preliminary results indicating cosmic antinuclei may signal new physics, warranting further investigation.

Conclusion: Advocates for a new flagship mission to validate or challenge these results.
...
### [106] [Rapid Variability and Broadband Spectral Modeling in the Flaring Activity of BL Lacertae](https://arxiv.org/abs/2608.27955)
...
TL;DR: This study investigates flaring episodes of BL Lacertae, providing insights into its gamma-ray emissions, variability, and underlying mechanisms.


<details>
  <summary>Details</summary>
Motivation: Understanding the nature and mechanisms of gamma-ray emissions in blazars, specifically during flaring events.

Method: Multi-wavelength observations, utilizing data from the Fermi LAT, to analyze gamma-ray flux, variability timescales, and spectral behavior.

Result: Identified a peak gamma-ray flux, minimum flux halving timescale, and evidence for rapid variability, alongside spectral trends during flares.

Conclusion: The findings suggest complex particle acceleration dynamics in a compact emitting region, linked to magnetic reconnection processes.
...
### [107] [From Inspiral to Expansion: The Wake-Driven Torque on Binary Black Holes in Gaseous Medium](https://arxiv.org/abs/2608.27970)
*Jixuan Yang,Lile Wang,Xinyu Li,Rixin Li*

Main category: astro-ph.HE

TL;DR: This study elucidates the impact of gas-driven torque on binary black holes (BBHs) in AGN disks, emphasizing the importance of wake-wake interactions and introducing a critical parameter, η, that influences torque dynamics.


<details>
  <summary>Details</summary>
Motivation: To understand the orbital evolution of BBHs in gas-rich environments, specifically the role of gas-driven torque in their dynamics.

Method: Conducted three-dimensional hydrodynamic simulations to analyze the interaction of wakes from circular BBHs within a uniform gas flow.

Result: Identified that the net torque on the BBHs is dictated by wake-wake interactions, with the torque characterized by the parameter η = v_g/v_o, showing a transition from negative to positive torque as η increases.

Conclusion: In AGN disks, the prevailing gas conditions influence the BBHs’ evolution, potentially affecting the rates of gravitational-wave mergers due to gas-driven expansion competing with gravitational-wave inspirals.
...
### [108] [Hyperon bulk viscosity effects in neutron-star inspirals](https://arxiv.org/abs/2608.28000)
*Elena M. Kantor,Mikhail E. Gusakov,Kirill Y. Kraav*

Main category: astro-ph.HE

TL;DR: The paper examines hyperon bulk viscosity's effect on neutron-star inspirals, finding minimal impact on gravitational waves but significant heating of the hyperon core.


<details>
  <summary>Details</summary>
Motivation: To assess how hyperon bulk viscosity affects neutron-star gravitational-wave signals during inspiral events.

Method: Analysis of gravitational-wave phase shifts and core heating due to hyperon bulk viscosity.

Result: Hyperon bulk viscosity causes a minor gravitational-wave phase shift (~10^-3 rad) and significantly heats the hyperon core to ~5 x 10^8 K.

Conclusion: The phase shift is too small for current or near-future detectors to measure, but significant heating of the core is noted.
...
### [109] [The Geometry of Ultra-Fast Outflows Probed by Soft X-ray Variability in PDS 456](https://arxiv.org/abs/2608.28034)
...
TL;DR: This study examines soft X-ray variability in quasar PDS 456 to constrain the location, geometry, and acceleration mechanisms of ultra-fast outflows (UFOs).


<details>
  <summary>Details</summary>
Motivation: Understanding the precise launching location and acceleration processes of ultra-fast outflows (UFOs) is crucial in astrophysics.

Method: Simultaneous soft X-ray observations using XRISM/Xtend and NuSTAR, followed by a model-independent spectral analysis and time-sliced spectral fitting to assess variability.

Result: Key findings include spectral variability near 1 keV, a partial-covering low-ionization UFO model, significant covering fraction variability, and constraints on absorber distance and crossing velocity.

Conclusion: The results suggest that soft X-ray variability is a useful geometrical probe of UFOs and may indicate specific acceleration mechanisms, deviating from traditional magnetocentrifugal theories.
...
### [110] [Exploring the sensitivity of in-ice radio detectors to cosmic ray mass composition](https://arxiv.org/abs/2608.28536)
*Nathaniel Alden,Marissa Boucher,Cosmin Deaconu,Abigail Vieregg,Philipp Windischhofer*

Main category: astro-ph.HE

TL;DR: In-ice radio detectors can measure cosmic ray mass composition by analyzing the Askaryan radio spectrum from simulated air showers, revealing sensitivity to primary cosmic ray atomic mass.


<details>
  <summary>Details</summary>
Motivation: To extend the use of in-ice radio detectors for measuring cosmic ray air showers in addition to high-energy neutrinos.

Method: Simulations using CORSIKA 8 are employed to analyze the lateral width of in-ice cascades and its correlation with cosmic ray properties, specifically focusing on the Askaryan effect.

Result: The study identifies that the in-ice cascade width varies with the atomic mass of the primary cosmic ray, and establishes a relationship between core width and $	ext{X}_{	ext{max}}$ for cosmic ray mass reconstruction.

Conclusion: In-ice radio detectors are effective for cosmic ray mass composition assessment above $10^{17}$eV, contingent on optimal placement for sampling the Askaryan emission.
...
### [111] [Spherical Accretion onto Konoplya Zhidenko Black Holes: Sonic Point Analysis and Fluid Dynamics](https://arxiv.org/abs/2608.28049)
*M H Waheed,M Z A Moughal*

Main category: astro-ph.HE

TL;DR: This paper examines spherical accretion onto a Konoplya-Zhidenko black hole, analyzing how spacetime deformation impacts the dynamics of accreting matter through critical points and sonic transitions across various fluid models.


<details>
  <summary>Details</summary>
Motivation: To understand how modifications in black hole spacetime affect the behavior of matter during accretion and to compare these effects across different black hole types.

Method: Utilized conservation laws to formulate the accretion problem, derived Hamiltonian for fluid motion, and analyzed critical points for different fluid models in the context of KZ black holes.

Result: The study revealed significant variations in the location and behavior of critical points depending on the black hole geometry and fluid equation of state, with notable changes in the radial accretion structure observed under KZ deformation.

Conclusion: The findings enhance understanding of how black hole geometries influence matter dynamics in strong gravitational fields, providing insights into spherical accretion across various black hole models.
...
### [112] [Three-dimensional Core-Collapse Supernova Simulations: From shell burning to shock revival](https://arxiv.org/abs/2608.28358)
*Haakon Andresen,Evan P. O'Connor,C. E. Fields,Sean M. Couch*

Main category: astro-ph.HE

TL;DR: This study investigates the impact of progenitor star structure on core-collapse supernova simulations, revealing that three-dimensional models yield higher kinetic energy and shock dynamics than one-dimensional or angle-averaged models.


<details>
  <summary>Details</summary>
Motivation: To understand how the progenitor star's multi-dimensional structure influences the dynamics of core-collapse supernovae.

Method: Three-dimensional simulations were performed on five solar-metallicity progenitors with varying masses, utilizing the FLASH code to map from one-dimensional MESA models, focusing on the last 10-15 minutes before collapse.

Result: The three-dimensional progenitor produces 35-50% more non-radial kinetic energy in the post-shock region and a shock radius that is 5-10% larger compared to models initiated from angle-averaged or 1D progenitors, with earlier shock revival observed.

Conclusion: Gravitational-wave emissions are consistent across models, emphasizing that changes in downflows to the protoneutron star drive emissions rather than progenitor asymmetries.
...
### [113] [Astrophysical Sensitivity Projections for the IceCube Upgrade](https://arxiv.org/abs/2608.28395)
...
TL;DR: The IceCube Upgrade, set for completion by the end of 2026, will enhance sensitivity to low-energy neutrinos, improving detection capabilities for various source types, particularly transient and soft-spectrum sources.


<details>
  <summary>Details</summary>
Motivation: To enhance neutrino detection sensitivity in the GeV energy regime, particularly for transient astrophysical events and steady emissions from specific sources.

Method: The upgrade introduces multi-PMT optical modules within the existing IceCube framework, using new Monte Carlo datasets to analyze sensitivity across different analyses.

Result: The IceCube Upgrade is projected to achieve significant improvements in sensitivity, particularly for transient sources at low energies and soft-spectrum sources across the southern sky.

Conclusion: The upgrades will broaden the discovery potential in the GeV band for the IceCube experiment over the next decade.
...
### [114] [Reassessing the contribution of long-GRB high-energy afterglows to the isotropic gamma-ray background after GRB 221009A](https://arxiv.org/abs/2608.28448)
*S. V. Troitsky*

Main category: astro-ph.HE

TL;DR: The study assesses the contribution of long gamma-ray bursts (GRBs) to the isotropic gamma-ray background (IGRB) using GRB 221009A as a reference, concluding that even with multi-TeV emissions, long GRBs are not significant sources for the IGRB.


<details>
  <summary>Details</summary>
Motivation: To evaluate the influence of long GRBs on the IGRB, particularly in light of new observations of GRB 221009A.

Method: Utilized a high-energy afterglow template for GRB 221009A, anchored by GeV-TeV data, and scaled estimations based on prompt energy and beaming.

Result: The long GRB contribution, even including direct GeV emission, remains relatively small: 1.6e-4 without direct emissions and up to 1.1e-3 with them; influenced by various factors but consistently showing low significance.

Conclusion: The observed emissions from GRB 221009A, despite their high energy, do not position long GRBs as significant contributors to the IGRB.
...
### [115] [Relativistic outflows power a quasi-periodic eruption: constraints on energetics, mass loss, and emission mechanisms](https://arxiv.org/abs/2608.28507)
...
TL;DR: This paper investigates quasi-periodic eruptions (QPEs) from supermassive black holes using deep X-ray observations, revealing key insights into their physical properties and energetics.


<details>
  <summary>Details</summary>
Motivation: To elucidate the nature of quasi-periodic eruptions from SMBHs, which exhibit unique X-ray variability with uncertain origins and emission characteristics.

Method: Employing new XMM-Newton observations of QPEs in ZTF19acnskyy, the authors analyze X-ray spectra for time-dependent P Cygni profiles, and construct an analytical model of wind dynamics to compute evolving luminosity and ionization.

Result: Spectral analysis indicates relativistic mass ejections with specific column densities and velocities. The modeled outflow can explain light curves and spectral features, suggesting significant mass and energy ejection during eruptions.

Conclusion: The findings set constraints on QPE energetics and emission mechanisms, suggesting that QPEs may influence their environments and can serve as observational proxies for testing theoretical models.
...
### [116] [Distinct Modes of Pulsar Glitch Activity Revealed by the Waiting-Time--Amplitude Morphology](https://arxiv.org/abs/2608.28523)
*Wen-Tong Liu,Wei-hua Wang,Xia Zhou,Fei-fei Kou*

Main category: astro-ph.HE

TL;DR: This study proposes a quantitative classification scheme for pulsar glitches, identifying two morphology classes: Compact and Extended, based on statistical analysis of waiting time and glitch amplitude.


<details>
  <summary>Details</summary>
Motivation: Existing qualitative classifications of pulsar glitches are inadequate; this research seeks to create a reproducible quantitative scheme for better understanding their diverse behaviors.

Method: Data from 349 glitches across 22 pulsars were analyzed using kernel density estimation and hierarchical clustering, focusing on the distribution of backward waiting time and glitch amplitude.

Result: Two classes of glitches—Compact and Extended—were objectively defined. The Compact class features small HDR areas and high anisotropy, whereas the Extended class shows broader occupancy and lower density. Mean backward waiting time is a significant predictor of class.

Conclusion: The classification scheme enriches our understanding of pulsar glitches, suggesting that different classes capture distinct physical processes related to crustal superfluidity.
...
### [117] [A Similarity Theorem and Its Breakdown in Atomic Black Hole Accretion](https://arxiv.org/abs/2608.28587)
*Marcus DuPont*

Main category: astro-ph.HE

TL;DR: The paper establishes a time-dependent similarity in atomic gas dynamics influenced by a point-mass potential, highlighting rescaling laws for mass and ambient density, and defining critical growth thresholds in terms of Bondi time.


<details>
  <summary>Details</summary>
Motivation: To understand the behavior of atomic gas in the context of point-mass potentials and the impact of scaling factors on two-body interactions and radiation laws.

Method: The authors prove the uniqueness of a rescaling transformation for the parameters of atomic gas systems, characterizing their growth rates and stability through defined metrics like the fractional mass gained in Bondi time.

Result: The rescaling reveals critical growth boundaries and identifies conditions under which stationary configurations cannot maintain both similarity and flux consistency, particularly in hyper-Eddington cases.

Conclusion: The study bridges the gap between radiating Bondi flows and feedback mechanisms, providing insights into stability and growth limits in astrophysical contexts.
...
### [118] [A microwave SQUID multiplexing concept for macro-cryogenic calorimeter arrays](https://arxiv.org/abs/2608.27556)
...
TL;DR: The paper proposes using microwave SQUID multiplexing for massive cryogenic BGO calorimeters to improve channel count for rare-event searches while maintaining resolution.


<details>
  <summary>Details</summary>
Motivation: Current readout methods limit the scalability of cryogenic calorimeter arrays, restricting them to a few dozen channels, which is insufficient for large-scale rare-event searches.

Method: The paper applies microwave SQUID multiplexing (μMUX) to BGO calorimeters, deriving a comprehensive noise model that includes multiple noise contributions and their effects on baseline resolution as the multiplexing factor increases.

Result: The proposed method achieves a degradation of less than 2% in baseline resolution for multiplexing factors up to 1000, with significant improvements in readout scalability compared to conventional methods.

Conclusion: This approach facilitates the design of large multi-tower arrays for sensitive searches in astrophysics, such as CEνNS and dark matter, without compromising performance.
...
### [119] [Frequency Synchronization Circuit Model for Analog Vector-Matrix Multiplication in the Frequency Domain](https://arxiv.org/abs/2608.27765)
*Taeju Lee,Scott T. Habermehl,Timothy W. Caplice,Michael L. Roukes,Philip X. -L. Feng,Kenneth L. Shepard*

Main category: physics.ins-det

TL;DR: This paper presents a frequency synchronization circuit model for analog vector-matrix multiplication using coupled oscillators and resonators.


<details>
  <summary>Details</summary>
Motivation: To improve frequency synchronization in analog circuits for efficient vector-matrix multiplication in the frequency domain.

Method: Utilizes complementary cross-coupled transconductance pairs and RC high-pass filters in a model that couples oscillators with resonators through all-to-all connections.

Result: Achieved both full and partial frequency synchronization by controlling coupling strength among selected oscillators, analyzed through small-signal perspectives.

Conclusion: Synchronized frequency is influenced by circuit and resonator parameters, enhancing understanding for future implementations.
...
### [120] [Migration of Belle II TOP Feature Extraction from the Zynq Processing System to PCIe40 Readout PCs](https://arxiv.org/abs/2608.27814)
...
TL;DR: The paper discusses the successful migration of waveform feature extraction systems for the Belle II TOP detector to off-detector systems, improving data acquisition stability amid increased luminosity.


<details>
  <summary>Details</summary>
Motivation: To address the challenges posed by increased luminosity and beam-induced backgrounds that caused single-event upsets in the Zynq systems, disrupting data acquisition.

Method: Waveform feature extraction tasks were transitioned from the on-detector Zynq processing systems to off-detector PCIe40 readout PCs, avoiding the radiation environment impacts.

Result: The changes eliminated SEU-induced processing system lockups, reduced TOP deadtime to near zero, and maintained stable operation at high trigger rates and hit rates.

Conclusion: The migrated architecture effectively improved the performance and reliability of the Belle II data acquisition system, proving robust under challenging conditions.
...
### [121] [Full-field fluorescence computed tomography (F3CT) using a calibrated virtual cone-beam pinhole geometry](https://arxiv.org/abs/2608.28275)
*Thomas Zillhardt,Yunhui Chen,Alexander Rack,Matthew Veale,Matt Wilson,Philip J. Withers,Nicola Viganò*

Main category: physics.ins-det

TL;DR: F3CT is a novel hyperspectral imaging technique that enhances 3D elemental mapping using synchrotron-based full-field fluorescence without the need for raster scanning.


<details>
  <summary>Details</summary>
Motivation: The need for improved imaging techniques that can efficiently map elemental distributions in various specimens, enhancing resolution and throughput without traditional scanning limitations.

Method: F3CT employs a pinhole aperture in conjunction with a 2D energy-resolving detector, along with a virtual cone-beam model and a two-stage calibration-reconstruction workflow for 3D imaging.

Result: The method successfully distinguished silver-stain distributions in zebrafish tissue and revealed high-energy fluorescence in rock cores, demonstrating its versatility across biological and geological samples.

Conclusion: F3CT facilitates high-throughput 3D XRF imaging and sets the stage for future correlated structural and chemical tomography applications, including potential real-time implementation.
...
### [122] [Development of a high-granularity, high-precision timing readout electronics system for large-area MRPC detectors](https://arxiv.org/abs/2608.28356)
*J. N. Tang,W. H. Wu,Y. Q. Tan,W. Zhi,H. J. Yang,Imad Laktineh,Q. P. Shen*

Main category: physics.ins-det

TL;DR: This paper presents a high-precision readout electronics system for large-area MRPC detectors, achieving remarkable timing resolution and uniformity across channels.


<details>
  <summary>Details</summary>
Motivation: The need for scalable and precise timing readout systems in MRPC detectors driven by their high time resolution and detection efficiency.

Method: The system integrates two Front-End Boards with high-granularity ASICs, employs an S-curve calibration for baseline equalization, and conducts signal-injection measurements to determine time resolution.

Result: The calibration procedure significantly reduced baseline voltage dispersion, achieving a single-channel electronic time resolution of 33 ps RMS and high inter-chip and inter-board resolutions of 43 ps and 45 ps RMS, respectively.

Conclusion: This timing readout system exhibits potential applications in various fields, such as Time-of-Flight systems and cosmic-ray imaging due to its high precision and scalability.
