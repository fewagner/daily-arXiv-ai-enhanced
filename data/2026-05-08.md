...
TL;DR: This paper proposes a simplified technique for fabricating active edge silicon detectors, reducing ineffective regions and improving performance through side ion implantation and microwave annealing.


<details>
  <summary>Details</summary>
Motivation: To reduce the insensitive area in silicon detectors, crucial for high-energy physics, X-ray experiments, and medical imaging.

Method: The proposed technique employs side ion implantation and microwave annealing to create highly doped edges, simplifying existing complex fabrication processes.

Result: Tests showed significant improvement in edge leakage current post-implantation and annealing, validating the feasibility of the new technique.

Conclusion: The new method offers a promising and simplified approach for fabricating active edge sensors, enhancing performance in various high-demand applications.
...
TL;DR: NDR biasing enhances the conversion gain of superconducting HEB mixers, overcoming historical issues of instability through circuit redesign.


<details>
  <summary>Details</summary>
Motivation: To improve the performance of superconducting hot-electron bolometer mixers by leveraging negative differential resistance (NDR) biasing, which has been previously dismissed due to instability.

Method: We analyzed the current-voltage characteristics under NDR biasing, identified the instability causes related to LC resonance, and redesigned the embedding circuit for stability, applying stability criteria from tunnel diodes.

Result: Experiments using 2.5-THz sources demonstrated a significant gain enhancement in the HEB mixer under stable NDR conditions.

Conclusion: NDR biasing is validated as an effective technique for enhancing HEB mixer performance, suggesting pathways for further research on noise and circuit improvements.
...
TL;DR: This study quantifies fast neutrons and other particle characteristics in the MoEDAL experiment's environment, utilizing Timepix detectors for real-time measurements.


<details>
  <summary>Details</summary>
Motivation: To identify experimental backgrounds that may interfere with detecting Dirac magnetic monopoles using Nuclear Track Detectors (NTDs) during the MoEDAL experiment.

Method: Data was collected through the Timepix detector network between 2013 and 2018, analyzing mixed radiation fields to ascertain properties like composition and directional characteristics.

Result: The analysis provides detailed insights into neutron and highly ionizing particle distributions, along with the showcasing of the Timepix detectors’ spatial tracking capabilities and energy-loss profiles.

Conclusion: The findings enhance understanding of particle interactions in the MoEDAL environment, aiding in the search for magnetic monopoles.
...
### [4] [Nonthermal leptogenesis via cosmological gravitational particle production is tested by inflationary gravitational waves](https://arxiv.org/abs/2605.05304)
*Tammi Chowdhury,Leah Jenks,Edward W. Kolb,Andrew J. Long,Evan McDonough*

Main category: hep-ph

TL;DR: This paper investigates the connection between cosmic inflation and right-handed neutrinos in seesaw models, suggesting that inflation can create sufficient neutrinos to account for the universe's baryon asymmetry, with predictions for future experiments.


<details>
  <summary>Details</summary>
Motivation: To understand the relationship between cosmic inflation and the generation of right-handed neutrinos within the framework of seesaw models, particularly in relation to the observed baryon asymmetry of the universe.

Method: The authors analyze inflation models and their potential to produce right-handed neutrinos, assessing the abundance needed to explain the baryon asymmetry, while also considering gravitational wave signatures for testing these models.

Result: The research indicates that next-generation CMB experiments could detect gravitational waves from inflation, which would concurrently produce right-handed neutrinos in adequate amounts to address the baryon asymmetry.

Conclusion: This work suggests that the interplay between cosmic inflation and right-handed neutrinos offers a promising avenue for testing fundamental physics in the universe's early moments.
...
### [5] [On the equivalence of unitarization prescriptions for the Sommerfeld enhancement](https://arxiv.org/abs/2605.05309)
*Barry E. Cimring,Tracy R. Slatyer*

Main category: hep-ph

TL;DR: This paper analyzes different approaches to regulating the Sommerfeld enhancement in dark matter annihilation, ensuring consistency and unitarity across methods.


<details>
  <summary>Details</summary>
Motivation: To address the unitarity violations in the standard calculations of Sommerfeld enhancement for self-interacting dark matter with long-range interactions, particularly near zero-energy resonances.

Method: The paper compares various proposed regulatory approaches, evaluating their cutoff dependencies and showing that regulated cross sections remain approximately UV-independent; it also develops a unitarization prescription for multi-state systems.

Result: The study finds that the Sommerfeld-enhanced cross sections are largely independent of the UV regulator and that different regulation schemes yield similar results when unitarity-preserving corrections are significant.

Conclusion: A regulator-independent method for unitarization is established, allowing for effective calculation of enhancement in multi-state systems, relying on standard enhancement factors and scattering amplitudes.
...
### [6] [Monochromatic neutrinos from scotogenic dark matter](https://arxiv.org/abs/2605.05312)
*Ricardo Cepedello,Pablo de la Torre,Manuel Masip*

Main category: hep-ph

TL;DR: The study proposes a modified scotogenic model featuring fermion singlets as dark matter candidates that annihilate into neutrinos, addressing the lithium problem and fitting within existing experimental bounds.


<details>
  <summary>Details</summary>
Motivation: To improve upon the scotogenic model of neutrino masses and dark matter, and to explore its implications for astrophysical phenomena.

Method: Introduce pseudo-Dirac pairs of fermions, with properties that allow for annihilation into neutrino pairs, maintaining consistency with observed data and experimental bounds.

Result: Identified a feasible dark matter candidate that annihilates predominantly into neutrinos, providing a potential solution to the lithium problem.

Conclusion: The proposed model aligns with experimental data while offering new insights into dark matter and neutrino interactions.
...
### [7] [All-loop four-quark Bethe-Salpeter kernel](https://arxiv.org/abs/2605.05349)
*Piotr Bargiela*

Main category: hep-ph

TL;DR: This paper calculates the four-quark Bethe-Salpeter kernel at all-loop order using modern scattering amplitude techniques, focusing on massless Quantum Chromodynamics under the large number of flavors approximation.


<details>
  <summary>Details</summary>
Motivation: To provide a comprehensive all-loop calculation of the four-quark Bethe-Salpeter kernel while avoiding the ambiguities of truncation schemes in Dyson-Schwinger equations.

Method: Analytical calculation using modern techniques, including Integration-By-Parts reduction of Feynman integrals and direct integration into Generalized Polylogarithms, working in massless Quantum Chromodynamics.

Result: The all-loop bare perturbative component of the four-quark Bethe-Salpeter kernel, alongside the gluon and quark propagators, was derived.

Conclusion: The work offers a foundation for nonperturbative formulations and identifies avenues for future phenomenological applications.
...
### [8] [Simplified approach to extracting nucleon transversity in collinear factorization using near-side energy-energy correlators](https://arxiv.org/abs/2604.28131)
*Zhong-Bo Kang,Andreas Metz,Daniel Pitonyak,Congyue Zhang*

Main category: hep-ph

TL;DR: The paper introduces a method to access the transversity parton distribution function using energy-energy correlators, simplifying previous models and providing predictions for future experiments.


<details>
  <summary>Details</summary>
Motivation: To improve the extraction of the transversity PDF without the complications of previous models involving intrinsic parton transverse momentum or resonances.

Method: A novel strategy using near-side energy-energy correlators within the dihadron fragmentation framework, presenting leading-order analytical results for transverse-spin observables in relevant scattering processes.

Result: Derives expressions similar to those used in extracting (un)polarized PDFs and fragmentation functions, demonstrating the utility of the energy-energy correlator approach in transversity PDF extraction.

Conclusion: The method shows promise in predicting outcomes for existing and future experimental facilities, establishing a feasible program to extract the transversity PDF.
...
### [9] [Evidence for Q-Dependent Nuclear Transverse-Momentum Redistribution Beyond Broadening from AI-driven analysis of p-Cu Drell-Yan](https://arxiv.org/abs/2605.05425)
*I. P. Fernando,D. Keller*

Main category: hep-ph

TL;DR: The study analyzes Drell-Yan data from fixed-target $p$--Cu collisions to extract a Cu transverse-momentum profile, revealing Q-dependent redistribution rather than universal width increase in nuclear modification.


<details>
  <summary>Details</summary>
Motivation: To understand the nuclear modifications in transverse momentum profiles in $p$--Cu Drell-Yan processes.

Method: The analysis holds a momentum-space proton reference fixed while training an asymmetric Cu kernel in the small-$q_T$ region.

Result: The findings indicate non-universal behavior characterized by Q-dependent redistribution, suggesting an $	ext{O}(1~	ext{GeV})$ shoulder and interaction between shoulder and resolved-tail regions.

Conclusion: Nuclear modifications cannot be simply described by broadening; instead, they involve complex redistributions in momentum space.
...
### [10] [Squeezed spectra and back-to-back correlations of protons and antiprotons at RHIC energies](https://arxiv.org/abs/2605.05565)
*Yong Zhang*

Main category: hep-ph

TL;DR: This study examines in-medium mass modification and its effects on proton-antiproton correlations, revealing a dependence on the source time distribution.


<details>
  <summary>Details</summary>
Motivation: To constrain in-medium mass modification and its impact on transverse momentum spectra and the {ar{p}}/p yield ratio of protons and antiprotons.

Method: The analysis employs a Gaussian source model with radial flow, comparing theoretical predictions for fermion back-to-back correlation (fBBC) of p{ar{p}} pairs at RHIC energies.

Result: The fBBC signal's sensitivity to source time distribution is demonstrated, with Lorentzian and Lévy forms producing distinct high and low momentum signals respectively, alongside an enhanced {ar{p}}/p yield ratio.

Conclusion: The findings suggest that higher {ar{p}}/p ratios may correlate with a greater likelihood of observing detectable fBBC signals, indicating potential for future experimental exploration.
...
### [11] [Kaon Portal to Freeze-in Dark Matter](https://arxiv.org/abs/2605.05947)
*Motoi Endo,Takumu Yamanaka*

Main category: hep-ph

TL;DR: The paper explores how dark matter can be produced in low-reheating cosmology via kaon decays and scatterings, linking it to experimental searches.


<details>
  <summary>Details</summary>
Motivation: To investigate dark matter production mechanisms in a low-reheating scenario, specifically through meson interactions.

Method: The study utilizes quark flavor-changing operators in kaon decays to analyze the generation of dark matter abundance.

Result: It establishes a relationship between dark matter production and rare kaon decays, predicting that lower reheating temperatures necessitate larger coupling constants for detection.

Conclusion: Kaon-driven freeze-in dark matter production can be tested through ongoing experiments like NA62 and KOTO.
...
TL;DR: The study systematically analyzes mass spectra of singly-heavy tetraquark states, using known states as reference to estimate mass splittings and decay widths.


<details>
  <summary>Details</summary>
Motivation: To explore the mass spectra and decay properties of $S$-wave singly-heavy tetraquarks, particularly in light of recently observed states by LHCb.

Method: A mass splitting model is employed to systematically study tetraquark mass spectra, taking the $X(4140)$ as a reference point for mass splittings and estimating rearrangement decay widths.

Result: The analysis supports the interpretation of observed LHCb tetraquark states and predicts several narrow candidates for tetraquarks, including for bottom counterparts.

Conclusion: The findings on mass spectra and decay properties provide useful insights for searching new singly-heavy tetraquark states.
...
### [13] [The temporal distribution of SN1987A neutrino events](https://arxiv.org/abs/2605.06401)
*Riccardo Maria Bozza,Vigilante di Risi,Veronica Oliviero,Giulia Ricciardi,Francesco Vissani*

Main category: hep-ph

TL;DR: This paper presents a high-precision alignment of SN1987A neutrino data, significantly reducing timing uncertainties and improving the understanding of neutrino origins.


<details>
  <summary>Details</summary>
Motivation: To address significant timing uncertainties and angular distribution tensions affecting the interpretation of SN1987A neutrino data.

Method: The authors aligned Kamiokande-II and Baksan data with the IMB clock using a new relative time offset to reduce temporal uncertainty to sub-second levels.

Result: The analysis reveals that Baksan timestamps need a 30.4 s advancement, whereas Kamiokande-II requires a 6.4 s delay; favors electron anti-neutrino events over neutronization-burst events with a likelihood ratio of 3-6.

Conclusion: This work provides the most stringent constraints on SN1987A's chronology and sets a benchmark for future supernova observations.
...
### [14] [Massive hybrid stars within the extended three-flavor quark-meson diquark model](https://arxiv.org/abs/2605.05816)
*Jens O. Andersen,Mathias P. Nødtvedt*

Main category: hep-ph

TL;DR: The EQMD model effectively describes QCD properties and EoS, showing compatibility with hybrid star observations.


<details>
  <summary>Details</summary>
Motivation: To investigate the EoS for hybrid stars within a renormalizable QCD framework using the EQMD model.

Method: Utilizing mean-field approximations, the EoS is calculated while maintaining charge neutrality, and parameters are adjusted to analyze their effects on hybrid star properties.

Result: Hybrid stars can exist with masses consistent with observations, and the EoS is significantly affected by the addition of vector and axial-vector mesons, facilitating stiffer EoS for intermediate densities.

Conclusion: Stars exceeding 2 solar masses likely contain a quark core at high densities, with the speed of sound displaying a unique double-peak structure influenced by changes in $s$ quark mass with increasing baryon chemical potential.
...
### [15] [Probing unknown nonperturbative effects in $b \to s \ell\ell$ with inclusive and exclusive observables](https://arxiv.org/abs/2605.06567)
*P. Alvarez-Cartelle,B. Capdevila,E. Lunghi,J. Matias*

Main category: hep-ph

TL;DR: The paper investigates whether the deficit in $b\to s \mu\mu$ branching ratios results from New Physics or a constant hadronic contribution. It distinguishes between these using different behaviors of inclusive and exclusive decay modes. Two observables are identified for testing, with preliminary data favoring New Physics.


<details>
  <summary>Details</summary>
Motivation: To determine the cause of the systematic deficit in $b\to s \mu\mu$ branching ratios—whether it's due to New Physics or a constant hadronic effect.

Method: The analysis compares the effects of non-perturbative contributions from $c\bar c$ loops on inclusive vs. exclusive decay modes, defining observables that help differentiate between New Physics and constant hadronic contributions.

Result: Preliminary evaluations suggest a preference for the New Physics interpretation over a constant hadronic contribution, supported by high $q^2$ measurements.

Conclusion: The paper provides projections for new observables and emphasizes the importance of upcoming LHCb and Belle II measurements to further clarify the situation.
...
### [16] [Top-associated Higgs-boson production using perturbative fragmentation functions at next-to-leading-order](https://arxiv.org/abs/2605.05880)
*Colomba Brancaccio,Michal Czakon,Terry Generet,Benedikt Gurdon*

Main category: hep-ph

TL;DR: The paper explores Higgs boson production with top quark pairs at hadron colliders, utilizing fragmentation functions to establish reliability in certain conditions, particularly at LHC and 100 TeV energies.


<details>
  <summary>Details</summary>
Motivation: To validate the application of perturbative fragmentation functions in predicting Higgs production associated with top-quark pairs, particularly at LHC and future collider energies.

Method: The paper analyzes two mass treatments for the top-quark: zero-mass-top-quark (ZMTQ) and a hybrid prescription, assessing their reliability at leading-order (NLO) conditions.

Result: The hybrid prescription provides reliable results at LHC energies, while the ZMTQ approach is valid in the quark-anti-quark channel at LHC but effective for the entire process at a 100 TeV collider.

Conclusion: The study confirms that certain fragmentation function approximations hold under specific collider conditions and outlines challenges in extending to next-to-next-to-leading-order (NNLO) calculations.
...
### [17] [Interaction and correlation functions for $πf_1(1285)$, $ηf_1(1285)$](https://arxiv.org/abs/2605.05946)
*Wen-Hao Jia,Hai-Peng Li,Wei-Hong Liang,Jing Song,Eulogio Oset*

Main category: hep-ph

TL;DR: The study examines the interaction of the $π^0 (η) f_1(1285)$ system using a molecular state model for $f_1(1285)$. An optical potential is developed via the fixed center approximation of the Faddeev equations and applied in a scattering analysis. Results include derived scattering matrix properties, effective parameters, and notable structures in amplitudes, but lack signals for specific resonances previously suggested by other models.


<details>
  <summary>Details</summary>
Motivation: To investigate the interaction of $π^0 (η)$ and $f_1(1285)$ and explore its properties as a molecular state, enriching understanding of particle interactions in this sector.

Method: An optical potential is constructed from the fixed center approximation to Faddeev equations, allowing the use of the Lippmann-Schwinger equation to analyze the scattering processes, leading to the calculation of the scattering matrix, scattering length, effective range, and correlation functions.

Result: The analysis yielded a scattering matrix and relevant scattering properties. No distinct signals for $π_1(1400)$, $π_1(1600)$, or $η_1(1855)$ were observed, but a notable amplitude structure was found around $1500-1600$ MeV with a strong cusp at the $ηf_1(1285)$ threshold of $1833$ MeV.

Conclusion: The findings indicate that while certain resonance signals are absent, significant features in scattering amplitudes provide valuable insights into the $π^0 (η) f_1(1285)$ interaction, enhancing theoretical understanding in this domain.
...
### [18] [Quark-gluon vertex in the complex plane](https://arxiv.org/abs/2605.06242)
*M. N. Ferreira,A. S. Miramontes,J. M. Morgado,J. Papavassiliou*

Main category: hep-ph

TL;DR: This paper investigates the nonperturbative quark-gluon vertex in the complex plane, focusing on its properties and structure.


<details>
  <summary>Details</summary>
Motivation: To understand the quark-gluon vertex beyond standard perturbative methods, particularly in a nonperturbative context that includes meson properties.

Method: Analyzes the transversely-projected quark-gluon vertex using a symmetry-preserving approach, examining the 'soft-gluon' limit and complexifying the momentum variable in defining integrals.

Result: Determined all eight vertex form factors within a specific domain in the complex plane, identified by a parabola, with insights on extending the domain using extrapolation methods.

Conclusion: The study opens avenues for investigating the quark propagator in the complex plane and highlights the importance of singularities in integrands.
...
### [19] [A Comparative Study of Mass Extraction Schemes and $π^\pm-ρ^\pm$ Mixing](https://arxiv.org/abs/2605.06271)
*Ziyue Wang*

Main category: hep-ph

TL;DR: The study investigates the non-monotonic magnetic-field dependence of the lowest charged pion excitation through various mass-extraction methods under lattice QCD, revealing insights into quasiparticle mixing effects.


<details>
  <summary>Details</summary>
Motivation: To understand the observed non-monotonic magnetic-field dependence of charged pion excitations in lattice QCD and the effects of pion-rho meson mixing.

Method: The SU(2) Nambu--Jona-Lasinio model with a tree-level mixing operator is employed, comparing four mass-extraction methods: rest-mass reconstruction, local bosonization, direct determinant solving, and near-pole expansion.

Result: Only the direct determinant and near-pole expansion schemes successfully capture a robust non-monotonic behavior in the lowest mode, while the rest-mass scheme fails to reproduce the lattice turnover.

Conclusion: The non-monotonic behavior reflects a genuine quasiparticle mixing effect, dependent on the extraction method used for the charged-meson pole structure in a magnetic field.
...
### [20] [Towards Precision Neutrino Fits in GUTs: Relevance of One-Loop Finite Corrections](https://arxiv.org/abs/2605.06362)
*Chee Sheng Fong,Shaikh Saad*

Main category: hep-ph

TL;DR: This study analyzes fermion mass fits in the minimal $SO(10)$ GUT, revealing that one-loop corrections significantly impact neutrino masses and mixings, challenging conventional tree-level fitting.


<details>
  <summary>Details</summary>
Motivation: To examine the limitations of tree-level approximations in the minimal $SO(10)$ GUT regarding fermion masses and neutrino mixing parameters.

Method: The authors incorporate one-loop finite corrections to the neutrino mass matrix, analyzing how these corrections affect fermion masses and mixing at various levels.

Result: Parameter regions yielding successful tree-level fits show significant deviations in neutrino masses and mixings, with corrections as large as $30	ext{%}$ to $40	ext{%}$.

Conclusion: Including one-loop effects is crucial for accurate exploration of parameter space in $SO(10)$ GUTs, particularly in light of modern neutrino oscillation data and future experimental enhancements.
...
### [21] [GTMDs, orbital angular momentum, and pretzelosity](https://arxiv.org/abs/2605.06412)
*Brean Maynard,Peter Schweitzer*

Main category: hep-ph

TL;DR: The paper analyzes Generalized Transverse Momentum Dependent parton distributions using the bag model, confirming theoretical consistency and exploring relations between orbital angular momentum and pretzelosity.


<details>
  <summary>Details</summary>
Motivation: To explore the theoretical consistency of GTMDs and their relationship with orbital angular momentum.

Method: Utilizes the bag model to study GTMDs and analytically proves associated sum rules involving orbital angular momentum.

Result: Confirms the consistency of the model and establishes a relationship between orbital angular momentum and the pretzelosity TMD.

Conclusion: The study deepens the understanding of GTMDs and their implications in the field of particle physics.
...
### [22] [Quantum spin dynamics of heavy quarks and polarization observables in relativistic heavy-ion collisions](https://arxiv.org/abs/2605.06461)
*Sunil Jaiswal,Sourav Dey,Amaresh Jaiswal*

Main category: hep-ph

TL;DR: The paper presents a quantum framework for analyzing heavy-quark spin dynamics in collisions, deriving evolution equations and connecting them to observables, and compares results with experimental data on spin alignment.


<details>
  <summary>Details</summary>
Motivation: To understand heavy-quark spin dynamics and its influence on observables in relativistic heavy-ion collisions.

Method: A quantum spin-density-matrix framework is developed to derive an evolution equation for spin polarization and analytic solutions are obtained, linking results to fragmentation in heavy-flavor production.

Result: The study provides theoretical predictions for spin alignment parameters and effective depolarization strength, aligned with ALICE measurements of $D^{*+}$ in Pb-Pb collisions.

Conclusion: The results offer benchmarks for different baryon polarizations and estimate new polarization harmonics, enhancing insights into heavy-quark behavior in high-energy collision environments.
...
### [23] [TMDs in the Lens of Generative AI: A Pixel-Based Approach to Partonic Imaging](https://arxiv.org/abs/2605.06606)
*Marco Zaccheddu,Leonard Gamberg,Wally Melnitchouk,Daniel Pitonyak,Alexei Prokudin,Jian-Wei Qiu,Nobuo Sato*

Main category: hep-ph

TL;DR: This paper presents a new framework for Bayesian inference and imaging of parton distributions using nonparametric pixel-based methods integrated with generative AI and singular value decomposition.


<details>
  <summary>Details</summary>
Motivation: The need for effective extraction of transverse momentum dependent parton distributions and understanding of their evolution in a Bayesian context.

Method: A nonparametric pixel-based framework combining TMD evolution, the Collins-Soper-Sterman formalism, and generative AI through a hybrid Metropolis-Hastings approach to sample high-dimensional posteriors.

Result: Successful validation via multi-scale closure tests, characterization of uncertainty in reconstructed distributions using SVD, and identification of null TMDs.

Conclusion: The framework integrates advanced computational techniques to enable precise Bayesian imaging and reduces degeneracies, thereby facilitating unbiased 3D partonic imaging.
...
### [24] [Sensitivity Projections for Low-Mass Dark Matter Annihilation with the IceCube Upgrade](https://arxiv.org/abs/2605.06600)
...
TL;DR: The IceCube Upgrade enhances the Observatory's sensitivity to low-mass dark matter detection, particularly neutrinos from dark matter annihilation.


<details>
  <summary>Details</summary>
Motivation: To improve the detection of low-mass dark matter scenarios using the IceCube Neutrino Observatory.

Method: Analyzing neutrino fluxes from dark matter annihilation for masses between 3 GeV and 500 GeV, focusing on sources from the Sun and Galactic Center.

Result: Projections show that the IceCube Upgrade will establish stringent limits on dark matter models within this mass range, achieving leading sensitivities with three years of data collection.

Conclusion: The upgrade significantly advances our ability to study low-mass dark matter through neutrino detection.
...
### [25] [A useful representation of TESS light curves](https://arxiv.org/abs/2605.05324)
*Dovi Poznanski*

Main category: astro-ph.IM

TL;DR: This paper introduces a novel method for representing TESS light curves that enhances exploratory analysis without reliance on labels or explicit period information.


<details>
  <summary>Details</summary>
Motivation: To create a computationally efficient representation of TESS light curves that enables large-scale exploratory analysis based on meaningful similarity.

Method: Light curves are represented using quantile graphs or scattering transforms, followed by dimensionality reduction via PCA and projection onto a self-organizing map (SOM). Approximately 1500 model configurations are evaluated, leading to the selection of a compact model that balances interpretability and performance.

Result: The resulting map organizes sources primarily by variability amplitude, signal-to-noise ratio, timescale, and light-curve shape, showing that sources occupy stable map regions, thus reflecting persistent properties.

Conclusion: The representation acts as an effective tool for exploration, anomaly detection, and dataset characterization in astronomical datasets, demonstrating the value of simple encodings in identifying structures.
...
### [26] [Results of ten years of UCLA SETI searches with the Green Bank Telescope](https://arxiv.org/abs/2605.05408)
*Jean-Luc Margot*

Main category: astro-ph.IM

TL;DR: The search for narrowband radio signals using the Green Bank Telescope has detected emissions from over 70,000 celestial sources, confirming that detected signals are largely anthropogenic, and setting stringent limits on the prevalence of extraterrestrial transmitters.


<details>
  <summary>Details</summary>
Motivation: To explore the possibility of extraterrestrial communication by detecting narrowband radio signals from nearby stars and planetary systems.

Method: Utilized the L-band receiver of the Green Bank Telescope, employing a data-processing pipeline with high efficiency (94%-99%) to identify signals, while involving citizen scientists in the classification process.

Result: Detected over 100 million candidate signals, with a high confidence that they are of human origin, and established that fewer than 6.3e-5 of stars within 20,000 light-years host detectable transmitters.

Conclusion: The study enhances our understanding of potential extraterrestrial signaling and improves methodologies for signal detection, leveraging AI and citizen science.
...
### [27] [On-Chip Resonator for Nonlinear Kinetic Inductance Characterisation and Future Spectrometry Applications](https://arxiv.org/abs/2605.05452)
*Patrick Ashworth,Peter S. Barry,Chris S. Benson,Harry Gordon-Moys,Izaak Morris*

Main category: astro-ph.IM

TL;DR: Development of tunable superconducting resonators using aluminium; study on film properties for mm-wave spectrometry and potential applications.


<details>
  <summary>Details</summary>
Motivation: To enhance performance in mm-wave on-chip spectrometers through improved resonator design and optimization.

Method: Deposited thin films of superconducting aluminium, characterized by varying oxygen content and stoichiometry, followed by DC and microwave measurements to analyze properties.

Result: Identified key properties such as resistivity, critical current, and critical temperature; successfully characterized microwave and non-linear kinetic inductance properties.

Conclusion: Findings can aid in the optimization of superconducting resonators and their applications, particularly in parametric amplifiers.
...
### [28] [Systematic Spectral Distortion from Digital Whitening in Radio Telescopes and Implications for 21 cm Cosmology](https://arxiv.org/abs/2605.05489)
*Ruby Byrne,Larry R. D'Addario,Daniel C. Jacobs,Gregg Hallinan*

Main category: astro-ph.IM

TL;DR: Digital flattening and re-quantization in radio telescopes distort measured spectra, notably impacting 21 cm cosmology; mitigation strategies exist.


<details>
  <summary>Details</summary>
Motivation: Understanding systematic errors introduced during signal processing in radio astronomy, particularly from digital flattening and re-quantization.

Method: Analysis of data from OVRO-LWA and semi-analytic simulations to investigate gain-vs.-frequency distortion due to these processes.

Result: Identified systematic distortion in measured spectra, affecting scientific accuracy in cosmology; the distortion, although subtle, can be significant in certain contexts.

Conclusion: Careful gain distribution and dithering during re-quantization can reduce the distortion effect.
...
### [29] [AstroAlertBench: Evaluating the Accuracy, Reasoning, and Honesty of Multimodal LLMs in Astronomical Classification](https://arxiv.org/abs/2605.05573)
...
TL;DR: AstroAlertBench is a multimodal benchmark for evaluating LLMs in astronomical event classification, revealing the gap between accuracy and model interpretability.


<details>
  <summary>Details</summary>
Motivation: To address the bottleneck in human review of vast astronomical data through improved LLM capabilities in classification and reasoning.

Method: A three-stage evaluation process using 1,500 ZTF alerts, benchmarking 13 LLMs on metadata grounding, scientific reasoning, and hierarchical classification.

Result: Findings show discrepancies between model accuracy and the ability to self-evaluate reasoning, highlighting concerns for real-world applications.

Conclusion: AstroAlertBench establishes a framework for developing interpretable astronomical assistants while initiating a human-in-the-loop evaluation for community engagement.
...
### [30] [Muon Track Reconstruction Procedures at the Baikal-GVD Neutrino Telescope](https://arxiv.org/abs/2605.06428)
*Grigory Safronov*

Main category: astro-ph.IM

TL;DR: The Baikal-GVD neutrino telescope, the largest in the Northern Hemisphere, has developed methods for analyzing track-like events from muons to improve neutrino event reconstruction, presenting preliminary results from 2019-2021.


<details>
  <summary>Details</summary>
Motivation: To enhance the precision of neutrino arrival direction and energy reconstruction using track-like responses in the Baikal-GVD detector.

Method: The collaboration developed various analysis methods for event direction and energy reconstruction and for selecting neutrino candidate events.

Result: Preliminary results of the analysis have been presented for data collected during 2019 to 2021.

Conclusion: The analysis pipeline shows promise for improving neutrino event analysis in the Baikal-GVD telescope.
...
### [31] [Atmospheric turbulence profiling with the Multistar Turbulence Monitor](https://arxiv.org/abs/2605.06449)
*Weisen Huang,Bin Ma,Tengfei Song,Paul Hickson,Zhaohui Shang,Xuefei Zhang,Mingyu Zhao,Qing Zhou*

Main category: astro-ph.IM

TL;DR: The Multistar Turbulence Monitor (MTM) effectively characterizes atmospheric optical turbulence, showing reliable performance in simulations and on-site measurements at Daocheng Astronomical Site.


<details>
  <summary>Details</summary>
Motivation: Accurate characterization of atmospheric turbulence is crucial for evaluating astronomical sites and enhancing adaptive optics systems.

Method: MTM infers vertical distribution of the refractive-index structure constant Cn2(z) by analyzing differential image motion between stellar pairs; employs MCMC inversion for data stability and reliability.

Result: MTM reliably tracks atmospheric seeing measurements, correlating well with DIMM results and demonstrating stability across different noise levels and pixel scales.

Conclusion: MTM offers a practical, portable method for atmospheric turbulence profiling and routine monitoring.
...
### [32] [What You Don't Know Won't Hurt You: Self-Consistent Hierarchical Inference with Unknown Follow-up Selection Strategies](https://arxiv.org/abs/2605.06636)
*Reed Essick,Amanda M. Farah*

Main category: astro-ph.IM

TL;DR: The paper discusses how to accurately infer the intrinsic properties of astrophysical populations despite challenges in modeling follow-up observations from surveys.


<details>
  <summary>Details</summary>
Motivation: The complexity in selecting candidates for follow-up observations from astronomical surveys complicates the inference of intrinsic astrophysical populations.

Method: The authors use hierarchical Bayesian inference, demonstrating that accurate insights into intrinsic populations can be gained without the need to explicitly model the follow-up selection process.

Result: They show that posterior constraints are influenced by the follow-up process, and that modeling contaminant populations may be necessary when initial selections are flawed.

Conclusion: This approach simplifies the population inference process amidst the challenges posed by uncoordinated follow-ups in large-scale surveys.
...
### [33] [A preliminary exploration of the effects of baseline length for the LIFE space mission](https://arxiv.org/abs/2605.06648)
...
TL;DR: The LIFE mission aims to find habitable exoplanets using nulling interferometry, refining previous assumptions about baseline lengths for optimal performance.


<details>
  <summary>Details</summary>
Motivation: To enhance the search for habitable exoplanets, the study aims to reassess the nulling baseline lengths crucial for the LIFE mission's interferometric technique.

Method: Using the LIFEsim mission simulator and updated mathematical tools, the study analyzes the effects of varying baseline lengths on planet yield and fringe tracking.

Result: The study finds that LIFE can effectively operate with shorter baseline ranges (25-80m) or discrete baselines with minimal performance loss (<10%).

Conclusion: While shorter baselines have benefits, careful balancing of performance and implementation simplification is necessary, considering spectral weighting and baseline optimization.
...
### [34] [HOLISMOKES XXI: Detecting strongly lensed type Ia supernovae from time series of multi-band LSST-like imaging data -- Part II](https://arxiv.org/abs/2605.05318)
...
TL;DR: The study enhances a deep-learning framework for detecting lensed supernovae (LSNe) from time-domain survey images, improving simulation realism and classification performance.


<details>
  <summary>Details</summary>
Motivation: To improve prompt identification of strongly lensed supernovae for timely follow-up observations and enhance existing detection frameworks.

Method: The study extends a deep-learning model using a convolutional LSTM architecture by incorporating realistic image simulations, including PSF variations and additional negative classes to represent false positives.

Result: The model achieves a true-positive rate of ~60% at a false-positive rate of ~10^-4 by the seventh observation, and ~80% by the tenth, despite added complexities in the simulation.

Conclusion: The robust performance of the image-time-series approach under realistic conditions supports its application in real-time searches for LSNs in LSST and similar surveys.
...
### [35] [On the Origin of Mass Ejection in Failed Supernovae](https://arxiv.org/abs/2605.05289)
*Daniel A. Paradiso,Sarah Vallejo,Eric R. Coughlin*

Main category: astro-ph.HE

TL;DR: This paper explores the dynamics of weak shockwaves in high-mass stars during failed supernovae, highlighting the stability of smaller Mach number solutions and the influence of mass loss and stellar density on shock strength and material ejection.


<details>
  <summary>Details</summary>
Motivation: To understand the mechanisms behind failed supernovae and the unique transient signals associated with them, particularly focusing on the shockwave dynamics during proto-neutron star formation.

Method: The analysis involves identifying self-similar shockwave solutions and examining their stability, particularly in terms of Mach number growth over time.

Result: Larger Mach number solutions are shown to be unstable, experiencing time-dependent growth, while smaller Mach number solutions remain stable. The shock parameters are influenced by mass loss and stellar density.

Conclusion: The findings elucidate why red supergiants, with high relative mass loss, produce more luminous explosions than their more compact counterparts, emphasizing the role of neutrino-driven mass loss in shockwave dynamics.
...
### [36] [No model-independent evidence for a peak in binary black hole spin (mis)alignments](https://arxiv.org/abs/2605.05300)
*Noah E. Wolfe,Salvatore Vitale,Michael Zevin*

Main category: astro-ph.HE

TL;DR: The study assesses black-hole spin tilt distributions using LIGO-Virgo-KAGRA data, finding no significant peaks or correlations with mass, but confirming a relationship between spin magnitude and mass.


<details>
  <summary>Details</summary>
Motivation: To understand black-hole formation through spin tilt analysis, which is linked to their evolutionary histories in different astrophysical environments.

Method: Analysis of the fourth LIGO-Virgo-KAGRA gravitational-wave transient catalog, focusing on measuring spin tilt and magnitude distributions at various black hole masses.

Result: No statistically significant peak in spin tilts was found, nor a reliable way to identify black hole subpopulations based on spin; however, a strong correlation between spin magnitude and mass was confirmed.

Conclusion: While spin tilt provides limited insights, the connection between spin magnitude and mass validates previous studies, indicating a complex relationship in black hole populations.
...
### [37] [An X-ray and optical spectral study of the changing-look narrow-line Seyfert 1 2MASX J0413-0050](https://arxiv.org/abs/2605.05301)
...
TL;DR: This study examines 2MASX J0413-0050, a changing-look AGN that underwent a spectral transition and displayed significant flux variations, supporting the idea that narrow-line Seyfert 1 galaxies can exhibit changing-look behavior.


<details>
  <summary>Details</summary>
Motivation: To investigate the spectral and flux variations in AGNs, particularly focusing on the peculiar behavior of narrow-line Seyfert 1 galaxies and the classifications of changing-look AGN.

Method: The source was observed in 2021 and compared with past observations from 2004, 2020, and 2022, examining spectral transitions and X-ray flux changes to classify the AGN type.

Result: 2MASX J0413-0050 transitioned from a narrow-line Seyfert 1 to a Seyfert 1.9, with the Hbeta line disappearing and later re-emerging, while X-ray flux exhibited a decreasing trend.

Conclusion: The findings suggest that this AGN may undergo multiple accretion state changes, reinforcing the classification as a changing-state AGN and indicating that NLS1s can experience significant spectral changes.
...
### [38] [Multi-wavelength outburst activity from EP J174942.2-384834: a very faint X-ray transient discovered by Einstein Probe](https://arxiv.org/abs/2605.05303)
...
TL;DR: This study identifies EP J174942.2$-$384834, a new faint X-ray transient black hole candidate, detailing its outbursts, spectral characteristics, and optical/UV behavior based on multi-wavelength observations.


<details>
  <summary>Details</summary>
Motivation: To characterize the newly discovered transient EP J174942.2$-$384834 and understand its behavior as a potential black hole candidate.

Method: Utilized multi-wavelength observations including X-ray, optical, and UV to analyze the object's outburst behavior and spectral characteristics over a seven-month period.

Result: Revealed a consistent hard X-ray spectrum, a correlation between optical/UV and X-ray emissions, and indications of a cool truncated accretion disk without significant radio emissions.

Conclusion: EP J174942.2$-$384834 is classified as a very faint X-ray transient black hole candidate, demonstrating the capability of the Einstein Probe in detecting faint accreting objects.
...
### [39] [Moving-mesh simulations of spreading dynamics and local electron cooling in structured gamma-ray burst afterglow jets](https://arxiv.org/abs/2605.05320)
*Sayan Kundu,Hendrik van Eerten*

Main category: astro-ph.HE

TL;DR: This study investigates the dynamics and emission profiles of structured gamma-ray burst afterglow jets using numerical simulations, highlighting the effects of jet structure on spreading and spectral features.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics of structured gamma-ray burst afterglow jets and their emission profiles better, thus providing insights into jet behavior and cooling mechanisms.

Method: Utilized the relativistic moving-mesh hydrodynamics code GAMMA for numerical simulations of axi-symmetric gamma-ray burst jets, focusing on the impact of jet structure and cooling mechanisms on dynamics and observed spectra.

Result: The study found that the jet's spreading is influenced by its initial angular structure but stabilizes once the jet width is exceeded. Significant shifts in the synchrotron cooling break frequency were observed due to local cooling effects, leading to sharper and smoother spectral features.

Conclusion: Local cooling mechanisms produce distinct emission characteristics in gamma-ray burst jets compared to global cooling approaches, providing a more nuanced understanding of afterglow emissions and cooling breaks.
...
### [40] [Astrophysical X-Ray Polarization](https://arxiv.org/abs/2605.05355)
*Philip Kaaret,Brian D. Ramsey*

Main category: astro-ph.HE

TL;DR: X-ray polarimetry enhances the study of high-energy astrophysical phenomena by providing new data on polarization, informing the understanding of accretion flows and magnetic fields.


<details>
  <summary>Details</summary>
Motivation: To explore the new insights gained from X-ray polarimetry in analyzing astrophysical systems, particularly in understanding accretion flows and magnetic fields.

Method: The review covers the fundamental processes behind polarized X-rays and methods for measuring polarization, as well as a discussion of existing and upcoming detectors.

Result: Highlights the significance of X-ray polarization metrics in revealing structural details of astrophysical phenomena.

Conclusion: X-ray polarimetry is a valuable tool for deepening astrophysical knowledge and warrants further technological development.
...
### [41] [Multiwavelength Analysis of PSR J0437-4715 with Pulse Profile Modeling](https://arxiv.org/abs/2605.05429)
*Liqiang Qi,Juan Zhang,Weiwei Xu,Shijie Zheng,Mingyu Ge,Ang Li,Shuang-Nan Zhang,Hua Feng,Fangjun Lu*

Main category: astro-ph.HE

TL;DR: A comprehensive multi-wavelength analysis of the millisecond pulsar PSR J0437–4715, integrating HST, ROSAT, and XMM-Newton data to derive stellar parameters using Bayesian inference.


<details>
  <summary>Details</summary>
Motivation: To enhance understanding of neutron star properties using a combined analysis of multi-wavelength data for PSR J0437–4715.

Method: Utilized far-ultraviolet, soft X-ray, and X-ray data to model pulsar emission components and infer parameters via Bayesian techniques, considering different thermal and non-thermal emissions.

Result: Achieved a gravitational mass of 1.38±0.03 M⊙ and equatorial radius of 13.25−0.35+0.34 km, with refined constraints from the hot-spot geometry.

Conclusion: The research highlights the necessity of multi-wavelength data for accurate neutron star mass-radius measurements and resolving geometric uncertainties.
...
### [42] [Searches for Binary Mergers with Sub-solar Mass Components in Data from the First Part of LIGO--Virgo--KAGRA's Fourth Observing Run](https://arxiv.org/abs/2605.05444)
...
TL;DR: This study investigates compact binary coalescences with at least one component mass between $0.2 M_	ext{odot}$ and $1 M_	ext{odot}$ using LIGO data. No significant detections were found, leading to upper limits on merger rates and constraints on dark matter models.


<details>
  <summary>Details</summary>
Motivation: To explore the existence and merger rates of sub-solar mass compact objects and assess their potential contributions to dark matter, particularly in the context of primordial and dark black holes.

Method: Data from LIGO detectors from May 2023 to January 2024 was analyzed for gravitational wave signals from binary coalescences with specified mass criteria, with no significant candidates identified.

Result: Detection sensitivity for sub-solar mass black holes was reported, with upper limits on their merger rates set between 110 and 10,000 $	ext{Gpc}^{-3} 	ext{yr}^{-1}$ at 90% confidence, and calculated constraints on dark matter scenarios.

Conclusion: The study effectively limits the fraction of dark matter that can be accounted for by primordial black holes and dark black holes at certain mass thresholds, concluding minimal contributions to dark matter from these compact objects.
...
### [43] [A Multiwavelength Assessment Disfavoring the X-ray Binary Origin of He III Regions in Metal-Poor Star-Forming Dwarf Galaxies](https://arxiv.org/abs/2605.05548)
...
TL;DR: This study investigates the ionizing radiation sources in metal-poor star-forming dwarf galaxies exhibiting He II emission, revealing that current X-ray observations fall short in explaining the required extreme-ultraviolet radiation.


<details>
  <summary>Details</summary>
Motivation: To understand the sources of extreme-ultraviolet radiation necessary for ionizing He III regions in metal-poor dwarf galaxies, which is crucial for understanding early galaxy formation.

Method: A systematic observational study using 7 new and 36 archival Chandra X-ray observations combined with optical stellar population synthesis modeling to analyze ionizing continua.

Result: Inferred extreme-ultraviolet output from accreting X-ray sources is lower than needed to sustain He II emission, consistent with known empirical X-ray luminosity relations and indicating X-ray sources alone are insufficient.

Conclusion: The findings suggest the need for additional or alternative sources of hard EUV radiation in these galaxies, as current X-ray sources do not meet the ionizing photon budget necessary for the observed He II emission.
...
### [44] [How do the LIGO-Virgo-KAGRA's Heavy Black Holes Form? No evidence for core-collapse Intermediate-mass black holes in GWTC-4](https://arxiv.org/abs/2605.05563)
*Fan-Xiao-Yu Xia,Yuan-Zhu Wang,Ying Qin*

Main category: astro-ph.HE

TL;DR: This study analyzes the population properties of high-mass binary black holes (BBHs) from the GWTC-4 catalog and investigates low-spin intermediate-mass black holes (IMBHs). No evidence for low-spin IMBHs is found; a merger rate limit is set. The mass distribution of low-spin black holes truncates near the pair-instability mass gap, and high-spin IMBHs are identified as possibly formed via mergers.


<details>
  <summary>Details</summary>
Motivation: To investigate the characteristics and formation mechanisms of binary black holes, particularly focusing on high-mass ranges and the potential existence of low-spin intermediate-mass black holes.

Method: Analysis of data from the GWTC-4 catalog to search for low-spin intermediate-mass black holes and to characterize the mass distribution of black holes.

Result: No evidence for a subpopulation of low-spin IMBHs is found, establishing a merger rate limit. The mass distribution of low-spin black holes truncates around 65 M⊙, aligning with the lower edge of the pair-instability mass gap.

Conclusion: The observed IMBHs appear to belong to a high-spin subpopulation, indicating they likely formed through hierarchical mergers.
...
### [45] [An Insight-HXMT View of the Evolution of the Type-C Quasiperiodic Oscillation during the Flaring State of Swift J1727.8-1613](https://arxiv.org/abs/2605.05735)
...
TL;DR: The paper analyzes type-C QPOs in the black hole X-ray binary Swift J1727.8-1613, revealing distinct behaviors in QPO amplitude and frequency across energy bands, with notable changes at 4 Hz indicating geometry alterations in accretion flow.


<details>
  <summary>Details</summary>
Motivation: To understand the behavior of QPOs during the flaring state of the black hole X-ray binary Swift J1727.8-1613 and how this varies across energy bands.

Method: Data from the Insight Hard X-ray Modulation Telescope was utilized to examine the relationship between QPO fractional rms amplitude and frequency across various energy bands.

Result: Distinct behaviors were observed: below 10 keV, QPO fractional rms decreases with frequency, while above 10 keV, it stabilizes; a break at 4 Hz was identified in both 2-4 and 50-100 keV bands, indicating a change in the accretion flow's geometry.

Conclusion: The observed break at 4 Hz signifies a significant change in the spectral parameters, suggesting alterations in the geometry of the accretion flow.
...
### [46] [Tearing of charged current layers](https://arxiv.org/abs/2605.06085)
*Maxim Lyutikov*

Main category: astro-ph.HE

TL;DR: This study uses PIC simulations to analyze the dynamics and plasmoid formation in charged astrophysical current layers, highlighting the interplay between electrostatic waves and current tearing modes.


<details>
  <summary>Details</summary>
Motivation: To explore the stability and dynamics of electrically charged astrophysical current layers, considering their implications in astrophysical phenomena like pulsar winds.

Method: Using particle-in-cell (PIC) simulations to investigate charged Harris-type and rotational current layers, examining the interactions of electrostatic Bernstein waves and current instabilities.

Result: The study finds that charged layers exhibit electrostatic instabilities, with Bernstein waves redistributing charge without significantly altering plasmoid growth, while rotational layers show increased charge fluctuations and tearing rates depending on temperature and charge configuration.

Conclusion: The findings elucidate the importance of charge dynamics in current layers and their implications for astrophysical phenomena, suggesting that charge presence influences instability and plasmoid evolution.
...
### [47] [A comparative study of occurrence rates and nature of Ultraluminous X-ray sources in spiral and elliptical galaxies](https://arxiv.org/abs/2605.06133)
*C. M. Sariga,P. Shalima,D. Bhattacharya,Vivek K. Agrawal*

Main category: astro-ph.HE

TL;DR: This study investigates the properties of Ultraluminous X-ray sources (ULXs) in galaxies, focusing on their occurrence rates in spiral and elliptical galaxies and identifying key differences based on these rates.


<details>
  <summary>Details</summary>
Motivation: To explore the differences in properties of ULXs between galaxies that host either a single ULX or multiple ULXs, enhancing our understanding of their distribution and characteristics.

Method: An effective scheme to generate flux-limited samples of ULXs in spirals and ellipticals, analyzing the differences between groups with one ULX per galaxy versus those with multiple.

Result: Identification of a distinct population of ULXs in $N=1$ spiral galaxies with varied sources, alongside the discovery of ULXs in $N=1$ ellipticals associated with globular clusters.

Conclusion: The findings suggest a potential correlation between ULX types, occurrence rates, and galaxy morphology, highlighting the need for further observations and spectral analyses.
...
### [48] [Vacuum polarization and cyclotron resonance effects on radiative transfer and plasma deceleration in subcritical X-ray pulsars](https://arxiv.org/abs/2605.06162)
*I. D. Markozov,A. Y. Potekhin,A. D. Kaminker,A. A. Mushtukov*

Main category: astro-ph.HE

TL;DR: This study analyzes radiation characteristics of a subcritical X-ray pulsar, focusing on polarized radiative transfer and the effects of magnetic fields and vacuum polarization.


<details>
  <summary>Details</summary>
Motivation: To understand the interaction of accreting matter and radiation in a strong magnetic field, particularly in the subcritical regime of X-ray pulsars.

Method: Utilized self-consistent radiation-hydrodynamic simulations to model the accretion channel and analyzed the polarized radiative transfer considering resonant Compton scattering and vacuum polarization effects.

Result: Demonstrated that resonant scattering governs the deceleration of accreting matter and identified that vacuum polarization influences cyclotron spectral features and changes the linear polarization degree at specific photon energies.

Conclusion: Established a correlation between accretion luminosity and the centroid energy of the cyclotron scattering feature, aligning with prior observational and theoretical findings.
...
### [49] [Early interaction signatures and an extended plateau phase in Type II SN 2020aze](https://arxiv.org/abs/2605.06313)
...
TL;DR: Analysis of SN 2020aze shows a fast decline and interaction with circumstellar material, indicating a red supergiant progenitor with significant mass loss.


<details>
  <summary>Details</summary>
Motivation: To understand the characteristics and progenitor system of Type II supernovae by observing the fast-declining SN 2020aze.

Method: Photometric and spectroscopic observations over 137 days, including early spectra analysis and semi-analytical light-curve modeling.

Result: The light curve peaked at -16.97 mag, with a decline of 2.04 mag/100 days; initial radius ~1100 solar radii, ejecta mass ~12 solar masses, explosion energy ~1.5e51 erg.

Conclusion: The findings underscore the influence of pre-supernova mass loss and interactions on Type II supernova diversity.
...
### [50] [Gravitational Lensing of Gravitational Waves from Astrophysical Sources: Theory, Detection, and Applications](https://arxiv.org/abs/2605.06321)
*Zhiwei Chen,Youjun Lu*

Main category: astro-ph.HE

TL;DR: This paper reviews the phenomenon of gravitational wave (GW) lensing, detailing its theoretical basis, detection prospects, and implications for fundamental physics and cosmology.


<details>
  <summary>Details</summary>
Motivation: To explore how gravitational waves from compact binary sources can be lensed by various cosmic structures and their potential to reveal insights into dark matter and cosmological parameters.

Method: The paper reviews the theoretical framework of GW lensing, categorizing it into geometric and wave optics, and discusses detection strategies and expected rates based on the mass and redshift distributions of source and lensing objects.

Result: The review outlines the identification of lensed signals through parameter overlap and frequency-dependent waveform modulations, suggesting promising detection rates for future observatories.

Conclusion: Lensed gravitational waves have significant potential as tools for enhancing our understanding of fundamental physics and cosmology, with suggested future directions for research and observation.
...
### [51] [Fifteen new millisecond pulsars in 47 Tucanae](https://arxiv.org/abs/2605.06492)
...
TL;DR: The study reports the discovery of fifteen new pulsars in the globular cluster 47 Tucanae using the MeerKAT telescope, increasing the total known pulsars in the cluster to 42. Key findings include unique systems with significant orbital characteristics.


<details>
  <summary>Details</summary>
Motivation: To enhance the understanding of stellar dynamics and evolution in 47 Tucanae by discovering additional pulsars, which are critical for dynamic investigations and might reveal unusual systems.

Method: Utilized MeerKAT for two observational campaigns tailored for the cluster's high scintillation, allowing for greater sensitivity and the discovery of new pulsars.

Result: Discovered fifteen new pulsars, bringing the total to 42, including notable systems like a 'black widow' pulsar and an eccentric binary pulsar with a massive companion, and re-localised elusive systems.

Conclusion: The findings expand the pulsar catalog in 47 Tucanae, providing insight into the cluster’s stellar population and dynamics, and underscore MeerKAT's capability for sensitive astronomical surveys.
...
### [52] [Error Mitigation in Dynamic Circuits for Hamiltonian Simulation](https://arxiv.org/abs/2605.05256)
*Sumeet Shirgure,Siyuan Niu*

Main category: quant-ph

TL;DR: This paper investigates error mitigation techniques for dynamic quantum circuits, focusing on reducing circuit errors during mid-circuit measurements and feed-forward operations, particularly in Hamiltonian simulations.


<details>
  <summary>Details</summary>
Motivation: Dynamic quantum circuits improve quantum protocols through real-time processing, but high error rates during execution on hardware challenge fidelity.

Method: The study examines standard error mitigation techniques, specifically dynamical decoupling (DD) and zero-noise extrapolation (ZNE), applied to dynamic circuits in Hamiltonian simulation scenarios on IBM quantum hardware.

Result: The approach combining DD and ZNE leads to a noticeable fidelity improvement (60% for ground state estimation) and significant error reduction (99% for time-evolved states of the Ising model and 20% for the Heisenberg model).

Conclusion: Implementing DD and ZNE strategies effectively mitigates errors from mid-circuit measurements and enhances the practical application of dynamic quantum circuits.
...
### [53] [Negative refraction with absorption suppressed by electromagneticly induced transparency in a left-handed atomic system](https://arxiv.org/abs/2605.05261)
*Shun-Cai Zhao*

Main category: quant-ph

TL;DR: The paper explores achieving negative refraction with reduced absorption using electromagnetically induced transparency (EIT) in a four-level atomic system.


<details>
  <summary>Details</summary>
Motivation: The research addresses the challenge of high dissipation and absorption in negative refractive materials.

Method: Utilizing a four-level atomic system to achieve negative refraction characterized by negative permittivity and permeability, alongside EIT for enhanced signal response.

Result: Negative refraction is realized with minimized absorption in specified frequency ranges, though high signal intensity risks increasing absorption near resonance.

Conclusion: The proposed scheme offers a pathway to low-loss negative refraction but must manage signal intensity to avoid excessive absorption.
...
### [54] [Quantum Proper Scoring Rules: Minimax Estimation and Resource-Theoretic Advantages](https://arxiv.org/abs/2605.05268)
*M. W. AlMasri*

Main category: quant-ph

TL;DR: This paper extends proper scoring rules to the quantum realm, focusing on quantum value functionals, minimax bounds for state estimation, and the economic value of quantum resources.


<details>
  <summary>Details</summary>
Motivation: To bridge classical proper scoring rules with quantum applications, providing new insights and bounds for quantum state estimation and resource quantification.

Method: Generalization of proper scoring rules using density operators, introduction of quantum value functionals through operator convex generators, and the establishment of a duality theory.

Result: Derivation of a Quantum Cramér-Rao-McCarthy Bound linking minimax risk, curvature, and Quantum Fisher Information, along with quantification of quantum resources' economic value.

Conclusion: The findings enhance understanding of quantum estimation strategies and have practical implications for quantum technologies like sensors and machine learning.
...
### [55] [Krylov Dynamics and Operator Growth in Time-Dependent Systems via Lie Algebras](https://arxiv.org/abs/2605.05290)
*András Grabarits,E. Medina-Guerra,Adolfo del Campo*

Main category: quant-ph

TL;DR: This paper explores quantum dynamics in Krylov spaces influenced by time-dependent Hamiltonians, linking these dynamics to the Hamiltonian's Lie-algebraic structure, and introducing a unified framework for understanding operator growth and complexity in such systems.


<details>
  <summary>Details</summary>
Motivation: To understand quantum dynamics in variable systems and establish a relationship with Lie-algebraic structures, providing insights into operator growth and complexity.

Method: Analysis of dynamical behavior in time-dependent Krylov subspaces using ladder operators from the associated Lie algebra, identifying conditions for the dynamical representation and extending to various examples.

Result: Establishment of a framework wherein time-dependent Krylov dynamics is governed by the interaction-picture Hamiltonian, alongside a new quantum speed limit applicable in these contexts.

Conclusion: The framework allows for comprehensive characterization of operator growth and Krylov complexity in time-dependent systems, emphasizing the role of temporal driving and Hamiltonian commutation.
...
### [56] [Systematic construction of quantum many-body scars in frustrated Rydberg arrays](https://arxiv.org/abs/2605.05297)
*Jean-Yves Desaules,Aron Kerschbaumer,Marko Ljubotina,Maksym Serbyn*

Main category: quant-ph

TL;DR: The paper investigates quantum many-body scars in Rydberg atom arrays, proposing a framework to identify scars on arbitrary lattices and demonstrating two mechanisms for their existence on frustrated systems.


<details>
  <summary>Details</summary>
Motivation: To explore the existence and behavior of quantum many-body scars in Rydberg atom arrays on non-bipartite lattices and understand their relation to frustration and initial state selection.

Method: A graph-theoretic framework is developed to identify candidate states for scarring in various lattice configurations, leading to two identified mechanisms of type-I and type-II scars.

Result: Both mechanisms were numerically demonstrated on a hexagonal lattice, revealing an exponential family of scarred trajectories that can encode information resistant to thermalization.

Conclusion: The findings confirm that scarring is a generic phenomenon in Rydberg atom systems and offer a new method for investigating non-thermal dynamics in quantum simulations.
...
### [57] [Universal Neural Propagator: Learning Time Evolution in Many-Body Quantum Systems](https://arxiv.org/abs/2605.05299)
*Zihao Qi,Christopher Earls,Yang Peng*

Main category: quant-ph

TL;DR: This paper proposes the Universal Neural Propagator (UNP), a self-supervised model for simulating quantum many-body dynamics across varying Hamiltonians and initial states, demonstrating improved accuracy and transferability.


<details>
  <summary>Details</summary>
Motivation: Conventional methods only simulate single trajectories, necessitating re-computation for changes in Hamiltonians or initial states. There is a need for a more flexible approach to quantum many-body dynamics.

Method: The authors introduce the Universal Neural Propagator (UNP), a unified model that maps driving protocols to time-evolution propagators, trained in a self-supervised manner to predict dynamics across multiple driving protocols and initial states simultaneously.

Result: UNP shows accuracy and transferability in simulating a two-dimensional driven Ising model, maintaining performance across diverse initial states and driving protocols, and proving effective even beyond exact diagonalization limits.

Conclusion: By focusing on learning operators instead of just quantum states, the UNP paves the way for effective transferability in simulations of driven quantum systems.
...
### [58] [Two Layers, No Swaps: Biplanar SPOQC Architecture Improves Runtime of Fermi-Hubbard Simulation](https://arxiv.org/abs/2605.05315)
*Boris Bourdoncle,Peter-Jan Derks,Théo Dessertaine,Johannes Frank*

Main category: quant-ph

TL;DR: The paper estimates the runtime and costs associated with simulating the Fermi-Hubbard model on a biplanar SPOQC system, highlighting improvements in logical timestep efficiency and examining error sources.


<details>
  <summary>Details</summary>
Motivation: To enhance simulation accuracy and efficiency of the two-dimensional Fermi-Hubbard model using advanced quantum computing architectures.

Method: The study employs a biplanar SPOQC architecture with honeycomb Floquet codes, optimizing Trotterization for time evolution while addressing error sources collaboratively.

Result: The proposed method reduces logical timestep depth significantly, with a total estimated runtime of 2 hours using $1.35 \times 10^6$ physical qubits for an $8 \times 8$ lattice.

Conclusion: Fallback rotation synthesis methods present a scalability issue, as their success probability declines exponentially with system size, leading to increased expected runtime.
...
### [59] [Analytical Angle-Finding and Series Expansions for Quantum Signal Processing via Orthogonal Polynomial Theory](https://arxiv.org/abs/2605.05321)
*Pierre-Antoine Bernard,Nathan Wiebe*

Main category: quant-ph

TL;DR: This paper explores quantum signal processing, detailing polynomial bases used for Hamiltonian simulation, deriving explicit quantum angles for various polynomial families, and establishing connections to orthogonal polynomial theory.


<details>
  <summary>Details</summary>
Motivation: To improve quantum algorithms through effective polynomial approximation techniques in quantum signal processing.

Method: Characterizes polynomial bases by orthogonality, derives quantum angles for polynomial sequences, and establishes a method for finding angles using their roots.

Result: Demonstrates that $2n+2$ rotation angles are necessary for polynomials of degree $n$ and shows that an $ε$-approximation can be achieved with $O(	ext{log}(1/ε))$ gates.

Conclusion: Establishes necessary conditions for achievable polynomials in the bivariate QSP setting and provides a complete characterization of polynomials for $	ext{SU}(1,1)$-QSP.
...
### [60] [Learning Gaussian optical states with quantum computers](https://arxiv.org/abs/2605.05325)
*Spencer Dimitroff,John Kallaugher,Ashe Miller,Mohan Sarovar*

Main category: quant-ph

TL;DR: The paper examines the advantages of using quantum computers for learning Gaussian states in electromagnetic fields, showing that fewer copies are needed for accurate parameter estimation compared to classical methods.


<details>
  <summary>Details</summary>
Motivation: To explore how quantum learning can enhance the estimation of unknown quantum states, particularly in applications like imaging and sensing of weak electromagnetic fields.

Method: The authors connect quantum learning theory to the transduction of an $n$-mode Gaussian state into qubits, followed by optimized measurements to extract state parameters.

Result: A rigorous bound on the number of Gaussian state copies required for accurate parameter estimates shows exponential improvement over classical approaches.

Conclusion: The proposed method demonstrates significantly better scaling and energy dependence compared to traditional classical shadows in characterizing Gaussian states.
...
### [61] [Geometric and Topological Obstructions to Hermitianization in Quasi-Hermitian Quantum Systems](https://arxiv.org/abs/2605.05335)
*Ming-Zhang Wang,Xu-Yang Hou,Hao Guo*

Main category: quant-ph

TL;DR: This paper discusses the conditions required for quasi-Hermitian quantum systems to be globally transformed into Hermitian systems, identifying geometric and topological obstructions to this process.


<details>
  <summary>Details</summary>
Motivation: To understand under what conditions quasi-Hermitian systems can be appropriately Hermitianized, particularly in terms of dynamical equivalence.

Method: The paper defines and analyzes geometric and topological obstructions to the similarity transformation necessary for Hermitianization, providing explicit criteria and examples for these obstructions.

Result: It establishes clear conditions under which quasi-Hermitian systems can be globally mapped to Hermitian systems, highlighting cases when non-Hermitian characteristics persist.

Conclusion: The findings offer a comprehensive geometric and topological framework for understanding the Hermitianization of quasi-Hermitian systems.
...
### [62] [Efficient Quantum Fourier Transforms For Semisimple Algebras](https://arxiv.org/abs/2605.05337)
*Ben Foxman,Barak Nehoran,Yongshan Ding*

Main category: quant-ph

TL;DR: This paper generalizes the quantum Fourier transform (QFT) for finite groups to finite-dimensional semisimple algebras, providing efficient quantum algorithms for various algebras with applications in quantum computation.


<details>
  <summary>Details</summary>
Motivation: The study extends the quantum Fourier transform's applicability from finite groups to semisimple algebras, which are crucial in advanced quantum algorithms and theoretical physics.

Method: An efficient quantum algorithm is proposed that approximates the Fourier transform of several algebras with specific gate complexity and error bounds.

Result: The proposed algorithm has gate complexity $	ext{poly}(n,	ext{log } d,	ext{log}(1/	ext{ε}))$ and achieves an approximation error of $(d^{-1/2}+	ext{ε})	ext{poly}(|A|)$ for algebras like the partition and Brauer algebras.

Conclusion: The findings suggest that with a sufficiently large parameter $d$, non-unitary Fourier transforms can still yield results close to unitary transforms, enhancing the algorithmic capabilities in quantum computation.
...
### [63] [Kinetically constrained superradiance](https://arxiv.org/abs/2605.05343)
*Luis Fernando dos Prazeres,Hossein Hosseinabadi,Jamir Marino*

Main category: quant-ph

TL;DR: The paper introduces kinetically constrained superradiance, which enables multiple collective decay channels through interaction-dependent energy shifts, stabilizes long-lived entanglement via dissipation, and offers insights for quantum state engineering in superradiant experiments.


<details>
  <summary>Details</summary>
Motivation: To explore new forms of cooperative emission that allow for distinct many-body spin configurations and long-lived quantum correlations through dissipation.

Method: The authors analyze a new superradiant regime where interactions lead to configuration-dependent energy shifts in optical transitions, creating multiple radiative channels and non-trivial relaxation dynamics.

Result: Demonstrated that different many-body spin configurations selectively radiate, leading to varying relaxation dynamics, and stabilizing entangled states without the need for coherent dynamics.

Conclusion: Kinetically constrained superradiance offers potential for dissipative engineering of complex quantum states, suggesting utility in advanced superradiant experiments.
...
### [64] [The true cost of factoring: Linking magic and number-theoretic complexity in Shor's algorithm](https://arxiv.org/abs/2605.05347)
*Alessio Paviglianiti,Matteo Seclì,Emanuele Tirrito,Vincenzo Savona*

Main category: quant-ph

TL;DR: This paper explores the quantification of quantum resources necessary for executing quantum algorithms, particularly focusing on Shor's factoring algorithm and the role of non-stabilizerness.


<details>
  <summary>Details</summary>
Motivation: Highlighting the gap in understanding the genuine quantum resources needed for successful quantum computation.

Method: Investigating non-stabilizerness in Shor's algorithm and developing an analytic theory to assess its impact on quantum resource requirements.

Result: Demonstrated a connection between quantum complexity and the number-theoretic hardness of factoring, emphasizing the maximized use of quantum resources in the algorithm.

Conclusion: The findings provide a resource-based metric that enhances the understanding of computational challenges in fault-tolerant quantum computing.
...
### [65] [Toward Hop-Independent Fidelity in Quantum Data Centers: Resource Requirements for Entanglement Purification](https://arxiv.org/abs/2605.05369)
*Mohadeseh Azari,Anoosha Fayyaz,Amy Babay,David Tipper,Prashant Krishnamurthy,Kaushik Seshadreesan*

Main category: quant-ph

TL;DR: The paper examines the efficacy of entanglement purification in quantum data-center networks, focusing on the balance between entanglement quality degradation over multi-hop paths and purification success rates.


<details>
  <summary>Details</summary>
Motivation: To determine if sufficient raw end-to-end entanglement copies exist to overcome fidelity loss through purification in various quantum network topologies.

Method: A topology-independent black-box model of the network is used, with links modeled as Werner states. Purification methods compared include recursive BBPSSW and higher-order bilocal-Clifford protocols, using dynamic programming for success probability calculations.

Result: The analysis reveals a threshold governed by the Werner condition and shows that multi-copy purification improves feasibility and efficiency. The Jansen purification method outperforms BBPSSW in most scenarios, requiring significantly fewer copies.

Conclusion: The study establishes a benchmark for evaluating future quantum data-center architectures concerning their ability to sustain high-quality, hop-independent end-to-end entanglement.
...
### [66] [BARFI-Q: Quantum-Enhanced Block Attention Residual Fusion Framework for Multivariate Time-Series Forecasting in Atom Interferometry](https://arxiv.org/abs/2605.05394)
*Muhammad Bilal Akram Dastagir,Omer Tariq,Safaa Alqrinawi,Shaikha Al-Naimi,Ahmed Farouk,Saif Al-Kuwari*

Main category: quant-ph

TL;DR: BARFI-Q is a novel Quantum-Enhanced Block Attention Residual Fusion framework that enhances multivariate time-series forecasting in atom interferometry by effectively modeling long-range temporal dependencies and interactions among sensing sources.


<details>
  <summary>Details</summary>
Motivation: Accurate forecasting of heterogeneous multivariate temporal streams in atom interferometry is crucial for predictive monitoring and intelligent quantum sensing, necessitating effective modeling of complex interactions and dependencies.

Method: BARFI-Q employs patch-based embedding, dual-branch temporal modeling, hierarchical fusion, and an adaptive block-attention mechanism, along with a quantum feature mapping module to forecast time-series data.

Result: BARFI-Q consistently outperforms conventional Transformer-based models across different historical window sizes and shows significant improvements in modeling multiscale temporal learning and feature interactions.

Conclusion: The integration of quantum-enhanced techniques and adaptive mechanisms in BARFI-Q provides a robust framework for forecasting in atom interferometry, indicating the potential for advanced quantum sensing applications.
...
### [67] [Signature structure of quadratic response under Zeno-Schur coarse graining in open quantum systems](https://arxiv.org/abs/2605.05417)
*Ansgar Pernice*

Main category: quant-ph

TL;DR: This paper explores how quadratic response tensors, significant in quantum kinetic descriptions, are affected by monitoring-induced coarse graining, revealing potential for negative directions in positivity due to coupling with fast degrees of freedom.


<details>
  <summary>Details</summary>
Motivation: To understand modifications of quadratic response structures under the influence of monitoring methods, specifically in quantum kinetic systems represented by the QLBE.

Method: The study employs the GKSL framework and applies Zeno elimination to fast degrees of freedom, leading to a subtractive renormalization characterized by Schur-complement structure.

Result: The analysis reveals that the positive definiteness of response tensors can be violated due to interactions between slow and quickly damped sectors, indicating the emergence of negative directions.

Conclusion: The findings suggest a new framework for understanding the dynamic reorganization of quadratic response tensors in QLBE-type systems under Zeno-induced coarse graining.
...
### [68] [Quantum Simulation of the Real-time Dynamics in the multi-flavor Gross-Neveu Model at the utility scale using Superconducting Quantum Computers](https://arxiv.org/abs/2605.05479)
*Talal Ahmed Chowdhury,Seokwon Choi,Kyoungchul Kong,Kwangmin Yu*

Main category: quant-ph

TL;DR: The paper introduces a quantum simulation framework for the multi-flavor Gross-Neveu model using superconducting processors, emphasizing a novel operator approximation method that enhances simulation efficiency and feasibility.


<details>
  <summary>Details</summary>
Motivation: This work aims to address the limitations of current quantum simulation techniques for interacting fermionic field theories, paving the way for larger and more complex simulations.

Method: The authors implement a hardware-efficient Trotterization that optimizes circuit depth based on fermion flavor and develop the Localized Diagonal Operator Approximation (LDOA) for reducing overhead from quartic interactions, employing a least-squares approach for diagonal unitary synthesis.

Result: The simulations demonstrate accurate results for real-time observables like density-density correlators when benchmarked against exact diagonalization and tensor network methods, displaying strong agreement across varying system sizes.

Conclusion: The study establishes a scalable method for quantum field theory simulations and highlights the synergy between circuit design and rigorous approximations, enabling significant advancements in practical quantum computing applications.
...
### [69] [Non-Markovian delay-assisted sensing with waveguide-coupled quantum emitters](https://arxiv.org/abs/2605.05434)
*Prajit Dhara,Isack Padilla,Saikat Guha,Annyun Das,Kanu Sinha*

Main category: quant-ph

TL;DR: Time-delayed feedback in two waveguide-coupled quantum emitters enhances sensitivity to field gradients via non-Markovian dynamics.


<details>
  <summary>Details</summary>
Motivation: Understanding how to improve sensing capabilities of quantum systems using time-delayed feedback and non-Markovian interactions.

Method: Analyzed two quantum emitters in a waveguide setup, considering the impact of external fields and interatomic distances on their non-Markovian dynamics and quantum Fisher information.

Result: Demonstrated that non-Markovian delays enhance quantum Fisher information for estimating field gradients, through quasi-bound states and multiple spectral modes of the field.

Conclusion: The study underscores the potential of non-Markovian dynamics and time-delayed feedback as valuable resources in distributed quantum sensing configurations.
...
### [70] [Operationally Admissible Post-Quantum Correlations from a Standard Quantum Walk](https://arxiv.org/abs/2605.05477)
*Marcos C. de Oliveira*

Main category: quant-ph

TL;DR: This paper demonstrates that a standard one-dimensional quantum walk can yield post-quantum correlations in a Bell scenario through an extended coin preparation, maintaining unitary dynamics and violating complementarity.


<details>
  <summary>Details</summary>
Motivation: To investigate how a standard quantum walk can give rise to post-quantum correlations without modifying its dynamics.

Method: Utilizes an extended operational preparation of the coin via a Hermitian trace-one operator, ensuring physical consistency at the observable statistics level using admissibility and no-signaling principles.

Result: The quantum walk can achieve CHSH values exceeding Tsirelson's bound, indicating significant post-quantum correlations, while the dynamics remain standard.

Conclusion: Although the generated post-quantum behavior exists, its practical accessibility is limited by natural measurement constraints, highlighting the gap between theoretical potential and realistic observation.
...
### [71] [Classical shadows over symmetric spaces](https://arxiv.org/abs/2605.05518)
*Rebecca Chang,Maureen Krumtünger,Martin Larocca,Maxwell West*

Main category: quant-ph

TL;DR: The study enhances classical shadow protocols for estimating quantum state expectation values, exploring scenarios beyond uniform sampling from compact groups by using compact symmetric spaces, leading to improved sample-complexity in some cases.


<details>
  <summary>Details</summary>
Motivation: To expand the understanding of classical shadow protocols in quantum state estimation beyond standard assumptions, particularly concerning sampling methods.

Method: The authors analyze protocols based on uniform sampling from compact symmetric spaces, developing a unifying theoretical framework for these extended classical shadows.

Result: Some protocols derived from this framework demonstrate improvements in sample-complexity for estimating certain observables compared to traditional shadow schemes.

Conclusion: This work advances the mathematical foundations of classical shadows and shows that more efficient sampling methods can improve the estimation process in quantum computations.
...
### [72] [Temporal Coarse-Graining as the Origin of Macroscopic Friction in Quantum Spin Chains via Data-Driven Liouvillian Extraction](https://arxiv.org/abs/2605.05604)
*Seiki Saito*

Main category: quant-ph

TL;DR: This paper presents a data-driven framework to derive hydrodynamic coefficients in isolated quantum systems, revealing how macroscopic friction and viscosity emerge from the observer's temporal resolution.


<details>
  <summary>Details</summary>
Motivation: The study aims to address the challenge of reconciling macroscopic irreversible hydrodynamics with the reversible dynamics of isolated quantum systems and to understand the influence of observer temporal resolution on this relationship.

Method: The authors employ a generalized Extended Dynamic Mode Decomposition (gEDMD) with Mori-Zwanzig projection, expanding the observable space to include spin currents for extracting Navier-Stokes coefficients from a chaotic XXZ spin chain.

Result: The extraction reveals that mechanical elasticity is derived from exact unitary dynamics, while macroscopic friction and viscosity oscillate around zero, necessitating finite temporal coarse-graining for observable transport properties.

Conclusion: Macroscopic friction in isolated quantum systems emerges from the observer's temporal resolution, indicating that it is not an inherent property but a consequence of finite coarse-graining in dynamics.
...
### [73] [Dynamical Signatures of Floquet Topology in Wave Packet Dynamics](https://arxiv.org/abs/2605.05608)
*Xin Shen,Bing Lu,Yan-Qing Zhu*

Main category: quant-ph

TL;DR: This study develops a Floquet perturbation theory to analyze the center-of-mass dynamics in periodically driven quantum systems, revealing new signatures of topological phase transitions.


<details>
  <summary>Details</summary>
Motivation: To overcome challenges in dynamically characterizing non-equilibrium topological invariants in Floquet systems.

Method: The study introduces a Floquet perturbation theory in an extended Hilbert space to analytically describe the CoM dynamics of wave packets.

Result: Application to the Su-Schrieffer-Heeger model shows Zitterbewegung oscillations, linked with Floquet band structure, and identifies distinct CoM dynamics at topological phase transitions.

Conclusion: CoM dynamics serves as a practical and experimental method to probe Floquet topological invariants and phase transitions.
...
### [74] [Static-Field Tunneling Ionization in Space-Fractional Quantum Mechanics](https://arxiv.org/abs/2605.05617)
*Marcelo F. Ciappina*

Main category: quant-ph

TL;DR: This paper presents a new analytical tunneling model in space-fractional quantum mechanics, demonstrating its impact on ionization rates in strong-field physics.


<details>
  <summary>Details</summary>
Motivation: To enhance our understanding of tunneling ionization using fractional calculus, offering a new perspective on ionization processes in strong fields.

Method: Developed an ADK-like model using the Riesz fractional Laplacian, deriving a closed-form tunneling exponent for ionization in a static electric field.

Result: Introduced a new scaling for the ionization rate and a complex-phase factor that modifies conventional quadratic models, resulting in a fractional exponent.

Conclusion: The findings provide a basis for analyzing static-field ionization in nonlocal quantum dynamics, potentially influencing future strong-field theory developments.
...
### [75] [Quantum Kernels for Parity-Structured Classification: A Hybrid Pipeline](https://arxiv.org/abs/2605.05625)
*Tushar Pandey*

Main category: quant-ph

TL;DR: The study reveals that quantum kernels offer a significant advantage in classifying parity problems as complexity increases, compared to classical methods.


<details>
  <summary>Details</summary>
Motivation: To understand how quantum kernel advantage varies with parity complexity and high-order feature interactions that classical methods struggle to capture.

Method: The research uses a ZZ quantum feature map with {0, pi} binary encoding, analyzing different complexity levels of feature interactions and comparing quantum and classical methods.

Result: At low complexity (n = 5), quantum and classical methods perform similarly, but as complexity increases (n = 11), quantum kernels outperform classical ones significantly, achieving 66.3% accuracy compared to 54.3% for the best classical method.

Conclusion: The findings demonstrate that as parity complexity grows, the advantages of quantum kernels become evident, indicating a clear threshold beyond which quantum methods excel.
...
### [76] [Eigenstate-Selective Entangled Two-Photon Absorption in Monolayer WSe$_2$](https://arxiv.org/abs/2605.05633)
*Minseok A. Jang,Hongki Yoo*

Main category: quant-ph

TL;DR: The Bell-state phase of polarization-entangled photon pairs influences biexciton eigenstate distributions in monolayer WSe$_2$ during ETPA, with distinct behavior for symmetric and antisymmetric states.


<details>
  <summary>Details</summary>
Motivation: To explore how the Bell-state phase affects biexciton eigenstate distributions in materials like monolayer WSe$_2$ during entangled photon interactions.

Method: The study employs a frequency-nondegenerate ladder scheme, analyzing independent valley pathways that factor in each pathway's interaction with the Bell-state phase in entangled two-photon absorption.

Result: The eigenstate distribution is phase-dependent, with the symmetric Bell state favoring bright eigenstates and the antisymmetric state promoting exchange-dark eigenstates, achieving high phase-scan visibility even under dephasing and scattering.

Conclusion: The results highlight a novel phase-control mechanism that distinguishes photon interaction outcomes in entangled photon systems, demonstrating significant implications for quantum optics and material science.
...
### [77] [Electronic and Photonic Integration of Single Quantum Emitters in 2D Materials](https://arxiv.org/abs/2605.05721)
*Sahil D. Patel,Sean Doan,Luka Jevremovic,Kamyar Parto,Galan Moody*

Main category: quant-ph

TL;DR: This review highlights advancements in integrating single-photon sources using two-dimensional materials, focusing on techniques that enhance performance metrics essential for quantum applications.


<details>
  <summary>Details</summary>
Motivation: Bright, pure, and interference-ready single-photon sources are crucial for quantum communication and processing, yet many solid-state systems face limitations in achieving desirable performance due to dependence on complex setups.

Method: The review examines progress in the integration of localized excitonic emitters from transition metal dichalcogenides and defect-based color centers in hexagonal boron nitride, covering both electronic methods (like electrical injection and stabilization) and photonic platforms (such as waveguides and resonators).

Result: Various strategies discussed include reducing interference effects, enhancing optical coupling through specific designs, and demonstrating key metrics such as purity and brightness performance in single-photon sources.

Conclusion: Future advancements will require co-designing electronic and photonic solutions that improve operational efficiency, stability, and compatibility with optical systems.
...
### [78] [Weighted Phase-Space Paths for Exact Wigner Dynamics](https://arxiv.org/abs/2605.05764)
*Surachate Limkumnerd,Panat Phanthaphanitkul*

Main category: quant-ph

TL;DR: The paper discusses the limitations of Wigner dynamics in phase space, emphasizing the need for accurate stochastic representations in quantum state reconstruction and the implications for non-quadratic potentials.


<details>
  <summary>Details</summary>
Motivation: To understand and accurately represent quantum states in phase space, particularly when dealing with non-classical dynamics and the limitations of existing models.

Method: The authors analyze Wigner dynamics and propose a stochastic representation of the Wigner function as a weighted empirical measure, highlighting the roles of carrier dynamics and correcting for non-classical effects.

Result: The study reveals that non-quadratic potentials lead to complexities in the Wigner--Moyal generator that cannot be captured by simple diffusion models, necessitating advanced representations to capture all quantum effects.

Conclusion: The findings provide insight into how non-classical transport dynamics can be represented in phase space, differentiating between classical and non-classical behaviors and establishing a framework for analyzing quantum processes.
...
### [79] [Optical Pulling Force in Carbon Nanotubes: Manifestation of Nonlocal Conductivity](https://arxiv.org/abs/2605.05785)
*Tomer Berghaus,Touvia Miloh,Gregory Ya. Slepyan*

Main category: quant-ph

TL;DR: This paper develops a theory for the optical force on a carbon nanotube (CNT) with nonlocal conductivity, highlighting the role of surface current density and electric fields, and deriving both numerical and analytical solutions.


<details>
  <summary>Details</summary>
Motivation: To enhance the theoretical understanding of optomechanical interactions in finite-length conductors and clarify the impact of nonlocal conductivity on optical forces.

Method: Utilizes an integral-equation-based approach to analyze surface current density related to axial electric fields, rigorously accounting for edge effects in finite-length cylindrical CNTs, and provides both numerical and analytical solutions.

Result: Identifies frequency ranges where the optical force can be negative, indicative of an optical pulling effect, originating from nonlocal conductivity; analytical expressions align well with numerical results.

Conclusion: Advances theoretical insight into optomechanical interactions in CNTs and illustrates how spatial dispersion contributes to optical pulling forces.
...
### [80] [Pontus-Mpemba effect in cavity quantum electrodynamics](https://arxiv.org/abs/2605.05827)
*Stefano Longhi*

Main category: quant-ph

TL;DR: The quantum Pontus-Mpemba effect demonstrates faster relaxation of a quantum system through a two-step evolution compared to single relaxation. This phenomenon is realized in cavity quantum electrodynamics using the Jaynes-Cummings model, showcasing distinct relaxation dynamics influenced by dissipation.


<details>
  <summary>Details</summary>
Motivation: To explore dissipative quantum dynamics and realize the quantum Pontus-Mpemba effect in a controlled experimental setting.

Method: Utilizing the Jaynes-Cummings model to study a two-level atom interacting with a single quantized mode of a lossy cavity, focusing on the single-excitation sector and simulating different cavity decay rates.

Result: Identified distinct relaxation paths resulting from a sudden change in cavity decay rate, demonstrating that a quenched dissipation trajectory relaxes faster than one with constant loss.

Conclusion: The interplay between coherent atom-photon exchange and cavity dissipation facilitates the quantum Pontus-Mpemba effect, making it experimentally accessible in optical and circuit QED systems.
...
### [81] [Three wave mixing vacuum squeezing generation in a SNAIL-based Traveling-Wave Parametric Amplifier with alternated flux polarity](https://arxiv.org/abs/2605.05830)
...
TL;DR: This paper explores vacuum squeezing generation in Josephson TWPAs through residual three-wave mixing, demonstrating its feasibility and implications for quantum applications.


<details>
  <summary>Details</summary>
Motivation: To investigate the feasibility of generating vacuum squeezing in TWPAs using residual three-wave mixing instead of traditional methods.

Method: By analyzing the interactions between four-wave mixing and residual three-wave mixing in Josephson TWPAs with SNAILs under different magnetic flux conditions.

Result: Demonstrated that effective vacuum squeezing can be achieved by carefully selecting operational flux points that leverage residual three-wave mixing effects.

Conclusion: The findings enhance understanding of nonlinear dynamics in TWPAs and suggest broader applications in quantum sensing and microwave photonics.
...
### [82] [Non-Abelian String-Breaking Dynamics on a Qudit Quantum Computer](https://arxiv.org/abs/2605.05841)
...
TL;DR: The paper presents the first quantum simulation of non-abelian string-breaking dynamics in SU(2) lattice gauge theory, utilizing a trapped-ion quantum computer.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of simulating real-time dynamics of string-breaking in non-abelian gauge theories, which differ fundamentally from abelian theories.

Method: Experiments were conducted on a trapped-ion quantum computer using qudit Hilbert spaces to encode gauge fields and apply digital Trotter dynamics.

Result: The study successfully simulated both unbreakable and breakable strings, elucidating string oscillations and gluonic excitations.

Conclusion: The findings suggest that qudit simulations can effectively access non-perturbative dynamics in high-energy physics, paving the way for future investigations.
...
### [83] [Surface-Code Thresholds and Qubit Footprints in Shuttling-Based Spin-Qubit Railways](https://arxiv.org/abs/2605.05881)
...
TL;DR: This paper presents a fault-tolerant method to map rotated surface codes onto a silicon spin-qubit architecture, highlighting significant improvements in system thresholds by using electron shuttling for check qubits over data qubits.


<details>
  <summary>Details</summary>
Motivation: The need to enhance fault tolerance in quantum computing architectures while addressing wiring limitations in silicon spin-qubit systems.

Method: The authors utilize a fault-tolerant mapping of rotated surface codes, incorporate circuit-level noise modeling, and compare performance thresholds under various noise biases.

Result: Shuttling check qubits improves thresholds significantly, and the non-CSS XZZX surface code outperforms standard CSS variants under dephasing noise bias, achieving a distance 7 code with error rate requirements suitable for Megaquop.

Conclusion: This work outlines a viable pathway for reducing hardware requirements in fault-tolerant quantum processors, particularly in the implementation of surface codes.
...
### [84] [Quantum-enhanced Large Language Models on Quantum Hardware via Cayley Unitary Adapters](https://arxiv.org/abs/2605.05914)
*Borja Aizpurua,Sukhbinder Singh,Augustine Kshetrimayum,Saeed S. Jahromi,Roman Orus*

Main category: quant-ph

TL;DR: This paper demonstrates the use of quantum circuit blocks to enhance the performance of large language models (LLMs) on real quantum hardware, achieving notable improvements in perplexity with minimal additional parameters.


<details>
  <summary>Details</summary>
Motivation: To overcome the limitations of classical memory requirements in training large language models, leveraging quantum computing presents a novel approach.

Method: The authors utilized Cayley-parameterised unitary adapters in the frozen layers of pre-trained LLMs, tested on IBM Quantum System Two, showing improved model perplexity.

Result: Implementation on Llama 3.1 (8B parameters) showed a 1.4% reduction in perplexity with only 6,000 additional parameters. A study on SmolLM2 revealed improvements in perplexity and resilience to compression degradation, as well as enhanced performance on specific tasks compared to classical models.

Conclusion: The findings suggest a viable pathway to enhance LLMs using quantum computing, with potential scalability benefits as qubit technology advances.
...
### [85] [Architecture Shape Governs QNN Trainability: Jacobian Null Space Growth and Parameter Efficiency](https://arxiv.org/abs/2605.05942)
...
TL;DR: Variational quantum circuits with angle encoding exhibit structural trainability differences due to Jacobian properties. Serial architectures face structural gradient starvation, while parallel ones maintain parameter effectiveness. Feature map layers enhance training efficiency compared to simply adding trainable blocks.


<details>
  <summary>Details</summary>
Motivation: To explore how the architecture shape of variational quantum circuits affects their trainability, despite sharing identical frequency characteristics.

Method: Analyzed the coefficient matching Jacobian's structural rank in serial and parallel architectures, identifying structural gradient starvation in the former.

Result: Serial architectures show a limitation in the Jacobian's rank, leading to parameter decoupling, while parallel architectures maintain a full rank up to certain parameter counts, ensuring effective training.

Conclusion: Using feature map layers is more effective than merely increasing trainable blocks for enhancing the training process in variational quantum circuits.
...
### [86] [Passive Imaging with Quantum Advantage](https://arxiv.org/abs/2605.05961)
*Li Gong,Aonan Zhang,Madhura Ghosh Dastidar,Alexander Duplinskii,A. I. Lvovsky*

Main category: quant-ph

TL;DR: The paper presents a novel method, Fourier Domain Division (FDD), to enhance far-field optical imaging by reducing noise effects and improving resolution, particularly for high spatial frequency components in photon-starved regimes.


<details>
  <summary>Details</summary>
Motivation: To overcome limitations of conventional optical imaging methods, particularly the suppression of high spatial frequency components due to noise, thus improving resolution.

Method: FDD partitions the Fourier plane for independent detection and post-processing, optimizing quantum measurements and reducing required photons for desired signal-to-noise ratios.

Result: FDD provides a 5-fold improvement in Fisher information for high spatial-frequencies in microscopy, making it advantageous in low-photon scenarios.

Conclusion: This method is passive and broadly applicable in various imaging fields, setting a new standard for superresolution imaging while addressing quantum limits.
...
### [87] [Syndrome resampling enhances quantum error correction thresholds](https://arxiv.org/abs/2605.06101)
*Luis Colmenarez,Áron Márton,Markus Müller*

Main category: quant-ph

TL;DR: Syndrome resampling enhances quantum error correction (QEC) thresholds and reduces logical errors by improving syndrome averages without extra hardware or decoding changes, evidenced through numerical simulations and practical applications.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the challenge of maintaining quantum hardware below error thresholds necessary for effective QEC, which is crucial for fault-tolerant quantum computing.

Method: The authors introduce syndrome resampling, which biases syndrome averages toward more probable syndromes to increase logical fidelities, linking the approach to Rényi coherent information (RCI) and maximum likelihood decoding (MLD).

Result: Numerical simulations demonstrate that syndrome resampling significantly enhances QEC thresholds and reduces logical error rates by up to four orders of magnitude in practically relevant scenarios, with effective implementation from finite data.

Conclusion: The method provides a decoder-agnostic strategy for enhancing logical fidelities in near-term quantum error correction experiments, demonstrating substantial improvements without additional measurements.
...
### [88] [Variationally Compressing Quantum Circuits to Approximate Nonadiabatic Molecular Quantum Dynamics](https://arxiv.org/abs/2605.06122)
*Joshua M. Courtney,P. C. Stancil*

Main category: quant-ph

TL;DR: The paper presents a method for variationally approximating quantum circuits to efficiently simulate nonadiabatic dynamics in quantum chemistry, focusing on preserving observable quantities and reducing resource costs.


<details>
  <summary>Details</summary>
Motivation: There is a need for efficient quantum simulations that accurately model nonadiabatic dynamics while minimizing resource consumption.

Method: The study employs variational approximation of unitary operations and classical emulation in hybrid quantum-classical optimization to compress Trotter terms and preserve reaction rate coefficients.

Result: The approach allows for effective simulation of dynamical systems, demonstrating preserved reaction rates and accurate results using compressed circuits on quantum hardware.

Conclusion: The proof-of-principle indicates that variational optimization can maintain observable fidelity while reducing qubit and gate count, paving the way for practical quantum simulations.
...
### [89] [Matrix encoding method in variational algorithm of calculating eigenvalues and generalized eigenvalues](https://arxiv.org/abs/2605.06167)
*Alexander I. Zenchuk,Junde Wu*

Main category: quant-ph

TL;DR: This paper presents a variational method for computing eigenvalues of complex matrices using a quantum algorithm, featuring a specific measurement technique and circuit efficiency metrics.


<details>
  <summary>Details</summary>
Motivation: To efficiently compute eigenvalues and generalized eigenvalues of large complex matrices using quantum computational methods.

Method: The algorithm encodes matrix elements into a quantum state, utilizes optimization parameters related to probability amplitudes in superposition, and employs ancilla state measurement to derive the loss function and its derivatives for gradient optimization.

Result: The algorithm achieves circuit depth of $O(N^2 	ext{ log } N)$ and size of $O(	ext{ log } N)$, indicating efficient implementation for large matrices.

Conclusion: This variational approach demonstrates a promising quantum strategy for eigenvalue computation, crucial for various applications in quantum computing and quantum mechanics.
...
### [90] [Universal Analog Quantum Simulation](https://arxiv.org/abs/2605.06178)
*Yiming Huang,Jiaxing Song,Xiaoxia Cai,Xiao Yuan*

Main category: quant-ph

TL;DR: UAQS is a hybrid framework that enhances the programmability of analog quantum simulators by employing optimized control fields for continuous-time evolution, allowing for a wider range of Hamiltonians.


<details>
  <summary>Details</summary>
Motivation: The limitation of fixed interaction structures in existing analog quantum simulators reduces programmability and the potential for exploring diverse quantum dynamics.

Method: UAQS introduces optimized continuous-time control fields to engineer target dynamics directly without decomposing into discrete sequences, preserving analog evolution.

Result: Numerical studies demonstrate that UAQS accurately replicates complex many-body dynamics in systems like superconducting circuits and Rydberg-atom arrays, surpassing the original hardware limits.

Conclusion: UAQS offers a significant advancement in transforming fixed-interaction devices into versatile, programmable analog quantum simulators.
...
### [91] [Finite-size general security for differential phase shift keying via variable-length quantum key distribution](https://arxiv.org/abs/2605.06249)
*Carlos Pascual-García*

Main category: quant-ph

TL;DR: This paper presents an improved approach to differential phase shift keying (DPSK) for quantum key distribution, overcoming previous limitations in security proofs and key rates.


<details>
  <summary>Details</summary>
Motivation: To advance quantum key distribution using DPSK, addressing security limits associated with repetition rates and statistical estimators.

Method: The study employs entropy accumulation techniques based on Rényi leftover hashing and conic optimization methods to enhance security and key rate performance.

Result: The proposed method achieves secret key rates with $10^5$ signals at levels beyond 12 dB, demonstrating feasibility for industrial applications.

Conclusion: This work provides a robust framework for implementing DPSK in practical quantum key distribution, enhancing its security and performance.
...
### [92] [Meromorphic Quantum Computing](https://arxiv.org/abs/2605.06251)
*Simon Burton,Hussain Anwar*

Main category: quant-ph

TL;DR: The paper explores projective kinematics in quantum mechanics, treating states as one-dimensional subspaces and generating an alternate proof for GHZ/W-calculus while identifying coherent circuit behaviors for quantum coding.


<details>
  <summary>Details</summary>
Motivation: To reinterpret quantum states and their kinematic properties using projective geometry, enhancing the understanding of quantum circuits and state preparations.

Method: The approach involves projectivizing quantum states through functorial and lax monoidal mapping, connecting qubits to the Bloch sphere and Riemann sphere.

Result: An alternate derivation of the arithmetic GHZ/W-calculus is provided, along with the identification of meromorphic functions characterizing circuit behavior for logical state preparation and magic state distillation.

Conclusion: The projective framework offers a significant perspective on quantum mechanics, enabling clearer descriptions of coherence in quantum circuits.
...
### [93] [Beating noise in frequency estimation with squeezing and memory in continuous-variable systems](https://arxiv.org/abs/2605.06263)
*Ayan Patra,Manju,Aditi Sen De,Matteo G. A. Paris*

Main category: quant-ph

TL;DR: This paper explores advanced quantum metrology techniques for frequency estimation in noisy systems, highlighting strategies like Hamiltonian engineering and non-Markovian dynamics to enhance sensitivity despite environmental noise.


<details>
  <summary>Details</summary>
Motivation: The degradation of quantum resources due to environmental noise limits the potential of quantum metrology. This work aims to counteract such effects to achieve high-precision measurements.

Method: The study investigates Hamiltonian engineering by embedding squeezing into the system Hamiltonian for tunable sensitivity, and utilizes the quantum Brownian motion model to explore non-Markovian dynamics that enable temporary information backflow and improved estimation precision.

Result: It was found that structured environments can enhance frequency estimation, and various measurement strategies (homodyne, heterodyne, optimized general-dyne) can achieve the quantum Fisher information bounds, with stronger squeezing leading to a need for non-Gaussian strategies.

Conclusion: The combination of optimizing the system's Hamiltonian and leveraging environmental memory can significantly improve frequency estimation precision in quantum metrology within open systems.
...
### [94] [Local distillation from Reed Muller codes unfolding](https://arxiv.org/abs/2605.06284)
*Vivien Londe*

Main category: quant-ph

TL;DR: The paper generalizes the Reed Muller distillation method by analyzing its algebraic structure and presents layouts for stabilizers, demonstrating low infidelities in outputs from input T states.


<details>
  <summary>Details</summary>
Motivation: To enhance the Reed Muller distillation factory's efficiency and understand its algebraic foundation, enabling practical applications in quantum error correction.

Method: The authors generalize the unfolding of a Reed Muller distillation factory and develop 2D and 3D local layouts for Z stabilizers corresponding to specific distances.

Result: The 2D local distillation factory with distance 4 achieves a CCZ state with an infidelity of $p=8.256 \times 10^{-9}$, while the 3D factory at distance 7 achieves a T state with infidelity $p=1.1811 \times 10^{-17}$.

Conclusion: The proposed models exhibit significantly reduced infidelities for outputs, underscoring the effectiveness of the generalized distillation factory designs.
...
### [95] [Macroscopic entanglement between two magnon modes via two-tone driving of a superconducting qubit](https://arxiv.org/abs/2605.06297)
*Rong-Can Yang,Gang Liu,Gen Li,Jie Li*

Main category: quant-ph

TL;DR: The paper proposes a method for entangling magnon modes in two YIG spheres using a superconducting qubit, achieving strong entanglement with feasible parameters and suggesting a detection scheme.


<details>
  <summary>Details</summary>
Motivation: To explore macroscopic quantum states using cavity-mediated coupling in a YIG sphere and superconducting qubit system.

Method: Entangling two magnon modes through driving the superconducting qubit with a two-tone field at selected frequencies and strengths.

Result: Strong entanglement can be achieved with fully feasible parameters, involving over $10^{18}$ spins.

Conclusion: The findings suggest practical applications in fundamental studies of macroscopic quantum mechanics and unconventional decoherence theories.
...
### [96] [Ablation Removal of Transport-Blocking Defects in Surface-Electrode Ion Traps](https://arxiv.org/abs/2605.06312)
*Toby Maddock,Parsa Rahimi,Matthew Aylett,Rares Barcan,Sebastian Weidt,Winfried Karl Hensinger*

Main category: quant-ph

TL;DR: The paper presents a method for removing defects in ion trap devices using a laser, enhancing efficiency without downtime.


<details>
  <summary>Details</summary>
Motivation: The need for efficient defect remediation in ion-shuttling architectures that require minimal downtime for system modifications.

Method: In situ removal of transport-blocking defects using a Q-switched Nd:YAG 532 nm pulsed ablation laser.

Result: Achieved near-unit shuttling success rates and acceptable micromotion levels after the ablation process.

Conclusion: The technique allows for quick restoration of transport pathways, facilitating uninterrupted experimental operations.
...
### [97] [Coherence limitations of a Fourier-engineered $\cos(2\varphi)$ transmon qubit](https://arxiv.org/abs/2605.06372)
...
TL;DR: This work demonstrates an experimentally realized $	ext{cos}(2	heta)$ superconducting qubit, which enhances coherence by suppressing charge-induced errors through Cooper-pair parity symmetry, using Fourier engineering techniques.


<details>
  <summary>Details</summary>
Motivation: Enhancing coherence times in superconducting qubits for improved quantum computing applications.

Method: Experimental realization of the $	ext{cos}(2	heta)$ qubit by Fourier engineering in a multi-junction circuit and an interference-based architecture to suppress odd harmonics in the qubit potential.

Result: Good agreement is observed between measured transition spectra and theoretical predictions; energy relaxation time is analyzed as a function of external flux.

Conclusion: The qubit's lifetime is limited by $1/f$ flux noise at the flux symmetry point, indicating challenges with interference-based protection, especially when compared to other qubit types like fluxonium.
...
### [98] [Photonic-Implemented Efficient Deep Quantum Neural Network via Virtual-Driven Hilbert Space Expansion](https://arxiv.org/abs/2605.06397)
...
TL;DR: The paper proposes a novel deep photonic quantum neural network (QNN) that enhances computational capabilities without the need for ancillary qubits, improving resource efficiency on integrated quantum photonic platforms.


<details>
  <summary>Details</summary>
Motivation: Classical neural networks face growing computational demands, necessitating energy-efficient alternatives. Quantum neural networks, particularly on integrated photonic platforms, promise enhanced computational power and scalability.

Method: A new QNN design utilizes input replication and mode expansion to achieve non-unitary and nonlinear activations directly on a linear quantum photonic chip, avoiding the necessity for additional qubits and measurement devices.

Result: The developed chip combines four entanglement sources and a high-dimensional interferometric network, supporting a two-hidden-layer QNN that outperforms existing architectures in expressivity across various tasks.

Conclusion: This work offers a scalable and efficient architecture for quantum deep learning, addressing challenges beyond classical computers' capabilities.
...
### [99] [A Residual-Based Quantum Linear System Algorithm with Dynamic Stopping and Applications to Elliptic PDEs](https://arxiv.org/abs/2605.06414)
*Xiantao Li*

Main category: quant-ph

TL;DR: The paper introduces a method to enhance quantum linear-system algorithms (QLSAs) by providing an a posteriori progress flag through a residual register, allowing on-the-fly convergence indication without full solution reconstruction.


<details>
  <summary>Details</summary>
Motivation: The lack of an a posteriori convergence indicator in current QLSA implementations contrasts with classical methods, necessitating improvements for more efficient quantum computing workflows.

Method: The authors formulate a stable first-order ODE linked to elliptic PDE discretizations, implement an augmented dynamics with residual variables to measure convergence, and conduct numerical experiments on a 2D finite element Poisson problem.

Result: The residual register effectively signals convergence, enabling early stopping of the quantum circuit, thus optimizing runtime and reducing gate counts compared to worst-case estimates.

Conclusion: The proposed method allows for more dynamic and efficient execution of QLSAs, improving convergence monitoring and reducing the impact of hardware errors.
...
### [100] [Multitime memory beyond the quantum regression theorem in sequential measurement statistics](https://arxiv.org/abs/2605.06427)
*Paolo Luppi,Claudia Benedetti,Andrea Smirne*

Main category: quant-ph

TL;DR: This study investigates memory effects in open quantum systems via deviations from the quantum regression theorem, revealing distinctions between reduced-state non-Markovianity and multitime memory.


<details>
  <summary>Details</summary>
Motivation: To examine how memory influences statistical measurements in open quantum systems, particularly how it deviates from the quantum regression theorem.

Method: Identified a decomposition of the two-time propagator into QRT-like contributions and a memory term, along with an operational quantifier for QRT violations, utilizing a spin-boson model for analysis.

Result: Demonstrated that non-Markovianity is impacted by environmental parameters and measurement protocols, revealing relationships between reduced-state non-Markovianity and multitime memory as distinct concepts.

Conclusion: Memory effects become evident in higher-order temporal statistics and are influenced by specific measurement protocols, distinct from single-time predictions.
...
### [101] [Revisiting the multi-mode rhombus circuit as a biased-noise qubit](https://arxiv.org/abs/2605.06430)
*Pablo Aramburu Sanchez,Trevyn F. Q. Larson,Anthony P. McFadden,Constantin Schrade,Joshua Combes,András Gyenis*

Main category: quant-ph

TL;DR: This paper explores a modified rhombus qubit based on Josephson junctions, highlighting enhanced qubit transitions and relaxation times under different conditions.


<details>
  <summary>Details</summary>
Motivation: To improve upon the original coding of qubit states in interferometers by investigating energy alterations in Josephson junctions, leading to better qubit performance.

Method: The authors modify the energy of one junction and measure qubit transitions and relaxation times, analyzing impacts of flux noise and quasiparticle tunneling.

Result: Achieved relaxation times of approximately 500 μs in the biased-noise regime and 27 μs at frustration, with Ramsey dephasing times of 90 ns and 670 ns respectively.

Conclusion: The study identifies an optimal operating regime around a few GHz, revealing factors limiting relaxation times.
...
### [102] [Tight Contraction Rates for Primitive Channels under Quantum $f$-Divergences](https://arxiv.org/abs/2605.06452)
*Matthew Simon Tan,Marco Tomamichel,Ian George*

Main category: quant-ph

TL;DR: This paper investigates quantum $f$-divergences and their implications for the contraction rates of quantum channels, establishing new relationships and bounds regarding distinguishability.


<details>
  <summary>Details</summary>
Motivation: To explore the role of quantum $f$-divergences in understanding the contraction rates of quantum channels towards equilibrium, leveraging inequalities like the strong data-processing inequality.

Method: The authors demonstrate that quantum $f$-divergences adhere to a local reverse Pinsker inequality, leading to bounds on contraction rates in relation to SDPI constants.

Result: Establishes that the asymptotic contraction rate of a quantum channel to its stationary state is bounded by the SDPI constant of non-commutative $χ^2$-divergence; also provides conditions for tight bounds via quantum-detailed balance.

Conclusion: Strengthens existing results on various $f$-divergences while providing a clearer framework for analyzing contraction rates in quantum processes.
...
### [103] [Entanglement generation in a two-body Schrödinger--Newton model](https://arxiv.org/abs/2605.06577)
*Marcin Płodzień,Julia Osęka-Lenart,Maciej Lewenstein,Michał Eckstein*

Main category: quant-ph

TL;DR: The paper presents a two-body Schrödinger–Newton model that differentiates between local nonlinear self-localization and a nonseparable Newtonian potential, analyzing entanglement dynamics in self-gravitating quantum systems.


<details>
  <summary>Details</summary>
Motivation: To explore the effects of nonlinear self-localization and Newtonian pair interactions on the entanglement generation in massive quantum systems.

Method: Analytical and numerical simulations of a two-body Schrödinger–Newton model are employed to investigate the impacts of initial configurations and mass ratios on entanglement.

Result: Highly localized wavepackets show reduced entanglement, while spatial delocalization and mass asymmetry lead to enhanced entanglement generation, particularly in dispersive Gaussian states.

Conclusion: The study reveals that initial conditions significantly influence entanglement dynamics, with stationary profiles isolating bare interactions and dispersive states amplifying them.
...
### [104] [Practical Log-Depth Quantum State Preparation and Circuit Verification via Tree Tensor Network Compilation](https://arxiv.org/abs/2605.06579)
*Angus Mingare,Peter V. Coveney*

Main category: quant-ph

TL;DR: The paper presents a method to efficiently load matrix product states onto quantum computers using log-depth circuits, suitable for near-term hardware applications.


<details>
  <summary>Details</summary>
Motivation: To enable practical implementation of matrix product states on quantum computers for quantum algorithms, particularly due to hardware limitations.

Method: A decomposition of matrix product states is achieved through a tree tensor network renormalisation procedure that reduces circuit depth while allowing trade-off in fidelity.

Result: The method yields log-depth circuits for matrix product states and operators, and facilitates overlap calculations through ancilla-free circuits.

Conclusion: The proposed circuits serve as verifier circuits, contributing to device calibration efforts in quantum computing.
...
### [105] [Machine Learning Approaches to Building Quantum Circuits for Sets of Matrices](https://arxiv.org/abs/2605.06633)
*Matvei Fedin,Andrei Morozov*

Main category: quant-ph

TL;DR: The paper presents an interpretable machine learning approach to develop a universal quantum algorithm for diagonal matrices.


<details>
  <summary>Details</summary>
Motivation: To leverage machine learning techniques in constructing quantum algorithms that are universally applicable to diagonal matrices.

Method: An interpretable machine learning framework is employed to analyze the parameters and construct the quantum algorithm.

Result: A universal shortest analytic quantum algorithm for arbitrary diagonal matrices of any size is successfully developed.

Conclusion: The integration of interpretable machine learning with quantum computing demonstrates promising results in algorithm construction.
