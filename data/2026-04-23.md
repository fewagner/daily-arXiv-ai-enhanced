...
### [1] [Stability of Charge Collection Efficiency and Time Resolution in a Novel Ultra-fast Graphene-Optimized Silicon Carbide Detector Under X-ray Irradiation](https://arxiv.org/abs/2604.20194)
*Zhenyu Jiang,Congcong Wang,Jingxuan He,Yi Zhan,Yingjie Huang,Xiyuan Zhang,Xin Shi*

Main category: physics.ins-det

TL;DR: The graphene-optimized SiC PIN detector demonstrates excellent radiation tolerance and stability under high-energy X-ray exposure, with impressive time resolution and charge collection performance.


<details>
  <summary>Details</summary>
Motivation: To develop a radiation-tolerant detector for applications in high-energy physics, space missions, and nuclear reactor monitoring, utilizing graphene in the design.

Method: Fabrication and evaluation of a graphene-optimized silicon carbide PIN detector under 160 keV X-ray irradiation, measuring electrical properties, charge collection efficiency, and time resolution.

Result: After 1 MGy irradiation, the detector showed low leakage current, good C-V characteristics, time resolution of 58.0 ps, and a charge collection efficiency of 99.24%, with stability before and after irradiation.

Conclusion: The graphene electrode design significantly enhances the performance of the SiC detector, making it suitable for extreme radiation environments.
...
### [2] [Predictive drift compensation of multi-frame STEM via live scan modification](https://arxiv.org/abs/2604.20558)
*Matthew Mosse,Jonathan J. P. Peters,Eoin Moynihan,James A. Gott,Ana M. Sanchez,Michele Conroy,Lewys Jones*

Main category: physics.ins-det

TL;DR: The paper presents a method for mitigating drift in scanning transmission electron microscopy (STEM) by predicting future sampling points based on past frames, improving image quality across various imaging scales and types.


<details>
  <summary>Details</summary>
Motivation: STEM imaging is prone to drift, leading to distortions and reduced usable areas, affecting image quality and analysis.

Method: The authors propose a predictive method to continually adjust the sampling grid based on previous frames, accommodating both long-range drift and intra-image warping.

Result: The method effectively corrects drift in STEM images of both atomic-resolution and lower-magnification in-situ video, showcasing its versatility across different imaging situations.

Conclusion: The proposed framework enhances imaging accuracy in STEM by correcting drift dynamically, applicable to various scanning patterns and resolutions.
...
### [3] [A 260-Liter Test Stand for Liquid Argon R&D](https://arxiv.org/abs/2604.20703)
*Yichen Li,Aleksey Bolotnikov,Milind Diwan,Jay Hyun Jo,Steven Kettell,Steven Linden,Xin Qian,Matteo Vicenzi,Chao Zhang*

Main category: physics.ins-det

TL;DR: A new 260-liter liquid argon cryogenic test stand designed for efficient detector R&D at BNL features gas-phase argon purification and enhanced thermal contact area, enabling quick iteration and measurement of liquid argon purity.


<details>
  <summary>Details</summary>
Motivation: To advance research and development in liquid argon detectors, specifically for LArTPC experiments, by providing a reliable and efficient test facility.

Method: The system uses pump-free gas-phase argon purification with gravitational recirculation, an upgraded condenser for better thermal contact, and a purity monitor for measuring electron lifetime in LAr.

Result: The setup demonstrates an electron lifetime of 0.5 ms under reported operating conditions, and allows for rapid operational cycles (7 days) for detector component iterations.

Conclusion: This facility effectively supports the testing and refinement of liquid argon detector designs, making it advantageous for large-scale LArTPC experiments.
...
### [4] [Low-Multiplicity Jets as Probes of GeV-Scale Light-Quark-Coupled Particles](https://arxiv.org/abs/2604.19864)
*Carlos Henrique de Lima,David McKeen,Maximilian Swiatlowski*

Main category: hep-ph

TL;DR: This paper presents a new search strategy at the LHC for GeV-scale particles that couple to light quarks, focusing on low-multiplicity jets associated with hard photons.


<details>
  <summary>Details</summary>
Motivation: To explore the production and decay of light gauge-singlet particles that manifest as low multiplicity jets, previously unexplored in hadronic coupling regimes.

Method: The search utilizes low-multiplicity jets produced alongside hard photons, analyzing jets with characteristics differing from typical QCD jets, and incorporates a data-driven approach to account for jet modeling uncertainties.

Result: The study quantitatively assesses the sensitivity to scalar and pseudoscalar couplings to up-quarks, revealing the ability to probe a previously inaccessible parameter space for hadronically-coupled particles.

Conclusion: This research opens new avenues for investigating light quark-coupled particles at the LHC, enhancing the sensitivity of searches in a previously unexplored energy regime.
...
### [5] [Self-Interaction and Galactic Magnetic Field Bounds on Millicharged Magnetic Monopole Dark Matter](https://arxiv.org/abs/2604.19873)
*Michael L. Graesser,R. Andrew Gustafson*

Main category: hep-ph

TL;DR: This paper presents a model of dark matter involving magnetic monopoles with small kinetic mixing with Standard Model photons, exploring different cases based on temperature and symmetry breaking with significant phenomenological implications.


<details>
  <summary>Details</summary>
Motivation: To explore the theoretical interest and phenomenological consequences of a dark matter sector made of magnetic monopoles connected to a dark U(1) symmetry.

Method: The paper discusses three distinct phenomenological scenarios based on the dark sector's temperature and the spontaneous symmetry breaking scale, and relates dark matter self-interaction constraints to model parameters.

Result: The study establishes that the magnetic monopoles interacting with Standard Model photons through kinetic mixing impose significant constraints from dark matter self-interactions and the survival of galactic magnetic fields.

Conclusion: The model provides an intriguing framework for understanding dark matter, highlighting the interplay between dark and visible sectors and the implications for galactic magnetic field survival.
...
### [6] [A First Account of the Impact of Ion Electromagnetic Dissociation on Event Exclusivity in Ultraperipheral LHC Collisions](https://arxiv.org/abs/2604.19879)
*M. Dyndal,L. A. Harland-Lang*

Main category: hep-ph

TL;DR: This paper examines hadron production in electromagnetic ion dissociation during high-energy ultraperipheral collisions, showing its significance in exclusive particle production processes at the LHC and resolving discrepancies between theory and experiments.


<details>
  <summary>Details</summary>
Motivation: To address the oversight of hadron production in electromagnetic ion dissociation processes that accompany exclusive particle production in high-energy collisions.

Method: The authors calculate the influence of hadron production on LHC measurements of exclusive muon pair production and exclusive J/ψ production, considering how this alters the expected outcomes.

Result: Incorporating hadron production modifies the understanding of exclusive processes, leading to reconciliations of existing theoretical predictions and experimental data.

Conclusion: The study highlights the importance of hadron production in EMD processes, suggesting that it can resolve discrepancies previously observed in LHC experimental results.
...
### [7] [Ultra-High-Energy Tau Neutrinos as Probes of Lorentz Invariance](https://arxiv.org/abs/2604.19880)
*Vedran Brdar,Samiur R. Mir*

Main category: hep-ph

TL;DR: This study assesses how upcoming neutrino telescopes GRAND and POEMMA can test Lorentz invariance violation (LIV) by measuring ultra-high-energy tau neutrinos, revealing significantly enhanced sensitivity compared to previous experiments.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of upcoming experiments to detect LIV in neutrino propagation through ultra-high-energy tau neutrinos, as higher energies amplify the effects of LIV.

Method: Use SimProp to generate cosmogenic neutrino flux and compute neutrino flavor transition probabilities influenced by LIV effects, analyzing event rates at GRAND and POEMMA.

Result: Projected sensitivities to LIV parameters surpass existing limits from lower-energy observations by orders of magnitude and consider interactions between multiple LIV parameters.

Conclusion: Future detections of ultra-high-energy tau neutrinos will offer some of the most rigorous constraints on Lorentz invariance violation.
...
### [8] [Sub-GeV dark matter from cosmic ray bremsstrahlung in the atmosphere](https://arxiv.org/abs/2604.19959)
*Branden Aitken,Peter Reimitz,Adam Ritz*

Main category: hep-ph

TL;DR: The paper investigates the ability of neutrino observatories and dark matter detection experiments to detect boosted light dark matter produced by cosmic ray interactions, extending sensitivity to higher masses using new modeling techniques.


<details>
  <summary>Details</summary>
Motivation: To understand how neutrino observatories and direct detection experiments can detect sub-GeV dark matter generated by cosmic ray collisions, especially at higher masses.

Method: The authors model the proton bremsstrahlung production mode through initial state radiation and analyze the impact of cosmic ray flux peaks on dark matter production, particularly focusing on vector-mediated models near the $ρ/ω$ resonances.

Result: The study evaluates and compares the sensitivities of various detection experiments, specifically LZ, PandaX-4T, Borexino, and Super-K, to the boosted dark matter signals.

Conclusion: The findings highlight enhanced sensitivity for detecting certain dark matter models at specific mediator masses, suggesting improved detection strategies for such scenarios.
...
TL;DR: The notes complement various lectures and workshops in hadron structure and physics across multiple institutions from 2018 to 2025.


<details>
  <summary>Details</summary>
Motivation: To provide supplementary materials for graduate-level discussions on hadron structure and related topics.

Method: Compilation of lecture notes and discussions from multiple workshops and schools focused on hadron physics.

Result: The notes serve as educational support for graduate students attending these events.

Conclusion: These notes are intended to enhance understanding of hadron structure in the context of upcoming research initiatives.
...
TL;DR: The paper explores a decaying dark matter model, analyzing its indirect detection signatures and potential observability in gamma rays and neutrinos.


<details>
  <summary>Details</summary>
Motivation: To understand the implications of a decaying dark matter scenario and its observable signatures in astrophysical contexts.

Method: The authors utilized numerical tools to compute gamma-ray and neutrino fluxes from a scalar singlet dark matter model, validating against cosmological constraints and analyzing multiple benchmark parameters.

Result: Predicted signals from the dark matter decay can be observed in particular regions of the parameter space, with computed event rates for Milky Way and dwarf galaxies.

Conclusion: The study indicates significant potential for observational evidence of decaying dark matter through specific experimental setups.
...
TL;DR: This paper presents a graph-theoretic technique to analyze fermion mass spectra in latticized theory-space models, establishing how massless modes correlate to graph theory concepts.


<details>
  <summary>Details</summary>
Motivation: To provide a systematic framework for analyzing fermion masses in complex models, addressing the limitations of existing methods in capturing localization properties.

Method: Mass terms are represented as edges in bipartite graphs; the number of massless modes is determined using maximum matching, with paths defined by graph decomposition techniques.

Result: The study reveals that the number of massless modes corresponds to the maximum matching in a bipartite graph, and their wave-function support is limited to specific graph paths.

Conclusion: The proposed method is robust, reliant solely on the topology of the theory space, allowing for structured construction of models with tailored localization characteristics.
...
### [12] [Chiral first order phase transition at finite baryon density and zero temperature from self-consistent pole masses in the linear sigma model with quarks](https://arxiv.org/abs/2604.20196)
*Alejandro Ayala,Bruno El-Bennich,Ricardo L. S. Farias,Luis A. Hernández,Bruno S. Lopes,Luis C. Parra L.,Renato Zamora*

Main category: hep-ph

TL;DR: The paper investigates the chiral phase transition at finite baryon chemical potential using the two-flavor Linear Sigma Model with quarks, finding it to be first-order, characterized by discontinuities in various thermodynamic quantities.


<details>
  <summary>Details</summary>
Motivation: To explore the chiral phase transition in QCD at finite baryon chemical potential and zero temperature, extending beyond conventional approximations.

Method: Utilizing the two-flavor Linear Sigma Model, the study sets up self-consistent coupled equations at one-loop order to minimize the effective potential for the chiral order parameter.

Result: The phase transition is identified as first-order, triggered when the chemical potential equals the vacuum quark mass, indicated by discontinuities in the chiral condensate and other properties.

Conclusion: The speed of sound exhibits a discontinuous change at the phase transition and approaches the conformal limit smoothly thereafter.
...
### [13] [Target-Mass Corrections in the OPE Sum-Rule Approach to Quarkonium-Nucleon Interactions with Global-Fit PDFs: an $x$-Resolved Analysis](https://arxiv.org/abs/2604.20217)
*Arkadiy I. Syamtomov*

Main category: hep-ph

TL;DR: This paper updates the operator-product-expansion sum-rule approach for inelastic quarkonium-nucleon interactions, analyzing gluon distributions and their effects on cross section calculations using modern parton distribution functions.


<details>
  <summary>Details</summary>
Motivation: The motivation is to enhance the understanding of quarkonium-nucleon interactions by improving the analysis of parton distribution functions (PDFs) and their impact on the resulting cross sections.

Method: The authors utilize global-fit PDFs to conduct an $x$-resolved analysis of the target mass corrections (TMC) effect, examining how contributions from different gluon distribution regions influence Mellin moments and sum rules.

Result: The study reveals that the TMC effect's magnitude is affected by both the kinematic weight in modified sum rules and the redistribution of support across small-, intermediate-, and large-$x$ regions by different global-fit PDFs.

Conclusion: The paper provides a clearer framework for analyzing quarkonium-nucleon sum rules and emphasizes the significance of current PDF information in predictive models for cross sections.
...
### [14] [Technically Natural Suppression of Fifth Force](https://arxiv.org/abs/2604.20292)
*Kensuke Homma,Taishi Katsuragawa,Shinya Matsuzaki*

Main category: hep-ph

TL;DR: The paper proposes a $Z_2$-symmetric mirror extension of the Standard Model to explain the suppression of a fifth force mediated by light scalars, using symmetry principles instead of traditional screening methods.


<details>
  <summary>Details</summary>
Motivation: To address the incompatibility of light scalars with local gravity tests, proposing a model that avoids issues with fifth force detection.

Method: Introducing a $Z_2$-symmetric mirror extension of the Standard Model combined with bi-conformal gravity, leading to a light scalaron arising from spontaneous scale invariance breaking.

Result: Establishes a parameter-independent relationship between fifth-force strength and scalaron mass, with numerical predictions aligning with next-generation experimental targets.

Conclusion: The suppression of the fifth force derived from symmetry principles offers an alternative to nonlinear dynamics, potentially facilitating the search for light scalars in future experiments.
...
### [15] [Baryon-Meson Sum Rule for $b \to s ν\barν$](https://arxiv.org/abs/2604.20340)
*Teppei Kitahara,Manas Kumar Mohapatra,Kota Sasaki*

Main category: hep-ph

TL;DR: The paper presents a robust sum rule linking branching fractions of specific baryonic and mesonic decays, which can help identify new-physics scenarios for left-handed neutrinos.


<details>
  <summary>Details</summary>
Motivation: To explore relationships between branching fractions in $b$-decays involving neutrinos and discover constraints for new-physics models.

Method: A theoretical framework is established using the effective Hamiltonian and right-handed neutrino assumptions, leading to the derivation of an exact sum rule among the branching fractions of various decay processes.

Result: The sum rule is shown to be numerically consistent with existing $b 	o c$ semileptonic decay results, indicating a profound connection between baryonic and mesonic transitions.

Conclusion: The findings suggest that measuring certain decay rates will enhance our understanding of the underlying physics, aiding in the discrimination between competing new-physics theories.
...
TL;DR: This study explores the relationship between lepton flavor violation (LFV) and leptogenesis in the minimal scotogenic model, highlighting viable scenarios for both high-scale and low-scale leptogenesis while addressing their constraints.


<details>
  <summary>Details</summary>
Motivation: Understanding the connections between lepton flavor violation and baryogenesis in leptogenesis to enhance the phenomenological understanding of neutrinos and related processes.

Method: The study employs the minimal scotogenic model and the Casas--Ibarra framework to analyze high-scale hierarchical and low-scale resonant leptogenesis, assessing correlations between Yukawa couplings, LFV processes, and baryogenesis conditions.

Result: High-scale leptogenesis is viable with effective LFV-baryogenesis decoupling; low-scale resonant leptogenesis faces constraints from the MEG experiment, although a narrow resonant window allows for successful baryogenesis and LFV safety under specific conditions.

Conclusion: The research identifies specific parameter regions where quasi-degenerate heavy fermions enable successful baryogenesis alongside reduced lepton flavor violation, providing benchmarks for future studies.
...
### [17] [How Invisible: Regressing The Key Model Parameter for Semi-visible Jet Searches](https://arxiv.org/abs/2604.20456)
*Yin Li,Bingxuan Liu,Jianbin Wang,Jiaqi Xie,Kairong Xu,Ruihan Ye,Zihuan Huang*

Main category: hep-ph

TL;DR: This study develops a regression model for reconstructing the parameter $r_{\mathrm{inv}}$ in semi-visible jets (SVJs), significantly improving precision over earlier methods.


<details>
  <summary>Details</summary>
Motivation: To provide insights into strongly interacting dark sectors using semi-visible jets and improve the reconstruction of key model parameters.

Method: A regression model utilizing information from high-level physics objects is applied to SVJ events associated with energetic photons, with an optimized training procedure for applicability.

Result: The model demonstrates robust performance across varying signal parameters, allowing for higher precision in reconstructing $r_{\mathrm{inv}}$ compared to previous methods.

Conclusion: The new approach enhances sensitivity for SVJ searches and potentially unifies different production channels.
...
TL;DR: The paper re-evaluates near-threshold J/ψ photoproduction on nucleons using modern parton distribution functions (PDFs), highlighting issues in moment-based cross-section reconstruction and proposing an eikonal unitarization approach to align data across energy ranges.


<details>
  <summary>Details</summary>
Motivation: To understand the discrepancies in J/ψ photoproduction data near threshold and improve theoretical models using updated parton distribution functions.

Method: The authors employ the Operator Product Expansion (OPE) sum-rule framework with vector-meson dominance and dispersion relations while investigating the effects of various NNLO PDF sets on cross-section reconstruction.

Result: The direct convolution method accurately describes threshold data but significantly overshoots HERA measurements at higher energies. The introduction of a minimal eikonal unitarization reconciles the predictions across different energy ranges without altering the threshold description.

Conclusion: The study concludes that incorporating an eikonal unitarization approach aligns theoretical predictions with experimental data, with the dispersive real part being crucial for the near-threshold cross-section, indicating the importance of refined modeling in photoproduction studies.
...
### [19] [Search for Axion Like Particles produced via the Primakoff process at COMPASS](https://arxiv.org/abs/2604.20734)
*Mehran Dehpour*

Main category: hep-ph

TL;DR: This paper presents a reinterpretation of COMPASS data to search for Axion-Like Particles (ALPs) using high-energy beam interactions, deriving exclusion limits on ALP-photon coupling.


<details>
  <summary>Details</summary>
Motivation: The study aims to explore ALPs as dark matter candidates and their role in the dark sector, utilizing existing experimental data to extend understanding of ALP properties.

Method: The research analyzes the 2009 COMPASS dataset of high-energy $π^-$ and $μ^-$ beams, focusing on the Primakoff production of ALPs and their decay signatures which mimic Standard Model scattering events.

Result: Exclusion limits for the ALP-photon coupling $g_{aγγ}$ were derived, showing couplings $g_{aγγ} 	extgreater 10^{-1}~	ext{GeV}^{-1}$ are excluded at 95% C.L. for ALP masses between 0.2 and 600 MeV.

Conclusion: The results provide independent constraints bridging beam dump experiments and collider data, establishing a novel framework for future studies on ALPs.
...
TL;DR: A new three-flavor neutrino oscillation calculator offers fast, precise predictions of oscillation probabilities in constant-density matter, utilizing both accurate and expedited computation methods while maintaining reliability in uncertainty estimates.


<details>
  <summary>Details</summary>
Motivation: With the increasing precision required in neutrino oscillation experiments, a tool is needed that balances speed and accuracy in calculations and uncertainty assessments.

Method: The calculator employs analytic perturbative formulas validated by comparison to established series expansions, incorporating the latest global-fit covariance matrix and offering various computation modes, including exact Hamiltonian diagonalization and a fast perturbative approximation.

Result: It accurately predicts oscillation probabilities over a specified energy range and distance, handles uncertainties through Monte Carlo sampling or a linearized method, and maintains essential physical properties.

Conclusion: This tool enhances capabilities for parameter scans and sensitivity studies in major long-baseline experiments, ensuring both efficiency and reliability in results.
...
### [21] [Probing QCD instantons using jet correlation observables in proton-proton collisions at the LHC](https://arxiv.org/abs/2604.20780)
*Sayak Guin,Swagatam Tah,Nihar Ranjan Sahoo,Sayantan Sharma*

Main category: hep-ph

TL;DR: This paper proposes jet correlation observables to identify instanton-induced processes in QCD, distinguishing them from perturbative events in LHC pp collisions, with implications for future Electron-Ion Collider experiments.


<details>
  <summary>Details</summary>
Motivation: The discovery of instantons in colliders aims to provide experimental evidence for the topological features of the QCD vacuum, which carries significant implications for understanding strong interactions.

Method: The authors calculate instanton sizes and separations in 2+1 flavor QCD using physical quark masses, proposing specific jet correlation observables designed to differentiate between instanton-induced processes and traditional hard scattering events.

Result: The research establishes constraints on the center-of-mass energies of the produced hadrons during instanton-induced processes, aiding in their identification in experimental conditions.

Conclusion: The findings present a pathway for future measurements at the Electron-Ion Collider, highlighting it as a more suitable environment for investigating instanton dynamics.
...
TL;DR: The study analyzes ILC-BDX's sensitivity to inelastic fermionic dark matter using a magnetic dipole operator, focusing on production rates through high-energy electron scattering and the corresponding detection limits.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of ILC-BDX in detecting inelastic fermionic dark matter interactions mediated by an off-diagonal magnetic dipole operator.

Method: Computed production rates of dark matter by high-energy electron scattering on target nuclei and propagated resultant fluxes to assess detector signals from electron scattering.

Result: Projected exclusion limits were identified for 1 and 10 years of data, revealing ILC-BDX's capability to probe relevant regions of inelastic magnetic-dipole dark matter across different mass splittings.

Conclusion: ILC-BDX can effectively explore inelastic magnetic-dipole dark matter, enhancing understanding in a significant area of parameter space.
...
TL;DR: The recent $K(1690)$ state may not be a local meson-meson current and could be explained as a compact multiquark configuration.


<details>
  <summary>Details</summary>
Motivation: To analyze the nature of the $K(1690)$ state reported by COMPASS as a possible strange crypto-exotic meson.

Method: Utilized QCD sum rules to study local meson-meson currents with various Dirac structures, performing a systematic operator product expansion and analyzing Borel stability, continuum threshold dependence, and pole contributions.

Result: Extracted masses consistently around $2~	ext{GeV}$ or higher, indicating a significant disparity with the experimental mass of $K(1690)$ and showing stability against QCD parameter variations.

Conclusion: The findings challenge the interpretation of $K(1690)$ as predominantly coupled to local meson-meson currents, suggesting a compact multiquark configuration instead.
...
TL;DR: The study investigates resonant production of ultralight dark matter via an oscillating scalar field interacting with a vector field, deriving key relationships for dark photon mass and conditions for stability in different regimes.


<details>
  <summary>Details</summary>
Motivation: To explore the mechanisms of ultralight vector dark matter production and its characteristics through scalar-field interactions, focusing on stability and mass relations.

Method: Analysis of a coupling between a scalar field and a vector field using a dilatonic kinetic function, deriving conditions for production and mass relations under specific cosmological assumptions.

Result: The growth-to-Hubble ratio is shown to scale with the equation-of-state parameter, and mass of the relic dark photon is dependent on the onset fraction of the field oscillations, leading to specific ranges for dark photon mass related to radiation-dominated conditions.

Conclusion: The study delineates conditions for consistent dark matter production and provides detailed relationships for relic dark photon masses, laying groundwork for further exploration of the stability and interactions in vector dark matter scenarios.
...
TL;DR: The paper explores low-scale leptogenesis models necessitating degenerate right-handed neutrino masses, proposing an extension via a scalar singlet that introduces new decay channels, enabling effective leptogenesis without mass degeneracy.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of low-scale leptogenesis, particularly the requirement for a degenerate mass spectrum of right-handed neutrinos.

Method: The authors extend the seesaw framework by introducing a scalar singlet field that couples to RHNs, allowing new decay channels and additional CP violation sources for leptogenesis. They utilize a flavor-symmetry neutrino mass model with a single flavon field as the scalar singlet.

Result: The model successfully reproduces observed neutrino masses and mixing angles, and achieves the required baryon asymmetry, all while adhering to current experimental constraints.

Conclusion: This framework provides a viable mechanism for low-scale leptogenesis without mass degeneracy, thus broadening the possibilities within neutrino mass models.
...
TL;DR: The paper investigates strange hidden-charm pentaquark states using a diquark-triquark model. Mass calculations for S-wave and P-wave excitations are presented, with predictions made for specific pentaquark states in light of experimental findings.


<details>
  <summary>Details</summary>
Motivation: To explore the properties and mass spectrum of strange hidden-charm pentaquark states within a theoretical framework that unifies diquarks and triquarks.

Method: A diquark-triquark model employing Gaussian expansion and non-relativistic potentials is utilized to calculate masses of diquark, triquark, and pentaquark states across S-wave and P-wave excitations.

Result: Masses of S-wave pentaquark states are calculated between 4200 MeV and 4590 MeV, while P-wave states are above 4600 MeV, with significant mass splittings observed between S-wave and P-wave states (350-570 MeV).

Conclusion: The predicted lowest strange hidden-charm pentaquark state is estimated to be around 4200 MeV with a specific quantum number configuration corresponding to identified experimental candidates.
...
### [27] [Spontaneous Baryogenesis from Axions on Induced Electroweak Walls](https://arxiv.org/abs/2604.20762)
*Miguel Vanvlasselaer,Wen Yin*

Main category: hep-ph

TL;DR: The paper proposes a new baryogenesis mechanism using a scalar field's wall configuration to induce an electroweak phase, generating baryon asymmetry via effective chemical potential and sphaleron transitions.


<details>
  <summary>Details</summary>
Motivation: To explore mechanisms for generating baryon asymmetry in the early universe through electroweak phase transitions influenced by scalar fields.

Method: A wall-like configuration of a scalar field, specifically an axion-like particle, is implemented to couple with the Higgs field, creating an induced electroweak wall that facilitates barrier asymmetry generation.

Result: The mechanism realizes spontaneous baryogenesis and predicts conditions under which baryon asymmetries and gravitational waves can arise due to the motion of the wall in the presence of sphaleron transitions.

Conclusion: The model provides insights into baryon inhomogeneities and suggests that the weak coupling of the axion can avoid detection limits from current experiments.
...
### [28] [The General Antiparticle Spectrometer (GAPS) Antarctic Balloon Payload](https://arxiv.org/abs/2604.19830)
...
TL;DR: The GAPS mission aims to detect low-energy cosmic-ray antinuclei as potential dark matter signatures using advanced particle identification techniques and a specialized tracker system.


<details>
  <summary>Details</summary>
Motivation: To improve sensitivity to low-energy cosmic-ray antinuclei for dark matter research.

Method: Employing a Tracker with custom silicon strip detectors and a scintillator TOF system to measure energy loss and particle identification while utilizing a heat pipe system for optimal temperature control.

Result: Successfully designed, integrated, and commissioned the GAPS payload for its inaugural flight.

Conclusion: GAPS represents a significant advancement in detecting cosmic-ray antinuclei, intending to contribute to dark matter investigations.
...
### [29] [Science from the In Situ Exploration of the Proxima Centauri System](https://arxiv.org/abs/2604.20182)
...
TL;DR: This paper explores the potential of picospacecraft swarms for interstellar exploration using laser propulsion, particularly targeting the exoplanet Proxima b to assess science returns.


<details>
  <summary>Details</summary>
Motivation: The motivation is to enable deep-space exploration at near-relativistic speeds with small spacecraft, enhancing our ability to study exoplanets.

Method: The study examines Coracle laser-sail picospacecraft swarms, focusing on mission designs that balance velocity, mass, and mission duration to optimize science returns.

Result: The findings indicate that even fast flybys can yield gigapixel-resolution imagery of target exoplanets, with significant potential for scientific discovery.

Conclusion: Initial missions with small spacecraft could lead to major discoveries regarding surface biology or technological civilizations on Proxima b, demonstrating the feasibility and benefits of such explorations.
...
### [30] [Photometric Super-Resolution for Improving Galaxy Morphological Measurements using Conditional Generative Adversarial Networks](https://arxiv.org/abs/2604.20195)
*Samuel Kahn,Ryan Hausen,Hubert Bretonnière,Nicole Drakos,Brant Robertson*

Main category: astro-ph.IM

TL;DR: The study introduces Neo, a conditional generative adversarial network that enhances galaxy imaging by transforming ground-based images to mimick space-based quality, significantly improving morphological parameter estimation.


<details>
  <summary>Details</summary>
Motivation: To enhance the precision and accuracy of galaxy morphological parameter measurements which are crucial in studies of galaxy evolution and cosmological weak lensing, given the limitations of ground-based telescopes.

Method: Developed a conditional generative adversarial network (Neo) to convert ground-based Subaru HSC images into higher quality, space-based equivalent images, improving resolution and detail.

Result: Neo achieved a 2-10 fold improvement in accuracy of morphological parameters when translating Subaru HSC images to match HST data.

Conclusion: Neo is a valuable tool for improving analyses of large-scale astronomical surveys and is open-source for community use.
...
### [31] [Measuring Tianlai's primary beam using sky model](https://arxiv.org/abs/2604.20262)
*Yunbo Geng,Furen Deng,Jixia Li,Shifan Zuo,Shijie Sun,Yichao Li,Fengquan Wu,Yougang Wang,Xuelei Chen*

Main category: astro-ph.IM

TL;DR: This study measures the beam pattern of the Tianlai Cylinder Pathfinder Array using the Sun as a calibration source, leading to independent E-W and N-S beam decomposition.


<details>
  <summary>Details</summary>
Motivation: To accurately characterize the beam pattern of a drift-scan telescope, leveraging the unique motion of the Sun and the factorizability of the primary beam.

Method: The study uses the Sun's motion to measure E-W beam profiles and simulates signals with a sky map to derive N-S beam profiles, applying normalization for solar activity effects.

Result: The E-W and N-S beam profiles were successfully extracted and found to conform to prior expectations, confirming the measurement method's validity.

Conclusion: The findings support the feasibility of using the Sun for beam pattern calibration and decomposition in drift-scan instruments.
...
### [32] [Review: A new method for estimation and use of systematic errors in Poisson regression](https://arxiv.org/abs/2604.20632)
*M. Bonamente*

Main category: astro-ph.IM

TL;DR: A new method for incorporating systematic errors into Poisson regression is presented, enhancing the modeling of astronomical spectra.


<details>
  <summary>Details</summary>
Motivation: Addressing systematic uncertainties in Poisson data regression is crucial for accurate astronomical analysis.

Method: The method generalizes the Cash statistic $C_{min}$ and the likelihood-ratio statistic $ΔC$ to include systematic errors in the analysis.

Result: It simplifies the modeling process while assessing systematic uncertainties and fit quality simultaneously, including for nested models.

Conclusion: This new approach effectively combines simplicity with comprehensive error assessment, improving analytical accuracy in astronomical data.
...
### [33] [A Python/CuPy Software Correlator for QUEST: Real-Time Performance and Initial Imaging](https://arxiv.org/abs/2604.20640)
...
TL;DR: Development of a Python/CuPy software correlator for small radio interferometers, successfully tested on the QUEST telescope with promising throughput and imaging results.


<details>
  <summary>Details</summary>
Motivation: To enhance real-time data processing and imaging capability for small radio interferometer arrays, specifically for the QUEST telescope.

Method: Employs multi-threaded data ingestion, GPU acceleration, and advanced techniques for calibration and RFI flagging in a streamlined workflow.

Result: Achieved a peak throughput of 1.51 GB/s on a NVIDIA RTX 4090D GPU, enabling effective real-time operation and producing a high-quality synthesis image of Cassiopeia A.

Conclusion: The software is effective for commissioning small arrays and initial imaging, demonstrating significant improvements in visibility calibration and background fluctuation reduction.
...
### [34] [Neural posterior estimation of the neutrino direction in IceCube using transformer-encoded normalizing flows on the sphere](https://arxiv.org/abs/2604.19846)
...
TL;DR: This paper presents a neural network approach using a transformer encoder for improving the directional reconstruction of neutrinos in the IceCube detector, achieving superior angular resolution and faster computation compared to traditional methods.


<details>
  <summary>Details</summary>
Motivation: Precise directional reconstruction of neutrinos is crucial for correlating them with astronomical objects, necessitating improved methods for analysis.

Method: Utilizes a transformer encoder in conjunction with a normalizing flow on the 2-sphere, employing novel structural choices like dual residual streams and nonlinear projections to enhance performance.

Result: Achieves new state-of-the-art angular resolution for both tracks and showers in IceCube, with significant improvement factors over previous likelihood-based methods, especially at high energies.

Conclusion: This ML-based technique sets a new benchmark for neutrino direction reconstruction, outperforming traditional methods and facilitating faster all-sky scans.
...
### [35] [Prospects for measuring exclusive diffractive $η,η'$ at the LHC](https://arxiv.org/abs/2604.20037)
*Rainer Schicker*

Main category: hep-ex

TL;DR: The paper discusses central exclusive diffractive production in proton-proton collisions at the LHC, focusing on the detection of events characterized by midrapidity hadronic activity and forward scattered protons, while exploring the role of pomeron-pomeron fusion and the identification of pseudoscalar mesons to elucidate the pomeron's spin structure.


<details>
  <summary>Details</summary>
Motivation: To explore central exclusive diffractive production and its mechanisms at hadron colliders, particularly under the context of LHC energies.

Method: Analysis involves the use of detectors to measure both midrapidity hadronic activity and the forward scattered protons, alongside a theoretical framework within the Regge approach to characterize the pomeron and study pseudoscalar meson identification.

Result: The study finds that central diffractive production is indeed dominated by pomeron-pomeron fusion, and provides insights into potential methods for identifying pseudoscalar mesons to clarify the spin structure of the pomeron.

Conclusion: Identifying specific mesons could significantly enhance the understanding of the pomeron's spin structure and contribute to the broader knowledge of diffractive processes in high-energy proton-proton collisions.
...
### [36] [Using Graph Neural Networks for hadronic clustering and to reduce beam background in the Belle~II electromagnetic calorimeter](https://arxiv.org/abs/2604.20518)
*Jonas Eppelt,Torben Ferber*

Main category: hep-ex

TL;DR: The study proposes a Graph Neural Network (GNN) approach to enhance the identification and clustering of energy depositions in the Belle II electromagnetic calorimeter, addressing challenges from increased background noise and irregular hadronic interactions.


<details>
  <summary>Details</summary>
Motivation: Recent data-taking at Belle~II faced issues due to record luminosities and irregular hadronic particle interactions, leading to poor photon energy resolution and misidentification of neutral hadrons.

Method: The novel method utilizes Graph Neural Networks by representing energy depositions as nodes in a graph, employing message-passing layers to manage input sparsity and the detector's asymmetric layout.

Result: The approach aims to improve the photon energy resolution and accurately identify and cluster hadronic events, reducing fake clusters and misidentifications.

Conclusion: The implementation of GNNs shows potential in effectively managing the complexities of the Belle II detector simulation, leading to enhanced data analysis capabilities.
...
### [37] [Quantum Integrated High-Performance Computing: Foundations, Architectural Elements and Future Directions](https://arxiv.org/abs/2604.19814)
*Suman Raj,Siva Sai,Yogesh Simmhan,Kyle Chard,Rajkumar Buyya*

Main category: quant-ph

TL;DR: The paper introduces Quantum Integrated High-Performance Computing (QHPC), a framework that combines quantum and classical computing resources to enhance computational capabilities for scientific discovery.


<details>
  <summary>Details</summary>
Motivation: The paper aims to explore the integration of quantum processing units (QPUs) with existing computing paradigms to expand HPC's potential in scientific research.

Method: QHPC proposes a layered system design featuring unified resource management, quantum-aware scheduling, middleware, and a unified job submission interface to streamline workloads across different compute architectures.

Result: The QHPC framework is designed to efficiently handle emerging workloads in fields like quantum chemistry and climate modeling through a hybrid orchestration of classical and quantum resources.

Conclusion: The paper identifies challenges in creating scalable quantum-classical infrastructures, emphasizing the need for reliable connections between diverse computing resources in future HPC ecosystems.
...
### [38] [Quantum $f$-divergences via Nussbaum-Szkoła Distributions in Semifinite von Neumann Algebras](https://arxiv.org/abs/2604.19853)
*Theodoros Anastasiadis,George Androulakis*

Main category: quant-ph

TL;DR: The paper extends a previously established result connecting quantum and classical $f$-divergences from a specific case to all semifinite von Neumann algebras.


<details>
  <summary>Details</summary>
Motivation: To explore the relationship between quantum and classical $f$-divergences across a broader class of mathematical structures, promoting a deeper understanding of their connections.

Method: The authors build on existing work for normal states in a bounded operator setting and generalize these findings to any semifinite von Neumann algebra.

Result: The quantum $f$-divergence is shown to equal the classical $f$-divergence for normal states on any semifinite von Neumann algebra, identifying the classical counterparts as Nussbaum-Szkoła distributions.

Conclusion: The extension of this result supports a broader application of quantum-classical equivalences in information theory and statistical mechanics.
...
### [39] [Toward designing workload-aware Surface Code Architectures](https://arxiv.org/abs/2604.19855)
*Archisman Ghosh,Avimita Chatterjee,Swaroop Ghosh*

Main category: quant-ph

TL;DR: This paper presents a balanced architecture for fault-tolerant quantum computing (FTQC) that optimizes logical qubit accessibility while reducing qubit overhead and latency. It introduces a workload-driven placement method and enhances the flexibility of concurrent program execution, achieving significant efficiency gains in resource usage.


<details>
  <summary>Details</summary>
Motivation: To address the high architectural overhead and latency in fault-tolerant quantum computing, balancing fast logical-qubit accessibility with qubit density.

Method: Proposes an architecture with surface-code patches around an ancilla-centric region, introducing a workload-driven placement method based on $T$-gate profiles, and implements reconfigurable optimizations for $Y$-gate measurement latency.

Result: Numerical evaluations show reduced cycles per instruction to near-optimal levels and a reduction in required data tiles by $	ext{~21	ext{%}}$, achieving up to $	ext{~90	ext{%}}$ efficiency with concurrent execution of 10 programs.

Conclusion: The proposed architecture significantly enhances resource efficiency in fault-tolerant quantum computing while supporting multiple program executions.
...
### [40] [Bootstrapping Open Quantum Many-body Systems with Absorbing Phase Transitions](https://arxiv.org/abs/2604.19862)
*Minjae Cho,Colin Oscar Nancarrow,Petar Tadić,Yuan Xin*

Main category: quant-ph

TL;DR: This paper introduces a bootstrap method utilizing positivity of density matrices for analyzing open quantum systems with absorbing phase transitions, specifically applied to the quantum contact process.


<details>
  <summary>Details</summary>
Motivation: The study tackles the challenge of analyzing open quantum many-body systems that follow Lindblad dynamics and exhibit phase transitions, which are crucial for understanding quantum behavior in these systems.

Method: The authors combine the positivity of density matrices with steady-state conditions to develop a systematic bootstrap method tailored for infinite lattice quantum systems governed by Lindblad master equations.

Result: The method yields bounds on various steady-state properties, including critical coupling parameters and the Liouvillian spectral gap, enhancing the understanding of nontrivial steady states and phase transitions.

Conclusion: The approach provides valuable insights into the behavior of open quantum many-body systems at critical points, showcasing its applicability to specific models like the quantum contact process.
...
### [41] [Valley-Aware Optimal Control of Spin Shuttling Using Cryogenic Integrated Electronics](https://arxiv.org/abs/2604.20482)
*Pau Dietz Romero,Nermine Chaabani,Lammert Duipmans,Alessandro David,Felix Motzoi,Stefan van Waasen,Lotte Geck*

Main category: quant-ph

TL;DR: This paper presents advancements in electron shuttling for spin-qubit architectures by integrating simulation frameworks, tailored shuttling signal generators, and noise-aware optimization procedures, achieving high fidelity and low power consumption in shuttling operations.


<details>
  <summary>Details</summary>
Motivation: To improve the scalability of spin-qubit architectures through better electron shuttling methods while addressing valley splitting and noise issues.

Method: The authors developed a co-simulation framework, an integrated cryogenic shuttling-signal generator for waveform shaping, and a noise-aware optimization process to produce high-fidelity shuttling sequences.

Result: The optimized velocity-modulation waveforms boosted transport performance, yielding an average shuttling fidelity of 99.99% at an average speed of 20 m/s over a 10 μm distance, with minimal power consumption.

Conclusion: The findings validate the use of on-chip memory for storing optimized control settings as an effective approach to counteract valley disorder in scalable electron shuttling architectures.
...
### [42] [Practical HPCQC Integration with QDMI: A Real-Hardware Case Study with IQM Systems](https://arxiv.org/abs/2604.19869)
...
TL;DR: Integration is the primary challenge for quantum computing in HPC centers, addressed by the Quantum Device Management Interface (QDMI).


<details>
  <summary>Details</summary>
Motivation: The shift from hardware access to integration complicates operations and hinders the transition to production workflows.

Method: Implementation of a QDMI layer using IQM superconducting systems, interfaced with Slurm and Qiskit.

Result: The integration demonstrates that standardization of the software-hardware boundary can greatly streamline processes across quantum computing providers.

Conclusion: Standardizing the boundary enhances usability and reusability, though not all challenges in HPCQC are eliminated.
...
### [43] [Co-Designing Error Mitigation and Error Detection for Logical Qubits](https://arxiv.org/abs/2604.19871)
*Rohan S. Kumar,Takahiro Tsunoda,Sophia H. Xue,Dantong Li,Robert J. Schoelkopf,Yongshan Ding*

Main category: quant-ph

TL;DR: The paper explores the joint architectural design of Quantum Error Detection (QED) and Probabilistic Error Cancellation (PEC) to improve error management in near-term quantum workloads, identifying design challenges and proposing optimizations that enhance efficiency and accuracy.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of current quantum error management techniques, and to explore their complementary nature for improved performance in near-term quantum computing.

Method: The authors derive an efficiency condition for the QED interval tuning, demonstrate that conventional single-cycle detection does not achieve optimal results, and develop a protocol called steady-state extraction to refine PEC's noise model.

Result: Optimized QED intervals on high-rate Iceberg codes showed significant error reduction, with PEC+QED achieving 2–11 times lower absolute error and up to 31 times lower mean squared error (MSE) compared to PEC alone on physical qubits.

Conclusion: Integrating QED and PEC effectively reduces errors in quantum workloads, but requires careful tuning of the detection cycle and attention to the integration process to avoid degradation of accuracy.
...
### [44] [Measurement and feedback-driven adaptive dynamics in the classical and quantum kicked top](https://arxiv.org/abs/2604.19874)
*Mahaveer Prasad,Ahana Chakraborty,Thomas Iadecola,Manas Kulkarni,J. H. Pixley,Sriram Ganeshan,Justin H. Wilson*

Main category: quant-ph

TL;DR: Stochastic feedback stabilizes chaotic dynamics in the kicked top model across classical, semiclassical, and quantum regimes, revealing phase-dependent control effects and discrepancies in observable behaviors.


<details>
  <summary>Details</summary>
Motivation: The study investigates how stochastic feedback can control chaotic systems, focusing on the kicked top model to understand the interplay between classical, semiclassical, and quantum dynamics.

Method: The dynamics of the kicked top are analyzed through stochastic feedback protocols in various regimes, comparing quantum dynamics with a truncated Wigner approximation to assess the influence of noise and interference.

Result: Low-moment observables match semiclassical predictions, while discrepancies in higher moments highlight the role of quantum interference and nonlinear trajectories, indicating effective control across multiple regimes.

Conclusion: The findings suggest that control mechanisms can reduce the chaotic system's capacity to encode quantum information, implying a significant impact of control on the system's dynamics.
...
### [45] [Quantum-to-Classical Computability Transition via Negative Markov Chains](https://arxiv.org/abs/2604.19889)
*Hugo Lóio,Jacopo De Nardis,Tony Jin*

Main category: quant-ph

TL;DR: The paper introduces a quantum dynamics representation using negative Markov processes and examines the effects of noise on quantum complexity and simulation.


<details>
  <summary>Details</summary>
Motivation: To understand quantum dynamics and its simulation challenges in relation to noise and particle proliferation.

Method: A formalism mapping quantum dynamics onto a Markov process with particle-antiparticle concepts, analyzing noise's role in classicalizing the system.

Result: Identified specific noise channels that can suppress particle growth, enabling efficient classical Monte Carlo sampling; described a transition to classical simulability for open quantum spin chains under depolarizing noise.

Conclusion: The findings show that quantum dynamics can be effectively classicalized under certain noise conditions, with a measurable critical threshold for noise strength, facilitating classical simulations.
...
### [46] [Semi-device-independent self-testing of unitary operations](https://arxiv.org/abs/2604.19911)
*Rajdeep Paul,Prabuddha Roy,A. K. Pan*

Main category: quant-ph

TL;DR: The paper introduces a semi-device-independent self-testing protocol for certifying unitary operations in a prepare-measure framework using a 3-bit random access code involving two parties.


<details>
  <summary>Details</summary>
Motivation: To explore and certify unitary operations in quantum communication without needing fully trusted devices.

Method: Alice encodes a message using unitary operations on her subsystem, and Bob decodes it through measurements on the system, optimizing the quantum success probability for a 3-bit PMRAC.

Result: Demonstrated a quantum advantage over classical methods, enabling effective self-testing of unitary operations and measurements.

Conclusion: The method can be generalized to any n-bit PMRAC and extended to other communication games.
...
### [47] [The influence of evanescent waves on the nature of optical cooperative effects in atomic ensembles in a waveguide](https://arxiv.org/abs/2604.19944)
*A. S. Kuraptsev,I. M. Sokolov*

Main category: quant-ph

TL;DR: The study examines how evanescent modes of electromagnetic fields affect collective behaviors in atomic ensembles within a waveguide.


<details>
  <summary>Details</summary>
Motivation: To explore the unique effects of evanescent modes on atomic ensembles and their cooperative behaviors.

Method: A quantum microscopic approach is employed to analyze the interplay between evanescent modes and spontaneous decay in atomic ensembles.

Result: Evanescent modes can significantly influence cooperative spontaneous decay and radiation transfer, potentially dominating over radiation modes in specific conditions.

Conclusion: The interaction is primarily mediated through modifications to dipole-dipole interatomic interactions.
...
### [48] [Dissipative microcanonical ensemble preparation from KMS-detailed balance](https://arxiv.org/abs/2604.19973)
*Anirban N. Chowdhury,Samuel O. Scalet,Kunal Sharma*

Main category: quant-ph

TL;DR: This paper explores the preparation of stationary states in quantum many-body systems using techniques from open-system dynamics, focusing on the efficiency of preparing microcanonical ensembles and ground states.


<details>
  <summary>Details</summary>
Motivation: The study aims to understand how to efficiently prepare stationary states, particularly microcanonical ensembles, which are crucial in statistical physics and have implications for studying observables in quantum systems.

Method: The authors leverage recent advancements in open-system dynamics and build upon KMS-detailed balance conditions related to Gibbs states of noncommuting Hamiltonians to derive criteria for efficient implementation of stationary state preparations.

Result: The paper provides general criteria for the efficient preparation of stationary states and offers specific results regarding the approximation of microcanonical ensembles, demonstrating connections to Gibbs ensemble behaviors.

Conclusion: The findings have implications for testing ensemble equivalences in local observables of microcanonical and Gibbs ensembles, enhancing understanding of statistical physics in quantum many-body systems.
...
### [49] [Reinforcement Learning for Robust Calibration of Multi-Qudit Quantum Gates](https://arxiv.org/abs/2604.19990)
*Amine Jaouadi,Sahel Ashhab*

Main category: quant-ph

TL;DR: This paper proposes a hybrid framework combining optimal control theory and reinforcement learning to optimize controlled-phase gates on two qutrits, enhancing robustness in the presence of parameter uncertainties.


<details>
  <summary>Details</summary>
Motivation: Higher-dimensional quantum systems like qudits face challenges in achieving high-fidelity quantum gates due to spectral crowding and limited controllability.

Method: The method integrates optimal control to create high-fidelity control pulses, followed by reinforcement learning to apply small corrections that adjust for static model mismatch and parameter uncertainties.

Result: The approach improves the transfer robustness of gate performance across devices by learning structured corrections that stabilize control solutions under variations in parameters.

Conclusion: Reinforcement learning is effective for calibrating quantum gates in high-dimensional systems, enhancing adaptability and reducing sensitivity to parameter fluctuations.
...
### [50] [Fractional-Time Jaynes-Cummings Model: Unitary Description of its Quantum Dynamics, Inverse Problem and Photon Statistics](https://arxiv.org/abs/2604.20001)
*Thiago T. Tsutsui,Danilo Cius,Antonio S. M. de Castro,Fabiano M. Andrade*

Main category: quant-ph

TL;DR: The study investigates how fractional-time effects influence the quantum dynamics of the Jaynes-Cummings model, revealing non-classical behaviors conditioned on initial states.


<details>
  <summary>Details</summary>
Motivation: To explore quantum dynamics using a fractional framework and understand the role of fractional derivatives in enhancing non-classicality.

Method: Utilizing a unitary framework for the fractional-time Schrödinger equation to examine the effects of fractional derivative order on quantum dynamics under different initial states.

Result: Fractional evolution alters dynamics significantly, with an effective time-dependent coupling observed. A transition in dynamical regimes occurs at α=0.50, leading to enhanced non-classical properties compared to conventional dynamics.

Conclusion: Fractional derivative orders enhance non-classical features such as sub-Poissonian statistics and quadrature squeezing, particularly for coherent states in specific dynamical regimes.
...
### [51] [Assessing System Capabilities and Bottlenecks of an Early Fault-Tolerant Bicycle Architecture](https://arxiv.org/abs/2604.20013)
*Kun Liu,Ben Foxman,Gian-Luca R. Anselmetti,Yongshan Ding*

Main category: quant-ph

TL;DR: This paper addresses the bottlenecks in modular fault-tolerant quantum computers caused by inter-module communication, proposing compiler optimizations to improve performance.


<details>
  <summary>Details</summary>
Motivation: To understand and mitigate the challenges of inter-module communication and limited magic state factories in fault-tolerant quantum computers, particularly for early modular designs.

Method: The study employs a modular architecture based on Bivariate Bicycle codes, introduces a compilation pipeline, and proposes optimizations such as synthesizing rotations at the factory and enhancing Clifford operations.

Result: The proposed method shows significant improvements: syn@fac reduces circuit failure probability by 9 times, transvection cuts compile time by 77.04%, and Clifford insertion decreases circuit duration by 11.54% on average across benchmarks.

Conclusion: These findings highlight the effectiveness of the proposed compiler optimizations and encourage further research in this area for modular fault-tolerant quantum computing.
...
### [52] [Direct U(2) approximation via repeat-until-success circuits](https://arxiv.org/abs/2604.20033)
*Vadym Kliuchnikov,Jendrik Brachter,Marcus P. da Silva*

Main category: quant-ph

TL;DR: The paper presents a method for efficiently approximating one-qubit unitaries using minimal resources, expanding the technique to multi-qubit gate sets and orthogonal matrices.


<details>
  <summary>Details</summary>
Motivation: To provide a more efficient approximation of unitaries without relying on Euler decomposition and encountering issues with magnitude approximation.

Method: The method employs repeat-until-success circuits and leverages lattice-based synthesis, integer point enumeration, and relative norm equations.

Result: The new technique allows for the approximation of unitaries using one ancillary qubit and extends to multi-qubit gate sets and orthogonal matrices.

Conclusion: This approach is a significant improvement over traditional methods, enhancing both efficiency and applicability in quantum circuit design.
...
### [53] [CVaR-Assisted Custom Penalty Function for Constrained Optimization](https://arxiv.org/abs/2604.20088)
*Xin Wei Lee,Hoong Chuin Lau*

Main category: quant-ph

TL;DR: This paper presents a novel slack-free penalty formulation for constrained binary optimization that enhances the efficiency and effectiveness of QUBO models by eliminating slack variables and using a nonlinear custom penalty function.


<details>
  <summary>Details</summary>
Motivation: Standard QUBO formulations often impose constraints through slack variables and quadratic penalties, complicating the problem and negatively affecting optimization performance.

Method: The authors propose a slack-free penalty formulation that directly incorporates a nonlinear custom penalty function into the objective function while using a finite-sampling method to manage computational complexity. The Conditional Value-at-Risk (CVaR) objective is integrated to enhance optimization robustness.

Result: The proposed framework, tested on the multi-dimensional knapsack problem, showed improved optimality gaps and reliable performance compared to conventional slack-based QUBO formulations.

Conclusion: The study concludes that effective penalty design is crucial for advancing quantum and hybrid quantum-classical algorithms in constrained optimization contexts.
...
### [54] [Universality cost of non-Gaussian enhancement in continuous-variable quantum teleportation: A fidelity--deviation trade-off](https://arxiv.org/abs/2604.20103)
*Kyoungho Cho,Bongjune Kim,Jeongho Bang*

Main category: quant-ph

TL;DR: This paper re-evaluates continuous-variable quantum teleportation using average fidelity and fidelity deviation as metrics, showing that effective teleportation requires both high fidelity and uniformity across input states. It reveals trade-offs in improving teleportation performance through filtering techniques.


<details>
  <summary>Details</summary>
Motivation: The need for a more comprehensive assessment of continuous-variable quantum teleportation, incorporating both average fidelity and the uniformity of input states.

Method: Analysis of teleportation fidelity using average fidelity and fidelity deviation; proof of results regarding deterministic unity-gain teleportation channels and a case study involving measurement-based noiseless linear amplification.

Result: Determined that displacement covariant channels have vanishing fidelity deviation for coherent states, highlighting the significance of covariance breaking. Demonstrated trade-offs in teleportation performance due to input-selective protocols.

Conclusion: Evaluated the necessity of assessing average quality, universality, and heralding rate equally in probabilistic CV teleportation, distinguishing genuine improvements from advantages driven by selectivity.
...
### [55] [Efficient Quantum Algorithms for Higher-Order Coupled Oscillators](https://arxiv.org/abs/2604.20108)
*Caesnan M. G. Leditto,Angus Southwell,Muhammad Usman,Kavan Modi*

Main category: quant-ph

TL;DR: The paper presents quantum algorithms for analyzing higher-order networks, focusing on synchronization estimation and phase-locking certification, demonstrating significant quantum advantages over classical methods.


<details>
  <summary>Details</summary>
Motivation: To address the complex dynamics exhibited by higher-order networks that traditional pairwise models cannot capture, particularly under multiway interactions.

Method: Development of quantum algorithms targeting synchronization estimation and no-phase-locking certification in the simplicial Kuramoto model, along with a derivation of quantum gate complexities.

Result: Identification of regimes showing polynomial quantum advantage for synchronization estimation and super-polynomial advantage for no-phase-locking certification compared to classical methods.

Conclusion: The findings broaden the application of quantum algorithms in analyzing higher-order networks, tackling computational challenges and enabling insights that classical approaches cannot achieve.
...
### [56] [Complexity of quantum states in the stabilizer formalism](https://arxiv.org/abs/2604.20118)
*Shuangshuang Fu,Shunlong Luo,Yue Zhang*

Main category: quant-ph

TL;DR: This paper introduces a novel quantifier for state complexity in discrete-variable quantum systems, tied to the stabilizer formalism and specific algebraic products, revealing a connection between state complexity and nonstabilizerness through characteristic function metrics.


<details>
  <summary>Details</summary>
Motivation: To explore a new measure of state complexity for discrete-variable quantum systems, enhancing understanding within quantum computation frameworks.

Method: The authors utilize the symmetric Jordan and skew-symmetric Lie products to develop an information-theoretic quantifier for quantum state complexity; they analyze properties and establish connections to nonstabilizerness using the $L^4$-norm of characteristic functions.

Result: The proposed quantifier reveals fundamental relationships between the complexity of quantum states and their nonstabilizerness, indicating a structural basis in their mathematics.

Conclusion: The findings contribute to the theoretical framework of quantum information by illustrating the intricate connections between state complexity, classicality, and quantumness.
...
### [57] [Average metric adjusted skew information of coherence under conical 2-designs generalized equiangular measurements](https://arxiv.org/abs/2604.20149)
*Baolong Cheng,Linlin Ye,Zhaoqi Wu*

Main category: quant-ph

TL;DR: This paper introduces a new measure of quantum uncertainty based on metric adjusted skew information, exploring average coherence through generalized equiangular measurements.


<details>
  <summary>Details</summary>
Motivation: To enhance understanding of quantum coherence and its implications in quantum information using new metrics.

Method: The study defines a measure of quantum uncertainty using metric adjusted skew information, examines coherence under conical 2-designs, and proves equivalences and trade-off relations.

Result: The proposed measure is equivalent to the scaled average coherence and facilitates the derivation of two entanglement criteria, supported by examples.

Conclusion: The findings augment tools for analyzing quantum coherence and entanglement, highlighting the utility of generalized equiangular measurements.
...
### [58] [Tensor network surrogate models for variational quantum computation](https://arxiv.org/abs/2604.20180)
*Ryo Watanabe,Dries Sels,Joseph Tindall*

Main category: quant-ph

TL;DR: This paper presents a two-dimensional tensor-network approach to simulate variational quantum algorithms, specifically targeting the Quantum Approximate Optimization Algorithm (QAOA) on Ising spin-glass problems across various lattice types.


<details>
  <summary>Details</summary>
Motivation: The motivation is to investigate the effectiveness of variational quantum algorithms in 2D qubit architectures, particularly through improved sampling strategies in large-scale quantum systems.

Method: The authors utilize a tensor-network ansatz to simulate QAOA on heavy-hexagonal and square lattices, employing parameter training on smaller instances for larger systems, and analyzing entanglement growth and sampling feasibility with moderate bond dimensions.

Result: The simulation shows that parameter transfer improves energy sampling up to intermediate circuit depths, with TN training on larger systems yielding lower-energy samples, although parameter concentration poses limitations.

Conclusion: The TN framework is effective for benchmarking variational quantum algorithms on 2D lattices and serves as a useful surrogate model for training, despite the computational challenges on square lattices.
...
### [59] [Hamiltonian simulation for 3D elastic wave equations in homogeneous elastic media](https://arxiv.org/abs/2604.20284)
*Kosuke Nakanishi,Hiroshi Yano,Yuki Sato*

Main category: quant-ph

TL;DR: A quantum circuit is constructed to simulate Hamiltonian dynamics of the 3D elastic wave equation in homogeneous isotropic media, improving upon previous methods by providing explicit gate complexities.


<details>
  <summary>Details</summary>
Motivation: To address limitations in estimating gate complexity for Hamiltonian simulations of elastic wave equations which typically rely on black box assumptions.

Method: The authors discretize the first-order velocity--stress formulation using finite differences, transform it into a Schrödinger form, and decompose the Hamiltonian into structured tensor products, implementing Trotter formulas for time evolution.

Result: Explicit gate complexity estimates and error bounds are derived, with numerical experiments validating the framework against exact time evolution and physical field reconstructions.

Conclusion: The proposed method effectively simulates the elastic wave equation, with clear advantages in complexity estimation and accuracy compared to previous approaches.
...
### [60] [Operational criterion for Wigner function negativity](https://arxiv.org/abs/2604.20303)
*Paolo Solinas,Beatrice Donelli,Stefano Gherardini*

Main category: quant-ph

TL;DR: The study proposes a criterion for assessing negativity in the Wigner function of quantum states using quantum non-demolition measurements, establishing connections between coherent superpositions and Wigner function positivity.


<details>
  <summary>Details</summary>
Motivation: To provide an operational criterion for determining Wigner function negativity in quantum states, enabling experimental accessibility and clearer insights into quantum behaviors.

Method: The authors define a criterion based on the presence or absence of coherent superpositions in the coherent-state basis and explore its implications for WF positivity and negativity.

Result: The study establishes that the absence of coherent superpositions is a sufficient condition for Wigner function positivity, and validates this condition in Schrödinger-cat and higher-order cat states.

Conclusion: While a comprehensive proof of necessity is not provided, the results affirm the connection between coherent states and the positivity of the Wigner function in specified cases.
...
### [61] [Cutting-plane methodology via quantum optimization for solving the Traveling Salesman Problem](https://arxiv.org/abs/2604.20321)
*Alessia Ciacco,Luigi Di Puglia Pugliese,Francesca Guerriero*

Main category: quant-ph

TL;DR: This study addresses the Traveling Salesman Problem using an iterative approach for dynamic subtour elimination and integration of preprocessing techniques, employing both classical and quantum optimization frameworks, leading to significant computational performance improvements.


<details>
  <summary>Details</summary>
Motivation: The Traveling Salesman Problem is NP-hard and requires efficient subtour elimination, a major challenge in its formulations.

Method: An iterative approach is used for dynamic generation of subtour elimination constraints, combined with a preprocessing phase to minimize candidate arcs, and includes both classical and quantum optimization techniques, particularly quantum annealing within the D-Wave framework.

Result: Computational experiments demonstrate that the proposed strategies reduce model size significantly and yield performance enhancements across classical, direct quantum, and hybrid solvers.

Conclusion: The findings confirm that the iterative and preprocessing methods improve computational efficiency in solving the Traveling Salesman Problem.
...
### [62] [Interpolating between positive, Schwarz, and completely positive evolution for d-level systems](https://arxiv.org/abs/2604.20335)
*Dariusz Chruściński,Farrukh Mukhamedov*

Main category: quant-ph

TL;DR: This paper explores quantum dynamical maps for d-level systems, analyzing transitions between different positivity classes and their implications for entanglement.


<details>
  <summary>Details</summary>
Motivation: To understand the nature of quantum dynamical maps and their transitions between different positivity classes, which are crucial for quantum information science.

Method: A geometric analysis of the parameter space of quantum dynamical maps, identifying regions related to positivity classes and observing dynamical trajectories within those regions.

Result: Dynamical trajectories can cross boundaries between positivity classes, illustrating transitions between Markovian and non-Markovian regimes, with eventual entanglement breaking in the evolution.

Conclusion: The study emphasizes the concepts of divisibility and eternally non-Markovian evolution in quantum dynamics.
...
### [63] [Column Generation for the Optimization of Switching in Repeaterless Quantum Networks](https://arxiv.org/abs/2604.20338)
*Álvaro Troyano Olivas,Andrés Agustí Casado,Hans H. Brunner,Chi-Hang Fred Fung,Momtchil Peev,Laura Ortiz,Vicente Martin*

Main category: quant-ph

TL;DR: The paper presents a new method for optimizing switching configurations in repeaterless quantum communication networks using a graph-based approach and linear programming.


<details>
  <summary>Details</summary>
Motivation: Efficient resource allocation and optical switching in quantum networks are crucial for enhancing key rates and reducing costs. However, finding optimal switching configurations is complex due to combinatorial challenges.

Method: The authors propose a novel graph formulation to model the structure of repeaterless quantum networks, framing the optimization problem as a linear program solved via a column generation technique.

Result: The proposed method demonstrates scalability in computation, managing an exponential number of configurations efficiently, verified through empirical tests with varying network sizes.

Conclusion: The study provides both a theoretical and practical framework for optimizing switching in quantum networks, establishing a foundation for future advancements in quantum network control.
...
### [64] [Comment on "Quantum Limits to Incoherent Imaging are Achieved by Linear Interferometry"](https://arxiv.org/abs/2604.20353)
*George Brumpton,Aiman Khan,Helia Hooshmand,Samanta Piano,Gerardo Adesso*

Main category: quant-ph

TL;DR: The paper identifies a flaw in a previous linear interferometer construction and presents a corrected optimal configuration that maximizes quantum Fisher information for imaging multiple weak incoherent emitters.


<details>
  <summary>Details</summary>
Motivation: To address and correct the shortcomings in the interferometer design presented in prior work, which does not achieve optimal performance.

Method: The authors derive the optimal configuration of the linear interferometer that adheres to the quantum Fisher information limit.

Result: The correct interferometric configuration is shown to achieve the theoretical quantum Fisher information limit for imaging N weak incoherent emitters.

Conclusion: The new design provides a significantly improved solution for optimal imaging of weak incoherent sources.
...
### [65] [Jaynes-Cummings dynamics in strong coupling for many-interacting-qubit quantum Rabi models](https://arxiv.org/abs/2604.20363)
*Roberto Grimaudo,Sagnik Chakraborty,Rosario Lo Franco,Giuseppe Falci*

Main category: quant-ph

TL;DR: This paper investigates many-body spin-systems interacting with a cavity mode, redefining the conditions for strong/weak coupling by analyzing collective dynamics.


<details>
  <summary>Details</summary>
Motivation: To clarify the nuances in strong and weak coupling regimes in many-body spin systems interacting with a cavity mode, given that individual subsystem interactions can differ from collective dynamics.

Method: The study involves analyzing the effective coupling and demonstrating counter-intuitive effects using three systems: two-qubit, two-qutrit, and $N$-qubit chain quantum Rabi models.

Result: The results reveal that a Jaynes-Cummings dynamics can emerge even in the presence of strong interactions, suggesting a complex interplay between individual and collective dynamics.

Conclusion: The findings underline the need for a re-evaluation of coupling definitions in many-body systems, emphasizing their universality across various quantum models.
...
### [66] [Level crossings and superradiant quantum phase transition for a two-qutrit quantum Rabi model](https://arxiv.org/abs/2604.20371)
*R. Grimaudo,A. S. M. De Castro,G. Falci,A. Messina,E. Paladino,A. Messina,N. V. Vitanov*

Main category: quant-ph

TL;DR: The study explores a two-qutrit extension of the quantum Rabi model, revealing its integrability under certain conditions, which facilitates the analysis of critical phenomena and the ground-state phase diagram.


<details>
  <summary>Details</summary>
Motivation: To investigate the complexities and potential integrable features of a two-qutrit extension of the quantum Rabi model.

Method: Analysis of the model under specific conditions allowing for integrability and the emergence of analytically tractable subdynamics.

Result: The derivation of the ground-state phase diagram and identification of critical phenomena related to level crossings and quantum phase transitions.

Conclusion: The findings highlight the critical phenomena arising from the model's integrability, providing insights into quantum phase transitions.
...
### [67] [Hessian-vector products for tensor networks via recursive tangent-state propagation](https://arxiv.org/abs/2604.20384)
*Isabel Nha Minh Le,Roeland Wiersema,Christian B. Mendl*

Main category: quant-ph

TL;DR: An analytical Hessian-vector product kernel enables efficient second-order optimization for tensor networks, improving convergence and fidelity in quantum circuit compression.


<details>
  <summary>Details</summary>
Motivation: Standard first-order optimization methods for tensor networks are slow and often get stuck in local minima, prompting the need for robust second-order methods without high computational costs.

Method: The paper introduces an analytical Hessian-vector product kernel that uses recursive tangent-state propagation with a bounded virtual bond dimension, allowing for efficient implementation in large-scale systems.

Result: The second-order optimization approach integrated into a Riemannian trust-region framework showed up to four times improvement in fidelity for quantum circuits, with faster convergence compared to first-order methods like Riemannian ADAM.

Conclusion: The proposed method significantly enhances the efficiency and effectiveness of optimizing tensor networks, particularly in quantum circuit applications.
...
### [68] [Nonuniversal beyond-LHY corrections to thermodynamic properties of a weakly interacting Bose gas](https://arxiv.org/abs/2604.20391)
*Pham Duy Thanh,Nguyen Van Thu*

Main category: quant-ph

TL;DR: Finite-range interatomic interactions significantly alter the equation of state and thermodynamic properties of a weakly interacting Bose gas.


<details>
  <summary>Details</summary>
Motivation: To understand how finite-range interactions affect a weakly interacting Bose gas at zero temperature.

Method: Utilizing the Cornwall-Jackiw-Tomboulis effective action approach to analyze the effects of finite-range interactions.

Result: Finite-range effects modify the equation of state and induce nonuniversal behavior in the system's thermodynamics at zero temperature.

Conclusion: Finite-range interatomic interactions play a crucial role in determining the thermodynamic characteristics of weakly interacting Bose gases.
...
### [69] [Unitary Realizations of Synchronizing Automata in Quantum Systems](https://arxiv.org/abs/2604.20432)
*Jȩdrzej Stempin,Jan Wójcik,Gabriela Banaszak,Andrzej Grudka,Marcin Karczewski,Paweł Kurzyński,Antoni Wójcik*

Main category: quant-ph

TL;DR: This paper introduces a quantum version of classical synchronizing automata, demonstrating how quantum synchronizing words can be used to reset the automaton to a predetermined state through auxiliary qubits, preserving unitarity in the process.


<details>
  <summary>Details</summary>
Motivation: The study aims to reconcile the concept of synchronizing automata with the principles of quantum mechanics, which typically oppose irreversibility.

Method: The authors propose a resetting protocol using auxiliary qubits to encode the automaton's rules, employing a global unitary operation for interaction with the automaton, represented by a qudit.

Result: The proposed quantum automaton can reach a predetermined pure state when driven by a synchronizing word, while the qubit register evolves into an entangled state reflecting the original configuration.

Conclusion: The framework allows for the generation of specific entangled states, providing insights into the interplay between the rule set and the automaton's initial configuration.
...
### [70] [Quantum-Enhanced Recurrent Neural Networks via Variational Quantum Gating for Battery State of Health Prediction](https://arxiv.org/abs/2604.20438)
*Yin Xu,Qinglin Liu,Li Gao,Hua Xu*

Main category: quant-ph

TL;DR: This paper presents QLSTM, a quantum-enhanced framework that improves state-of-health estimation for lithium-ion batteries by integrating quantum circuits into LSTM gating mechanisms, outperforming classical models in predictive accuracy.


<details>
  <summary>Details</summary>
Motivation: The complex degradation mechanisms of lithium-ion batteries necessitate more accurate state-of-health estimations due to the limitations of classical models.

Method: QLSTM incorporates variational quantum circuits in the gating mechanisms of LSTMs, replacing classical affine transformations with parameterized unitary operations to enhance state transitions.

Result: Experimental results show QLSTM achieves up to a 20% reduction in mean absolute error compared to classical LSTM models and demonstrates robustness across multiple datasets.

Conclusion: The findings suggest that the integration of quantum computational elements into recurrent architectures can significantly enhance sequence modeling capabilities, marking a new approach for temporal learning applications.
...
### [71] [Native quantum games from interacting discrete-time quantum walks](https://arxiv.org/abs/2604.20455)
*Rashid Ahmad*

Main category: quant-ph

TL;DR: This paper explores strategic interactions in quantum games defined by controlled quantum dynamics, highlighting how such interactions arise from the quantum mechanics of distinguishable quantum walkers.


<details>
  <summary>Details</summary>
Motivation: To understand the emergence of strategic behavior in games through controlled quantum dynamics rather than external mathematical frameworks.

Method: A class of quantum games featuring distinguishable quantum walkers, where strategies are local coin operations and payoffs are defined as expectation values of observables, is numerically examined.

Result: Stable strategy profiles in competitive, cooperative, and asymmetric games are found when walkers are coupled, with no equilibria present in isolation; analytical perturbation shows strategic interactions result from interference in joint probabilities.

Conclusion: The study provides a new perspective on strategic interdependence in quantum processes and positions interacting quantum walks as a basis for exploring game theory within quantum dynamics.
...
### [72] [Quantum metrology via mitigation of single-photon loss using an engineered nonlinear oscillator](https://arxiv.org/abs/2604.20563)
*Tian-Le Yang,Wen Ning,Zhen-Biao Yang,Shi-Biao Zheng*

Main category: quant-ph

TL;DR: The paper addresses the challenge of quantum metrological advantages in the face of single-photon loss by employing engineered two-photon loss in a Kerr resonator model, leading to improved measurement stability and extended high-sensitivity windows.


<details>
  <summary>Details</summary>
Motivation: To overcome the limitations in quantum sensing caused by single-photon loss, which hampers the effective use of quantum resources for practical measurements.

Method: A hybrid TPD-Kerr-ETPL model was developed, integrating engineered two-photon loss to mitigate oscillations caused by single-photon loss, allowing for smoother measurement dynamics.

Result: The introduction of ETPL enhances the measurement windows by over an order of magnitude, stabilizing quantum resources and revealing a hierarchy of sensitivity mechanisms: initial sensitivity from Gaussian squeezing and sustained precision from non-Gaussian cat states.

Conclusion: Engineered loss combined with appropriate driving strategies can maintain useful quantum states for metrology, leading to improved stability in quantum measurements without relying on real-time feedback systems.
...
### [73] [Device-independent quantum cryptography with input leakage](https://arxiv.org/abs/2604.20573)
*Víctor Zapatero,Marcos Curty*

Main category: quant-ph

TL;DR: This paper analyzes CHSH-based randomness certification and key distribution under partial information leakage, quantifying local randomness and secret key rates dependent on input leakage.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the assumption of no information leakage in device-independent quantum cryptography protocols, a critical aspect for their practical implementation.

Method: The authors model information leakage using a noisy channel to examine CHSH-based randomness certification and key distribution.

Result: The study quantifies both the certifiable local randomness and the secret key rate in relation to the extent of the input leakage.

Conclusion: The findings suggest that even with partial leakage, certain levels of randomness and security can still be guaranteed.
...
### [74] [Distributed Quantum Optimization for Large-Scale Higher-Order Problems with Dense Interactions](https://arxiv.org/abs/2604.20599)
*Seongmin Kim,Vincent R. Pascuzzi,Travis S. Humble,Thomas Beck,Sanghyo Hwang,Tengfei Luo,Eungkyu Lee,In-Saeng Suh*

Main category: quant-ph

TL;DR: The paper presents a distributed quantum optimization framework (DQOF) for solving complex higher-order optimization problems, demonstrating superior efficiency and performance compared to classical methods.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of solving higher-order optimization tasks that involve dense, multi-variable interactions using classical methods, which are limited in handling such complexity.

Method: The DQOF integrates quantum circuits to directly capture higher-order interactions while leveraging high-performance computing for parallel execution. A clustering strategy is employed to facilitate the use of wide quantum circuits without increasing execution depth.

Result: The framework successfully tackles HUBOs with up to 500 variables in 170 seconds, showing significantly enhanced solution quality and scalability compared to conventional methods.

Conclusion: DQOF demonstrates its viability as a practical computational approach for large-scale scientific optimization, particularly in applications like optical metamaterial design.
...
### [75] [Bound, antibound and resonance two-photon states in chiral waveguide QED](https://arxiv.org/abs/2604.20602)
*Alexander Poddubny*

Main category: quant-ph

TL;DR: This study presents a comprehensive analysis of the two-particle spectrum in chiral waveguide QED, revealing new solutions for all momentum values.


<details>
  <summary>Details</summary>
Motivation: To explore the two-particle spectrum in chiral waveguide QED setups with varying center-of-mass momenta.

Method: Theoretical analysis of the two-particle spectrum $ω(K)$, examining the existence of distinct solutions across momentum values.

Result: Identified distinct bound, antibound, and resonance states, consistent across all momenta, with a gapless real part of the spectrum.

Conclusion: The findings extend previous studies by demonstrating a more comprehensive understanding of the two-particle spectrum in this setup.
...
### [76] [A quantum frequency conversion hub interfacing with DWDM networks](https://arxiv.org/abs/2604.20620)
*Masatake Yamada,Kurama Hirano,Masahiro Yabuno,Shigehito Miki,Tsuyoshi Kodama,Hideki Shimoi,Takashi Yamamoto,Rikizo Ikuta*

Main category: quant-ph

TL;DR: The paper proposes a quantum network hub that connects local quantum devices to telecom networks using quantum frequency conversion, demonstrating a successful channel-selective QFC with high pump tuning and preservation of quantum information.


<details>
  <summary>Details</summary>
Motivation: To facilitate the realization of the quantum internet by interconnecting diverse quantum systems.

Method: Utilize quantum frequency conversion (QFC) with frequency-channel selectivity in periodically poled lithium niobate waveguides, demonstrating a channel-selective QFC from 780 nm to 1540 nm.

Result: Achieved a pump tuning range of 2 THz and distributed polarization-encoded single photons into 16 frequency channels on the ITU-T DWDM grid with 25 GHz spacing, preserving quantum information.

Conclusion: The QFC-based hub offers a robust solution for linking various quantum devices across frequency-multiplexed telecom networks.
...
### [77] [Distributed Quantum-Enhanced Optimization: A Topographical Preconditioning Approach for High-Dimensional Search](https://arxiv.org/abs/2604.20639)
*Dominik Soós,Marc Paterno,John Stenger,Nikos Chrisochoides*

Main category: quant-ph

TL;DR: D-QEO leverages quantum optimization as a preconditioner, improving classical methods for challenging optimization problems.


<details>
  <summary>Details</summary>
Motivation: The increasing complexity of optimization problems with numerous variables makes finding global minima difficult using classical algorithms, particularly for non-convex functions.

Method: D-QEO uses a quantum processor to identify promising regions in the search space, generating seed points for classical refinement while employing separable functions to manage complexity effectively.

Result: Benchmarks indicate that D-QEO significantly improves performance over classical methods by reducing failure rates and iterations needed for convergence on high-dimensional functions.

Conclusion: D-QEO serves as an efficient strategy for integrating quantum resources into optimization, demonstrating practical utility for complex problems.
...
### [78] [Quantum Advantage for Coordinated Frequency Selection Against Distributed Jammers](https://arxiv.org/abs/2604.20647)
*Stephanie Wehner*

Main category: quant-ph

TL;DR: This paper investigates how two parties can select a common frequency band for communication amidst interference from jammers, revealing advantages of quantum strategies over classical ones when using entangled pairs.


<details>
  <summary>Details</summary>
Motivation: The need for effective communication in the presence of jammers drives the exploration of strategies for parties to agree on a common frequency band without direct communication.

Method: The authors establish a classical strategy for optimal band selection and introduce quantum strategies utilizing entangled states, particularly focusing on a case with dimension d = 2 and demonstrating improved performance over classical methods.

Result: The quantum strategy outperforms the classical optimum across all spectrum sizes, achieving an asymptotic advantage of 5.4% when using one shared entangled Bell pair, contingent on the availability of sufficient safe bands and spectrum size.

Conclusion: This work highlights the superiority of quantum coordination techniques in communication scenarios affected by jammers, suggesting broad implications for quantum networks in future communication systems.
...
### [79] [Controllable non-Hermitian topology in a dynamically protected cat qubit](https://arxiv.org/abs/2604.20680)
*Tian-Le Yang,Pei-Rong Han,Zhen-Biao Yang,Shi-Biao Zheng*

Main category: quant-ph

TL;DR: The paper explores the non-Hermitian spectral topology of cat qubits, revealing Liouvillian exceptional points (LEPs) through engineered losses and drives, and introduces a method for robust identification of these points with a topological invariant.


<details>
  <summary>Details</summary>
Motivation: To investigate the non-Hermitian spectral properties of dissipatively stabilized cat qubits for improvements in fault-tolerant quantum information processing.

Method: The authors study cat-qubits under two-photon drive and loss, alongside single-photon dynamics, identifying second- and third-order Liouvillian exceptional points based on the strength and detuning of single-photon drive, and introduce a topological invariant related to the winding number.

Result: They find that the phase of two-photon drive influences the behavior of LEP3s, which can be controlled coherently, with phase $θ=π/2$ causing divergence; simulations show high-fidelity confinement in the logical subspace.

Conclusion: This work connects dissipative stabilization mechanisms with control over non-Hermitian topology, providing insights into the dynamics and stability of higher-order exceptional points in open quantum systems.
...
### [80] [Divide-and-Conquer Neural Network Surrogates for Quantum Sampling: Accelerating Markov Chain Monte Carlo in Large-Scale Constrained Optimization Problems](https://arxiv.org/abs/2604.20701)
*Yuya Kawamata,Yuichiro Nakano,Keisuke Fujii*

Main category: quant-ph

TL;DR: The paper introduces a neural network framework that enhances quantum sampling for accelerating Markov chain Monte Carlo (MCMC) processes, particularly under Hamming weight constraints, demonstrating its superiority over classical methods in various scenarios.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of large-scale and constrained practical problems in MCMC that hinder the efficiency of classical proposal distributions.

Method: A divide-and-conquer neural network surrogate framework that breaks down Ising problems into manageable subgraphs, using QAOA and conditioning neural networks on Hamming weight to generate efficient proposal distributions.

Result: Numerical experiments showed significant acceleration in mixing for Boltzmann sampling on 3-regular graphs, achieving speedup factors of about 20.3 and 7.6 over classical methods, alongside improved performance in an MNIST feature mask optimization problem.

Conclusion: This method proves to be efficient and scalable for MCMC, outperforming classical approaches, making it feasible for practical applications on NISQ devices.
...
### [81] [Rank-2 Electromagnetic Backgrounds and Angular Momentum Barriers in Gravitomagnetic Spin-Quadrupole Searches](https://arxiv.org/abs/2604.20717)
*Leonardo A. Pachon*

Main category: quant-ph

TL;DR: This paper analyzes the constraints on detecting gravitomagnetic spin-quadrupole coupling in highly charged ions, highlighting selection rules, background interactions, and providing a roadmap for experiments.


<details>
  <summary>Details</summary>
Motivation: Understanding gravitomagnetic effects in highly charged ions is critical for advancing gravitational physics and potentially new physics beyond the Standard Model.

Method: The study identifies angular momentum selection rules and quantifies various electromagnetic background interactions, establishing conditions for a multi-isotope, multi-transition Generalized King Plot to isolate gravitational signals.

Result: The analysis finds significant electromagnetic background sources and establishes a first laboratory-derivable bound on the gyrogravitational ratio for molybdenum isotopes, indicating the need for multiple transitions and odd-spin isotopes in experiments.

Conclusion: A structured approach is outlined to improve experimental sensitivity and bounds on the gyrogravitational ratio, essential for future explorations of gravitomagnetic interactions.
...
### [82] [Comment on 'The axiom of choice and the no-signalling principle'](https://arxiv.org/abs/2604.20756)
*Martti Karvonen*

Main category: quant-ph

TL;DR: The paper critiques arXiv:2206.08467's claim that deterministic no-signalling resources surpass probabilistic ones, asserting that deterministic resources are essentially probabilistic, that deterministic strategies can be converted to probabilistic ones, and that a gap exists in the original argument due to unexamined measurability assumptions.


<details>
  <summary>Details</summary>
Motivation: To challenge the claim made in arXiv:2206.08467 regarding the superiority of deterministic no-signalling resources over probabilistic ones.

Method: The authors analyze the definitions of no-signalling resources, critique the claims made in arXiv:2206.08467, and propose new measurability assumptions.

Result: They argue that deterministic no-signalling resources are essentially probabilistic and point out gaps in the original paper's arguments related to measurability.

Conclusion: The difference observed in the previous work should be viewed through the lens of measurable versus non-measurable no-signalling resources.
...
### [83] [Path integral formulation of finite-dimensional quantum mechanics in discrete phase space](https://arxiv.org/abs/2604.20776)
*Leonardo A. Pachon,Andres F. Gomez*

Main category: quant-ph

TL;DR: This paper presents a path integral formulation for finite-dimensional quantum dynamics using a discrete phase space, focusing on the discrete Wigner function and providing expressions for quantum propagators and entanglement dynamics.


<details>
  <summary>Details</summary>
Motivation: To explore quantum system dynamics in a finite-dimensional Hilbert space and establish a coherent framework for path integrals within discrete phase space.

Method: Derivation of an exact evolution kernel using discrete Wigner function on a lattice, followed by deriving a sum-over-paths representation and exploring Hamiltonians linear in phase-space coordinates.

Result: Demonstrated that the fluctuation sum can factorize, leading to deterministic shifts at specific time intervals and allowing thorough analysis of entanglement dynamics for single and interacting qutrits.

Conclusion: The formulation is relevant for semiclassical simulations of many-body spin systems and aids in characterizing non-classicality via Wigner negativity.
...
### [84] [Reflections on Quantum Reflectometry: Quantum and Tunneling capacitances as well as Sisyphus and Hermes resistances](https://arxiv.org/abs/2604.20790)
*O. Yu. Kitsenko,S. N. Shevchenko,L. Peri,Franco Nori*

Main category: quant-ph

TL;DR: The paper presents a comprehensive analysis of how quantum electronic devices interact with electrical resonators, focusing on admittance changes and effective parameters influenced by quantum dynamics.


<details>
  <summary>Details</summary>
Motivation: To rigorously describe the mutual dependence of quantum electronic devices and resonators and how this interaction impacts measurements.

Method: The authors introduce quantum and tunneling capacitances, along with specific resistances (Hermes and Sisyphus), within a driven-dissipative qudit-resonator system framework, extending existing theories.

Result: The study elucidates how effective parameters like capacitance and resistance are modified when quantum subsystem dynamics interact with resonator characteristics, using specific examples.

Conclusion: The findings offer a robust framework for analyzing a wide range of quantum systems in relation to classical resonators, potentially enhancing reflectionometry techniques.
...
### [85] [Quantum hardware noise learning via differentiable Kraus representation on tensor networks](https://arxiv.org/abs/2604.20804)
*Ryo Sakai,Yu Yamashiro*

Main category: quant-ph

TL;DR: This paper introduces a method to learn quantum hardware noise using measurement distributions and optimized noise channels for accurate simulation and prediction of device behaviors.


<details>
  <summary>Details</summary>
Motivation: The need for accurate modeling of quantum hardware noise to improve the reliability and performance of quantum circuits.

Method: The authors utilize automatically differentiable Kraus operators from a Stinespring-based parameterization, optimizing noise channels within a framework that ensures complete positivity and trace preservation, and evaluate circuits with a matrix product density operator model.

Result: On the IBM FEZ superconducting processor, the method successfully reproduces device output distributions for a ripple-carry adder and generalizes to an unrelated multiplier circuit without retraining, indicating robust learning of hardware characteristics.

Conclusion: The approach facilitates effective noise-aware predictions, validated through various benchmark tests, enhancing the feasibility of quantum algorithms in practical scenarios.
...
### [86] [High-Girth Regular Quantum LDPC Codes from Affine-Coset Structures](https://arxiv.org/abs/2604.20838)
*Koki Okada,Kenta Kasai*

Main category: quant-ph

TL;DR: This paper presents a new quantum low-density parity-check (LDPC) code family using a Calderbank-Shor-Steane base matrix, demonstrating effective decoding performance.


<details>
  <summary>Details</summary>
Motivation: To create efficient quantum LDPC codes that offer robust error correction for quantum computing applications.

Method: The code is constructed from a length-512 base matrix pair with specific regularity and girth properties, utilizing affine cosets and circulant permutation matrix lifts, culminating in a code with higher parameters.

Result: Decoding experiments indicate a frame error rate of approximately $10^{-8}$ at a depolarizing error probability of $0.085$, and a logical residual weight bounds the performance of the decoder to $d 	extleq 40$.

Conclusion: The proposed quantum LDPC code demonstrates promising low error rates and bounds for logical stability, indicating its potential for practical quantum error correction.
...
### [87] [Quasi-Periodic Microstructures in Pulsar Emission: Automated Detection and Archival Survey](https://arxiv.org/abs/2604.19883)
*Amarnath,Yogesh Maan*

Main category: astro-ph.HE

TL;DR: The study introduces QMIST, an automated tool for identifying quasi-periodic microstructures in pulsar data, successfully detects new microstructures in multiple pulsars, and confirms relationships between microstructure periodicity and pulsar rotation periods.


<details>
  <summary>Details</summary>
Motivation: Identifying quasi-period microstructures in pulsars is labor-intensive and time-consuming, necessitating an automated solution to enhance efficiency and accuracy.

Method: Development of the Quasi-periodic MIcrostructure Search Tool (QMIST) for automating the search in radio pulsar time-series data, validated on a multi-epoch survey of 27 pulsars using multiple telescope data.

Result: Revealed new detections of quasi-periodic microstructures in three pulsars and estimated periodicity in another known pulsar, confirming the relationship between microstructure periodicity and pulsar rotation periods.

Conclusion: The findings enhance understanding of pulsar emission mechanisms and suggest further exploration of microstructure characteristics.
...
### [88] [Radio detection of supernova remnant G310.7-5.4 with $γ$-ray counterpart: Abeona SNR](https://arxiv.org/abs/2604.19897)
...
TL;DR: This study investigates the radio properties of the supernova remnant (SNR) candidate G310.7-5.4, confirming it as a new SNR named Abeona, and detailing its faint radio emission and coinciding $	ext{γ}$-ray detection.


<details>
  <summary>Details</summary>
Motivation: To characterize the radio emission and properties of the previously unobserved SNR candidate G310.7-5.4, particularly given its high Galactic latitude and coinciding $	ext{γ}$-ray emission.

Method: Utilized radio continuum observations from the EMU and POSSUM surveys at 943.5 MHz and 16.5 years of Fermi-LAT data; also integrated previous multiwavelength observations, including infrared and X-ray surveys.

Result: Confirmed G310.7-5.4 as the new supernova remnant Abeona, detecting a faint, extended radio shell with a diameter of about 30' and a radio flux density of approximately $1.5^{+1.5}_{-0.1}$ Jy; identified linearly polarized emission consistent with synchrotron processes.

Conclusion: Brought G310.7-5.4 into the context of high-latitude SNRs and their $	ext{γ}$-ray emissions, contributing to the knowledge of faint SNRs in the Galaxy.
...
### [89] [Search for Anisotropic Pair Halos Associated with Blazar Jets](https://arxiv.org/abs/2604.19916)
*Ao Zhang,Wenlei Chen,Manel Errando*

Main category: astro-ph.HE

TL;DR: The study investigates intergalactic magnetic fields (IGMFs) using gamma-ray pair halos from blazars, applying a novel anisotropic analysis method that enhances sensitivity and finds significant evidence for a non-zero IGMF.


<details>
  <summary>Details</summary>
Motivation: Understanding the origin of intergalactic magnetic fields is crucial in cosmology, and gamma-ray pair halos from blazars provide a unique method to probe these fields.

Method: The study utilized a Monte Carlo framework to model the spatial distribution of cascade emissions from 21 high-synchrotron-peaked BL Lac objects, rotating and stacking Fermi-LAT observations along jet directions to enhance sensitivity to anisotropic emission.

Result: The analysis revealed evidence for a non-zero IGMF, with a best-fit field strength of $B_0 = 2.8 \times 10^{-16}\mathrm{G}$, excluding the null hypothesis at a $3.8σ$ level.

Conclusion: This approach significantly increases sensitivity to intergalactic magnetism and suggests potential for future observations to directly image pair halos and map magnetic fields.
...
### [90] [SN 2007it on the RISE -- a radio detection of an interacting supernova 18 years post-explosion](https://arxiv.org/abs/2604.20076)
...
TL;DR: First detection of radio emission from supernova SN 2007it, 18 years after explosion, indicating potential interaction with circumstellar material.


<details>
  <summary>Details</summary>
Motivation: To monitor late-time interactions of core-collapse supernovae with dense circumstellar material and understand their emission mechanisms.

Method: Radio observations conducted with the Australian Telescope Compact Array (ATCA) at multiple frequencies post-explosion.

Result: Successful detection of radio emission at 5.5 GHz and 9.0 GHz, with significant flux densities, while non-detection at lower frequencies raises questions about internal absorption.

Conclusion: Encourages further multi-wavelength follow-up to investigate emission mechanisms and interactions.
...
### [91] [Detections of nearly bias-free core shifts with 5-30 $μ$as precisions at 8-43 GHz in BL Lacertae](https://arxiv.org/abs/2604.20095)
*Niu Liu,Jun Yang,Xiaopeng Cheng,Ai-Ling Zeng,Wen Chen,Xiao-Long Yang,Xiaoyu Hong,Xia-Xuan Zhang,Jia-Cheng Liu,Zi Zhu*

Main category: astro-ph.HE

TL;DR: This study analyzes frequency-dependent core shifts in the radio jet of BL Lacertae using VLBI observations to constrain magnetic field properties.


<details>
  <summary>Details</summary>
Motivation: Understanding core shifts in radio jets aids in identifying their origin and magnetic field constraints.

Method: Very long baseline interferometric (VLBI) observations were conducted at multiple GHz frequencies, utilizing phase-referencing techniques for precision astrometry.

Result: Significant core shift measurements were achieved, with a maximum shift of 250 μas between 8.4 and 43.2 GHz, revealing a scaling relationship with frequency.

Conclusion: The derived core-shift index suggests the presence of an optically thick region, consistent with energy equipartition, while accommodating flaring state deviations.
...
### [92] [Fast-Cooling Synchrotron in Decaying Magnetic Fields: Implications for the GRB Spectral Distribution](https://arxiv.org/abs/2604.20142)
*Jia-Ming Chen,Ke-Rui Zhu,Zhao-Yang Peng,Yong-Gang Zheng,Yun-Lu Gong,Shan Chang,Shi-Ting Tian,Li Zhang*

Main category: astro-ph.HE

TL;DR: The study investigates a fast-cooling synchrotron model with a decaying magnetic field to explain the low-energy spectral index of gamma-ray bursts (GRBs), finding partial success in alleviating overly soft spectra but suggesting the need for additional processes.


<details>
  <summary>Details</summary>
Motivation: To understand the typical low-energy spectral index of GRBs (~-1) which challenges standard synchrotron radiation models.

Method: We employed a fast-cooling synchrotron model incorporating magnetic field decay, solving the electron continuity equation to derive time-dependent electron distributions and synthetic spectra, and tested against GBM catalog data.

Result: The magnetic-field decay can alter the recovered low-energy spectral index (α), primarily yielding values between -1.5 and -0.8, but does not consistently stabilize α near observations.

Conclusion: While the model partially addresses the soft spectra issue, it does not fully reproduce the observed α distribution, indicating the necessity of including additional physical mechanisms.
...
### [93] [XRF 241001A/SN 2024aiiq: A Faint Soft X-ray Transient Detected by SVOM with a Broad-Line Type Ic Supernova Revealed by JWST](https://arxiv.org/abs/2604.20346)
...
TL;DR: This paper investigates X-ray flash 241001A detected by the SVOM mission, focusing on its properties, origin, and implications for gamma-ray burst populations.


<details>
  <summary>Details</summary>
Motivation: To enhance understanding of soft X-ray transients like XRFs and their connection to gamma-ray bursts by utilizing new observational data from the SVOM mission.

Method: Photometric and spectroscopic analysis of XRF 241001A, comparing its properties with long GRBs and modeling its afterglow emissions from X-ray to radio wavelengths.

Result: XRF 241001A shows low-energy characteristics with prompt emission dominated below 20 keV, likening it to collapsar events with broad-line supernova signatures and a clear afterglow model pointing to a relativistic jet.

Conclusion: XRF 241001A supports the notion that some XRFs are part of the long GRB population's low-energy tail, showcasing SVOM/ECLAIRs' capabilities for soft high-energy transient studies.
...
### [94] [The January 2010 flare of Mrk421: Insights from a stochastic acceleration model](https://arxiv.org/abs/2604.20480)
...
TL;DR: Mrk421 showed unprecedented flux in Feb 2010, requiring refined SED modeling beyond standard models. Temporal analysis revealed stochastic acceleration processes and correlations with light curves.


<details>
  <summary>Details</summary>
Motivation: To enhance understanding of Mrk421's particle dynamics and emission properties during an unprecedented high flux state.

Method: Temporal evolution of spectra analyzed from January 2010; SEDs fit using JetSeT; explored LPPL distribution and stochastic acceleration models.

Result: Findings support the stochastic acceleration hypothesis, detecting Maxwellian components in the SED during specific nights, consistent with high-energy and X-ray data.

Conclusion: The study's SED models align with theoretical predictions on diffusion-based temporal evolution, emphasizing new dynamics in Mrk421's emission.
...
### [95] [Approximating General Relativity in Core-Collapse Supernova Simulations](https://arxiv.org/abs/2604.20579)
*Steven A. Fromm,Vassilios Mewes,O. E. Bronson Messer,Eric J. Lentz,W. Raphael Hix,J. Austin Harris*

Main category: astro-ph.HE

TL;DR: This paper introduces effective potentials to account for general relativity in Newtonian core-collapse supernova simulations and validates them against general relativistic simulations.


<details>
  <summary>Details</summary>
Motivation: To improve the accuracy of Newtonian simulations of core-collapse supernovae by incorporating general relativistic effects.

Method: Formulation of effective potentials derived from Eulerian and Lagrangian projections of the Einstein equations, implemented in Chimera and Flash-X codes for simulations.

Result: Close agreement is found between new effective potentials and fully general relativistic results across multiple codes, outperforming another effective potential formulation.

Conclusion: The new effective potentials provide a viable method for approximating general relativistic effects in Newtonian simulations, enhancing their predictive accuracy.
...
### [96] [Deep VLBI constraints on compact radio cores in four ultraluminous X-ray sources](https://arxiv.org/abs/2604.20609)
*Ailing Wang,Hua Feng,Tao An,Yijia Zhang,Jun Yang,Roberto Soria,Lian Tao,Thomas Russell,Jing Guo,Liang Zhang*

Main category: astro-ph.HE

TL;DR: This study presents high-sensitivity VLBI observations of four ULXs, revealing no detected compact emission and setting upper limits on their radio luminosity, suggesting weak and variable emissions.


<details>
  <summary>Details</summary>
Motivation: To investigate the radio properties and compact emission of ultraluminous X-ray sources via high-sensitivity VLBI observations.

Method: VLBI observations were conducted on four ULXs, with rms noise levels of 5--20 μJy and 5σ flux density upper limits of approximately 26 μJy, to assess compact emission.

Result: No compact emission was detected, implying radio luminosity limits of $L_{R} 	extless 2 × 10^{33}	ext{erg s^{-1}}$, and a noted variability in Holmberg II X-1.

Conclusion: The findings suggest that compact emissions may be weak or intermittent, potentially influenced by low-surface-brightness structure and absorption effects.
...
### [97] [A Search for Rotation Measure Flare Candidates in Repeating Fast Radio Bursts](https://arxiv.org/abs/2604.20814)
*Ye Li*

Main category: astro-ph.HE

TL;DR: This paper investigates rapid rotation measure (RM) variations, or RM flares, in repeating fast radio bursts (FRBs), identifying several candidates for further study.


<details>
  <summary>Details</summary>
Motivation: Understanding the nature of FRBs and their local magneto-ionic environments.

Method: Systematic search for RM flare candidates using multi-epoch RM measurements and a $3σ$ significance threshold.

Result: Identified RM flare candidates in FRB~20121102A, FRB~20201124A, and a single-epoch candidate in FRB~20180916B, along with the previously noted RM flare in FRB~20220529.

Conclusion: RM flares may not be rare among repeating FRBs, indicating dynamic magnetized environments; future observations are crucial for confirmation.
