...
TL;DR: This study demonstrates atomic-resolution imaging of molten metal/solid interfaces at temperatures above 200 °C using a novel high-speed AFM with a qPlus sensor, achieving significant advancements in imaging techniques.


<details>
  <summary>Details</summary>
Motivation: To enhance the understanding of molten metal/solid interfaces and their properties at elevated temperatures, which is crucial for various industrial applications.

Method: A high-temperature, high-speed AFM with a custom Quadpod scanner and Hybrid-loop frequency demodulation technique was developed to improve imaging resolution and thermal drift tolerance.

Result: Atomic-resolution topographic images of the molten Ga/PtGa_x interface at approximately 210 °C were obtained, revealing a new low-symmetry surface structure compared to room temperature observations.

Conclusion: The developed techniques enable unprecedented visualization of non-aqueous liquid/solid interfaces at high temperatures, offering insights and potential applications in areas like injection modeling and soldering.
...
TL;DR: This paper presents a novel flexible optoelectronic fibre for real-time gamma radiation detection, overcoming limitations of traditional dosimeters in flexibility and spatial resolution.


<details>
  <summary>Details</summary>
Motivation: With the rising global interest in nuclear power, there is an increasing need for adaptable and discreet nuclear detection technologies.

Method: The authors developed flexible, radiation-sensitive optical fibres integrating silicon photomultipliers within scintillator waveguides to enhance real-time gamma dosimetry performance.

Result: These fibres demonstrated sensitivity to localized radiation sources and extended detection capabilities over 30 cm, with low detection limits rivaling background radiation.

Conclusion: The innovative design and materials employed position these fibres to facilitate large-area, high-resolution gamma radiation mapping, ideal for various applications.
...
TL;DR: CHRONOS is a proposed low-frequency gravitational-wave detector aimed at overcoming significant noise challenges to achieve high sensitivity in the sub-Hz frequency range, with applications in both astronomy and earthquake early warning.


<details>
  <summary>Details</summary>
Motivation: The motivation for CHRONOS is to explore the largely unexplored sub-Hz frequency range for gravitational waves, which is limited by strong noise in current ground-based detectors.

Method: CHRONOS utilizes cryogenic operation, a cross torsion-bar configuration, a triangular Sagnac interferometer, and a speed meter readout scheme to enhance strain sensitivity and manage noise contributions.

Result: Analytical and interferometric simulations show that CHRONOS can achieve a strain sensitivity of $h \sim 10^{-18} Hz^{-1/2}$ at around 2 Hz, and a stochastic gravitational wave background of $Ω_{GW} \approx 2 \times 10^{-3}$, demonstrating competitive sensitivity at low frequencies.

Conclusion: The findings suggest that CHRONOS can significantly contribute to gravitational-wave astronomy and geophysical monitoring, with potential use in earthquake early-warning systems, thereby encouraging further development of low-frequency detection technologies.
...
TL;DR: A new parametric simulation tool for pixel sensors offers an efficient alternative to traditional simulations by relying on measurement data rather than process details, demonstrated with the MALTA2 sensor.


<details>
  <summary>Details</summary>
Motivation: The need for a quicker, efficient simulation method that bypasses the reliance on proprietary manufacturing data for pixel sensors.

Method: A parametric simulation tool was developed to realistically model pixel sensor responses using measurement input, validated against the MALTA2 sensor.

Result: The simulation tool was able to effectively simulate the MALTA2 sensor response and optimize peripheral modifications for improved tracking and calorimetry in high hit rate environments.

Conclusion: This work provides a rapid, adaptable simulation framework that enhances pixel sensor design and optimization, particularly beneficial for future iterations like the MALTA3 sensor in advanced processes.
...
### [5] [Geomagnetic storm suppression of photographic plate transient detections in the POSS-I archive: an independent physical variable strengthening the nuclear test correlation](https://arxiv.org/abs/2604.04950)
*Kevin Cann*

Main category: astro-ph.IM

TL;DR: A study found a significant correlation between nuclear weapon tests and transient detection rates at Palomar Observatory, modulated by geomagnetic storm activity, strengthening the association with advanced statistical methods.


<details>
  <summary>Details</summary>
Motivation: To investigate the relationship between atmospheric nuclear tests and transient detection rates, while considering geomagnetic influences.

Method: Analyzed transient detection rates from the POSS-I archive, applying negative binomial regression and multivariate logistic regression with weather and lunar-phase controls.

Result: Identified a dose-response relationship between geomagnetic storm activity and transient rates, with correlation strengthening from 2.6 sigma to 3.1 sigma after adjustments.

Conclusion: The findings suggest that detected transients are linked to the radiation belt environment, ruling out alternative explanations like emulsion defects.
...
### [6] [The Cluster Completeness Correction Calculator (C-4): A Neural-Network framework and pilot application to the LEGUS Survey of NGC 628](https://arxiv.org/abs/2604.05291)
*Jianling Tang,Kathryn Grasha,Tomasz Różański,Mark R. Krumholz,Alan Zhang*

Main category: astro-ph.IM

TL;DR: The paper introduces C-4, a software tool for correcting selection biases in star cluster catalogues, enhancing the analysis of cluster demographics with improved accuracy.


<details>
  <summary>Details</summary>
Motivation: To address biases in integrated-light star cluster catalogues caused by complex selection effects that limit demographic analyses of clusters in external galaxies.

Method: C-4 uses artificial star clusters added to galaxy images, processes them through detection routines, and employs multilayer perceptron neural networks to learn and model the selection function for completeness corrections.

Result: The pilot application to NGC 628 shows that C-4 accurately captures the dependence of completeness on mass, age, and extinction, extending the range of analyses significantly and removing artificial biases in observed distributions.

Conclusion: The study establishes neural-network completeness modelling as effective for recovering intrinsic star cluster populations, providing a scalable framework for high-dimensional studies in stellar populations.
...
### [7] [Instrumental development for Cryogenic sub-Hz cROss torsion bar detector with quantum NOn-demolition Speed meter (CHRONOS)](https://arxiv.org/abs/2604.05801)
*Daiki Tanabe,Hsiang-Yu Huang,Yuki Inoue,Mario Juvenal S. Onglao,Ta-Chun Yu*

Main category: astro-ph.IM

TL;DR: The paper discusses the CHRONOS detector aimed at detecting gravitational waves from intermediate-mass black-hole binaries, highlighting its design and commissioning status.


<details>
  <summary>Details</summary>
Motivation: To investigate strong-field gravity and black-hole evolution through the detection of intermediate-mass black holes, which present significant challenges due to low-frequency noise.

Method: The CHRONOS detector employs a cryogenic sub-Hz cROss torsion bar design with a quantum NOn-demolition Speed meter, targeting a strain sensitivity of $10^{-18} {m Hz}^{-1/2}$ at 2 Hz.

Result: CHRONOS aims to detect GWs from IMBH mergers around $10^4$ M$_{	ext{odot}}$ and explore a stochastic gravitational background of $Ω_{m GW} 	ext{ 	extasciitilde } 2	imes 10^{-3}$ at 2 Hz, integrating techniques like torsion bars, speed meters, and cryogenic mirrors.

Conclusion: The design and early operational status of CHRONOS reveal significant potential for enhancing low-frequency gravitational wave detection capabilities.
...
### [8] [Deep Spectroscopy with DESI for Photometric Redshift Training and Calibration](https://arxiv.org/abs/2604.06143)
...
TL;DR: The paper discusses the use of deep spectroscopic samples to enhance photometric redshift estimates, specifically utilizing the capabilities of the DESI on the 4m Mayall telescope. Results highlight DESI's efficiency in measuring faint galaxy redshifts, offering significant improvements for LSST data analysis.


<details>
  <summary>Details</summary>
Motivation: To improve photo-$z$ estimates and reduce uncertainties in redshift distributions for cosmological studies, particularly for upcoming LSST data.

Method: The DESI-Deep pilot program assessed the Dark Energy Spectroscopic Instrument's effectiveness in measuring redshifts of faint galaxies (m_i ≤ 24.5) using the 4m Mayall telescope.

Result: DESI achieved high redshift success rates comparable to 10m-class telescopes, with better efficiency than expected, as well as significant multiplexing advantages.

Conclusion: The findings support the potential of DESI to yield valuable redshift samples for LSST, suggesting a feasible and impactful approach for future cosmological analyses.
...
### [9] [Measurement of charged-particle production in $\sqrt{s_\text{NN}}=9.62$ TeV proton-oxygen collisions as a probe of cosmic-ray air showers with the ATLAS detector](https://arxiv.org/abs/2604.05512)
*ATLAS Collaboration*

Main category: hep-ex

TL;DR: The paper reports precise measurements of charged-particle production in proton-oxygen interactions at high energy, providing data crucial for understanding cosmic-ray air showers.


<details>
  <summary>Details</summary>
Motivation: To improve the modeling of cosmic-ray air showers in astroparticle physics through precise experimental data from proton-oxygen interactions.

Method: Measurements were conducted using the ATLAS detector at a center-of-mass energy of 9.62 TeV, with a total of 246 million selected events analyzed.

Result: The observed fiducial proton-oxygen cross section is 396±6 (exp.)±9 (lumi.) mb, and the extrapolated inelastic proton-air cross section is 406±6 (exp.)±9 (lumi.)±28 (th.) mb, indicating enhanced precision in charged-particle multiplicity and distributions.

Conclusion: The resulting measurements significantly refine the understanding of hadronic interactions, offering valuable insights for cosmic-ray research.
...
### [10] [Measurement of the CKM angle $γ$ in $B^{\pm} \rightarrow D(\rightarrow K^{0}_{\rm S} h^{\prime+}h^{\prime-})h^{\pm}$ decays with a novel approach](https://arxiv.org/abs/2604.05701)
...
TL;DR: This paper presents a precise measurement of the CKM angle $γ$ using a model-independent approach in specific $B$ decays, analyzed from complementary datasets collected by BESIII and LHCb.


<details>
  <summary>Details</summary>
Motivation: To measure the CKM angle $γ$ with high precision and explore related strong-phase parameters, enhancing understanding of $C	ext{P}$ violation in particle decays.

Method: A model-independent approach was employed for analysis, utilizing a joint dataset from BESIII and LHCb to increase sensitivity, with per-event weights applied based on amplitude variation.

Result: The measurement of the CKM angle $γ$ was determined to be $γ= (71.3lex{±}5.0)^{	ext{°}}$, the most precise single measurement to date.

Conclusion: This measurement significantly advances the precision of CKM angle $γ$ determination, contributing important insights into the dynamics of $C	ext{P}$ violation.
...
### [11] [Precise measurement of the CKM angle $γ$ with a novel approach](https://arxiv.org/abs/2604.05712)
*The BESIII,LHCb Collaborations,:,M. Ablikim,M. N. Achasov,P. Adlarson,X. C. Ai,C. S. Akondi,R. Aliberti,A. Amoroso,Q. An,Y. H. An,Y. Bai,O. Bakina,H. R. Bao,X. L. Bao,M. Barbagiovanni,V. Batozskaya,K. Begzsuren,N. Berger,M. Berlowski,M. B. Bertani,D. Bettoni,F. Bianchi,E. Bianco,A. Bortone,I. Boyko,R. A. Briere,A. Brueggemann,D. Cabiati,H. Cai,M. H. Cai,X. Cai,A. Calcaterra,G. F. Cao,N. Cao,S. A. Cetin,X. Y. Chai,J. F. Chang,T. T. Chang,G. R. Che,Y. Z. Che,C. H. Chen,Chao Chen,G. Chen,H. S. Chen,H. Y. Ch
J. Yao,Z. P. Yao,M. Ye,M. H. Ye,Z. J. Ye,K. Yi,Junhao Yin,Z. Y. You,B. X. Yu,C. X. Yu,G. Yu,J. S. Yu,L. W. Yu,T. Yu,X. D. Yu,Y. C. Yu,Yongchao Yu,C. Z. Yuan,H. Yuan,J. Yuan,Jie Yuan,L. Yuan,M. K. Yuan,S. H. Yuan,Y. Yuan,C. X. Yue,Ying Yue,A. A. Zafar,F. R. Zeng,S. H. Zeng,X. Zeng,Y. J. Zeng,Yujie Zeng,Y. C. Zhai,Y. H. Zhan,B. L. Zhang,B. X. Zhang,D. H. Zhang,G. Y. Zhang,Gengyuan Zhang,H. Zhang,H. C. Zhang,H. H. Zhang,H. Q. Zhang,H. R. Zhang,H. Y. Zhang,Han Zhang,J. Zhang,J. J. Zhang,J. L. Zhang,J. Q. Zhang,J. S. Zhang,J. W. Zhang,J. X. Zhang,J. Y. Zhang,J. Z. Zhang,Jianyu Zhang,Jin Zhang,Jiyuan Zhang,L. M. Zhang,Lei Zhang,N. Zhang,P. Zhang,Q. Zhang,Q. Y. Zhang,Q. Z. Zhang,R. Y. Zhang,S. H. Zhang,S. N. Zhang,Shulei Zhang,X. M. Zhang,X. Y. Zhang,Y. T. Zhang,Y. H. Zhang,Y. P. Zhang,Yao Zhang,Yu Zhang,Yu Zhang,Z. Zhang,Z. D. Zhang,Z. H. Zhang,Z. L. Zhang,Z. X. Zhang,Z. Y. Zhang,Zh. Zh. Zhang,Zhilong Zhang,Ziyang Zhang,Ziyu Zhang,G. Zhao,J. -P. Zhao,J. Y. Zhao,J. Z. Zhao,L. Zhao,Lei Zhao,M. G. Zhao,R. P. Zhao,S. J. Zhao,Y. B. Zhao,Y. L. Zhao,Y. P. Zhao,Y. X. Zhao,Z. G. Zhao,A. Zhemchugov,B. Zheng,B. M. Zheng,J. P. Zheng,W. J. Zheng,W. Q. Zheng,X. R. Zheng,Y. H. Zheng,B. Zhong,C. Zhong,X. Zhong,H. Zhou,J. Q. Zhou,S. Zhou,X. Zhou,X. K. Zhou,X. R. Zhou,X. Y. Zhou,Y. X. Zhou,Y. Z. Zhou,A. N. Zhu,J. Zhu,K. Zhu,K. J. Zhu,K. S. Zhu,L. X. Zhu,Lin Zhu,S. H. Zhu,T. J. Zhu,W. D. Zhu,W. J. Zhu,W. Z. Zhu,Y. C. Zhu,Z. A. Zhu,X. Y. Zhuang,M. Zhuge,J. H. Zou,J. Zu,R. Aaij,A. S. W. Abdelmotteleb,C. Abellan Beteta,F. Abudinén,T. Ackernley,A. A. Adefisoye,B. Adeva,M. Adinolfi,P. Adlarson,C. Agapopoulou,C. A. Aidala,Z. Ajaltouni,S. Akar,K. Akiba,P. Albicocco,J. Albrecht,R. Aleksiejunas,F. Alessio,P. Alvarez Cartelle,R. Amalric,S. Amato,J. L. Amey,Y. Amhis,L. An,L. Anderlini,M. Andersson,P. Andreola,M. Andreotti,S. Andres Estrada,A. Anelli,D. Ao,C. Arata,F. Archilli,Z. Areg,M. Argenton,S. Arguedas Cuendis,L. Arnone,A.
Main category: hep-ex

TL;DR: The paper presents a precise measurement of the CKM angle $γ$ using a novel model-independent method applied to data from BESIII and LHCb experiments, yielding $γ = (71.3  bpm 5.0)^{ b0}$, the most accurate measurement to date.


<details>
  <summary>Details</summary>
Motivation: To obtain a precise measurement of the CKM angle $γ$, which is crucial for understanding $C	ext{P}$ violation in the Standard Model.

Method: A novel, unbinned, model-independent approach is used on datasets from electron-positron and proton-proton collisions, analyzing specific decay processes to extract $γ$ and associated strong-phase parameters.

Result: The joint fit from both experiments yields ${γ = (71.3  bpm 5.0)^{ b0}}$, the most accurate measurement of the CKM angle to date.

Conclusion: The result is consistent with prior measurements and contributes significantly to the understanding of $C	ext{P}$ violation in particle physics.
...
### [12] [Reactor Antineutrino Oscillations and Geoneutrinos in SNO+](https://arxiv.org/abs/2604.05746)
*William Parker*

Main category: hep-ex

TL;DR: SNO+ measured neutrino oscillation parameters and geoneutrino flux using data from a multipurpose detector at SNOLAB.


<details>
  <summary>Details</summary>
Motivation: To accurately measure the neutrino oscillation parameter $Δm^2_{21}$ and assess geoneutrino flux, leveraging the unique underground location and reactor infrastructure.

Method: A spectral analysis was conducted, simultaneously fitting $Δm^2_{21}$, $θ_{12}$, reactor antineutrino fluxes, background rates, and associated uncertainties using data from May 2022 to July 2025.

Result: The analysis yielded $Δm^2_{21} = (7.93^{+0.21}_{-0.24}) 	imes 10^{-5}$ eV$^2$, consistent with results from KamLAND and JUNO, and the first measurement of geoneutrino flux was recorded at $49^{+13}_{-12}$ TNU.

Conclusion: The findings contribute to the understanding of neutrino physics and validate geological model predictions regarding geoneutrino flux.
...
### [13] [Search for soft unclustered energy patterns produced in association with a W or Z boson in proton-proton collisions at $\sqrt{s}$ = 13 TeV](https://arxiv.org/abs/2604.05996)
*CMS Collaboration*

Main category: hep-ex

TL;DR: The paper presents a search for Higgs boson production with W/Z bosons and its decay into a soft unclustered energy pattern using LHC data, finding no significant excess and setting parameter limits on production cross section.


<details>
  <summary>Details</summary>
Motivation: To explore Higgs boson interactions and decay patterns, particularly focusing on those associated with W/Z bosons and characterized by soft unclustered energy patterns, enhancing understanding of particle physics.

Method: The analysis utilizes proton-proton collision data from LHC (138 fb$^{-1}$), investigating final states with leptonic W/Z boson decays and high multiplicity of low-momentum charged particles.

Result: No significant excess over the standard model background was observed; limits on the production cross section of a Higgs boson decaying into a SUEP were established across various model parameters.

Conclusion: The findings contribute to the search for new physics beyond the standard model, providing limits that may inform future research directions.
...
### [14] [Probing the Solar $^8$B Neutrino Fog with XENONnT](https://arxiv.org/abs/2604.06002)
...
TL;DR: The XENONnT experiment measures coherent elastic neutrino-nucleus scattering from solar $^8$B neutrinos, revealing a flux consistent with earlier results, without evidence for light dark matter and demonstrating diminishing sensitivity returns with increased exposure.


<details>
  <summary>Details</summary>
Motivation: To measure neutrino interactions and explore the potential existence of light dark matter, while improving sensitivity to weakly interacting particles and testing beyond Standard Model physics.

Method: Analyzed data from a 6.77 t$	imes$yr exposure in the XENONnT experiment to measure neutrino-nucleus scattering and other interactions.

Result: Achieved a 3.3 $σ$ measurement of the solar $^8$B neutrino flux and a 93% increase in exposure improved sensitivity to 5 GeV/$c^2$ WIMPs by 10% without detecting light dark matter.

Conclusion: Findings support previous measurements of neutrino flux, indicate diminishing returns in sensitivity for increasing exposure, and refine measurements relevant to beyond the Standard Model physics.
...
### [15] [Unquenched Radially Excited $P$-wave Charmonia](https://arxiv.org/abs/2604.04991)
*George Rupp*

Main category: hep-ph

TL;DR: The study investigates the mass discrepancies in certain charmonium states, presenting preliminary results for their first radial excitations using the Resonance-Spectrum Expansion and a specific decay channel calculation method.


<details>
  <summary>Details</summary>
Motivation: To address the inconsistencies between static quark model predictions and observed mass patterns in $P$-wave charmonia around 3.85-3.95 GeV, particularly regarding radial excitations and scalar states.

Method: Preliminary results obtained using the Resonance-Spectrum Expansion that includes all OZI-allowed decay channels, alongside a generalized scheme for computing decay coupling constants based on the ${}^{3eP_0}$ model.

Result: Findings indicate a different mass pattern for the radial excitations of $P$-wave charmonia in contrast to predictions from static models, highlighting the role of decay channels.

Conclusion: The inclusion of dynamic decay processes alters the expected mass spectra, necessitating further investigation into charm-meson interactions.
...
### [16] [Electroweak Doublet Dark Matter for a Galactic Halo Gamma-Ray Excess](https://arxiv.org/abs/2604.05016)
*Yasunori Nomura,Tomonori Totani*

Main category: hep-ph

TL;DR: The paper presents a reexamination of minimal dark matter models that could explain recent indirect detection signals, suggesting electroweak doublet dark matter with Higgs-portal interactions as a viable candidate that fits well with existing constraints.


<details>
  <summary>Details</summary>
Motivation: Recent claims of an indirect-detection signal from dark matter annihilation in the mass range 400-800 GeV motivate the exploration of models that explain this while complying with existing constraints.

Method: The authors analyze extensions of the Standard Model, focusing on the electroweak doublet dark matter with Higgs-portal interactions and explore its implications for annihilation into gauge bosons and inelastic dark matter.

Result: The proposed model offers explanations consistent with the observed signal, predicting specific branching fractions and accommodating a mass splitting in inelastic dark matter that aligns with observed anomalies.

Conclusion: The paper concludes with insights on possible enhancements to the current annihilation rate, noting a potential simple model involving a light scalar field that could suppress enhancements in dwarf galaxies.
...
### [17] [Signals of Doomsday III: Cosmological signatures of the late time $U(1)_{EM}$ symmetry breaking](https://arxiv.org/abs/2604.05023)
*Amartya Sengupta,Dejan Stojkovic*

Main category: hep-ph

TL;DR: This paper investigates the potential astrophysical signatures of a late-time breaking of electromagnetism ($U(1)_{m EM}$), proposing a model involving a new massive scalar field and first-order phase transition that produces detectable high-energy photons and neutrinos.


<details>
  <summary>Details</summary>
Motivation: To explore the implications of a potential late-time breaking of $U(1)_{m EM}$, which could have observable astrophysical effects.

Method: A model is presented with a new massive scalar field causing a first-order phase transition through true-vacuum bubbles. The dynamics of these bubbles and their interaction with surrounding matter lead to the production of a spectrum of particles, including photons and neutrinos, which are then simulated and analyzed.

Result: The study calculates a particle spectrum resulting from the bubble's dynamics, revealing a substantial production of high-energy photons and neutrinos, which can serve as observable signatures of the transition.

Conclusion: Even a subluminal bubble wall velocity allows for significant lead time for the detection of photon and neutrino signals, suggesting that nearby bubble events could be monitored with current and future detection technologies.
...
### [18] [Learning to Unscramble Feynman Loop Integrals with SAILIR](https://arxiv.org/abs/2604.05034)
*David Shih*

Main category: hep-ph

TL;DR: SAILIR, a self-supervised AI approach, improves Feynman integral reduction by using a transformer-based classifier to manage memory usage and reduce complexity.


<details>
  <summary>Details</summary>
Motivation: Traditional IBP reduction methods struggle with memory consumption and computational intensity as integrals become complex.

Method: SAILIR employs a transformer-based classifier trained in a self-supervised manner on synthetically generated data, facilitating online integral reduction combined with beam search and parallel processing.

Result: SAILIR maintains lower memory consumption (40% less than Kira) while achieving comparable reduction times, especially for complex integrals, despite being slower in overall wall-clock time.

Conclusion: SAILIR presents a novel method for IBP reduction that may alleviate existing memory bottlenecks, enabling previously infeasible precision calculations in high-energy physics.
...
### [19] [The chromomagnetic moment of a heavy quark with hyperasymptotic precision](https://arxiv.org/abs/2604.05044)
*Cesar Ayala,Antonio Pineda*

Main category: hep-ph

TL;DR: The study calculates chromomagnetic moment renormalization for heavy quarks, deriving hyperfine splitting for B and D mesons with high precision.


<details>
  <summary>Details</summary>
Motivation: To better understand the chromomagnetic moment and its effects on meson spectroscopy, especially for B and D mesons.

Method: The authors determine the infrared renormalon normalization and compute hyperfine splitting using operator product expansion and fitting to experimental data.

Result: The study provides estimates for higher order coefficients and precise computation of hyperfine splitting, yielding a value of $	ext{hat μ}^2_{G,m PV}=0.507(7)$ GeV$^2$ for the ground state.

Conclusion: The findings enhance the theoretical understanding of heavy quark interactions and improve predictions for meson properties.
...
### [20] [Bridging the divide: axion searches and axino phenomenology at colliders](https://arxiv.org/abs/2511.07224)
*Gabe Hoshino,Kristin Dona,Keisuke Harigaya,David W. Miller,Jan T. Offermann,Bianca Pol,Benjamin Rosser*

Main category: hep-ph

TL;DR: The paper presents a model that incorporates axions and their partner axinos into the minimal supersymmetric standard model, analyzing their interactions and potential detection at colliders.


<details>
  <summary>Details</summary>
Motivation: To explore the phenomenology of axions and axinos within the framework of the supersymmetric DFSZ model and investigate their experimental signatures.

Method: A sensitivity analysis is conducted using Monte Carlo simulations with $	exttt{MadGraph}$ and $	exttt{MadAnalysis5}$ to evaluate possible collider signatures of axinos, focusing on decays of next-to-lightest supersymmetric particles into axinos.

Result: The analysis shows that for a higgsino mass under 1 TeV and axion decay constant $f_a < 10^{11}$ GeV, significant probeability exists by the LHC with an integrated luminosity of 140 fb$^{-1}$.

Conclusion: The study indicates that existing collider experiments can effectively investigate supersymmetric DFSZ axion models, complementing other detection methods and broadening the understanding of supersymmetric axion scenarios.
...
### [21] [Gravitational Waves from Matter Perturbations of Spectator Scalar Fields](https://arxiv.org/abs/2604.05078)
*Marcos A. G. Garcia,Angel Garcia-Vega,Sarunas Verner*

Main category: hep-ph

TL;DR: This paper studies the stochastic gravitational wave background from a spectator scalar field coupled to the inflaton, focusing on resonance effects during reheating and providing a master formula for wave spectra dependent on reheating temperature.


<details>
  <summary>Details</summary>
Motivation: To understand the gravitational wave signals from spectator fields in inflationary models, particularly focusing on their interaction effects during reheating.

Method: The authors compute the gravitational wave background using second-order Einstein equations, focusing on a field-gradient source from a spectator scalar field, and derive analytical scaling relations depending on reheating history.

Result: They find a peak gravitational wave amplitude with specific scaling laws related to reheating temperature and portal strength, validating their findings through comparisons with nonlinear lattice simulations.

Conclusion: The analysis shows complex dependencies of the gravitational wave signal on interaction parameters, demonstrating significant effects due to echoes of inflation and reheating dynamics.
...
### [22] [Probing Gluon TMD Models with Drell--Yan Structure Functions](https://arxiv.org/abs/2604.05154)
*Jan Ferdyan*

Main category: hep-ph

TL;DR: This paper computes structure functions for the Drell-Yan process in proton-proton collisions at 8 TeV, using various gluon TMD models and comparing them with ATLAS data.


<details>
  <summary>Details</summary>
Motivation: To analyze structure functions in the Drell-Yan process and assess the performance of different transverse momentum dependent (TMD) models in describing experimental data.

Method: Utilized high-energy factorization formalism and hard scattering matrix elements in two channels, evaluating four types of gluon TMD models (Gaussian, WW, KMR, JH) with phenomenological adjustments.

Result: The study reveals significant differences in structure function predictions across TMD models, with the modified WW model providing the best fit to the ATLAS 2016 data based on the χ^2 analysis.

Conclusion: The findings highlight key features of TMD models for future fits and emphasize the necessity of model refinement for accurate representation of experimental outcomes.
...
### [23] [$b \to c$ semileptonic sum rule: SU(3)$_{\rm{F}}$ symmetry violation](https://arxiv.org/abs/2604.05186)
*Syuhei Iguro*

Main category: hep-ph

TL;DR: This paper extends the $b	o c$ semileptonic sum rule to include additional decay processes, providing a framework for cross-checks against experimental results, while quantifying symmetry violations and ensuring that they remain below experimental uncertainties.


<details>
  <summary>Details</summary>
Motivation: To investigate deviations in $b	o cτarν$ processes and provide consistency checks among experimental findings using semileptonic sum rules.

Method: The authors extend the existing semileptonic sum rule to include new decay channels, leveraging heavy quark symmetry and SU(3) flavor symmetry, assessing the sizes of symmetry violations through numerical evaluations.

Result: Numerical evaluations show that the violations of the symmetries are smaller than the expected uncertainties in future experiments, supporting the validity of the extended sum rule.

Conclusion: The findings lead to the formulation of new, predictive sum rules that are agnostic to new physics, enhancing the consistency checks among experimental results.
...
### [24] [Reply to "Comment on `Unified neutrino mixing and approximate $μ-τ$ reflection symmetry'[arXiv:2603.00885]''](https://arxiv.org/abs/2604.05270)
*Yuta Hyodo,Teruyuki Kitabayashi*

Main category: hep-ph

TL;DR: Huang and Li critique the authors for overlooking important real-value conditions in their previous work, while also suggesting that Inverted Ordering (IO) of neutrino masses is still viable. The authors clarify that they excluded IO based on neutrino mass sum constraints, arguing it remains in tension with experimental bounds.


<details>
  <summary>Details</summary>
Motivation: To address and clarify points raised by Huang and Li about the authors' previous study on neutrino mass ordering and symmetries.

Method: The authors assessed the implications of real-value conditions and neutrino mass constraints from their previous research.

Result: They acknowledge a valid critique regarding overlooked real-value conditions while disputing the viability of Invited Ordering based on mass sum constraints.

Conclusion: While some data may support IO, it conflicts with the sum of neutrino mass limitations, maintaining tensions with experimental findings.
...
### [25] [Thermodynamic and Transport Properties of Quark-Gluon Plasma at Finite Chemical Potential with a DNN framework](https://arxiv.org/abs/2604.05858)
*Rishabh Kumar Tiwari,Kangkan Goswami,Suraj Prasad,Captain R. Singh,Raghunath Sahoo,Mohammad Yousuf Jamal*

Main category: hep-ph

TL;DR: This paper explores the properties of quark-gluon plasma at finite baryon chemical potential using a deep-learning quasi-particle model, achieving results consistent with existing lattice QCD studies.


<details>
  <summary>Details</summary>
Motivation: To better understand the thermodynamic and transport properties of quark-gluon plasma under varying baryon chemical potentials, a novel approach using deep learning is introduced.

Method: The study employs a deep-learning-assisted quasi-particle model (DLQPM) to estimate temperature and baryon chemical potential-dependent thermal masses. Neural networks are trained on lattice QCD results to predict the equation of state and emulates the QGP behavior.

Result: The computations yield notable properties such as the speed of sound, specific heat, viscosity, and conductivity, which align well with existing lattice calculations and phenomenological models.

Conclusion: This research confirms that a deep-learning-based approach can efficiently model the properties of quark-gluon plasma at finite baryon density, paving the way for future studies in this complex field.
...
### [26] [Gamma-Ray Signatures of Thermal Misalignment Dark Matter](https://arxiv.org/abs/2604.05326)
*Koichi Hamaguchi,Ryoichiro Hayakawa,Hiroki Takahashi*

Main category: hep-ph

TL;DR: The paper investigates thermal misalignment of dark matter scalars and their observable signatures, focusing on their interaction with photons and implications for gamma-ray observations.


<details>
  <summary>Details</summary>
Motivation: To explore the implications of thermal misalignment in dark matter scenarios and identify observable signatures of metastable dark matter scalars coupled to photons.

Method: The authors analyze a scalar field interacting with the electromagnetic field, denoted as $φF^{μν} F_{μν}$, and evaluate existing gamma-ray constraints on the scalar mass.

Result: The study concludes that current gamma-ray observations impose a strong upper limit on the scalar mass around $	ext{O}(1)	ext{GeV}$, while future observations may extend this analysis into the MeV–GeV range.

Conclusion: The findings suggest a significant potential for future gamma-ray observatories to further constrain dark matter scenarios through enhanced observations.
...
### [27] [Rare B meson decays in the Minimal R-symmetric Supersymmetric Standard Model](https://arxiv.org/abs/2604.05357)
*Ke-Sheng Sun,Kui-Wen Guan,Hao-Yi Liu,Jin-Lei Yang,Tie-Jun Gao*

Main category: hep-ph

TL;DR: The study examines lepton flavor violating decays of B mesons in minimal R-symmetric supersymmetric model, focusing on the influence of model parameters and constraints from experimental data.


<details>
  <summary>Details</summary>
Motivation: To understand lepton flavor violating decays within the framework of a specific supersymmetric model and predict rates for future experiments.

Method: Analysis of B meson decay branching ratios considering constraints from slepton and squark mass matrices and experimental data.

Result: The branching ratio for the decay $B^0_d\rightarrow μτ$ is predicted to be significantly below future experimental sensitivity, yet it remains a candidate for future observation.

Conclusion: While the decay is unlikely to be detected in the near term, future advancements may increase chances of observation.
...
### [28] [Towards Testable Type-III Leptogenesis in Non-Standard Early Universe Scenarios](https://arxiv.org/abs/2604.05362)
*Simran Arora,Devabrat Mahanta*

Main category: hep-ph

TL;DR: This paper explores leptogenesis via triplet fermion decay in non-standard cosmological scenarios, showing viable baryon asymmetry generation at lower masses than previously required.


<details>
  <summary>Details</summary>
Motivation: The study aims to investigate leptogenesis as a viable explanation for baryon asymmetry through triplet fermions, seeking signatures detectable in experiments and addressing previous constraints on neutrino sector masses.

Method: The authors analyze leptogenesis in two non-standard cosmological models: one with faster-than-radiation universe expansion and another based on scalar-tensor gravity theories.

Result: Successful leptogenesis can occur with triplet fermion masses in the few TeV range for a rapidly expanding universe and several hundred TeV for scalar-tensor gravity, challenging previous heavy mass requirements.

Conclusion: This research opens paths for detecting triplet fermion decay signatures and suggests that baryon asymmetry can be achieved under broader conditions than previously thought.
...
### [29] [Gauge coupling unification and doublet-triplet splitting via GUT dynamical breaking](https://arxiv.org/abs/2604.05509)
*Isabella Masina,Mariano Quiros*

Main category: hep-ph

TL;DR: This paper explores gauge coupling unification within a modified Standard Model framework, particularly focusing on $d 
eq 5$ operators and specific representations that facilitate this process.


<details>
  <summary>Details</summary>
Motivation: To achieve gauge coupling unification in the Standard Model context by introducing non-renormalizable operators and examining their implications.

Method: The paper reviews the relevant phenomenology, particularly in relation to the $SU(5)$ model, highlighting representations that support unification and relating these to dynamical breaking and proton decay.

Result: It identifies that fermion condensates in the $5$ representation fail due to proton decay restrictions, while those in the $10$ and $24$ representations yield viable models for gauge coupling unification.

Conclusion: Successful gauge coupling unification models are achievable using fermionic condensates from the $10$ and $24$ representations, avoiding proton decay issues.
...
### [30] [Cosmological collider signals of modular spontaneous CP breaking](https://arxiv.org/abs/2604.05548)
*Shuntaro Aoki,Alessandro Strumia*

Main category: hep-ph

TL;DR: The paper discusses a modular-invariant extension of the Standard Model where the modulus acts as the inflaton, influencing CP-violating phases and leading to enhanced Higgs condensates with implications for next-generation experiments.


<details>
  <summary>Details</summary>
Motivation: To explore extensions of the Standard Model that incorporate modular invariance and investigate the effects during inflation.

Method: The authors analyze the dynamics of CP-violating phases in Yukawa couplings during inflation, focusing on their effects on Higgs condensates and one-loop cosmological collider signals with chemical potentials.

Result: The study provides specific expressions for Dirac fermions influenced by chemical potentials in de Sitter space, suggesting next-generation experiments can detect sub-Planckian modulus decay constants.

Conclusion: This modular-invariant approach to the Standard Model reveals novel dynamics during inflation that can be tested in upcoming experimental setups.
...
### [31] [Deuteron normalization and channel-dependent formation dynamics in pion and kaon color transparency](https://arxiv.org/abs/2604.05612)
*Byung-Geel Yu,Kook-Jin Kong,Tae Keun Choi*

Main category: hep-ph

TL;DR: The study analyzes nuclear transparency in pion and kaon electroproduction, showing differing effects of normalization to deuterium and distinct in-medium dynamics for pion and kaon production.


<details>
  <summary>Details</summary>
Motivation: To investigate the onset of color transparency in nuclear interactions, focusing on how pion and kaon electroproduction exhibit different behaviors in terms of normalization and dynamics.

Method: The analysis compares data from $A(e,e'π^+)$ and $A(e,e'K^+)$ reactions, emphasizing the role of deuterium normalization and examining the $Q^2$ dependence of nuclear transparency.

Result: The results indicate that pion production is dominated by protons due to missing-mass selection, while kaon production retains a true proton-neutron average; differing formation dynamics are observed for both reactions, with the pion well-described by a diffusion model and kaon requiring a geometric expansion model.

Conclusion: These findings suggest that the onset of color transparency is reaction-dependent, influencing both the normalization approach and the propagation of particles through the nuclear medium.
...
### [32] [Pion Parton Distribution Functions in the Light-Cone Quark Model and Experimental Constraints](https://arxiv.org/abs/2604.05762)
*Hari Govind P,Satyajit Puhan,Abhishek K. P,Reetanshu Pandey,Harleen Dahiya,Arvind Kumar,Suneel Dutt*

Main category: hep-ph

TL;DR: This study explores the valence quark parton distribution functions (PDFs) of pions using the light-cone quark model, evolves them with DGLAP equations, predicts the $F_2$ structure function at NLO, and validates against experimental data.


<details>
  <summary>Details</summary>
Motivation: To improve the understanding of pion valence quark PDFs and their implications for high-energy particle interactions.

Method: Calculate initial quark PDFs via quark-quark correlation functions, evolve them using DGLAP equations, and compute the $F_2$ structure function and Drell-Yan cross-section.

Result: The evolved PDFs align with experimental data and theoretical predictions, and the calculated $F_2$ structure function is validated against ZEUS and H1 data.

Conclusion: The light-cone quark model effectively computes pion quark PDFs, consistent with existing experimental results.
...
### [33] [Scalar axion field of toroidal electromagnetic pulses](https://arxiv.org/abs/2604.05791)
*Wangke Yu,Nikitas Papasimakis,Nikolay I. Zheludev,Yijie Shen*

Main category: hep-ph

TL;DR: This study explores axion electrodynamics by demonstrating that toroidal electromagnetic pulses can create localized regions with a non-zero pseudoscalar field, highlighting the effects of an extended Maxwell's theory rather than generating axion particles.


<details>
  <summary>Details</summary>
Motivation: The paper investigates the implications of axion electrodynamics, which seeks to extend the classical understanding of electromagnetism by including a pseudoscalar axion field influenced by electric and magnetic fields.

Method: The authors analyze the behavior of superposed toroidal electromagnetic pulses in free space to identify conditions where the dot product of electric and magnetic fields is non-zero, leading to the emergence of a pseudoscalar field.

Result: The study finds that these structured light pulses indeed result in localized regions characterized by a non-zero $m{E}	imesm{B}$ product, indicating the presence of a pseudoscalar field co-propagating with the pulses.

Conclusion: The findings reinforce the idea that the phenomenon observed is a result of employing the axion electrodynamics framework in Maxwell's equations, and does not imply a process for creating physical axion particles.
...
### [34] [Doubly charged Higgs production within the Higgs triplet model at future electron-positron colliders](https://arxiv.org/abs/2604.05924)
*Shu-Xiang Li,Ren-You Zhang,Ming-Hui Liu,Xiao-Feng Wang,Zhong-Yuan Liu,Yi Jiang,Liang Han,Qing-hai Wang*

Main category: hep-ph

TL;DR: This paper evaluates the discovery potential of doubly charged Higgs bosons at the Compact Linear Collider (CLIC) across various collision modes, showing a significant advantage over the High Luminosity Large Hadron Collider (HL-LHC).


<details>
  <summary>Details</summary>
Motivation: To assess the discovery potential of the doubly charged Higgs boson within the Higgs triplet model at CLIC, focusing on different collision modes and benchmark regions.

Method: The study analyzes potential production mechanisms and decay modes of doubly charged Higgs bosons in Yukawa-like and gauge-like regions, using statistical significance to evaluate discovery potential.

Result: CLIC demonstrates strong discovery potential for the doubly charged Higgs, especially in the Yukawa-like region via single production, and up to 1.2 TeV mass in the gauge-like region with specific final states.

Conclusion: Compared to HL-LHC, CLIC offers superior discovery potential for the doubly charged Higgs boson, reinforcing its importance in future collider experiments.
...
### [35] [Monte-Carlo Event Generation for X-Ray Thomson Scattering Analysis](https://arxiv.org/abs/2604.05935)
...
TL;DR: The paper presents an event-driven approach to X-ray Thomson scattering (XRTS) modeling, improving efficiency and flexibility in warm-dense matter diagnostics by sampling individual scattering events instead of using forward models.


<details>
  <summary>Details</summary>
Motivation: XRTS is crucial for warm-dense matter experiments, but traditional methods face limitations due to complex instrument effects and high computational costs.

Method: The authors implement an event-driven framework where individual scattering events are sampled and processed through a spectrometer simulation, decoupling event generation from detector analysis.

Result: The method is shown to be feasible and consistent for non-resonant XRTS in a synthetic setup, allowing for efficient reuse of sampled events.

Conclusion: This new model-agnostic approach connects particle-physics techniques with WDM diagnostics, providing a scalable framework for advanced XRTS analysis.
...
### [36] [Quarkyonic Meson Matter for Finite Isospin Density](https://arxiv.org/abs/2604.06054)
*Larry McLerran*

Main category: hep-ph

TL;DR: The paper explores QCD at finite isospin density with a focus on meson dynamics across different density regimes, employing a linear sigma model to describe phase transitions and confinement behaviors.


<details>
  <summary>Details</summary>
Motivation: Investigating the behavior of QCD at finite isospin density enhances the understanding of quantum chromodynamics under varying conditions, particularly in relation to condensation phenomena and meson dynamics.

Method: The study employs a linear sigma model to analyze low-density meson content and evaluates different density regimes, utilizing weak coupling methods where applicable.

Result: At low isospin chemical potentials, a Bose condensate emerges; at higher densities, confinement persists as degrees of freedom shift to mesons and Cooper pairs, with quarkyonic matter observed across intermediate density ranges.

Conclusion: The findings suggest that meson matter behaves quarkyonically at intermediate isospin densities, with implications for Fermi sea configurations and the possible existence of Bose condensation at the Fermi surface.
...
### [37] [Electromagnetic Flares from Compact-Object Mergers in AGN Disks: Signatures and Predictions](https://arxiv.org/abs/2604.05020)
*Hiromichi Tagawa,Zoltán Haiman,Shigeo S. Kimura,Hassen M. Yesuf,Hengxiao Guo*

Main category: astro-ph.HE

TL;DR: The study explores the potential electromagnetic (EM) signatures from post-merger events in active galactic nuclei (AGN) where stellar-mass black holes merge, focusing on gamma-ray and optical emissions that could be detected following gravitational wave events.


<details>
  <summary>Details</summary>
Motivation: With the uncertain origins of gravitational wave (GW) events detected by LIGO and others, the study aims to identify accompanying electromagnetic (EM) signatures from such mergers.

Method: The research analyzes post-merger electromagnetic flares from jets and shocked ambient gas, using a model that simulates jet breakouts and their subsequent emissions in gamma-ray, hard X-rays, and optical wavelengths, while considering angular momentum changes post-merger.

Result: The model predicts detectable gamma-ray emissions from jet breakouts and cooling emissions in UV and optical ranges, potentially observable from numerous AGNs over extended monitoring periods.

Conclusion: By proposing a transition in accretion states post-merger, the study offers a feasible explanation for observed emission patterns, while addressing concerns of black hole growth associated with hyper-Eddington accretion.
...
### [38] [Characterizing the Gamma-ray Emission from Low-Luminosity AGN](https://arxiv.org/abs/2604.05028)
*Chris Karwin,Nikita Khatiya,Margot Boughelilba,Xiurui Zhao,Anita Reimer,Marco Ajello*

Main category: astro-ph.HE

TL;DR: This study investigates low-luminosity active galactic nuclei (LLAGN) to detect gamma-ray emissions and explores their origins, presenting new findings and a publicly available analysis tool.


<details>
  <summary>Details</summary>
Motivation: Understanding gamma-ray emissions from LLAGN, which have been largely unexplored despite their predicted activity.

Method: Analyzed 14.4 years of Fermi-LAT data, assessing both detected and subthreshold LLAGN using stacking techniques.

Result: Detected one new LLAGN and identified gamma-ray emissions from a subthreshold population, primarily attributed to star formation but possibly influenced by jets.

Conclusion: Individually detected LLAGN emissions suggest jet dominance; a Python-based analysis tool for further studies is also released.
...
### [39] [Wide Jets or Low Rates: Reconciling Short GRB and Gravitational-Wave Neutron Star Merger Rates](https://arxiv.org/abs/2604.05046)
*Keerthi Kunnumkai,Antonella Palmese,Brendan O'Connor,Amanda Farah,Ignacio Magana Hernandez*

Main category: astro-ph.HE

TL;DR: This study explores the compatibility of gravitational wave (GW) rates and short Gamma Ray Burst (sGRB) observations, focusing on binary neutron star (BNS) mergers.


<details>
  <summary>Details</summary>
Motivation: To determine if GW merger rates can account for observed sGRB rates, especially given the limited BNS merger detections in recent LVK runs.

Method: By analyzing recent merger rate constraints from the fourth LVK observing run and local sGRB rate density estimates, the study evaluates the viability of BNS mergers and jets with varying opening angles as sources of sGRBs.

Result: Finding that if over 55% of BNS mergers can launch jets with core half-opening angles ≥ 10°, the BNS rate aligns with observed sGRB rates. A narrow jet population can only match lower sGRB density estimates.

Conclusion: The findings suggest that BNS mergers are likely the primary progenitors of sGRBs and that NSBH mergers play a minor role, particularly for high sGRB rate densities.
...
### [40] [Approximating the Fourier Transform of Ring-Like Images: the Focal Expansion](https://arxiv.org/abs/2604.05199)
*Filip Niewiński,Michael D. Johnson*

Main category: astro-ph.HE

TL;DR: This paper presents a new method for approximating Fourier transforms in 2D, particularly for ring-like functions, using Hankel transforms and focal expansions.


<details>
  <summary>Details</summary>
Motivation: The need for accurate Fourier transform approximations for radially concentrated functions in various applications, including astrophysics.

Method: The method reduces the problem to evaluating Hankel transforms of angular modes and uses focal expansion for accurate approximations across spatial frequency ranges.

Result: The proposed approximation remains valid from small to large spatial frequencies and effectively captures the global behavior of a wide array of functions.

Conclusion: The utility of the method is demonstrated with its application to modeling the photon ring of a black hole, aiding in experimental measurements.
...
### [41] [Photon-Count Statistics of Crab X-ray Pulses: Skellam Behavior and Excess Variance in the Main Pulse](https://arxiv.org/abs/2604.05050)
...
TL;DR: The Crab pulsar's X-ray photon-count data reveals distinct statistical behaviors for its main pulse (MP) and interpulse (IP), with the IP fitting a Skellam distribution, while the MP displays excess variance and memory correlation analysis shows no significant results.


<details>
  <summary>Details</summary>
Motivation: To analyze the statistical properties of high-energy photon-count data from the Crab pulsar, particularly the differences in behavior between the main pulse and interpulse components.

Method: Using 78.8 ks of NICER data, we constructed single-pulse photon-count distributions for MP and IP, employing Skellam and Gaussian statistical models for analysis.

Result: The IP fits a Skellam distribution, while the MP, despite showing excess variance and not following Gaussian models, aligns with Skellam behaviors when counts are averaged.

Conclusion: The findings underline a statistical distinction between MP and IP, emphasizing the need for appropriate models in photon-counting studies and offering insights into pulsar emission mechanisms.
...
### [42] [Kinetic magnetohydrodynamics and Landau fluid closure in relativity](https://arxiv.org/abs/2604.05058)
*Abhishek Hegade K. R.,James M. Stone*

Main category: astro-ph.HE

TL;DR: This paper presents a theoretical framework for understanding weakly collisional plasmas near supermassive black holes, addressing the significant deviations from thermal equilibrium and their implications on fluid dynamics and horizon-scale observations.


<details>
  <summary>Details</summary>
Motivation: To examine the effects of weakly collisional plasmas on large-scale fluid motion near supermassive black holes, especially as they relate to horizon-scale observations.

Method: Derivation of relativistic drift kinetic equations from the Vlasov-Maxwell equations, including evolution equations for gyroaveraged distribution functions and an analytic Landau fluid closure.

Result: The proposed model captures anisotropic heat flow without relying on thermal equilibrium imposed by strong collisions, incorporating Landau damping in the fluid closure.

Conclusion: The model provides insights into weakly collisional phenomena in low-luminosity black hole accretion disks, complementing fully kinetic simulations.
...
### [43] [Developing Pre-Supernova Neutrino Support for sntools](https://arxiv.org/abs/2604.05894)
*Ellie O'Brien,Susan Cartwright,Patrick Stowell*

Main category: astro-ph.HE

TL;DR: The paper discusses the development of sntools to include pre-supernova neutrino event generation, aiding early detection of supernovae, with a focus on simulation optimization and validation.


<details>
  <summary>Details</summary>
Motivation: Detecting pre-supernova neutrinos could provide early warnings of imminent supernovae, improving observational readiness and understanding of these events.

Method: The paper details adaptations and additions to the existing sntools neutrino event generator to incorporate pre-supernova models, focusing on optimizing time binning for simulation accuracy.

Result: Updates on the status and capabilities of the sntools package, including validation processes and how the new functionality will be used by the Hyper-Kamiokande Collaboration, are provided.

Conclusion: The enhanced sntools will facilitate better study of pre-supernova neutrinos and their integration into current neutrino detection efforts.
...
### [44] [Implications of low neutron star merger rates for gamma-ray bursts, r-process production and Galactic double neutron stars](https://arxiv.org/abs/2604.05059)
*Maya Fishbach,Alexander P. Ji,Wen-fai Fong,Tom Y. Wu,Jillian C. Rastinejad,Aditya Vijaykumar,Hsin-Yu Chen*

Main category: astro-ph.HE

TL;DR: The paper analyzes the updated binary neutron star (BNS) merger rate from gravitational wave data, revealing a significant revision downward and highlighting tensions with known rates of short gamma-ray bursts, r-process elements, and double neutron star populations.


<details>
  <summary>Details</summary>
Motivation: To reassess the binary neutron star merger rate in light of new gravitational wave data and its implications for astrophysical phenomena like short gamma-ray bursts and r-process nucleosynthesis.

Method: The study employs data from the GWTC-4 catalog to determine the updated BNS merger rate and compares it with rates of short gamma-ray bursts, r-process mass production, and Galactic double neutron star systems.

Result: The total BNS merger rate is found to be $28$--$300\,\mathrm{Gpc}^{-3}\mathrm{yr}^{-1}$, with specific values for GW170817-like systems, revealing tensions with higher rates of SGRBs and r-process nucleosynthesis.

Conclusion: The reduced BNS merger rate suggests significant discrepancies with rates inferred from short gamma-ray bursts and r-process production, indicating the need for better understanding of underlying astrophysical processes.
...
### [45] [On the observational distinguishability of the Kerr and Kerr-Hayward metrics to EHT](https://arxiv.org/abs/2604.06128)
*Nikola Bukowiecka,Angelo Ricarte,Prashant Kocherlakota,Cora Prather*

Main category: astro-ph.HE

TL;DR: This study presents the Kerr-Hayward metric as a viable alternative to the Kerr metric for modeling astrophysical black holes by removing the ring-like singularity while retaining observable characteristics in polarized black hole images, as tested against Event Horizon Telescope data.


<details>
  <summary>Details</summary>
Motivation: To address the philosophical issue of the ring-like curvature singularity inherent in the Kerr metric representation of black holes.

Method: New GRMHD simulations were performed in the Kerr-Hayward spacetime, extending the EHT analysis framework for polarized radiative transfer, and integrating this modified spacetime into an open-source pipeline.

Result: Simulations and analyses revealed that observables in the Kerr-Hayward framework, such as polarization patterns and photon ring structures, remain functionally indistinguishable from those derived from the Kerr metric under specific conditions.

Conclusion: The singularity-free Kerr-Hayward metric can yield EHT observables that are effectively indistinguishable from those predicted by the Kerr metric, thus providing a compelling alternative for black hole imaging.
...
### [46] [A New Method for Testing Einstein's Theory of Gravity Close to Rapidly Spinning Black Holes](https://arxiv.org/abs/2604.05085)
*Shravan Vengalil Menon,Kun Hu,Henric Krawczynski*

Main category: astro-ph.HE

TL;DR: New observational signatures of extreme frame dragging near spinning black holes may reveal spectral components that test Einstein's gravity theory and measure black hole spin.


<details>
  <summary>Details</summary>
Motivation: To explore the previously believed unobservable efficiency of black holes in energizing particles through extreme frame dragging processes.

Method: Identify and analyze a new spectral component in rapidly spinning black holes within X-ray binaries that results from processes similar to collisional Penrose processes.

Result: Detection of this spectral component would provide distinct spectral and polarimetric properties, offering a new way to observe black hole dynamics and frame dragging effects.

Conclusion: Observations using X-ray polarimeters could enhance our understanding of black holes and test the predictions of general relativity.
...
### [47] [Identification of a Radio Counterpart to SN 2025ulz in the S250818k Localization Area](https://arxiv.org/abs/2604.05128)
...
TL;DR: The LIGO-Virgo-KAGRA collaboration identified a gravitational-wave candidate linked to a binary neutron star merger, leading to the discovery of SN 2025ulz, a Type IIb supernova with potential non-thermal ejecta indicating a central engine. Multi-band radio observations reveal significant emission, supporting theories of a superkilonova and suggesting future follow-ups for related events.


<details>
  <summary>Details</summary>
Motivation: To explore the connection between gravitational wave event S250818k, a potential binary neutron star merger, and the subsequent apparent supernova SN 2025ulz, particularly regarding the nature of its ejected material.

Method: Multi-band radio observations of SN 2025ulz were conducted using the Karl G. Jansky Very Large Array, along with observations from other radio telescopes to analyze the emission characteristics.

Result: Faint but significant radio emission from SN 2025ulz was detected, consistent with non-thermal emission from the supernova’s ejecta and suggestive of interaction with circumstellar material, potentially indicating fast ejecta and an off-axis jet.

Conclusion: The findings support the possibility that SN 2025ulz could be linked to a superkilonova scenario, advocating for future multi-wavelength follow-ups to investigate the association with GW events involving sub-solar mass neutron stars.
...
### [48] [Reconstruction of fast-rotating neutron star observables with the neural network](https://arxiv.org/abs/2604.05428)
*Wen Liu,Lingxiao Wang,Zhenyu Zhu*

Main category: astro-ph.HE

TL;DR: The paper presents a causal convolutional neural network model that rapidly evaluates neutron star properties, significantly speeding up analysis compared to traditional methods.


<details>
  <summary>Details</summary>
Motivation: Rapidly rotating neutron stars require complex modeling, and traditional calculations are too slow for extensive analysis.

Method: A causal convolutional neural network is developed to quickly reconstruct neutron star observables based on the equation of state, using a dataset generated from 	exttt{RNS}.

Result: The network accurately reproduces results for three different EoS and evaluates configurations in about 50ms, a significant improvement over the traditional 30-minute runtime.

Conclusion: This method allows for efficient inference analyses of rapidly rotating neutron stars, enabling faster exploration of their properties.
...
### [49] [The NANOGrav 15 yr and 20 yr Datasets: Timing Events and Pulse Shape Changes](https://arxiv.org/abs/2604.05453)
...
TL;DR: This paper investigates pulse shape stability and changes in pulsars, utilizing principal component analysis on a dataset from NANOGrav to identify and analyze timing events associated with morphological changes in pulse profiles.


<details>
  <summary>Details</summary>
Motivation: To understand the stability of pulsar pulse shapes over time and investigate anomalous timing events that deviate from traditional models, particularly focusing on PSR J1713+0747 and other pulsars.

Method: The authors applied principal component analysis to pulse profiles from nine NANOGrav pulsars, examining existing and new data over a 15 to 20-year period to identify significant pulse shape changes and variations.

Result: The analysis successfully identified three known pulse shape change events in PSR J1713+0747 and another in PSR J1643$-$1224, along with slow variations in additional pulsars and an unexpected recurrence in PSR B1937+21.

Conclusion: The findings underline the complexity of pulsar timing and the significance of pulse shape variations, suggesting that these changes can impact timing accuracy and models used in gravitational wave detection.
...
### [50] [Remnant recoil and host environments of GWTC-4.0 binary black-hole mergers](https://arxiv.org/abs/2604.05492)
...
TL;DR: This study analyzes the origin of binary black hole mergers and their retention in various astrophysical environments, identifying five events likely of dynamical origin and suggesting that while globular clusters may not retain merger remnants, nuclear star clusters could.


<details>
  <summary>Details</summary>
Motivation: Understanding the origins of binary black holes and their merger remnants is crucial for studying the growth of intermediate-mass black holes and the dynamics of hierarchical mergers.

Method: The study assessed 84 gravitational-wave events from LIGO-Virgo-KAGRA, comparing posteriors with synthetic population models via Bayes factors, calculating recoil velocities using the IMRPhenomXPNR model, and identifying events with dynamical origins.

Result: Five events favored a dynamical formation origin, including the most massive O4a event, with recoil velocities suggesting that remnants are likely ejected from globular clusters, while nuclear star clusters may retain them.

Conclusion: The findings challenge the likelihood of efficient hierarchical growth in globular clusters but support the potential for repeated mergers in nuclear star clusters, highlighting the need for improved population models and GW detection methodologies.
...
### [51] [Extreme Blazars Observed with MAGIC: Second Catalog Release](https://arxiv.org/abs/2604.05576)
...
TL;DR: This study presents a mini-catalog of extreme blazars based on observations from MAGIC telescopes, identifying new sources and confirming physical behaviors.


<details>
  <summary>Details</summary>
Motivation: To investigate the extreme characteristics and physical processes of high-peaked BL Lac objects or extreme blazars through very-high-energy gamma-ray observations.

Method: Monitoring seven targets with MAGIC telescopes from 2017 to 2025, analyzing data for VHE detections, and performing simultaneous multiwavelength observations.

Result: Two new VHE detections of extreme blazars, alongside hints of VHE emission in three additional sources; confirmation of typical behavior patterns such as modest variability and a 'harder-when-brighter' trend.

Conclusion: The findings expand the population of known extreme blazars and reinforce understanding of their physical properties through detailed broadband analysis.
...
### [52] [Non-LTE Ionization Modeling for Helium and Strontium in Neutron Star Merger Ejecta](https://arxiv.org/abs/2604.05703)
*Koya Chiba,Masaomi Tanaka,Shinya Wanajo,Sho Fujibayashi,Kyohei Kawaguchi,Kenta Hotokezaka*

Main category: astro-ph.HE

TL;DR: This study develops models to analyze the contributions of helium and strontium to the absorption feature in the kilonova AT2017gfo following the GW170817 event and estimates their abundances in the ejecta.


<details>
  <summary>Details</summary>
Motivation: To clarify the contributions of helium and strontium to the absorption feature in the kilonova AT2017gfo, and to improve consistency in modeling these elements simultaneously.

Method: Non-local thermodynamic equilibrium ionization models for He and Sr are developed, accounting for ionization by high-energy electrons to estimate the abundances needed to match the observed spectral feature.

Result: The study finds approximately 1% of He or 1-10% of Sr by mass in the ejecta, with Sr's mass fraction aligning with solar r-process abundance. It also suggests nucleosynthesis conditions involving low electron fraction and entropy.

Conclusion: The findings suggest significant r-process nucleosynthesis in low-EY conditions within GW170817 and indicate potential production of elements beyond the third r-process peak based on helium mass fractions from alpha decays.
...
### [53] [Strontium and helium in the kilonova AT2017gfo: Origin of the 1μm feature constrained via NLTE calculations](https://arxiv.org/abs/2604.05812)
*Aayush Arya,Rasmus Damgaard,Albert Sneppen,David J. Dougan,Stuart A. Sim,Connor P. Ballance,Darach Watson*

Main category: astro-ph.HE

TL;DR: This study explores the origins of a spectral feature near 1 μm in the kilonova AT2017gfo following the neutron star merger GW170817, providing strong evidence for strontium's role at early times, while allowing for helium's contribution later on.


<details>
  <summary>Details</summary>
Motivation: Neutron star mergers are key for understanding heavy element synthesis in the universe. The spectral feature in AT2017gfo is crucial for confirming r-process nucleosynthesis.

Method: Non-local thermodynamic equilibrium (NLTE) radiative transfer modeling is used, incorporating fresh strontium atomic data for e$^-$ collisions, photoionization, and recombination, to analyze the kilonova's spectra.

Result: The strontium model accurately simulates the temporal behavior of the 1 μm feature, indicating it is prominent at early times and decreases with time, while helium can contribute at later stages.

Conclusion: Strontium is essential for explaining the early appearance of the 1 μm feature, with helium potentially dominating its later evolution.
...
### [54] [Unveiling axion signals in galactic supernovae with future MeV telescopes](https://arxiv.org/abs/2604.05817)
*Zhen Xie,Jiahao Liu,Bing Liu,Ruizhi Yang*

Main category: astro-ph.HE

TL;DR: The paper evaluates detection prospects for axion-like particles (ALPs) from core-collapse supernovae, projecting sensitivities for next-gen MeV telescopes that could explore new ALP parameter spaces, potentially constraining ALP couplings significantly below current limits.


<details>
  <summary>Details</summary>
Motivation: The study aims to understand the potential for detecting ALPs produced in supernovae and their subsequent conversion to gamma-rays, addressing gaps in current astrophysical limits on ALP properties.

Method: Sensitivity projections combine instrument response simulations with background estimates, using realistic models of ALP flux and conversion probabilities in Galactic magnetic fields.

Result: Next-gen telescopes could detect photon-ALP couplings as low as gagamma ~ 1.61 x 10^-13 GeV^-1 for ALP masses < 10^-9 eV, indicating the capacity to explore previously uncharted ALP regions.

Conclusion: Future MeV missions are expected to provide definitive tests for axion-like particles as dark matter candidates in the ultra-light mass range, potentially constraining ALP couplings two orders of magnitude below current limits.
...
### [55] [Testing X-ray Periodicity and Long-Term Trend in PG 1553+113 via Targeted Swift-XRT Monitoring](https://arxiv.org/abs/2604.05905)
*P. Peñil,N. Torres-Albà,L. Marcotulli,A. Domínguez,M. Ajello,A. Rico,S. Buson,S. Adhikari*

Main category: astro-ph.HE

TL;DR: This study investigates PG 1553+113's X-ray emission patterns, noting a long-term linear trend similar to gamma-ray and optical bands, but finds no strong periodic behavior.


<details>
  <summary>Details</summary>
Motivation: To resolve the debate on periodic X-ray emissions in PG 1553+113 and to explore long-term trends across different wavelengths.

Method: Evaluated 2.1-year X-ray light curves using Swift-XRT and UVOT, comparing to predictions of oscillation phases and examining long-term trends.

Result: Tentative evidence of correlation between high-emission states in gamma-ray and X-ray/UV bands, but no strong periodic signal found in X-rays.

Conclusion: X-ray emission shows a long-term linear trend aligned with other bands, yet stochastic variability complicates identifying periodic behavior.
...
### [56] [Geometry of Free Fermion Commutants](https://arxiv.org/abs/2604.05031)
*Marco Lastres,Sanjay Moudgalya*

Main category: quant-ph

TL;DR: The paper explores the $k$-commutants of free-fermion systems, revealing a larger $O(2k)$ symmetry and its geometric interpretation using Grassmannian manifolds, which aids in understanding entanglement entropies and correlation functions.


<details>
  <summary>Details</summary>
Motivation: To understand the structure of $k$-commutants in free-fermion systems, which is crucial for analyzing physical behaviors under unitary evolution in many-body quantum systems.

Method: The authors mapped $k$-commutants to the ground state of effective Heisenberg models and employed representation theory, while using coherent states parametrized by Grassmannian manifolds for a geometric perspective.

Result: The Grassmannian manifold of $k$-commutants corresponds to fermionic Gaussian states on $2k$ sites, revealing a duality between real space and replica space, and yielding a compact projection formula for analytical calculations of entanglement properties.

Conclusion: This study provides a novel geometric insight into the $k$-commutant of free fermions, linking it to broader themes in quantum many-body physics, and facilitates efficient calculations related to entanglement entropies.
...
### [57] [Real-time Dynamics in 3D for up to 1000 Qubits with Neural Quantum States: Quenches and the Quantum Kibble--Zurek Mechanism](https://arxiv.org/abs/2604.05032)
*Vighnesh Dattatraya Naik,Zheng-Hang Sun,Markus Heyl*

Main category: quant-ph

TL;DR: This paper establishes Neural Quantum States (NQS) as a scalable framework for simulating 3D quantum dynamics, demonstrating their effectiveness in capturing complex behaviors in the 3D transverse-field Ising model, including the quantum Kibble-Zurek mechanism.


<details>
  <summary>Details</summary>
Motivation: The challenge of accurately simulating real-time dynamics in higher dimensions due to the exponential complexity of many-body wave functions and rapid entanglement growth.

Method: A residual-based convolutional architecture for Neural Quantum States was developed for cubic spin lattices, applied to study finite-rate quenches in the 3D transverse-field Ising model.

Result: NQS effectively captured various quench dynamics, including the quantum Kibble-Zurek mechanism, in systems of up to 1000 qubits, showing agreement with expected scaling dimensions and revealing universal entanglement dynamics.

Conclusion: Neural Quantum States provide a scalable and accurate method for exploring 3D quantum phenomena, offering valuable benchmarks for 3D quantum simulators.
...
### [58] [Efficient simulation of noisy IQP circuits with amplitude-damping noise](https://arxiv.org/abs/2604.05036)
*Shravan Shravan,Mohsin Raza,Ariel Shlosberg*

Main category: quant-ph

TL;DR: This paper presents a polynomial-time classical algorithm for sampling from the output distributions of amplitude-damped IQP circuits, addressing the gap in efficient simulation regarding non-unital noise.


<details>
  <summary>Details</summary>
Motivation: There is a need for efficient simulation algorithms for NISQ circuits that experience non-unital noise without randomness, which has been understudied.

Method: The authors develop a polynomial-time classical algorithm tailored for sampling from the output distributions of IQP circuits that utilize $l$-local diagonal gates with a specified depth and are affected by constant amplitude-damping noise.

Result: The proposed algorithm successfully simulates the described amplitude-damped IQP circuits in polynomial time, filling a critical gap in the literature regarding non-unital noise.

Conclusion: The work contributes significantly to classical simulation techniques for quantum circuits by demonstrating efficient sampling under non-unital noise conditions.
...
### [59] [Mixed eigenstates in spin-boson systems with one-photon and two-photon interactions](https://arxiv.org/abs/2604.05037)
*David Villaseñor,Marko Robnik*

Main category: quant-ph

TL;DR: This study investigates mixed eigenstates in spin-boson systems, revealing differences between one-photon and two-photon interactions, and proposes a new phase-space overlap index.


<details>
  <summary>Details</summary>
Motivation: To explore the mixed phase space of spin-boson systems and their transition from regular to chaotic behavior.

Method: Comparison of one-photon and two-photon interactions, alongside the introduction of a generalized phase-space overlap index.

Result: Identification of genuine mixed eigenstates and highlighting significant differences due to two-photon interactions compared to one-photon processes.

Conclusion: The findings support the principle of uniform semiclassical condensation (PUSC) for quasiprobability functions in these systems.
...
### [60] [Information Propagation in Rydberg Arrays via Analog OTOC Calculations](https://arxiv.org/abs/2604.05038)
*Goksu Can Toga,Siva Darbha,Ermal Rrapaj,Pedro L. S. Lopes,Alexander F. Kemper*

Main category: quant-ph

TL;DR: This paper presents a novel randomized measurement protocol for computing out-of-time-order correlators (OTOCs) on analog quantum computers, bypassing the need for backward time evolution, and successfully applies it to observe information propagation in 1D Rydberg chains.


<details>
  <summary>Details</summary>
Motivation: OTOCs are essential in studying quantum chaos and scrambling, yet their measurement on analog quantum computers is challenging due to the need for backward time evolution.

Method: The paper introduces a randomized measurement protocol that uses global randomized quenches to simulate the necessary unitary 2-design properties for calculating infinite-temperature OTOCs from statistical correlations.

Result: The protocol was successfully implemented on the Aquila quantum system, with clear observations of the lightcone of information propagation in 1D Rydberg chains, with results compared to state-vector simulations and matrix product state calculations.

Conclusion: This work marks the first successful measurement of randomized OTOCs in neutral-atom simulators, creating a scalable method for investigating quantum chaos in complex many-body systems.
...
### [61] [Instability-Enhanced Quantum Sensing with Tunable Multibody Interactions](https://arxiv.org/abs/2604.05047)
*Bidhi Vijaywargia,Jorge Chávez-Carlos,Francisco Pérez-Bernal,Lea F. Santos*

Main category: quant-ph

TL;DR: The paper investigates how a quartic extension of a Hamiltonian enhances signal amplification in quantum sensing, surpassing traditional limits and optimizing sensor performance.


<details>
  <summary>Details</summary>
Motivation: To explore how dynamical instabilities can be utilized to improve quantum sensing capabilities beyond the standard quantum limit.

Method: Experimental demonstration with a quartic extension of a twisting-and-turning Hamiltonian, analyzing both classical and quantum behaviors in a multibody system.

Result: The quartic Hamiltonian leads to greater amplification of signals and increased sensitivity, leveraging new unstable points in phase space.

Conclusion: Phase-space curvature emerges as a key factor for optimizing quantum sensor performance, allowing quicker and more effective signal amplification.
...
### [62] [Unlocking a fast adiabatic CZ gate and exact residual $ZZ$ cancellation between fixed-frequency transmons using a floating tunable coupler](https://arxiv.org/abs/2604.05048)
*Angela Q. Chen,Xian Wu,Sarah Strong,Stefano Poletto*

Main category: quant-ph

TL;DR: The study presents a symmetric floating tunable coupler that enables rapid, high-fidelity controlled-Z gates in superconducting qubit systems while maintaining low error rates and preserving idle ZZ cancellation.


<details>
  <summary>Details</summary>
Motivation: Achieving low error rates for fast two-qubit gates in superconducting qubits is challenging due to the need to suppress leakage and non-adiabatic errors while maintaining favorable qubit conditions.

Method: The authors utilized a symmetric floating tunable coupler and introduced pulse-shaping techniques based on the instantaneous adiabatic factor to achieve high fidelity in controlled-Z gates.

Result: A 24 ns adiabatic controlled-Z gate was experimentally realized with a fidelity exceeding 99.9% and stable operation over several hours.

Conclusion: The proposed coupler architecture and pulse-shaping techniques enable rapid, robust, and high-fidelity gate operations in superconducting qubit systems.
...
### [63] [Tennis-racket instability of twisted electrons](https://arxiv.org/abs/2604.05089)
*S. S. Baturin*

Main category: quant-ph

TL;DR: The paper explores how a weak nonlinear magnetic edge can induce tennis-racket instability in twisted electrons' orbital dynamics under a magnetic field.


<details>
  <summary>Details</summary>
Motivation: Understanding the dynamics of twisted electrons in magnetic fields may reveal novel quantum behaviors and transition mechanics relevant to advanced electron microscopy techniques.

Method: The authors derive an effective Hamiltonian to analyze the influence of a magnetic entrance edge on twisted electron dynamics, accounting for corrections to their pseudospin precession.

Result: They find that under certain conditions, the dynamics exhibit recurrent reversals of mean pseudospin, transitioning between distinct quantum vortex states in real space.

Conclusion: The mechanisms are feasible within current experimental setups, potentially enhancing electron microscopy through the manipulation of quantum states.
...
### [64] [Quantum Algorithms for Heterogeneous PDEs: The Neutron Diffusion Eigenvalue Problem](https://arxiv.org/abs/2604.05098)
*Andrew M. Childs,Lincoln Johnston,Brian Kiedrowski,Mahathi Vempati,Jeffery Yu*

Main category: quant-ph

TL;DR: A hybrid classical-quantum algorithm effectively solves a linear reaction-diffusion equation related to nuclear criticality, showing significant speedup over classical methods.


<details>
  <summary>Details</summary>
Motivation: To find efficient solutions for the neutron diffusion k-eigenvalue problem in heterogeneous media, which is crucial for nuclear criticality safety.

Method: Utilizes a hybrid classical-quantum approach with uniform finite elements and recent quantum advancements for linear systems, including fast inversion and quantum preconditioning.

Result: Demonstrated substantial polynomial end-to-end speedup of the quantum algorithm compared to classical algorithms.

Conclusion: While quantum algorithms can outperform classical methods for certain heterogeneous PDEs, the advantage is contingent on the performance of classical techniques like nonuniform or adaptive meshing.
...
### [65] [Mirror Dual Symmetry in Physics](https://arxiv.org/abs/2604.05741)
*Lucas Lamata*

Main category: quant-ph

TL;DR: This paper explores a symmetry principle connecting the quantum Rabi model and the Dirac equation, proposing a unique zero-energy interpretation that may address various outstanding issues in modern physics.


<details>
  <summary>Details</summary>
Motivation: The paper aims to bridge the quantum Rabi model and the Dirac equation, focusing on their shared symmetry and implications for modern physics, particularly in avoiding pitfalls related to negative energy solutions.

Method: The author proposes an interpretation where total energy remains zero, requiring each positive energy excitation to have a corresponding negative energy excitation, thus enforcing mirror dual symmetry.

Result: This approach potentially resolves issues such as the necessity for a Dirac sea, while automatically canceling zero point energy and addressing concerns in quantum gravity, dark matter, and dark energy.

Conclusion: By enforcing this total symmetry principle, many longstanding problems in physics could be mitigated, presenting a new framework for understanding these fundamental models.
...
### [66] [A superconducting quantum circuit single artificial atom maser](https://arxiv.org/abs/2604.05105)
*Maria Mucci,Nicholas Hougland,Chun-Che Wang,Israa Yusuf,Chenxu Liu,David Pekker,Michael Hatridge*

Main category: quant-ph

TL;DR: The paper presents a circuit QED analog of an atomic micromaser using an artificial multi-level atom as the gain medium.


<details>
  <summary>Details</summary>
Motivation: To explore the application of circuit QED in probing maser physics with engineered components.

Method: An artificial multi-level atom is pumped into a population-inverted state by a microwave tone, utilizing the flexibility of the circuit QED platform to control level structure and coupling.

Result: The device exhibits rich physics reflective of maser functionalities, indicating potential for further exploration in microwave quantum circuits.

Conclusion: This work highlights the intersection of circuit QED and maser physics, suggesting new avenues for research in quantum optics.
...
### [67] [Quantum noise in ranging with optical pulses](https://arxiv.org/abs/2604.05107)
*Mylenne Manrique,Ilaria Gianani,Marco Barbieri,Valentina Parigi,Nicolas Treps*

Main category: quant-ph

TL;DR: This paper explores the use of quantum frequency combs for high-precision distance ranging, focusing on the benefits of squeezing in measurement precision.


<details>
  <summary>Details</summary>
Motivation: To investigate improved distance estimation uncertainties using quantum frequency combs, beyond what traditional methods offer.

Method: An effective Hamiltonian framework is applied to analyze ranging with quantum frequency combs and derive precision bounds.

Result: The study reveals that intensity anti-squeezing and temporal beam shaping enhance measurement precision, particularly for short-distance applications.

Conclusion: Quantum frequency combs may provide advantages in high-precision ranging, but their benefits are largely applicable in short-distance scenarios.
...
### [68] [In-Situ Simultaneous Magic State Injection on Arbitrary CSS qLDPC Codes](https://arxiv.org/abs/2604.05126)
*Kun Liu,Shifan Xu,Tomas Jochym-O'Connor,Zhiyang He,Shraddha Singh,Yongshan Ding*

Main category: quant-ph

TL;DR: This paper introduces an  in-situ magic state injection scheme for quantum low-density parity-check (qLDPC) codes, allowing for direct preparation of logical magic states within a memory block, enhancing efficiency and reducing overhead.


<details>
  <summary>Details</summary>
Motivation: Existing magic state injection methods for qLDPC codes are limited to external approaches, which necessitate additional resources. The authors aim to innovate by proposing a more efficient in-situ method.

Method: The proposed in-situ injection prepares logical magic states directly within the qLDPC memory block, relying solely on resources needed for syndrome extraction. This is adaptable to any CSS qLDPC code.

Result: Simulations on the [[144,12,12]] Bivariate Bicycle code and the [[225,9,4]] Hypergraph Product code demonstrate that the injection error rate remains below the threshold of relevant gate errors, with negligible correlated errors under specified noise models.

Conclusion: The scheme offers a simpler, more resource-efficient approach for magic state injection in qLDPC codes, achieving significant reductions in overhead compared to previous methods.
...
### [69] [Tight Quantum Lower Bound for k-Distinctness](https://arxiv.org/abs/2604.05133)
*Aleksandrs Belovs*

Main category: quant-ph

TL;DR: This paper introduces a new quantum query lower bound framework that improves upon previous techniques by eliminating the use of oracles and allowing arbitrary input distributions.


<details>
  <summary>Details</summary>
Motivation: To establish a new framework for quantum query complexities that can derive stronger lower bounds in quantum computing.

Method: The method involves defining 'knowledge' through state expansion in the Fourier basis without oracles, and accommodating arbitrary input probability distributions.

Result: The framework is effectively applied to derive the first tight quantum query lower bound for the k-Distinctness problem.

Conclusion: This new approach not only enhances previous techniques but also opens pathways for more robust quantum algorithm analysis.
...
### [70] [Star product for qubit states in phase space and star exponentials](https://arxiv.org/abs/2604.05170)
*Jasel Berra-Montiel,Alberto Molgado,Mar Sánchez-Córdova*

Main category: quant-ph

TL;DR: This paper presents a phase space description of qubit systems through coadjoint orbits and deformation quantization on the sphere, linking quantum dynamics to the coherent-state path integral formulation.


<details>
  <summary>Details</summary>
Motivation: To develop a comprehensive framework for describing qubit dynamics using advanced mathematical structures.

Method: Utilizes coadjoint orbits of $SU(2)$ and the Stratonovich-Weyl correspondence to construct a star product and express quantum dynamics via star exponentials of Hamiltonian symbols.

Result: Demonstrated that the constructed framework reproduces the operator algebra of complexified quaternions and establishes a connection between the coherent-state path integral and star exponentials on $S^2$.

Conclusion: The paper concludes that the phase space formulation offers a unified approach to qubit dynamics and illustrates this with examples of star-exponential functions and Poisson structures.
...
### [71] [Quantum Hilbert Space Fragmentation and Entangled Frozen States](https://arxiv.org/abs/2604.05218)
*Zihan Zhou,Tian-Hua Yang,Bo-Ting Chen*

Main category: quant-ph

TL;DR: Local Hamiltonian rank deficiency leads to quantum Hilbert space fragmentation via entangled frozen states (EFS), observed in four symmetry models.


<details>
  <summary>Details</summary>
Motivation: Understanding quantum fragmentation mechanisms is crucial for insights into quantum systems' dynamics and entanglement properties.

Method: Analyzed four models with varying symmetry structures: asymmetric qubit projector, $	ext{Z}_2$-symmetric GHZ projector, $	ext{Z}_3$-symmetric cyclic qutrit projector, and the Temperley-Lieb model, exploring their Krylov subspaces and irreducible blocks.

Result: Identified EFS generation due to rank deficiency, established closed-form expressions for Krylov dimensions, and distinguished between weak and strong quantum fragmentation based on the behavior of irreducible blocks and spectral statistics.

Conclusion: Quantum fragmentation is characterized by the count of irreducible blocks influenced by system size, revealing different ergodic properties and spectral distributions.
...
### [72] [Square-root Time Atom Reconfiguration Plan for Lattice-shaped Mobile Tweezers](https://arxiv.org/abs/2604.05317)
*Koki Aoyama,Takafumi Tomita,Fumihiko Ino*

Main category: quant-ph

TL;DR: This paper presents a scalable algorithm for reconfiguring defect-free atom arrays in neutral-atom systems, achieving significant efficiency improvements in transport time and atom capture.


<details>
  <summary>Details</summary>
Motivation: The need for efficiently reconfiguring atom arrays to support scalable quantum computing applications.

Method: The algorithm employs a divide-and-conquer strategy, parallelizing atom transport and utilizing acousto-optic deflectors to create a 2D lattice pattern, resulting in a reconfiguration cost of $	ext{O}(	ext{sqrt}(N))$ for $N$ atoms.

Result: Numerical simulations show a transportation cost reduction to 1/7 of existing algorithms and increased atom capture by 32%-35%, validated on a 632x632 atom array.

Conclusion: The proposed algorithm significantly enhances the scalability and efficiency of atom array reconfigurations, aiding the development of larger quantum computers.
...
### [73] [Addressing a device in a quantum network: A quantum approach including routing](https://arxiv.org/abs/2604.05321)
*Alexander Pirker*

Main category: quant-ph

TL;DR: The paper proposes a quantum network addressing scheme using quantum states for tasks, eliminating classical communication of addresses and operations, leading to innovative applications and a distributed routing protocol.


<details>
  <summary>Details</summary>
Motivation: To improve quantum networking by removing classical communication requirements, enhancing efficiency, and exploring the potential of entanglement in device addressing.

Method: Devices utilize address states and request states for task execution, leading to a distributed quantum routing protocol based on entanglement for controlled-teleportation routes.

Result: The approach allows for efficient routing without classical address communication, demonstrating the feasibility of task performance in superposition in a quantum network.

Conclusion: Utilizing quantum states for addressing enhances quantum network functionalities and paves the way for advanced quantum communication protocols.
...
### [74] [Noise is not always detrimental: the capacity of quantum batteries is enhanced in black holes](https://arxiv.org/abs/2604.05325)
*Xukun Wang,Xiaofen Huang,Zhihao Ma,Shao-Ming Fei,Tinggui Zhang*

Main category: quant-ph

TL;DR: This study investigates the effects of Hawking radiation and environmental noise on the capacity of quantum batteries, revealing that Hawking radiation can enhance capacity while certain noise types degrade it significantly.


<details>
  <summary>Details</summary>
Motivation: Understanding quantum battery capacity is essential for improving energy storage technologies in quantum systems, especially under varying spacetime and environmental conditions.

Method: The study examines bipartite mixed states and analyzes how different types of noise and Hawking radiation modulate quantum battery capacity and the dynamics of energy exchange.

Result: Hawking radiation can enhance quantum battery capacity counter to expectations, while environmental noise generally reduces it, with significant differences based on the noise type; extreme noise can drive capacity to near zero.

Conclusion: These results advance the understanding of quantum batteries in curved spacetime, highlighting the complex interplay between radiation, noise, and energy storage capabilities.
...
### [75] [Dynamics of Entanglement in Schwarzschild Black Holes](https://arxiv.org/abs/2604.05331)
*Fang Xie,Ying Yang,Tinggui Zhang,Xiaofen Huang*

Main category: quant-ph

TL;DR: The paper investigates the impact of Hawking radiation on the entanglement of quantum states, finding varying behaviors in accessible and inaccessible concurrence under different noise channels.


<details>
  <summary>Details</summary>
Motivation: To better understand how Hawking radiation influences quantum entanglement beyond the event horizon.

Method: Concurrence is used as an entanglement measure, analyzing its evolution with Hawking temperature and under three types of noise: phase damping, phase flip, and bit flip.

Result: Physically accessible concurrence decreases with increasing Hawking acceleration, while inaccessible concurrence increases. Different noise channels affect the evolution of concurrence differently, particularly leading to sudden death in phase flip and bit flip channels.

Conclusion: Concurrence shows a trade-off between accessible and inaccessible measures, influenced by the type of noise channel present.
...
### [76] [Molecular Excited States using Quantum Subspace Methods: Accuracy, Resource Reduction, and Error-Mitigated Hardware Implementation of q-sc-EOM](https://arxiv.org/abs/2604.05380)
*Srivathsan Poyyapakkam Sundar,Prince Frederick Kwao,Alexey Galda,Ayush Asthana*

Main category: quant-ph

TL;DR: This study examines the use of advanced quantum algorithms for accurate excited-state potential energy surfaces in quantum chemistry simulations, comparing them to classical methods and addressing scaling challenges through innovative techniques to mitigate errors on quantum hardware.


<details>
  <summary>Details</summary>
Motivation: The need for achieving accurate excited-state potential energy surfaces in quantum chemical simulations is crucial for realizing quantum utility on near-term quantum hardware.

Method: The authors combine ADAPT-VQE/LUCJ and q-sc-EOM algorithms, assess their accuracy, and reduce scaling bottlenecks using the Davidson algorithm and basis rotation grouping, while implementing error mitigation strategies on quantum hardware.

Result: The q-sc-EOM algorithm, with effective error mitigation, yielded reasonably accurate excited-state energies, identifying gate noise as the leading error source and reducing measurement scaling significantly.

Conclusion: This work advances the feasibility of accurate and scalable quantum excited-state methods, highlighting critical challenges for future improvements in quantum chemistry simulations.
...
### [77] [Granularity Noise Limit in Atomic-Ensemble-Based Metrology](https://arxiv.org/abs/2604.05420)
*Chen-Rong Liu,Chuang Li,Runxia Tao,Yixuan Wang,Mingti Zhou,Xinqing Wang,Ying Dong*

Main category: quant-ph

TL;DR: This study challenges the continuous-medium approximation in atomic-ensemble sensing, revealing intrinsic atomic granularity noise (AGN) that competes with optical measurement noise (OMN). A unified noise-scaling law is derived, demonstrating how increased optical probe power can inadvertently degrade sensitivity and establishing a threshold beyond which quantum enhancements fail to improve measurements due to AGN dominance.


<details>
  <summary>Details</summary>
Motivation: To address limitations in conventional noise analysis of atomic-ensemble sensing, which assumes a continuous medium and neglects intrinsic atomic granularity.

Method: A discrete-atom statistical framework is employed to derive a unified noise-scaling law based on the photon-to-atom flux ratio, allowing for analysis of noise contributions from both optical measurement and atomic granularity.

Result: The unified noise-scaling law indicates a crossover from OMN-limited to AGN-limited regimes and reveals that increasing optical power can worsen sensitivity when AGN dominates.

Conclusion: There exists a critical resource threshold $_\mathrm{crit}$ at which quantum-enhanced metrology ceases to improve due to AGN constraints, highlighting the necessity for careful optimization in sensor design.
...
### [78] [Decoherence-induced Multiphoton Interference](https://arxiv.org/abs/2604.05422)
*Yifan Du,Jiuyi Zhang,Daniel López Martínez,Misagh Izadi,Yuping Huang*

Main category: quant-ph

TL;DR: Decoherence, typically negative in quantum tech, can enable useful phenomena. This study shows how photons, linked through a lossy channel on a lithium niobate chip, can form coherent states, revealing potential for harnessing decoherence in quantum info.


<details>
  <summary>Details</summary>
Motivation: To explore the unconventional utilities of decoherence in quantum information processing, challenging its traditionally detrimental perception.

Method: Connected two spontaneous parametric down-converters via a lossy channel on a lithium niobate chip to produce coherent multiphoton states and establish correlations among two to four photons.

Result: Demonstrated successful creation of coherent multiphoton states and tunable correlations by adjusting the relative phase of the driving pumps.

Conclusion: This study reveals the potential of leveraging decoherence creatively in quantum technologies, encouraging further exploration and utilization of quantum loss as a resource.
...
### [79] [A Digital Spreading Framework for Quantum Expectation Computation Without Rotation Gates or Arithmetic Circuits](https://arxiv.org/abs/2604.05452)
*Yu-Ting Kao,Yeong-Jar Chang*

Main category: quant-ph

TL;DR: This study presents Digital Spreading (DS), a digital quantum computing framework that overcomes limitations of traditional quantum methods by avoiding multiplication and rotation gates, achieving high precision in financial computations.


<details>
  <summary>Details</summary>
Motivation: To address the trade-offs between analog rotation gates' biases and digital circuits' complexity in achieving quantum advantage for financial engineering.

Method: Digital Spreading (DS) employs a pruned Cuccaro ripple-carry architecture and integer comparison operations on superposed quantum states to perform weighted-average computations without costly multiplications or rotation gates.

Result: DS achieves a relative error of 0.0001% in option pricing simulations, outperforming competitors like JP Morgan and ITRI's methods, which had errors of 1.43% and 19.14%, respectively.

Conclusion: DS offers a compact, robust, and accurate digital framework for quantum-weighted average computations in financial applications.
...
### [80] [Another Triumph of Locality: Colliding Histories Skew Handshakes](https://arxiv.org/abs/2604.05455)
*Charles Alexandre Bédard*

Main category: quant-ph

TL;DR: This chapter reinterprets Bell's theorem, suggesting local explanations for quantum phenomena that challenge traditional views of non-locality.


<details>
  <summary>Details</summary>
Motivation: To explore the implications of Bell's theorem on local reality and hidden variable theories in quantum mechanics.

Method: Theorem presentation in a simplified manner, critique of existing hidden variable strategies, and a formulation of Bell's scenario in the Heisenberg picture.

Result: Demonstrates that a strictly local explanation for Bell's scenario can be developed through unitary quantum mechanics.

Conclusion: Classical interpretations of quantum phenomena should be re-examined, allowing for local explanations that align with quantum mechanics.
...
### [81] [Phase-Fidelity-Aware Truncated Quantum Fourier Transform for Scalable Phase Estimation on NISQ Hardware](https://arxiv.org/abs/2604.05456)
*Akoramurthy B,Surendiran. B*

Main category: quant-ph

TL;DR: This paper introduces the Phase-Fidelity-Aware Truncated Quantum Fourier Transform (PFA-TQFT), which reduces the complexity of quantum phase estimation from $	extcal{O}(m^{2})$ to $	extcal{O}(m	ext{log} m)$ with minimal increase in estimation error, making it a viable option for near-term quantum devices.


<details>
  <summary>Details</summary>
Motivation: The aim is to address the prohibitive overhead of the standard QFT implementation on NISQ devices, particularly the $	extcal{O}(m^{2})$ gate requirement due to a large number of control qubits.

Method: The PFA-TQFT uses a truncation depth $d$ to approximate the QFT by omitting controlled-phase rotations below a fidelity threshold $	imes$. It establishes a relationship between circuit size and approximation error, allowing for a significant reduction in resource requirements while controlling the error.

Result: The analysis shows that with $d=	extcal{O}(	ext{log} m)$, the gate count reduces from $	extcal{O}(m^{2})$ to $	extcal{O}(m	ext{log} m)$, with the maximum estimation error increasing by $	extcal{O}(2^{-d})$. Experimental results corroborate the theoretical findings, showing a notable improvement in performance under NISQ noise conditions.

Conclusion: PFA-TQFT significantly reduces the gate requirements for quantum phase estimation while maintaining acceptable accuracy, and it outperforms traditional QFT implementations in the presence of noise, demonstrating practical applicability on current quantum devices.
...
### [82] [Non-Markovian exceptional points in waveguide quantum electrodynamics](https://arxiv.org/abs/2604.05473)
*Stefano Longhi*

Main category: quant-ph

TL;DR: The paper explores non-Markovian dynamics in quantum emitters influenced by feedback and collective effects, revealing exceptional points in relaxation dynamics.


<details>
  <summary>Details</summary>
Motivation: To investigate how time-delayed feedback and cooperative emission modify spontaneous emission processes in quantum electrodynamics (QED).

Method: The study focuses on the spontaneous emission of giant atoms and analyzes their relaxation dynamics, particularly in waveguide-QED environments.

Result: The emergence of non-Markovian exceptional points (EPs) in spontaneous emission, leading to oscillatory behavior in the excited-state amplitude.

Conclusion: Waveguide-QED systems are viable platforms for studying non-Markovian EP physics, offering insights into the behavior of quantum emitters under complex interactions.
...
### [83] [Qurator: Scheduling Hybrid Quantum-Classical Workflows Across Heterogeneous Cloud Providers](https://arxiv.org/abs/2604.05505)
*Sinan Pehlivanoglu,Ulrik de Muelenaere,Peter Kogge,Amr Sabry*

Main category: quant-ph

TL;DR: Qurator optimizes quantum cloud scheduling by addressing queue time and fidelity jointly, enhancing HPC integration.


<details>
  <summary>Details</summary>
Motivation: The shift of quantum computing toward integration with large workflows highlights the challenge of minimizing wait time in quantum cloud scheduling without sacrificing execution fidelity.

Method: Qurator models hybrid quantum-classical workloads as dynamic Directed Acyclic Graphs (DAGs) incorporating quantum semantics and employs a logarithmic success score to unify calibration data for fidelity estimation.

Result: In evaluations, Qurator achieves up to 75% queue time reduction in high load conditions while maintaining fidelity within 1% of the highest-fidelity baseline, adhering to user-defined fidelity targets.

Conclusion: Qurator effectively balances the trade-off between queue time and circuit fidelity in quantum cloud scheduling, making it a valuable tool for enhancing the performance of quantum tasks in HPC systems.
...
### [84] [Quantum state determinability from local marginals is universally robust](https://arxiv.org/abs/2604.05508)
*Wenjun Yu,Fei Shi,Giulio Chiribella,Qi Zhao*

Main category: quant-ph

TL;DR: The paper establishes that unique determination of multiparticle quantum states from local marginals can withstand local imperfections, with a classification based on the power-law exponent of these marginals.


<details>
  <summary>Details</summary>
Motivation: To understand whether multiparticle quantum states can be determined from local marginals, particularly when only finite statistics are available.

Method: The authors prove that deviations in local marginals affect global states according to a power law, classify states by their power-law exponents, and derive a certification criterion using semidefinite programming.

Result: The study characterizes multipartite quantum states by their robustness, reveals that stabilizer states are square-root robust, and classifies the Dicke family of states.

Conclusion: The findings enable the construction of an efficient entanglement witness, highlighting practical applications of the robustness classification.
...
### [85] [Resource Implications of Different Encodings for Quantum Computational Fluid Dynamics](https://arxiv.org/abs/2604.05577)
*Hans A. Kösel,Roland Ewert,Jan W. Delfs*

Main category: quant-ph

TL;DR: This paper addresses the challenges of amplitude encoding in quantum algorithms for computational fluid dynamics, focusing on initialization and read-out costs, and proposes a new encoding method for the lattice Boltzmann approach based on empirical findings.


<details>
  <summary>Details</summary>
Motivation: The need for efficient quantum algorithms to compute entire fields of values in applications like computational fluid dynamics, while addressing the computational challenges in initialization and read-out phases.

Method: The paper reviews various encoding schemes, extends previous literature on computational costs, deduces circuit depths for initialization, and derives an upper bound for required algorithm runs using IBM's Qiskit for empirical verification.

Result: An upper bound for the number of algorithm executions required to achieve accuracy scales as ${	ilde{n}^2} ~ {	ext{ln}({	ilde{n}})}$, but this was found to be conservative compared to the empirical scaling law of ${	ilde{n}} ~ {	ext{ln}({	ilde{n}})}$ derived from a specific study.

Conclusion: Insights from this analysis lead to a new quantum encoding strategy specifically designed for the lattice Boltzmann method, providing a more efficient approach for CFD applications.
...
### [86] [PQC-Enhanced QKD Networks: A Layered Approach](https://arxiv.org/abs/2604.05599)
*Paul Spooren,Andreas Neuhold,Sebastian Ramacher,Thomas Hühn*

Main category: quant-ph

TL;DR: The paper introduces a dual-layer architecture combining Quantum Key Distribution and Post-Quantum Cryptography for secure multi-hop quantum networks.


<details>
  <summary>Details</summary>
Motivation: To provide scalable, end-to-end security in quantum networks while ensuring practical deployment and interoperability.

Method: A layered approach employs WireGuard and Rosenpass for key exchange and protection, using open-source implementations in simulated environments.

Result: The design demonstrates uninterrupted operation over multi-hop paths with a low resource footprint and effective fail-safe mechanisms.

Conclusion: The architecture maintains compositional security and suggests integration strategies for current infrastructures leveraging QKD-aware overlays.
...
### [87] [A solid-state quantum memory based on a continuous optoacoustic system](https://arxiv.org/abs/2604.05602)
*Changlong Zhu,Claudiu Genes,Birgit Stiller*

Main category: quant-ph

TL;DR: A protocol for quantum memory utilizing photon-phonon transduction in a Brillouin-active optical waveguide allows for high-fidelity storage and retrieval of quantum states.


<details>
  <summary>Details</summary>
Motivation: Quantum memories are crucial for advancing quantum communication and information processing technologies.

Method: The proposed protocol employs a pulsed pump to facilitate a beam-splitter interaction between optical and acoustic fields for mapping and retrieving quantum states.

Result: The protocol enables high-fidelity storage and retrieval of squeezed and entangled quantum states, with a memory bandwidth potentially reaching hundreds of MHz.

Conclusion: Brillouin optomechanical systems can serve as scalable platforms for broadband quantum memories and multimode quantum signal processing.
...
### [88] [Loss-aware state space geometry for quantum variational algorithms](https://arxiv.org/abs/2604.05627)
*Ankit Gill,Kunal Pal*

Main category: quant-ph

TL;DR: This paper presents an enhanced natural gradient descent optimisation method that incorporates inherent geometry of outcome spaces, improving performance in specific scenarios over traditional methods.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of natural gradient descent in considering the distance measure on the outcome space in optimising classical and quantum observables.

Method: Introduction of a generic optimising principle leveraging the geometry of the outcome space through ambient space constructions and conformal variants, leading to loss-aware natural gradient updates.

Result: Benchmarking shows that the proposed methods offer improved best-case convergence in certain scenarios compared to standard natural gradient techniques.

Conclusion: While standard natural gradient remains robust on average, the new conformal schemes can enhance convergence under favorable conditions.
...
### [89] [Estimation of trace distance between two arbitrary quantum states](https://arxiv.org/abs/2604.05628)
*Sanchita Ghosh,Anumita Mukhopadhyay,Anindita Bera,Prasenjit Deb,Shibdas Roy*

Main category: quant-ph

TL;DR: The paper proposes a quantum algorithm for computing trace distance between quantum states, achieving a complexity of O(N^8) and demonstrating its effectiveness via simulations and IBM quantum hardware.


<details>
  <summary>Details</summary>
Motivation: To provide an efficient method for calculating trace distance, a crucial metric in quantum computation, given the computational challenges with current methods.

Method: The algorithm leverages density matrix exponentiation and improved quantum phase estimation (IQPE) to compute trace distance for pure and mixed states.

Result: The proposed algorithm achieves a time complexity of O(N^8) and shows effectiveness through simulations and practical implementations on IBM quantum computers.

Conclusion: The algorithm promises efficiency and applicability for near-term quantum devices, marking an advancement in the computation of trace distances.
...
### [90] [Quantum Learning of Classical Correlations with continuous-domain Pauli Correlation Encoding](https://arxiv.org/abs/2604.05637)
*Vicente P. Soloviev,Bibhas Adhikari*

Main category: quant-ph

TL;DR: This paper proposes a quantum machine learning framework for estimating covariance matrices using two quantum estimators within the Pauli-Correlation-Encoding paradigm, highlighting their trade-offs, challenges, and effectiveness in high-dimensional statistics.


<details>
  <summary>Details</summary>
Motivation: There is a growing interest in leveraging quantum computing for high-dimensional statistical estimation, particularly in leveraging quantum machine learning techniques for efficient covariance matrix estimation.

Method: The paper introduces two quantum covariance estimators: the C-Estimator, which uses Cholesky factorization to ensure positive definiteness, and the E-Estimator, which calculates covariance directly from observable expectations. It also addresses the barren plateau phenomenon in variational training by optimizing regularization parameters.

Result: Numerical simulations show that both estimators converge well and are robust against low-rank assumptions, demonstrating their potential in covariance completion with partially observed data.

Conclusion: The developed quantum framework offers a promising route for applying quantum machine learning to complex statistical problems, suggesting its viability for high-dimensional covariance matrix estimation.
...
### [91] [Coherence and Imaginarity as Resources in Quantum Circuit Complexity](https://arxiv.org/abs/2604.05660)
*Linlin Ye,Zhaoqi Wu,Nanrun Zhou*

Main category: quant-ph

TL;DR: This paper explores the complexity of quantum circuits using coherence and imaginarity resources, establishing lower bounds on circuit cost via Tsallis relative α entropy.


<details>
  <summary>Details</summary>
Motivation: To quantify the minimal gate count required for unitary transformations in quantum circuits, enhancing understanding of quantum computation efficiency.

Method: Lower bounds on circuit cost are derived using Tsallis relative α entropy and skew information, with explicit examples for typical quantum gates.

Result: The established bounds are tighter than previous work and demonstrate that imaginarity constraints can be significant even when coherence yields zero lower bounds.

Conclusion: The findings illuminate the interplay between quantum resources and circuit complexity, highlighting potential advantages of imaginarity in certain scenarios.
...
### [92] [The final version of a recent approach towards quantum foundation](https://arxiv.org/abs/2604.05675)
*Inge S. Helland*

Main category: quant-ph

TL;DR: The article simplifies a quantum foundation approach, removing a previously used inaccessible variable assumption and relying on two complementary accessible variables to derive the Hilbert space formalism.


<details>
  <summary>Details</summary>
Motivation: The author aims to streamline the theoretical framework for quantum foundations, addressing the complexity introduced by inaccessible variables.

Method: The article presents a simplified basis derived from the assumption of two complementary maximal accessible variables, leading to the Hilbert space formalism.

Result: The formulation allows for a clearer derivation of quantum mechanics from a purely mathematical theory.

Conclusion: The proposed theory facilitates a better understanding of quantum mechanics by focusing on accessible variables, with discussions on possible applications and mathematical proofs included.
...
### [93] [A plug-and-play superconducting quantum controller at millikelvin temperatures enables exceeding 99.9% average gate fidelity](https://arxiv.org/abs/2604.05693)
...
TL;DR: The paper presents a superconducting quantum controller for efficient chip-to-chip qubit manipulation at low temperatures, achieving high fidelity and low energy operation.


<details>
  <summary>Details</summary>
Motivation: To enhance superconducting quantum computing by improving in-situ control methods for high-fidelity operations at cryogenic temperatures.

Method: A superconducting quantum controller was developed enabling direct chip-to-chip interconnections and all-digital manipulation of qubits.

Result: The controller achieved an average Clifford fidelity of 99.9% with minimal leakage and low gate operation energy of 0.121 fJ.

Conclusion: This technology addresses the control bottleneck in superconducting quantum computing, indicating its high potential for future applications.
...
### [94] [Kinetic Uncertainty Relation in Collective Dissipative Quantum Many-Body Systems](https://arxiv.org/abs/2604.05747)
*Hayato Yunoki,Yoshihiko Hasegawa*

Main category: quant-ph

TL;DR: This paper establishes kinetic uncertainty relations for many-body quantum systems undergoing collective dissipation, revealing enhanced precision linked to particle interactions.


<details>
  <summary>Details</summary>
Motivation: To determine the ultimate precision limits in interacting many-body quantum systems, which are unknown despite existing bounds for single-body cases.

Method: The authors derive a kinetic uncertainty relation using a mean-field approximation and express results in terms of physical quantities for many-body systems with collective dissipation.

Result: The analysis shows that collective interactions significantly enhance precision, enabling it to scale with the number of particles in the system.

Conclusion: This research provides a framework for understanding precision limits in many-body systems, vital for advancing quantum technologies that leverage collective quantum phenomena.
...
### [95] [A Nested Amplitude Amplification Protocol for the Binary Knapsack Problem](https://arxiv.org/abs/2604.05776)
*Laurin Demmler,Maximilian Hess*

Main category: quant-ph

TL;DR: The paper proposes a nested Amplitude Amplification protocol to improve Grover Adaptive Search (GAS) for the binary knapsack problem, optimizing circuit depth and performance for NISQ devices.


<details>
  <summary>Details</summary>
Motivation: To leverage quantum Amplitude Amplification in combinatorial optimization while addressing the challenges posed by NISQ capabilities.

Method: The protocol performs partial amplification using an Inner Iteration Finder to optimize rotation counts on initial variables, followed by a global GAS on the full search space, employing a Quantum Tree Generator for state preparation.

Result: The nested protocol demonstrated reduced costs for enhancing incumbent solutions compared to baseline GAS, especially for specific knapsack instances.

Conclusion: Efficient methods that lower circuit costs are essential for achieving quantum advantage in combinatorial optimization applications, particularly as problem scales increase.
...
### [96] [Quantum-Boosted Nonlinear Tunneling Driven by a Bright Squeezed Vacuum](https://arxiv.org/abs/2604.05783)
...
TL;DR: This paper reports the first experiment demonstrating that bright squeezed vacuum (BSV) can enhance nonlinear tunneling ionization in sodium atoms, achieving efficiency comparable to higher energy coherent light sources.


<details>
  <summary>Details</summary>
Motivation: To explore how quantum light can improve nonlinear processes like tunneling ionization, which is critical for applications in attosecond science and electron motion control.

Method: The experiment used bright squeezed vacuum (BSV) to induce tunneling ionization of a sodium atom, comparing its effects to those of a coherent light source.

Result: The BSV beam, at 300 nJ, matched the ionization efficiency of a 7.1 μJ coherent light source, illustrating a significant boost in nonlinear efficiency due to phase squeezing.

Conclusion: These results highlight the potential of quantum light to enhance nonlinear optical processes, suggesting future applications in efficient frequency conversion and controlled quantum reactions.
...
### [97] [Deviations from thermal light statistics in ensembles of independent two-level emitters](https://arxiv.org/abs/2604.05823)
*Manuel Bojer,André Cidrim,Romain Bachelard,Joachim von Zanthier*

Main category: quant-ph

TL;DR: This study explores how independent two-level atoms can emit thermal light, identifying specific conditions for this emission to align with Gaussian Moment Theorem.


<details>
  <summary>Details</summary>
Motivation: To clarify how independent two-level atoms can produce thermal light and the necessary conditions for this phenomenon.

Method: We analyze an ensemble of independent motionless two-level atoms, deriving necessary conditions on atom number and light emission characteristics for thermal light statistics to hold.

Result: Conditions are established for thermal light emission related to the atom count and the coherent-incoherent light emission ratio, applicable to both pure and mixed atomic states.

Conclusion: The findings enhance understanding of thermal light generation in independent atom ensembles, providing insights applicable to both theoretical and experimental setups.
...
### [98] [Quantum optomechanics of lossy bodies: general approach and structured squeezed vacuum effects](https://arxiv.org/abs/2604.05864)
*Alessandro Ciattoni*

Main category: quant-ph

TL;DR: This paper explores the optomechanical forces on a lossy macroscopic object under quantum illumination, deriving expressions that link quantum states to mechanical effects.


<details>
  <summary>Details</summary>
Motivation: To understand how quantum illumination affects mechanical interactions in macroscopic systems beyond thermal equilibrium.

Method: Utilized the Modified Langevin Noise Formalism to derive the Maxwell stress tensor's time-averaged expectation for non-equilibrium scenarios, and analyzed the implications using mixed quantum states and thermal equilibrium conditions.

Result: Demonstrated that using an anisotropic multimode squeezed vacuum state can engineer quantum fluctuations to produce a non-classical force, differing significantly from classical radiation pressure.

Conclusion: Developed a formalism for macroscopic quantum optomechanics that predicts quantum forces in regimes that transcend classical mean fields, contributing to the understanding of macroscopic quantum coherence.
...
### [99] [Fault-Tolerant One-Shot Entanglement Generation with Constant-Sized Quantum Devices in the Plane](https://arxiv.org/abs/2604.05870)
*Dylan Harley,Robert Koenig*

Main category: quant-ph

TL;DR: This paper presents a protocol that generates entanglement between distant qubits in a 2D grid, maintaining fidelity under noisy conditions, with efficient resource requirements and execution time.


<details>
  <summary>Details</summary>
Motivation: The need to produce reliable entanglement in quantum networks with inherent noise and resource constraints.

Method: A one-shot protocol is proposed that utilizes a rectangular grid of qubits and many-body entanglement to create constant-fidelity Bell pairs across large distances under stochastic Pauli noise.

Result: The protocol successfully generates distance-$R$ entanglement using a minimal qubit grid ($Θ(R)×Θ(\mathsf{poly}(\log R))$), achieving constant time execution and robustness to local noise.

Conclusion: This work demonstrates long-range localizable entanglement in 2D and forms the basis for a 2D stabilizer Hamiltonian with desired thermal properties.
...
### [100] [Dynamical decoupling and quantum error correction with SU(d) symmetries](https://arxiv.org/abs/2604.05871)
*Colin Read,Eduardo Serrano-Ensástiga,John Martin*

Main category: quant-ph

TL;DR: The paper presents a new framework for dynamical decoupling in qudit systems using Lie group representation theory, providing systematic methods for identifying decoupling groups and showcasing applications through new pulse sequences for qutrits and quantum error-correcting codes.


<details>
  <summary>Details</summary>
Motivation: The need for effective dynamical decoupling protocols in higher-dimensional qudit systems due to the limitations of existing techniques for qubits.

Method: A framework is developed based on Lie group representation theory to identify decoupling groups within finite subgroups of SU(d), with analysis of operator space components.

Result: New pulse sequences for interacting qutrits based on SU(3) subgroups were constructed, resulting in more practical protocols, and a unification of dynamical decoupling with quantum error correction was achieved.

Conclusion: The symmetry-based approach not only enhances dynamical decoupling techniques for multi-level systems but also facilitates the development of corresponding quantum error-correcting codes.
...
### [101] [Adaptive Deformation of Color Code in Square Lattices with Defects](https://arxiv.org/abs/2604.05874)
*Tian-Hao Wei,Jia-Xuan Zhang,Jia-Ning Li,Wei-Cheng Kong,Yu-Chun Wu,Guo-Ping Guo*

Main category: quant-ph

TL;DR: The paper proposes a universal superstabilizer scheme for addressing defects in color codes used in quantum error correction, enabling lower logical error rates and efficient handling of defects in quantum hardware.


<details>
  <summary>Details</summary>
Motivation: Existing defect adaptive methods focus primarily on surface codes, leaving a gap in systematic strategies for handling defects in other topological codes like color codes.

Method: A universal superstabilizer scheme is developed for managing defects in data qubits of arbitrary stabilizer codes, particularly focusing on isolated defects in color codes. Optimization techniques for ancilla qubit defects involve reusing nearby ancilla qubits and utilizing iSWAP gates.

Result: The proposed methods minimize resource waste and achieve lower logical error rates while supporting a full transversal Clifford gate set and lattice surgery operations.

Conclusion: The research provides a robust framework for implementing effective color codes on defect-prone quantum processors, paving the way for enhanced fault tolerance in quantum computing.
...
### [102] [Hybrid Quantum-Classical Algorithm for Hamiltonian Simulation](https://arxiv.org/abs/2604.05881)
*Nhat A. Nghiem,Tzu-Chieh Wei*

Main category: quant-ph

TL;DR: This paper introduces a hybrid classical-quantum algorithm for Hamiltonian simulation that utilizes classical diagonalization of operators and quantum block-encoding.


<details>
  <summary>Details</summary>
Motivation: To enhance the capabilities of quantum simulation algorithms, enabling practical simulations of physical systems on quantum computers.

Method: The proposed procedure involves three variants of classical diagonalization of known operators, followed by quantum block-encoding to obtain the evolution operator.

Result: The algorithm provides an efficient approach for simulating Hamiltonians, especially for commuting cases, and compares favorably with existing algorithms.

Conclusion: The hybrid framework expands the potential for quantum computing in simulating physical systems, and the work also explores a technique for quantum state preparation.
...
### [103] [Quantum advantage in transfer of quantum states](https://arxiv.org/abs/2604.05915)
*Andrei Stepanenko,Kseniia Chernova,Maxim Gorlach*

Main category: quant-ph

TL;DR: The paper demonstrates a clear instance of quantum advantage through time-optimal excitation transfer in a lattice, highlighting how quantum properties can improve efficiency over classical methods.


<details>
  <summary>Details</summary>
Motivation: To clarify the conditions under which quantum advantage exists, especially in large-scale systems, where its definition is often ambiguous.

Method: We analyze excitation transfer in a lattice with both nearest-neighbor and longer-range couplings, focusing on the time-optimal transfer of excitations influenced by quantum mechanics.

Result: The research shows that quantum propagation along multiple trajectories significantly reduces transfer time compared to classical paths, providing a definitive case of quantum advantage.

Conclusion: This work establishes a concrete example of quantum advantage in excitation transfer, contributing to understanding its applications in quantum technologies.
...
### [104] [Distributed Quantum Property Testing with Communication Constraints](https://arxiv.org/abs/2604.05962)
*Mina Doosti,Ryan Sweke,Chirag Wadhwa*

Main category: quant-ph

TL;DR: The paper presents a framework for distributed quantum inference under communication limits, focusing on quantum state certification with limited quantum communication between nodes and a central node.


<details>
  <summary>Details</summary>
Motivation: To extend the classical distributed inference model by incorporating quantum resources and investigate quantum state certification under communication constraints.

Method: The framework allows $m$ distributed nodes to communicate about an unknown quantum state $ρ$. It establishes sample complexity bounds for certification tasks under limited qubit communication and shared randomness.

Result: Shows that sample complexity is $\\mathcal{O}(\frac{d^2}{2^{n_q}ε^2})$ with public randomness, and establishes $Ω(\frac{d^3}{4^{n_q} ε^2})$ lower bounds in a private-coin setting, leveraging a quantum version of the Ingster-Suslina method.

Conclusion: Presents the first detailed characterization of distributed quantum state certification with communication limitations, offering insights and a framework for future research.
...
### [105] [Distributions of Noisy Expectation Values over Sets of Measurement Operators](https://arxiv.org/abs/2604.05973)
*Matthew Duschenes,Roger G. Melko,Juan Carrasquilla,Raymond Laflamme*

Main category: quant-ph

TL;DR: This paper generalizes the understanding of measurement probabilities in quantum algorithms by analyzing expectation values of measurement operators with random mixed quantum states, deriving expressions for their moments, and simulating their distributions in contexts of noise and circuit depth.


<details>
  <summary>Details</summary>
Motivation: To comprehend non-unitary dynamics in quantum systems by studying the distribution of expectation values in measurement probabilities.

Method: Utilizing combinatorial approaches to derive moment expressions, constructing empirical distributions via simulations of Haar random brickwork quantum circuits under local depolarizing noise, and comparing these to effective models.

Result: The empirical distributions align with a global-depolarizing-like model, showing peaks related to circuit depths and noise, while the distinctions between symmetric and non-symmetric measurement operators reveal different distribution behaviors.

Conclusion: The findings highlight unique characteristics of multi-modal distributions with non-symmetric measurement operators, raising future questions about their simulability.
...
### [106] [Quantum Machine Learning for particle scattering entanglement classification](https://arxiv.org/abs/2604.05986)
*Hala Elhag,Yahui Chai*

Main category: quant-ph

TL;DR: The study examines fermion density profiles as proxies for entanglement in particle scattering, using QCNNs and classical CNNs. It finds QCNNs outperform in accuracy and convergence, with optimal performance from a compact 4-qubit model.


<details>
  <summary>Details</summary>
Motivation: To simplify the evaluation of entanglement in particle scattering processes by utilizing accessible fermion density profiles instead of direct computational methods.

Method: The study uses Quantum Convolutional Neural Networks (QCNNs) and classical CNNs to classify entanglement across thresholds, specifically testing them on fermion scattering in the Thirring model.

Result: QCNNs consistently show better accuracy, faster convergence, and lower variance compared to classical CNNs, with an optimal configuration found in a compact 4-qubit QCNN model.

Conclusion: The research highlights the effectiveness of quantum and quantum-inspired models in deriving significant quantum information from simpler observables, relevant for fields like high-energy physics.
...
### [107] [Scaling Laws for Hybrid Quantum Neural Networks: Depth, Width, and Quantum-Centric Diagnostics](https://arxiv.org/abs/2604.06007)
*Danil Vyskubov,Kirill Vyskubov,Nouhaila Innan,Muhammad Shafique*

Main category: quant-ph

TL;DR: This study evaluates how hybrid quantum neural networks' performance and quantum behavior scale with circuit depth and qubit count, revealing trends and providing guidance for their optimization.


<details>
  <summary>Details</summary>
Motivation: To understand the scaling behavior of hybrid quantum neural networks for improved classification performance and to develop an evaluation protocol.

Method: A controlled scaling study was conducted by varying the number of quantum layers and qubits, using multiple datasets to assess predictive performance and quantum-specific metrics.

Result: Identified scaling trends, saturation regimes, and dataset sensitivity, revealing relationships between quantum metrics and predictive performance.

Conclusion: Provides guidance for choosing quantum layer and qubit configurations in hybrid quantum neural network classifiers and establishes a standardized scaling evaluation approach.
...
### [108] [Exploring bosonic bound states with parallel reaction coordinates](https://arxiv.org/abs/2604.06027)
*Guan-Yu Lai,Friedemann Queißer,Gernot Schaller*

Main category: quant-ph

TL;DR: The paper examines bound states in quantum systems strongly coupled to reservoirs, demonstrating their stability within band gaps through both exact and weak-coupling methods.


<details>
  <summary>Details</summary>
Motivation: Understanding bound states in quantum systems can aid in unraveling phenomena related to dissipation and energy stability when interacting with reservoirs.

Method: The study employs an exactly solvable bosonic model and a perturbative weak-coupling approach that includes a supersystem with multiple reaction coordinates representing the reservoir's spectral function.

Result: The analysis reveals that bound state stability hinges on energy placement within band gaps, and that weak interactions lead to finite lifetimes that can be extended by increasing system-reservoir coupling.

Conclusion: The findings highlight the nuanced behavior of bound states in varying reservoir configurations and the effects of system-reservoir interaction strength on state stability.
...
### [109] [Simulating Thermal Properties of Bose-Hubbard Models on a Quantum Computer](https://arxiv.org/abs/2604.06077)
*Simon Becker,Cambyse Rouzé,Robert Salzmann*

Main category: quant-ph

TL;DR: This paper introduces a general framework for efficient Gibbs sampling in bosonic many-body systems, demonstrating that these models can be effectively prepared using gapped dissipative generators, with implications for quantum computation.


<details>
  <summary>Details</summary>
Motivation: Exploring the complexity of quantum algorithms for infinite-dimensional systems, particularly bosonic models, which are less understood than their finite-dimensional counterparts.

Method: The authors develop a rigorous Gibbs sampling framework, proving the existence of gapped dissipative generators in relevant bosonic models, using Bose-Hubbard Hamiltonians as examples.

Result: The framework establishes exponential convergence to thermal states and enables efficient preparation of Gibbs states on qubit hardware.

Conclusion: This research provides a controlled methodology for Gibbs sampling in infinite-dimensional systems, with potential applications in quantum simulation, thermalization, and addressing many-body complexity.
...
### [110] [Gauss law codes and vacuum codes from lattice gauge theories](https://arxiv.org/abs/2604.06087)
*Javier P. Lacambra,Aidan Chatwin-Davies,Masazumi Honda,Philipp A. Hoehn*

Main category: quant-ph

TL;DR: This paper presents a framework for constructing quantum error correcting codes from Abelian lattice gauge theories using quantum reference frames, highlighting two types of codes and their relationships to gauge-invariant structures.


<details>
  <summary>Details</summary>
Motivation: To explore the link between quantum error correction and Abelian lattice gauge theories for improving quantum simulations.

Method: The authors develop quantum error correcting codes classified into Gauss law codes and vacuum codes, analyzing them using quantum reference frames within various gauge theories.

Result: Gauss law codes identify the full gauge-invariant sector, while vacuum codes focus on the vacuum sector, with insights on their equivalence and error structures depending on the gauge group's nature.

Conclusion: The framework reveals parallels between error correction and gauge theory, with implications for enhanced quantum simulations on noisy devices.
...
### [111] [Pixel-Translation-Equivariant Quantum Convolutional Neural Networks via Fourier Multiplexers](https://arxiv.org/abs/2604.06094)
*Dmitry Chirkov,Igor Lobanov*

Main category: quant-ph

TL;DR: This paper addresses the mismatch in translation equivariance between standard convolutional neural networks and quantum convolutional neural networks (QCNNs) based on data encoding, proposing a new architecture that maintains symmetry and improves trainability.


<details>
  <summary>Details</summary>
Motivation: The study aims to resolve discrepancies in translation equivariance between classical CNNs and QCNNs, particularly focusing on various encoding schemes.

Method: The authors formalize the relationship between pixel cyclic shift symmetry and QCNN layers, characterizing PCS-equivariant unitaries through the quantum Fourier transform and designing a deep PCS-QCNN with specific features like measurement-induced pooling and inter-layer QFT cancellation.

Result: A deep PCS-QCNN architecture is constructed that manages pixel cyclic shifts effectively and shows that the expected squared gradient norm remains stable across network depth.

Conclusion: The proposed architecture allows for enhanced training capabilities in QCNNs while avoiding issues related to depth-induced barren plateaus.
...
### [112] [Nonvariational quantum optimisation approaches to pangenome-guided sequence assembly](https://arxiv.org/abs/2604.06106)
*Josh Cudby,Sergii Strelchuk*

Main category: quant-ph

TL;DR: This study addresses the challenges of genome assembly from short-read sequencing data in repetitive regions by employing quantum optimization techniques to efficiently navigate the associated computational complexities.


<details>
  <summary>Details</summary>
Motivation: The difficulty in genome assembly arises from reference bias and complexity in repetitive regions, prompting the need for improved approaches like pangenome-guided sequence assembly (PGSA).

Method: The authors develop quantum optimization strategies utilizing two formulations: a quadratic unconstrained binary optimization (QUBO) and a novel higher-order binary optimization (HUBO), with the latter streamlining problem complexity. Using the Iterative-QAOA framework, they optimize computational efficiency while addressing variable and noise-related challenges.

Result: Through simulations, Iterative-QAOA successfully identifies optimal genome assemblies from extremely small fractions of candidate solutions, and preliminary tests on IBM quantum hardware yield comparable results.

Conclusion: This research highlights the potential of quantum optimization in resolving significant computational challenges in pangenome assembly, suggesting a promising avenue for future biological applications.
...
### [113] [Necessary and sufficient conditions for the N-representability of functionals of the one-electron reduced density matrix](https://arxiv.org/abs/2604.06127)
*Jannis Erhard,Paul W. Ayers*

Main category: quant-ph

TL;DR: This paper presents conditions for the N-representability of one-electron reduced density matrix functionals, which ensure accurate energy estimates in related theories.


<details>
  <summary>Details</summary>
Motivation: To provide a mathematical foundation for ensuring that one-electron reduced density matrix functionals yield reliable energy estimates across various systems.

Method: Establishment of necessary and sufficient conditions for the N-representability of functionals in one-electron reduced density matrix functional theory.

Result: Functionals that meet these conditions will yield variational upper bounds on true energy, while those that violate them may underestimate energy estimates.

Conclusion: The constraints identified will assist in developing new approximations and algorithms within density matrix functional theory.
...
### [114] [Shot-Based Quantum Encoding: A Data-Loading Paradigm for Quantum Neural Networks](https://arxiv.org/abs/2604.06135)
*Basil Kyriacou,Viktoria Patapovich,Maniraman Periyasamy,Alexey Melnikov*

Main category: quant-ph

TL;DR: The paper introduces Shot-Based Quantum Encoding (SBQE), a method for efficient data loading in quantum machine learning, achieving significant accuracy improvements over traditional encoding methods with minimal additional circuit complexity.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of current quantum data encoding methods that underutilize Hilbert-space capacity or require excessive circuit depths for practical quantum computing.

Method: SBQE uses a data-dependent classical distribution to allocate quantum shots across multiple states, treating shot counts as learnable parameters and representing data in a manner compatible with classical activation functions.

Result: SBQE demonstrates significant accuracy improvements, achieving 89.1% test accuracy on Semeion and 80.95% on Fashion MNIST, outperforming traditional amplitude encoding and linear multilayer perceptrons without the need for extra encoding gates.

Conclusion: SBQE offers a promising approach for efficient quantum data embedding, enhancing accuracy in quantum machine learning while remaining compatible with current hardware constraints.
...
### [115] [Light-Induced Quantum Self-Trapping of Vibrational Excitons in an Optical Cavity](https://arxiv.org/abs/2604.06142)
*Vincent Pouthier,Saad Yalouz*

Main category: quant-ph

TL;DR: This paper explores using optical cavities to achieve energy localization through Quantum Self-Trapping (QST) of vibrational excitons, demonstrating how light-matter coupling alters energy transfer dynamics across different regimes.


<details>
  <summary>Details</summary>
Motivation: The study aims to investigate energy localization in optical cavities, specifically through Quantum Self-Trapping, which contrasts with the commonly reported energy delocalization effects.

Method: A generalized Tavis-Cummings model is employed to analyze vibrational excitons' transport between anharmonic modes and their interaction with cavity photons.

Result: Two distinct regimes of energy transfer are observed: one where weak coupling leads to enhanced self-trapping and another where strong coupling facilitates accelerated energy transfer, with critical coupling strengths identified that demarcate the regimes.

Conclusion: Optical cavities can stabilize energy localization phenomena, suggesting new avenues for controlling energy flow in quantum systems.
...
### [116] [From generating functions to the geometric Binder cumulant](https://arxiv.org/abs/2604.06147)
*Balázs Hetényi*

Main category: quant-ph

TL;DR: This paper reviews the use of generating functions in quantum mechanics, focusing on their role in understanding fluctuations, geometric phases, and quantum phase transitions.


<details>
  <summary>Details</summary>
Motivation: The paper aims to elucidate how generating functions facilitate the understanding of fluctuations in quantum systems, especially in the context of polarization theory and phase transitions.

Method: The authors extend the original formalism for geometric phases to include quasiadiabatic cycles via a generalized Bargmann invariant, which acts as a generating function. They derive cumulants and use them to form geometric Binder cumulants that indicate critical phenomena.

Result: The generalized Binder cumulants developed are sensitive indicators of phenomena such as metal-insulator transitions, validated through example calculations on known localization models.

Conclusion: The approach demonstrates utility in identifying quantum phase transitions and complements other geometric quantities like fidelity susceptibility.
...
### [117] [Error Correction in Lattice Quantum Electrodynamics with Quantum Reference Frames](https://arxiv.org/abs/2604.06149)
*Elias Rothlin,Carla Ferradini,Lin-Qing Chen*

Main category: quant-ph

TL;DR: This paper explores the relationship between gauge symmetry and quantum error-correcting codes in lattice quantum electrodynamics, demonstrating how gauge theories can facilitate information protection against noise.


<details>
  <summary>Details</summary>
Motivation: To investigate whether gauge symmetry is merely a redundancy or has deeper significance, particularly in the context of quantum error-correcting codes (QECCs).

Method: The authors use group-theoretical methods to construct recovery operations for error sets in lattice quantum electrodynamics, creating QECC structures for both pure-gauge and fermionic sectors.

Result: They establish gauge-field and fermionic QRFs, revealing how physical information is encoded and how syndromes of gauge-violating errors can be resolved to identify correctable errors.

Conclusion: Lattice QED is shown to function as a QECC beyond the stabilizer framework, highlighting the role of gauge symmetry in providing an encoding structure that enables error correction.
