...
TL;DR: The study introduces a machine-learning method called 	extit{phast} for accurate reconstruction of photoelectron counts and timing from photomultiplier tube waveforms, overcoming challenges posed by electronic effects.


<details>
  <summary>Details</summary>
Motivation: Accurate extraction of photoelectron multiplicities and timing from PMT waveforms is critical in particle and nuclear physics experiments, yet challenging due to noise and electronic effects.

Method: The 	extit{phast} model employs a wave-transformer encoder with shared features and two branches: one for PE count prediction and another for time using a count-conditioned query decoder.

Result: The method showcases robust reconstruction performance, demonstrating high consistency in PE counting and timing across various waveform conditions constructed through Monte Carlo simulations.

Conclusion: Integrating convolutional feature extraction with transformer decoders is effective for addressing complex PMT waveform reconstruction issues.
...
TL;DR: The study explores dibaryon states $Ξ^0p$, $Ω^-p$, and $Ω^-n$ in $Υ(1S)$ and $Υ(2S)$ decays, finding no significant signals and establishing upper limits on their decay branching fractions.


<details>
  <summary>Details</summary>
Motivation: Understanding multistrange baryon-baryon interactions is crucial for neutron-star matter and previous studies suggest attractive $ΞN$ and $ΩN$ interactions, necessitating searches for weakly bound states.

Method: The analysis utilized samples from $102$ million $Υ(1S)$ and $158$ million $Υ(2S)$ decays collected with the Belle detector at KEKB, focusing on mass regions near baryon-pair thresholds.

Result: No significant signals were observed for the dibaryon states, leading to the establishment of upper limits for the branching fractions at $O(10^{-7})$-$O(10^{-6})$ depending on the decay channel and mass assumptions.

Conclusion: The findings set the first upper limits on the branching fractions for $Υ(1S)$ and $Υ(2S)$ decays into the targeted dibaryon states, contributing to the understanding of baryon interactions.
...
### [3] [First head-to-head comparison of agentic AI applied to the analysis of simulated data of the Einstein Telescope](https://arxiv.org/abs/2605.28916)
*Gianluca Inguglia*

Main category: astro-ph.IM

TL;DR: This study compares two AI systems, Claude Code and Codex, in executing a gravitational wave data analysis pipeline, revealing stark differences in performance, behavior, and manuscript generation despite convergence in scientific results.


<details>
  <summary>Details</summary>
Motivation: To assess the efficacy and behavior of advanced AI systems in autonomous scientific computing tasks, specifically in gravitational wave data analysis.

Method: Two AI agents, Claude Code and Codex, were tasked with the same data analysis pipeline under identical conditions, with experiments run twice across varying signal-to-noise ratios.

Result: While scientific outcomes were consistent, Claude Code completed tasks faster with deviations, while Codex exhibited longer run times with self-corrections and followed instructions precisely, leading to differences in generated manuscripts.

Conclusion: Behavioral differences between AI systems impact speed, auditability, and error handling, emphasizing the importance of clear instruction interpretation and data representation in AI-driven scientific workflows.
...
### [4] [Photometry is all you need: supernova classification as a mixing problem](https://arxiv.org/abs/2605.28922)
*Ana Sofía M. Uzsoy,V. Ashley Villar*

Main category: astro-ph.IM

TL;DR: This paper presents a robust method for classifying supernova populations using photometric light curves, achieving high accuracy without needing extensive spectroscopic data.


<details>
  <summary>Details</summary>
Motivation: The increasing volume of transient light curves necessitates efficient classification methods beyond spectroscopic follow-up.

Method: The classification is framed as a mixing problem, utilizing a semi-analytical SN model and Gaussian Mixture model to analyze observed light curves and optimize the population mixing fractions.

Result: Achieves ≥ 90% classification accuracy for SNe Ia and Ibc purely from photometry, validating the method across different population mixtures and including various information types.

Conclusion: The proposed method effectively enables rapid and accurate supernova classification and population analysis using only photometric data.
...
### [5] [Massive Stars in the Thirties: awaiting new Hubble discoveries](https://arxiv.org/abs/2605.28972)
*Lidia M. Oskinova,Sylvia Ekström,Miriam Garcia,Takashi Moriya,Andreas A. C. Sander,Sergio Simón-Díaz,Aida Wofford*

Main category: astro-ph.IM

TL;DR: The paper highlights the critical role of massive stars in galaxy evolution and identifies key uncertainties in their physics, proposing a plan for addressing these gaps through advanced observational techniques, particularly utilizing HST.


<details>
  <summary>Details</summary>
Motivation: Understanding massive stars is crucial for galaxy evolution, stellar populations, and cosmic phenomena like gravitational waves.

Method: Combining UV-optical spectroscopy, time-domain monitoring, and archival data to address open questions regarding massive stars and their environments in the 2030s.

Result: This approach aims to enhance knowledge about massive star populations, their winds, and binary systems across varied metallicities.

Conclusion: The outlined observational strategy is vital for future advancements in massive star research and securing HST's legacy in this field.
...
### [6] [Three-dimensional Conditional Diffusion Models for Cosmological 21 cm Lightcone Emulation](https://arxiv.org/abs/2605.29016)
*Bin Xia,John H. Wise*

Main category: astro-ph.IM

TL;DR: This paper explores conditional diffusion modeling for three-dimensional 21 cm lightcone emulation and identifies preprocessing as crucial for stable training and physical fidelity in generated lightcones.


<details>
  <summary>Details</summary>
Motivation: To develop robust methods for accurately emulating 3D 21 cm lightcones, addressing challenges related to skewed voxel distributions and memory limitations.

Method: The study compares various preprocessing techniques, dynamic-range compression, architecture depth, and training duration using a large dataset of training and validation lightcones. It evaluates the results with multiple diagnostics including brightness-temperature slices and the global signal.

Result: The Yeo-Johnson preprocessing combined with moderate amplitude compression showed the best balance between stability and fidelity, as assessed through mean absolute error and other diagnostics.

Conclusion: The findings establish a baseline for future 3D 21 cm emulation studies, highlighting the need for further work to reduce biases in higher-order statistics.
...
### [7] [Kolmogorov--Arnold Networks as Implicit Regularizers: Noise Robustness and Interpretability for Stellar Classification](https://arxiv.org/abs/2605.29039)
*Kristian Sestak*

Main category: astro-ph.IM

TL;DR: This study evaluates Kolmogorov--Arnold Networks (KAN 2.0) against Multi-Layer Perceptrons (MLP) and XGBoost for stellar classification, revealing that KAN's noise robustness stems from implicit regularization rather than architecture, with potential improvements noted when combining predictions from MLP and KAN.


<details>
  <summary>Details</summary>
Motivation: To determine if KAN 2.0 offers better noise robustness than MLP and XGBoost in classifying astronomical objects.

Method: A comparative analysis of classification accuracy at varying signal-to-noise ratios (SNR), evaluating the effects of weight decay and feature importance techniques.

Result: KAN shows a 9 percentage point advantage over MLP at SNR=5, but this gap closes with regularized MLP. Analysis indicates varying performance degradation across classes, with stars performing the worst at low SNR.

Conclusion: KAN serves as an auto-regularizer with enhanced interpretability, and a hybrid prediction pipeline can elevate performance in low-SNR scenarios.
...
### [8] [Development and demonstration of a Modular Astrobiological Experiments (MAEx) payload for autonomous biological monitoring in Low Earth Orbit (LEO)](https://arxiv.org/abs/2605.29308)
...
TL;DR: The Modular Astrobiology Experiment (MAEx) platform facilitates autonomous biological research under spaceflight conditions by integrating various sensing technologies to study diverse biological systems.


<details>
  <summary>Details</summary>
Motivation: The need for research in unique spaceflight conditions that affect biological systems and present opportunities for biomanufacturing.

Method: MAEx is a compact 3U payload designed for autonomous operation, incorporating imaging and spectroscopic techniques to characterize biological samples.

Result: Demonstrated versatility by analyzing different biological systems, including bacteria, fungi, and proteins, under conditions relevant to space.

Conclusion: MAEx enables multimodal biological characterization in microgravity, paving the way for future orbital biomanufacturing and biofabrication research.
...
### [9] [Extending Hubble into the 2030s to Resolve the Physics of LyC Escape](https://arxiv.org/abs/2605.30035)
...
TL;DR: The paper discusses the role of star-forming galaxies in cosmic reionization and the importance of high-resolution ultraviolet observations for understanding the escape of ionizing photons.


<details>
  <summary>Details</summary>
Motivation: To ascertain the efficiency of ionizing photon escape from galaxies and its implications for cosmic reionization, especially given the challenges of direct observation at high redshifts.

Method: The paper examines low-resolution UV observations from HST, discusses the influence of stellar feedback on LyC escape, and emphasizes the need for high-resolution spectroscopy for a deeper understanding.

Result: Current evidence suggests that stellar feedback is crucial in regulating LyC escape, but additional high-resolution data are needed to clarify the mechanics of galactic winds and their effects.

Conclusion: Extending HST's operational life and focusing on ultraviolet observations are crucial for enhancing our understanding of cosmic reionization mechanisms and for future missions like the HWO.
...
### [10] [From Images to Orbits: A Hubble 2030s Astrometric Legacy for the M31-M33 Star Cluster Systems](https://arxiv.org/abs/2605.30249)
*Borja Anguiano,Benjamin J. Gibson,Sten Hasselquist*

Main category: astro-ph.IM

TL;DR: The paper advocates for a Hubble-focused initiative to leverage existing imaging data and create a comprehensive astrometric legacy by 2030, enhancing our understanding of star clusters in the Local Group.


<details>
  <summary>Details</summary>
Motivation: To leverage HST’s unique capability in the 2030s, specifically its long-term observational baseline, for the study of star clusters in the Local Group.

Method: Implement a Hubble Local Group Astrometric Legacy by combining future observations with existing archival data, focusing on star clusters in M31 and M33, and delivering transverse velocity products through MAST.

Result: This approach would result in a systematic orbital mapping of star clusters beyond the Milky Way, providing insights into disk heating, cluster dynamics, and mass distributions in the Local Group.

Conclusion: The proposed program not only enhances astrophysical understanding but also strengthens calibration standards necessary for optical/UV observations in future astronomical endeavors.
...
### [11] [Measurements and simulations of X-ray radiation damage effects on CNM n-type 4H-SiC MOS capacitors](https://arxiv.org/abs/2605.29375)
...
TL;DR: The paper investigates radiation-induced surface damage at the 4H-SiC/SiO2 interface in MOS capacitors and develops a TCAD model to simulate these effects.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of using silicon carbide in high-radiation environments by understanding surface damage mechanisms.

Method: Experimental measurements of capacitance-voltage characteristics combined with TCAD simulation to analyze fixed oxide charge and interface trap density after X-ray irradiation.

Result: A dose-dependent TCAD model was created and validated, accurately reproducing C-V characteristics over all radiation doses tested.

Conclusion: The model serves as a baseline for further predictive simulations of n-type 4H-SiC detector performance under radiation exposure.
...
### [12] [Effect of increased DCR on the detection of minimum-ionizing particles with SiPMs](https://arxiv.org/abs/2605.29600)
*Katjana Neumann,Massimiliano Antonello,Lukas Brinkmann,Erika Garutti,Jörn Schwandt*

Main category: physics.ins-det

TL;DR: Radiation damage to SiPMs increases dark current, degrading MIP detection efficiency; this can be simulated using LED illumination, isolating the effect of dark-count rate.


<details>
  <summary>Details</summary>
Motivation: To understand how radiation damage affects SiPM performance in high-granularity calorimeters for CMS experiments.

Method: Used a plastic scintillator tile and a SiPM to detect MIPs from a 90Sr source, comparing responses to radiation exposure with those simulated via increased dark-count rate using an LED light source.

Result: Both radiation damage and LED-induced DCR increases cause similar decreases in MIP signal and signal-to-noise ratio, highlighting elevated dark-count rate as the main factor in performance degradation.

Conclusion: Controlled optical illumination can replicate radiation damage effects on SiPMs, offering a practical method for testing and enhancing SiPM performance under radiation-like conditions.
...
### [13] [Thin single-crystal perovskite detector for high-energy charged particles](https://arxiv.org/abs/2605.29764)
...
TL;DR: This paper presents the first demonstration of a thin organometal halide perovskite (OMHP) crystal as a radiation detector for high-energy charged particles, showcasing advantages like direct growth on substrates and self-healing properties post-radiation exposure.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of OMHPs for detecting high-energy charged particles, addressing gaps in existing research on their effectiveness for such applications.

Method: A thin single OMHP crystal, approximately 150 micrometers thick, was grown on a patterned substrate using a dewetting technique, along with the development of dedicated electronics for synchronization with the crystal's response.

Result: The device successfully detected high-energy charged particles with energies of hundreds of MeV, demonstrating a high dynamic range of incident fluxes.

Conclusion: This work highlights the feasibility and advantages of using thin OMHP crystals for high-energy radiation detection, paving the way for future advancements in radiation monitoring technology.
...
### [14] [The relative interfacial thermal contraction as a possible origin of the low-energy excess in cryogenic calorimeters](https://arxiv.org/abs/2605.30194)
*Vanessa Zema,Pasquale Pavone*

Main category: physics.ins-det

TL;DR: This paper investigates the low-energy excess (LEE) in cryogenic calorimeters linked to thermal-contraction mismatches, proposing a model and new detector designs to mitigate these effects.


<details>
  <summary>Details</summary>
Motivation: The study addresses the rising low-energy excess (LEE) in cryogenic calorimeters that limits their sensitivity in rare-event searches.

Method: The authors describe the LEE as induced by thermal contraction mismatches between the absorber and supporting materials, supported by an elastic model and double-TES module designs for surface background rejection.

Result: The paper confirms that the thermal boundary resistance and related dislocations can explain the LEE in double-TES modules, alongside discussions of new detector designs.

Conclusion: Proposed modifications to detector designs aim to test and reduce the impact of the LEE, ensuring improved performance in rare-event searches.
...
### [15] [Characterization of Spurious Charge in SENSEI Skipper-CCDs](https://arxiv.org/abs/2605.30281)
...
TL;DR: This paper analyzes and mitigates spurious charge in Skipper-CCDs, improving the detection of dark matter and neutrino interactions.


<details>
  <summary>Details</summary>
Motivation: The objective is to enhance the sensitivity of Skipper-CCDs in detecting rare events like sub-GeV dark matter and neutrino-nucleus scattering, hindered by spurious charge generation.

Method: The research characterizes the spurious charge in Skipper-CCDs and introduces a tri-level clocking scheme to minimize charge generation during readout.

Result: Under standard conditions, the serial-register single-electron density was measured at $(2.9 	imes 10^{-5})$ electrons/pixel/image, reduced to $(4.0 	imes 10^{-6})$ with the tri-level clocking, showing a factor of 7 improvement.

Conclusion: The tri-level clocking technique significantly reduces spurious charge, enhancing background suppression in Skipper-CCD experiments.
...
### [16] [A Minimal Dark $SU(2)$ Origin of a Massless Dirac Neutrino](https://arxiv.org/abs/2605.28923)
*P. S. Bhupal Dev,Julia Gehrlein,Amartya Sengupta,Amarjit Soni*

Main category: hep-ph

TL;DR: The paper presents a model for a rank-two Dirac neutrino mass matrix, ensuring one massless neutrino while adhering to oscillation and cosmological constraints, utilizing a minimal dark gauge symmetry with implications for dark matter.


<details>
  <summary>Details</summary>
Motivation: To explain the origin of neutrino masses with a mechanism that allows for one massless neutrino, consistent with experimental data.

Method: Introduce a minimal dark SU(2)_D gauge symmetry, restricting a right-handed neutrino's Yukawa coupling and leading to a specific fermionic structure to maintain quantum consistency.

Result: The proposed model eliminates one neutrino mass while satisfying neutrino oscillation data and produces an anomaly-free dark sector with potential dark matter candidates.

Conclusion: The construction links neutrino mass dynamics to a confining dark sector, suggesting new insights into both neutrino properties and dark matter.
...
### [17] [Bump Hunting Inside Jets with Energy Correlators](https://arxiv.org/abs/2605.28934)
*Lorenzo Ricci,Marc Riembau,Minho Son*

Main category: hep-ph

TL;DR: The study investigates how new physics affects energy correlators in jets, providing methods for identifying these effects as bumps in scaling behavior, specifically testing this with a light hadrophilic $Z'$.


<details>
  <summary>Details</summary>
Motivation: The motivation is to understand how new physics impacts energy correlators, which are fundamental in studying collinear dynamics in QCD.

Method: The authors use unitarity and positivity assumptions to classify and constrain new physics signatures, focusing on the identification of angular resonances over a smooth scaling background.

Result: They derive projected LHC sensitivity for a hypothetical light hadrophilic $Z'$, demonstrating that their approach yields competitive constraints compared to existing searches.

Conclusion: The findings suggest that energy correlator measurements can effectively uncover new physics by identifying deviations from expected performance in jet formations.
...
### [18] [Neural Scaling Laws for Jet Generation](https://arxiv.org/abs/2605.28940)
*Oz Amram,Darius A. Faroughy,Tjarko Gerdes,Anna Hallin,Gregor Kasieczka,Michael Krämer,Humberto Reyes-Gonzalez,David Shih*

Main category: hep-ph

TL;DR: The paper examines scaling laws for foundation models, specifically in particle jet generation, revealing logarithmic scaling for model size but weaker scaling for dataset size and compute.


<details>
  <summary>Details</summary>
Motivation: To investigate if scaling laws observed in foundation-type models apply to particle jet generation, aiding both training and simulation.

Method: The study replicates scaling law behavior using next token prediction loss and sliced Wasserstein distance for physical quantities, analyzing the relationships between these metrics.

Result: Logarithmic scaling is found for model size, with weaker scaling noted for dataset size and compute; a learnable window concept is introduced to explain behavior.

Conclusion: Next token prediction loss is a good proxy for physics performance, with the study contributing to understanding the differences between generative models and traditional supervised learning in collider physics.
...
### [19] [FunKit: A computer algebra toolkit for functional approaches](https://arxiv.org/abs/2605.28935)
*Franz R. Sattler*

Main category: hep-ph

TL;DR: FunKit is a Mathematica package designed for deriving functional equations from master equations, featuring extensions for specialized systems and supporting code export.


<details>
  <summary>Details</summary>
Motivation: The package aims to streamline the derivation and tracing of functional equations from various master equations encountered in field theory.

Method: FunKit offers a vocabulary of expressions, tracing capabilities, and allows for user-defined extensions, while facilitating export to programming languages like C++, Julia, and Fortran.

Result: The tool enhances efficiency in handling complex tensor expressions and enables numerical evaluation of derived results.

Conclusion: FunKit is versatile, compatible with various equation systems, and can be used independently or alongside other packages, improving the functionality of existing tools in theoretical physics.
...
TL;DR: This study explores dark matter candidates in standard model extensions with electroweak triplet scalars or fermions. Key findings indicate that while the scalar triplet with $Y=0$ is ruled out due to detection constraints, the $Y=2$ triplet candidates are also excluded due to detection limits. However, the $Y=0$ fermion triplet remains viable within certain experimental sensitivities.


<details>
  <summary>Details</summary>
Motivation: To investigate the dark matter phenomenology within minimal extensions of the standard model that include electroweak triplet scalars or fermions.

Method: The authors analyze the parameter space of these triplet extensions against cosmological relic abundance and experimental constraints, focusing on direct and indirect detection limits.

Result: Scalar triplets with hypercharge $Y=0$ are excluded, while scalar and fermionic triplets with $Y=2$ are ruled out due to detection limits. The $Y=0$ fermion triplet remains a viable candidate.

Conclusion: The viable parameter space for the $Y=0$ fermion triplet dark matter overlaps with future experimental sensitivities, highlighting avenues for indirect detection and collider studies.
...
### [21] [Visible inelasticity as a probe of tau flavor content of astrophysical neutrinos](https://arxiv.org/abs/2605.29105)
*Alex Y. Wen,Carlos A. Argüelles,Sergio Palomares-Ruiz*

Main category: hep-ph

TL;DR: The paper explores a novel method to measure tau neutrino flux using visible inelasticity in starting track events, offering competitive sensitivity in distinguishing tau from muon neutrinos.


<details>
  <summary>Details</summary>
Motivation: Astrophysical neutrinos allow for the study of neutrino flavor variations over large distances, but current detection methods are limited by rarity.

Method: The study examines using visible inelasticity in tracks from muonic decays of tau leptons compared to muon neutrino interactions in neutrino telescopes such as IceCube.

Result: The proposed method demonstrates competitive sensitivity to the tau-to-muon flux ratio, $R_{τμ}$, with existing IceCube data.

Conclusion: This technique may enhance flavor measurements from individual astrophysical sources and facilitate the identification of tau-dominated source catalogs.
...
### [22] [Heavy Axion from a Confining Mirror GUT](https://arxiv.org/abs/2605.28954)
*Giacomo Cacciapaglia,Csaba Csáki,Teng Ma*

Main category: hep-ph

TL;DR: The paper presents a framework for addressing the strong CP problem using a heavy axion within mirror symmetry and grand unification, proposing a solution that mitigates sensitivity to Planck scale corrections and enables new directions in theoretical physics.


<details>
  <summary>Details</summary>
Motivation: To provide a viable explanation for the strong CP problem while avoiding fine tuning and constraints from additional phases in GUT Yukawas.

Method: Utilizing a heavy axion in a mirror GUT framework that remains unbroken and dynamically generates a mass scale through confinement.

Result: Models yield a heavy axion potential that is robust against Planck scale modifications and support the existence of electric dipole moments detectable in future studies.

Conclusion: This framework opens avenues for advancements in GUT model building, axion physics, dark matter, and cosmological implications.
...
### [23] [Alignment and Enhanced Multi-Higgs Production](https://arxiv.org/abs/2605.29345)
*Subhojit Roy,Carlos E. M. Wagner*

Main category: hep-ph

TL;DR: The paper identifies scenarios where multi-Higgs boson final states are the main indicators of new physics at the LHC, challenging traditional expectations.


<details>
  <summary>Details</summary>
Motivation: To explore new pathways for discovering physics beyond the Standard Model, particularly through multi-Higgs production channels at the LHC.

Method: The authors analyze extended scalar-sector scenarios with higher-dimensional interactions and suppressed Higgs-scalar mixing, leading to enhanced multi-Higgs decay patterns.

Result: They find that scenarios such as single-scalar extensions and two-singlet frameworks can produce observable multi-Higgs signatures through gluon fusion, despite leading to the same final states.

Conclusion: Distinct kinematic features from different realizations provide insight into the underlying dynamics, indicating a new avenue for exploring particle physics.
...
### [24] [Dynamical Tsallis WIMP Freeze-Out and Residual Memory Channels in the Radiation Sector](https://arxiv.org/abs/2605.29132)
*Matias P. Gonzalez*

Main category: hep-ph

TL;DR: This work extends the thermal decoupling of dark matter using Tsallis nonextensive statistics, addressing how deviations from standard thermal behavior affect neutrino energy density and cosmological parameters.


<details>
  <summary>Details</summary>
Motivation: The study aims to explore how nonextensive statistics can modify dark matter freeze-out and its consequences for cosmic background radiation, enhancing understanding of dark matter's impacts on cosmology.

Method: It utilizes $q$-deformed distribution functions derived from maximum entropy principles under Curado-Tsallis constraints, with the Tsallis parameter evolving dynamically based on dark matter mass to assess relic abundance and its influence on radiation sectors.

Result: The research computes relic abundance for varying dark matter masses and initial Tsallis parameters, leading to an adjusted value of the effective number of neutrino species ($N_{m eff}$), compatible with current cosmological observations.

Conclusion: The findings suggest that incorporating nonextensive properties of dark matter can align well with existing cosmological constraints, providing new insights into dark matter's role in the early universe.
...
### [25] [Hiding in the Shadow of the Upsilon: Ditaus from a Light Pseudoscalar](https://arxiv.org/abs/2605.29289)
*Matthew R Buckley,David Shih,Isaac R Wang*

Main category: hep-ph

TL;DR: The CMS collaboration reports a notable measurement of $Υ$ decays to ditau involving $61.9~{m fb}^{-1}$ of data, revealing inconsistencies with previous findings that could suggest new physics.


<details>
  <summary>Details</summary>
Motivation: To investigate potential violations of lepton flavor universality in the context of $Υ$ decays and their implications for new physics.

Method: The study introduces a model involving a light pseudoscalar that mixes with two Higgs doublets near the $Υ(1S)$ mass, showing that it decays primarily to taus.

Result: The measured ditau decay rate is significantly larger than that in dimuon final states, and inconsistent with B-factory measurements, suggesting new physics.

Conclusion: If confirmed, this violation of lepton flavor universality points to the need for new physics, with testable predictions derived from the proposed model.
...
### [26] [High-Quality Axion Dark Matter without Isocurvature Problem](https://arxiv.org/abs/2605.29370)
*Masahiro Kawasaki,Jie Sheng,Tsutomu T. Yanagida*

Main category: hep-ph

TL;DR: This paper explores a mechanism to suppress axion fluctuations in high-scale inflation, addressing the isocurvature constraint and predicting axion parameter space for future experiments.


<details>
  <summary>Details</summary>
Motivation: The need to comply with CMB constraints on axion dark matter fluctuations during high-scale inflation.

Method: Introducing a gauge-invariant operator that increases the effective axion mass during inflation, leveraging discrete gauge symmetry.

Result: The proposed mechanism maintains a high-quality axion and effectively suppresses fluctuations, resolving the isocurvature problem caused by large axion domain wall numbers.

Conclusion: This approach offers a solution to both the axion quality and isocurvature problems, with predictions that can be tested in future experiments.
...
### [27] [Charmonium production at SPS and FAIR energies](https://arxiv.org/abs/2605.29479)
*Taesoo Song,Jiaxing Zhao,Joerg Aichelin,Elena Bratkovskaya*

Main category: hep-ph

TL;DR: The study employs the Remler formalism to analyze charmonium production and dissociation in baryon-rich environments during heavy-ion collisions at SPS and GSI/FAIR energies.


<details>
  <summary>Details</summary>
Motivation: To understand how baryon-rich matter influences charmonium behavior in heavy-ion collisions.

Method: The Remler formalism is first validated in p+p collisions, then extended to p+A collisions to derive the nuclear absorption cross section, which is subsequently used in heavy-ion collisions.

Result: The formalism accurately describes charmonium production at SPS energies, especially when incorporating an in-medium heavy quark potential that triggers $J/ψ$ dissociation near the critical temperature $T_c$.

Conclusion: The study successfully applies the Remler formalism to estimate charmonium production at GSI/FAIR energies.
...
### [28] [Polyakov-loop potential of accelerated gluonic matter and subtlety in thermodynamics](https://arxiv.org/abs/2605.29503)
*Hao-Lei Chen,Kenji Fukushima,Yu-Han Gao,Xu-Guang Huang,Yusuke Shimada,Zhi-Bin Zhu*

Main category: hep-ph

TL;DR: This study explores the one-loop Polyakov-loop effective potential in gluonic matter under constant acceleration, using both Euclidean Rindler and optical spacetimes to resolve discrepancies in previous works.


<details>
  <summary>Details</summary>
Motivation: To investigate the effects of constant acceleration on the Polyakov-loop effective potential in pure gluonic matter, and to clarify relationships between various formulations and energy-momentum components.

Method: The authors performed computations in both Euclidean Rindler spacetime and optical spacetime, identifying connections to the energy-momentum tensor components and resolving earlier discrepancies related to conical backgrounds.

Result: The study concludes that minimizing the effective potential in the optical metric leads to the finding that real acceleration enhances deconfining properties, while also yielding insights into the behavior under imaginary acceleration.

Conclusion: There are notable similarities and differences between systems under imaginary acceleration and rotation, suggesting rich underlying physics related to acceleration effects.
...
### [29] [Quantum field theory of massive chiral fields](https://arxiv.org/abs/2605.29646)
*Massimo Blasone,Petr Jizba,Luca Smaldone*

Main category: hep-ph

TL;DR: The paper presents a quantum-field-theoretic approach to massive chiral fields, confirming previous findings and deriving new uncertainty relations.


<details>
  <summary>Details</summary>
Motivation: To establish a quantum-field-theoretic framework for massive chiral fields that maintains chirality and helicity properties of particles.

Method: Utilizes quantum field theory to analyze chiral fields and derive relations consistent with weak-interaction processes.

Result: The framework reproduces the chiral oscillation formula and introduces novel chiral-energy uncertainty relations.

Conclusion: This approach provides a coherent description of chiral fields in weak interactions.
...
### [30] [Thermodynamics in symmetry-improved Cornwall-Jackiw-Tomboulis formalism: application to the low-energy effective theory of QCD](https://arxiv.org/abs/2605.29701)
*Yuepeng Guan,Mamiya Kawaguchi,Shinya Matsuzaki,Akio Tomiya*

Main category: hep-ph

TL;DR: This study explores the thermodynamics of the SICJT formalism in low-energy QCD, analyzing pressure prescriptions and thermodynamic observables near the chiral transition.


<details>
  <summary>Details</summary>
Motivation: To improve the symmetry properties of the 2PI theory through the SICJT formalism, while ensuring consistent thermodynamic interpretation of pressure.

Method: Employing the SICJT formalism, multiple pressure prescriptions are formulated and analyzed using the three-flavor linear sigma model with quarks across the chiral transition.

Result: Global thermodynamic structure remains stable across different pressure prescriptions, with notable quantitative differences near the crossover and first-order transition region.

Conclusion: The findings establish a framework for thermodynamically consistent observables in symmetry-improved 2PI approaches.
...
### [31] [HyperPrecision: A Mathematica package for High-Precision Numerical Evaluation of Multivariate Hypergeometric Functions](https://arxiv.org/abs/2605.30216)
*Sumit Banik,Souvik Bera*

Main category: hep-ph

TL;DR: HyperPrecision is a Mathematica package for high-precision evaluation of Horn-type multivariate hypergeometric functions, addressing challenges in convergence and analytic continuation.


<details>
  <summary>Details</summary>
Motivation: High-precision evaluation of multivariate hypergeometric functions is essential for various applications in physics and mathematics, yet remains computationally challenging.

Method: HyperPrecision constructs the Pfaffian system of partial differential equations for hypergeometric functions and utilizes the Frobenius method to solve it along a specific contour defined by the parameters.

Result: The package successfully evaluates key multivariate hypergeometric functions and demonstrates its applicability in multiple areas, including angular integrals and Feynman integrals.

Conclusion: HyperPrecision provides a robust solution for the challenging computation of high-precision hypergeometric functions, facilitating their broader use in scientific research.
...
### [32] [Analytic Properties of the Jost Functions via the Poincaré-Picard Theorem](https://arxiv.org/abs/2605.28859)
*Yannick Mvondo-She*

Main category: quant-ph

TL;DR: The paper investigates the analyticity of Jost functions in quantum scattering through parameter-dependent differential equations, showing that transformed Jost functions are single-valued and analytic in complex energy.


<details>
  <summary>Details</summary>
Motivation: Understanding the analytic properties of Jost functions is crucial in quantum scattering theory and for analytic continuation of the scattering matrix.

Method: The study derives a first-order differential system from the radial Schrödinger equation, factorizes momentum-dependent terms, and applies classical analytic dependence theory.

Result: It demonstrates that the transformed Jost functions are single-valued analytic functions of complex energy for finite radial distance.

Conclusion: The paper concludes with a geometric interpretation of the factorization in relation to the Riemann surface topology.
...
### [33] [Quantum and Thermal Properties of the Klein-Gordon Inverted Harmonic Oscillator with Physical Applications](https://arxiv.org/abs/2605.28875)
*Kevin Hernández*

Main category: quant-ph

TL;DR: The paper presents a framework for analyzing a Klein-Gordon scalar field in an inverted harmonic potential, allowing for calculations of thermal properties and applications in various physical scenarios.


<details>
  <summary>Details</summary>
Motivation: To systematically investigate the quantum and thermal characteristics of a Klein-Gordon scalar field under an inverted harmonic potential.

Method: The authors utilize a non-Hermitian momentum transformation and a symplectic phase-space rotation to simplify the field's dynamics, enabling the derivation of partition functions and expressions for thermodynamic quantities.

Result: Closed-form expressions for free energy, entropy, and thermal correlation functions were derived, applicable to multiple physical contexts including cosmology and condensed matter.

Conclusion: The framework reconciles disparate results in existing literature and offers novel predictions regarding the spectral density and entanglement entropy in unstable quantum systems.
...
### [34] [A tutorial on Dirac quantisation by analysing the problem of a ball on an inclined plane as a Hamiltonian system with constraints](https://arxiv.org/abs/2605.28878)
*M. F. Araujo de Resende,Thales Machado F*

Main category: quant-ph

TL;DR: The paper reviews the Dirac quantization of constrained Hamiltonian systems, exemplified by a solid ball rolling down an incline, highlighting the transition from classical to quantum mechanics through the Dirac-Bergmann algorithm.


<details>
  <summary>Details</summary>
Motivation: The aim is to analyze Dirac quantization methods using a relatable physical example, providing insights into holonomic and non-holonomic constraints, as well as gauge systems.

Method: The study uses a solid ball rolling down an incline to explore the dynamics and applies the Dirac-Bergmann algorithm for transitioning from classical to quantum mechanics, transitioning from Dirac brackets to commutators.

Result: The Hamiltonian operator's restriction to the physical Hilbert subspace leads to the same Schrödinger equation derived in intrinsic terms, demonstrating the consistency of Dirac quantization.

Conclusion: This reinforces the robustness of the Dirac quantization approach in handling constraints within Hamiltonian systems.
...
### [35] [Meta-Quantum Ensemble Framework for Robust Network Intrusion Detection](https://arxiv.org/abs/2605.28879)
*Ritvik Bhatnagar,Nouhaila Innan,Angel Arul Jothi J.,Muhammad Shafique*

Main category: quant-ph

TL;DR: This study explores the use of heterogeneous quantum learners in Intrusion Detection Systems (IDS) to enhance detection performance and reduce false positives, proposing a novel framework that combines Quantum Support Vector Machines and Quantum Neural Networks through a meta-learning approach.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of high detection sensitivity and strict false-positive constraints in IDS, particularly given class imbalance and varying IoT traffic.

Method: The study employs a hybrid framework, System-Level Meta-Quantum Ensemble (MQE), that integrates outputs from Quantum Support Vector Machines and Quantum Neural Networks using a Random Forest meta-learner to capture consensus and divergence in predictions.

Result: Experiments indicate that the MQE framework outperforms standalone quantum learners in terms of performance and reliability across multiple datasets.

Conclusion: Meta-level fusion is an effective approach for enhancing the reliability of quantum machine learning in IDS applications.
...
TL;DR: This paper investigates polar fidelities, Holevo bases, and unitary factors in the context of the Afham-Ferrie theory, establishing properties of polar fidelities and addressing specific open problems in the field.


<details>
  <summary>Details</summary>
Motivation: The study seeks to address unresolved issues in the Afham-Ferrie theory related to the mathematical understanding of generalized fidelities.

Method: It analyzes one-sided polar fidelities and their symmetry, proving that these functions are monotonic on specified intervals, and explores the categorization of Holevo bases and unitary factors.

Result: The paper demonstrates that polar paths correspond to fidelity intervals on [-1, 1] and identifies specific conditions under which certain realizations fail, while providing classifications of Holevo bases and relevant unitary factors.

Conclusion: The findings clarify the structure of generalized fidelities and challenge previous assumptions about unitary constraints, notably disproving a particular inclusion regarding special unitaries.
...
TL;DR: The paper explores how environmental factors impact entanglement in quantum systems, focusing on the interaction of two spins in a bosonic environment to optimize quantum information devices.


<details>
  <summary>Details</summary>
Motivation: To address the challenges posed by decoherence in quantum computing and to explore the beneficial interactions that can promote entanglement.

Method: The study examines the time evolution of two spins interacting via a bosonic environment, analyzing entanglement through negativity across various environmental models.

Result: Conditions were established to maximize spin entanglement by optimizing environmental parameters, resulting in models that reduce decoherence effects.

Conclusion: An effective unitary operator was derived to describe the system's evolution, showing that minimal decoherence yields significant entanglement, enhancing the viability of quantum information devices.
...
TL;DR: The paper derives sharp uncertainty relations for variances in position and momentum spaces, indicating a minimum product bound.


<details>
  <summary>Details</summary>
Motivation: To explore the fundamental limits of uncertainty relations in various theories of light, including classical and quantum contexts.

Method: The authors derive these relations by analyzing the variances in the position and momentum spaces for different light beam theories.

Result: The derived uncertainty relation $ΔrΔk	extgreater= 5/2$ holds true across classical, quantum coherent, and individual photon theories.

Conclusion: The findings indicate a consistent minimum product of position and momentum uncertainties across different frameworks of light theory.
...
TL;DR: The paper addresses the understanding of strong and weak symmetries in quantum systems, presenting a local approach to the concept of strong-to-weak symmetry breaking and introducing the notion of von Neumann symmetries.


<details>
  <summary>Details</summary>
Motivation: The paper aims to clarify the nature of strong and weak symmetries in quantum many-body systems, particularly focusing on the phenomenon of spontaneous symmetry breaking.

Method: It utilizes a rigorous definition of strong symmetry applicable in infinite volume and presents several equivalent formulations, including local charge coherence, to analyze symmetry breaking locally.

Result: The authors provide a comprehensive framework for diagnosing strong symmetries and detail the emergence of von Neumann symmetries as intermediaries between strong and weak symmetries, including new anomaly constraints.

Conclusion: The findings enhance the understanding of symmetry in quantum systems, offering a more localized perspective on strong and weak symmetry relationships.
...
TL;DR: The paper explores how quantum methods can be used to efficiently compute topological invariants directly from classical datasets, rather than relying on resource-intensive combinatorial constructions.


<details>
  <summary>Details</summary>
Motivation: To improve the efficiency of computing topological invariants from classical datasets using quantum techniques, circumventing the challenges of resource-intensive combinatorial approaches.

Method: Investigate various quantum encodings that directly interact with the classical dataset to determine which ones best preserve topological invariants for analysis.

Result: Identified promising quantum encodings that maintain the essential topological characteristics from classical datasets, ultimately facilitating faster computations of topological features through quantum algorithms.

Conclusion: The study marks a significant advancement towards optimizing quantum TDA by prioritizing direct data encodings versus conventional combinatorial constructions.
...
### [41] [Learning quantum ground states in the space of measurement outcomes](https://arxiv.org/abs/2605.28931)
*Kartiek Agarwal*

Main category: quant-ph

TL;DR: The paper explores autoregressive neural networks for variational learning of quantum many-body ground states in measurement space, utilizing SIC-POVM and emphasizing the role of constraints and neural network architectures.


<details>
  <summary>Details</summary>
Motivation: To directly represent quantum many-body ground states in measurement space and assess the effectiveness of neural networks in learning these states efficiently.

Method: The method involves representing quantum states as probability distributions derived from SIC-POVM, optimized using gradient descent while incorporating positivity constraints through autoregressive neural networks (GRUs).

Result: The approach is benchmarked against prominent quantum models, such as the transverse-field Ising model and the Heisenberg model, showcasing successful learning of ground states for system sizes up to L=128.

Conclusion: The study demonstrates that the enforcement of positivity constraints and architectural variety in neural networks significantly enhances the efficacy of variational learning in quantum systems.
...
TL;DR: This paper analyzes resource requirements for high-fidelity logical magic state generation on silicon spin-qubit platforms, comparing various architectures and error correcting codes, and demonstrating significant overhead reductions through optimized control sequences.


<details>
  <summary>Details</summary>
Motivation: To improve the efficiency and performance of magic-state generation in quantum computing, specifically in silicon spin-qubit platforms.

Method: The study involves a comparative analysis of different architectures and error correction codes, using a noise model based on a silicon-processor Hamiltonian, leading to estimations of required physical resources for target logical error rates.

Result: Optimized control pulses reduce magic-state distillation overhead by 42%, and biased error-correcting codes reduce the physical footprint by approximately threefold compared to surface codes without the need for bias-preserving operations.

Conclusion: The research offers a framework for evaluating resource optimization strategies in silicon-based quantum computing, highlighting key methods that can lead to substantial improvements in hardware efficiency.
...
TL;DR: Quantum mechanics enhances zero-error communication in permutation channels, allowing for significantly more distinguishable messages compared to classical methods.


<details>
  <summary>Details</summary>
Motivation: To explore the capabilities of quantum communication in scenarios where information is transmitted without positional identity due to potential reordering.

Method: Analyzed cyclic reorderings and dihedral permutation channels, deriving formulas for distinguishable messages with classical and quantum protocols, including ancilla-assisted methods.

Result: Quantum protocols can recover the identity-channel value and exceed classical scaling, with ancilla assistance further increasing the number of distinguishable messages.

Conclusion: The findings demonstrate a clear quantum advantage in communication and storage amidst positional uncertainty.
...
TL;DR: This study presents novel methods for pricing derivatives on quantum devices that outperform classical techniques and reduce qubit requirements for specific option contracts.


<details>
  <summary>Details</summary>
Motivation: To enhance the efficiency of pricing derivatives using quantum computing, addressing limitations in classical methods and qubit requirements.

Method: The authors developed methods that leverage quantum devices for pricing derivatives, specifically focusing on options with path-dependent payoffs.

Result: The new methods provide an exponential reduction in the qubit requirements compared to existing quantum Monte Carlo approaches.

Conclusion: The proposed methods highlight the potential of quantum computing to significantly improve derivative pricing, particularly in complex scenarios.
...
### [45] [Prime Number Identification Demonstrated with Quantum Processors Using a New Rescaling-Based Noise Mitigation Technique](https://arxiv.org/abs/2605.28964)
*Victor F. dos Santos,Victor P. Brasil,Pedro A. S. Contri,Jonas Maziero*

Main category: quant-ph

TL;DR: The paper presents a quantum protocol for identifying prime numbers using IBM quantum processors, involving entanglement dynamics and noise mitigation techniques.


<details>
  <summary>Details</summary>
Motivation: The study aims to improve prime number identification utilizing quantum computing amidst the challenges posed by experimental noise.

Method: The protocol links primality to Fourier components derived from entanglement dynamics in a bipartite system, incorporating a noise-mitigation strategy based on rescaling factors.

Result: The introduction of a new analytical bound for Fourier modes improves the differentiation between prime and composite numbers, even with moderate noise.

Conclusion: These findings advance the potential for practical applications in number theory using noisy intermediate-scale quantum devices.
...
### [46] [Local Strong-to-Weak Spontaneous Symmetry Breaking](https://arxiv.org/abs/2605.28967)
*Francisco Divi,Leonardo A. Lessa,Chong Wang*

Main category: quant-ph

TL;DR: The paper introduces a local definition of strong-to-weak spontaneous symmetry breaking (SW-SSB) using a one-point fidelity correlator, improving detection in large systems and ensuring well-definedness in the thermodynamic limit.


<details>
  <summary>Details</summary>
Motivation: To enhance the understanding and detection of strong-to-weak spontaneous symmetry breaking in quantum systems, particularly in large sizes and thermodynamical contexts.

Method: A local one-point fidelity correlator is proposed, enabling easier detection and maintaining relevance in the thermodynamic limit, contrasting with the traditional two-point fidelity correlators.

Result: The local SW-SSB framework retains essential properties like stability under symmetric channels and long-range conditional mutual information, validated through examples and universal scaling behavior analysis in critical systems.

Conclusion: The local formulation provides a robust framework for studying SW-SSB in critical systems, analogous to local thermalization, with implications for defect problems in quantum states.
...
### [47] [Atom--photon Entanglement with a Single Trapped Cesium Atom](https://arxiv.org/abs/2605.28968)
*H. Hwang,J. Moon,F. Herzallah,E. Oh,A. Safari,M. Saffman*

Main category: quant-ph

TL;DR: The paper demonstrates entanglement between a single cesium atom and a photon, achieving high fidelity values and establishing a quantum interface for future networking.


<details>
  <summary>Details</summary>
Motivation: To explore atom-photon entanglement and leverage the properties of cesium atoms for quantum networking applications.

Method: Resonant excitation of a single cesium atom leads to spontaneous decay, entangling the atom's Zeeman state with the polarization of emitted photons, which are collected and analyzed.

Result: Achieved raw entanglement fidelity of 0.942 and inferred fidelity of 0.962 after error corrections, showing significant entanglement generation.

Conclusion: The demonstrated Cs atom-photon interface advances the understanding of quantum communication and sets the stage for dual-species quantum networking.
...
### [48] [Comparing Classical Simulation and Sample-Based Learning of Quantum Systems: Learning the Hardness of Quantum Systems from Samples](https://arxiv.org/abs/2605.28986)
*João Pedro Del Rey,Raúl O. Vallejos,Fernando de Melo*

Main category: quant-ph

TL;DR: This paper explores the empirical relationship between classical simulation and learning from quantum measurement data, focusing on how simulation complexity relates to learning difficulty in neural networks.


<details>
  <summary>Details</summary>
Motivation: To understand how different classical resources affect the ability to simulate quantum systems and learn from their measurements.

Method: Utilized a deep energy-based generative model on measurement samples from quantum states, tuning entanglement and non-stabilizerness while analyzing learning difficulty through neural-network complexity metrics.

Result: Increased simulation hardness is correlated with sharper loss landscapes and poorer reconstruction performance, indicating a relationship between simulation complexity and learning difficulty.

Conclusion: Empirical observations suggest that training dynamics of neural networks reflect quantum computational hardness, implying a connection between classical learnability and simulation complexity.
...
TL;DR: This paper presents a novel method to enhance image contrast in weakly scattering media using spatio-temporally entangled photon pairs, improving upon traditional techniques like time gating and spatial filtering.


<details>
  <summary>Details</summary>
Motivation: To enhance the image contrast of objects in weakly scattering media, particularly where traditional methods are impractical.

Method: The method involves using coincidence detection and post-selection on spatially correlated events from spatio-temporally entangled photon pairs to isolate ballistic photons and eliminate background light.

Result: Numerical simulations and experimental results demonstrate improved image contrast through correlation post-selection, even though this leads to increased shot noise.

Conclusion: The approach offers a promising avenue for quantum imaging in scenarios where conventional techniques fail.
...
### [50] [Quantum Crossovers Revealed by Local Measurements](https://arxiv.org/abs/2605.29019)
*A. C. S. Costa,E. C. Diniz,O. P. de Sa Neto*

Main category: quant-ph

TL;DR: This study identifies quantum crossover phenomena in open quantum systems using local measurements, linking local quantum Fisher information to crossover behavior and challenging the utility of quantum steering ellipsoid volume as a universal indicator.


<details>
  <summary>Details</summary>
Motivation: Understanding quantum crossover phenomena in few-body open quantum systems is crucial, yet traditionally relies on less robust global or model-dependent indicators.

Method: The authors utilize local measurements to characterize quantum crossovers, focusing on local quantum Fisher information and the behavior of the local Bloch vector.

Result: They find that while quantum steering ellipsoid volume does not universally indicate crossover, specific regimes reveal sensitivities in local measurements related to crossover transitions.

Conclusion: The study establishes a crucial geometric distinction between local and global indicators of quantum crossover behavior.
...
### [51] [A Quantum Algorithm for Simulating Nonunitary Dynamics Governed by Nonautonomous Linear Ordinary Differential Equations](https://arxiv.org/abs/2605.29052)
*Pouya Khazaei,Eitan Geva*

Main category: quant-ph

TL;DR: This paper presents a quantum algorithm that simulates nonunitary dynamics without requiring prior knowledge of the nonunitary propagator, using singular value decomposition and suitable dilation techniques.


<details>
  <summary>Details</summary>
Motivation: There is a need for efficient methods to solve nonautonomous linear ordinary differential equations in quantum computing, especially when dealing with nonunitary dynamics that cannot be captured by existing algorithms which require known propagators.

Method: The proposed algorithm utilizes singular value decomposition (SVD) to express the nonunitary propagator as a sum of unitary operators, performing the necessary dilation directly on quantum hardware without needing the propagator's closed-form expression.

Result: The algorithm successfully simulates the nonunitary dynamics of a photoinduced charge transfer process, demonstrating effectiveness and noise sensitivity on quantum hardware.

Conclusion: This method offers a novel approach to treating nonunitary dynamics in quantum systems and expands the applicability of quantum computing to a broader range of dynamic processes.
...
### [52] [A hidden bottleneck in classical and quantum linear reservoir computing](https://arxiv.org/abs/2605.29071)
*Johannes Nokkala,Federico Centrone,Francesco Arzani*

Main category: quant-ph

TL;DR: Linear reservoir computers have a hidden limitation in processing capacity due to their inherent linear dynamics, which restricts fixed-delay expressive power; however, single-photon operations can exceed this limitation, offering new potential for quantum reservoir computing.


<details>
  <summary>Details</summary>
Motivation: To explore limitations in the information processing capacity of linear reservoir computers and to highlight the potential of quantum reservoir computing.

Method: The study analyzes linear reservoir dynamics, revealing that they can only redistribute, but not create new expressive power. It derives a Gaussian limit specifically for covariance-based quantum reservoirs and conducts numerical experiments using single-photon operations.

Result: Findings indicate that single-photon operations surpass the Gaussian limit, implying they are a true resource for quantum reservoir computing and revealing non-Gaussian processing potential in specific systems.

Conclusion: The research uncovers significant limitations in linear reservoir computing while demonstrating that single-photon operations enhance processing capabilities, indicating a pathway for advanced quantum information processing.
...
### [53] [Local diagnostics for strong-to-weak spontaneous symmetry breaking and non-equilibrium phase transitions](https://arxiv.org/abs/2605.29113)
*Carolyn Zhang*

Main category: quant-ph

TL;DR: This paper investigates $	ext{Z}_2$-symmetric local dynamics, highlighting transitions between strong-paramagnetism and spontaneous symmetry breaking (SWSSB) across dimensions.


<details>
  <summary>Details</summary>
Motivation: To explore the behavior of Markov/Lindblad dynamics and understand transitions between different symmetry phases, particularly in the context of absorbing states and symmetry breaking.

Method: A combination of absorbing-state constructions and Toom's rule variants, alongside the introduction of a marginal fidelity correlator that acts as a local proxy for calculating fidelity order parameters.

Result: In 1+1d, transitions exhibit scaling consistent with a known universality class, while in 2+1d, evidence of a stable regime and a clear transition into an active SWSSB regime is found. The marginal fidelity correlator shows promising bounds in various state classes.

Conclusion: Marginal fidelities serve as a reliable, model-independent diagnostic for SWSSB in absorbing-state transitions, addressing the non-universal nature of microscopic defects in characterizing these transitions.
...
### [54] [Quantum error correction and fault tolerance: A comprehensive tutorial](https://arxiv.org/abs/2605.29137)
*Daniel J. Spencer,Shubham P. Jain,Andrew Tanggara,Zeen Sun,Tobias Haug,Derek Khu,Kishor Bharti*

Main category: quant-ph

TL;DR: This paper provides a comprehensive tutorial on quantum error correction (QEC), detailing core concepts, code families, and recent advancements in the field.


<details>
  <summary>Details</summary>
Motivation: To address the significant challenge noise presents in quantum computing by detailing techniques available for error correction without altering quantum information.

Method: The tutorial outlines key QEC concepts such as codes, syndromes, stabilizers, and fault tolerance, while also discussing established and novel code families including topological, subsystem, bosonic, qudit, dynamical codes, and qLDPC codes.

Result: Readers gain operational knowledge on QEC, learning how to design codes, diagnose errors, and implement fault-tolerant computation in quantum systems.

Conclusion: The tutorial serves as an accessible introduction for newcomers and a coherent reference for researchers, facilitating a deeper understanding of current research directions in QEC.
...
### [55] [Modular non-Hermitian topology and its application to critical sensing](https://arxiv.org/abs/2605.29173)
*Saubhik Sarkar,Chiranjib Mukhopadhyay,Abolfazl Bayat*

Main category: quant-ph

TL;DR: The paper explores the enhancement of sensing performance in non-Hermitian topological systems with modular structures, emphasizing their unique properties and criticality for precision metrology.


<details>
  <summary>Details</summary>
Motivation: To investigate the unique phenomena associated with non-Hermitian topological systems and their practical applications in sensing technology.

Method: The authors analyze modular structures with specific coupling variations and their impact on topological attributes such as the non-Hermitian skin effect and bulk-boundary correspondence.

Result: Demonstrates that modular structures enhance sensing performance, particularly near spectral topological phase transitions and in multi-parameter estimation scenarios.

Conclusion: The findings highlight the potential of modular non-Hermitian topological systems for improved precision metrology.
...
### [56] [A Variational Quantum Algorithm for Nonlinear Finite Element Analysis of Hyperelastic Materials](https://arxiv.org/abs/2605.29181)
*Uditnarayan Kouskiya,Caglar Oskay*

Main category: quant-ph

TL;DR: The manuscript presents a variational quantum method for tackling nonlinear elasticity in hyperelastic materials using near term quantum devices.


<details>
  <summary>Details</summary>
Motivation: To harness quantum computing for solving complex nonlinear elasticity problems that are challenging for classical methods.

Method: Combines variational quantum algorithms with classical optimization, utilizing polynomial approximations for strain energy density in hyperelastic models, implemented on NISQ devices.

Result: The method was practically demonstrated on a NeoHookean material model, with varying polynomial orders affecting accuracy and efficiency.

Conclusion: The proposed approach is feasible for current quantum hardware, suggesting a pathway for practical applications in material science.
...
### [57] [Fundamental limitations on entanglement extraction from purity](https://arxiv.org/abs/2605.29197)
*Tulja Varun Kondra,Pedro Barrios Hita,Justus Neumann,Hermann Kampermann,Dagmar Bruß*

Main category: quant-ph

TL;DR: The study investigates the purity threshold required for generating entanglement, identifying types of separable states and introducing a new criterion for separability based only on eigenvalues.


<details>
  <summary>Details</summary>
Motivation: To determine the minimum purity required for a state to facilitate entanglement generation, given the experimental challenges of high-purity states.

Method: The authors characterize a new class of states termed 'completely absolutely separable' and derive a sufficient condition for separability based on eigenvalues and local dimensions.

Result: Some absolutely separable states can generate entanglement through probabilistic protocols; a new sufficient condition for separability is established.

Conclusion: The research enhances the understanding of separability and entanglement generation, providing new tools for analyzing quantum states.
...
### [58] [Hybrid Gaussian-exponential zero-noise extrapolation for periodic circuits](https://arxiv.org/abs/2605.29242)
*Tao Wang,Yun Shang*

Main category: quant-ph

TL;DR: This paper presents a hybrid extrapolation method reducing gate errors in quantum circuits by enhancing noise modeling without prior characterization.


<details>
  <summary>Details</summary>
Motivation: To improve the accuracy of zero-noise extrapolation methods amidst varying error models in quantum computing.

Method: A hybrid Gaussian-exponential extrapolation scheme is developed, specifically for circuits with periodic structures, incorporating a log-normal distribution for noise amplification.

Result: The new model shows significant bias reductions in error mitigation for various quantum algorithms, outperforming existing techniques.

Conclusion: The hybrid approach enhances performance in error suppression on current quantum hardware, demonstrating practical applicability.
...
### [59] [Permutation Matrix Representation for Quantum Simulation: Comparative Resource Analysis](https://arxiv.org/abs/2605.29279)
*Hriday Sabharwal,Itay Hen*

Main category: quant-ph

TL;DR: This paper compares the permutation matrix representation method for Hamiltonian simulation with other quantum algorithms, highlighting its advantages in resource efficiency in both time-independent and time-dependent regimes.


<details>
  <summary>Details</summary>
Motivation: The study aims to evaluate the efficiency of the PMR method against established quantum algorithms, particularly focusing on resource costs in quantum simulations.

Method: The comparison involves benchmarking PMR against quantum signal processing (QSP) and qubitization for time-independent Hamiltonians, and against the quantum highly oscillatory protocol (qHOP) for time-dependent Hamiltonians.

Result: PMR shows complementary advantages, offering better resource efficiency and scaling with certain system parameters compared to other methods.

Conclusion: The findings suggest that PMR could be beneficial for practical applications on resource-constrained quantum hardware.
...
### [60] [Candidate collapse-noise correlators from Generalized Trace Dynamics: a Hubble-scale spectral line under structural assumptions](https://arxiv.org/abs/2605.29374)
*Tejinder P. Singh*

Main category: quant-ph

TL;DR: The paper presents a structure for collapse-noise correlators using Generalized Trace Dynamics (GTD), establishing a method that deviates from minimal GTD through structural postulates, yielding a spectrum at the Hubble scale that's not constrained by existing CSL bounds.


<details>
  <summary>Details</summary>
Motivation: To develop a framework for candidate CSL-type collapse-noise correlators that is rooted in a robust mathematical structure rather than phenomenological fitting.

Method: The method involves constructing a two-point function for a collapse-noise operator using a modified Grassmann algebra and specific structural postulates, leading to effective quantum treatments with canonical quantization.

Result: The resulting calculations indicate a narrow-band spectrum at the Hubble scale, consistent with cosmological parameters and avoiding conflict with current CSL bounds.

Conclusion: The framework provides a new perspective on collapse-noise correlators with implications for cosmological scales, illustrating a shift from traditional minimal forms based on the introduction of auxiliary structures.
...
### [61] [Total, quantum, and classical measures of anticoherence for mixed spin states](https://arxiv.org/abs/2605.29436)
*Jérôme Denis,Tara Lacaille,John Martin,Eduardo Serrano-Ensástiga*

Main category: quant-ph

TL;DR: This paper introduces a framework for analyzing mixed-state anticoherent spin states, distinguishing between classical and quantum contributions to their isotropy.


<details>
  <summary>Details</summary>
Motivation: The study aims to explore the nature of anticoherent spin states and their applications in quantum metrology and reference-frame alignment, especially in relation to mixed states.

Method: An axiomatic framework for mixed-state $t$-anticoherence is proposed, distinguishing total and quantum $t$-anticoherence using symmetric qubit embedding and measures based on state purity and entanglement.

Result: The paper elucidates explicit mixed-state examples, identifies states with maximal quantum anticoherence, and examines robustness against particle loss, along with a trade-off analysis between purity and anticoherence order.

Conclusion: The findings enhance the understanding of anticoherent states, contributing to the development of quantum technologies by clarifying the distinction between quantum and classical contributions to isotropy.
...
### [62] [High-Fidelity ROI CT Reconstruction with Limited Quantum Resources via Hybrid Classical-Quantum Refinement](https://arxiv.org/abs/2605.29472)
*Hyunju Lee,Jeonghwa Lee,Kyungtaek Jun*

Main category: quant-ph

TL;DR: This paper presents a hybrid quantum optimization framework for CT reconstruction that focuses on region-of-interest (ROI) refinement to enhance image quality while managing variable constraints effectively.


<details>
  <summary>Details</summary>
Motivation: Traditional quantum optimization methods struggle with large or complex objects in CT reconstruction due to the high number of binary variables needed for full image representation.

Method: A two-stage approach is proposed: first, a global image is reconstructed using classical or quantum methods, followed by quantum optimization focusing on a selected ROI to refine the image.

Result: Experiments indicate that the proposed method achieves accurate ROI reconstructions, with SART combined with quantum methods showing the lowest reconstruction errors for moderate-size cases.

Conclusion: The study demonstrates that utilizing classical methods for global reconstruction while reserving quantum techniques for local ROI refinement optimizes CT imaging outcomes.
...
### [63] [Near surface donor-acceptor pairs in hydrogenated homoepitaxial diamond nanolayers](https://arxiv.org/abs/2605.29492)
*A. M. Romshin,A. P. Bolshakov,A. A. Zhivopistsev,A. V. Gritsienko,O. S. Kudryavtsev,P. A. Pivovarov,V. G. Ralchenko,I. I. Vlasov*

Main category: quant-ph

TL;DR: Hydrogen-terminated diamond exhibits p-type surface conductivity through hole accumulation. This study shows that surface acceptors can form optically active DAPs with nitrogen donors, with interlayer thickness enabling tunable donor-acceptor separation and unique optical properties.


<details>
  <summary>Details</summary>
Motivation: The research aims to explore the optical properties of hydrogen-terminated diamond surfaces and their interaction with nitrogen donors to enhance quantum emitter technologies.

Method: A nominally undoped CVD interlayer was inserted between a nitrogen-rich HPHT substrate and a hydrogen-terminated surface, allowing precise control over the donor-acceptor separation.

Result: Bright, narrow DAP recombination lines were observed, with characteristics varying according to the interlayer thickness, demonstrating single-photon statistics and polarization anisotropy.

Conclusion: The study reveals a link between surface transfer doping and optical activity in diamond, establishing a platform for tunable DAP-based quantum emitters.
...
### [64] [Quantum Markovian Dynamics from a Double Covariance Stochastic Framework](https://arxiv.org/abs/2605.29508)
*Andrei Khrennikov*

Main category: quant-ph

TL;DR: Development of the Double Covariance Model (DCM) to describe macroscopic quantum dynamics through microscopic fluctuations and coarse-graining.


<details>
  <summary>Details</summary>
Motivation: To create a comprehensive framework that transitions from stochastic microscopic behaviors to deterministic macroscopic phenomena in quantum systems.

Method: Introduced a closed evolution equation via multi-scale Itô calculus and sliding-window averaging, accounting for fast and slow temporal scales in dynamics.

Result: The emergent dynamics follows the GKSL form, with Hamiltonian evolution from deterministic flow and dissipative channels from noise correlations; the model also shows how non-separable interactions can arise from local feedback.

Conclusion: The model integrates both open and closed quantum dynamics, reducing to the von Neumann equation in the fluctuation-free limit.
...
### [65] [Performance Analysis of Underwater Quantum Key Distribution Protocols: BB84, SARG04, and BBM92](https://arxiv.org/abs/2605.29513)
*Nour Rizk,Angélique Drémeau,Arnaud Coatanhay*

Main category: quant-ph

TL;DR: This study evaluates the performance of three underwater quantum key distribution protocols under different seawater conditions, focusing on quantum bit error rates and channel correlations.


<details>
  <summary>Details</summary>
Motivation: To ensure secure quantum communication in underwater environments where traditional methods may fail due to channel impairments.

Method: Analyzed BB84, SARG04, and BBM92 protocols using a model for quantum channel impacts with Kraus operators; validated results through Monte Carlo simulations.

Result: Analytical expressions for the quantum bit error rate were derived and validated, showing how performance varies with water type and conditions.

Conclusion: Identified optimal conditions for achieving effective and secure underwater quantum communications across different protocols.
...
### [66] [Non-Clifford Crosstalk Noise in Surface Codes Using Hybrid Stabilizer-Tensor Network Methods](https://arxiv.org/abs/2605.29514)
*Ben Harper,Azar C. Nakhl,Martin Sevior,Muhammad Usman*

Main category: quant-ph

TL;DR: This paper explores the impact of coherent quantum crosstalk noise on quantum error correction, revealing increased logical error rates and lower code thresholds compared to traditional noise models.


<details>
  <summary>Details</summary>
Motivation: The work aims to address the limitations of classical simulations of quantum error correction by incorporating coherent noise models, which are often overlooked in existing analyses.

Method: The authors employ advanced hybrid stabilizer-tensor network simulation techniques to model the effects of coherent quantum crosstalk noise during syndrome extraction in a surface code framework.

Result: The inclusion of coherence in the noise models leads to higher logical error rates and a reduced code threshold, with the specific noise distribution significantly affecting the outcomes.

Conclusion: This research introduces a novel approach to simulate complex noise models, offering valuable insights into the challenges of quantum error correction in realistic noisy environments.
...
### [67] [Ground-state estimation of the Heisenberg model on frustrated lattices with Sample-based Krylov Quantum Diagonalization](https://arxiv.org/abs/2605.29521)
*Calvin Brooks,Henry Zou,Trevor David Rhone*

Main category: quant-ph

TL;DR: The paper presents SKQD to estimate the ground state of antiferromagnetic spin models, showing improved accuracy over prior VQE results and establishing a new benchmark for quantum simulations of frustrated lattices.


<details>
  <summary>Details</summary>
Motivation: To address challenges in simulating frustrated lattices relevant to quantum spin liquid phases using both classical and quantum algorithms.

Method: Sample-based Krylov Quantum Diagonalization (SKQD) applied to the antiferromagnetic XXZ Heisenberg model on various lattice geometries, with tailored modifications for spin models.

Result: SKQD achieves sub-percent energy errors for up to 24 spins, outperforming previous variational results. It extends the simulation capacity to 72 spins, though accuracy degrades beyond 24 spins.

Conclusion: SKQD provides a scalable, hardware-compatible method for quantum simulations of strongly correlated spin systems, setting a new benchmark despite accuracy limitations at larger sizes.
...
### [68] [Rademacher Complexity Bounds for Parameterized Quantum Circuits Generated by Pauli Strings](https://arxiv.org/abs/2605.29546)
*Hiroshi Ohno*

Main category: quant-ph

TL;DR: This paper analyzes the Rademacher complexity of parameterized unitaries generated by Pauli strings, deriving scaling bounds and suggesting advantages over classical models.


<details>
  <summary>Details</summary>
Motivation: To clarify the understanding of Rademacher complexity in quantum machine learning, specifically for parameterized unitaries using Pauli strings, where existing bounds are less transparent.

Method: The study derives Rademacher complexity scaling bounds based on the number of parameters and training samples, providing explicit formulas for both full and restricted parameter domains.

Result: The derived complexity bounds are $	ext{O}(rac{L^{rac{3}{2}}}{	ext{√}M})$ for the full parameter domain and $	ext{O}(rac{L}{	ext{√}M})$ for the restricted domain, demonstrating potential advantages over classical models.

Conclusion: Numerical experiments support the derived scaling results, indicating a possible statistical-complexity advantage in quantum models with norms scaling with parameters.
...
### [69] [Quantum Subliminal Learning](https://arxiv.org/abs/2605.29557)
*Shi-Xin Zhang,Yu-Qin Chen*

Main category: quant-ph

TL;DR: This paper explores subliminal learning in quantum models, demonstrating distinct transmission characteristics in classical and quantum neural networks when learning from observable interfaces.


<details>
  <summary>Details</summary>
Motivation: To investigate the phenomenon of subliminal learning in machine learning models, particularly how it extends to quantum neural networks (QNNs).

Method: Analyzed two distillation pathways: an auxiliary channel on random inputs and a restricted task channel, examining the transmission of hidden behavioral traits for QNNs and classical neural networks.

Result: Classical neural networks transmit minimal hidden-task information through public-task interfaces, while QNNs retain most hidden-task signals, revealing architecture dependence in subliminal learning efficiency.

Conclusion: These findings raise security concerns for quantum model supply chains and offer insights into controlled hidden-information transfer in quantum information processing.
...
TL;DR: This paper explores a single-spin experiment providing insights into Bell inequality violations, suggesting that Bell-type correlations arise from sequential measurements rather than implying non-locality.


<details>
  <summary>Details</summary>
Motivation: To address the conceptual implications of Bell inequality violations and their connection to non-locality in quantum mechanics.

Method: The authors introduce a sequential, single-spin experiment and draw a counterfactual equivalence between its correlations and those observed in two-spin entangled systems.

Result: The findings indicate that Bell-type correlations can be viewed as a different manifestation of sequential measurements, thereby reframing our understanding of non-locality in quantum mechanics.

Conclusion: The apparent non-locality is explained as a result of measuring values that are not predefined, emphasizing the impact of the sequential nature of spin measurements.
...
TL;DR: The paper reveals that recoil heating from photon scattering in optical trapping can be significantly suppressed using microcavities, challenging existing assumptions about heating rates.


<details>
  <summary>Details</summary>
Motivation: Understanding and mitigating decoherence in optical trapping due to recoil heating is essential for preparing nonclassical motional states.

Method: A theoretical framework based on macroscopic quantum electrodynamics and few-mode quantization is developed to analyze the recoil heating rate in the presence of electromagnetic structures.

Result: The proposed method indicates that recoil heating rates can be substantially reduced in state-of-the-art microcavities, improving the prospects for nonclassical state preparation.

Conclusion: The findings suggest that careful design of photonic structures can enhance control over motional decoherence in levitated optomechanics.
...
### [72] [Error-corrected phase estimation averaged over variable grids on a trapped-ion quantum computer: hyperacuity spectra of a CO molecule adsorbed onto $χ$-Fe$_5$C$_2$](https://arxiv.org/abs/2605.29674)
*Taichi Kosugi,Hirofumi Nishi,Keito Kasebayashi,Hiroki Takahashi,Yu-ichiro Matsushita*

Main category: quant-ph

TL;DR: The paper presents a new method called QPE averaged over variable grids (QAVG) for improving quantum phase estimation in many-electron systems, effectively overcoming challenges related to low resolution and noise, and demonstrating its application on a CO molecule using a quantum computer.


<details>
  <summary>Details</summary>
Motivation: The need for better methods to extract excitation spectra of many-electron systems due to limitations in current quantum phase estimation techniques, specifically low grid resolution and environmental noise.

Method: The QAVG method utilizes low-resolution quantum phase estimation combined with origin shifts and continuous parametrization to improve spectrum reconstruction, implemented within an end-to-end workflow for a CO molecule system on a specific surface.

Result: QAVG enables accurate reconstruction of excitation spectra with significantly smaller deviations than standard QPE resolution, even in noisy environments. It stabilizes the optimization of parameters by averaging cost landscapes across shifted grids, reducing local minima from spectral leakage.

Conclusion: QAVG provides a promising and robust approach for quantum simulations of correlated spectra, paving the way for applications in early-fault-tolerant quantum computing.
...
### [73] [Channel-agnostic finite-temperature phase estimation averaged over variable grids: reconstruction of Green's function for dynamical mean-field theory](https://arxiv.org/abs/2605.29681)
*Taichi Kosugi,Hirofumi Nishi,Keito Kasebayashi,Hiroki Takahashi,Yu-ichiro Matsushita*

Main category: quant-ph

TL;DR: This paper presents a quantum-classical hybrid method for dynamical mean-field theory (DMFT), utilizing modified quantum phase estimation for efficient extraction of Green's functions at finite temperatures.


<details>
  <summary>Details</summary>
Motivation: The motivation is to effectively treat correlated electronic systems using quantum computers, aiming to improve the efficiency and accuracy of dynamical mean-field theory.

Method: The method involves a quantum part that uses modified quantum phase estimation circuits to obtain spectral amplitudes and excitation energies, combined with a classical approach called QPE averaged over variable grids for estimating the Green's function.

Result: The approach, termed QAVG-DMFT, was successfully applied to SrVO$_3$, demonstrating its effectiveness through numerical simulations.

Conclusion: The proposed QAVG-DMFT scheme shows promise for efficiently reconstructing Green's functions, thereby advancing the treatment of correlated electronic systems on quantum computers.
...
### [74] [Tripartite Interactions Induced Strongly Correlated Quantum Emissions](https://arxiv.org/abs/2605.29694)
*Qian Bin,Ying Wu,Franco Nori,Xin-You Lü*

Main category: quant-ph

TL;DR: This paper presents a theoretical advancement in multiquanta emission by utilizing tripartite interactions to achieve high-efficiency photon-phonon emission, mitigating traditional challenges linked to higher-order quantum processes.


<details>
  <summary>Details</summary>
Motivation: The need for efficient multiquanta emission in quantum information processing is pivotal yet challenging due to reliance on higher-order quantum processes.

Method: The authors demonstrate strongly correlated photon-phonon emission through direct tripartite interactions, facilitating the formation of high-order multiquanta states without sequential transitions.

Result: The findings show that high-efficiency even-quanta and odd-quanta emissions can be achieved, even in dissipative environments, by employing two-photon dissipation and parity-protected mechanisms.

Conclusion: This research advances multiquanta emission techniques into the tripartite coupling regime, indicating significant potential for future applications in hybrid quantum networks.
...
### [75] [Finite-key feasibility of geostationary quantum key distribution](https://arxiv.org/abs/2605.29706)
*Vaisakh Mannalath,Víctor Zapatero,Marcos Curty*

Main category: quant-ph

TL;DR: This paper presents a feasibility study for implementing a decoy-state BB84 quantum key distribution protocol using GEO satellites, addressing channel loss, noise, and providing design guidelines for future missions.


<details>
  <summary>Details</summary>
Motivation: The need for secure communication over large distances using satellite technology despite challenges like extreme channel loss and noise.

Method: A comprehensive analysis of a decoy-state BB84 protocol in a GEO downlink scenario, accounting for variable-length finite-key security and diverse receiver architectures.

Result: Evaluation of QKD performance in various environments and wavelengths, leading to predictions of key yields across Europe based on historical cloud data.

Conclusion: The study identifies critical performance trade-offs and establishes practical thresholds for future GEO-QKD operations.
...
### [76] [Discrete and Continuous Wigner Functions in Open Quantum Systems: Non-Markovian and Thermodynamic Effects](https://arxiv.org/abs/2605.29717)
*Jai Lalita*

Main category: quant-ph

TL;DR: This thesis investigates non-classical resources in finite-dimensional quantum systems, focusing on negative quantum states and their resilience to noise.


<details>
  <summary>Details</summary>
Motivation: To explore non-classical resources for quantum systems that can withstand realistic noise for practical applications.

Method: Utilizes discrete Wigner functions to analyze negative states under various noise channels, employs protection strategies, and develops quantum circuits for state generation.

Result: Negative states are shown to outperform Bell states in terms of entanglement resilience and teleportation efficiency under non-Markovian noise.

Conclusion: Negative quantum states can serve as robust alternatives to traditional Bell states, particularly in environments with significant non-Markovian noise.
...
### [77] [Treewidth-Aware Gate Cut Selection for Reducing Transpilation Overhead on Superconducting Quantum Devices](https://arxiv.org/abs/2605.29723)
*Hana Ebi,Shin Nishio,Takahiko Satoh*

Main category: quant-ph

TL;DR: TW2S is a method for optimizing two-qubit gate cuts in quantum circuits that improves efficiency without backend-specific transpilation, outperforming random selections in various graph models.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the inefficiencies introduced by additional SWAP gates in superconducting quantum devices with sparse qubit connectivity.

Method: TW2S operates in two stages: the first analyzes the circuit interaction graph to score edges based on their contribution to the treewidth upper bound; the second ranks potential cuts by their edge betweenness centrality, factoring in a degree penalty.

Result: TW2S consistently outperforms random cut selection across diverse benchmarks, showing significant improvements in estimation error and effective routing under increased shot budgets.

Conclusion: The results demonstrate that graph-structural cut selection can effectively reduce routing overhead in quantum circuits, making it a valuable tool for compiler-side optimizations.
...
### [78] [Bound-state-protected phase metrology for a quantum emitter in a Su-Schrieffer-Heeger bath](https://arxiv.org/abs/2605.29724)
*Sofia Evangelou*

Main category: quant-ph

TL;DR: The paper explores local phase estimation in a quantum emitter coupled to a dimerized bosonic SSH bath, revealing impacts on coherence and phase information retention based on system parameters and spectral characteristics.


<details>
  <summary>Details</summary>
Motivation: To understand the mechanisms by which a single quantum emitter retains phase information when interacting with a bosonic SSH bath, particularly through the effects of dimerization and bound states.

Method: The authors employ a microscopic lattice model, using Dyson-equation analysis to derive the local bath Green's function, in-gap bound-state conditions, and emitter residue relevant to phase information.

Result: The analysis shows that at resonance, stronger emitter-bath coupling enhances hybridization but decreases retained phase signal, while away from resonance, retention times and averages indicate how phase information protection diminishes as the emitter approaches the band edge.

Conclusion: The findings suggest that spectral-gap characteristics dominate the coherence retention dynamics, and the response does not depend on the dimerization sign, indicating a broader exploration of spectral-gap physics over the SSH winding sector.
...
### [79] [Non-Perturbative Closed Form for the Typical Bipartite Mutual Information of Haar-Random States](https://arxiv.org/abs/2605.29725)
*Zhi-Wei Wang,Pei-Wen Li,Samuel L. Braunstein*

Main category: quant-ph

TL;DR: The paper provides an exact expression for the average bipartite quantum mutual information of Haar-random pure states using Page's formula. It presents a closed form involving digamma functions and a convergent integral over a Bose–Einstein kernel, demonstrating a clear separation of classical and quantum correlations.


<details>
  <summary>Details</summary>
Motivation: To derive an exact formulation of average bipartite quantum mutual information in Haar-random pure states and understand its structure through Page's entropy.

Method: The authors express the average mutual information using an integral representation involving a Bose–Einstein kernel and derive a non-perturbative closed form. They analyze asymptotic behaviors and demonstrate scale-inversion symmetry.

Result: The closed form of mutual information is given by $ig(d_A^2-1)(d_B^2-1)ig\,	ext{G}(d_A,d_B,d_E)$, with the integral providing an exact Borel sum of an asymptotic series that diverges, along with a clear upper bound.

Conclusion: The mutual information formulation cleanly divides classical and quantum contributions by connecting it to a structured decomposition of Page's entropy.
...
### [80] [Exact Geometric Typicality and Bipartite Entanglement from the Projected Central Limit Theorem on Hyperspheres](https://arxiv.org/abs/2605.29732)
*Zhi-Wei Wang,Pei-Wen Li,Samuel L. Braunstein*

Main category: quant-ph

TL;DR: The study provides a detailed examination of the bipartite quantum mutual information for Haar-random pure states by utilizing the Projected Central Limit Theorem and deriving important results related to finite-size corrections.


<details>
  <summary>Details</summary>
Motivation: To understand the behavior of subsystem occupation probabilities and mutual information in quantum systems, particularly in the context of finite-size effects.

Method: Employing the Projected Central Limit Theorem on hyperspheres to derive the Beta distribution, along with an algebraic reorganization of Page's formula, to analyze the asymptotic expansion of mutual information in terms of system dimensions.

Result: The leading finite-size correction can be decomposed into contributions from quantum coherence and classical probability, revealing that higher odd-order corrections vanish and leading to a Bernoulli-factorized form of mutual information.

Conclusion: The typical mutual information can be succinctly expressed as a product involving an explicit Bose–Einstein integral, with its asymptotic behavior reflecting the derived structural forms.
...
### [81] [Quantum algorithms for density functional theory with minimal readout](https://arxiv.org/abs/2605.29774)
...
TL;DR: Developed a qubit-efficient quantum algorithm for Kohn-Sham DFT that computes occupied orbitals and total energy with potential exponential speedup, avoiding electronic density readout.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of quantum computing to enhance the efficiency of DFT calculations, which are computationally demanding in classical settings.

Method: Introduced an encoding scheme for wavefunctions in KS DFT and a quantum algorithm that simultaneously computes all occupied orbitals, particularly effective with the Harris functional; proposed a secondary method using multiple wavefunction copies for self-consistency.

Result: Demonstrated improved efficiency and potential exponential speedup in DFT calculations, with successful application in numerical examples.

Conclusion: Our algorithms present a promising direction for leveraging quantum computing in density functional theory, improving scalability over classical methods.
...
### [82] [Incompleteness is necessary for activation of nonlocality without entanglement](https://arxiv.org/abs/2605.29775)
*Atanu Bhunia,Saronath Halder,Preeti Parashar,Ritabrata Sengupta*

Main category: quant-ph

TL;DR: The paper explores quantum nonlocality without entanglement, establishing that orthogonal product bases can maintain local distinguishability under certain measurements and introducing 'strongly local sets'.


<details>
  <summary>Details</summary>
Motivation: The goal is to understand the transition between locally distinguishable and indistinguishable states in quantum systems, particularly in relation to nonlocality without entanglement.

Method: The authors analyze complete orthogonal product bases and their behavior under orthogonality-preserving local projective measurements, defining the concept of 'strongly local sets'.

Result: The research shows that initially locally distinguishable bases cannot become indistinguishable through the defined local operations, and it articulates the concept of strong local sets.

Conclusion: The findings enhance our understanding of local-to-nonlocal transitions and provide critical insight into the structure of state discrimination in multipartite quantum systems.
...
### [83] [Resolving the phase space](https://arxiv.org/abs/2605.29784)
*Zdenek Hradil,Jaroslav Rehacek*

Main category: quant-ph

TL;DR: This paper presents a framework for quantum tomography that enhances resolution by analyzing sampling operators linked to the Gram matrix, allowing for the effective reconstruction of quantum states.


<details>
  <summary>Details</summary>
Motivation: To improve the resolution in quantum tomography and distinguish genuine features from artefacts due to measurement limitations.

Method: The study utilizes a sampling operator based on the Gram matrix of measurements, analogous to an imaging transfer function, and reconstructs states in the Gram eigenbasis for efficient measurement adaptation.

Result: Establishes a resolution-based framework that allows for the effective identification of genuinely resolved quantum features while accounting for artefacts from incomplete sampling.

Conclusion: The findings are significant for contemporary quantum experiments investigating structured nonclassical states.
...
### [84] [Chain rules for conditional entropies in quantum cryptography: limitations and improvements](https://arxiv.org/abs/2605.29787)
*Lewis Wooltorton,Peter Brown,Omar Fawzi*

Main category: quant-ph

TL;DR: This paper examines chain rules applied to conditional entropies in quantum cryptography, particularly focusing on the limitations in device-independent settings and providing new insights for entropy accumulation theorems.


<details>
  <summary>Details</summary>
Motivation: The need to enhance security proofs in quantum cryptography, particularly in non-i.i.d. scenarios, motivates the exploration of chain rules that can effectively analyze conditional entropies across many rounds of interaction.

Method: The authors propose a new chain rule in a device-independent setting that serves as an intermediate improvement over existing methods, while also providing a unified framework for comparing different chain rules.

Result: The new chain rule allows for a slightly tighter version of the Rényi entropy accumulation theorem in specific contexts, addressing limitations identified in previous approaches.

Conclusion: The study highlights both the challenges and potential improvements in the analysis of quantum cryptographic protocols, emphasizing the importance of the introduced chain rule in the broader context of security proofs.
...
### [85] [Adaptive Stabilizer State Fidelity Certification](https://arxiv.org/abs/2605.29820)
*Kun Wang*

Main category: quant-ph

TL;DR: This paper enhances the certification of fidelity to stabilizer states by developing an adaptive method that provides a complete interval of certified fidelity, overcoming gauge dependence and ambiguity.


<details>
  <summary>Details</summary>
Motivation: The fundamental task of certifying the fidelity of quantum states is hindered by gauge dependence, leading to potential ambiguities in fidelity estimation.

Method: An adaptive design approach for gauge selection is proposed, solving endpoint linear programs in each round and employing a witness elimination strategy to select new gauges, thus deriving both upper and lower bounds.

Result: The method yields a complete interval of certified fidelity and proves that adaptivity can outperform traditional exponential benchmarks in specific syndrome distributions.

Conclusion: The developed adaptive scheme achieves a tighter fidelity estimation and guarantees recovery when all nontrivial stabilizers are accounted for, demonstrating significant improvements in efficiency.
...
### [86] [Indistinguishability of photonic qubits emitted from trapped $^{40}$Ca$^+$ ions via pulsed excitation](https://arxiv.org/abs/2605.29825)
*Pascal Baumgart,Max Bergerhoff,Jonas Meiers,Stephan Kucera,Jürgen Eschner*

Main category: quant-ph

TL;DR: This study explores the indistinguishability of Raman photons from trapped $^{40}$Ca$^+$ ions and its effect on Hong-Ou-Mandel interference.


<details>
  <summary>Details</summary>
Motivation: Understanding the indistinguishability of photons is crucial for quantum communication and computing applications, particularly in enhancing interference effects.

Method: The authors investigated the effect of spontaneous scattering on Hong-Ou-Mandel interference using few-nanosecond excitation pulses on two trapped ions.

Result: They demonstrated that the mean number of back-decays is a significant parameter, influencing the interference visibility of the photons emitted from the two identical emitters.

Conclusion: This study provides insights into how single-emitter characteristics can impact the indistinguishability of quantum optical sources, important for future quantum technologies.
...
### [87] [Gate Parameter Lee-Yang Zeros and Dynamical Phases in Quantum Circuits](https://arxiv.org/abs/2605.29838)
*Chang Liu,Yu Wu,Yunfeng Jiang,Yang Zhang*

Main category: quant-ph

TL;DR: This paper introduces gate-parameter Lee-Yang zeros of Loschmidt amplitudes as a method to probe dynamical phases in finite quantum circuits, revealing transitions through the behavior of zeros in circuit parameters.


<details>
  <summary>Details</summary>
Motivation: To investigate dynamical phases in quantum circuits and develop a diagnostic tool that does not depend on integrability.

Method: Utilization of gate-parameter Lee-Yang zeros of Loschmidt amplitudes with a brickwork model governed by a Floquet operator, examining zeros' organization in the parameter space.

Result: The zeros condense onto universal curves dictated by Floquet eigenvalues, showcasing abrupt reorganizations that signal dynamical phase transitions as parameters change.

Conclusion: The approach provides insights into dynamical transitions in finite qubit systems without relying solely on integrability, emphasizing the role of spectral competition and local unitarity.
...
### [88] [Toward Practical Two-Way Covert Communication](https://arxiv.org/abs/2605.29840)
...
TL;DR: This paper investigates two-way covert communication using quantum bosonic channels and proposes a practical system using narrowband lasers, alongside a correlator-based receiver for enhanced performance.


<details>
  <summary>Details</summary>
Motivation: The exploration of covert communication schemes that can transmit information stealthily is crucial, particularly when the adversary has quantum capabilities.

Method: The study utilized narrowband laser sources to create an experimental two-way covert communication system, eliminating the impracticalities of broadband sources in terms of mode matching and synchronization.

Result: The experimental results validate the proof-of-concept for the covert communication system, demonstrating effective communication even in the presence of quantum-capable adversaries.

Conclusion: A correlator-based receiver can achieve the benefits of broadband gain without stringent requirements, making the system more feasible in practical applications.
...
### [89] [Claim against Measurement: Statistical Artefacts in Quantum Error Mitigation Benchmarks](https://arxiv.org/abs/2605.29872)
*Dominik Köster,Wolfgang Mauerer*

Main category: quant-ph

TL;DR: The paper reviews 81 recent QEM studies, revealing significant issues in statistical rigor and reporting. Only 25% use inferential methods. It highlights parameter sensitivity and drift-induced biases in current benchmarks, proposing improved reporting standards.


<details>
  <summary>Details</summary>
Motivation: To assess the empirical validity of QEM techniques in bridging NISQ devices to FTQC, as previous studies showed a lack of scrutiny on their conclusions.

Method: A systematic review of 81 QEM papers using an eight-criterion framework focusing on statistical rigor, reproducibility, and reporting quality.

Result: Only 15 papers (25%) used inferential methods; 25 (42%) provided only descriptive uncertainty reports. Identified issues include parameter sensitivity affecting outcomes and drift-induced biases in effectiveness measures.

Conclusion: Current evaluation practices may exaggerate QEM techniques' performance robustness. The paper proposes minimum reporting standards to enhance clarity and reliability in QEM evaluations.
...
### [90] [Verifying Adversarial Robustness in Quantum Machine Learning: from theory to physical validation via a software tool](https://arxiv.org/abs/2605.29877)
*Ji Guan,Mingsheng Ying*

Main category: quant-ph

TL;DR: This chapter presents a framework for certifying the robustness of quantum machine learning models against adversarial attacks, essential for trustworthy quantum AI.


<details>
  <summary>Details</summary>
Motivation: The vulnerability of quantum machine learning models to input perturbations necessitates robust verification methods, especially given the context of near-term quantum hardware.

Method: The framework includes a fidelity-based robustness lower bound computable from measurement distributions, using semidefinite programming for optimal bound calculation, facilitating both formal verification and empirical estimation.

Result: The framework has led to the development of an efficient formal verification method, VeriQR tool for robustness verification, and a benchmark of quantum adversarial robustness using a 20-qubit superconducting processor.

Conclusion: These advancements contribute to systematic and scalable evaluations of robustness in quantum machine learning, enhancing the reliability of quantum AI applications.
...
### [91] [Dynamical Casimir photons from rotation of a nonspherical particle](https://arxiv.org/abs/2605.29883)
*Guilherme C. Matos,Lucas Bianchi,Jeremy N. Munday,François Impens,Reinaldo de Melo e Souza,Paulo A. Maia Neto*

Main category: quant-ph

TL;DR: This study explores the interaction of a non-spherical neutral particle in free space with the electromagnetic quantum vacuum, focusing on induced photon pair emission due to its rotation.


<details>
  <summary>Details</summary>
Motivation: To analyze how the structure and rotation of a particle influence photon pair emission from the quantum vacuum.

Method: The effects of particle shape and rotation axis on the scattered field and resulting photon emissions were mathematically evaluated, considering parameters like tip velocity and resonances.

Result: The emission rate is maximized for nearly spherical geometries under maximum velocity conditions, and resonance effects enhance this rate, although the practical emission remains very low.

Conclusion: Despite theoretical optimizations suggesting potential for spin-induced emissions, actual rates are too small for significant free-space applications involving a single nanoparticle.
...
### [92] [Evaluating Parameter Transfer in FALQON Across Graph Families](https://arxiv.org/abs/2605.29917)
...
TL;DR: This paper evaluates the effectiveness of FALQON parameter transfer for Max-Cut across graphs of varying sizes, highlighting that the success of transfer depends more on the recipient graphs than the donors, particularly favoring dense graphs.


<details>
  <summary>Details</summary>
Motivation: The goal is to reduce the measurement overhead in parameter transfer by demonstrating the utility of smaller donor graphs for optimizing larger recipient graphs in the Max-Cut problem.

Method: We assessed parameter transfer using small donor graphs with sizes 8, 10, and 12, applying them to 14-node recipient graphs drawn from 3-regular and Erdős-Rényi families, and compared performance based on graph density and structure.

Result: The study found that transfer success is mainly dependent on the characteristics of the recipient graph, with dense graphs achieving high approximation ratios, while sparse graphs showed lower success rates. Performance remained effective even with smaller donor graphs (8-node) on larger instances.

Conclusion: The findings suggest that small, inexpensive graphs can effectively provide parameter settings for larger Max-Cut problems, leading to significant reductions in measurement overhead.
...
### [93] [Quadratic Sums-of-Powers for Fixed-Parameter Tractable Quantum-Circuit Simulation](https://arxiv.org/abs/2605.29944)
*Alexis de Colnet,Floris Geerts,Rihan Hai,Alfons Laarman,Joon Hyung Lee,Guillermo A. Pérez*

Main category: quant-ph

TL;DR: This paper presents an efficient algorithm for quantum circuit simulation based on the rank-width of the path-variable graph, outperforming existing methods in specific cases.


<details>
  <summary>Details</summary>
Motivation: To improve the efficiency of quantum circuit simulation by leveraging structural properties of the circuit's path-variable graph, specifically rank-width.

Method: The authors develop an algorithm that computes output amplitudes in time exponential only in the rank-width and polynomial in the circuit size, using artificial intelligence tools such as binary decision diagrams.

Result: The algorithm demonstrates performance improvements over existing methods, reproducing a recent breakthrough and achieving superior efficiency on certain circuit families, specifically those with small rank-width.

Conclusion: The proposed algorithm allows for practical quantum circuit simulations, effectively utilizing general-purpose decision-diagram tools alongside specialized techniques for circuits with small rank-width.
...
### [94] [Quantitative semidefinite certificates for ground-state energies of Pauli Hamiltonians](https://arxiv.org/abs/2605.29959)
*Igor Klep,Nando Leijenhorst,Victor Magron*

Main category: quant-ph

TL;DR: This paper establishes explicit finite convergence rates for semidefinite programming hierarchies in the context of $k$-local Hamiltonians with even-weight Pauli terms.


<details>
  <summary>Details</summary>
Motivation: To address the lack of quantitative accuracy guarantees for low hierarchy levels in the study of $k$-local Hamiltonians using semidefinite programming.

Method: The paper proves convergence rates in the Pauli setting by employing almost-reproducing kernels and relating their spectra to Krawtchouk polynomials, facilitating a reduction to an even-weight case with ancilla qubits.

Result: The NPA-type lower-bound and upper-bound hierarchies yield error rates of at most $C(k)ξ^{n,4}_{d+1}/n$, with $C(k)$ independent of the number of qubits and hierarchy level, providing the first quantitative guarantees for such relaxations.

Conclusion: The findings advance the understanding of noncommutative semidefinite relaxations for Pauli Hamiltonians, establishing robust theoretical foundations for future computational applications.
...
### [95] [A Neutral-Atom Quantum Compiler with Application-Specific Layout and Hub-Assisted Shuttling](https://arxiv.org/abs/2605.29964)
*Takahiko Satoh,Takaharu Yoshida*

Main category: quant-ph

TL;DR: The paper presents a novel approach using hub traps to efficiently compile NISQ circuits onto neutral-atom devices, significantly improving execution time and eliminating SWAP gates in routing-dominated scenarios.


<details>
  <summary>Details</summary>
Motivation: To resolve the challenges of compiling NISQ circuits onto neutral-atom devices, particularly due to constraints in interaction range and site separation, which hinder practical schedules for small circuits.

Method: The authors propose a pipeline that integrates dynamically placed hub traps to facilitate transit in circuit compilation and employ a rule that balances SWAP routing and hub-mediated shuttling for gate execution.

Result: Evaluating on seventeen benchmarks, the improved pipeline enables circuits to compile in seconds to minutes while removing SWAP gates completely, yielding fidelity improvements of up to three orders of magnitude in routing-dominated circuits compared to a baseline.

Conclusion: The introduction of hub traps effectively transforms routing challenges in NISQ circuit compilation, leading to significant efficiency gains, especially for routing-heavy circuits, while achieving practical execution times.
...
### [96] [Quantum Networks Using Color Defects in Diamond: Principles, Progress, and Perspectives](https://arxiv.org/abs/2605.30005)
*Ayan Majumder,Cem Güney Torun,Tim Schröder,Gregor Pieplow,Prem Kumar,Kasturi Saha*

Main category: quant-ph

TL;DR: This review explores diamond color defects as key components for large-scale quantum networks, highlighting their properties, integration with photonic circuits, progress in quantum networking, and addressing associated challenges.


<details>
  <summary>Details</summary>
Motivation: The need for scalable quantum networks to enable new applications in quantum information science.

Method: Reviewing the optical and spin properties of diamond color defects, advancements in integration with photonic circuits, and discussions on quantum network demonstrations.

Result: Demonstrates the feasibility and progress of using diamond color defects for quantum networks and identifies challenges and solutions.

Conclusion: Diamond color defects are promising for quantum networking but face fundamental and experimental challenges that need addressing for further advancements.
...
### [97] [Elfs, transducers and quantum walks](https://arxiv.org/abs/2605.30013)
*Simon Apers,Jérémie Roland,Yuxin Zhang*

Main category: quant-ph

TL;DR: Electric flow sampling (elfs) enhances quantum walk algorithms, introducing zero-error transducers and achieving improvements in search, sampling, and optimization on graphs.


<details>
  <summary>Details</summary>
Motivation: The need for efficient quantum algorithms to solve various problems on graphs motivates the development of electric flow sampling (elfs).

Method: The paper presents a zero-error transducer for elfs and establishes a transducer for reflecting on the intersection of two subspaces, facilitating error-free transitions in quantum algorithms.

Result: The derived quantum walk algorithms demonstrate optimal error scaling in estimating effective resistances and span program witness sizes and enable efficient sampling from random walk distributions.

Conclusion: The advancements yield up to quadratic quantum speedup in semi-supervised learning tasks on expander graphs, showcasing the practical benefits of elfs.
...
### [98] [On the question of noise as a resource in quantum computing](https://arxiv.org/abs/2605.30026)
*J. Montes,F. Borondo,Gabriel G. Carlo*

Main category: quant-ph

TL;DR: Noise in quantum systems can enhance performance; this paper formulates a geometric mechanism explaining how certain non-unital noise improves state distribution, employing a minimal 1-qubit model with amplitude damping and universal gates.


<details>
  <summary>Details</summary>
Motivation: The study emerges from recent findings that noise, often seen as detrimental, can actually boost the performance of quantum reservoir computing by affecting the dynamics positively.

Method: A geometric mechanism is proposed, where non-unital noise combined with a universal gate set accelerates convergence to Haar-like distributions. A 1-qubit model with amplitude damping is utilized to develop a globally expanding nonlinear map on pure states.

Result: The analysis reveals that this noise induces effective volume expansion on the manifold of pure states, enabling faster approaches to desired state distributions when combined with specific gate sets.

Conclusion: The results suggest that noise can be harnessed as a beneficial resource in future quantum algorithms, challenging the conventional view of noise as purely an obstacle.
...
### [99] [A comparison of different master equations for driven-dissipative dynamics in composite quantum systems: Dispersive readout in structured electromagnetic environments](https://arxiv.org/abs/2605.30032)
*Prakritish Gogoi,Angela Riva,Émile Cochin,Alex Chin*

Main category: quant-ph

TL;DR: This paper compares Lindblad and Bloch-Redfield approaches in modeling dissipative qubit-resonator systems, demonstrating different behaviors under varying conditions of driving and spectral densities.


<details>
  <summary>Details</summary>
Motivation: To provide a more accurate description of driven-dissipative dynamics in qubit-resonator systems, particularly in hybridized regimes.

Method: Utilization of a microscopic Bloch-Redfield approach to incorporate dissipation based on the eigenbasis of the coupled system, contrasting it with traditional Lindblad master equations.

Result: Findings indicate significant quantitative differences in decay rates under undriven conditions, and qualitatively distinct behaviors in driven scenarios, influenced by the driving strength and spectral structure.

Conclusion: The study provides insights into the impact of driving on qubit-resonator dynamics and highlights the advantages of using a Bloch-Redfield approach over Lindblad equations for accurate modeling.
...
### [100] [Quantum Mechanics: Problems and Paradoxes](https://arxiv.org/abs/2605.30067)
*L. V. Prokhorov,Alexander Ushakov S.,Yury Berdinsky*

Main category: quant-ph

TL;DR: The book explores lesser-discussed quantum mechanics problems, including the origin of probabilities and the interpretation of key quantum concepts, and proposes a new axiomatic framework.


<details>
  <summary>Details</summary>
Motivation: To address and clarify foundational issues in quantum mechanics that are often overlooked in traditional discussions.

Method: Formulation of an axiomatic system for quantum theory and analysis of a model interpreting classical oscillators as quantum systems.

Result: A detailed examination of the measurement problem and insights into quantum probabilities and wave functions.

Conclusion: The book provides a foundational perspective that could enhance understanding of quantum mechanics for advanced students and professionals.
...
### [101] [Asymptotic magic state distillation with almost linear rate](https://arxiv.org/abs/2605.30108)
*Koki Ehara,Ryuji Takagi*

Main category: quant-ph

TL;DR: The paper explores the relationship between overhead exponent and asymptotic distillation rate in magic state distillation, showing that they can behave independently in certain regimes.


<details>
  <summary>Details</summary>
Motivation: To clarify the relationship between the overhead exponent and asymptotic distillation rate in magic state distillation protocols.

Method: Introduced protocols with overhead exponents greater than one while still achieving asymptotic rates close to linear, utilizing error checking via logical Clifford operator measurements.

Result: Demonstrated that the overhead exponent does not limit the distillation rate in the sublinear regime, even with higher overhead exponents present.

Conclusion: The findings suggest that the mechanisms for error checking could be key to enhancing asymptotic magic state distillation.
...
### [102] [Alternative adiabatic quantum dynamics with algorithmic applications](https://arxiv.org/abs/2605.30110)
*Joseph Cunningham,Jérémie Roland*

Main category: quant-ph

TL;DR: The paper proposes alternative processes for achieving adiabatic quantum computing that can be implemented on gate-based quantum computers, providing a new framework for related theorems and algorithms, especially for solving Quantum Linear Systems Problems with improved efficiency.


<details>
  <summary>Details</summary>
Motivation: To simplify adiabatic quantum computing on gate-based systems by bypassing the challenges of simulating time-dependent Hamiltonians.

Method: The authors introduce alternative processes and a general framework for deriving adiabatic theorems, alongside specific algorithms for solving Quantum Linear Systems Problems.

Result: The new algorithms exhibit optimal scaling relative to the condition number and include variations of Trotterisation that outperform standard error bounds.

Conclusion: The proposed framework and algorithms enhance the efficiency of quantum computing processes, particularly in solving linear systems and randomised settings.
...
### [103] [Simulation of smooth models of potentials with singular point using Many-Interacting-Worlds Method](https://arxiv.org/abs/2605.30124)
*Wen Chen,An Min Wang*

Main category: quant-ph

TL;DR: This paper extends the deterministic many-interacting-worlds method to solve bounded systems with singular potentials in two dimensions, demonstrating consistency with traditional methods.


<details>
  <summary>Details</summary>
Motivation: To explore the application of the many-interacting-worlds method beyond harmonic oscillators and assess its effectiveness in solving bounded systems with singular potentials.

Method: The authors apply an asymptotic smooth method and utilize numerical simulations based on a dynamical algorithm inherent in the many-interacting-worlds framework.

Result: Results indicate consistency with the matrix Numerov method in standard quantum mechanics and show promise for addressing more complex systems.

Conclusion: This work validates the use of the many-interacting-worlds method for complex bounded systems and suggests its potential for future applications in quantum mechanics.
...
### [104] [Overcoming the Matrix-Product-State Encoding Barrier via DMRG-Guided Probabilistic Imaginary-Time Evolution](https://arxiv.org/abs/2605.30141)
*Masari Watanabe,Hirofumi Nishi,Taichi Kosugi,Shinji Tsuneyuki,Yu-ichiro Matsushita*

Main category: quant-ph

TL;DR: The paper presents a three-stage framework for efficient ground-state preparation in quantum simulation using MPS encoding and probabilistic imaginary-time evolution.


<details>
  <summary>Details</summary>
Motivation: Ground-state preparation is crucial for effective quantum simulation, impacting subsequent algorithm costs based on state overlap.

Method: The framework employs DMRG to prepare an MPS, uses an MPD encoding circuit for loading on a quantum register, and employs PITE to reduce errors after initial encoding.

Result: The efficacy of the encoding scales logarithmically, with the inflection point $L^{*}$ serving as a cutoff for efficiency; encodings beyond this point show diminishing returns on fidelity.

Conclusion: The proposed approach integrates DMRG, optimization-free encoding, and deterministically scheduled PITE for an efficient, practical method of achieving ground-state preparation without deep encoding circuits.
...
### [105] [Koopman--von Neumann Molecular Dynamics for Green--Kubo Transport Coefficients](https://arxiv.org/abs/2605.30142)
*Masari Watanabe,Hirofumi Nishi,Taichi Kosugi,Shigekazu Hidaka,Ryo Sakurai,Yu-ichiro Matsushita*

Main category: quant-ph

TL;DR: This paper presents a quantum algorithm for calculating Green--Kubo transport coefficients in molecular dynamics, demonstrating improved accuracy and resource efficiency using the Koopman--von Neumann framework.


<details>
  <summary>Details</summary>
Motivation: To enhance the accuracy and efficiency of calculating transport coefficients in molecular dynamics through quantum algorithms.

Method: The authors derive unitary evolutions for NVE and Nosé--Hoover-type NVT dynamics and propose using quantum phase estimation (QPE) for measuring transport coefficients, incorporating error analysis and resource assessment.

Result: The proposed method shows that the discretization error decreases exponentially with the number of qubits, and the statistical efficiency improves from $N_{\rm queries}^{-1/2}$ to near $N_{\rm queries}^{-1}$.

Conclusion: This work offers a foundational approach for applying quantum algorithms to accurately compute transport coefficients in practical molecular simulations.
...
### [106] [End-to-End Molecular Dynamics with a Langevin Thermostat on Quantum Circuits](https://arxiv.org/abs/2605.30143)
*Masari Watanabe,Hirofumi Nishi,Taichi Kosugi,Shigekazu Hidaka,Ryo Sakurai,Yu-ichiro Matsushita*

Main category: quant-ph

TL;DR: This paper presents a quantum-circuit framework for simulating finite-temperature molecular dynamics using a Langevin thermostat, specifically targeting canonical ensemble behavior and physical-property readouts.


<details>
  <summary>Details</summary>
Motivation: To connect quantum computing methodologies with molecular dynamics in the canonical ensemble, enhancing quantum-classical hybrid simulations.

Method: A quantum-circuit framework is constructed that encodes classical phase-space distributions into a KvN wave function, using Langevin dynamics for state preparation and implementing distinct circuit blocks for Hamiltonian flow, friction, and diffusion processes.

Result: Numerical simulations demonstrate the relaxation of a non-equilibrium distribution to a canonical KvN state, with effective readouts of vibrational density of states and TST rate constants for the H$_2$ molecule.

Conclusion: The work provides a circuit-level protocol that effectively links Langevin state preparation and physical-property calculations, representing a significant advancement toward hybrid molecular dynamics on quantum computers.
...
### [107] [Tunneling phase diagram: A machine-learning framework for multidimensional kinetic isotope effects](https://arxiv.org/abs/2605.30165)
*Xinrui Yang,Zhigang Wang*

Main category: quant-ph

TL;DR: A novel machine-learning framework, the tunneling phase diagram, decouples tunneling strength from KIE and classical kinetics, revealing an anomalous relationship at high temperatures.


<details>
  <summary>Details</summary>
Motivation: To improve understanding of quantum tunneling by addressing the complexities in the relationship between kinetic isotope effect (KIE) and tunneling.

Method: Utilized a machine-learning framework to construct a tunneling phase diagram that separates tunneling strength from zero-point energy influences, analyzing the nonlinear relationship between KIE and the tunneling factor.

Result: Achieved a high fidelity (R^2 > 0.98, RMSE = 0.21) in identifying an unusual high KIE-low  3BA pattern in the temperature range of 300-600 K.

Conclusion: This framework establishes a new paradigm for quantitatively assessing quantum tunneling.
...
### [108] [Programmable Dissipation via Partial Quantum Error Correction](https://arxiv.org/abs/2605.30217)
*Sameer Dambal,Michael AD Taylor,Yu Zhang*

Main category: quant-ph

TL;DR: The paper presents a method to utilize logical noise in quantum information processing as a resource rather than an obstacle, enabling effective simulation of open quantum systems without additional ancilla qubits.


<details>
  <summary>Details</summary>
Motivation: The interplay between noise and quantum information processing, particularly within open quantum dynamics, highlights the need for new approaches that harness dissipation rather than suppress it.

Method: The authors treat error-correction as a programmable primitive, using fault-tolerant rounds to create logical channels that allow for the mixing of target dissipators into effective logical dynamics.

Result: The introduction of a controllable family of logical channels enables accurate simulation of dissipative dynamics, achieving multi-step simulation with manageable error rates.

Conclusion: Partial quantum error correction can efficiently manage logical noise to facilitate the simulation of open quantum systems, providing a resource-efficient pathway for quantum computation.
...
### [109] [Heralded ultrafast generation of macroscopic quantum states in matter with bright squeezed vacuum light](https://arxiv.org/abs/2605.30224)
*Shohei Imai*

Main category: quant-ph

TL;DR: The paper demonstrates that bright squeezed vacuum light and quadrature measurements enable rapid generation of macroscopic quantum states in matter, overcoming classical limitations through heralding.


<details>
  <summary>Details</summary>
Motivation: To enhance the generation of macroscopic quantum states in matter using quantum light, addressing limitations posed by classical mixtures due to light-matter entanglement.

Method: A combination of bright squeezed vacuum light and single-shot quadrature measurement was used to herald the preparation of matter in Gaussian-weighted quantum superpositions.

Result: The dynamics revealed a Gaussian filtering effect for electric polarization, facilitating a faster transition to a Dicke state and further to a cat-like state through counter-rotating terms.

Conclusion: This approach paves the way for ultrafast engineering of macroscopic quantum matter using strong-field quantum light.
...
### [110] [Non-Abelian Mixer for QAOA on Hybrid Oscillator-Qubit Quantum Processors](https://arxiv.org/abs/2605.30234)
*Thinh Le,Hansika Weerasena,Jianqing Liu*

Main category: quant-ph

TL;DR: This paper introduces a non-Abelian mixer for the QAOA on hybrid CV-DV quantum processors, demonstrating improved performance over traditional methods for solving the Max-Cut problem.


<details>
  <summary>Details</summary>
Motivation: The need for effective algorithm development in hybrid quantum processors, particularly for the QAOA, which has limited implementation in CV-DV settings.

Method: A hardware-native non-Abelian mixer for QAOA is proposed, along with a hybrid ansatz tailored for the Max-Cut problem, and evaluated on unweighted Erdős-Rényi graphs.

Result: The non-Abelian mixer shows better expected solution quality and higher optimal solution probability compared to the standard transverse-field mixer across various graph sizes and Fock cutoffs.

Conclusion: The non-Abelian mixer is a viable enhancement for QAOA in hybrid quantum architectures, showcasing significant improvements in performance.
...
### [111] [Indefinite Causal Order Reverses the Real-Complex Hierarchy](https://arxiv.org/abs/2605.30238)
*Jacopo Surace,Shintaro Minagawa,Ravi Kunjwal*

Main category: quant-ph

TL;DR: This paper explores the role of quantum indefiniteness in causal relations through the process-matrix framework, revealing that under indefinite causal order, real quantum theory exhibits more process correlations than complex quantum theory.


<details>
  <summary>Details</summary>
Motivation: To investigate whether causal relations can exhibit quantum indefiniteness and to understand the implications of symmetry constraints on local operations in quantum processes.

Method: Utilizing the process-matrix framework, the authors assess how symmetry limitations affect local laboratory operations and the resultant correlations, particularly contrasting finite unitary symmetry with real quantum theory.

Result: The study establishes that for any finite unitary symmetry, the additional processes do not create new correlations, whereas real quantum theory generates genuinely new correlations under indefinite causal order.

Conclusion: Under indefinite causal order, real quantum theory demonstrates a richer landscape of process correlations compared to complex quantum theory, reversing a previously established hierarchy observed under fixed causal order.
...
### [112] [Quantum optimization beyond QUBO for industrial logistics and scheduling](https://arxiv.org/abs/2605.30252)
*Juan F. R. Hernandez,Pavle Nikacevic,Enrique Solano,Chinonso Onah,Agneev Guin,Arne-Christian Voigt,Archismita Dalal*

Main category: quant-ph

TL;DR: This paper explores HUBO formulations for industrial scheduling and transport routing problems, demonstrating their benefits and limitations in quantum optimization frameworks, particularly in qubit efficiency and circuit complexity.


<details>
  <summary>Details</summary>
Motivation: The complexity of industrial scheduling and transport routing necessitates exploring advanced optimization methods, particularly in the context of quantum computing.

Method: The study formulates logistics and manufacturing problems as higher-order unconstrained binary optimization (HUBO) problems and compares them to traditional quadratic (QUBO) forms, analyzing both noisy and fault-tolerant quantum regimes.

Result: HUBO formulations lower qubit demands through compact binary representation but introduce complex higher-order interactions that can increase circuit depth, impacting feasibility on current quantum hardware.

Conclusion: While HUBO offers efficiency in qubit use over QUBO, its practicality is limited by challenges like gate fidelity and circuit depth, indicating that hybrid quantum-classical approaches are recommended for real-world applications.
...
### [113] [Quantum Synchronization of Fock States](https://arxiv.org/abs/2605.30271)
*Fabian Hassler,David Scheer,Samah Saquaque,Steven Kim*

Main category: quant-ph

TL;DR: The paper explores quantum synchronization in a bosonic mode with a negative Wigner function, revealing phase-locking to an external drive and a new method for analyzing phase slip rates.


<details>
  <summary>Details</summary>
Motivation: To investigate synchronization phenomena in quantum systems, particularly focusing on non-classical states and their dynamics.

Method: Quantum synchronization is demonstrated through a bosonic mode with a limit cycle, exploring the phase-locking to external drives within an Arnold tongue regime, and employing a novel method to measure phase slip rates using Lindblad dynamics.

Result: The study reveals the existence of a steady state with a negative Wigner function and shows synchronization dynamics related to the suppression of phase slips.

Conclusion: Insights gained could significantly advance understanding of non-classical synchronization dynamics and potential applications.
...
### [114] [Improved sample complexity bound for sample-based Lindbladian simulation](https://arxiv.org/abs/2605.30301)
*Siheon Park,Youngjin Seo,Byeongseon Go,Dhrumil Patel,Mark M. Wilde,Hyukjoon Kwon*

Main category: quant-ph

TL;DR: This paper establishes refined bounds for sample complexity in Lindbladian simulation using the Wave Matrix Lindbladization algorithm, demonstrating a significant reduction in complexity for certain cases while highlighting the stark difference between typical and worst-case scenarios.


<details>
  <summary>Details</summary>
Motivation: To improve the sample complexity bounds for Lindbladian simulation, addressing limitations in previous results and refining understanding of dimensional dependencies.

Method: Derives explicit non-asymptotic sample complexity bounds for the WML algorithm, proving improved dependencies on dimensions and conditions where typical-case complexities can be reduced.

Result: Achieves a refined bound of $n_d^*(t,\\varepsilon) \le \left( \frac{2d+3}{8} \right) \|L\|_\infty^2 \left( \frac{t^2}{\varepsilon} \right)$, and shows a significant reduction to $O(t^2/\varepsilon)$ under certain conditions while outlining an explicit example demonstrating a worst-case scenario requiring $Ω(dt^2/\varepsilon)$ samples.

Conclusion: The findings indicate a clear divide in sample complexities depending on the problem type, furthering the theoretical understanding of sample-based quantum algorithms.
...
### [115] [Quantum Desynchronization of Limit Cycles](https://arxiv.org/abs/2605.30302)
*Hans Christiansen,Jens Paaske*

Main category: quant-ph

TL;DR: The paper explores how synchronization in quantum systems degrades due to quantum phase slips, using a Keldysh path integral approach.


<details>
  <summary>Details</summary>
Motivation: To understand the breakdown of synchronization in continuous variable quantum systems, analogous to classical systems affected by noise.

Method: The authors employ a Keldysh path integral formulation to analyze phase dynamics within limit cycles and investigate quantum phase slips.

Result: They find that quantum phase slips degrade phase locking despite strong correlations, and illustrate non-Markovian effects on synchronization.

Conclusion: The study provides a framework for understanding synchronization issues in quantum systems like superconducting resonators, highlighting the role of quantum phase slips.
...
### [116] [Analytical model for structured light propagation through a turbulent atmosphere](https://arxiv.org/abs/2605.30304)
*Konstantin Kravtsov*

Main category: quant-ph

TL;DR: An analytical framework for spatial light mode propagation in turbulent atmospheres is developed, demonstrating linear power transfer related to phase fluctuations and mode interactions, with predictions aligning well with simulations.


<details>
  <summary>Details</summary>
Motivation: To understand how turbulence affects the power distribution in spatial light modes in atmospheric conditions, which is critical for applications in optical communications and remote sensing.

Method: The framework uses a split-step approach combined with mode-based optical field representation to model phase fluctuations and power transfer between spatial modes, computed through a matrix exponential solution.

Result: The model predicts average power distributions across spatial modes, accurately representing cases where one mode dominates, and aligns well with simulation data up to medium-to-strong turbulence levels.

Conclusion: The findings confirm established empirical scalings related to mode order and enhance understanding of turbulence effects on optical power distribution.
...
### [117] [JWST's Dusty Blue BOAT -- GRB 221009A](https://arxiv.org/abs/2605.29022)
...
TL;DR: Re-analysis of GRB 221009A's afterglow reveals strong degeneracy in extinction and spectral index, leading to significant findings on medium density and electron distribution.


<details>
  <summary>Details</summary>
Motivation: To address conflicting values in afterglow modeling of GRB 221009A caused by high line-of-sight extinction and low Galactic latitude.

Method: Utilized VLT X-Shooter and JWST NIRSpec/MIRI data across various epochs; fitted with single and double smoothly broken power-law models.

Result: Determined total line-of-sight extinction of $A_{V} = 4.40 \pm 0.01$ and intrinsic spectral index of $β= 0.447 \pm 0.001$; ruled out wind medium based on light curve evolution.

Conclusion: Findings suggest a narrow, energetic jet core dominating early emission, questioning standard particle acceleration models.
...
### [118] [Nebular Fingerprints of a Violent White Dwarf Merger: 3D NLTE Modelling of Type Ia Supernovae](https://arxiv.org/abs/2605.29038)
*J. M. Pollin,R. Pakmor,L. J. Shingles,F. P. Callan,S. A. Sim,L. A. Kwok,C. E. Collins,F. K. Roepke,A. L. McGarrity*

Main category: astro-ph.HE

TL;DR: This study presents 3D radiative-transfer calculations for a violent merger of sub-Chandrasekhar mass white dwarfs, highlighting how multidimensional modeling enhances understanding of spectral features linked to Type Ia supernovae.


<details>
  <summary>Details</summary>
Motivation: Assess the role of binary carbon-oxygen white dwarf mergers as progenitors for Type Ia supernovae, particularly focusing on the dynamics and outcomes of these events.

Method: Utilized 3D nebular-phase radiative-transfer simulations of a binary composed of a 1.1 M☉ and a 0.7 M☉ white dwarf, incorporating NLTE treatments of excitation, ionization, and non-thermal electron contributions.

Result: The 3D model improves the understanding of the ionization state and spectral features, matching much of the spectrum of SN 2021aefx but underpredicts some lines like [Ni II]. It suggests the need for different configurations to explain emissions seen in SN 2022pul.

Conclusion: The variation in viewing angles indicates significant differences from D^6 scenarios, suggesting that upcoming JWST data combined with multidimensional modeling will help differentiate supernova progenitor channels.
...
### [119] [The MeerKAT Thousand-Pulsar Polarization Array I: Properties of the Polarization and Rotation Measure Time Series Data](https://arxiv.org/abs/2605.29106)
*Michael Sarkis,Zi-Yan Yuwen,Yin-Zhe Ma,Tao Liu,Jing Ren,Patrick Weltevrede,Xiao Xue*

Main category: astro-ph.HE

TL;DR: This study analyzes polarization data from 513 pulsars to investigate the influence of dark matter on polarization angle changes due to Faraday Rotation and other noise models.


<details>
  <summary>Details</summary>
Motivation: To test emission mechanisms and theories beyond the Standard Model using pulsar polarimetry data, focusing on ultralight Axion-Like Dark Matter (ALDM).

Method: An analysis of polarization time series from 513 pulsars, examining polarization angle trends, accounting for Faraday Rotation effects, and employing Bayesian MCMC for noise modeling.

Result: Identified deviations from typical rotation measures in several pulsars and confirmed long-term linear trends in Faraday rotation; no evidence of oscillatory behavior within observation timespan.

Conclusion: The study enables deeper exploration of potential ALDM contributions to pulsar polarization, while providing insights into polarization behaviors affected by cosmic environments.
...
### [120] [Assessing the Relative Importance of Neutrino Matter Interaction Channels in Post-Merger Remnant of Binary Neutron Stars](https://arxiv.org/abs/2605.29187)
*Samantha Rath,Francois Foucart,Lawrence E. Kidder,Harald P. Pfeiffer,Mark A. Scheel*

Main category: astro-ph.HE

TL;DR: This study examines neutrino interactions in neutron star mergers, revealing the importance of detailed neutrino transport and interactions for understanding thermodynamic evolution and nucleosynthesis.


<details>
  <summary>Details</summary>
Motivation: To improve our understanding of r-process element production and thermodynamic evolution in neutron star mergers, by addressing limitations in existing neutrino transport simulations.

Method: The authors utilize energy-dependent Monte Carlo neutrino transport to evaluate neutrino opacities and their effects on thermalization and nucleosynthesis during neutron star mergers.

Result: Findings indicate significant contributions from inelastic scattering and enhanced pair annihilation rates in low-density regions, enhancing our understanding of neutrino interactions and resulting physics in merger remnants.

Conclusion: The study suggests that existing merger simulations underestimate the influence of specific neutrino interactions, necessitating more comprehensive models to capture the dynamics and outcomes of neutron star mergers.
...
### [121] [Recoil-regulated extreme mass-ratio inspirals in AGN disks](https://arxiv.org/abs/2605.29305)
*LingQin Xue,Zoltán Haiman,Hiromichi Tagawa,Imre Bartos*

Main category: astro-ph.HE

TL;DR: The study highlights the role of stellar interactions in the formation of extreme mass-ratio inspirals (EMRIs) within active galactic nucleus (AGN) disks, suggesting a strong influence on the detectability of EMRIs by future gravitational-wave observatories.


<details>
  <summary>Details</summary>
Motivation: To explore how stellar interactions within AGN disks affect the formation of EMRIs, which are critical for future gravitational-wave observations.

Method: The authors used semi-analytical AGN disk models and Monte Carlo simulations, analyzing black holes of varying masses and Eddington ratios to investigate the impact of binary interactions and recoil kicks on EMRI formation.

Result: The study finds that stellar interactions and recoil kicks significantly suppress EMRI formation across a broad parameter space, with detectable EMRIs mainly arising from young AGNs and involving merger-grown black holes.

Conclusion: Stellar interactions are crucial for understanding EMRI formation in AGN disks, and future observations can inform both AGN disk dynamics and the demographics of low-mass AGNs.
...
### [122] [Sub-luminous Type IIP SN 2024abfl as a result of a significantly low energy Fe-core collapse](https://arxiv.org/abs/2605.29363)
...
TL;DR: This paper presents the observations and analysis of SN 2024abfl, a low-luminosity Type IIP supernova with unique characteristics such as an unprecedented flat brightness plateau and low expansion velocities, contributing to the understanding of low-energy supernovae.


<details>
  <summary>Details</summary>
Motivation: The goal is to analyze the unique properties of SN 2024abfl, which lies at the faint end of Type IIP supernovae, and to explore its implications for low-energy core-collapse explosions.

Method: The study employs multiwavelength photometric and optical spectroscopic observations alongside hydrodynamical modeling to analyze SN 2024abfl's characteristics, distance, and progenitor scenarios.

Result: SN 2024abfl exhibits an unprecedented flat plateau with a mid-plateau absolute magnitude of -13.8 mag, narrow spectral lines, and parameters indicating a low-energy explosion with a compact progenitor.

Conclusion: The findings provide critical insights into the nature of low-energy core-collapse supernovae, enhancing the understanding of their progenitor scenarios and explosion physics.
...
### [123] [The Impact of the New $^{59}$Fe Decay Rates on $^{60}$Fe and $^{26}$Al Nucleosynthesis in Massive Stars](https://arxiv.org/abs/2605.29381)
*Bingyang Tan,Wenyu Xin,Ruizheng Jiang,Gang Zhao,Koh Takahashi*

Main category: astro-ph.HE

TL;DR: This study addresses the $^{60}$Fe/$^{26}$Al flux ratio in Galactic nucleosynthesis, revealing that updated decay rates significantly reduce $^{60}$Fe production and align theoretical predictions with observations.


<details>
  <summary>Details</summary>
Motivation: To resolve discrepancies between theoretical models and observed $^{60}$Fe/$^{26}$Al flux ratios in the Galaxy, particularly the overproduction of $^{60}$Fe.

Method: The authors computed a grid of non-rotating massive star models ($14$-$80$ M$_igodot$) at solar metallicity using the MESA code, incorporating recent temperature-dependent decay rates for $^{59}$Fe and conducting a numerical resolution analysis.

Result: The updated decay rate reduces $^{60}$Fe production by approximately 0.28 dex (about 47%), while $^{26}$Al yields remain unchanged, leading to a predicted flux ratio of $	ext{~}0.18$, closely matching the observed value of $0.184 	ext{ } 	ext{±} 0.042$.

Conclusion: This new nuclear physics approach resolves the overproduction problem for $^{60}$Fe, aligning models more closely with observational data.
...
### [124] [A Note on QPE Timing: False Alarms in O-C](https://arxiv.org/abs/2605.29382)
*Cong Zhou,Zirui Zhang,Zhen Pan,Wen Zhao*

Main category: astro-ph.HE

TL;DR: This paper discusses the impact of inaccurate cycle number assignment on O-C timing analysis of quasi-periodic eruptions (QPEs) and presents findings from two case studies: GSN 069 and eRO-QPE2.


<details>
  <summary>Details</summary>
Motivation: To analyze and interpret O-C timing data from quasi-periodic eruptions accurately, considering the sensitivity to cycle number assignment.

Method: The authors show how small mismatches in the assigned cycle numbers lead to significant errors in O-C diagrams and provide case studies using both O-C analysis and EMRI+disk modeling.

Result: For GSN 069, the data suggest an anti-phase modulation between even and odd eruptions; for eRO-QPE2, a near-circular EMRI and a precessing disk fit the data well.

Conclusion: Accurate cycle number assignments are crucial for reliable physical interpretations of O-C timing analysis in QPEs.
...
### [125] [From reflection to scattering: polarimetric signatures of funnel-type outflows. Modeling obscured ultraluminous X-ray sources](https://arxiv.org/abs/2605.29487)
*Varpu Ahlberg,Alexandra Veledina,Eugene Churazov,Ildar Khabibullin*

Main category: astro-ph.HE

TL;DR: The paper investigates the polarization and collimation of X-ray emissions from super-Eddington accretion onto compact objects, emphasizing the role of funnel surface albedo.


<details>
  <summary>Details</summary>
Motivation: To understand the geometry and radiative signatures of super-Eddington accretion flows, especially in terms of their effects on observed X-ray polarimetry.

Method: Utilizing semi-analytical methods and Monte Carlo simulations to model inclination-dependent radiative signatures, accounting for multiple scatterings.

Result: The study reveals a trade-off between polarization degree and emission collimation based on the albedo of the funnel surface, informing interpretations of X-ray polarization data.

Conclusion: This framework aids in deciphering X-ray polarimetric signatures from obscured compact objects like Cygnus X-3, linking observations with theoretical models and physical scenarios.
...
### [126] [Time-Domain Deep Learning for Pairwise Identification of Strongly Lensed Gravitational-Wave Candidates](https://arxiv.org/abs/2605.29510)
*Fan Zhang,Qikai Zhang,Qiyuan Yang,Jiaqing Huang,Yong Yuan,Xilong Fan*

Main category: astro-ph.HE

TL;DR: The paper introduces PI-ResNet, a fast machine learning approach for identifying strongly lensed gravitational waves (GWs) from time-domain strain data, achieving high classification accuracy and suggesting further adaptation for detector variations.


<details>
  <summary>Details</summary>
Motivation: The increasing size of GW catalogs and the computational demands of Bayesian analyses highlight the need for rapid prescreening methods in identifying strongly lensed GW events.

Method: The authors propose PI-ResNet, a Siamese ResNet architecture that processes raw time-domain strain data directly, comparing embedded features of paired input segments to classify GW candidates without intermediate time-frequency transformations.

Result: PI-ResNet achieves 95.60% accuracy for singular isothermal sphere lensed events and 93.80% for point-mass lenses under ideal conditions, and performs reasonably well under noisy environments, retaining 84.03% and 78.25% accuracy respectively.

Conclusion: The method demonstrates that direct analysis of 1D strain data can effectively facilitate the identification of lensed GW candidates, but emphasizes the necessity for further adaptation to specific detector noise characteristics.
...
### [127] [Enhanced All-Distance Equi-Zenith Angle Method for Cosmic-Ray Anisotropy Measurement](https://arxiv.org/abs/2605.29644)
*Dong-Xu Sun,Dan Li,Wei Liu,Qiang Yuan,Yi-Qing Guo,Hong-bo Hu*

Main category: astro-ph.HE

TL;DR: The paper presents an improved method for measuring cosmic-ray anisotropy, addressing challenges in precision due to detector instability.


<details>
  <summary>Details</summary>
Motivation: Measuring faint cosmic-ray anisotropy signals is challenging due to low intensity and instrumental artifacts.

Method: An enhanced all-distance equi-zenith angle method is introduced, enabling simultaneous measurement of anisotropies across multiple time frames and direct efficiency determination from data.

Result: The new method allows for high-precision anisotropy measurement, even with unstable detector arrays and incomplete data spanning.

Conclusion: The enhanced method significantly improves the reliability of cosmic-ray anisotropy measurements in various operational conditions.
...
### [128] [Long-Duration GRB 211211A: Internal Energy Dissipation Driven by a Long-Lived Magnetar](https://arxiv.org/abs/2605.30025)
*Nissim Fraija*

Main category: astro-ph.HE

TL;DR: The study analyzes GRB 211211A, proposing that its characteristics align with neutron star mergers resulting in a long-lived magnetar and variable accretion rates.


<details>
  <summary>Details</summary>
Motivation: To reconcile the unexpected association of a kilonova with the atypical long-duration GRB 211211A against existing classification schemes.

Method: Comprehensive modeling of X-ray data from a long-lived magnetar, examining fallback accretion rates of $\'dot{M}\propto t^0$ and $\'dot{M}\propto t^{\frac12}$ during its initial phase.

Result: The model successfully addresses the long duration of the prompt gamma-ray emission and explains precursor and extended emissions, suggesting the variable accretion rate model gives a better fit.

Conclusion: The findings support the merger of two neutron stars producing a long-lived magnetar, challenging traditional interpretations favoring immediate black hole formation.
...
### [129] [A new completely parameter-free clustering algorithm for unsupervised classification of BATSE gamma-ray bursts](https://arxiv.org/abs/2605.30175)
*Soumita Modak*

Main category: astro-ph.HE

TL;DR: This paper introduces a novel clustering algorithm for gamma-ray bursts (GRBs), addressing the uncertainty in the number of clusters involved and confirming two main groups consistent with existing theories.


<details>
  <summary>Details</summary>
Motivation: The need to resolve the conflicting number of clusters in GRB patterns and accurately categorize them to understand their physical sources.

Method: The paper proposes a 'completely parameter-free' clustering algorithm to classify GRBs, diverging from conventional approaches.

Result: The new algorithm identifies two primary groups of GRBs—short and long bursts—that align with the merger-collapsar theory, despite challenges faced by traditional methods.

Conclusion: The proposed algorithm provides a valid classification of GRBs, reinforcing the existing merger-collapsar framework while addressing prior methodological limitations.
...
### [130] [The Northern Cross Fast Radio Burst project: VI. The INCART public database](https://arxiv.org/abs/2605.30192)
*L. Bruno,G. Bernardi,M. Pilia,D. Pelliciari,A. Geminardi,F. Fiori,V. Galluzzi,G. Naldi,M. Trudu,A. Zanichelli*

Main category: astro-ph.HE

TL;DR: The paper introduces the Italian Northern Cross Atlas of Radio Transients (INCART), a public platform that provides access to FRB data from the Northern Cross radio interferometer, fostering research collaborations and enhancing data re-analysis.


<details>
  <summary>Details</summary>
Motivation: To provide a centralized, accessible resource for FRB data collected by the Northern Cross radio interferometer, enabling broader scientific use and ensuring long-term data storage.

Method: Developing the INCART platform which offers frequency-time series datasets and FRB catalogues with best-fit physical parameters, along with a future-proof processing pipeline.

Result: The creation of INCART facilitates public access to FRB data, enhancing the potential for scientific collaboration and maximizing the legacy value of the observations.

Conclusion: Accessible FRB data through INCART will significantly aid in future research by promoting re-analysis, collaboration, and integration with other databases.
