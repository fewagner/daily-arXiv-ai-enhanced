...
TL;DR: This paper discusses various aspects of hadron physics, focusing on charmed baryon decays, CP violation, and intrinsic charm mechanisms, using advanced theoretical frameworks like current algebra and nonlocal field operators.


<details>
  <summary>Details</summary>
Motivation: To introduce different research groups to hadron physics topics, fostering collaboration within the COST action CA24159.

Method: Utilizes the current algebra approach with tensor invariants and nonlocal extensions of theoretical models derived from QCD, including the relativistic Faddeev approach.

Result: Demonstrates how this framework can elucidate CP violation effects, analyze discrepancies in charm production data, and account for unique decay processes in hadron physics.

Conclusion: Highlights the need for further exploration of open questions in hadron research and suggests that nonlocal field operator models could reconcile existing discrepancies in experimental results.
...
TL;DR: Thermal misalignment offers a novel mechanism for scalar dark matter production, primarily influenced by particle interactions rather than initial conditions.


<details>
  <summary>Details</summary>
Motivation: To explore a new mechanism for cosmological scalar dark matter production that addresses constraints posed by cosmic microwave background and isocurvature perturbations.

Method: Utilizes thermal interactions to create a finite-temperature potential, inducing scalar misalignment early in the radiation era, and analyzing the resulting dynamics and perturbations.

Result: Thermal misalignment leads to a reduced isocurvature signal, permitting a wider parameter space for light scalars without conflicting with CMB bounds.

Conclusion: This approach provides a generic and viable alternative for producing scalar dark matter that is compatible with observational constraints.
...
TL;DR: High-energy lepton colliders, particularly wakefield ones, can effectively probe heavy vector resonances by utilizing beamstrahlung effects that broaden collision energy ranges.


<details>
  <summary>Details</summary>
Motivation: To investigate the capabilities of future high-energy lepton colliders in analyzing heavy vector resonances that may be key to new physics.

Method: The study examines the implications of beam-beam interactions at wakefield colliders, focusing on how beamstrahlung can enhance the sensitivity to resonances across various energy levels.

Result: The findings indicate that the beamstrahlung effect enhances the collider's ability to scan a wide array of center-of-mass energies, which is beneficial for resonance detection.

Conclusion: Utilizing beamstrahlung as a strength rather than a drawback offers a unique approach to exploring heavy vector resonances, exemplified through projections for a heavy kinetically mixed $Z'$.
...
TL;DR: The paper discusses the potential for gravitational wave emissions during the formation of quark matter cores in massive neutron stars during supernovae, highlighting new opportunities for high-frequency gravitational wave detectors to test theories of quantum chromodynamics.


<details>
  <summary>Details</summary>
Motivation: To explore the implications of quark matter cores in neutron stars and their potential gravitational wave emissions, which could provide insights into quantum chromodynamics.

Method: Examining the theoretical framework for the formation of quark matter cores in supernovae and predicting the associated gravitational wave emissions in the MHz range.

Result: Identified gravitational wave signals from quark matter core formation as potential targets for high-frequency detectors, expanding the scope of gravitational wave astronomy.

Conclusion: High-frequency gravitational wave detectors may reveal unique characteristics of quark matter and quantum chromodynamics that are otherwise difficult to study.
...
TL;DR: This study explores a multi-component dark matter model within the type-I two-Higgs-doublet framework, analyzing thermal production processes and confronting the model with experimental constraints.


<details>
  <summary>Details</summary>
Motivation: To understand the feasibility and constraints of a two-component dark matter scenario in the context of the type-I two-Higgs-doublet model.

Method: The authors examine dark matter candidates (a real scalar and a Dirac fermion) considering their production through thermal freeze-out, and analyze the parameter space including interactions through scalar and Yukawa couplings, imposing theoretical constraints.

Result: The scan over the parameter space identifies viable regions that meet dark matter requirements, although collider constraints significantly limit the scalar sector and lead to tension in the sub-TeV mass range.

Conclusion: While certain parameter choices align with dark matter phenomenology, stringent collider limits restrict the allowed configurations, indicating a conflict between dark matter viability and collider observables.
...
TL;DR: This paper reviews the significance of meV axions in physics, discussing theoretical and experimental aspects, their role as dark matter or dark radiation, and the motivations behind current research efforts.


<details>
  <summary>Details</summary>
Motivation: The meV mass range is critical for axion physics due to its potential links with dark matter and beyond-Standard-Model physics, necessitating a comprehensive overview amidst ongoing research.

Method: The paper synthesizes theoretical insights, cosmological and astrophysical implications, and experimental approaches, including helioscopes, haloscopes, and large-volume detectors.

Result: The review highlights both established knowledge and remaining uncertainties regarding meV axions, emphasizing their importance as probes of new physics.

Conclusion: The document aims to foster collaboration and guide future research on meV axions, showcasing their central role in understanding fundamental physics.
...
TL;DR: This paper examines how mixing between supersymmetric partners, specifically the photon and photino, occurs due to a Lorentz-symmetry violating (LSV) background, extending the Primakoff effect. It introduces LSV parameters via a non-dynamical superfield, leading to a photon-photino mixing term, and applies its findings to constraints in stellar physics using solar energy loss data.


<details>
  <summary>Details</summary>
Motivation: To explore new physics implications of mixing between supersymmetric partners in the context of Lorentz symmetry violation.

Method: Introduces LSV parameters as a non-dynamical superfield and analyzes the resulting photon-photino mixing in a superspace framework.

Result: Identifies a mixing term between gauge bosons and gauginos, allowing for the evaluation of physical effects in stellar scenarios.

Conclusion: Provides constraints on the strength of fermionic LSV backgrounds using solar energy loss data.
...
TL;DR: The study reassesses the parameter space of coannihilation dark matter in supersymmetric models, focusing on bino-slepton scenarios and incorporating recent LHC results, revealing specific mass constraints and implications for experimental observations.


<details>
  <summary>Details</summary>
Motivation: To explore the largely unexplored parameter space of coannihilation dark matter, particularly in the context of recent enhancements in LHC sensitivity to compressed mass spectra.

Method: The authors analyze the bino-slepton coannihilation scenario using the latest LHC results, focusing on minimal setups with light bino-like neutralinos and sleptons, and extending the analysis to include light higgsinos.

Result: The mass of dark matter is constrained to approximately 170-420 GeV for left-handed sleptons and 130-430 GeV for right-handed sleptons, with implications for muon g-2 and the SUSY contribution being limited to |Δa_μ^{m SUSY}|≤1.2×10^{-9}.

Conclusion: The combined constraints from LHC and direct detection experiments significantly narrow the viable parameter space for coannihilation dark matter and highlight its implications for related particles and observables.
...
TL;DR: The paper investigates the production of the $d_{N Ω}$ bound state in the $Ω^{-} d ightarrow p d_{N Ω}^-$ process using an effective Lagrangian approach, providing cross section estimates and potential experimental validations.


<details>
  <summary>Details</summary>
Motivation: To explore the production mechanisms of the $d_{N Ω}$ bound state and its implications for hadron physics, particularly in relation to existing experimental facilities.

Method: An effective Lagrangian approach is employed to model the $Ω^{-} d ightarrow p d_{N Ω}^-$ process, estimating cross sections for various beam momenta.

Result: Cross sections for the process were estimated at different $Ω$ beam momenta, showing significant variation: $(329.7^{+26.9}_{-49.6})$, $(174.0^{+26.5}_{-38.2})$, $(16.9^{+7.4}_{-7.7})$, and $(2.0^{+1.8}_{-1.4}) 	ext{ } μb$ for momenta of 0.7, 0.9, 2.0, and 4.0 GeV, respectively.

Conclusion: The findings suggest that the production of the $d_{N Ω}$ state can be experimentally verified at facilities like J-PARC and STCF, with additional implications for understanding dibaryon decays.
...
### [10] [Higgs boson decay to massive bottom quarks at order $α_s^4$ induced by top-quark Yukawa couplings](https://arxiv.org/abs/2603.18576)
*Jian Wang,Xing Wang,Yefan Wang*

Main category: hep-ph

TL;DR: The paper calculates contributions to Higgs boson decay to massive bottom quarks, finding that including top-quark Yukawa effects increases the decay width by 0.4%, which surpasses experimental precision at future lepton colliders.


<details>
  <summary>Details</summary>
Motivation: To improve the accuracy of the decay rate of the Higgs boson to massive bottom quarks by including higher-order contributions from top-quark Yukawa interactions.

Method: Calculated the decay width to $	ext{b}ar{	ext{b}}$ at $	ext{O}(α_s^4)$, factoring in contributions from top-quark Yukawa couplings, focusing on their enhancements due to logarithmic and power terms.

Result: Including top-quark Yukawa contributions increases the decay width by 0.4% compared to previous calculations up to $	ext{O}(α_s^3)$, while also reducing scale dependence significantly.

Conclusion: The findings highlight the importance of top-quark contributions in precision measurements of Higgs boson decay, potentially impacting future experimental observations.
...
### [11] [Cosmological Implications of the Slingshot Effect: Gravitational Waves, Primordial Black Holes and Dark Matter](https://arxiv.org/abs/2603.18512)
*Maximilian Bachmaier,Gia Dvali,Juan Sebastián Valbuena-Bermúdez,Michael Zantedeschi*

Main category: hep-ph

TL;DR: The paper investigates the slingshot effect, where a localized source crosses a domain wall, affecting gravitational waves, dark matter, and primordial black hole formation.


<details>
  <summary>Details</summary>
Motivation: To understand the slingshot effect's implications across various physical contexts, including confinement phases and cosmological phenomena.

Method: Analysis of the slingshot effect in scenarios involving monopoles, quarks, and $D$-branes crossing domain walls, along with their effects on gravitational waves and dark matter.

Result: It demonstrates that the slingshot effect influences gravitational wave sourcing and allows for the creation of primordial black holes within relevant mass ranges for dark matter and cosmic rays.

Conclusion: The slingshot effect has significant consequences for cosmology, particularly in the contexts of dark matter and gravitational wave generation.
...
### [12] [A Systematic Approach to Finite Multiloop Feynman Integrals](https://arxiv.org/abs/2603.18691)
...
TL;DR: The paper presents a method using Loop-Tree Duality to identify finite Feynman integrals efficiently, facilitating multiloop calculations by distinguishing singular and non-singular contributions, and introduces a new set of integrands to improve UV behavior.


<details>
  <summary>Details</summary>
Motivation: To enhance multiloop calculations by leveraging finite Feynman integrals with better analytical and numerical properties.

Method: Utilizing Loop-Tree Duality (LTD) to systematically identify finite integrals and propose a new strategy based on numerator and raised propagator Ansätze, alongside a generalized set of integrands defined within LTD.

Result: Achieves clarity and compactness in results similar to existing methods, while introducing integrands that are typically infrared-finite and reduce UV issues.

Conclusion: The proposed approach provides a robust foundation for high-order calculations, offering improved efficiency and management of singularities.
...
### [13] [Probing the Color-Octet Mechanism via Dihadron Fragmentation in $χ_b$ Decays](https://arxiv.org/abs/2603.18874)
*Zhi-Guo He,Guanghui Li,Yu-Jie Tian,Xin-Kai Wen,Bin Yan*

Main category: hep-ph

TL;DR: The paper explores the Artru-Collins asymmetry in bottomonium decays to investigate the color-octet mechanism in QCD, aiming to resolve discrepancies in matrix element calculations.


<details>
  <summary>Details</summary>
Motivation: To enhance understanding of color-octet dynamics and address limitations in current QCD matrix element measurements.

Method: The Artru-Collins asymmetry in ${e^+e^-}\to Υ(2S)\to γ χ_{b2}$ is analyzed in an asymmetric beam configuration to extract the ratio $ρ_8$ of color-octet to color-singlet matrix elements without strong suppression effects.

Result: The proposed method preserves the asymmetry in the laboratory frame, allowing for precise measurements of the ratio $ρ_8$ using data from Belle II.

Conclusion: By obtaining a reliable determination of $ρ_8$, the study aims to reconcile discrepancies between lattice calculations and phenomenological results in non-relativistic QCD.
...
TL;DR: This paper explores a model with a complex scalar singlet that enhances first-order electroweak phase transition (SFOEWPT) through a dimension-six operator, allowing for a wider parameter range and linking to observable gravitational waves and LHC signatures.


<details>
  <summary>Details</summary>
Motivation: To understand SFOEWPT within an effective field theory framework that modifies the Standard Model, enhancing its predictive power for phase transition dynamics.

Method: The study involves analyzing a model with a complex scalar singlet and a dimension-six term in the scalar potential, assessing its implications on phase transition parameters and dynamics.

Result: The presence of the dimension-six operator significantly expands the parameter space enabling SFOEWPT, predominantly influenced by the singlet scalar's VEV, which also affects particle production at the LHC.

Conclusion: This model has the potential to produce observable gravitational waves and distinctive multi-scalar signatures at LHC, indicating significant implications for exploring new physics beyond the Standard Model.
...
### [15] [Transverse spin effects and light-quark dipole moments at colliders](https://arxiv.org/abs/2603.18951)
*Xin-Kai Wen,Bin Yan,Zhite Yu,C. -P. Yuan*

Main category: hep-ph

TL;DR: The paper introduces innovative methods to study light-quark dipole interactions at colliders by measuring azimuthal asymmetries in dihadron production, allowing for substantial constraints on quark dipole moments and insights into $CP$ violations.


<details>
  <summary>Details</summary>
Motivation: To provide a unique and precise methodology for observing transversely polarized quarks and investigating new physics through dipole interactions in collider experiments.

Method: Measurement of azimuthal asymmetries in semi-inclusive deep inelastic lepton scattering and dihadron production at lepton colliders, focusing on the interactions of light quarks and their dipole moments.

Result: This approach can enhance constraints on dipole couplings by one to two orders of magnitude, facilitating the separation of up- and down-quark dipole moments and the contributions from different mediators.

Conclusion: The methods allow for simultaneous determination of dipole couplings, offering a promising route to explore potential $CP$-violating effects at high energies.
...
### [16] [Signatures of the $Ω(2012)^{-}$ state in $Ξ^*\bar K$ Correlation Functions](https://arxiv.org/abs/2603.18610)
*Jia-Xin Lin,Pablo Encarnación,Albert Feijoo,Miguel Albaladejo*

Main category: hep-ph

TL;DR: This study presents a quantitative analysis of the $Ω(2012)$ resonance in the strangeness $S=-3$ sector using a coupled-channel chiral unitary approach, highlighting its characteristics through femtoscopic correlation functions.


<details>
  <summary>Details</summary>
Motivation: To explore the properties of the $Ω(2012)$ resonance, including its dynamics and coupling in the $S=-3$ strangeness sector, and to utilize femtoscopic correlation functions as a means to extract resonance features.

Method: The $Ω(2012)$ is modeled as a quasi-bound state within a coupled-channel chiral unitary framework, with parameters constrained by mass and branching fraction measurements. Femtoscopic correlation functions are computed for systems involving $Ξ^{	ext{*}}K^-$, $Ξ^{	ext{*}}ar K^0$, and $Ω^-η$.

Result: The $Ω(2012)$ mass is determined to be $(2012.53	ext{meV} 	ext{±} 0.73)$ and its width $(4.05	ext{meV} 	ext{±} 0.13)$. Correlation functions exhibit significant near-threshold features indicative of the $Ω(2012)$ pole, particularly the $Ξ^{	ext{*}}K^-$ function as a selective probe of the resonance.

Conclusion: Femtoscopic measurements offer a robust means of probing resonance properties, surpassing traditional analyses and setting a theoretical framework for future experimental investigations of the molecular nature of the $Ω(2012)$. 
...
TL;DR: This study examines the impact of phenomenological prescriptions in the CSS approach on TMD extractions, highlighting significant theoretical uncertainties in fits for Drell-Yan data.


<details>
  <summary>Details</summary>
Motivation: To understand the effects of different $b_*$ prescriptions on the extraction of TMDs using the CSS approach, particularly in relation to Drell-Yan processes.

Method: We performed fits to low-energy Drell-Yan data utilizing various $b_*$ prescriptions and analyzed the impact on TMD extractions at different transverse momentum scales.

Result: Different $b_*$ prescriptions yielded comparable fits at low energies, but significant differences were observed at intermediate transverse momentum, affecting high-energy predictions.

Conclusion: The $b_*$ prescription introduces a theoretical uncertainty in the CSS approach, impacting TMD extractions, and emphasizes the significance of data across energy scales.
...
TL;DR: The study investigates the magnetic dipole moments of hidden-charm pentaquarks using QCD light-cone sum rules, revealing how these moments vary significantly based on internal quark configurations and spin alignments.


<details>
  <summary>Details</summary>
Motivation: To understand the electromagnetic properties of exotic hadrons and the impact of their internal structures on observables like magnetic dipole moments.

Method: Employing QCD light-cone sum rules with four different interpolating currents, accounting for contributions from light and charm quarks and higher-dimensional operators.

Result: The magnetic moments exhibit a strong dependence on quark configurations and spin alignments, showing significant variations across different currents despite identical quark content. Molecular-type predictions align with existing studies, while compact configurations present notable disparities in values.

Conclusion: Electromagnetic observables are highly sensitive to the internal structure of exotic hadrons, making them effective for distinguishing among different structural models.
...
### [19] [Correlator of heavy-light quark currents in HQET in the large $β_0$ limit](https://arxiv.org/abs/2603.18711)
*Andrey G. Grozin*

Main category: hep-ph

TL;DR: The paper calculates the perturbative contribution to the correlator of heavy-light quark currents in HQET, focusing on light-quark mass effects and leading-order renormalon poles.


<details>
  <summary>Details</summary>
Motivation: To enhance the understanding of heavy-light quark currents in the context of Heavy Quark Effective Theory (HQET) and the impact of light-quark mass on their correlators.

Method: The authors perform a perturbative expansion in light-quark masses up to quadratic terms and analyze the correlator of heavy-light quark currents at leading order in the parameter $1/β_0$.

Result: The study reveals details about ultraviolet and infrared renormalon poles associated with the Borel images of the Wilson coefficients, highlighting the complexities introduced by light-quark mass contributions.

Conclusion: The findings provide insight into the structure of heavy-light quark current correlators in HQET and the implications of renormalon behavior in quantum field theories.
...
### [20] [A global analysis of Energy-Energy Correlation data: determination of $α_S$ and non-perturbative QCD parameters](https://arxiv.org/abs/2603.19162)
*Ugo Giuseppe Aglietti,Giancarlo Ferrera,Lorenzo Rossi*

Main category: hep-ph

TL;DR: The paper presents a detailed analysis of Energy-Energy Correlations in electron-positron annihilation, achieving high precision in determining the strong coupling constant and non-perturbative parameters.


<details>
  <summary>Details</summary>
Motivation: To analyze Energy-Energy Correlation data in electron-positron annihilation to enhance understanding of strong interactions across varying energies.

Method: The authors employ a resummation technique to all orders for logarithmically-enhanced contributions, matching it with fixed-order calculations while including heavy-quark mass effects and non-perturbative corrections.

Result: An excellent fit to experimental data was achieved, leading to a precise determination of the strong coupling constant, α_S(m_Z^2) = 0.119 ± 0.002, and characterization of non-perturbative parameters.

Conclusion: The analysis, integrating datasets from ALEPH and AMY collaborations, represents a significant advancement in the precision measurement of strong interaction dynamics.
...
### [21] [Gamma-ray production in the cosmic-ray -- dark matter scattering as a probe of the axion-like particle -- proton interaction](https://arxiv.org/abs/2603.19103)
*Victor P. Goncalves,Emmanuel Moulin,Igor Reis,Aion Viana*

Main category: hep-ph

TL;DR: This paper explores the potential of very-high-energy (VHE) gamma-ray observatories to investigate axion-like particles (ALPs) in the Milky Way's dark matter halo through ALP-proton scattering. Current instruments can probe previously unexplored couplings and regions of axion dark matter models.


<details>
  <summary>Details</summary>
Motivation: To identify and explore the interaction between axion-like particles (ALPs) and cosmic rays, particularly in the context of dark matter interactions within the Milky Way.

Method: Utilizing the latest instrument response functions from ground-based VHE gamma-ray observatories like H.E.S.S., CTAO, and SWGO to explore ALP-proton couplings throughout a specified mass range.

Result: The study finds that ongoing and future VHE gamma-ray experiments can achieve sensitivities to ALP-proton couplings above $10^{-2}$ in the mass range of $1 - 10^{8}$ eV, revealing the potential to investigate QCD axion dark matter models.

Conclusion: VHE gamma-ray astronomy holds significant promise for placing unique constraints on ALPs and their interactions with baryonic matter, thereby advancing our understanding of dark matter.
...
### [22] [From N- to (p,N)- Inflationary Attractors in view of ACT](https://arxiv.org/abs/2603.18826)
*C. Pallis*

Main category: hep-ph

TL;DR: The paper reviews fractional Kaehler potentials in the context of inflation models, identifying attractors leading to observable effects compatible with empirical data.


<details>
  <summary>Details</summary>
Motivation: To explore the behavior of fractional Kaehler potentials under inflationary dynamics and their impact on observable cosmological parameters.

Method: Analyzed two types of fractional Kaehler potentials within a non-linear sigma model alongside traditional chaotic inflationary potentials, employing supergravity models with chiral superfields.

Result: Identified a class of inflationary attractors that yield observable predictions consistent with ACT DR6 data, despite inflation occurring at subplanckian inflaton values.

Conclusion: The inflation models suggest that the tensor-to-scalar ratio could be measurable soon, as they align with observational data.
...
### [23] [Searching for dark matter X-ray lines from the Large Magellanic Cloud with eROSITA](https://arxiv.org/abs/2603.19109)
*Jorge Terol Calvo,Marco Taoso,Andrea Caputo,Michela Negro,Marco Regis*

Main category: hep-ph

TL;DR: This study searches for an X-ray line from dark matter decay in the Large Magellanic Cloud, finding no evidence and setting new limits on dark matter properties.


<details>
  <summary>Details</summary>
Motivation: To explore potential signals of dark matter decay, specifically from sterile neutrinos and axion-like particles, within astronomical observations.

Method: Analyzed eROSITA-DE DR1 datasets in the 1 to 9 keV energy range to search for dark matter decay emission lines.

Result: No evidence for a dark matter emission line was found, leading to the establishment of lower limits on dark matter lifetime and upper limits on mixing angles and coupling coefficients for specific dark matter candidates.

Conclusion: The results provide strong constraints on dark matter mass and properties, particularly for masses below 5 keV.
...
### [24] [Hadron production through Higgs decay at next-to-leading order in the general-mass variable-flavor-number scheme](https://arxiv.org/abs/2603.18875)
*S. Mohammad Moosavi Nejad*

Main category: hep-ph

TL;DR: This study examines the impact of b-quark and B-meson masses on the scaled-energy distribution of B-mesons produced in Higgs decays, revealing significant enhancements in decay rates in specific energy regions.


<details>
  <summary>Details</summary>
Motivation: The paper addresses previous omissions in the analysis of Higgs decay to B-mesons by incorporating mass effects, aiming to refine our understanding of Higgs characteristics through B-hadron studies.

Method: The authors use a general-mass variable-flavor-number scheme (GM-VFNs) to account for the mass of b-quarks and B-mesons in analyzing the scaled-energy ($x_B$) distribution of B-mesons.

Result: The study finds that the B-meson mass significantly enhances the partial decay width in the low-$x_B$ region, while the b-quark mass increases the decay rate in the peak region and above.

Conclusion: Incorporating mass effects leads to a more accurate representation of Higgs decay processes, potentially revealing new insights into Higgs characteristics through B-meson distributions.
...
### [25] [Two-body strong decays of the pseudoscalar hidden-charm tetraquark states via the QCD sum rules](https://arxiv.org/abs/2603.18877)
*Yu-Hang Xu,Zhi-Gang Wang*

Main category: hep-ph

TL;DR: This study investigates pseudoscalar hidden-charm tetraquark states by using QCD sum rules to analyze their decay properties and calculate decay widths.


<details>
  <summary>Details</summary>
Motivation: The investigation into the properties of the pseudoscalar hidden-charm tetraquark states, important for understanding strong interactions and exotic states in quantum chromodynamics (QCD).

Method: The study employs QCD sum rules based on quark-hadron duality, incorporating vacuum condensates up to dimension 5 to derive hadronic coupling constants.

Result: Total decay widths obtained are: $Γ_{Z_{c}^{-}} = 326.197^{+4.255}_{-3.106}$ MeV and $Γ_{Z_{c}^{+}} = 91.835^{+0.96}_{-0.76}$ MeV for the $Z_{c}^{-}$ and $Z_{c}^{+}$ states, respectively.

Conclusion: The analysis provides crucial insights into the decay properties of tetraquark states, shedding light on their underlying quark structures.
...
### [26] [Direct $CP$ violation in $D^\pm \to π^\pm π^+ π^-$ with $a_0^0(980)-f_0(980)$ mixing](https://arxiv.org/abs/2603.18917)
*Shi-Ji Cao,Jing-Juan Qi,Yi-Fan Zhao,Chao Wang,Zhen-Yang Wang,Xin-Heng Guo*

Main category: hep-ph

TL;DR: This study examines direct CP violation in D± decays, highlighting the impact of a mixing mechanism between the a0^0(980) and f0(980) resonances. The mixing intensities are calculated, showing significant effects on CP asymmetry near the f0(980) resonance, particularly influenced by quark composition and mixing angles.


<details>
  <summary>Details</summary>
Motivation: To explore how the mixing of a0^0(980) and f0(980) affects CP violation in meson decays, providing insights for both theoretical models and experimental verification.

Method: Integrated mixing intensities are calculated using meson masses and coupling constants from various models and experimental data, focusing on the invariant mass of the π+π− pair.

Result: The study finds that the mixing mechanism can significantly enhance the CP asymmetry, especially when conditions favor a notable nar{n} quark component and a mixing angle of about 26°.

Conclusion: Incorporating the a0^0(980)−f0(980) mixing mechanism is crucial for understanding CP violation in D and B meson decays, with implications for future theoretical and experimental research.
...
TL;DR: A non-supersymmetric inverse seesaw model utilizing $A^{	ext{'}}_5$ modular symmetry explains neutrino masses, mixing, and cosmic baryon asymmetry via leptogenesis, with phenomenological predictions compatible with current data.


<details>
  <summary>Details</summary>
Motivation: To unify the explanation of neutrino masses, mixing, and the cosmic baryon asymmetry through a novel theoretical framework.

Method: Constructed three concrete realizations of a non-supersymmetric inverse seesaw model based on $A^{	ext{'}}_5$ modular symmetry and analyzed their phenomenological implications.

Result: Results align with measured neutrino oscillation parameters and provide predictions for mass ordering, CP-violating phases, and effective Majorana mass, alongside a TeV-scale leptogenesis scenario.

Conclusion: The framework is testable in both low-energy neutrino experiments and high-energy collider searches, offering a comprehensive approach to neutrino physics.
...
TL;DR: The paper reviews advancements in understanding preheating in Higgs inflation using the Einstein-Cartan framework, noting phenomena such as oscillon formation and their implications for the Universe's evolution.


<details>
  <summary>Details</summary>
Motivation: To explore preheating dynamics in Higgs inflation within the Einstein-Cartan framework and its effects on the Universe's thermal history.

Method: Analyze the evolution of the Higgs field post-inflation using tachyonic instabilities and nonlinear self-interactions to derive implications for observable phenomena.

Result: Identified that self-interactions at low field values lead to transient oscillons and decay, shifting the Universe towards radiation domination.

Conclusion: The findings highlight significant implications for inflationary observables and gravitational wave generation, crucial for understanding the early Universe's thermal history.
...
### [29] [Asymptotic Expansions for Neural Network Approximations of Quantum Channels](https://arxiv.org/abs/2603.18033)
*Rômulo Damasclin Chaves dos Santos*

Main category: quant-ph

TL;DR: This paper presents the Quantum Voronovskaya--Damasclin Theorem, characterizing Quantum Neural Network Operators' asymptotic behavior in approximating quantum channels.


<details>
  <summary>Details</summary>
Motivation: To extend the classical Voronovskaya theorem to the realm of quantum information, specifically for non-commutative operators.

Method: Rigorous quantum analogues of Sobolev and Hölder spaces are developed using Fréchet differentiability and the completely bounded norm, leading to an asymptotic expansion of the approximation error.

Result: An explicit expansion of the approximation error is derived, detailing contributions from integer-order, fractional, and non-commutative effects, along with a sharp remainder estimate.

Conclusion: The findings enhance understanding of quantum neural networks and their approximation capabilities, linking classical theory with quantum information science, and offering practical implications for quantum algorithms and machine learning.
...
### [30] [Advanced Quantum Annealing for the Bi-Objective Traveling Thief Problem: An $\varepsilon$-Constraint-based Approach](https://arxiv.org/abs/2603.18038)
*Nguyen Hoang Viet,Nguyen Xuan Tung,Trinh Van Chien,Won-Joo Hwang*

Main category: quant-ph

TL;DR: This paper presents an advanced hybrid approach for solving the Bi-Objective Traveling Thief Problem by combining quantum annealing and the epsilon-constraint method.


<details>
  <summary>Details</summary>
Motivation: The BI-TTP presents significant scalability issues due to complex interdependencies in routing and packing decisions, making classical approaches less effective.

Method: The method reformulates the bi-objective problem into a single-objective format using epsilon-level restrictions, converts it into a QUBO model for quantum annealing, and applies a heuristic for solution refinement.

Result: The proposed hybrid method captures a broad Pareto front and outperforms traditional methods in balancing travel cost and item profit while improving time efficiency.

Conclusion: Experimental results confirm the hybrid approach's effectiveness, demonstrating enhanced solution diversity and performance over baseline methods.
...
### [31] [Some Studies On Exact Solutions Of Models In Noncommutative Spaces](https://arxiv.org/abs/2603.18047)
*Manjari Dutta*

Main category: quant-ph

TL;DR: This thesis investigates solvable models in time dependent noncommutative spaces, presenting exact solutions and examining their energy dynamics and Berry phases.


<details>
  <summary>Details</summary>
Motivation: To deepen the understanding of quantum theory in noncommutative spaces and explore solvable models for theoretical development.

Method: Application of Lewis Riesenfeld theory to develop exact solutions, analyze energy expectation values analytically, and study the Berry geometric phase.

Result: Derived exact solutions and explored energy dynamics, revealing the presence of a non-zero Berry phase due to noncommutativity.

Conclusion: The research indicates a strong potential for a consistent quantum theory in time dependent noncommutative frameworks.
...
### [32] [Cache Hierarchy and Vectorization Analysis of Lindblad Master Equation Simulation for Near-Term Quantum Control](https://arxiv.org/abs/2603.18052)
*Rylan Malarchick*

Main category: quant-ph

TL;DR: The paper addresses the computational challenges of simulating open quantum systems via the Lindblad master equation, particularly focusing on optimization strategies for matrix operations to enhance performance on modern CPUs.


<details>
  <summary>Details</summary>
Motivation: To overcome the computational bottlenecks in simulating open quantum systems while performing tasks like optimal pulse engineering and feedback controller design.

Method: The study analyzes the performance of matrix-vector multiplications by constructing a Roofline model, examining compiler optimizations, and employing the structure-of-arrays (SoA) layout for enhanced arithmetic intensity and cache usage.

Result: Using SoA layout with optimized compiler flags, the research achieves a speedup of 2-4 times compared to traditional methods, highlighting the importance of compiler options like -ffast-math for auto-vectorization.

Conclusion: The paper provides practical recommendations for quantum simulation libraries to improve efficiency in simulating near-term quantum systems.
...
### [33] [XCOM: Full Mesh Network Synchronization and Low-Latency Communication for QICK (Quantum Instrumentation Control Kit)](https://arxiv.org/abs/2603.18977)
*Diego Martin,Luis H. Arnaldi,Kenneth Treptow,Neal Wilcer,Sho Uemura,Sara Sussman,David I Schuster,Gustavo Cancelo*

Main category: quant-ph

TL;DR: XCOM is a network solution for synchronizing multi-board control systems in quantum computing, achieving precise synchronization and low-latency communication across hardware components.


<details>
  <summary>Details</summary>
Motivation: There is a need for scalable control systems in superconducting and spin qubit testbeds, which require coordination beyond single electronics board capabilities.

Method: XCOM synchronizes QICK boards and absolute clocks to within 100 ps and enables deterministic all-to-all data communication with latency below 185 ns.

Result: XCOM achieves high precision and low latency communication for multi-board control in large-scale quantum systems.

Conclusion: XCOM is a scalable and versatile solution that enhances the coordination of control systems in diverse qubit technologies.
...
### [34] [Reinforcement Learning for Fast and Robust Longitudinal Qubit Readout](https://arxiv.org/abs/2603.18060)
*Yiming Yu,Yuan Qiu,Xinyu Zhao,Ye-Hong Chen,Yan Xia*

Main category: quant-ph

TL;DR: This paper presents a reinforcement learning approach to optimize longitudinal coupling waveforms for quantum nondemolition readout, improving signal-to-noise ratio (SNR) and robustness under hardware constraints.


<details>
  <summary>Details</summary>
Motivation: The motivation is to enhance quantum nondemolition (QND) readout through optimized pulse design, addressing limitations posed by coupling strength and necessary photon numbers.

Method: A reinforcement learning framework is developed to optimize the longitudinal coupling waveform, utilizing shortcuts to adiabaticity (STA) and cubic B-spline parameterization.

Result: The optimized pulse achieves a roughly 50% improvement in signal-to-noise ratio (SNR) compared to an STA baseline and shows better robustness to parameter drifts.

Conclusion: The study successfully demonstrates that reinforcement learning can effectively enhance the performance of longitudinal readout pulses, providing smooth and interpretable waveforms aligned with hardware constraints.
...
### [35] [One Key Good, L Keys Better: List Decoding Meets Quantum Privacy Amplification](https://arxiv.org/abs/2603.18097)
*Prateek P. Kulkarni*

Main category: quant-ph

TL;DR: This paper introduces list privacy amplification (LPA) to enhance key extraction in quantum key distribution (QKD), ensuring that at least one key remains secret from an eavesdropper while increasing the length of extractable keys.


<details>
  <summary>Details</summary>
Motivation: To improve the final key extraction step in QKD and address limitations of traditional quantum leftover hash lemma (QLHL) by allowing the extraction of multiple candidate keys while guaranteeing at least one remains secret from an eavesdropper.

Method: Formalizes list privacy amplification (LPA) within an abstract cryptographic framework and proves the Quantum List Leftover Hash Lemma (QLLHL) that allows for a list of candidate keys to be extracted under specific conditions, offering an additive gain over QLHL.

Result: Establishes that the list size can be increased significantly, allowing for larger tolerable error rates in QKD schemes; demonstrates the conditions under which LPA can be effectively applied, alongside proving its tightness and providing two practical constructions.

Conclusion: LPA effectively increases key extraction capabilities in QKD, enabling higher resistance against eavesdropping and larger successful key lengths, with practical constructions that enhance the performance of quantum cryptographic systems.
...
### [36] [Improved quantum circuits for division](https://arxiv.org/abs/2603.18110)
*Priyanka Mukhopadhyay,Alexandru Gheorghiu,Hari Krovi*

Main category: quant-ph

TL;DR: This paper presents optimized fault-tolerant quantum circuits for integer division algorithms, achieving significant reductions in T-count and CNOT-count compared to previous constructions.


<details>
  <summary>Details</summary>
Motivation: To develop more efficient quantum circuits for arithmetic operations crucial in quantum algorithms.

Method: Introducing a primitive called COMP-N-SUB, which combines integer comparison and conditional subtraction, enabling more efficient circuit designs.

Result: The new circuits achieved up to 76.08% T-count reduction and 68.35% CNOT-count reduction, and improved asymptotic T-depth from $O(n^2)$ to $O(n "log n)$.

Conclusion: This approach lowers both qubit counts and gate costs, enhancing the efficiency of integer division in quantum computing.
...
### [37] [Towards sample-optimal learning of bosonic Gaussian quantum states](https://arxiv.org/abs/2603.18136)
*Senrui Chen,Francesco Anna Mele,Marco Fanizza,Alfred Li,Zachary Mann,Hsin-Yuan Huang,Yanbei Chen,John Preskill*

Main category: quant-ph

TL;DR: Characterization of bosonic Gaussian states using minimal samples is studied, revealing necessary sample sizes and bounds for learning these states across various measurements, improving quantum learning theory in practical applications.


<details>
  <summary>Details</summary>
Motivation: Understanding the efficiency limits in characterizing bosonic Gaussian states is crucial for advancing quantum technologies in diverse fields such as computation and sensing.

Method: An analytical approach to determine the number of copies required to learn an n-mode Gaussian state to a defined trace distance, establishing bounds for Gaussian and non-Gaussian measurements.

Result: Proved lower bounds of Ω(n^3/ε^2) and Ω(n^2/ε^2) for different measurement types, while deriving upper bounds that indicate the importance of measurement type in learning state properties.

Conclusion: The findings enhance the comprehension of quantum learning in bosonic regimes, emphasizing the distinct measurement requirements for pure versus passive Gaussian states, with implications for quantum sensing and benchmarking.
...
### [38] [Theory of Two-Qubit $T_2$ Spectroscopy of Quantum Many-Body Systems](https://arxiv.org/abs/2603.18176)
*Hossein Hosseinabadi,Pavel E. Dolgirev,Sarang Gopalakrishnan,Amir Yacoby,Eugene Demler,Jamir Marino*

Main category: quant-ph

TL;DR: This paper highlights the use of two-qubit quantum sensors to analyze environmental responses and noise through a $T_2$ spectroscopy framework, enabling insights into correlation dynamics and transport regimes.


<details>
  <summary>Details</summary>
Motivation: To enhance the capabilities of single-qubit sensing by utilizing two-qubit sensors for more nuanced analysis of environmental responses.

Method: Suitable pulse sequences are applied to a two-qubit sensor, allowing the separate extraction of response and noise, which enables the resolution of correlation dynamics in many-body systems.

Result: The approach successfully resolves spatio-temporal spreading of correlations, revealing features like light-cone-like profiles and the effects of non-equilibrium conditions on these profiles.

Conclusion: The method effectively distinguishes between various transport regimes, including ballistic and diffusive behaviors, and demonstrates the potential for profound insights into many-body systems.
...
### [39] [Fully selective charging of a quantum battery by a purely quantum charger](https://arxiv.org/abs/2603.18181)
*Yohan Vianna,Marcelo F. Santos*

Main category: quant-ph

TL;DR: The paper presents an optimal protocol for charging a two-level quantum battery using a bipartite charger, extending its application to multiple batteries by leveraging quantum coherence.


<details>
  <summary>Details</summary>
Motivation: To optimize the charging efficiency of quantum batteries and explore applications in quantum computation.

Method: Introducing a bipartite charger made of quantum harmonic oscillators and selective interactions to charge the battery and adapt protocols for active state resetting.

Result: The protocol enables full charging of the battery and is universally optimal; quantum coherence is utilized to charge multiple batteries efficiently.

Conclusion: The findings suggest significant implications for quantum technology, particularly in quantum computation tasks like active state resetting.
...
### [40] [Towards spintronics via tunneling through asymmetric barriers](https://arxiv.org/abs/2603.18187)
*Elvira Bilokon,Valeriia Bilokon,Stanislava Litvinova,Denys I. Bondar,Andrii Sotnikov*

Main category: quant-ph

TL;DR: Directional spin currents can be generated in a one-dimensional fermionic ring with static, spin-independent asymmetric barriers, showing that initial state preparation and barrier tuning can enhance or reverse these currents.


<details>
  <summary>Details</summary>
Motivation: The study aims to explore new mechanisms for generating spin transport without relying on conventional methods like magnetic fields or spin-orbit coupling.

Method: The authors theoretically analyze a one-dimensional interacting fermionic ring with asymmetric barriers to investigate the emergence of spin-resolved circulating currents.

Result: Asymmetric barrier geometries lead to the emergence of spin-resolved currents even from symmetric initial configurations, with the effects being tunable through initial state preparation and barrier adjustments.

Conclusion: The findings suggest a novel approach to generating directional spin currents, opening avenues for manipulation and control in spintronic devices.
...
### [41] [Dissipative Phase Transition in a Parametrically Amplified Quantum Rabi Model with Two-photon decay](https://arxiv.org/abs/2603.18188)
*Mingjian Zhu,Han Pu*

Main category: quant-ph

TL;DR: The study explores dissipative phase transitions in an open quantum Rabi model, revealing four composite phases and an inverted regime with distinct DPT characteristics.


<details>
  <summary>Details</summary>
Motivation: To understand dissipative phase transitions in quantum systems, focusing on their behavior in open quantum Rabi models influenced by photon decay.

Method: Mean-field analysis, adiabatic approach, and semi-classical Langevin formalism to analyze steady-state structures and phase transitions.

Result: Four composite phases are identified, with a unique inverted regime and a tricritical point marking first- and second-order DPTs, influenced by two-photon dissipation.

Conclusion: The findings unveil the role of nonlinearity in criticality and propose scaling relations for understanding the critical behavior of these phase transitions.
...
### [42] [On Non-Existence of Stabilizer Absolutely Maximally Entangled States in Even Local Dimensions](https://arxiv.org/abs/2603.18193)
*Jakub Wójcik,Owidiusz Makuta,Wojciech Bruzda,Remigiusz Augusiak*

Main category: quant-ph

TL;DR: The paper shows that AME states with $N=4k$ qudits and even local dimension cannot be graph states, highlighting constraints on multipartite systems.


<details>
  <summary>Details</summary>
Motivation: To explore the realizability of AME states as graph states and understand their limitations in quantum systems.

Method: The authors analyse properties of AME states and their characterization within the stabilizer formalism, using combinatorial and algebraic techniques.

Result: Demonstrated that specific AME states (for $N=4k$ qudits) cannot be represented as graph states, impacting our understanding of multipartite entanglement.

Conclusion: This work clarifies that certain AME states cannot be constructed as graph states, providing insights into the nature of entanglement in complex quantum systems.
...
### [43] [Bell-EPR Correlations within Local Quantum Theory](https://arxiv.org/abs/2603.18198)
*Jay Lawrence*

Main category: quant-ph

TL;DR: The paper introduces a local unitary theory for Bell-EPR measurements, detailing premeasurement filtering and the detection process using multiple photodetectors. It highlights local decoherence and the confirmation of Bell-EPR correlations through communication of outcomes.


<details>
  <summary>Details</summary>
Motivation: To provide a local framework for understanding Bell-EPR measurements amidst various interpretations.

Method: The theory incorporates local decoherence linked to each detector's absorption of photons, using four photodetectors positioned at two stations.

Result: Local decoherence occurs independently at each detector, aligning with Bell-EPR correlations observed through post-measurement communication.

Conclusion: The proposed theory maintains a local perspective, contrasting with other non-local interpretations.
...
### [44] [Finite-size resource scaling for learning quantum phase transitions with fidelity-based support vector machines](https://arxiv.org/abs/2603.18211)
*Aaqib Ali,Giovanni Scala,Cosmo Lupo,Antonio Mandarino*

Main category: quant-ph

TL;DR: The paper discusses the scalability of quantum kernels in learning about quantum phase transitions, addressing how model symmetry affects resource requirements for fidelity estimation.


<details>
  <summary>Details</summary>
Motivation: To clarify the relationship between model symmetry and the scalability of learning strategies in quantum phase transitions.

Method: The authors derive a connection between model symmetry and the required measurement resources, using a tunable one-dimensional spin-1/2 Hamiltonian and estimating fidelity-based quantum kernels via a SWAP-test estimator.

Result: Increased symmetry in the spin model leads to higher measurement shot requirements, with specific examples from symmetric Ising, XY, and XXZ regimes illustrating substantial shot costs despite similar bounds.

Conclusion: The findings offer a practical framework for implementing physics-informed quantum machine learning by providing symmetry-aware bounds for estimating quantum kernel resources.
...
### [45] [High-dimensional quantum communication with scalable photonic entanglement in time and frequency](https://arxiv.org/abs/2603.18212)
...
TL;DR: This paper presents a scan-free method for characterizing high-dimensional photonic entanglement, achieving notable fidelity and ebit values while paving the way for robust quantum communication.


<details>
  <summary>Details</summary>
Motivation: The need for improved methods to characterize high-dimensional entangled states due to the limitations of traditional full state tomography.

Method: A novel scan-free technique was applied in the time-frequency domain to reconstruct high-dimensional entangled states, achieving notably high fidelity and ebit values.

Result: A record $5.70\pm0.07$ ebits with $65.4\pm0.4\%$ fidelity, certifying $668$-dimensional entanglement and enabling a secure key rate of $15.6$ kB/s in a quantum communication protocol.

Conclusion: The proposed architecture is both scalable and practical for high-rate, noise-resilient quantum communication schemes, potentially enhancing current capabilities.
...
### [46] [Preprocessing noise in finite-size quantum key distribution](https://arxiv.org/abs/2603.18213)
*Gabriele Staffieri,Giuseppe D'Ambruoso,Giovanni Scala,Cosmo Lupo*

Main category: quant-ph

TL;DR: Preprocessing noise can enhance quantum key distribution (QKD) by allowing for higher qubit error rates. This study analyzes preprocessing noise in a finite-size regime, identifying optimal conditions for key rate improvements and the maximum tolerable qubit error rate.


<details>
  <summary>Details</summary>
Motivation: To explore how preprocessing noise affects quantum key distribution, particularly in scenarios with limited signal exchanges, enhancing key generation capabilities even under higher error rates.

Method: We employ a two-step Frank-Wolfe algorithm to compute numerical lower bounds concerning the sandwiched Rényi entropy of order alpha, factoring in a trusted noise parameter q.

Result: Trusted noise effectively improves key rates within a specific range of alpha (1 to approximately 1.4), allowing enhanced performance in both asymptotic and finite-size contexts and revealing a correlation between block size and maximum tolerable QBER.

Conclusion: The study demonstrates that preprocessing noise can facilitate secret key generation beyond conventional limits, with potential dependencies on block size and QBER.
...
### [47] [Operator dynamics in k-Markov random circuits](https://arxiv.org/abs/2603.18217)
*Unnati Akhouri,Pei-Jun Huang,Elliott Rose,Sarah Shandera*

Main category: quant-ph

TL;DR: This study explores $k$-Markov sequences of unitary gates for efficient manipulation of information flow in quantum circuits, highlighting their advantages over traditional 0-Markov circuits.


<details>
  <summary>Details</summary>
Motivation: To address the inefficiencies in information spreading in quantum circuits, the authors investigate $k$-Markov sequences as a better alternative to random 0-Markov circuits.

Method: The study employs graph cover time analysis to show how $k$-Markov processes affect operator transport and utilizes SWAP gates to assess scrambling time and spatial-temporal correlations in qubit networks.

Result: The findings reveal that $k$-Markov circuits lead to significant changes in Hamming weight dynamics and space-time correlation structures compared to 0-Markov circuits, influenced by transition probabilities.

Conclusion: $k$-Markov sequences provide a systematic approach to manipulate information dynamics and correlations in quantum systems, enhancing control over quantum state evolution.
...
### [48] [An HHL-Based Quantum-Classical Solver for the Incompressible Navier-Stokes Equations with Approximate QST](https://arxiv.org/abs/2603.18222)
*Moshe Inger,Steven Frankel*

Main category: quant-ph

TL;DR: The paper explores the integration of quantum linear system algorithms with computational fluid dynamics (CFD) to enhance the efficiency of solving the Poisson equation arising from the Navier-Stokes equations, demonstrating successful simulations of fluid dynamics.


<details>
  <summary>Details</summary>
Motivation: To address the computational bottleneck in solving the Poisson equation in CFD, leveraging quantum algorithms for exponential speedup.

Method: Coupling the Harrow-Hassidim-Lloyd (HHL) algorithm with a discretized version of the incompressible Navier-Stokes equations, using a novel quantum state tomography (QST) technique for readout.

Result: Accurate simulations of lid-driven cavity flow and Taylor-Green vortex are achieved, validating the hybrid quantum algorithm against classical methods.

Conclusion: The study establishes a framework for quantum fluid dynamics simulations and showcases a viable approach for future high-Reynolds number CFD workflows.
...
### [49] [From Classical Stochastic to Monitored Quantum Dynamics: Dynamical Phase Coexistence in East Circuit Models](https://arxiv.org/abs/2603.18227)
*Marcel Cech,Johan du Buisson,Cecilia De Fazio,Federico Carollo,Igor Lesanovsky*

Main category: quant-ph

TL;DR: This paper investigates monitored quantum circuit models to explore dynamical phase coexistence between active and inactive phases influenced by measurement strength.


<details>
  <summary>Details</summary>
Motivation: To understand emergent phenomena in the dynamics of kinetically constrained models, particularly in relation to quantum and classical dynamics.

Method: The authors interpret measurement records as microstates of a fictitious 1+1D spin system, utilizing thermodynamic concepts to analyze phase coexistence.

Result: The study reveals different signatures of dynamical phase coexistence as measurement strength varies, highlighting persistent dynamics in the quantum regime.

Conclusion: The findings provide insights into the complexities of many-body dynamics, suggesting implications for future experiments in quantum simulators.
...
### [50] [Iterative Decoding of Stabilizer Codes under Radiation-Induced Correlated Noise](https://arxiv.org/abs/2603.18231)
*Anuj K. Nayak,Paul G. Baity,Peter J. Love,Nicholas Jeon,Byung-Jun Yoon,Adolfy Hoisie,Lav R. Varshney*

Main category: quant-ph

TL;DR: This paper presents a method to improve fault-tolerant quantum computation through joint noise sensing and decoding by modeling quasiparticle density as a latent variable, resulting in reduced logical error rates under radiation-induced correlated noise.


<details>
  <summary>Details</summary>
Motivation: Fault-tolerant quantum computation requires low error rates, but superconducting qubits face challenges from radiation-induced correlated noise.

Method: The authors employ a variational expectation-maximization approach, developing an iterative algorithm that alternates between quasiparticle density estimation and syndrome-based decoding to improve noise model accuracy.

Result: Simulations show a significant reduction in logical error probability compared to traditional decoding methods that use a uniform prior.

Conclusion: Integrating physical noise estimation into the decoding process can effectively mitigate correlated noise and ease the error-rate requirements for quantum computation.
...
### [51] [Multi-Outcome Circuit Optimization for Enhanced Non-Gaussian State Generation](https://arxiv.org/abs/2603.18303)
*S. Ismailzadeh,B. Abedi Ravan*

Main category: quant-ph

TL;DR: This paper introduces a multi-outcome optimization strategy in photonic quantum computing to improve the generation of non-Gaussian quantum states, enhancing overall success rates through diversified measurement patterns.


<details>
  <summary>Details</summary>
Motivation: The paper aims to address the challenge of low success rates in generating non-Gaussian quantum states necessary for fault-tolerant quantum computation, which typically involves high precision in measurements.

Method: The authors propose a multi-outcome optimization strategy that uses a single circuit to produce quantum states across several measurement patterns, evaluated by generating various core states with Gaussian circuits.

Result: The strategy shows improved success probabilities through simultaneous targeting of diverse resource states and aggregation of degenerate outcomes for increased production rates.

Conclusion: The findings illustrate that this approach can significantly enhance the efficiency and reliability of quantum state generation in photonic quantum computing.
...
### [52] [Efficient Soft-Output Guessing for Enhanced Quantum Tanner Code Decoding](https://arxiv.org/abs/2603.18318)
*Lukas Rapp,Muriel Médard,Eugene Tang,Ken R. Duffy*

Main category: quant-ph

TL;DR: This paper presents a new decoding framework for quantum Tanner codes that significantly enhances performance.


<details>
  <summary>Details</summary>
Motivation: To address inefficiencies in conventional decoding methods for quantum Tanner codes, particularly regarding trapping sets and cycles.

Method: The authors develop a soft-output decoding approach using SOGRAND along with OSD for post-processing to enhance convergence.

Result: The proposed method shows up to three orders of magnitude improvement in logical error rates compared to existing belief propagation methods with OSD.

Conclusion: This work provides a promising pathway for the scalable decoding of Tanner-code-based quantum codes.
...
### [53] [Nonlocal Games as Cross-Platform Quantum Benchmarks: Exceeding unconditional classical bounds on trapped-ion processors](https://arxiv.org/abs/2603.18323)
...
TL;DR: The paper demonstrates a quantum processor achieving a statistically significant win in a nonlocal game, surpassing classical limits, marking a milestone in quantum benchmarks.


<details>
  <summary>Details</summary>
Motivation: To explore the performance of quantum hardware against classical benchmarks in nonlocal games.

Method: Implementation of a 14-vertex graph coloring game on four trapped-ion quantum processors from three institutions.

Result: One quantum system exceeded classical performance bounds with statistical significance; others matched the best superconducting processors in win rates.

Conclusion: Nonlocal games serve effectively as benchmarks for assessing quantum hardware across different architectures.
...
### [54] [Alice and Bob through a quantum mirror](https://arxiv.org/abs/2603.18371)
*M. Uria,C. Hermann-Avigliano,P. Solano,A. Delgado*

Main category: quant-ph

TL;DR: Quantum mirrors can control optical responses via qubits, enabling efficient quantum communication protocols.


<details>
  <summary>Details</summary>
Motivation: The paper explores enhancing quantum networks' capabilities through the integration of quantum mirrors, aiming for reliable long-distance quantum communication.

Method: Quantum mirrors are used as network nodes with coherent state propagation allowing interactions between control qubits, facilitating quantum teleportation, state transfer, and entanglement swapping.

Result: Success probability and fidelity of quantum communication methods improve exponentially with increasing average photon numbers, with teleportation demonstrating robustness against various errors.

Conclusion: Quantum mirrors present a viable solution for robust and efficient long-distance quantum communication.
...
### [55] [Observable-Conditioned Backaction in Dynamic Circuits: A Higher-Order Context-Conditioned Kernel for Local Dynamics](https://arxiv.org/abs/2603.18381)
*Petr Sramek*

Main category: quant-ph

TL;DR: The paper addresses the challenge of characterizing the disturbance caused by mid-circuit measurements in dynamic circuits and quantum error correction. It introduces a sophisticated kernel that captures higher-order context effects and demonstrates its effectiveness through experiments with synthetic hardware.


<details>
  <summary>Details</summary>
Motivation: Characterizing the disturbance induced by mid-circuit measurements is critical for dynamic circuits and quantum error correction; existing metrics like $T_1$ and $T_2$ may be incomplete for complex systems.

Method: A higher-order context-conditioned kernel is proposed, combining local observables and phenomenological terms to isolate context dependence. The approach circumvents challenges associated with quantum partial-information decompositions, relying on classical measurement outcomes.

Result: Evidence includes a split based on observable classes from GHZ-clock hardware, dynamical results from the A6 synthetic hardware showing hidden context effects, and coherent controllability demonstrated in the A6.2 quantum-eraser experiment.

Conclusion: The results support a context-conditioned framework for understanding backaction effects, validating the proposed kernel over traditional low-order diagnostic models.
...
### [56] [Accelerated Rydberg-EIT quantum memory via shortcuts to adiabaticity](https://arxiv.org/abs/2603.18399)
*Y. Wei,Changcheng Li,Y. M. Liu,Yuechun Jiao,Weibin Li,X. Q. Shao*

Main category: quant-ph

TL;DR: The paper presents a novel quantum storage scheme using a shortcut-to-adiabaticity technique to enhance the speed and fidelity of electromagnetically induced transparency in quantum memories, addressing the limitations of conventional methods.


<details>
  <summary>Details</summary>
Motivation: To improve the speed of coherent light-matter storage without sacrificing fidelity in photonic quantum memories, which are crucial for scalable quantum networks.

Method: The authors propose a quantum storage protocol using counter-diabatic driving combined with a tailored auxiliary field in an EIT system, allowing for rapid writing while mitigating losses due to excited intermediate states.

Result: The proposed scheme shows significantly shortened writing times, robustness against imperfections, and adaptability across various pulse profiles, thus maintaining high storage performance even under non-ideal conditions.

Conclusion: This approach overcomes traditional speed-fidelity trade-offs in EIT protocols, enabling the development of efficient quantum devices for future quantum communication and processing applications.
...
### [57] [Learning Entanglement Quasiprobability from Noisy and Incomplete Data](https://arxiv.org/abs/2603.18414)
*Yu-Zhuo Li,Li-Chao Peng,Ke-Mi Xu*

Main category: quant-ph

TL;DR: The paper presents a deep-learning method for reconstructing entanglement quasiprobabilities directly from incomplete measurements, enhancing scalability and accuracy compared to traditional state tomography.


<details>
  <summary>Details</summary>
Motivation: To address the scalability limitations of conventional quantum state tomography in reconstructing entanglement quasiprobabilities, which are crucial for identifying quantum nonclassicality and entanglement.

Method: A deep-learning framework using residual neural networks to map partial measurement outcomes to high-fidelity entanglement quasiprobabilities without full state reconstruction.

Result: Achieved over a 30-fold reduction in reconstruction error against state-of-the-art methods for up to three qubits, validated experimentally with photonic entangled states.

Conclusion: The proposed method improves the practicality and scalability of entanglement characterization in quantum optics, enabling efficient reconstruction of entanglement quasiprobabilities with fewer resources.
...
### [58] [Inhomogeneous mass trap for dark-state polaritons in atomic media](https://arxiv.org/abs/2603.18451)
*Ding-An Chen,Kai-You Huang,Chun-Yen Hsu,Meng-Cheng Xie,Ite A. Yu,Wen-Te Liao*

Main category: quant-ph

TL;DR: The study theoretically explores creating a trapping potential for dark-state polaritons using engineered spatial inhomogeneity in effective mass, enabling tailored spatial control over optical information and advancing towards Bose-Einstein condensation.


<details>
  <summary>Details</summary>
Motivation: To enhance the control over dark-state polaritons for potential applications in optical information processing and quantum technologies.

Method: Theoretical analysis of a two-dimensional system using electromagnetically induced transparency to manipulate the effective mass of dark-state polaritons.

Result: A trapping potential emerges from engineered inhomogeneous effective mass, enabling tailored behavior of bound dark-state polaritons.

Conclusion: Findings suggest possibilities for spatial optical information control and pave the way for Bose-Einstein condensation of dark-state polaritons.
...
### [59] [Simulating Quantum Error Correction beyond Pauli Stochastic Errors](https://arxiv.org/abs/2603.18457)
*Jordan Hines,Corey Ostrove,Kenneth Rudinger,Stefan Seritan,Kevin Young,Robin Blume-Kohout,Timothy Proctor*

Main category: quant-ph

TL;DR: The study presents a method to effectively model coherent and non-Pauli errors in quantum error correction (QEC) for fault-tolerant quantum computing (FTQC), addressing the unpredictable impacts of these errors compared to stochastic Pauli errors.


<details>
  <summary>Details</summary>
Motivation: Quantum error correction protocols traditionally focus on stochastic errors but face challenges when real-world errors deviate from these models, necessitating a new approach to understand their effects on FTQC.

Method: The authors introduce a technique to map Markovian circuit-level error models to a detector error model (DEM), facilitating Monte Carlo simulations of logical error rates and effective noise-adapted decoding strategies.

Result: The analysis reveals that coherent errors can substantially alter fault-tolerance thresholds, increase the resource requirements for magic state cultivation, and elevate logical error rates significantly above those induced by stochastic errors.

Conclusion: This work advances the modeling of diverse error types in quantum circuits, providing valuable insights for designing more resilient QEC protocols in practical FTQC applications.
...
### [60] [Barren Plateaus Beyond Observable Concentration](https://arxiv.org/abs/2603.18479)
*Zi-Shen Li,Bujiao Wu,Xiao-Wei Li,Man-Hong Yung*

Main category: quant-ph

TL;DR: This paper develops a unified statistical framework to address barren plateaus in parameterized quantum circuits, distinguishing between observable concentration and other gradient suppression mechanisms.


<details>
  <summary>Details</summary>
Motivation: To clarify the distinct factors contributing to barren plateaus in parameterized quantum circuits by separating observable concentration from other gradient suppression mechanisms.

Method: The authors introduce a unified statistical framework that identifies observable concentration as a key factor in barren plateaus, alongside mid-circuit sources of gradient suppression like information loss and scrambling.

Result: The framework clarifies standard explanations for barren plateaus and provides new insights, evidenced by numerical simulations that reveal gradient suppression without observable concentration.

Conclusion: Avoiding observable concentration is necessary for trainability, but additional mechanisms must also be addressed to fully overcome barren plateaus in quantum circuits.
...
### [61] [Gravitational Wave-Induced Scrambling Delay in SYK Wormhole Teleportation](https://arxiv.org/abs/2603.18509)
*Sudhanva Joshi,Sunil Kumar Mishra*

Main category: quant-ph

TL;DR: This study examines the impact of gravitational-wave-like perturbations on teleportation fidelity in the SYK model, revealing insights into holographic scrambling and system responses.


<details>
  <summary>Details</summary>
Motivation: To explore how gravitational-wave perturbations affect quantum teleportation fidelity in the context of traversable wormholes and holographic principles.

Method: The SYK boundary is subjected to a periodic Floquet deformation akin to metric-strain perturbations, followed by numerical time evolution with disorder averaging at a specific temperature scale.

Result: Four key findings include: distinct amplitude regimes in fidelity responses, low-pass filter characteristics sensitive to specific frequencies, delays in fidelity peaks correlating with scrambling diagnostics, and consistent behavior across various system sizes.

Conclusion: The research indicates that the integrity of holographic teleportation channels is resilient under gravitational-wave-like modifications, offering insights for future quantum computing applications involving traversable wormholes.
...
### [62] [End-to-End QGAN-Based Image Synthesis via Neural Noise Encoding and Intensity Calibration](https://arxiv.org/abs/2603.18554)
*Xue Yang,Rigui Zhou,Shizheng Jia,Dax Enshan Koh,Siong Thye Goh,Yaochong Li,Hongyu Chen,Fuhui Xiong*

Main category: quant-ph

TL;DR: ReQGAN is an end-to-end quantum framework for full-image generation, addressing limitations of existing QGANs in capturing global image semantics.


<details>
  <summary>Details</summary>
Motivation: Existing QGANs struggle with full-image synthesis due to reliance on classical methods, losing the potential of quantum generators.

Method: ReQGAN utilizes a single D-qubit circuit, introducing a Neural Noise Encoder for state preparation and an Intensity Calibration module for pixel mapping.

Result: Experiments on MNIST and Fashion-MNIST show ReQGAN achieves stable training and effective image synthesis within qubit constraints.

Conclusion: ReQGAN successfully synthesizes entire images while verifying the importance of its proposed components.
...
### [63] [High-threshold magic state distillation with quantum quadratic residue codes](https://arxiv.org/abs/2603.18560)
*Michael Zurel,Santanil Jana,Nadish de Silva*

Main category: quant-ph

TL;DR: This paper explores the role of quantum quadratic residue codes in magic state distillation, demonstrating their equivalence to existing distillation codes and introducing new examples with high thresholds.


<details>
  <summary>Details</summary>
Motivation: The motivation is to enhance understanding and application of quantum quadratic residue codes in distilling magic states, which are crucial for quantum computing.

Method: The method involves analyzing and proving the equivalence of certain known codes to quantum quadratic residue codes, while introducing new codes that achieve high thresholds for distillation.

Result: The study shows that various established codes are equivalent to quantum quadratic residue codes, and identifies new codes that can distill qubit $T$ states and qutrit Strange states effectively.

Conclusion: All identified codes, including those with the highest known thresholds for specific states, are encapsulated within the framework of quantum quadratic residue codes.
...
### [64] [Distribution of fidelity zeros in two-band topological models](https://arxiv.org/abs/2603.18592)
*Siyan Lin,Zhen-Yu Zheng,Shu Chen*

Main category: quant-ph

TL;DR: This study explores fidelity zeros in two-band topological models by extending parameters into the complex plane, revealing their relation to energy gaps and topological transitions in various models.


<details>
  <summary>Details</summary>
Motivation: To understand the role of fidelity zeros in topological phase transitions and their connection to momentum modes and energy gaps.

Method: The phase transition parameter is extended into the complex plane using a biorthogonal formulation to analyze fidelity zeros in the Kitaev chain, Haldane model, and QWZ model.

Result: In finite systems, fidelity zeros appear as discrete lines; in the thermodynamic limit, they form extended regions. Critical points bound accessible intervals in specific models, with fidelity zeros indicating transitions.

Conclusion: The findings enhance the fidelity-zero framework in the context of topological quantum phase transitions, illustrating how critical information is represented in complex parameter space.
...
### [65] [Schrödinger Bridges via the Hacking of Bayesian Priors in Classical and Quantum Regimes](https://arxiv.org/abs/2603.18665)
*Clive Cenxin Aw,Peter Sidajaya*

Main category: quant-ph

TL;DR: The paper critiques the use of Bayes' rule for belief updating, introducing 'prior hacking' to preserve specific beliefs while simulating Bayesian updates, applicable in both classical and quantum contexts.


<details>
  <summary>Details</summary>
Motivation: To explore the limitations of traditional Bayesian belief updating, offering an alternative method that allows for the maintenance of certain beliefs during updates.

Method: The authors engineer a reference prior distribution and prove the possibility of prior hacking, providing algorithms for implementation in classical and quantum settings.

Result: The duality between prior hacking and Schrödinger bridge problems is established, allowing for consistent inference in quantum scenarios and showing that Schrödinger bridges perform Bayes-like updates relative to the process.

Conclusion: The findings redefine belief updating in Bayesian contexts, demonstrating a robust mechanism for maintaining prior beliefs while achieving desired distributions.
...
### [66] [On-chip Parametric Amplification in a Double Quantum Dots Circuit](https://arxiv.org/abs/2603.18666)
...
TL;DR: The study presents an on-site single-atom parametric amplifier (SAPA) within a reconfigurable quantum circuit that significantly improves qubit readout in microwave-based quantum circuits.


<details>
  <summary>Details</summary>
Motivation: The need to enhance qubit readout fidelity in quantum circuits while overcoming the limitations of traditional parametric amplifiers.

Method: An on-site single-atom parametric amplifier is demonstrated using a superconducting microwave cavity and two GaAs gate-defined double quantum dots (DQDs), leveraging the nonlinearity of the DQD for gain.

Result: Achieved a parametric gain exceeding 11 dB, resulting in over two times improvement in the signal-to-noise ratio (SNR) during qubit readout.

Conclusion: This work offers a versatile platform for improved qubit readout in quantum computing and introduces new options for parametric amplifiers in microwave-based circuits.
...
### [67] [Teleporting an unknown qutrit state via a 2-qudit entangled channel](https://arxiv.org/abs/2603.18679)
*Xiao-Xu Li,Feng-Li Yan,Ting Gao*

Main category: quant-ph

TL;DR: This paper presents a quantum teleportation protocol for a single qutrit using a 2-qudit entangled state as the channel, detailing Alice's measurement strategy and Bob's transformations.


<details>
  <summary>Details</summary>
Motivation: To enhance the theory of quantum teleportation utilizing higher-dimensional quantum states and to provide a practical method for teleporting qutrits.

Method: A systematic measurement basis is established for Alice, leading to designed collective unitary transformations for Bob who then performs a von Neumann measurement.

Result: The teleportation scheme yields finite success probabilities based on various quantum channels, demonstrating a theoretical framework for qutrit teleportation.

Conclusion: The findings contribute to the field of quantum teleportation by proposing a viable method for transmitting high-dimensional quantum states.
...
### [68] [A simple understanding of quantum electrodynamics using Bohmian trajectories: detecting non-ontic photons](https://arxiv.org/abs/2603.18692)
*Juan José Seoane,Abdelilah Benali,Xavier Oriols*

Main category: quant-ph

TL;DR: This paper demonstrates the applicability of Bohmian mechanics in modeling quantum optics and how it reconciles deterministic trajectories with photon phenomena.


<details>
  <summary>Details</summary>
Motivation: To address claims that Bohmian mechanics cannot model photon creation and annihilation, offering a realistic interpretation of quantum phenomena.

Method: The authors propose a framework utilizing Bohmian trajectories for electrons and evolving electromagnetic fields to model quantum optics, focusing on specific experimental scenarios.

Result: The paper reaffirms the effectiveness of the Bohmian framework in computing and visualizing quantum electrodynamics, while elucidating measurement implications in quantum optics.

Conclusion: The findings validate Bohmian mechanics as a useful pedagogical tool and clarify implications of measuring properties related to photons and electromagnetic fields.
...
### [69] [Comment on "Association between quantum paradoxes based on weak values and a realistic interpretation of quantum measurements"](https://arxiv.org/abs/2603.18713)
*Juan José Seoane,Xabier Oianguren-Asua,Albert Solé,Xavier Oriols*

Main category: quant-ph

TL;DR: Aredes and Saldanha's paper on weak values is critiqued for its incorrect general argument regarding inconsistencies in realistic interpretations, which the authors rebut using Bohmian mechanics as a counterexample.


<details>
  <summary>Details</summary>
Motivation: The authors aim to clarify misconceptions about weak values and their interpretations, particularly in light of perceived inconsistencies identified by Aredes and Saldanha.

Method: The authors utilize Bohmian mechanics to illustrate that certain weak values—specifically, those postselected in position—can consistently represent properties of quantum systems without reliance on measuring devices.

Result: The critique demonstrates that the argument proposed by Aredes and Saldanha is not universally applicable to all weak values and quantum theories, particularly highlighting valid interpretations within Bohmian mechanics.

Conclusion: The inconsistencies pointed out by Aredes and Saldanha do not stem from a true general argument about weak values but from a misunderstanding of their interpretation in certain quantum frameworks.
...
### [70] [A generalized framework for quantum subspace diagonalization](https://arxiv.org/abs/2603.18731)
*Paul D. Nation,Abdullah Ash Saki,Hwajung Kang*

Main category: quant-ph

TL;DR: The paper proposes a framework for efficiently solving Hamiltonian eigenproblems using sampled bit-strings from quantum computers, enabling sparse matrix representations and matrix-free solutions with reduced memory and runtime.


<details>
  <summary>Details</summary>
Motivation: To enhance the efficiency and flexibility of Hamiltonian eigenproblem solutions applicable to quantum advantage scenarios.

Method: The framework utilizes an extended alphabet for Hamiltonians, organizes operators to evaluate only non-zero terms, and leverages bit-sets in hash maps for efficient indexing, allowing for scalable solutions without qubit limitations.

Result: The framework computes ground-state solutions in condensed matter physics and quantum chemistry with significantly reduced memory and runtime, achieving improvements by an order of magnitude compared to existing techniques.

Conclusion: This work offers a versatile and efficient approach for quantum-classical eigensolutions, supporting advancements in quantum computing applications.
...
### [71] [Simulating Supersymmetric Quantum Mechanics Using Variational Quantum Algorithms](https://arxiv.org/abs/2603.18749)
*John Kerfoot,David Schaich,Emanuele Mendicelli*

Main category: quant-ph

TL;DR: The paper explores using variational quantum eigensolver (VQE) for spontaneous supersymmetry breaking in quantum mechanics, proposing a new adaptive ansatz to enhance computational efficiency.


<details>
  <summary>Details</summary>
Motivation: To address the sign problem in lattice studies of spontaneous supersymmetry breaking, leveraging quantum computing as an alternative methodology.

Method: The study employs the variational quantum eigensolver (VQE) with an adaptive ansatz construction algorithm to minimize variational parameters and optimize resource usage on NISQ devices.

Result: Preliminary VQE results from real IBM quantum devices show improved accuracy and manageable computational costs, with a discussion on error mitigation methods and their impact.

Conclusion: The proposed adaptive approach enhances the feasibility of studying supersymmetry on quantum computers amidst current resource constraints.
...
### [72] [A Flexible GKP-State-Embedded Fault-Tolerant Quantum Computation Configuration Based on a Three-Dimensional Cluster State](https://arxiv.org/abs/2603.18778)
*Peilin Du,Jing Zhang,Tiancai Zhang,Rongguo Yang,Kui Liu,Jiangrui Gao*

Main category: quant-ph

TL;DR: This paper proposes a novel architecture for fault-tolerant quantum computation using a three-dimensional cluster state and diverse entangled pairs, optimizing performance through a squeezing gate.


<details>
  <summary>Details</summary>
Motivation: To enhance operational flexibility and fault tolerance in quantum computation by integrating diverse quantum resources and degrees of freedom.

Method: The authors design optical entanglement generators to create three types of entangled pairs, construct a three-dimensional cluster state using a beam-splitter network with delays, and introduce a partially squeezed surface-GKP code for fault tolerance.

Result: The proposed architecture achieves a fault-tolerant squeezing threshold of 11.5 dB and demonstrates flexibility, scalability, and experimental feasibility in quantum computation.

Conclusion: This flexible and scalable architecture provides a promising framework for future developments in optical fault-tolerant quantum computation.
...
### [73] [Comparing optical-microwave conversion and all-microwave control schemes for a transmon qubit](https://arxiv.org/abs/2603.18780)
...
TL;DR: The study compares transmon qubit control via conventional microwave lines and an optical system, finding no significant impact on qubit coherence.


<details>
  <summary>Details</summary>
Motivation: To explore advanced qubit control techniques that could enable large-scale integration of quantum computing systems.

Method: The study employs two control methods: conventional microwave lines and an optical control system using modulated laser light transmitted through optical fiber to a photodiode at 1K in a dilution cryostat, measuring energy relaxation and coherence times over 20-hour runs.

Result: Measurements showed no significant deterioration in qubit coherence compared to random fluctuations, allowing for the potential of optical control integration.

Conclusion: The findings suggest viability for optical qubit control systems in scalable quantum computing architectures.
...
### [74] [If Quantum Measurements Are Secretly Continuous Nonunitary Processes, Weak Measurements Can Detect It](https://arxiv.org/abs/2603.18787)
*Igor Prlina,Milutin Živković*

Main category: quant-ph

TL;DR: The paper challenges the standard view of instantaneous quantum state collapse by considering finite time measurement resolution, leading to mixed state evolution. It proposes weak postselected measurements to differentiate between this nonunitary evolution and traditional collapse, illustrated with a hydrogen atom example.


<details>
  <summary>Details</summary>
Motivation: To explore the implications of finite resolution in time measurement on quantum state collapse, questioning the instantaneous nature of conventional measurements.

Method: The paper introduces weak postselected measurements as a technique to distinguish between nonunitary evolution due to measurement timing and traditional instantaneous collapse.

Result: The findings indicate that weak postselected measurements can effectively differentiate between fundamentally nonunitary evolution and the expected collapse of the quantum state at various time instances.

Conclusion: This research provides a new perspective on quantum measurements and the nature of state collapse, suggesting that measurement timing can significantly influence the observed evolution of quantum systems.
...
### [75] [Time-Multiplexed Distributed Quantum Sensing](https://arxiv.org/abs/2603.18807)
*Hanbom Yoo,Hyukgun Kwon,Seongjin Hong*

Main category: quant-ph

TL;DR: This paper demonstrates that incorporating temporal mode entanglement in quantum metrology allows for improved sensitivity scaling beyond current limits by leveraging time-domain multiplexing.


<details>
  <summary>Details</summary>
Motivation: To improve the sensitivity of distributed quantum sensing beyond linear scaling with measurement repetitions by incorporating temporal modes and entanglement.

Method: Utilizing Bogoliubov transformation formalism, the authors derive the sensitivity scaling with respect to photon number, spatial modes, and measurement repetitions, employing homodyne detection and maximum-likelihood estimation.

Result: The proposed method achieves an overall sensitivity of $Δ^2 φ ∝ 1/(NMR)^2$, approaching simultaneous Heisenberg scaling across all relevant parameters, even in the presence of optical loss.

Conclusion: The integration of time-multiplexing techniques into quantum metrology presents a significant advancement towards optimal sensitivity in distributed quantum sensing.
...
### [76] [Quantum Advantage: a Tensor Network Perspective](https://arxiv.org/abs/2603.18825)
*Augustine Kshetrimayum,Saeed S. Jahromi,Sukhbinder Singh,Román Orús*

Main category: quant-ph

TL;DR: The paper reviews recent quantum advantage experiments and their simulations using tensor network methods, assessing the implications for future quantum technologies.


<details>
  <summary>Details</summary>
Motivation: To clarify the implications of quantum advantage experiments and improve classical simulation methods for better understanding quantum computing's capabilities.

Method: Review of quantum advantage experiments by IBM, D-Wave, and Google, focusing on tensor network simulations.

Result: Evaluated the strengths and challenges of tensor network approaches in simulating quantum experiments and their influence on future developments.

Conclusion: Identified ongoing challenges in simulation methods and potential improvements for achieving genuine quantum advantage.
...
### [77] [Certifying ergotropy under partial information](https://arxiv.org/abs/2603.18828)
*Egle Pagliaro,Leonardo Zambrano,Mir Alimuddin,Alioscia Hamma,Antonio Acín,Donato Farina*

Main category: quant-ph

TL;DR: The paper presents a method to estimate ergotropy under partial information using expectation values of observables, offering confidence-certified bounds and applicability in realistic quantum experiments.


<details>
  <summary>Details</summary>
Motivation: Estimating ergotropy with partial knowledge of quantum states is a significant challenge in quantum physics, which this paper aims to address.

Method: A general certification framework that uses expectation values of a limited set of observables to derive lower bounds on ergotropy, with considerations for shot noise.

Result: The method was validated with both synthetic data and experimental results from an IBM quantum processor, demonstrating its practicality and robustness.

Conclusion: The proposed framework serves as a useful tool for certifying extractable work in realistic quantum scenarios.
...
### [78] [Optimal and improved gate decompositions for accelerated classical simulation of near-Gaussian fermionic circuits](https://arxiv.org/abs/2603.18869)
*Beatriz Dias,Jan Lukas Bosse,James R. Seddon*

Main category: quant-ph

TL;DR: The paper presents decompositions for non-Gaussian gates to enhance classical simulation of fermionic circuits and explores their robustness against noise.


<details>
  <summary>Details</summary>
Motivation: To improve classical simulations of fermionic Gaussian circuits, particularly when non-Gaussian operations are introduced, addressing limitations in current simulation methods.

Method: Derived analytic decompositions for non-Gaussian gates and channels, focusing on two-qubit fermionic gates and stochastic noise effects; generalized sparsification methods for classical sampling.

Result: Achieved optimal decompositions that enhance classical simulation speed and robustness against noise, outperforming stabilizer magic.

Conclusion: The new decompositions offer significant improvements for simulating fermionic circuits, effectively handling noise and extending the applicability of classical simulators.
...
### [79] [Quantum and classical approaches to the optimization of highway platooning: the two-vehicle matching problem](https://arxiv.org/abs/2603.18919)
*Chinonso Onah,Agneev Guin,Carsten Othmer,J. A. Montañez-Barrera,Kristel Michielsen*

Main category: quant-ph

TL;DR: This paper explores the use of QUBO formulations in optimizing highway vehicle platooning with various heuristic approaches.


<details>
  <summary>Details</summary>
Motivation: Vehicle platooning can reduce aerodynamic drag but faces technological and legislative challenges. 'Windbreaking-as-a-Service' offers a low-tech solution for platooning.

Method: The study employs classical metaheuristics like simulated annealing and tabu search, and quantum heuristics such as quantum annealing and QAOA, using a QUBO framework for optimization.

Result: The heuristics investigated provide solutions in a polynomial memory space and support aggressive parallelization, with classical post-processing helping to ensure valid schedules.

Conclusion: QUBO serves as a unifying framework for classical, quantum, and hybrid optimization methods in the context of highway platooning.
...
TL;DR: This paper explores how interfacing materials with electromagnetic cavities can modify magnetic interactions in quantum systems, presenting a method to calculate these effects using first principles, identifying optimal cavity designs for experimental application.


<details>
  <summary>Details</summary>
Motivation: The study aims to understand how vacuum fluctuations in electromagnetic cavities can influence equilibrium properties, particularly in correlated electron systems without characteristic energy scales.

Method: A non-perturbative calculation of the cavity-modified magnetic exchange interaction in the half-filled Hubbard model, incorporating all cavity modes and parameters derived from first principles.

Result: The study finds that the modification's strength is governed by a generalized Purcell factor, highlighting that polaritonic surface cavities significantly enhance interactions, unlike standard Fabry-Pérot resonators that cancel out effects.

Conclusion: This framework establishes guidelines for using cavity design to influence material responses in the off-resonant regime, paving the way for future research in quantum materials.
...
### [81] [Long Distance Daylight Drone-based Quantum Key Distribution under Relative Motion](https://arxiv.org/abs/2603.18934)
...
TL;DR: This paper presents a kilometer-scale drone-based quantum key distribution (QKD) network, addressing challenges in dynamic quantum links with innovative polarization adaptive correction technology.


<details>
  <summary>Details</summary>
Motivation: To enable practical implementation of quantum networks using low-altitude drones despite difficulties in establishing stable quantum links under dynamic conditions.

Method: Development of single-ended polarization adaptive correction technology for both transmitting and receiving ends; implementation in a drone-based QKD system.

Result: Achieved a 1.2 km free-space QKD link with a secure key rate of 2.76 kbps, and validated QKD between a dynamic drone and ground vehicle at 100 m distance with a secure key rate of 70.94 kbps.

Conclusion: This work demonstrates the potential for drone-based QKD to support dynamic urban quantum networks, indicating a significant advancement towards an airborne quantum internet.
...
### [82] [Dependence of Lindbladian spectral statistics on the integrability of no-jump Hamiltonians and the recycling terms](https://arxiv.org/abs/2603.18946)
*Dingzu Wang,Hao Zhu,Guo-Feng Zhang,Dario Poletti*

Main category: quant-ph

TL;DR: The paper analyzes spectral statistics in Markovian open quantum systems governed by Lindbladians, focusing on the effects of recycling processes, symmetry constraints, and Liouville-space structure on spectral correlations.


<details>
  <summary>Details</summary>
Motivation: To understand the spectral properties and differentiate between integrability and chaos in Markovian open quantum systems using spectral statistics.

Method: The analysis involves spectrum-statistics diagnostics on Lindbladians and their effective non-Hermitian Hamiltonians, particularly assessing how various factors influence spectral correlations.

Result: The study identifies a class of spectrally separable Lindbladians with spectra that maintain Poisson statistics, even as the corresponding effective non-Hermitian Hamiltonian transitions from regular to chaotic behavior.

Conclusion: This work provides a comprehensive framework for characterizing spectral statistics in Lindbladians and their non-Hermitian counterparts, enhancing insights into the nature of spectral properties in open many-body systems.
...
### [83] [End-to-End Simulation of Chemical Dynamics on a Quantum Computer](https://arxiv.org/abs/2603.19007)
*Elliot C. Eklund,Arkin Tikku,Patrick Sinnott,William J. Huggins,Guang Hao Low,Dominic W. Berry,Ivan Kassal*

Main category: quant-ph

TL;DR: This paper presents a new quantum algorithm for simulating chemical dynamics, efficiently handling non-adiabatic processes without uncontrolled approximations, with sublinear complexity.


<details>
  <summary>Details</summary>
Motivation: Classical computers struggle with simulating complex chemical dynamics, particularly non-adiabatic processes, prompting the need for a more efficient quantum solution.

Method: The algorithm treats nuclei and electrons equally, using a momentum-space grid representation and covering all processes from state preparation to observable measurement, achieving faster initial-state preparation.

Result: The algorithm shows sublinear complexity in grid size and is applicable to photochemistry, enabling potentially classically intractable simulations with manageable resources.

Conclusion: This work advances quantum chemical simulations, opening pathways for practical applications in photochemistry and beyond.
...
### [84] [Multiparameter quantum estimation and Stirling Engine Performance in a Gravitational Cat State System](https://arxiv.org/abs/2603.19010)
*Omar Bachain,Mohamed Amazioug,Rachid Ahl Laamara*

Main category: quant-ph

TL;DR: This paper explores the quantum estimation and thermodynamic properties of a gravitational cat state system, using the quantum Fisher information matrix to analyze parameter estimation limits and examining thermal effects on system behavior.


<details>
  <summary>Details</summary>
Motivation: To investigate the multiparameter estimation limits and thermodynamic properties of a gravcat system and understand the interplay between quantum metrology and thermodynamics.

Method: The study employs quantum parameter estimation theory, specifically the quantum Fisher information matrix (QFIM), along with symmetric logarithmic derivative (SLD) formalism, to derive estimation bounds for gravitational coupling, energy splitting, and temperature.

Result: The research identifies optimal regions for parameter estimation precision that depend on interaction strengths, energy gaps, and thermal environments, and analyzes the system's efficiency as a quantum heat engine.

Conclusion: The findings emphasize the correlation between quantum metrology and quantum thermodynamics, showcasing enhanced estimation capabilities in specific parameter conditions.
...
### [85] [Exact Law of Quantum Reversibility under Gaussian Pure Loss](https://arxiv.org/abs/2603.19024)
*Ammar Fayad*

Main category: quant-ph

TL;DR: The paper establishes an exact law of quantum reversibility in pure-loss dynamics, showing a critical phase boundary influencing reverse costs and optimal noise strategies.


<details>
  <summary>Details</summary>
Motivation: To explore fundamental principles of quantum reverse diffusion and its implications in systems undergoing decoherence, particularly in optical and bosonic contexts.

Method: Analysis of Gaussian pure-loss dynamics, focusing on the concept of complete positivity and phase boundaries with respect to reverse noise budgets and minimum costs.

Result: Identified an exact phase boundary where minimum reverse cost vanishes, influencing the feasibility of reverse protocols and providing an optimal strategy for noise.

Conclusion: The findings present a significant theoretical framework for quantum reversibility and set benchmarks for future research in quantum reverse diffusion, showing that exact reversal of pure quantum states is unattainable.
...
### [86] [Fair Decoder Baselines and Rigorous Finite-Size Scaling for Bivariate Bicycle Codes on the Quantum Erasure Channel](https://arxiv.org/abs/2603.19062)
*Tushar Pandey*

Main category: quant-ph

TL;DR: This paper addresses the challenges in fair threshold estimation for bivariate bicycle (BB) codes on quantum erasure channels, highlighting decoder unfairness and the misinterpretation of pseudo-thresholds. It compares decoding methods and achieves significant performance benchmarks for BB codes.


<details>
  <summary>Details</summary>
Motivation: The need for fair threshold estimation in the performance evaluation of bivariate bicycle codes on quantum erasure channels stems from issues of decoder unfairness and confusion between finite-size pseudo-thresholds and true asymptotic thresholds.

Method: The study employs both uninformed and 'erasure-aware' minimum-weight perfect matching surface code baselines alongside BP-OSD decoding of BB codes, testing various sizes of BB codes with a large number of experimental shots for robustness.

Result: The analysis reveals that pseudo-thresholds for BB codes range from 0.370 to 0.471, with an asymptotic threshold of approximately 0.488. BB codes demonstrate a notable performance advantage in normalized overhead compared to surface codes at significantly higher qubit counts.

Conclusion: BB codes show a modest edge in threshold performance over surface codes with a significantly lower normalized overhead, indicating their potential for practical applications in quantum error correction.
...
### [87] [Photon-echo synchronization and quantum state transfer in short quantum links](https://arxiv.org/abs/2603.19064)
*Hong Jiang,Carlos Barahona-Pascual,Juan José García-Ripoll*

Main category: quant-ph

TL;DR: This paper explores the short quantum link regime, demonstrating how emitters can synchronize Rabi oscillations via photon echoes, enhancing quantum state transfer efficiency through Delay Differential Equations (DDE).


<details>
  <summary>Details</summary>
Motivation: The short quantum link regime is crucial yet underexplored, as existing models fail in conditions where delay and multimode effects matter.

Method: Utilizes a Delay Differential Equation framework to derive exact solutions from single-mode to multimode systems, addressing synchronization in photon emissions.

Result: Demonstrated that emitters exhibit self-synchronized Rabi oscillations driven by photon echoes, which optimize quantum state transfer schemes, particularly STIRAP, across multiple parameter ranges.

Conclusion: Photon-echo synchronization is identified as a valuable resource for improving quantum state transfer, with DDE providing essential analytical insights for future experiments.
...
### [88] [Utility-scale quantum computational chemistry](https://arxiv.org/abs/2603.19081)
*Davide Castaldo,Markus Reiher*

Main category: quant-ph

TL;DR: The paper discusses the need for quantum algorithms to evolve alongside quantum hardware to enhance practical applications in chemistry and materials science, emphasizing integration into high-throughput workflows for routine molecular calculations.


<details>
  <summary>Details</summary>
Motivation: There is a compelling need to unlock advanced simulation capabilities in chemistry and materials science using quantum hardware, while adapting to evolving technological constraints.

Method: The authors explore the integration of quantum algorithms with classical wavefunction-theory methods and assert the importance of adapting these algorithms for practical use in high-throughput computational pipelines.

Result: The findings suggest that quantum algorithms should focus on both accurate calculations for complex molecular structures and seamless integration into routine workflows.

Conclusion: To deliver substantial societal value, quantum computations must support the efficient processing of varied molecular calculations beyond merely addressing strongly correlated systems.
...
### [89] [Practical Quantum Broadcasting](https://arxiv.org/abs/2603.19089)
*Ximing Wang,Yunlong Xiao*

Main category: quant-ph

TL;DR: Introducing virtual broadcasting mitigates the limitations of sample efficiency in quantum broadcasting, allowing for optimal protocols despite restrictions.


<details>
  <summary>Details</summary>
Motivation: To address the restrictions posed by traditional broadcasting methods in quantum systems, particularly regarding state consumption and sample efficiency.

Method: Developing approximate and probabilistic virtual broadcasting techniques with derived analytic expressions for their sample complexities.

Result: Allowing deviations at receivers enhances sample efficiency in certain configurations, while probabilistic methods highlight challenges in efficiency for 1-to-2 implementations across arbitrary dimensions, though 1-to-6 implementations are achievable for larger receiver counts.

Conclusion: Sample complexity has emerged as a key principle in quantum information distribution, paving the way for efficient protocols in practical applications.
...
### [90] [Active Quantum Particles from Engineered Dissipation](https://arxiv.org/abs/2603.19094)
*Jeanne Gipouloux,Matteo Brunelli,Leticia Cugliandolo,Rosario Fazio,Marco Schirò*

Main category: quant-ph

TL;DR: This paper presents several models for an active quantum particle influenced by engineered dissipation, showing a transition from diffusive to active-diffusive behavior and its implications in quantum systems.


<details>
  <summary>Details</summary>
Motivation: The study aims to investigate active quantum particles influenced by nonequilibrium environments and to understand how dissipation contributes to active motion.

Method: The authors introduce various models, including lattice movement with coherent and dissipative hopping, and quantum versions of known active behaviors like the Ornstein-Uhlenbeck process and active Brownian motion.

Result: All models exhibit features of active motion, transitioning from diffusive to active-diffusive behavior over time, influenced by boundary conditions due to the Liouville skin effect.

Conclusion: The findings highlight the importance of quantum fluctuations and suggest future research directions in experimental setups and many-body effects in quantum active matter.
...
### [91] [Entanglement assisted communication complexity measured by distinguishability](https://arxiv.org/abs/2603.19105)
*Satyaki Manna,Ankush Pandit,Debashis Saha*

Main category: quant-ph

TL;DR: The paper explores quantum advantages in two-party communication with prior correlations, demonstrating that entanglement assistance can enhance both classical and quantum communication performance over classical communication with shared randomness.


<details>
  <summary>Details</summary>
Motivation: To understand how entanglement can improve communication efficiency in scenarios where prior correlations exist between two parties.

Method: A general framework for communication tasks with pre-shared correlations is developed, focusing on scenarios with varying degrees of entanglement.

Result: Entanglement-assisted communication demonstrates advantages over classical methods, with some scenarios showing non-maximally entangled states are more beneficial than maximally entangled states.

Conclusion: Entanglement assistance plays a crucial role in enhancing communication effectiveness, establishing strong links between quantum and classical communication strategies.
...
### [92] [Post-Quantum Cryptography from Quantum Stabilizer Decoding](https://arxiv.org/abs/2603.19110)
*Jonathan Z. Lu,Alexander Poremba,Yihui Quek,Akshar Ramkumar*

Main category: quant-ph

TL;DR: This work proposes random quantum stabilizer code decoding as a novel cryptographic assumption for post-quantum security, proving its hardness and practical use in public-key encryption and oblivious transfer.


<details>
  <summary>Details</summary>
Motivation: The current post-quantum cryptography landscape is vulnerable due to reliance on a limited set of hardness assumptions, necessitating new options that ensure quantum security.

Method: The authors establish a connection between quantum stabilizer decoding and classical cryptographic primitives, providing reductions that show its average-case hardness and employing new scrambling techniques for security proofs.

Result: They demonstrate that stabilizer decoding can underlie essential cryptographic operations like public-key encryption and oblivious transfer, achieving practicality and efficiency akin to existing methods.

Conclusion: The study presents strong evidence that quantum stabilizer decoding offers a genuinely new assumption for post-quantum cryptography, with robust security and practical implementations.
...
### [93] [Low-weight quantum syndrome errors in belief propagation decoding](https://arxiv.org/abs/2603.19126)
*Haggai Landa*

Main category: quant-ph

TL;DR: The paper presents an empirical method to identify low-weight combinations of columns in quantum circuit noise models, which slow down belief-propagation (BP) convergence. By analyzing the low-density parity check code, it characterizes Tanner subgraphs related to error syndromes and evaluates BP performance under specific error weights. The findings indicate that enhancing the decoding matrix with relevant fault columns boosts BP convergence, leading to fewer logical errors and shorter decoding times.


<details>
  <summary>Details</summary>
Motivation: To understand the slow convergence of BP algorithms in quantum circuit decoding, particularly in the context of noise models and error syndromes.

Method: An empirical study identifying low-weight column combinations in decoding matrices, focusing on the low-density parity check code and analyzing iteration dynamics of BP for specific error weights.

Result: Identification of criteria that characterize Tanner subgraphs for low-weight error syndromes; BP dynamics exhibit exponential-like activation effects; improved convergence with added fault column combinations reduces logical errors and decoding time.

Conclusion: Enhancing the decoding matrix with relevant combinations can significantly improve BP performance in quantum circuit error correction.
...
### [94] [Quantum block encoding for semiseparable matrices](https://arxiv.org/abs/2603.19130)
*Giacomo Antonioli,Paola Boito,Gianna M. Del Corso,Margherita Porcelli*

Main category: quant-ph

TL;DR: The paper presents a new quantum block encoding approach for one-pair semiseparable matrices, requiring fewer qubits and time while maintaining a manageable error level.


<details>
  <summary>Details</summary>
Motivation: The research addresses the need for efficient quantum block encoding techniques, particularly for less-explored data-sparse matrices.

Method: The proposed method uses a specific factorization of one-pair semiseparable matrices into triangular and diagonal factors, allowing for effective block encoding.

Result: The new algorithm encodes matrices using $2	ext{log}(N)+7$ ancillary qubits and executes in polylogarithmic time with an error bound of $	ext{O}(N^2)$.

Conclusion: This work advances quantum algorithms by providing efficient encoding techniques for a specific class of data-sparse matrices, enhancing practical applications.
...
### [95] [Quantum Structures as Generative Scores: Partition Logic, Generative Logic, and Aesthetic Form](https://arxiv.org/abs/2603.19177)
*Christian Jendreiko,Karl Svozil*

Main category: quant-ph

TL;DR: The paper bridges partition logic and Generative Logic via Prolog to create the Quantum Square, showing the utility of partition logic in generative design and communication.


<details>
  <summary>Details</summary>
Motivation: To explore the connection between partition logic and Generative Logic and its applications in generative design and communication.

Method: Finite partition logics are translated into Prolog-based Simple Generative Logic Grammars, using V-logic L_{12} to demonstrate the concept.

Result: The Quantum Square, a modular visual artifact, was generated to showcase the approach's efficacy.

Conclusion: Partition logic effectively serves as both a resource for generative design and a means of conveying the concept of complementarity.
...
### [96] [Measurement-Induced Quantum Neural Network](https://arxiv.org/abs/2603.19200)
*Paul Argyle,Djamil Lakhdar-Hamina,Sarah H. Miller,Victor Galitski*

Main category: quant-ph

TL;DR: This paper presents a measurement-induced quantum neural network (MINN) that leverages mid-circuit measurements to adaptively control entangling gates, demonstrating its applications in optimization and classification tasks.


<details>
  <summary>Details</summary>
Motivation: The need for advanced quantum neural networks that can leverage measurement effects for superior dynamics and functionalities in quantum computing applications.

Method: A variational architecture is introduced where mid-circuit measurements guide the subsequent entangling gates, enhancing nonlinearity and allowing for adaptable dynamics. A specific matchgate MINN is analyzed for its exact fermionic simulation properties and its training capabilities using gradient estimators.

Result: The MINN shows effective training for applications in continuous optimization, image classification, and ground-state searches, especially in contexts like the Sherrington-Kirkpatrick spin glass, with promising performance across various monitoring rates.

Conclusion: The proposed MINN construction is a viable approach for quantum neural networks, exhibiting potential for complex tasks while remaining challenging to simulate classically.
...
### [97] [Quantum theory based on real numbers cannot be experimentally falsified](https://arxiv.org/abs/2603.19208)
*Timothée Hoffreumon,Mischa P. Woods*

Main category: quant-ph

TL;DR: Real quantum theory (RQT) is shown to reproduce all correlations of standard quantum theory (QT), challenging the belief that RQT can be experimentally falsified through specific network experiments.


<details>
  <summary>Details</summary>
Motivation: Investigating whether real quantum theory can replace complex numbers in quantum mechanics, and whether there are distinguishable experimental implications for the two theories.

Method: By differentiating between product-state independence and operational independence and imposing source independence, the authors analyze the correlation structures in both theories.

Result: The authors demonstrate that every finite network correlation achievable in QT is also achievable in RQT, thus supporting the equivalence of both theories under specific conditions.

Conclusion: RQT cannot be experimentally falsified as long as QT's predictions hold, preserving their empirical indistinguishability despite differing interpretations.
...
### [98] [The commutant of fermionic Gaussian unitaries](https://arxiv.org/abs/2603.19210)
*Paolo Braccia,N. L. Diaz,Martin Larocca,M. Cerezo,Diego García-Martín*

Main category: quant-ph

TL;DR: This paper characterizes the commutants of fermionic Gaussian unitaries, deriving closed formulas for their dimensions and providing a unified framework for higher-order invariants in fermionic Gaussian dynamics.


<details>
  <summary>Details</summary>
Motivation: To understand the role commutants play in fermionic randomized protocols and resource quantification in the context of Gaussian dynamics.

Method: Utilizes Howe dualities to identify generators of the commutants, deriving closed formulas for dimensions, and develops Gelfand–Tsetlin procedures for explicit orthonormal bases.

Result: Closed formulas for the dimensions of the commutants as functions of $t$ and $n$, along with constructs for orthonormal bases and explicit examples for low $t$.

Conclusion: The findings provide an algebraic framework that clarifies the structure of fermionic states and their correlations, linking various measures and constraints relevant in fermionic systems.
...
### [99] [Setting SAIL: Leveraging Scientist-AI-Loops for Rigorous Visualization Tools](https://arxiv.org/abs/2603.18145)
...
TL;DR: The Scientist-AI-Loop (SAIL) framework balances rapid AI code generation with scientific rigor, illustrated via two astrophysics tools, ensuring valid results and facilitating research.


<details>
  <summary>Details</summary>
Motivation: To bridge the gap between theoretical knowledge and the skills required for creating interactive scientific tools, addressing the limitations of large language models in producing scientifically valid code.

Method: SAIL separates domain logic from code syntax, allowing researchers to maintain control over scientific accuracy while leveraging AI for code implementation, as demonstrated through two interactive astrophysics tools.

Result: The development of two tools was condensed to days, showcasing the ability of SAIL to uphold scientific integrity despite the rapid code generation.

Conclusion: SAIL offers a viable workflow for effective code generation in various scientific contexts, emphasizing the need for stringent protocols for research-grade outputs.
...
### [100] [ALABI: Active Learning for Accelerated Bayesian Inference](https://arxiv.org/abs/2603.18259)
*Jessica Birky,Rory K. Barnes*

Main category: astro-ph.IM

TL;DR: The paper introduces 	exttt{alabi}, an open-source Python package that accelerates Bayesian inference via active learning and Gaussian Process surrogates, significantly reducing computation time for high-dimensional problems.


<details>
  <summary>Details</summary>
Motivation: To address the computational challenges in Bayesian inference with expensive models, particularly when evaluating likelihood functions takes substantial time.

Method: 	exttt{alabi} utilizes a Gaussian Process surrogate model trained to predict posterior probabilities and employs active learning to enhance predictive performance in regions of high likelihood uncertainty. It integrates with various MCMC packages for efficient posterior distribution estimation.

Result: The implementation of 	exttt{alabi} demonstrates significant improvements, achieving speedups of 10-1000 times in MCMC computations for high-dimensional inference problems, especially those with likelihood evaluations exceeding 1 second.

Conclusion: 	exttt{alabi} provides a robust and efficient framework for Bayesian inference, effectively minimizing the number of expensive model evaluations necessary for accurate posterior estimation.
...
### [101] [cosmo-numba: B-modes and COSEBIs computations accelerated by Numba](https://arxiv.org/abs/2603.18419)
*Axel Guinot,Rachel Mandelbaum*

Main category: astro-ph.IM

TL;DR: The paper presents a Python software package for E-/B-mode decomposition in weak gravitational lensing analyses, addressing systematic uncertainties.


<details>
  <summary>Details</summary>
Motivation: The need to tackle systematic uncertainties in weak gravitational lensing data analysis, as we move beyond data volume limitations.

Method: Development of a Python-based software for E-/B-mode decomposition that emphasizes precision and speed.

Result: The software demonstrates high precision and efficiency in analysis, minimizing limitations due to numerical precision and computational time.

Conclusion: The presented software package is a valuable tool for researchers in cosmology to ensure reliable analysis amid systematic uncertainties.
...
### [102] [One-week optical observations of pulsed emission from the Crab pulsar with IMONY on the 3.8 m Seimei telescope](https://arxiv.org/abs/2603.18500)
...
TL;DR: This study presents optical observations of the Crab pulsar using an upgraded photon-counting imager, achieving significant findings regarding single-pulse emissions and optical peak timing drifts.


<details>
  <summary>Details</summary>
Motivation: To observe optical emissions from the Crab pulsar and understand the nature of its optical pulsed emission region.

Method: Utilized an upgraded IMONY detector on the 3.8 m Seimei telescope, conducting nightly optical observations and simultaneous radio observations for data collection.

Result: Detected optical Single Pulses with a timing drift of $30\pm7.9~\mathrm{μs}$ over three days, with a significance of $3.9σ$ and a corresponding emission region size of 9.1 km.

Conclusion: Optical emissions may fluctuate due to magnetospheric changes, ruled out pulsar glitches as the cause of timing drifts.
...
### [103] [Narrowband Radio Technosignature Search toward 3I/ATLAS with FAST](https://arxiv.org/abs/2603.19023)
*Jian-Kang Li,Zhen-Zhao Tao,Tong-Jie Zhang*

Main category: astro-ph.IM

TL;DR: The study conducted a narrowband radio technosignature search for interstellar object 3I/ATLAS using FAST, finding no credible signals and placing constraints on potential transmitters.


<details>
  <summary>Details</summary>
Motivation: To search for signs of extraterrestrial technology associated with interstellar object 3I/ATLAS in the Solar System.

Method: Utilized FAST L-band multibeam receiver to conduct frequency-drifting signal searches, employing signal filtering and analysis techniques, including PCA and cluster analysis.

Result: No credible narrowband radio technosignatures were detected; null results constrained transmitter power to above $2.862\times 10^{-3}$ W.

Conclusion: Introduced a Bayesian inference framework to evaluate existence probabilities and characteristics of potential transmitters.
...
### [104] [D$_4$CNN$\times$AnaCal: Physics-Informed Machine Learning for Accurate and Precise Weak Lensing Shear Estimation](https://arxiv.org/abs/2603.19046)
*Shurui Lin,Xiangchong Li,Ji Li,Shengcao Cao,Xin Liu,Yu-Xiong Wang*

Main category: astro-ph.IM

TL;DR: This paper presents a D$_4$-equivariant deep neural network for galaxy shape measurement that overcomes calibration biases while achieving lower shape noise and effective density gains compared to traditional methods.


<details>
  <summary>Details</summary>
Motivation: Traditional weak lensing shear estimators face limitations in capturing realistic galaxy morphologies and biases in machine learning models.

Method: A D$_4$-equivariant neural network architecture is used along with the Analytical Calibration (AnaCal) framework for calibration, focusing on isolated galaxies in LSST-like simulations.

Result: The proposed method achieves approximately 10% lower shape noise and about 20% increase in effective galaxy number density while maintaining negligible multiplicative biases across varied conditions.

Conclusion: The framework sets a strong foundation for future ML-based shear estimation in complex scenarios and will provide publicly available data and codes.
...
### [105] [Hyper-efficient superconducting filterbanks with impedance-defined spectral resolution for millimeter-wave spectroscopy](https://arxiv.org/abs/2603.19142)
*Oliver Jeong*

Main category: astro-ph.IM

TL;DR: This paper introduces a high-efficiency on-chip filterbank spectrometer for line intensity mapping and dark matter searches, overcoming limitations in existing architectures.


<details>
  <summary>Details</summary>
Motivation: To improve sensitivity and precision in line intensity mapping and broadband dark matter searches, addressing existing efficiency and loss issues in superconducting filterbank designs.

Method: The design eliminates the termination resistor and utilizes niobium-on-silicon coplanar waveguide resonant structures, evaluated through Sonnet electromagnetic simulations.

Result: Achieved >74% efficiency per channel in a 10-channel device at 90 GHz, with a resolving power of R=1211±105.

Conclusion: The design offers a scalable solution for future millimeter-wave spectroscopic experiments, demonstrating robustness against fabrication uncertainties.
...
### [106] [Fluxes of Generic Extreme-Mass-Ratio Inspirals with a Spinning Secondary](https://arxiv.org/abs/2603.18075)
*Qiuxin Cui,Wen-Biao Han*

Main category: astro-ph.HE

TL;DR: The paper develops a framework for calculating gravitational waveforms from extreme mass-ratio inspirals (EMRIs) that consider the spin of a stellar-mass compact object orbiting a supermassive black hole.


<details>
  <summary>Details</summary>
Motivation: To improve measurement precision of gravitational waves and understand the spin distribution of stellar-mass objects.

Method: The flux and waveform are constructed in a Kerr background under linear-spin approximation using a radiative prescription to derive orbit-averaged evolution equations for constants of motion.

Result: A tractable framework is established for generating waveforms that include the secondary spin component, with prospects for further simplification.

Conclusion: This framework enhances the capability of modeling EMRIs, paving the way for improved insights into gravitational wave observables.
...
### [107] [Discovery of Bimodal Drift Rate Structure in FRB 20240114A: Evidence for Dual Emission Regions](https://arxiv.org/abs/2603.18109)
*Santosh Arron*

Main category: astro-ph.HE

TL;DR: Discovery of bimodal structure in drift rate distribution of burst clusters from FRB 20240114A, indicating two distinct emission regions.


<details>
  <summary>Details</summary>
Motivation: To explore the drift rate characteristics of upward-drifting burst clusters and understand their underlying mechanisms.

Method: Applied UMAP and HDBSCAN on 233 burst clusters, revealing a distinct subpopulation with higher drift rates, supported by Gaussian mixture modeling for bimodality.

Result: Identified a bimodal distribution with a distinct subpopulation (C1) and confirmed the findings through restriction to single-component clusters, showing lower frequencies and shorter durations.

Conclusion: Findings indicate two spatially separated emission regions in the magnetosphere producing distinct burst clusters, calling for further observations to confirm.
...
### [108] [Probing Kerr black hole in a uniform Bertotti-Robinson magnetic field through astrophysical quasi-periodic oscillations](https://arxiv.org/abs/2603.18129)
*Hamza Rehman,Sanjar Shaymatov,Saddam Hussain,Tao Zhu*

Main category: astro-ph.HE

TL;DR: This study investigates high-frequency quasi-periodic oscillations (QPOs) around a Kerr black hole in a magnetic field, analyzing test particle motion and observational data from X-ray binaries to infer black hole parameters.


<details>
  <summary>Details</summary>
Motivation: To understand the influence of magnetic fields on the dynamics of high-frequency QPOs in the vicinity of Kerr black holes, and to leverage observational data for parameter estimation.

Method: Geodesic equations are determined to analyze particle motion, while QPO models based on parametric and forced resonance mechanisms are constructed using observational data analyzed via Bayesian inference and MCMC techniques.

Result: Nonzero values for the dimensionless parameter related to the magnetic field were found for some black hole binaries at 68% confidence, while upper bounds were noted for others. The forced resonance model yielded only upper bounds across all sources.

Conclusion: The magnetic field parameter is small yet significant, influencing particle dynamics and features of the accretion disk, affirming the need for further exploration of magnetic effects on QPO behavior.
...
### [109] [Spectral Hardness as the Primary Discriminator: Unveiling the Collapsar--Merger Boundary with a Gold-Standard Gamma-Ray Burst Sample](https://arxiv.org/abs/2603.18150)
*Xue Zhang,Yan-Kun Qu,Shuang-Xi Yi,Yu-Peng Yang,Fen Lyu,Fa-Yin Wang,Zhong-Xiao Man*

Main category: astro-ph.HE

TL;DR: This study presents a classification method using SVM to distinguish between GRB progenitors. A classification index is derived that emphasizes spectral hardness and energetics.


<details>
  <summary>Details</summary>
Motivation: To create a reliable classification method for Gamma-Ray Bursts (GRBs) and understand the physical differences between their progenitors, specifically mergers and collapsars.

Method: A Support Vector Machine is trained on a sample of 24 GRBs with confirmed progenitors. The analysis isolates the prompt spike to minimize contamination, leading to a quantitative classification index from physical parameters.

Result: The classification index indicates that spectral hardness (E_p,i) is the most discriminative feature, significantly more so than duration (T_90,z), with E_iso also contributing meaningfully. The method accurately classifies historical GRB cases regardless of instrumental era.

Conclusion: The new classification tool enhances the understanding of GRB progenitors and will aid in refining future cosmological studies by improving the quality of GRB samples.
...
### [110] [Supermassive Black Hole Winds in X-rays: SUBWAYS V. Properties of hot coronae in quasars at intermediate redshift](https://arxiv.org/abs/2603.18156)
...
TL;DR: This study analyzes the X-ray properties of 23 radio-quiet AGN to examine the characteristics of their hot coronae, finding relationships between the energy cut-off and accretion parameters.


<details>
  <summary>Details</summary>
Motivation: The aim is to understand the properties of AGN coronae by analyzing hard and soft X-ray emissions in a representative sample of quasars.

Method: The research utilized high-quality X-ray spectra from XMM-Newton and NuSTAR, focusing on the emission in the soft (0.3-2 keV) and hard X-ray (up to 30-40 keV) bands.

Result: The soft X-ray spectrum indicates a warm corona with a temperature of 0.40 keV and optical depth of 20-40. The hard X-ray band is described by a hot corona model with a median cut-off energy of 87 keV and optical depth of 1-5, showing a significant anti-correlation with accretion parameters.

Conclusion: Luminous AGN exhibit cooler and optically thicker coronae compared to lower-luminosity Seyfert galaxies, supporting the notion of enhanced coronal cooling driven by pair-production.
...
### [111] [Neutrinos and gamma rays from Seyfert galaxies constrain the properties of coronal turbulence](https://arxiv.org/abs/2603.18214)
*Federico Testagrossa,Damiano F. G. Fiorillo,Luca Comisso,Enrico Peretti,Maria Petropoulou,Lorenzo Sironi*

Main category: astro-ph.HE

TL;DR: This study analyzes TeV neutrinos from AGN NGC 1068 and NGC 7469, probing coronal properties through multimessenger signals and fitting IceCube and Fermi-LAT data.


<details>
  <summary>Details</summary>
Motivation: To understand the coronal properties of AGN based on observed neutrino signals and their implications for hadronic acceleration.

Method: Jointly fit neutrino data from IceCube and gamma-ray data from Fermi-LAT, focusing on the relationship between the magnetic field, turbulence, and coronal size.

Result: Quantitative constraints on coronal properties are derived, indicating NGC 1068 has a compact, strongly magnetized corona, while NGC 7469 suggests a larger corona with lower non-thermal proton energy.

Conclusion: Model predictions are made available for future comparisons, highlighting diverse coronal properties based on neutrino observations.
...
### [112] [A systematic search for physical associations between fast radio bursts and astrophysical transients](https://arxiv.org/abs/2603.18487)
*Hao-Hao Chen,Wen-Tao Xu,Xin-Yu Liang,Ming-Xuan Lu,Can-Min Deng*

Main category: astro-ph.HE

TL;DR: This study investigates associations between fast radio bursts (FRBs) and energetic astrophysical transients (ATs) using Bayesian methods, revealing limited associations and emphasizing the need for precise localization.


<details>
  <summary>Details</summary>
Motivation: To explore the relationship between FRBs and their potential progenitors, particularly magnetars, by systematically searching for associations with energetic astrophysical transients (ATs).

Method: A 3D Bayesian inference framework was employed to assess the association probabilities between 3765 FRBs and ATs, considering angular separation, positional uncertainty, and redshift constraints.

Result: Identified 14 FRB-optical transient and 15 FRB-gamma-ray burst candidate pairs; confirmed a strong association for FRB 20180916B with an AT probability of 0.9998, but found no new significant associations for other candidates.

Conclusion: While small angular separation is noted, it alone cannot confirm FRB-AT associations, highlighting the importance of high-precision localization for reliable identifications.
...
### [113] [GRB 241030A: a bright afterglow challenging forward shock emission](https://arxiv.org/abs/2603.18956)
...
TL;DR: GRB 241030A shows unusual afterglow characteristics, challenging standard GRB models.


<details>
  <summary>Details</summary>
Motivation: To investigate the afterglow physics of GRB 241030A and evaluate the implications for jet structure and energy.

Method: Multi-wavelength observations analyzed with a unified photometry pipeline and Bayesian inference using models of jet physics affecting afterglows.

Result: The study finds that GRB 241030A's jets are energetic yet inefficient with large opening angles, contradicting conventional GRB expectations.

Conclusion: The afterglow suggests additional emission mechanisms beyond the forward shock, indicating GRB 241030A fits a unique subclass of GRBs.
...
### [114] [Non-Markovian Cosmic-Ray Pitch-Angle Transport from Mirror Interactions](https://arxiv.org/abs/2603.19037)
*Kai Yan,Huirong Yan,Parth Pavaskar,Chuanpeng Hou,Ruo-Yu Liu*

Main category: astro-ph.HE

TL;DR: The study presents a guiding-center Langevin model for cosmic-ray pitch-angle transport in MHD turbulence, highlighting the roles of magnetic mirroring and gyroresonant scattering.


<details>
  <summary>Details</summary>
Motivation: To understand cosmic-ray pitch-angle transport influenced by magnetic fields in turbulent plasma environments.

Method: A Langevin model incorporating mirror drift and gyroresonant diffusion was developed and validated against test-particle simulations in three-dimensional MHD turbulence.

Result: The model shows that magnetic mirroring leads to anomalous pitch-angle diffusion, with significant non-Markovian effects for large-pitch-angle particles, while small-pitch-angle particles exhibit consistent diffusive behavior.

Conclusion: The transport mechanism is primarily driven by compressible perturbations, with a notable impact from transit time damping in accounting for mirror interactions.
...
### [115] [GRB 240205B: A Reverse Shock Detected in Rapid Response Radio Observations](https://arxiv.org/abs/2603.19047)
*S. I. Chastain,G. E. Anderson,A. J. van der Horst,L. Rhodes,C. Morley,A. Gulati,J. K. Leung,T. D. Russel,S. D. Ryder*

Main category: astro-ph.HE

TL;DR: This study presents significant radio observations of GRB 240205B, revealing the earliest afterglow detection and introducing key models involving reverse and forward shocks.


<details>
  <summary>Details</summary>
Motivation: To refine understanding of gamma-ray burst (GRB) afterglows, particularly at early times, and to improve detection strategies for future observations.

Method: Utilized broadband radio modeling with data from ATCA and MeerKAT, including a rapid-response observation triggered shortly after the GRB, followed by extensive follow-up for over five months.

Result: The early radio afterglow indicated a reverse shock component, which is critical for modeling, and provided the highest independent constraint on the GRB's minimum bulk Lorentz factor.

Conclusion: A combined shock model effectively describes GRB 240205B's afterglow; the study emphasizes the importance of fast-response observations and outlines strategies for future detections.
...
### [116] [G objects as Primordial Black Hole-Neutron Star Remnants: Population Modeling and Multi-Wavelength Observables](https://arxiv.org/abs/2603.19083)
*David Morales-Zapien,Stefano Profumo*

Main category: astro-ph.HE

TL;DR: G objects near the Galactic Center may be remnants of neutron stars turned into black holes via primordial black hole capture, offering insights into dark matter and compact-object physics.


<details>
  <summary>Details</summary>
Motivation: To resolve the mystery of G objects, which defy traditional interpretations as stars or gas clouds.

Method: A population-level framework relating the characteristics of G objects to neutron-star populations and primordial black holes.

Result: G objects and the lack of ordinary radio pulsars in the Galactic Center can be explained by the same conversion process; they provide testable observational signatures across multiple wavelengths.

Conclusion: G objects serve as probes for understanding compact-object capture physics and dark matter dynamics on sub-galactic scales.
...
### [117] [ADAMOS: Axion Daily Modulation Searches for Dark Matter at 20 GHz](https://arxiv.org/abs/2603.18006)
*Marios Maroudas,Toma-Stefan Cezar,Antonios Gardikiotis,Dieter Horns*

Main category: hep-ex

TL;DR: ADAMOS aims to explore dark matter using a fixed-frequency axion haloscope at 20 GHz, employing an innovative thin-shell design for large detection volume and enhanced sensitivity.


<details>
  <summary>Details</summary>
Motivation: To understand the nature of dark matter, particularly through axion signals, and build on previous experimental learnings.

Method: Construct a 20 GHz cavity resonator using a thin-shell design, install it in a 14 T superconducting magnet, and connect it to a sensitive RF chain with continuous calibration.

Result: The setup will facilitate simultaneous searches for cold DM axions, relativistic axions from quark nugget annihilations, and transient DM signal enhancements.

Conclusion: ADAMOS' novel approach will enable exploration of new discovery channels in the dark sector at unexplored frequency regimes.
...
### [118] [A search for lepton-flavour violating $τ\to 3μ$ decays with the ATLAS detector](https://arxiv.org/abs/2603.18099)
*ATLAS Collaboration*

Main category: hep-ex

TL;DR: A search for the decay process $τ\to 3μ$ in 13 TeV $pp$ collisions found no evidence of charged lepton flavour violation, setting a limit on the branching ratio.


<details>
  <summary>Details</summary>
Motivation: To investigate potential charged lepton flavour violation in the decay process $τ\to 3μ$, which could provide insights into physics beyond the Standard Model.

Method: Utilized ATLAS data from 13 TeV $pp$ collisions with an integrated luminosity of 137 $	ext{fb}^{-1}$. Employed two-muon and three-muon triggers, followed by a multivariate analysis to distinguish signal from background, and performed an unbinned likelihood fit on the three-muon invariant mass spectrum.

Result: Data analysis showed compatibility with the background-only hypothesis. The observed limit on the branching ratio was $8.7\times 10^{-8}$, while the expected limit was $7.5\times 10^{-8}$ at 90% CL.

Conclusion: The results provide no evidence for lepton flavour violation in the $τ\to 3μ$ decay and establish stringent upper limits on the decay's branching ratio.
...
### [119] [Reconstruction of overlapping electromagnetic showers in calorimeters using Transformers](https://arxiv.org/abs/2603.18172)
*Yuliia Maidannyk,Fabrice Couderc,Julie Malclès,Mehmet Özgür Sahin*

Main category: hep-ex

TL;DR: Deep learning approaches for clustering electromagnetic energy deposits improve photon/electron reconstruction by enhancing overlapping showers and efficiency.


<details>
  <summary>Details</summary>
Motivation: Accurate clustering is critical due to challenges in modern collider experiments such as overlapping energy deposits and pileup effects.

Method: Introduces a two-step strategy with distance-weighted message passing and attention mechanisms, alongside a single-step graph transformer called ClusTEX, which uses a novel positional encoding scheme.

Result: ClusTEX outperforms standard algorithms and two-step methods in energy resolution, splitting rate, and robustness against detector failures, especially for overlapping showers and di-photon mass identification.

Conclusion: Deep learning consistently enhances reconstruction capabilities in complex particle interactions, demonstrating superior performance and stability under various conditions.
...
### [120] [Observation of $D_s^+ \to a_0(980)^+f_0(500)$ in the Amplitude Analysis of $D_s^+ \to π^+ π^0 π^0 η$](https://arxiv.org/abs/2603.18521)
...
TL;DR: The first observation of the decay $D_s^+ \to π^+π^0π^0η$ is reported, with a significant branching fraction, offering insights into light scalar mesons' structure and validating isospin symmetry in related decays.


<details>
  <summary>Details</summary>
Motivation: To explore the decay mechanisms and branching fractions of the $D_s^+$ meson, focusing particularly on new decay channels and their significance in understanding light scalar mesons.

Method: Data collected from $e^+e^-$ collisions by the BESIII detector at varying energies, with subsequent analysis to measure the branching fractions of various decay processes.

Result: A significant branching fraction for $D_s^+ \to a_0(980)^+ f_0(500)$ is observed, alongside the dominant process $D_s^+ \to a_1(1260)^+η$, confirming isospin symmetry and leading to reduced estimates of other branching fractions.

Conclusion: The findings enhance the understanding of light scalar mesons and validate isospin symmetry, while the newly measured branching fractions highlight previously unrecognized decay paths.
...
### [121] [Combined effective field theory interpretation of measurements sensitive to quartic gauge boson couplings in $pp$ collisions at $\sqrt{s}=13$ TeV with the ATLAS detector](https://arxiv.org/abs/2603.18630)
*ATLAS Collaboration*

Main category: hep-ex

TL;DR: This paper presents combined measurements of anomalous electroweak gauge boson couplings using ATLAS data, providing constraints on quartic self-couplings from dimension-8 operators in the Éboli model.


<details>
  <summary>Details</summary>
Motivation: To investigate anomalous quartic couplings of electroweak bosons, which could provide insights into new physics beyond the Standard Model.

Method: The analysis utilizes proton-proton collision data from the ATLAS detector, focusing on vector-boson scattering and tri-boson measurements, applying effective field theory to constrain the anomalous couplings.

Result: Results are expressed as confidence intervals parameterized by Wilson coefficients, indicating the presence or absence of unitarity constraints, with related theoretical bounds noted.

Conclusion: This comprehensive analysis enhances the understanding of electroweak interactions and sets limits on new physics scenarios, contributing significant findings to the field.
...
### [122] [Measurement of the $\mathbf{B^0}$-meson production cross section in proton--proton collisions at $\mathbf{\sqrt{\textit{s}}=13.6}$ TeV](https://arxiv.org/abs/2603.18904)
*ALICE Collaboration*

Main category: hep-ex

TL;DR: The paper presents the first measurement of the transverse momentum differential production cross section of B$^0$ mesons in proton-proton collisions at 13.6 TeV using the ALICE detector, detailing decay channels and rapidity comparisons.


<details>
  <summary>Details</summary>
Motivation: To fill a knowledge gap in B$^0$ meson production data at high energies and provide empirical measurements for testing theoretical models.

Method: B$^0$ mesons were reconstructed from the decay B$^{0}	o$D$^{-}π^+$ with D$^-	o$K$^+π^-π^-$, measuring $p_{m T}$ differential cross sections.

Result: The measured production cross section at midrapidity is ${m d}σ({m B^0})/{m d} y|_{|y|<0.5} = 24.2 	imes 10^{-6}~μ{m b}$, consistent with advanced QCD models.

Conclusion: The findings provide significant data for understanding B meson production and contribute to the validation of quantum chromodynamics models.
...
### [123] [Stability of Charge Collection Efficiency and Time Resolution in 4H-SiC PIN Diodes Under X-ray Irradiation](https://arxiv.org/abs/2603.18547)
*Jiaqi Zhou,Sen Zhao,Xiyuan Zhang,Suyu Xiao,Chenxi Fu,Congcong Wang,Yanpeng Li,Weimin Song,Xin Shi*

Main category: physics.ins-det

TL;DR: This study assesses the radiation tolerance of a 4H-SiC PIN detector subjected to X-ray exposure, finding minimal degradation in performance post-irradiation.


<details>
  <summary>Details</summary>
Motivation: The goal is to evaluate the robustness of the 4H-SiC PIN detector for applications in high-radiation environments, critical for fields like high-energy physics and space exploration.

Method: The detector was characterized using I-V/C-V measurements, charge collection efficiency tests with beta particles, and timing resolution assessment before and after exposure to X-ray irradiation up to 2 MGy at 160 keV.

Result: Post-irradiation, the reverse leakage current remained ultralow at approximately 10^-11 A/cm^2, with negligible degradation in C-V characteristics and only a minor reduction in CCE (less than 5%). Timing resolution was slightly affected, with resolutions of 21 ps pre- and 31 ps post-irradiation.

Conclusion: The 4H-SiC PIN detector exhibits stable performance even after extreme X-ray exposure, affirming its suitability for radiation-sensitive applications.
...
### [124] [Spatial resolution improvement of PICOSEC Micromegas precise timing detectors](https://arxiv.org/abs/2603.18733)
...
TL;DR: PICOSEC Micromegas detectors combine a Cherenkov radiator with a photocathode and achieve a time resolution under 15ps and spatial resolution of around 0.5mm.


<details>
  <summary>Details</summary>
Motivation: To enhance the performance of particle detectors in terms of timing and spatial resolution.

Method: Integrate a Cherenkov radiator, a semi-transparent photocathode, and a Micromegas amplification stage in high readout granularity prototypes.

Result: Prototypes achieved approximately 0.5mm spatial resolution with medium granularity, and timing resolution remained better than 20ps.

Conclusion: The design allows for precise timing and moderate resolution tracking, demonstrating the potential for use in advanced detection systems.
...
### [125] [A Minimal-Component 100 MHz Full-Duplex Digital Link Over a Single Coaxial Cable for Laboratory Instrumentation](https://arxiv.org/abs/2603.18848)
*Michael Wiebusch*

Main category: physics.ins-det

TL;DR: The paper presents a minimal-component bidirectional digital interconnect for simultaneous signal transmission and reception via a single coaxial cable, emphasizing simplicity and performance without active components.


<details>
  <summary>Details</summary>
Motivation: The aim is to create a straightforward solution for bidirectional communication that is compatible with existing coaxial cable infrastructure, addressing constraints in laboratory settings

Method: The approach utilizes a passive resistive hybrid for signal separation, a CMOS logic gate as a driver, and a commercial LVDS receiver for signal comparison, avoiding the need for active components.

Result: The experimental setup showed that the timing error for signals transmitted over typical laboratory coaxial cables remains below 1 ns, with successful full-duplex operation demonstrated at 250 MBaud.

Conclusion: The proposed interconnect design offers a practical solution for reliable communication in constrained environments, highlighting its potential utility in various laboratory and detector applications.
...
### [126] [A Sub-electron-noise Skipper-CCD Readout ASIC with Improved Channel-to-channel Isolation and an Integrated Cryogenic Voltage Reference](https://arxiv.org/abs/2603.18993)
...
TL;DR: MIDNA ASICs enhance skipper-CCD readout with dual-slope integrators, achieving single-electron resolution at low temperatures.


<details>
  <summary>Details</summary>
Motivation: To improve the performance of skipper-CCD readouts in various temperature ranges, particularly at cryogenic levels, by addressing vulnerabilities and optimizing design.

Method: Utilized a 65 nm low-power CMOS process for ASICs with updates including an on-chip voltage reference and implemented correlated double sampling via dual-slope integrators.

Result: Achieved single-electron resolution through analog charge averaging at 140 K with readout noise of 0.11 erms for 1200 samples, and demonstrated channel-to-channel crosstalk better than -62 dB.

Conclusion: The updated MIDNA ASICs significantly enhance performance for skipper-CCD applications, especially in low-temperature environments.
